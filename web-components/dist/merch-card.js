var Rr=Object.defineProperty;var Or=a=>{throw TypeError(a)};var Mi=(a,r,e)=>r in a?Rr(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Ri=(a,r)=>()=>(a&&(r=a(a=0)),r);var Oi=(a,r)=>{for(var e in r)Rr(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>Mi(a,typeof r!="symbol"?r+"":r,e),rr=(a,r,e)=>r.has(a)||Or("Cannot "+e);var l=(a,r,e)=>(rr(a,r,"read from private field"),e?e.call(a):r.get(a)),u=(a,r,e)=>r.has(a)?Or("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(rr(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),y=(a,r,e)=>(rr(a,r,"access private method"),e);var Dr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return l(a,r,t)}});var ar={};Oi(ar,{default:()=>tt});import{LitElement as Di,html as Ae,css as Ni,nothing as Fi}from"./lit-all.min.js";import{unsafeHTML as qr}from"./lit-all.min.js";import{ifDefined as Ii}from"./lit-all.min.js";function $i(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var R,tt,ir=Ri(()=>{R=class R extends Di{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();R.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),d=c?c.offsetWidth:o,p=c?c.offsetHeight:s,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>t&&(f="left");let C=e.left+e.width/2,N=e.top+e.height/2,ie=6,zt=(Li,Pi,_i)=>Math.max(Li,Math.min(Pi,_i)),Tt,Lt,tr;f==="top"||f==="bottom"?(Tt=f==="top"?e.top-p-n:e.bottom+n,Lt=zt(0,t-d,C-d/2),tr=zt(ie,d-ie*2,C-Lt-ie)):(Lt=f==="left"?e.left-d-n:e.right+n,Tt=zt(0,i-p,N-p/2),tr=zt(ie,p-ie*2,N-Tt-ie)),this._tooltipTop=Tt,this._tooltipLeft=Lt,this._arrowOffset=tr,this._computedPlacement=f}showTooltip(){R.activeTooltip&&R.activeTooltip!==this&&(R.activeTooltip.closeOverlay(),R.activeTooltip.tooltipVisible=!1,R.activeTooltip.requestUpdate()),R.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){R.activeTooltip===this&&(R.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ae`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:Ae`<slot></slot>`}render(){let r=this.effectiveContent,e=this.effectivePlacement;if(!r)return Ae`<span class="icon-only">${this.renderIcon()}</span>`;if($i())return Ae`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let i=r.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:g=>{this.lastPointerType=g.pointerType},pointerenter:g=>g.pointerType!=="touch"&&this.showTooltip(),pointerleave:g=>g.pointerType!=="touch"&&this.hideTooltip(),click:g=>{this.lastPointerType==="touch"&&this.handleTap(g),this.lastPointerType=null}},s=this._computedPlacement,c=s==="top"||s==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=c?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return Ae`
            <span
    ...
    `);tt=R;customElements.define("mas-mnemonic",tt)});import{LitElement as Do}from"./lit-all.min.js";import{css as $r,unsafeCSS as Ir}from"./lit-all.min.js";var E="(max-width: 767px)",P="(max-width: 1199px)",k="(min-width: 768px)",b="(min-width: 1200px)",_="(min-width: 1600px)",Nr="(min-width: 1280px)",Fr={matchMobile:window.matchMedia(E),matchDesktop:window.matchMedia(`${b} and (not ${_})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(_),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Fr;function Pt(){return Fr.isDesktop}var Br=$r`
    :host {
...
`,Hr=()=>[$r`
    ...
    `);customElements.define("merch-icon",ze);var Qo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Zo=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var Te=2e4;var w='span[is="inline-price"][data-wcs-osi]',J='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Ui='a[is="upt-link"]',jr=`${w},${J},${Ui}`;var Gr="merch-offer-select:ready",Vr="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",rt="merch-card-quantity:change",nr="merch-modal:addon-and-quantity-update";var Le="merch-card-collection:literals-changed";var Pe="aem:load",_e="aem:error",me="mas:ready",Wr="mas:error";var Kr="placeholder-failed",Yr="placeholder-pending",Qr="placeholder-resolved";var Zr="mas:failed",K="mas:resolved",Xr="mas/commerce";var ne="failed",ge="pending",oe="resolved";var _t="X-Request-Id",Xo=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Jo=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Mt=":start",Rt=":duration";var M="legal",Jr="mas-ff-defaults";var ji="mas-commerce-service";function ea(a,r){let e;return function(){let t=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(t,i),r)}}function z(a,r={},e=null,t=null){let i=t?document.createElement(a,{is:t}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Me(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function or(){return window.matchMedia("(max-width: 1024px)").matches}function ue(){return document.getElementsByTagName(ji)?.[0]}function at(a){let r=window.getComputedStyle(a);return a.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function ta(a){let r=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var it,fe,nt,ot,Re,Ot=class extends HTMLElement{constructor(){super();u(this,it,"");u(this,fe);u(this,nt,[]);u(this,ot,[]);u(this,Re);m(this,Re,ea(()=>{this.isConnected&&(this.parentElement.style.background=this.value,l(this,fe)?this.parentElement.style.borderRadius=l(this,fe):l(this,fe)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=l(this,nt).map((t,i)=>{let n=l(this,ot)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${l(this,it)}, ${e})`}connectedCallback(){l(this,Re).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&m(this,fe,i?.trim()),e==="colors"&&i?m(this,nt,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,ot,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,it,i?.trim()??""),l(this,Re).call(this)}};it=new WeakMap,fe=new WeakMap,nt=new WeakMap,ot=new WeakMap,Re=new WeakMap;customElements.define("merch-gradient",Ot);import{LitElement as Gi,html as Vi,css as Wi}from"./lit-all.min.js";var Oe=class extends Gi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${r}"] ${w}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(K,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(K,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];t&&(e.setAttribute("data-offer-type",t.offerType),e.closest("p").setAttribute("data-plan-type",t.planType))}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return Vi` <input
                type="checkbox"
                id="addon-checkbox"
    ...
    `);customElements.define("merch-addon",Oe);import{html as Dt,nothing as Ki}from"./lit-all.min.js";var De,st=class st{constructor(r){h(this,"card");u(this,De);this.card=r,this.insertVariantStyle()}getContainer(){return m(this,De,l(this,De)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),l(this,De)}insertVariantStyle(){let r=this.constructor.name;if(!st.styleMap[r]){st.styleMap[r]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(r,e){if(!r||this.card.heightSync===!1)return;let t=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(t))||0;i>o&&n.style.setProperty(t,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let t=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${t}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${t}-${o}-height`;e.style.getPropertyValue(s)&&e.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),d=n.get(c);d||(d=[],n.set(c,d)),d.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let d=`--consonant-merch-card-${t}-${s}-height`,p=o.map(f=>f.style.getPropertyValue(d)),g=0;for(let f of o){f.style.removeProperty(d);let C=c(f);if(!C)continue;let N=Math.max(0,parseInt(window.getComputedStyle(C).height)||0);N>g&&(g=N)}o.forEach((f,C)=>{g>0?f.style.setProperty(d,`${g}px`):p[C]&&f.style.setProperty(d,p[C])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Dt`
        ...
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let r=Promise.allSettled(this.card.prices.map(i=>i.onceSettled?.()||Promise.resolve())),e,t=new Promise(i=>{e=setTimeout(i,Te)});await Promise.race([r,t]),clearTimeout(e)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Nt(this.card.variant)}};De=new WeakMap,h(st,"styleMap",{});var v=st;import{html as sr,css as Yi}from"./lit-all.min.js";var ra=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as ct,css as Qi}from"./lit-all.min.js";var ia=`
:root {
...
`;var tn=32,ma={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ie=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>It` <footer>
    ...
    `);import{html as lt,css as rn,nothing as $t}from"./lit-all.min.js";var ga=`
:root {
...
`;var Bt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ua={...function(){let{whatsIncluded:a,size:r,...e}=Bt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},fa={...function(){let{subtitle:a,whatsIncluded:r,size:e,quantitySelect:t,...i}=Bt;return i}()},Y,Q,D=class extends v{constructor(e){super(e);u(this,Y);u(this,Q);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ga}adjustSlotPlacement(e,t,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!t.includes(s)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&c){if(d)c.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(c):p.appendChild(c)}return}if(i&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!c){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){l(this,Y)||(m(this,Y,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(l(this,Y)?.disconnect(),m(this,Y,null),this.syncHeights())})),l(this,Y).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let i=t.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),t.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=at(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(d+=at(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+at(f));for(let N of t.childNodes){if(N.classList.contains("spacer"))break;d+=at(N)}let C=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(C)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${w}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?lt`<div class="divider"></div>`:$t}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`);t&&e.push(t);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?lt`<label id="stock-checkbox">
    ...
    `),h(D,"collectionOptions",{customHeaderArea:e=>e.sidenav?lt`<slot name="resultsText"></slot>`:$t,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let t=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};x.matchDesktop.addEventListener("change",t),e.addEventListener(Le,t),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",t),e.removeEventListener(Le,t)})}});import{html as ee,css as an,unsafeCSS as ba,nothing as Ht}from"./lit-all.min.js";var va=`
:root {
...
`;var[Sc,Ac,wa,Ea,ka,Ca]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Sa={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},te,be,gt,T,Aa,ht,za,pt,cr,qt,Ut=class Ut extends v{constructor(){super(...arguments);u(this,T);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,te,null);u(this,be,null);h(this,"lastSyncKey",null);u(this,gt,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of y(this,T,Aa).call(this)){let n=i.variantLayout;n instanceof Ut&&(n.expanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?y(this,T,cr).call(this):y(this,T,pt).call(this),this.card.requestUpdate()});u(this,qt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Ea:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:y(this,T,pt).call(this);break;case wa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:y(this,T,pt).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case ka:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}y(this,T,pt).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),y(this,T,cr).call(this);break;case Ca:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,y(this,T,ht).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(O,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return ya}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(K,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let t=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=t?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=t.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=`--consonant-merch-card-${t}-top-card-height`,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(s=>s.getBoundingClientRect().width>2&&s.variantLayout?.card?.heightSync!==!1),o=new Map;for(let s of n){let c=o.get(s.offsetTop)??[];c.push(s),o.set(s.offsetTop,c)}for(let s of o.values()){let c=0;for(let d of s){d.style.removeProperty(i);let p=d.shadowRoot?.querySelector(".top-card");p&&(c=Math.max(c,parseInt(getComputedStyle(p).height)||0))}c>0&&s.length>1&&s.forEach(d=>d.style.setProperty(i,`${c}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),i=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(rt,l(this,gt)),typeof ResizeObserver>"u"))return;m(this,be,new ResizeObserver(()=>this.resyncOnReflow())),l(this,be).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&l(this,be).observe(e)}disconnectedCallbackHook(){y(this,T,ht).call(this),l(this,be)?.disconnect(),this.card?.removeEventListener(rt,l(this,gt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t)return null;let o=[];for(let s=t;s<=i;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return le`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return le`
        ...
        `}renderLayout(){let e=!!this.expanded;return le`
            ...
            ${this.hasWhatsIncluded?le`
                  ...
                  `:dt}
            <slot></slot>
        `}};te=new WeakMap,be=new WeakMap,gt=new WeakMap,T=new WeakSet,Aa=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},ht=function(){l(this,te)&&(document.removeEventListener("mousedown",l(this,te)),m(this,te,null))},za=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},pt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=y(this,T,za).call(this),l(this,te)||(m(this,te,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),y(this,T,ht).call(this))}),document.addEventListener("mousedown",l(this,te)))},cr=function(){this.licenseOpen=!1,y(this,T,ht).call(this)},qt=new WeakMap,h(Ut,"variantStyle",nn`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var mt=Ut;import{html as lr,css as on}from"./lit-all.min.js";var Ta=`
:root {
...
`;var La={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Z,$e=class extends v{constructor(e){super(e);u(this,Z);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ta}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return lr` ${this.badge}
...
`;var _a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Be=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Pa}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return dr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var mr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},ut=class ut extends v{getGlobalCSS(){return Fa}get aemFragmentMapping(){return mr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ia`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let e=window.getComputedStyle(r),t=`${e.fontWeight} ${e.fontSize} ${e.fontFamily}`;await document.fonts.load(t,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let r=ut.SYNCED_SECTIONS.map(s=>({name:s,getElement:c=>c.shadowRoot?.querySelector(`.${s}`)})),e=this.getContainer(),t=e?e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(t,s=>s.querySelectorAll(i).length)),o=Array.from({length:n},(s,c)=>({name:`description-row-${c}`,getElement:d=>d.querySelectorAll(i)[c]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=49;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let e=this.card.querySelector(this.headingSelector),t=e?Math.round(e.getBoundingClientRect().height):0,i=`${Math.round(r)}:${t}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return Ia`
            ...
            <slot></slot>
        `}};h(ut,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),h(ut,"variantStyle",mn`
    ...
    `);var ft=ut;import{html as gr,css as gn,nothing as un}from"./lit-all.min.js";var $a=`
...
`;var ur={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},wn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],jt,ja,Ve=class extends v{constructor(e){super(e);u(this,jt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ua}get aemFragmentMapping(){return ur}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,jt,ja).call(this))}renderLayout(){return xn`
            <div class="card">
            ...
            <slot></slot>
        `}};jt=new WeakSet,ja=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;wn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ve,"variantStyle",yn`
...
`;var fr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},We=class extends v{getGlobalCSS(){return Ga}get aemFragmentMapping(){return fr}renderLayout(){return En`
    ...
    `);var Gt=new Map,Va=new WeakMap,Wa=new Map,S=(a,r,e=null,t=null,i)=>{Gt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",Ne,aa,Ne.variantStyle);S("image",ve);S("inline-heading",Ft);S("mini-compare-chart",Fe,da,Fe.variantStyle);S("mini-compare-chart-mweb",Ie,ma,Ie.variantStyle);S("plans",D,Bt,D.variantStyle,D.collectionOptions);S("plans-students",D,fa,D.variantStyle,D.collectionOptions);S("plans-education",D,ua,D.variantStyle,D.collectionOptions);S("plans-v2",ce,xa,ce.variantStyle,ce.collectionOptions);S("bizpro",mt,Sa,mt.variantStyle);S("product",$e,La,$e.variantStyle);S("segment",Be,_a,Be.variantStyle);S("media",He,Ra,He.variantStyle);S("headless",je,Ba,je.variantStyle);S("special-offers",qe,Da,qe.variantStyle);S("simplified-pricing-express",Ue,pr,Ue.variantStyle);S("full-pricing-express",ft,mr,ft.variantStyle);S("mini",Ge,qa,Ge.variantStyle);S("image",ve,na,ve.variantStyle);S("compare-chart-column",Ve,ur,Ve.variantStyle);S("fries",We,fr,We.variantStyle);var Cn=(a,r,e)=>{try{let t=Wa.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),Wa.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},vr=a=>{let r=Gt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=Va.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?Cn(a,t,i):{};return Va.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Nt(a){return Gt.get(a)?.fragmentMapping}function Ka(a){return Gt.get(a)?.collectionOptions}var Ya=document.createElement("style");Ya.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var xe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Za=1e3;function zn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Xa(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!xe.serializableTypes.includes(e))return e}return a}function Tn(a,r){if(!xe.ignoredProperties.includes(a))return Xa(r)}var xr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(zn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(Xa).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${xe.delimiter}page=${o}${s}`;c.length>Za&&(c=`${c.slice(0,Za)}<trunc>`),n+=c,i.length&&(n+=`${xe.delimiter}facts=`,n+=JSON.stringify(i,Tn)),window.lana?.log(n,xe)}};function Ja(a){Object.assign(xe,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in xe&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ei={LOCAL:"local",PROD:"prod",STAGE:"stage"},yr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},wr=new Set,Er=new Set,ti=new Map,ri={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},ai={filter:({level:a})=>a!==yr.DEBUG},Ln={filter:()=>!1};function Pn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Wt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function _n(a){[...Er].every(r=>r(a))&&wr.forEach(r=>r(a))}function ii(a){let r=(ti.get(a)??0)+1;ti.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>ii(`${t.namespace}/${i}`),updateConfig:Ja};return Object.values(yr).forEach(i=>{t[i]=(n,...o)=>_n(Pn(i,n,a,o,e))}),Object.seal(t)}function Kt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Wt(t)&&Er.add(t),Wt(e)&&wr.add(e)})}function Mn(a={}){let{name:r}=a,e=Qa(Vt("commerce.debug",{search:!0,storage:!0}),r===ei.LOCAL);return Kt(e?ri:ai),r===ei.PROD&&Kt(xr),vt}function Rn(){wr.clear(),Er.clear()}var vt={...ii(Xr),Level:yr,Plugins:{consoleAppender:ri,debugFilter:ai,quietFilter:Ln,lanaAppender:xr},init:Mn,reset:Rn,use:Kt};var On="mas-commerce-service",Td=vt.module("utilities"),Dn={requestId:_t,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Yt=a=>window.setTimeout(a);function kr(){return document.getElementsByTagName(On)?.[0]}function ni(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Dn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function oi(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,t*(n+1)))}throw i}var si="fragment",ci="author",li="preview",di="loading",hi="mask",pi="pzn",mi="timeout",Cr="aem-fragment",gi="eager",ui="cache",Nn=[gi,ui],q,ye,F,Sr=class{constructor(){u(this,q,new Map);u(this,ye,new Map);u(this,F,new Map)}clear(){l(this,q).clear(),l(this,ye).clear(),l(this,F).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(l(this,q).set(r.id,r),r.fields?.originalId&&l(this,q).set(r.fields.originalId,r),l(this,F).has(r.id)){let[,t]=l(this,F).get(r.id);t()}if(l(this,F).has(r.fields?.originalId)){let[,t]=l(this,F).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return l(this,q).has(r)}entries(){return l(this,q).entries()}get(r){return l(this,q).get(r)}getAsPromise(r){let[e]=l(this,F).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),l(this,F).set(r,[e,t]),e}getFetchInfo(r){let e=l(this,ye).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},l(this,ye).set(r,e)),e}set(r,e){if(l(this,q).set(r,e),l(this,F).has(r)){let[,t]=l(this,F).get(r);t()}}remove(r){l(this,q).delete(r),l(this,ye).delete(r),l(this,F).delete(r)}};q=new WeakMap,ye=new WeakMap,F=new WeakMap;var re=new Sr,Ke,$,ae,I,U,L,bt,j,G,xt,V,yt,wt,Ye,W,fi,vi,Ar,bi,Qt=class extends HTMLElement{constructor(){super(...arguments);u(this,W);h(this,"cache",re);u(this,Ke);u(this,$,null);u(this,ae,null);u(this,I,null);u(this,U);u(this,L);u(this,bt,gi);u(this,j);u(this,G);u(this,xt,5e3);u(this,V);u(this,yt,!1);u(this,wt,0);u(this,Ye)}static get observedAttributes(){return[si,di,mi,ci,li,hi,pi]}cacheKey(){return`${l(this,U)}${l(this,G)?`-p_${l(this,G)}`:""}${l(this,j)?`-m_${l(this,j)}`:""}`}attributeChangedCallback(e,t,i){e===si&&(m(this,U,i),m(this,L,re.getFetchInfo(this.cacheKey()))),e===hi&&m(this,j,i),e===pi&&m(this,G,i),e===di&&Nn.includes(i)&&m(this,bt,i),e===mi&&m(this,xt,parseInt(i,10)),e===ci&&m(this,yt,["","true"].includes(i)),e===li&&m(this,Ye,i)}connectedCallback(){if(!l(this,V)){if(l(this,I)??m(this,I,ue(this)),m(this,Ye,l(this,I).settings?.preview),l(this,Ke)??m(this,Ke,l(this,I).log.module(`${Cr}[${l(this,U)}]`)),!l(this,U)||l(this,U)==="#"){l(this,L)??m(this,L,re.getFetchInfo("missing-fragment-id")),y(this,W,Ar).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(l(this,L)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(l(this,V)&&!await Promise.race([l(this,V),Promise.resolve(!1)]))return;e&&re.remove(this.cacheKey()),l(this,bt)===ui&&await Promise.race([re.getAsPromise(this.cacheKey()),new Promise(s=>setTimeout(s,l(this,xt)))]);try{m(this,V,y(this,W,bi).call(this)),await l(this,V)}catch(s){return y(this,W,Ar).call(this,s.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=l(this,$)||{};return o&&!Vt("mas.disableWcsCache")&&l(this,I).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Pe,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...l(this,L)},bubbles:!0,composed:!0})),l(this,V)}get updateComplete(){return l(this,V)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return l(this,ae)?l(this,ae):(l(this,yt)?this.transformAuthorData():this.transformPublishData(),l(this,ae))}get rawData(){return l(this,$)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,settings:s={},priceLiterals:c={},dictionary:d={},placeholders:p={}}=l(this,$);m(this,ae,e.reduce((g,{name:f,multiple:C,values:N})=>(g.fields[f]=C?N:N[0],g),{fields:{},id:t,tags:n,settings:s,priceLiterals:c,dictionary:d,maskId:i,placeholders:p,variationId:o}))}transformPublishData(){if(!l(this,$))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},maskId:c,placeholders:d={},variationId:p}=l(this,$);m(this,ae,Object.entries(e).reduce((g,[f,C])=>(g.fields[f]=C?.mimeType?C.value:C??"",g),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:s,maskId:c,placeholders:d,variationId:p}))}getFragmentClientUrl(){let t=new URLSearchParams(window.location.search).get("maslibs");if(!t||t.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=t.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:l(this,I).settings.locale,apiKey:l(this,I).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??l(this,I).settings.instant,o={...i,...n!=null?{instant:n}:{},...l(this,j)!=null?{mask:l(this,j)}:{},...l(this,G)!=null?{pzn:l(this,G)}:{}};return await t(l(this,U),o)}};Ke=new WeakMap,$=new WeakMap,ae=new WeakMap,I=new WeakMap,U=new WeakMap,L=new WeakMap,bt=new WeakMap,j=new WeakMap,G=new WeakMap,xt=new WeakMap,V=new WeakMap,yt=new WeakMap,wt=new WeakMap,Ye=new WeakMap,W=new WeakSet,fi=async function(e){Dr(this,wt)._++;let t=`${Cr}:${this.cacheKey()}:${l(this,wt)}`,i=`${t}${Mt}`,n=`${t}${Rt}`;if(l(this,Ye)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new de(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(l(this,L).stale=!1,l(this,L).url=e,o=await oi(e,{cache:"default",credentials:"omit"}),y(this,W,vi).call(this,o),l(this,L).status=o?.status,l(this,L).measure=Me(performance.measure(n,i)),l(this,L).retryCount=o.retryCount,!o?.ok)throw new de("Unexpected fragment response",{response:o,...l(this,I).duration});return await o.json()}catch(s){if(l(this,L).measure=Me(performance.measure(n,i)),l(this,L).retryCount=s.retryCount,l(this,$))return l(this,L).stale=!0,l(this,Ke).error("Serving stale data",l(this,L)),l(this,$);let c=s.message??"unknown";throw new de(`Failed to fetch fragment: ${c}`,{})}},vi=function(e){Object.assign(l(this,L),ni(e))},Ar=function(e){m(this,V,null),l(this,L).message=e,this.classList.add("error");let t={...l(this,L),...l(this,I).duration};l(this,Ke).error(e,t),this.dispatchEvent(new CustomEvent(_e,{detail:t,bubbles:!0,composed:!0}))},bi=async function(){var c;this.classList.remove("error"),m(this,ae,null);let e=re.get(this.cacheKey());if(e)return m(this,$,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=l(this,I).settings,s=`${t}/fragment?id=${l(this,U)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),l(this,j)&&(s+=`&mask=${l(this,j)}`),l(this,G)&&(s+=`&pzn=${l(this,G)}`),e=await y(this,W,fi).call(this,s),(c=e.fields).originalId??(c.originalId=l(this,U)),l(this,j)||l(this,G)?re.set(this.cacheKey(),e):re.add(e),m(this,$,e),!0},h(Qt,"cache",re);customElements.define(Cr,Qt);import{LitElement as Fn,html as zr,css as In,nothing as $n}from"./lit-all.min.js";import{unsafeHTML as Bn}from"./lit-all.min.js";var Hn=a=>a?a.startsWith("sp-icon-")?zr`${Bn(`<${a} class="badge-icon"></${a}>`)}`:zr`<img src="${a}" class="badge-icon" />`:$n,Qe=class extends Fn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return zr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Qe);import{html as qn,css as Un,LitElement as jn}from"./lit-all.min.js";var Et=class extends jn{constructor(){super()}render(){return qn`
            <slot name="icon"></slot>
    ...
    `),h(Et,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Et);import{html as Tr,css as Gn,LitElement as Vn,nothing as xi}from"./lit-all.min.js";var kt=class extends Vn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Tr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Tr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:xi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(kt,"styles",Gn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

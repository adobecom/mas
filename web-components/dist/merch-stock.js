...
var T = (o, e, t) =>
    e in o
        ...
        : (o[e] = t);
var _ = (o, e, t) => T(o, typeof e != 'symbol' ? e + '' : e, t),
    h = (o, e, t) => e.has(o) || r('Cannot ' + t);
var c = (o, e, t) => (
        h(o, e, 'read from private field'), t ? t.call(o) : e.get(o)
    ),
    a = (o, e, t) =>
        e.has(o)
            ...
            : e instanceof WeakSet
              ? e.add(o)
              : e.set(o, t);
import { LitElement as C, css as S, html as N } from '/deps/lit-all.min.js';
var L = Object.freeze({
        MONTH: 'MONTH',
        YEAR: 'YEAR',
        TWO_YEARS: 'TWO_YEARS',
...
var A = '(max-width: 767px)';
var s,
    E = class extends C {
        constructor() {
            super();
            a(this, s, new n(this, A));
            this.checked = !1;
        }
        handleChange(t) {
        ...
        render() {
            if (this.planType && !c(this, s).matches)
                return N`
            <sp-checkbox
                size="s"

...
`,Gr=()=>[Ur`
        ...
        `];import{LitElement as Ki,html as Wr,css as Yi}from"./lit-all.min.js";function Qi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Pe=class extends Ki{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Qi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let t="",i="top";if(e.tagName==="SP-TOOLTIP")t=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(t=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(t){let n=document.createElement("mas-mnemonic");n.setAttribute("content",t),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>cr())}e.remove()})}render(){let{href:r}=this;return r?Wr`<a href="${r}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(Pe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(Pe,"styles",Yi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Pe);var sc=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),lc=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var _e=2e4;var E='span[is="inline-price"][data-wcs-osi]',te='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Zi='a[is="upt-link"]',Kr=`${E},${te},${Zi}`;var Yr="merch-offer-select:ready",Qr="merch-card:action-menu-toggle";var M="merch-quantity-selector:change",ot="merch-card-quantity:change",sr="merch-modal:addon-and-quantity-update";var Me="merch-card-collection:literals-changed";var Re="aem:load",Oe="aem:error",ue="mas:ready",Zr="mas:error";var Xr="placeholder-failed",Jr="placeholder-pending",ea="placeholder-resolved";var ta="mas:failed",U="mas:resolved",ra="mas/commerce";var oe="failed",fe="pending",ce="resolved";var Ot="X-Request-Id",dc=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var hc=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Dt=":start",Nt=":duration";var R="legal",aa="mas-ff-defaults";var Xi="mas-commerce-service";function ia(a,r){let e;return function(){let t=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(t,i),r)}}function P(a,r={},e=null,t=null){let i=t?document.createElement(a,{is:t}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function De(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function lr(){return window.matchMedia("(max-width: 1024px)").matches}function ve(){return document.getElementsByTagName(Xi)?.[0]}function ct(a){let r=window.getComputedStyle(a);return a.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function na(a){let r=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var st,xe,lt,dt,Ne,Ft=class extends HTMLElement{constructor(){super();u(this,st,"");u(this,xe);u(this,lt,[]);u(this,dt,[]);u(this,Ne);m(this,Ne,ia(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,xe)?this.parentElement.style.borderRadius=s(this,xe):s(this,xe)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,lt).map((t,i)=>{let n=s(this,dt)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${s(this,st)}, ${e})`}connectedCallback(){s(this,Ne).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&m(this,xe,i?.trim()),e==="colors"&&i?m(this,lt,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,dt,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,st,i?.trim()??""),s(this,Ne).call(this)}};st=new WeakMap,xe=new WeakMap,lt=new WeakMap,dt=new WeakMap,Ne=new WeakMap;customElements.define("merch-gradient",Ft);import{LitElement as Ji,html as en,css as tn}from"./lit-all.min.js";var Fe=class extends Ji{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${r}"] ${E}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(U,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(U,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];t&&(e.setAttribute("data-offer-type",t.offerType),e.closest("p").setAttribute("data-plan-type",t.planType))}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return en` <input
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(Fe,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0},background:{type:String,attribute:"background"}}),h(Fe,"styles",tn`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as pt,css as nn}from"./lit-all.min.js";var sa=`
:root {
...
`;var cn=32,ga={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},He=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?se`<slot name="secure-transaction-label">
    ...
    `);import{html as Bt,css as sn,unsafeCSS as hr,nothing as ln}from"./lit-all.min.js";var ua=`
  :root {
...
`;var dn=32,fa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Q,Be=class extends v{constructor(e){super(e);u(this,Q);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Bt` <footer>
    ...
    `);import{html as mt,css as hn,nothing as qt}from"./lit-all.min.js";var va=`
:root {
...
`;var Ut={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},xa={...function(){let{whatsIncluded:a,size:r,...e}=Ut;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},ba={...function(){let{subtitle:a,whatsIncluded:r,size:e,quantitySelect:t,...i}=Ut;return i}()},Z,X,F=class extends v{constructor(e){super(e);u(this,Z);u(this,X);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return va}adjustSlotPlacement(e,t,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!t.includes(c)){if(o?.classList.toggle("wide-footer",b.isDesktopOrUp),!i&&l){if(d)l.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(l):p.appendChild(l)}return}if(i&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!l){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],b.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],b.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,Z)||(m(this,Z,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,Z)?.disconnect(),m(this,Z,null),this.syncHeights())})),s(this,Z).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let i=t.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),t.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=ct(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(d+=ct(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+ct(f));for(let O of t.childNodes){if(O.classList.contains("spacer"))break;d+=ct(O)}let C=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(C)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${E}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?mt`<div class="divider"></div>`:qt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${E}[data-template="price"]`);t&&e.push(t);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?mt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Z=new WeakMap,X=new WeakMap,h(F,"variantStyle",hn`
        :host([variant^='plans']) {
            min-height: 273px;
...
`;var[Fs,Is,Ca,Sa,Aa,Ta]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var un="pro",La=`--consonant-merch-card-${un}-top-card-height`,za={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ae,ye,xt,L,Pa,ut,_a,ft,pr,Gt,Vt=class Vt extends v{constructor(e){super(e);u(this,L);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,ae,null);u(this,ye,null);h(this,"lastSyncKey",null);u(this,xt,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of y(this,L,Pa).call(this)){let n=i.variantLayout;n instanceof Vt&&(n.expanded=t,i._proExpanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?y(this,L,pr).call(this):y(this,L,ft).call(this),this.card.requestUpdate()});u(this,Gt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Sa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:y(this,L,ft).call(this);break;case Ca:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:y(this,L,ft).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Aa:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}y(this,L,ft).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),y(this,L,pr).call(this);break;case Ta:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,y(this,L,ut).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(M,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._proExpanded??!1}getGlobalCSS(){return ka}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(U,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let t=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=t?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=t.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${E}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=La,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1),o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}for(let c of o.values()){let l=0;for(let d of c){d.style.removeProperty(i);let p=d.shadowRoot?.querySelector(".top-card");p&&(l=Math.max(l,parseInt(getComputedStyle(p).height)||0))}l>0&&c.length>1&&c.forEach(d=>d.style.setProperty(i,`${l}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),i=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(ot,s(this,xt)),this.card.addEventListener(M,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;m(this,ye,new ResizeObserver(()=>this.resyncOnReflow())),s(this,ye).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&s(this,ye).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(M,this.updatePriceQuantity),y(this,L,ut).call(this),s(this,ye)?.disconnect(),this.card?.removeEventListener(ot,s(this,xt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t)return null;let o=[];for(let c=t;c<=i;c+=n)o.push(String(c));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return de`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return de`
        ...
        `}renderLayout(){let e=!!this.expanded;return de`
            ...
            ${this.hasWhatsIncluded?de`
                  ...
                  `:gt}
            <slot></slot>
        `}};ae=new WeakMap,ye=new WeakMap,xt=new WeakMap,L=new WeakSet,Pa=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},ut=function(){s(this,ae)&&(document.removeEventListener("mousedown",s(this,ae)),m(this,ae,null))},_a=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},ft=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=y(this,L,_a).call(this),s(this,ae)||(m(this,ae,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),y(this,L,ut).call(this))}),document.addEventListener("mousedown",s(this,ae)))},pr=function(){this.licenseOpen=!1,y(this,L,ut).call(this)},Gt=new WeakMap,h(Vt,"variantStyle",mn`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var vt=Vt;import{html as mr,css as fn}from"./lit-all.min.js";var Ma=`
:root {
...
`;var Ra={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},J,qe=class extends v{constructor(e){super(e);u(this,J);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ma}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return mr` ${this.badge}
    ...
    `);import{html as gr,css as vn}from"./lit-all.min.js";var Oa=`
:root {
...
`;var Da={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ue=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===R&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Oa}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${E}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return gr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as xn,css as bn}from"./lit-all.min.js";var Na=`
...
`;var Fa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},je=class extends v{constructor(r){super(r)}getGlobalCSS(){return Na}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return xn`
    ...
    `);import{html as ur,css as yn}from"./lit-all.min.js";var Ia=`
:root {
...
`;var $a={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Ge=class extends v{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Ia}renderLayout(){return ur`${this.cardImage}
            ...
            ${this.evergreen?ur`
                  ...
                  `:ur`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(Ge,"variantStyle",yn`
    ...
    `);import{html as Ba,css as wn,nothing as En}from"./lit-all.min.js";var Ha=`
:root {
...
`;var fr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ve=class extends v{getGlobalCSS(){return Ha}get aemFragmentMapping(){return fr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')?Ba`<div class="badge-wrapper">
    ...
    `);import{html as Ua,css as kn,nothing as Cn}from"./lit-all.min.js";var qa=`
:root {
...
`;var vr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},bt=class bt extends v{getGlobalCSS(){return qa}get aemFragmentMapping(){return vr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')?Ua`<div class="badge-wrapper">
            ...
            <slot></slot>
        `}};h(bt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),h(bt,"variantStyle",kn`
    ...
    `);var yt=bt;import{html as xr,css as Sn,nothing as An}from"./lit-all.min.js";var ja=`
...
`;var Ga={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Tn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],We=class extends v{constructor(r){super(r)}getGlobalCSS(){return ja}renderLayout(){return xr`
    ...
    `);import{css as Ln,html as zn}from"./lit-all.min.js";var Va=`
...
`;var Wa={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ke=class extends v{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Va}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,t){t.literals={...t.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},t.space=!0,t.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${E}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",t.dataset.template="legal",t.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return zn`
    ...
    `);import{html as Pn,css as _n}from"./lit-all.min.js";var Ka=`
...
`;var br={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Mn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Wt,Ya,Ye=class extends v{constructor(e){super(e);u(this,Wt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ka}get aemFragmentMapping(){return br}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Wt,Ya).call(this))}renderLayout(){return Pn`
            <div class="card">
            ...
            <slot></slot>
        `}};Wt=new WeakSet,Ya=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Mn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ye,"variantStyle",_n`
...
`;var yr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Qe=class extends v{getGlobalCSS(){return Qa}get aemFragmentMapping(){return yr}renderLayout(){return Rn`
    ...
    `);var Kt=new Map,Za=new WeakMap,Xa=new Map,S=(a,r,e=null,t=null,i)=>{Kt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",$e,ca,$e.variantStyle);S("image",be);S("inline-heading",Ht);S("mini-compare-chart",He,ga,He.variantStyle);S("mini-compare-chart-mweb",Be,fa,Be.variantStyle);S("plans",F,Ut,F.variantStyle,F.collectionOptions);S("plans-students",F,ba,F.variantStyle,F.collectionOptions);S("plans-education",F,xa,F.variantStyle,F.collectionOptions);S("plans-v2",le,Ea,le.variantStyle,le.collectionOptions);S("pro",vt,za,vt.variantStyle);S("product",qe,Ra,qe.variantStyle);S("segment",Ue,Da,Ue.variantStyle);S("media",je,Fa,je.variantStyle);S("headless",We,Ga,We.variantStyle);S("special-offers",Ge,$a,Ge.variantStyle);S("simplified-pricing-express",Ve,fr,Ve.variantStyle);S("full-pricing-express",yt,vr,yt.variantStyle);S("mini",Ke,Wa,Ke.variantStyle);S("image",be,la,be.variantStyle);S("compare-chart-column",Ye,br,Ye.variantStyle);S("fries",Qe,yr,Qe.variantStyle);var Dn=(a,r,e)=>{try{let t=Xa.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),Xa.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},wr=a=>{let r=Kt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=Za.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?Dn(a,t,i):{};return Za.set(a,{appliedVariant:a.variant,...n}),new e(a)};function $t(a){return Kt.get(a)?.fragmentMapping}function Ja(a){return Kt.get(a)?.collectionOptions}var ei=document.createElement("style");ei.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var we={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ri=1e3;function In(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ai(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!we.serializableTypes.includes(e))return e}return a}function $n(a,r){if(!we.ignoredProperties.includes(a))return ai(r)}var kr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(In(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(ai).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${we.delimiter}page=${o}${c}`;l.length>ri&&(l=`${l.slice(0,ri)}<trunc>`),n+=l,i.length&&(n+=`${we.delimiter}facts=`,n+=JSON.stringify(i,$n)),window.lana?.log(n,we)}};function ii(a){Object.assign(we,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in we&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ni={LOCAL:"local",PROD:"prod",STAGE:"stage"},Cr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Sr=new Set,Ar=new Set,oi=new Map,ci={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},si={filter:({level:a})=>a!==Cr.DEBUG},Hn={filter:()=>!1};function Bn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Qt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function qn(a){[...Ar].every(r=>r(a))&&Sr.forEach(r=>r(a))}function li(a){let r=(oi.get(a)??0)+1;oi.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>li(`${t.namespace}/${i}`),updateConfig:ii};return Object.values(Cr).forEach(i=>{t[i]=(n,...o)=>qn(Bn(i,n,a,o,e))}),Object.seal(t)}function Zt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Qt(t)&&Ar.add(t),Qt(e)&&Sr.add(e)})}function Un(a={}){let{name:r}=a,e=ti(Yt("commerce.debug",{search:!0,storage:!0}),r===ni.LOCAL);return Zt(e?ci:si),r===ni.PROD&&Zt(kr),wt}function jn(){Sr.clear(),Ar.clear()}var wt={...li(ra),Level:Cr,Plugins:{consoleAppender:ci,debugFilter:si,quietFilter:Hn,lanaAppender:kr},init:Un,reset:jn,use:Zt};var Gn="mas-commerce-service",Hd=wt.module("utilities"),Vn={requestId:Ot,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Xt=a=>window.setTimeout(a);function Tr(){return document.getElementsByTagName(Gn)?.[0]}function di(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Vn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function hi(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,t*(n+1)))}throw i}var Wn="<explicit_empty/>";function Ze(a){return a===Wn}function pi(a){return Array.isArray(a)&&a.length===1&&Ze(a[0])}function mi(a){if(Array.isArray(a))return a.map(e=>{let t=e.values??[],i=e.multiple===!0;return pi(t)?{...e,values:i?[]:[""]}:t.some(Ze)?{...e,values:t.map(n=>Ze(n)?"":n)}:e});if(!a||typeof a!="object")return a;let r={};for(let[e,t]of Object.entries(a))Array.isArray(t)?r[e]=pi(t)?[]:t.map(i=>Ze(i)?"":i):Ze(t)?r[e]="":t&&typeof t=="object"&&Ze(t.value)?r[e]={...t,value:""}:r[e]=t;return r}var gi="fragment",ui="author",fi="preview",vi="loading",xi="mask",bi="pzn",yi="timeout",Lr="aem-fragment",wi="eager",Ei="cache",Kn=[wi,Ei],j,Ee,I,zr=class{constructor(){u(this,j,new Map);u(this,Ee,new Map);u(this,I,new Map)}clear(){s(this,j).clear(),s(this,Ee).clear(),s(this,I).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(s(this,j).set(r.id,r),r.fields?.originalId&&s(this,j).set(r.fields.originalId,r),s(this,I).has(r.id)){let[,t]=s(this,I).get(r.id);t()}if(s(this,I).has(r.fields?.originalId)){let[,t]=s(this,I).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return s(this,j).has(r)}entries(){return s(this,j).entries()}get(r){return s(this,j).get(r)}getAsPromise(r){let[e]=s(this,I).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),s(this,I).set(r,[e,t]),e}getFetchInfo(r){let e=s(this,Ee).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,Ee).set(r,e)),e}set(r,e){if(s(this,j).set(r,e),s(this,I).has(r)){let[,t]=s(this,I).get(r);t()}}remove(r){s(this,j).delete(r),s(this,Ee).delete(r),s(this,I).delete(r)}};j=new WeakMap,Ee=new WeakMap,I=new WeakMap;var ie=new zr,Xe,H,ne,$,G,z,Et,V,W,kt,K,Ct,St,Je,Y,ki,Ci,Pr,Si,Jt=class extends HTMLElement{constructor(){super(...arguments);u(this,Y);h(this,"cache",ie);u(this,Xe);u(this,H,null);u(this,ne,null);u(this,$,null);u(this,G);u(this,z);u(this,Et,wi);u(this,V);u(this,W);u(this,kt,5e3);u(this,K);u(this,Ct,!1);u(this,St,0);u(this,Je)}static get observedAttributes(){return[gi,vi,yi,ui,fi,xi,bi]}cacheKey(){return`${s(this,G)}${s(this,W)?`-p_${s(this,W)}`:""}${s(this,V)?`-m_${s(this,V)}`:""}`}attributeChangedCallback(e,t,i){e===gi&&(m(this,G,i),m(this,z,ie.getFetchInfo(this.cacheKey()))),e===xi&&m(this,V,i),e===bi&&m(this,W,i),e===vi&&Kn.includes(i)&&m(this,Et,i),e===yi&&m(this,kt,parseInt(i,10)),e===ui&&m(this,Ct,["","true"].includes(i)),e===fi&&m(this,Je,i)}connectedCallback(){if(!s(this,K)){if(s(this,$)??m(this,$,ve(this)),m(this,Je,s(this,$).settings?.preview),s(this,Xe)??m(this,Xe,s(this,$).log.module(`${Lr}[${s(this,G)}]`)),!s(this,G)||s(this,G)==="#"){s(this,z)??m(this,z,ie.getFetchInfo("missing-fragment-id")),y(this,Y,Pr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,z)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(s(this,K)&&!await Promise.race([s(this,K),Promise.resolve(!1)]))return;e&&ie.remove(this.cacheKey()),s(this,Et)===Ei&&await Promise.race([ie.getAsPromise(this.cacheKey()),new Promise(c=>setTimeout(c,s(this,kt)))]);try{m(this,K,y(this,Y,Si).call(this)),await s(this,K)}catch(c){return y(this,Y,Pr).call(this,c.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=s(this,H)||{};return o&&!Yt("mas.disableWcsCache")&&s(this,$).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Re,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...s(this,z)},bubbles:!0,composed:!0})),s(this,K)}get updateComplete(){return s(this,K)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,ne)?s(this,ne):(s(this,Ct)?this.transformAuthorData():this.transformPublishData(),s(this,ne))}get rawData(){return s(this,H)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,promoProject:c,promoVariationProject:l,settings:d={},priceLiterals:p={},dictionary:g={},placeholders:f={}}=s(this,H),C=mi(e);m(this,ne,C.reduce((O,{name:D,multiple:Le,values:ge})=>(O.fields[D]=Le?ge:ge[0],O),{fields:{},id:t,tags:n,settings:d,priceLiterals:p,dictionary:g,maskId:i,placeholders:f,variationId:o,promoProject:c,promoVariationProject:l}))}transformPublishData(){if(!s(this,H))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},maskId:l,placeholders:d={},variationId:p,promoProject:g,promoVariationProject:f}=s(this,H);m(this,ne,Object.entries(e).reduce((C,[O,D])=>(C.fields[O]=D?.mimeType?D.value:D??"",C),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:c,maskId:l,placeholders:d,variationId:p,promoProject:g,promoVariationProject:f}))}getFragmentClientUrl(){let t=new URLSearchParams(window.location.search).get("maslibs");if(!t||t.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=t.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:s(this,$).settings.locale,apiKey:s(this,$).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,$).settings.instant,o={...i,...n!=null?{instant:n}:{},...s(this,V)!=null?{mask:s(this,V)}:{},...s(this,W)!=null?{pzn:s(this,W)}:{}};return await t(s(this,G),o)}};Xe=new WeakMap,H=new WeakMap,ne=new WeakMap,$=new WeakMap,G=new WeakMap,z=new WeakMap,Et=new WeakMap,V=new WeakMap,W=new WeakMap,kt=new WeakMap,K=new WeakMap,Ct=new WeakMap,St=new WeakMap,Je=new WeakMap,Y=new WeakSet,ki=async function(e){$r(this,St)._++;let t=`${Lr}:${this.cacheKey()}:${s(this,St)}`,i=`${t}${Dt}`,n=`${t}${Nt}`;if(s(this,Je)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new he(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,z).stale=!1,s(this,z).url=e,o=await hi(e,{cache:"default",credentials:"omit"}),y(this,Y,Ci).call(this,o),s(this,z).status=o?.status,s(this,z).measure=De(performance.measure(n,i)),s(this,z).retryCount=o.retryCount,!o?.ok)throw new he("Unexpected fragment response",{response:o,...s(this,$).duration});return await o.json()}catch(c){if(s(this,z).measure=De(performance.measure(n,i)),s(this,z).retryCount=c.retryCount,s(this,H))return s(this,z).stale=!0,s(this,Xe).error("Serving stale data",s(this,z)),s(this,H);let l=c.message??"unknown";throw new he(`Failed to fetch fragment: ${l}`,{})}},Ci=function(e){Object.assign(s(this,z),di(e))},Pr=function(e){m(this,K,null),s(this,z).message=e,this.classList.add("error");let t={...s(this,z),...s(this,$).duration};s(this,Xe).error(e,t),this.dispatchEvent(new CustomEvent(Oe,{detail:t,bubbles:!0,composed:!0}))},Si=async function(){var l;this.classList.remove("error"),m(this,ne,null);let e=ie.get(this.cacheKey());if(e)return m(this,H,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=s(this,$).settings,c=`${t}/fragment?id=${s(this,G)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),s(this,V)&&(c+=`&mask=${s(this,V)}`),s(this,W)&&(c+=`&pzn=${s(this,W)}`),e=await y(this,Y,ki).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,G)),s(this,V)||s(this,W)?ie.set(this.cacheKey(),e):ie.add(e),m(this,H,e),!0},h(Jt,"cache",ie);customElements.define(Lr,Jt);import{LitElement as Yn,html as _r,css as Qn,nothing as Zn}from"./lit-all.min.js";import{unsafeHTML as Xn}from"./lit-all.min.js";var Jn=a=>a?a.startsWith("sp-icon-")?_r`${Xn(`<${a} class="badge-icon"></${a}>`)}`:_r`<img src="${a}" class="badge-icon" />`:Zn,et=class extends Yn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return _r`<div class="badge">
    ...
    `);customElements.define("merch-badge",et);import{html as eo,css as to,LitElement as ro}from"./lit-all.min.js";var At=class extends ro{constructor(){super()}render(){return eo`
            <slot name="icon"></slot>
    ...
    `),h(At,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",At);import{html as Mr,css as ao,LitElement as io,nothing as Ai}from"./lit-all.min.js";var Tt=class extends io{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Mr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Mr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:Ai}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(Tt,"styles",ao`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

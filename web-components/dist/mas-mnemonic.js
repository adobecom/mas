        ...
        ></merch-icon>`:r`<slot></slot>`}render(){let t=this.effectiveContent,i=this.effectivePlacement;return t?h()?r`
            ...
            `:r`
                <span
                    ...
                    @click=${o=>o.pointerType==="touch"&&this.handleTap(o)}
                >
                    ${this.renderIcon()}
                </span>

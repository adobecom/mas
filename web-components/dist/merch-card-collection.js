...
`;var _i={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Rt=class extends E{getGlobalCSS(){return Lo}get aemFragmentMapping(){return _i}renderLayout(){return Xl`
    ...
    `);import{html as Li,nothing as Ql}from"./lit-all.min.js";var Po={cardName:{attribute:"name"},image:{tag:"picture",slot:"image"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},Zl=[{slot:"image",label:"Image"},{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Nt=class extends E{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return Li`
            <div class="headless">
        ...
        `}};g(Ot,"variantStyle",Ve("faq"));import{html as No}from"./lit-all.min.js";var Oo={cardName:{attribute:"name"},image:{tag:"picture",slot:"image"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},ed=[{slot:"image",label:"Image"},{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],It=class extends E{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return No`
            <div class="headless">

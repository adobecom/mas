var gr=Object.defineProperty;var ur=a=>{throw TypeError(a)};var ai=(a,t,e)=>t in a?gr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var ii=(a,t)=>()=>(a&&(t=a(a=0)),t);var ni=(a,t)=>{for(var e in t)gr(a,e,{get:t[e],enumerable:!0})};var h=(a,t,e)=>ai(a,typeof t!="symbol"?t+"":t,e),$t=(a,t,e)=>t.has(a)||ur("Cannot "+e);var s=(a,t,e)=>($t(a,t,"read from private field"),e?e.call(a):t.get(a)),f=(a,t,e)=>t.has(a)?ur("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>($t(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),_=(a,t,e)=>($t(a,t,"access private method"),e);var fr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return s(a,t,r)}});var Bt={};ni(Bt,{default:()=>Ye});import{LitElement as oi,html as be,css as ci,nothing as si}from"./lit-all.min.js";import{unsafeHTML as Er}from"./lit-all.min.js";import{ifDefined as li}from"./lit-all.min.js";function di(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var P,Ye,Ht=ii(()=>{P=class P extends oi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();P.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>i?u="top":u==="left"&&e.left-d-n<0?u="right":u==="right"&&e.right+d+n>r&&(u="left");let C=e.left+e.width/2,$=e.top+e.height/2,Z=6,pt=(ei,ti,ri)=>Math.max(ei,Math.min(ti,ri)),mt,gt,It;u==="top"||u==="bottom"?(mt=u==="top"?e.top-p-n:e.bottom+n,gt=pt(0,r-d,C-d/2),It=pt(Z,d-Z*2,C-gt-Z)):(gt=u==="left"?e.left-d-n:e.right+n,mt=pt(0,i-p,$-p/2),It=pt(Z,p-Z*2,$-mt-Z)),this._tooltipTop=mt,this._tooltipLeft=gt,this._arrowOffset=It,this._computedPlacement=u}showTooltip(){P.activeTooltip&&P.activeTooltip!==this&&(P.activeTooltip.closeOverlay(),P.activeTooltip.tooltipVisible=!1,P.activeTooltip.requestUpdate()),P.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){P.activeTooltip===this&&(P.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?be`<merch-icon
    ...
    `);Ye=P;customElements.define("mas-mnemonic",Ye)});import{LitElement as ro}from"./lit-all.min.js";import{css as br,unsafeCSS as xr}from"./lit-all.min.js";var w="(max-width: 767px)",T="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",L="(min-width: 1600px)",vr={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${L})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=vr;function ut(){return vr.isDesktop}var yr=br`
    :host {
...
`;var Ai=32,Yr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Pe=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>St` <footer>
    ...
    `);import{html as tt,css as Ti,nothing as Ct}from"./lit-all.min.js";var Kr=`
:root {
...
`;var ra={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},V,Me=class extends b{constructor(e){super(e);f(this,V);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return ta}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return jt` ${this.badge}
    ...
    `);import{html as Vt,css as _i}from"./lit-all.min.js";var aa=`
:root {
...
`;var ia={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Re=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return aa}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Vt`
    ...
    `);import{html as Pi,css as Mi}from"./lit-all.min.js";var na=`
...
`;var oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Oe=class extends b{constructor(t){super(t)}getGlobalCSS(){return na}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Pi`
    ...
    `);import{html as Wt,css as Ri}from"./lit-all.min.js";var ca=`
:root {
...
`;var sa={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},De=class extends b{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ca}renderLayout(){return Wt`${this.cardImage}
    ...
    `);import{html as da,css as Oi,nothing as Di}from"./lit-all.min.js";var la=`
:root {
...
`;var Yt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ne=class extends b{getGlobalCSS(){return la}get aemFragmentMapping(){return Yt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')?da`<div class="badge-wrapper">
    ...
    `);import{html as pa,css as Ni,nothing as Fi}from"./lit-all.min.js";var ha=`
:root {
...
`;var fa={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},$e=class extends b{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return ua}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return qi`
            ${this.badge}
            <div class="body">
...
`;var Xt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Be=class extends b{getGlobalCSS(){return va}get aemFragmentMapping(){return Xt}renderLayout(){return Ui`
    ...
    `);var Lt=new Map,xa=new WeakMap,ba=new Map,k=(a,t,e=null,r=null,i)=>{Lt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",ze,Ir,ze.variantStyle);k("image",he);k("inline-heading",kt);k("mini-compare-chart",_e,jr,_e.variantStyle);k("mini-compare-chart-mweb",Pe,Yr,Pe.variantStyle);k("plans",R,At,R.variantStyle,R.collectionOptions);k("plans-students",R,Xr,R.variantStyle,R.collectionOptions);k("plans-education",R,Qr,R.variantStyle,R.collectionOptions);k("plans-v2",ae,ea,ae.variantStyle,ae.collectionOptions);k("product",Me,ra,Me.variantStyle);k("segment",Re,ia,Re.variantStyle);k("media",Oe,oa,Oe.variantStyle);k("headless",Ie,ga,Ie.variantStyle);k("special-offers",De,sa,De.variantStyle);k("simplified-pricing-express",Ne,Yt,Ne.variantStyle);k("full-pricing-express",Fe,Kt,Fe.variantStyle);k("mini",$e,fa,$e.variantStyle);k("image",he,Br,he.variantStyle);k("fries",Be,Xt,Be.variantStyle);var ji=(a,t,e)=>{try{let r=ba.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ba.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Zt=a=>{let t=Lt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=xa.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?ji(a,r,i):{};return xa.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Et(a){return Lt.get(a)?.fragmentMapping}function ya(a){return Lt.get(a)?.collectionOptions}var wa=document.createElement("style");wa.innerHTML=`
:root {
...
`;document.head.appendChild(wa);function zt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=Jt(r)?r:a;n=o.get(c)}if(i&&n==null){let o=Jt(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Wi(Jt(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var Vi=a=>typeof a=="boolean",_t=a=>typeof a=="function";var Jt=a=>typeof a=="string";function Ea(a,t){if(Vi(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Wi(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var ie=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(vt);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var pe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ka=1e3;function Yi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Sa(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!pe.serializableTypes.includes(e))return e}return a}function Ki(a,t){if(!pe.ignoredProperties.includes(a))return Sa(t)}var er={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(Yi(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(Sa).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${pe.delimiter}page=${o}${c}`;l.length>ka&&(l=`${l.slice(0,ka)}<trunc>`),n+=l,i.length&&(n+=`${pe.delimiter}facts=`,n+=JSON.stringify(i,Ki)),window.lana?.log(n,pe)}};function Ca(a){Object.assign(pe,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in pe&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Aa={LOCAL:"local",PROD:"prod",STAGE:"stage"},tr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},rr=new Set,ar=new Set,Ta=new Map,La={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},za={filter:({level:a})=>a!==tr.DEBUG},Qi={filter:()=>!1};function Xi(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&_t(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Zi(a){[...ar].every(t=>t(a))&&rr.forEach(t=>t(a))}function _a(a){let t=(Ta.get(a)??0)+1;Ta.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>_a(`${r.namespace}/${i}`),updateConfig:Ca};return Object.values(tr).forEach(i=>{r[i]=(n,...o)=>Zi(Xi(i,n,a,o,e))}),Object.seal(r)}function Pt(...a){a.forEach(t=>{let{append:e,filter:r}=t;_t(r)&&ar.add(r),_t(e)&&rr.add(e)})}function Ji(a={}){let{name:t}=a,e=Ea(zt("commerce.debug",{search:!0,storage:!0}),t===Aa.LOCAL);return Pt(e?La:za),t===Aa.PROD&&Pt(er),rt}function en(){rr.clear(),ar.clear()}var rt={..._a(Rr),Level:tr,Plugins:{consoleAppender:La,debugFilter:za,quietFilter:Qi,lanaAppender:er},init:Ji,reset:en,use:Pt};var tn="mas-commerce-service",_l=rt.module("utilities"),rn={requestId:vt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Mt=a=>window.setTimeout(a);function ir(){return document.getElementsByTagName(tn)?.[0]}function Pa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(rn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ma(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var an="explicit_empty";function nr(a){return a===an}function nn(a){return Array.isArray(a)&&a.length===1&&nr(a[0])}function Ra(a,t=[]){if(nn(t))return a?[]:"";if(a)return t.map(r=>nr(r)?"":r);let e=t[0];return nr(e)?"":e}var Oa="fragment",Da="author",Na="preview",Fa="loading",Ia="timeout",or="aem-fragment",$a="eager",Ba="cache",on=[$a,Ba],W,me,B,cr=class{constructor(){f(this,W,new Map);f(this,me,new Map);f(this,B,new Map)}clear(){s(this,W).clear(),s(this,me).clear(),s(this,B).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,W).set(t.id,t),t.fields?.originalId&&s(this,W).set(t.fields.originalId,t),s(this,B).has(t.id)){let[,r]=s(this,B).get(t.id);r()}if(s(this,B).has(t.fields?.originalId)){let[,r]=s(this,B).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,W).has(t)}entries(){return s(this,W).entries()}get(t){return s(this,W).get(t)}getAsPromise(t){let[e]=s(this,B).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,B).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,me).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,me).set(t,e)),e}remove(t){s(this,W).delete(t),s(this,me).delete(t),s(this,B).delete(t)}};W=new WeakMap,me=new WeakMap,B=new WeakMap;var ne=new cr,He,H,X,D,O,A,at,it,q,nt,ot,qe,U,Ha,qa,sr,Ua,Rt=class extends HTMLElement{constructor(){super(...arguments);f(this,U);h(this,"cache",ne);f(this,He);f(this,H,null);f(this,X,null);f(this,D,null);f(this,O);f(this,A);f(this,at,$a);f(this,it,5e3);f(this,q);f(this,nt,!1);f(this,ot,0);f(this,qe)}static get observedAttributes(){return[Oa,Fa,Ia,Da,Na]}attributeChangedCallback(e,r,i){e===Oa&&(m(this,O,i),m(this,A,ne.getFetchInfo(i))),e===Fa&&on.includes(i)&&m(this,at,i),e===Ia&&m(this,it,parseInt(i,10)),e===Da&&m(this,nt,["","true"].includes(i)),e===Na&&m(this,qe,i)}connectedCallback(){if(!s(this,q)){if(s(this,D)??m(this,D,le(this)),m(this,qe,s(this,D).settings?.preview),s(this,He)??m(this,He,s(this,D).log.module(`${or}[${s(this,O)}]`)),!s(this,O)||s(this,O)==="#"){s(this,A)??m(this,A,ne.getFetchInfo("missing-fragment-id")),_(this,U,sr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,A)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&ne.remove(s(this,O)),s(this,at)===Ba&&await Promise.race([ne.getAsPromise(s(this,O)),new Promise(c=>setTimeout(c,s(this,it)))]);try{m(this,q,_(this,U,Ua).call(this)),await s(this,q)}catch(c){return _(this,U,sr).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,H)||{};return o&&!zt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ke,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,A)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,X)?s(this,X):(s(this,nt)?this.transformAuthorData():this.transformPublishData(),s(this,X))}get rawData(){return s(this,H)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:d={}}=s(this,H);m(this,X,e.reduce((p,{name:g,multiple:u,values:C})=>(p.fields[g]=Ra(u,C),p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:d,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:d}=s(this,H);m(this,X,Object.entries(e).reduce((p,[g,u])=>(p.fields[g]=u?.mimeType?u.value:u??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,D).settings.instant;return n&&(i.instant=n),await r(s(this,O),i)}};He=new WeakMap,H=new WeakMap,X=new WeakMap,D=new WeakMap,O=new WeakMap,A=new WeakMap,at=new WeakMap,it=new WeakMap,q=new WeakMap,nt=new WeakMap,ot=new WeakMap,qe=new WeakMap,U=new WeakSet,Ha=async function(e){fr(this,ot)._++;let r=`${or}:${s(this,O)}:${s(this,ot)}`,i=`${r}${xt}`,n=`${r}${bt}`;if(s(this,qe)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new ie(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,A).stale=!1,s(this,A).url=e,o=await Ma(e,{cache:"default",credentials:"omit"}),_(this,U,qa).call(this,o),s(this,A).status=o?.status,s(this,A).measure=Ce(performance.measure(n,i)),s(this,A).retryCount=o.retryCount,!o?.ok)throw new ie("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,A).measure=Ce(performance.measure(n,i)),s(this,A).retryCount=c.retryCount,s(this,H))return s(this,A).stale=!0,s(this,He).error("Serving stale data",s(this,A)),s(this,H);let l=c.message??"unknown";throw new ie(`Failed to fetch fragment: ${l}`,{})}},qa=function(e){Object.assign(s(this,A),Pa(e))},sr=function(e){m(this,q,null),s(this,A).message=e,this.classList.add("error");let r={...s(this,A),...s(this,D).duration};s(this,He).error(e,r),this.dispatchEvent(new CustomEvent(Se,{detail:r,bubbles:!0,composed:!0}))},Ua=async function(){var l;this.classList.remove("error"),m(this,X,null);let e=ne.get(s(this,O));if(e)return m(this,H,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,O)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await _(this,U,Ha).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,O)),ne.add(e),m(this,H,e),!0},h(Rt,"cache",ne);customElements.define(or,Rt);import{LitElement as cn,html as lr,css as sn,nothing as ln}from"./lit-all.min.js";import{unsafeHTML as dn}from"./lit-all.min.js";var hn=a=>a?a.startsWith("sp-icon-")?lr`${dn(`<${a} class="badge-icon"></${a}>`)}`:lr`<img src="${a}" class="badge-icon" />`:ln,Ue=class extends cn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return lr`<div class="badge">
            ${hn(this.icon)}<slot>${this.text}</slot>
        </div>`}};h(Ue,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),h(Ue,"styles",sn`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Ue);import{html as pn,css as mn,LitElement as gn}from"./lit-all.min.js";var ct=class extends gn{constructor(){super()}render(){return pn`
            <slot name="icon"></slot>
    ...
    `),h(ct,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ct);import{html as dr,css as un,LitElement as fn,nothing as Ga}from"./lit-all.min.js";var st=class extends fn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return dr`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?dr`<slot name="content"></slot>`:Ga}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?dr`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Ga}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(st,"styles",un`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

var or=Object.defineProperty;var cr=a=>{throw TypeError(a)};var Ua=(a,t,e)=>t in a?or(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var Ga=(a,t)=>()=>(a&&(t=a(a=0)),t);var ja=(a,t)=>{for(var e in t)or(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>Ua(a,typeof t!="symbol"?t+"":t,e),_t=(a,t,e)=>t.has(a)||cr("Cannot "+e);var s=(a,t,e)=>(_t(a,t,"read from private field"),e?e.call(a):t.get(a)),g=(a,t,e)=>t.has(a)?cr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(_t(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),S=(a,t,e)=>(_t(a,t,"access private method"),e);var sr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return s(a,t,r)}});var Mt={};ja(Mt,{default:()=>Be});import{LitElement as Va,html as ct,css as Wa}from"./lit-all.min.js";function Ya(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var P,Be,Rt=Ga(()=>{P=class P extends Va{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();P.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}showTooltip(){P.activeTooltip&&P.activeTooltip!==this&&(P.activeTooltip.closeOverlay(),P.activeTooltip.tooltipVisible=!1,P.activeTooltip.requestUpdate()),P.activeTooltip=this,this.tooltipVisible=!0}hideTooltip(){P.activeTooltip===this&&(P.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?ct`<merch-icon
    ...
    `);Be=P;customElements.define("mas-mnemonic",Be)});import{LitElement as Dn}from"./lit-all.min.js";import{css as hr,unsafeCSS as dr}from"./lit-all.min.js";var y="(max-width: 767px)",A="(max-width: 1199px)",w="(min-width: 768px)",u="(min-width: 1200px)",z="(min-width: 1600px)",lr={matchMobile:window.matchMedia(y),matchDesktop:window.matchMedia(`${u} and (not ${z})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(z),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},f=lr;function ot(){return lr.isDesktop}var pr=hr`
    :host {
...
`,mr=()=>[hr`
            ...
            /* Laptop */
            @media screen and ${dr(u)} {
                :host([size='wide']) {
                    grid-column: span 2;
                }
            }
        `];import{LitElement as Ka,html as gr,css as Qa}from"./lit-all.min.js";function Za(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var me=class extends Ka{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Za())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Rt())}e.remove()})}render(){let{href:t}=this;return t?gr`<a href="${t}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(me,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(me,"styles",Qa`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",me);var Kn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Qn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var b='span[is="inline-price"][data-wcs-osi]',W='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Xa='a[is="upt-link"]',ur=`${b},${W},${Xa}`;var fr="merch-offer-select:ready",vr="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",xr="merch-card-quantity:change",Ot="merch-modal:addon-and-quantity-update";var ge="merch-card-collection:literals-changed";var ue="aem:load",fe="aem:error",st="mas:ready",br="mas:error",yr="placeholder-failed",wr="placeholder-pending",Er="placeholder-resolved";var kr="mas:failed",He="mas:resolved",Cr="mas/commerce";var Y="failed",re="pending",K="resolved";var lt="X-Request-Id",Zn=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Xn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var dt=":start",ht=":duration";var N="legal",Sr="mas-ff-defaults";var Ja="mas-commerce-service";function Ar(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function T(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function ve(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function Nt(){return window.matchMedia("(max-width: 1024px)").matches}function ae(){return document.getElementsByTagName(Ja)?.[0]}function qe(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Ue,ie,Ge,je,xe,pt=class extends HTMLElement{constructor(){super();g(this,Ue,"");g(this,ie);g(this,Ge,[]);g(this,je,[]);g(this,xe);m(this,xe,Ar(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,ie)?this.parentElement.style.borderRadius=s(this,ie):s(this,ie)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Ge).map((r,i)=>{let n=s(this,je)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,Ue)}, ${e})`}connectedCallback(){s(this,xe).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,ie,i?.trim()),e==="colors"&&i?m(this,Ge,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,je,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Ue,i?.trim()??""),s(this,xe).call(this)}};Ue=new WeakMap,ie=new WeakMap,Ge=new WeakMap,je=new WeakMap,xe=new WeakMap;customElements.define("merch-gradient",pt);import{LitElement as ei,html as ti,css as ri}from"./lit-all.min.js";var be=class extends ei{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${b}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(He,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(He,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return ti` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(be,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),d(be,"styles",ri`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",be);import{html as mt,nothing as ai}from"./lit-all.min.js";var ye,Ve=class Ve{constructor(t){d(this,"card");g(this,ye);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,ye,s(this,ye)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,ye)}insertVariantStyle(){let t=this.constructor.name;if(!Ve.styleMap[t]){Ve.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=parseInt(window.getComputedStyle(t).height,10);(!Number.isFinite(i)||i<=0)&&(i=Math.round(t.getBoundingClientRect().height)),i=Math.max(0,i);let n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),mt`
        ...
        `}get cardImage(){return mt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:ai}get secureLabelFooter(){return mt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return gt(this.card.variant)}};ye=new WeakMap,d(Ve,"styleMap",{});var v=Ve;import{html as Dt,css as ii}from"./lit-all.min.js";var Tr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return Tr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};d(we,"variantStyle",ii`
    ...
    `);import{html as We,css as ni}from"./lit-all.min.js";var zr=`
:root {
...
`;var Pr={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},ne=class extends v{constructor(t){super(t)}getGlobalCSS(){return zr}renderLayout(){return We`<div class="image">
                <slot name="bg-image"></slot>
    ...
    `);import{html as Mr}from"./lit-all.min.js";var _r=`
:root {
...
`;var ut=class extends v{constructor(t){super(t)}getGlobalCSS(){return _r}renderLayout(){return Mr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Mr`<hr />`} ${this.secureLabelFooter}`}};import{html as Q,css as oi,unsafeCSS as Or}from"./lit-all.min.js";var Rr=`
  :root {
...
`;var ci=32,Nr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Ee=class extends v{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?Q`<slot name="secure-transaction-label">
    ...
    `);import{html as ft,css as si,unsafeCSS as Fr,nothing as li}from"./lit-all.min.js";var Dr=`
  :root {
...
`;var di=32,Ir={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},ke=class extends v{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>ft` <footer>
    ...
    `);import{html as Ye,css as hi,nothing as vt}from"./lit-all.min.js";var $r=`
:root {
...
`;var xt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Br={...function(){let{whatsIncluded:a,size:t,...e}=xt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Hr={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=xt;return i}()},_=class extends v{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return $r}adjustSlotPlacement(t,e,r){let i=this.card.shadowRoot,n=i.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let c=i.querySelector(`footer slot[name="${t}"]`),l=i.querySelector(`.body slot[name="${t}"]`),p=i.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),c&&c.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",f.isDesktopOrUp),!r&&c){if(l)c.remove();else{let h=p.querySelector(`[data-placeholder-for="${t}"]`);h?h.replaceWith(c):p.appendChild(c)}return}if(r&&l){let h=document.createElement("div");if(h.setAttribute("data-placeholder-for",t),h.classList.add("slot-placeholder"),!c){let x=l.cloneNode(!0);n.prepend(x)}l.replaceWith(h)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],f.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],f.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let i=r.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),e.insertBefore(n,i);let o=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,p=this.card.querySelector('[slot="heading-s"]');p&&(l+=qe(p));let h=this.card.querySelector('[slot="subtitle"]');h&&(l+=qe(h));let x=this.card.querySelector('[slot="heading-m"]');x&&(l+=8+qe(x));for(let R of e.childNodes){if(R.classList.contains("spacer"))break;l+=qe(R)}let L=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(L)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${b}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ye`<div class="divider"></div>`:vt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${b}[data-template="price"]`);e&&t.push(e);let r=t.map(async i=>{let n=i.cloneNode(!0);await i.onceSettled(),i?.options&&(i.options.displayPerUnit&&(i.dataset.displayPerUnit="false"),i.options.displayTax&&(i.dataset.displayTax="false"),i.options.displayPlanType&&(i.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),i.parentNode.insertBefore(n,i.nextSibling),await n.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Ye`<label id="stock-checkbox">
    ...
    `),d(_,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ye`<slot name="resultsText"></slot>`:vt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let e=()=>{let r=t.querySelectorAll("merch-card");for(let n of r)n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"));if(!f.isDesktop)return;let i=0;for(let n of r){if(n.style.display==="none")continue;let o=n.getAttribute("size"),c=o==="wide"?2:o==="super-wide"?3:1;c===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),c=1),i+=c}};f.matchDesktop.addEventListener("change",e),t.addEventListener(ge,e),t.onUnmount.push(()=>{f.matchDesktop.removeEventListener("change",e),t.removeEventListener(ge,e)})}});import{html as j,css as pi,unsafeCSS as Ur,nothing as bt}from"./lit-all.min.js";var qr=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(f.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?f.isMobile?j`
        ...
        `:j`
            ...
            `:bt}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?j`<slot name="icons"></slot>`:bt}get secureLabelFooter(){return j`<footer>
...
`;var Vr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ce=class extends v{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return jr}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ft` ${this.badge}
    ...
    `);import{html as It,css as gi}from"./lit-all.min.js";var Wr=`
:root {
...
`;var Yr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Se=class extends v{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Wr}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${b}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return It`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as ui,css as fi}from"./lit-all.min.js";var Kr=`
...
`;var Qr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ae=class extends v{constructor(t){super(t)}getGlobalCSS(){return Kr}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return ui`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Xr={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Te=class extends v{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Zr}renderLayout(){return $t`${this.cardImage}
            ...
            ${this.evergreen?$t`
                  ...
                  `:$t`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(Te,"variantStyle",vi`
    ...
    `);import{html as xi,css as bi}from"./lit-all.min.js";var Jr=`
:root {
...
`;var Bt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Le=class extends v{getGlobalCSS(){return Jr}get aemFragmentMapping(){return Bt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;if(!t)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(t.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(i=>i.onceSettled?.()));let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",c)})}),f.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!ot()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let t=this.getContainer();t&&t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t<=2||t===this.lastSyncedWidth||(this.lastSyncedWidth=t,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(ot())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};e();let r=window.matchMedia(y);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(y).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||ot())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return xi`
    ...
    `);import{html as ta,css as yi}from"./lit-all.min.js";var ea=`
:root {
...
`;var Ht={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},ze=class extends v{getGlobalCSS(){return ea}get aemFragmentMapping(){return Ht}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return ta`
    ...
    `);import{html as qt,css as wi,nothing as Ei}from"./lit-all.min.js";var ra=`
...
`;var aa={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},ki=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Pe=class extends v{constructor(t){super(t)}getGlobalCSS(){return ra}renderLayout(){return qt`
    ...
    `);import{css as Ci,html as Si}from"./lit-all.min.js";var ia=`
...
`;var na={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},_e=class extends v{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return ia}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${b}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Si`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Ai,css as Ti}from"./lit-all.min.js";var oa=`
...
`;var Ut={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Li=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],yt,ca,Me=class extends v{constructor(e){super(e);g(this,yt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return oa}get aemFragmentMapping(){return Ut}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,S(this,yt,ca).call(this))}renderLayout(){return Ai`
            <div class="card">
            ...
            <slot></slot>
        `}};yt=new WeakSet,ca=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Li.forEach(({key:r,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),r))},d(Me,"variantStyle",Ti`
    ...
    `);var wt=new Map,sa=new WeakMap,la=new Map,E=(a,t,e=null,r=null,i)=>{wt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};E("catalog",we,Lr,we.variantStyle);E("image",ne);E("inline-heading",ut);E("mini-compare-chart",Ee,Nr,Ee.variantStyle);E("mini-compare-chart-mweb",ke,Ir,ke.variantStyle);E("plans",_,xt,_.variantStyle,_.collectionOptions);E("plans-students",_,Hr,_.variantStyle,_.collectionOptions);E("plans-education",_,Br,_.variantStyle,_.collectionOptions);E("plans-v2",Z,Gr,Z.variantStyle,Z.collectionOptions);E("product",Ce,Vr,Ce.variantStyle);E("segment",Se,Yr,Se.variantStyle);E("media",Ae,Qr,Ae.variantStyle);E("headless",Pe,aa,Pe.variantStyle);E("special-offers",Te,Xr,Te.variantStyle);E("simplified-pricing-express",Le,Bt,Le.variantStyle);E("full-pricing-express",ze,Ht,ze.variantStyle);E("mini",_e,na,_e.variantStyle);E("image",ne,Pr,ne.variantStyle);E("compare-chart",Me,Ut,Me.variantStyle);var zi=(a,t,e)=>{try{let r=la.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),la.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Gt=a=>{let t=wt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=sa.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?zi(a,r,i):{};return sa.set(a,{appliedVariant:a.variant,...n}),new e(a)};function gt(a){return wt.get(a)?.fragmentMapping}function da(a){return wt.get(a)?.collectionOptions}var ha=document.createElement("style");ha.innerHTML=`
:root {
...
`;document.head.appendChild(ha);function Et(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=jt(r)?r:a;n=o.get(c)}if(i&&n==null){let o=jt(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=_i(jt(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var Pi=a=>typeof a=="boolean",kt=a=>typeof a=="function";var jt=a=>typeof a=="string";function pa(a,t){if(Pi(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function _i(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var X=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(lt);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var oe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ma=1e3;function Mi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ga(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!oe.serializableTypes.includes(e))return e}return a}function Ri(a,t){if(!oe.ignoredProperties.includes(a))return ga(t)}var Vt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(p=>{p!=null&&(Mi(p)?r:i).push(p)}),r.length&&(n+=" "+r.map(ga).join(" "));let{pathname:o,search:c}=window.location,l=`${oe.delimiter}page=${o}${c}`;l.length>ma&&(l=`${l.slice(0,ma)}<trunc>`),n+=l,i.length&&(n+=`${oe.delimiter}facts=`,n+=JSON.stringify(i,Ri)),window.lana?.log(n,oe)}};function ua(a){Object.assign(oe,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in oe&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var fa={LOCAL:"local",PROD:"prod",STAGE:"stage"},Wt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Yt=new Set,Kt=new Set,va=new Map,xa={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},ba={filter:({level:a})=>a!==Wt.DEBUG},Oi={filter:()=>!1};function Ni(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&kt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Di(a){[...Kt].every(t=>t(a))&&Yt.forEach(t=>t(a))}function ya(a){let t=(va.get(a)??0)+1;va.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>ya(`${r.namespace}/${i}`),updateConfig:ua};return Object.values(Wt).forEach(i=>{r[i]=(n,...o)=>Di(Ni(i,n,a,o,e))}),Object.seal(r)}function Ct(...a){a.forEach(t=>{let{append:e,filter:r}=t;kt(r)&&Kt.add(r),kt(e)&&Yt.add(e)})}function Fi(a={}){let{name:t}=a,e=pa(Et("commerce.debug",{search:!0,storage:!0}),t===fa.LOCAL);return Ct(e?xa:ba),t===fa.PROD&&Ct(Vt),Ke}function Ii(){Yt.clear(),Kt.clear()}var Ke={...ya(Cr),Level:Wt,Plugins:{consoleAppender:xa,debugFilter:ba,quietFilter:Oi,lanaAppender:Vt},init:Fi,reset:Ii,use:Ct};var $i="mas-commerce-service",cl=Ke.module("utilities"),Bi={requestId:lt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var St=a=>window.setTimeout(a);function Qt(){return document.getElementsByTagName($i)?.[0]}function wa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Bi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ea(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var ka="fragment",Ca="author",Sa="preview",Aa="loading",Ta="timeout",Zt="aem-fragment",La="eager",za="cache",Hi=[La,za],U,ce,$,Xt=class{constructor(){g(this,U,new Map);g(this,ce,new Map);g(this,$,new Map)}clear(){s(this,U).clear(),s(this,ce).clear(),s(this,$).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,U).set(t.id,t),t.fields?.originalId&&s(this,U).set(t.fields.originalId,t),s(this,$).has(t.id)){let[,r]=s(this,$).get(t.id);r()}if(s(this,$).has(t.fields?.originalId)){let[,r]=s(this,$).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,U).has(t)}entries(){return s(this,U).entries()}get(t){return s(this,U).get(t)}getAsPromise(t){let[e]=s(this,$).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,$).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,ce).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,ce).set(t,e)),e}remove(t){s(this,U).delete(t),s(this,ce).delete(t),s(this,$).delete(t)}};U=new WeakMap,ce=new WeakMap,$=new WeakMap;var J=new Xt,Re,B,V,D,M,C,Qe,Ze,H,Xe,Je,Oe,q,Pa,_a,Jt,Ma,At=class extends HTMLElement{constructor(){super(...arguments);g(this,q);d(this,"cache",J);g(this,Re);g(this,B,null);g(this,V,null);g(this,D,null);g(this,M);g(this,C);g(this,Qe,La);g(this,Ze,5e3);g(this,H);g(this,Xe,!1);g(this,Je,0);g(this,Oe)}static get observedAttributes(){return[ka,Aa,Ta,Ca,Sa]}attributeChangedCallback(e,r,i){e===ka&&(m(this,M,i),m(this,C,J.getFetchInfo(i))),e===Aa&&Hi.includes(i)&&m(this,Qe,i),e===Ta&&m(this,Ze,parseInt(i,10)),e===Ca&&m(this,Xe,["","true"].includes(i)),e===Sa&&m(this,Oe,i)}connectedCallback(){if(!s(this,H)){if(s(this,D)??m(this,D,ae(this)),m(this,Oe,s(this,D).settings?.preview),s(this,Re)??m(this,Re,s(this,D).log.module(`${Zt}[${s(this,M)}]`)),!s(this,M)||s(this,M)==="#"){s(this,C)??m(this,C,J.getFetchInfo("missing-fragment-id")),S(this,q,Jt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,C)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,H)&&!await Promise.race([s(this,H),Promise.resolve(!1)]))return;e&&J.remove(s(this,M)),s(this,Qe)===za&&await Promise.race([J.getAsPromise(s(this,M)),new Promise(c=>setTimeout(c,s(this,Ze)))]);try{m(this,H,S(this,q,Ma).call(this)),await s(this,H)}catch(c){return S(this,q,Jt).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,B)||{};return o&&!Et("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ue,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,C)},bubbles:!0,composed:!0})),s(this,H)}get updateComplete(){return s(this,H)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,V)?s(this,V):(s(this,Xe)?this.transformAuthorData():this.transformPublishData(),s(this,V))}get rawData(){return s(this,B)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:p={}}=s(this,B);m(this,V,e.reduce((h,{name:x,multiple:L,values:R})=>(h.fields[x]=L?R:R[0],h),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:p,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:p}=s(this,B);m(this,V,Object.entries(e).reduce((h,[x,L])=>(h.fields[x]=L?.mimeType?L.value:L??"",h),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:p}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,M),{locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0})}};Re=new WeakMap,B=new WeakMap,V=new WeakMap,D=new WeakMap,M=new WeakMap,C=new WeakMap,Qe=new WeakMap,Ze=new WeakMap,H=new WeakMap,Xe=new WeakMap,Je=new WeakMap,Oe=new WeakMap,q=new WeakSet,Pa=async function(e){sr(this,Je)._++;let r=`${Zt}:${s(this,M)}:${s(this,Je)}`,i=`${r}${dt}`,n=`${r}${ht}`;if(s(this,Oe)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new X(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,C).stale=!1,s(this,C).url=e,o=await Ea(e,{cache:"default",credentials:"omit"}),S(this,q,_a).call(this,o),s(this,C).status=o?.status,s(this,C).measure=ve(performance.measure(n,i)),s(this,C).retryCount=o.retryCount,!o?.ok)throw new X("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,C).measure=ve(performance.measure(n,i)),s(this,C).retryCount=c.retryCount,s(this,B))return s(this,C).stale=!0,s(this,Re).error("Serving stale data",s(this,C)),s(this,B);let l=c.message??"unknown";throw new X(`Failed to fetch fragment: ${l}`,{})}},_a=function(e){Object.assign(s(this,C),wa(e))},Jt=function(e){m(this,H,null),s(this,C).message=e,this.classList.add("error");let r={...s(this,C),...s(this,D).duration};s(this,Re).error(e,r),this.dispatchEvent(new CustomEvent(fe,{detail:r,bubbles:!0,composed:!0}))},Ma=async function(){var l;this.classList.remove("error"),m(this,V,null);let e=J.get(s(this,M));if(e)return m(this,B,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,M)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await S(this,q,Pa).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,M)),J.add(e),m(this,B,e),!0},d(At,"cache",J);customElements.define(Zt,At);import{LitElement as qi,html as er,css as Ui,nothing as Gi}from"./lit-all.min.js";import{unsafeHTML as ji}from"./lit-all.min.js";var Vi=a=>a?a.startsWith("sp-icon-")?er`${ji(`<${a} class="badge-icon"></${a}>`)}`:er`<img src="${a}" class="badge-icon" />`:Gi,Ne=class extends qi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return er`<div class="badge">
            ${Vi(this.icon)}<slot>${this.text}</slot>
        </div>`}};d(Ne,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),d(Ne,"styles",Ui`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Ne);import{html as Wi,css as Yi,LitElement as Ki}from"./lit-all.min.js";var et=class extends Ki{constructor(){super()}render(){return Wi`
            <slot name="icon"></slot>
    ...
    `),d(et,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",et);import{html as tr,css as Qi,LitElement as Zi,nothing as Ra}from"./lit-all.min.js";var tt=class extends Zi{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return tr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?tr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:Ra}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(tt,"styles",Qi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),d(tt,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",tt);var Xi={[Y]:yr,[re]:wr,[K]:Er},Ji={[Y]:kr,[K]:He},rt,Tt=class{constructor(t){g(this,rt);d(this,"changes",new Map);d(this,"connected",!1);d(this,"error");d(this,"log");d(this,"options");d(this,"promises",[]);d(this,"state",re);d(this,"timer",null);d(this,"value");d(this,"version",0);d(this,"wrapperElement");this.wrapperElement=t,this.log=Ke.module("mas-element")}update(){[Y,re,K].forEach(t=>{this.wrapperElement.classList.toggle(Xi[t],t===this.state)})}notify(){(this.state===K||this.state===Y)&&(this.state===K?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===Y&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof X&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Ji[this.state],{bubbles:!0,composed:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){m(this,rt,Qt()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return K===r?Promise.resolve(this.wrapperElement):Y===r?Promise.reject(t):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=K,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),St(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=Y,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...s(this,rt)?.duration}),St(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=re,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!Qt()||this.timer)return;let{error:e,options:r,state:i,value:n,version:o}=this;this.state=re,this.timer=St(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===re&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,r)}})}};rt=new WeakMap;function en(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var le,se=class se extends HTMLAnchorElement{constructor(){super();d(this,"masElement",new Tt(this));g(this,le);this.setAttribute("is",se.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,i){this.masElement.attributeChangedCallback(e,r,i)}connectedCallback(){this.masElement.connectedCallback(),m(this,le,ae()),s(this,le)&&(this.log=s(this,le).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,le,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=ae();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:c,language:l,env:p}=r,h=`locale=${l}_${c}&country=${c}&offer_id=${o.offerId}`,x=this.getAttribute("data-promotion-code");x&&(h+=`&promotion_code=${encodeURIComponent(x)}`),this.href=`${en(p)}?${h}`,this.masElement.toggleResolved(i,o,r)}catch(o){let c=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,c,r),!1}}static createFrom(e){let r=new se;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?r.setAttribute("class",i.value.replace("upt-link","").trim()):r.setAttribute(i.name,i.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};le=new WeakMap,d(se,"is","upt-link"),d(se,"tag","a"),d(se,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var ee=se;window.customElements.get(ee.is)||window.customElements.define(ee.is,ee,{extends:ee.tag});var tn="#000000",rr="#F8D904",rn="#EAEAEA",an="#31A547",nn=/(accent|primary|secondary)(-(outline|link))?/,on="mas:product_code/",cn="daa-ll",Lt="daa-lh",sn=["XL","L","M","S"],ar="...",ln=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function F(a,t,e,r){let i=r[a];if(t[a]&&i){let n={slot:i?.slot,...i?.attributes},o=t[a];if(i.maxCount&&typeof o=="string"){let[l,p]=Tn(o,i.maxCount,i.withSuffix);l!==o&&(n.title=p,o=l)}let c=T(i.tag,n,o);e.append(c)}}function dn(a,t,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,c)=>({icon:o,alt:a.mnemonicAlt?.[c]??"",link:a.mnemonicLink?.[c]??""}));i?.forEach(({icon:o,alt:c,link:l})=>{if(l&&!/^https?:/.test(l))try{l=new URL(`https://${l}`).href.toString()}catch{l="#"}let p={slot:"icons",src:o,loading:t.loading,size:e?.size??"l"};c&&(p.alt=c),l&&(p.href=l);let h=T("merch-icon",p);t.append(h)});let n=t.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function hn(a,t,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let r=rr,i=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,a.borderColor||(i=!0));let n=a.badgeBackgroundColor||r,o=a.borderColor||"";i&&(o=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${n}" border-color="${o}">${a.badge}</merch-badge>`}F("badge",a,t,e)}else a.badge?(t.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",a.badgeColor||tn),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",a.badgeBackgroundColor||rr),t.setAttribute("border-color",a.badgeBackgroundColor||rr)):t.setAttribute("border-color",a.borderColor||rn)}function pn(a,t,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||an;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${r}">${a.trialBadge}</merch-badge>`}F("trialBadge",a,t,e)}}function mn(a,t,e){e?.includes(a.size)&&t.setAttribute("size",a.size)}function gn(a,t){a.cardName&&t.setAttribute("name",a.cardName)}function un(a,t,e){a.cardTitle&&(a.cardTitle=De(a.cardTitle)),F("cardTitle",a,t,{cardTitle:e})}function fn(a,t,e){F("subtitle",a,t,e)}function vn(a,t,e,r){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[a.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),t.setAttribute("background-color",a.backgroundColor)):r?.attribute&&a.backgroundColor&&(t.setAttribute(r.attribute,a.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function xn(a,t,e){let r=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")t.style.setProperty(i,"transparent");else if(a.borderColor&&r){let o=r?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),c=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){t.setAttribute("gradient-border","true");let l=a.borderColor;if(r?.specialValues){for(let[p,h]of Object.entries(r.specialValues))if(h===a.borderColor){l=p;break}}t.setAttribute("border-color",l),t.style.removeProperty(i)}else c?(t.setAttribute("border-color",a.borderColor),t.style.setProperty(i,`var(--${a.borderColor})`)):t.style.setProperty(i,`var(--${a.borderColor})`)}}function bn(a,t,e){if(a.backgroundImage){let r={loading:t.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?r.alt=a.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,a.backgroundImage);return}t.append(T(e.tag,{slot:e.slot},T("img",r)))}}function De(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(Rt(),Mt)).catch(console.error),a}function yn(a,t,e){a.prices&&(a.prices=De(a.prices)),F("prices",a,t,e)}function wn(a,t){let e=Array.isArray(a.features)?a.features:a.features?[a.features]:[];if(!e.length)return;let r=T("div",{slot:"features",hidden:"","data-compare-chart-features":""});e.forEach(i=>{if(typeof i!="string"||!i.trim())return;let o=new DOMParser().parseFromString(i,"text/html").body.querySelector("p[name]");if(o){r.append(o);return}r.insertAdjacentHTML("beforeend",i)}),r.children.length&&t.append(r)}function Na(a,t,e){let r=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=nn.exec(i)?.[0]??"accent",o=n.includes("accent"),c=n.includes("primary"),l=n.includes("secondary"),p=n.includes("-outline"),h=n.includes("-link");a.classList.remove("accent","primary","secondary");let x;if(t.consonant)x=_n(a,o,r,h,c,l,e?.ctas?.size);else if(h)x=a;else{let L;o?L="accent":c?L="primary":l&&(L="secondary"),x=t.spectrum==="swc"?Pn(a,e,p,L,r):zn(a,e,p,L,r)}return x}function En(a,t){let{slot:e}=t?.description,r=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(i=>{let n=Na(i,a,t);i.replaceWith(n)})}function kn(a,t,e){a.description&&(a.description=De(a.description)),a.promoText&&(a.promoText=De(a.promoText)),a.shortDescription&&(a.shortDescription=De(a.shortDescription)),F("promoText",a,t,e),F("description",a,t,e),F("shortDescription",a,t,e),a.shortDescription&&(t.setAttribute("action-menu","true"),a.actionMenuLabel||t.setAttribute("action-menu-label","More options")),En(t,e),F("callout",a,t,e),F("quantitySelect",a,t,e),F("whatsIncluded",a,t,e)}function Cn(a,t,e,r={}){if(!e.addon)return;let n=(a.addon??r.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o=T("merch-addon",{slot:"addon"},n);[...o.querySelectorAll(b)].forEach(c=>{let l=c.parentElement;l?.nodeName==="P"&&l.setAttribute("data-plan-type","")}),t.append(o)}function Sn(a,t,e){a.addonConfirmation&&F("addonConfirmation",a,t,e)}function An(a,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function Tn(a,t,e=!0){try{let r=typeof a!="string"?"":a,i=Oa(r);if(i.length<=t)return[r,i];let n=0,o=!1,c=e?t-ar.length<1?1:t-ar.length:t,l=[];for(let x of r){if(n++,x==="<")if(o=!0,r[n]==="/")l.pop();else{let L="";for(let R of r.substring(n)){if(R===" "||R===">")break;L+=R}l.push(L)}if(x==="/"&&r[n]===">"&&l.pop(),x===">"){o=!1;continue}if(!o&&(c--,c===0))break}let p=r.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let x of l.reverse())p+=`</${x}>`}return[`${p}${e?ar:""}`,i]}catch{let i=typeof a=="string"?a:"",n=Oa(i);return[i,n]}}function Oa(a){if(!a)return"";let t="",e=!1;for(let r of a){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function Ln(a,t){t.querySelectorAll("a.upt-link").forEach(r=>{let i=ee.createFrom(r);r.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function zn(a,t,e,r,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let h of a.attributes)["class","is"].includes(h.name)||n.setAttribute(h.name,h.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",c=`spectrum-Button--${r}`,l=sn.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",p=["spectrum-Button",c,l];return e&&p.push("spectrum-Button--outline"),n.classList.add(...p),n}function Pn(a,t,e,r,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let c=T("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return c.source=n,(i?n.onceSettled():Promise.resolve(n)).then(l=>{c.setAttribute("data-navigation-url",l.href)}),c.addEventListener("click",l=>{l.defaultPrevented||n.click()}),c}function _n(a,t,e,r,i,n,o){let c=a;if(e)try{let l=customElements.get("checkout-link");l&&(c=l.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return r||(c.classList.add("button","con-button"),o&&o!=="m"&&c.classList.add(`button-${o}`),t&&c.classList.add("blue"),i&&c.classList.add("primary"),n&&c.classList.add("secondary")),c}function Mn(a,t,e,r,i){if(a.ctas){a.ctas=De(a.ctas);let{slot:n}=e.ctas,o=T("div",{slot:n},a.ctas),c=[...o.querySelectorAll("a")],l=i?.hideTrialCTAs?c.filter(h=>!ln.has(h.dataset.analyticsId)):c,p=(l.length>0?l:c).map(h=>Na(h,t,e));o.textContent="",o.append(...p),t.append(o),i?.hideTrialCTAs&&l.length>0&&p.forEach(h=>{let x=h.source??h;x.onceSettled&&(h.hidden=!0,x.onceSettled().then(()=>{x.value?.[0]?.offerType==="TRIAL"&&p.some(R=>R!==h&&!R.hidden)?h.remove():h.hidden=!1}).catch(()=>{h.hidden=!1}))})}}function Rn(a,t){let{tags:e}=a,r=e?.find(n=>typeof n=="string"&&n.startsWith(on))?.split("/").pop();if(!r)return;t.setAttribute(Lt,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(cn,`${n.dataset.analyticsId}-${o+1}`)})}function On(a){a.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{a.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function Nn(a){a.querySelectorAll("[slot]").forEach(r=>{r.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","gradient-border","size",Lt].forEach(r=>a.removeAttribute(r));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function Da(a,t){if(!a){let l=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!a.fields){let l=a.id||"unknown",p=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${p}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${p}) is missing 'fields'.`)}let{id:e,fields:r,settings:i={},priceLiterals:n}=a,{variant:o}=r;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);Nn(t),t.compatVersion=r.compatVersion,t.contextPromotionCode=r.promoCode,t.settings=i,n&&(t.priceLiterals=n),t.id??(t.id=a.id),a.variationId&&t.setAttribute("variation-id",a.variationId??""),t.variant=o,await t.updateComplete;let{aemFragmentMapping:c}=t.variantLayout;if(!c)throw new Error(`hydrate: variant mapping not found for ${e}`);c.style==="consonant"&&t.setAttribute("consonant",!0),dn(r,t,c.mnemonics),pn(r,t,c),mn(r,t,c.size),gn(r,t),un(r,t,c.title),hn(r,t,c),fn(r,t,c),yn(r,t,c),bn(r,t,c.backgroundImage),vn(r,t,c.allowedColors,c.backgroundColor),xn(r,t,c),kn(r,t,c),wn(r,t),Cn(r,t,c,i),Sn(r,t,c),An(r,t,c,i);try{Ln(r,t)}catch{}Mn(r,t,c,o,i),Rn(r,t),On(t)}var Pt="merch-card",ir=2e4,Fa="merch-card:",Ha=["full-pricing-express","simplified-pricing-express"],qa=["segment","product"];function Ia(a,t){let e=a.closest(Pt);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.promotionCode),e.aemFragment&&(t[Sr]=!0),e.variantLayout?.priceOptionsProvider?.(a,t)}function $a(a,t){let e=a.closest(Pt);if(!e)return t;!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.promotionCode)}function Fn(a){a.providers.has(Ia)||a.providers.price(Ia),a.providers.has($a)||a.providers.checkout($a)}var at=new IntersectionObserver(a=>{a.forEach(t=>{let e=t.target;if(Ha.includes(e.variant)){if(e.clientHeight===0)return;at.unobserve(e),e.requestUpdate();return}if(qa.includes(e.variant)){if(t.boundingClientRect.width===0)return;if(e.variant==="product"&&e.querySelector('merch-icon[slot="icons"]')){at.unobserve(e);return}let r=e.getBoundingClientRect().width,n=e.querySelector('[slot="badge"]')?.getBoundingClientRect().width||0;if(r===0||n===0){at.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(r-n-16)}px`),at.unobserve(e)}})}),In=0,nt,Fe,Ie,$e,G,he,I,pe,k,de,it,nr,zt,te=class extends Dn{constructor(){super();g(this,k);g(this,nt);g(this,Fe);g(this,Ie);g(this,$e);g(this,G);g(this,he);g(this,I);g(this,pe,new Promise(e=>{m(this,I,e)}));d(this,"compatVersion");d(this,"customerSegment");d(this,"marketSegment");d(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}set contextPromotionCode(e){m(this,nt,e)}firstUpdated(){this.variantLayout=Gt(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=Gt(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){S(this,k,de).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(b)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(W)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(W)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(W)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let i of r){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let c=i.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&c.push(o),i.dataset.wcsOsi=c.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let i=n=>{let{offerType:o,planType:c}=n.value?.[0]??{};if(!o||!c)return;let l=e.getOsi(c,o),p=(n.dataset.wcsOsi||"").split(",").filter(h=>h&&h!==l);e.checked&&p.push(l),n.dataset.wcsOsi=p.join(",")};r.forEach(i)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let i of r)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(i=>{if(e){r[i].order=Math.min(r[i].order||2,2);return}let n=r[i].order;n===1||isNaN(n)||(r[i].order=Number(n)+1)}),this.filters=r}showInfoTooltip(e,r){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(r)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(r=>this.iconButton.addEventListener(r,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(r=>this.iconButton.addEventListener(r,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",r=>{r.key==="Escape"&&this.iconButton.classList.remove(e)}))}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),s(this,Ie)||m(this,Ie,In++),this.aemFragment||((r=s(this,I))==null||r.call(this),m(this,I,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??s(this,Ie);m(this,he,`${Fa}${e}${dt}`),m(this,Fe,`${Fa}${e}${ht}`),performance.mark(s(this,he)),m(this,G,ae()),Fn(s(this,G)),m(this,$e,s(this,G).Log.module(Pt)),this.addEventListener(O,this.handleQuantitySelection),this.addEventListener(Ot,this.handleAddonAndQuantityUpdate),this.addEventListener(fr,this.handleMerchOfferSelectReady),this.addEventListener(fe,this.handleAemFragmentEvents),this.addEventListener(ue,this.handleAemFragmentEvents),this.addEventListener(st,this.handleInfoIconEvents),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(O,this.handleQuantitySelection),this.removeEventListener(fe,this.handleAemFragmentEvents),this.removeEventListener(ue,this.handleAemFragmentEvents),this.removeEventListener(st,this.handleInfoIconEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(Ot,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===fe&&S(this,k,de).call(this,"AEM fragment cannot be loaded"),e.type===ue&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{s(this,I)||m(this,pe,new Promise(n=>{m(this,I,n)})),await Da(i,this)}catch(n){S(this,k,de).call(this,`hydration has failed: ${n.message}`)}finally{(r=s(this,I))==null||r.call(this),m(this,I,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;s(this,pe)&&(await s(this,pe),(Ha.includes(this.variant)||qa.includes(this.variant))&&at.observe(this),m(this,pe,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(o=>setTimeout(()=>o("timeout"),ir));if(this.aemFragment){let o=await Promise.race([this.aemFragment.updateComplete,e]);if(o===!1||o==="timeout"){let c=o==="timeout"?`AEM fragment was not resolved within ${ir} timeout`:"AEM fragment cannot be loaded";S(this,k,de).call(this,c,{},!1);return}}let r=[...this.querySelectorAll(ur)],i=Promise.all(r.map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(c=>c.classList.contains("placeholder-resolved"))),n=await Promise.race([i,e]);if(n===!0){this.measure=performance.measure(s(this,Fe),s(this,he));let o={...this.aemFragment?.fetchInfo,...s(this,G).duration,measure:ve(this.measure)};return this.dispatchEvent(new CustomEvent(st,{bubbles:!0,composed:!0,detail:o})),this}else{this.measure=performance.measure(s(this,Fe),s(this,he));let o={measure:ve(this.measure),...s(this,G).duration};n==="timeout"?S(this,k,de).call(this,`Contains offers that were not resolved within ${ir} timeout`,o):S(this,k,de).call(this,"Contains unresolved offers",o)}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(W)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(h=>h.getAttribute("data-modal-id")===e);if(!n)return;let c=new URL(n.getAttribute("href")).searchParams.get("pa"),l=r.find(h=>h.productArrangementCode===c)?.quantity,p=!!r.find(h=>h.productArrangementCode!==c);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(xr,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==p){this.toggleStockOffer({target:this.addonCheckbox});let h=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(h,"target",{writable:!1,value:{checked:p}}),this.addonCheckbox.handleChange(h)}}get prices(){return Array.from(this.querySelectorAll(b))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${b}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return s(this,k,it)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${b}[data-promotion-code],${W}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return s(this,nt);let r=[...new Set(e)];return r.length>1&&s(this,$e)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${b}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(s(this,k,nr)??s(this,k,it))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return s(this,k,it)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return s(this,k,nr)?.querySelector(e)?.textContent?.trim()??s(this,k,it)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return S(this,k,zt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${W}, a`);return Array.from(e??[])}get primaryCta(){return S(this,k,zt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return S(this,k,zt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};nt=new WeakMap,Fe=new WeakMap,Ie=new WeakMap,$e=new WeakMap,G=new WeakMap,he=new WeakMap,I=new WeakMap,pe=new WeakMap,k=new WeakSet,de=function(e,r={},i=!0){var l;if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let c={...this.aemFragment.fetchInfo,...s(this,G).duration,...r,message:e};s(this,$e).error(`merch-card${o}: ${e}`,c),this.failed=!0,(l=s(this,I))==null||l.call(this),m(this,I,void 0),s(this,G).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(br,{bubbles:!0,composed:!0,detail:c}))},it=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${b}[data-template="price"] > span`)},nr=function(){return this.querySelector(`${b}[data-template="legal"]`)},zt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},d(te,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,i,n]=e.split(",");return{PUF:r,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[i,n,o]=r.split(":"),c=Number(n);return[i,{order:isNaN(c)?void 0:c,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:i,size:n}])=>[r,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Lt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),d(te,"styles",[pr,...mr()]),d(te,"registerVariant",E),d(te,"getCollectionOptions",da),d(te,"getFragmentMapping",gt);customElements.define(Pt,te);export{te as MerchCard};

...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Rt,css as Bs}from"./lit-all.min.js";var Ta=`
:root {
...
`;var sr=class extends T{constructor(r){super(r)}getGlobalCSS(){return Pa}renderLayout(){return La` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":La`<hr />`} ${this.secureLabelFooter}`}};import{html as Re,css as Fs,unsafeCSS as Ma}from"./lit-all.min.js";var ka=`
  :root {
...
`;var Us=32,za={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},ot=class extends T{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Re`<slot name="secure-transaction-label">
    ...
    `);import{html as cr,css as $s,unsafeCSS as Na,nothing as Gs}from"./lit-all.min.js";var Ra=`
  :root {
...
`;var qs=32,Oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},st=class extends T{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>cr` <footer>
    ...
    `);import{html as Nt,css as Vs,nothing as lr}from"./lit-all.min.js";var Ia=`
:root {
...
`;var dr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Da={...function(){let{whatsIncluded:e,size:r,...t}=dr;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Ha={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:i,...a}=dr;return a}()},xe,be,te=class extends T{constructor(t){super(t);O(this,xe);O(this,be);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,i){t.dataset.template===ne&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Ia}adjustSlotPlacement(t,i,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let l=n.querySelector(`footer slot[name="${t}"]`),c=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!i.includes(s)){if(o?.classList.toggle("wide-footer",P.isDesktopOrUp),!a&&l){if(c)l.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(l):d.appendChild(l)}return}if(a&&c){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!l){let m=c.cloneNode(!0);o.prepend(m)}c.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],P.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],P.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,xe)||(_(this,xe,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,xe)?.disconnect(),_(this,xe,null),this.syncHeights())})),v(this,xe).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(i=>({name:i,getElement:a=>a.querySelector(`[slot="${i}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),i.insertBefore(o,n);let s=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let c=0,d=this.card.querySelector('[slot="heading-s"]');d&&(c+=Mt(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(c+=Mt(p));let m=this.card.querySelector('[slot="heading-m"]');m&&(c+=8+Mt(m));for(let u of i.childNodes){if(u.classList.contains("spacer"))break;c+=Mt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");c>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${c}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${c}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${V}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Nt`<div class="divider"></div>`:lr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],i=this.card.querySelector(`[slot="heading-m"] ${V}[data-template="price"]`);i&&t.push(i);let a=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(t.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?Nt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};xe=new WeakMap,be=new WeakMap,g(te,"variantStyle",Vs`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),g(te,"collectionOptions",{customHeaderArea:t=>t.sidenav?Nt`<slot name="resultsText"></slot>`:lr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let i=()=>{let a=t.querySelectorAll("merch-card");for(let o of a)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!P.isDesktop)return;let n=0;for(let o of a){if(o.style.display==="none")continue;let s=o.getAttribute("size"),l=s==="wide"?2:s==="super-wide"?3:1;l===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),l=1),n+=l}};P.matchDesktop.addEventListener("change",i),t.addEventListener(pe,i),t.onUnmount.push(()=>{P.matchDesktop.removeEventListener("change",i),t.removeEventListener(pe,i)})}});import{html as Ae,css as js,unsafeCSS as Fa,nothing as hr}from"./lit-all.min.js";var Ba=`
:root {
...
`;var Ga={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},Oe,ye,Ge,Te,qa,It,pr=class pr extends T{constructor(){super(...arguments);O(this,Te);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);O(this,Oe,null);O(this,ye,null);O(this,Ge,null);g(this,"handleResize",()=>{v(this,ye)&&cancelAnimationFrame(v(this,ye)),_(this,ye,requestAnimationFrame(()=>{_(this,ye,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))});g(this,"toggleExpanded",t=>{t.preventDefault();let i=!this.expanded;for(let a of he(this,Te,qa).call(this)){let n=a.variantLayout;n instanceof pr&&(n.expanded=i,a.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen=!this.licenseOpen,this.licenseOpen?(_(this,Oe,i=>{i.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),he(this,Te,It).call(this))}),document.addEventListener("mousedown",v(this,Oe))):he(this,Te,It).call(this),this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,he(this,Te,It).call(this);let i=this.quantitySelectEl;i&&(i.selectedValue=Number(t),i.dispatchEvent(new CustomEvent(le,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return $a}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${V}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(t.planType=a)}async postCardUpdateHook(){await this.adjustAddon(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights())}syncHeights(){this.card.getBoundingClientRect().width<=2||this.syncRowHeights([{name:"top-card",getElement:t=>t.shadowRoot?.querySelector(".top-card")}])}connectedCallbackHook(){window.addEventListener("resize",this.handleResize),_(this,Ge,new IntersectionObserver(([t])=>{t.boundingClientRect.height!==0&&t.isIntersecting&&(window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights()),v(this,Ge)?.disconnect())})),v(this,Ge).observe(this.card)}disconnectedCallbackHook(){he(this,Te,It).call(this),window.removeEventListener("resize",this.handleResize),v(this,ye)&&(cancelAnimationFrame(v(this,ye)),_(this,ye,null)),v(this,Ge)?.disconnect()}get hasLegalText(){return!!this.card.querySelector('[slot="legal-text"]')}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let i=parseInt(t.getAttribute("min"),10),a=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(i)||Number.isNaN(a)||a<i)return null;let o=[];for(let s=i;s<=a;s+=n)o.push(String(s));return o.length?o:null}get licenseLabel(){return this.quantitySelectEl?.getAttribute("title")||"License"}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let i=this.quantitySelectEl?.getAttribute("default-value");return i!=null&&t.includes(i)?i:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Ce`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,i=this.currentLicenseValue,a=!!this.licenseOpen,n=this.licenseLabel;return Ce`
        ...
        `}renderLayout(){let t=!!this.expanded;return Ce`
            ...
            ${this.hasWhatsIncluded?Ce`
                  ...
                  `:Ot}
            <slot></slot>
        `}};Oe=new WeakMap,ye=new WeakMap,Ge=new WeakMap,Te=new WeakSet,qa=function(){let t=Math.round(this.card.getBoundingClientRect().top),i=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(a=>{let n=a.getBoundingClientRect();return n.width>2&&Math.round(n.top)===t});return i.length?i:[this.card]},It=function(){v(this,Oe)&&(document.removeEventListener("mousedown",v(this,Oe)),_(this,Oe,null))},g(pr,"variantStyle",Ws`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Dt=pr;import{html as ui,css as Ys}from"./lit-all.min.js";var Va=`
:root {
...
`;var ja={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},we,ct=class extends T{constructor(t){super(t);O(this,we);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Va}priceOptionsProvider(t,i){t.dataset.template===ne&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return ui` ${this.badge}
...
`,Ze.MISSING_INTL_API,o);var A=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[A]||d.options.other}if(!b)throw new ta(d.value,m,Object.keys(d.options),o);s.push.apply(s,Yt(b.value,r,t,i,a,m-(d.offset||0)));continue}}return Il(s)}function Hl(e,r){return r?L(L(L({},e||{}),r||{}),Object.keys(e).reduce(function(t,i){return t[i]=L(L({},e[i]),r[i]||{}),t},{})):e}function Bl(e,r){return r?Object.keys(e).reduce(function(t,i){return t[i]=Hl(e[i],r[i]),t},L({},e)):e}function ra(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function Fl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:jt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.NumberFormat).bind.apply(r,Cr([void 0],t,!1)))},{cache:ra(e.number),strategy:Rr.variadic}),getDateTimeFormat:jt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.DateTimeFormat).bind.apply(r,Cr([void 0],t,!1)))},{cache:ra(e.dateTime),strategy:Rr.variadic}),getPluralRules:jt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.PluralRules).bind.apply(r,Cr([void 0],t,!1)))},{cache:ra(e.pluralRules),strategy:Rr.variadic})}}var To=function(){function e(r,t,i,a){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var l=s.reduce(function(c,d){return!c.length||d.type!==K.literal||typeof c[c.length-1]!="string"?c.push(d.value):c[c.length-1]+=d.value,c},[]);return l.length<=1?l[0]||"":l},this.formatToParts=function(o){return Yt(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Bl(e.formats,i),this.formatters=a&&a.formatters||Fl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=wo,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var _o=To;var ia={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Ul=un("ConsonantTemplates/price"),$l=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},De={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},aa="TAX_EXCLUSIVE",Gl=e=>hn(e)?Object.entries(e).filter(([,r])=>vt(r)||ur(r)||r===!0).reduce((r,[t,i])=>`${r} ${t}${i===!0?"":`="${dn(i)}"`}`,""):"",G=(e,r,t,i=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${Gl(t)}>${i?Fn(r):r??""}</span>`;function ql(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function Vl(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function Pe(e,r,t,i){let a=e[t];if(a==null)return"";let n=a.includes("<"),o=a.includes("<a ");try{a=o?ql(a):a,a=n?a.replace($l,""):a;let s=new _o(a,r).format(i);return o?Vl(s):s}catch{return Ul.error("Failed to format literal:",a),""}}function jl(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:l,recurrenceLabel:c,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=G($.currencySymbol,i),u=G($.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),l&&(f+=h+u),f+=G($.integer,s),f+=G($.decimalsDelimiter,n),f+=G($.decimals,a),l||(f+=u+h),f+=G($.recurrence,c,null,!0),f+=G($.unitType,d,null,!0),f+=G($.taxInclusivity,p,!0),G(e,f,{...m})}var Y=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:l=!0,displayPerUnit:c=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:S,price:b,priceWithoutDiscount:A,taxDisplay:D,taxTerm:z,term:U,usePrecision:q,promotion:Q}={},W={})=>{Object.entries({country:o,formatString:S,language:p,price:b}).forEach(([hs,ps])=>{if(ps==null)throw new Error(`Argument "${hs}" is missing for osi ${y?.toString()}, country ${o}, language ${p}`)});let F={...ia,...m},N=`${p.toLowerCase()}-${o.toUpperCase()}`,J;Q&&!f&&A?J=e||i?b:A:t&&A?J=A:J=b;let se=r?$n:Gn;a&&(se=qn);let{accessiblePrice:et,recurrenceTerm:pa,...ma}=se({commitment:x,formatString:S,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:A,price:r?b:J,promotion:Q,quantity:h,term:U,usePrecision:q}),Ir="",Dr="",Hr="";w(l)&&pa&&(Hr=Pe(F,N,De.recurrenceLabel,{recurrenceTerm:pa}));let er="";w(c)&&(u&&(er+=" "),er+=Pe(F,N,De.perUnitLabel,{perUnit:"LICENSE"}));let tr="";w(d)&&z&&(u&&(tr+=" "),tr+=Pe(F,N,D===aa?De.taxExclusiveLabel:De.taxInclusiveLabel,{taxTerm:z})),t&&(Ir=Pe(F,N,De.strikethroughAriaLabel,{strikethroughPrice:Ir})),e&&(Dr=Pe(F,N,De.alternativePriceAriaLabel,{alternativePrice:Dr}));let Be=$.container;if(r&&(Be+=` ${$.containerOptical}`),t&&(Be+=` ${$.containerStrikethrough}`),i&&(Be+=` ${$.containerPromoStrikethrough}`),e&&(Be+=` ${$.containerAlternative}`),a&&(Be+=` ${$.containerAnnual}`),w(s))return jl(Be,{...ma,accessibleLabel:Ir,altAccessibleLabel:Dr,recurrenceLabel:Hr,perUnitLabel:er,taxInclusivityLabel:tr},W);let{currencySymbol:ua,decimals:os,decimalsDelimiter:ss,hasCurrencySpace:ga,integer:cs,isCurrencyFirst:ls}=ma,tt=[cs,ss,os];ls?(tt.unshift(ga?"\xA0":""),tt.unshift(ua)):(tt.push(ga?"\xA0":""),tt.push(ua)),tt.push(Hr,er,tr);let ds=tt.join("");return G(Be,ds,W)},Po=()=>(e,r,t)=>{let i=Xe(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||i);return`${n?`${Y({displayStrikethrough:!0})({isPromoApplied:i,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${Y({isAlternativePrice:n})({isPromoApplied:i,...e},r,t)}`},Lo=()=>(e,r,t)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=Xe(r.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return Y()(e,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualPrefix," (")+Y({displayAnnual:!0,instant:i})(n,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${Y({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${Y({isAlternativePrice:s})({isPromoApplied:a,...e},r,t)}${G($.containerAnnualPrefix," (")}${Y({displayAnnual:!0,instant:i})(n,r,t)}${G($.containerAnnualSuffix,")")}`},ko=()=>(e,r,t)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${Y({isAlternativePrice:e.displayOldPrice})(e,r,t)}${G($.containerAnnualPrefix," (")}${Y({displayAnnual:!0})(i,r,t)}${G($.containerAnnualSuffix,")")}`};var Xt={...$,containerLegal:"price-legal",planType:"price-plan-type"},Nr={...De,planTypeLabel:"planTypeLabel"};function Wl(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:i},a={},n=!0){let o="";return o+=G(Xt.unitType,r,null,!0),t&&i&&n&&(t+=". "),o+=G(Xt.taxInclusivity,t,!0),o+=G(Xt.planType,i,null),G(e,o,{...a})}var Mo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:i=!1,displayDot:a=!0,language:n,literals:o={}}={},{taxDisplay:s,taxTerm:l,planType:c}={},d={})=>{let p={...ia,...o},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";w(r)&&(h=Pe(p,m,Nr.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),w(t)&&l&&(u=Pe(p,m,s===aa?Nr.taxExclusiveLabel:Nr.taxInclusiveLabel,{taxTerm:l}));let f="";w(i)&&c&&(f=Pe(p,m,Nr.planTypeLabel,{planType:c}));let x=Xt.container;return x+=` ${Xt.containerLegal}`,Wl(x,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,a)};var zo=Y(),Ro=Po(),No=Y({displayOptical:!0}),Oo=Y({displayStrikethrough:!0}),Io=Y({displayPromoStrikethrough:!0}),Do=Y({displayAnnual:!0}),Ho=Y({displayOptical:!0,isAlternativePrice:!0}),Bo=Y({isAlternativePrice:!0}),Fo=ko(),Uo=Lo(),$o=Mo;var Yl=(e,r)=>{if(!(!Ht(e)||!Ht(r)))return Math.floor((r-e)/r*100)},Go=()=>(e,r)=>{let{price:t,priceWithoutDiscount:i}=r,a=Yl(t,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var qo=Go();var Vo="INDIVIDUAL_COM",oa="TEAM_COM",jo="INDIVIDUAL_EDU",sa="TEAM_EDU",Xl=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],Kl={[Vo]:[],[oa]:[],[jo]:[],[sa]:[]},Zl={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Ql=[Vo,oa,jo,sa],Jl=e=>[oa,sa].includes(e);function na(e,r,t,i){if(e[r])return e[r];let a=`${r}_${t}`;if(e[a])return e[a];let n;if(i)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var ed=(e,r,t,i)=>{let a=`${t}_${i}`,n=na(Zl,e,r,!1);if(n){let o=Ql.indexOf(a);return n[o]}return Jl(a)},td=(e,r,t,i)=>{if(na(Xl,e,r,!0))return!0;let a=Kl[`${t}_${i}`];return a?na(a,e,r,!0)?!0:M.displayTax:M.displayTax},ca=async(e,r,t,i)=>{let a=td(e,r,t,i);return{displayTax:a,forceTaxExclusive:a?ed(e,r,t,i):M.forceTaxExclusive}},Kt=class Kt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ie(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let i=ie();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=i.collectPriceOptions(t);return Sr(Kt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===me}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let i=ie();if(!i)return!1;let a=i.collectPriceOptions(t,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=i.resolveOfferSelectors(n),l=await Promise.all(s),c=l.map(h=>{let u=Ft(h,n);return u?.length?u[0]:null});if(c.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=c,p=Di(c);if(i.featureFlags[Se]||n[Se]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,x=await ca(h,u,p.customerSegment,f);a.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=l.map(y=>{let S=Ft(y,n);return S?.length?S[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(i.featureFlags[it]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=Di(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,i,a=void 0){if(!this.isConnected)return;let n=ie();if(!n)return!1;if(a??(a=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(a,t,i)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(l=>{l.dataset.template!=="strikethrough"&&l.options&&!l.options.alternativePrice&&!l.isFailed&&(l.options.alternativePrice=!0,l.innerHTML=n.buildPriceHTML(t,l.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,o,this.options))return this.innerHTML="",!0}return!1}};g(Kt,"is","inline-price"),g(Kt,"tag","span");var Le=Kt;window.customElements.get(Le.is)||window.customElements.define(Le.is,Le,{extends:Le.tag});function Wo({literals:e,providers:r,settings:t}){function i(o,s=null){let l={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let z of r.price)z(s,l);let{displayOldPrice:c,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:y,quantity:S,alternativePrice:b,wcsOsi:A,...D}=Object.assign(l,s?.dataset??{},o??{});return l=gr(Object.assign({...l,...D,displayOldPrice:w(c),displayPerUnit:w(d),displayRecurrence:w(p),displayTax:w(m),displayPlanType:w(h),forceTaxExclusive:w(u),perpetual:w(f),displayAnnual:w(x),promotionCode:vr(y).effectivePromoCode,quantity:xt(S,M.quantity),alternativePrice:w(b),wcsOsi:Er(A)})),l}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:l}=s,c;switch(l){case"discount":c=qo;break;case"strikethrough":c=Oo;break;case"promo-strikethrough":c=Io;break;case"annual":c=Do;break;case"legal":c=$o;break;default:s.template==="optical"&&s.alternativePrice?c=Ho:s.template==="optical"?c=No:s.displayAnnual&&o[0].planType==="ABM"?c=s.promotionCode&&o[0].promotion?Uo:Fo:s.alternativePrice?c=Bo:c=s.promotionCode&&o[0].promotion?Ro:zo}let[d]=o;return d={...d,...d.priceDetails},c({...t,...s},d)}let n=Le.createInlinePrice;return{InlinePrice:Le,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function rd({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||M.language),r??(r=e?.split("_")?.[1]||M.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function Yo(e={},r){let t=r.featureFlags[Se],{commerce:i={}}=e,a=fe.PRODUCTION,n=ni,o=H("checkoutClientId",i)??M.checkoutClientId,s=Bt(H("checkoutWorkflowStep",i),ee,M.checkoutWorkflowStep),l=w(H("displayOldPrice",i),M.displayOldPrice),c=M.displayPerUnit,d=w(H("displayRecurrence",i),M.displayRecurrence),p=w(H("displayTax",i),M.displayTax),m=w(H("displayPlanType",i),M.displayPlanType),h=w(H("entitlement",i),M.entitlement),u=w(H("modal",i),M.modal),f=w(H("forceTaxExclusive",i),M.forceTaxExclusive),x=H("promotionCode",i)??M.promotionCode,y=xt(H("quantity",i)),S=H("wcsApiKey",i)??M.wcsApiKey,b=i?.env==="stage",A=ze.PUBLISHED;["true",""].includes(i.allowOverride)&&(b=(H(ii,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",A=Bt(H(ai,i),ze,A)),b&&(a=fe.STAGE,n=oi);let z=H(ri)??e.preview,U=typeof z<"u"&&z!=="off"&&z!=="false",q={};U&&(q={preview:U});let Q=H("mas-io-url")??e.masIOUrl??`https://www${a===fe.STAGE?".stage":""}.adobe.com/mas/io`,W=H("preselect-plan")??void 0,F=H("instant")??e.instant;return{...rd(e),...q,displayOldPrice:l,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:c,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:M.extraOptions,modal:u,env:a,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:M.alternativePrice,wcsApiKey:S,wcsURL:n,landscape:A,masIOUrl:Q,...W&&{preselectPlan:W},...F&&{instant:F}}}async function Xo(e,r={},t=2,i=100){let a;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,i*(n+1)))}throw a}var la="wcs";function Ko({settings:e}){let r=re.module(la),{env:t,wcsApiKey:i}=e,a=new Map,n=new Map,o,s=new Map;async function l(u,f,x=!0){let y=ie(),S=Jr;r.debug("Fetching:",u);let b="",A;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let D=new Map(f),[z]=u.offerSelectorIds,U=Date.now()+Math.random().toString(36).substring(2,7),q=`${la}:${z}:${U}${ci}`,Q=`${la}:${z}:${U}${li}`,W;try{if(performance.mark(q),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",z),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===fe.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",i),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),A=await Xo(b.toString(),{credentials:"omit"}),A.ok){let F=[];try{let N=await A.json();r.debug("Fetched:",u,N),F=N.resolvedOffers??[]}catch(N){r.error(`Error parsing JSON: ${N.message}`,{...N.context,...y?.duration})}F=F.map(xr),f.forEach(({resolve:N},J)=>{let se=F.filter(({offerSelectorIds:et})=>et.includes(J)).flat();se.length&&(D.delete(J),f.delete(J),N(se))})}else S=Qr}catch(F){S=`Network error: ${F.message}`}finally{W=performance.measure(Q,q),performance.clearMarks(q),performance.clearMeasures(Q)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=_n(A);f.forEach(N=>{N.reject(new bt(S,{...u,...F,response:A,measure:ar(W),...y?.duration}))})}}function c(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>l(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===fe.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,S]of Object.entries(x))a.set(y,Promise.resolve(S.map(xr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let u=a.size;s=new Map(a),a.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,x){let y=u!=="GB"&&!x?"MULT":"en",S=di.includes(u)?u:M.country;return{validCountry:S,validLanguage:y,locale:`${f}_${S}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:S=[]}){let{validCountry:b,validLanguage:A,locale:D}=m(u,f,x),z=[b,A,y].filter(U=>U).join("-").toLowerCase();return S.map(U=>{let q=`${U}-${z}`;if(a.has(q))return a.get(q);let Q=new Promise((W,F)=>{let N=n.get(z);N||(N={options:{country:b,locale:D,...A==="MULT"&&{language:A},offerSelectorIds:[]},promises:new Map},n.set(z,N)),y&&(N.options.promotionCode=y),N.options.offerSelectorIds.push(U),N.promises.set(U,{resolve:W,reject:F}),c()}).catch(W=>{if(s.has(q))return s.get(q);throw W});return a.set(q,Q),Q})}return{Commitment:Fe,PlanType:fn,Term:ce,applyPlanType:xr,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var Zo="mas-commerce-service",Qo="mas-commerce-service:start",Jo="mas-commerce-service:ready",Zt,wt,Qe,es,ha,da=class extends HTMLElement{constructor(){super(...arguments);O(this,Qe);O(this,Zt);O(this,wt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let o=await t?.(i,a,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,wt)||_(this,wt,{[Se]:he(this,Qe,ha).call(this,Se),[it]:he(this,Qe,ha).call(this,it)}),v(this,wt)}activate(){let t=v(this,Qe,es),i=Yo(t,this);br(t.lana);let a=re.init(t.hostEnv).module("service");a.debug("Activating:",t);let o={price:Jn(i)},s={checkout:new Set,price:new Set},l={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Kn(l),...Zn(l),...Wo(l),...Ko(l),...hi,Log:re,resolvePriceTaxFlags:ca,get defaults(){return M},get log(){return re},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:o,settings:i});let c=new CustomEvent(ir,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Jo),_(this,Zt,performance.measure(Jo,Qo)),this.dispatchEvent(c),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Qo),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Ur).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":ar(v(this,Zt))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:o})=>a===0&&n===0&&o<200||o>=400),i=Array.from(new Map(t.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Zt=new WeakMap,wt=new WeakMap,Qe=new WeakSet,es=function(){let t=this.getAttribute("env")??"prod",i={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=n}}),i},ha=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(Zo)||window.customElements.define(Zo,da);var as="merch-card-collection",id=3e4,ad={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},nd={plans:!0},od=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),sd=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(i=>t.types.includes(i)))):e,cd=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),ld=(e,{filter:r})=>e.sort((t,i)=>i.filters[r]?.order==null||isNaN(i.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-i.filters[r].order),dd=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,He,St,Je,Jt,Or,ns,Et=class extends rs{constructor(){super();O(this,Or);O(this,He,{});O(this,St);O(this,Je);O(this,Jt);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return ke` <slot></slot>
    ...
    `);Et.SortOrder=ue;customElements.define(as,Et);var hd={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},pd=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(a=>{a.innerText=t||""})},md={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},ud={catalog:"l"},ae,At,Qt=class extends rs{constructor(){super();O(this,ae);O(this,At);g(this,"tablet",new Ct(this,I));g(this,"desktop",new Ct(this,C));this.collection=null,_(this,ae,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(pe,this.updateLiterals),this.collection?.addEventListener(_t,this.handleSidenavAttached),_(this,At,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(pe,this.updateLiterals),this.collection?.removeEventListener(_t,this.handleSidenavAttached)}willUpdate(){v(this,ae).search=this.getVisibility("search"),v(this,ae).filter=this.getVisibility("filter"),v(this,ae).sort=this.getVisibility("sort"),v(this,ae).result=this.getVisibility("result"),v(this,ae).custom=this.getVisibility("custom")}parseVisibilityOptions(t,i){if(!t||!Object.hasOwn(t,i))return null;let a=t[i];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(t){let i=v(this,At)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(i,t);return a!==null?a:this.parseVisibilityOptions(md,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,ae).search)return ge;let t=Lt(this,"searchText");return t?ke`
        ...
        `:ge}get filterAction(){return v(this,ae).filter?this.sidenav?ke`
            <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
            ...
            ></sp-action-button>
        `:ge:ge}get sortAction(){if(!v(this,ae).sort)return ge;let t=Lt(this,"sortText");if(!t)return;let i=Lt(this,"popularityText"),a=Lt(this,"alphabeticallyText");if(!(i&&a))return;let n=this.collection?.sort===ue.alphabetical;return ke`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        </div>`}get customArea(){if(!v(this,ae).custom)return ge;let t=v(this,At)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return ge;let i=t(this.collection);return!i||i===ge?ge:ke`<div id="custom" role="heading" aria-level="2">
            ${i}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(i=>{pd(this,i,t.detail[i])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return ke`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};ae=new WeakMap,At=new WeakMap,g(Qt,"styles",is`
        :host {
    ...
    `);customElements.define("merch-card-collection-header",Qt);export{Et as MerchCardCollection,Qt as default};

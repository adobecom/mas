...
test.describe('M@S Studio ACOM Full Pricing Express card discard test suite', () => {
    ...
    // @studio-full-pricing-express-discard-description2-changes - Validate discarding description2 changes for full pricing express card
    test(`${features[3].name},${features[3].tags}`, async ({ page, baseURL }) => {
        ...
        await test.step('step-4: Discard and validate', async () => {
            ...
            await page.waitForTimeout(1000);
            await expect(await editor.description2).toContainText(data.description2);
            await expect(await fullPricingExpress.cardDescription2).toContainText(data.description2);
        });
    });

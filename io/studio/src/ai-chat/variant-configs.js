...
export const SURFACE_MAPPINGS = {
    acom: ['plans', 'plans-v2', 'plans-students', 'plans-education', 'catalog', 'product', 'segment', 'special-offers', 'image', 'mini', 'simplified-pricing-express'],
    ccd: ['ccd-slice', 'ccd-suggested', 'mini'],
    commerce: ['fries'],
...
export const VARIANT_METADATA = {
    ...
    'plans-v2': {
        name: 'Plans v2',
        description: 'Updated pricing plan cards with collapsible short descriptions and responsive layouts',
        ctaStyle: 'accent',
        ctaSize: 'm',
    },
    product: {
        name: 'Product',
        description: 'Vertical product/app detail cards with height sync and addon support',
        ctaStyle: 'primary-outline',
        ctaSize: 'm',
    },
    segment: {
        name: 'Segment',
        description: 'Compact customer segment cards with badge width synchronization',
        ctaStyle: 'primary-outline',
        ctaSize: 'm',
    },
    image: {
        name: 'Image',
        description: 'Background image-based cards with prominent hero image and absolute-positioned badge',
        ctaStyle: 'primary-outline',
        ctaSize: 'm',
    },
    fries: {
    ...
    headless: {
        name: 'Headless',
        description: 'Debug/development variant that renders slots as label-value pairs for testing',
        ctaStyle: 'primary',
        ctaSize: 'm',
    },
};
...
export const VARIANT_CONFIGS = {
    ...
    'plans-v2': {
        name: 'Plans v2',
        description: 'Updated pricing plan cards with collapsible short descriptions',
        ctaStyle: 'accent',
        ctaSize: 'm',
        requiredFields: ['title', 'prices', 'ctas'],
        optionalFields: ['subtitle', 'shortDescription', 'description', 'badge', 'mnemonics', 'promoText', 'callout', 'whatsIncluded', 'addon', 'quantitySelect'],
        sizes: ['wide', 'super-wide'],
        mapping: {
            cardName: { attribute: 'name' },
            title: { tag: 'h3', slot: 'heading-xs' },
    ...
    product: {
        name: 'Product',
        description: 'Vertical product/app detail cards',
        ctaStyle: 'primary-outline',
        ctaSize: 'm',
        requiredFields: ['title', 'prices', 'ctas'],
        optionalFields: ['description', 'badge', 'mnemonics', 'promoText', 'callout', 'whatsIncluded', 'quantitySelect'],
        sizes: [],
        mapping: {
            cardName: { attribute: 'name' },
            title: { tag: 'h3', slot: 'heading-xs' },
    ...
    segment: {
        name: 'Segment',
        description: 'Compact customer segment cards',
        ctaStyle: 'primary-outline',
        ctaSize: 'm',
        requiredFields: ['title', 'prices', 'ctas'],
        optionalFields: ['description', 'badge', 'promoText', 'callout'],
        sizes: [],
        mapping: {
            cardName: { attribute: 'name' },
            title: { tag: 'h3', slot: 'heading-xs' },
    ...
    image: {
        name: 'Image',
        description: 'Background image-based cards',
        ctaStyle: 'primary-outline',
        ctaSize: 'm',
        requiredFields: ['backgroundImage', 'ctas'],
        optionalFields: ['title', 'subtitle', 'description', 'prices', 'badge', 'mnemonics', 'promoText'],
        sizes: ['wide', 'super-wide'],
        mapping: {
            cardName: { attribute: 'name' },
            title: { tag: 'h3', slot: 'heading-xs' },

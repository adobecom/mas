...
`;var ur={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ja={...function(){let{whatsIncluded:e,size:r,...t}=ur;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Wa={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:i,...a}=ur;return a}()},be,ye,ne=class extends w{constructor(t){super(t);z(this,be);z(this,ye);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Va}adjustSlotPlacement(t,i,a){let n=this.card.shadowRoot,s=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(o.includes("wide")||(s?.classList.remove("wide-footer"),c&&c.remove()),!!i.includes(o)){if(s?.classList.toggle("wide-footer",_.isDesktopOrUp),!a&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(a&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);s.prepend(m)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],_.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],_.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,be)||(L(this,be,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,be)?.disconnect(),L(this,be,null),this.syncHeights())})),v(this,be).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(i=>({name:i,getElement:a=>a.querySelector(`[slot="${i}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,s=document.createElement("div");s.classList.add("spacer"),i.insertBefore(s,n);let o=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Lt(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=Lt(p));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+Lt(m));for(let u of i.childNodes){if(u.classList.contains("spacer"))break;l+=Lt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${W}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Rt`<div class="divider"></div>`:mr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],i=this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`);i&&t.push(i);let a=t.map(async n=>{let s=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),s.setAttribute("data-template","legal"),n.parentNode.insertBefore(s,n.nextSibling),await s.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled?.();let a=i.value?.[0]?.planType;a&&(t.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?Rt`<label id="stock-checkbox">
    ...
    `),g(ne,"collectionOptions",{customHeaderArea:t=>t.sidenav?Rt`<slot name="resultsText"></slot>`:mr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let i=()=>{let a=t.querySelectorAll("merch-card");for(let s of a)s.hasAttribute("data-size")&&(s.setAttribute("size",s.getAttribute("data-size")),s.removeAttribute("data-size"));if(!_.isDesktop)return;let n=0;for(let s of a){if(s.style.display==="none")continue;let o=s.getAttribute("size"),c=o==="wide"?2:o==="super-wide"?3:1;c===2&&n%3===2&&(s.setAttribute("data-size",o),s.removeAttribute("size"),c=1),n+=c}};_.matchDesktop.addEventListener("change",i),t.addEventListener(me,i),t.onUnmount.push(()=>{_.matchDesktop.removeEventListener("change",i),t.removeEventListener(me,i)})}});import{html as Ae,css as lc,unsafeCSS as Xa,nothing as gr}from"./lit-all.min.js";var Ya=`
:root {
...
`;var Ti={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Bt=class Bt extends w{getGlobalCSS(){return gn}get aemFragmentMapping(){return Ti}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return fn`
    ...
    `);var Ft=Bt;import{html as _i,css as bc,nothing as yc}from"./lit-all.min.js";var vn=`
...
`;var ki={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Tc=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],xr,En,ut=class extends w{constructor(t){super(t);z(this,xr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return wn}get aemFragmentMapping(){return ki}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,j(this,xr,En).call(this))}renderLayout(){return Ac`
    ...
    `);import{html as _c,css as kc}from"./lit-all.min.js";var Sn=`
...
`,Ze.MISSING_INTL_API,s);var C=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[C]||d.options.other}if(!b)throw new da(d.value,m,Object.keys(d.options),s);o.push.apply(o,Zt(b.value,r,t,i,a,m-(d.offset||0)));continue}}return rd(o)}function ad(e,r){return r?k(k(k({},e||{}),r||{}),Object.keys(e).reduce(function(t,i){return t[i]=k(k({},e[i]),r[i]||{}),t},{})):e}function nd(e,r){return r?Object.keys(e).reduce(function(t,i){return t[i]=ad(e[i],r[i]),t},k({},e)):e}function ha(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function od(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Xt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.NumberFormat).bind.apply(r,Mr([void 0],t,!1)))},{cache:ha(e.number),strategy:Br.variadic}),getDateTimeFormat:Xt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.DateTimeFormat).bind.apply(r,Mr([void 0],t,!1)))},{cache:ha(e.dateTime),strategy:Br.variadic}),getPluralRules:Xt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.PluralRules).bind.apply(r,Mr([void 0],t,!1)))},{cache:ha(e.pluralRules),strategy:Br.variadic})}}var $o=function(){function e(r,t,i,a){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(s){var o=n.formatToParts(s);if(o.length===1)return o[0].value;var c=o.reduce(function(l,d){return!l.length||d.type!==Q.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(s){return Zt(n.ast,n.locales,n.formatters,n.formats,s,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=nd(e.formats,i),this.formatters=a&&a.formatters||od(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Do,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Go=$o;var pa={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},sd=Ln("ConsonantTemplates/price"),cd=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},De={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},ma="TAX_EXCLUSIVE",ld=e=>_n(e)?Object.entries(e).filter(([,r])=>ft(r)||yr(r)||r===!0).reduce((r,[t,i])=>`${r} ${t}${i===!0?"":`="${Tn(i)}"`}`,""):"",q=(e,r,t,i=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${ld(t)}>${i?ro(r):r??""}</span>`;function dd(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function hd(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function _e(e,r,t,i){let a=e[t];if(a==null)return"";let n=a.includes("<"),s=a.includes("<a ");try{a=s?dd(a):a,a=n?a.replace(cd,""):a;let o=new Go(a,r).format(i);return s?hd(o):o}catch{return sd.error("Failed to format literal:",a),""}}function pd(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:s,integer:o,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=q($.currencySymbol,i),u=q($.currencySpace,s?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=q($.integer,o),f+=q($.decimalsDelimiter,n),f+=q($.decimals,a),c||(f+=u+h),f+=q($.recurrence,l,null,!0),f+=q($.unitType,d,null,!0),f+=q($.taxInclusivity,p,!0),q(e,f,{...m})}var K=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:s,displayFormatted:o=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:A,price:b,priceWithoutDiscount:C,taxDisplay:D,taxTerm:R,term:U,usePrecision:V,promotion:te}={},X={})=>{Object.entries({country:s,formatString:A,language:p,price:b}).forEach(([_s,ks])=>{if(ks==null)throw new Error(`Argument "${_s}" is missing for osi ${y?.toString()}, country ${s}, language ${p}`)});let F={...pa,...m},I=`${p.toLowerCase()}-${s.toUpperCase()}`,re;te&&!f&&C?re=e||i?b:C:t&&C?re=C:re=b;let de=r?ao:no;a&&(de=oo);let{accessiblePrice:et,recurrenceTerm:wa,...Ea}=de({commitment:x,formatString:A,instant:n,isIndianPrice:s==="IN",originalPrice:b,priceWithoutDiscount:C,price:r?b:re,promotion:te,quantity:h,term:U,usePrecision:V}),$r="",Gr="",qr="";E(c)&&wa&&(qr=_e(F,I,De.recurrenceLabel,{recurrenceTerm:wa}));let ir="";E(l)&&(u&&(ir+=" "),ir+=_e(F,I,De.perUnitLabel,{perUnit:"LICENSE"}));let ar="";E(d)&&R&&(u&&(ar+=" "),ar+=_e(F,I,D===ma?De.taxExclusiveLabel:De.taxInclusiveLabel,{taxTerm:R})),t&&($r=_e(F,I,De.strikethroughAriaLabel,{strikethroughPrice:$r})),e&&(Gr=_e(F,I,De.alternativePriceAriaLabel,{alternativePrice:Gr}));let Be=$.container;if(r&&(Be+=` ${$.containerOptical}`),t&&(Be+=` ${$.containerStrikethrough}`),i&&(Be+=` ${$.containerPromoStrikethrough}`),e&&(Be+=` ${$.containerAlternative}`),a&&(Be+=` ${$.containerAnnual}`),E(o))return pd(Be,{...Ea,accessibleLabel:$r,altAccessibleLabel:Gr,recurrenceLabel:qr,perUnitLabel:ir,taxInclusivityLabel:ar},X);let{currencySymbol:Sa,decimals:Es,decimalsDelimiter:Ss,hasCurrencySpace:Aa,integer:As,isCurrencyFirst:Cs}=Ea,tt=[As,Ss,Es];Cs?(tt.unshift(Aa?"\xA0":""),tt.unshift(Sa)):(tt.push(Aa?"\xA0":""),tt.push(Sa)),tt.push(qr,ir,ar);let Ts=tt.join("");return q(Be,Ts,X)},qo=()=>(e,r,t)=>{let i=Xe(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||i);return`${n?`${K({displayStrikethrough:!0})({isPromoApplied:i,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${K({isAlternativePrice:n})({isPromoApplied:i,...e},r,t)}`},Vo=()=>(e,r,t)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=Xe(r.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return K()(e,{...r,price:r.priceWithoutDiscount},t)+q($.containerAnnualPrefix," (")+K({displayAnnual:!0,instant:i})(n,{...r,price:r.priceWithoutDiscount},t)+q($.containerAnnualSuffix,")");let o=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${o?`${K({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${K({isAlternativePrice:o})({isPromoApplied:a,...e},r,t)}${q($.containerAnnualPrefix," (")}${K({displayAnnual:!0,instant:i})(n,r,t)}${q($.containerAnnualSuffix,")")}`},jo=()=>(e,r,t)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${K({isAlternativePrice:e.displayOldPrice})(e,r,t)}${q($.containerAnnualPrefix," (")}${K({displayAnnual:!0})(i,r,t)}${q($.containerAnnualSuffix,")")}`};var Qt={...$,containerLegal:"price-legal",planType:"price-plan-type"},Fr={...De,planTypeLabel:"planTypeLabel"};function md(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:i},a={},n=!0){let s="";return s+=q(Qt.unitType,r,null,!0),t&&i&&n&&(t+=t.endsWith(".")?" ":". "),s+=q(Qt.taxInclusivity,t,!0),s+=q(Qt.planType,i,null),q(e,s,{...a})}var Wo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:i=!1,displayDot:a=!0,language:n,literals:s={}}={},{taxDisplay:o,taxTerm:c,planType:l}={},d={})=>{let p={...pa,...s},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";E(r)&&(h=_e(p,m,Fr.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),E(t)&&c&&(u=_e(p,m,o===ma?Fr.taxExclusiveLabel:Fr.taxInclusiveLabel,{taxTerm:c}));let f="";E(i)&&l&&(f=_e(p,m,Fr.planTypeLabel,{planType:l}));let x=Qt.container;return x+=` ${Qt.containerLegal}`,md(x,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,a)};var Yo=K(),Xo=qo(),Ko=K({displayOptical:!0}),Zo=K({displayStrikethrough:!0}),Qo=K({displayPromoStrikethrough:!0}),Jo=K({displayAnnual:!0}),es=K({displayOptical:!0,isAlternativePrice:!0}),ts=K({isAlternativePrice:!0}),rs=jo(),is=Vo(),as=Wo;var ud=(e,r)=>{if(!(!Ut(e)||!Ut(r)))return Math.floor((r-e)/r*100)},ns=()=>(e,r)=>{let{price:t,priceWithoutDiscount:i}=r,a=ud(t,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var os=ns();var ss="INDIVIDUAL_COM",ga="TEAM_COM",cs="INDIVIDUAL_EDU",fa="TEAM_EDU",gd=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],fd={[ss]:[],[ga]:[],[cs]:[],[fa]:[]},vd={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},xd=[ss,ga,cs,fa],bd=e=>[ga,fa].includes(e);function ua(e,r,t,i){if(e[r])return e[r];let a=`${r}_${t}`;if(e[a])return e[a];let n;if(i)n=e.find(s=>s.startsWith(`${r}_`));else{let s=Object.keys(e).find(o=>o.startsWith(`${r}_`));n=s?e[s]:null}return n}var yd=(e,r,t,i)=>{let a=`${t}_${i}`,n=ua(vd,e,r,!1);if(n){let s=xd.indexOf(a);return n[s]}return bd(a)},wd=(e,r,t,i)=>{if(ua(gd,e,r,!0))return!0;let a=fd[`${t}_${i}`];return a?ua(a,e,r,!0)?!0:M.displayTax:M.displayTax},va=async(e,r,t,i)=>{let a=wd(e,r,t,i);return{displayTax:a,forceTaxExclusive:a?yd(e,r,t,i):M.forceTaxExclusive}},Jt=class Jt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ie(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let i=se();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=i.collectPriceOptions(t);return Pr(Jt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ue}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let i=se();if(!i)return!1;let a=i.collectPriceOptions(t,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let s=this.masElement.togglePending({});this.innerHTML="";let o=i.resolveOfferSelectors(n),c=await Promise.all(o),l=c.map(h=>{let u=Gt(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=ji(l);if(i.featureFlags[Se]||n[Se]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,x=await va(h,u,p.customerSegment,f);a.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let A=Gt(y,n);return A?.length?A[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(i.featureFlags[rt]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,s)}let m=ji(d);return this.renderOffers([m],n,s)}catch(s){throw this.innerHTML="",s}}renderOffers(t,i,a=void 0){if(!this.isConnected)return;let n=se();if(!n)return!1;if(a??(a=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(a,t,i)){this.innerHTML=n.buildPriceHTML(t,this.options);let s=this.closest("p, h3, div");if(!s||!s.querySelector('span[data-template="strikethrough"]')||s.querySelector(".alt-aria-label"))return!0;let o=s?.querySelectorAll('span[is="inline-price"]');return o.length>1&&o.length===s.querySelectorAll('span[data-template="strikethrough"]').length*2&&o.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let s=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,s,this.options))return this.innerHTML="",!0}return!1}};g(Jt,"is","inline-price"),g(Jt,"tag","span");var ke=Jt;window.customElements.get(ke.is)||window.customElements.define(ke.is,ke,{extends:ke.tag});function ls({literals:e,providers:r,settings:t}){function i(s,o=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(o&&r?.price)for(let R of r.price)R(o,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:y,quantity:A,alternativePrice:b,wcsOsi:C,...D}=Object.assign(c,o?.dataset??{},s??{});return c=wr(Object.assign({...c,...D,displayOldPrice:E(l),displayPerUnit:E(d),displayRecurrence:E(p),displayTax:E(m),displayPlanType:E(h),forceTaxExclusive:E(u),perpetual:E(f),displayAnnual:E(x),promotionCode:Sr(y).effectivePromoCode,quantity:vt(A,M.quantity),alternativePrice:E(b),wcsOsi:kr(C)})),c}function a(s,o){if(!Array.isArray(s)||!s.length||!o)return"";let{template:c}=o,l;switch(c){case"discount":l=os;break;case"strikethrough":l=Zo;break;case"promo-strikethrough":l=Qo;break;case"annual":l=Jo;break;case"legal":l=as;break;default:o.template==="optical"&&o.alternativePrice?l=es:o.template==="optical"?l=Ko:o.displayAnnual&&s[0].planType==="ABM"?l=o.promotionCode&&s[0].promotion?is:rs:o.alternativePrice?l=ts:l=o.promotionCode&&s[0].promotion?Xo:Yo}let[d]=s;return d={...d,...d.priceDetails},l({...t,...o},d)}let n=ke.createInlinePrice;return{InlinePrice:ke,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function Ed({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||M.language),r??(r=e?.split("_")?.[1]||M.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function ds(e={},r){let t=r.featureFlags[Se],{commerce:i={}}=e,a=ve.PRODUCTION,n=hi,s=H("checkoutClientId",i)??M.checkoutClientId,o=$t(H("checkoutWorkflowStep",i),ae,M.checkoutWorkflowStep),c=E(H("displayOldPrice",i),M.displayOldPrice),l=M.displayPerUnit,d=E(H("displayRecurrence",i),M.displayRecurrence),p=E(H("displayTax",i),M.displayTax),m=E(H("displayPlanType",i),M.displayPlanType),h=E(H("entitlement",i),M.entitlement),u=E(H("modal",i),M.modal),f=E(H("forceTaxExclusive",i),M.forceTaxExclusive),x=H("promotionCode",i)??M.promotionCode,y=vt(H("quantity",i)),A=H("wcsApiKey",i)??M.wcsApiKey,b=i?.env==="stage",C=ze.PUBLISHED;["true",""].includes(i.allowOverride)&&(b=(H(li,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",C=$t(H(di,i),ze,C)),b&&(a=ve.STAGE,n=pi);let R=H(ci)??e.preview,U=typeof R<"u"&&R!=="off"&&R!=="false",V={};U&&(V={preview:U});let te=H("mas-io-url")??e.masIOUrl??`https://www${a===ve.STAGE?".stage":""}.adobe.com/mas/io`,X=H("preselect-plan")??void 0,F=H("instant")??e.instant;return{...Ed(e),...V,displayOldPrice:c,checkoutClientId:s,checkoutWorkflowStep:o,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:M.extraOptions,modal:u,env:a,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:M.alternativePrice,wcsApiKey:A,wcsURL:n,landscape:C,masIOUrl:te,...X&&{preselectPlan:X},...F&&{instant:F}}}async function hs(e,r={},t=2,i=100){let a;for(let n=0;n<=t;n++)try{let s=await fetch(e,r);return s.retryCount=n,s}catch(s){if(a=s,a.retryCount=n,n>t)break;await new Promise(o=>setTimeout(o,i*(n+1)))}throw a}var xa="wcs";function ps({settings:e}){let r=oe.module(xa),{env:t,wcsApiKey:i}=e,a=new Map,n=new Map,s,o=new Map;async function c(u,f,x=!0){let y=se(),A=ni;r.debug("Fetching:",u);let b="",C;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let D=new Map(f),[R]=u.offerSelectorIds,U=Date.now()+Math.random().toString(36).substring(2,7),V=`${xa}:${R}:${U}${ui}`,te=`${xa}:${R}:${U}${gi}`,X;try{if(performance.mark(V),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",R),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===ve.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",i),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),C=await hs(b.toString(),{credentials:"omit"}),C.ok){let F=[];try{let I=await C.json();r.debug("Fetched:",u,I),F=I.resolvedOffers??[]}catch(I){r.error(`Error parsing JSON: ${I.message}`,{...I.context,...y?.duration})}F=F.map(Ar),f.forEach(({resolve:I},re)=>{let de=F.filter(({offerSelectorIds:et})=>et.includes(re)).flat();de.length&&(D.delete(re),f.delete(re),I(de))})}else A=ai}catch(F){A=`Network error: ${F.message}`}finally{X=performance.measure(te,V),performance.clearMarks(V),performance.clearMeasures(te)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=Gn(C);f.forEach(I=>{I.reject(new xt(A,{...u,...F,response:C,measure:cr(X),...y?.duration}))})}}function l(){clearTimeout(s);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ve.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,A]of Object.entries(x))a.set(y,Promise.resolve(A.map(Ar)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let u=a.size;o=new Map(a),a.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,x){let y=u!=="GB"&&!x?"MULT":"en",A=fi.includes(u)?u:M.country;return{validCountry:A,validLanguage:y,locale:`${f}_${A}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:A=[]}){let{validCountry:b,validLanguage:C,locale:D}=m(u,f,x),R=[b,C,y].filter(U=>U).join("-").toLowerCase();return A.map(U=>{let V=`${U}-${R}`;if(a.has(V))return a.get(V);let te=new Promise((X,F)=>{let I=n.get(R);I||(I={options:{country:b,locale:D,...C==="MULT"&&{language:C},offerSelectorIds:[]},promises:new Map},n.set(R,I)),y&&(I.options.promotionCode=y),I.options.offerSelectorIds.push(U),I.promises.set(U,{resolve:X,reject:F}),l()}).catch(X=>{if(o.has(V))return o.get(V);throw X});return a.set(V,te),te})}return{Commitment:Fe,PlanType:zn,Term:he,applyPlanType:Ar,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var ms="mas-commerce-service",us="mas-commerce-service:start",gs="mas-commerce-service:ready",er,yt,Qe,fs,ya,ba=class extends HTMLElement{constructor(){super(...arguments);z(this,Qe);z(this,er);z(this,yt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let s=await t?.(i,a,this.imsSignedInPromise,n);return s||null})}get featureFlags(){return v(this,yt)||L(this,yt,{[Se]:j(this,Qe,ya).call(this,Se),[rt]:j(this,Qe,ya).call(this,rt)}),v(this,yt)}activate(){let t=v(this,Qe,fs),i=ds(t,this);Cr(t.lana);let a=oe.init(t.hostEnv).module("service");a.debug("Activating:",t);let s={price:fo(i)},o={checkout:new Set,price:new Set},c={literals:s,providers:o,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...mo(c),...uo(c),...ls(c),...ps(c),...vi,Log:oe,resolvePriceTaxFlags:va,get defaults(){return M},get log(){return oe},get providers(){return{checkout(d){return o.checkout.add(d),()=>o.checkout.delete(d)},price(d){return o.price.add(d),()=>o.price.delete(d)},has:d=>o.price.has(d)||o.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:s,settings:i});let l=new CustomEvent(or,{bubbles:!0,cancelable:!1,detail:this});performance.mark(gs),L(this,er,performance.measure(gs,us)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(us),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Wr).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":cr(v(this,er))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:s})=>a===0&&n===0&&s<200||s>=400),i=Array.from(new Map(t.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};er=new WeakMap,yt=new WeakMap,Qe=new WeakSet,fs=function(){let t=this.getAttribute("env")??"prod",i={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let s=a.replace(/-([a-z])/g,o=>o[1].toUpperCase());i.commerce[s]=n}}),i},ya=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(ms)||window.customElements.define(ms,ba);var ys="merch-card-collection",Sd=3e4,Ad={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Cd={plans:!0},Td=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),_d=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(i=>t.types.includes(i)))):e,kd=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Pd=(e,{filter:r})=>e.sort((t,i)=>i.filters[r]?.order==null||isNaN(i.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-i.filters[r].order),Ld=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,He,Et,Je,rr,Ur,ws,wt=class extends xs{constructor(){super();z(this,Ur);z(this,He,{});z(this,Et);z(this,Je);z(this,rr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=Ra(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Pe` <slot></slot>
    ...
    `);wt.SortOrder=ge;customElements.define(ys,wt);var Md={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},zd=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(a=>{a.innerText=t||""})},Rd={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},Nd={catalog:"l"},ce,St,tr=class extends xs{constructor(){super();z(this,ce);z(this,St);g(this,"tablet",new At(this,N));g(this,"desktop",new At(this,T));this.collection=null,L(this,ce,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(me,this.updateLiterals),this.collection?.addEventListener(Tt,this.handleSidenavAttached),L(this,St,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(me,this.updateLiterals),this.collection?.removeEventListener(Tt,this.handleSidenavAttached)}willUpdate(){v(this,ce).search=this.getVisibility("search"),v(this,ce).filter=this.getVisibility("filter"),v(this,ce).sort=this.getVisibility("sort"),v(this,ce).result=this.getVisibility("result"),v(this,ce).custom=this.getVisibility("custom")}parseVisibilityOptions(t,i){if(!t||!Object.hasOwn(t,i))return null;let a=t[i];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(t){let i=v(this,St)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(i,t);return a!==null?a:this.parseVisibilityOptions(Rd,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,ce).search)return fe;let t=kt(this,"searchText");return t?Pe`
        ...
        `:fe}get filterAction(){return v(this,ce).filter?this.sidenav?Pe`
            ...
            ></sp-action-button>
        `:fe:fe}get sortAction(){if(!v(this,ce).sort)return fe;let t=kt(this,"sortText");if(!t)return;let i=kt(this,"popularityText"),a=kt(this,"alphabeticallyText");if(!(i&&a))return;let n=this.collection?.sort===ge.alphabetical;return Pe`
            <sp-action-menu
                id="sort"
                size="m"

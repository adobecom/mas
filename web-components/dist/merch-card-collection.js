var ca=Object.defineProperty;var la=e=>{throw TypeError(e)};var ts=(e,r,t)=>r in e?ca(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var rs=(e,r)=>{for(var t in r)ca(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>ts(e,typeof r!="symbol"?r+"":r,t),Mr=(e,r,t)=>r.has(e)||la("Cannot "+t);var b=(e,r,t)=>(Mr(e,r,"read from private field"),t?t.call(e):r.get(e)),U=(e,r,t)=>r.has(e)?la("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),N=(e,r,t,i)=>(Mr(e,r,"write to private field"),i?i.call(e,t):r.set(e,t),t),xt=(e,r,t)=>(Mr(e,r,"access private method"),t);import{html as Ce,LitElement as qo,css as Vo,unsafeCSS as Go,nothing as me}from"./lit-all.min.js";var I="(max-width: 767px)",X="(max-width: 1199px)",D="(min-width: 768px)",T="(min-width: 1200px)",Z="(min-width: 1600px)",da={matchMobile:window.matchMedia(I),matchDesktop:window.matchMedia(`${T} and (not ${Z})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(Z),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},C=da;function Xt(){return da.isDesktop}var bt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var ha="hashchange";function is(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let i of t){let[a,n=""]=i.split("=");a&&r.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function yt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([a,n])=>{n?r.set(a,n):r.delete(a)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,i)}function pa(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=is(window.location.hash);e(t)};return r(),window.addEventListener(ha,r),()=>{window.removeEventListener(ha,r)}}var ii={};rs(ii,{CLASS_NAME_FAILED:()=>Ur,CLASS_NAME_HIDDEN:()=>ns,CLASS_NAME_PENDING:()=>$r,CLASS_NAME_RESOLVED:()=>Gr,CheckoutWorkflow:()=>ys,CheckoutWorkflowStep:()=>ee,Commitment:()=>Ie,ERROR_MESSAGE_BAD_REQUEST:()=>qr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>vs,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Vr,EVENT_AEM_ERROR:()=>Br,EVENT_AEM_LOAD:()=>Hr,EVENT_MAS_ERROR:()=>Fr,EVENT_MAS_READY:()=>fs,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>us,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Or,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>de,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Dr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>wt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Ir,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>ms,EVENT_MERCH_OFFER_READY:()=>cs,EVENT_MERCH_OFFER_SELECT_READY:()=>ls,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ue,EVENT_MERCH_SEARCH_CHANGE:()=>gs,EVENT_MERCH_SIDENAV_SELECT:()=>zr,EVENT_MERCH_STOCK_CHANGE:()=>hs,EVENT_MERCH_STORAGE_CHANGE:()=>ps,EVENT_OFFER_SELECTED:()=>ds,EVENT_TYPE_FAILED:()=>jr,EVENT_TYPE_READY:()=>Kt,EVENT_TYPE_RESOLVED:()=>Ke,Env:()=>ge,FF_ANNUAL_PRICE:()=>Ze,FF_DEFAULTS:()=>we,HEADER_X_REQUEST_ID:()=>Et,LOG_NAMESPACE:()=>Wr,Landscape:()=>Pe,MARK_DURATION_SUFFIX:()=>ti,MARK_START_SUFFIX:()=>ei,MERCH_CARD_LOAD_TIMEOUT:()=>Rr,MODAL_TYPE_3_IN_1:()=>De,NAMESPACE:()=>as,PARAM_AOS_API_KEY:()=>xs,PARAM_ENV:()=>Xr,PARAM_LANDSCAPE:()=>Kr,PARAM_MAS_PREVIEW:()=>Yr,PARAM_WCS_API_KEY:()=>bs,PROVIDER_ENVIRONMENT:()=>Jr,SELECTOR_MAS_CHECKOUT_LINK:()=>ma,SELECTOR_MAS_ELEMENT:()=>Nr,SELECTOR_MAS_INLINE_PRICE:()=>j,SELECTOR_MAS_SP_BUTTON:()=>ss,SELECTOR_MAS_UPT_LINK:()=>ua,SORT_ORDER:()=>pe,STATE_FAILED:()=>he,STATE_PENDING:()=>_e,STATE_RESOLVED:()=>ye,SUPPORTED_COUNTRIES:()=>ri,TAG_NAME_SERVICE:()=>os,TEMPLATE_PRICE:()=>ws,TEMPLATE_PRICE_ANNUAL:()=>Ss,TEMPLATE_PRICE_LEGAL:()=>ne,TEMPLATE_PRICE_STRIKETHROUGH:()=>Es,Term:()=>ce,WCS_PROD_URL:()=>Zr,WCS_STAGE_URL:()=>Qr});var Ie=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ce=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),as="merch",Rr=2e4,ns="hidden",Kt="wcms:commerce:ready",os="mas-commerce-service",j='span[is="inline-price"][data-wcs-osi]',ma='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',ss="sp-button[data-wcs-osi]",ua='a[is="upt-link"]',Nr=`${j},${ma},${ua}`,cs="merch-offer:ready",ls="merch-offer-select:ready",Or="merch-card:action-menu-toggle",ds="merch-offer:selected",hs="merch-stock:change",ps="merch-storage:change",ue="merch-quantity-selector:change",ms="merch-card-quantity:change",us="merch-modal:addon-and-quantity-update",gs="merch-search:change",Ir="merch-card-collection:sort",de="merch-card-collection:literals-changed",wt="merch-card-collection:sidenav-attached",Dr="merch-card-collection:showmore",zr="merch-sidenav:select",Hr="aem:load",Br="aem:error",fs="mas:ready",Fr="mas:error",Ur="placeholder-failed",$r="placeholder-pending",Gr="placeholder-resolved",qr="Bad WCS request",Vr="Commerce offer not found",vs="Literals URL not provided",jr="mas:failed",Ke="mas:resolved",Wr="mas/commerce",Yr="mas.preview",Xr="commerce.env",Kr="commerce.landscape",xs="commerce.aosKey",bs="commerce.wcsKey",Zr="https://www.adobe.com/web_commerce_artifact",Qr="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",_e="pending",ye="resolved",Pe={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Et="X-Request-Id",ee=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),ys="UCv3",ge=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Jr={PRODUCTION:"PRODUCTION"},De={TWP:"twp",D2P:"d2p",CRM:"crm"},ei=":start",ti=":duration",ws="price",Es="price-strikethrough",Ss="annual",ne="legal",we="mas-ff-defaults",Ze="mas-ff-annual-price",pe={alphabetical:"alphabetical",authored:"authored"},ri=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var As="mas-commerce-service";var St=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function fe(e,r={},t=null,i=null){let a=i?document.createElement(e,{is:i}):document.createElement(e);t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t;for(let[n,o]of Object.entries(r))a.setAttribute(n,o);return a}function Zt(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function ai(){return window.matchMedia("(max-width: 1024px)").matches}function At(){return document.getElementsByTagName(As)?.[0]}function Tt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}import{html as Qt,nothing as Ts}from"./lit-all.min.js";var Qe,Ct=class Ct{constructor(r){g(this,"card");U(this,Qe);this.card=r,this.insertVariantStyle()}getContainer(){return N(this,Qe,b(this,Qe)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),b(this,Qe)}insertVariantStyle(){let r=this.constructor.name;if(!Ct.styleMap[r]){Ct.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let i=this.card.variant,a=Array.from(t.querySelectorAll(`merch-card[variant="${i}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${i}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of a){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${i}-${s}-height`,d=0,p=[];for(let m of o){m.style.removeProperty(l);let h=c(m);if(!h){p.push({card:m,height:0});continue}let u=Math.max(0,parseInt(window.getComputedStyle(h).height)||0);p.push({card:m,height:u}),u>d&&(d=u)}if(!(d<=0))for(let{card:m}of p)m.style.setProperty(l,`${d}px`)}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Qt`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as _t,css as _s}from"./lit-all.min.js";var va=`
:root {
...
`;var xa={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},ze=class extends _{constructor(r){super(r)}getGlobalCSS(){return va}renderLayout(){return _t`<div class="image">
                <slot name="bg-image"></slot>
    ...
    `);import{html as ya}from"./lit-all.min.js";var ba=`
:root {
...
`;var er=class extends _{constructor(r){super(r)}getGlobalCSS(){return ba}renderLayout(){return ya` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":ya`<hr />`} ${this.secureLabelFooter}`}};import{html as Le,css as Ps,unsafeCSS as Ea}from"./lit-all.min.js";var wa=`
  :root {
...
`;var Ls=32,Sa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},et=class extends _{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Le`<slot name="secure-transaction-label">
    ...
    `);import{html as tr,css as ks,unsafeCSS as Ta,nothing as Ms}from"./lit-all.min.js";var Aa=`
  :root {
...
`;var Rs=32,Ca={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},tt=class extends _{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>tr` <footer>
    ...
    `);import{html as Pt,css as Ns,nothing as rr}from"./lit-all.min.js";var _a=`
:root {
...
`;var ir={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Pa={...function(){let{whatsIncluded:e,size:r,...t}=ir;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},La={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:i,...a}=ir;return a}()},ve,xe,te=class extends _{constructor(t){super(t);U(this,ve);U(this,xe);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,i){t.dataset.template===ne&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return _a}adjustSlotPlacement(t,i,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!i.includes(s)){if(o?.classList.toggle("wide-footer",C.isDesktopOrUp),!a&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(a&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);o.prepend(m)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],C.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],C.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){b(this,ve)||(N(this,ve,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(b(this,ve)?.disconnect(),N(this,ve,null),this.syncHeights())})),b(this,ve).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(i=>({name:i,getElement:a=>a.querySelector(`[slot="${i}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),i.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Tt(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=Tt(p));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+Tt(m));for(let u of i.childNodes){if(u.classList.contains("spacer"))break;l+=Tt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${j}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Pt`<div class="divider"></div>`:rr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],i=this.card.querySelector(`[slot="heading-m"] ${j}[data-template="price"]`);i&&t.push(i);let a=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(t.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?Pt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};ve=new WeakMap,xe=new WeakMap,g(te,"variantStyle",Ns`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),g(te,"collectionOptions",{customHeaderArea:t=>t.sidenav?Pt`<slot name="resultsText"></slot>`:rr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let i=()=>{let a=t.querySelectorAll("merch-card");for(let o of a)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!C.isDesktop)return;let n=0;for(let o of a){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};C.matchDesktop.addEventListener("change",i),t.addEventListener(de,i),t.onUnmount.push(()=>{C.matchDesktop.removeEventListener("change",i),t.removeEventListener(de,i)})}});import{html as Ee,css as Os,unsafeCSS as Ma,nothing as ar}from"./lit-all.min.js";var ka=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(C.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?C.isMobile?Ee`
        ...
        `:Ee`
            ...
            `:ar}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?Ee`<slot name="icons"></slot>`:ar}get secureLabelFooter(){return Ee`<footer>
            ...
            <slot></slot>`}};g(ke,"variantStyle",Os`
...
`;var Oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},be,rt=class extends _{constructor(t){super(t);U(this,be);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Na}priceOptionsProvider(t,i){t.dataset.template===ne&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return oi` ${this.badge}
    ...
    `);import{html as si,css as Ds}from"./lit-all.min.js";var Ia=`
:root {
...
`;var Da={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},it=class extends _{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===ne&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return Ia}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${j}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return si`
    ...
    `);import{html as zs,css as Hs}from"./lit-all.min.js";var za=`
...
`;var Ha={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},at=class extends _{constructor(r){super(r)}getGlobalCSS(){return za}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return zs`
    ...
    `);import{html as ci,css as Bs}from"./lit-all.min.js";var Ba=`
:root {
...
`;var Fa={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},nt=class extends _{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Ba}renderLayout(){return ci`${this.cardImage}
            ...
            ${this.evergreen?ci`
                  ...
                  `:ci`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(nt,"variantStyle",Bs`
    ...
    `);import{html as Fs,css as Us}from"./lit-all.min.js";var Ua=`
:root {
...
`;var li={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ot=class extends _{getGlobalCSS(){return Ua}get aemFragmentMapping(){return li}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(a=>this.updateCardElementMinHeight(r.querySelector(`.${a}`),a));let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let i=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');i&&this.updateCardElementMinHeight(i,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),i=34;t.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>i;o.classList.toggle("small-font-size-button",s)})}),C.isDesktopOrUp&&t.forEach(a=>a.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Xt()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(t=>t.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let t=()=>{if(Xt())r.removeAttribute("data-expanded");else{let a=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",a?"true":"false")}};t();let i=window.matchMedia(I);this.mediaQueryListener=()=>{t()},i.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(I).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||Xt())return;let a=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",a)}renderLayout(){return Fs`
    ...
    `);import{html as Ga,css as $s}from"./lit-all.min.js";var $a=`
:root {
...
`;var di={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Lt=class Lt extends _{getGlobalCSS(){return $a}get aemFragmentMapping(){return di}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ga`
        ...
        `}async syncHeights(){if(await document.fonts.ready,await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let r=Lt.SYNCED_SECTIONS.map(s=>({name:s,getElement:c=>c.shadowRoot?.querySelector(`.${s}`)})),t=this.getContainer(),i=t?t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],a='[slot="body-s"] > *',n=Math.max(0,...Array.from(i,s=>s.querySelectorAll(a).length)),o=Array.from({length:n},(s,c)=>({name:`description-row-${c}`,getElement:l=>l.querySelectorAll(a)[c]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),i=49;t.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>i;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}renderLayout(){return Ga`
            ...
            <slot></slot>
        `}};g(Lt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(Lt,"variantStyle",$s`
    ...
    `);var kt=Lt;import{html as hi,css as Gs,nothing as qs}from"./lit-all.min.js";var qa=`
...
`;var Va={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Vs=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],st=class extends _{constructor(r){super(r)}getGlobalCSS(){return qa}renderLayout(){return hi`
    ...
    `);import{css as js,html as Ws}from"./lit-all.min.js";var ja=`
...
`;var Wa={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},ct=class extends _{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return ja}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${j}[data-template="price"]`);if(!t)return;let i=t.cloneNode(!0);this.legal=i,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return Ws`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Ys,css as Xs}from"./lit-all.min.js";var Ya=`
...
`;var pi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},lt=class extends _{getGlobalCSS(){return Ya}get aemFragmentMapping(){return pi}renderLayout(){return Ys`
    ...
    `);var Xa=new Map;var V=(e,r,t=null,i=null,a)=>{Xa.set(e,{class:r,fragmentMapping:t,style:i,collectionOptions:a})};V("catalog",Je,fa,Je.variantStyle);V("image",ze);V("inline-heading",er);V("mini-compare-chart",et,Sa,et.variantStyle);V("mini-compare-chart-mweb",tt,Ca,tt.variantStyle);V("plans",te,ir,te.variantStyle,te.collectionOptions);V("plans-students",te,La,te.variantStyle,te.collectionOptions);V("plans-education",te,Pa,te.variantStyle,te.collectionOptions);V("plans-v2",ke,Ra,ke.variantStyle,ke.collectionOptions);V("product",rt,Oa,rt.variantStyle);V("segment",it,Da,it.variantStyle);V("media",at,Ha,at.variantStyle);V("headless",st,Va,st.variantStyle);V("special-offers",nt,Fa,nt.variantStyle);V("simplified-pricing-express",ot,li,ot.variantStyle);V("full-pricing-express",kt,di,kt.variantStyle);V("mini",ct,Wa,ct.variantStyle);V("image",ze,xa,ze.variantStyle);V("fries",lt,pi,lt.variantStyle);function Jt(e){return Xa.get(e)?.fragmentMapping}var Ka="tacocat.js";var mi=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),Za=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function z(e,r={},{metadata:t=!0,search:i=!0,storage:a=!0}={}){let n;if(i&&n==null){let o=new URLSearchParams(window.location.search),s=dt(i)?i:e;n=o.get(s)}if(a&&n==null){let o=dt(a)?a:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=Zs(dt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var Ks=e=>typeof e=="boolean",nr=e=>typeof e=="function",or=e=>typeof e=="number",Qa=e=>e!=null&&typeof e=="object";var dt=e=>typeof e=="string",Ja=e=>dt(e)&&e,Mt=e=>or(e)&&Number.isFinite(e)&&e>0;function sr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,i])=>{r(i)&&delete e[t]}),e}function w(e,r){if(Ks(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Rt(e,r,t){let i=Object.values(r);return i.find(a=>mi(a,e))??t??i[0]}function Zs(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,i)=>`${t}-${i}`).replace(/\W+/gu,"-").toLowerCase()}function en(e,r=1){return or(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var Qs=Date.now(),ui=()=>`(+${Date.now()-Qs}ms)`,cr=new Set,Js=w(z("tacocat.debug",{},{metadata:!1}),!1);function tn(e){let r=`[${Ka}/${e}]`,t=(o,s,...c)=>o?!0:(a(s,...c),!1),i=Js?(o,...s)=>{console.debug(`${r} ${o}`,...s,ui())}:()=>{},a=(o,...s)=>{let c=`${r} ${o}`;cr.forEach(([l])=>l(c,...s))};return{assert:t,debug:i,error:a,warn:(o,...s)=>{let c=`${r} ${o}`;cr.forEach(([,l])=>l(c,...s))}}}function ec(e,r){let t=[e,r];return cr.add(t),()=>{cr.delete(t)}}ec((e,...r)=>{console.error(e,...r,ui())},(e,...r)=>{console.warn(e,...r,ui())});var tc="no promo",rn="promo-tag",rc="yellow",ic="neutral",ac=(e,r,t)=>{let i=n=>n||tc,a=t?` (was "${i(r)}")`:"";return`${i(e)}${a}`},nc="cancel-context",lr=(e,r)=>{let t=e===nc,i=!t&&e?.length>0,a=(i||t)&&(r&&r!=e||!r&&!t),n=a&&i||!a&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?rn:`${rn} no-promo`,text:ac(o,r,a),variant:n?rc:ic,isOverriden:a}};var gi;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(gi||(gi={}));var oe;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(oe||(oe={}));var le;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(le||(le={}));var fi;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(fi||(fi={}));var vi;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(vi||(vi={}));var xi;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(xi||(xi={}));var bi;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(bi||(bi={}));var yi="ABM",wi="PUF",Ei="M2M",Si="PERPETUAL",Ai="P3Y",oc="TAX_INCLUSIVE_DETAILS",sc="TAX_EXCLUSIVE",an={ABM:yi,PUF:wi,M2M:Ei,PERPETUAL:Si,P3Y:Ai},rm={[yi]:{commitment:oe.YEAR,term:le.MONTHLY},[wi]:{commitment:oe.YEAR,term:le.ANNUAL},[Ei]:{commitment:oe.MONTH,term:le.MONTHLY},[Si]:{commitment:oe.PERPETUAL,term:void 0},[Ai]:{commitment:oe.THREE_MONTHS,term:le.P3Y}},nn="Value is not an offer",dr=e=>{if(typeof e!="object")return nn;let{commitment:r,term:t}=e,i=cc(r,t);return{...e,planType:i}};var cc=(e,r)=>{switch(e){case void 0:return nn;case"":return"";case oe.YEAR:return r===le.MONTHLY?yi:r===le.ANNUAL?wi:"";case oe.MONTH:return r===le.MONTHLY?Ei:"";case oe.PERPETUAL:return Si;case oe.TERM_LICENSE:return r===le.P3Y?Ai:"";default:return""}};function on(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:i,priceWithoutTax:a,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==oc)return e;let s={...e,priceDetails:{...r,price:a??t,priceWithoutDiscount:n??i,taxDisplay:sc}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var He={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},sn=1e3;function lc(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function cn(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:i,originatingRequest:a,status:n}=e;return[i,n,a].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!He.serializableTypes.includes(t))return t}return e}function dc(e,r){if(!He.ignoredProperties.includes(e))return cn(r)}var Ti={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,i=[],a=[],n=r;t.forEach(l=>{l!=null&&(lc(l)?i:a).push(l)}),i.length&&(n+=` ${i.map(cn).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${He.delimiter}page=${o}${s}`;c.length>sn&&(c=`${c.slice(0,sn)}<trunc>`),n+=c,a.length&&(n+=`${He.delimiter}facts=`,n+=JSON.stringify(a,dc)),window.lana?.log(n,He)}};function hr(e){Object.assign(He,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in He&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var ln={LOCAL:"local",PROD:"prod",STAGE:"stage"},Ci={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},_i=new Set,Pi=new Set,dn=new Map,hn={append({level:e,message:r,params:t,timestamp:i,source:a}){console[e](`${i}ms [${a}] %c${r}`,"font-weight: bold;",...t)}},pn={filter:({level:e})=>e!==Ci.DEBUG},hc={filter:()=>!1};function pc(e,r,t,i,a){return{level:e,message:r,namespace:t,get params(){return i.length===1&&nr(i[0])&&(i=i[0](),Array.isArray(i)||(i=[i])),i},source:a,timestamp:performance.now().toFixed(3)}}function mc(e){[...Pi].every(r=>r(e))&&_i.forEach(r=>r(e))}function mn(e){let r=(dn.get(e)??0)+1;dn.set(e,r);let t=`${e} #${r}`,i={id:t,namespace:e,module:a=>mn(`${i.namespace}/${a}`),updateConfig:hr};return Object.values(Ci).forEach(a=>{i[a]=(n,...o)=>mc(pc(a,n,e,o,t))}),Object.seal(i)}function pr(...e){e.forEach(r=>{let{append:t,filter:i}=r;nr(i)&&Pi.add(i),nr(t)&&_i.add(t)})}function uc(e={}){let{name:r}=e,t=w(z("commerce.debug",{search:!0,storage:!0}),r===ln.LOCAL);return pr(t?hn:pn),r===ln.PROD&&pr(Ti),re}function gc(){_i.clear(),Pi.clear()}var re={...mn(Wr),Level:Ci,Plugins:{consoleAppender:hn,debugFilter:pn,quietFilter:hc,lanaAppender:Ti},init:uc,reset:gc,use:pr};var fc="mas-commerce-service",vc=re.module("utilities"),xc={requestId:Et,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Nt(e,{country:r,forceTaxExclusive:t}){let i;if(e.length<2)i=e;else{let a=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===a?-1:o.language===a?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),i=[e[0]]}return t&&(i=i.map(on)),i}var un=(e,r)=>{let t=e.reduce((i,a)=>i+(r(a)||0),0);return t>0?Math.round(t*100)/100:void 0};function Li(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let p=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?s.priceDetails?.formatString:s[l];m!==p&&vc.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:p,actual:m})}}let i=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],a={};for(let[s,c]of i){let l=un(e,c);l!==void 0&&(a[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=un(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...a,...o&&{annualized:o}}}}var mr=e=>window.setTimeout(e);function ht(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(en).filter(Mt);return t.length||(t=[r]),t}function ur(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(Ja)}function ie(){return document.getElementsByTagName(fc)?.[0]}function gn(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[i,a]of Object.entries(xc)){let n=t.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[i]=n)}return r}var pt=class e extends Error{constructor(r,t,i){if(super(r,{cause:i}),this.name="MasError",t.response){let a=t.response.headers?.get(Et);a&&(t.requestId=a),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([i,a])=>`${i}: ${JSON.stringify(a)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var bc={[he]:Ur,[_e]:$r,[ye]:Gr},yc={[he]:jr,[ye]:Ke},Ot,Me=class{constructor(r){U(this,Ot);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",_e);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=re.module("mas-element")}update(){[he,_e,ye].forEach(r=>{this.wrapperElement.classList.toggle(bc[r],r===this.state)})}notify(){(this.state===ye||this.state===he)&&(this.state===ye?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===he&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof pt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(yc[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,i){this.changes.set(r,i),this.requestUpdate()}connectedCallback(){N(this,Ot,ie()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:i}=this;return ye===i?Promise.resolve(this.wrapperElement):he===i?Promise.reject(r):new Promise((a,n)=>{t.push({resolve:a,reject:n})})}toggleResolved(r,t,i){return r!==this.version?!1:(i!==void 0&&(this.options=i),this.state=ye,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),mr(()=>this.notify()),!0)}toggleFailed(r,t,i){if(r!==this.version)return!1;i!==void 0&&(this.options=i),this.error=t,this.state=he,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...b(this,Ot)?.duration}),mr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=_e,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!ie()||this.timer)return;let{error:t,options:i,state:a,value:n,version:o}=this;this.state=_e,this.timer=mr(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===_e&&this.version===o&&(this.state=a,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,i)}})}};Ot=new WeakMap;function fn(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function gr(e,r={}){let{tag:t,is:i}=e,a=document.createElement(t,{is:i});return a.setAttribute("is",i),Object.assign(a.dataset,fn(r)),a}function vn(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,fn(r)),e):null}function wc(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Ue,Be=class Be extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new Me(this));U(this,Ue);this.setAttribute("is",Be.is)}get isUptLink(){return!0}initializeWcsData(t,i){this.setAttribute("data-wcs-osi",t),i&&this.setAttribute("data-promotion-code",i)}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),N(this,Ue,At()),b(this,Ue)&&(this.log=b(this,Ue).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),N(this,Ue,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=At();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let i=t.collectCheckoutOptions({},this);if(!i.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(i),n=t.resolveOfferSelectors(i);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=i,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,p=this.getAttribute("data-promotion-code");p&&(d+=`&promotion_code=${encodeURIComponent(p)}`),this.href=`${wc(l)}?${d}`,this.masElement.toggleResolved(a,o,i)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${i.wcsOsi}.`,o.message);return this.masElement.toggleFailed(a,s,i),!1}}static createFrom(t){let i=new Be;for(let a of t.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?i.setAttribute("class",a.value.replace("upt-link","").trim()):i.setAttribute(a.name,a.value));return i.innerHTML=t.innerHTML,i.setAttribute("tabindex",0),i}};Ue=new WeakMap,g(Be,"is","upt-link"),g(Be,"tag","a"),g(Be,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Fe=Be;window.customElements.get(Fe.is)||window.customElements.define(Fe.is,Fe,{extends:Fe.tag});function xn(e){return e&&(e.startsWith("plans")?"plans":e)}var Ec="p_draft_landscape",Sc="/store/",Ac=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),ki=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Tc=["env","workflowStep","clientId","country"],Cc=["/tw/","/hk_zh/"];function _c(e){let r=e??"";return Cc.some(t=>r.startsWith(t))}function Pc(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(_c)}function Mi(e){if(!Pc())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var bn=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),yn=e=>Ac.get(e)??e;function fr(e,r,t){for(let[i,a]of Object.entries(e)){let n=yn(i);a!=null&&t.has(n)&&r.set(n,a)}}function Lc(e){switch(e){case Jr.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function kc(e,r){for(let t in e){let i=e[t];for(let[a,n]of Object.entries(i)){if(n==null)continue;let o=yn(a);r.set(`items[${t}][${o}]`,n)}}}function Mc({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let i=e.searchParams.get("af");return e.searchParams.set("af",[i,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===De.CRM?"creative":"mini_plans"),e}function Rc(e){let r=new URLSearchParams(window.location.search),t={};bn.forEach(i=>{let a=r.get(i);a!==null&&(t[i]=a)}),Object.keys(t).length>0&&fr(t,e.searchParams,bn)}function wn(e){Nc(e);let{env:r,items:t,workflowStep:i,marketSegment:a,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:p,...m}=e,h=new URL(Lc(r));if(h.pathname=`${Sc}${i}`,i!==ee.SEGMENTATION&&i!==ee.CHANGE_PLAN_TEAM_PLANS&&kc(t,h.searchParams),fr({...m},h.searchParams,ki),Rc(h),c===Pe.DRAFT&&fr({af:Ec},h.searchParams,ki),i===ee.SEGMENTATION){let u={marketSegment:a,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};p?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):p?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),fr(u,h.searchParams,ki),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=Mc({url:h,modal:l,is3in1:d})}return Mi(h)}function Nc(e){for(let r of Tc)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==ee.SEGMENTATION&&e.workflowStep!==ee.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var Oc=/[0-9\-+#]/,Ic=/[^\d\-+#]/g;function En(e){return e.search(Oc)}function Dc(e="#.##"){let r={},t=e.length,i=En(e);r.prefix=i>0?e.substring(0,i):"";let a=En(e.split("").reverse().join("")),n=t-a,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=a>0?e.substring(s,t):"",r.mask=e.substring(i,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(Ic);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function zc(e,r,t){let i=!1,a={value:e};e<0&&(i=!0,a.value=-a.value),a.sign=i?"-":"",a.value=Number(a.value).toFixed(r.fraction&&r.fraction.length),a.value=Number(a.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=a.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),a.integer=o,a.fraction=s,Hc(a,r),(a.result==="0"||a.result==="")&&(i=!1,a.sign=""),!i&&r.maskHasPositiveSign?a.sign="+":i&&r.maskHasPositiveSign?a.sign="-":i&&(a.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),a}function Hc(e,r){e.result="";let t=r.integer.split(r.separator),i=t.join(""),a=i&&i.indexOf("0");if(a>-1)for(;e.integer.length<i.length-a;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function Bc(e,r,t={}){if(!e||isNaN(Number(r)))return r;let i=Dc(e),a=zc(r,i,t);return i.prefix+a.sign+a.result+i.suffix}var Sn=Bc;var An=".",Fc=",",Cn=/^\s+/,_n=/\s+$/,Tn="&nbsp;",Ri=e=>e*12,Ge=(e,r,t=1)=>{if(!e)return!1;let{start:i,end:a,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!i||!a)return!1;let d=new Date(i),p=new Date(a);return l>=d&&l<=p},$e={MONTH:"MONTH",YEAR:"YEAR"},Uc={[ce.ANNUAL]:12,[ce.MONTHLY]:1,[ce.THREE_YEARS]:36,[ce.TWO_YEARS]:24},Ni=(e,r)=>({accept:e,round:r}),$c=[Ni(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),Ni(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),Ni(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],Oi={[Ie.YEAR]:{[ce.MONTHLY]:$e.MONTH,[ce.ANNUAL]:$e.YEAR},[Ie.MONTH]:{[ce.MONTHLY]:$e.MONTH}},Gc=(e,r)=>e.indexOf(`'${r}'`)===0,qc=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),i=Ln(t);return!!i?r||(t=t.replace(/[,\.]0+/,i)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${jc(e)}`),t},Vc=e=>{let r=Wc(e),t=Gc(e,r),i=e.replace(/'.*?'/,""),a=Cn.test(i)||_n.test(i);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:a}},Pn=e=>e.replace(Cn,Tn).replace(_n,Tn),jc=e=>e.match(/#(.?)#/)?.[1]===An?Fc:An,Wc=e=>e.match(/'(.*?)'/)?.[1]??"",Ln=e=>e.match(/0(.?)0/)?.[1]??"";function mt({formatString:e,price:r,usePrecision:t,isIndianPrice:i=!1},a,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=Vc(e),l=t?Ln(e):"",d=qc(e,t),p=t?2:0,m=n(r,{currencySymbol:o}),h=i?m.toLocaleString("hi-IN",{minimumFractionDigits:p,maximumFractionDigits:p}):Sn(d,m),u=t?h.lastIndexOf(l):h.length,f=h.substring(0,u),v=h.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:v,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:a}}var kn=e=>{let{commitment:r,term:t,usePrecision:i}=e,a=Uc[t]??1;return mt(e,a>1?$e.MONTH:Oi[r]?.[t],n=>{let o={divisor:a,price:n,usePrecision:i},{round:s}=$c.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},Mn=({commitment:e,term:r,...t})=>mt(t,Oi[e]?.[r]),Rn=e=>{let{commitment:r,instant:t,price:i,originalPrice:a,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===Ie.YEAR&&c===ce.MONTHLY){if(!o)return mt(e,$e.YEAR,Ri);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(Ge(o,t,s)){let p=parseInt(d.replace("P","").replace("M",""));if(isNaN(p))return Ri(i);let m=a*p,h=n*(12-p),u=Math.round((m+h)*100)/100;return mt({...e,price:u},$e.YEAR)}default:return mt(e,$e.YEAR,()=>Ri(n??i))}}return mt(e,Oi[r]?.[c])};var Nn="download",On="upgrade",In={e:"EDU",t:"TEAM"};function Dn(e,r={},t=""){let i=ie();if(!i)return null;let{checkoutMarketSegment:a,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f}=i.collectCheckoutOptions(r),v=gr(e,{checkoutMarketSegment:a,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f});return t&&(v.innerHTML=`<span style="pointer-events: none;">${t}</span>`),v}function zn(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new Me(this))}attributeChangedCallback(i,a,n){this.masElement.attributeChangedCallback(i,a,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let i=this.options?.ms??this.value?.[0].marketSegments?.[0];return In[i]??i}get customerSegment(){let i=this.options?.cs??this.value?.[0]?.customerSegment;return In[i]??i}get is3in1Modal(){return Object.values(De).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let i=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!i||i.content!=="off")}requestUpdate(i=!1){return this.masElement.requestUpdate(i)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(i={}){let a=ie();if(!a)return!1;this.dataset.imsCountry||a.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),i.imsCountry=null;let n=a.collectCheckoutOptions(i,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=a.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>Nt(h,n));let d=l.flat().find(h=>h.promotion);!Ge(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let m=await a.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},m,s)}renderOffers(i,a,n={},o=void 0,s=void 0){let c=ie();if(!c)return!1;if(a={...JSON.parse(this.dataset.extraOptions??"{}"),...a,...n},s??(s=this.masElement.togglePending(a)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(Nn,On),this.masElement.toggleResolved(s,i,a);let{url:d,text:p,className:m,handler:h}=o;d&&this.setCheckoutUrl(Mi(d)),p&&(this.firstElementChild.innerHTML=p),m&&this.classList.add(...m.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(i.length){if(this.masElement.toggleResolved(s,i,a)){if(!this.classList.contains(Nn)&&!this.classList.contains(On)){let d=c.buildCheckoutURL(i,a);this.setCheckoutUrl(a.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,a))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(i){}updateOptions(i={}){let a=ie();if(!a)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}=a.collectCheckoutOptions(i);return vn(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}),!0}}}var It=class It extends zn(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return Dn(It,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(It,"is","checkout-link"),g(It,"tag","a");var Se=It;window.customElements.get(Se.is)||window.customElements.define(Se.is,Se,{extends:Se.tag});var k=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:ee.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:ge.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Pe.PUBLISHED});function Hn({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u};if(o)for(let Ye of r.checkout)Ye(o,f);let{checkoutMarketSegment:v,checkoutWorkflowStep:y=c,imsCountry:S,country:x=S??l,language:A=d,quantity:O=m,entitlement:M,upgrade:F,modal:q,perpetual:Q,promotionCode:W=p,wcsOsi:B,extraOptions:R,...J}=Object.assign(f,o?.dataset??{},n??{}),se=Rt(y,ee,k.checkoutWorkflowStep);return f=sr({...J,extraOptions:R,checkoutClientId:s,checkoutMarketSegment:v,country:x,quantity:ht(O,k.quantity),checkoutWorkflowStep:se,language:A,entitlement:w(M),upgrade:w(F),modal:q,perpetual:w(Q),promotionCode:lr(W).effectivePromoCode,wcsOsi:ur(B),preselectPlan:h}),f}function i(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:p,country:m,promotionCode:h,quantity:u,preselectPlan:f,ms:v,cs:y,...S}=t(o),x=document.querySelector("meta[name=mas-ff-3in1]"),A=Object.values(De).includes(o.modal)&&(!x||x.content!=="off"),O=window.frameElement||A?"if":"fp",[{productArrangementCode:M,marketSegments:[F],customerSegment:q,offerType:Q}]=n,W=v??F??d,B=y??q;f?.toLowerCase()==="edu"?W="EDU":f?.toLowerCase()==="team"&&(B="TEAM");let R={is3in1:A,checkoutPromoCode:h,clientId:l,context:O,country:m,env:s,items:[],marketSegment:W,customerSegment:B,offerType:Q,productArrangementCode:M,workflowStep:p,landscape:c,...S},J=u[0]>1?u[0]:void 0;if(n.length===1){let{offerId:se}=n[0];R.items.push({id:se,quantity:J})}else R.items.push(...n.map(({offerId:se,productArrangementCode:Ye})=>({id:se,quantity:J,...A?{productArrangementCode:Ye}:{}})));return wn(R)}let{createCheckoutLink:a}=Se;return{CheckoutLink:Se,CheckoutWorkflowStep:ee,buildCheckoutURL:i,collectCheckoutOptions:t,createCheckoutLink:a}}function Yc({interval:e=200,maxAttempts:r=25}={}){let t=re.module("ims");return new Promise(i=>{t.debug("Waing for IMS to be ready");let a=0;function n(){window.adobeIMS?.initialized?i():++a>r?(t.debug("Timeout"),i()):setTimeout(n,e)}n()})}function Xc(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Kc(e){let r=re.module("ims");return e.then(t=>t?window.adobeIMS.getProfile().then(({countryCode:i})=>(r.debug("Got user country:",i),i),i=>{r.error("Unable to get user country:",i)}):null)}function Bn({}){let e=Yc(),r=Xc(e),t=Kc(r);return{imsReadyPromise:e,imsSignedInPromise:r,imsCountryPromise:t}}var Fn=window.masPriceLiterals;function Un(e){if(Array.isArray(Fn)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=a=>Fn.find(n=>mi(n.lang,a)),i=t(r)??t(k.language);if(i)return Object.freeze(i)}return{}}var Ii=function(e,r){return Ii=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,i){t.__proto__=i}||function(t,i){for(var a in i)Object.prototype.hasOwnProperty.call(i,a)&&(t[a]=i[a])},Ii(e,r)};function Dt(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");Ii(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var P=function(){return P=Object.assign||function(r){for(var t,i=1,a=arguments.length;i<a;i++){t=arguments[i];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},P.apply(this,arguments)};function vr(e,r,t){if(t||arguments.length===2)for(var i=0,a=r.length,n;i<a;i++)(n||!(i in r))&&(n||(n=Array.prototype.slice.call(r,0,i)),n[i]=r[i]);return e.concat(n||Array.prototype.slice.call(r))}var E;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(E||(E={}));var H;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(H||(H={}));var qe;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(qe||(qe={}));function Di(e){return e.type===H.literal}function $n(e){return e.type===H.argument}function xr(e){return e.type===H.number}function br(e){return e.type===H.date}function yr(e){return e.type===H.time}function wr(e){return e.type===H.select}function Er(e){return e.type===H.plural}function Gn(e){return e.type===H.pound}function Sr(e){return e.type===H.tag}function Ar(e){return!!(e&&typeof e=="object"&&e.type===qe.number)}function zt(e){return!!(e&&typeof e=="object"&&e.type===qe.dateTime)}var zi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var Zc=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function qn(e){var r={};return e.replace(Zc,function(t){var i=t.length;switch(t[0]){case"G":r.era=i===4?"long":i===5?"narrow":"short";break;case"y":r.year=i===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][i-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][i-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=i===4?"short":i===5?"narrow":"short";break;case"e":if(i<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][i-4];break;case"c":if(i<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][i-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][i-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][i-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][i-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][i-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][i-1];break;case"s":r.second=["numeric","2-digit"][i-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=i<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var Vn=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Xn(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(Vn).filter(function(m){return m.length>0}),t=[],i=0,a=r;i<a.length;i++){var n=a[i],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var p=d[l];if(p.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function Qc(e){return e.replace(/^(.*?)-/,"")}var jn=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Kn=/^(@+)?(\+|#+)?[rs]?$/g,Jc=/(\*)(0+)|(#+)(0+)|(0+)/g,Zn=/^(0+)$/;function Wn(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(Kn,function(t,i,a){return typeof a!="string"?(r.minimumSignificantDigits=i.length,r.maximumSignificantDigits=i.length):a==="+"?r.minimumSignificantDigits=i.length:i[0]==="#"?r.maximumSignificantDigits=i.length:(r.minimumSignificantDigits=i.length,r.maximumSignificantDigits=i.length+(typeof a=="string"?a.length:0)),""}),r}function Qn(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function el(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!Zn.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function Yn(e){var r={},t=Qn(e);return t||r}function Jn(e){for(var r={},t=0,i=e;t<i.length;t++){var a=i[t];switch(a.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=a.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=Qc(a.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=P(P(P({},r),{notation:"scientific"}),a.options.reduce(function(c,l){return P(P({},c),Yn(l))},{}));continue;case"engineering":r=P(P(P({},r),{notation:"engineering"}),a.options.reduce(function(c,l){return P(P({},c),Yn(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(a.options[0]);continue;case"integer-width":if(a.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");a.options[0].replace(Jc,function(c,l,d,p,m,h){if(l)r.minimumIntegerDigits=d.length;else{if(p&&m)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Zn.test(a.stem)){r.minimumIntegerDigits=a.stem.length;continue}if(jn.test(a.stem)){if(a.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");a.stem.replace(jn,function(c,l,d,p,m,h){return d==="*"?r.minimumFractionDigits=l.length:p&&p[0]==="#"?r.maximumFractionDigits=p.length:m&&h?(r.minimumFractionDigits=m.length,r.maximumFractionDigits=m.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=a.options[0];n==="w"?r=P(P({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=P(P({},r),Wn(n)));continue}if(Kn.test(a.stem)){r=P(P({},r),Wn(a.stem));continue}var o=Qn(a.stem);o&&(r=P(P({},r),o));var s=el(a.stem);s&&(r=P(P({},r),s))}return r}var Ht={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function eo(e,r){for(var t="",i=0;i<e.length;i++){var a=e.charAt(i);if(a==="j"){for(var n=0;i+1<e.length&&e.charAt(i+1)===a;)n++,i++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=tl(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else a==="J"?t+="H":t+=a}return t}function tl(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,i;t!=="root"&&(i=e.maximize().region);var a=Ht[i||""]||Ht[t||""]||Ht["".concat(t,"-001")]||Ht["001"];return a[0]}var Hi,rl=new RegExp("^".concat(zi.source,"*")),il=new RegExp("".concat(zi.source,"*$"));function L(e,r){return{start:e,end:r}}var al=!!String.prototype.startsWith,nl=!!String.fromCodePoint,ol=!!Object.fromEntries,sl=!!String.prototype.codePointAt,cl=!!String.prototype.trimStart,ll=!!String.prototype.trimEnd,dl=!!Number.isSafeInteger,hl=dl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Fi=!0;try{to=no("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Fi=((Hi=to.exec("a"))===null||Hi===void 0?void 0:Hi[0])==="a"}catch{Fi=!1}var to,ro=al?function(r,t,i){return r.startsWith(t,i)}:function(r,t,i){return r.slice(i,i+t.length)===t},Ui=nl?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var i="",a=r.length,n=0,o;a>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");i+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return i},io=ol?Object.fromEntries:function(r){for(var t={},i=0,a=r;i<a.length;i++){var n=a[i],o=n[0],s=n[1];t[o]=s}return t},ao=sl?function(r,t){return r.codePointAt(t)}:function(r,t){var i=r.length;if(!(t<0||t>=i)){var a=r.charCodeAt(t),n;return a<55296||a>56319||t+1===i||(n=r.charCodeAt(t+1))<56320||n>57343?a:(a-55296<<10)+(n-56320)+65536}},pl=cl?function(r){return r.trimStart()}:function(r){return r.replace(rl,"")},ml=ll?function(r){return r.trimEnd()}:function(r){return r.replace(il,"")};function no(e,r){return new RegExp(e,r)}var $i;Fi?(Bi=no("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),$i=function(r,t){var i;Bi.lastIndex=t;var a=Bi.exec(r);return(i=a[1])!==null&&i!==void 0?i:""}):$i=function(r,t){for(var i=[];;){var a=ao(r,t);if(a===void 0||so(a)||fl(a))break;i.push(a),t+=a>=65536?2:1}return Ui.apply(void 0,i)};var Bi,oo=function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,i){for(var a=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,i);if(o.err)return o;a.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),a.push({type:H.pound,location:L(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(i)break;return this.error(E.UNMATCHED_CLOSING_TAG,L(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&Gi(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;a.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;a.push(o.val)}}}return{val:a,err:null}},e.prototype.parseTag=function(r,t){var i=this.clonePosition();this.bump();var a=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:H.literal,value:"<".concat(a,"/>"),location:L(i,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Gi(this.char()))return this.error(E.INVALID_TAG,L(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return a!==l?this.error(E.UNMATCHED_CLOSING_TAG,L(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:H.tag,value:a,children:o,location:L(i,this.clonePosition())},err:null}:this.error(E.INVALID_TAG,L(s,this.clonePosition())))}else return this.error(E.UNCLOSED_TAG,L(i,this.clonePosition()))}else return this.error(E.INVALID_TAG,L(i,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&gl(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var i=this.clonePosition(),a="";;){var n=this.tryParseQuote(t);if(n){a+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){a+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){a+=s;continue}break}var c=L(i,this.clonePosition());return{val:{type:H.literal,value:a,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!ul(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var i=this.char();if(i===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(i);this.bump()}return Ui.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var i=this.char();return i===60||i===123||i===35&&(t==="plural"||t==="selectordinal")||i===125&&r>0?null:(this.bump(),Ui(i))},e.prototype.parseArgument=function(r,t){var i=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(E.EXPECT_ARGUMENT_CLOSING_BRACE,L(i,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(E.EMPTY_ARGUMENT,L(i,this.clonePosition()));var a=this.parseIdentifierIfPossible().value;if(!a)return this.error(E.MALFORMED_ARGUMENT,L(i,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(E.EXPECT_ARGUMENT_CLOSING_BRACE,L(i,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:H.argument,value:a,location:L(i,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(E.EXPECT_ARGUMENT_CLOSING_BRACE,L(i,this.clonePosition())):this.parseArgumentOptions(r,t,a,i);default:return this.error(E.MALFORMED_ARGUMENT,L(i,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),i=$i(this.message,t),a=t+i.length;this.bumpTo(a);var n=this.clonePosition(),o=L(r,n);return{value:i,location:o}},e.prototype.parseArgumentOptions=function(r,t,i,a){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(E.EXPECT_ARGUMENT_TYPE,L(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),p=this.parseSimpleArgStyleIfPossible();if(p.err)return p;var m=ml(p.val);if(m.length===0)return this.error(E.EXPECT_ARGUMENT_STYLE,L(this.clonePosition(),this.clonePosition()));var h=L(d,this.clonePosition());l={style:m,styleLocation:h}}var u=this.tryParseArgumentClose(a);if(u.err)return u;var f=L(a,this.clonePosition());if(l&&ro(l?.style,"::",0)){var v=pl(l.style.slice(2));if(s==="number"){var p=this.parseNumberSkeletonFromString(v,l.styleLocation);return p.err?p:{val:{type:H.number,value:i,location:f,style:p.val},err:null}}else{if(v.length===0)return this.error(E.EXPECT_DATE_TIME_SKELETON,f);var y=v;this.locale&&(y=eo(v,this.locale));var m={type:qe.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?qn(y):{}},S=s==="date"?H.date:H.time;return{val:{type:S,value:i,location:f,style:m},err:null}}}return{val:{type:s==="number"?H.number:s==="date"?H.date:H.time,value:i,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var x=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(E.EXPECT_SELECT_ARGUMENT_OPTIONS,L(x,P({},x)));this.bumpSpace();var A=this.parseIdentifierIfPossible(),O=0;if(s!=="select"&&A.value==="offset"){if(!this.bumpIf(":"))return this.error(E.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,L(this.clonePosition(),this.clonePosition()));this.bumpSpace();var p=this.tryParseDecimalInteger(E.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,E.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(p.err)return p;this.bumpSpace(),A=this.parseIdentifierIfPossible(),O=p.val}var M=this.tryParsePluralOrSelectOptions(r,s,t,A);if(M.err)return M;var u=this.tryParseArgumentClose(a);if(u.err)return u;var F=L(a,this.clonePosition());return s==="select"?{val:{type:H.select,value:i,options:io(M.val),location:F},err:null}:{val:{type:H.plural,value:i,options:io(M.val),offset:O,pluralType:s==="plural"?"cardinal":"ordinal",location:F},err:null}}default:return this.error(E.INVALID_ARGUMENT_TYPE,L(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(E.EXPECT_ARGUMENT_CLOSING_BRACE,L(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var i=this.char();switch(i){case 39:{this.bump();var a=this.clonePosition();if(!this.bumpUntil("'"))return this.error(E.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,L(a,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var i=[];try{i=Xn(r)}catch{return this.error(E.INVALID_NUMBER_SKELETON,t)}return{val:{type:qe.number,tokens:i,location:t,parsedOptions:this.shouldParseSkeletons?Jn(i):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,i,a){for(var n,o=!1,s=[],c=new Set,l=a.value,d=a.location;;){if(l.length===0){var p=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var m=this.tryParseDecimalInteger(E.EXPECT_PLURAL_ARGUMENT_SELECTOR,E.INVALID_PLURAL_ARGUMENT_SELECTOR);if(m.err)return m;d=L(p,this.clonePosition()),l=this.message.slice(p.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?E.DUPLICATE_SELECT_ARGUMENT_SELECTOR:E.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?E.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:E.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,L(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(r+1,t,i);if(u.err)return u;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:u.val,location:L(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?E.EXPECT_SELECT_ARGUMENT_SELECTOR:E.EXPECT_PLURAL_ARGUMENT_SELECTOR,L(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(E.MISSING_OTHER_CLAUSE,L(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var i=1,a=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(i=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=L(a,this.clonePosition());return n?(o*=i,hl(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=ao(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(ro(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),i=this.message.indexOf(r,t);return i>=0?(this.bumpTo(i),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&so(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),i=this.message.charCodeAt(t+(r>=65536?2:1));return i??null},e}();function Gi(e){return e>=97&&e<=122||e>=65&&e<=90}function ul(e){return Gi(e)||e===47}function gl(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function so(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function fl(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function qi(e){e.forEach(function(r){if(delete r.location,wr(r)||Er(r))for(var t in r.options)delete r.options[t].location,qi(r.options[t].value);else xr(r)&&Ar(r.style)||(br(r)||yr(r))&&zt(r.style)?delete r.style.location:Sr(r)&&qi(r.children)})}function co(e,r){r===void 0&&(r={}),r=P({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new oo(e,r).parse();if(t.err){var i=SyntaxError(E[t.err.kind]);throw i.location=t.err.location,i.originalMessage=t.err.message,i}return r?.captureLocation||qi(t.val),t.val}function Bt(e,r){var t=r&&r.cache?r.cache:El,i=r&&r.serializer?r.serializer:wl,a=r&&r.strategy?r.strategy:xl;return a(e,{cache:t,serializer:i})}function vl(e){return e==null||typeof e=="number"||typeof e=="boolean"}function lo(e,r,t,i){var a=vl(i)?i:t(i),n=r.get(a);return typeof n>"u"&&(n=e.call(this,i),r.set(a,n)),n}function ho(e,r,t){var i=Array.prototype.slice.call(arguments,3),a=t(i),n=r.get(a);return typeof n>"u"&&(n=e.apply(this,i),r.set(a,n)),n}function Vi(e,r,t,i,a){return t.bind(r,e,i,a)}function xl(e,r){var t=e.length===1?lo:ho;return Vi(e,this,t,r.cache.create(),r.serializer)}function bl(e,r){return Vi(e,this,ho,r.cache.create(),r.serializer)}function yl(e,r){return Vi(e,this,lo,r.cache.create(),r.serializer)}var wl=function(){return JSON.stringify(arguments)};function ji(){this.cache=Object.create(null)}ji.prototype.get=function(e){return this.cache[e]};ji.prototype.set=function(e,r){this.cache[e]=r};var El={create:function(){return new ji}},Tr={variadic:bl,monadic:yl};var Ve;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Ve||(Ve={}));var Ft=function(e){Dt(r,e);function r(t,i,a){var n=e.call(this,t)||this;return n.code=i,n.originalMessage=a,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r}(Error);var Wi=function(e){Dt(r,e);function r(t,i,a,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(i,'". Options are "').concat(Object.keys(a).join('", "'),'"'),Ve.INVALID_VALUE,n)||this}return r}(Ft);var po=function(e){Dt(r,e);function r(t,i,a){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(i),Ve.INVALID_VALUE,a)||this}return r}(Ft);var mo=function(e){Dt(r,e);function r(t,i){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(i,'"'),Ve.MISSING_VALUE,i)||this}return r}(Ft);var K;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(K||(K={}));function Sl(e){return e.length<2?e:e.reduce(function(r,t){var i=r[r.length-1];return!i||i.type!==K.literal||t.type!==K.literal?r.push(t):i.value+=t.value,r},[])}function Al(e){return typeof e=="function"}function Ut(e,r,t,i,a,n,o){if(e.length===1&&Di(e[0]))return[{type:K.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(Di(d)){s.push({type:K.literal,value:d.value});continue}if(Gn(d)){typeof n=="number"&&s.push({type:K.literal,value:t.getNumberFormat(r).format(n)});continue}var p=d.value;if(!(a&&p in a))throw new mo(p,o);var m=a[p];if($n(d)){(!m||typeof m=="string"||typeof m=="number")&&(m=typeof m=="string"||typeof m=="number"?String(m):""),s.push({type:typeof m=="string"?K.literal:K.object,value:m});continue}if(br(d)){var h=typeof d.style=="string"?i.date[d.style]:zt(d.style)?d.style.parsedOptions:void 0;s.push({type:K.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(yr(d)){var h=typeof d.style=="string"?i.time[d.style]:zt(d.style)?d.style.parsedOptions:i.time.medium;s.push({type:K.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(xr(d)){var h=typeof d.style=="string"?i.number[d.style]:Ar(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(m=m*(h.scale||1)),s.push({type:K.literal,value:t.getNumberFormat(r,h).format(m)});continue}if(Sr(d)){var u=d.children,f=d.value,v=a[f];if(!Al(v))throw new po(f,"function",o);var y=Ut(u,r,t,i,a,n),S=v(y.map(function(O){return O.value}));Array.isArray(S)||(S=[S]),s.push.apply(s,S.map(function(O){return{type:typeof O=="string"?K.literal:K.object,value:O}}))}if(wr(d)){var x=d.options[m]||d.options.other;if(!x)throw new Wi(d.value,m,Object.keys(d.options),o);s.push.apply(s,Ut(x.value,r,t,i,a));continue}if(Er(d)){var x=d.options["=".concat(m)];if(!x){if(!Intl.PluralRules)throw new Ft(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Ve.MISSING_INTL_API,o);var A=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));x=d.options[A]||d.options.other}if(!x)throw new Wi(d.value,m,Object.keys(d.options),o);s.push.apply(s,Ut(x.value,r,t,i,a,m-(d.offset||0)));continue}}return Sl(s)}function Tl(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,i){return t[i]=P(P({},e[i]),r[i]||{}),t},{})):e}function Cl(e,r){return r?Object.keys(e).reduce(function(t,i){return t[i]=Tl(e[i],r[i]),t},P({},e)):e}function Yi(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function _l(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Bt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.NumberFormat).bind.apply(r,vr([void 0],t,!1)))},{cache:Yi(e.number),strategy:Tr.variadic}),getDateTimeFormat:Bt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.DateTimeFormat).bind.apply(r,vr([void 0],t,!1)))},{cache:Yi(e.dateTime),strategy:Tr.variadic}),getPluralRules:Bt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.PluralRules).bind.apply(r,vr([void 0],t,!1)))},{cache:Yi(e.pluralRules),strategy:Tr.variadic})}}var uo=function(){function e(r,t,i,a){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==K.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Ut(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Cl(e.formats,i),this.formatters=a&&a.formatters||_l(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=co,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var go=uo;var Xi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Pl=tn("ConsonantTemplates/price"),Ll=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Re={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ki="TAX_EXCLUSIVE",kl=e=>Qa(e)?Object.entries(e).filter(([,r])=>dt(r)||or(r)||r===!0).reduce((r,[t,i])=>`${r} ${t}${i===!0?"":`="${Za(i)}"`}`,""):"",G=(e,r,t,i=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${kl(t)}>${i?Pn(r):r??""}</span>`;function Ml(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function Rl(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function Ae(e,r,t,i){let a=e[t];if(a==null)return"";let n=a.includes("<"),o=a.includes("<a ");try{a=o?Ml(a):a,a=n?a.replace(Ll,""):a;let s=new go(a,r).format(i);return o?Rl(s):s}catch{return Pl.error("Failed to format literal:",a),""}}function Nl(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=G($.currencySymbol,i),u=G($.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=G($.integer,s),f+=G($.decimalsDelimiter,n),f+=G($.decimals,a),c||(f+=u+h),f+=G($.recurrence,l,null,!0),f+=G($.unitType,d,null,!0),f+=G($.taxInclusivity,p,!0),G(e,f,{...m})}var Y=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:v,offerSelectorIds:y,formatString:S,price:x,priceWithoutDiscount:A,taxDisplay:O,taxTerm:M,term:F,usePrecision:q,promotion:Q}={},W={})=>{Object.entries({country:o,formatString:S,language:p,price:x}).forEach(([Jo,es])=>{if(es==null)throw new Error(`Argument "${Jo}" is missing for osi ${y?.toString()}, country ${o}, language ${p}`)});let B={...Xi,...m},R=`${p.toLowerCase()}-${o.toUpperCase()}`,J;Q&&!f&&A?J=e||i?x:A:t&&A?J=A:J=x;let se=r?kn:Mn;a&&(se=Rn);let{accessiblePrice:Ye,recurrenceTerm:aa,...na}=se({commitment:v,formatString:S,instant:n,isIndianPrice:o==="IN",originalPrice:x,priceWithoutDiscount:A,price:r?x:J,promotion:Q,quantity:h,term:F,usePrecision:q}),Pr="",Lr="",kr="";w(c)&&aa&&(kr=Ae(B,R,Re.recurrenceLabel,{recurrenceTerm:aa}));let Wt="";w(l)&&(u&&(Wt+=" "),Wt+=Ae(B,R,Re.perUnitLabel,{perUnit:"LICENSE"}));let Yt="";w(d)&&M&&(u&&(Yt+=" "),Yt+=Ae(B,R,O===Ki?Re.taxExclusiveLabel:Re.taxInclusiveLabel,{taxTerm:M})),t&&(Pr=Ae(B,R,Re.strikethroughAriaLabel,{strikethroughPrice:Pr})),e&&(Lr=Ae(B,R,Re.alternativePriceAriaLabel,{alternativePrice:Lr}));let Oe=$.container;if(r&&(Oe+=` ${$.containerOptical}`),t&&(Oe+=` ${$.containerStrikethrough}`),i&&(Oe+=` ${$.containerPromoStrikethrough}`),e&&(Oe+=` ${$.containerAlternative}`),a&&(Oe+=` ${$.containerAnnual}`),w(s))return Nl(Oe,{...na,accessibleLabel:Pr,altAccessibleLabel:Lr,recurrenceLabel:kr,perUnitLabel:Wt,taxInclusivityLabel:Yt},W);let{currencySymbol:oa,decimals:Yo,decimalsDelimiter:Xo,hasCurrencySpace:sa,integer:Ko,isCurrencyFirst:Zo}=na,Xe=[Ko,Xo,Yo];Zo?(Xe.unshift(sa?"\xA0":""),Xe.unshift(oa)):(Xe.push(sa?"\xA0":""),Xe.push(oa)),Xe.push(kr,Wt,Yt);let Qo=Xe.join("");return G(Oe,Qo,W)},fo=()=>(e,r,t)=>{let i=Ge(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||i);return`${n?`${Y({displayStrikethrough:!0})({isPromoApplied:i,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${Y({isAlternativePrice:n})({isPromoApplied:i,...e},r,t)}`},vo=()=>(e,r,t)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=Ge(r.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return Y()(e,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualPrefix," (")+Y({displayAnnual:!0,instant:i})(n,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${Y({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${Y({isAlternativePrice:s})({isPromoApplied:a,...e},r,t)}${G($.containerAnnualPrefix," (")}${Y({displayAnnual:!0,instant:i})(n,r,t)}${G($.containerAnnualSuffix,")")}`},xo=()=>(e,r,t)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${Y({isAlternativePrice:e.displayOldPrice})(e,r,t)}${G($.containerAnnualPrefix," (")}${Y({displayAnnual:!0})(i,r,t)}${G($.containerAnnualSuffix,")")}`};var $t={...$,containerLegal:"price-legal",planType:"price-plan-type"},Cr={...Re,planTypeLabel:"planTypeLabel"};function Ol(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:i},a={},n=!0){let o="";return o+=G($t.unitType,r,null,!0),t&&i&&n&&(t+=". "),o+=G($t.taxInclusivity,t,!0),o+=G($t.planType,i,null),G(e,o,{...a})}var bo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:i=!1,displayDot:a=!0,language:n,literals:o={}}={},{taxDisplay:s,taxTerm:c,planType:l}={},d={})=>{let p={...Xi,...o},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";w(r)&&(h=Ae(p,m,Cr.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),w(t)&&c&&(u=Ae(p,m,s===Ki?Cr.taxExclusiveLabel:Cr.taxInclusiveLabel,{taxTerm:c}));let f="";w(i)&&l&&(f=Ae(p,m,Cr.planTypeLabel,{planType:l}));let v=$t.container;return v+=` ${$t.containerLegal}`,Ol(v,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,a)};var yo=Y(),wo=fo(),Eo=Y({displayOptical:!0}),So=Y({displayStrikethrough:!0}),Ao=Y({displayPromoStrikethrough:!0}),To=Y({displayAnnual:!0}),Co=Y({displayOptical:!0,isAlternativePrice:!0}),_o=Y({isAlternativePrice:!0}),Po=xo(),Lo=vo(),ko=bo;var Il=(e,r)=>{if(!(!Mt(e)||!Mt(r)))return Math.floor((r-e)/r*100)},Mo=()=>(e,r)=>{let{price:t,priceWithoutDiscount:i}=r,a=Il(t,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var Ro=Mo();var No="INDIVIDUAL_COM",Qi="TEAM_COM",Oo="INDIVIDUAL_EDU",Ji="TEAM_EDU",Dl=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],zl={[No]:[],[Qi]:[],[Oo]:[],[Ji]:[]},Hl={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Bl=[No,Qi,Oo,Ji],Fl=e=>[Qi,Ji].includes(e);function Zi(e,r,t,i){if(e[r])return e[r];let a=`${r}_${t}`;if(e[a])return e[a];let n;if(i)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Ul=(e,r,t,i)=>{let a=`${t}_${i}`,n=Zi(Hl,e,r,!1);if(n){let o=Bl.indexOf(a);return n[o]}return Fl(a)},$l=(e,r,t,i)=>{if(Zi(Dl,e,r,!0))return!0;let a=zl[`${t}_${i}`];return a?Zi(a,e,r,!0)?!0:k.displayTax:k.displayTax},ea=async(e,r,t,i)=>{let a=$l(e,r,t,i);return{displayTax:a,forceTaxExclusive:a?Ul(e,r,t,i):k.forceTaxExclusive}},Gt=class Gt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Me(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let i=ie();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:v}=i.collectPriceOptions(t);return gr(Gt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===he}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let i=ie();if(!i)return!1;let a=i.collectPriceOptions(t,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=i.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let u=Nt(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=Li(l);if(i.featureFlags[we]||n[we]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,v=await ea(h,u,p.customerSegment,f);a.displayTax===void 0&&(n.displayTax=v?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=v?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let S=Nt(y,n);return S?.length?S[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(i.featureFlags[Ze]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=Li(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,i,a=void 0){if(!this.isConnected)return;let n=ie();if(!n)return!1;if(a??(a=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(a,t,i)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,o,this.options))return this.innerHTML="",!0}return!1}};g(Gt,"is","inline-price"),g(Gt,"tag","span");var Te=Gt;window.customElements.get(Te.is)||window.customElements.define(Te.is,Te,{extends:Te.tag});function Io({literals:e,providers:r,settings:t}){function i(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let M of r.price)M(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:v,promotionCode:y,quantity:S,alternativePrice:x,wcsOsi:A,...O}=Object.assign(c,s?.dataset??{},o??{});return c=sr(Object.assign({...c,...O,displayOldPrice:w(l),displayPerUnit:w(d),displayRecurrence:w(p),displayTax:w(m),displayPlanType:w(h),forceTaxExclusive:w(u),perpetual:w(f),displayAnnual:w(v),promotionCode:lr(y).effectivePromoCode,quantity:ht(S,k.quantity),alternativePrice:w(x),wcsOsi:ur(A)})),c}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Ro;break;case"strikethrough":l=So;break;case"promo-strikethrough":l=Ao;break;case"annual":l=To;break;case"legal":l=ko;break;default:s.template==="optical"&&s.alternativePrice?l=Co:s.template==="optical"?l=Eo:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?Lo:Po:s.alternativePrice?l=_o:l=s.promotionCode&&o[0].promotion?wo:yo}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Te.createInlinePrice;return{InlinePrice:Te,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function Gl({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||k.language),r??(r=e?.split("_")?.[1]||k.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function Do(e={},r){let t=r.featureFlags[we],{commerce:i={}}=e,a=ge.PRODUCTION,n=Zr,o=z("checkoutClientId",i)??k.checkoutClientId,s=Rt(z("checkoutWorkflowStep",i),ee,k.checkoutWorkflowStep),c=w(z("displayOldPrice",i),k.displayOldPrice),l=k.displayPerUnit,d=w(z("displayRecurrence",i),k.displayRecurrence),p=w(z("displayTax",i),k.displayTax),m=w(z("displayPlanType",i),k.displayPlanType),h=w(z("entitlement",i),k.entitlement),u=w(z("modal",i),k.modal),f=w(z("forceTaxExclusive",i),k.forceTaxExclusive),v=z("promotionCode",i)??k.promotionCode,y=ht(z("quantity",i)),S=z("wcsApiKey",i)??k.wcsApiKey,x=i?.env==="stage",A=Pe.PUBLISHED;["true",""].includes(i.allowOverride)&&(x=(z(Xr,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",A=Rt(z(Kr,i),Pe,A)),x&&(a=ge.STAGE,n=Qr);let M=z(Yr)??e.preview,F=typeof M<"u"&&M!=="off"&&M!=="false",q={};F&&(q={preview:F});let Q=z("mas-io-url")??e.masIOUrl??`https://www${a===ge.STAGE?".stage":""}.adobe.com/mas/io`,W=z("preselect-plan")??void 0,B=z("instant")??e.instant;return{...Gl(e),...q,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:k.extraOptions,modal:u,env:a,forceTaxExclusive:f,promotionCode:v,quantity:y,alternativePrice:k.alternativePrice,wcsApiKey:S,wcsURL:n,landscape:A,masIOUrl:Q,...W&&{preselectPlan:W},...B&&{instant:B}}}async function zo(e,r={},t=2,i=100){let a;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,i*(n+1)))}throw a}var ta="wcs";function Ho({settings:e}){let r=re.module(ta),{env:t,wcsApiKey:i}=e,a=new Map,n=new Map,o,s=new Map;async function c(u,f,v=!0){let y=ie(),S=Vr;r.debug("Fetching:",u);let x="",A;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let O=new Map(f),[M]=u.offerSelectorIds,F=Date.now()+Math.random().toString(36).substring(2,7),q=`${ta}:${M}:${F}${ei}`,Q=`${ta}:${M}:${F}${ti}`,W;try{if(performance.mark(q),x=new URL(e.wcsURL),x.searchParams.set("offer_selector_ids",M),x.searchParams.set("country",u.country),x.searchParams.set("locale",u.locale),x.searchParams.set("landscape",t===ge.STAGE?"ALL":e.landscape),x.searchParams.set("api_key",i),u.language&&x.searchParams.set("language",u.language),u.promotionCode&&x.searchParams.set("promotion_code",u.promotionCode),u.currency&&x.searchParams.set("currency",u.currency),A=await zo(x.toString(),{credentials:"omit"}),A.ok){let B=[];try{let R=await A.json();r.debug("Fetched:",u,R),B=R.resolvedOffers??[]}catch(R){r.error(`Error parsing JSON: ${R.message}`,{...R.context,...y?.duration})}B=B.map(dr),f.forEach(({resolve:R},J)=>{let se=B.filter(({offerSelectorIds:Ye})=>Ye.includes(J)).flat();se.length&&(O.delete(J),f.delete(J),R(se))})}else S=qr}catch(B){S=`Network error: ${B.message}`}finally{W=performance.measure(Q,q),performance.clearMarks(q),performance.clearMeasures(Q)}if(v&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let B=gn(A);f.forEach(R=>{R.reject(new pt(S,{...u,...B,response:A,measure:Zt(W),...y?.duration}))})}}function l(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:v})=>c(f,v))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ge.STAGE?"stage":"prod",v=u[f];if(!v||typeof v!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,S]of Object.entries(v))a.set(y,Promise.resolve(S.map(dr)));r.debug(`Prefilled WCS cache with ${v.size} entries`)}function p(){let u=a.size;s=new Map(a),a.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,v){let y=u!=="GB"&&!v?"MULT":"en",S=ri.includes(u)?u:k.country;return{validCountry:S,validLanguage:y,locale:`${f}_${S}`}}function h({country:u,language:f,perpetual:v=!1,promotionCode:y="",wcsOsi:S=[]}){let{validCountry:x,validLanguage:A,locale:O}=m(u,f,v),M=[x,A,y].filter(F=>F).join("-").toLowerCase();return S.map(F=>{let q=`${F}-${M}`;if(a.has(q))return a.get(q);let Q=new Promise((W,B)=>{let R=n.get(M);R||(R={options:{country:x,locale:O,...A==="MULT"&&{language:A},offerSelectorIds:[]},promises:new Map},n.set(M,R)),y&&(R.options.promotionCode=y),R.options.offerSelectorIds.push(F),R.promises.set(F,{resolve:W,reject:B}),l()}).catch(W=>{if(s.has(q))return s.get(q);throw W});return a.set(q,Q),Q})}return{Commitment:Ie,PlanType:an,Term:ce,applyPlanType:dr,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var Bo="mas-commerce-service",Fo="mas-commerce-service:start",Uo="mas-commerce-service:ready",qt,ut,je,$o,ia,ra=class extends HTMLElement{constructor(){super(...arguments);U(this,je);U(this,qt);U(this,ut);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let o=await t?.(i,a,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return b(this,ut)||N(this,ut,{[we]:xt(this,je,ia).call(this,we),[Ze]:xt(this,je,ia).call(this,Ze)}),b(this,ut)}activate(){let t=b(this,je,$o),i=Do(t,this);hr(t.lana);let a=re.init(t.hostEnv).module("service");a.debug("Activating:",t);let o={price:Un(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Hn(c),...Bn(c),...Io(c),...Ho(c),...ii,Log:re,resolvePriceTaxFlags:ea,get defaults(){return k},get log(){return re},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(Kt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Uo),N(this,qt,performance.measure(Uo,Fo)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Fo),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Nr).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Zt(b(this,qt))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:o})=>a===0&&n===0&&o<200||o>=400),i=Array.from(new Map(t.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};qt=new WeakMap,ut=new WeakMap,je=new WeakSet,$o=function(){let t=this.getAttribute("env")??"prod",i={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=n}}),i},ia=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||z(t))};window.customElements.get(Bo)||window.customElements.define(Bo,ra);var jo="merch-card-collection",ql=3e4,Vl={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},jl={plans:!0},Wl=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Yl=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(i=>t.types.includes(i)))):e,Xl=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Kl=(e,{filter:r})=>e.sort((t,i)=>i.filters[r]?.order==null||isNaN(i.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-i.filters[r].order),Zl=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Ne,ft,We,jt,_r,Wo,gt=class extends qo{constructor(){super();U(this,_r);U(this,Ne,{});U(this,ft);U(this,We);U(this,jt);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return Ce` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let i=new Promise(a=>setTimeout(()=>a(!1),ql));return Promise.race([this.hydrationReady,i])}updated(t){if(!this.querySelector("merch-card"))return;let i=window.scrollY||document.documentElement.scrollTop,a=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(a.length===0)return;t.has("singleApp")&&this.singleApp&&a.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===pe.alphabetical?Xl:Kl,s=[Wl,Yl,Zl,n].reduce((l,d)=>d(l,this),a).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);a.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,i),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(zr,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(de,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){N(this,Ne,{}),this.overrides?.split(",").forEach(t=>{let[i,a]=t?.split(":");i&&a&&(b(this,Ne)[i]=a)})}connectedCallback(){super.connectedCallback(),N(this,ft,At()),b(this,ft)&&N(this,We,b(this,ft).Log.module(jo)),N(this,jt,customElements.get("merch-card")),this.buildOverrideMap(),this.init()}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t()}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(a=>{let n=a.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(a)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let i of Object.keys(t)){let a=t[i],n=a.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",i),o.setAttribute("placeholder",""),o.innerHTML=a,this.append(o)}}attachSidenav(t,i=!0){if(!t)return;i&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),jl[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(wt));let a=b(this,jt)?.getCollectionOptions(this.variant)?.onSidenavAttached;a&&a(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let i;this.hydrationReady=new Promise(s=>{i=s});let a=this;function n(s){let c;return s.fields?.checkboxGroups?c=s.fields.checkboxGroups:s.fields?.tagFilters&&(c=[{title:s.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:s.fields.tagFilters.map(l=>{let d=l.split("/").pop(),p=s.settings?.tagLabels?.[d]||d;return p=p.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):p,{name:d,label:p}})}]),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(p,m){for(let h of m){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(x=>x.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){b(a,We)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let u=s.references[h.identifier]?.value,f=h.referencesTree,v=c[h.identifier];if(v){let x=document.querySelector(`aem-fragment[fragment="${v}"]`)?.rawData;if(x?.fields)u=x,f=x.referencesTree,s.references={...s.references,...x.references};else{b(a,We)?.error(`Override fragment ${v} not found or invalid:`);continue}}if(!u?.fields)continue;let{fields:y}=u,S={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(x=>c[x]||x):[],collections:[]};y.defaultchild&&(S.defaultchild=c[y.defaultchild]||y.defaultchild),p.push(S),d(S.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(a.filtered="all"),l}t.addEventListener(Br,s=>{xt(this,_r,Wo).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(Hr,async s=>{this.limit=27,this.data=o(s.detail,b(this,Ne)),s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?b(this,Ne)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let p=(u,f)=>{for(let v of u)if(v.defaultchild===f||v.collections&&p(v.collections,f))return!0;return!1};for(let u of c){let x=function(O){for(let M of O){let F=M.cards.indexOf(v);if(F===-1)continue;let q=M.queryLabel??M?.label?.toLowerCase()??"";f.filters[q]={order:F+1,size:u.fields.size},x(M.collections)}},f=document.createElement("merch-card"),v=b(this,Ne)[u.id]||u.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=u.fields.tags?.filter(O=>O.startsWith("mas:types/")).map(O=>O.split("/")[1]).join(",");y&&f.setAttribute("types",y),Jt(u.fields.variant)?.supportsDefaultChild&&(d?v===d:p(l,v))&&f.setAttribute("data-default-card","true"),x(l);let A=document.createElement("aem-fragment");A.setAttribute("fragment",v),f.append(A),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(u)+1,size:u.fields.size}}),this.append(f)}let m="",h=xn(c[0]?.fields?.variant);this.variant=h,h==="plans"&&c.length===3&&!c.some(u=>u.fields?.size?.includes("wide"))?m="ThreeColumns":(h==="segment"||h==="product")&&(c.length===2||c.length===3)?m=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(m=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Vl[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),i(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Ce`<div id="footer">
        ...
        </sp-button>`}sortChanged(t){t.target.value===pe.authored?yt({sort:void 0}):yt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(Ir,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(Dr,{bubbles:!0,composed:!0}));let t=this.page+1;yt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=pa(({category:t,filter:i,types:a,sort:n,search:o,single_app:s,page:c})=>{i=i||t,!this.filtered&&i&&i!==this.filter&&setTimeout(()=>{yt({page:void 0}),this.page=1},1),this.filtered||(this.filter=i??this.filter),this.types=a??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(c)||1})}openFilters(t){this.sidenav?.showModal(t)}};Ne=new WeakMap,ft=new WeakMap,We=new WeakMap,jt=new WeakMap,_r=new WeakSet,Wo=function(t,i={},a=!0){b(this,We)?.error(`merch-card-collection: ${t}`,i),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(Fr,{detail:{...i,message:t},bubbles:!0,composed:!0}))},g(gt,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:pe.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(gt,"styles",Vo`
        #footer {
            grid-column: 1 / -1;
    ...
    `);gt.SortOrder=pe;customElements.define(jo,gt);var Ql={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},Jl=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(a=>{a.innerText=t||""})},ed={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},td={catalog:"l"},ae,vt,Vt=class extends qo{constructor(){super();U(this,ae);U(this,vt);g(this,"tablet",new bt(this,D));g(this,"desktop",new bt(this,T));this.collection=null,N(this,ae,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(de,this.updateLiterals),this.collection?.addEventListener(wt,this.handleSidenavAttached),N(this,vt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(de,this.updateLiterals),this.collection?.removeEventListener(wt,this.handleSidenavAttached)}willUpdate(){b(this,ae).search=this.getVisibility("search"),b(this,ae).filter=this.getVisibility("filter"),b(this,ae).sort=this.getVisibility("sort"),b(this,ae).result=this.getVisibility("result"),b(this,ae).custom=this.getVisibility("custom")}parseVisibilityOptions(t,i){if(!t||!Object.hasOwn(t,i))return null;let a=t[i];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(t){let i=b(this,vt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(i,t);return a!==null?a:this.parseVisibilityOptions(ed,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!b(this,ae).search)return me;let t=St(this,"searchText");return t?Ce`
        ...
        </div>`}get customArea(){if(!b(this,ae).custom)return me;let t=b(this,vt)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return me;let i=t(this.collection);return!i||i===me?me:Ce`<div id="custom" role="heading" aria-level="2">
            ${i}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(i=>{Jl(this,i,t.detail[i])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return Ce`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};ae=new WeakMap,vt=new WeakMap,g(Vt,"styles",Vo`
        :host {
    ...
    `);customElements.define("merch-card-collection-header",Vt);export{gt as MerchCardCollection,Vt as default};

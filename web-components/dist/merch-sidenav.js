var w=Object.defineProperty;var O=(s,e,t)=>e in s?w(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var r=(s,e,t)=>O(s,typeof e!="symbol"?e+"":e,t);import{html as S,css as q,LitElement as K,nothing as k}from"./lit-all.min.js";var d=class{constructor(e,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=e,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),e.addController(this)}hostConnected(){var e;(e=this.media)==null||e.addEventListener("change",this.onChange)}hostDisconnected(){var e;(e=this.media)==null||e.removeEventListener("change",this.onChange)}onChange(e){this.matches!==e.matches&&(this.matches=e.matches,this.host.requestUpdate(this.key,!this.matches))}};import{html as H,LitElement as U}from"./lit-all.min.js";var Q=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),J=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var D='span[is="inline-price"][data-wcs-osi]',M='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var I='a[is="upt-link"]',ee=`${D},${M},${I}`;var _="merch-search:change";var h="merch-sidenav:select";var te=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var ie=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});function u(s,e){let t;return function(){let i=this,o=arguments;clearTimeout(t),t=setTimeout(()=>s.apply(i,o),e)}}function A(s,e={},t=null,i=null){let o=i?document.createElement(s,{is:i}):document.createElement(s);t instanceof HTMLElement?o.appendChild(t):o.innerHTML=t;for(let[n,a]of Object.entries(e))o.setAttribute(n,a);return o}function P(s){if(!window.history.pushState)return;let e=new URL(window.location.href);e.search=s,window.history.pushState({path:e.href},"",e.href)}function g(s,e){let t=new URLSearchParams(window.location.hash.slice(1));t.set(s,e),window.location.hash=t.toString()}function T(s=[]){s.forEach(e=>{let t=new URLSearchParams(window.location.search),i=t.get(e);i&&(window.location.hash.includes(`${e}=`)?g(e,i):window.location.hash=window.location.hash?`${window.location.hash}&${e}=${i}`:`${e}=${i}`,t.delete(e),P(t.toString()))})}var f="hashchange";function x(s=window.location.hash){let e=[],t=s.replace(/^#/,"").split("&");for(let i of t){let[o,n=""]=i.split("=");o&&e.push([o,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(e)}function c(s,e){if(s.deeplink){let t={};t[s.deeplink]=e,y(t)}}function y(s){let e=new URLSearchParams(window.location.hash.slice(1));Object.entries(s).forEach(([o,n])=>{n?e.set(o,n):e.delete(o)}),e.sort();let t=e.toString();if(t===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,i)}function l(s){let e=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=x(window.location.hash);s(t)};return e(),window.addEventListener(f,e),()=>{window.removeEventListener(f,e)}}var v=class extends U{get search(){return this.querySelector("sp-search")}constructor(){super(),this.handleInput=()=>{c(this,this.search.value),this.search.value&&this.dispatchEvent(new CustomEvent(_,{bubbles:!0,composed:!0,detail:{type:"search",value:this.search.value}}))},this.handleInputDebounced=u(this.handleInput.bind(this))}connectedCallback(){super.connectedCallback(),this.search&&(this.search.addEventListener("input",this.handleInputDebounced),this.search.addEventListener("submit",this.handleInputSubmit),this.updateComplete.then(()=>{this.setStateFromURL()}),this.startDeeplink())}disconnectedCallback(){super.disconnectedCallback(),this.search.removeEventListener("input",this.handleInputDebounced),this.search.removeEventListener("submit",this.handleInputSubmit),this.stopDeeplink?.()}setStateFromURL(){let t=x()[this.deeplink];t&&(this.search.value=t)}startDeeplink(){this.stopDeeplink=l(({search:e})=>{this.search.value=e??""})}handleInputSubmit(e){e.preventDefault()}render(){return H`<slot></slot>`}};r(v,"properties",{deeplink:{type:String}});customElements.define("merch-search",v);import{html as b,LitElement as V,css as Y,nothing as $}from"./lit-all.min.js";var p=class extends V{constructor(){super(),this.toggleIconColor=!1,this.handleClickDebounced=u(this.handleClick.bind(this))}selectElement(e,t=!0){e.selected=t,e.parentNode.tagName==="SP-SIDENAV-ITEM"&&this.selectElement(e.parentNode,!1);let i=e.querySelector(".selection");i?.setAttribute("selected",t);let o=i?.dataset,n=t&&this.toggleIconColor?o?.light:o?.dark;n&&e.querySelector("img")?.setAttribute("src",n),t&&(this.selectedElement=e,this.selectedText=o?.selectedText||e.label,this.selectedValue=e.value,setTimeout(()=>{e.selected=!0},1),this.dispatchEvent(new CustomEvent(h,{bubbles:!0,composed:!0,detail:{type:"sidenav",value:this.selectedValue,elt:this.selectedElement}})))}markCurrentItem(e){let t=e.closest("sp-sidenav");t&&(t.querySelectorAll("sp-sidenav-item[aria-current]").forEach(i=>{i.removeAttribute("aria-current")}),e.setAttribute("aria-current","true"))}handleClick({target:e},t=!0){let{value:i,parentNode:o}=e;this.selectElement(e),this.markCurrentItem(e),o?.tagName==="SP-SIDENAV"?(o.querySelectorAll("sp-sidenav-item[expanded],sp-sidenav-item[selected]").forEach(n=>{n.value!==i&&(n.expanded=!1,n.removeAttribute("aria-expanded"),this.selectElement(n,!1))}),o.querySelectorAll(".selection[selected=true]").forEach(n=>{let a=n.parentElement;a.value!==i&&this.selectElement(a,!1)})):o?.tagName==="SP-SIDENAV-ITEM"&&([...o.closest("sp-sidenav")?.querySelectorAll(":scope > sp-sidenav-item")].filter(a=>a!==o).forEach(a=>{a.expanded=!1,a.removeAttribute("aria-expanded")}),o.closest("sp-sidenav")?.querySelectorAll("sp-sidenav-item[selected]").forEach(a=>{a.value!==i&&this.selectElement(a,!1)})),t&&c(this,i)}selectionChanged(e){let{target:{value:t,parentNode:i}}=e;this.selectElement(this.querySelector(`sp-sidenav-item[value="${t}"]`)),c(this,t)}startDeeplink(){this.stopDeeplink=l(e=>{let t=e[this.deeplink]??"all",i=this.querySelector(`sp-sidenav-item[value="${t}"]`);i||(i=this.querySelector("sp-sidenav-item:first-child"),g(this.deeplink,i.value)),this.updateComplete.then(()=>{i.firstElementChild?.tagName==="SP-SIDENAV-ITEM"&&(i.expanded=!0,i.setAttribute("aria-expanded","true")),i.parentNode?.tagName==="SP-SIDENAV-ITEM"&&(i.parentNode.expanded=!0,i.parentNode.setAttribute("aria-expanded","true")),this.handleClick({target:i},!!window.location.hash.includes("category"))})})}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleClickDebounced),this.updateComplete.then(()=>{this.deeplink&&(T(["filter","single_app"]),this.startDeeplink())})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleClickDebounced),this.stopDeeplink?.()}render(){return b`<div
    ...
    `);customElements.define("merch-sidenav-checkbox-group",m);var N="(max-width: 700px)",z="(max-width: 767px)",L="(max-width: 1199px)";var C="(min-width: 1200px)",R="(min-width: 1600px)";var Ce={matchMobile:window.matchMedia(z),matchDesktop:window.matchMedia(`${C} and (not ${R})`),matchDesktopOrUp:window.matchMedia(C),matchLargeDesktop:window.matchMedia(R),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}};var W={catalog:"l"},X={catalog:"xl"},E=class extends K{constructor(){super();r(this,"mobileDevice",new d(this,N));r(this,"mobileAndTablet",new d(this,L));this.open=!1,this.autoclose=!1,this.variant=null,this.dir=document.documentElement.dir||"ltr",this.closeModal=this.closeModal.bind(this),this.handleSelection=this.handleSelection.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(h,this.handleSelection),this.dirObserver=new MutationObserver(()=>{let t=document.documentElement.dir||"ltr";this.dir!==t&&(this.dir=t,this.requestUpdate())}),this.dirObserver.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]})}disconnectedCallback(){this.dirObserver?.disconnect(),super.disconnectedCallback(),this.removeEventListener(h,this.handleSelection)}firstUpdated(){let t=W[this.variant];if(t){let o=this.querySelector("merch-search sp-search");o&&o?.setAttribute("size",t)}let i=X[this.variant];i&&this.querySelectorAll("merch-sidenav-checkbox-group sp-checkbox").forEach(n=>{n.setAttribute("size",i)})}updated(){this.mobileAndTablet.matches?(this.modal=!0,this.style.padding=0,this.style.margin=0):(this.modal=!1,this.style.removeProperty("padding"),this.style.removeProperty("margin"),this.open&&this.closeModal())}get filters(){return this.querySelector("merch-sidenav-list")}get search(){return this.querySelector("merch-search")}render(){return this.mobileAndTablet.matches?this.asDialog:this.asAside}get asDialog(){if(!this.open)return k;let t=this.autoclose?k:S`<sp-link @click="${this.closeModal}"

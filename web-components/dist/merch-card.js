var mr=Object.defineProperty;var gr=a=>{throw TypeError(a)};var Ja=(a,t,e)=>t in a?mr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var ei=(a,t)=>()=>(a&&(t=a(a=0)),t);var ti=(a,t)=>{for(var e in t)mr(a,e,{get:t[e],enumerable:!0})};var h=(a,t,e)=>Ja(a,typeof t!="symbol"?t+"":t,e),It=(a,t,e)=>t.has(a)||gr("Cannot "+e);var s=(a,t,e)=>(It(a,t,"read from private field"),e?e.call(a):t.get(a)),f=(a,t,e)=>t.has(a)?gr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(It(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),P=(a,t,e)=>(It(a,t,"access private method"),e);var ur=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return s(a,t,r)}});var $t={};ti($t,{default:()=>Ve});import{LitElement as ri,html as xe,css as ai,nothing as ii}from"./lit-all.min.js";import{unsafeHTML as wr}from"./lit-all.min.js";import{ifDefined as ni}from"./lit-all.min.js";function oi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var _,Ve,Bt=ei(()=>{_=class _ extends ri{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();_.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>i?u="top":u==="left"&&e.left-d-n<0?u="right":u==="right"&&e.right+d+n>r&&(u="left");let C=e.left+e.width/2,$=e.top+e.height/2,Q=6,ht=(Qa,Xa,Za)=>Math.max(Qa,Math.min(Xa,Za)),pt,mt,Ft;u==="top"||u==="bottom"?(pt=u==="top"?e.top-p-n:e.bottom+n,mt=ht(0,r-d,C-d/2),Ft=ht(Q,d-Q*2,C-mt-Q)):(mt=u==="left"?e.left-d-n:e.right+n,pt=ht(0,i-p,$-p/2),Ft=ht(Q,p-Q*2,$-pt-Q)),this._tooltipTop=pt,this._tooltipLeft=mt,this._arrowOffset=Ft,this._computedPlacement=u}showTooltip(){_.activeTooltip&&_.activeTooltip!==this&&(_.activeTooltip.closeOverlay(),_.activeTooltip.tooltipVisible=!1,_.activeTooltip.requestUpdate()),_.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){_.activeTooltip===this&&(_.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?xe`<merch-icon
        ...
        ></merch-icon>`:xe`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return xe`<span class="icon-only">${this.renderIcon()}</span>`;if(oi())return xe`
            ...
            `;let i=t.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:g=>{this.lastPointerType=g.pointerType},pointerenter:g=>g.pointerType!=="touch"&&this.showTooltip(),pointerleave:g=>g.pointerType!=="touch"&&this.hideTooltip(),click:g=>{this.lastPointerType==="touch"&&this.handleTap(g),this.lastPointerType=null}},c=this._computedPlacement,l=c==="top"||c==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=l?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return xe`
            <span
    ...
    `);Ve=_;customElements.define("mas-mnemonic",Ve)});import{LitElement as Yn}from"./lit-all.min.js";import{css as xr,unsafeCSS as vr}from"./lit-all.min.js";var w="(max-width: 767px)",T="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",L="(min-width: 1600px)",fr={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${L})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=fr;function gt(){return fr.isDesktop}var br=xr`
    :host {
...
`,yr=()=>[xr`
        ...
        `];import{LitElement as ci,html as Er,css as si}from"./lit-all.min.js";function li(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var be=class extends ci{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(li())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Bt())}e.remove()})}render(){let{href:t}=this;return t?Er`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(be,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(be,"styles",si`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",be);var ho=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),po=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var y='span[is="inline-price"][data-wcs-osi]',X='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var di='a[is="upt-link"]',kr=`${y},${X},${di}`;var Sr="merch-offer-select:ready",Cr="merch-card:action-menu-toggle";var N="merch-quantity-selector:change",Ar="merch-card-quantity:change",Ht="merch-modal:addon-and-quantity-update";var ye="merch-card-collection:literals-changed";var we="aem:load",Ee="aem:error",ut="mas:ready",Tr="mas:error",Lr="placeholder-failed",zr="placeholder-pending",Pr="placeholder-resolved";var _r="mas:failed",Z="mas:resolved",Mr="mas/commerce";var J="failed",ce="pending",ee="resolved";var ft="X-Request-Id",mo=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var go=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var vt=":start",xt=":duration";var D="legal",Rr="mas-ff-defaults";var hi="mas-commerce-service";function Or(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function z(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function ke(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function qt(){return window.matchMedia("(max-width: 1024px)").matches}function se(){return document.getElementsByTagName(hi)?.[0]}function We(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Ke,le,Ye,Qe,Se,bt=class extends HTMLElement{constructor(){super();f(this,Ke,"");f(this,le);f(this,Ye,[]);f(this,Qe,[]);f(this,Se);m(this,Se,Or(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,le)?this.parentElement.style.borderRadius=s(this,le):s(this,le)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Ye).map((r,i)=>{let n=s(this,Qe)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,Ke)}, ${e})`}connectedCallback(){s(this,Se).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,le,i?.trim()),e==="colors"&&i?m(this,Ye,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,Qe,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Ke,i?.trim()??""),s(this,Se).call(this)}};Ke=new WeakMap,le=new WeakMap,Ye=new WeakMap,Qe=new WeakMap,Se=new WeakMap;customElements.define("merch-gradient",bt);import{LitElement as pi,html as mi,css as gi}from"./lit-all.min.js";var Ce=class extends pi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Z,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Z,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return mi` <input
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(Ce,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),h(Ce,"styles",gi`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",Ce);import{html as yt,nothing as ui}from"./lit-all.min.js";var Ae,Xe=class Xe{constructor(t){h(this,"card");f(this,Ae);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,Ae,s(this,Ae)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,Ae)}insertVariantStyle(){let t=this.constructor.name;if(!Xe.styleMap[t]){Xe.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let r=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${r}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of t){let c=`--consonant-merch-card-${r}-${o}-height`;e.style.getPropertyValue(c)&&e.style.removeProperty(c)}let n=new Map;for(let o of i){let c=o.getBoundingClientRect();if(c.width<=2)continue;let l=Math.round(c.top),d=n.get(l);d||(d=[],n.set(l,d)),d.push(o)}for(let o of n.values())for(let{name:c,getElement:l}of t){let d=`--consonant-merch-card-${r}-${c}-height`,p=0,g=[];for(let u of o){u.style.removeProperty(d);let C=l(u);if(!C){g.push({card:u,height:0});continue}let $=Math.max(0,parseInt(window.getComputedStyle(C).height)||0);g.push({card:u,height:$}),$>p&&(p=$)}if(!(p<=0))for(let{card:u}of g)u.style.setProperty(d,`${p}px`)}}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),yt`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return wt(this.card.variant)}};Ae=new WeakMap,h(Xe,"styleMap",{});var b=Xe;import{html as Ut,css as fi}from"./lit-all.min.js";var Nr=`
:root {
...
`;var Et=class extends b{constructor(t){super(t)}getGlobalCSS(){return $r}renderLayout(){return Br` ${this.badge}
            ...
            ${this.card.customHr?"":Br`<hr />`} ${this.secureLabelFooter}`}};import{html as te,css as xi,unsafeCSS as qr}from"./lit-all.min.js";var Hr=`
  :root {
...
`;var ea={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Pe=class extends b{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Jr}priceOptionsProvider(t,e){t.dataset.template===D&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Gt` ${this.badge}
...
`;var Kt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Ne=class extends b{getGlobalCSS(){return sa}get aemFragmentMapping(){return Kt}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return la`
    ...
    `);import{html as Yt,css as Ri,nothing as Oi}from"./lit-all.min.js";var da=`
...
Caused by: ${this.cause}`),e}};var he={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ya=1e3;function Ui(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function wa(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!he.serializableTypes.includes(e))return e}return a}function Gi(a,t){if(!he.ignoredProperties.includes(a))return wa(t)}var Jt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(Ui(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(wa).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${he.delimiter}page=${o}${c}`;l.length>ya&&(l=`${l.slice(0,ya)}<trunc>`),n+=l,i.length&&(n+=`${he.delimiter}facts=`,n+=JSON.stringify(i,Gi)),window.lana?.log(n,he)}};function Ea(a){Object.assign(he,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in he&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ka={LOCAL:"local",PROD:"prod",STAGE:"stage"},er={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},tr=new Set,rr=new Set,Sa=new Map,Ca={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Aa={filter:({level:a})=>a!==er.DEBUG},ji={filter:()=>!1};function Vi(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&zt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Wi(a){[...rr].every(t=>t(a))&&tr.forEach(t=>t(a))}function Ta(a){let t=(Sa.get(a)??0)+1;Sa.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Ta(`${r.namespace}/${i}`),updateConfig:Ea};return Object.values(er).forEach(i=>{r[i]=(n,...o)=>Wi(Vi(i,n,a,o,e))}),Object.seal(r)}function Pt(...a){a.forEach(t=>{let{append:e,filter:r}=t;zt(r)&&rr.add(r),zt(e)&&tr.add(e)})}function Ki(a={}){let{name:t}=a,e=ba(Lt("commerce.debug",{search:!0,storage:!0}),t===ka.LOCAL);return Pt(e?Ca:Aa),t===ka.PROD&&Pt(Jt),et}function Yi(){tr.clear(),rr.clear()}var et={...Ta(Mr),Level:er,Plugins:{consoleAppender:Ca,debugFilter:Aa,quietFilter:ji,lanaAppender:Jt},init:Ki,reset:Yi,use:Pt};var Qi="mas-commerce-service",El=et.module("utilities"),Xi={requestId:ft,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var _t=a=>window.setTimeout(a);function ar(){return document.getElementsByTagName(Qi)?.[0]}function La(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Xi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function za(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var Pa="fragment",_a="author",Ma="preview",Ra="loading",Oa="timeout",ir="aem-fragment",Na="eager",Da="cache",Zi=[Na,Da],V,pe,B,nr=class{constructor(){f(this,V,new Map);f(this,pe,new Map);f(this,B,new Map)}clear(){s(this,V).clear(),s(this,pe).clear(),s(this,B).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,V).set(t.id,t),t.fields?.originalId&&s(this,V).set(t.fields.originalId,t),s(this,B).has(t.id)){let[,r]=s(this,B).get(t.id);r()}if(s(this,B).has(t.fields?.originalId)){let[,r]=s(this,B).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,V).has(t)}entries(){return s(this,V).entries()}get(t){return s(this,V).get(t)}getAsPromise(t){let[e]=s(this,B).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,B).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,pe).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,pe).set(t,e)),e}remove(t){s(this,V).delete(t),s(this,pe).delete(t),s(this,B).delete(t)}};V=new WeakMap,pe=new WeakMap,B=new WeakMap;var ie=new nr,$e,H,Y,O,R,A,tt,rt,q,at,it,Be,U,Fa,Ia,or,$a,Mt=class extends HTMLElement{constructor(){super(...arguments);f(this,U);h(this,"cache",ie);f(this,$e);f(this,H,null);f(this,Y,null);f(this,O,null);f(this,R);f(this,A);f(this,tt,Na);f(this,rt,5e3);f(this,q);f(this,at,!1);f(this,it,0);f(this,Be)}static get observedAttributes(){return[Pa,Ra,Oa,_a,Ma]}attributeChangedCallback(e,r,i){e===Pa&&(m(this,R,i),m(this,A,ie.getFetchInfo(i))),e===Ra&&Zi.includes(i)&&m(this,tt,i),e===Oa&&m(this,rt,parseInt(i,10)),e===_a&&m(this,at,["","true"].includes(i)),e===Ma&&m(this,Be,i)}connectedCallback(){if(!s(this,q)){if(s(this,O)??m(this,O,se(this)),m(this,Be,s(this,O).settings?.preview),s(this,$e)??m(this,$e,s(this,O).log.module(`${ir}[${s(this,R)}]`)),!s(this,R)||s(this,R)==="#"){s(this,A)??m(this,A,ie.getFetchInfo("missing-fragment-id")),P(this,U,or).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,A)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&ie.remove(s(this,R)),s(this,tt)===Da&&await Promise.race([ie.getAsPromise(s(this,R)),new Promise(c=>setTimeout(c,s(this,rt)))]);try{m(this,q,P(this,U,$a).call(this)),await s(this,q)}catch(c){return P(this,U,or).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,H)||{};return o&&!Lt("mas.disableWcsCache")&&s(this,O).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(we,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,A)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,Y)?s(this,Y):(s(this,at)?this.transformAuthorData():this.transformPublishData(),s(this,Y))}get rawData(){return s(this,H)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:d={}}=s(this,H);m(this,Y,e.reduce((p,{name:g,multiple:u,values:C})=>(p.fields[g]=u?C:C[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:d,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:d}=s(this,H);m(this,Y,Object.entries(e).reduce((p,[g,u])=>(p.fields[g]=u?.mimeType?u.value:u??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:s(this,O).settings.locale,apiKey:s(this,O).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,O).settings.instant;return n&&(i.instant=n),await r(s(this,R),i)}};$e=new WeakMap,H=new WeakMap,Y=new WeakMap,O=new WeakMap,R=new WeakMap,A=new WeakMap,tt=new WeakMap,rt=new WeakMap,q=new WeakMap,at=new WeakMap,it=new WeakMap,Be=new WeakMap,U=new WeakSet,Fa=async function(e){ur(this,it)._++;let r=`${ir}:${s(this,R)}:${s(this,it)}`,i=`${r}${vt}`,n=`${r}${xt}`;if(s(this,Be)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new ae(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,A).stale=!1,s(this,A).url=e,o=await za(e,{cache:"default",credentials:"omit"}),P(this,U,Ia).call(this,o),s(this,A).status=o?.status,s(this,A).measure=ke(performance.measure(n,i)),s(this,A).retryCount=o.retryCount,!o?.ok)throw new ae("Unexpected fragment response",{response:o,...s(this,O).duration});return await o.json()}catch(c){if(s(this,A).measure=ke(performance.measure(n,i)),s(this,A).retryCount=c.retryCount,s(this,H))return s(this,A).stale=!0,s(this,$e).error("Serving stale data",s(this,A)),s(this,H);let l=c.message??"unknown";throw new ae(`Failed to fetch fragment: ${l}`,{})}},Ia=function(e){Object.assign(s(this,A),La(e))},or=function(e){m(this,q,null),s(this,A).message=e,this.classList.add("error");let r={...s(this,A),...s(this,O).duration};s(this,$e).error(e,r),this.dispatchEvent(new CustomEvent(Ee,{detail:r,bubbles:!0,composed:!0}))},$a=async function(){var l;this.classList.remove("error"),m(this,Y,null);let e=ie.get(s(this,R));if(e)return m(this,H,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,O).settings,c=`${r}/fragment?id=${s(this,R)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await P(this,U,Fa).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,R)),ie.add(e),m(this,H,e),!0},h(Mt,"cache",ie);customElements.define(ir,Mt);import{LitElement as Ji,html as cr,css as en,nothing as tn}from"./lit-all.min.js";import{unsafeHTML as rn}from"./lit-all.min.js";var an=a=>a?a.startsWith("sp-icon-")?cr`${rn(`<${a} class="badge-icon"></${a}>`)}`:cr`<img src="${a}" class="badge-icon" />`:tn,He=class extends Ji{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return cr`<div class="badge">
    ...
    `);customElements.define("merch-badge",He);import{html as nn,css as on,LitElement as cn}from"./lit-all.min.js";var nt=class extends cn{constructor(){super()}render(){return nn`
            <slot name="icon"></slot>
    ...
    `),h(nt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",nt);import{html as sr,css as sn,LitElement as ln,nothing as Ba}from"./lit-all.min.js";var ot=class extends ln{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return sr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?sr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:Ba}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(ot,"styles",sn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

...
`;var qt=class extends N{constructor(t){super(t)}getGlobalCSS(){return na}renderLayout(){return oa` ${this.badge}
            ...
            ${this.card.customHr?"":oa`<hr />`} ${this.secureLabelFooter}`}};import{html as Ye,css as is,unsafeCSS as ca}from"./lit-all.min.js";var sa=`
  :root {
...
`;var as=32,Xe=class extends N{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Ye`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),k.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(Xe,"variantStyle",is`
    ...
    `);import{html as bt,css as ns,nothing as jt}from"./lit-all.min.js";var la=`
:root {
...
`;var ga={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-variation"},allowedBadgeColors:["spectrum-yellow-300-variation","spectrum-gray-300-variation","spectrum-gray-700-variation","spectrum-green-900-variation","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-variation","spectrum-gray-300-variation","spectrum-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ne=class extends N{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return fa}priceOptionsProvider(t,r){t.dataset.template===Me&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Kr` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook),this.card.addEventListener(Le,this.updatePriceQuantity)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook),this.card.removeEventListener(Le,this.updatePriceQuantity)}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),k.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),this.adjustTitleWidth())}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let r=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),t.parentNode.insertBefore(r,t.nextSibling),await r.onceSettled()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${K}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}toggleAddon(t){let r=this.mainPrice,i=this.headingXSSlot;if(!r&&i){let a=t?.getAttribute("plan-type"),n=null;if(t&&a&&(n=t.querySelector(`p[data-plan-type="${a}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(s=>s.remove()),t.checked){if(n){let s=Re("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},n.innerHTML);this.card.appendChild(s)}}else{let s=Re("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let r=this.mainPrice,i=this.card.planType;r&&(await r.onceSettled(),i=r.value?.[0]?.planType),i&&(t.planType=i)}};g(Ne,"variantStyle",ss`
...
`;var Ke=class extends N{constructor(t){super(t)}getGlobalCSS(){return xa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Zr` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}};g(Ke,"variantStyle",cs`
...
`;var ba={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Ze=class extends N{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return va}renderLayout(){return Qr`${this.cardImage}
            ...
            ${this.evergreen?Qr`
                  ...
                  `:Qr`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(Ze,"variantStyle",ls`
...
`,ze.MISSING_INTL_API,s);var w=r.getPluralRules(t,{type:d.pluralType}).select(u-(d.offset||0));x=d.options[w]||d.options.other}if(!x)throw new Oi(d.value,u,Object.keys(d.options),s);o.push.apply(o,kt(x.value,t,r,i,a,u-(d.offset||0)));continue}}return Uc(o)}function zc(e,t){return t?T(T(T({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=T(T({},e[i]),t[i]||{}),r},{})):e}function $c(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=zc(e[i],t[i]),r},T({},e)):e}function Ii(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Gc(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Pt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,sr([void 0],r,!1)))},{cache:Ii(e.number),strategy:fr.variadic}),getDateTimeFormat:Pt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,sr([void 0],r,!1)))},{cache:Ii(e.dateTime),strategy:fr.variadic}),getPluralRules:Pt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,sr([void 0],r,!1)))},{cache:Ii(e.pluralRules),strategy:fr.variadic})}}var Gn=function(){function e(t,r,i,a){var n=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(s){var o=n.formatToParts(s);if(o.length===1)return o[0].value;var c=o.reduce(function(l,d){return!l.length||d.type!==W.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(s){return kt(n.ast,n.locales,n.formatters,n.formats,s,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=$c(e.formats,i),this.formatters=a&&a.formatters||Gc(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Bn,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Vn=Gn;var Di={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Vc=Ma("ConsonantTemplates/price"),qc=/<\/?[^>]+(>|$)/g,U={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Te={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Hi="TAX_EXCLUSIVE",jc=e=>Pa(e)?Object.entries(e).filter(([,t])=>tt(t)||Kt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+_a(i)+'"'}`,""):"",z=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+U.disabled}"${jc(r)}>${i?en(t):t??""}</span>`;function Wc(e){e=e.replaceAll("</a>","&lt;/a&gt;");let t=/<a [^>]+(>|$)/g;return e.match(t)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function Yc(e){e=e.replaceAll("&lt;/a&gt;","</a>");let t=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(t)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function ve(e,t,r,i){let a=e[r];if(a==null)return"";let n=a.includes("<"),s=a.includes("<a ");try{a=s?Wc(a):a,a=n?a.replace(qc,""):a;let o=new Vn(a,t).format(i);return s?Yc(o):o}catch{return Vc.error("Failed to format literal:",a),""}}function Xc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:s,integer:o,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:h},u={}){let p=z(U.currencySymbol,i),m=z(U.currencySpace,s?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=p+m),f+=z(U.integer,o),f+=z(U.decimalsDelimiter,n),f+=z(U.decimals,a),c||(f+=m+p),f+=z(U.recurrence,l,null,!0),f+=z(U.unitType,d,null,!0),f+=z(U.taxInclusivity,h,!0),z(e,f,{...u})}var j=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:s,displayFormatted:o=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:h,literals:u={},quantity:p=1,space:m=!1,isPromoApplied:f=!1}={},{commitment:v,offerSelectorIds:b,formatString:E,price:x,priceWithoutDiscount:w,taxDisplay:R,taxTerm:P,term:H,usePrecision:$,promotion:Y}={},V={})=>{Object.entries({country:s,formatString:E,language:h,price:x}).forEach(([Lo,ko])=>{if(ko==null)throw new Error(`Argument "${Lo}" is missing for osi ${b?.toString()}, country ${s}, language ${h}`)});let F={...Di,...u},M=`${h.toLowerCase()}-${s.toUpperCase()}`,X;Y&&!f&&w?X=e||i?x:w:r&&w?X=w:X=x;let ne=t?rn:an;a&&(ne=nn);let{accessiblePrice:Ge,recurrenceTerm:qi,...ji}=ne({commitment:v,formatString:E,instant:n,isIndianPrice:s==="IN",originalPrice:x,priceWithoutDiscount:w,price:t?x:X,promotion:Y,quantity:p,term:H,usePrecision:$}),vr="",br="",yr="";A(c)&&qi&&(yr=ve(F,M,Te.recurrenceLabel,{recurrenceTerm:qi}));let Ht="";A(l)&&(m&&(Ht+=" "),Ht+=ve(F,M,Te.perUnitLabel,{perUnit:"LICENSE"}));let Bt="";A(d)&&P&&(m&&(Bt+=" "),Bt+=ve(F,M,R===Hi?Te.taxExclusiveLabel:Te.taxInclusiveLabel,{taxTerm:P})),r&&(vr=ve(F,M,Te.strikethroughAriaLabel,{strikethroughPrice:vr})),e&&(br=ve(F,M,Te.alternativePriceAriaLabel,{alternativePrice:br}));let _e=U.container;if(t&&(_e+=" "+U.containerOptical),r&&(_e+=" "+U.containerStrikethrough),i&&(_e+=" "+U.containerPromoStrikethrough),e&&(_e+=" "+U.containerAlternative),a&&(_e+=" "+U.containerAnnual),A(o))return Xc(_e,{...ji,accessibleLabel:vr,altAccessibleLabel:br,recurrenceLabel:yr,perUnitLabel:Ht,taxInclusivityLabel:Bt},V);let{currencySymbol:Wi,decimals:So,decimalsDelimiter:To,hasCurrencySpace:Yi,integer:Co,isCurrencyFirst:_o}=ji,Ve=[Co,To,So];_o?(Ve.unshift(Yi?"\xA0":""),Ve.unshift(Wi)):(Ve.push(Yi?"\xA0":""),Ve.push(Wi)),Ve.push(yr,Ht,Bt);let Po=Ve.join("");return z(_e,Po,V)},qn=()=>(e,t,r)=>{let i=Ue(t.promotion,t.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||A(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price&&(!t.promotion||i);return`${n?j({displayStrikethrough:!0})({isPromoApplied:i,...e},t,r)+"&nbsp;":""}${j({isAlternativePrice:n})({isPromoApplied:i,...e},t,r)}`},jn=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=Ue(t.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return j()(e,{...t,price:t.priceWithoutDiscount},r)+z(U.containerAnnualPrefix,"&nbsp;(")+j({displayAnnual:!0,instant:i})(n,{...t,price:t.priceWithoutDiscount},r)+z(U.containerAnnualSuffix,")");let o=(e.displayOldPrice===void 0||A(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${o?j({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${j({isAlternativePrice:o})({isPromoApplied:a,...e},t,r)}${z(U.containerAnnualPrefix,"&nbsp;(")}${j({displayAnnual:!0,instant:i})(n,t,r)}${z(U.containerAnnualSuffix,")")}`},Wn=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${j({isAlternativePrice:e.displayOldPrice})(e,t,r)}${z(U.containerAnnualPrefix,"&nbsp;(")}${j({displayAnnual:!0})(i,t,r)}${z(U.containerAnnualSuffix,")")}`};var Mt={...U,containerLegal:"price-legal",planType:"price-plan-type"},gr={...Te,planTypeLabel:"planTypeLabel"};function Kc(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},a={}){let n="";return n+=z(Mt.unitType,t,null,!0),r&&i&&(r+=". "),n+=z(Mt.taxInclusivity,r,!0),n+=z(Mt.planType,i,null),z(e,n,{...a})}var Yn=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:a,literals:n={}}={},{taxDisplay:s,taxTerm:o,planType:c}={},l={})=>{let d={...Di,...n},h=`${a.toLowerCase()}-${e.toUpperCase()}`,u="";A(t)&&(u=ve(d,h,gr.perUnitLabel,{perUnit:"LICENSE"}));let p="";e==="US"&&a==="en"&&(r=!1),A(r)&&o&&(p=ve(d,h,s===Hi?gr.taxExclusiveLabel:gr.taxInclusiveLabel,{taxTerm:o}));let m="";A(i)&&c&&(m=ve(d,h,gr.planTypeLabel,{planType:c}));let f=Mt.container;return f+=" "+Mt.containerLegal,Kc(f,{perUnitLabel:u,taxInclusivityLabel:p,planTypeLabel:m},l)};var Xn=j(),Kn=qn(),Zn=j({displayOptical:!0}),Qn=j({displayStrikethrough:!0}),Jn=j({displayPromoStrikethrough:!0}),eo=j({displayAnnual:!0}),to=j({displayOptical:!0,isAlternativePrice:!0}),ro=j({isAlternativePrice:!0}),io=Wn(),ao=jn(),no=Yn;var Zc=(e,t)=>{if(!(!yt(e)||!yt(t)))return Math.floor((t-e)/t*100)},oo=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,a=Zc(r,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var so=oo();var co="INDIVIDUAL_COM",Ui="TEAM_COM",lo="INDIVIDUAL_EDU",Fi="TEAM_EDU",Qc=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","LU_de","LU_en","LU_fr","MY_en","MY_ms","MU_en","NL_nl","NO_nb","NZ_en","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TH_en","TH_th","TR_tr","UA_uk"],Jc={[co]:["LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko","ZA_en"],[Ui]:["LT_lt","LV_lv","NG_en","CO_es","KR_ko","ZA_en"],[lo]:["LT_lt","LV_lv","SA_en","SG_en","SA_ar"],[Fi]:["SG_en","KR_ko"]},el={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0],ZA_en:[!1,!1,!1,!1]},tl=[co,Ui,lo,Fi],rl=e=>[Ui,Fi].includes(e);function Bi(e,t,r,i){if(e[t])return e[t];let a=`${t}_${r}`;if(e[a])return e[a];let n;if(i)n=e.find(s=>s.startsWith(`${t}_`));else{let s=Object.keys(e).find(o=>o.startsWith(`${t}_`));n=s?e[s]:null}return n}var il=(e,t,r,i)=>{let a=`${r}_${i}`,n=Bi(el,e,t,!1);if(n){let s=tl.indexOf(a);return n[s]}return rl(a)},al=(e,t,r,i)=>{if(Bi(Qc,e,t,!0))return!0;let a=Jc[`${r}_${i}`];return a?Bi(a,e,t,!0)?!0:_.displayTax:_.displayTax},zi=async(e,t,r,i)=>{let a=al(e,t,r,i);return{displayTax:a,forceTaxExclusive:a?il(e,t,r,i):_.forceTaxExclusive}},Rt=class Rt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Se(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(r){let i=te();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:h,promotionCode:u,quantity:p,alternativePrice:m,template:f,wcsOsi:v}=i.collectPriceOptions(r);return nr(Rt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:h,promotionCode:u,quantity:p,alternativePrice:m,template:f,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,a){this.masElement.attributeChangedCallback(r,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===de}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=te();if(!i)return!1;let a=i.collectPriceOptions(r,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let s=this.masElement.togglePending({});this.innerHTML="";let o=i.resolveOfferSelectors(n),c=await Promise.all(o),l=c.map(p=>{let m=wt(p,n);return m?.length?m[0]:null});if(l.some(p=>!p))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,h=xi(l);if(i.featureFlags[fe]||n[fe]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=h.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:p,language:m}=n,[f=""]=h.marketSegments,v=await zi(p,m,h.customerSegment,f);a.displayTax===void 0&&(n.displayTax=v?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=v?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(b=>{let E=wt(b,n);return E?.length?E[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);i.featureFlags[qe]&&n.displayAnnual!==!1&&(n.displayAnnual=!0);let u=xi(d);return this.renderOffers([u],n,s)}catch(s){throw this.innerHTML="",s}}renderOffers(r,i,a=void 0){if(!this.isConnected)return;let n=te();if(!n)return!1;if(a??(a=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(a,r,i)){this.innerHTML=n.buildPriceHTML(r,this.options);let s=this.closest("p, h3, div");if(!s||!s.querySelector('span[data-template="strikethrough"]')||s.querySelector(".alt-aria-label"))return!0;let o=s?.querySelectorAll('span[is="inline-price"]');return o.length>1&&o.length===s.querySelectorAll('span[data-template="strikethrough"]').length*2&&o.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(r,c.options))}),!0}}else{let s=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,s,this.options))return this.innerHTML="",!0}return!1}};g(Rt,"is","inline-price"),g(Rt,"tag","span");var be=Rt;window.customElements.get(be.is)||window.customElements.define(be.is,be,{extends:be.tag});function po({literals:e,providers:t,settings:r}){function i(s,o=null){let c={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(o&&t?.price)for(let P of t.price)P(o,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:h,displayTax:u,displayPlanType:p,forceTaxExclusive:m,perpetual:f,displayAnnual:v,promotionCode:b,quantity:E,alternativePrice:x,wcsOsi:w,...R}=Object.assign(c,o?.dataset??{},s??{});return c=Zt(Object.assign({...c,...R,displayOldPrice:A(l),displayPerUnit:A(d),displayRecurrence:A(h),displayTax:A(u),displayPlanType:A(p),forceTaxExclusive:A(m),perpetual:A(f),displayAnnual:A(v),promotionCode:Jt(b).effectivePromoCode,quantity:rt(E,_.quantity),alternativePrice:A(x),wcsOsi:ar(w)})),c}function a(s,o){if(!Array.isArray(s)||!s.length||!o)return"";let{template:c}=o,l;switch(c){case"discount":l=so;break;case"strikethrough":l=Qn;break;case"promo-strikethrough":l=Jn;break;case"annual":l=eo;break;case"legal":l=no;break;default:o.template==="optical"&&o.alternativePrice?l=to:o.template==="optical"?l=Zn:o.displayAnnual&&s[0].planType==="ABM"?l=o.promotionCode?ao:io:o.alternativePrice?l=ro:l=o.promotionCode?Kn:Xn}let[d]=s;return d={...d,...d.priceDetails},l({...r,...o},d)}let n=be.createInlinePrice;return{InlinePrice:be,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function nl({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||_.language),t??(t=e?.split("_")?.[1]||_.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function ho(e={},t){let r=t.featureFlags[fe],{commerce:i={}}=e,a=me.PRODUCTION,n=zr,s=B("checkoutClientId",i)??_.checkoutClientId,o=Et(B("checkoutWorkflowStep",i),Z,_.checkoutWorkflowStep),c=_.displayOldPrice,l=_.displayPerUnit,d=A(B("displayRecurrence",i),_.displayRecurrence),h=A(B("displayTax",i),_.displayTax),u=A(B("displayPlanType",i),_.displayPlanType),p=A(B("entitlement",i),_.entitlement),m=A(B("modal",i),_.modal),f=A(B("forceTaxExclusive",i),_.forceTaxExclusive),v=B("promotionCode",i)??_.promotionCode,b=rt(B("quantity",i)),E=B("wcsApiKey",i)??_.wcsApiKey,x=i?.env==="stage",w=we.PUBLISHED;["true",""].includes(i.allowOverride)&&(x=(B(Ur,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",w=Et(B(Fr,i),we,w)),x&&(a=me.STAGE,n=$r);let P=B(Br)??e.preview,H=typeof P<"u"&&P!=="off"&&P!=="false",$={};H&&($={preview:H});let Y=B("mas-io-url")??e.masIOUrl??`https://www${a===me.STAGE?".stage":""}.adobe.com/mas/io`,V=B("preselect-plan")??void 0;return{...nl(e),...$,displayOldPrice:c,checkoutClientId:s,checkoutWorkflowStep:o,displayPerUnit:l,displayRecurrence:d,displayTax:h,displayPlanType:u,entitlement:p,extraOptions:_.extraOptions,modal:m,env:a,forceTaxExclusive:f,promotionCode:v,quantity:b,alternativePrice:_.alternativePrice,wcsApiKey:E,wcsURL:n,landscape:w,masIOUrl:Y,...V&&{preselectPlan:V}}}async function mo(e,t={},r=2,i=100){let a;for(let n=0;n<=r;n++)try{let s=await fetch(e,t);return s.retryCount=n,s}catch(s){if(a=s,a.retryCount=n,n>r)break;await new Promise(o=>setTimeout(o,i*(n+1)))}throw a}var $i="wcs";function uo({settings:e}){let t=ee.module($i),{env:r,wcsApiKey:i}=e,a=new Map,n=new Map,s,o=new Map;async function c(m,f,v=!0){let b=te(),E=Or;t.debug("Fetching:",m);let x="",w;if(m.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let R=new Map(f),[P]=m.offerSelectorIds,H=Date.now()+Math.random().toString(36).substring(2,7),$=`${$i}:${P}:${H}${Vr}`,Y=`${$i}:${P}:${H}${qr}`,V;try{if(performance.mark($),x=new URL(e.wcsURL),x.searchParams.set("offer_selector_ids",P),x.searchParams.set("country",m.country),x.searchParams.set("locale",m.locale),x.searchParams.set("landscape",r===me.STAGE?"ALL":e.landscape),x.searchParams.set("api_key",i),m.language&&x.searchParams.set("language",m.language),m.promotionCode&&x.searchParams.set("promotion_code",m.promotionCode),m.currency&&x.searchParams.set("currency",m.currency),w=await mo(x.toString(),{credentials:"omit"}),w.ok){let F=[];try{let M=await w.json();t.debug("Fetched:",m,M),F=M.resolvedOffers??[]}catch(M){t.error(`Error parsing JSON: ${M.message}`,{...M.context,...b?.duration})}F=F.map(er),f.forEach(({resolve:M},X)=>{let ne=F.filter(({offerSelectorIds:Ge})=>Ge.includes(X)).flat();ne.length&&(R.delete(X),f.delete(X),M(ne))})}else E=Nr}catch(F){E=`Network error: ${F.message}`}finally{V=performance.measure(Y,$),performance.clearMarks($),performance.clearMeasures(Y)}if(v&&f.size){t.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=Va(w);f.forEach(M=>{M.reject(new it(E,{...m,...F,response:w,measure:zt(V),...b?.duration}))})}}function l(){clearTimeout(s);let m=[...n.values()];n.clear(),m.forEach(({options:f,promises:v})=>c(f,v))}function d(m){if(!m||typeof m!="object")throw new TypeError("Cache must be a Map or similar object");let f=r===me.STAGE?"stage":"prod",v=m[f];if(!v||typeof v!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[b,E]of Object.entries(v))a.set(b,Promise.resolve(E.map(er)));t.debug(`Prefilled WCS cache with ${v.size} entries`)}function h(){let m=a.size;o=new Map(a),a.clear(),t.debug(`Moved ${m} cache entries to stale cache`)}function u(m,f,v){let b=m!=="GB"&&!v?"MULT":"en",E=jr.includes(m)?m:_.country;return{validCountry:E,validLanguage:b,locale:`${f}_${E}`}}function p({country:m,language:f,perpetual:v=!1,promotionCode:b="",wcsOsi:E=[]}){let{validCountry:x,validLanguage:w,locale:R}=u(m,f,v),P=[x,w,b].filter(H=>H).join("-").toLowerCase();return E.map(H=>{let $=`${H}-${P}`;if(a.has($))return a.get($);let Y=new Promise((V,F)=>{let M=n.get(P);M||(M={options:{country:x,locale:R,...w==="MULT"&&{language:w},offerSelectorIds:[]},promises:new Map},n.set(P,M)),b&&(M.options.promotionCode=b),M.options.offerSelectorIds.push(H),M.promises.set(H,{resolve:V,reject:F}),l()}).catch(V=>{if(o.has($))return o.get($);throw V});return a.set($,Y),Y})}return{Commitment:Pe,PlanType:Na,Term:se,applyPlanType:er,resolveOfferSelectors:p,flushWcsCacheInternal:h,prefillWcsCache:d,normalizeCountryLanguageAndLocale:u}}var fo="mas-commerce-service",go="mas-commerce-service:start",xo="mas-commerce-service:ready",Nt,nt,$e,vo,Vi,Gi=class extends HTMLElement{constructor(){super(...arguments);G(this,$e);G(this,Nt);G(this,nt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let s=await r?.(i,a,this.imsSignedInPromise,n);return s||null})}get featureFlags(){return S(this,nt)||q(this,nt,{[fe]:lt(this,$e,Vi).call(this,fe),[qe]:lt(this,$e,Vi).call(this,qe)}),S(this,nt)}activate(){let r=S(this,$e,vo),i=ho(r,this);tr(r.lana);let a=ee.init(r.hostEnv).module("service");a.debug("Activating:",r);let s={price:xn(i)},o={checkout:new Set,price:new Set},c={literals:s,providers:o,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...un(c),...fn(c),...po(c),...uo(c),...Wr,Log:ee,resolvePriceTaxFlags:zi,get defaults(){return _},get log(){return ee},get providers(){return{checkout(d){return o.checkout.add(d),()=>o.checkout.delete(d)},price(d){return o.price.add(d),()=>o.price.delete(d)},has:d=>o.price.has(d)||o.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:s,settings:i});let l=new CustomEvent(Ft,{bubbles:!0,cancelable:!1,detail:this});performance.mark(xo),q(this,Nt,performance.measure(xo,go)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(go),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(wr).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":zt(S(this,Nt))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:s})=>a===0&&n===0&&s<200||s>=400),i=Array.from(new Map(r.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Nt=new WeakMap,nt=new WeakMap,$e=new WeakSet,vo=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let s=a.replace(/-([a-z])/g,o=>o[1].toUpperCase());i.commerce[s]=n}}),i},Vi=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||B(r))};window.customElements.get(fo)||window.customElements.define(fo,Gi);var wo="merch-card-collection",ol=2e4,sl={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"]},cl={plans:!0},ll=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),dl=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,pl=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),hl=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),ml=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,Ce,st,It,Dt,xr,Ao,ot=class extends yo{constructor(){super();G(this,xr);G(this,Ce,{});G(this,st);G(this,It);G(this,Dt);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return ye` <slot></slot>
    ...
    `);customElements.define("merch-card-collection-header",Ot);export{ot as MerchCardCollection,Ot as default};

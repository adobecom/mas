...
/**
 * Preview bulk delete for multiple cards
 * Adobe I/O Runtime action for studio_preview_bulk_delete operation
 * Returns preview of what would be deleted without executing the deletion
 */
async function main(params) {
    const { fragmentIds, __ow_headers } = params;
    ...
    try {
        ...
        const result = await studioOps.previewBulkDelete({ fragmentIds });

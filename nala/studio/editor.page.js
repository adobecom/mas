...
export default class EditorPage {
    constructor(page) {
        ...
        this.badgeColor = this.panel.locator('sp-picker#badgeColor button');
        this.badgeBorderColor = this.panel.locator('sp-picker#badgeBorderColor button');
        this.cardBorderColor = this.panel.locator('sp-picker#border-color button');
        ...
        this.borderColor = this.panel.locator('sp-picker#border-color button');
        this.backgroundColor = this.panel.locator('sp-picker#backgroundColor button');

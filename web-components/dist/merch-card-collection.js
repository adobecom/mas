...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as gt}from"./lit-all.min.js";var ia=`
:root {
...
`;var Gt=class extends O{constructor(t){super(t)}getGlobalCSS(){return ia}renderLayout(){return gt`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?gt`
                  ...
                  `:gt`
                      <hr />
                      ${this.secureLabelFooter}
                  `}`}};import{html as na}from"./lit-all.min.js";var aa=`
:root {
...
`;var Vt=class extends O{constructor(t){super(t)}getGlobalCSS(){return aa}renderLayout(){return na` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":na`<hr />`} ${this.secureLabelFooter}`}};import{html as Ve,css as ts,unsafeCSS as sa}from"./lit-all.min.js";var oa=`
  :root {
...
`;var rs=32,qe=class extends O{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Ve`<slot name="secure-transaction-label">
    ...
    `);import{html as xt,css as is,nothing as qt}from"./lit-all.min.js";var ca=`
:root {
...
`;var je=class extends O{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return ua}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Xr` ${this.badge}
    ...
    `);import{html as Kr,css as os}from"./lit-all.min.js";var fa=`
:root {
...
`;var We=class extends O{constructor(t){super(t)}getGlobalCSS(){return fa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Kr` ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var xa={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ye=class extends O{constructor(t){super(t)}getGlobalCSS(){return ga}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Zr`${this.cardImage}
            <div class="body">
    ...
    `);import{html as cs,css as ls}from"./lit-all.min.js";var va=`
:root {
...
`;var Qr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Xe=class extends O{getGlobalCSS(){return va}get aemFragmentMapping(){return Qr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let r=this.card.querySelector('[slot="price"]');r&&this.updateCardElementMinHeight(r,"price");let i=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');i&&this.updateCardElementMinHeight(i,"icons")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),k.isDesktopOrUp)){let t=this.getContainer();if(!t)return;requestAnimationFrame(()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(i=>i.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Bt()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let r=()=>{if(Bt())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};r();let i=window.matchMedia(N);this.mediaQueryListener=()=>{r()},i.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(N).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||Bt())return;let a=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",a)}renderLayout(){return cs`
    ...
    `);import{html as ya,css as ds}from"./lit-all.min.js";var ba=`
:root {
...
`;var Jr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},Ke=class extends O{getGlobalCSS(){return ba}get aemFragmentMapping(){return Jr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return ya`
    ...
    `);import{css as ps,html as hs}from"./lit-all.min.js";var Ea=`
...
`;var wa={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ze=class extends O{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Ea}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${K}[data-template="price"]`);if(!r)return;let i=r.cloneNode(!0);this.legal=i,r.dataset.displayTax="false",r.dataset.displayPerUnit="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return hs`
            ${this.badge}
            <div class="body">
    ...
    `);var Sa=new Map;var J=(e,t,r=null,i=null,a)=>{Sa.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:a})};J("catalog",Ge,ra,Ge.variantStyle);J("image",Gt);J("inline-heading",Vt);J("mini-compare-chart",qe,null,qe.variantStyle);J("plans",Q,jt,Q.variantStyle,Q.collectionOptions);J("plans-students",Q,da,Q.variantStyle,Q.collectionOptions);J("plans-education",Q,la,Q.variantStyle,Q.collectionOptions);J("plans-v2",Se,ma,Se.variantStyle,Se.collectionOptions);J("product",je,null,je.variantStyle);J("segment",We,null,We.variantStyle);J("special-offers",Ye,xa,Ye.variantStyle);J("simplified-pricing-express",Xe,Qr,Xe.variantStyle);J("full-pricing-express",Ke,Jr,Ke.variantStyle);J("mini",Ze,wa,Ze.variantStyle);function $t(e){return Sa.get(e)?.fragmentMapping}var Aa="tacocat.js";var ei=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),Ta=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function B(e,t={},{metadata:r=!0,search:i=!0,storage:a=!0}={}){let n;if(i&&n==null){let o=new URLSearchParams(window.location.search),s=Qe(i)?i:e;n=o.get(s)}if(a&&n==null){let o=Qe(a)?a:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(r&&n==null){let o=us(Qe(r)?r:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[e]}var ms=e=>typeof e=="boolean",Yt=e=>typeof e=="function",Xt=e=>typeof e=="number",Ca=e=>e!=null&&typeof e=="object";var Qe=e=>typeof e=="string",_a=e=>Qe(e)&&e,vt=e=>Xt(e)&&Number.isFinite(e)&&e>0;function Kt(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,i])=>{t(i)&&delete e[r]}),e}function S(e,t){if(ms(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function bt(e,t,r){let i=Object.values(t);return i.find(a=>ei(a,e))??r??i[0]}function us(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,i)=>`${r}-${i}`).replace(/\W+/gu,"-").toLowerCase()}function Pa(e,t=1){return Xt(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var fs=Date.now(),ti=()=>`(+${Date.now()-fs}ms)`,Zt=new Set,gs=S(B("tacocat.debug",{},{metadata:!1}),!1);function La(e){let t=`[${Aa}/${e}]`,r=(o,s,...c)=>o?!0:(a(s,...c),!1),i=gs?(o,...s)=>{console.debug(`${t} ${o}`,...s,ti())}:()=>{},a=(o,...s)=>{let c=`${t} ${o}`;Zt.forEach(([l])=>l(c,...s))};return{assert:r,debug:i,error:a,warn:(o,...s)=>{let c=`${t} ${o}`;Zt.forEach(([,l])=>l(c,...s))}}}function xs(e,t){let r=[e,t];return Zt.add(r),()=>{Zt.delete(r)}}xs((e,...t)=>{console.error(e,...t,ti())},(e,...t)=>{console.warn(e,...t,ti())});var vs="no promo",ka="promo-tag",bs="yellow",ys="neutral",Es=(e,t,r)=>{let i=n=>n||vs,a=r?` (was "${i(t)}")`:"";return`${i(e)}${a}`},ws="cancel-context",Qt=(e,t)=>{let r=e===ws,i=!r&&e?.length>0,a=(i||r)&&(t&&t!=e||!t&&!r),n=a&&i||!a&&!!t,o=n?e||t:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?ka:`${ka} no-promo`,text:Es(o,t,a),variant:n?bs:ys,isOverriden:a}};var ri;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(ri||(ri={}));var ae;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(ae||(ae={}));var ce;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(ce||(ce={}));var ii;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(ii||(ii={}));var ai;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ai||(ai={}));var ni;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(ni||(ni={}));var oi;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(oi||(oi={}));var si="ABM",ci="PUF",li="M2M",di="PERPETUAL",pi="P3Y",Ss="TAX_INCLUSIVE_DETAILS",As="TAX_EXCLUSIVE",Ma={ABM:si,PUF:ci,M2M:li,PERPETUAL:di,P3Y:pi},Np={[si]:{commitment:ae.YEAR,term:ce.MONTHLY},[ci]:{commitment:ae.YEAR,term:ce.ANNUAL},[li]:{commitment:ae.MONTH,term:ce.MONTHLY},[di]:{commitment:ae.PERPETUAL,term:void 0},[pi]:{commitment:ae.THREE_MONTHS,term:ce.P3Y}},Ra="Value is not an offer",Jt=e=>{if(typeof e!="object")return Ra;let{commitment:t,term:r}=e,i=Ts(t,r);return{...e,planType:i}};var Ts=(e,t)=>{switch(e){case void 0:return Ra;case"":return"";case ae.YEAR:return t===ce.MONTHLY?si:t===ce.ANNUAL?ci:"";case ae.MONTH:return t===ce.MONTHLY?li:"";case ae.PERPETUAL:return di;case ae.TERM_LICENSE:return t===ce.P3Y?pi:"";default:return""}};function Oa(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:i,priceWithoutTax:a,priceWithoutDiscountAndTax:n,taxDisplay:o}=t;if(o!==Ss)return e;let s={...e,priceDetails:{...t,price:a??r,priceWithoutDiscount:n??i,taxDisplay:As}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Re={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Na=1e3;function Cs(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Ia(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:i,originatingRequest:a,status:n}=e;return[i,n,a].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Re.serializableTypes.includes(r))return r}return e}function _s(e,t){if(!Re.ignoredProperties.includes(e))return Ia(t)}var hi={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,i=[],a=[],n=t;r.forEach(l=>{l!=null&&(Cs(l)?i:a).push(l)}),i.length&&(n+=" "+i.map(Ia).join(" "));let{pathname:o,search:s}=window.location,c=`${Re.delimiter}page=${o}${s}`;c.length>Na&&(c=`${c.slice(0,Na)}<trunc>`),n+=c,a.length&&(n+=`${Re.delimiter}facts=`,n+=JSON.stringify(a,_s)),window.lana?.log(n,Re)}};function er(e){Object.assign(Re,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Re&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var Da={LOCAL:"local",PROD:"prod",STAGE:"stage"},mi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},ui=new Set,fi=new Set,Ha=new Map,Ba={append({level:e,message:t,params:r,timestamp:i,source:a}){console[e](`${i}ms [${a}] %c${t}`,"font-weight: bold;",...r)}},Ua={filter:({level:e})=>e!==mi.DEBUG},Ps={filter:()=>!1};function Ls(e,t,r,i,a){return{level:e,message:t,namespace:r,get params(){return i.length===1&&Yt(i[0])&&(i=i[0](),Array.isArray(i)||(i=[i])),i},source:a,timestamp:performance.now().toFixed(3)}}function ks(e){[...fi].every(t=>t(e))&&ui.forEach(t=>t(e))}function Fa(e){let t=(Ha.get(e)??0)+1;Ha.set(e,t);let r=`${e} #${t}`,i={id:r,namespace:e,module:a=>Fa(`${i.namespace}/${a}`),updateConfig:er};return Object.values(mi).forEach(a=>{i[a]=(n,...o)=>ks(Ls(a,n,e,o,r))}),Object.seal(i)}function tr(...e){e.forEach(t=>{let{append:r,filter:i}=t;Yt(i)&&fi.add(i),Yt(r)&&ui.add(r)})}function Ms(e={}){let{name:t}=e,r=S(B("commerce.debug",{search:!0,storage:!0}),t===Da.LOCAL);return tr(r?Ba:Ua),t===Da.PROD&&tr(hi),ee}function Rs(){ui.clear(),fi.clear()}var ee={...Fa(Dr),Level:mi,Plugins:{consoleAppender:Ba,debugFilter:Ua,quietFilter:Ps,lanaAppender:hi},init:Ms,reset:Rs,use:tr};var Os="mas-commerce-service",gi=ee.module("utilities"),Ns={requestId:dt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function yt(e,{country:t,forceTaxExclusive:r}){let i;if(e.length<2)i=e;else{let a=t==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===a?-1:o.language===a?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),i=[e[0]]}return r&&(i=i.map(Oa)),i}function xi(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[t,...r]=e;for(let c of r)c.commitment!==t.commitment&&gi.warn("Offers have different commitment types, summing may produce unexpected results",{expected:t.commitment,actual:c.commitment}),c.term!==t.term&&gi.warn("Offers have different terms, summing may produce unexpected results",{expected:t.term,actual:c.term}),c.priceDetails?.formatString!==t.priceDetails?.formatString&&gi.warn("Offers have different currency formats, summing may produce unexpected results",{expected:t.priceDetails?.formatString,actual:c.priceDetails?.formatString});let i=e.reduce((c,l)=>c+(l.priceDetails?.price||0),0),a=e.reduce((c,l)=>c+(l.priceDetails?.priceWithoutDiscount||0),0),n=e.reduce((c,l)=>c+(l.priceDetails?.priceWithoutTax||0),0),o=e.reduce((c,l)=>c+(l.priceDetails?.priceWithoutDiscountAndTax||0),0),s=e.flatMap(c=>c.offerSelectorIds||[]);return{...t,offerSelectorIds:s,priceDetails:{...t.priceDetails,price:Math.round(i*100)/100,...a>0&&{priceWithoutDiscount:Math.round(a*100)/100},...n>0&&{priceWithoutTax:Math.round(n*100)/100},...o>0&&{priceWithoutDiscountAndTax:Math.round(o*100)/100}}}}var rr=e=>window.setTimeout(e);function Je(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(Pa).filter(vt);return r.length||(r=[t]),r}function ir(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(_a)}function te(){return document.getElementsByTagName(Os)?.[0]}function za(e){let t={};if(!e?.headers)return t;let r=e.headers;for(let[i,a]of Object.entries(Ns)){let n=r.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[i]=n)}return t}var et=class e extends Error{constructor(t,r,i){if(super(t,{cause:i}),this.name="MasError",r.response){let a=r.response.headers?.get(dt);a&&(r.requestId=a),r.response.status&&(r.status=r.response.status,r.statusText=r.response.statusText),r.response.url&&(r.url=r.response.url)}delete r.response,this.context=r,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let t=Object.entries(this.context||{}).map(([i,a])=>`${i}: ${JSON.stringify(a)}`).join(", "),r=`${this.name}: ${this.message}`;return t&&(r+=` (${t})`),this.cause&&(r+=`
Caused by: ${this.cause}`),r}};var Is={[de]:Lr,[Ee]:kr,[ue]:Mr},Ds={[de]:Nr,[ue]:Ir},Et,Ae=class{constructor(t){G(this,Et);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",Ee);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=t,this.log=ee.module("mas-element")}update(){[de,Ee,ue].forEach(t=>{this.wrapperElement.classList.toggle(Is[t],t===this.state)})}notify(){(this.state===ue||this.state===de)&&(this.state===ue?this.promises.forEach(({resolve:r})=>r(this.wrapperElement)):this.state===de&&this.promises.forEach(({reject:r})=>r(this.error)),this.promises=[]);let t=this.error;this.error instanceof et&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Ds[this.state],{bubbles:!0,composed:!0,detail:t}))}attributeChangedCallback(t,r,i){this.changes.set(t,i),this.requestUpdate()}connectedCallback(){q(this,Et,te()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:r,state:i}=this;return ue===i?Promise.resolve(this.wrapperElement):de===i?Promise.reject(t):new Promise((a,n)=>{r.push({resolve:a,reject:n})})}toggleResolved(t,r,i){return t!==this.version?!1:(i!==void 0&&(this.options=i),this.state=ue,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),rr(()=>this.notify()),!0)}toggleFailed(t,r,i){if(t!==this.version)return!1;i!==void 0&&(this.options=i),this.error=r,this.state=de,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${r.message}`,{element:this.wrapperElement,...r.context,...A(this,Et)?.duration}),rr(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=Ee,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!te()||this.timer)return;let{error:r,options:i,state:a,value:n,version:o}=this;this.state=Ee,this.timer=rr(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===Ee&&this.version===o&&(this.state=a,this.error=r,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,i)}})}};Et=new WeakMap;function $a(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function ar(e,t={}){let{tag:r,is:i}=e,a=document.createElement(r,{is:i});return a.setAttribute("is",i),Object.assign(a.dataset,$a(t)),a}function Ga(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,$a(t)),e):null}function Hs(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Ie,Oe=class Oe extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new Ae(this));G(this,Ie);this.setAttribute("is",Oe.is)}get isUptLink(){return!0}initializeWcsData(r,i){this.setAttribute("data-wcs-osi",r),i&&this.setAttribute("data-promotion-code",i)}attributeChangedCallback(r,i,a){this.masElement.attributeChangedCallback(r,i,a)}connectedCallback(){this.masElement.connectedCallback(),q(this,Ie,mt()),A(this,Ie)&&(this.log=A(this,Ie).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),q(this,Ie,void 0)}requestUpdate(r=!1){this.masElement.requestUpdate(r)}onceSettled(){return this.masElement.onceSettled()}async render(){let r=mt();if(!r)return!1;this.dataset.imsCountry||r.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let i=r.collectCheckoutOptions({},this);if(!i.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(i),n=r.resolveOfferSelectors(i);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=i,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,h=this.getAttribute("data-promotion-code");h&&(d+=`&promotion_code=${encodeURIComponent(h)}`),this.href=`${Hs(l)}?${d}`,this.masElement.toggleResolved(a,o,i)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${i.wcsOsi}.`,o.message);return this.masElement.toggleFailed(a,s,i),!1}}static createFrom(r){let i=new Oe;for(let a of r.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?i.setAttribute("class",a.value.replace("upt-link","").trim()):i.setAttribute(a.name,a.value));return i.innerHTML=r.innerHTML,i.setAttribute("tabindex",0),i}};Ie=new WeakMap,g(Oe,"is","upt-link"),g(Oe,"tag","a"),g(Oe,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Ne=Oe;window.customElements.get(Ne.is)||window.customElements.define(Ne.is,Ne,{extends:Ne.tag});function Va(e){return e&&(e.startsWith("plans")?"plans":e)}var Bs=/[0-9\-+#]/,Us=/[^\d\-+#]/g;function qa(e){return e.search(Bs)}function Fs(e="#.##"){let t={},r=e.length,i=qa(e);t.prefix=i>0?e.substring(0,i):"";let a=qa(e.split("").reverse().join("")),n=r-a,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);t.suffix=a>0?e.substring(s,r):"",t.mask=e.substring(i,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Us);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function zs(e,t,r){let i=!1,a={value:e};e<0&&(i=!0,a.value=-a.value),a.sign=i?"-":"",a.value=Number(a.value).toFixed(t.fraction&&t.fraction.length),a.value=Number(a.value).toString();let n=t.fraction&&t.fraction.lastIndexOf("0"),[o="0",s=""]=a.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+("0."+s)).toFixed(n+1).replace("0.","")),a.integer=o,a.fraction=s,$s(a,t),(a.result==="0"||a.result==="")&&(i=!1,a.sign=""),!i&&t.maskHasPositiveSign?a.sign="+":i&&t.maskHasPositiveSign?a.sign="-":i&&(a.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),a}function $s(e,t){e.result="";let r=t.integer.split(t.separator),i=r.join(""),a=i&&i.indexOf("0");if(a>-1)for(;e.integer.length<i.length-a;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let n=r[1]&&r[r.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Gs(e,t,r={}){if(!e||isNaN(Number(t)))return t;let i=Fs(e),a=zs(t,i,r);return i.prefix+a.sign+a.result+i.suffix}var ja=Gs;var Wa=".",Vs=",",Xa=/^\s+/,Ka=/\s+$/,Ya="&nbsp;",vi=e=>e*12,He=(e,t,r=1)=>{if(!e)return!1;let{start:i,end:a,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||r<s)return!1;let l=t?new Date(t):new Date;if(!i||!a)return!1;let d=new Date(i),h=new Date(a);return l>=d&&l<=h},De={MONTH:"MONTH",YEAR:"YEAR"},qs={[se.ANNUAL]:12,[se.MONTHLY]:1,[se.THREE_YEARS]:36,[se.TWO_YEARS]:24},bi=(e,t)=>({accept:e,round:t}),js=[bi(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),bi(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),bi(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],yi={[Pe.YEAR]:{[se.MONTHLY]:De.MONTH,[se.ANNUAL]:De.YEAR},[Pe.MONTH]:{[se.MONTHLY]:De.MONTH}},Ws=(e,t)=>e.indexOf(`'${t}'`)===0,Ys=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),i=Qa(r);return!!i?t||(r=r.replace(/[,\.]0+/,i)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Ks(e)),r},Xs=e=>{let t=Zs(e),r=Ws(e,t),i=e.replace(/'.*?'/,""),a=Xa.test(i)||Ka.test(i);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:a}},Za=e=>e.replace(Xa,Ya).replace(Ka,Ya),Ks=e=>e.match(/#(.?)#/)?.[1]===Wa?Vs:Wa,Zs=e=>e.match(/'(.*?)'/)?.[1]??"",Qa=e=>e.match(/0(.?)0/)?.[1]??"";function tt({formatString:e,price:t,usePrecision:r,isIndianPrice:i=!1},a,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=Xs(e),l=r?Qa(e):"",d=Ys(e,r),h=r?2:0,u=n(t,{currencySymbol:o}),p=i?u.toLocaleString("hi-IN",{minimumFractionDigits:h,maximumFractionDigits:h}):ja(d,u),m=r?p.lastIndexOf(l):p.length,f=p.substring(0,m),v=p.substring(m+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,p).replace(/SYMBOL/,o),currencySymbol:o,decimals:v,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:a}}var Ja=e=>{let{commitment:t,term:r,usePrecision:i}=e,a=qs[r]??1;return tt(e,a>1?De.MONTH:yi[t]?.[r],n=>{let o={divisor:a,price:n,usePrecision:i},{round:s}=js.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},en=({commitment:e,term:t,...r})=>tt(r,yi[e]?.[t]),tn=e=>{let{commitment:t,instant:r,price:i,originalPrice:a,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(t===Pe.YEAR&&c===se.MONTHLY){if(!o)return tt(e,De.YEAR,vi);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(He(o,r,s)){let h=parseInt(d.replace("P","").replace("M",""));if(isNaN(h))return vi(i);let u=a*h,p=n*(12-h),m=Math.round((u+p)*100)/100;return tt({...e,price:m},De.YEAR)}default:return tt(e,De.YEAR,()=>vi(n??i))}}return tt(e,yi[t]?.[c])};var rn="download",an="upgrade",nn={e:"EDU",t:"TEAM"};function on(e,t={},r=""){let i=te();if(!i)return null;let{checkoutMarketSegment:a,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:h,quantity:u,wcsOsi:p,extraOptions:m,analyticsId:f}=i.collectCheckoutOptions(t),v=ar(e,{checkoutMarketSegment:a,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:h,quantity:u,wcsOsi:p,extraOptions:m,analyticsId:f});return r&&(v.innerHTML=`<span style="pointer-events: none;">${r}</span>`),v}function sn(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new Ae(this))}attributeChangedCallback(i,a,n){this.masElement.attributeChangedCallback(i,a,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let i=this.options?.ms??this.value?.[0].marketSegments?.[0];return nn[i]??i}get customerSegment(){let i=this.options?.cs??this.value?.[0]?.customerSegment;return nn[i]??i}get is3in1Modal(){return Object.values(ke).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let i=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!i||i.content!=="off")}requestUpdate(i=!1){return this.masElement.requestUpdate(i)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(i={}){let a=te();if(!a)return!1;this.dataset.imsCountry||a.imsCountryPromise.then(p=>{p&&(this.dataset.imsCountry=p)}),i.imsCountry=null;let n=a.collectCheckoutOptions(i,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(p){this.masElement.log?.error("cannot parse exta checkout options",p)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=a.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(p=>yt(p,n));let d=l.flat().find(p=>p.promotion);!He(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let u=await a.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},u,s)}renderOffers(i,a,n={},o=void 0,s=void 0){let c=te();if(!c)return!1;if(a={...JSON.parse(this.dataset.extraOptions??"{}"),...a,...n},s??(s=this.masElement.togglePending(a)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(rn,an),this.masElement.toggleResolved(s,i,a);let{url:d,text:h,className:u,handler:p}=o;d&&this.setCheckoutUrl(d),h&&(this.firstElementChild.innerHTML=h),u&&this.classList.add(...u.split(" ")),p&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=p.bind(this))}if(i.length){if(this.masElement.toggleResolved(s,i,a)){if(!this.classList.contains(rn)&&!this.classList.contains(an)){let d=c.buildCheckoutURL(i,a);this.setCheckoutUrl(a.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,a))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(i){}updateOptions(i={}){let a=te();if(!a)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:h,promotionCode:u,quantity:p,wcsOsi:m}=a.collectCheckoutOptions(i);return Ga(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:h,promotionCode:u,quantity:p,wcsOsi:m}),!0}}}var wt=class wt extends sn(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return on(wt,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};g(wt,"is","checkout-link"),g(wt,"tag","a");var xe=wt;window.customElements.get(xe.is)||window.customElements.define(xe.is,xe,{extends:xe.tag});var Qs="p_draft_landscape",Js="/store/",ec=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),Ei=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),tc=["env","workflowStep","clientId","country"],cn=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),ln=e=>ec.get(e)??e;function nr(e,t,r){for(let[i,a]of Object.entries(e)){let n=ln(i);a!=null&&r.has(n)&&t.set(n,a)}}function rc(e){switch(e){case $r.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function ic(e,t){for(let r in e){let i=e[r];for(let[a,n]of Object.entries(i)){if(n==null)continue;let o=ln(a);t.set(`items[${r}][${o}]`,n)}}}function ac({url:e,modal:t,is3in1:r}){if(!r||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let i=e.searchParams.get("af");return e.searchParams.set("af",[i,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",t===ke.CRM?"creative":"mini_plans"),e}function nc(e){let t=new URLSearchParams(window.location.search),r={};cn.forEach(i=>{let a=t.get(i);a!==null&&(r[i]=a)}),Object.keys(r).length>0&&nr(r,e.searchParams,cn)}function dn(e){oc(e);let{env:t,items:r,workflowStep:i,marketSegment:a,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:h,...u}=e,p=new URL(rc(t));if(p.pathname=`${Js}${i}`,i!==Z.SEGMENTATION&&i!==Z.CHANGE_PLAN_TEAM_PLANS&&ic(r,p.searchParams),nr({...u},p.searchParams,Ei),nc(p),c===we.DRAFT&&nr({af:Qs},p.searchParams,Ei),i===Z.SEGMENTATION){let m={marketSegment:a,offerType:o,customerSegment:n,productArrangementCode:s,quantity:r?.[0]?.quantity,addonProductArrangementCode:s?r?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:r?.[1]?.productArrangementCode};h?.toLowerCase()==="edu"?p.searchParams.set("ms","EDU"):h?.toLowerCase()==="team"&&p.searchParams.set("cs","TEAM"),nr(m,p.searchParams,Ei),p.searchParams.get("ot")==="PROMOTION"&&p.searchParams.delete("ot"),p=ac({url:p,modal:l,is3in1:d})}return p.toString()}function oc(e){for(let t of tc)if(!e[t])throw new Error(`Argument "checkoutData" is not valid, missing: ${t}`);if(e.workflowStep!==Z.SEGMENTATION&&e.workflowStep!==Z.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var _=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:Z.EMAIL,country:"US",displayOldPrice:!1,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:me.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:we.PUBLISHED});function pn({settings:e,providers:t}){function r(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:h,quantity:u,preselectPlan:p,env:m}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:h,quantity:u,preselectPlan:p,env:m};if(o)for(let Fe of t.checkout)Fe(o,f);let{checkoutMarketSegment:v,checkoutWorkflowStep:b=c,imsCountry:E,country:x=E??l,language:w=d,quantity:R=u,entitlement:P,upgrade:H,modal:$,perpetual:Y,promotionCode:V=h,wcsOsi:F,extraOptions:M,...X}=Object.assign(f,o?.dataset??{},n??{}),ne=bt(b,Z,_.checkoutWorkflowStep);return f=Kt({...X,extraOptions:M,checkoutClientId:s,checkoutMarketSegment:v,country:x,quantity:Je(R,_.quantity),checkoutWorkflowStep:ne,language:w,entitlement:S(P),upgrade:S(H),modal:$,perpetual:S(Y),promotionCode:Qt(V).effectivePromoCode,wcsOsi:ir(F),preselectPlan:p}),f}function i(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:h,country:u,promotionCode:p,quantity:m,preselectPlan:f,ms:v,cs:b,...E}=r(o),x=document.querySelector("meta[name=mas-ff-3in1]"),w=Object.values(ke).includes(o.modal)&&(!x||x.content!=="off"),R=window.frameElement||w?"if":"fp",[{productArrangementCode:P,marketSegments:[H],customerSegment:$,offerType:Y}]=n,V=v??H??d,F=b??$;f?.toLowerCase()==="edu"?V="EDU":f?.toLowerCase()==="team"&&(F="TEAM");let M={is3in1:w,checkoutPromoCode:p,clientId:l,context:R,country:u,env:s,items:[],marketSegment:V,customerSegment:F,offerType:Y,productArrangementCode:P,workflowStep:h,landscape:c,...E},X=m[0]>1?m[0]:void 0;if(n.length===1){let{offerId:ne}=n[0];M.items.push({id:ne,quantity:X})}else M.items.push(...n.map(({offerId:ne,productArrangementCode:Fe})=>({id:ne,quantity:X,...w?{productArrangementCode:Fe}:{}})));return dn(M)}let{createCheckoutLink:a}=xe;return{CheckoutLink:xe,CheckoutWorkflowStep:Z,buildCheckoutURL:i,collectCheckoutOptions:r,createCheckoutLink:a}}function sc({interval:e=200,maxAttempts:t=25}={}){let r=ee.module("ims");return new Promise(i=>{r.debug("Waing for IMS to be ready");let a=0;function n(){window.adobeIMS?.initialized?i():++a>t?(r.debug("Timeout"),i()):setTimeout(n,e)}n()})}function cc(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function lc(e){let t=ee.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:i})=>(t.debug("Got user country:",i),i),i=>{t.error("Unable to get user country:",i)}):null)}function hn({}){let e=sc(),t=cc(e),r=lc(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}var mn=window.masPriceLiterals;function un(e){if(Array.isArray(mn)){let t=e.locale==="id_ID"?"in":e.language,r=a=>mn.find(n=>ei(n.lang,a)),i=r(t)??r(_.language);if(i)return Object.freeze(i)}return{}}var wi=function(e,t){return wi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,i){r.__proto__=i}||function(r,i){for(var a in i)Object.prototype.hasOwnProperty.call(i,a)&&(r[a]=i[a])},wi(e,t)};function St(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");wi(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var T=function(){return T=Object.assign||function(t){for(var r,i=1,a=arguments.length;i<a;i++){r=arguments[i];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t},T.apply(this,arguments)};function or(e,t,r){if(r||arguments.length===2)for(var i=0,a=t.length,n;i<a;i++)(n||!(i in t))&&(n||(n=Array.prototype.slice.call(t,0,i)),n[i]=t[i]);return e.concat(n||Array.prototype.slice.call(t))}var y;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(y||(y={}));var I;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(I||(I={}));var Be;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Be||(Be={}));function Si(e){return e.type===I.literal}function fn(e){return e.type===I.argument}function sr(e){return e.type===I.number}function cr(e){return e.type===I.date}function lr(e){return e.type===I.time}function dr(e){return e.type===I.select}function pr(e){return e.type===I.plural}function gn(e){return e.type===I.pound}function hr(e){return e.type===I.tag}function mr(e){return!!(e&&typeof e=="object"&&e.type===Be.number)}function At(e){return!!(e&&typeof e=="object"&&e.type===Be.dateTime)}var Ai=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var dc=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function xn(e){var t={};return e.replace(dc,function(r){var i=r.length;switch(r[0]){case"G":t.era=i===4?"long":i===5?"narrow":"short";break;case"y":t.year=i===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][i-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][i-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=i===4?"short":i===5?"narrow":"short";break;case"e":if(i<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][i-4];break;case"c":if(i<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][i-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][i-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][i-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][i-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][i-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][i-1];break;case"s":t.second=["numeric","2-digit"][i-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=i<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var vn=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function wn(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(vn).filter(function(u){return u.length>0}),r=[],i=0,a=t;i<a.length;i++){var n=a[i],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var h=d[l];if(h.length===0)throw new Error("Invalid number skeleton")}r.push({stem:s,options:c})}return r}function pc(e){return e.replace(/^(.*?)-/,"")}var bn=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Sn=/^(@+)?(\+|#+)?[rs]?$/g,hc=/(\*)(0+)|(#+)(0+)|(0+)/g,An=/^(0+)$/;function yn(e){var t={};return e[e.length-1]==="r"?t.roundingPriority="morePrecision":e[e.length-1]==="s"&&(t.roundingPriority="lessPrecision"),e.replace(Sn,function(r,i,a){return typeof a!="string"?(t.minimumSignificantDigits=i.length,t.maximumSignificantDigits=i.length):a==="+"?t.minimumSignificantDigits=i.length:i[0]==="#"?t.maximumSignificantDigits=i.length:(t.minimumSignificantDigits=i.length,t.maximumSignificantDigits=i.length+(typeof a=="string"?a.length:0)),""}),t}function Tn(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function mc(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!An.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function En(e){var t={},r=Tn(e);return r||t}function Cn(e){for(var t={},r=0,i=e;r<i.length;r++){var a=i[r];switch(a.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=a.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=pc(a.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=T(T(T({},t),{notation:"scientific"}),a.options.reduce(function(c,l){return T(T({},c),En(l))},{}));continue;case"engineering":t=T(T(T({},t),{notation:"engineering"}),a.options.reduce(function(c,l){return T(T({},c),En(l))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(a.options[0]);continue;case"integer-width":if(a.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");a.options[0].replace(hc,function(c,l,d,h,u,p){if(l)t.minimumIntegerDigits=d.length;else{if(h&&u)throw new Error("We currently do not support maximum integer digits");if(p)throw new Error("We currently do not support exact integer digits")}return""});continue}if(An.test(a.stem)){t.minimumIntegerDigits=a.stem.length;continue}if(bn.test(a.stem)){if(a.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");a.stem.replace(bn,function(c,l,d,h,u,p){return d==="*"?t.minimumFractionDigits=l.length:h&&h[0]==="#"?t.maximumFractionDigits=h.length:u&&p?(t.minimumFractionDigits=u.length,t.maximumFractionDigits=u.length+p.length):(t.minimumFractionDigits=l.length,t.maximumFractionDigits=l.length),""});var n=a.options[0];n==="w"?t=T(T({},t),{trailingZeroDisplay:"stripIfInteger"}):n&&(t=T(T({},t),yn(n)));continue}if(Sn.test(a.stem)){t=T(T({},t),yn(a.stem));continue}var o=Tn(a.stem);o&&(t=T(T({},t),o));var s=mc(a.stem);s&&(t=T(T({},t),s))}return t}var Tt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function _n(e,t){for(var r="",i=0;i<e.length;i++){var a=e.charAt(i);if(a==="j"){for(var n=0;i+1<e.length&&e.charAt(i+1)===a;)n++,i++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=uc(t);for((l=="H"||l=="k")&&(s=0);s-- >0;)r+=c;for(;o-- >0;)r=l+r}else a==="J"?r+="H":r+=a}return r}function uc(e){var t=e.hourCycle;if(t===void 0&&e.hourCycles&&e.hourCycles.length&&(t=e.hourCycles[0]),t)switch(t){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var r=e.language,i;r!=="root"&&(i=e.maximize().region);var a=Tt[i||""]||Tt[r||""]||Tt["".concat(r,"-001")]||Tt["001"];return a[0]}var Ti,fc=new RegExp("^".concat(Ai.source,"*")),gc=new RegExp("".concat(Ai.source,"*$"));function C(e,t){return{start:e,end:t}}var xc=!!String.prototype.startsWith,vc=!!String.fromCodePoint,bc=!!Object.fromEntries,yc=!!String.prototype.codePointAt,Ec=!!String.prototype.trimStart,wc=!!String.prototype.trimEnd,Sc=!!Number.isSafeInteger,Ac=Sc?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},_i=!0;try{Pn=Rn("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),_i=((Ti=Pn.exec("a"))===null||Ti===void 0?void 0:Ti[0])==="a"}catch{_i=!1}var Pn,Ln=xc?function(t,r,i){return t.startsWith(r,i)}:function(t,r,i){return t.slice(i,i+r.length)===r},Pi=vc?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var i="",a=t.length,n=0,o;a>n;){if(o=t[n++],o>1114111)throw RangeError(o+" is not a valid code point");i+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return i},kn=bc?Object.fromEntries:function(t){for(var r={},i=0,a=t;i<a.length;i++){var n=a[i],o=n[0],s=n[1];r[o]=s}return r},Mn=yc?function(t,r){return t.codePointAt(r)}:function(t,r){var i=t.length;if(!(r<0||r>=i)){var a=t.charCodeAt(r),n;return a<55296||a>56319||r+1===i||(n=t.charCodeAt(r+1))<56320||n>57343?a:(a-55296<<10)+(n-56320)+65536}},Tc=Ec?function(t){return t.trimStart()}:function(t){return t.replace(fc,"")},Cc=wc?function(t){return t.trimEnd()}:function(t){return t.replace(gc,"")};function Rn(e,t){return new RegExp(e,t)}var Li;_i?(Ci=Rn("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Li=function(t,r){var i;Ci.lastIndex=r;var a=Ci.exec(t);return(i=a[1])!==null&&i!==void 0?i:""}):Li=function(t,r){for(var i=[];;){var a=Mn(t,r);if(a===void 0||Nn(a)||Lc(a))break;i.push(a),r+=a>=65536?2:1}return Pi.apply(void 0,i)};var Ci,On=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.locale=r.locale,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,i){for(var a=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(t,i);if(o.err)return o;a.push(o.val)}else{if(n===125&&t>0)break;if(n===35&&(r==="plural"||r==="selectordinal")){var s=this.clonePosition();this.bump(),a.push({type:I.pound,location:C(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(i)break;return this.error(y.UNMATCHED_CLOSING_TAG,C(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&ki(this.peek()||0)){var o=this.parseTag(t,r);if(o.err)return o;a.push(o.val)}else{var o=this.parseLiteral(t,r);if(o.err)return o;a.push(o.val)}}}return{val:a,err:null}},e.prototype.parseTag=function(t,r){var i=this.clonePosition();this.bump();var a=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:I.literal,value:"<".concat(a,"/>"),location:C(i,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(t+1,r,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!ki(this.char()))return this.error(y.INVALID_TAG,C(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return a!==l?this.error(y.UNMATCHED_CLOSING_TAG,C(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:I.tag,value:a,children:o,location:C(i,this.clonePosition())},err:null}:this.error(y.INVALID_TAG,C(s,this.clonePosition())))}else return this.error(y.UNCLOSED_TAG,C(i,this.clonePosition()))}else return this.error(y.INVALID_TAG,C(i,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&Pc(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var i=this.clonePosition(),a="";;){var n=this.tryParseQuote(r);if(n){a+=n;continue}var o=this.tryParseUnquoted(t,r);if(o){a+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){a+=s;continue}break}var c=C(i,this.clonePosition());return{val:{type:I.literal,value:a,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!_c(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var i=this.char();if(i===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(i);this.bump()}return Pi.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var i=this.char();return i===60||i===123||i===35&&(r==="plural"||r==="selectordinal")||i===125&&t>0?null:(this.bump(),Pi(i))},e.prototype.parseArgument=function(t,r){var i=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE,C(i,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(y.EMPTY_ARGUMENT,C(i,this.clonePosition()));var a=this.parseIdentifierIfPossible().value;if(!a)return this.error(y.MALFORMED_ARGUMENT,C(i,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE,C(i,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:I.argument,value:a,location:C(i,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE,C(i,this.clonePosition())):this.parseArgumentOptions(t,r,a,i);default:return this.error(y.MALFORMED_ARGUMENT,C(i,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),i=Li(this.message,r),a=r+i.length;this.bumpTo(a);var n=this.clonePosition(),o=C(t,n);return{value:i,location:o}},e.prototype.parseArgumentOptions=function(t,r,i,a){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(y.EXPECT_ARGUMENT_TYPE,C(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),h=this.parseSimpleArgStyleIfPossible();if(h.err)return h;var u=Cc(h.val);if(u.length===0)return this.error(y.EXPECT_ARGUMENT_STYLE,C(this.clonePosition(),this.clonePosition()));var p=C(d,this.clonePosition());l={style:u,styleLocation:p}}var m=this.tryParseArgumentClose(a);if(m.err)return m;var f=C(a,this.clonePosition());if(l&&Ln(l?.style,"::",0)){var v=Tc(l.style.slice(2));if(s==="number"){var h=this.parseNumberSkeletonFromString(v,l.styleLocation);return h.err?h:{val:{type:I.number,value:i,location:f,style:h.val},err:null}}else{if(v.length===0)return this.error(y.EXPECT_DATE_TIME_SKELETON,f);var b=v;this.locale&&(b=_n(v,this.locale));var u={type:Be.dateTime,pattern:b,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?xn(b):{}},E=s==="date"?I.date:I.time;return{val:{type:E,value:i,location:f,style:u},err:null}}}return{val:{type:s==="number"?I.number:s==="date"?I.date:I.time,value:i,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var x=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(y.EXPECT_SELECT_ARGUMENT_OPTIONS,C(x,T({},x)));this.bumpSpace();var w=this.parseIdentifierIfPossible(),R=0;if(s!=="select"&&w.value==="offset"){if(!this.bumpIf(":"))return this.error(y.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,C(this.clonePosition(),this.clonePosition()));this.bumpSpace();var h=this.tryParseDecimalInteger(y.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,y.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(h.err)return h;this.bumpSpace(),w=this.parseIdentifierIfPossible(),R=h.val}var P=this.tryParsePluralOrSelectOptions(t,s,r,w);if(P.err)return P;var m=this.tryParseArgumentClose(a);if(m.err)return m;var H=C(a,this.clonePosition());return s==="select"?{val:{type:I.select,value:i,options:kn(P.val),location:H},err:null}:{val:{type:I.plural,value:i,options:kn(P.val),offset:R,pluralType:s==="plural"?"cardinal":"ordinal",location:H},err:null}}default:return this.error(y.INVALID_ARGUMENT_TYPE,C(o,c))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE,C(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var i=this.char();switch(i){case 39:{this.bump();var a=this.clonePosition();if(!this.bumpUntil("'"))return this.error(y.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,C(a,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var i=[];try{i=wn(t)}catch{return this.error(y.INVALID_NUMBER_SKELETON,r)}return{val:{type:Be.number,tokens:i,location:r,parsedOptions:this.shouldParseSkeletons?Cn(i):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,i,a){for(var n,o=!1,s=[],c=new Set,l=a.value,d=a.location;;){if(l.length===0){var h=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var u=this.tryParseDecimalInteger(y.EXPECT_PLURAL_ARGUMENT_SELECTOR,y.INVALID_PLURAL_ARGUMENT_SELECTOR);if(u.err)return u;d=C(h,this.clonePosition()),l=this.message.slice(h.offset,this.offset())}else break}if(c.has(l))return this.error(r==="select"?y.DUPLICATE_SELECT_ARGUMENT_SELECTOR:y.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var p=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?y.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:y.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,C(this.clonePosition(),this.clonePosition()));var m=this.parseMessage(t+1,r,i);if(m.err)return m;var f=this.tryParseArgumentClose(p);if(f.err)return f;s.push([l,{value:m.val,location:C(p,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(r==="select"?y.EXPECT_SELECT_ARGUMENT_SELECTOR:y.EXPECT_PLURAL_ARGUMENT_SELECTOR,C(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(y.MISSING_OTHER_CLAUSE,C(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var i=1,a=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(i=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=C(a,this.clonePosition());return n?(o*=i,Ac(o)?{val:o,err:null}:this.error(r,c)):this.error(t,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=Mn(this.message,t);if(r===void 0)throw Error("Offset ".concat(t," is at invalid UTF-16 code unit boundary"));return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(Ln(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),i=this.message.indexOf(t,r);return i>=0?(this.bumpTo(i),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset ".concat(t," must be greater than or equal to the current offset ").concat(this.offset()));for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset ".concat(t," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Nn(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),i=this.message.charCodeAt(r+(t>=65536?2:1));return i??null},e}();function ki(e){return e>=97&&e<=122||e>=65&&e<=90}function _c(e){return ki(e)||e===47}function Pc(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Nn(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function Lc(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Mi(e){e.forEach(function(t){if(delete t.location,dr(t)||pr(t))for(var r in t.options)delete t.options[r].location,Mi(t.options[r].value);else sr(t)&&mr(t.style)||(cr(t)||lr(t))&&At(t.style)?delete t.style.location:hr(t)&&Mi(t.children)})}function In(e,t){t===void 0&&(t={}),t=T({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new On(e,t).parse();if(r.err){var i=SyntaxError(y[r.err.kind]);throw i.location=r.err.location,i.originalMessage=r.err.message,i}return t?.captureLocation||Mi(r.val),r.val}function Ct(e,t){var r=t&&t.cache?t.cache:Ic,i=t&&t.serializer?t.serializer:Nc,a=t&&t.strategy?t.strategy:Mc;return a(e,{cache:r,serializer:i})}function kc(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Dn(e,t,r,i){var a=kc(i)?i:r(i),n=t.get(a);return typeof n>"u"&&(n=e.call(this,i),t.set(a,n)),n}function Hn(e,t,r){var i=Array.prototype.slice.call(arguments,3),a=r(i),n=t.get(a);return typeof n>"u"&&(n=e.apply(this,i),t.set(a,n)),n}function Ri(e,t,r,i,a){return r.bind(t,e,i,a)}function Mc(e,t){var r=e.length===1?Dn:Hn;return Ri(e,this,r,t.cache.create(),t.serializer)}function Rc(e,t){return Ri(e,this,Hn,t.cache.create(),t.serializer)}function Oc(e,t){return Ri(e,this,Dn,t.cache.create(),t.serializer)}var Nc=function(){return JSON.stringify(arguments)};function Oi(){this.cache=Object.create(null)}Oi.prototype.get=function(e){return this.cache[e]};Oi.prototype.set=function(e,t){this.cache[e]=t};var Ic={create:function(){return new Oi}},ur={variadic:Rc,monadic:Oc};var Ue;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Ue||(Ue={}));var _t=function(e){St(t,e);function t(r,i,a){var n=e.call(this,r)||this;return n.code=i,n.originalMessage=a,n}return t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error);var Ni=function(e){St(t,e);function t(r,i,a,n){return e.call(this,'Invalid values for "'.concat(r,'": "').concat(i,'". Options are "').concat(Object.keys(a).join('", "'),'"'),Ue.INVALID_VALUE,n)||this}return t}(_t);var Bn=function(e){St(t,e);function t(r,i,a){return e.call(this,'Value for "'.concat(r,'" must be of type ').concat(i),Ue.INVALID_VALUE,a)||this}return t}(_t);var Un=function(e){St(t,e);function t(r,i){return e.call(this,'The intl string context variable "'.concat(r,'" was not provided to the string "').concat(i,'"'),Ue.MISSING_VALUE,i)||this}return t}(_t);var W;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(W||(W={}));function Dc(e){return e.length<2?e:e.reduce(function(t,r){var i=t[t.length-1];return!i||i.type!==W.literal||r.type!==W.literal?t.push(r):i.value+=r.value,t},[])}function Hc(e){return typeof e=="function"}function Pt(e,t,r,i,a,n,o){if(e.length===1&&Si(e[0]))return[{type:W.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(Si(d)){s.push({type:W.literal,value:d.value});continue}if(gn(d)){typeof n=="number"&&s.push({type:W.literal,value:r.getNumberFormat(t).format(n)});continue}var h=d.value;if(!(a&&h in a))throw new Un(h,o);var u=a[h];if(fn(d)){(!u||typeof u=="string"||typeof u=="number")&&(u=typeof u=="string"||typeof u=="number"?String(u):""),s.push({type:typeof u=="string"?W.literal:W.object,value:u});continue}if(cr(d)){var p=typeof d.style=="string"?i.date[d.style]:At(d.style)?d.style.parsedOptions:void 0;s.push({type:W.literal,value:r.getDateTimeFormat(t,p).format(u)});continue}if(lr(d)){var p=typeof d.style=="string"?i.time[d.style]:At(d.style)?d.style.parsedOptions:i.time.medium;s.push({type:W.literal,value:r.getDateTimeFormat(t,p).format(u)});continue}if(sr(d)){var p=typeof d.style=="string"?i.number[d.style]:mr(d.style)?d.style.parsedOptions:void 0;p&&p.scale&&(u=u*(p.scale||1)),s.push({type:W.literal,value:r.getNumberFormat(t,p).format(u)});continue}if(hr(d)){var m=d.children,f=d.value,v=a[f];if(!Hc(v))throw new Bn(f,"function",o);var b=Pt(m,t,r,i,a,n),E=v(b.map(function(R){return R.value}));Array.isArray(E)||(E=[E]),s.push.apply(s,E.map(function(R){return{type:typeof R=="string"?W.literal:W.object,value:R}}))}if(dr(d)){var x=d.options[u]||d.options.other;if(!x)throw new Ni(d.value,u,Object.keys(d.options),o);s.push.apply(s,Pt(x.value,t,r,i,a));continue}if(pr(d)){var x=d.options["=".concat(u)];if(!x){if(!Intl.PluralRules)throw new _t(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Ue.MISSING_INTL_API,o);var w=r.getPluralRules(t,{type:d.pluralType}).select(u-(d.offset||0));x=d.options[w]||d.options.other}if(!x)throw new Ni(d.value,u,Object.keys(d.options),o);s.push.apply(s,Pt(x.value,t,r,i,a,u-(d.offset||0)));continue}}return Dc(s)}function Bc(e,t){return t?T(T(T({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=T(T({},e[i]),t[i]||{}),r},{})):e}function Uc(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=Bc(e[i],t[i]),r},T({},e)):e}function Ii(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Fc(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Ct(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,or([void 0],r,!1)))},{cache:Ii(e.number),strategy:ur.variadic}),getDateTimeFormat:Ct(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,or([void 0],r,!1)))},{cache:Ii(e.dateTime),strategy:ur.variadic}),getPluralRules:Ct(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,or([void 0],r,!1)))},{cache:Ii(e.pluralRules),strategy:ur.variadic})}}var Fn=function(){function e(t,r,i,a){var n=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==W.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Pt(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Uc(e.formats,i),this.formatters=a&&a.formatters||Fc(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=In,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var zn=Fn;var Di={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},zc=La("ConsonantTemplates/price"),$c=/<\/?[^>]+(>|$)/g,U={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Te={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Hi="TAX_EXCLUSIVE",Gc=e=>Ca(e)?Object.entries(e).filter(([,t])=>Qe(t)||Xt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+Ta(i)+'"'}`,""):"",z=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+U.disabled}"${Gc(r)}>${i?Za(t):t??""}</span>`;function Vc(e){e=e.replaceAll("</a>","&lt;/a&gt;");let t=/<a [^>]+(>|$)/g;return e.match(t)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function qc(e){e=e.replaceAll("&lt;/a&gt;","</a>");let t=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(t)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function ve(e,t,r,i){let a=e[r];if(a==null)return"";let n=a.includes("<"),o=a.includes("<a ");try{a=o?Vc(a):a,a=n?a.replace($c,""):a;let s=new zn(a,t).format(i);return o?qc(s):s}catch{return zc.error("Failed to format literal:",a),""}}function jc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:h},u={}){let p=z(U.currencySymbol,i),m=z(U.currencySpace,o?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=p+m),f+=z(U.integer,s),f+=z(U.decimalsDelimiter,n),f+=z(U.decimals,a),c||(f+=m+p),f+=z(U.recurrence,l,null,!0),f+=z(U.unitType,d,null,!0),f+=z(U.taxInclusivity,h,!0),z(e,f,{...u})}var j=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:h,literals:u={},quantity:p=1,space:m=!1,isPromoApplied:f=!1}={},{commitment:v,offerSelectorIds:b,formatString:E,price:x,priceWithoutDiscount:w,taxDisplay:R,taxTerm:P,term:H,usePrecision:$,promotion:Y}={},V={})=>{Object.entries({country:o,formatString:E,language:h,price:x}).forEach(([_o,Po])=>{if(Po==null)throw new Error(`Argument "${_o}" is missing for osi ${b?.toString()}, country ${o}, language ${h}`)});let F={...Di,...u},M=`${h.toLowerCase()}-${o.toUpperCase()}`,X;Y&&!f&&w?X=e||i?x:w:r&&w?X=w:X=x;let ne=t?Ja:en;a&&(ne=tn);let{accessiblePrice:Fe,recurrenceTerm:Vi,...qi}=ne({commitment:v,formatString:E,instant:n,isIndianPrice:o==="IN",originalPrice:x,priceWithoutDiscount:w,price:t?x:X,promotion:Y,quantity:p,term:H,usePrecision:$}),xr="",vr="",br="";S(c)&&Vi&&(br=ve(F,M,Te.recurrenceLabel,{recurrenceTerm:Vi}));let It="";S(l)&&(m&&(It+=" "),It+=ve(F,M,Te.perUnitLabel,{perUnit:"LICENSE"}));let Dt="";S(d)&&P&&(m&&(Dt+=" "),Dt+=ve(F,M,R===Hi?Te.taxExclusiveLabel:Te.taxInclusiveLabel,{taxTerm:P})),r&&(xr=ve(F,M,Te.strikethroughAriaLabel,{strikethroughPrice:xr})),e&&(vr=ve(F,M,Te.alternativePriceAriaLabel,{alternativePrice:vr}));let _e=U.container;if(t&&(_e+=" "+U.containerOptical),r&&(_e+=" "+U.containerStrikethrough),i&&(_e+=" "+U.containerPromoStrikethrough),e&&(_e+=" "+U.containerAlternative),a&&(_e+=" "+U.containerAnnual),S(s))return jc(_e,{...qi,accessibleLabel:xr,altAccessibleLabel:vr,recurrenceLabel:br,perUnitLabel:It,taxInclusivityLabel:Dt},V);let{currencySymbol:ji,decimals:wo,decimalsDelimiter:So,hasCurrencySpace:Wi,integer:Ao,isCurrencyFirst:To}=qi,ze=[Ao,So,wo];To?(ze.unshift(Wi?"\xA0":""),ze.unshift(ji)):(ze.push(Wi?"\xA0":""),ze.push(ji)),ze.push(br,It,Dt);let Co=ze.join("");return z(_e,Co,V)},$n=()=>(e,t,r)=>{let i=He(t.promotion,t.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||S(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price&&(!t.promotion||i);return`${n?j({displayStrikethrough:!0})({isPromoApplied:i,...e},t,r)+"&nbsp;":""}${j({isAlternativePrice:n})({isPromoApplied:i,...e},t,r)}`},Gn=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=He(t.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return j()(e,{...t,price:t.priceWithoutDiscount},r)+z(U.containerAnnualPrefix,"&nbsp;(")+j({displayAnnual:!0,instant:i})(n,{...t,price:t.priceWithoutDiscount},r)+z(U.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||S(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${s?j({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${j({isAlternativePrice:s})({isPromoApplied:a,...e},t,r)}${z(U.containerAnnualPrefix,"&nbsp;(")}${j({displayAnnual:!0,instant:i})(n,t,r)}${z(U.containerAnnualSuffix,")")}`},Vn=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${j({isAlternativePrice:e.displayOldPrice})(e,t,r)}${z(U.containerAnnualPrefix,"&nbsp;(")}${j({displayAnnual:!0})(i,t,r)}${z(U.containerAnnualSuffix,")")}`};var Lt={...U,containerLegal:"price-legal",planType:"price-plan-type"},fr={...Te,planTypeLabel:"planTypeLabel"};function Wc(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},a={}){let n="";return n+=z(Lt.unitType,t,null,!0),r&&i&&(r+=". "),n+=z(Lt.taxInclusivity,r,!0),n+=z(Lt.planType,i,null),z(e,n,{...a})}var qn=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:a,literals:n={}}={},{taxDisplay:o,taxTerm:s,planType:c}={},l={})=>{let d={...Di,...n},h=`${a.toLowerCase()}-${e.toUpperCase()}`,u="";S(t)&&(u=ve(d,h,fr.perUnitLabel,{perUnit:"LICENSE"}));let p="";e==="US"&&a==="en"&&(r=!1),S(r)&&s&&(p=ve(d,h,o===Hi?fr.taxExclusiveLabel:fr.taxInclusiveLabel,{taxTerm:s}));let m="";S(i)&&c&&(m=ve(d,h,fr.planTypeLabel,{planType:c}));let f=Lt.container;return f+=" "+Lt.containerLegal,Wc(f,{perUnitLabel:u,taxInclusivityLabel:p,planTypeLabel:m},l)};var jn=j(),Wn=$n(),Yn=j({displayOptical:!0}),Xn=j({displayStrikethrough:!0}),Kn=j({displayPromoStrikethrough:!0}),Zn=j({displayAnnual:!0}),Qn=j({displayOptical:!0,isAlternativePrice:!0}),Jn=j({isAlternativePrice:!0}),eo=Vn(),to=Gn(),ro=qn;var Yc=(e,t)=>{if(!(!vt(e)||!vt(t)))return Math.floor((t-e)/t*100)},io=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,a=Yc(r,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var ao=io();var no="INDIVIDUAL_COM",Ui="TEAM_COM",oo="INDIVIDUAL_EDU",Fi="TEAM_EDU",Xc=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","LU_de","LU_en","LU_fr","MY_en","MY_ms","MU_en","NL_nl","NO_nb","NZ_en","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TH_en","TH_th","TR_tr","UA_uk"],Kc={[no]:["LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko","ZA_en"],[Ui]:["LT_lt","LV_lv","NG_en","CO_es","KR_ko","ZA_en"],[oo]:["LT_lt","LV_lv","SA_en","SG_en","SA_ar"],[Fi]:["SG_en","KR_ko"]},Zc={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0],ZA_en:[!1,!1,!1,!1]},Qc=[no,Ui,oo,Fi],Jc=e=>[Ui,Fi].includes(e);function Bi(e,t,r,i){if(e[t])return e[t];let a=`${t}_${r}`;if(e[a])return e[a];let n;if(i)n=e.find(o=>o.startsWith(`${t}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${t}_`));n=o?e[o]:null}return n}var el=(e,t,r,i)=>{let a=`${r}_${i}`,n=Bi(Zc,e,t,!1);if(n){let o=Qc.indexOf(a);return n[o]}return Jc(a)},tl=(e,t,r,i)=>{if(Bi(Xc,e,t,!0))return!0;let a=Kc[`${r}_${i}`];return a?Bi(a,e,t,!0)?!0:_.displayTax:_.displayTax},zi=async(e,t,r,i)=>{let a=tl(e,t,r,i);return{displayTax:a,forceTaxExclusive:a?el(e,t,r,i):_.forceTaxExclusive}},kt=class kt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ae(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(r){let i=te();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:h,promotionCode:u,quantity:p,alternativePrice:m,template:f,wcsOsi:v}=i.collectPriceOptions(r);return ar(kt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:h,promotionCode:u,quantity:p,alternativePrice:m,template:f,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,a){this.masElement.attributeChangedCallback(r,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===de}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=te();if(!i)return!1;let a=i.collectPriceOptions(r,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=i.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(p=>{let m=yt(p,n);return m?.length?m[0]:null});if(l.some(p=>!p))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,h=xi(l);if(i.featureFlags[fe]||n[fe]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=h.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:p,language:m}=n,[f=""]=h.marketSegments,v=await zi(p,m,h.customerSegment,f);a.displayTax===void 0&&(n.displayTax=v?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=v?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(b=>{let E=yt(b,n);return E?.length?E[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);let u=xi(d);return this.renderOffers([u],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(r,i,a=void 0){if(!this.isConnected)return;let n=te();if(!n)return!1;if(a??(a=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(a,r,i)){this.innerHTML=n.buildPriceHTML(r,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(r,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,o,this.options))return this.innerHTML="",!0}return!1}};g(kt,"is","inline-price"),g(kt,"tag","span");var be=kt;window.customElements.get(be.is)||window.customElements.define(be.is,be,{extends:be.tag});function so({literals:e,providers:t,settings:r}){function i(o,s=null){let c={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(s&&t?.price)for(let P of t.price)P(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:h,displayTax:u,displayPlanType:p,forceTaxExclusive:m,perpetual:f,displayAnnual:v,promotionCode:b,quantity:E,alternativePrice:x,wcsOsi:w,...R}=Object.assign(c,s?.dataset??{},o??{});return c=Kt(Object.assign({...c,...R,displayOldPrice:S(l),displayPerUnit:S(d),displayRecurrence:S(h),displayTax:S(u),displayPlanType:S(p),forceTaxExclusive:S(m),perpetual:S(f),displayAnnual:S(v),promotionCode:Qt(b).effectivePromoCode,quantity:Je(E,_.quantity),alternativePrice:S(x),wcsOsi:ir(w)})),c}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=ao;break;case"strikethrough":l=Xn;break;case"promo-strikethrough":l=Kn;break;case"annual":l=Zn;break;case"legal":l=ro;break;default:s.template==="optical"&&s.alternativePrice?l=Qn:s.template==="optical"?l=Yn:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode?to:eo:s.alternativePrice?l=Jn:l=s.promotionCode?Wn:jn}let[d]=o;return d={...d,...d.priceDetails},l({...r,...s},d)}let n=be.createInlinePrice;return{InlinePrice:be,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function rl({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||_.language),t??(t=e?.split("_")?.[1]||_.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function co(e={},t){let r=t.featureFlags[fe],{commerce:i={}}=e,a=me.PRODUCTION,n=Fr,o=B("checkoutClientId",i)??_.checkoutClientId,s=bt(B("checkoutWorkflowStep",i),Z,_.checkoutWorkflowStep),c=_.displayOldPrice,l=_.displayPerUnit,d=S(B("displayRecurrence",i),_.displayRecurrence),h=S(B("displayTax",i),_.displayTax),u=S(B("displayPlanType",i),_.displayPlanType),p=S(B("entitlement",i),_.entitlement),m=S(B("modal",i),_.modal),f=S(B("forceTaxExclusive",i),_.forceTaxExclusive),v=B("promotionCode",i)??_.promotionCode,b=Je(B("quantity",i)),E=B("wcsApiKey",i)??_.wcsApiKey,x=i?.env==="stage",w=we.PUBLISHED;["true",""].includes(i.allowOverride)&&(x=(B(Br,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",w=bt(B(Ur,i),we,w)),x&&(a=me.STAGE,n=zr);let P=B(Hr)??e.preview,H=typeof P<"u"&&P!=="off"&&P!=="false",$={};H&&($={preview:H});let Y=B("mas-io-url")??e.masIOUrl??`https://www${a===me.STAGE?".stage":""}.adobe.com/mas/io`,V=B("preselect-plan")??void 0;return{...rl(e),...$,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:h,displayPlanType:u,entitlement:p,extraOptions:_.extraOptions,modal:m,env:a,forceTaxExclusive:f,promotionCode:v,quantity:b,alternativePrice:_.alternativePrice,wcsApiKey:E,wcsURL:n,landscape:w,masIOUrl:Y,...V&&{preselectPlan:V}}}async function lo(e,t={},r=2,i=100){let a;for(let n=0;n<=r;n++)try{let o=await fetch(e,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>r)break;await new Promise(s=>setTimeout(s,i*(n+1)))}throw a}var $i="wcs";function po({settings:e}){let t=ee.module($i),{env:r,wcsApiKey:i}=e,a=new Map,n=new Map,o,s=new Map;async function c(m,f,v=!0){let b=te(),E=Or;t.debug("Fetching:",m);let x="",w;if(m.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let R=new Map(f),[P]=m.offerSelectorIds,H=Date.now()+Math.random().toString(36).substring(2,7),$=`${$i}:${P}:${H}${Gr}`,Y=`${$i}:${P}:${H}${Vr}`,V;try{if(performance.mark($),x=new URL(e.wcsURL),x.searchParams.set("offer_selector_ids",P),x.searchParams.set("country",m.country),x.searchParams.set("locale",m.locale),x.searchParams.set("landscape",r===me.STAGE?"ALL":e.landscape),x.searchParams.set("api_key",i),m.language&&x.searchParams.set("language",m.language),m.promotionCode&&x.searchParams.set("promotion_code",m.promotionCode),m.currency&&x.searchParams.set("currency",m.currency),w=await lo(x.toString(),{credentials:"omit"}),w.ok){let F=[];try{let M=await w.json();t.debug("Fetched:",m,M),F=M.resolvedOffers??[]}catch(M){t.error(`Error parsing JSON: ${M.message}`,{...M.context,...b?.duration})}F=F.map(Jt),f.forEach(({resolve:M},X)=>{let ne=F.filter(({offerSelectorIds:Fe})=>Fe.includes(X)).flat();ne.length&&(R.delete(X),f.delete(X),M(ne))})}else E=Rr}catch(F){E=`Network error: ${F.message}`}finally{V=performance.measure(Y,$),performance.clearMarks($),performance.clearMeasures(Y)}if(v&&f.size){t.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=za(w);f.forEach(M=>{M.reject(new et(E,{...m,...F,response:w,measure:Ft(V),...b?.duration}))})}}function l(){clearTimeout(o);let m=[...n.values()];n.clear(),m.forEach(({options:f,promises:v})=>c(f,v))}function d(m){if(!m||typeof m!="object")throw new TypeError("Cache must be a Map or similar object");let f=r===me.STAGE?"stage":"prod",v=m[f];if(!v||typeof v!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[b,E]of Object.entries(v))a.set(b,Promise.resolve(E.map(Jt)));t.debug(`Prefilled WCS cache with ${v.size} entries`)}function h(){let m=a.size;s=new Map(a),a.clear(),t.debug(`Moved ${m} cache entries to stale cache`)}function u(m,f,v){let b=m!=="GB"&&!v?"MULT":"en",E=qr.includes(m)?m:_.country;return{validCountry:E,validLanguage:b,locale:`${f}_${E}`}}function p({country:m,language:f,perpetual:v=!1,promotionCode:b="",wcsOsi:E=[]}){let{validCountry:x,validLanguage:w,locale:R}=u(m,f,v),P=[x,w,b].filter(H=>H).join("-").toLowerCase();return E.map(H=>{let $=`${H}-${P}`;if(a.has($))return a.get($);let Y=new Promise((V,F)=>{let M=n.get(P);M||(M={options:{country:x,locale:R,...w==="MULT"&&{language:w},offerSelectorIds:[]},promises:new Map},n.set(P,M)),b&&(M.options.promotionCode=b),M.options.offerSelectorIds.push(H),M.promises.set(H,{resolve:V,reject:F}),l()}).catch(V=>{if(s.has($))return s.get($);throw V});return a.set($,Y),Y})}return{Commitment:Pe,PlanType:Ma,Term:se,applyPlanType:Jt,resolveOfferSelectors:p,flushWcsCacheInternal:h,prefillWcsCache:d,normalizeCountryLanguageAndLocale:u}}var ho="mas-commerce-service",mo="mas-commerce-service:start",uo="mas-commerce-service:ready",Mt,rt,it,fo,go,Gi=class extends HTMLElement{constructor(){super(...arguments);G(this,it);G(this,Mt);G(this,rt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let o=await r?.(i,a,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return A(this,rt)||q(this,rt,{[fe]:Ht(this,it,go).call(this,fe)}),A(this,rt)}activate(){let r=A(this,it,fo),i=co(r,this);er(r.lana);let a=ee.init(r.hostEnv).module("service");a.debug("Activating:",r);let o={price:un(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...pn(c),...hn(c),...so(c),...po(c),...jr,Log:ee,resolvePriceTaxFlags:zi,get defaults(){return _},get log(){return ee},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(Ut,{bubbles:!0,cancelable:!1,detail:this});performance.mark(uo),q(this,Mt,performance.measure(uo,mo)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(mo),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Er).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Ft(A(this,Mt))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:o})=>a===0&&n===0&&o<200||o>=400),i=Array.from(new Map(r.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Mt=new WeakMap,rt=new WeakMap,it=new WeakSet,fo=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=n}}),i},go=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||B(r))};window.customElements.get(ho)||window.customElements.define(ho,Gi);var yo="merch-card-collection",il=2e4,al={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},nl={plans:!0},ol=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),sl=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,cl=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),ll=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),dl=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,Ce,nt,Ot,Nt,gr,Eo,at=class extends vo{constructor(){super();G(this,gr);G(this,Ce,{});G(this,nt);G(this,Ot);G(this,Nt);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return ye` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let i=new Promise(a=>setTimeout(()=>a(!1),il));return Promise.race([this.hydrationReady,i])}updated(r){if(!this.querySelector("merch-card"))return;let i=window.scrollY||document.documentElement.scrollTop,a=[...this.children].filter(l=>l.tagName==="MERCH-CARD");if(a.length===0)return;r.has("singleApp")&&this.singleApp&&a.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===pe.alphabetical?cl:ll,s=[ol,sl,dl,n].reduce((l,d)=>d(l,this),a).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);a.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,i),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Tr,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(le,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){q(this,Ce,{}),this.overrides?.split(",").forEach(r=>{let[i,a]=r?.split(":");i&&a&&(A(this,Ce)[i]=a)})}connectedCallback(){super.connectedCallback(),q(this,nt,mt()),A(this,nt)&&q(this,Ot,A(this,nt).Log.module(yo)),q(this,Nt,customElements.get("merch-card")),this.buildOverrideMap(),this.init()}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let r of this.onUnmount)r()}initializeHeader(){let r=document.createElement("merch-card-collection-header");r.collection=this,r.classList.add(this.variant),this.parentElement.insertBefore(r,this),this.header=r,this.querySelectorAll("[placeholder]").forEach(a=>{let n=a.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(a)})}initializePlaceholders(){let r=this.data?.placeholders||{};!r.searchText&&this.data?.sidenavSettings?.searchText&&(r.searchText=this.data.sidenavSettings.searchText);for(let i of Object.keys(r)){let a=r[i],n=a.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",i),o.setAttribute("placeholder",""),o.innerHTML=a,this.append(o)}}attachSidenav(r,i=!0){if(!r)return;i&&this.parentElement.prepend(r),this.sidenav=r,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),nl[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(lt));let a=A(this,Nt)?.getCollectionOptions(this.variant)?.onSidenavAttached;a&&a(this)}async hydrate(){if(this.hydrating)return!1;let r=this.querySelector("aem-fragment");if(!r)return;this.id=r.getAttribute("fragment"),this.hydrating=!0;let i;this.hydrationReady=new Promise(s=>{i=s});let a=this;function n(s){let c;return s.fields?.checkboxGroups?c=s.fields.checkboxGroups:s.fields?.tagFilters&&(c=[{title:s.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:s.fields.tagFilters.map(l=>{let d=l.split("/").pop(),h=s.settings?.tagLabels?.[d]||d;return h=h.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):h,{name:d,label:h}})}]),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(h,u){for(let p of u){if(p.fieldName==="variations")continue;if(p.fieldName==="cards"){if(l.cards.findIndex(x=>x.id===p.identifier)!==-1)continue;l.cards.push(s.references[p.identifier].value);continue}let m=s.references[p.identifier]?.value,f=p.referencesTree,v=c[p.identifier];if(v){let x=document.querySelector(`aem-fragment[fragment="${v}"]`)?.rawData;x?.fields&&(m=x,f=x.referencesTree,s.references={...s.references,...x.references})}if(!m?.fields)continue;let{fields:b}=m,E={label:b.label||"",icon:b.icon,iconLight:b.iconLight,queryLabel:b.queryLabel,cards:b.cards?b.cards.map(x=>c[x]||x):[],collections:[]};b.defaultchild&&(E.defaultchild=c[b.defaultchild]||b.defaultchild),h.push(E),d(E.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(a.filtered="all"),l}r.addEventListener(_r,s=>{Ht(this,gr,Eo).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,r.remove()}),r.addEventListener(Cr,async s=>{this.limit=27,this.data=o(s.detail,A(this,Ce));let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?A(this,Ce)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;r.cache.add(...c);let h=(m,f)=>{for(let v of m)if(v.defaultchild===f||v.collections&&h(v.collections,f))return!0;return!1};for(let m of c){let x=function(R){for(let P of R){let H=P.cards.indexOf(v);if(H===-1)continue;let $=P.queryLabel??P?.label?.toLowerCase()??"";f.filters[$]={order:H+1,size:m.fields.size},x(P.collections)}},f=document.createElement("merch-card"),v=A(this,Ce)[m.id]||m.id;f.setAttribute("consonant",""),f.setAttribute("style","");let b=m.fields.tags?.filter(R=>R.startsWith("mas:types/")).map(R=>R.split("/")[1]).join(",");b&&f.setAttribute("types",b),$t(m.fields.variant)?.supportsDefaultChild&&(d?v===d:h(l,v))&&f.setAttribute("data-default-card","true"),x(l);let w=document.createElement("aem-fragment");w.setAttribute("fragment",v),f.append(w),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(m)+1,size:m.fields.size}}),this.append(f)}let u="",p=Va(c[0]?.fields?.variant);this.variant=p,p==="plans"&&c.length===3&&!c.some(m=>m.fields?.size?.includes("wide"))&&(u="ThreeColumns"),p&&this.classList.add("merch-card-collection",p,...al[`${p}${u}`]||[]),this.displayResult=!0,this.hydrating=!1,r.remove(),i(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return ye`<div id="footer">
    ...
    `);at.SortOrder=pe;customElements.define(yo,at);var pl={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},hl=(e,t,r)=>{e.querySelectorAll(`[data-placeholder="${t}"]`).forEach(a=>{a.innerText=r||""})},ml={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},ul={catalog:"l"},re,ot,Rt=class extends vo{constructor(){super();G(this,re);G(this,ot);g(this,"tablet",new st(this,D));g(this,"desktop",new st(this,L));this.collection=null,q(this,re,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(le,this.updateLiterals),this.collection?.addEventListener(lt,this.handleSidenavAttached),q(this,ot,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(le,this.updateLiterals),this.collection?.removeEventListener(lt,this.handleSidenavAttached)}willUpdate(){A(this,re).search=this.getVisibility("search"),A(this,re).filter=this.getVisibility("filter"),A(this,re).sort=this.getVisibility("sort"),A(this,re).result=this.getVisibility("result"),A(this,re).custom=this.getVisibility("custom")}parseVisibilityOptions(r,i){if(!r||!Object.hasOwn(r,i))return null;let a=r[i];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(r){let i=A(this,ot)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(i,r);return a!==null?a:this.parseVisibilityOptions(ml,r)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!A(this,re).search)return he;let r=ht(this,"searchText");return r?ye`
        ...
        >
            ...
            ${i}
        </div>`}openFilters(r){this.sidenav.showModal(r)}updateLiterals(r){Object.keys(r.detail).forEach(i=>{hl(this,i,r.detail[i])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return ye`
            <sp-theme color="light" scale="medium">
                <div id="header">

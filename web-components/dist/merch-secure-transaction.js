var m=Object.defineProperty;var h=(e,t,o)=>t in e?m(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o;var s=(e,t,o)=>h(e,typeof t!="symbol"?t+"":t,o);import{LitElement as w,html as l}from"./lit-all.min.js";import{css as x}from"./lit-all.min.js";var d="(max-width: 767px)";var p="(min-width: 1200px)",a="(min-width: 1600px)";var u={matchMobile:window.matchMedia(d),matchDesktop:window.matchMedia(`${p} and (not ${a})`),matchDesktopOrUp:window.matchMedia(p),matchLargeDesktop:window.matchMedia(a),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}};var c=x`
    #label {
        align-items: center;
        cursor: pointer;
        display: inline-flex;

...
`,fc=()=>[b`
    ...
    `);customElements.define("merch-icon",qt);var Xr,At,Kr,Qr,Vt,Yi=class extends HTMLElement{constructor(){super();E(this,Xr,"");E(this,At);E(this,Kr,[]);E(this,Qr,[]);E(this,Vt);y(this,Vt,Ir(()=>{this.isConnected&&(this.parentElement.style.background=this.value,m(this,At)?this.parentElement.style.borderRadius=m(this,At):m(this,At)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let r=m(this,Kr).map((i,a)=>{let n=m(this,Qr)[a]||"";return`${i} ${n}`}).join(", ");return`linear-gradient(${m(this,Xr)}, ${r})`}connectedCallback(){m(this,Vt).call(this)}attributeChangedCallback(r,i,a){r==="border-radius"&&y(this,At,a?.trim()),r==="colors"&&a?y(this,Kr,a?.split(",").map(n=>n.trim())??[]):r==="positions"&&a?y(this,Qr,a?.split(",").map(n=>n.trim())??[]):r==="angle"&&y(this,Xr,a?.trim()??""),m(this,Vt).call(this)}};Xr=new WeakMap,At=new WeakMap,Kr=new WeakMap,Qr=new WeakMap,Vt=new WeakMap;customElements.define("merch-gradient",Yi);M();var jt=class extends G{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,r){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[r]||[r]).map(s=>`p[data-plan-type="${t}"] ${D}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Be,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Be,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let r=t.target,i=r?.value?.[0];i&&(r.setAttribute("data-offer-type",i.offerType),r.closest("p").setAttribute("data-plan-type",i.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return f` <input
                type="checkbox"
                id="addon-checkbox"
    ...
    `);customElements.define("merch-addon",jt);M();var Wt,Zr=class Zr{constructor(t){u(this,"card");E(this,Wt);this.card=t,this.insertVariantStyle()}getContainer(){return y(this,Wt,m(this,Wt)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),m(this,Wt)}insertVariantStyle(){let t=this.constructor.name;if(!Zr.styleMap[t]){Zr.styleMap[t]=!0;let r=document.createElement("style");r.innerHTML=this.getGlobalCSS(),document.head.appendChild(r)}}updateCardElementMinHeight(t,r){if(!t||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let r=this.getContainer();if(!r)return;let i=this.card.variant,a=Array.from(r.querySelectorAll(`merch-card[variant="${i}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:o}of t){let s=`--consonant-merch-card-${i}-${o}-height`;r.style.getPropertyValue(s)&&r.style.removeProperty(s)}let n=new Map;for(let o of a){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of t){let l=`--consonant-merch-card-${i}-${s}-height`,d=0,h=[];for(let p of o){p.style.removeProperty(l);let g=c(p);if(!g){h.push({card:p,height:0});continue}let v=Math.max(0,parseInt(window.getComputedStyle(g).height)||0);h.push({card:p,height:v}),v>d&&(d=v)}if(!(d<=0))for(let{card:p}of h)p.style.setProperty(l,`${d}px`)}}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),f`
        ...
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let t=Promise.allSettled(this.card.prices.map(a=>a.onceSettled?.()||Promise.resolve())),r,i=new Promise(a=>{r=setTimeout(a,ot)});await Promise.race([t,i]),clearTimeout(r)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Xi(this.card.variant)}};Wt=new WeakMap,u(Zr,"styleMap",{});var C=Zr;M();var Ac=`
:root {
...
`;var Qi={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Nc={...function(){let{whatsIncluded:e,size:t,...r}=Qi;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},zc={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...a}=Qi;return a}()},Ie,De,ge=class extends C{constructor(r){super(r);E(this,Ie);E(this,De);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(r,i){r.dataset.template===ve&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Oc}adjustSlotPlacement(r,i,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${r}"]`),l=n.querySelector(`.body slot[name="${r}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!i.includes(s)){if(o?.classList.toggle("wide-footer",z.isDesktopOrUp),!a&&c){if(l)c.remove();else{let h=d.querySelector(`[data-placeholder-for="${r}"]`);h?h.replaceWith(c):d.appendChild(c)}return}if(a&&l){let h=document.createElement("div");if(h.setAttribute("data-placeholder-for",r),h.classList.add("slot-placeholder"),!c){let p=l.cloneNode(!0);o.prepend(p)}l.replaceWith(h)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],z.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],z.isDesktopOrUp)}adjustCallout(){let r=this.card.querySelector('[slot="callout-content"] .icon-button');r&&r.title&&(r.dataset.tooltip=r.title,r.removeAttribute("title"),r.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==r?r.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==r?r.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){m(this,Ie)||(y(this,Ie,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(m(this,Ie)?.disconnect(),y(this,Ie,null),this.syncHeights())})),m(this,Ie).observe(this.card));return}let r=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(r.map(i=>({name:i,getElement:a=>a.querySelector(`[slot="${i}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),i.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Dr(d));let h=this.card.querySelector('[slot="subtitle"]');h&&(l+=Dr(h));let p=this.card.querySelector('[slot="heading-m"]');p&&(l+=8+Dr(p));for(let v of i.childNodes){if(v.classList.contains("spacer"))break;l+=Dr(v)}let g=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(g)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${D}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?f`<div class="divider"></div>`:w}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=[],i=this.card.querySelector(`[slot="heading-m"] ${D}[data-template="price"]`);i&&r.push(i);let a=r.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let r=this.card.addon;if(!r)return;r.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(r.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?f`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Ie=new WeakMap,De=new WeakMap,u(ge,"variantStyle",b`
        :host([variant^='plans']) {
            min-height: 273px;
...
`;var Hc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Qt=class extends C{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return $c}priceOptionsProvider(t,r){t.dataset.template===ve&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return f` ${this.badge}
...
`;var Fc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Zt=class extends C{constructor(t){super(t)}priceOptionsProvider(t,r){t.dataset.template===ve&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}getGlobalCSS(){return Bc}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${D}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let r=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),t.parentNode.insertBefore(r,t.nextSibling),await r.onceSettled()}catch{}}renderLayout(){return f`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Qc={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},ar=class extends C{constructor(){super(...arguments);u(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal(),await super.postCardUpdateHook()}getGlobalCSS(){return Kc}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${D}[data-template="price"]`);if(!r)return;let i=r.cloneNode(!0);this.legal=i,r.dataset.displayTax="false",r.dataset.displayPerUnit="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return f`
            ${this.badge}
            <div class="body">
...
`;var $n={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},nr=class extends C{getGlobalCSS(){return Zc}get aemFragmentMapping(){return $n}renderLayout(){return f`
    ...
    `);var Zi=new Map,Jc=new WeakMap,el=new Map,q=(e,t,r=null,i=null,a)=>{Zi.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:a})};q("catalog",Yt,Cc,Yt.variantStyle);q("image",Ct);q("inline-heading",Ki);q("mini-compare-chart",Xt,Lc,Xt.variantStyle);q("mini-compare-chart-mweb",Kt,Mc,Kt.variantStyle);q("plans",ge,Qi,ge.variantStyle,ge.collectionOptions);q("plans-students",ge,zc,ge.variantStyle,ge.collectionOptions);q("plans-education",ge,Nc,ge.variantStyle,ge.collectionOptions);q("plans-v2",et,Dc,et.variantStyle,et.collectionOptions);q("product",Qt,Hc,Qt.variantStyle);q("segment",Zt,Fc,Zt.variantStyle);q("media",Jt,Gc,Jt.variantStyle);q("headless",ir,Xc,ir.variantStyle);q("special-offers",er,Vc,er.variantStyle);q("simplified-pricing-express",tr,In,tr.variantStyle);q("full-pricing-express",rr,Dn,rr.variantStyle);q("mini",ar,Qc,ar.variantStyle);q("image",Ct,kc,Ct.variantStyle);q("fries",nr,$n,nr.variantStyle);var lp=(e,t,r)=>{try{let i=el.get(e.variant);if(i||(i=new CSSStyleSheet,i.replaceSync(t.cssText),el.set(e.variant,i)),r?.styleSheet&&r.styleSheet!==i){let a=e.shadowRoot.adoptedStyleSheets.indexOf(r.styleSheet);a!==-1&&e.shadowRoot.adoptedStyleSheets.splice(a,1)}return e.shadowRoot.adoptedStyleSheets.includes(i)||e.shadowRoot.adoptedStyleSheets.push(i),{styleSheet:i}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",e.variant);let n=r?.styleElement||e.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),e.shadowRoot.appendChild(a),{styleElement:a}}},Hn=e=>{let t=Zi.get(e.variant);if(!t)return;let{class:r,style:i}=t,a=Jc.get(e);if(a?.appliedVariant===e.variant)return new r(e);let n=i?lp(e,i,a):{};return Jc.set(e,{appliedVariant:e.variant,...n}),new r(e)};function Xi(e){return Zi.get(e)?.fragmentMapping}function tl(e){return Zi.get(e)?.collectionOptions}var rl=document.createElement("style");rl.innerHTML=`
:root {
...
`;document.head.appendChild(rl);var il="fragment",al="author",nl="preview",ol="loading",sl="timeout",Bn="aem-fragment",cl="eager",ll="cache",dp=[cl,ll],$e,Tt,Pe,Fn=class{constructor(){E(this,$e,new Map);E(this,Tt,new Map);E(this,Pe,new Map)}clear(){m(this,$e).clear(),m(this,Tt).clear(),m(this,Pe).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(m(this,$e).set(t.id,t),t.fields?.originalId&&m(this,$e).set(t.fields.originalId,t),m(this,Pe).has(t.id)){let[,i]=m(this,Pe).get(t.id);i()}if(m(this,Pe).has(t.fields?.originalId)){let[,i]=m(this,Pe).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return m(this,$e).has(t)}entries(){return m(this,$e).entries()}get(t){return m(this,$e).get(t)}getAsPromise(t){let[r]=m(this,Pe).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),m(this,Pe).set(t,[r,i]),r}getFetchInfo(t){let r=m(this,Tt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},m(this,Tt).set(t,r)),r}remove(t){m(this,$e).delete(t),m(this,Tt).delete(t),m(this,Pe).delete(t)}};$e=new WeakMap,Tt=new WeakMap,Pe=new WeakMap;var tt=new Fn,or,Le,We,be,fe,J,Jr,ei,Re,ti,ri,sr,Me,dl,hl,Un,pl,Ji=class extends HTMLElement{constructor(){super(...arguments);E(this,Me);u(this,"cache",tt);E(this,or);E(this,Le,null);E(this,We,null);E(this,be,null);E(this,fe);E(this,J);E(this,Jr,cl);E(this,ei,5e3);E(this,Re);E(this,ti,!1);E(this,ri,0);E(this,sr)}static get observedAttributes(){return[il,ol,sl,al,nl]}attributeChangedCallback(r,i,a){r===il&&(y(this,fe,a),y(this,J,tt.getFetchInfo(a))),r===ol&&dp.includes(a)&&y(this,Jr,a),r===sl&&y(this,ei,parseInt(a,10)),r===al&&y(this,ti,["","true"].includes(a)),r===nl&&y(this,sr,a)}connectedCallback(){if(!m(this,Re)){if(m(this,be)??y(this,be,vt(this)),y(this,sr,m(this,be).settings?.preview),m(this,or)??y(this,or,m(this,be).log.module(`${Bn}[${m(this,fe)}]`)),!m(this,fe)||m(this,fe)==="#"){m(this,J)??y(this,J,tt.getFetchInfo("missing-fragment-id")),Z(this,Me,Un).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(m(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(m(this,Re)&&!await Promise.race([m(this,Re),Promise.resolve(!1)]))return;r&&tt.remove(m(this,fe)),m(this,Jr)===ll&&await Promise.race([tt.getAsPromise(m(this,fe)),new Promise(s=>setTimeout(s,m(this,ei)))]);try{y(this,Re,Z(this,Me,pl).call(this)),await m(this,Re)}catch(s){return Z(this,Me,Un).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=m(this,Le)||{};return o&&!B("mas.disableWcsCache")&&m(this,be).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ct,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...m(this,J)},bubbles:!0,composed:!0})),m(this,Re)}get updateComplete(){return m(this,Re)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return m(this,We)?m(this,We):(m(this,ti)?this.transformAuthorData():this.transformPublishData(),m(this,We))}get rawData(){return m(this,Le)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=m(this,Le);y(this,We,r.reduce((d,{name:h,multiple:p,values:g})=>(d.fields[h]=p?g:g[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=m(this,Le);y(this,We,Object.entries(r).reduce((d,[h,p])=>(d.fields[h]=p?.mimeType?p.value:p??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r),a={locale:m(this,be).settings.locale,apiKey:m(this,be).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??m(this,be).settings.instant;return n&&(a.instant=n),await i(m(this,fe),a)}};or=new WeakMap,Le=new WeakMap,We=new WeakMap,be=new WeakMap,fe=new WeakMap,J=new WeakMap,Jr=new WeakMap,ei=new WeakMap,Re=new WeakMap,ti=new WeakMap,ri=new WeakMap,sr=new WeakMap,Me=new WeakSet,dl=async function(r){ao(this,ri)._++;let i=`${Bn}:${m(this,fe)}:${m(this,ri)}`,a=`${i}${ht}`,n=`${i}${pt}`;if(m(this,sr)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Ne(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(m(this,J).stale=!1,m(this,J).url=r,o=await $i(r,{cache:"default",credentials:"omit"}),Z(this,Me,hl).call(this,o),m(this,J).status=o?.status,m(this,J).measure=ze(performance.measure(n,a)),m(this,J).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...m(this,be).duration});return await o.json()}catch(s){if(m(this,J).measure=ze(performance.measure(n,a)),m(this,J).retryCount=s.retryCount,m(this,Le))return m(this,J).stale=!0,m(this,or).error("Serving stale data",m(this,J)),m(this,Le);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},hl=function(r){Object.assign(m(this,J),Ei(r))},Un=function(r){y(this,Re,null),m(this,J).message=r,this.classList.add("error");let i={...m(this,J),...m(this,be).duration};m(this,or).error(r,i),this.dispatchEvent(new CustomEvent(lt,{detail:i,bubbles:!0,composed:!0}))},pl=async function(){var c;this.classList.remove("error"),y(this,We,null);let r=tt.get(m(this,fe));if(r)return y(this,Le,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=m(this,be).settings,s=`${i}/fragment?id=${m(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Me,dl).call(this,s),(c=r.fields).originalId??(c.originalId=m(this,fe)),tt.add(r),y(this,Le,r),!0},u(Ji,"cache",tt);customElements.define(Bn,Ji);M();Nn();var hp=e=>e?e.startsWith("sp-icon-")?f`${Wr(`<${e} class="badge-icon"></${e}>`)}`:f`<img src="${e}" class="badge-icon" />`:w,cr=class extends G{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">
    ...
    `);customElements.define("merch-badge",cr);M();var ii=class extends G{constructor(){super()}render(){return f`
            <slot name="icon"></slot>
...
`;var kl={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},ur=class extends C{getGlobalCSS(){return Tl}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return f` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}async postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage(),await super.postCardUpdateHook()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};u(ur,"variantStyle",b`
...
`;var Pl={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},gr=class extends C{getGlobalCSS(){return _l}renderLayout(){return f` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Kn={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},vr=class extends C{getGlobalCSS(){return Rl}get aemFragmentMapping(){return Kn}renderLayout(){return f`
    ...
    `);q("ccd-suggested",ur,kl,ur.variantStyle);q("ccd-slice",gr,Pl,gr.variantStyle);q("ah-try-buy-widget",fr,Xn,fr.variantStyle);q("ah-promoted-plans",vr,Kn,vr.variantStyle);

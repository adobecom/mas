...
\f\r"'\`<>=]|("|')|))|$)`,"g"),tc=/'/g,rc=/"/g,sc=/^(?:script|style|textarea|title)$/i,cc=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),g=cc(1),Tf=cc(2),qe=Symbol.for("lit-noChange"),w=Symbol.for("lit-nothing"),ic=new WeakMap,bt=yt.createTreeWalker(yt,129,null,!1);rp=(e,t)=>{let r=e.length-1,i=[],a,n=t===2?"<svg>":"",o=Hr;for(let s=0;s<r;s++){let c=e[s],l,d,h=-1,m=0;for(;m<c.length&&(o.lastIndex=m,d=o.exec(c),d!==null);)m=o.lastIndex,o===Hr?d[1]==="!--"?o=Js:d[1]!==void 0?o=ec:d[2]!==void 0?(sc.test(d[2])&&(a=RegExp("</"+d[2],"g")),o=vt):d[3]!==void 0&&(o=vt):o===vt?d[0]===">"?(o=a??Hr,h=-1):d[1]===void 0?h=-2:(h=o.lastIndex-d[2].length,l=d[1],o=d[3]===void 0?vt:d[3]==='"'?rc:tc):o===rc||o===tc?o=vt:o===Js||o===ec?o=Hr:(o=vt,a=void 0);let f=o===vt&&e[s+1].startsWith("/>")?" ":"";n+=o===Hr?c+ep:h>=0?(i.push(l),c.slice(0,h)+Cn+c.slice(h)+Qe+f):c+Qe+(h===-2?(i.push(void 0),s):f)}return[lc(e,n+(e[r]||"<?>")+(t===2?"</svg>":"")),i]},Ur=class e{constructor({strings:t,_$litType$:r},i){let a;this.parts=[];let n=0,o=0,s=t.length-1,c=this.parts,[l,d]=rp(t,r);if(this.el=e.createElement(l,i),bt.currentNode=this.el.content,r===2){let h=this.el.content,m=h.firstChild;m.remove(),h.append(...m.childNodes)}for(;(a=bt.nextNode())!==null&&c.length<s;){if(a.nodeType===1){if(a.hasAttributes()){let h=[];for(let m of a.getAttributeNames())if(m.endsWith(Cn)||m.startsWith(Qe)){let f=d[o++];if(h.push(m),f!==void 0){let x=a.getAttribute(f.toLowerCase()+Cn).split(Qe),v=/([.?@])?(.*)/.exec(f);c.push({type:1,index:n,name:v[2],strings:x,ctor:v[1]==="."?kn:v[1]==="?"?_n:v[1]==="@"?Pn:Bt})}else c.push({type:6,index:n})}for(let m of h)a.removeAttribute(m)}if(sc.test(a.tagName)){let h=a.textContent.split(Qe),m=h.length-1;if(m>0){a.textContent=$t?$t.emptyScript:"";for(let f=0;f<m;f++)a.append(h[f],Br()),bt.nextNode(),c.push({type:2,index:++n});a.append(h[m],Br())}}}else if(a.nodeType===8)if(a.data===nc)c.push({type:2,index:n});else{let h=-1;for(;(h=a.data.indexOf(Qe,h+1))!==-1;)c.push({type:7,index:n}),h+=Qe.length-1}n++}}static createElement(t,r){let i=yt.createElement("template");return i.innerHTML=t,i}};Tn=class{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var r;let{el:{content:i},parts:a}=this._$AD,n=((r=t?.creationScope)!==null&&r!==void 0?r:yt).importNode(i,!0);bt.currentNode=n;let o=bt.nextNode(),s=0,c=0,l=a[0];for(;l!==void 0;){if(s===l.index){let d;l.type===2?d=new Gr(o,o.nextSibling,this,t):l.type===1?d=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(d=new Ln(o,this,t)),this._$AV.push(d),l=a[++c]}s!==l?.index&&(o=bt.nextNode(),s++)}return bt.currentNode=yt,n}v(t){let r=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,r),r+=i.strings.length-2):i._$AI(t[r])),r++}},Gr=class e{constructor(t,r,i,a){var n;this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=i,this.options=a,this._$Cp=(n=a?.isConnected)===null||n===void 0||n}get _$AU(){var t,r;return(r=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&r!==void 0?r:this._$Cp}get parentNode(){let t=this._$AA.parentNode,r=this._$AM;return r!==void 0&&t?.nodeType===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=Ht(this,t,r),Fr(t)?t===w||t==null||t===""?(this._$AH!==w&&this._$AR(),this._$AH=w):t!==this._$AH&&t!==qe&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):tp(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==w&&Fr(this._$AH)?this._$AA.nextSibling.data=t:this.$(yt.createTextNode(t)),this._$AH=t}g(t){var r;let{values:i,_$litType$:a}=t,n=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=Ur.createElement(lc(a.h,a.h[0]),this.options)),a);if(((r=this._$AH)===null||r===void 0?void 0:r._$AD)===n)this._$AH.v(i);else{let o=new Tn(n,this),s=o.u(this.options);o.v(i),this.$(s),this._$AH=o}}_$AC(t){let r=ic.get(t.strings);return r===void 0&&ic.set(t.strings,r=new Ur(t)),r}T(t){oc(this._$AH)||(this._$AH=[],this._$AR());let r=this._$AH,i,a=0;for(let n of t)a===r.length?r.push(i=new e(this.k(Br()),this.k(Br()),this,this.options)):i=r[a],i._$AI(n),a++;a<r.length&&(this._$AR(i&&i._$AB.nextSibling,a),r.length=a)}_$AR(t=this._$AA.nextSibling,r){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,r);t&&t!==this._$AB;){let a=t.nextSibling;t.remove(),t=a}}setConnected(t){var r;this._$AM===void 0&&(this._$Cp=t,(r=this._$AP)===null||r===void 0||r.call(this,t))}},Bt=class{constructor(t,r,i,a,n){this.type=1,this._$AH=w,this._$AN=void 0,this.element=t,this.name=r,this._$AM=a,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=w}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,r=this,i,a){let n=this.strings,o=!1;if(n===void 0)t=Ht(this,t,r,0),o=!Fr(t)||t!==this._$AH&&t!==qe,o&&(this._$AH=t);else{let s=t,c,l;for(t=n[0],c=0;c<n.length-1;c++)l=Ht(this,s[i+c],r,c),l===qe&&(l=this._$AH[c]),o||(o=!Fr(l)||l!==this._$AH[c]),l===w?t=w:t!==w&&(t+=(l??"")+n[c+1]),this._$AH[c]=l}o&&!a&&this.j(t)}j(t){t===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},kn=class extends Bt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===w?void 0:t}},ip=$t?$t.emptyScript:"",_n=class extends Bt{constructor(){super(...arguments),this.type=4}j(t){t&&t!==w?this.element.setAttribute(this.name,ip):this.element.removeAttribute(this.name)}},Pn=class extends Bt{constructor(t,r,i,a,n){super(t,r,i,a,n),this.type=5}_$AI(t,r=this){var i;if((t=(i=Ht(this,t,r,0))!==null&&i!==void 0?i:w)===qe)return;let a=this._$AH,n=t===w&&a!==w||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,o=t!==w&&(a===w||n);n&&this.element.removeEventListener(this.name,this,a),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var r,i;typeof this._$AH=="function"?this._$AH.call((i=(r=this.options)===null||r===void 0?void 0:r.host)!==null&&i!==void 0?i:this.element,t):this._$AH.handleEvent(t)}},Ln=class{constructor(t,r,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Ht(this,t)}},ac=Gi.litHtmlPolyfillSupport;ac?.(Ur,Gr),((Sn=Gi.litHtmlVersions)!==null&&Sn!==void 0?Sn:Gi.litHtmlVersions=[]).push("2.8.0");dc=(e,t,r)=>{var i,a;let n=(i=r?.renderBefore)!==null&&i!==void 0?i:t,o=n._$litPart$;if(o===void 0){let s=(a=r?.renderBefore)!==null&&a!==void 0?a:null;n._$litPart$=o=new Gr(t.insertBefore(Br(),s),s,void 0,r??{})}return o._$AI(e),o}});var Mn,Rn,G,hc,pc=ye(()=>{Ui();Ui();Ft();Ft();G=class extends Ge{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,r;let i=super.createRenderRoot();return(t=(r=this.renderOptions).renderBefore)!==null&&t!==void 0||(r.renderBefore=i.firstChild),i}update(t){let r=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=dc(r,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return qe}};G.finalized=!0,G._$litElement$=!0,(Mn=globalThis.litElementHydrateSupport)===null||Mn===void 0||Mn.call(globalThis,{LitElement:G});hc=globalThis.litElementPolyfillSupport;hc?.({LitElement:G});((Rn=globalThis.litElementVersions)!==null&&Rn!==void 0?Rn:globalThis.litElementVersions=[]).push("3.3.3")});var mc=ye(()=>{});var R=ye(()=>{Ui();Ft();pc();mc()});var xc,vc,Vi,bc=ye(()=>{xc={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},vc=e=>(...t)=>({_$litDirective$:e,values:t}),Vi=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,i){this._$Ct=t,this._$AM=r,this._$Ci=i}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}}});var qr,Vr,yc=ye(()=>{Ft();bc();qr=class extends Vi{constructor(t){if(super(t),this.et=w,t.type!==xc.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===w||t==null)return this.ft=void 0,this.et=t;if(t===qe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let r=[t];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};qr.directiveName="unsafeHTML",qr.resultType=1;Vr=vc(qr)});var On=ye(()=>{yc()});var wc,Ec=ye(()=>{Ft();wc=e=>e??w});var Sc=ye(()=>{Ec()});var Nn={};io(Nn,{default:()=>jr});function ap(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var ue,jr,ji=ye(()=>{R();On();Sc();ue=class ue extends G{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let r=t.composedPath();ue.activeTooltip===this&&!r.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let r=t.getBoundingClientRect(),i=window.innerWidth,a=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),l=c?c.offsetWidth:o,d=c?c.offsetHeight:s,m=this.effectivePlacement;m==="top"&&r.top-d-n<0?m="bottom":m==="bottom"&&r.bottom+d+n>a?m="top":m==="left"&&r.left-l-n<0?m="right":m==="right"&&r.right+l+n>i&&(m="left");let f=r.left+r.width/2,x=r.top+r.height/2,v=6,S=(M,W,H)=>Math.max(M,Math.min(W,H)),L,P,A;m==="top"||m==="bottom"?(L=m==="top"?r.top-d-n:r.bottom+n,P=S(0,i-l,f-l/2),A=S(v,l-v*2,f-P-v)):(P=m==="left"?r.left-l-n:r.right+n,L=S(0,a-d,x-d/2),A=S(v,d-v*2,x-L-v)),this._tooltipTop=L,this._tooltipLeft=P,this._arrowOffset=A,this._computedPlacement=m}showTooltip(){ue.activeTooltip&&ue.activeTooltip!==this&&(ue.activeTooltip.closeOverlay(),ue.activeTooltip.tooltipVisible=!1,ue.activeTooltip.requestUpdate()),ue.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){ue.activeTooltip===this&&(ue.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?g`<merch-icon
        ...
        ></merch-icon>`:g`<slot></slot>`}render(){let t=this.effectiveContent,r=this.effectivePlacement;if(!t)return g`<span class="icon-only">${this.renderIcon()}</span>`;if(ap())return g`
            ...
            `;let a=t.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:h=>{this.lastPointerType=h.pointerType},pointerenter:h=>h.pointerType!=="touch"&&this.showTooltip(),pointerleave:h=>h.pointerType!=="touch"&&this.hideTooltip(),click:h=>{this.lastPointerType==="touch"&&this.handleTap(h),this.lastPointerType=null}},s=this._computedPlacement,c=s==="top"||s==="bottom",l=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,d=c?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return g`
            <span
...
`;var Xi=class extends C{constructor(t){super(t)}getGlobalCSS(){return _c}renderLayout(){return g` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":g`<hr />`} ${this.secureLabelFooter}`}};R();var Pc=`
  :root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let r=t.querySelector("strong, b, p");r&&(I.isMobile?r.style.display="none":r.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?I.isMobile?g`
...
`;document.head.appendChild(rl);var il="fragment",al="author",nl="preview",ol="loading",sl="timeout",Hn="aem-fragment",cl="eager",ll="cache",dp=[cl,ll],De,St,Pe,Bn=class{constructor(){E(this,De,new Map);E(this,St,new Map);E(this,Pe,new Map)}clear(){p(this,De).clear(),p(this,St).clear(),p(this,Pe).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(p(this,De).set(t.id,t),t.fields?.originalId&&p(this,De).set(t.fields.originalId,t),p(this,Pe).has(t.id)){let[,i]=p(this,Pe).get(t.id);i()}if(p(this,Pe).has(t.fields?.originalId)){let[,i]=p(this,Pe).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return p(this,De).has(t)}entries(){return p(this,De).entries()}get(t){return p(this,De).get(t)}getAsPromise(t){let[r]=p(this,Pe).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),p(this,Pe).set(t,[r,i]),r}getFetchInfo(t){let r=p(this,St).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},p(this,St).set(t,r)),r}remove(t){p(this,De).delete(t),p(this,St).delete(t),p(this,Pe).delete(t)}};De=new WeakMap,St=new WeakMap,Pe=new WeakMap;var Je=new Bn,ar,Le,Ve,Se,fe,J,Qr,Zr,Me,Jr,ei,nr,Re,dl,hl,Fn,pl,Zi=class extends HTMLElement{constructor(){super(...arguments);E(this,Re);u(this,"cache",Je);E(this,ar);E(this,Le,null);E(this,Ve,null);E(this,Se,null);E(this,fe);E(this,J);E(this,Qr,cl);E(this,Zr,5e3);E(this,Me);E(this,Jr,!1);E(this,ei,0);E(this,nr)}static get observedAttributes(){return[il,ol,sl,al,nl]}attributeChangedCallback(r,i,a){r===il&&(y(this,fe,a),y(this,J,Je.getFetchInfo(a))),r===ol&&dp.includes(a)&&y(this,Qr,a),r===sl&&y(this,Zr,parseInt(a,10)),r===al&&y(this,Jr,["","true"].includes(a)),r===nl&&y(this,nr,a)}connectedCallback(){if(!p(this,Me)){if(p(this,Se)??y(this,Se,ut(this)),y(this,nr,p(this,Se).settings?.preview),p(this,ar)??y(this,ar,p(this,Se).log.module(`${Hn}[${p(this,fe)}]`)),!p(this,fe)||p(this,fe)==="#"){p(this,J)??y(this,J,Je.getFetchInfo("missing-fragment-id")),Z(this,Re,Fn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(p(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(p(this,Me)&&!await Promise.race([p(this,Me),Promise.resolve(!1)]))return;r&&Je.remove(p(this,fe)),p(this,Qr)===ll&&await Promise.race([Je.getAsPromise(p(this,fe)),new Promise(s=>setTimeout(s,p(this,Zr)))]);try{y(this,Me,Z(this,Re,pl).call(this)),await p(this,Me)}catch(s){return Z(this,Re,Fn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=p(this,Le)||{};return o&&!U("mas.disableWcsCache")&&p(this,Se).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(nt,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...p(this,J)},bubbles:!0,composed:!0})),p(this,Me)}get updateComplete(){return p(this,Me)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return p(this,Ve)?p(this,Ve):(p(this,Jr)?this.transformAuthorData():this.transformPublishData(),p(this,Ve))}get rawData(){return p(this,Le)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=p(this,Le);y(this,Ve,r.reduce((d,{name:h,multiple:m,values:f})=>(d.fields[h]=m?f:f[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=p(this,Le);y(this,Ve,Object.entries(r).reduce((d,[h,m])=>(d.fields[h]=m?.mimeType?m.value:m??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(p(this,fe),{locale:p(this,Se).settings.locale,apiKey:p(this,Se).settings.wcsApiKey,fullContext:!0})}};ar=new WeakMap,Le=new WeakMap,Ve=new WeakMap,Se=new WeakMap,fe=new WeakMap,J=new WeakMap,Qr=new WeakMap,Zr=new WeakMap,Me=new WeakMap,Jr=new WeakMap,ei=new WeakMap,nr=new WeakMap,Re=new WeakSet,dl=async function(r){ao(this,ei)._++;let i=`${Hn}:${p(this,fe)}:${p(this,ei)}`,a=`${i}${ct}`,n=`${i}${lt}`;if(p(this,nr)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Ne(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(p(this,J).stale=!1,p(this,J).url=r,o=await Di(r,{cache:"default",credentials:"omit"}),Z(this,Re,hl).call(this,o),p(this,J).status=o?.status,p(this,J).measure=Ie(performance.measure(n,a)),p(this,J).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...p(this,Se).duration});return await o.json()}catch(s){if(p(this,J).measure=Ie(performance.measure(n,a)),p(this,J).retryCount=s.retryCount,p(this,Le))return p(this,J).stale=!0,p(this,ar).error("Serving stale data",p(this,J)),p(this,Le);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},hl=function(r){Object.assign(p(this,J),wi(r))},Fn=function(r){y(this,Me,null),p(this,J).message=r,this.classList.add("error");let i={...p(this,J),...p(this,Se).duration};p(this,ar).error(r,i),this.dispatchEvent(new CustomEvent(ot,{detail:i,bubbles:!0,composed:!0}))},pl=async function(){var c;this.classList.remove("error"),y(this,Ve,null);let r=Je.get(p(this,fe));if(r)return y(this,Le,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=p(this,Se).settings,s=`${i}/fragment?id=${p(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Re,dl).call(this,s),(c=r.fields).originalId??(c.originalId=p(this,fe)),Je.add(r),y(this,Le,r),!0},u(Zi,"cache",Je);customElements.define(Hn,Zi);R();On();var hp=e=>e?e.startsWith("sp-icon-")?g`${Vr(`<${e} class="badge-icon"></${e}>`)}`:g`<img src="${e}" class="badge-icon" />`:w,or=class extends G{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return g`<div class="badge">
    ...
    `);customElements.define("merch-badge",or);R();var ti=class extends G{constructor(){super()}render(){return g`
            <slot name="icon"></slot>
...
`;var Pl={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},mr=class extends C{getGlobalCSS(){return _l}renderLayout(){return g` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>

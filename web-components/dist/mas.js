...
var Yc = (e, t, r) =>
    t in e
        ? Io(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
        : (e[t] = r);
var Xe = (e, t) => () => (e && (t = e((e = 0))), t);
var Ho = (e, t) => {
    for (var r in t) Io(e, r, { get: t[r], enumerable: !0 });
};
var u = (e, t, r) => Yc(e, typeof t != 'symbol' ? t + '' : t, r),
    Gi = (e, t, r) => t.has(e) || $o('Cannot ' + r);
var h = (e, t, r) => (
        Gi(e, t, 'read from private field'), r ? r.call(e) : t.get(e)
    ),
    E = (e, t, r) =>
        t.has(e)
            ...
            : t instanceof WeakSet
              ...
              : t.set(e, r),
    v = (e, t, r, i) => (
        Gi(e, t, 'write to private field'), i ? i.call(e, r) : t.set(e, r), r
    ),
    Z = (e, t, r) => (Gi(e, t, 'access private method'), r);
var Do = (e, t, r, i) => ({
    set _(n) {
        v(e, t, n, r);
    },
...
var gi,
    ...
    to = Xe(() => {
        (gi = window),
            (xi =
                gi.ShadowRoot &&
                (gi.ShadyCSS === void 0 || gi.ShadyCSS.nativeShadow) &&
            ...
            (je = (e) => new Sr(typeof e == 'string' ? e : e + '', void 0, Jn)),
            (y = (e, ...t) => {
                let r =
                    e.length === 1
                        ? e[0]
...
var ro,
    ...
    yi = Xe(() => {
        ...
        (vi = window),
            (Ls = vi.trustedTypes),
            (th = Ls ? Ls.emptyScript : ''),
            (Rs = vi.reactiveElementPolyfillSupport),
            (no = {
                toAttribute(e, t) {
                    switch (t) {
                        case Boolean:
            ...
            (Ie = class extends HTMLElement {
                ...
                static getPropertyDescriptor(t, r, i) {
                    return {
                        ...
                        set(n) {
                            let o = this[t];
                            (this[r] = n), this.requestUpdate(t, o, i);
                        },
                        configurable: !0,
                        enumerable: !0,
                    };
                ...
                static finalize() {
                    if (this.hasOwnProperty(oo)) return !1;
                    this[oo] = !0;
                ...
                static finalizeStyles(t) {
                    ...
                    if (Array.isArray(t)) {
                        ...
                        for (let n of i) r.unshift(bi(n));
                    } else t !== void 0 && r.push(bi(t));
                    return r;
                }
                static _$Ep(t, r) {
                    let i = r.attribute;
                ...
                createRenderRoot() {
                    ...
                    return eo(r, this.constructor.elementStyles), r;
                }
                connectedCallback() {
                    var t;
                    this.renderRoot === void 0 &&
                            ...
                            s =
                                typeof a.converter == 'function'
                                    ...
                                    : ((i = a.converter) === null ||
                                      ...
                                      : no;
                        (this._$El = o),
                            (this[o] = s.fromAttribute(r, a.type)),
                            (this._$El = null);
                    }
                }
                requestUpdate(t, r, i) {
                ...
                performUpdate() {
                    ...
                    this.hasUpdated,
                        this._$Ei &&
                            (this._$Ei.forEach((n, o) => (this[o] = n)),
                            (this._$Ei = void 0));
                    let r = !1,
                        i = this._$AL;
                    try {
        ...
        (Ie[oo] = !0),
            (Ie.elementProperties = new Map()),
            (Ie.elementStyles = []),
            (Ie.shadowRootOptions = { mode: 'open' }),
            Rs?.({ ReactiveElement: Ie }),
            ((ro = vi.reactiveElementVersions) !== null && ro !== void 0
                ? ro
                : (vi.reactiveElementVersions = [])
            ).push('1.6.3');
    });
function Vs(e, t) {
    ...
    let c =
            i !== void 0
                ? (n = r._$Co) === null || n === void 0
                    ...
                    : n[i]
                : r._$Cl,
        l = Cr(t) ? void 0 : t._$litDirective$;
    return (
        c?.constructor !== l &&
            ((o = c?._$AO) === null || o === void 0 || o.call(c, !1),
            l === void 0 ? (c = void 0) : ((c = new l(e)), c._$AT(e, r, i)),
            i !== void 0
                ? (((a = (s = r)._$Co) !== null && a !== void 0
                      ? a
                      : (s._$Co = []))[i] = c)
                : (r._$Cl = c)),
        c !== void 0 && (t = Rt(e, c._$AS(e, t.values), c, i)),
        t
    );
}
var ao,
    ...
    wi = Xe(() => {
        (Ei = window),
            (Lt = Ei.trustedTypes),
            (Ns = Lt
                ? Lt.createPolicy('lit-html', { createHTML: (e) => e })
                : void 0),
            (co = '$lit$'),
            (qe = `lit$${(Math.random() + '').slice(9)}$`),
            (Bs = '?' + qe),
            (rh = `<${Bs}>`),
            (ht = document),
            (Tr = () => ht.createComment('')),
            ...
            (zs = Array.isArray),
            (ih = (e) => zs(e) || typeof e?.[Symbol.iterator] == 'function'),
            (so = `[ 	
\f\r]`),
            (_r = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g),
            (Ms = /-->/g),
            (Is = />/g),
            (lt = RegExp(
                `>|${so}(?:([^\\s"'>=/]+)(${so}*=${so}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,
            ...
            (Ds = new WeakMap()),
            (dt = ht.createTreeWalker(ht, 129, null, !1));
        (nh = (e, t) => {
            let r = e.length - 1,
                i = [],
                n,
            ...
            for (let s = 0; s < r; s++) {
                ...
                for (
                    ;
                    m < c.length &&
                    ((a.lastIndex = m), (d = a.exec(c)), d !== null);
                            ...
                            : a === lt
                              ...
                              : a === Hs || a === $s
                                ...
                                : a === Ms || a === Is
                                  ? (a = _r)
                                  : ((a = lt), (n = void 0));
                let f = a === lt && e[s + 1].startsWith('/>') ? ' ' : '';
                o +=
                    a === _r
                        ? c + rh
                        : p >= 0
                          ? (i.push(l),
                            c.slice(0, p) + co + c.slice(p) + qe + f)
                          : c + qe + (p === -2 ? (i.push(void 0), s) : f);
            }
            return [Vs(e, o + (e[r] || '<?>') + (t === 2 ? '</svg>' : '')), i];
        }),
            (kr = class e {
                constructor({ strings: t, _$litType$: r }, i) {
                    ...
                    if (
                        ...
                        (dt.currentNode = this.el.content),
                        r === 2)
                    ) {
                        let p = this.el.content,
                            m = p.firstChild;
                        m.remove(), p.append(...m.childNodes);
                    }
                    for (; (n = dt.nextNode()) !== null && c.length < s; ) {
                        if (n.nodeType === 1) {
                            if (n.hasAttributes()) {
                                let p = [];
                                for (let m of n.getAttributeNames())
                                    if (m.endsWith(co) || m.startsWith(qe)) {
                                        let f = d[a++];
                                        if ((p.push(m), f !== void 0)) {
                                            let x = n
                                                    .getAttribute(
                                                        f.toLowerCase() + co,
                                                    )
                                ...
                                for (let m of p) n.removeAttribute(m);
                            }
                            if (Fs.test(n.tagName)) {
                                let p = n.textContent.split(qe),
                                    m = p.length - 1;
                                if (m > 0) {
                            ...
                            if (n.data === Bs) c.push({ type: 2, index: o });
                            else {
                                let p = -1;
                                for (; (p = n.data.indexOf(qe, p + 1)) !== -1; )
                ...
                static createElement(t, r) {
                    let i = ht.createElement('template');
        ...
        (lo = class {
            ...
            u(t) {
                ...
                let {
                    ...
                    o = (
                        (r = t?.creationScope) !== null && r !== void 0 ? r : ht
                    ).importNode(i, !0);
                dt.currentNode = o;
                let a = dt.nextNode(),
                    s = 0,
                ...
                for (; l !== void 0; ) {
                    if (s === l.index) {
                        let d;
                        l.type === 2
                            ? (d = new Pr(a, a.nextSibling, this, t))
                            : l.type === 1
                              ? (d = new l.ctor(a, l.name, l.strings, this, t))
                              : l.type === 6 && (d = new uo(a, this, t)),
                            this._$AV.push(d),
                            (l = n[++c]);
                    }
                    s !== l?.index && ((a = dt.nextNode()), s++);
                }
            ...
            (Pr = class e {
                constructor(t, r, i, n) {
                    ...
                    (this.type = 2),
                        ...
                        (this.options = n),
                        (this._$Cp =
                            (o = n?.isConnected) === null || o === void 0 || o);
                }
                get _$AU() {
                    var t, r;
                    return (r =
                ...
                _(t) {
                    this._$AH !== N && Cr(this._$AH)
                        ? (this._$AA.nextSibling.data = t)
                        : this.$(ht.createTextNode(t)),
                        (this._$AH = t);
                }
                g(t) {
                    var r;
                ...
                _$AC(t) {
                    let r = Ds.get(t.strings);
                    return (
                        r === void 0 && Ds.set(t.strings, (r = new kr(t))), r
                    );
                }
                T(t) {
            ...
            (po = class extends Ot {
                ...
                j(t) {
                    t && t !== N
                        ? this.element.setAttribute(this.name, oh)
                        : this.element.removeAttribute(this.name);
                }
            }),
            (mo = class extends Ot {
            ...
            (Us = Ei.litHtmlPolyfillSupport);
        Us?.(kr, Pr),
            ((ao = Ei.litHtmlVersions) !== null && ao !== void 0
                ? ao
                : (Ei.litHtmlVersions = [])
            ).push('2.8.0');
        js = (e, t, r) => {
            var i, n;
            let o = (i = r?.renderBefore) !== null && i !== void 0 ? i : t,
                a = o._$litPart$;
            if (a === void 0) {
                let s =
                    (n = r?.renderBefore) !== null && n !== void 0 ? n : null;
                o._$litPart$ = a = new Pr(
                    t.insertBefore(Tr(), s),
                    s,
                    void 0,
                    r ?? {},
...
var fo,
    ...
    Ws = Xe(() => {
        ...
        (I.finalized = !0),
            (I._$litElement$ = !0),
            (fo = globalThis.litElementHydrateSupport) === null ||
                fo === void 0 ||
                fo.call(globalThis, { LitElement: I });
        qs = globalThis.litElementPolyfillSupport;
        qs?.({ LitElement: I });
        ((go = globalThis.litElementVersions) !== null && go !== void 0
            ? go
...
var mt,
    ...
    `,
        ...
        customElements.define('mas-mnemonic', mt);
    });
var Ke = {
...
function Bo(e) {
    ...
    if (t === 'object') {
        ...
        if (typeof e.originatingRequest == 'string') {
            let { message: i, originatingRequest: n, status: o } = e;
            return [i, o, n].filter(Boolean).join(' ');
        }
        let r =
            e[Symbol.toStringTag] ?? Object.getPrototypeOf(e).constructor.name;
        if (!Ke.serializableTypes.includes(r)) return r;
    }
    return e;
}
function Kc(e, t) {
    if (!Ke.ignoredProperties.includes(e)) return Bo(t);
}
var Vi = {
    append(e) {
        ...
        let { message: t, params: r } = e,
            ...
            o = t;
        r.forEach((l) => {
            l != null && (Xc(l) ? i : n).push(l);
        }),
            i.length && (o += ' ' + i.map(Bo).join(' '));
        let { pathname: a, search: s } = window.location,
            c = `${Ke.delimiter}page=${a}${s}`;
        c.length > Uo && (c = `${c.slice(0, Uo)}<trunc>`),
            (o += c),
            n.length &&
                ((o += `${Ke.delimiter}facts=`), (o += JSON.stringify(n, Kc))),
            window.lana?.log(o, Ke);
    },
};
function Vr(e) {
    Object.assign(
...
var pn = {};
Ho(pn, {
    CLASS_NAME_FAILED: () => Xi,
    CLASS_NAME_HIDDEN: () => Zc,
    CLASS_NAME_PENDING: () => Ki,
    CLASS_NAME_RESOLVED: () => Qi,
    CheckoutWorkflow: () => Fo,
    CheckoutWorkflowStep: () => re,
    Commitment: () => Qe,
    ERROR_MESSAGE_BAD_REQUEST: () => Zi,
    ERROR_MESSAGE_MISSING_LITERALS_URL: () => ll,
    ERROR_MESSAGE_OFFER_NOT_FOUND: () => Ji,
    EVENT_AEM_ERROR: () => Je,
    EVENT_AEM_LOAD: () => Ze,
    EVENT_MAS_ERROR: () => Yi,
    EVENT_MAS_READY: () => Wi,
    EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE: () => qr,
    EVENT_MERCH_CARD_ACTION_MENU_TOGGLE: () => ji,
    EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED: () => ol,
    EVENT_MERCH_CARD_COLLECTION_SHOWMORE: () => sl,
    EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED: () => al,
    EVENT_MERCH_CARD_COLLECTION_SORT: () => nl,
    EVENT_MERCH_CARD_QUANTITY_CHANGE: () => wt,
    EVENT_MERCH_OFFER_READY: () => Et,
    EVENT_MERCH_OFFER_SELECT_READY: () => ir,
    EVENT_MERCH_QUANTITY_SELECTOR_CHANGE: () => Pe,
    EVENT_MERCH_SEARCH_CHANGE: () => il,
    EVENT_MERCH_SIDENAV_SELECT: () => cl,
    EVENT_MERCH_STOCK_CHANGE: () => tl,
    EVENT_MERCH_STORAGE_CHANGE: () => rl,
    EVENT_OFFER_SELECTED: () => qi,
    EVENT_TYPE_FAILED: () => en,
    EVENT_TYPE_READY: () => jr,
    EVENT_TYPE_RESOLVED: () => At,
    Env: () => Ae,
    FF_DEFAULTS: () => ze,
    HEADER_X_REQUEST_ID: () => nr,
    LOG_NAMESPACE: () => tn,
    Landscape: () => Be,
    MARK_DURATION_SUFFIX: () => rt,
    MARK_START_SUFFIX: () => tt,
    MODAL_TYPE_3_IN_1: () => et,
    NAMESPACE: () => Qc,
    PARAM_AOS_API_KEY: () => dl,
    PARAM_ENV: () => nn,
    PARAM_LANDSCAPE: () => on,
    PARAM_MAS_PREVIEW: () => rn,
    PARAM_WCS_API_KEY: () => hl,
    PROVIDER_ENVIRONMENT: () => cn,
    SELECTOR_MAS_CHECKOUT_LINK: () => ge,
    SELECTOR_MAS_ELEMENT: () => rr,
    SELECTOR_MAS_INLINE_PRICE: () => z,
    SELECTOR_MAS_SP_BUTTON: () => el,
    SELECTOR_MAS_UPT_LINK: () => zo,
    SORT_ORDER: () => fl,
    STATE_FAILED: () => xe,
    STATE_PENDING: () => Ue,
    STATE_RESOLVED: () => Le,
    SUPPORTED_COUNTRIES: () => hn,
    SUPPORTED_LANGUAGES: () => dn,
    SUPPORTED_LANGUAGE_COUNTRY: () => or,
    TAG_NAME_SERVICE: () => Jc,
    TEMPLATE_PRICE: () => pl,
    TEMPLATE_PRICE_ANNUAL: () => ul,
    TEMPLATE_PRICE_LEGAL: () => ln,
    TEMPLATE_PRICE_STRIKETHROUGH: () => ml,
    Term: () => me,
    WCS_PROD_URL: () => an,
    WCS_STAGE_URL: () => sn,
});
var Qe = Object.freeze({
    ...
    Qc = 'merch',
    Zc = 'hidden',
    jr = 'wcms:commerce:ready',
    Jc = 'mas-commerce-service',
    z = 'span[is="inline-price"][data-wcs-osi]',
    ge =
        'a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',
    el = 'sp-button[data-wcs-osi]',
    zo = 'a[is="upt-link"]',
    rr = `${z},${ge},${zo}`,
    Et = 'merch-offer:ready',
    ir = 'merch-offer-select:ready',
    ji = 'merch-card:action-menu-toggle',
    qi = 'merch-offer:selected',
    tl = 'merch-stock:change',
    rl = 'merch-storage:change',
    Pe = 'merch-quantity-selector:change',
    wt = 'merch-card-quantity:change',
    qr = 'merch-modal:addon-and-quantity-update',
    il = 'merch-search:change',
    nl = 'merch-card-collection:sort',
    ol = 'merch-card-collection:literals-changed',
    al = 'merch-card-collection:sidenav-attached',
    sl = 'merch-card-collection:showmore',
    cl = 'merch-sidenav:select',
    Ze = 'aem:load',
    Je = 'aem:error',
    Wi = 'mas:ready',
    Yi = 'mas:error',
    Xi = 'placeholder-failed',
    Ki = 'placeholder-pending',
    Qi = 'placeholder-resolved',
    Zi = 'Bad WCS request',
    Ji = 'Commerce offer not found',
    ll = 'Literals URL not provided',
    en = 'mas:failed',
    At = 'mas:resolved',
    tn = 'mas/commerce',
    rn = 'mas.preview',
    ...
    dl = 'commerce.aosKey',
    hl = 'commerce.wcsKey',
    an = 'https://www.adobe.com/web_commerce_artifact',
    sn = 'https://www.stage.adobe.com/web_commerce_artifact_stage',
    xe = 'failed',
    Ue = 'pending',
    Le = 'resolved',
    Be = { DRAFT: 'DRAFT', PUBLISHED: 'PUBLISHED' },
    nr = 'X-Request-Id',
    re = Object.freeze({
    ...
    cn = { PRODUCTION: 'PRODUCTION' },
    et = { TWP: 'twp', D2P: 'd2p', CRM: 'crm' },
    tt = ':start',
    rt = ':duration',
    pl = 'price',
    ml = 'price-strikethrough',
    ul = 'annual',
    ln = 'legal',
    ze = 'mas-ff-defaults',
    fl = { alphabetical: 'alphabetical', authored: 'authored' },
    or = [
        'en_US',
        'ar_DZ',
        'ar_EG',
...
function H(
    ...
    if (n && o == null) {
        let a = St(n) ? n : e;
        o = window.sessionStorage.getItem(a) ?? window.localStorage.getItem(a);
    }
    if (r && o == null) {
        let a = xl(St(r) ? r : e);
        o = document.documentElement.querySelector(
            `meta[name="${a}"]`,
        )?.content;
    }
    return o ?? t[e];
}
var gl = (e) => typeof e == 'boolean',
    Wr = (e) => typeof e == 'function',
    Yr = (e) => typeof e == 'number',
    jo = (e) => e != null && typeof e == 'object';
var St = (e) => typeof e == 'string',
    qo = (e) => St(e) && e,
    ar = (e) => Yr(e) && Number.isFinite(e) && e > 0;
function Xr(e, t = (r) => r == null || r === '') {
    return (
        e != null &&
...
var bl = Date.now(),
    un = () => `(+${Date.now() - bl}ms)`,
    Kr = new Set(),
    vl = S(H('tacocat.debug', {}, { metadata: !1 }), !1);
function Yo(e) {
    let t = `[${Go}/${e}]`,
        r = (a, s, ...c) => (a ? !0 : (n(s, ...c), !1)),
        i = vl
            ? (a, ...s) => {
                  console.debug(`${t} ${a}`, ...s, un());
              }
            : () => {},
        n = (a, ...s) => {
            let c = `${t} ${a}`;
...
var El = 'no promo',
    ...
    Qr = (e, t) => {
        let r = e === _l,
            ...
            a = o ? e || t : void 0;
        return {
            effectivePromoCode: a,
            overridenPromoCode: e,
            className: o ? Xo : `${Xo} no-promo`,
            text: Sl(a, t, n),
            variant: o ? wl : Al,
            isOverriden: n,
        };
...
var yn = 'ABM',
    ...
    An = 'PERPETUAL',
    Sn = 'P3Y',
    Tl = 'TAX_INCLUSIVE_DETAILS',
    Cl = 'TAX_EXCLUSIVE',
    Ko = { ABM: yn, PUF: En, M2M: wn, PERPETUAL: An, P3Y: Sn },
    tp = {
        [yn]: { commitment: ce.YEAR, term: ue.MONTHLY },
        [En]: { commitment: ce.YEAR, term: ue.ANNUAL },
        [wn]: { commitment: ce.MONTH, term: ue.MONTHLY },
        [An]: { commitment: ce.PERPETUAL, term: void 0 },
        [Sn]: { commitment: ce.THREE_MONTHS, term: ue.P3Y },
    },
    Qo = 'Value is not an offer',
    cr = (e) => {
        if (typeof e != 'object') return Qo;
...
var kl = (e, t) => {
    switch (e) {
        ...
        case '':
            return '';
        case ce.YEAR:
            return t === ue.MONTHLY ? yn : t === ue.ANNUAL ? En : '';
        case ce.MONTH:
            return t === ue.MONTHLY ? wn : '';
        case ce.PERPETUAL:
            return An;
        case ce.TERM_LICENSE:
            return t === ue.P3Y ? Sn : '';
        default:
            return '';
    }
...
function lr(e, { country: t, forceTaxExclusive: r }) {
    let i;
    if (e.length < 2) i = e;
    else {
        let n = t === 'GB' ? 'EN' : 'MULT';
        e.sort((o, a) => (o.language === n ? -1 : a.language === n ? 1 : 0)),
            e.sort((o, a) =>
                !o.term && a.term ? -1 : o.term && !a.term ? 1 : 0,
            ),
            (i = [e[0]]);
    }
    return r && (i = i.map(Zo)), i;
}
var Zr = (e) => window.setTimeout(e);
function _t(e, t = 1) {
    if (e == null) return [t];
    let r = (Array.isArray(e) ? e : String(e).split(',')).map(Wo).filter(ar);
    return r.length || (r = [t]), r;
}
function Jr(e) {
    return e == null
        ? []
        : (Array.isArray(e) ? e : String(e).split(',')).filter(qo);
}
function ie() {
    return document.getElementsByTagName(Pl)?.[0];
}
function ei(e) {
    let t = {};
    if (!e?.headers) return t;
    let r = e.headers;
    for (let [i, n] of Object.entries(Ll)) {
        let o = r.get(n);
        o &&
            ((o = o.replace(/[,;]/g, '|')),
            (o = o.replace(/[| ]+/g, '|')),
...
var Jo = { LOCAL: 'local', PROD: 'prod', STAGE: 'stage' },
    _n = { DEBUG: 'debug', ERROR: 'error', INFO: 'info', WARN: 'warn' },
    Tn = new Set(),
    Cn = new Set(),
    ea = new Map(),
    ta = {
    ...
    ra = { filter: ({ level: e }) => e !== _n.DEBUG },
    Rl = { filter: () => !1 };
function Ol(e, t, r, i, n) {
    return {
        level: e,
        message: t,
        namespace: r,
...
function Nl(e) {
    [...Cn].every((t) => t(e)) && Tn.forEach((t) => t(e));
}
function ia(e) {
    let t = (ea.get(e) ?? 0) + 1;
    ea.set(e, t);
    let r = `${e} #${t}`,
        i = {
            id: r,
            namespace: e,
            module: (n) => ia(`${i.namespace}/${n}`),
            updateConfig: Vr,
        };
    return (
        Object.values(_n).forEach((n) => {
            i[n] = (o, ...a) => Nl(Ol(n, o, e, a, r));
        }),
        Object.seal(i)
    );
}
function ti(...e) {
    e.forEach((t) => {
        ...
        Wr(i) && Cn.add(i), Wr(r) && Tn.add(r);
    });
}
function Ml(e = {}) {
    let { name: t } = e,
        r = S(H('commerce.debug', { search: !0, storage: !0 }), t === Jo.LOCAL);
    return ti(r ? ta : ra), t === Jo.PROD && ti(Vi), le;
}
function Il() {
    Tn.clear(), Cn.clear();
}
...
var Re = class e extends Error {
    constructor(t, r, i) {
        if ((super(t, { cause: i }), (this.name = 'MasError'), r.response)) {
            let n = r.response.headers?.get(nr);
            n && (r.requestId = n),
                r.response.status &&
...
var $l = { [xe]: Xi, [Ue]: Ki, [Le]: Qi },
    ...
    Fe = class {
        constructor(t) {
            ...
            (this.wrapperElement = t), (this.log = le.module('mas-element'));
        }
        update() {
            [xe, Ue, Le].forEach((t) => {
                this.wrapperElement.classList.toggle($l[t], t === this.state);
            });
        }
        notify() {
            (this.state === Le || this.state === xe) &&
                (this.state === Le
                ...
                (this.promises = []));
            let t = this.error;
            this.error instanceof Re &&
                (t = { message: this.error.message, ...this.error.context }),
                this.wrapperElement.dispatchEvent(
                    new CustomEvent(Hl[this.state], { bubbles: !0, detail: t }),
                );
        }
        attributeChangedCallback(t, r, i) {
        ...
        connectedCallback() {
            v(this, dr, ie()), this.requestUpdate(!0);
        }
        disconnectedCallback() {
            this.connected &&
                ((this.connected = !1),
        ...
        requestUpdate(t = !1) {
            if (!this.wrapperElement.isConnected || !ie() || this.timer) return;
            let { error: r, options: i, state: n, value: o, version: a } = this;
            (this.state = Ue),
                (this.timer = Zr(async () => {
                    this.timer = null;
                    let s = null;
...
function ri(e, t = {}) {
    ...
    return n.setAttribute('is', i), Object.assign(n.dataset, na(t)), n;
}
function oa(e, t = {}) {
    return e instanceof HTMLElement
        ? (Object.assign(e.dataset, na(t)), e)
        : null;
}
var aa = 'download',
    sa = 'upgrade',
...
function ii(e, t = {}, r = '') {
    ...
    return (
        r && (w.innerHTML = `<span style="pointer-events: none;">${r}</span>`),
        w
    );
}
function ni(e) {
    return class extends e {
        ...
        attributeChangedCallback(i, n, o) {
            this.masElement.attributeChangedCallback(i, n, o);
        }
        connectedCallback() {
        ...
        get is3in1Modal() {
            return Object.values(et).includes(this.getAttribute('data-modal'));
        }
        get isOpen3in1Modal() {
        ...
        async render(i = {}) {
            ...
            this.dataset.imsCountry ||
                ...
                (i.imsCountry = null);
            let o = n.collectCheckoutOptions(i, this);
            if (!o.wcsOsi.length) return !1;
            let a;
            try {
                a = JSON.parse(o.extraOptions ?? '{}');
            } catch (p) {
            ...
            let s = this.masElement.togglePending(o);
            this.setCheckoutUrl('');
            let c = n.resolveOfferSelectors(o),
                l = await Promise.all(c);
            (l = l.map((p) => lr(p, o))),
                (o.country = this.dataset.imsCountry || o.country);
            let d = await n.buildCheckoutAction?.(
                l.flat(),
                { ...a, ...o },
                this,
            );
            return this.renderOffers(l.flat(), o, {}, d, s);
        }
        renderOffers(i, n, o = {}, a = void 0, s = void 0) {
            let c = ie();
            if (!c) return !1;
            if (
                ((n = {
                ...
                this.classList.remove(aa, sa),
                    this.masElement.toggleResolved(s, i, n);
                let { url: d, text: p, className: m, handler: f } = a;
                d && this.setCheckoutUrl(d),
                    p && (this.firstElementChild.innerHTML = p),
                    m && this.classList.add(...m.split(' ')),
                    f &&
                        (this.setCheckoutUrl('#'),
                        (this.checkoutActionHandler = f.bind(this)));
            }
            if (i.length) {
                if (this.masElement.toggleResolved(s, i, n)) {
                    if (
                        !this.classList.contains(aa) &&
                        !this.classList.contains(sa)
                    ) {
...
var hr = class hr extends ni(HTMLAnchorElement) {
...
u(hr, 'is', 'checkout-link'), u(hr, 'tag', 'a');
var Oe = hr;
window.customElements.get(Oe.is) ||
    window.customElements.define(Oe.is, Oe, { extends: Oe.tag });
var Dl = 'p_draft_landscape',
    Ul = '/store/',
    Bl = new Map([
        ['countrySpecific', 'cs'],
        ['customerSegment', 'cs'],
    ...
    zl = ['env', 'workflowStep', 'clientId', 'country'],
    la = (e) => Bl.get(e) ?? e;
function Pn(e, t, r) {
    for (let [i, n] of Object.entries(e)) {
        let o = la(i);
        n != null && r.has(o) && t.set(o, n);
    }
}
function Fl(e) {
    switch (e) {
...
function Vl({ url: e, modal: t, is3in1: r }) {
    ...
    return (
        ...
        e.searchParams.get('cli') !== 'doc_cloud' &&
            e.searchParams.set('cli', t === et.CRM ? 'creative' : 'mini_plans'),
        e
    );
}
function da(e) {
    ...
    if (
        ((f.pathname = `${Ul}${i}`),
        i !== re.SEGMENTATION &&
            i !== re.CHANGE_PLAN_TEAM_PLANS &&
            Gl(r, f.searchParams),
        Pn({ ...m }, f.searchParams, kn),
        c === Be.DRAFT && Pn({ af: Dl }, f.searchParams, kn),
        i === re.SEGMENTATION)
    ) {
        let x = {
            marketSegment: n,
            ...
            addonProductArrangementCode: s
                ? r?.find((b) => b.productArrangementCode !== s)
                      ?.productArrangementCode
                : r?.[1]?.productArrangementCode,
        };
        p?.toLowerCase() === 'edu'
            ? f.searchParams.set('ms', 'EDU')
            : p?.toLowerCase() === 'team' && f.searchParams.set('cs', 'TEAM'),
            Pn(x, f.searchParams, kn),
            f.searchParams.get('ot') === 'PROMOTION' &&
                f.searchParams.delete('ot'),
            (f = Vl({ url: f, modal: l, is3in1: d }));
    }
    return f.toString();
}
function jl(e) {
    ...
    if (
        e.workflowStep !== re.SEGMENTATION &&
        e.workflowStep !== re.CHANGE_PLAN_TEAM_PLANS &&
        !e.items
    )
...
function ha({ settings: e, providers: t }) {
    function r(o, a) {
        let {
                checkoutClientId: s,
        ...
        if (a) for (let De of t.checkout) De(a, b);
        let {
                checkoutMarketSegment: w,
                ...
                extraOptions: $,
                ...he
            } = Object.assign(b, a?.dataset ?? {}, o ?? {}),
            pe = sr(P, re, _.checkoutWorkflowStep);
        return (
            (b = Xr({
                ...he,
                extraOptions: $,
                ...
                checkoutMarketSegment: w,
                country: T,
                quantity: _t(G, _.quantity),
                checkoutWorkflowStep: pe,
                language: O,
                entitlement: S(B),
                upgrade: S(V),
                modal: Y,
                perpetual: S(J),
                promotionCode: Qr(j).effectivePromoCode,
                wcsOsi: Jr(ee),
                preselectPlan: f,
            })),
            b
    ...
    function i(o, a) {
        if (!Array.isArray(o) || !o.length || !a) return '';
        let { env: s, landscape: c } = e,
            {
                checkoutClientId: l,
                checkoutMarketSegment: d,
                checkoutWorkflowStep: p,
                country: m,
                promotionCode: f,
                quantity: x,
                preselectPlan: b,
            ...
            O =
                Object.values(et).includes(a.modal) &&
                (!T || T.content !== 'off'),
            G = window.frameElement || O ? 'if' : 'fp',
            [
                {
                    productArrangementCode: B,
                    marketSegments: [V],
                    customerSegment: Y,
                    offerType: J,
                },
        ...
        if (o.length === 1) {
            let { offerId: pe } = o[0];
            $.items.push({ id: pe, quantity: he });
        } else
            $.items.push(
                ...o.map(({ offerId: pe, productArrangementCode: De }) => ({
                    id: pe,
                    quantity: he,
                    ...(O ? { productArrangementCode: De } : {}),
                })),
            );
        return da($);
    }
    let { createCheckoutLink: n } = Oe;
    return {
        CheckoutLink: Oe,
        CheckoutWorkflowStep: re,
        buildCheckoutURL: i,
...
function ql({ interval: e = 200, maxAttempts: t = 25 } = {}) {
    let r = le.module('ims');
...
var ma = window.masPriceLiterals;
function ua(e) {
    if (Array.isArray(ma)) {
        let t = (i) => ma.find((n) => mn(n.lang, i)),
...
function wa(e) {
    ...
    for (
        var t = e.split(ba).filter(function (m) {
                return m.length > 0;
            }),
            r = [],
            i = 0,
        ...
        for (var s = a[0], c = a.slice(1), l = 0, d = c; l < d.length; l++) {
            var p = d[l];
...
function Ta(e) {
    for (var t = {}, r = 0, i = e; r < i.length; r++) {
        ...
        switch (n.stem) {
            ...
            case 'measure-unit':
            case 'unit':
                (t.style = 'unit'), (t.unit = Kl(n.options[0]));
                continue;
            case 'compact-short':
            case 'K':
            ...
            case 'integer-width':
                ...
                n.options[0].replace(Ql, function (c, l, d, p, m, f) {
        ...
        if (va.test(n.stem)) {
            ...
            n.stem.replace(va, function (c, l, d, p, m, f) {
                return (
                    d === '*'
                        ? (t.minimumFractionDigits = l.length)
                        : p && p[0] === '#'
                          ? (t.maximumFractionDigits = p.length)
                          : m && f
                            ? ((t.minimumFractionDigits = m.length),
                              (t.maximumFractionDigits = m.length + f.length))
                            : ((t.minimumFractionDigits = l.length),
            ...
            var o = n.options[0];
            o === 'w'
                ? (t = C(C({}, t), { trailingZeroDisplay: 'stripIfInteger' }))
                : o && (t = C(C({}, t), ya(o)));
            continue;
        }
        if (Aa.test(n.stem)) {
...
var Nn,
    ed = new RegExp('^'.concat(On.source, '*')),
    td = new RegExp(''.concat(On.source, '*$'));
function k(e, t) {
    return { start: e, end: t };
}
var rd = !!String.prototype.startsWith,
    id = !!String.fromCodePoint,
    nd = !!Object.fromEntries,
    od = !!String.prototype.codePointAt,
    ad = !!String.prototype.trimStart,
    sd = !!String.prototype.trimEnd,
    cd = !!Number.isSafeInteger,
    ld = cd
    ...
    In = !0;
try {
    (ka = Oa('([^\\p{White_Space}\\p{Pattern_Syntax}]*)', 'yu')),
        (In =
            ((Nn = ka.exec('a')) === null || Nn === void 0 ? void 0 : Nn[0]) ===
            'a');
} catch {
    In = !1;
}
...
var Hn;
In
    ? ((Mn = Oa('([^\\p{White_Space}\\p{Pattern_Syntax}]*)', 'yu')),
      (Hn = function (t, r) {
          var i;
          Mn.lastIndex = r;
          var n = Mn.exec(t);
    ...
    Na = (function () {
        ...
        return (
            ...
            (e.prototype.parseTagName = function () {
                var t = this.offset();
                for (this.bump(); !this.isEOF() && md(this.char()); )
                    this.bump();
            ...
            (e.prototype.parseLiteral = function (t, r) {
                ...
                return {
                    val: { type: D.literal, value: n, location: c },
                    err: null,
                };
            }),
            ...
            (e.prototype.parseArgument = function (t, r) {
                ...
                if (this.char() === 125)
                    return (
                        this.bump(),
                        this.error(A.EMPTY_ARGUMENT, k(i, this.clonePosition()))
                    );
            ...
            (e.prototype.parseArgumentOptions = function (t, r, i, n) {
                ...
                switch (s) {
                    case '':
                        return this.error(A.EXPECT_ARGUMENT_TYPE, k(a, c));
                    case 'number':
                    case 'date':
                    case 'time': {
                        this.bumpSpace();
                        ...
                        if (this.bumpIf(',')) {
                            ...
                            var f = k(d, this.clonePosition());
                            l = { style: m, styleLocation: f };
                        }
                        var x = this.tryParseArgumentClose(n);
                        if (x.err) return x;
                        var b = k(n, this.clonePosition());
                        if (l && Pa(l?.style, '::', 0)) {
                            var w = dd(l.style.slice(2));
                            if (s === 'number') {
                                ...
                                var P = w;
                                this.locale && (P = Ca(w, this.locale));
                                var m = {
                                        type: it.dateTime,
                                        pattern: P,
                    ...
                    case 'select': {
                        ...
                        var B = this.tryParsePluralOrSelectOptions(t, s, r, O);
                        if (B.err) return B;
                        var x = this.tryParseArgumentClose(n);
                        if (x.err) return x;
                        var V = k(n, this.clonePosition());
                        return s === 'select'
                            ? {
                                  val: {
                                      type: D.select,
                    ...
                    default:
                        return this.error(A.INVALID_ARGUMENT_TYPE, k(a, c));
                }
            }),
            ...
            (e.prototype.parseNumberSkeletonFromString = function (t, r) {
                ...
                return {
                    val: {
                        ...
                        tokens: i,
                        location: r,
                        parsedOptions: this.shouldParseSkeletons ? Ta(i) : {},
                    },
                    err: null,
                };
            }),
            (e.prototype.tryParsePluralOrSelectOptions = function (t, r, i, n) {
                for (
                    ...
                    var x = this.parseMessage(t + 1, r, i);
                    if (x.err) return x;
                    var b = this.tryParseArgumentClose(f);
                    if (b.err) return b;
                    s.push([
                        l,
                        { value: x.val, location: k(f, this.clonePosition()) },
                    ]),
                        c.add(l),
                        this.bumpSpace(),
                        (o = this.parseIdentifierIfPossible()),
            ...
            (e.prototype.tryParseDecimalInteger = function (t, r) {
                ...
                return o
                    ? ((a *= i),
                      ld(a) ? { val: a, err: null } : this.error(r, c))
                    : this.error(t, c);
            }),
            ...
            (e.prototype.bumpSpace = function () {
                for (; !this.isEOF() && Ma(this.char()); ) this.bump();
            }),
...
function Un(e) {
    e.forEach(function (t) {
        if ((delete t.location, li(t) || di(t)))
            for (var r in t.options)
                delete t.options[r].location, Un(t.options[r].value);
        else
            (ai(t) && pi(t.style)) || ((si(t) || ci(t)) && mr(t.style))
...
function Ia(e, t) {
    t === void 0 && (t = {}),
        (t = C({ shouldParseSkeletons: !0, requiresOtherClause: !0 }, t));
...
function fr(e, t) {
    var r = t && t.cache ? t.cache : yd,
        i = t && t.serializer ? t.serializer : vd,
        n = t && t.strategy ? t.strategy : gd;
...
function gd(e, t) {
    var r = e.length === 1 ? $a : Ha;
    return Bn(e, this, r, t.cache.create(), t.serializer);
}
function xd(e, t) {
    return Bn(e, this, Ha, t.cache.create(), t.serializer);
}
function bd(e, t) {
    return Bn(e, this, $a, t.cache.create(), t.serializer);
}
var vd = function () {
    ...
    for (var s = [], c = 0, l = e; c < l.length; c++) {
        ...
        if (hi(d)) {
            var x = d.children,
                b = d.value,
                w = n[b];
            if (!wd(w)) throw new Da(b, 'function', a);
            var P = xr(x, t, r, i, n, o),
                M = w(
                    P.map(function (G) {
                        return G.value;
                    }),
        ...
        if (li(d)) {
            var T = d.options[m] || d.options.other;
            if (!T) throw new Fn(d.value, m, Object.keys(d.options), a);
            s.push.apply(s, xr(T.value, t, r, i, n));
            continue;
        }
        if (di(d)) {
            var T = d.options['='.concat(m)];
            if (!T) {
                if (!Intl.PluralRules)
                    throw new gr(
...
`,
                ...
                var O = r
                    ...
                    .select(m - (d.offset || 0));
                T = d.options[O] || d.options.other;
            }
            if (!T) throw new Fn(d.value, m, Object.keys(d.options), a);
            s.push.apply(s, xr(T.value, t, r, i, n, m - (d.offset || 0)));
            continue;
        }
    }
    return Ed(s);
    ...
    return (
        e === void 0 && (e = { number: {}, dateTime: {}, pluralRules: {} }),
        {
            getNumberFormat: fr(
                ...
                { cache: Gn(e.number), strategy: mi.variadic },
            ),
            getDateTimeFormat: fr(
                ...
                { cache: Gn(e.dateTime), strategy: mi.variadic },
            ),
            getPluralRules: fr(
                function () {
                    for (var t, r = [], i = 0; i < arguments.length; i++)
                ...
                { cache: Gn(e.pluralRules), strategy: mi.variadic },
            ),
        }
    );
}
var Ba = (function () {
    function e(t, r, i, n) {
        ...
        (this.formats = Sd(e.formats, i)),
            (this.formatters = (n && n.formatters) || _d(this.formatterCache));
    }
    return (
...
function Pd(e, t, r) {
    ...
    let o = t.fraction && t.fraction.lastIndexOf('0'),
        [a = '0', s = ''] = n.value.split('.');
    return (
        (!s || (s && s.length <= o)) &&
            (s = o < 0 ? '' : (+('0.' + s)).toFixed(o + 1).replace('0.', '')),
        (n.integer = a),
        (n.fraction = s),
        Ld(n, t),
...
function Ld(e, t) {
    ...
    let o = r[1] && r[r.length - 1].length;
    if (o) {
        let a = e.integer.length,
            s = a % o;
        for (let c = 0; c < a; c++)
            (e.result += e.integer.charAt(c)),
                !((c - s + 1) % o) && c < a - o && (e.result += t.separator);
...
var Va = '.',
    ...
    Ya = (e, t) => {
        let {
            ...
            displaySummary: {
                amount: n,
                duration: o,
                minProductQuantity: a,
                outcomeType: s,
            } = {},
        } = e;
        if (!(n && o && s && a)) return !1;
        let c = t ? new Date(t) : new Date();
        if (!r || !i) return !1;
        let l = new Date(r),
            d = new Date(i);
        return c >= l && c <= d;
    },
    ot = { MONTH: 'MONTH', YEAR: 'YEAR' },
    Nd = {
        [me.ANNUAL]: 12,
        [me.MONTHLY]: 1,
        [me.THREE_YEARS]: 36,
    ...
    qn = {
        [Qe.YEAR]: { [me.MONTHLY]: ot.MONTH, [me.ANNUAL]: ot.YEAR },
        [Qe.MONTH]: { [me.MONTHLY]: ot.MONTH },
    },
    Id = (e, t) => e.indexOf(`'${t}'`) === 0,
    $d = (e, t = !0) => {
    ...
    Hd = (e) => {
        let t = Ud(e),
            r = Id(e, t),
            i = e.replace(/'.*?'/, ''),
            n = qa.test(i) || Wa.test(i);
        return { currencySymbol: t, isCurrencyFirst: r, hasCurrencySpace: n };
    },
    Xa = (e) => e.replace(qa, ja).replace(Wa, ja),
    Dd = (e) => (e.match(/#(.?)#/)?.[1] === Va ? Od : Va),
    Ud = (e) => e.match(/'(.*?)'/)?.[1] ?? '',
    Ka = (e) => e.match(/0(.?)0/)?.[1] ?? '';
function Tt(
    ...
    let { currencySymbol: a, isCurrencyFirst: s, hasCurrencySpace: c } = Hd(e),
        l = r ? Ka(e) : '',
        d = $d(e, r),
        p = r ? 2 : 0,
        m = o(t, { currencySymbol: a }),
        f = i
            ? m.toLocaleString('hi-IN', {
                  minimumFractionDigits: p,
                  maximumFractionDigits: p,
              })
            : Ga(d, m),
        x = r ? f.lastIndexOf(l) : f.length,
        b = f.substring(0, x),
        w = f.substring(x + 1);
    return {
        accessiblePrice: e
...
var Qa = (e) => {
        let { commitment: t, term: r, usePrecision: i } = e,
            n = Nd[r] ?? 1;
        return Tt(e, n > 1 ? ot.MONTH : qn[t]?.[r], (o) => {
            let a = { divisor: n, price: o, usePrecision: i },
                { round: s } = Md.find(({ accept: c }) => c(a));
            if (!s)
                throw new Error(
                    `Missing rounding rule for: ${JSON.stringify(a)}`,
                );
            return s(a);
        });
    },
    Za = ({ commitment: e, term: t, ...r }) => Tt(r, qn[e]?.[t]),
    Ja = (e) => {
        let {
            commitment: t,
            instant: r,
            price: i,
            originalPrice: n,
            priceWithoutDiscount: o,
            promotion: a,
            quantity: s = 1,
            term: c,
        } = e;
        if (t === Qe.YEAR && c === me.MONTHLY) {
            if (!a) return Tt(e, ot.YEAR, Vn);
            let {
                displaySummary: {
                    outcomeType: l,
                    duration: d,
                    minProductQuantity: p = 1,
                } = {},
            } = a;
            switch (l) {
                case 'PERCENTAGE_DISCOUNT':
                    if (s >= p && Ya(a, r)) {
                        ...
                        if (isNaN(m)) return Vn(i);
                        let f = s * n * m,
                            x = s * o * (12 - m),
                            b = Math.round((f + x) * 100) / 100;
                        return Tt({ ...e, price: b }, ot.YEAR);
                    }
                default:
                    return Tt(e, ot.YEAR, () => Vn(o ?? i));
            }
        }
        return Tt(e, qn[t]?.[c]);
    };
var Wn = {
    ...
    Bd = Yo('ConsonantTemplates/price'),
    zd = /<\/?[^>]+(>|$)/g,
    q = {
        container: 'price',
    ...
    Fd = (e) =>
        jo(e)
            ...
            : '',
    X = (e, t, r, i = !1) =>
        `<span class="${e}${t ? '' : ' ' + q.disabled}"${Fd(r)}>${i ? Xa(t) : (t ?? '')}</span>`;
function Ne(e, t, r, i) {
    let n = e[r];
    if (n == null) return '';
    try {
        return new za(n.replace(zd, ''), t).format(i);
    } catch {
        return Bd.error('Failed to format literal:', n), '';
    }
}
function Gd(
    e,
    {
        ...
        recurrenceLabel: l,
        perUnitLabel: d,
        taxInclusivityLabel: p,
    },
    m = {},
) {
    let f = X(q.currencySymbol, i),
        x = X(q.currencySpace, a ? '&nbsp;' : ''),
        b = '';
    return (
        t
            ? (b = `<sr-only class="strikethrough-aria-label">${t}</sr-only>`)
            : r && (b = `<sr-only class="alt-aria-label">${r}</sr-only>`),
        c && (b += f + x),
        (b += X(q.integer, s)),
        (b += X(q.decimalsDelimiter, o)),
        (b += X(q.decimals, n)),
        c || (b += x + f),
        (b += X(q.recurrence, l, null, !0)),
        (b += X(q.unitType, d, null, !0)),
        (b += X(q.taxInclusivity, p, !0)),
        X(e, b, { ...m })
    );
}
var ne =
        ...
        (
            ...
            Object.entries({
                ...
                if (Wc == null)
                    throw new Error(
                        `Argument "${qc}" is missing for osi ${b?.toString()}, country ${o}, language ${d}`,
                    );
            });
            let J = { ...Wn, ...p },
                j = `${d.toLowerCase()}-${o.toUpperCase()}`,
                ee = r && M ? M : P,
                $ = t ? Qa : Za;
            i && ($ = Ja);
            let {
            ...
            S(s) &&
                pe &&
                (Fi = Ne(J, j, Ge.recurrenceLabel, { recurrenceTerm: pe }));
            let Fr = '';
            S(c) &&
                (f && (Fr += ' '),
                (Fr += Ne(J, j, Ge.perUnitLabel, { perUnit: 'LICENSE' })));
            let Gr = '';
            S(l) &&
                O &&
                (f && (Gr += ' '),
                (Gr += Ne(
                    J,
                    j,
                    T === Yn ? Ge.taxExclusiveLabel : Ge.taxInclusiveLabel,
                    { taxTerm: O },
                ))),
                r &&
                    (Bi = Ne(J, j, Ge.strikethroughAriaLabel, {
                        strikethroughPrice: Bi,
                    })),
                e &&
                    (zi = Ne(J, j, Ge.alternativePriceAriaLabel, {
                        alternativePrice: zi,
                    }));
            let vt = q.container;
            if (
                (t && (vt += ' ' + q.containerOptical),
                r && (vt += ' ' + q.containerStrikethrough),
                e && (vt += ' ' + q.containerAlternative),
                i && (vt += ' ' + q.containerAnnual),
                S(a))
            )
                return Gd(
                    vt,
                    {
                        ...De,
                        accessibleLabel: Bi,
                        altAccessibleLabel: zi,
                        recurrenceLabel: Fi,
                        perUnitLabel: Fr,
                        taxInclusivityLabel: Gr,
                    },
                    Y,
                );
            let {
                ...
                yt = [Gc, Fc, zc];
            Vc
                ? (yt.unshift(Mo ? '\xA0' : ''), yt.unshift(No))
                : (yt.push(Mo ? '\xA0' : ''), yt.push(No)),
                yt.push(Fi, Fr, Gr);
            let jc = yt.join('');
            return X(vt, jc, Y);
        },
    es = () => (e, t, r) => {
        ...
        return `${n ? ne({ displayStrikethrough: !0 })(e, t, r) + '&nbsp;' : ''}${ne({ isAlternativePrice: n })(e, t, r)}`;
    },
    ts = () => (e, t, r) => {
        let { instant: i } = e;
        try {
        ...
        let n = { ...e, displayTax: !1, displayPerUnit: !1 },
            a =
                ...
                t.priceWithoutDiscount &&
                t.priceWithoutDiscount != t.price;
        return `${a ? ne({ displayStrikethrough: !0 })(n, t, r) + '&nbsp;' : ''}${ne({ isAlternativePrice: a })(e, t, r)}${X(q.containerAnnualPrefix, '&nbsp;(')}${ne({ displayAnnual: !0, instant: i })(n, t, r)}${X(q.containerAnnualSuffix, ')')}`;
    },
    rs = () => (e, t, r) => {
        let i = { ...e, displayTax: !1, displayPerUnit: !1 };
        return `${ne({ isAlternativePrice: e.displayOldPrice })(e, t, r)}${X(q.containerAnnualPrefix, '&nbsp;(')}${ne({ displayAnnual: !0 })(i, t, r)}${X(q.containerAnnualSuffix, ')')}`;
    };
var br = { ...q, containerLegal: 'price-legal', planType: 'price-plan-type' },
    ui = { ...Ge, planTypeLabel: 'planTypeLabel' };
function Vd(
    e,
    ...
    let o = '';
    return (
        (o += X(br.unitType, t, null, !0)),
        r && i && (r += '. '),
        (o += X(br.taxInclusivity, r, !0)),
        (o += X(br.planType, i, null)),
        X(e, o, { ...n })
    );
}
var is = (
    ...
    { taxDisplay: a, taxTerm: s, planType: c } = {},
    l = {},
) => {
    let d = { ...Wn, ...o },
        p = `${n.toLowerCase()}-${e.toUpperCase()}`,
        m = '';
    S(t) && (m = Ne(d, p, ui.perUnitLabel, { perUnit: 'LICENSE' }));
    let f = '';
    e === 'US' && n === 'en' && (r = !1),
        S(r) &&
            s &&
            (f = Ne(
                d,
                p,
                a === Yn ? ui.taxExclusiveLabel : ui.taxInclusiveLabel,
                { taxTerm: s },
            ));
    let x = '';
    S(i) && c && (x = Ne(d, p, ui.planTypeLabel, { planType: c }));
    let b = br.container;
    return (
        (b += ' ' + br.containerLegal),
        Vd(b, { perUnitLabel: m, taxInclusivityLabel: f, planTypeLabel: x }, l)
    );
};
var ns = ne(),
    os = es(),
    as = ne({ displayOptical: !0 }),
    ss = ne({ displayStrikethrough: !0 }),
    cs = ne({ displayAnnual: !0 }),
    ls = ne({ displayOptical: !0, isAlternativePrice: !0 }),
    ds = ne({ isAlternativePrice: !0 }),
    hs = rs(),
    ps = ts(),
    ms = is;
var jd = (e, t) => {
        if (!(!ar(e) || !ar(t))) return Math.floor(((t - e) / t) * 100);
    },
    us = () => (e, t) => {
...
var xs = 'INDIVIDUAL_COM',
    ...
    qd = {
        ...
        [Xn]: ['MU_en', 'LT_lt', 'LV_lv', 'NG_en', 'CO_es', 'KR_ko'],
    ...
    Qd = (e, t, r, i) => {
        let n = `${e}_${t}`;
        if (gs.includes(e) || gs.includes(n)) return !0;
        let o = qd[`${r}_${i}`];
        return o
    ...
    vs = async (e, t, r, i) => {
        ...
        return {
            displayTax: n,
            forceTaxExclusive: n ? Kd(e, t, r, i) : _.forceTaxExclusive,
        };
    },
    vr = class vr extends HTMLSpanElement {
        constructor() {
            super();
            u(this, 'masElement', new Fe(this));
        ...
        get isFailed() {
            return this.masElement.state === xe;
        }
        requestUpdate(r = !1) {
        ...
        async render(r = {}) {
            ...
            if (!o.wcsOsi.length) return !1;
            try {
                let a = this.masElement.togglePending({});
                this.innerHTML = '';
                let [s] = await i.resolveOfferSelectors(o),
                    c = lr(await s, o),
                    [l] = c;
                if (i.featureFlags[ze]) {
                    if (
                        ...
                        let { country: d, language: p } = o,
                            [m = ''] = l.marketSegments,
                            f = await vs(d, p, l.customerSegment, m);
                        n.displayTax === void 0 &&
                            (o.displayTax = f?.displayTax || o.displayTax),
                            n.forceTaxExclusive === void 0 &&
                                (o.forceTaxExclusive =
                                    f?.forceTaxExclusive ||
                                    o.forceTaxExclusive),
                            o.forceTaxExclusive && (c = lr(c, o));
                    }
                } else n.displayOldPrice === void 0 && (o.displayOldPrice = !0);
                return this.renderOffers(c, o, a);
            } catch (a) {
                throw ((this.innerHTML = ''), a);
            }
        }
        renderOffers(r, i, n = void 0) {
            ...
            if ((n ?? (n = this.masElement.togglePending()), r.length)) {
                if (this.masElement.toggleResolved(n, r, i)) {
                    this.innerHTML = o.buildPriceHTML(r, this.options);
                    let a = this.closest('p, h3, div');
                    if (
                        !a ||
                        !a.querySelector(
                            'span[data-template="strikethrough"]',
                        ) ||
                        a.querySelector('.alt-aria-label')
                    )
                        return !0;
                    let s = a?.querySelectorAll('span[is="inline-price"]');
                    return (
                        s.length > 1 &&
                            s.length ===
                                a.querySelectorAll(
                ...
                if (this.masElement.toggleFailed(n, a, this.options))
                    return (this.innerHTML = ''), !0;
            }
            return !1;
        }
    };
u(vr, 'is', 'inline-price'), u(vr, 'tag', 'span');
var Me = vr;
...
function ys({ literals: e, providers: t, settings: r }) {
    function i(a, s = null) {
        ...
        if (s && t?.price) for (let B of t.price) B(s, c);
        let {
            displayOldPrice: l,
            displayPerUnit: d,
            displayRecurrence: p,
        ...
        return (
            (c = Xr(
                Object.assign({
                    ...
                    displayOldPrice: S(l),
                    displayPerUnit: S(d),
                    displayRecurrence: S(p),
                    displayTax: S(m),
                    displayPlanType: S(f),
                    forceTaxExclusive: S(x),
                    perpetual: S(b),
                    displayAnnual: S(w),
                    promotionCode: Qr(P).effectivePromoCode,
                    quantity: _t(M, _.quantity),
                    alternativePrice: S(T),
                    wcsOsi: Jr(O),
                }),
            )),
            c
    ...
    function n(a, s) {
        if (!Array.isArray(a) || !a.length || !s) return '';
        let { template: c } = s,
            l;
        switch (c) {
            case 'discount':
            ...
            default:
                s.template === 'optical' && s.alternativePrice
                    ...
                    : s.template === 'optical'
                      ? (l = as)
                      : s.displayAnnual && a[0].planType === 'ABM'
                        ? (l = s.promotionCode ? ps : hs)
                        : s.alternativePrice
                          ? (l = ds)
                          : (l = s.promotionCode ? os : ns);
        }
        let [d] = a;
        return (d = { ...d, ...d.priceDetails }), l({ ...r, ...s }, d);
    }
    let o = Me.createInlinePrice;
    return {
        InlinePrice: Me,
        buildPriceHTML: n,
...
function Es(e = {}, t) {
    let r = t.featureFlags[ze],
        { commerce: i = {} } = e,
        n = Ae.PRODUCTION,
        o = an,
        a = H('checkoutClientId', i) ?? _.checkoutClientId,
        s = sr(H('checkoutWorkflowStep', i), re, _.checkoutWorkflowStep),
        c = _.displayOldPrice,
        l = _.displayPerUnit,
        d = S(H('displayRecurrence', i), _.displayRecurrence),
        p = S(H('displayTax', i), _.displayTax),
        m = S(H('displayPlanType', i), _.displayPlanType),
        f = S(H('entitlement', i), _.entitlement),
        x = S(H('modal', i), _.modal),
        b = S(H('forceTaxExclusive', i), _.forceTaxExclusive),
        w = H('promotionCode', i) ?? _.promotionCode,
        P = _t(H('quantity', i)),
        M = H('wcsApiKey', i) ?? _.wcsApiKey,
        T = i?.env === 'stage',
        O = Be.PUBLISHED;
    ['true', ''].includes(i.allowOverride) &&
        ((T =
            (H(nn, i, { metadata: !1 })?.toLowerCase() ?? i?.env) === 'stage'),
        (O = sr(H(on, i), Be, O))),
        T && ((n = Ae.STAGE), (o = sn));
    let B = H(rn) ?? e.preview,
        V = typeof B < 'u' && B !== 'off' && B !== 'false',
        Y = {};
    V && (Y = { preview: V });
    let J =
            H('mas-io-url') ??
            e.masIOUrl ??
            `https://www${n === Ae.STAGE ? '.stage' : ''}.adobe.com/mas/io`,
        j = H('preselect-plan') ?? void 0;
    return {
        ...Zd(e),
        ...Y,
        displayOldPrice: c,
...
async function fi(e, t = {}, r = 2, i = 100) {
    let n;
    for (let o = 0; o <= r; o++)
        try {
            let a = await fetch(e, t);
            return (a.retryCount = o), a;
        } catch (a) {
            if (((n = a), (n.retryCount = o), o > r)) break;
            await new Promise((s) => setTimeout(s, i * (o + 1)));
        }
    throw n;
}
var Jd = 'mas-commerce-service';
function yr(e, t) {
    let r;
    return function () {
        let i = this,
...
function at() {
    return document.getElementsByTagName(Jd)?.[0];
}
function Er(e) {
...
function As({ settings: e }) {
    let t = le.module(Qn),
        ...
        a,
        s = new Map();
    async function c(x, b, w = !0) {
        let P = ie(),
            M = Ji;
        t.debug('Fetching:', x);
        let T = '',
            O;
        if (x.offerSelectorIds.length > 1)
            throw new Error('Multiple OSIs are not supported anymore');
        let G = new Map(b),
            [B] = x.offerSelectorIds,
            V = Date.now() + Math.random().toString(36).substring(2, 7),
            Y = `${Qn}:${B}:${V}${tt}`,
            J = `${Qn}:${B}:${V}${rt}`,
            j;
        try {
            if (
                (performance.mark(Y),
                (T = new URL(e.wcsURL)),
                T.searchParams.set('offer_selector_ids', B),
                T.searchParams.set('country', x.country),
                T.searchParams.set('locale', x.locale),
                T.searchParams.set(
                    'landscape',
                    r === Ae.STAGE ? 'ALL' : e.landscape,
                ),
                T.searchParams.set('api_key', i),
                x.language && T.searchParams.set('language', x.language),
                x.promotionCode &&
                    T.searchParams.set('promotion_code', x.promotionCode),
                x.currency && T.searchParams.set('currency', x.currency),
                (O = await fi(T.toString(), { credentials: 'omit' })),
                O.ok)
            ) {
                let ee = [];
                try {
                    let $ = await O.json();
                    t.debug('Fetched:', x, $), (ee = $.resolvedOffers ?? []);
                } catch ($) {
                    t.error(`Error parsing JSON: ${$.message}`, {
                        ...$.context,
                        ...P?.duration,
                    });
                }
                (ee = ee.map(cr)),
                    b.forEach(({ resolve: $ }, he) => {
                        let pe = ee
                            .filter(({ offerSelectorIds: De }) =>
                                De.includes(he),
                            )
                            .flat();
                        pe.length && (G.delete(he), b.delete(he), $(pe));
                    });
            } else M = Zi;
        } catch (ee) {
            M = `Network error: ${ee.message}`;
        } finally {
            (j = performance.measure(J, Y)),
                performance.clearMarks(Y),
                performance.clearMeasures(J);
        }
        if (w && b.size) {
    ...
    function l() {
        clearTimeout(a);
        let x = [...o.values()];
        o.clear(), x.forEach(({ options: b, promises: w }) => c(b, w));
    }
    function d(x) {
        if (!x || typeof x != 'object')
            throw new TypeError('Cache must be a Map or similar object');
        let b = r === Ae.STAGE ? 'stage' : 'prod',
            w = x[b];
        if (!w || typeof w != 'object') {
            t.warn(`No cache found for environment: ${r}`);
            return;
        }
        for (let [P, M] of Object.entries(w))
            n.set(P, Promise.resolve(M.map(cr)));
        t.debug(`Prefilled WCS cache with ${w.size} entries`);
    }
    function p() {
        let x = n.size;
        (s = new Map(n)),
            n.clear(),
            t.debug(`Moved ${x} cache entries to stale cache`);
    }
    function m(x, b, w) {
        if (x && !hn.includes(x))
            return (
                console.error(`Country ${x} is not supported`),
                { language: b, locale: '', isValid: !1 }
            );
        if (b && !dn.includes(b))
            return (
                console.error(`Language ${b} is not supported`),
                { language: b, locale: '', isValid: !1 }
            );
        let P = '';
        return (
    ...
    function f({
        ...
        let { isValid: T, language: O, locale: G } = m(x, b, w);
        if (!T) throw new Error('Invalid language or country');
        let B = [x, O, P]
            .filter((V) => V)
            .join('-')
            .toLowerCase();
        return M.map((V) => {
            ...
            let J = new Promise((j, ee) => {
                let $ = o.get(B);
                if (!$) {
                    let he = { country: x, locale: G, offerSelectorIds: [] };
                    x !== 'GB' && !w && (he.language = O),
                        ($ = { options: he, promises: new Map() }),
                        o.set(B, $);
                }
                P && ($.options.promotionCode = P),
                    $.options.offerSelectorIds.push(V),
                    $.promises.set(V, { resolve: j, reject: ee }),
                    l();
            }).catch((j) => {
    ...
    return {
        ...
        Term: me,
        applyPlanType: cr,
        resolveOfferSelectors: f,
        flushWcsCacheInternal: p,
        prefillWcsCache: d,
        resolveLanguageAndLocale: m,
    };
}
var Ss = 'mas-commerce-service',
    _s = 'mas-commerce-service:start',
    Ts = 'mas-commerce-service:ready',
    wr,
    Ct,
    kt,
    Cs,
    ...
    Zn = class extends HTMLElement {
        ...
        async registerCheckoutAction(r) {
            typeof r == 'function' &&
                (this.buildCheckoutAction = async (i, n, o) => {
                    let a = await r?.(i, n, this.imsSignedInPromise, o);
                    return a || null;
                });
        }
        get featureFlags() {
            return (
                h(this, Ct) ||
                    v(this, Ct, { [ze]: Z(this, kt, ks).call(this, ze) }),
                h(this, Ct)
            );
        }
        activate() {
            let r = h(this, kt, Cs),
                i = Es(r, this);
            Vr(r.lana);
            let n = le.init(r.hostEnv).module('service');
            n.debug('Activating:', r);
            let a = { price: ua(i) },
                s = { checkout: new Set(), price: new Set() },
                c = { literals: a, providers: s, settings: i };
            Object.defineProperties(
                ...
                n.debug('Activated:', { literals: a, settings: i });
            let l = new CustomEvent(jr, {
                bubbles: !0,
                cancelable: !1,
                detail: this,
            });
            performance.mark(Ts),
                v(this, wr, performance.measure(Ts, _s)),
        ...
        connectedCallback() {
            performance.mark(_s), this.activate();
        }
        flushWcsCache() {
        ...
        get duration() {
            return { 'mas-commerce-service:measure': Se(h(this, wr)) };
        }
        logFailedRequests() {
            let r = [...performance.getEntriesByType('resource')]
                    .filter(({ startTime: n }) => n > this.lastLoggingTime)
                    .filter(
                        ({ transferSize: n, duration: o, responseStatus: a }) =>
                            (n === 0 && o === 0 && a < 200) || a >= 400,
                    ),
...
(wr = new WeakMap()),
    ...
    (Cs = function () {
        ...
        return (
            ...
            [
                ...
                let o = this.getAttribute(n);
                if (o != null) {
                    let a = n.replace(/-([a-z])/g, (s) => s[1].toUpperCase());
                    i.commerce[a] = o;
                }
            }),
            i
    ...
    (ks = function (r) {
        return ['on', 'true', !0].includes(
            this.getAttribute(`data-${r}`) || H(r),
        );
    });
window.customElements.get(Ss) || window.customElements.define(Ss, Zn);
var Ar = class Ar extends ni(HTMLButtonElement) {
...
u(Ar, 'is', 'checkout-button'), u(Ar, 'tag', 'button');
var Pt = Ar;
...
var ct,
    st = class st extends HTMLAnchorElement {
        constructor() {
            super();
            u(this, 'masElement', new Fe(this));
            E(this, ct);
            this.setAttribute('is', st.is);
        }
        get isUptLink() {
            return !0;
        }
        ...
        connectedCallback() {
            this.masElement.connectedCallback(),
                v(this, ct, at()),
                h(this, ct) && (this.log = h(this, ct).log.module('upt-link'));
        }
        disconnectedCallback() {
            this.masElement.disconnectedCallback(), v(this, ct, void 0);
        }
        requestUpdate(r = !1) {
        ...
        async render() {
            ...
            if (!r) return !1;
            this.dataset.imsCountry ||
                r.imsCountryPromise.then((a) => {
                    a && (this.dataset.imsCountry = a);
                });
            ...
            let n = this.masElement.togglePending(i),
                o = r.resolveOfferSelectors(i);
            try {
                let [[a]] = await Promise.all(o),
...
R();
R();
var de = '(max-width: 767px)',
    be = '(max-width: 1199px)',
    F = '(min-width: 768px)',
    U = '(min-width: 1200px)',
    _e = '(min-width: 1600px)';
function Ai() {
    return window.matchMedia(de);
}
function Si() {
    return window.matchMedia(U);
}
function _i() {
    return Ai().matches;
}
    ...
    handleTooltips() {
        ...
        this.querySelectorAll('sp-tooltip, overlay-trigger').forEach((r) => {
            ...
            if (r.tagName === 'SP-TOOLTIP')
                ...
                let o = r.querySelector('sp-tooltip');
                o &&
                    ((i = o.textContent),
                    (n =
            ...
            if (i) {
                ...
                o.setAttribute('content', i), o.setAttribute('placement', n);
                let a = this.querySelector('img'),
                    s = this.querySelector('a');
                s && s.contains(a) ? o.appendChild(s) : a && o.appendChild(a),
                    (this.innerHTML = ''),
                    this.appendChild(o),
                    Promise.resolve().then(() => Ci());
            }
            r.remove();
        });
    }
...
customElements.define('merch-icon', Nt);
var Lr,
    ut,
    Rr,
    Or,
    Mt,
    ki = class extends HTMLElement {
        constructor() {
            super();
            E(this, Lr, '');
            E(this, ut);
        ...
        get value() {
            let r = h(this, Rr)
                ...
                .join(', ');
            return `linear-gradient(${h(this, Lr)}, ${r})`;
        }
        connectedCallback() {
            h(this, Mt).call(this);
        }
        attributeChangedCallback(r, i, n) {
            r === 'border-radius' && v(this, ut, n?.trim()),
                r === 'colors' && n
                    ? v(this, Rr, n?.split(',').map((o) => o.trim()) ?? [])
                    : r === 'positions' && n
                      ? v(this, Or, n?.split(',').map((o) => o.trim()) ?? [])
                      : r === 'angle' && v(this, Lr, n?.trim() ?? ''),
                h(this, Mt).call(this);
        }
    };
(Lr = new WeakMap()),
    ...
    (Or = new WeakMap()),
    (Mt = new WeakMap());
customElements.define('merch-gradient', ki);
R();
var It = class extends I {
    ...
    getOsi(t, r) {
        let o = (
            ...
            .map((s) => `p[data-plan-type="${t}"] ${z}[data-offer-type="${s}"]`)
            .join(', ');
        return this.querySelector(o)?.dataset?.wcsOsi;
    }
    connectedCallback() {
        super.connectedCallback(),
            this.addEventListener(At, this.updatePlanType);
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
            this.removeEventListener(At, this.updatePlanType);
    }
    updatePlanType(t) {
...
customElements.define('merch-addon', It);
R();
var $t,
    Nr = class Nr {
        constructor(t) {
        ...
        insertVariantStyle() {
            if (!Nr.styleMap[this.card.variant]) {
                Nr.styleMap[this.card.variant] = !0;
        ...
        updateCardElementMinHeight(t, r) {
            ...
            let i = `--consonant-merch-card-${this.card.variant}-${r}-height`,
                ...
                o =
                    ...
                    0;
            n > o && this.getContainer().style.setProperty(i, `${n}px`);
        }
        get badge() {
            let t;
            if (
        ...
        get secureLabel() {
            return this.card.secureLabel
                ? g`<span class="secure-transaction-label"
        ...
        get aemFragmentMapping() {
            return Pi(this.card.variant);
        }
    };
($t = new WeakMap()), u(Nr, 'styleMap', {});
var L = Nr;
R();
var Qs = `
:root {
    ...
    Ht = class extends L {
        constructor(r) {
            ...
            u(this, 'toggleActionMenu', (r) => {
                ...
                let i = this.actionMenuContentSlot.classList.contains('hidden');
                i || this.dispatchActionMenuToggle(),
                    this.setAriaExpanded(this.actionMenu, (!i).toString());
            });
            u(this, 'toggleActionMenuFromCard', (r) => {
                ...
                this.card.blur(),
                    ...
                    this.actionMenuContentSlot &&
                        (i || this.dispatchActionMenuToggle(),
                        this.actionMenuContentSlot.classList.toggle(
                            'hidden',
                            i,
                        ),
                        this.setAriaExpanded(this.actionMenu, 'false'));
            });
            u(this, 'hideActionMenu', (r) => {
...
var Ri = class extends L {
    ...
    renderLayout() {
        return g` ${this.badge}
            ...
            ${this.card.customHr ? '' : g`<hr />`} ${this.secureLabelFooter}`;
    }
};
R();
var tc = `
    ...
    Dt = class extends L {
        constructor(r) {
            ...
            u(this, 'getMiniCompareFooter', () => {
                let r = this.card.secureLabel
                    ? g`<slot name="secure-transaction-label">
                  <span class="secure-transaction-label"
                      >${this.card.secureLabel}</span
                  ></slot
              >`
                    : g`<slot name="secure-transaction-label"></slot>`;
                return g`<footer>${r}<slot name="footer"></slot></footer>`;
            });
        }
        getGlobalCSS() {
            return tc;
        ...
        get mainPrice() {
            return this.card.querySelector(
                `[slot="heading-m-price"] ${z}[data-template="price"]`,
            );
        }
        ...
        toggleAddon(r) {
            ...
            if (!i && n) {
                let o = r?.getAttribute('plan-type'),
                    a = null;
                if (
                    (r &&
                        o &&
                        (a = r
                            .querySelector(`p[data-plan-type="${o}"]`)
        ...
        renderLayout() {
            return g` <div class="top-section${this.badge ? ' badge' : ''}">
                <slot name="icons"></slot> ${this.badge}
            </div>
            <slot name="heading-m"></slot>
            ${
                this.card.classList.contains('bullet-list')
                    ? g`<slot name="heading-m-price"></slot>
                      <slot name="price-commitment"></slot>
                      <slot name="body-xxs"></slot>
                      <slot name="promo-text"></slot>
                      <slot name="body-m"></slot>
                      <slot name="offers"></slot>`
                    : g`<slot name="body-m"></slot>
...
var Oi = {
    ...
    ic = {
        ...(function () {
            let { whatsIncluded: e, size: t, ...r } = Oi;
            return r;
        })(),
    ...
    ae = class extends L {
        ...
        adjustSlotPlacement(t, r, i) {
            let n = this.card.shadowRoot,
                o = n.querySelector('footer'),
                a = this.card.getAttribute('size');
            if (!a) return;
            ...
            if (
                (a.includes('wide') ||
                    (o?.classList.remove('wide-footer'), s && s.remove()),
                !!r.includes(a))
            ) {
                if ((o?.classList.toggle('wide-footer', Ti()), !i && s)) {
                    if (c) s.remove();
                    else {
        ...
        adaptForMedia() {
            ...
            this.adjustSlotPlacement('addon', ['super-wide'], Ti()),
        ...
        async adjustEduLists() {
            ...
            o.classList.add('spacer'), r.insertBefore(o, n);
            let a = new IntersectionObserver(([s]) => {
                ...
                d && (c += Er(d));
                let p = this.card.querySelector('[slot="heading-m"]');
                p && (c += 8 + Er(p));
                for (let f of r.childNodes) {
                    if (f.classList.contains('spacer')) break;
                    c += Er(f);
                }
                let m = this.card.parentElement.style.getPropertyValue(
        ...
        get mainPrice() {
            return this.headingM.querySelector(`${z}[data-template="price"]`);
        }
        get divider() {
                ...
                try {
                    ...
                    let t = [],
                        r = this.card.querySelector(
                            `[slot="heading-m"] ${z}[data-template="price"]`,
                        );
                    r && t.push(r);
                    let i = t.map(async (n) => {
                        let o = n.cloneNode(!0);
                        await n.onceSettled(),
                            n?.options &&
                                ...
                                o.setAttribute('data-template', 'legal'),
        ...
        get icons() {
            return !this.card.querySelector('[slot="icons"]') &&
                ...
                ? N
                : g`<slot name="icons"></slot>`;
        }
        connectedCallbackHook() {
            let t = Ai();
            t?.addEventListener &&
                t.addEventListener('change', this.adaptForMedia);
            let r = Si();
            r?.addEventListener &&
                r.addEventListener('change', this.adaptForMedia);
        }
        disconnectedCallbackHook() {
            let t = Ai();
            t?.removeEventListener &&
                t.removeEventListener('change', this.adaptForMedia);
            let r = Si();
            r?.removeEventListener &&
                r.removeEventListener('change', this.adaptForMedia);
        }
        renderLayout() {
            return g` ${this.badge}
            <div class="body">
...
u(
    ...
    u(ae, 'collectionOptions', {
        customHeaderArea: (t) =>
            t.sidenav ? g`<slot name="resultsText"></slot>` : N,
        headerVisibility: {
            search: !1,
            sort: !1,
...
var Ut = class extends L {
    ...
    postCardUpdateHook() {
        this.card.isConnected &&
            (this.adjustAddon(),
            _i() || this.adjustProductBodySlots(),
            this.adjustTitleWidth());
    }
    get headingXSSlot() {
        return this.card.shadowRoot
    ...
    get mainPrice() {
        return this.card.querySelector(
            `[slot="heading-xs"] ${z}[data-template="price"]`,
        );
    }
    toggleAddon(t) {
        let r = this.mainPrice,
...
`;
var Ni = () => window.matchMedia(be).matches,
    bo = {
    ...
    Ft = class extends L {
        ...
        setupAccordion() {
            ...
            let r = () => {
                ...
                } else t.removeAttribute('data-expanded');
            };
            r();
            ...
            (this.mediaQueryListener = () => {
                ...
                (this.attributeObserver = new MutationObserver((n) => {
                    n.forEach((o) => {
                        o.type === 'attributes' &&
                            o.attributeName === 'data-default-card' &&
                            this.card.hasAttribute('data-default-card') &&
                            Ni() &&
                            this.card.setAttribute('data-expanded', 'true');
                    });
        ...
        handleChevronClick(t) {
            ...
            r.setAttribute('data-expanded', o);
        }
        renderLayout() {
            return g`
...
var hc = {
    ...
    Gt = class extends L {
        ...
        adjustLegal() {
            ...
            let r = this.card.querySelector(`${z}[data-template="price"]`);
            if (!r) return;
            let i = r.cloneNode(!0);
            (this.legal = i),
...
W('catalog', Ht, Zs, Ht.variantStyle);
W('image', Li);
W('inline-heading', Ri);
W('mini-compare-chart', Dt, null, Dt.variantStyle);
W('plans', ae, Oi, ae.variantStyle, ae.collectionOptions);
W('plans-students', ae, nc, ae.variantStyle, ae.collectionOptions);
W('plans-education', ae, ic, ae.variantStyle, ae.collectionOptions);
W('product', Ut, null, Ut.variantStyle);
W('segment', Bt, null, Bt.variantStyle);
W('special-offers', zt, cc, zt.variantStyle);
W('simplified-pricing-express', Ft, bo, Ft.variantStyle);
W('mini', Gt, hc, Gt.variantStyle);
var vo = (e) => {
    let t = Mi.get(e.variant);
    if (!t) return;
    ...
    if (i)
        try {
            ...
            (o.textContent = i.cssText), e.shadowRoot.appendChild(o);
        }
    return new r(e);
};
function Pi(e) {
    return Mi.get(e)?.fragmentMapping;
}
function pc(e) {
    return Mi.get(e)?.collectionOptions;
}
...
var uc = 'fragment',
    ...
    Eo = class {
        ...
        clear() {
            h(this, Te).clear(), h(this, ft).clear(), h(this, ve).clear();
        }
        add(t, r = !0) {
            if (!this.has(t.id) && !this.has(t.fields?.originalId)) {
                if (
                    (h(this, Te).set(t.id, t),
                    t.fields?.originalId &&
                        h(this, Te).set(t.fields.originalId, t),
                    h(this, ve).has(t.id))
                ) {
                    let [, i] = h(this, ve).get(t.id);
                    i();
                }
                if (h(this, ve).has(t.fields?.originalId)) {
                    let [, i] = h(this, ve).get(t.fields?.originalId);
                    i();
                }
                if (
                    !(
                    ...
                    for (let i in t.references) {
                        let { type: n, value: o } = t.references[i];
                        n === 'content-fragment' &&
        ...
        has(t) {
            return h(this, Te).has(t);
        }
        entries() {
            return h(this, Te).entries();
        }
        get(t) {
            return h(this, Te).get(t);
        }
        getAsPromise(t) {
            let [r] = h(this, ve).get(t) ?? [];
            if (r) return r;
            let i;
            return (
                (r = new Promise((n) => {
        ...
        remove(t) {
            h(this, Te).delete(t), h(this, ft).delete(t), h(this, ve).delete(t);
        }
    };
(Te = new WeakMap()), (ft = new WeakMap()), (ve = new WeakMap());
var We = new Eo(),
    Vt,
    Ce,
    $e,
    ...
    Ii = class extends HTMLElement {
        ...
        static get observedAttributes() {
            return [uc, xc, bc, fc, gc];
        }
        attributeChangedCallback(r, i, n) {
            r === uc && (v(this, se, n), v(this, K, We.getFetchInfo(n))),
                r === xc && lh.includes(n) && v(this, Mr, n),
                r === bc && v(this, Ir, parseInt(n, 10)),
                r === fc && v(this, $r, ['', 'true'].includes(n)),
                r === gc && v(this, jt, n);
        }
        connectedCallback() {
            if (!h(this, ye)) {
                if (
                    (h(this, fe) ?? v(this, fe, at(this)),
                    v(this, jt, h(this, fe).settings?.preview),
                    h(this, Vt) ??
                        v(
                            this,
                            Vt,
                            h(this, fe).log.module(`${yo}[${h(this, se)}]`),
                        ),
                    !h(this, se) || h(this, se) === '#')
                ) {
                    h(this, K) ??
                        v(this, K, We.getFetchInfo('missing-fragment-id')),
                        Z(this, Ee, wo).call(this, 'Missing fragment id');
                    return;
                }
                this.refresh(!1);
            }
        ...
        async refresh(r = !0) {
            if (
                h(this, ye) &&
                !(await Promise.race([h(this, ye), Promise.resolve(!1)]))
            )
                return;
            r && We.remove(h(this, se)),
                h(this, Mr) === yc &&
                    (await Promise.race([
                        We.getAsPromise(h(this, se)),
                        new Promise((s) => setTimeout(s, h(this, Ir))),
                    ]));
            try {
                v(this, ye, Z(this, Ee, Ac).call(this)), await h(this, ye);
            } catch (s) {
                return Z(this, Ee, wo).call(this, s.message), !1;
            }
            let {
                references: i,
                referencesTree: n,
            ...
            return (
                a &&
                    !H('mas.disableWcsCache') &&
                    h(this, fe).prefillWcsCache(a),
                this.dispatchEvent(
                    new CustomEvent(Ze, {
                        detail: {
                            ...this.data,
        ...
        transformAuthorData() {
            ...
            v(
                ...
                $e,
                r.reduce(
                    (l, { name: d, multiple: p, values: m }) => (
                        (l.fields[d] = p ? m : m[0]), l
                    ),
                    {
                        fields: {},
                        id: i,
        ...
        transformPublishData() {
            ...
            v(
                ...
                Object.entries(r).reduce(
                    (l, [d, p]) => (
                        (l.fields[d] = p?.mimeType ? p.value : (p ?? '')), l
                    ),
                    {
                        fields: {},
                        id: i,
        ...
        getFragmentClientUrl() {
            ...
            let { hostname: o } = window.location,
                a = o.endsWith('.page') ? 'page' : 'live';
            return n.includes('--')
                ? `https://${n}.aem.${a}/studio/libs/fragment-client.js`
                : `https://${n}--mas--adobecom.aem.${a}/studio/libs/fragment-client.js`;
        }
        async generatePreview() {
            let r = this.getFragmentClientUrl(),
                { previewFragment: i } = await import(r);
            return await i(h(this, se), {
                locale: h(this, fe).settings.locale,
                apiKey: h(this, fe).settings.wcsApiKey,
            });
        }
    };
(Vt = new WeakMap()),
    ...
    (Ec = async function (r) {
        Do(this, Hr)._++;
        let i = `${yo}:${h(this, se)}:${h(this, Hr)}`,
            n = `${i}${tt}`,
            o = `${i}${rt}`;
        if (h(this, jt)) return await this.generatePreview();
        performance.mark(n);
        let a;
        try {
            if (
                ((h(this, K).stale = !1),
                (h(this, K).url = r),
                (a = await fi(r, { cache: 'default', credentials: 'omit' })),
                Z(this, Ee, wc).call(this, a),
                (h(this, K).status = a?.status),
                (h(this, K).measure = Se(performance.measure(o, n))),
                (h(this, K).retryCount = a.retryCount),
                !a?.ok)
            )
                throw new Re('Unexpected fragment response', {
                    response: a,
                    ...h(this, fe).duration,
                });
            return await a.json();
            ...
            if (
                ...
                return (
                    (h(this, K).stale = !0),
                    h(this, Vt).error('Serving stale data', h(this, K)),
                    h(this, Ce)
                );
            let c = s.message ?? 'unknown';
            throw new Re(`Failed to fetch fragment: ${c}`, {});
        }
    }),
    (wc = function (r) {
        Object.assign(h(this, K), ei(r));
    }),
    (wo = function (r) {
        v(this, ye, null),
            (h(this, K).message = r),
            this.classList.add('error');
        let i = { ...h(this, K), ...h(this, fe).duration };
        h(this, Vt).error(r, i),
            this.dispatchEvent(
                new CustomEvent(Je, { detail: i, bubbles: !0, composed: !0 }),
            );
    }),
    (Ac = async function () {
        var c;
        this.classList.remove('error'), v(this, $e, null);
        let r = We.get(h(this, se));
        if (r) return v(this, Ce, r), !0;
        let {
                masIOUrl: i,
                wcsApiKey: n,
                country: o,
            ...
            s = `${i}/fragment?id=${h(this, se)}&api_key=${n}&locale=${a}`;
        return (
            o && !a.endsWith(`_${o}`) && (s += `&country=${o}`),
            (r = await Z(this, Ee, Ec).call(this, s)),
            (c = r.fields).originalId ?? (c.originalId = h(this, se)),
            We.add(r),
            v(this, Ce, r),
            !0
        );
...
var qt = class extends I {
    ...
    render() {
        return g`<div class="badge">${this.text}</div>`;
    }
};
u(qt, 'properties', {
    color: { type: String },
...
u(
    ...
    u(Dr, 'properties', { description: { type: String, attribute: !0 } });
customElements.define('merch-mnemonic-list', Dr);
R();
        ...
        return g`<slot name="heading"></slot>
            ...
            ${
                this.isMobile && this.rows.length > this.mobileRows
                    ? g`<div @click=${this.toggle} class="see-more">
...
customElements.define('merch-whats-included', Ur);
var dh = '#000000',
    Ao = '#F8D904',
    hh = '#EAEAEA',
    ph = '#31A547',
    mh = /(accent|primary|secondary)(-(outline|link))?/,
    uh = 'mas:product_code/',
    fh = 'daa-ll',
    Hi = 'daa-lh',
    gh = ['XL', 'L', 'M', 'S'],
...
function we(e, t, r, i) {
    ...
    if (t[e] && n) {
        ...
        if (n.maxCount && typeof a == 'string') {
            let [c, l] = Nh(a, n.maxCount, n.withSuffix);
            c !== a && ((o.title = l), (a = c));
        }
        let s = oe(n.tag, o, a);
        r.append(s);
...
function xh(e, t, r) {
    let i = e.mnemonicIcon?.map((o, a) => ({
        icon: o,
        alt: e.mnemonicAlt[a] ?? '',
        link: e.mnemonicLink[a] ?? '',
    }));
    i?.forEach(({ icon: o, alt: a, link: s }) => {
        if (s && !/^https?:/.test(s))
            try {
        ...
        a && (c.alt = a), s && (c.href = s);
        let l = oe('merch-icon', c);
        t.append(l);
    });
...
function bh(e, t, r) {
    if (r.badge?.slot) {
        if (e.badge?.length && !e.badge?.startsWith('<merch-badge')) {
            ...
            let o = e.badgeBackgroundColor || i,
                a = e.borderColor || '';
            n && ((a = r.badge?.default), (e.borderColor = r.badge?.default)),
                (e.badge = `<merch-badge variant="${e.variant}" background-color="${o}" border-color="${a}">${e.badge}</merch-badge>`);
        }
        we('badge', e, t, r);
    } else
        e.badge
            ? (t.setAttribute('badge-text', e.badge),
              r.disabledAttributes?.includes('badgeColor') ||
                  t.setAttribute('badge-color', e.badgeColor || dh),
              r.disabledAttributes?.includes('badgeBackgroundColor') ||
                  t.setAttribute(
                      'badge-background-color',
                      e.badgeBackgroundColor || Ao,
                  ),
              t.setAttribute('border-color', e.badgeBackgroundColor || Ao))
            : t.setAttribute('border-color', e.borderColor || hh);
}
function vh(e, t, r) {
...
function Th(e, t, r) {
    if (e.backgroundImage) {
        ...
        t.append(oe(r.tag, { slot: r.slot }, oe('img', i)));
    }
}
function $i(e) {
    return (
...
function Ch(e, t, r) {
    e.prices && (e.prices = $i(e.prices)), we('prices', e, t, r);
}
function _c(e, t, r) {
    let i = e.hasAttribute('data-wcs-osi') && !!e.getAttribute('data-wcs-osi'),
        n = e.className || '',
        o = mh.exec(n)?.[0] ?? 'accent',
        a = o.includes('accent'),
        s = o.includes('primary'),
        c = o.includes('secondary'),
        l = o.includes('-outline'),
        d = o.includes('-link');
    e.classList.remove('accent', 'primary', 'secondary');
    let p;
    if (t.consonant) p = Hh(e, a, i, d, s);
    else if (d) p = e;
    else {
        let m;
        a ? (m = 'accent') : s ? (m = 'primary') : c && (m = 'secondary'),
            (p = t.spectrum === 'swc' ? $h(e, r, l, m, i) : Ih(e, r, l, m, i));
    }
    return p;
}
function kh(e, t) {
...
function Ph(e, t, r) {
    e.description && (e.description = $i(e.description)),
        e.promoText && (e.promoText = $i(e.promoText)),
        we('promoText', e, t, r),
        we('description', e, t, r),
        kh(t, r),
        we('callout', e, t, r),
        we('quantitySelect', e, t, r),
        we('whatsIncluded', e, t, r);
}
function Lh(e, t, r) {
    if (!r.addon) return;
    let i = e.addon?.replace(/[{}]/g, '');
    if (!i || /disabled/.test(i)) return;
    let n = oe('merch-addon', { slot: 'addon' }, i);
    [...n.querySelectorAll(z)].forEach((o) => {
        let a = o.parentElement;
        a?.nodeName === 'P' && a.setAttribute('data-plan-type', '');
    }),
        t.append(n);
}
function Rh(e, t, r) {
    e.addonConfirmation && we('addonConfirmation', e, t, r);
}
function Oh(e, t, r, i) {
    i?.secureLabel &&
        r?.secureLabel &&
...
function Nh(e, t, r = !0) {
    try {
        ...
        let o = 0,
            a = !1,
            s = r ? (t - So.length < 1 ? 1 : t - So.length) : t,
            c = [];
        for (let p of i) {
            if ((o++, p === '<'))
                if (((a = !0), i[o] === '/')) c.pop();
        ...
        let l = i.substring(0, o).trim();
        if (c.length > 0) {
            c[0] === 'p' && c.shift();
            for (let p of c.reverse()) l += `</${p}>`;
        }
        return [`${l}${r ? So : ''}`, n];
    } catch {
...
function Ih(e, t, r, i, n) {
    ...
    n
        ...
        : (o.innerHTML = `<span>${o.textContent}</span>`),
        o.setAttribute('tabindex', 0);
    for (let d of e.attributes)
        ['class', 'is'].includes(d.name) || o.setAttribute(d.name, d.value);
...
function $h(e, t, r, i, n) {
    ...
    return (
        (s.source = o),
        (n ? o.onceSettled() : Promise.resolve(o)).then((c) => {
            s.setAttribute('data-navigation-url', c.href);
        }),
        s.addEventListener('click', (c) => {
            c.defaultPrevented || o.click();
        }),
        s
    );
}
function Hh(e, t, r, i, n) {
    ...
    return (
        ...
        i ||
            (o.classList.add('button', 'con-button'),
            t && o.classList.add('blue'),
            n && o.classList.add('primary')),
        o
    );
}
function Dh(e, t, r, i) {
    if (e.ctas) {
        e.ctas = $i(e.ctas);
        let { slot: n } = r.ctas,
            o = oe('div', { slot: n }, e.ctas),
            a = [...o.querySelectorAll('a')].map((s) => _c(s, t, r));
...
function Uh(e, t) {
    ...
    t.setAttribute(Hi, i),
        [
            ...
            o.setAttribute(fh, `${o.dataset.analyticsId}-${a + 1}`);
        });
}
function Bh(e) {
    e.spectrum === 'css' &&
...
function Fh(e) {
    e.providers.has(kc) || e.providers.price(kc);
}
var Gh = 0,
    Wt,
    Yt,
    ...
    Ye = class extends I {
        ...
        get price() {
            return this.headingmMSlot?.querySelector(z);
        }
        get checkoutLinks() {
            return [...(this.footerSlot?.querySelectorAll(ge) ?? [])];
        }
        get checkoutLinksDescription() {
            return [...(this.descriptionSlot?.querySelectorAll(ge) ?? [])];
        }
        get checkoutLinkDescriptionCompare() {
            return [
                ...(this.descriptionSlotCompare?.querySelectorAll(ge) ?? []),
            ];
        }
        ...
        async toggleStockOffer({ target: r }) {
            ...
            if (i.length !== 0)
                for (let n of i) {
                    await n.onceSettled();
                    let o = n.value?.[0]?.planType;
                    if (!o) return;
                    let a = this.stockOfferOsis[o];
                    if (!a) return;
                    let s = n.dataset.wcsOsi.split(',').filter((c) => c !== a);
                    r.checked && s.push(a), (n.dataset.wcsOsi = s.join(','));
                }
        }
        changeHandler(r) {
        ...
        toggleAddon(r) {
            ...
            let n = (o) => {
                let { offerType: a, planType: s } = o.value?.[0] ?? {};
                if (!a || !s) return;
                let c = r.getOsi(s, a),
                    l = (o.dataset.wcsOsi || '')
                        .split(',')
                        .filter((d) => d && d !== c);
                r.checked && l.push(c), (o.dataset.wcsOsi = l.join(','));
            };
            i.forEach(n);
        }
        ...
        updateFilters(r) {
            ...
            Object.keys(i).forEach((n) => {
                ...
                let o = i[n].order;
                o === 1 || isNaN(o) || (i[n].order = Number(o) + 1);
            }),
                (this.filters = i);
        }
        includes(r) {
        ...
        connectedCallback() {
            var i;
            super.connectedCallback(),
                h(this, Yt) || v(this, Yt, Gh++),
                this.aemFragment ||
                    ((i = h(this, ke)) == null || i.call(this),
                    v(this, ke, void 0)),
                this.id ??
                    (this.id =
                        this.getAttribute('id') ??
                        this.aemFragment?.getAttribute('fragment'));
            let r = this.id ?? h(this, Yt);
            v(this, xt, `${Cc}${r}${tt}`),
                v(this, Wt, `${Cc}${r}${rt}`),
                performance.mark(h(this, xt)),
                v(this, He, at()),
                Fh(h(this, He)),
                v(this, Xt, h(this, He).Log.module(To)),
                this.addEventListener(Pe, this.handleQuantitySelection),
                this.addEventListener(qr, this.handleAddonAndQuantityUpdate),
                this.addEventListener(ir, this.handleMerchOfferSelectReady),
                this.addEventListener(Je, this.handleAemFragmentEvents),
                this.addEventListener(Ze, this.handleAemFragmentEvents),
        ...
        disconnectedCallback() {
            super.disconnectedCallback(),
                ...
                this.removeEventListener(Pe, this.handleQuantitySelection),
                this.removeEventListener(Je, this.handleAemFragmentEvents),
                this.removeEventListener(Ze, this.handleAemFragmentEvents),
                this.removeEventListener('change', this.changeHandler),
                this.removeEventListener(qr, this.handleAddonAndQuantityUpdate);
        }
        async handleAemFragmentEvents(r) {
            ...
            if (
                this.isConnected &&
                (r.type === Je &&
                    Z(this, Q, gt).call(this, 'AEM fragment cannot be loaded'),
                r.type === Ze &&
                ...
                try {
                    ...
                    Z(this, Q, gt).call(
                        this,
                        `hydration has failed: ${o.message}`,
                    );
                } finally {
                    (i = h(this, ke)) == null || i.call(this),
                        v(this, ke, void 0);
        ...
        async checkReady() {
            if (!this.isConnected) return;
            h(this, bt) && (await h(this, bt), v(this, bt, void 0)),
                this.variantLayoutPromise &&
                    (await this.variantLayoutPromise,
                    (this.variantLayoutPromise = void 0));
            let r = new Promise((a) => setTimeout(() => a('timeout'), _o));
            if (this.aemFragment) {
                ...
                if (a === !1 || a === 'timeout') {
                    let s =
                        a === 'timeout'
                            ? `AEM fragment was not resolved within ${_o} timeout`
                            : 'AEM fragment cannot be loaded';
                    Z(this, Q, gt).call(this, s, {}, !1);
                    return;
                }
            }
            let i = [...this.querySelectorAll(rr)],
                n = Promise.all(
                    i.map((a) => a.onceSettled().catch(() => a)),
                ).then((a) =>
                    a.every((s) =>
                        s.classList.contains('placeholder-resolved'),
                    ),
                ),
                o = await Promise.race([n, r]);
            if (o === !0) {
                this.measure = performance.measure(h(this, Wt), h(this, xt));
                let a = {
                    ...this.aemFragment?.fetchInfo,
                    ...h(this, He).duration,
                    measure: Se(this.measure),
                };
                return (
                    this.dispatchEvent(
                        new CustomEvent(Wi, {
                ...
                this.measure = performance.measure(h(this, Wt), h(this, xt));
                let a = { measure: Se(this.measure), ...h(this, He).duration };
                o === 'timeout'
                    ? Z(this, Q, gt).call(
                          this,
                          `Contains offers that were not resolved within ${_o} timeout`,
                          a,
                      )
                    : Z(this, Q, gt).call(
                          this,
        ...
        displayFooterElementsInColumn() {
            ...
            (this.footerSlot?.querySelectorAll(ge)).length === 2 &&
                r &&
        ...
        handleAddonAndQuantityUpdate({ detail: { id: r, items: i } }) {
            if (
                ...
                return;
            let o = this.checkoutLinks.find(
                (d) => d.getAttribute('data-modal-id') === r,
            );
            if (!o) return;
            let s = new URL(o.getAttribute('href')).searchParams.get('pa'),
        ...
        get regularPrice() {
            return h(this, Q, Di)?.innerText;
        }
        get promotionCode() {
            let r = [
                    ...this.querySelectorAll(
                        `${z}[data-promotion-code],${ge}[data-promotion-code]`,
                    ),
        ...
        get annualPrice() {
            return this.querySelector(
                `${z}[data-template="price"] > .price.price-annual`,
            )?.innerText;
        }
        get promoText() {}
        get taxText() {
            return (
                (h(this, Q, Pc) ?? h(this, Q, Di))
        ...
        get seeTermsInfo() {
            ...
            if (r) return Z(this, Q, Ui).call(this, r);
        }
        get renewalText() {
        ...
        get ctas() {
            ...
            )?.querySelectorAll(`${ge}, a`);
            return Array.from(r ?? []);
        }
        get primaryCta() {
            return Z(this, Q, Ui).call(
                this,
                this.ctas.find(
                    (r) =>
                        r.variant === 'accent' ||
...
(Wt = new WeakMap()),
    ...
    (gt = function (r, i = {}, n = !0) {
        if (!this.isConnected) return;
        let a = this.aemFragment?.getAttribute('fragment');
        a = `[${a}]`;
        let s = {
            ...this.aemFragment?.fetchInfo,
            ...h(this, He).duration,
        ...
        h(this, Xt).error(`merch-card${a}: ${r}`, s),
            (this.failed = !0),
            n &&
                this.dispatchEvent(
                    new CustomEvent(Yi, {
    ...
    (Di = function () {
        return (
            ...
            this.querySelector(`${z}[data-template="price"] > span`)
        );
    }),
    (Pc = function () {
        return this.querySelector(`${z}[data-template="legal"]`);
    }),
    (Ui = function (r) {
        if (r)
            return {
                ...
                fromAttribute: (r) =>
                    Object.fromEntries(
                        r.split(',').map((i) => {
                            ...
                            return [
                                n,
                                { order: isNaN(s) ? void 0 : s, size: a },
                            ];
                        }),
                    ),
                toAttribute: (r) =>
                    Object.entries(r)
                        .map(([i, { order: n, size: o }]) =>
                            [i, n, o].filter((a) => a != null).join(':'),
                        )
                        .join(','),
            },
        },
    ...
    u(Ye, 'styles', [Xs, ...Ks()]),
    u(Ye, 'registerVariant', W),
    u(Ye, 'getCollectionOptions', pc),
    u(Ye, 'getFragmentMapping', Pi);
customElements.define(To, Ye);
R();
var Kt,
    Br = class extends I {
        constructor() {
        ...
        updateSlot(r, i) {
            ...
            if (!n) return;
            let o = this.selectedOffer.getOptionValue(r)
                ? this.selectedOffer.getOptionValue(r)
                : this.defaults[r];
            o && n.replaceWith(o.cloneNode(!0));
        }
        ...
        selectOffer(r) {
            ...
            i && (i.selected = !1),
                ...
                this.updateComplete.then(() => {
                    this.dispatchEvent(
                        new CustomEvent(qi, { detail: this, bubbles: !0 }),
                    );
                });
        }
        findAppropriateOffer(r) {
            ...
            return (
                this.offers.find((o) => {
                    let a = Number.parseInt(o.getAttribute('value'));
                    if (a === r) return !0;
                    if (a > r) return !1;
                    i = o;
                }) || i
        ...
        render() {
            return g`<fieldset><slot class="${this.variant}"></slot></fieldset>`;
        }
        connectedCallback() {
            super.connectedCallback(),
                this.addEventListener('focusin', this.handleFocusin),
                this.addEventListener('click', this.handleFocusin),
                this.addEventListener(Et, this.handleOfferSelectReady);
            let r = this.closest('merch-quantity-select');
            (this.manageableMode = r),
                (this.offers = [...this.querySelectorAll('merch-offer')]),
                v(this, Kt, this.handleOfferSelectionByQuantity.bind(this)),
                this.manageableMode
                    ? r.addEventListener(Pe, h(this, Kt))
        ...
        disconnectedCallback() {
            super.disconnectedCallback(),
                this.removeEventListener(Pe, h(this, Kt)),
                this.removeEventListener(Et, this.handleOfferSelectReady),
        ...
        async handleOfferSelectReady() {
            this.planType ||
                ...
                this.dispatchEvent(new CustomEvent(ir, { bubbles: !0 })));
        }
    };
(Kt = new WeakMap()),
    u(
...
customElements.define('merch-offer-select', Br);
R();
R();
var Lc = y`
    :host {
...
var Vh = 'merch-offer',
    zr = class extends I {
        ...
        get asRadioOption() {
            return g` <div class="merch-Radio">
        ...
        get asSubscriptionOption() {
            return g`<slot name="commitment"></slot>
            <slot name="price"></slot>
        ...
        async initOffer() {
            ...
            (this.planType = r.planType),
                await this.updateComplete,
                this.dispatchEvent(new CustomEvent(Et, { bubbles: !0 }));
        }
    };
u(zr, 'properties', {
    text: { type: String },
...
var Po = class extends I {
    ...
    constructor() {
        super(),
            ...
            (this.handleKeyupDebounced = yr(this.handleKeyup.bind(this), 500)),
            (this.debouncedQuantityUpdate = yr(
    ...
    connectedCallback() {
        super.connectedCallback(),
            ...
            this.addEventListener(wt, this.debouncedQuantityUpdate);
    }
    get button() {
        return this.shadowRoot.querySelector('button');
    }
    handleKeyup(t) {
        t.key === ko || t.key === Co || (this.handleInput(), this.sendEvent());
    }
    selectValue() {
        if (!this.closed) {
    ...
    disconnectedCallback() {
        super.disconnectedCallback(),
            ...
            this.removeEventListener(wt, this.debouncedQuantityUpdate);
    }
...
customElements.define('merch-quantity-select', Po);
Ci();
R();
var Mc = `
...
var Ic = {
    ...
    Qt = class extends L {
        ...
        renderLayout() {
            return g` <div style="${this.stripStyle}" class="body">
                <div class="header">
                    <div class="top-section">
                        <slot name="icons"></slot>
                        ${this.badge}
...
W('ccd-suggested', Qt, Ic, Qt.variantStyle);
W('ccd-slice', Zt, Hc, Zt.variantStyle);
W('ah-try-buy-widget', Jt, Lo, Jt.variantStyle);
W('ah-promoted-plans', er, Ro, er.variantStyle);
W('fries', tr, Oo, tr.variantStyle);

var gr=Object.defineProperty;var ur=a=>{throw TypeError(a)};var ai=(a,t,e)=>t in a?gr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var ii=(a,t)=>()=>(a&&(t=a(a=0)),t);var ni=(a,t)=>{for(var e in t)gr(a,e,{get:t[e],enumerable:!0})};var h=(a,t,e)=>ai(a,typeof t!="symbol"?t+"":t,e),$t=(a,t,e)=>t.has(a)||ur("Cannot "+e);var s=(a,t,e)=>($t(a,t,"read from private field"),e?e.call(a):t.get(a)),f=(a,t,e)=>t.has(a)?ur("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>($t(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),P=(a,t,e)=>($t(a,t,"access private method"),e);var fr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return s(a,t,r)}});var Bt={};ni(Bt,{default:()=>Ke});import{LitElement as oi,html as be,css as ci,nothing as si}from"./lit-all.min.js";import{unsafeHTML as Er}from"./lit-all.min.js";import{ifDefined as li}from"./lit-all.min.js";function di(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var _,Ke,Ht=ii(()=>{_=class _ extends oi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();_.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>i?u="top":u==="left"&&e.left-d-n<0?u="right":u==="right"&&e.right+d+n>r&&(u="left");let C=e.left+e.width/2,B=e.top+e.height/2,Z=6,pt=(ei,ti,ri)=>Math.max(ei,Math.min(ti,ri)),mt,gt,It;u==="top"||u==="bottom"?(mt=u==="top"?e.top-p-n:e.bottom+n,gt=pt(0,r-d,C-d/2),It=pt(Z,d-Z*2,C-gt-Z)):(gt=u==="left"?e.left-d-n:e.right+n,mt=pt(0,i-p,B-p/2),It=pt(Z,p-Z*2,B-mt-Z)),this._tooltipTop=mt,this._tooltipLeft=gt,this._arrowOffset=It,this._computedPlacement=u}showTooltip(){_.activeTooltip&&_.activeTooltip!==this&&(_.activeTooltip.closeOverlay(),_.activeTooltip.tooltipVisible=!1,_.activeTooltip.requestUpdate()),_.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){_.activeTooltip===this&&(_.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?be`<merch-icon
    ...
    `);Ke=_;customElements.define("mas-mnemonic",Ke)});import{LitElement as Jn}from"./lit-all.min.js";import{css as br,unsafeCSS as xr}from"./lit-all.min.js";var w="(max-width: 767px)",T="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",L="(min-width: 1600px)",vr={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${L})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=vr;function ut(){return vr.isDesktop}var yr=br`
    :host {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as et,css as wi}from"./lit-all.min.js";var $r=`
:root {
...
`;var kt=class extends b{constructor(t){super(t)}getGlobalCSS(){return Hr}renderLayout(){return qr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":qr`<hr />`} ${this.secureLabelFooter}`}};import{html as re,css as Ei,unsafeCSS as Gr}from"./lit-all.min.js";var Ur=`
  :root {
...
`;var ki=32,jr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Pe=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?re`<slot name="secure-transaction-label">
    ...
    `);import{html as St,css as Si,unsafeCSS as Wr,nothing as Ci}from"./lit-all.min.js";var Vr=`
  :root {
...
`;var Ai=32,Kr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},_e=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>St` <footer>
    ...
    `);import{html as tt,css as Ti,nothing as Ct}from"./lit-all.min.js";var Yr=`
:root {
...
`;var ra={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},V,Me=class extends b{constructor(e){super(e);f(this,V);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return ta}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Vt` ${this.badge}
    ...
    `);import{html as Wt,css as Pi}from"./lit-all.min.js";var aa=`
:root {
...
`;var ia={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Re=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return aa}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Wt`
    ...
    `);import{html as _i,css as Mi}from"./lit-all.min.js";var na=`
...
`;var oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Oe=class extends b{constructor(t){super(t)}getGlobalCSS(){return na}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return _i`
    ...
    `);import{html as Kt,css as Ri}from"./lit-all.min.js";var ca=`
:root {
...
`;var sa={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},De=class extends b{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ca}renderLayout(){return Kt`${this.cardImage}
    ...
    `);import{html as Oi,css as Di}from"./lit-all.min.js";var la=`
:root {
...
`;var Yt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ne=class extends b{getGlobalCSS(){return la}get aemFragmentMapping(){return Yt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;if(!t)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(t.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",c)})}),x.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!ut()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let t=this.getContainer();t&&t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t<=2||t===this.lastSyncedWidth||(this.lastSyncedWidth=t,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(ut())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};e();let r=window.matchMedia(w);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(w).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||ut())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return Oi`
    ...
    `);import{html as ha,css as Ni}from"./lit-all.min.js";var da=`
:root {
...
`;var Qt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Fe=class extends b{getGlobalCSS(){return da}get aemFragmentMapping(){return Qt}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return ha`
    ...
    `);import{html as Xt,css as Fi,nothing as Ii}from"./lit-all.min.js";var pa=`
...
`;var ma={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},$i=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Ie=class extends b{constructor(t){super(t)}getGlobalCSS(){return pa}renderLayout(){return Xt`
    ...
    `);import{css as Bi,html as Hi}from"./lit-all.min.js";var ga=`
...
`;var ua={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},$e=class extends b{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return ga}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Hi`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as qi,css as Ui}from"./lit-all.min.js";var fa=`
...
`;var Zt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Be=class extends b{getGlobalCSS(){return fa}get aemFragmentMapping(){return Zt}renderLayout(){return qi`
    ...
    `);var Lt=new Map,va=new WeakMap,xa=new Map,k=(a,t,e=null,r=null,i)=>{Lt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",ze,Ir,ze.variantStyle);k("image",he);k("inline-heading",kt);k("mini-compare-chart",Pe,jr,Pe.variantStyle);k("mini-compare-chart-mweb",_e,Kr,_e.variantStyle);k("plans",R,At,R.variantStyle,R.collectionOptions);k("plans-students",R,Xr,R.variantStyle,R.collectionOptions);k("plans-education",R,Qr,R.variantStyle,R.collectionOptions);k("plans-v2",ae,ea,ae.variantStyle,ae.collectionOptions);k("product",Me,ra,Me.variantStyle);k("segment",Re,ia,Re.variantStyle);k("media",Oe,oa,Oe.variantStyle);k("headless",Ie,ma,Ie.variantStyle);k("special-offers",De,sa,De.variantStyle);k("simplified-pricing-express",Ne,Yt,Ne.variantStyle);k("full-pricing-express",Fe,Qt,Fe.variantStyle);k("mini",$e,ua,$e.variantStyle);k("image",he,Br,he.variantStyle);k("fries",Be,Zt,Be.variantStyle);var Gi=(a,t,e)=>{try{let r=xa.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),xa.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Jt=a=>{let t=Lt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=va.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?Gi(a,r,i):{};return va.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Et(a){return Lt.get(a)?.fragmentMapping}function ba(a){return Lt.get(a)?.collectionOptions}var ya=document.createElement("style");ya.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var pe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ea=1e3;function Wi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ka(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!pe.serializableTypes.includes(e))return e}return a}function Ki(a,t){if(!pe.ignoredProperties.includes(a))return ka(t)}var tr={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(Wi(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(ka).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${pe.delimiter}page=${o}${c}`;l.length>Ea&&(l=`${l.slice(0,Ea)}<trunc>`),n+=l,i.length&&(n+=`${pe.delimiter}facts=`,n+=JSON.stringify(i,Ki)),window.lana?.log(n,pe)}};function Sa(a){Object.assign(pe,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in pe&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Ca={LOCAL:"local",PROD:"prod",STAGE:"stage"},rr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},ar=new Set,ir=new Set,Aa=new Map,Ta={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},La={filter:({level:a})=>a!==rr.DEBUG},Yi={filter:()=>!1};function Qi(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Pt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Xi(a){[...ir].every(t=>t(a))&&ar.forEach(t=>t(a))}function za(a){let t=(Aa.get(a)??0)+1;Aa.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>za(`${r.namespace}/${i}`),updateConfig:Sa};return Object.values(rr).forEach(i=>{r[i]=(n,...o)=>Xi(Qi(i,n,a,o,e))}),Object.seal(r)}function _t(...a){a.forEach(t=>{let{append:e,filter:r}=t;Pt(r)&&ir.add(r),Pt(e)&&ar.add(e)})}function Zi(a={}){let{name:t}=a,e=wa(zt("commerce.debug",{search:!0,storage:!0}),t===Ca.LOCAL);return _t(e?Ta:La),t===Ca.PROD&&_t(tr),rt}function Ji(){ar.clear(),ir.clear()}var rt={...za(Rr),Level:rr,Plugins:{consoleAppender:Ta,debugFilter:La,quietFilter:Yi,lanaAppender:tr},init:Zi,reset:Ji,use:_t};var en="mas-commerce-service",Ll=rt.module("utilities"),tn={requestId:vt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Mt=a=>window.setTimeout(a);function nr(){return document.getElementsByTagName(en)?.[0]}function Pa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(tn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function _a(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var Ma="fragment",Ra="author",Oa="preview",Da="loading",Na="timeout",or="aem-fragment",Fa="eager",Ia="cache",rn=[Fa,Ia],W,me,H,cr=class{constructor(){f(this,W,new Map);f(this,me,new Map);f(this,H,new Map)}clear(){s(this,W).clear(),s(this,me).clear(),s(this,H).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,W).set(t.id,t),t.fields?.originalId&&s(this,W).set(t.fields.originalId,t),s(this,H).has(t.id)){let[,r]=s(this,H).get(t.id);r()}if(s(this,H).has(t.fields?.originalId)){let[,r]=s(this,H).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,W).has(t)}entries(){return s(this,W).entries()}get(t){return s(this,W).get(t)}getAsPromise(t){let[e]=s(this,H).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,H).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,me).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,me).set(t,e)),e}remove(t){s(this,W).delete(t),s(this,me).delete(t),s(this,H).delete(t)}};W=new WeakMap,me=new WeakMap,H=new WeakMap;var ne=new cr,He,F,X,D,O,A,at,it,q,nt,ot,qe,U,$a,Ba,sr,Ha,Rt=class extends HTMLElement{constructor(){super(...arguments);f(this,U);h(this,"cache",ne);f(this,He);f(this,F,null);f(this,X,null);f(this,D,null);f(this,O);f(this,A);f(this,at,Fa);f(this,it,5e3);f(this,q);f(this,nt,!1);f(this,ot,0);f(this,qe)}static get observedAttributes(){return[Ma,Da,Na,Ra,Oa]}attributeChangedCallback(e,r,i){e===Ma&&(m(this,O,i),m(this,A,ne.getFetchInfo(i))),e===Da&&rn.includes(i)&&m(this,at,i),e===Na&&m(this,it,parseInt(i,10)),e===Ra&&m(this,nt,["","true"].includes(i)),e===Oa&&m(this,qe,i)}connectedCallback(){if(!s(this,q)){if(s(this,D)??m(this,D,le(this)),m(this,qe,s(this,D).settings?.preview),s(this,He)??m(this,He,s(this,D).log.module(`${or}[${s(this,O)}]`)),!s(this,O)||s(this,O)==="#"){s(this,A)??m(this,A,ne.getFetchInfo("missing-fragment-id")),P(this,U,sr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,A)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&ne.remove(s(this,O)),s(this,at)===Ia&&await Promise.race([ne.getAsPromise(s(this,O)),new Promise(c=>setTimeout(c,s(this,it)))]);try{m(this,q,P(this,U,Ha).call(this)),await s(this,q)}catch(c){return P(this,U,sr).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,F)||{};return o&&!zt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ke,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,A)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,X)?s(this,X):(s(this,nt)?this.transformAuthorData():this.transformPublishData(),s(this,X))}get rawData(){return s(this,F)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:d={}}=s(this,F);m(this,X,e.reduce((p,{name:g,multiple:u,values:C})=>(p.fields[g]=u?C:C[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:d,variationId:n}))}transformPublishData(){if(!s(this,F))return;let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:d}=s(this,F);m(this,X,Object.entries(e).reduce((p,[g,u])=>(p.fields[g]=u?.mimeType?u.value:u??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,D).settings.instant;return n&&(i.instant=n),await r(s(this,O),i)}};He=new WeakMap,F=new WeakMap,X=new WeakMap,D=new WeakMap,O=new WeakMap,A=new WeakMap,at=new WeakMap,it=new WeakMap,q=new WeakMap,nt=new WeakMap,ot=new WeakMap,qe=new WeakMap,U=new WeakSet,$a=async function(e){fr(this,ot)._++;let r=`${or}:${s(this,O)}:${s(this,ot)}`,i=`${r}${xt}`,n=`${r}${bt}`;if(s(this,qe)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new ie(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,A).stale=!1,s(this,A).url=e,o=await _a(e,{cache:"default",credentials:"omit"}),P(this,U,Ba).call(this,o),s(this,A).status=o?.status,s(this,A).measure=Ce(performance.measure(n,i)),s(this,A).retryCount=o.retryCount,!o?.ok)throw new ie("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,A).measure=Ce(performance.measure(n,i)),s(this,A).retryCount=c.retryCount,s(this,F))return s(this,A).stale=!0,s(this,He).error("Serving stale data",s(this,A)),s(this,F);let l=c.message??"unknown";throw new ie(`Failed to fetch fragment: ${l}`,{})}},Ba=function(e){Object.assign(s(this,A),Pa(e))},sr=function(e){m(this,q,null),s(this,A).message=e,this.classList.add("error");let r={...s(this,A),...s(this,D).duration};s(this,He).error(e,r),this.dispatchEvent(new CustomEvent(Se,{detail:r,bubbles:!0,composed:!0}))},Ha=async function(){var l;this.classList.remove("error"),m(this,X,null);let e=ne.get(s(this,O));if(e)return m(this,F,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,O)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await P(this,U,$a).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,O)),ne.add(e),m(this,F,e),!0},h(Rt,"cache",ne);customElements.define(or,Rt);import{LitElement as an,html as lr,css as nn,nothing as on}from"./lit-all.min.js";import{unsafeHTML as cn}from"./lit-all.min.js";var sn=a=>a?a.startsWith("sp-icon-")?lr`${cn(`<${a} class="badge-icon"></${a}>`)}`:lr`<img src="${a}" class="badge-icon" />`:on,Ue=class extends an{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return lr`<div class="badge">
    ...
    `),h(ct,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ct);import{html as dr,css as pn,LitElement as mn,nothing as qa}from"./lit-all.min.js";var st=class extends mn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return dr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?dr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:qa}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(st,"styles",pn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

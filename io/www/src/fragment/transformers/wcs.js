...
import { SUPPORTED_COUNTRIES, SUPPORTED_LANGUAGE_COUNTRY } from '../../../../../web-components/src/constants.js';
...
async function wcs(context) {
    ...
    if (matches.length > 0) {
        ...
        const wcsContext = {
            locale: SUPPORTED_LANGUAGE_COUNTRY.includes(locale) ? locale : 'en_US',
            country: SUPPORTED_COUNTRIES.includes(country) ? country : 'US',
            context,
        };
        context.body.wcs ??= {};

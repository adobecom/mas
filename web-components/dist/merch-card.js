...
`,Cr=()=>[Er`
        ...
        `];import{LitElement as fi,html as Ar,css as vi}from"./lit-all.min.js";function bi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var ue=class extends fi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(bi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let t="",i="top";if(e.tagName==="SP-TOOLTIP")t=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(t=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(t){let n=document.createElement("mas-mnemonic");n.setAttribute("content",t),n.setAttribute("placement",i);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Ut())}e.remove()})}render(){let{href:r}=this;return r?Ar`<a href="${r}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(ue,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(ue,"styles",vi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
...
`;var wt=class extends v{constructor(r){super(r)}getGlobalCSS(){return Gr}renderLayout(){return Wr` ${this.badge}
            ...
            ${this.card.customHr?"":Wr`<hr />`} ${this.secureLabelFooter}`}};import{html as J,css as Fi,unsafeCSS as na}from"./lit-all.min.js";var Yr=`
  :root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?W`
        ...
        `:W`
            ...
            <slot></slot>`}};d(ee,"variantStyle",Ui`

var Ui=Object.defineProperty;var $i=e=>{throw TypeError(e)};var Xs=(e,r,t)=>r in e?Ui(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Ks=(e,r)=>{for(var t in r)Ui(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Xs(e,typeof r!="symbol"?r+"":r,t),ra=(e,r,t)=>r.has(e)||$i("Cannot "+t);var v=(e,r,t)=>(ra(e,r,"read from private field"),t?t.call(e):r.get(e)),_=(e,r,t)=>r.has(e)?$i("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),T=(e,r,t,a)=>(ra(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),W=(e,r,t)=>(ra(e,r,"access private method"),t);import{html as Oe,LitElement as Ds,css as Hs,unsafeCSS as zs,nothing as xe}from"./lit-all.min.js";var z="(max-width: 767px)",X="(max-width: 1199px)",R="(min-width: 768px)",k="(min-width: 1200px)",re="(min-width: 1600px)",kt="(min-width: 1280px)",Gi={matchMobile:window.matchMedia(z),matchDesktop:window.matchMedia(`${k} and (not ${re})`),matchDesktopOrUp:window.matchMedia(k),matchLargeDesktop:window.matchMedia(re),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},L=Gi;function hr(){return Gi.isDesktop}var _t=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var qi="hashchange";function Zs(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function Lt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function Vi(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=Zs(window.location.hash);e(t)};return r(),window.addEventListener(qi,r),()=>{window.removeEventListener(qi,r)}}var _a={};Ks(_a,{CLASS_NAME_FAILED:()=>pa,CLASS_NAME_HIDDEN:()=>Js,CLASS_NAME_PENDING:()=>ma,CLASS_NAME_RESOLVED:()=>ua,CheckoutWorkflow:()=>uc,CheckoutWorkflowStep:()=>ne,Commitment:()=>$e,ERROR_MESSAGE_BAD_REQUEST:()=>ga,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>hc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>fa,EVENT_AEM_ERROR:()=>da,EVENT_AEM_LOAD:()=>la,EVENT_COMPARE_CHART_REHYDRATE:()=>lc,EVENT_EXPANDED_GROUPS_CHANGE:()=>dc,EVENT_MAS_ERROR:()=>ha,EVENT_MAS_READY:()=>ur,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>sc,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>na,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>me,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>sa,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Pt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>oa,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>mr,EVENT_MERCH_OFFER_READY:()=>rc,EVENT_MERCH_OFFER_SELECT_READY:()=>ac,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ie,EVENT_MERCH_SEARCH_CHANGE:()=>cc,EVENT_MERCH_SIDENAV_SELECT:()=>ca,EVENT_MERCH_STOCK_CHANGE:()=>nc,EVENT_MERCH_STORAGE_CHANGE:()=>oc,EVENT_OFFER_SELECTED:()=>ic,EVENT_TYPE_FAILED:()=>va,EVENT_TYPE_READY:()=>pr,EVENT_TYPE_RESOLVED:()=>ue,Env:()=>be,FF_ANNUAL_PRICE:()=>at,FF_DEFAULTS:()=>ke,HEADER_X_REQUEST_ID:()=>Mt,LOG_NAMESPACE:()=>xa,Landscape:()=>Ie,MARK_DURATION_SUFFIX:()=>Ta,MARK_START_SUFFIX:()=>Ca,MERCH_CARD_LOAD_TIMEOUT:()=>aa,MODAL_TYPE_3_IN_1:()=>Ge,NAMESPACE:()=>Qs,PARAM_AOS_API_KEY:()=>pc,PARAM_ENV:()=>ya,PARAM_LANDSCAPE:()=>wa,PARAM_MAS_PREVIEW:()=>ba,PARAM_WCS_API_KEY:()=>mc,PROVIDER_ENVIRONMENT:()=>Aa,SELECTOR_MAS_CHECKOUT_LINK:()=>ji,SELECTOR_MAS_ELEMENT:()=>ia,SELECTOR_MAS_INLINE_PRICE:()=>$,SELECTOR_MAS_SP_BUTTON:()=>tc,SELECTOR_MAS_UPT_LINK:()=>Wi,SORT_ORDER:()=>fe,STATE_FAILED:()=>ge,STATE_PENDING:()=>Ne,STATE_RESOLVED:()=>Te,SUPPORTED_COUNTRIES:()=>ka,TAG_NAME_SERVICE:()=>ec,TEMPLATE_PRICE:()=>gc,TEMPLATE_PRICE_ANNUAL:()=>vc,TEMPLATE_PRICE_LEGAL:()=>ae,TEMPLATE_PRICE_STRIKETHROUGH:()=>fc,TRIAL_ANALYTICS_IDS:()=>Yi,Term:()=>he,WCS_PROD_URL:()=>Ea,WCS_STAGE_URL:()=>Sa});var $e=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),he=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Qs="merch",aa=2e4,Js="hidden",pr="wcms:commerce:ready",ec="mas-commerce-service",$='span[is="inline-price"][data-wcs-osi]',ji='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',tc="sp-button[data-wcs-osi]",Wi='a[is="upt-link"]',ia=`${$},${ji},${Wi}`,Yi=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]),rc="merch-offer:ready",ac="merch-offer-select:ready",na="merch-card:action-menu-toggle",ic="merch-offer:selected",nc="merch-stock:change",oc="merch-storage:change",ie="merch-quantity-selector:change",mr="merch-card-quantity:change",sc="merch-modal:addon-and-quantity-update",cc="merch-search:change",oa="merch-card-collection:sort",me="merch-card-collection:literals-changed",Pt="merch-card-collection:sidenav-attached",sa="merch-card-collection:showmore",ca="merch-sidenav:select",la="aem:load",da="aem:error",ur="mas:ready",ha="mas:error",lc="mas-compare-chart:rehydrate",dc="expanded-groups-change",pa="placeholder-failed",ma="placeholder-pending",ua="placeholder-resolved",ga="Bad WCS request",fa="Commerce offer not found",hc="Literals URL not provided",va="mas:failed",ue="mas:resolved",xa="mas/commerce",ba="mas.preview",ya="commerce.env",wa="commerce.landscape",pc="commerce.aosKey",mc="commerce.wcsKey",Ea="https://www.adobe.com/web_commerce_artifact",Sa="https://www.stage.adobe.com/web_commerce_artifact_stage",ge="failed",Ne="pending",Te="resolved",Ie={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Mt="X-Request-Id",ne=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),uc="UCv3",be=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Aa={PRODUCTION:"PRODUCTION"},Ge={TWP:"twp",D2P:"d2p",CRM:"crm"},Ca=":start",Ta=":duration",gc="price",fc="price-strikethrough",vc="annual",ae="legal",ke="mas-ff-defaults",at="mas-ff-annual-price",fe={alphabetical:"alphabetical",authored:"authored"},ka=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var xc="mas-commerce-service";function Xi(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Rt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function ye(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,s]of Object.entries(r))i.setAttribute(n,s);return i}function gr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function La(){return window.matchMedia("(max-width: 1024px)").matches}function Ot(){return document.getElementsByTagName(xc)?.[0]}function Nt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var bc=["adobe.com","adobeioruntime.net","aem.live","aem.page"],yc=["localhost","127.0.0.1"];function Ki(e){try{let r=new URL(e);return yc.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:bc.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as fr,nothing as wc}from"./lit-all.min.js";var it,It=class It{constructor(r){g(this,"card");_(this,it);this.card=r,this.insertVariantStyle()}getContainer(){return T(this,it,v(this,it)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,it)}insertVariantStyle(){let r=this.constructor.name;if(!It.styleMap[r]){It.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),s=parseInt(n.style.getPropertyValue(a))||0;i>s&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(s=>s.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:s}of r){let o=`--consonant-merch-card-${a}-${s}-height`;t.style.getPropertyValue(o)&&t.style.removeProperty(o)}let n=new Map;for(let s of i){let o=s.getBoundingClientRect();if(o.width<=2)continue;let c=Math.round(o.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(s)}for(let s of n.values())for(let{name:o,getElement:c}of r){let l=`--consonant-merch-card-${a}-${o}-height`,d=s.map(h=>h.style.getPropertyValue(l)),m=0,u=s.map(h=>{h.style.removeProperty(l);let p=c(h);if(!p)return p;let f=Math.max(0,parseInt(window.getComputedStyle(p).height)||0);return f>m&&(m=f),p});s.forEach((h,p)=>{u[p]?.tagName!=="HR"&&(m>0?h.style.setProperty(l,`${m}px`):d[p]&&h.style.setProperty(l,d[p]))})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),fr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as zt,css as Sc}from"./lit-all.min.js";var Ji=`
:root {
...
`;var xr=class extends w{constructor(r){super(r)}getGlobalCSS(){return tn}renderLayout(){return rn` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":rn`<hr />`} ${this.secureLabelFooter}`}};import{html as ze,css as Ac,unsafeCSS as nn}from"./lit-all.min.js";var an=`
  :root {
...
`;var Cc=32,on={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},ot=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?ze`<slot name="secure-transaction-label">
    ...
    `);import{html as br,css as Tc,unsafeCSS as Ma,nothing as kc}from"./lit-all.min.js";var sn=`
  :root {
...
`;var _c=32,cn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},we,st=class extends w{constructor(t){super(t);_(this,we);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>br` <footer>
        ...
        @media screen and ${Ma(k)} {
            :host([variant='mini-compare-chart-mweb']) footer {
                padding: 0;
            }
        }

        @media screen and ${Ma(R)} {
            :host([variant='mini-compare-chart-mweb'])
                .price-wrapping
                > slot[name='subtitle'] {
                min-height: var(
    ...
    `);import{html as Dt,css as Lc,nothing as yr}from"./lit-all.min.js";var ln=`
:root {
...
`;var wr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},dn={...(function(){let{whatsIncluded:e,size:r,...t}=wr;return t})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},hn={...(function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=wr;return i})()},Ee,Se,oe=class extends w{constructor(t){super(t);_(this,Ee);_(this,Se);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===ae&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ln}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,s=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(o.includes("wide")||(s?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(o)){if(s?.classList.toggle("wide-footer",L.isDesktopOrUp),!i&&c){if(l)c.remove();else{let m=d.querySelector(`[data-placeholder-for="${t}"]`);m?m.replaceWith(c):d.appendChild(c)}return}if(i&&l){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",t),m.classList.add("slot-placeholder"),!c){let u=l.cloneNode(!0);s.prepend(u)}l.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],L.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],L.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,Ee)||(T(this,Ee,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Ee)?.disconnect(),T(this,Ee,null),this.syncHeights())})),v(this,Ee).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,s=document.createElement("div");s.classList.add("spacer"),a.insertBefore(s,n);let o=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Nt(d));let m=this.card.querySelector('[slot="subtitle"]');m&&(l+=Nt(m));let u=this.card.querySelector('[slot="heading-m"]');u&&(l+=8+Nt(u));for(let p of a.childNodes){if(p.classList.contains("spacer"))break;l+=Nt(p)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${$}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Dt`<div class="divider"></div>`:yr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${$}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let s=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),s.setAttribute("data-template","legal"),n.parentNode.insertBefore(s,n.nextSibling),await s.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?Dt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Ee=new WeakMap,Se=new WeakMap,g(oe,"variantStyle",Lc`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),g(oe,"collectionOptions",{customHeaderArea:t=>t.sidenav?Dt`<slot name="resultsText"></slot>`:yr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let a=()=>{let i=t.querySelectorAll("merch-card");for(let s of i)s.hasAttribute("data-size")&&(s.setAttribute("size",s.getAttribute("data-size")),s.removeAttribute("data-size"));if(!L.isDesktop)return;let n=0;for(let s of i){if(s.style.display==="none")continue;let o=s.getAttribute("size"),c=o==="wide"?2:o==="super-wide"?3:1;c===2&&n%3===2&&(s.setAttribute("data-size",o),s.removeAttribute("size"),c=1),n+=c}};L.matchDesktop.addEventListener("change",a),t.addEventListener(me,a),t.onUnmount.push(()=>{L.matchDesktop.removeEventListener("change",a),t.removeEventListener(me,a)})}});import{html as _e,css as Pc,unsafeCSS as mn,nothing as Er}from"./lit-all.min.js";var pn=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(L.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?L.isMobile?_e`
        ...
        `:_e`
            ...
            <slot></slot>`}};g(De,"variantStyle",Pc`
    ...
    `),g(De,"collectionOptions",{customHeaderArea:r=>r.sidenav?_e`<slot name="resultsText"></slot>`:Er,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let t=()=>{let a=r.querySelectorAll("merch-card");if(a.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!L.isDesktop)return;let i=0;a.forEach(n=>{if(n.style.display==="none")return;let s=n.getAttribute("size"),o=s==="wide"?2:s==="super-wide"?3:1;o===2&&i%3===2&&(n.setAttribute("data-size",s),n.removeAttribute("size"),o=1),i+=o})};L.matchDesktop.addEventListener("change",t),r.addEventListener(me,t),r.onUnmount.push(()=>{L.matchDesktop.removeEventListener("change",t),r.removeEventListener(me,t)})}});import{html as Le,css as Mc,nothing as ct,unsafeCSS as Ht}from"./lit-all.min.js";var gn=`
:root {
...
`;var[Cp,Tp,fn,vn,xn,bn]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Ar="pro",Ra=`--consonant-merch-card-${Ar}-top-card-height`,Sr=[{prop:`--consonant-merch-card-${Ar}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Ar}-name-description-height`,selector:".name-description"}],yn=`--consonant-merch-card-${Ar}-strike-reserve`,Oa='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',Rc="(min-width: 768px)",wn={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Pe,Ve,$t,Gt,Y,En,Ft,Sn,Bt,Na,Cr,Tr=class Tr extends w{constructor(t){super(t);_(this,Y);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);_(this,Pe,null);_(this,Ve,null);_(this,$t,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);_(this,Gt,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of W(this,Y,En).call(this)){let n=i.variantLayout;n instanceof Tr&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?W(this,Y,Na).call(this):W(this,Y,Bt).call(this),this.card.requestUpdate()});_(this,Cr,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case vn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:W(this,Y,Bt).call(this);break;case fn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:W(this,Y,Bt).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case xn:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}W(this,Y,Bt).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),W(this,Y,Na).call(this);break;case bn:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,W(this,Y,Ft).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(ie,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return gn}priceOptionsProvider(t,a){t.dataset.template===ae&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(ue,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let a=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=a?.querySelector(".price-plan-type");if(!i)return;i.textContent=t;let n=a.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${$}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:s}=this.card.placeholders??{},o=document.createElement("p");if(o.className="whats-included-label",o.textContent=n??"",i.after(o),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),s){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=s,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=Ra,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(Rc).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let s=new Map;for(let c of n){let l=s.get(c.offsetTop)??[];l.push(c),s.set(c.offsetTop,l)}let o=(c,l)=>c.reduce((d,m)=>{let u=l(m);return u?Math.max(d,parseInt(getComputedStyle(u).height)||0):d},0);for(let c of s.values()){if(c.forEach(u=>this.clearSyncedHeights(u)),c.length<2)continue;let l=c.map(u=>u.querySelector(Oa)&&parseInt(getComputedStyle(u.querySelector(Oa)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((u,h)=>{let p=d-l[h];p>0&&u.style.setProperty(yn,`${p}px`)});for(let u of Sr){let h=o(c,p=>p.shadowRoot?.querySelector(u.selector));h>0&&c.forEach(p=>p.style.setProperty(u.prop,`${h}px`))}let m=o(c,u=>u.shadowRoot?.querySelector(".top-card"));m>0&&c.forEach(u=>u.style.setProperty(i,`${m}px`))}}clearSyncedHeights(t){t.style.removeProperty(Ra),t.style.removeProperty(yn),Sr.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,s=this.card)=>Math.round(s?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(Oa),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(mr,v(this,Gt)),this.card.addEventListener(ie,this.updatePriceQuantity),this.card.addEventListener(ue,v(this,$t)),typeof ResizeObserver>"u"))return;T(this,Ve,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Ve).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Ve).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ie,this.updatePriceQuantity),this.card?.removeEventListener(ue,v(this,$t)),W(this,Y,Ft).call(this),v(this,Ve)?.disconnect(),this.card?.removeEventListener(mr,v(this,Gt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let s=[];for(let o=a;o<=i;o+=n)s.push(String(o));return s}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(s=>s.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Le`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Le`
        ...
        `}renderLayout(){let t=!!this.expanded;return Le`
            ...
            <slot></slot>
        `}};Pe=new WeakMap,Ve=new WeakMap,$t=new WeakMap,Gt=new WeakMap,Y=new WeakSet,En=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},Ft=function(){v(this,Pe)&&(document.removeEventListener("mousedown",v(this,Pe)),T(this,Pe,null))},Sn=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},Bt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=W(this,Y,Sn).call(this),v(this,Pe)||(T(this,Pe,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),W(this,Y,Ft).call(this))}),document.addEventListener("mousedown",v(this,Pe)))},Na=function(){this.licenseOpen=!1,W(this,Y,Ft).call(this)},Cr=new WeakMap,g(Tr,"variantStyle",Mc`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Ut=Tr;import{html as Ia,css as Oc}from"./lit-all.min.js";var An=`
:root {
...
`;var Cn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ae,lt=class extends w{constructor(t){super(t);_(this,Ae);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return An}priceOptionsProvider(t,a){t.dataset.template===ae&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return Ia` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){this.handleResize=()=>{v(this,Ae)&&cancelAnimationFrame(v(this,Ae)),T(this,Ae,requestAnimationFrame(()=>{T(this,Ae,null),this.postCardUpdateHook()}))},this.adjustShortDescriptionBound=this.adjustShortDescription.bind(this),window.addEventListener("resize",this.handleResize),this.card.addEventListener(ie,this.updatePriceQuantity),this.card.addEventListener(ur,this.adjustShortDescriptionBound)}disconnectedCallbackHook(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),v(this,Ae)&&(cancelAnimationFrame(v(this,Ae)),T(this,Ae,null)),this.card.removeEventListener(ie,this.updatePriceQuantity),this.card.removeEventListener(ur,this.adjustShortDescriptionBound)}adjustShortDescription(){let t=this.card.querySelector('[slot="short-description"]');if(!t?.textContent?.trim())return;let a=this.card.querySelector('span[data-template="legal"]');if(!a)return;this.card.querySelector(".merch-short-description")?.remove();let i=document.createElement("span");i.className="merch-short-description",i.innerHTML=t.innerHTML,i.querySelectorAll("p").forEach(n=>n.replaceWith(...n.childNodes)),i.querySelectorAll(".icon-button").forEach(n=>{n.dataset.eventsWired||(n.dataset.eventsWired="1",["mouseenter","focus"].forEach(s=>n.addEventListener(s,()=>n.classList.add("tooltip-visible"))),["mouseleave","blur"].forEach(s=>n.addEventListener(s,()=>n.classList.remove("tooltip-visible"))),n.addEventListener("keydown",s=>{s.key==="Escape"&&n.classList.remove("tooltip-visible")}))}),a.after(i),t.hidden=!0}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),L.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),t.closest('[slot="heading-xs"]').appendChild(a),await a.onceSettled(),a.querySelector(".price-unit-type")?.remove()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${$}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}toggleAddon(t){let a=this.mainPrice,i=this.headingXSSlot;if(!a&&i){let n=t?.getAttribute("plan-type"),s=null;if(t&&n&&(s=t.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(o=>o.remove()),t.checked){if(s){let o=ye("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},s.innerHTML);this.card.appendChild(o)}}else{let o=ye("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(o)}}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let a=this.mainPrice,i=this.card.planType;a&&(await a.onceSettled?.(),i=a.value?.[0]?.planType),i&&(t.planType=i)}};Ae=new WeakMap,g(lt,"variantStyle",Oc`
    ...
    `);import{html as za,css as Nc}from"./lit-all.min.js";var Tn=`
:root {
...
`;var kn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},dt=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===ae&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return Tn}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${$}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return za`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Ic,css as zc}from"./lit-all.min.js";var _n=`
...
`;var Ln={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},ht=class extends w{constructor(r){super(r)}getGlobalCSS(){return _n}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Ic`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as Da,css as Dc}from"./lit-all.min.js";var Pn=`
:root {
...
`;var Mn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},pt=class extends w{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Pn}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${$}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Da`${this.cardImage}
            ...
            ${this.evergreen?Da`
                  ...
                  `:Da`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(pt,"variantStyle",Dc`
    ...
    `);import{html as On,css as Hc}from"./lit-all.min.js";var Rn=`
:root {
...
`;var Ha={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},mt=class extends w{getGlobalCSS(){return Rn}get aemFragmentMapping(){return Ha}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return On`<div
    ...
    `);import{html as In,css as Fc}from"./lit-all.min.js";var Nn=`
:root {
...
`;var Fa={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},qt=class qt extends w{getGlobalCSS(){return Nn}get aemFragmentMapping(){return Fa}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return In`<div
        ...
        >
            ...
            <slot></slot>
        `}};g(qt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(qt,"variantStyle",Fc`
    ...
    `);var Vt=qt;import{html as jt,css as Bc,nothing as Dn}from"./lit-all.min.js";var zn=`
...
`;var Hn={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},Uc=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],ut=class extends w{constructor(r){super(r)}getGlobalCSS(){return zn}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return jt`
    ...
    `);import{css as $c,html as Gc}from"./lit-all.min.js";var Fn=`
...
`;var Bn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},gt=class extends w{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Fn}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${$}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Gc`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as qc,css as Vc}from"./lit-all.min.js";var Un=`
...
`;var Ba={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},jc=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],kr,$n,ft=class extends w{constructor(t){super(t);_(this,kr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Un}get aemFragmentMapping(){return Ba}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,W(this,kr,$n).call(this))}renderLayout(){return qc`
            <div class="card">
            ...
            <slot></slot>
        `}};kr=new WeakSet,$n=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;jc.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(ft,"variantStyle",Vc`
    ...
    `);import{html as Wc,css as Yc}from"./lit-all.min.js";var Gn=`
...
`;var Ua={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},vt=class extends w{getGlobalCSS(){return Gn}get aemFragmentMapping(){return Ua}renderLayout(){return Wc`
    ...
    `);var qn=new Map;var q=(e,r,t=null,a=null,i)=>{qn.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};q("catalog",nt,Qi,nt.variantStyle);q("image",qe);q("inline-heading",xr);q("mini-compare-chart",ot,on,ot.variantStyle);q("mini-compare-chart-mweb",st,cn,st.variantStyle);q("plans",oe,wr,oe.variantStyle,oe.collectionOptions);q("plans-students",oe,hn,oe.variantStyle,oe.collectionOptions);q("plans-education",oe,dn,oe.variantStyle,oe.collectionOptions);q("plans-v2",De,un,De.variantStyle,De.collectionOptions);q("pro",Ut,wn,Ut.variantStyle);q("product",lt,Cn,lt.variantStyle);q("segment",dt,kn,dt.variantStyle);q("media",ht,Ln,ht.variantStyle);q("headless",ut,Hn,ut.variantStyle);q("special-offers",pt,Mn,pt.variantStyle);q("simplified-pricing-express",mt,Ha,mt.variantStyle);q("full-pricing-express",Vt,Fa,Vt.variantStyle);q("mini",gt,Bn,gt.variantStyle);q("image",qe,en,qe.variantStyle);q("compare-chart-column",ft,Ba,ft.variantStyle);q("fries",vt,Ua,vt.variantStyle);function vr(e){return qn.get(e)?.fragmentMapping}var Vn="tacocat.js";var $a=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),jn=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function H(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let s=new URLSearchParams(window.location.search),o=xt(a)?a:e;n=s.get(o)}if(i&&n==null){let s=xt(i)?i:e;n=window.sessionStorage.getItem(s)??window.localStorage.getItem(s)}if(t&&n==null){let s=Kc(xt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${s}"]`)?.content}return n??r[e]}var Xc=e=>typeof e=="boolean",_r=e=>typeof e=="function",Lr=e=>typeof e=="number",Wn=e=>e!=null&&typeof e=="object";var xt=e=>typeof e=="string",Yn=e=>xt(e)&&e,bt=e=>Lr(e)&&Number.isFinite(e)&&e>0;function Pr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function E(e,r){if(Xc(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Wt(e,r,t){let a=Object.values(r);return a.find(i=>$a(i,e))??t??a[0]}function Kc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function Xn(e,r=1){return Lr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var Zc=Date.now(),Ga=()=>`(+${Date.now()-Zc}ms)`,Mr=new Set,Qc=E(H("tacocat.debug",{},{metadata:!1}),!1);function Kn(e){let r=`[${Vn}/${e}]`,t=(s,o,...c)=>s?!0:(i(o,...c),!1),a=Qc?(s,...o)=>{console.debug(`${r} ${s}`,...o,Ga())}:()=>{},i=(s,...o)=>{let c=`${r} ${s}`;Mr.forEach(([l])=>l(c,...o))};return{assert:t,debug:a,error:i,warn:(s,...o)=>{let c=`${r} ${s}`;Mr.forEach(([,l])=>l(c,...o))}}}function Jc(e,r){let t=[e,r];return Mr.add(t),()=>{Mr.delete(t)}}Jc((e,...r)=>{console.error(e,...r,Ga())},(e,...r)=>{console.warn(e,...r,Ga())});var el="no promo",Zn="promo-tag",tl="yellow",rl="neutral",al=(e,r,t)=>{let a=n=>n||el,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Rr="cancel-context",Or=(e,r)=>{let t=e===Rr,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,s=n?e||r:void 0;return{effectivePromoCode:s,overridenPromoCode:e,className:n?Zn:`${Zn} no-promo`,text:al(s,r,i),variant:n?tl:rl,isOverriden:i}};var qa;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(qa||(qa={}));var de;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(de||(de={}));var pe;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(pe||(pe={}));var Va;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Va||(Va={}));var ja;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ja||(ja={}));var Wa;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(Wa||(Wa={}));var Ya;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Ya||(Ya={}));var Xa="ABM",Ka="PUF",Za="M2M",Qa="PERPETUAL",Ja="P3Y",il="TAX_INCLUSIVE_DETAILS",nl="TAX_EXCLUSIVE",Qn={ABM:Xa,PUF:Ka,M2M:Za,PERPETUAL:Qa,P3Y:Ja},Pu={[Xa]:{commitment:de.YEAR,term:pe.MONTHLY},[Ka]:{commitment:de.YEAR,term:pe.ANNUAL},[Za]:{commitment:de.MONTH,term:pe.MONTHLY},[Qa]:{commitment:de.PERPETUAL,term:void 0},[Ja]:{commitment:de.THREE_MONTHS,term:pe.P3Y}},Jn="Value is not an offer",Nr=e=>{if(typeof e!="object")return Jn;let{commitment:r,term:t}=e,a=ol(r,t);return{...e,planType:a}};var ol=(e,r)=>{switch(e){case void 0:return Jn;case"":return"";case de.YEAR:return r===pe.MONTHLY?Xa:r===pe.ANNUAL?Ka:"";case de.MONTH:return r===pe.MONTHLY?Za:"";case de.PERPETUAL:return Qa;case de.TERM_LICENSE:return r===pe.P3Y?Ja:"";default:return""}};function eo(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:s}=r;if(s!==il)return e;let o={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:nl}};return o.offerType==="TRIAL"&&o.priceDetails.price===0&&(o.priceDetails.price=o.priceDetails.priceWithoutDiscount),o}var je={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},to=1e3;function sl(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function ro(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!je.serializableTypes.includes(t))return t}return e}function cl(e,r){if(!je.ignoredProperties.includes(e))return ro(r)}var ei={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(sl(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(ro).join(" ")}`);let{pathname:s,search:o}=window.location,c=`${je.delimiter}page=${s}${o}`;c.length>to&&(c=`${c.slice(0,to)}<trunc>`),n+=c,i.length&&(n+=`${je.delimiter}facts=`,n+=JSON.stringify(i,cl)),window.lana?.log(n,je)}};function Ir(e){Object.assign(je,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in je&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var ao={LOCAL:"local",PROD:"prod",STAGE:"stage"},ti={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},ri=new Set,ai=new Set,io=new Map,no={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},oo={filter:({level:e})=>e!==ti.DEBUG},ll={filter:()=>!1};function dl(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&_r(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function hl(e){[...ai].every(r=>r(e))&&ri.forEach(r=>r(e))}function so(e){let r=(io.get(e)??0)+1;io.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>so(`${a.namespace}/${i}`),updateConfig:Ir};return Object.values(ti).forEach(i=>{a[i]=(n,...s)=>hl(dl(i,n,e,s,t))}),Object.seal(a)}function zr(...e){e.forEach(r=>{let{append:t,filter:a}=r;_r(a)&&ai.add(a),_r(t)&&ri.add(t)})}function pl(e={}){let{name:r}=e,t=E(H("commerce.debug",{search:!0,storage:!0}),r===ao.LOCAL);return zr(t?no:oo),r===ao.PROD&&zr(ei),se}function ml(){ri.clear(),ai.clear()}var se={...so(xa),Level:ti,Plugins:{consoleAppender:no,debugFilter:oo,quietFilter:ll,lanaAppender:ei},init:pl,reset:ml,use:zr};var ul="mas-commerce-service",gl=se.module("utilities"),fl={requestId:Mt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Yt(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,s)=>n.language===i?-1:s.language===i?1:0),e.sort((n,s)=>!n.term&&s.term?-1:n.term&&!s.term?1:0),a=[e[0]]}return t&&(a=a.map(eo)),a}var co=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function ii(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let o of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let m=l.includes(".")?r.priceDetails?.formatString:r[l],u=l.includes(".")?o.priceDetails?.formatString:o[l];u!==m&&gl.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:m,actual:u})}}let a=[["price",o=>o.priceDetails?.price],["priceWithoutDiscount",o=>o.priceDetails?.priceWithoutDiscount],["priceWithoutTax",o=>o.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",o=>o.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[o,c]of a){let l=co(e,c);l!==void 0&&(i[o]=l)}let n=e.some(o=>o.priceDetails?.annualized),s;if(n){let o=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];s={};for(let[c,l]of o){let d=co(e,l);d!==void 0&&(s[c]=d)}}return{...r,offerSelectorIds:e.flatMap(o=>o.offerSelectorIds||[]),priceInfo:void 0,priceDetails:{...r.priceDetails,...i,...s&&{annualized:s}}}}var Dr=e=>window.setTimeout(e);function yt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(Xn).filter(bt);return t.length||(t=[r]),t}function Hr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(Yn)}function ce(){return document.getElementsByTagName(ul)?.[0]}function lo(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(fl)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var wt=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(Mt);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var vl={[ge]:pa,[Ne]:ma,[Te]:ua},xl={[ge]:va,[Te]:ue},Xt,He=class{constructor(r){_(this,Xt);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",Ne);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=se.module("mas-element")}update(){[ge,Ne,Te].forEach(r=>{this.wrapperElement.classList.toggle(vl[r],r===this.state)})}notify(){(this.state===Te||this.state===ge)&&(this.state===Te?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ge&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof wt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(xl[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){T(this,Xt,ce()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return Te===a?Promise.resolve(this.wrapperElement):ge===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=Te,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Dr(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=ge,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,Xt)?.duration}),Dr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=Ne,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!ce()||this.timer)return;let{error:t,options:a,state:i,value:n,version:s}=this;this.state=Ne,this.timer=Dr(async()=>{this.timer=null;let o=null;if(this.changes.size&&(o=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:o}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:o})),o||r)try{await this.wrapperElement.render?.()===!1&&this.state===Ne&&this.version===s&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};Xt=new WeakMap;function ho(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function Fr(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,ho(r)),i}function po(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,ho(r)),e):null}function bl(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Xe,We=class We extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new He(this));_(this,Xe);this.setAttribute("is",We.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),T(this,Xe,Ot()),v(this,Xe)&&(this.log=v(this,Xe).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),T(this,Xe,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Ot();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(s=>{s&&(this.dataset.imsCountry=s)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[s]]=await Promise.all(n),{country:o,language:c,env:l}=a,d=`locale=${c}_${o}&country=${o}&offer_id=${s.offerId}`,m=this.getAttribute("data-promotion-code");m&&(d+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${bl(l)}?${d}`,this.masElement.toggleResolved(i,s,a)}catch(s){let o=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,s.message);return this.masElement.toggleFailed(i,o,a),!1}}static createFrom(t){let a=new We;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};Xe=new WeakMap,g(We,"is","upt-link"),g(We,"tag","a"),g(We,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Ye=We;window.customElements.get(Ye.is)||window.customElements.define(Ye.is,Ye,{extends:Ye.tag});function mo(e){return e&&(e==="bizpro"&&(e="pro"),e==="pro"||e.startsWith("plans")?"plans":e)}var yl="p_draft_landscape",wl="/store/",El=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),ni=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Sl=["env","workflowStep","clientId","country"],Al=["/tw/","/hk_zh/"];function Cl(e){let r=e??"";return Al.some(t=>r.startsWith(t))}function Tl(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(Cl)}function oi(e){if(!Tl())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var uo=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),go=e=>El.get(e)??e;function Br(e,r,t){for(let[a,i]of Object.entries(e)){let n=go(a);i!=null&&t.has(n)&&r.set(n,i)}}function kl(e){return e===Aa.PRODUCTION?"https://commerce.adobe.com":"https://commerce-stg.adobe.com"}function _l(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let s=go(i);r.set(`items[${t}][${s}]`,n)}}}function Ll({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===Ge.CRM?"creative":"mini_plans"),e}function Pl(e){let r=e.indexOf("?");return r===-1?e:e.slice(0,r)}function Ml(e){let r=new URLSearchParams(window.location.search),t={};uo.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=Pl(i))}),Object.keys(t).length>0&&Br(t,e.searchParams,uo)}function fo(e){Rl(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:s,productArrangementCode:o,landscape:c,modal:l,is3in1:d,preselectPlan:m,...u}=e,h=new URL(kl(r));if(h.pathname=`${wl}${a}`,a!==ne.SEGMENTATION&&a!==ne.CHANGE_PLAN_TEAM_PLANS&&_l(t,h.searchParams),Br({...u},h.searchParams,ni),Ml(h),c===Ie.DRAFT&&Br({af:yl},h.searchParams,ni),a===ne.SEGMENTATION){let p={marketSegment:i,offerType:s,customerSegment:n,productArrangementCode:o,quantity:t?.[0]?.quantity,addonProductArrangementCode:o?t?.find(f=>f.productArrangementCode!==o)?.productArrangementCode:t?.[1]?.productArrangementCode};m?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):m?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),Br(p,h.searchParams,ni),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=Ll({url:h,modal:l,is3in1:d})}return oi(h)}function Rl(e){for(let r of Sl)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==ne.SEGMENTATION&&e.workflowStep!==ne.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var Ol=/[0-9\-+#]/,Nl=/[^\d\-+#]/g;function vo(e){return e.search(Ol)}function Il(e="#.##"){let r={},t=e.length,a=vo(e);r.prefix=a>0?e.substring(0,a):"";let i=vo(e.split("").reverse().join("")),n=t-i,s=e.substring(n,n+1),o=n+(s==="."||s===","?1:0);r.suffix=i>0?e.substring(o,t):"",r.mask=e.substring(a,o),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(Nl);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function zl(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[s="0",o=""]=i.value.split(".");return(!o||o&&o.length<=n)&&(o=n<0?"":(+`0.${o}`).toFixed(n+1).replace("0.","")),i.integer=s,i.fraction=o,Dl(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function Dl(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let s=e.integer.length,o=s%n;for(let c=0;c<s;c++)e.result+=e.integer.charAt(c),!((c-o+1)%n)&&c<s-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function Hl(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=Il(e),i=zl(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var xo=Hl;var bo=".",Fl=",",li=/^\s+/,di=/\s+$/,yo="&nbsp;",si=e=>e*12,Ze=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:s,minProductQuantity:o=1,outcomeType:c}={}}=e;if(!(n&&s&&c)||t<o)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),m=new Date(i);return l>=d&&l<=m},Ke={MONTH:"MONTH",YEAR:"YEAR"},Bl={[he.ANNUAL]:12,[he.MONTHLY]:1,[he.THREE_YEARS]:36,[he.TWO_YEARS]:24},ci=(e,r)=>({accept:e,round:r}),Ul=[ci(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),ci(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),ci(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],hi={[$e.YEAR]:{[he.MONTHLY]:Ke.MONTH,[he.ANNUAL]:Ke.YEAR},[$e.MONTH]:{[he.MONTHLY]:Ke.MONTH}},$l=(e,r)=>e.indexOf(`'${r}'`)===0,Gl=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=pi(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${ql(e)}`),t},wo=e=>{let r=Vl(e),t=$l(e,r),a=e.replace(/'.*?'/,""),i=li.test(a)||di.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},Eo=e=>e.replace(li,yo).replace(di,yo),ql=e=>e.match(/#(.?)#/)?.[1]===bo?Fl:bo,Vl=e=>e.match(/'(.*?)'/)?.[1]??"",pi=e=>e.match(/0(.?)0/)?.[1]??"",jl=(e,r,t)=>{if(typeof e!="string"||!e)return null;let{currencySymbol:a,isCurrencyFirst:i,hasCurrencySpace:n}=wo(r),s=t?pi(r):"",o=e;if(a){if(!o.includes(a))return null;o=o.replace(a,"")}o=o.replace(li,"").replace(di,"");let c=t?o.lastIndexOf(s):o.length,l=o.substring(0,c),d=o.substring(c+1);return(t&&s?`${l}${s}${d}`:l)!==o?null:{currencySymbol:a,decimals:d,decimalsDelimiter:s,hasCurrencySpace:n,integer:l,isCurrencyFirst:i}},So=({priceInfo:e,showWithoutDiscount:r,taxExclusive:t,displayAnnual:a,promotion:i})=>a?i?void 0:t?e.annualized?.annualizedPriceWithoutTax:e.annualized?.annualizedPrice:r?t?e.priceWithoutDiscountAndTax:e.priceWithoutDiscount:t?e.priceWithoutTax:e.price;function Et({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1,formatted:i},n,s=o=>o){if(i!=null&&!a){let b=jl(i,e,t);if(b)return{accessiblePrice:i,recurrenceTerm:n,...b}}let{currencySymbol:o,isCurrencyFirst:c,hasCurrencySpace:l}=wo(e),d=t?pi(e):"",m=Gl(e,t),u=t?2:0,h=s(r,{currencySymbol:o}),p=a?h.toLocaleString("hi-IN",{minimumFractionDigits:u,maximumFractionDigits:u}):xo(m,h),f=t?p.lastIndexOf(d):p.length,x=p.substring(0,f),y=p.substring(f+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,p).replace(/SYMBOL/,o),currencySymbol:o,decimals:y,decimalsDelimiter:d,hasCurrencySpace:l,integer:x,isCurrencyFirst:c,recurrenceTerm:n}}var Ao=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=Bl[t]??1;return Et(e,i>1?Ke.MONTH:hi[r]?.[t],n=>{let s={divisor:i,price:n,usePrecision:a},{round:o}=Ul.find(({accept:c})=>c(s));if(!o)throw new Error(`Missing rounding rule for: ${JSON.stringify(s)}`);return o(s)})},Co=({commitment:e,term:r,...t})=>Et(t,hi[e]?.[r]),To=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:s,quantity:o=1,term:c}=e;if(r===$e.YEAR&&c===he.MONTHLY){if(!s)return Et(e,Ke.YEAR,si);let{displaySummary:{outcomeType:l,duration:d}={}}=s;switch(l){case"PERCENTAGE_DISCOUNT":if(Ze(s,t,o)){let m=parseInt(d.replace("P","").replace("M",""));if(isNaN(m))return si(a);let u=i*m,h=n*(12-m),p=Math.round((u+h)*100)/100;return Et({...e,price:p},Ke.YEAR)}default:return Et(e,Ke.YEAR,()=>si(n??a))}}return Et(e,hi[r]?.[c])};var ko="download",_o="upgrade",Lo={e:"EDU",t:"TEAM"};function Po(e,r={},t=""){let a=ce();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:s,entitlement:o,upgrade:c,modal:l,perpetual:d,promotionCode:m,quantity:u,wcsOsi:h,extraOptions:p,analyticsId:f}=a.collectCheckoutOptions(r),x=Fr(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:s,entitlement:o,upgrade:c,modal:l,perpetual:d,promotionCode:r.promotionCode===Rr?Rr:m,quantity:u,wcsOsi:h,extraOptions:p,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function Mo(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new He(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0].marketSegments?.[0];return Lo[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return Lo[a]??a}get is3in1Modal(){return Object.values(Ge).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=ce();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let s;try{s=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let o=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>Yt(h,n));let d=l.flat().find(h=>h.promotion);!Ze(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let u=await i.buildCheckoutAction?.(l.flat(),{...s,...n},this);return this.renderOffers(l.flat(),n,{},u,o)}renderOffers(a,i,n={},s=void 0,o=void 0){let c=ce();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},o??(o=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),s){this.classList.remove(ko,_o),this.masElement.toggleResolved(o,a,i);let{url:d,text:m,className:u,handler:h}=s;d&&this.setCheckoutUrl(oi(d)),m&&(this.firstElementChild.innerHTML=m),u&&this.classList.add(...u.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(a.length){if(this.masElement.toggleResolved(o,a,i)){if(!this.classList.contains(ko)&&!this.classList.contains(_o)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(o,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(a){}updateOptions(a={}){let i=ce();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:s,checkoutWorkflowStep:o,entitlement:c,upgrade:l,modal:d,perpetual:m,promotionCode:u,quantity:h,wcsOsi:p}=i.collectCheckoutOptions(a);return po(this,{checkoutMarketSegment:n,checkoutWorkflow:s,checkoutWorkflowStep:o,entitlement:c,upgrade:l,modal:d,perpetual:m,promotionCode:u,quantity:h,wcsOsi:p}),!0}}}var Kt=class Kt extends Mo(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return Po(Kt,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(Kt,"is","checkout-link"),g(Kt,"tag","a");var Me=Kt;window.customElements.get(Me.is)||window.customElements.define(Me.is,Me,{extends:Me.tag});var O=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:ne.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:be.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Ie.PUBLISHED});function Ro({settings:e,providers:r}){function t(n,s){let{checkoutClientId:o,checkoutWorkflowStep:c,country:l,language:d,promotionCode:m,quantity:u,preselectPlan:h,env:p}=e,f={checkoutClientId:o,checkoutWorkflowStep:c,country:l,language:d,promotionCode:m,quantity:u,preselectPlan:h,env:p};if(s)for(let Be of r.checkout)Be(s,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:y=c,imsCountry:S,country:b=S??l,language:A=d,quantity:D=u,entitlement:I,upgrade:B,modal:j,perpetual:Z,promotionCode:Q=m,wcsOsi:G,extraOptions:N,...ee}=Object.assign(f,s?.dataset??{},n??{}),te=Wt(y,ne,O.checkoutWorkflowStep);return f=Pr({...ee,extraOptions:N,checkoutClientId:o,checkoutMarketSegment:x,country:b,quantity:yt(D,O.quantity),checkoutWorkflowStep:te,language:A,entitlement:E(I),upgrade:E(B),modal:j,perpetual:E(Z),promotionCode:Or(Q).effectivePromoCode,wcsOsi:Hr(G),preselectPlan:h}),f}function a(n,s){if(!Array.isArray(n)||!n.length||!s)return"";let{env:o,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:m,country:u,promotionCode:h,quantity:p,preselectPlan:f,ms:x,cs:y,...S}=t(s),b=document.querySelector("meta[name=mas-ff-3in1]"),A=Object.values(Ge).includes(s.modal)&&(!b||b.content!=="off"),D=window.frameElement||A?"if":"fp",[{productArrangementCode:I,marketSegments:[B],customerSegment:j,offerType:Z}]=n,Q=x??B??d,G=y??j;f?.toLowerCase()==="edu"?Q="EDU":f?.toLowerCase()==="team"&&(G="TEAM");let N={is3in1:A,checkoutPromoCode:h,clientId:l,context:D,country:u,env:o,items:[],marketSegment:Q,customerSegment:G,offerType:Z,productArrangementCode:I,workflowStep:m,landscape:c,...S},ee=p[0]>1?p[0]:void 0;if(n.length===1){let{offerId:te}=n[0];N.items.push({id:te,quantity:ee})}else N.items.push(...n.map(({offerId:te,productArrangementCode:Be})=>({id:te,quantity:ee,...A?{productArrangementCode:Be}:{}})));return fo(N)}let{createCheckoutLink:i}=Me;return{CheckoutLink:Me,CheckoutWorkflowStep:ne,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}var Wl="ims_country_code";function Yl(){if(typeof document>"u")return null;let e=document.cookie.match(new RegExp(`(?:^|;\\s*)${Wl}=([^;]*)`));if(!e)return null;let r;try{r=decodeURIComponent(e[1])}catch{return null}return r.trim().toUpperCase()||null}function Xl({interval:e=200,maxAttempts:r=25}={}){let t=se.module("ims");return new Promise(a=>{t.debug("Waiting for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function Kl(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Zl(){let e=Yl();return e&&se.module("ims").debug("Got user country from cookie:",e),Promise.resolve(e)}function Oo(){let e=Xl();return{imsReadyPromise:e,imsSignedInPromise:Kl(e),imsCountryPromise:Zl()}}var No=window.masPriceLiterals;function Io(e){if(Array.isArray(No)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>No.find(n=>$a(n.lang,i)),a=t(r)??t(O.language);if(a)return Object.freeze(a)}return{}}var mi=function(e,r){return mi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},mi(e,r)};function Zt(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");mi(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var P=function(){return P=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},P.apply(this,arguments)};function Ur(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var C;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(C||(C={}));var F;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(F||(F={}));var Qe;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Qe||(Qe={}));function ui(e){return e.type===F.literal}function zo(e){return e.type===F.argument}function $r(e){return e.type===F.number}function Gr(e){return e.type===F.date}function qr(e){return e.type===F.time}function Vr(e){return e.type===F.select}function jr(e){return e.type===F.plural}function Do(e){return e.type===F.pound}function Wr(e){return e.type===F.tag}function Yr(e){return!!(e&&typeof e=="object"&&e.type===Qe.number)}function Qt(e){return!!(e&&typeof e=="object"&&e.type===Qe.dateTime)}var gi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var Ql=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function Ho(e){var r={};return e.replace(Ql,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var Fo=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Go(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(Fo).filter(function(u){return u.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],s=n.split("/");if(s.length===0)throw new Error("Invalid number skeleton");for(var o=s[0],c=s.slice(1),l=0,d=c;l<d.length;l++){var m=d[l];if(m.length===0)throw new Error("Invalid number skeleton")}t.push({stem:o,options:c})}return t}function Jl(e){return e.replace(/^(.*?)-/,"")}var Bo=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,qo=/^(@+)?(\+|#+)?[rs]?$/g,ed=/(\*)(0+)|(#+)(0+)|(0+)/g,Vo=/^(0+)$/;function Uo(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(qo,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function jo(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function td(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!Vo.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function $o(e){var r={},t=jo(e);return t||r}function Wo(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=Jl(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=P(P(P({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return P(P({},c),$o(l))},{}));continue;case"engineering":r=P(P(P({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return P(P({},c),$o(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(ed,function(c,l,d,m,u,h){if(l)r.minimumIntegerDigits=d.length;else{if(m&&u)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Vo.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(Bo.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(Bo,function(c,l,d,m,u,h){return d==="*"?r.minimumFractionDigits=l.length:m&&m[0]==="#"?r.maximumFractionDigits=m.length:u&&h?(r.minimumFractionDigits=u.length,r.maximumFractionDigits=u.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=P(P({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=P(P({},r),Uo(n)));continue}if(qo.test(i.stem)){r=P(P({},r),Uo(i.stem));continue}var s=jo(i.stem);s&&(r=P(P({},r),s));var o=td(i.stem);o&&(r=P(P({},r),o))}return r}var Jt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function Yo(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var s=1+(n&1),o=n<2?1:3+(n>>1),c="a",l=rd(r);for((l=="H"||l=="k")&&(o=0);o-- >0;)t+=c;for(;s-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function rd(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=Jt[a||""]||Jt[t||""]||Jt["".concat(t,"-001")]||Jt["001"];return i[0]}var fi,ad=new RegExp("^".concat(gi.source,"*")),id=new RegExp("".concat(gi.source,"*$"));function M(e,r){return{start:e,end:r}}var nd=!!String.prototype.startsWith,od=!!String.fromCodePoint,sd=!!Object.fromEntries,cd=!!String.prototype.codePointAt,ld=!!String.prototype.trimStart,dd=!!String.prototype.trimEnd,hd=!!Number.isSafeInteger,pd=hd?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},xi=!0;try{Xo=Jo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),xi=((fi=Xo.exec("a"))===null||fi===void 0?void 0:fi[0])==="a"}catch{xi=!1}var Xo,Ko=nd?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},bi=od?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,s;i>n;){if(s=r[n++],s>1114111)throw RangeError(s+" is not a valid code point");a+=s<65536?String.fromCharCode(s):String.fromCharCode(((s-=65536)>>10)+55296,s%1024+56320)}return a},Zo=sd?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],s=n[0],o=n[1];t[s]=o}return t},Qo=cd?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},md=ld?function(r){return r.trimStart()}:function(r){return r.replace(ad,"")},ud=dd?function(r){return r.trimEnd()}:function(r){return r.replace(id,"")};function Jo(e,r){return new RegExp(e,r)}var yi;xi?(vi=Jo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),yi=function(r,t){var a;vi.lastIndex=t;var i=vi.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):yi=function(r,t){for(var a=[];;){var i=Qo(r,t);if(i===void 0||ts(i)||vd(i))break;a.push(i),t+=i>=65536?2:1}return bi.apply(void 0,a)};var vi,es=(function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var s=this.parseArgument(r,a);if(s.err)return s;i.push(s.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var o=this.clonePosition();this.bump(),i.push({type:F.pound,location:M(o,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(C.UNMATCHED_CLOSING_TAG,M(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&wi(this.peek()||0)){var s=this.parseTag(r,t);if(s.err)return s;i.push(s.val)}else{var s=this.parseLiteral(r,t);if(s.err)return s;i.push(s.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:F.literal,value:"<".concat(i,"/>"),location:M(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var s=n.val,o=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!wi(this.char()))return this.error(C.INVALID_TAG,M(o,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(C.UNMATCHED_CLOSING_TAG,M(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:F.tag,value:i,children:s,location:M(a,this.clonePosition())},err:null}:this.error(C.INVALID_TAG,M(o,this.clonePosition())))}else return this.error(C.UNCLOSED_TAG,M(a,this.clonePosition()))}else return this.error(C.INVALID_TAG,M(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&fd(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var s=this.tryParseUnquoted(r,t);if(s){i+=s;continue}var o=this.tryParseLeftAngleBracket();if(o){i+=o;continue}break}var c=M(a,this.clonePosition());return{val:{type:F.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!gd(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return bi.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),bi(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(C.EMPTY_ARGUMENT,M(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(C.MALFORMED_ARGUMENT,M(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:F.argument,value:i,location:M(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(C.MALFORMED_ARGUMENT,M(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=yi(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),s=M(r,n);return{value:a,location:s}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,s=this.clonePosition(),o=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(o){case"":return this.error(C.EXPECT_ARGUMENT_TYPE,M(s,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),m=this.parseSimpleArgStyleIfPossible();if(m.err)return m;var u=ud(m.val);if(u.length===0)return this.error(C.EXPECT_ARGUMENT_STYLE,M(this.clonePosition(),this.clonePosition()));var h=M(d,this.clonePosition());l={style:u,styleLocation:h}}var p=this.tryParseArgumentClose(i);if(p.err)return p;var f=M(i,this.clonePosition());if(l&&Ko(l?.style,"::",0)){var x=md(l.style.slice(2));if(o==="number"){var m=this.parseNumberSkeletonFromString(x,l.styleLocation);return m.err?m:{val:{type:F.number,value:a,location:f,style:m.val},err:null}}else{if(x.length===0)return this.error(C.EXPECT_DATE_TIME_SKELETON,f);var y=x;this.locale&&(y=Yo(x,this.locale));var u={type:Qe.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?Ho(y):{}},S=o==="date"?F.date:F.time;return{val:{type:S,value:a,location:f,style:u},err:null}}}return{val:{type:o==="number"?F.number:o==="date"?F.date:F.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(C.EXPECT_SELECT_ARGUMENT_OPTIONS,M(b,P({},b)));this.bumpSpace();var A=this.parseIdentifierIfPossible(),D=0;if(o!=="select"&&A.value==="offset"){if(!this.bumpIf(":"))return this.error(C.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,M(this.clonePosition(),this.clonePosition()));this.bumpSpace();var m=this.tryParseDecimalInteger(C.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,C.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(m.err)return m;this.bumpSpace(),A=this.parseIdentifierIfPossible(),D=m.val}var I=this.tryParsePluralOrSelectOptions(r,o,t,A);if(I.err)return I;var p=this.tryParseArgumentClose(i);if(p.err)return p;var B=M(i,this.clonePosition());return o==="select"?{val:{type:F.select,value:a,options:Zo(I.val),location:B},err:null}:{val:{type:F.plural,value:a,options:Zo(I.val),offset:D,pluralType:o==="plural"?"cardinal":"ordinal",location:B},err:null}}default:return this.error(C.INVALID_ARGUMENT_TYPE,M(s,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE,M(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(C.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,M(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=Go(r)}catch{return this.error(C.INVALID_NUMBER_SKELETON,t)}return{val:{type:Qe.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?Wo(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,s=!1,o=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var m=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var u=this.tryParseDecimalInteger(C.EXPECT_PLURAL_ARGUMENT_SELECTOR,C.INVALID_PLURAL_ARGUMENT_SELECTOR);if(u.err)return u;d=M(m,this.clonePosition()),l=this.message.slice(m.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?C.DUPLICATE_SELECT_ARGUMENT_SELECTOR:C.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(s=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?C.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:C.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,M(this.clonePosition(),this.clonePosition()));var p=this.parseMessage(r+1,t,a);if(p.err)return p;var f=this.tryParseArgumentClose(h);if(f.err)return f;o.push([l,{value:p.val,location:M(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return o.length===0?this.error(t==="select"?C.EXPECT_SELECT_ARGUMENT_SELECTOR:C.EXPECT_PLURAL_ARGUMENT_SELECTOR,M(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!s?this.error(C.MISSING_OTHER_CLAUSE,M(this.clonePosition(),this.clonePosition())):{val:o,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,s=0;!this.isEOF();){var o=this.char();if(o>=48&&o<=57)n=!0,s=s*10+(o-48),this.bump();else break}var c=M(i,this.clonePosition());return n?(s*=a,pd(s)?{val:s,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=Qo(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(Ko(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&ts(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e})();function wi(e){return e>=97&&e<=122||e>=65&&e<=90}function gd(e){return wi(e)||e===47}function fd(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function ts(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function vd(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Ei(e){e.forEach(function(r){if(delete r.location,Vr(r)||jr(r))for(var t in r.options)delete r.options[t].location,Ei(r.options[t].value);else $r(r)&&Yr(r.style)||(Gr(r)||qr(r))&&Qt(r.style)?delete r.style.location:Wr(r)&&Ei(r.children)})}function rs(e,r){r===void 0&&(r={}),r=P({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new es(e,r).parse();if(t.err){var a=SyntaxError(C[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||Ei(t.val),t.val}function er(e,r){var t=r&&r.cache?r.cache:Sd,a=r&&r.serializer?r.serializer:Ed,i=r&&r.strategy?r.strategy:bd;return i(e,{cache:t,serializer:a})}function xd(e){return e==null||typeof e=="number"||typeof e=="boolean"}function as(e,r,t,a){var i=xd(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function is(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function Si(e,r,t,a,i){return t.bind(r,e,a,i)}function bd(e,r){var t=e.length===1?as:is;return Si(e,this,t,r.cache.create(),r.serializer)}function yd(e,r){return Si(e,this,is,r.cache.create(),r.serializer)}function wd(e,r){return Si(e,this,as,r.cache.create(),r.serializer)}var Ed=function(){return JSON.stringify(arguments)};function Ai(){this.cache=Object.create(null)}Ai.prototype.get=function(e){return this.cache[e]};Ai.prototype.set=function(e,r){this.cache[e]=r};var Sd={create:function(){return new Ai}},Xr={variadic:yd,monadic:wd};var Je;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Je||(Je={}));var tr=(function(e){Zt(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r})(Error);var Ci=(function(e){Zt(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),Je.INVALID_VALUE,n)||this}return r})(tr);var ns=(function(e){Zt(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),Je.INVALID_VALUE,i)||this}return r})(tr);var os=(function(e){Zt(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),Je.MISSING_VALUE,a)||this}return r})(tr);var J;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(J||(J={}));function Ad(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==J.literal||t.type!==J.literal?r.push(t):a.value+=t.value,r},[])}function Cd(e){return typeof e=="function"}function rr(e,r,t,a,i,n,s){if(e.length===1&&ui(e[0]))return[{type:J.literal,value:e[0].value}];for(var o=[],c=0,l=e;c<l.length;c++){var d=l[c];if(ui(d)){o.push({type:J.literal,value:d.value});continue}if(Do(d)){typeof n=="number"&&o.push({type:J.literal,value:t.getNumberFormat(r).format(n)});continue}var m=d.value;if(!(i&&m in i))throw new os(m,s);var u=i[m];if(zo(d)){(!u||typeof u=="string"||typeof u=="number")&&(u=typeof u=="string"||typeof u=="number"?String(u):""),o.push({type:typeof u=="string"?J.literal:J.object,value:u});continue}if(Gr(d)){var h=typeof d.style=="string"?a.date[d.style]:Qt(d.style)?d.style.parsedOptions:void 0;o.push({type:J.literal,value:t.getDateTimeFormat(r,h).format(u)});continue}if(qr(d)){var h=typeof d.style=="string"?a.time[d.style]:Qt(d.style)?d.style.parsedOptions:a.time.medium;o.push({type:J.literal,value:t.getDateTimeFormat(r,h).format(u)});continue}if($r(d)){var h=typeof d.style=="string"?a.number[d.style]:Yr(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(u=u*(h.scale||1)),o.push({type:J.literal,value:t.getNumberFormat(r,h).format(u)});continue}if(Wr(d)){var p=d.children,f=d.value,x=i[f];if(!Cd(x))throw new ns(f,"function",s);var y=rr(p,r,t,a,i,n),S=x(y.map(function(D){return D.value}));Array.isArray(S)||(S=[S]),o.push.apply(o,S.map(function(D){return{type:typeof D=="string"?J.literal:J.object,value:D}}))}if(Vr(d)){var b=d.options[u]||d.options.other;if(!b)throw new Ci(d.value,u,Object.keys(d.options),s);o.push.apply(o,rr(b.value,r,t,a,i));continue}if(jr(d)){var b=d.options["=".concat(u)];if(!b){if(!Intl.PluralRules)throw new tr(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Je.MISSING_INTL_API,s);var A=t.getPluralRules(r,{type:d.pluralType}).select(u-(d.offset||0));b=d.options[A]||d.options.other}if(!b)throw new Ci(d.value,u,Object.keys(d.options),s);o.push.apply(o,rr(b.value,r,t,a,i,u-(d.offset||0)));continue}}return Ad(o)}function Td(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=P(P({},e[a]),r[a]||{}),t},{})):e}function kd(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=Td(e[a],r[a]),t},P({},e)):e}function Ti(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function _d(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:er(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,Ur([void 0],t,!1)))},{cache:Ti(e.number),strategy:Xr.variadic}),getDateTimeFormat:er(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,Ur([void 0],t,!1)))},{cache:Ti(e.dateTime),strategy:Xr.variadic}),getPluralRules:er(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,Ur([void 0],t,!1)))},{cache:Ti(e.pluralRules),strategy:Xr.variadic})}}var ss=(function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(s){var o=n.formatToParts(s);if(o.length===1)return o[0].value;var c=o.reduce(function(l,d){return!l.length||d.type!==J.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(s){return rr(n.ast,n.locales,n.formatters,n.formats,s,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=kd(e.formats,a),this.formatters=i&&i.formatters||_d(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=rs,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e})();var cs=ss;var ar={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}",discountLabel:"{discount}%"},Ld=Kn("ConsonantTemplates/price"),Pd=/<\/?[^>]+(>|$)/g,U={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Ce={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Kr="TAX_EXCLUSIVE",Md=e=>Wn(e)?Object.entries(e).filter(([,r])=>xt(r)||Lr(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${jn(a)}"`}`,""):"",V=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${U.disabled}`}"${Md(t)}>${a?Eo(r):r??""}</span>`;function Rd(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function Od(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function ve(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),s=i.includes("<a ");try{i=s?Rd(i):i,i=n?i.replace(Pd,""):i;let o=new cs(i,r).format(a);return s?Od(o):o}catch{return Ld.error("Failed to format literal:",i),""}}function Nd(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:s,integer:o,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:m},u={}){let h=V(U.currencySymbol,a),p=V(U.currencySpace,s?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+p),f+=V(U.integer,o),f+=V(U.decimalsDelimiter,n),f+=V(U.decimals,i),c||(f+=p+h),f+=V(U.recurrence,l,null,!0),f+=V(U.unitType,d,null,!0),f+=V(U.taxInclusivity,m,!0),V(e,f,{...u})}var K=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:s,displayFormatted:o=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:m,literals:u={},quantity:h=1,space:p=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:S,price:b,priceWithoutDiscount:A,taxDisplay:D,taxTerm:I,term:B,usePrecision:j,promotion:Z,priceInfo:Q}={},G={})=>{Object.entries({country:s,formatString:S,language:m,price:b}).forEach(([Ws,Ys])=>{if(Ys==null)throw new Error(`Argument "${Ws}" is missing for osi ${y?.toString()}, country ${s}, language ${m}`)});let N={...ar,...u},ee=`${m.toLowerCase()}-${s.toUpperCase()}`,te;Z&&!f&&A?te=e||a?b:A:t&&A?te=A:te=b;let Be=te===A,Ni=r?Ao:Co;i&&(Ni=To);let Ii=s==="IN",Us=D===Kr,zi;Q&&!r&&!Ii&&E(o)&&(zi=So({priceInfo:Q,showWithoutDiscount:Be,taxExclusive:Us,displayAnnual:i,promotion:Z}));let{accessiblePrice:ih,recurrenceTerm:Di,...Hi}=Ni({commitment:x,formatString:S,instant:n,isIndianPrice:Ii,originalPrice:b,priceWithoutDiscount:A,price:r?b:te,promotion:Z,quantity:h,term:B,usePrecision:j,formatted:zi}),Jr="",ea="",ta="";E(c)&&Di&&(ta=ve(N,ee,Ce.recurrenceLabel,{recurrenceTerm:Di}));let lr="";E(l)&&(p&&(lr+=" "),lr+=ve(N,ee,Ce.perUnitLabel,{perUnit:"LICENSE"}));let dr="";E(d)&&I&&(p&&(dr+=" "),dr+=ve(N,ee,D===Kr?Ce.taxExclusiveLabel:Ce.taxInclusiveLabel,{taxTerm:I})),t&&(Jr=ve(N,ee,Ce.strikethroughAriaLabel,{strikethroughPrice:Jr})),e&&(ea=ve(N,ee,Ce.alternativePriceAriaLabel,{alternativePrice:ea}));let Ue=U.container;if(r&&(Ue+=` ${U.containerOptical}`),t&&(Ue+=` ${U.containerStrikethrough}`),a&&(Ue+=` ${U.containerPromoStrikethrough}`),e&&(Ue+=` ${U.containerAlternative}`),i&&(Ue+=` ${U.containerAnnual}`),E(o))return Nd(Ue,{...Hi,accessibleLabel:Jr,altAccessibleLabel:ea,recurrenceLabel:ta,perUnitLabel:lr,taxInclusivityLabel:dr},G);let{currencySymbol:Fi,decimals:$s,decimalsDelimiter:Gs,hasCurrencySpace:Bi,integer:qs,isCurrencyFirst:Vs}=Hi,rt=[qs,Gs,$s];Vs?(rt.unshift(Bi?"\xA0":""),rt.unshift(Fi)):(rt.push(Bi?"\xA0":""),rt.push(Fi)),rt.push(ta,lr,dr);let js=rt.join("");return V(Ue,js,G)},ls=()=>(e,r,t)=>{let a=Ze(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${K({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${K({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},ds=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=Ze(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return K()(e,{...r,price:r.priceWithoutDiscount},t)+V(U.containerAnnualPrefix," (")+K({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+V(U.containerAnnualSuffix,")");let o=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${o?`${K({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${K({isAlternativePrice:o})({isPromoApplied:i,...e},r,t)}${V(U.containerAnnualPrefix," (")}${K({displayAnnual:!0,instant:a})(n,r,t)}${V(U.containerAnnualSuffix,")")}`},hs=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${K({isAlternativePrice:e.displayOldPrice})(e,r,t)}${V(U.containerAnnualPrefix," (")}${K({displayAnnual:!0})(a,r,t)}${V(U.containerAnnualSuffix,")")}`};var ir={...U,containerLegal:"price-legal",planType:"price-plan-type"},Zr={...Ce,planTypeLabel:"planTypeLabel"};function Id(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let s="";return s+=V(ir.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),s+=V(ir.taxInclusivity,t,!0),s+=V(ir.planType,a,null),V(e,s,{...i})}var ps=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,language:n,literals:s={}}={},{taxDisplay:o,taxTerm:c,planType:l}={},d={})=>{let m={...ar,...s},u=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";E(r)&&(h=ve(m,u,Zr.perUnitLabel,{perUnit:"LICENSE"}));let p="";e==="US"&&n==="en"&&(t=!1),E(t)&&c&&(p=ve(m,u,o===Kr?Zr.taxExclusiveLabel:Zr.taxInclusiveLabel,{taxTerm:c}));let f="";E(a)&&l&&(f=ve(m,u,Zr.planTypeLabel,{planType:l}));let x=ir.container;return x+=` ${ir.containerLegal}`,Id(x,{perUnitLabel:h,taxInclusivityLabel:p,planTypeLabel:f},d,i)};var ms=K(),us=ls(),gs=K({displayOptical:!0}),fs=K({displayStrikethrough:!0}),vs=K({displayPromoStrikethrough:!0}),xs=K({displayAnnual:!0}),bs=K({displayOptical:!0,isAlternativePrice:!0}),ys=K({isAlternativePrice:!0}),ws=hs(),Es=ds(),Ss=ps;var zd={...Ce,discountLabel:"discountLabel"},Dd=(e,r)=>{if(!r&&bt(e))return 0;if(!(!bt(e)||!bt(r)))return Math.floor((r-e)/r*100)},As=()=>(e,r)=>{let{country:t,language:a,literals:i={}}=e??{},{price:n,priceWithoutDiscount:s}=r,o=Dd(n,s);if(o===void 0)return'<span class="no-discount"></span>';let c={...ar,...i},l=a&&t?`${a.toLowerCase()}-${t.toUpperCase()}`:"en-US";return`<span class="discount">${ve(c,l,zd.discountLabel,{discount:o,remainingPercent:100-o})}</span>`};var Cs=As();var Ts="INDIVIDUAL_COM",_i="TEAM_COM",ks="INDIVIDUAL_EDU",Li="TEAM_EDU",Hd=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],Fd={[Ts]:[],[_i]:[],[ks]:[],[Li]:[]},Bd={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Ud=[Ts,_i,ks,Li],$d=e=>[_i,Li].includes(e);function ki(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(s=>s.startsWith(`${r}_`));else{let s=Object.keys(e).find(o=>o.startsWith(`${r}_`));n=s?e[s]:null}return n}var Gd=(e,r,t,a)=>{let i=`${t}_${a}`,n=ki(Bd,e,r,!1);if(n){let s=Ud.indexOf(i);return n[s]}return $d(i)},qd=(e,r,t,a)=>{if(ki(Hd,e,r,!0))return!0;let i=Fd[`${t}_${a}`];return i?ki(i,e,r,!0)?!0:O.displayTax:O.displayTax},Pi=async(e,r,t,a)=>{let i=qd(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Gd(e,r,t,a):O.forceTaxExclusive}},nr=class nr extends HTMLSpanElement{constructor(){super();g(this,"masElement",new He(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=ce();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:u,quantity:h,alternativePrice:p,template:f,wcsOsi:x}=a.collectPriceOptions(t);return Fr(nr,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:u,quantity:h,alternativePrice:p,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ge}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=ce();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let s=this.masElement.togglePending({});this.innerHTML="";let o=a.resolveOfferSelectors(n),c=await Promise.all(o),l=c.map(h=>{let p=Yt(h,n);return p?.length?p[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,m=ii(l);if(a.featureFlags[ke]||n[ke]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=m.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:p}=n,[f=""]=m.marketSegments,x=await Pi(h,p,m.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let S=Yt(y,n);return S?.length?S[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[at]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,p]=d,f={...h,priceInfo:void 0,priceDetails:{...h.priceDetails,priceWithoutDiscount:p.priceDetails?.price}};return this.renderOffers([f],n,s)}let u=ii(d);return this.renderOffers([u],n,s)}catch(s){throw this.innerHTML="",s}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=ce();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let s=this.closest("p, h3, div");if(!s||!s.querySelector('span[data-template="strikethrough"]')||s.querySelector(".alt-aria-label"))return!0;let o=s?.querySelectorAll('span[is="inline-price"]');return o.length>1&&o.length===s.querySelectorAll('span[data-template="strikethrough"]').length*2&&o.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let s=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,this.options))return this.innerHTML="",!0}return!1}};g(nr,"is","inline-price"),g(nr,"tag","span");var Re=nr;window.customElements.get(Re.is)||window.customElements.define(Re.is,Re,{extends:Re.tag});function _s({literals:e,providers:r,settings:t}){function a(s,o=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(o&&r?.price)for(let I of r.price)I(o,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:m,displayTax:u,displayPlanType:h,forceTaxExclusive:p,perpetual:f,displayAnnual:x,promotionCode:y,quantity:S,alternativePrice:b,wcsOsi:A,...D}=Object.assign(c,o?.dataset??{},s??{});return c=Pr(Object.assign({...c,...D,displayOldPrice:E(l),displayPerUnit:E(d),displayRecurrence:E(m),displayTax:E(u),displayPlanType:E(h),forceTaxExclusive:E(p),perpetual:E(f),displayAnnual:E(x),promotionCode:Or(y).effectivePromoCode,quantity:yt(S,O.quantity),alternativePrice:E(b),wcsOsi:Hr(A)})),c}function i(s,o){if(!Array.isArray(s)||!s.length||!o)return"";let{template:c}=o,l;switch(c){case"discount":l=Cs;break;case"strikethrough":l=fs;break;case"promo-strikethrough":l=vs;break;case"annual":l=xs;break;case"legal":l=Ss;break;default:o.template==="optical"&&o.alternativePrice?l=bs:o.template==="optical"?l=gs:o.displayAnnual&&s[0].planType==="ABM"?l=o.promotionCode&&s[0].promotion?Es:ws:o.alternativePrice?l=ys:l=o.promotionCode&&s[0].promotion?us:ms}let[d]=s;return d={...d,...d.priceDetails},l({...t,...o},d)}let n=Re.createInlinePrice;return{InlinePrice:Re,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Vd({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||O.language),r??(r=e?.split("_")?.[1]||O.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function Ls(e={},r){let t=r.featureFlags[ke],{commerce:a={}}=e,i=be.PRODUCTION,n=Ea,s=H("checkoutClientId",a)??O.checkoutClientId,o=Wt(H("checkoutWorkflowStep",a),ne,O.checkoutWorkflowStep),c=E(H("displayOldPrice",a),O.displayOldPrice),l=O.displayPerUnit,d=E(H("displayRecurrence",a),O.displayRecurrence),m=E(H("displayTax",a),O.displayTax),u=E(H("displayPlanType",a),O.displayPlanType),h=E(H("entitlement",a),O.entitlement),p=E(H("modal",a),O.modal),f=E(H("forceTaxExclusive",a),O.forceTaxExclusive),x=H("promotionCode",a)??O.promotionCode,y=yt(H("quantity",a)),S=H("wcsApiKey",a)??O.wcsApiKey,b=a?.env==="stage",A=Ie.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(H(ya,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",A=Wt(H(wa,a),Ie,A)),b&&(i=be.STAGE,n=Sa);let I=H(ba)??e.preview,B=typeof I<"u"&&I!=="off"&&I!=="false",j={};B&&(j={preview:B});let Z=H("mas-io-url")??e.masIOUrl,Q=Ki(Z)?Z:`https://www${i===be.STAGE?".stage":""}.adobe.com/mas/io`,G=H("preselect-plan")??void 0,N=H("instant")??e.instant;return{...Vd(e),...j,displayOldPrice:c,checkoutClientId:s,checkoutWorkflowStep:o,displayPerUnit:l,displayRecurrence:d,displayTax:m,displayPlanType:u,entitlement:h,extraOptions:O.extraOptions,modal:p,env:i,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:O.alternativePrice,wcsApiKey:S,wcsURL:n,landscape:A,masIOUrl:Q,...G&&{preselectPlan:G},...N&&{instant:N}}}async function Ps(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let s=await fetch(e,r);return s.retryCount=n,s}catch(s){if(i=s,i.retryCount=n,n>t)break;await new Promise(o=>setTimeout(o,a*(n+1)))}throw i}var Mi="wcs";function Ms({settings:e}){let r=se.module(Mi),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,s,o=new Map;async function c(p,f,x=!0){let y=ce(),S=fa;r.debug("Fetching:",p);let b="",A;if(p.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let D=new Map(f),[I]=p.offerSelectorIds,B=Date.now()+Math.random().toString(36).substring(2,7),j=`${Mi}:${I}:${B}${Ca}`,Z=`${Mi}:${I}:${B}${Ta}`,Q;try{if(performance.mark(j),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",I),b.searchParams.set("country",p.country),b.searchParams.set("locale",p.locale),b.searchParams.set("landscape",t===be.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),p.language&&b.searchParams.set("language",p.language),p.promotionCode&&b.searchParams.set("promotion_code",p.promotionCode),p.currency&&b.searchParams.set("currency",p.currency),A=await Ps(b.toString(),{credentials:"omit"}),A.ok){let G=[];try{let N=await A.json();r.debug("Fetched:",p,N),G=N.resolvedOffers??[]}catch(N){r.error(`Error parsing JSON: ${N.message}`,{...N.context,...y?.duration})}G=G.map(Nr),f.forEach(({resolve:N},ee)=>{let te=G.filter(({offerSelectorIds:Be})=>Be.includes(ee)).flat();te.length&&(D.delete(ee),f.delete(ee),N(te))})}else S=ga}catch(G){S=`Network error: ${G.message}`}finally{Q=performance.measure(Z,j),performance.clearMarks(j),performance.clearMeasures(Z)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let G=lo(A);f.forEach(N=>{N.reject(new wt(S,{...p,...G,response:A,measure:gr(Q),...y?.duration}))})}}function l(){clearTimeout(s);let p=[...n.values()];n.clear(),p.forEach(({options:f,promises:x})=>c(f,x))}function d(p){if(!p||typeof p!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===be.STAGE?"stage":"prod",x=p[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,S]of Object.entries(x))i.set(y,Promise.resolve(S.map(Nr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function m(){let p=i.size;o=new Map(i),i.clear(),r.debug(`Moved ${p} cache entries to stale cache`)}function u(p,f,x){let y=p!=="GB"&&!x?"MULT":"en",S=ka.includes(p)?p:O.country;return{validCountry:S,validLanguage:y,locale:`${f}_${S}`}}function h({country:p,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:S=[]}){let{validCountry:b,validLanguage:A,locale:D}=u(p,f,x),I=[b,A,y].filter(B=>B).join("-").toLowerCase();return S.map(B=>{let j=`${B}-${I}`;if(i.has(j))return i.get(j);let Z=new Promise((Q,G)=>{let N=n.get(I);N||(N={options:{country:b,locale:D,...A==="MULT"&&{language:A},offerSelectorIds:[]},promises:new Map},n.set(I,N)),y&&(N.options.promotionCode=y),N.options.offerSelectorIds.push(B),N.promises.set(B,{resolve:Q,reject:G}),l()}).catch(Q=>{if(o.has(j))return o.get(j);throw Q});return i.set(j,Z),Z})}return{Commitment:$e,PlanType:Qn,Term:he,applyPlanType:Nr,resolveOfferSelectors:h,flushWcsCacheInternal:m,prefillWcsCache:d,normalizeCountryLanguageAndLocale:u}}var Rs="mas-commerce-service",Os="mas-commerce-service:start",Ns="mas-commerce-service:ready",or,St,et,Is,Oi,Ri=class extends HTMLElement{constructor(){super(...arguments);_(this,et);_(this,or);_(this,St);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let s=await t?.(a,i,this.imsSignedInPromise,n);return s||null})}get featureFlags(){return v(this,St)||T(this,St,{[ke]:W(this,et,Oi).call(this,ke),[at]:W(this,et,Oi).call(this,at)}),v(this,St)}activate(){let t=v(this,et,Is),a=Ls(t,this);Ir(t.lana);let i=se.init(t.hostEnv).module("service");i.debug("Activating:",t);let s={price:Io(a)},o={checkout:new Set,price:new Set},c={literals:s,providers:o,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Ro(c),...Oo(c),..._s(c),...Ms(c),..._a,Log:se,resolvePriceTaxFlags:Pi,get defaults(){return O},get log(){return se},get providers(){return{checkout(d){return o.checkout.add(d),()=>o.checkout.delete(d)},price(d){return o.price.add(d),()=>o.price.delete(d)},has:d=>o.price.has(d)||o.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:s,settings:a});let l=new CustomEvent(pr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ns),T(this,or,performance.measure(Ns,Os)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Os),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(ia).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":gr(v(this,or))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:s})=>i===0&&n===0&&s<200||s>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};or=new WeakMap,St=new WeakMap,et=new WeakSet,Is=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let s=i.replace(/-([a-z])/g,o=>o[1].toUpperCase());a.commerce[s]=n}}),a},Oi=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(Rs)||window.customElements.define(Rs,Ri);var Fs="merch-card-collection",jd=3e4,Wd={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Yd={plans:!0},Xd=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Kd=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,Zd=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Qd=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),Jd=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Fe,Ct,tt,cr,Qr,Bs,At=class extends Ds{constructor(){super();_(this,Qr);_(this,Fe,{});_(this,Ct);_(this,tt);_(this,cr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=Xi(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Oe` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a=new Promise(i=>setTimeout(()=>i(!1),jd));return Promise.race([this.hydrationReady,a])}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===fe.alphabetical?Zd:Qd,o=[Xd,Kd,Jd,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=o.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=o.length>l,o=o.filter(([,d])=>d<l)}let c=new Map(o.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(ca,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(me,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){T(this,Fe,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,Fe)[a]=i)})}connectedCallback(){super.connectedCallback(),T(this,Ct,Ot()),v(this,Ct)&&T(this,tt,v(this,Ct).Log.module(Fs)),T(this,cr,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",s=document.createElement(n);s.setAttribute("slot",a),s.setAttribute("placeholder",""),s.innerHTML=i,this.append(s)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Yd[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Pt));let i=v(this,cr)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(o=>{a=o});let i=this;function n(o){let c;return o.fields?.checkboxGroups?c=o.fields.checkboxGroups:o.fields?.tagFilters&&(c=[{title:o.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:o.fields.tagFilters.map(l=>{let d=l.split("/").pop(),m=o.settings?.tagLabels?.[d]||d;return m=m.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):m,{name:d,label:m}})}]),{searchText:o.fields?.searchText,tagFilters:c,linksTitle:o.fields?.linksTitle,link:o.fields?.link,linkText:o.fields?.linkText,linkIcon:o.fields?.linkIcon}}function s(o,c){let l={cards:[],hierarchy:[],placeholders:o.placeholders,sidenavSettings:n(o)};function d(m,u){for(let h of u){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!o.references[h.identifier]?.value){v(i,tt)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(o.references[h.identifier].value);continue}let p=o.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)p=b,f=b.referencesTree,o.references={...o.references,...b.references};else{v(i,tt)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!p?.fields)continue;let{fields:y}=p,S={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(b=>c[b]||b):[],collections:[]};y.defaultchild&&(S.defaultchild=c[y.defaultchild]||y.defaultchild),m.push(S),d(S.collections,f)}}return d(l.hierarchy,o.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(da,o=>{W(this,Qr,Bs).call(this,"Error loading AEM fragment",o.detail),this.hydrating=!1,t.remove()}),t.addEventListener(la,async o=>{this.limit=27,this.data=s(o.detail,v(this,Fe)),o.detail.variationId&&this.setAttribute("variation-id",o.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&o.detail.fields?.defaultchild?v(this,Fe)[o.detail.fields.defaultchild]||o.detail.fields.defaultchild:null;t.cache.add(...c);let m=(p,f)=>{for(let x of p)if(x.defaultchild===f||x.collections&&m(x.collections,f))return!0;return!1};for(let p of c){let b=function(D){for(let I of D){let B=I.cards.indexOf(x);if(B===-1)continue;let j=I.queryLabel??I?.label?.toLowerCase()??"";f.filters[j]={order:B+1,size:p.fields.size},b(I.collections)}},f=document.createElement("merch-card"),x=v(this,Fe)[p.id]||p.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=p.fields.tags?.filter(D=>D.startsWith("mas:types/")).map(D=>D.split("/")[1]).join(",");y&&f.setAttribute("types",y),vr(p.fields.variant)?.supportsDefaultChild&&(d?x===d:m(l,x))&&f.setAttribute("data-default-card","true"),b(l);let A=document.createElement("aem-fragment");A.setAttribute("fragment",x),f.append(A),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(p)+1,size:p.fields.size}}),this.append(f)}let u="",h=mo(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(p=>p.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?u=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(u=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Wd[`${h}${u}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Oe`<div id="footer">
        ...
        </sp-button>`}sortChanged(t){t.target.value===fe.authored?Lt({sort:void 0}):Lt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(oa,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(sa,{bubbles:!0,composed:!0}));let t=this.page+1;Lt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=Vi(({category:t,filter:a,types:i,sort:n,search:s,single_app:o,page:c})=>{a=a||t,!this.filtered&&a&&a!==this.filter&&setTimeout(()=>{Lt({page:void 0}),this.page=1},1),this.filtered||(this.filter=a??this.filter),this.types=i??"",this.search=s??"",this.singleApp=o,this.sort=n,this.page=Number(c)||1})}openFilters(t){this.sidenav?.showModal(t)}};Fe=new WeakMap,Ct=new WeakMap,tt=new WeakMap,cr=new WeakMap,Qr=new WeakSet,Bs=function(t,a={},i=!0){v(this,tt)?.error(`merch-card-collection: ${t}`,a),this.failed=!0,i&&this.dispatchEvent(new CustomEvent(ha,{detail:{...a,message:t},bubbles:!0,composed:!0}))},g(At,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:fe.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(At,"styles",Hs`
        #footer {
            grid-column: 1 / -1;
    ...
    `);At.SortOrder=fe;customElements.define(Fs,At);var eh={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},th=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(i=>{i.innerText=t||""})},rh={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},ah={catalog:"l"},le,Tt,sr=class extends Ds{constructor(){super();_(this,le);_(this,Tt);g(this,"tablet",new _t(this,R));g(this,"desktop",new _t(this,k));this.collection=null,T(this,le,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(me,this.updateLiterals),this.collection?.addEventListener(Pt,this.handleSidenavAttached),T(this,Tt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(me,this.updateLiterals),this.collection?.removeEventListener(Pt,this.handleSidenavAttached)}willUpdate(){v(this,le).search=this.getVisibility("search"),v(this,le).filter=this.getVisibility("filter"),v(this,le).sort=this.getVisibility("sort"),v(this,le).result=this.getVisibility("result"),v(this,le).custom=this.getVisibility("custom")}parseVisibilityOptions(t,a){if(!t||!Object.hasOwn(t,a))return null;let i=t[a];return i===!1?!1:i===!0?!0:i.includes(this.currentMedia)}getVisibility(t){let a=v(this,Tt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,i=this.parseVisibilityOptions(a,t);return i!==null?i:this.parseVisibilityOptions(rh,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,le).search)return xe;let t=Rt(this,"searchText");return t?Oe`
        ...
        `:xe}get filterAction(){return v(this,le).filter?this.sidenav?Oe`
            <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
            ...
            ></sp-action-button>
        `:xe:xe}get sortAction(){if(!v(this,le).sort)return xe;let t=Rt(this,"sortText");if(!t)return;let a=Rt(this,"popularityText"),i=Rt(this,"alphabeticallyText");if(!(a&&i))return;let n=this.collection?.sort===fe.alphabetical;return Oe`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        </div>`}get customArea(){if(!v(this,le).custom)return xe;let t=v(this,Tt)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return xe;let a=t(this.collection);return!a||a===xe?xe:Oe`<div id="custom" role="heading" aria-level="2">
            ${a}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(a=>{th(this,a,t.detail[a])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return Oe`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};le=new WeakMap,Tt=new WeakMap,g(sr,"styles",Hs`
        :host {

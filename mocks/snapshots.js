...
const price = `
<span class="price" aria-label="US$599.88 per year per license">
...
const strikethrough = `
<span class="price price-strikethrough" aria-label="Regularly at US$599.88 per year per license">
  <span class="price-currency-symbol"> US$ </span>
  <span class="price-currency-space disabled"> </span>
  <span class="price-integer"> 599 </span>
  <span class="price-decimals-delimiter"> . </span>
...
const annual = `
<span class="price price-annual" aria-label="US$659.88 per year per license">
  <span class="price-currency-symbol"> US$ </span>
  <span class="price-currency-space disabled"> </span>
...
const promo = `
<span class="price" aria-label="US$43.99 per month per license">
  <span class="price-currency-symbol"> US$ </span>
  <span class="price-currency-space disabled"> </span>
...
<span class="price" aria-label="US$54.99 per month per license">
  <span class="price-currency-symbol"> US$ </span>
  <span class="price-currency-space disabled"> </span>
...
const taxExclusive = `
<span class="price" aria-label="41,65 &amp;euro; per month per license">

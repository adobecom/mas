var D=Object.defineProperty;var w=(i,e,t)=>e in i?D(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var a=(i,e,t)=>w(i,typeof e!="symbol"?e+"":e,t);import{html as T,css as z,LitElement as K,nothing as k}from"./lit-all.min.js";var d=class{constructor(e,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=e,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),e.addController(this)}hostConnected(){var e;(e=this.media)==null||e.addEventListener("change",this.onChange)}hostDisconnected(){var e;(e=this.media)==null||e.removeEventListener("change",this.onChange)}onChange(e){this.matches!==e.matches&&(this.matches=e.matches,this.host.requestUpdate(this.key,!this.matches))}};import{html as H,LitElement as U}from"./lit-all.min.js";var X=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),J=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var M='span[is="inline-price"][data-wcs-osi]',O='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var I='a[is="upt-link"]',ee=`${M},${O},${I}`;var A="merch-search:change";var h="merch-sidenav:select";var te=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var oe=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});function u(i,e){let t;return function(){let o=this,s=arguments;clearTimeout(t),t=setTimeout(()=>i.apply(o,s),e)}}function _(i,e={},t=null,o=null){let s=o?document.createElement(i,{is:o}):document.createElement(i);t instanceof HTMLElement?s.appendChild(t):s.innerHTML=t;for(let[n,r]of Object.entries(e))s.setAttribute(n,r);return s}function P(i){if(!window.history.pushState)return;let e=new URL(window.location.href);e.search=`?${i}`,window.history.pushState({path:e.href},"",e.href)}function g(i,e){let t=new URLSearchParams(window.location.hash.slice(1));t.set(i,e),window.location.hash=t.toString()}function S(i=[]){i.forEach(e=>{let t=new URLSearchParams(window.location.search),o=t.get(e);o&&(window.location.hash.includes(`${e}=`)?g(e,o):window.location.hash=window.location.hash?`${window.location.hash}&${e}=${o}`:`${e}=${o}`,t.delete(e),P(t.toString()))})}var f="hashchange";function x(i=window.location.hash){let e=[],t=i.replace(/^#/,"").split("&");for(let o of t){let[s,n=""]=o.split("=");s&&e.push([s,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(e)}function c(i,e){if(i.deeplink){let t={};t[i.deeplink]=e,y(t)}}function y(i){let e=new URLSearchParams(window.location.hash.slice(1));Object.entries(i).forEach(([s,n])=>{n?e.set(s,n):e.delete(s)}),e.sort();let t=e.toString();if(t===window.location.hash)return;let o=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,o)}function l(i){let e=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=x(window.location.hash);i(t)};return e(),window.addEventListener(f,e),()=>{window.removeEventListener(f,e)}}var v=class extends U{get search(){return this.querySelector("sp-search")}constructor(){super(),this.handleInput=()=>{c(this,this.search.value),this.search.value&&this.dispatchEvent(new CustomEvent(A,{bubbles:!0,composed:!0,detail:{type:"search",value:this.search.value}}))},this.handleInputDebounced=u(this.handleInput.bind(this))}connectedCallback(){super.connectedCallback(),this.search&&(this.search.addEventListener("input",this.handleInputDebounced),this.search.addEventListener("submit",this.handleInputSubmit),this.updateComplete.then(()=>{this.setStateFromURL()}),this.startDeeplink())}disconnectedCallback(){super.disconnectedCallback(),this.search.removeEventListener("input",this.handleInputDebounced),this.search.removeEventListener("submit",this.handleInputSubmit),this.stopDeeplink?.()}setStateFromURL(){let t=x()[this.deeplink];t&&(this.search.value=t)}startDeeplink(){this.stopDeeplink=l(({search:e})=>{this.search.value=e??""})}handleInputSubmit(e){e.preventDefault()}render(){return H`<slot></slot>`}};a(v,"properties",{deeplink:{type:String}});customElements.define("merch-search",v);import{html as b,LitElement as V,css as Y,nothing as F}from"./lit-all.min.js";var p=class extends V{constructor(){super(),this.toggleIconColor=!1,this.handleClickDebounced=u(this.handleClick.bind(this))}selectElement(e,t=!0){e.selected=t,e.parentNode.tagName==="SP-SIDENAV-ITEM"&&this.selectElement(e.parentNode,!1);let o=e.querySelector(".selection");o?.setAttribute("selected",t);let s=o?.dataset,n=t&&this.toggleIconColor?s?.light:s?.dark;n&&e.querySelector("img")?.setAttribute("src",n),t&&(this.selectedElement=e,this.selectedText=s?.selectedText||e.label,this.selectedValue=e.value,setTimeout(()=>{e.selected=!0},1),this.dispatchEvent(new CustomEvent(h,{bubbles:!0,composed:!0,detail:{type:"sidenav",value:this.selectedValue,elt:this.selectedElement}})))}markCurrentItem(e){let t=e.closest("sp-sidenav");t&&(t.querySelectorAll("sp-sidenav-item[aria-current]").forEach(o=>{o.removeAttribute("aria-current")}),e.setAttribute("aria-current","true"))}handleClick({target:e},t=!0){let{value:o,parentNode:s}=e;this.selectElement(e),this.markCurrentItem(e),s?.tagName==="SP-SIDENAV"?(s.querySelectorAll("sp-sidenav-item[expanded],sp-sidenav-item[selected]").forEach(n=>{n.value!==o&&(n.expanded=!1,n.removeAttribute("aria-expanded"),this.selectElement(n,!1))}),s.querySelectorAll(".selection[selected=true]").forEach(n=>{let r=n.parentElement;r.value!==o&&this.selectElement(r,!1)})):s?.tagName==="SP-SIDENAV-ITEM"&&([...s.closest("sp-sidenav")?.querySelectorAll(":scope > sp-sidenav-item")].filter(r=>r!==s).forEach(r=>{r.expanded=!1,r.removeAttribute("aria-expanded")}),s.closest("sp-sidenav")?.querySelectorAll("sp-sidenav-item[selected]").forEach(r=>{r.value!==o&&this.selectElement(r,!1)})),t&&c(this,o)}selectionChanged(e){let{target:{value:t,parentNode:o}}=e;this.selectElement(this.querySelector(`sp-sidenav-item[value="${t}"]`)),c(this,t)}startDeeplink(){this.stopDeeplink=l(e=>{let t=e[this.deeplink]??"all",o=this.querySelector(`sp-sidenav-item[value="${t}"]`);o||(o=this.querySelector("sp-sidenav-item:first-child"),g(this.deeplink,o.value)),this.updateComplete.then(()=>{o.firstElementChild?.tagName==="SP-SIDENAV-ITEM"&&(o.expanded=!0,o.setAttribute("aria-expanded","true")),o.parentNode?.tagName==="SP-SIDENAV-ITEM"&&(o.parentNode.expanded=!0,o.parentNode.setAttribute("aria-expanded","true")),this.handleClick({target:o},!!window.location.hash.includes("category"))})})}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleClickDebounced),this.updateComplete.then(()=>{this.deeplink&&(S(["filter","single_app"]),this.startDeeplink())})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleClickDebounced),this.stopDeeplink?.()}render(){return b`<div
    ...
    `);customElements.define("merch-sidenav-checkbox-group",m);var N="(max-width: 700px)",q="(max-width: 767px)",L="(max-width: 1199px)";var C="(min-width: 1200px)",R="(min-width: 1600px)",Ce={matchMobile:window.matchMedia(q),matchDesktop:window.matchMedia(`${C} and (not ${R})`),matchDesktopOrUp:window.matchMedia(C),matchLargeDesktop:window.matchMedia(R),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}};var W={catalog:"l"},Z={catalog:"xl"},E=class extends K{constructor(){super();a(this,"mobileDevice",new d(this,N));a(this,"mobileAndTablet",new d(this,L));this.open=!1,this.autoclose=!1,this.variant=null,this.closeModal=this.closeModal.bind(this),this.handleSelection=this.handleSelection.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(h,this.handleSelection)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(h,this.handleSelection)}firstUpdated(){let t=W[this.variant];if(t){let s=this.querySelector("merch-search sp-search");s&&s?.setAttribute("size",t)}let o=Z[this.variant];o&&this.querySelectorAll("merch-sidenav-checkbox-group sp-checkbox").forEach(n=>{n.setAttribute("size",o)})}updated(){this.mobileAndTablet.matches?(this.modal=!0,this.style.padding=0,this.style.margin=0):(this.modal=!1,this.style.removeProperty("padding"),this.style.removeProperty("margin"),this.open&&this.closeModal())}get filters(){return this.querySelector("merch-sidenav-list")}get search(){return this.querySelector("merch-search")}render(){return this.mobileAndTablet.matches?this.asDialog:this.asAside}get asDialog(){if(!this.open)return k;let t=this.autoclose?k:T`<sp-link @click="${this.closeModal}"
        ...
        `}get asAside(){return T`<sp-theme color="light" scale="medium"
            ><h2>${this.sidenavTitle}</h2>
            <slot></slot

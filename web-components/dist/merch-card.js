var Ar=Object.defineProperty;var zr=a=>{throw TypeError(a)};var xi=(a,t,e)=>t in a?Ar(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var yi=(a,t)=>()=>(a&&(t=a(a=0)),t);var wi=(a,t)=>{for(var e in t)Ar(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>xi(a,typeof t!="symbol"?t+"":t,e),Qt=(a,t,e)=>t.has(a)||zr("Cannot "+e);var c=(a,t,e)=>(Qt(a,t,"read from private field"),e?e.call(a):t.get(a)),u=(a,t,e)=>t.has(a)?zr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Qt(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),k=(a,t,e)=>(Qt(a,t,"access private method"),e);var Tr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return c(a,t,r)}});var Zt={};wi(Zt,{default:()=>et});import{LitElement as Ei,html as Ce,css as ki,nothing as Ci}from"./lit-all.min.js";import{unsafeHTML as Dr}from"./lit-all.min.js";import{ifDefined as Si}from"./lit-all.min.js";function Ai(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var M,et,Xt=yi(()=>{M=class M extends Ei{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();M.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),h=l?l.offsetWidth:o,p=l?l.offsetHeight:s,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-h-n<0?f="right":f==="right"&&e.right+h+n>r&&(f="left");let A=e.left+e.width/2,B=e.top+e.height/2,te=6,yt=(fi,vi,bi)=>Math.max(fi,Math.min(vi,bi)),wt,Et,Kt;f==="top"||f==="bottom"?(wt=f==="top"?e.top-p-n:e.bottom+n,Et=yt(0,r-h,A-h/2),Kt=yt(te,h-te*2,A-Et-te)):(Et=f==="left"?e.left-h-n:e.right+n,wt=yt(0,i-p,B-p/2),Kt=yt(te,p-te*2,B-wt-te)),this._tooltipTop=wt,this._tooltipLeft=Et,this._arrowOffset=Kt,this._computedPlacement=f}showTooltip(){M.activeTooltip&&M.activeTooltip!==this&&(M.activeTooltip.closeOverlay(),M.activeTooltip.tooltipVisible=!1,M.activeTooltip.requestUpdate()),M.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){M.activeTooltip===this&&(M.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ce`<merch-icon
        ...
        ></merch-icon>`:Ce`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return Ce`<span class="icon-only">${this.renderIcon()}</span>`;if(Ai())return Ce`
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${Si(h)}>
                    ${Dr(t)}
...
`,Or=()=>[Mr`
        ...
        `];import{LitElement as zi,html as Nr,css as Ti}from"./lit-all.min.js";function Li(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Se=class extends zi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Li())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Xt())}e.remove()})}render(){let{href:t}=this;return t?Nr`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(Se,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(Se,"styles",Ti`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Se);var Io=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),$o=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var Ae=2e4;var y='span[is="inline-price"][data-wcs-osi]',Z='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Pi='a[is="upt-link"]',Fr=`${y},${Z},${Pi}`;var Ir="merch-offer-select:ready",$r="merch-card:action-menu-toggle";var R="merch-quantity-selector:change",Br="merch-card-quantity:change",Jt="merch-modal:addon-and-quantity-update";var ze="merch-card-collection:literals-changed";var Te="aem:load",Le="aem:error",Ct="mas:ready",Hr="mas:error";var qr="placeholder-failed",Ur="placeholder-pending",Gr="placeholder-resolved";var jr="mas:failed",G="mas:resolved",Vr="mas/commerce";var re="failed",pe="pending",ae="resolved";var St="X-Request-Id",Bo=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Ho=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var At=":start",zt=":duration";var _="legal",Wr="mas-ff-defaults";var _i="mas-commerce-service";function Yr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function z(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function Pe(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function er(){return window.matchMedia("(max-width: 1024px)").matches}function me(){return document.getElementsByTagName(_i)?.[0]}function tt(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}function Kr(a){let t=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&t?.isInlinePrice&&t?.dataset?.template==="price"}var rt,ge,at,it,_e,Tt=class extends HTMLElement{constructor(){super();u(this,rt,"");u(this,ge);u(this,at,[]);u(this,it,[]);u(this,_e);m(this,_e,Yr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,ge)?this.parentElement.style.borderRadius=c(this,ge):c(this,ge)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,at).map((r,i)=>{let n=c(this,it)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,rt)}, ${e})`}connectedCallback(){c(this,_e).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,ge,i?.trim()),e==="colors"&&i?m(this,at,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,it,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,rt,i?.trim()??""),c(this,_e).call(this)}};rt=new WeakMap,ge=new WeakMap,at=new WeakMap,it=new WeakMap,_e=new WeakMap;customElements.define("merch-gradient",Tt);import{LitElement as Mi,html as Ri,css as Oi}from"./lit-all.min.js";var Me=class extends Mi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(G,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(G,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Ri` <input
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(Me,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),d(Me,"styles",Oi`
        :host {
            --merch-addon-gap: 9px;
...
`;var qi=32,sa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ne=class extends v{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>Mt` <footer>
...
`;var Ot={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},la={...function(){let{whatsIncluded:a,size:t,...e}=Ot;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},da={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=Ot;return i}()},j,V,O=class extends v{constructor(e){super(e);u(this,j);u(this,V);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===_&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ca}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let l=n.querySelector(`footer slot[name="${e}"]`),h=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(s)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&l){if(h)l.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(l):p.appendChild(l)}return}if(i&&h){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!l){let f=h.cloneNode(!0);o.prepend(f)}h.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){c(this,j)||(m(this,j,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(c(this,j)?.disconnect(),m(this,j,null),this.syncHeights())})),c(this,j).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let s=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let h=0,p=this.card.querySelector('[slot="heading-s"]');p&&(h+=tt(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(h+=tt(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(h+=8+tt(f));for(let B of r.childNodes){if(B.classList.contains("spacer"))break;h+=tt(B)}let A=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");h>(parseFloat(A)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${h}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${h}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?st`<div class="divider"></div>`:Rt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?st`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};j=new WeakMap,V=new WeakMap,d(O,"variantStyle",Ui`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?X`
        ...
        `:X`
            ...
            <slot></slot>`}};d(ne,"variantStyle",Gi`
...
`;var Ca={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Be=class extends v{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ka}renderLayout(){return ir`${this.cardImage}
            ...
            ${this.evergreen?ir`
                  ...
                  `:ir`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(Be,"variantStyle",Qi`
...
`;var cr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},cn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],It,Ra,je=class extends v{constructor(e){super(e);u(this,It);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ma}get aemFragmentMapping(){return cr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,k(this,It,Ra).call(this))}renderLayout(){return on`
            ...
            <slot></slot>
        `}};It=new WeakSet,Ra=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;cn.forEach(({key:r,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),r))},d(je,"variantStyle",sn`
...
Caused by: ${this.cause}`),e}};var ve={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ba=1e3;function gn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Ha(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ve.serializableTypes.includes(e))return e}return a}function un(a,t){if(!ve.ignoredProperties.includes(a))return Ha(t)}var pr={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(h=>{h!=null&&(gn(h)?r:i).push(h)}),r.length&&(n+=` ${r.map(Ha).join(" ")}`);let{pathname:o,search:s}=window.location,l=`${ve.delimiter}page=${o}${s}`;l.length>Ba&&(l=`${l.slice(0,Ba)}<trunc>`),n+=l,i.length&&(n+=`${ve.delimiter}facts=`,n+=JSON.stringify(i,un)),window.lana?.log(n,ve)}};function qa(a){Object.assign(ve,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in ve&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Ua={LOCAL:"local",PROD:"prod",STAGE:"stage"},mr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},gr=new Set,ur=new Set,Ga=new Map,ja={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Va={filter:({level:a})=>a!==mr.DEBUG},fn={filter:()=>!1};function vn(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Ht(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function bn(a){[...ur].every(t=>t(a))&&gr.forEach(t=>t(a))}function Wa(a){let t=(Ga.get(a)??0)+1;Ga.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Wa(`${r.namespace}/${i}`),updateConfig:qa};return Object.values(mr).forEach(i=>{r[i]=(n,...o)=>bn(vn(i,n,a,o,e))}),Object.seal(r)}function qt(...a){a.forEach(t=>{let{append:e,filter:r}=t;Ht(r)&&ur.add(r),Ht(e)&&gr.add(e)})}function xn(a={}){let{name:t}=a,e=$a(Bt("commerce.debug",{search:!0,storage:!0}),t===Ua.LOCAL);return qt(e?ja:Va),t===Ua.PROD&&qt(pr),dt}function yn(){gr.clear(),ur.clear()}var dt={...Wa(Vr),Level:mr,Plugins:{consoleAppender:ja,debugFilter:Va,quietFilter:fn,lanaAppender:pr},init:xn,reset:yn,use:qt};var wn="mas-commerce-service",pd=dt.module("utilities"),En={requestId:St,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Ut=a=>window.setTimeout(a);function fr(){return document.getElementsByTagName(wn)?.[0]}function Ya(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(En)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ka(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw i}var Qa="fragment",Za="author",Xa="preview",Ja="loading",ei="timeout",vr="aem-fragment",ti="eager",ri="cache",kn=[ti,ri],K,be,H,br=class{constructor(){u(this,K,new Map);u(this,be,new Map);u(this,H,new Map)}clear(){c(this,K).clear(),c(this,be).clear(),c(this,H).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,K).set(t.id,t),t.fields?.originalId&&c(this,K).set(t.fields.originalId,t),c(this,H).has(t.id)){let[,r]=c(this,H).get(t.id);r()}if(c(this,H).has(t.fields?.originalId)){let[,r]=c(this,H).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,K).has(t)}entries(){return c(this,K).entries()}get(t){return c(this,K).get(t)}getAsPromise(t){let[e]=c(this,H).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),c(this,H).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,be).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,be).set(t,e)),e}remove(t){c(this,K).delete(t),c(this,be).delete(t),c(this,H).delete(t)}};K=new WeakMap,be=new WeakMap,H=new WeakMap;var le=new br,We,F,ee,N,D,T,ht,pt,q,mt,gt,Ye,U,ai,ii,xr,ni,Gt=class extends HTMLElement{constructor(){super(...arguments);u(this,U);d(this,"cache",le);u(this,We);u(this,F,null);u(this,ee,null);u(this,N,null);u(this,D);u(this,T);u(this,ht,ti);u(this,pt,5e3);u(this,q);u(this,mt,!1);u(this,gt,0);u(this,Ye)}static get observedAttributes(){return[Qa,Ja,ei,Za,Xa]}attributeChangedCallback(e,r,i){e===Qa&&(m(this,D,i),m(this,T,le.getFetchInfo(i))),e===Ja&&kn.includes(i)&&m(this,ht,i),e===ei&&m(this,pt,parseInt(i,10)),e===Za&&m(this,mt,["","true"].includes(i)),e===Xa&&m(this,Ye,i)}connectedCallback(){if(!c(this,q)){if(c(this,N)??m(this,N,me(this)),m(this,Ye,c(this,N).settings?.preview),c(this,We)??m(this,We,c(this,N).log.module(`${vr}[${c(this,D)}]`)),!c(this,D)||c(this,D)==="#"){c(this,T)??m(this,T,le.getFetchInfo("missing-fragment-id")),k(this,U,xr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,T)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,q)&&!await Promise.race([c(this,q),Promise.resolve(!1)]))return;e&&le.remove(c(this,D)),c(this,ht)===ri&&await Promise.race([le.getAsPromise(c(this,D)),new Promise(s=>setTimeout(s,c(this,pt)))]);try{m(this,q,k(this,U,ni).call(this)),await c(this,q)}catch(s){return k(this,U,xr).call(this,s.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=c(this,F)||{};return o&&!Bt("mas.disableWcsCache")&&c(this,N).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Te,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...c(this,T)},bubbles:!0,composed:!0})),c(this,q)}get updateComplete(){return c(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,ee)?c(this,ee):(c(this,mt)?this.transformAuthorData():this.transformPublishData(),c(this,ee))}get rawData(){return c(this,F)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:s={},dictionary:l={},placeholders:h={}}=c(this,F);m(this,ee,e.reduce((p,{name:g,multiple:f,values:A})=>(p.fields[g]=f?A:A[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:s,dictionary:l,placeholders:h,variationId:n}))}transformPublishData(){if(!c(this,F))return;let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={},variationId:h}=c(this,F);m(this,ee,Object.entries(e).reduce((p,[g,f])=>(p.fields[g]=f?.mimeType?f.value:f??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:s,placeholders:l,variationId:h}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:c(this,N).settings.locale,apiKey:c(this,N).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??c(this,N).settings.instant;return n&&(i.instant=n),await r(c(this,D),i)}};We=new WeakMap,F=new WeakMap,ee=new WeakMap,N=new WeakMap,D=new WeakMap,T=new WeakMap,ht=new WeakMap,pt=new WeakMap,q=new WeakMap,mt=new WeakMap,gt=new WeakMap,Ye=new WeakMap,U=new WeakSet,ai=async function(e){Tr(this,gt)._++;let r=`${vr}:${c(this,D)}:${c(this,gt)}`,i=`${r}${At}`,n=`${r}${zt}`;if(c(this,Ye)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new ce(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(c(this,T).stale=!1,c(this,T).url=e,o=await Ka(e,{cache:"default",credentials:"omit"}),k(this,U,ii).call(this,o),c(this,T).status=o?.status,c(this,T).measure=Pe(performance.measure(n,i)),c(this,T).retryCount=o.retryCount,!o?.ok)throw new ce("Unexpected fragment response",{response:o,...c(this,N).duration});return await o.json()}catch(s){if(c(this,T).measure=Pe(performance.measure(n,i)),c(this,T).retryCount=s.retryCount,c(this,F))return c(this,T).stale=!0,c(this,We).error("Serving stale data",c(this,T)),c(this,F);let l=s.message??"unknown";throw new ce(`Failed to fetch fragment: ${l}`,{})}},ii=function(e){Object.assign(c(this,T),Ya(e))},xr=function(e){m(this,q,null),c(this,T).message=e,this.classList.add("error");let r={...c(this,T),...c(this,N).duration};c(this,We).error(e,r),this.dispatchEvent(new CustomEvent(Le,{detail:r,bubbles:!0,composed:!0}))},ni=async function(){var l;this.classList.remove("error"),m(this,ee,null);let e=le.get(c(this,D));if(e)return m(this,F,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=c(this,N).settings,s=`${r}/fragment?id=${c(this,D)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await k(this,U,ai).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,D)),le.add(e),m(this,F,e),!0},d(Gt,"cache",le);customElements.define(vr,Gt);import{LitElement as Cn,html as yr,css as Sn,nothing as An}from"./lit-all.min.js";import{unsafeHTML as zn}from"./lit-all.min.js";var Tn=a=>a?a.startsWith("sp-icon-")?yr`${zn(`<${a} class="badge-icon"></${a}>`)}`:yr`<img src="${a}" class="badge-icon" />`:An,Ke=class extends Cn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return yr`<div class="badge">
    ...
    `),d(ut,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ut);import{html as wr,css as Mn,LitElement as Rn,nothing as oi}from"./lit-all.min.js";var ft=class extends Rn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return wr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?wr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:oi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(ft,"styles",Mn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

...
`;var mt=class extends v{constructor(t){super(t)}getGlobalCSS(){return Tr}renderLayout(){return Lr` ${this.badge}
            ...
            ${this.card.customHr?"":Lr`<hr />`} ${this.secureLabelFooter}`}};import{html as X,css as Za,unsafeCSS as Pr}from"./lit-all.min.js";var zr=`
  :root {

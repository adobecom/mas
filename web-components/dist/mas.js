...
`,gl=()=>[S`
        ...
        `];I();function wm(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var er=class extends X{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(wm())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(r=>{let i="",a="top";if(r.tagName==="SP-TOOLTIP")i=r.textContent,a=r.getAttribute("placement")||"top";else if(r.tagName==="OVERLAY-TRIGGER"){let n=r.querySelector("sp-tooltip");n&&(i=n.textContent,a=n.getAttribute("placement")||r.getAttribute("placement")||"top")}if(i){let n=document.createElement("mas-mnemonic");n.setAttribute("content",i),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Aa())}r.remove()})}render(){let{href:t}=this;return t?x`<a href="${t}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
    ...
    `);customElements.define("merch-icon",er);var hi,Rt,pi,mi,tr,Sa=class extends HTMLElement{constructor(){super();A(this,hi,"");A(this,Rt);A(this,pi,[]);A(this,mi,[]);A(this,tr);E(this,tr,Ze(()=>{this.isConnected&&(this.parentElement.style.background=this.value,m(this,Rt)?this.parentElement.style.borderRadius=m(this,Rt):m(this,Rt)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let r=m(this,pi).map((i,a)=>{let n=m(this,mi)[a]||"";return`${i} ${n}`}).join(", ");return`linear-gradient(${m(this,hi)}, ${r})`}connectedCallback(){m(this,tr).call(this)}attributeChangedCallback(r,i,a){r==="border-radius"&&E(this,Rt,a?.trim()),r==="colors"&&a?E(this,pi,a?.split(",").map(n=>n.trim())??[]):r==="positions"&&a?E(this,mi,a?.split(",").map(n=>n.trim())??[]):r==="angle"&&E(this,hi,a?.trim()??""),m(this,tr).call(this)}};hi=new WeakMap,Rt=new WeakMap,pi=new WeakMap,mi=new WeakMap,tr=new WeakMap;customElements.define("merch-gradient",Sa);I();var rr=class extends X{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,r){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[r]||[r]).map(s=>`p[data-plan-type="${t}"] ${O}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Gt,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Gt,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let r=t.target,i=r?.value?.[0];i&&(r.setAttribute("data-offer-type",i.offerType),r.closest("p").setAttribute("data-plan-type",i.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return x` <input
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};g(rr,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),g(rr,"styles",S`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",rr);I();var ir,ui=class ui{constructor(t){g(this,"card");A(this,ir);this.card=t,this.insertVariantStyle()}getContainer(){return E(this,ir,m(this,ir)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),m(this,ir)}insertVariantStyle(){let t=this.constructor.name;if(!ui.styleMap[t]){ui.styleMap[t]=!0;let r=document.createElement("style");r.innerHTML=this.getGlobalCSS(),document.head.appendChild(r)}}updateCardElementMinHeight(t,r){if(!t||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),x`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:_}get secureLabelFooter(){return x`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return this.constructor.fragmentMapping??null}};ir=new WeakMap,g(ui,"styleMap",{});var L=ui;I();var yl=`
:root {
...
`;var Ca=class extends L{constructor(t){super(t)}getGlobalCSS(){return Sl}renderLayout(){return x` ${this.badge}
            ...
            ${this.card.customHr?"":x`<hr />`} ${this.secureLabelFooter}`}};I();var Cl=`
  :root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let r=t.querySelector("strong, b, p");r&&(D.isMobile?r.style.display="none":r.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?D.isMobile?x`
        ...
        `:x`
            ...
            `:_}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?x`<slot name="icons"></slot>`:_}get secureLabelFooter(){return x`<footer>
...
@media screen and ${H} and (max-width: 1399px) {
    merch-card-collection.full-pricing-express {
        grid-template-columns: repeat(2, 1fr);
...
`;document.head.appendChild(Ql);var Zl="fragment",Jl="author",ed="preview",td="loading",rd="timeout",Eo="aem-fragment",id="eager",ad="cache",Tm=[id,ad],qe,Ot,He,Ao=class{constructor(){A(this,qe,new Map);A(this,Ot,new Map);A(this,He,new Map)}clear(){m(this,qe).clear(),m(this,Ot).clear(),m(this,He).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(m(this,qe).set(t.id,t),t.fields?.originalId&&m(this,qe).set(t.fields.originalId,t),m(this,He).has(t.id)){let[,i]=m(this,He).get(t.id);i()}if(m(this,He).has(t.fields?.originalId)){let[,i]=m(this,He).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return m(this,qe).has(t)}entries(){return m(this,qe).entries()}get(t){return m(this,qe).get(t)}getAsPromise(t){let[r]=m(this,He).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),m(this,He).set(t,[r,i]),r}getFetchInfo(t){let r=m(this,Ot).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},m(this,Ot).set(t,r)),r}remove(t){m(this,qe).delete(t),m(this,Ot).delete(t),m(this,He).delete(t)}};qe=new WeakMap,Ot=new WeakMap,He=new WeakMap;var dt=new Ao,gr,ze,tt,ke,Ee,ne,gi,fi,$e,bi,xi,fr,De,nd,od,So,sd,La=class extends HTMLElement{constructor(){super(...arguments);A(this,De);g(this,"cache",dt);A(this,gr);A(this,ze,null);A(this,tt,null);A(this,ke,null);A(this,Ee);A(this,ne);A(this,gi,id);A(this,fi,5e3);A(this,$e);A(this,bi,!1);A(this,xi,0);A(this,fr)}static get observedAttributes(){return[Zl,td,rd,Jl,ed]}attributeChangedCallback(r,i,a){r===Zl&&(E(this,Ee,a),E(this,ne,dt.getFetchInfo(a))),r===td&&Tm.includes(a)&&E(this,gi,a),r===rd&&E(this,fi,parseInt(a,10)),r===Jl&&E(this,bi,["","true"].includes(a)),r===ed&&E(this,fr,a)}connectedCallback(){if(!m(this,$e)){if(m(this,ke)??E(this,ke,Ie(this)),E(this,fr,m(this,ke).settings?.preview),m(this,gr)??E(this,gr,m(this,ke).log.module(`${Eo}[${m(this,Ee)}]`)),!m(this,Ee)||m(this,Ee)==="#"){m(this,ne)??E(this,ne,dt.getFetchInfo("missing-fragment-id")),ie(this,De,So).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(m(this,ne)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(m(this,$e)&&!await Promise.race([m(this,$e),Promise.resolve(!1)]))return;r&&dt.remove(m(this,Ee)),m(this,gi)===ad&&await Promise.race([dt.getAsPromise(m(this,Ee)),new Promise(s=>setTimeout(s,m(this,fi)))]);try{E(this,$e,ie(this,De,sd).call(this)),await m(this,$e)}catch(s){return ie(this,De,So).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=m(this,ze)||{};return o&&!Y("mas.disableWcsCache")&&m(this,ke).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(pe,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...m(this,ne)},bubbles:!0,composed:!0})),m(this,$e)}get updateComplete(){return m(this,$e)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return m(this,tt)?m(this,tt):(m(this,bi)?this.transformAuthorData():this.transformPublishData(),m(this,tt))}get rawData(){return m(this,ze)}transformAuthorData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=m(this,ze);E(this,tt,r.reduce((l,{name:d,multiple:h,values:p})=>(l.fields[d]=h?p:p[0],l),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=m(this,ze);E(this,tt,Object.entries(r).reduce((l,[d,h])=>(l.fields[d]=h?.mimeType?h.value:h??"",l),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(m(this,Ee),{locale:m(this,ke).settings.locale,apiKey:m(this,ke).settings.wcsApiKey})}};gr=new WeakMap,ze=new WeakMap,tt=new WeakMap,ke=new WeakMap,Ee=new WeakMap,ne=new WeakMap,gi=new WeakMap,fi=new WeakMap,$e=new WeakMap,bi=new WeakMap,xi=new WeakMap,fr=new WeakMap,De=new WeakSet,nd=async function(r){Ft(this,xi)._++;let i=`${Eo}:${m(this,Ee)}:${m(this,xi)}`,a=`${i}${Re}`,n=`${i}${Ne}`;if(m(this,fr))return await this.generatePreview();performance.mark(a);let o;try{if(m(this,ne).stale=!1,m(this,ne).url=r,o=await ma(r,{cache:"default",credentials:"omit"}),ie(this,De,od).call(this,o),m(this,ne).status=o?.status,m(this,ne).measure=xe(performance.measure(n,a)),m(this,ne).retryCount=o.retryCount,!o?.ok)throw new Ye("Unexpected fragment response",{response:o,...m(this,ke).duration});return await o.json()}catch(s){if(m(this,ne).measure=xe(performance.measure(n,a)),m(this,ne).retryCount=s.retryCount,m(this,ze))return m(this,ne).stale=!0,m(this,gr).error("Serving stale data",m(this,ne)),m(this,ze);let c=s.message??"unknown";throw new Ye(`Failed to fetch fragment: ${c}`,{})}},od=function(r){Object.assign(m(this,ne),Qi(r))},So=function(r){E(this,$e,null),m(this,ne).message=r,this.classList.add("error");let i={...m(this,ne),...m(this,ke).duration};m(this,gr).error(r,i),this.dispatchEvent(new CustomEvent(me,{detail:i,bubbles:!0,composed:!0}))},sd=async function(){var c;this.classList.remove("error"),E(this,tt,null);let r=dt.get(m(this,Ee));if(r)return E(this,ze,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=m(this,ke).settings,s=`${i}/fragment?id=${m(this,Ee)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await ie(this,De,nd).call(this,s),(c=r.fields).originalId??(c.originalId=m(this,Ee)),dt.add(r),E(this,ze,r),!0},g(La,"cache",dt);customElements.define(Eo,La);I();bo();var km=e=>e?e.startsWith("sp-icon-")?x`${Ea(`<${e} class="badge-icon"></${e}>`)}`:x`<img src="${e}" class="badge-icon" />`:_,br=class extends X{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return x`<div class="badge">
    ...
    `),g(vi,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",vi);I();var yi=class extends X{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return x`<slot name="heading"></slot>
            ...
            ${!this.isMobile||!this.bulletsAdded?x`<slot name="content"></slot>`:_}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?x`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:_}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};g(yi,"styles",S`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),g(Ai,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Ai);I();I();var md=S`
    :host {
...
`;var[gE,fE,Po,Mo,gd,fd]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Ro=class extends X{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return ud}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=Ze(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=Ze(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(qt,this.debouncedQuantityUpdate)}get button(){return this.shadowRoot.querySelector("button")}handleKeyup(t){t.key===Mo||t.key===Po||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let t=this.options[this.highlightedIndex];if(!t){this.closed=!0;return}this.selectedValue=t,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(t){switch(t.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case fd:this.selectValue();break;case Mo:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,t.preventDefault();break;case Po:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),t.preventDefault();break;case gd:this.selectValue(),this.button.classList.contains("focused")&&t.preventDefault();break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=t.value.replace(/\D/g,"");t.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let a=i;this.maxInput&&i>this.maxInput&&(a=this.maxInput),this.min&&a<this.min&&(a=this.min),this.adjustInput(t,a)}else this.adjustInput(t,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(qt,this.debouncedQuantityUpdate)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}update(t){(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue"))&&(this.options=this.generateOptionsArray(),this.highlightedIndex=this.defaultValue?this.options.indexOf(this.defaultValue):0,this.handleMenuOption(this.defaultValue?this.defaultValue:this.options[0])),super.update(t)}handleClickOutside(t){t.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let t=this.shadowRoot.querySelector(".popover");this.closed||t.getBoundingClientRect().bottom<=window.innerHeight?t.setAttribute("placement","bottom"):t.setAttribute("placement","top")}handleMouseEnter(t){this.highlightedIndex=t}handleMenuOption(t,r){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let t=new CustomEvent(oe,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return x` <div
            id="qsPopover"
        ...
        >
            ${this.options.map((t,r)=>x`
                ...
                `)}
        </div>`}handleQuantityUpdate({detail:{quantity:t}}){if(t&&t!==this.selectedValue){this.selectedValue=t;let r=this.shadowRoot.querySelector(".text-field-input");r&&(r.value=t),this.sendEvent()}}onButtonFocus(t){t.target.classList.add("focused")}onButtonBlur(t){t.target.classList.remove("focused")}render(){return x`
...
`;var Vd={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},Rr=class extends L{getGlobalCSS(){return Gd}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return x` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};g(Rr,"variantStyle",S`
...
`;var Wd={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Nr=class extends L{getGlobalCSS(){return jd}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Qo={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},Hr=class extends L{getGlobalCSS(){return Kd}get aemFragmentMapping(){return Qo}renderLayout(){return x`
    ...
    `);K("ccd-suggested",Rr,Vd,Rr.variantStyle);K("ccd-slice",Nr,Wd,Nr.variantStyle);K("ah-try-buy-widget",Or,Xo,Or.variantStyle);K("ah-promoted-plans",Ir,Ko,Ir.variantStyle);K("fries",Hr,Qo,Hr.variantStyle);

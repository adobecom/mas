var nn=Object.defineProperty;var on=e=>{throw TypeError(e)};var Sc=(e,r,t)=>r in e?nn(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Ac=(e,r)=>{for(var t in r)nn(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Sc(e,typeof r!="symbol"?r+"":r,t),ba=(e,r,t)=>r.has(e)||on("Cannot "+t);var v=(e,r,t)=>(ba(e,r,"read from private field"),t?t.call(e):r.get(e)),S=(e,r,t)=>r.has(e)?on("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),w=(e,r,t,a)=>(ba(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),U=(e,r,t)=>(ba(e,r,"access private method"),t);import{html as Ie,LitElement as pc,css as mc,unsafeCSS as hc,nothing as ye}from"./lit-all.min.js";var z="(max-width: 767px)",Z="(max-width: 1199px)",L="(min-width: 768px)",_="(min-width: 1200px)",ie="(min-width: 1600px)",Xe="(min-width: 1280px)",sn={matchMobile:window.matchMedia(z),matchDesktop:window.matchMedia(`${_} and (not ${ie})`),matchDesktopOrUp:window.matchMedia(_),matchLargeDesktop:window.matchMedia(ie),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},C=sn;function Pr(){return sn.isDesktop}var Vt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var cn="hashchange";function Cc(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function jt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function ln(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=Cc(window.location.hash);e(t)};return r(),window.addEventListener(cn,r),()=>{window.removeEventListener(cn,r)}}var Va={};Ac(Va,{CLASS_NAME_FAILED:()=>La,CLASS_NAME_HIDDEN:()=>kc,CLASS_NAME_PENDING:()=>Pa,CLASS_NAME_RESOLVED:()=>Ma,CheckoutWorkflow:()=>$c,CheckoutWorkflowStep:()=>se,Commitment:()=>Ke,ERROR_MESSAGE_BAD_REQUEST:()=>Ra,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Fc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Na,EVENT_AEM_ERROR:()=>ka,EVENT_AEM_LOAD:()=>Ta,EVENT_COMPARE_CHART_REHYDRATE:()=>Dc,EVENT_EXPANDED_GROUPS_CHANGE:()=>Hc,EVENT_MAS_ERROR:()=>_a,EVENT_MAS_READY:()=>Nr,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>Ic,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Ea,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>fe,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Aa,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Wt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Sa,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Rr,EVENT_MERCH_OFFER_READY:()=>Pc,EVENT_MERCH_OFFER_SELECT_READY:()=>Mc,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ne,EVENT_MERCH_SEARCH_CHANGE:()=>zc,EVENT_MERCH_SIDENAV_SELECT:()=>Ca,EVENT_MERCH_STOCK_CHANGE:()=>Nc,EVENT_MERCH_STORAGE_CHANGE:()=>Oc,EVENT_OFFER_SELECTED:()=>Rc,EVENT_TYPE_FAILED:()=>Oa,EVENT_TYPE_READY:()=>Mr,EVENT_TYPE_RESOLVED:()=>oe,Env:()=>we,FF_ANNUAL_PRICE:()=>he,FF_DEFAULTS:()=>Le,HEADER_X_REQUEST_ID:()=>Yt,LOG_NAMESPACE:()=>Ia,Landscape:()=>Fe,MARK_DURATION_SUFFIX:()=>Ga,MARK_START_SUFFIX:()=>$a,MERCH_CARD_LOAD_TIMEOUT:()=>ya,MODAL_TYPE_3_IN_1:()=>Qe,NAMESPACE:()=>Tc,PARAM_AOS_API_KEY:()=>Bc,PARAM_ENV:()=>Da,PARAM_LANDSCAPE:()=>Ha,PARAM_MAS_PREVIEW:()=>za,PARAM_WCS_API_KEY:()=>Uc,PLACEHOLDER_PLAN_TYPE_TEXT:()=>jc,PROVIDER_ENVIRONMENT:()=>Ua,SELECTOR_MAS_CHECKOUT_LINK:()=>dn,SELECTOR_MAS_ELEMENT:()=>wa,SELECTOR_MAS_INLINE_PRICE:()=>F,SELECTOR_MAS_SP_BUTTON:()=>Lc,SELECTOR_MAS_UPT_LINK:()=>hn,SORT_ORDER:()=>xe,STATE_FAILED:()=>ve,STATE_PENDING:()=>He,STATE_RESOLVED:()=>_e,SUPPORTED_COUNTRIES:()=>qa,TAG_NAME_SERVICE:()=>_c,TEMPLATE_PRICE:()=>Gc,TEMPLATE_PRICE_ANNUAL:()=>Vc,TEMPLATE_PRICE_LEGAL:()=>X,TEMPLATE_PRICE_STRIKETHROUGH:()=>qc,TRIAL_ANALYTICS_IDS:()=>pn,Term:()=>me,WCS_PROD_URL:()=>Fa,WCS_STAGE_URL:()=>Ba});var Ke=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),me=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Tc="merch",ya=2e4,kc="hidden",Mr="wcms:commerce:ready",_c="mas-commerce-service",F='span[is="inline-price"][data-wcs-osi]',dn='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Lc="sp-button[data-wcs-osi]",hn='a[is="upt-link"]',wa=`${F},${dn},${hn}`,pn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]),Pc="merch-offer:ready",Mc="merch-offer-select:ready",Ea="merch-card:action-menu-toggle",Rc="merch-offer:selected",Nc="merch-stock:change",Oc="merch-storage:change",ne="merch-quantity-selector:change",Rr="merch-card-quantity:change",Ic="merch-modal:addon-and-quantity-update",zc="merch-search:change",Sa="merch-card-collection:sort",fe="merch-card-collection:literals-changed",Wt="merch-card-collection:sidenav-attached",Aa="merch-card-collection:showmore",Ca="merch-sidenav:select",Ta="aem:load",ka="aem:error",Nr="mas:ready",_a="mas:error",Dc="mas-compare-chart:rehydrate",Hc="expanded-groups-change",La="placeholder-failed",Pa="placeholder-pending",Ma="placeholder-resolved",Ra="Bad WCS request",Na="Commerce offer not found",Fc="Literals URL not provided",Oa="mas:failed",oe="mas:resolved",Ia="mas/commerce",za="mas.preview",Da="commerce.env",Ha="commerce.landscape",Bc="commerce.aosKey",Uc="commerce.wcsKey",Fa="https://www.adobe.com/web_commerce_artifact",Ba="https://www.stage.adobe.com/web_commerce_artifact_stage",ve="failed",He="pending",_e="resolved",Fe={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Yt="X-Request-Id",se=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),$c="UCv3",we=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Ua={PRODUCTION:"PRODUCTION"},Qe={TWP:"twp",D2P:"d2p",CRM:"crm"},$a=":start",Ga=":duration",Gc="price",qc="price-strikethrough",Vc="annual",X="legal",jc="plan-type-text",Le="mas-ff-defaults",he="mas-ff-annual-price",xe={alphabetical:"alphabetical",authored:"authored"},qa=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Wc="mas-commerce-service";function mn(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Xt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function Ee(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Or(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Wa(){return window.matchMedia("(max-width: 1024px)").matches}var ja=new Map,Yc=0;function un(e,r){let t=++Yc,a=r,i=performance.now(),n,o=()=>{Ya(t),e()},s=()=>{i=performance.now(),n=setTimeout(o,a)},c=()=>{document.visibilityState==="hidden"?(clearTimeout(n),a-=performance.now()-i):s()};return ja.set(t,()=>{clearTimeout(n),document.removeEventListener("visibilitychange",c)}),document.addEventListener("visibilitychange",c),document.visibilityState!=="hidden"&&s(),t}function Ya(e){let r=ja.get(e);r&&(r(),ja.delete(e))}function Kt(){return document.getElementsByTagName(Wc)?.[0]}function Qt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var Xc=["adobe.com","adobeioruntime.net","aem.live","aem.page"],Kc=["localhost","127.0.0.1"];function gn(e){try{let r=new URL(e);return Kc.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:Xc.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as Ir,nothing as Qc}from"./lit-all.min.js";var mt,Zt=class Zt{constructor(r){g(this,"card");S(this,mt);this.card=r,this.insertVariantStyle()}getContainer(){return w(this,mt,v(this,mt)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,mt)}insertVariantStyle(){let r=this.constructor.name;if(!Zt.styleMap[r]){Zt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(h=>h.style.getPropertyValue(l)),m=0,p=o.map(h=>{h.style.removeProperty(l);let u=c(h);if(!u)return u;let f=Math.max(0,parseInt(window.getComputedStyle(u).height)||0);return f>m&&(m=f),u});o.forEach((h,u)=>{p[u]?.tagName!=="HR"&&(m>0?h.style.setProperty(l,`${m}px`):d[u]&&h.style.setProperty(l,d[u]))})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Ir`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return fn}setAriaExpanded(t,a){t.setAttribute("aria-expanded",a)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};g(ut,"variantStyle",Zc`
    ...
    `);import{html as Jt,css as Jc}from"./lit-all.min.js";var xn=`
:root {
...
`;var bn={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},Ze=class extends y{constructor(r){super(r)}getGlobalCSS(){return xn}renderLayout(){return Jt`<div class="image">
                <slot name="bg-image"></slot>
    ...
    `);import{html as wn}from"./lit-all.min.js";var yn=`
:root {
...
`;var Dr=class extends y{constructor(r){super(r)}getGlobalCSS(){return yn}renderLayout(){return wn` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":wn`<hr />`} ${this.secureLabelFooter}`}};import{html as Be,css as Sl,unsafeCSS as Un}from"./lit-all.min.js";var En=`
  :root {
...
`;var Sn="tacocat.js";var Ka=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),An=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function $(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=gt(a)?a:e;n=o.get(s)}if(i&&n==null){let o=gt(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=tl(gt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var el=e=>typeof e=="boolean",Hr=e=>typeof e=="function",Fr=e=>typeof e=="number",Cn=e=>e!=null&&typeof e=="object";var gt=e=>typeof e=="string",Qa=e=>gt(e)&&e,ft=e=>Fr(e)&&Number.isFinite(e)&&e>0;function Br(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function T(e,r){if(el(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function er(e,r,t){let a=Object.values(r);return a.find(i=>Ka(i,e))??t??a[0]}function tl(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function Tn(e,r=1){return Fr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var rl=Date.now(),Za=()=>`(+${Date.now()-rl}ms)`,Ur=new Set,al=T($("tacocat.debug",{},{metadata:!1}),!1);function kn(e){let r=`[${Sn}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=al?(o,...s)=>{console.debug(`${r} ${o}`,...s,Za())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;Ur.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;Ur.forEach(([,l])=>l(c,...s))}}}function il(e,r){let t=[e,r];return Ur.add(t),()=>{Ur.delete(t)}}il((e,...r)=>{console.error(e,...r,Za())},(e,...r)=>{console.warn(e,...r,Za())});var nl="no promo",_n="promo-tag",ol="yellow",sl="neutral",cl=(e,r,t)=>{let a=n=>n||nl,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},$r="cancel-context",Gr=(e,r)=>{let t=e===$r,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?_n:`${_n} no-promo`,text:cl(o,r,i),variant:n?ol:sl,isOverriden:i}};var Ja;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Ja||(Ja={}));var pe;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(pe||(pe={}));var ue;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(ue||(ue={}));var ei;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(ei||(ei={}));var ti;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ti||(ti={}));var ri;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(ri||(ri={}));var ai;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(ai||(ai={}));var ii="ABM",ni="PUF",oi="M2M",si="PERPETUAL",ci="P3Y",ll="TAX_INCLUSIVE_DETAILS",dl="TAX_EXCLUSIVE",Ln={ABM:ii,PUF:ni,M2M:oi,PERPETUAL:si,P3Y:ci},Dp={[ii]:{commitment:pe.YEAR,term:ue.MONTHLY},[ni]:{commitment:pe.YEAR,term:ue.ANNUAL},[oi]:{commitment:pe.MONTH,term:ue.MONTHLY},[si]:{commitment:pe.PERPETUAL,term:void 0},[ci]:{commitment:pe.THREE_MONTHS,term:ue.P3Y}},Pn="Value is not an offer",qr=e=>{if(typeof e!="object")return Pn;let{commitment:r,term:t}=e,a=hl(r,t);return{...e,planType:a}};var hl=(e,r)=>{switch(e){case void 0:return Pn;case"":return"";case pe.YEAR:return r===ue.MONTHLY?ii:r===ue.ANNUAL?ni:"";case pe.MONTH:return r===ue.MONTHLY?oi:"";case pe.PERPETUAL:return si;case pe.TERM_LICENSE:return r===ue.P3Y?ci:"";default:return""}};function Mn(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==ll)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:dl}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Je={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Rn=1e3;function pl(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Nn(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Je.serializableTypes.includes(t))return t}return e}function ml(e,r){if(!Je.ignoredProperties.includes(e))return Nn(r)}var li={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(pl(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(Nn).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${Je.delimiter}page=${o}${s}`;c.length>Rn&&(c=`${c.slice(0,Rn)}<trunc>`),n+=c,i.length&&(n+=`${Je.delimiter}facts=`,n+=JSON.stringify(i,ml)),window.lana?.log(n,Je)}};function Vr(e){Object.assign(Je,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in Je&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var On={LOCAL:"local",PROD:"prod",STAGE:"stage"},di={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},hi=new Set,pi=new Set,In=new Map,zn={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},Dn={filter:({level:e})=>e!==di.DEBUG},ul={filter:()=>!1};function gl(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&Hr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function fl(e){[...pi].every(r=>r(e))&&hi.forEach(r=>r(e))}function Hn(e){let r=(In.get(e)??0)+1;In.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>Hn(`${a.namespace}/${i}`),updateConfig:Vr};return Object.values(di).forEach(i=>{a[i]=(n,...o)=>fl(gl(i,n,e,o,t))}),Object.seal(a)}function jr(...e){e.forEach(r=>{let{append:t,filter:a}=r;Hr(a)&&pi.add(a),Hr(t)&&hi.add(t)})}function vl(e={}){let{name:r}=e,t=T($("commerce.debug",{search:!0,storage:!0}),r===On.LOCAL);return jr(t?zn:Dn),r===On.PROD&&jr(li),ce}function xl(){hi.clear(),pi.clear()}var ce={...Hn(Ia),Level:di,Plugins:{consoleAppender:zn,debugFilter:Dn,quietFilter:ul,lanaAppender:li},init:vl,reset:xl,use:jr};var bl="mas-commerce-service",yl=ce.module("utilities"),wl={requestId:Yt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function tr(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map(Mn)),a}var Fn=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function mi(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let m=l.includes(".")?r.priceDetails?.formatString:r[l],p=l.includes(".")?s.priceDetails?.formatString:s[l];p!==m&&yl.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:m,actual:p})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=Fn(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=Fn(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var Wr=e=>window.setTimeout(e);function vt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(Tn).filter(ft);return t.length||(t=[r]),t}function El(e){return e==null?[]:Array.isArray(e)?e:String(e).split(",").map(r=>r.trim())}function Yr(e,r){let t=El(r);if(e==null)return{wcsOsi:[],promotionCodes:t};let a=Array.isArray(e)?e:String(e).split(",");if(t.length<=1)return{wcsOsi:a.filter(Qa),promotionCodes:t};let i=[],n=[];return a.forEach((o,s)=>{Qa(o)&&(i.push(o),n.push(t[s]??""))}),{wcsOsi:i,promotionCodes:n}}function j(){return document.getElementsByTagName(bl)?.[0]}function Bn(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(wl)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var Al=32,$n={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"};function rr(e,r,t,a){e?.featureFlags[he]&&r.options[a]?t.dataset[a]="false":r.options[a]&&(r.dataset[a]="false")}var xt=class extends y{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Be`<slot name="secure-transaction-label">
    ...
    `);import{html as Xr,css as Cl,unsafeCSS as ui,nothing as Tl}from"./lit-all.min.js";var Gn=`
  :root {
...
`;var kl=32,_l=0,Ll=()=>`mweb-list-${_l+=1}`,Pl=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],Ml=8,qn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Se,et,yt,wt,Et,Ue,gi,fi,bt=class extends y{constructor(t){super(t);S(this,Ue);S(this,Se);S(this,et);S(this,yt);S(this,wt,0);S(this,Et);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Xr` <footer>
        ...
        `}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),C.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),C.isMobile||await U(this,Ue,fi).call(this)}resetSyncedHeights(){let t=this.getContainer();if(!t)return;let a=this.card.variant,i=U(this,Ue,gi).call(this,t);for(let n of Pl){let o=`--consonant-merch-card-${a}-${n}-height`;t.style.removeProperty(o),i.forEach(s=>s.style.removeProperty(o))}for(let n=1;n<=Ml;n+=1)t.style.removeProperty(this.getRowMinHeightPropertyName(n))}};Se=new WeakMap,et=new WeakMap,yt=new WeakMap,wt=new WeakMap,Et=new WeakMap,Ue=new WeakSet,gi=function(t){return t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)},fi=async function(){let t=this.getContainer();if(!t)return;let a=Array.from(U(this,Ue,gi).call(this,t));this.card===a[0]&&(await Promise.all(a.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),requestAnimationFrame(()=>{this.resetSyncedHeights(),this.syncHeights()}))},g(bt,"variantStyle",Cl`
    ...
    `);import{html as ar,css as Rl,nothing as Kr}from"./lit-all.min.js";var Vn=`
:root {
...
`;var Qr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},jn={...(function(){let{whatsIncluded:e,size:r,...t}=Qr;return t})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Wn={...(function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=Qr;return i})()},Ae,Ce,le=class extends y{constructor(t){super(t);S(this,Ae);S(this,Ce);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===X&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Vn}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(s)){if(o?.classList.toggle("wide-footer",C.isDesktopOrUp),!i&&c){if(l)c.remove();else{let m=d.querySelector(`[data-placeholder-for="${t}"]`);m?m.replaceWith(c):d.appendChild(c)}return}if(i&&l){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",t),m.classList.add("slot-placeholder"),!c){let p=l.cloneNode(!0);o.prepend(p)}l.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],C.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],C.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,Ae)||(w(this,Ae,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Ae)?.disconnect(),w(this,Ae,null),this.syncHeights())})),v(this,Ae).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),a.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Qt(d));let m=this.card.querySelector('[slot="subtitle"]');m&&(l+=Qt(m));let p=this.card.querySelector('[slot="heading-m"]');p&&(l+=8+Qt(p));for(let u of a.childNodes){if(u.classList.contains("spacer"))break;l+=Qt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${F}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?ar`<div class="divider"></div>`:Kr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${F}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?ar`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Ae=new WeakMap,Ce=new WeakMap,g(le,"variantStyle",Rl`
        :host([variant^='plans']) {
            min-height: 273px;
...
`;var[Dm,Hm,Zn,Jn,eo,to]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var ea="pro",vi=`--consonant-merch-card-${ea}-top-card-height`,Jr=[{prop:`--consonant-merch-card-${ea}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${ea}-name-description-height`,selector:".name-description"}],ro=`--consonant-merch-card-${ea}-strike-reserve`,xi='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',Il="(min-width: 768px)",ao={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Re,tt,cr,lr,K,io,nr,no,or,bi,ta,ra=class ra extends y{constructor(t){super(t);S(this,K);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);S(this,Re,null);S(this,tt,null);S(this,cr,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);S(this,lr,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of U(this,K,io).call(this)){let n=i.variantLayout;n instanceof ra&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?U(this,K,bi).call(this):U(this,K,or).call(this),this.card.requestUpdate()});S(this,ta,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case Jn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:U(this,K,or).call(this);break;case Zn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:U(this,K,or).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case eo:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}U(this,K,or).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),U(this,K,bi).call(this);break;case to:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,U(this,K,nr).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(ne,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return Qn}priceOptionsProvider(t,a){t.dataset.template===X&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(oe,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]');if(!t?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=t.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${F}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=vi,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(Il).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,m)=>{let p=l(m);return p?Math.max(d,parseInt(getComputedStyle(p).height)||0):d},0);for(let c of o.values()){if(c.forEach(p=>this.clearSyncedHeights(p)),c.length<2)continue;let l=c.map(p=>p.querySelector(xi)&&parseInt(getComputedStyle(p.querySelector(xi)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((p,h)=>{let u=d-l[h];u>0&&p.style.setProperty(ro,`${u}px`)});for(let p of Jr){let h=s(c,u=>u.shadowRoot?.querySelector(p.selector));h>0&&c.forEach(u=>u.style.setProperty(p.prop,`${h}px`))}let m=s(c,p=>p.shadowRoot?.querySelector(".top-card"));m>0&&c.forEach(p=>p.style.setProperty(i,`${m}px`))}}clearSyncedHeights(t){t.style.removeProperty(vi),t.style.removeProperty(ro),Jr.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(xi),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Rr,v(this,lr)),this.card.addEventListener(ne,this.updatePriceQuantity),this.card.addEventListener(oe,v(this,cr)),typeof ResizeObserver>"u"))return;w(this,tt,new ResizeObserver(()=>this.resyncOnReflow())),v(this,tt).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,tt).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ne,this.updatePriceQuantity),this.card?.removeEventListener(oe,v(this,cr)),U(this,K,nr).call(this),v(this,tt)?.disconnect(),this.card?.removeEventListener(Rr,v(this,lr))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Me`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Me`
        ...
        `}renderLayout(){let t=!!this.expanded;return Me`
            ...
            <slot></slot>
        `}};Re=new WeakMap,tt=new WeakMap,cr=new WeakMap,lr=new WeakMap,K=new WeakSet,io=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},nr=function(){v(this,Re)&&(document.removeEventListener("mousedown",v(this,Re)),w(this,Re,null))},no=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},or=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=U(this,K,no).call(this),v(this,Re)||(w(this,Re,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),U(this,K,nr).call(this))}),document.addEventListener("mousedown",v(this,Re)))},bi=function(){this.licenseOpen=!1,U(this,K,nr).call(this)},ta=new WeakMap,g(ra,"variantStyle",Ol`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var sr=ra;import{html as yi,css as zl}from"./lit-all.min.js";var oo=`
:root {
...
`;var so={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Te,At=class extends y{constructor(t){super(t);S(this,Te);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return oo}priceOptionsProvider(t,a){t.dataset.template===X&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return yi` ${this.badge}
    ...
    `);import{html as Dl,css as Hl}from"./lit-all.min.js";var co=`
...
`;var lo={cardName:{attribute:"name"},mnemonics:{size:"l"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},planType:!0,promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},Ct=class extends y{getGlobalCSS(){return co}priceOptionsProvider(r,t){r.dataset.template===X&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.card.querySelector(`[slot="heading-xs"] ${F}[data-template="price"]`);if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}renderLayout(){return Dl` ${this.badge}
            <div class="body">
                <slot name="icons"></slot>
                <slot name="badge"></slot>
                <slot name="heading-s"></slot>
            ...
            <slot></slot>`}};g(Ct,"variantStyle",Hl`
    ...
    `);import{html as wi,css as Fl}from"./lit-all.min.js";var ho=`
:root {
...
`;var po={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Tt=class extends y{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===X&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return ho}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${F}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return wi`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Bl,css as Ul}from"./lit-all.min.js";var mo=`
...
`;var uo={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},kt=class extends y{constructor(r){super(r)}getGlobalCSS(){return mo}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Bl`
    ...
    `);import{html as Ei,css as $l}from"./lit-all.min.js";var go=`
:root {
...
`;var fo={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},_t=class extends y{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return go}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${F}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Ei`${this.cardImage}
            <div class="body">
    ...
    `);import{html as xo,css as Gl}from"./lit-all.min.js";var vo=`
:root {
...
`;var Ai={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},dr=class dr extends y{getGlobalCSS(){return bo}get aemFragmentMapping(){return Ai}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return yo`<div
        ...
        >
            ...
            <slot></slot>
        `}};g(dr,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(dr,"variantStyle",ql`
    ...
    `);var hr=dr;import{html as pr,nothing as Eo}from"./lit-all.min.js";import{css as Vl,unsafeCSS as jl}from"./lit-all.min.js";var wo=["headless","marquee","faq","banner-blade"],Pt=(e,r="")=>wo.map(t=>`merch-card[variant='${t}'] [slot='${e}']${r}`).join(`,
`),Ci=e=>wo.map(r=>`merch-card[variant='${r}'] ${e}`).join(`,
`),Ge=`
...
`;function qe(e){let r=jl(e);return Vl`
        :host([variant='${r}']) {
            border: none;
            background: transparent;
            box-shadow: none;
    ...
    `}var So={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},Wl=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Mt=class extends y{constructor(r){super(r)}getGlobalCSS(){return Ge}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return pr`
        ...
        `}};g(Mt,"variantStyle",qe("headless"));import{css as Yl,html as Xl}from"./lit-all.min.js";var Ao=`
...
`;var Co={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Rt=class extends y{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Ao}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${F}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Xl`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Kl,css as Ql}from"./lit-all.min.js";var To=`
...
`;var Ti={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Zl=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],aa,ko,Nt=class extends y{constructor(t){super(t);S(this,aa);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return To}get aemFragmentMapping(){return Ti}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,U(this,aa,ko).call(this))}renderLayout(){return Kl`
            <div class="card">
            ...
            <slot></slot>
        `}};aa=new WeakSet,ko=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Zl.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(Nt,"variantStyle",Ql`
    ...
    `);import{html as Jl,css as ed}from"./lit-all.min.js";var _o=`
...
`;var ki={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ot=class extends y{getGlobalCSS(){return _o}get aemFragmentMapping(){return ki}renderLayout(){return Jl`
    ...
    `);import{html as _i,nothing as td}from"./lit-all.min.js";var Lo={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},rd=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],It=class extends y{constructor(r){super(r)}getGlobalCSS(){return Ge}renderLayout(){return _i`
            <div class="headless">
                ${rd.map(({slot:r,label:t})=>_i`
                        <div class="headless-row">
        ...
        `}};g(It,"variantStyle",qe("marquee"));import{html as Po}from"./lit-all.min.js";var Mo={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},ad=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],zt=class extends y{constructor(r){super(r)}getGlobalCSS(){return Ge}renderLayout(){return Po`
            <div class="headless">
                ${ad.map(({slot:r,label:t})=>Po`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value">
                                <slot name="${r}"></slot>
        ...
        `}};g(zt,"variantStyle",qe("faq"));import{html as Ro}from"./lit-all.min.js";var No={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},id=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],Dt=class extends y{constructor(r){super(r)}getGlobalCSS(){return Ge}renderLayout(){return Ro`
            <div class="headless">
        ...
        `}};g(Dt,"variantStyle",qe("banner-blade"));import{html as nd,css as od}from"./lit-all.min.js";var Oo=`
...
`;var Io=L,zo=["heading-s","body-xs","heading-xs"],Do={cardName:{attribute:"name"},mnemonics:{size:"s"},badge:{tag:"div",slot:"badge"},title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},Ve,mr,Ht=class extends y{constructor(){super(...arguments);S(this,Ve,null);S(this,mr,()=>this.resyncOnReflow());g(this,"lastSyncKey",null)}getGlobalCSS(){return Oo}priceOptionsProvider(t,a){t.dataset.template===X&&(a.displayPlanType=!0)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.card.querySelector(`[slot="heading-xs"] ${F}:not([data-template="legal"])`);if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t.options)return;a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook(),this.flagPriceRow(),window.matchMedia(Io).matches&&requestAnimationFrame(()=>this.syncHeights()))}syncHeights(){this.card.getBoundingClientRect().width<=2||window.matchMedia(Io).matches&&this.syncRowHeights(zo.map(t=>({name:t,getElement:a=>a.querySelector(`[slot="${t}"]`)})))}flagPriceRow(){this.card.toggleAttribute("no-price",!this.card.querySelector('[slot="heading-xs"]'))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=n=>Math.round(this.card.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),...zo.map(n=>a(`[slot="${n}"]`))].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(this.card.addEventListener(oe,v(this,mr)),typeof ResizeObserver>"u")return;w(this,Ve,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Ve).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Ve).observe(t)}disconnectedCallbackHook(){this.card.removeEventListener(oe,v(this,mr)),v(this,Ve)?.disconnect(),w(this,Ve,null)}renderLayout(){return nd` <div class="header">
                <slot name="icons"></slot>
                <slot name="badge"></slot>
            </div>
            <div class="panel">
            ...
            <slot></slot>`}};Ve=new WeakMap,mr=new WeakMap,g(Ht,"variantStyle",od`
    ...
    `);var Ho=new Map;var B=(e,r,t=null,a=null,i)=>{Ho.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};B("catalog",ut,vn,ut.variantStyle);B("image",Ze);B("inline-heading",Dr);B("mini-compare-chart",xt,$n,xt.variantStyle);B("mini-compare-chart-mweb",bt,qn,bt.variantStyle);B("plans",le,Qr,le.variantStyle,le.collectionOptions);B("plans-students",le,Wn,le.variantStyle,le.collectionOptions);B("plans-education",le,jn,le.variantStyle,le.collectionOptions);B("plans-v2",$e,Kn,$e.variantStyle,$e.collectionOptions);B("pro",sr,ao,sr.variantStyle);B("product",At,so,At.variantStyle);B("brand-concierge-product",Ct,lo,Ct.variantStyle);B("segment",Tt,po,Tt.variantStyle);B("media",kt,uo,kt.variantStyle);B("headless",Mt,So,Mt.variantStyle);B("special-offers",_t,fo,_t.variantStyle);B("simplified-pricing-express",Lt,Si,Lt.variantStyle);B("full-pricing-express",hr,Ai,hr.variantStyle);B("mini",Rt,Co,Rt.variantStyle);B("image",Ze,bn,Ze.variantStyle);B("compare-chart-column",Nt,Ti,Nt.variantStyle);B("fries",Ot,ki,Ot.variantStyle);B("marquee",It,Lo,It.variantStyle);B("faq",zt,Mo,zt.variantStyle);B("banner-blade",Dt,No,Dt.variantStyle);B("uber-pricing",Ht,Do,Ht.variantStyle);function zr(e){return Ho.get(e)?.fragmentMapping}var Ft=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(Yt);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var sd={[ve]:La,[He]:Pa,[_e]:Ma},cd={[ve]:Oa,[_e]:oe},ur,je=class{constructor(r){S(this,ur);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",He);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=ce.module("mas-element")}update(){[ve,He,_e].forEach(r=>{this.wrapperElement.classList.toggle(sd[r],r===this.state)})}notify(){(this.state===_e||this.state===ve)&&(this.state===_e?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ve&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof Ft&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(cd[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){w(this,ur,j()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return _e===a?Promise.resolve(this.wrapperElement):ve===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=_e,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Wr(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=ve,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,ur)?.duration}),Wr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=He,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!j()||this.timer)return;let{error:t,options:a,state:i,value:n,version:o}=this;this.state=He,this.timer=Wr(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===He&&this.version===o&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};ur=new WeakMap;function Fo(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function ia(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,Fo(r)),i}function Bo(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Fo(r)),e):null}function ld(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var it,rt=class rt extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new je(this));S(this,it);this.setAttribute("is",rt.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),w(this,it,Kt()),v(this,it)&&(this.log=v(this,it).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),w(this,it,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Kt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=a,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,m=this.getAttribute("data-promotion-code");m&&(d+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${ld(l)}?${d}`,this.masElement.toggleResolved(i,o,a)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,a),!1}}static createFrom(t){let a=new rt;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};it=new WeakMap,g(rt,"is","upt-link"),g(rt,"tag","a"),g(rt,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var at=rt;window.customElements.get(at.is)||window.customElements.define(at.is,at,{extends:at.tag});function Uo(e){return e&&(e==="bizpro"&&(e="pro"),e==="pro"||e.startsWith("plans")?"plans":e)}var dd="p_draft_landscape",hd="/store/",pd=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),Li=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),md=["env","workflowStep","clientId","country"],ud=["/tw/","/hk_zh/"];function gd(e){let r=e??"";return ud.some(t=>r.startsWith(t))}function fd(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(gd)}function Pi(e){if(!fd())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var $o=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),Go=e=>pd.get(e)??e;function na(e,r,t){for(let[a,i]of Object.entries(e)){let n=Go(a);i!=null&&t.has(n)&&r.set(n,i)}}function vd(e){return e===Ua.PRODUCTION?"https://commerce.adobe.com":"https://commerce-stg.adobe.com"}function xd(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let o=Go(i);r.set(`items[${t}][${o}]`,n)}}}function bd({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===Qe.CRM?"creative":"mini_plans"),e}function yd(e){let r=e.indexOf("?");return r===-1?e:e.slice(0,r)}function wd(e){let r=new URLSearchParams(window.location.search),t={};$o.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=yd(i))}),Object.keys(t).length>0&&na(t,e.searchParams,$o)}function qo(e){Ed(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:m,...p}=e,h=new URL(vd(r));if(h.pathname=`${hd}${a}`,a!==se.SEGMENTATION&&a!==se.CHANGE_PLAN_TEAM_PLANS&&xd(t,h.searchParams),na({...p},h.searchParams,Li),wd(h),c===Fe.DRAFT&&na({af:dd},h.searchParams,Li),a===se.SEGMENTATION){let u={marketSegment:i,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};m?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):m?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),na(u,h.searchParams,Li),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=bd({url:h,modal:l,is3in1:d})}return Pi(h)}function Ed(e){for(let r of md)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==se.SEGMENTATION&&e.workflowStep!==se.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var Sd=/[0-9\-+#]/,Ad=/[^\d\-+#]/g;function Vo(e){return e.search(Sd)}function Cd(e="#.##"){let r={},t=e.length,a=Vo(e);r.prefix=a>0?e.substring(0,a):"";let i=Vo(e.split("").reverse().join("")),n=t-i,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=i>0?e.substring(s,t):"",r.mask=e.substring(a,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(Ad);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function Td(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=i.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),i.integer=o,i.fraction=s,kd(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function kd(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function _d(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=Cd(e),i=Td(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var jo=_d;var Wo=".",Ld=",",Xo=/^\s+/,Ko=/\s+$/,Yo="&nbsp;",Mi=e=>e*12,ot=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),m=new Date(i);return l>=d&&l<=m},nt={MONTH:"MONTH",YEAR:"YEAR"},Pd={[me.ANNUAL]:12,[me.MONTHLY]:1,[me.THREE_YEARS]:36,[me.TWO_YEARS]:24},Ri=(e,r)=>({accept:e,round:r}),Md=[Ri(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),Ri(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),Ri(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],Ni={[Ke.YEAR]:{[me.MONTHLY]:nt.MONTH,[me.ANNUAL]:nt.YEAR},[Ke.MONTH]:{[me.MONTHLY]:nt.MONTH}},Rd=(e,r)=>e.indexOf(`'${r}'`)===0,Nd=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=Zo(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Id(e)}`),t},Od=e=>{let r=zd(e),t=Rd(e,r),a=e.replace(/'.*?'/,""),i=Xo.test(a)||Ko.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},Qo=e=>e.replace(Xo,Yo).replace(Ko,Yo),Id=e=>e.match(/#(.?)#/)?.[1]===Wo?Ld:Wo,zd=e=>e.match(/'(.*?)'/)?.[1]??"",Zo=e=>e.match(/0(.?)0/)?.[1]??"";function Bt({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1},i,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=Od(e),l=t?Zo(e):"",d=Nd(e,t),m=t?2:0,p=n(r,{currencySymbol:o}),h=a?p.toLocaleString("hi-IN",{minimumFractionDigits:m,maximumFractionDigits:m}):jo(d,p),u=t?h.lastIndexOf(l):h.length,f=h.substring(0,u),x=h.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var Jo=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=Pd[t]??1;return Bt(e,i>1?nt.MONTH:Ni[r]?.[t],n=>{let o={divisor:i,price:n,usePrecision:a},{round:s}=Md.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},es=({commitment:e,term:r,...t})=>Bt(t,Ni[e]?.[r]),ts=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===Ke.YEAR&&c===me.MONTHLY){if(!o)return Bt(e,nt.YEAR,Mi);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(ot(o,t,s)){let m=parseInt(d.replace("P","").replace("M",""));if(isNaN(m))return Mi(a);let p=i*m,h=n*(12-m),u=Math.round((p+h)*100)/100;return Bt({...e,price:u},nt.YEAR)}default:return Bt(e,nt.YEAR,()=>Mi(n??a))}}return Bt(e,Ni[r]?.[c])};var rs="download",as="upgrade",is={e:"EDU",t:"TEAM"};function ns(e,r={},t=""){let a=j();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:m,quantity:p,wcsOsi:h,extraOptions:u,analyticsId:f}=a.collectCheckoutOptions(r),x=ia(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:r.promotionCode===$r?$r:m,quantity:p,wcsOsi:h,extraOptions:u,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function os(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new je(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0].marketSegments?.[0];return is[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return is[a]??a}get is3in1Modal(){return Object.values(Qe).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=j();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>tr(h,n));let d=l.flat().find(h=>h.promotion);!ot(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let p=await i.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},p,s)}renderOffers(a,i,n={},o=void 0,s=void 0){let c=j();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(rs,as),this.masElement.toggleResolved(s,a,i);let{url:d,text:m,className:p,handler:h}=o;d&&this.setCheckoutUrl(Pi(d)),m&&(this.firstElementChild.innerHTML=m),p&&this.classList.add(...p.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(a.length){if(this.masElement.toggleResolved(s,a,i)){if(!this.classList.contains(rs)&&!this.classList.contains(as)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(a){}updateOptions(a={}){let i=j();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:m,promotionCode:p,quantity:h,wcsOsi:u}=i.collectCheckoutOptions(a);return Bo(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:m,promotionCode:p,quantity:h,wcsOsi:u}),!0}}}var gr=class gr extends os(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return ns(gr,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(gr,"is","checkout-link"),g(gr,"tag","a");var Ne=gr;window.customElements.get(Ne.is)||window.customElements.define(Ne.is,Ne,{extends:Ne.tag});var N=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:se.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:we.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Fe.PUBLISHED});function ss({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:m,quantity:p,preselectPlan:h,env:u}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:m,quantity:p,preselectPlan:h,env:u};if(o)for(let De of r.checkout)De(o,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:E=c,imsCountry:A,country:b=A??l,language:P=d,quantity:I=p,entitlement:D,upgrade:q,modal:W,perpetual:Q,promotionCode:te=m,wcsOsi:H,extraOptions:O,...re}=Object.assign(f,o?.dataset??{},n??{}),J=er(E,se,N.checkoutWorkflowStep),{wcsOsi:ze,promotionCodes:ge}=Yr(H,te),ht=ge.map(De=>Gr(De).effectivePromoCode);return f=Br({...re,extraOptions:O,checkoutClientId:s,checkoutMarketSegment:x,country:b,quantity:vt(I,N.quantity),checkoutWorkflowStep:J,language:P,entitlement:T(D),upgrade:T(q),modal:W,perpetual:T(Q),promotionCode:ht[0],promotionCodes:ht,wcsOsi:ze,preselectPlan:h}),f}function a(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:m,country:p,promotionCode:h,quantity:u,preselectPlan:f,ms:x,cs:E,...A}=t(o),b=document.querySelector("meta[name=mas-ff-3in1]"),P=Object.values(Qe).includes(o.modal)&&(!b||b.content!=="off"),I=window.frameElement||P?"if":"fp",[{productArrangementCode:D,marketSegments:[q],customerSegment:W,offerType:Q}]=n,te=x??q??d,H=E??W;f?.toLowerCase()==="edu"?te="EDU":f?.toLowerCase()==="team"&&(H="TEAM");let O={is3in1:P,checkoutPromoCode:h,clientId:l,context:I,country:p,env:s,items:[],marketSegment:te,customerSegment:H,offerType:Q,productArrangementCode:D,workflowStep:m,landscape:c,...A},re=u[0]>1?u[0]:void 0;if(n.length===1){let{offerId:J}=n[0];O.items.push({id:J,quantity:re})}else O.items.push(...n.map(({offerId:J,productArrangementCode:ze})=>({id:J,quantity:re,...P?{productArrangementCode:ze}:{}})));return qo(O)}let{createCheckoutLink:i}=Ne;return{CheckoutLink:Ne,CheckoutWorkflowStep:se,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}var Dd="ims_country_code";function Hd(){if(typeof document>"u")return null;let e=document.cookie.match(new RegExp(`(?:^|;\\s*)${Dd}=([^;]*)`));if(!e)return null;let r;try{r=decodeURIComponent(e[1])}catch{return null}return r.trim().toUpperCase()||null}function Fd({interval:e=200,maxAttempts:r=25}={}){let t=ce.module("ims");return new Promise(a=>{t.debug("Waiting for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function Bd(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Ud(){let e=Hd();return e&&ce.module("ims").debug("Got user country from cookie:",e),Promise.resolve(e)}function cs(){let e=Fd();return{imsReadyPromise:e,imsSignedInPromise:Bd(e),imsCountryPromise:Ud()}}var ls=window.masPriceLiterals;function ds(e){if(Array.isArray(ls)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>ls.find(n=>Ka(n.lang,i)),a=t(r)??t(N.language);if(a)return Object.freeze(a)}return{}}var Oi=function(e,r){return Oi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},Oi(e,r)};function fr(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");Oi(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var M=function(){return M=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},M.apply(this,arguments)};function oa(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var k;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(k||(k={}));var G;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(G||(G={}));var st;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(st||(st={}));function Ii(e){return e.type===G.literal}function hs(e){return e.type===G.argument}function sa(e){return e.type===G.number}function ca(e){return e.type===G.date}function la(e){return e.type===G.time}function da(e){return e.type===G.select}function ha(e){return e.type===G.plural}function ps(e){return e.type===G.pound}function pa(e){return e.type===G.tag}function ma(e){return!!(e&&typeof e=="object"&&e.type===st.number)}function vr(e){return!!(e&&typeof e=="object"&&e.type===st.dateTime)}var zi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var $d=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function ms(e){var r={};return e.replace($d,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var us=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function xs(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(us).filter(function(p){return p.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var m=d[l];if(m.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function Gd(e){return e.replace(/^(.*?)-/,"")}var gs=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,bs=/^(@+)?(\+|#+)?[rs]?$/g,qd=/(\*)(0+)|(#+)(0+)|(0+)/g,ys=/^(0+)$/;function fs(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(bs,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function ws(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Vd(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!ys.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function vs(e){var r={},t=ws(e);return t||r}function Es(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=Gd(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=M(M(M({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return M(M({},c),vs(l))},{}));continue;case"engineering":r=M(M(M({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return M(M({},c),vs(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(qd,function(c,l,d,m,p,h){if(l)r.minimumIntegerDigits=d.length;else{if(m&&p)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(ys.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(gs.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(gs,function(c,l,d,m,p,h){return d==="*"?r.minimumFractionDigits=l.length:m&&m[0]==="#"?r.maximumFractionDigits=m.length:p&&h?(r.minimumFractionDigits=p.length,r.maximumFractionDigits=p.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=M(M({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=M(M({},r),fs(n)));continue}if(bs.test(i.stem)){r=M(M({},r),fs(i.stem));continue}var o=ws(i.stem);o&&(r=M(M({},r),o));var s=Vd(i.stem);s&&(r=M(M({},r),s))}return r}var xr={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function Ss(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=jd(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function jd(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=xr[a||""]||xr[t||""]||xr["".concat(t,"-001")]||xr["001"];return i[0]}var Di,Wd=new RegExp("^".concat(zi.source,"*")),Yd=new RegExp("".concat(zi.source,"*$"));function R(e,r){return{start:e,end:r}}var Xd=!!String.prototype.startsWith,Kd=!!String.fromCodePoint,Qd=!!Object.fromEntries,Zd=!!String.prototype.codePointAt,Jd=!!String.prototype.trimStart,eh=!!String.prototype.trimEnd,th=!!Number.isSafeInteger,rh=th?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Fi=!0;try{As=_s("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Fi=((Di=As.exec("a"))===null||Di===void 0?void 0:Di[0])==="a"}catch{Fi=!1}var As,Cs=Xd?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},Bi=Kd?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,o;i>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");a+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return a},Ts=Qd?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],o=n[0],s=n[1];t[o]=s}return t},ks=Zd?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},ah=Jd?function(r){return r.trimStart()}:function(r){return r.replace(Wd,"")},ih=eh?function(r){return r.trimEnd()}:function(r){return r.replace(Yd,"")};function _s(e,r){return new RegExp(e,r)}var Ui;Fi?(Hi=_s("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Ui=function(r,t){var a;Hi.lastIndex=t;var i=Hi.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):Ui=function(r,t){for(var a=[];;){var i=ks(r,t);if(i===void 0||Ps(i)||sh(i))break;a.push(i),t+=i>=65536?2:1}return Bi.apply(void 0,a)};var Hi,Ls=(function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,a);if(o.err)return o;i.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:G.pound,location:R(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(k.UNMATCHED_CLOSING_TAG,R(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&$i(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;i.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;i.push(o.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:G.literal,value:"<".concat(i,"/>"),location:R(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!$i(this.char()))return this.error(k.INVALID_TAG,R(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(k.UNMATCHED_CLOSING_TAG,R(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:G.tag,value:i,children:o,location:R(a,this.clonePosition())},err:null}:this.error(k.INVALID_TAG,R(s,this.clonePosition())))}else return this.error(k.UNCLOSED_TAG,R(a,this.clonePosition()))}else return this.error(k.INVALID_TAG,R(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&oh(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){i+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=R(a,this.clonePosition());return{val:{type:G.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!nh(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return Bi.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),Bi(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,R(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(k.EMPTY_ARGUMENT,R(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(k.MALFORMED_ARGUMENT,R(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,R(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:G.argument,value:i,location:R(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,R(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(k.MALFORMED_ARGUMENT,R(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=Ui(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),o=R(r,n);return{value:a,location:o}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(k.EXPECT_ARGUMENT_TYPE,R(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),m=this.parseSimpleArgStyleIfPossible();if(m.err)return m;var p=ih(m.val);if(p.length===0)return this.error(k.EXPECT_ARGUMENT_STYLE,R(this.clonePosition(),this.clonePosition()));var h=R(d,this.clonePosition());l={style:p,styleLocation:h}}var u=this.tryParseArgumentClose(i);if(u.err)return u;var f=R(i,this.clonePosition());if(l&&Cs(l?.style,"::",0)){var x=ah(l.style.slice(2));if(s==="number"){var m=this.parseNumberSkeletonFromString(x,l.styleLocation);return m.err?m:{val:{type:G.number,value:a,location:f,style:m.val},err:null}}else{if(x.length===0)return this.error(k.EXPECT_DATE_TIME_SKELETON,f);var E=x;this.locale&&(E=Ss(x,this.locale));var p={type:st.dateTime,pattern:E,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?ms(E):{}},A=s==="date"?G.date:G.time;return{val:{type:A,value:a,location:f,style:p},err:null}}}return{val:{type:s==="number"?G.number:s==="date"?G.date:G.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(k.EXPECT_SELECT_ARGUMENT_OPTIONS,R(b,M({},b)));this.bumpSpace();var P=this.parseIdentifierIfPossible(),I=0;if(s!=="select"&&P.value==="offset"){if(!this.bumpIf(":"))return this.error(k.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,R(this.clonePosition(),this.clonePosition()));this.bumpSpace();var m=this.tryParseDecimalInteger(k.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,k.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(m.err)return m;this.bumpSpace(),P=this.parseIdentifierIfPossible(),I=m.val}var D=this.tryParsePluralOrSelectOptions(r,s,t,P);if(D.err)return D;var u=this.tryParseArgumentClose(i);if(u.err)return u;var q=R(i,this.clonePosition());return s==="select"?{val:{type:G.select,value:a,options:Ts(D.val),location:q},err:null}:{val:{type:G.plural,value:a,options:Ts(D.val),offset:I,pluralType:s==="plural"?"cardinal":"ordinal",location:q},err:null}}default:return this.error(k.INVALID_ARGUMENT_TYPE,R(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,R(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(k.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,R(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=xs(r)}catch{return this.error(k.INVALID_NUMBER_SKELETON,t)}return{val:{type:st.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?Es(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,o=!1,s=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var m=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var p=this.tryParseDecimalInteger(k.EXPECT_PLURAL_ARGUMENT_SELECTOR,k.INVALID_PLURAL_ARGUMENT_SELECTOR);if(p.err)return p;d=R(m,this.clonePosition()),l=this.message.slice(m.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?k.DUPLICATE_SELECT_ARGUMENT_SELECTOR:k.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?k.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:k.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,R(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(r+1,t,a);if(u.err)return u;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:u.val,location:R(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?k.EXPECT_SELECT_ARGUMENT_SELECTOR:k.EXPECT_PLURAL_ARGUMENT_SELECTOR,R(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(k.MISSING_OTHER_CLAUSE,R(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=R(i,this.clonePosition());return n?(o*=a,rh(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=ks(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(Cs(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Ps(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e})();function $i(e){return e>=97&&e<=122||e>=65&&e<=90}function nh(e){return $i(e)||e===47}function oh(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Ps(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function sh(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Gi(e){e.forEach(function(r){if(delete r.location,da(r)||ha(r))for(var t in r.options)delete r.options[t].location,Gi(r.options[t].value);else sa(r)&&ma(r.style)||(ca(r)||la(r))&&vr(r.style)?delete r.style.location:pa(r)&&Gi(r.children)})}function Ms(e,r){r===void 0&&(r={}),r=M({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new Ls(e,r).parse();if(t.err){var a=SyntaxError(k[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||Gi(t.val),t.val}function br(e,r){var t=r&&r.cache?r.cache:mh,a=r&&r.serializer?r.serializer:ph,i=r&&r.strategy?r.strategy:lh;return i(e,{cache:t,serializer:a})}function ch(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Rs(e,r,t,a){var i=ch(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function Ns(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function qi(e,r,t,a,i){return t.bind(r,e,a,i)}function lh(e,r){var t=e.length===1?Rs:Ns;return qi(e,this,t,r.cache.create(),r.serializer)}function dh(e,r){return qi(e,this,Ns,r.cache.create(),r.serializer)}function hh(e,r){return qi(e,this,Rs,r.cache.create(),r.serializer)}var ph=function(){return JSON.stringify(arguments)};function Vi(){this.cache=Object.create(null)}Vi.prototype.get=function(e){return this.cache[e]};Vi.prototype.set=function(e,r){this.cache[e]=r};var mh={create:function(){return new Vi}},ua={variadic:dh,monadic:hh};var ct;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(ct||(ct={}));var yr=(function(e){fr(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r})(Error);var ji=(function(e){fr(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),ct.INVALID_VALUE,n)||this}return r})(yr);var Os=(function(e){fr(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),ct.INVALID_VALUE,i)||this}return r})(yr);var Is=(function(e){fr(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),ct.MISSING_VALUE,a)||this}return r})(yr);var ae;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(ae||(ae={}));function uh(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==ae.literal||t.type!==ae.literal?r.push(t):a.value+=t.value,r},[])}function gh(e){return typeof e=="function"}function wr(e,r,t,a,i,n,o){if(e.length===1&&Ii(e[0]))return[{type:ae.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(Ii(d)){s.push({type:ae.literal,value:d.value});continue}if(ps(d)){typeof n=="number"&&s.push({type:ae.literal,value:t.getNumberFormat(r).format(n)});continue}var m=d.value;if(!(i&&m in i))throw new Is(m,o);var p=i[m];if(hs(d)){(!p||typeof p=="string"||typeof p=="number")&&(p=typeof p=="string"||typeof p=="number"?String(p):""),s.push({type:typeof p=="string"?ae.literal:ae.object,value:p});continue}if(ca(d)){var h=typeof d.style=="string"?a.date[d.style]:vr(d.style)?d.style.parsedOptions:void 0;s.push({type:ae.literal,value:t.getDateTimeFormat(r,h).format(p)});continue}if(la(d)){var h=typeof d.style=="string"?a.time[d.style]:vr(d.style)?d.style.parsedOptions:a.time.medium;s.push({type:ae.literal,value:t.getDateTimeFormat(r,h).format(p)});continue}if(sa(d)){var h=typeof d.style=="string"?a.number[d.style]:ma(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(p=p*(h.scale||1)),s.push({type:ae.literal,value:t.getNumberFormat(r,h).format(p)});continue}if(pa(d)){var u=d.children,f=d.value,x=i[f];if(!gh(x))throw new Os(f,"function",o);var E=wr(u,r,t,a,i,n),A=x(E.map(function(I){return I.value}));Array.isArray(A)||(A=[A]),s.push.apply(s,A.map(function(I){return{type:typeof I=="string"?ae.literal:ae.object,value:I}}))}if(da(d)){var b=d.options[p]||d.options.other;if(!b)throw new ji(d.value,p,Object.keys(d.options),o);s.push.apply(s,wr(b.value,r,t,a,i));continue}if(ha(d)){var b=d.options["=".concat(p)];if(!b){if(!Intl.PluralRules)throw new yr(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,ct.MISSING_INTL_API,o);var P=t.getPluralRules(r,{type:d.pluralType}).select(p-(d.offset||0));b=d.options[P]||d.options.other}if(!b)throw new ji(d.value,p,Object.keys(d.options),o);s.push.apply(s,wr(b.value,r,t,a,i,p-(d.offset||0)));continue}}return uh(s)}function fh(e,r){return r?M(M(M({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=M(M({},e[a]),r[a]||{}),t},{})):e}function vh(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=fh(e[a],r[a]),t},M({},e)):e}function Wi(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function xh(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:br(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,oa([void 0],t,!1)))},{cache:Wi(e.number),strategy:ua.variadic}),getDateTimeFormat:br(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,oa([void 0],t,!1)))},{cache:Wi(e.dateTime),strategy:ua.variadic}),getPluralRules:br(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,oa([void 0],t,!1)))},{cache:Wi(e.pluralRules),strategy:ua.variadic})}}var zs=(function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==ae.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return wr(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=vh(e.formats,a),this.formatters=i&&i.formatters||xh(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Ms,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e})();var Ds=zs;var Er={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}",discountLabel:"{discount}%"},bh=kn("ConsonantTemplates/price"),yh=/<\/?[^>]+(>|$)/g,V={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ke={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Yi="TAX_EXCLUSIVE",wh=e=>Cn(e)?Object.entries(e).filter(([,r])=>gt(r)||Fr(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${An(a)}"`}`,""):"",Y=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${V.disabled}`}"${wh(t)}>${a?Qo(r):r??""}</span>`;function Eh(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function Sh(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function be(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?Eh(i):i,i=n?i.replace(yh,""):i;let s=new Ds(i,r).format(a);return o?Sh(s):s}catch{return bh.error("Failed to format literal:",i),""}}function Ah(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:m},p={}){let h=Y(V.currencySymbol,a),u=Y(V.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=Y(V.integer,s),f+=Y(V.decimalsDelimiter,n),f+=Y(V.decimals,i),c||(f+=u+h),f+=Y(V.recurrence,l,null,!0),f+=Y(V.unitType,d,null,!0),f+=Y(V.taxInclusivity,m,!0),Y(e,f,{...p})}var ee=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:m,literals:p={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:E,formatString:A,price:b,priceWithoutDiscount:P,taxDisplay:I,taxTerm:D,term:q,usePrecision:W,promotion:Q}={},te={})=>{Object.entries({country:o,formatString:A,language:m,price:b}).forEach(([wc,Ec])=>{if(Ec==null)throw new Error(`Argument "${wc}" is missing for osi ${E?.toString()}, country ${o}, language ${m}`)});let H={...Er,...p},O=`${m.toLowerCase()}-${o.toUpperCase()}`,re;Q&&!f&&P?re=e||a?b:P:t&&P?re=P:re=b;let J=r?Jo:es;i&&(J=ts);let{accessiblePrice:ze,recurrenceTerm:ge,...ht}=J({commitment:x,formatString:A,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:P,price:r?b:re,promotion:Q,quantity:h,term:q,usePrecision:W}),De="",va="",xa="";T(c)&&ge&&(xa=be(H,O,ke.recurrenceLabel,{recurrenceTerm:ge}));let _r="";T(l)&&(u&&(_r+=" "),_r+=be(H,O,ke.perUnitLabel,{perUnit:"LICENSE"}));let Lr="";T(d)&&D&&(u&&(Lr+=" "),Lr+=be(H,O,I===Yi?ke.taxExclusiveLabel:ke.taxInclusiveLabel,{taxTerm:D})),t&&(De=be(H,O,ke.strikethroughAriaLabel,{strikethroughPrice:De})),e&&(va=be(H,O,ke.alternativePriceAriaLabel,{alternativePrice:va}));let Ye=V.container;if(r&&(Ye+=` ${V.containerOptical}`),t&&(Ye+=` ${V.containerStrikethrough}`),a&&(Ye+=` ${V.containerPromoStrikethrough}`),e&&(Ye+=` ${V.containerAlternative}`),i&&(Ye+=` ${V.containerAnnual}`),T(s))return Ah(Ye,{...ht,accessibleLabel:De,altAccessibleLabel:va,recurrenceLabel:xa,perUnitLabel:_r,taxInclusivityLabel:Lr},te);let{currencySymbol:rn,decimals:fc,decimalsDelimiter:vc,hasCurrencySpace:an,integer:xc,isCurrencyFirst:bc}=ht,pt=[xc,vc,fc];bc?(pt.unshift(an?"\xA0":""),pt.unshift(rn)):(pt.push(an?"\xA0":""),pt.push(rn)),pt.push(xa,_r,Lr);let yc=pt.join("");return Y(Ye,yc,te)},Hs=()=>(e,r,t)=>{let a=ot(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${ee({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},Fs=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=ot(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return ee()(e,{...r,price:r.priceWithoutDiscount},t)+Y(V.containerAnnualPrefix," (")+ee({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+Y(V.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${ee({displayStrikethrough:!0})(n,r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${Y(V.containerAnnualPrefix," (")}${ee({displayAnnual:!0,instant:a})(n,r,t)}${Y(V.containerAnnualSuffix,")")}`},Bs=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${ee({isAlternativePrice:e.displayOldPrice})(e,r,t)}${Y(V.containerAnnualPrefix," (")}${ee({displayAnnual:!0})(a,r,t)}${Y(V.containerAnnualSuffix,")")}`};var Sr={...V,containerLegal:"price-legal",planType:"price-plan-type"},ga={...ke,planTypeLabel:"planTypeLabel"};function Ch(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=Y(Sr.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=Y(Sr.taxInclusivity,t,!0),o+=Y(Sr.planType,a,null),Y(e,o,{...i})}var Us=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,planTypeCase:n,language:o,literals:s={}}={},{taxDisplay:c,taxTerm:l,planType:d}={},m={})=>{let p={...Er,...s},h=`${o.toLowerCase()}-${e.toUpperCase()}`,u="";T(r)&&(u=be(p,h,ga.perUnitLabel,{perUnit:"LICENSE"}));let f="";e==="US"&&o==="en"&&(t=!1),T(t)&&l&&(f=be(p,h,c===Yi?ga.taxExclusiveLabel:ga.taxInclusiveLabel,{taxTerm:l}));let x="";T(a)&&d&&(x=be(p,h,ga.planTypeLabel,{planType:d})),x&&n&&(x=(n==="lower"?x[0].toLowerCase():x[0].toUpperCase())+x.slice(1));let E=Sr.container;return E+=` ${Sr.containerLegal}`,Ch(E,{perUnitLabel:u,taxInclusivityLabel:f,planTypeLabel:x},m,i)};var $s=ee(),Gs=Hs(),qs=ee({displayOptical:!0}),Vs=ee({displayStrikethrough:!0}),js=ee({displayPromoStrikethrough:!0}),Ws=ee({displayAnnual:!0}),Ys=ee({displayOptical:!0,isAlternativePrice:!0}),Xs=ee({isAlternativePrice:!0}),Ks=Bs(),Qs=Fs(),Zs=Us;var Th={...ke,discountLabel:"discountLabel"},kh=(e,r)=>{if(!r&&ft(e))return 0;if(!(!ft(e)||!ft(r)))return Math.floor((r-e)/r*100)},Js=()=>(e,r)=>{let{country:t,language:a,literals:i={}}=e??{},{price:n,priceWithoutDiscount:o}=r,s=kh(n,o);if(s===void 0)return'<span class="no-discount"></span>';let c={...Er,...i},l=a&&t?`${a.toLowerCase()}-${t.toUpperCase()}`:"en-US";return`<span class="discount">${be(c,l,Th.discountLabel,{discount:s,remainingPercent:100-s})}</span>`};var ec=Js();var tc="INDIVIDUAL_COM",Ki="TEAM_COM",rc="INDIVIDUAL_EDU",Qi="TEAM_EDU",_h=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh","KE_en","GH_en","TZ_en","AM_en","AZ_en","GE_en","MD_en","KZ_en","KG_en","TJ_en","UZ_en","OM_en","BH_en"],Lh={[tc]:[],[Ki]:[],[rc]:[],[Qi]:[]},Ph={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Mh=[tc,Ki,rc,Qi],Rh=e=>[Ki,Qi].includes(e);function Xi(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Nh=(e,r,t,a)=>{let i=`${t}_${a}`,n=Xi(Ph,e,r,!1);if(n){let o=Mh.indexOf(i);return n[o]}return Rh(i)},Oh=(e,r,t,a)=>{if(Xi(_h,e,r,!0))return!0;let i=Lh[`${t}_${a}`];return i?Xi(i,e,r,!0)?!0:N.displayTax:N.displayTax},Zi=async(e,r,t,a)=>{let i=Oh(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Nh(e,r,t,a):N.forceTaxExclusive}},Ar=class Ar extends HTMLSpanElement{constructor(){super();g(this,"masElement",new je(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=j();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=a.collectPriceOptions(t);return ia(Ar,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ve}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=j();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let u=tr(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,m=mi(l);if(a.featureFlags[Le]||n[Le]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=m.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=m.marketSegments,x=await Zi(h,u,m.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(E=>{let A=tr(E,n);return A?.length?A[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[he]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let p=mi(d);return this.renderOffers([p],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=j();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(Ar,"is","inline-price"),g(Ar,"tag","span");var Oe=Ar;window.customElements.get(Oe.is)||window.customElements.define(Oe.is,Oe,{extends:Oe.tag});function ac({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let Q of r.price)Q(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:m,displayTax:p,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:E,quantity:A,alternativePrice:b,wcsOsi:P,...I}=Object.assign(c,s?.dataset??{},o??{}),{wcsOsi:D,promotionCodes:q}=Yr(P,E),W=q.map(Q=>Gr(Q).effectivePromoCode);return c=Br(Object.assign({...c,...I,displayOldPrice:T(l),displayPerUnit:T(d),displayRecurrence:T(m),displayTax:T(p),displayPlanType:T(h),forceTaxExclusive:T(u),perpetual:T(f),displayAnnual:T(x),promotionCode:W[0],promotionCodes:W,quantity:vt(A,N.quantity),alternativePrice:T(b),wcsOsi:D})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=ec;break;case"strikethrough":l=Vs;break;case"promo-strikethrough":l=js;break;case"annual":l=Ws;break;case"legal":l=Zs;break;default:s.template==="optical"&&s.alternativePrice?l=Ys:s.template==="optical"?l=qs:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?Qs:Ks:s.alternativePrice?l=Xs:l=s.promotionCode&&o[0].promotion?Gs:$s}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Oe.createInlinePrice;return{InlinePrice:Oe,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Ih({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||N.language),r??(r=e?.split("_")?.[1]||N.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function ic(e={},r){let t=r.featureFlags[Le],{commerce:a={}}=e,i=we.PRODUCTION,n=Fa,o=$("checkoutClientId",a)??N.checkoutClientId,s=er($("checkoutWorkflowStep",a),se,N.checkoutWorkflowStep),c=T($("displayOldPrice",a),N.displayOldPrice),l=N.displayPerUnit,d=T($("displayRecurrence",a),N.displayRecurrence),m=T($("displayTax",a),N.displayTax),p=T($("displayPlanType",a),N.displayPlanType),h=T($("entitlement",a),N.entitlement),u=T($("modal",a),N.modal),f=T($("forceTaxExclusive",a),N.forceTaxExclusive),x=$("promotionCode",a)??N.promotionCode,E=vt($("quantity",a)),A=$("wcsApiKey",a)??N.wcsApiKey,b=a?.env==="stage",P=Fe.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=($(Da,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",P=er($(Ha,a),Fe,P)),b&&(i=we.STAGE,n=Ba);let D=$(za)??e.preview,q=typeof D<"u"&&D!=="off"&&D!=="false",W={};q&&(W={preview:q});let Q=$("mas-io-url")??e.masIOUrl,te=gn(Q)?Q:`https://www${i===we.STAGE?".stage":""}.adobe.com/mas/io`,H=$("preselect-plan")??void 0,O=$("instant")??e.instant;return{...Ih(e),...W,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:m,displayPlanType:p,entitlement:h,extraOptions:N.extraOptions,modal:u,env:i,forceTaxExclusive:f,promotionCode:x,quantity:E,alternativePrice:N.alternativePrice,wcsApiKey:A,wcsURL:n,landscape:P,masIOUrl:te,...H&&{preselectPlan:H},...O&&{instant:O}}}async function nc(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var Ji="wcs";function oc({settings:e}){let r=ce.module(Ji),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(u,f,x=!0){let E=j(),A=Na;r.debug("Fetching:",u);let b="",P;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let I=new Map(f),[D]=u.offerSelectorIds,q=Date.now()+Math.random().toString(36).substring(2,7),W=`${Ji}:${D}:${q}${$a}`,Q=`${Ji}:${D}:${q}${Ga}`,te;try{if(performance.mark(W),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",D),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===we.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),P=await nc(b.toString(),{credentials:"omit"}),P.ok){let H=[];try{let O=await P.json();r.debug("Fetched:",u,O),H=O.resolvedOffers??[]}catch(O){r.error(`Error parsing JSON: ${O.message}`,{...O.context,...E?.duration})}H=H.map(qr),f.forEach(({resolve:O},re)=>{let J=H.filter(({offerSelectorIds:ze})=>ze.includes(re)).flat();J.length&&(I.delete(re),f.delete(re),O(J))})}else A=Ra}catch(H){A=`Network error: ${H.message}`}finally{te=performance.measure(Q,W),performance.clearMarks(W),performance.clearMeasures(Q)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let H=Bn(P);f.forEach(O=>{O.reject(new Ft(A,{...u,...H,response:P,measure:Or(te),...E?.duration}))})}}function l(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===we.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[E,A]of Object.entries(x))i.set(E,Promise.resolve(A.map(qr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function m(){let u=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function p(u,f,x){let E=u!=="GB"&&!x?"MULT":"en",A=qa.includes(u)?u:N.country;return{validCountry:A,validLanguage:E,locale:`${f}_${A}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:E="",promotionCodes:A,wcsOsi:b=[]}){let{validCountry:P,validLanguage:I,locale:D}=p(u,f,x),q=Array.isArray(A)&&A.length?A:[E];return b.map((W,Q)=>{let te=q.length===1?q[0]:q[Q]??"",H=[P,I,te].filter(J=>J).join("-").toLowerCase(),O=`${W}-${H}`;if(i.has(O))return i.get(O);let re=new Promise((J,ze)=>{let ge=n.get(H);ge||(ge={options:{country:P,locale:D,...I==="MULT"&&{language:I},offerSelectorIds:[]},promises:new Map},n.set(H,ge)),te&&(ge.options.promotionCode=te),ge.options.offerSelectorIds.push(W),ge.promises.set(W,{resolve:J,reject:ze}),l()}).catch(J=>{if(s.has(O))return s.get(O);throw J});return i.set(O,re),re})}return{Commitment:Ke,PlanType:Ln,Term:me,applyPlanType:qr,resolveOfferSelectors:h,flushWcsCacheInternal:m,prefillWcsCache:d,normalizeCountryLanguageAndLocale:p}}var sc="mas-commerce-service",cc="mas-commerce-service:start",lc="mas-commerce-service:ready",Cr,Ut,lt,dc,tn,en=class extends HTMLElement{constructor(){super(...arguments);S(this,lt);S(this,Cr);S(this,Ut);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,Ut)||w(this,Ut,{[Le]:U(this,lt,tn).call(this,Le),[he]:U(this,lt,tn).call(this,he)}),v(this,Ut)}activate(){let t=v(this,lt,dc),a=ic(t,this);Vr(t.lana);let i=ce.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:ds(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...ss(c),...cs(c),...ac(c),...oc(c),...Va,Log:ce,resolvePriceTaxFlags:Zi,get defaults(){return N},get log(){return ce},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(Mr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(lc),w(this,Cr,performance.measure(lc,cc)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(cc),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(wa).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Or(v(this,Cr))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Cr=new WeakMap,Ut=new WeakMap,lt=new WeakSet,dc=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},tn=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||$(t))};window.customElements.get(sc)||window.customElements.define(sc,en);var uc="merch-card-collection",zh=3e4,Dh={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Hh={plans:!0},Fh=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Bh=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,Uh=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),$h=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),Gh=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,We,Gt,dt,kr,fa,gc,$t=class extends pc{constructor(){super();S(this,fa);S(this,We,{});S(this,Gt);S(this,dt);S(this,kr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=mn(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Ie` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a,i=new Promise(o=>{a=un(()=>o(!1),zh)}),n=Promise.race([this.hydrationReady,i]);return n.finally(()=>Ya(a)),n}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===xe.alphabetical?Uh:$h,s=[Fh,Bh,Gh,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Ca,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(fe,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){w(this,We,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,We)[a]=i)})}connectedCallback(){super.connectedCallback(),w(this,Gt,Kt()),v(this,Gt)&&w(this,dt,v(this,Gt).Log.module(uc)),w(this,kr,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",a),o.setAttribute("placeholder",""),o.innerHTML=i,this.append(o)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Hh[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Wt));let i=v(this,kr)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(s=>{a=s});let i=this;function n(s){let c;return s.fields?.checkboxGroups?c=s.fields.checkboxGroups:s.fields?.tagFilters&&(c=[{title:s.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:s.fields.tagFilters.map(l=>{let d=l.split("/").pop(),m=s.settings?.tagLabels?.[d]||d;return m=m.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):m,{name:d,label:m}})}]),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(m,p){for(let h of p){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){v(i,dt)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let u=s.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)u=b,f=b.referencesTree,s.references={...s.references,...b.references};else{v(i,dt)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!u?.fields)continue;let{fields:E}=u,A={label:E.label||"",icon:E.icon,iconLight:E.iconLight,queryLabel:E.queryLabel,cards:E.cards?E.cards.map(b=>c[b]||b):[],collections:[]};E.defaultchild&&(A.defaultchild=c[E.defaultchild]||E.defaultchild),m.push(A),d(A.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(ka,s=>{U(this,fa,gc).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(Ta,async s=>{this.limit=27,this.data=o(s.detail,v(this,We)),s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?v(this,We)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let m=(u,f)=>{for(let x of u)if(x.defaultchild===f||x.collections&&m(x.collections,f))return!0;return!1};for(let u of c){let b=function(I){for(let D of I){let q=D.cards.indexOf(x);if(q===-1)continue;let W=D.queryLabel??D?.label?.toLowerCase()??"";f.filters[W]={order:q+1,size:u.fields.size},b(D.collections)}},f=document.createElement("merch-card"),x=v(this,We)[u.id]||u.id;f.setAttribute("consonant",""),f.setAttribute("style","");let E=u.fields.tags?.filter(I=>I.startsWith("mas:types/")).map(I=>I.split("/")[1]).join(",");E&&f.setAttribute("types",E),zr(u.fields.variant)?.supportsDefaultChild&&(d?x===d:m(l,x))&&f.setAttribute("data-default-card","true"),b(l);let P=document.createElement("aem-fragment");P.setAttribute("fragment",x),f.append(P),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(u)+1,size:u.fields.size}}),this.append(f)}let p="",h=Uo(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(u=>u.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?p=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(p=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Dh[`${h}${p}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Ie`<div id="footer">

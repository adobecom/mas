var Ar=Object.defineProperty;var zr=a=>{throw TypeError(a)};var xi=(a,t,e)=>t in a?Ar(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var yi=(a,t)=>()=>(a&&(t=a(a=0)),t);var wi=(a,t)=>{for(var e in t)Ar(a,e,{get:t[e],enumerable:!0})};var h=(a,t,e)=>xi(a,typeof t!="symbol"?t+"":t,e),Qt=(a,t,e)=>t.has(a)||zr("Cannot "+e);var c=(a,t,e)=>(Qt(a,t,"read from private field"),e?e.call(a):t.get(a)),u=(a,t,e)=>t.has(a)?zr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Qt(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),k=(a,t,e)=>(Qt(a,t,"access private method"),e);var Tr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return c(a,t,r)}});var Zt={};wi(Zt,{default:()=>et});import{LitElement as Ei,html as Ce,css as ki,nothing as Ci}from"./lit-all.min.js";import{unsafeHTML as Dr}from"./lit-all.min.js";import{ifDefined as Si}from"./lit-all.min.js";function Ai(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var M,et,Xt=yi(()=>{M=class M extends Ei{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();M.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:s,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>r&&(f="left");let A=e.left+e.width/2,B=e.top+e.height/2,te=6,yt=(fi,vi,bi)=>Math.max(fi,Math.min(vi,bi)),wt,Et,Kt;f==="top"||f==="bottom"?(wt=f==="top"?e.top-p-n:e.bottom+n,Et=yt(0,r-d,A-d/2),Kt=yt(te,d-te*2,A-Et-te)):(Et=f==="left"?e.left-d-n:e.right+n,wt=yt(0,i-p,B-p/2),Kt=yt(te,p-te*2,B-wt-te)),this._tooltipTop=wt,this._tooltipLeft=Et,this._arrowOffset=Kt,this._computedPlacement=f}showTooltip(){M.activeTooltip&&M.activeTooltip!==this&&(M.activeTooltip.closeOverlay(),M.activeTooltip.tooltipVisible=!1,M.activeTooltip.requestUpdate()),M.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){M.activeTooltip===this&&(M.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ce`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:Ce`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return Ce`<span class="icon-only">${this.renderIcon()}</span>`;if(Ai())return Ce`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let i=t.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:g=>{this.lastPointerType=g.pointerType},pointerenter:g=>g.pointerType!=="touch"&&this.showTooltip(),pointerleave:g=>g.pointerType!=="touch"&&this.hideTooltip(),click:g=>{this.lastPointerType==="touch"&&this.handleTap(g),this.lastPointerType=null}},s=this._computedPlacement,l=s==="top"||s==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=l?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return Ce`
            <span
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${Si(d)}>
                    ${Dr(t)}
    ...
    `);et=M;customElements.define("mas-mnemonic",et)});import{LitElement as ko}from"./lit-all.min.js";import{css as Mr,unsafeCSS as _r}from"./lit-all.min.js";var w="(max-width: 767px)",L="(max-width: 1199px)",E="(min-width: 768px)",b="(min-width: 1200px)",P="(min-width: 1600px)",Lr="(min-width: 1280px)",Pr={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${b} and (not ${P})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(P),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Pr;function kt(){return Pr.isDesktop}var Rr=Mr`
    :host {
...
`,Or=()=>[Mr`
            ...
            /* Laptop */
            @media screen and ${_r(b)} {
                :host([size='wide']) {
                    grid-column: span 2;
                }
            }
        `];import{LitElement as zi,html as Nr,css as Ti}from"./lit-all.min.js";function Li(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Se=class extends zi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Li())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Xt())}e.remove()})}render(){let{href:t}=this;return t?Nr`<a href="${t}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(Se,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(Se,"styles",Ti`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Se);var Io=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),$o=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var Ae=2e4;var y='span[is="inline-price"][data-wcs-osi]',Z='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Pi='a[is="upt-link"]',Fr=`${y},${Z},${Pi}`;var Ir="merch-offer-select:ready",$r="merch-card:action-menu-toggle";var R="merch-quantity-selector:change",Br="merch-card-quantity:change",Jt="merch-modal:addon-and-quantity-update";var ze="merch-card-collection:literals-changed";var Te="aem:load",Le="aem:error",Ct="mas:ready",Hr="mas:error";var qr="placeholder-failed",Ur="placeholder-pending",Gr="placeholder-resolved";var jr="mas:failed",G="mas:resolved",Vr="mas/commerce";var re="failed",pe="pending",ae="resolved";var St="X-Request-Id",Bo=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Ho=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var At=":start",zt=":duration";var _="legal",Wr="mas-ff-defaults";var _i="mas-commerce-service";function Yr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function z(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function Pe(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function er(){return window.matchMedia("(max-width: 1024px)").matches}function me(){return document.getElementsByTagName(_i)?.[0]}function tt(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}function Kr(a){let t=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&t?.isInlinePrice&&t?.dataset?.template==="price"}var rt,ge,at,it,_e,Tt=class extends HTMLElement{constructor(){super();u(this,rt,"");u(this,ge);u(this,at,[]);u(this,it,[]);u(this,_e);m(this,_e,Yr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,ge)?this.parentElement.style.borderRadius=c(this,ge):c(this,ge)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,at).map((r,i)=>{let n=c(this,it)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,rt)}, ${e})`}connectedCallback(){c(this,_e).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,ge,i?.trim()),e==="colors"&&i?m(this,at,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,it,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,rt,i?.trim()??""),c(this,_e).call(this)}};rt=new WeakMap,ge=new WeakMap,at=new WeakMap,it=new WeakMap,_e=new WeakMap;customElements.define("merch-gradient",Tt);import{LitElement as Mi,html as Ri,css as Oi}from"./lit-all.min.js";var Me=class extends Mi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(G,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(G,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Ri` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(Me,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),h(Me,"styles",Oi`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as ot,css as Fi}from"./lit-all.min.js";var Xr=`
:root {
...
`;var Jr={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},ue=class extends v{constructor(t){super(t)}getGlobalCSS(){return Xr}renderLayout(){return ot`<div class="image">
    ...
    `);import{html as ta}from"./lit-all.min.js";var ea=`
:root {
...
`;var _t=class extends v{constructor(t){super(t)}getGlobalCSS(){return ea}renderLayout(){return ta` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":ta`<hr />`} ${this.secureLabelFooter}`}};import{html as ie,css as Ii,unsafeCSS as aa}from"./lit-all.min.js";var ra=`
  :root {
...
`;var $i=32,ia={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},De=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ie`<slot name="secure-transaction-label">
    ...
    `);import{html as Mt,css as Bi,unsafeCSS as oa,nothing as Hi}from"./lit-all.min.js";var na=`
  :root {
...
`;var qi=32,sa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ne=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Mt` <footer>
    ...
    `);import{html as st,css as Ui,nothing as Rt}from"./lit-all.min.js";var ca=`
:root {
...
`;var Ot={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},la={...function(){let{whatsIncluded:a,size:t,...e}=Ot;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},da={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=Ot;return i}()},j,V,O=class extends v{constructor(e){super(e);u(this,j);u(this,V);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===_&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ca}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let l=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(s)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&l){if(d)l.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(l):p.appendChild(l)}return}if(i&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!l){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){c(this,j)||(m(this,j,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(c(this,j)?.disconnect(),m(this,j,null),this.syncHeights())})),c(this,j).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let s=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=tt(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(d+=tt(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+tt(f));for(let B of r.childNodes){if(B.classList.contains("spacer"))break;d+=tt(B)}let A=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(A)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?st`<div class="divider"></div>`:Rt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled?.();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?st`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};j=new WeakMap,V=new WeakMap,h(O,"variantStyle",Ui`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?X`
        ...
        `:X`
            ...
            `:Dt}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?X`<slot name="icons"></slot>`:Dt}get secureLabelFooter(){return X`<footer>
            ...
            <slot></slot>`}};h(ne,"variantStyle",Gi`
...
`;var ua={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},se,W,fe,J,fa,ct,Ft=class Ft extends v{constructor(){super(...arguments);u(this,J);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);u(this,se,null);u(this,W,null);u(this,fe,null);h(this,"handleResize",()=>{c(this,W)&&cancelAnimationFrame(c(this,W)),m(this,W,requestAnimationFrame(()=>{m(this,W,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))});h(this,"toggleExpanded",e=>{e.preventDefault();let r=!this.expanded;for(let i of k(this,J,fa).call(this)){let n=i.variantLayout;n instanceof Ft&&(n.expanded=r,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen=!this.licenseOpen,this.licenseOpen?(m(this,se,r=>{r.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),k(this,J,ct).call(this))}),document.addEventListener("mousedown",c(this,se))):k(this,J,ct).call(this),this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,k(this,J,ct).call(this);let r=this.quantitySelectEl;r&&(r.selectedValue=Number(e),r.dispatchEvent(new CustomEvent(R,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return ga}priceOptionsProvider(e,r){e.dataset.template===_&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),r.dataset.displayPerUnit="false",e.parentNode.insertBefore(r,e.nextSibling),await r.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),r.addEventListener(G,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]')?.querySelector(".price-plan-type");i&&(i.textContent=e)}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled?.();let i=r.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights())}syncHeights(){this.card.getBoundingClientRect().width<=2||this.syncRowHeights([{name:"top-card",getElement:e=>e.shadowRoot?.querySelector(".top-card")}])}connectedCallbackHook(){window.addEventListener("resize",this.handleResize),m(this,fe,new IntersectionObserver(([e])=>{e.boundingClientRect.height!==0&&e.isIntersecting&&(window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights()),c(this,fe)?.disconnect())})),c(this,fe).observe(this.card)}disconnectedCallbackHook(){k(this,J,ct).call(this),window.removeEventListener("resize",this.handleResize),c(this,W)&&(cancelAnimationFrame(c(this,W)),m(this,W,null)),c(this,fe)?.disconnect()}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let r=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(r)||Number.isNaN(i)||i<r)return null;let o=[];for(let s=r;s<=i;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(e){let r=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=r.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let r=this.quantitySelectEl?.getAttribute("default-value");return r!=null&&e.includes(r)?r:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return oe`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,r=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(r));return oe`
        ...
        `}renderLayout(){let e=!!this.expanded;return oe`
            ...
            ${this.hasWhatsIncluded?oe`
                  ...
                  `:Nt}
            <slot></slot>
        `}};se=new WeakMap,W=new WeakMap,fe=new WeakMap,J=new WeakSet,fa=function(){let e=Math.round(this.card.getBoundingClientRect().top),r=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(i=>{let n=i.getBoundingClientRect();return n.width>2&&Math.round(n.top)===e});return r.length?r:[this.card]},ct=function(){c(this,se)&&(document.removeEventListener("mousedown",c(this,se)),m(this,se,null))},h(Ft,"variantStyle",ji`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var lt=Ft;import{html as rr,css as Vi}from"./lit-all.min.js";var va=`
:root {
...
`;var ba={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Y,Fe=class extends v{constructor(e){super(e);u(this,Y);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return va}priceOptionsProvider(e,r){e.dataset.template===_&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return rr` ${this.badge}
    ...
    `);import{html as ar,css as Wi}from"./lit-all.min.js";var xa=`
:root {
...
`;var ya={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ie=class extends v{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===_&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return xa}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return ar`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Yi,css as Ki}from"./lit-all.min.js";var wa=`
...
`;var Ea={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},$e=class extends v{constructor(t){super(t)}getGlobalCSS(){return wa}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Yi`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as ir,css as Qi}from"./lit-all.min.js";var ka=`
:root {
...
`;var Ca={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Be=class extends v{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ka}renderLayout(){return ir`${this.cardImage}
            ...
            ${this.evergreen?ir`
                  ...
                  `:ir`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(Be,"variantStyle",Qi`
    ...
    `);import{html as Zi,css as Xi}from"./lit-all.min.js";var Sa=`
:root {
...
`;var nr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},He=class extends v{getGlobalCSS(){return Sa}get aemFragmentMapping(){return nr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;if(!t)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(t.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",s)})}),x.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!kt()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let t=this.getContainer();t&&t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t<=2||t===this.lastSyncedWidth||(this.lastSyncedWidth=t,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(kt())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};e();let r=window.matchMedia(w);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(w).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||kt())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return Zi`
    ...
    `);import{html as za,css as Ji}from"./lit-all.min.js";var Aa=`
:root {
...
`;var or={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},qe=class extends v{getGlobalCSS(){return Aa}get aemFragmentMapping(){return or}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return za`
    ...
    `);import{html as sr,css as en,nothing as tn}from"./lit-all.min.js";var Ta=`
...
`;var La={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},rn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Ue=class extends v{constructor(t){super(t)}getGlobalCSS(){return Ta}renderLayout(){return sr`
    ...
    `);import{css as an,html as nn}from"./lit-all.min.js";var Pa=`
...
`;var _a={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ge=class extends v{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Pa}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return nn`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as on,css as sn}from"./lit-all.min.js";var Ma=`
...
`;var cr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},cn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],It,Ra,je=class extends v{constructor(e){super(e);u(this,It);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ma}get aemFragmentMapping(){return cr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,k(this,It,Ra).call(this))}renderLayout(){return on`
            <div class="card">
            ...
            <slot></slot>
        `}};It=new WeakSet,Ra=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;cn.forEach(({key:r,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),r))},h(je,"variantStyle",sn`
    ...
    `);import{html as ln,css as dn}from"./lit-all.min.js";var Oa=`
...
`;var lr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ve=class extends v{getGlobalCSS(){return Oa}get aemFragmentMapping(){return lr}renderLayout(){return ln`
    ...
    `);var $t=new Map,Da=new WeakMap,Na=new Map,C=(a,t,e=null,r=null,i)=>{$t.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};C("catalog",Oe,Zr,Oe.variantStyle);C("image",ue);C("inline-heading",_t);C("mini-compare-chart",De,ia,De.variantStyle);C("mini-compare-chart-mweb",Ne,sa,Ne.variantStyle);C("plans",O,Ot,O.variantStyle,O.collectionOptions);C("plans-students",O,da,O.variantStyle,O.collectionOptions);C("plans-education",O,la,O.variantStyle,O.collectionOptions);C("plans-v2",ne,ma,ne.variantStyle,ne.collectionOptions);C("bizpro",lt,ua,lt.variantStyle);C("product",Fe,ba,Fe.variantStyle);C("segment",Ie,ya,Ie.variantStyle);C("media",$e,Ea,$e.variantStyle);C("headless",Ue,La,Ue.variantStyle);C("special-offers",Be,Ca,Be.variantStyle);C("simplified-pricing-express",He,nr,He.variantStyle);C("full-pricing-express",qe,or,qe.variantStyle);C("mini",Ge,_a,Ge.variantStyle);C("image",ue,Jr,ue.variantStyle);C("compare-chart-column",je,cr,je.variantStyle);C("fries",Ve,lr,Ve.variantStyle);var hn=(a,t,e)=>{try{let r=Na.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),Na.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},dr=a=>{let t=$t.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=Da.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?hn(a,r,i):{};return Da.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Pt(a){return $t.get(a)?.fragmentMapping}function Fa(a){return $t.get(a)?.collectionOptions}var Ia=document.createElement("style");Ia.innerHTML=`
:root {
...
`;document.head.appendChild(Ia);function Bt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=hr(r)?r:a;n=o.get(s)}if(i&&n==null){let o=hr(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=mn(hr(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var pn=a=>typeof a=="boolean",Ht=a=>typeof a=="function";var hr=a=>typeof a=="string";function $a(a,t){if(pn(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function mn(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var ce=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(St);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var ve={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ba=1e3;function gn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Ha(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ve.serializableTypes.includes(e))return e}return a}function un(a,t){if(!ve.ignoredProperties.includes(a))return Ha(t)}var pr={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(gn(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(Ha).join(" ")}`);let{pathname:o,search:s}=window.location,l=`${ve.delimiter}page=${o}${s}`;l.length>Ba&&(l=`${l.slice(0,Ba)}<trunc>`),n+=l,i.length&&(n+=`${ve.delimiter}facts=`,n+=JSON.stringify(i,un)),window.lana?.log(n,ve)}};function qa(a){Object.assign(ve,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in ve&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Ua={LOCAL:"local",PROD:"prod",STAGE:"stage"},mr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},gr=new Set,ur=new Set,Ga=new Map,ja={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Va={filter:({level:a})=>a!==mr.DEBUG},fn={filter:()=>!1};function vn(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Ht(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function bn(a){[...ur].every(t=>t(a))&&gr.forEach(t=>t(a))}function Wa(a){let t=(Ga.get(a)??0)+1;Ga.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Wa(`${r.namespace}/${i}`),updateConfig:qa};return Object.values(mr).forEach(i=>{r[i]=(n,...o)=>bn(vn(i,n,a,o,e))}),Object.seal(r)}function qt(...a){a.forEach(t=>{let{append:e,filter:r}=t;Ht(r)&&ur.add(r),Ht(e)&&gr.add(e)})}function xn(a={}){let{name:t}=a,e=$a(Bt("commerce.debug",{search:!0,storage:!0}),t===Ua.LOCAL);return qt(e?ja:Va),t===Ua.PROD&&qt(pr),dt}function yn(){gr.clear(),ur.clear()}var dt={...Wa(Vr),Level:mr,Plugins:{consoleAppender:ja,debugFilter:Va,quietFilter:fn,lanaAppender:pr},init:xn,reset:yn,use:qt};var wn="mas-commerce-service",pd=dt.module("utilities"),En={requestId:St,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Ut=a=>window.setTimeout(a);function fr(){return document.getElementsByTagName(wn)?.[0]}function Ya(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(En)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ka(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw i}var Qa="fragment",Za="author",Xa="preview",Ja="loading",ei="timeout",vr="aem-fragment",ti="eager",ri="cache",kn=[ti,ri],K,be,H,br=class{constructor(){u(this,K,new Map);u(this,be,new Map);u(this,H,new Map)}clear(){c(this,K).clear(),c(this,be).clear(),c(this,H).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,K).set(t.id,t),t.fields?.originalId&&c(this,K).set(t.fields.originalId,t),c(this,H).has(t.id)){let[,r]=c(this,H).get(t.id);r()}if(c(this,H).has(t.fields?.originalId)){let[,r]=c(this,H).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,K).has(t)}entries(){return c(this,K).entries()}get(t){return c(this,K).get(t)}getAsPromise(t){let[e]=c(this,H).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),c(this,H).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,be).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,be).set(t,e)),e}remove(t){c(this,K).delete(t),c(this,be).delete(t),c(this,H).delete(t)}};K=new WeakMap,be=new WeakMap,H=new WeakMap;var le=new br,We,F,ee,N,D,T,ht,pt,q,mt,gt,Ye,U,ai,ii,xr,ni,Gt=class extends HTMLElement{constructor(){super(...arguments);u(this,U);h(this,"cache",le);u(this,We);u(this,F,null);u(this,ee,null);u(this,N,null);u(this,D);u(this,T);u(this,ht,ti);u(this,pt,5e3);u(this,q);u(this,mt,!1);u(this,gt,0);u(this,Ye)}static get observedAttributes(){return[Qa,Ja,ei,Za,Xa]}attributeChangedCallback(e,r,i){e===Qa&&(m(this,D,i),m(this,T,le.getFetchInfo(i))),e===Ja&&kn.includes(i)&&m(this,ht,i),e===ei&&m(this,pt,parseInt(i,10)),e===Za&&m(this,mt,["","true"].includes(i)),e===Xa&&m(this,Ye,i)}connectedCallback(){if(!c(this,q)){if(c(this,N)??m(this,N,me(this)),m(this,Ye,c(this,N).settings?.preview),c(this,We)??m(this,We,c(this,N).log.module(`${vr}[${c(this,D)}]`)),!c(this,D)||c(this,D)==="#"){c(this,T)??m(this,T,le.getFetchInfo("missing-fragment-id")),k(this,U,xr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,T)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,q)&&!await Promise.race([c(this,q),Promise.resolve(!1)]))return;e&&le.remove(c(this,D)),c(this,ht)===ri&&await Promise.race([le.getAsPromise(c(this,D)),new Promise(s=>setTimeout(s,c(this,pt)))]);try{m(this,q,k(this,U,ni).call(this)),await c(this,q)}catch(s){return k(this,U,xr).call(this,s.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=c(this,F)||{};return o&&!Bt("mas.disableWcsCache")&&c(this,N).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Te,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...c(this,T)},bubbles:!0,composed:!0})),c(this,q)}get updateComplete(){return c(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,ee)?c(this,ee):(c(this,mt)?this.transformAuthorData():this.transformPublishData(),c(this,ee))}get rawData(){return c(this,F)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:s={},dictionary:l={},placeholders:d={}}=c(this,F);m(this,ee,e.reduce((p,{name:g,multiple:f,values:A})=>(p.fields[g]=f?A:A[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:s,dictionary:l,placeholders:d,variationId:n}))}transformPublishData(){if(!c(this,F))return;let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={},variationId:d}=c(this,F);m(this,ee,Object.entries(e).reduce((p,[g,f])=>(p.fields[g]=f?.mimeType?f.value:f??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:s,placeholders:l,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:c(this,N).settings.locale,apiKey:c(this,N).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??c(this,N).settings.instant;return n&&(i.instant=n),await r(c(this,D),i)}};We=new WeakMap,F=new WeakMap,ee=new WeakMap,N=new WeakMap,D=new WeakMap,T=new WeakMap,ht=new WeakMap,pt=new WeakMap,q=new WeakMap,mt=new WeakMap,gt=new WeakMap,Ye=new WeakMap,U=new WeakSet,ai=async function(e){Tr(this,gt)._++;let r=`${vr}:${c(this,D)}:${c(this,gt)}`,i=`${r}${At}`,n=`${r}${zt}`;if(c(this,Ye)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new ce(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(c(this,T).stale=!1,c(this,T).url=e,o=await Ka(e,{cache:"default",credentials:"omit"}),k(this,U,ii).call(this,o),c(this,T).status=o?.status,c(this,T).measure=Pe(performance.measure(n,i)),c(this,T).retryCount=o.retryCount,!o?.ok)throw new ce("Unexpected fragment response",{response:o,...c(this,N).duration});return await o.json()}catch(s){if(c(this,T).measure=Pe(performance.measure(n,i)),c(this,T).retryCount=s.retryCount,c(this,F))return c(this,T).stale=!0,c(this,We).error("Serving stale data",c(this,T)),c(this,F);let l=s.message??"unknown";throw new ce(`Failed to fetch fragment: ${l}`,{})}},ii=function(e){Object.assign(c(this,T),Ya(e))},xr=function(e){m(this,q,null),c(this,T).message=e,this.classList.add("error");let r={...c(this,T),...c(this,N).duration};c(this,We).error(e,r),this.dispatchEvent(new CustomEvent(Le,{detail:r,bubbles:!0,composed:!0}))},ni=async function(){var l;this.classList.remove("error"),m(this,ee,null);let e=le.get(c(this,D));if(e)return m(this,F,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=c(this,N).settings,s=`${r}/fragment?id=${c(this,D)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await k(this,U,ai).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,D)),le.add(e),m(this,F,e),!0},h(Gt,"cache",le);customElements.define(vr,Gt);import{LitElement as Cn,html as yr,css as Sn,nothing as An}from"./lit-all.min.js";import{unsafeHTML as zn}from"./lit-all.min.js";var Tn=a=>a?a.startsWith("sp-icon-")?yr`${zn(`<${a} class="badge-icon"></${a}>`)}`:yr`<img src="${a}" class="badge-icon" />`:An,Ke=class extends Cn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return yr`<div class="badge">
            ${Tn(this.icon)}<slot>${this.text}</slot>
        </div>`}};h(Ke,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),h(Ke,"styles",Sn`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Ke);import{html as Ln,css as Pn,LitElement as _n}from"./lit-all.min.js";var ut=class extends _n{constructor(){super()}render(){return Ln`
            <slot name="icon"></slot>
    ...
    `),h(ut,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ut);import{html as wr,css as Mn,LitElement as Rn,nothing as oi}from"./lit-all.min.js";var ft=class extends Rn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return wr`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?wr`<slot name="content"></slot>`:oi}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?wr`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:oi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(ft,"styles",Mn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),h(ft,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",ft);var On={[re]:qr,[pe]:Ur,[ae]:Gr},Dn={[re]:jr,[ae]:G},vt,jt=class{constructor(t){u(this,vt);h(this,"changes",new Map);h(this,"connected",!1);h(this,"error");h(this,"log");h(this,"options");h(this,"promises",[]);h(this,"state",pe);h(this,"timer",null);h(this,"value");h(this,"version",0);h(this,"wrapperElement");this.wrapperElement=t,this.log=dt.module("mas-element")}update(){[re,pe,ae].forEach(t=>{this.wrapperElement.classList.toggle(On[t],t===this.state)})}notify(){(this.state===ae||this.state===re)&&(this.state===ae?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===re&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof ce&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Dn[this.state],{bubbles:!0,composed:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){m(this,vt,fr()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return ae===r?Promise.resolve(this.wrapperElement):re===r?Promise.reject(t):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=ae,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),Ut(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=re,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...c(this,vt)?.duration}),Ut(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=pe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!fr()||this.timer)return;let{error:e,options:r,state:i,value:n,version:o}=this;this.state=pe,this.timer=Ut(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===pe&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,r)}})}};vt=new WeakMap;function Nn(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ye,xe=class xe extends HTMLAnchorElement{constructor(){super();h(this,"masElement",new jt(this));u(this,ye);this.setAttribute("is",xe.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,i){this.masElement.attributeChangedCallback(e,r,i)}connectedCallback(){this.masElement.connectedCallback(),m(this,ye,me()),c(this,ye)&&(this.log=c(this,ye).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,ye,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=me();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:s,language:l,env:d}=r,p=`locale=${l}_${s}&country=${s}&offer_id=${o.offerId}`,g=this.getAttribute("data-promotion-code");g&&(p+=`&promotion_code=${encodeURIComponent(g)}`),this.href=`${Nn(d)}?${p}`,this.masElement.toggleResolved(i,o,r)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,r),!1}}static createFrom(e){let r=new xe;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?r.setAttribute("class",i.value.replace("upt-link","").trim()):r.setAttribute(i.name,i.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};ye=new WeakMap,h(xe,"is","upt-link"),h(xe,"tag","a"),h(xe,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var de=xe;window.customElements.get(de.is)||window.customElements.define(de.is,de,{extends:de.tag});var Fn="#000000",Er="#F8D904",In="#EAEAEA",$n="#31A547",Bn=/(accent|primary|secondary)(-(outline|link))?/,Hn="mas:product_code/",qn="daa-ll",Vt="daa-lh",Un=["XL","L","M","S"],kr="...",Gn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function I(a,t,e,r){let i=r[a];if(t[a]&&i){let n={slot:i?.slot,...i?.attributes},o=t[a];if(i.maxCount&&typeof o=="string"){let[l,d]=mo(o,i.maxCount,i.withSuffix);l!==o&&(n.title=d,o=l)}let s=z(i.tag,n,o);e.append(s)}}function jn(a,t,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,s)=>({icon:o,alt:a.mnemonicAlt?.[s]??"",link:a.mnemonicLink?.[s]??""}));i?.forEach(({icon:o,alt:s,link:l})=>{if(l&&!/^https?:/.test(l))try{l=new URL(`https://${l}`).href.toString()}catch{l="#"}let d={slot:"icons",src:o,loading:t.loading,size:e?.size??"l"};s&&(d.alt=s),l&&(d.href=l);let p=z("merch-icon",d);t.append(p)});let n=t.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function Vn(a,t,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let r=Er,i=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,a.borderColor||(i=!0));let n=a.badgeBackgroundColor||r,o=a.borderColor||"";i&&(o=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${n}" border-color="${o}">${a.badge}</merch-badge>`}I("badge",a,t,e)}else a.badge?(t.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",a.badgeColor||Fn),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",a.badgeBackgroundColor||Er),t.setAttribute("border-color",a.badgeBackgroundColor||Er)):t.setAttribute("border-color",a.borderColor||In)}function Wn(a,t,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||$n;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${r}">${a.trialBadge}</merch-badge>`}I("trialBadge",a,t,e)}}function Yn(a,t,e){e?.includes(a.size)&&t.setAttribute("size",a.size)}function Kn(a,t){a.cardName&&t.setAttribute("name",a.cardName)}function Qn(a,t,e){a.cardTitle&&(a.cardTitle=Qe(a.cardTitle)),I("cardTitle",a,t,{cardTitle:e})}function Zn(a,t,e){I("subtitle",a,t,e)}function Xn(a,t,e,r){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[a.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),t.setAttribute("background-color",a.backgroundColor)):r?.attribute&&a.backgroundColor&&(t.setAttribute(r.attribute,a.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function Jn(a,t,e){let r=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")t.style.setProperty(i,"transparent");else if(a.borderColor&&r){let o=r?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),s=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){t.setAttribute("gradient-border","true");let l=a.borderColor;if(r?.specialValues){for(let[d,p]of Object.entries(r.specialValues))if(p===a.borderColor){l=d;break}}t.setAttribute("border-color",l),t.style.removeProperty(i)}else s?(t.setAttribute("border-color",a.borderColor),t.style.setProperty(i,`var(--${a.borderColor})`)):t.style.setProperty(i,`var(--${a.borderColor})`)}}var eo=new Set(["","default"]);function to(a,t,e){let r=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!r)return;let o=(t.querySelector('[slot="footer-rows"] merch-whats-included')??t.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),s=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",l=o||s;if(l==null||eo.has(String(l).trim().toLowerCase())){t.removeAttribute("whats-included-divider-color"),t.style.removeProperty(i);return}let d=String(l).trim();if(d.toLowerCase()==="transparent"){t.removeAttribute("whats-included-divider-color"),t.style.setProperty(i,"transparent");return}let g=r.specialValues?.[d]?.includes("gradient")||/-gradient/.test(d)||/^gradient-/.test(d),f=/^spectrum-.*-(plans|special-offers)$/.test(d);if(g){let A=d;if(r.specialValues){for(let[B,te]of Object.entries(r.specialValues))if(te===d){A=B;break}}t.setAttribute("whats-included-divider-color",A),t.style.removeProperty(i)}else f?(t.setAttribute("whats-included-divider-color",d),t.style.setProperty(i,`var(--${d})`)):(t.removeAttribute("whats-included-divider-color"),t.style.setProperty(i,`var(--${d})`))}function ro(a,t,e){if(a.backgroundImage){let r={loading:t.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?r.alt=a.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,a.backgroundImage);return}t.append(z(e.tag,{slot:e.slot},z("img",r)))}}function Qe(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(Xt(),Zt)).catch(console.error),a}function ao(a){if(!a||typeof a!="string")return a;let t=document.createElement("template");t.innerHTML=a.trim();let e=Array.from(t.content.children);return e.length!==1||e[0].tagName!=="P"?a:e[0].innerHTML}function io(a,t,e){a.prices&&(a.prices=ao(Qe(a.prices))),I("prices",a,t,e)}function Cr(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap(Cr);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap(Cr);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function no(a,t,e){let r=Cr(a.features).filter(n=>n.trim());if(!r.length)return;let i=z("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});r.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let s=o.body.querySelector("p[name]");if(s){i.append(s);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&t.append(i)}function ci(a,t,e){let r=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=Bn.exec(i)?.[0]??"accent",o=n.includes("accent"),s=n.includes("primary"),l=n.includes("secondary"),d=n.includes("-outline"),p=n.includes("-link");a.classList.remove("accent","primary","secondary");let g;if(t.consonant)g=vo(a,o,r,p,s,l,e?.ctas?.size);else if(p)g=a;else{let f;o?f="accent":s?f="primary":l&&(f="secondary"),g=t.spectrum==="swc"?fo(a,e,d,f,r):uo(a,e,d,f,r)}return g}function oo(a,t){let{slot:e}=t?.description,r=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(i=>{let n=ci(i,a,t);i.replaceWith(n)})}function so(a,t,e,r){a.description&&(a.description=Qe(a.description)),a.promoText&&(a.promoText=Qe(a.promoText)),a.shortDescription&&(a.shortDescription=Qe(a.shortDescription)),I("promoText",a,t,e),I("description",a,t,e),I("shortDescription",a,t,e),a.shortDescription&&(t.setAttribute("action-menu","true"),a.actionMenuLabel||t.setAttribute("action-menu-label","More options")),oo(t,e),I("callout",a,t,e),co(a,t,e,r),I("whatsIncluded",a,t,e)}function co(a,t,e,r={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=r.quantitySelect),I("quantitySelect",a,t,e))}function lo(a,t,e,r={}){if(!e.addon)return;let n=(a.addon??r.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o=z("merch-addon",{slot:"addon"},n);[...o.querySelectorAll(y)].forEach(s=>{let l=s.parentElement;l?.nodeName==="P"&&l.setAttribute("data-plan-type","")}),t.append(o)}function ho(a,t,e){a.addonConfirmation&&I("addonConfirmation",a,t,e)}function po(a,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function mo(a,t,e=!0){try{let r=typeof a!="string"?"":a,i=si(r);if(i.length<=t)return[r,i];let n=0,o=!1,s=e?t-kr.length<1?1:t-kr.length:t,l=[];for(let g of r){if(n++,g==="<")if(o=!0,r[n]==="/")l.pop();else{let f="";for(let A of r.substring(n)){if(A===" "||A===">")break;f+=A}l.push(f)}if(g==="/"&&r[n]===">"&&l.pop(),g===">"){o=!1;continue}if(!o&&(s--,s===0))break}let d=r.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let g of l.reverse())d+=`</${g}>`}return[`${d}${e?kr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=si(i);return[i,n]}}function si(a){if(!a)return"";let t="",e=!1;for(let r of a){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function go(a,t){t.querySelectorAll("a.upt-link").forEach(r=>{let i=de.createFrom(r);r.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function uo(a,t,e,r,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of a.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",s=`spectrum-Button--${r}`,l=Un.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",d=["spectrum-Button",s,l];return e&&d.push("spectrum-Button--outline"),n.classList.add(...d),n}function fo(a,t,e,r,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let s=z("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return s.source=n,(i?n.onceSettled():Promise.resolve(n)).then(l=>{s.setAttribute("data-navigation-url",l.href)}),s.addEventListener("click",l=>{l.defaultPrevented||n.click()}),s}function vo(a,t,e,r,i,n,o){let s=a;if(e)try{let l=customElements.get("checkout-link");l&&(s=l.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return r||(s.classList.add("button","con-button"),o&&o!=="m"&&s.classList.add(`button-${o}`),t&&s.classList.add("blue"),i&&s.classList.add("primary"),n&&s.classList.add("secondary")),s}function bo(a,t,e,r,i){if(a.ctas){a.ctas=Qe(a.ctas);let{slot:n}=e.ctas,o=z("div",{slot:n},a.ctas),s=[...o.querySelectorAll("a")],l=i?.hideTrialCTAs?s.filter(p=>!Gn.has(p.dataset.analyticsId)):s,d=(l.length>0?l:s).map(p=>ci(p,t,e));o.textContent="",o.append(...d),t.append(o),i?.hideTrialCTAs&&l.length>0&&d.forEach(p=>{let g=p.source??p;g.onceSettled&&(p.hidden=!0,g.onceSettled().then(()=>{g.value?.[0]?.offerType==="TRIAL"&&d.some(A=>A!==p&&!A.hidden)?p.remove():p.hidden=!1}).catch(()=>{p.hidden=!1}))})}}function xo(a,t){let{tags:e}=a,r=e?.find(n=>typeof n=="string"&&n.startsWith(Hn))?.split("/").pop();if(!r)return;t.setAttribute(Vt,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(qn,`${n.dataset.analyticsId}-${o+1}`)})}function yo(a,t,e){let r={},i=[...a.classList].filter(n=>n!==t);for(let n of a.attributes)n.name!=="class"&&(r[n.name]=n.value);i.length&&(r.class=i.join(" ")),e==="secondary"&&(r.variant="secondary"),a.replaceWith(z("sp-link",r,a.innerHTML))}function wo(a){if(a.consonant)return;let{spectrum:t}=a;t!=="css"&&t!=="swc"||[["primary-link","primary"],["secondary-link","secondary"]].forEach(([e,r])=>{a.querySelectorAll(`a.${e}`).forEach(i=>{t==="swc"?yo(i,e,r):(i.classList.remove(e),i.classList.add("spectrum-Link",`spectrum-Link--${r}`))})})}function Eo(a){a.querySelectorAll("[slot]").forEach(r=>{r.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",Vt].forEach(r=>a.removeAttribute(r));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function li(a,t){if(!a){let l=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!a.fields){let l=a.id||"unknown",d=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'.`)}let{id:e,fields:r,settings:i={},priceLiterals:n}=a,{variant:o}=r;if(!o)throw new Error(`hydrate: no template found in payload ${e}`);Eo(t),t.compatVersion=r.compatVersion,t.contextPromotionCode=r.promoCode,t.settings=i,n&&(t.priceLiterals=n),t.id??(t.id=a.id),a.variationId&&t.setAttribute("variation-id",a.variationId??""),t.variant=o,await t.updateComplete;let{aemFragmentMapping:s}=t.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&t.setAttribute("consonant",!0),jn(r,t,s.mnemonics),Wn(r,t,s),Yn(r,t,s.size),Kn(r,t),Qn(r,t,s.title),Vn(r,t,s),Zn(r,t,s),io(r,t,s),ro(r,t,s.backgroundImage),Xn(r,t,s.allowedColors,s.backgroundColor),Jn(r,t,s),so(r,t,s,i),no(r,t,s),to(r,t,s),lo(r,t,s,i),ho(r,t,s),po(r,t,s,i);try{go(r,t)}catch{}bo(r,t,s,o,i),xo(r,t),wo(t)}var Yt="merch-card",di="merch-card:",gi=["full-pricing-express","simplified-pricing-express"],ui=["segment","product"];function hi(a,t){let e=a.closest(Yt);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),Kr(a)&&(t.displayPerUnit=!1,t.displayTax=!1),!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.contextPromotionCode),e.aemFragment&&(t[Wr]=!0),e.variantLayout?.priceOptionsProvider?.(a,t),a.dataset.template===_&&(t.displayDot??(t.displayDot=e.variantLayout?.legalDisplayDot??!0))}function pi(a,t){let e=a.closest(Yt);if(!e)return t;!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.contextPromotionCode)}function Co(a){a.providers.has(hi)||a.providers.price(hi),a.providers.has(pi)||a.providers.checkout(pi)}var bt=new IntersectionObserver(a=>{a.forEach(t=>{let e=t.target;if(gi.includes(e.variant)){if(e.clientHeight===0)return;bt.unobserve(e),e.requestUpdate();return}if(ui.includes(e.variant)){if(t.boundingClientRect.width===0)return;if(e.variant==="product"&&e.querySelector('merch-icon[slot="icons"]')){bt.unobserve(e);return}let r=e.getBoundingClientRect().width,n=e.querySelector('[slot="badge"]')?.getBoundingClientRect().width||0;if(r===0||n===0){bt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(r-n-16)}px`),bt.unobserve(e)}})}),So=0,Ze,Xe,Je,Q,Ee,$,ke,S,we,xt,Sr,Wt,he=class extends ko{constructor(){super();u(this,S);h(this,"contextPromotionCode");u(this,Ze);u(this,Xe);u(this,Je);u(this,Q);u(this,Ee);u(this,$);u(this,ke,new Promise(e=>{m(this,$,e)}));h(this,"compatVersion");h(this,"customerSegment");h(this,"marketSegment");h(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=dr(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=dr(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){k(this,S,we).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(y)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(Z)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(Z)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(Z)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let i of r){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let s=i.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&s.push(o),i.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let i=n=>{let{offerType:o,planType:s}=n.value?.[0]??{};if(!o||!s)return;let l=e.getOsi(s,o),d=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==l);e.checked&&d.push(l),n.dataset.wcsOsi=d.join(",")};r.forEach(i)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let i of r)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(i=>{if(e){r[i].order=Math.min(r[i].order||2,2);return}let n=r[i].order;n===1||isNaN(n)||(r[i].order=Number(n)+1)}),this.filters=r}showInfoTooltip(e,r){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(r)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(r=>this.iconButton.addEventListener(r,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(r=>this.iconButton.addEventListener(r,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",r=>{r.key==="Escape"&&this.iconButton.classList.remove(e)}))}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),c(this,Xe)||m(this,Xe,So++),this.aemFragment||((r=c(this,$))==null||r.call(this),m(this,$,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??c(this,Xe);m(this,Ee,`${di}${e}${At}`),m(this,Ze,`${di}${e}${zt}`),performance.mark(c(this,Ee)),m(this,Q,me()),Co(c(this,Q)),m(this,Je,c(this,Q).Log.module(Yt)),this.addEventListener(R,this.handleQuantitySelection),this.addEventListener(Jt,this.handleAddonAndQuantityUpdate),this.addEventListener(Ir,this.handleMerchOfferSelectReady),this.addEventListener(Le,this.handleAemFragmentEvents),this.addEventListener(Te,this.handleAemFragmentEvents),this.addEventListener(Ct,this.handleInfoIconEvents),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(R,this.handleQuantitySelection),this.removeEventListener(Le,this.handleAemFragmentEvents),this.removeEventListener(Te,this.handleAemFragmentEvents),this.removeEventListener(Ct,this.handleInfoIconEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(Jt,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===Le&&k(this,S,we).call(this,"AEM fragment cannot be loaded"),e.type===Te&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{c(this,$)||m(this,ke,new Promise(n=>{m(this,$,n)})),await li(i,this)}catch(n){k(this,S,we).call(this,`hydration has failed: ${n.message}`)}finally{(r=c(this,$))==null||r.call(this),m(this,$,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;c(this,ke)&&(await c(this,ke),(gi.includes(this.variant)||ui.includes(this.variant))&&bt.observe(this),m(this,ke,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(l=>setTimeout(()=>l("timeout"),Ae));if(this.aemFragment){let l=await Promise.race([this.aemFragment.updateComplete,e]);if(l===!1||l==="timeout"){let d=l==="timeout"?`AEM fragment was not resolved within ${Ae} timeout`:"AEM fragment cannot be loaded";k(this,S,we).call(this,d,{},!1);return}}let r=[...this.querySelectorAll(Fr)],i=Promise.all(r.map(l=>{let d=l.onceSettled?.();return d?d.catch(()=>l):Promise.resolve(l)})).then(l=>{let d=l.filter(p=>p.isConnected);return d.length===0||d.every(p=>p.classList.contains("placeholder-resolved"))}),n=await Promise.race([i,e]);if(!this.isConnected)return;let o=r.filter(l=>l.isConnected);if(o.length===0||o.every(l=>l.classList.contains("placeholder-resolved"))){this.measure=performance.measure(c(this,Ze),c(this,Ee));let l={...this.aemFragment?.fetchInfo,...c(this,Q).duration,measure:Pe(this.measure)};return this.dispatchEvent(new CustomEvent(Ct,{bubbles:!0,composed:!0,detail:l})),this}else{this.measure=performance.measure(c(this,Ze),c(this,Ee));let l={measure:Pe(this.measure),...c(this,Q).duration};if(n==="timeout")k(this,S,we).call(this,`Contains offers that were not resolved within ${Ae} timeout`,l);else{let d=o.some(p=>p.matches(Z)&&p.classList.contains("placeholder-failed"));k(this,S,we).call(this,d?"CTA has an invalid offer":"Contains unresolved offers",l)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(Z)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let s=new URL(n.getAttribute("href")).searchParams.get("pa"),l=r.find(p=>p.productArrangementCode===s)?.quantity,d=!!r.find(p=>p.productArrangementCode!==s);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(Br,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==d){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:d}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(y))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${y}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return c(this,S,xt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${y}[data-promotion-code],${Z}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return this.contextPromotionCode;let r=[...new Set(e)];return r.length>1&&c(this,Je)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${y}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(c(this,S,Sr)??c(this,S,xt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return c(this,S,xt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return c(this,S,Sr)?.querySelector(e)?.textContent?.trim()??c(this,S,xt)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return k(this,S,Wt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${Z}, a`);return Array.from(e??[])}get primaryCta(){return k(this,S,Wt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return k(this,S,Wt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Ze=new WeakMap,Xe=new WeakMap,Je=new WeakMap,Q=new WeakMap,Ee=new WeakMap,$=new WeakMap,ke=new WeakMap,S=new WeakSet,we=function(e,r={},i=!0){var l;if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let s={...this.aemFragment.fetchInfo,...c(this,Q).duration,...r,message:e};c(this,Je).error(`merch-card${o}: ${e}`,s),this.failed=!0,(l=c(this,$))==null||l.call(this),m(this,$,void 0),c(this,Q).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(Hr,{bubbles:!0,composed:!0,detail:s}))},xt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${y}[data-template="price"] > span`)},Sr=function(){return this.querySelector(`${y}[data-template="legal"]`)},Wt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},h(he,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,i,n]=e.split(",");return{PUF:r,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[i,n,o]=r.split(":"),s=Number(n);return[i,{order:isNaN(s)?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:i,size:n}])=>[r,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Vt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),h(he,"styles",[Rr,...Or()]),h(he,"registerVariant",C),h(he,"getCollectionOptions",Fa),h(he,"getFragmentMapping",Pt);customElements.define(Yt,he);export{he as MerchCard};

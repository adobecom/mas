var Kt=Object.defineProperty;var Qt=i=>{throw TypeError(i)};var vi=(i,t,e)=>t in i?Kt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var bi=(i,t)=>()=>(i&&(t=i(i=0)),t);var yi=(i,t)=>{for(var e in t)Kt(i,e,{get:t[e],enumerable:!0})};var d=(i,t,e)=>vi(i,typeof t!="symbol"?t+"":t,e),wt=(i,t,e)=>t.has(i)||Qt("Cannot "+e);var c=(i,t,e)=>(wt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Qt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),m=(i,t,e,r)=>(wt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),S=(i,t,e)=>(wt(i,t,"access private method"),e);var Xt=(i,t,e,r)=>({set _(a){m(i,t,a,e)},get _(){return c(i,t,r)}});var Et={};yi(Et,{default:()=>De});import{LitElement as wi,html as et,css as Ei}from"./lit-all.min.js";function ki(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var T,De,kt=bi(()=>{T=class T extends wi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();T.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}showTooltip(){T.activeTooltip&&T.activeTooltip!==this&&(T.activeTooltip.closeOverlay(),T.activeTooltip.tooltipVisible=!1,T.activeTooltip.requestUpdate()),T.activeTooltip=this,this.tooltipVisible=!0}hideTooltip(){T.activeTooltip===this&&(T.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?et`<merch-icon
    ...
    `);De=T;customElements.define("mas-mnemonic",De)});import{LitElement as Qa}from"./lit-all.min.js";import{css as er,unsafeCSS as Jt}from"./lit-all.min.js";var y="(max-width: 767px)",M="(max-width: 1199px)",w="(min-width: 768px)",u="(min-width: 1200px)",C="(min-width: 1600px)",Zt={matchMobile:window.matchMedia(y),matchDesktop:window.matchMedia(`${u} and (not ${C})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(C),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},f=Zt;function Je(){return Zt.isDesktop}var tr=er`
    :host {
...
`,rr=()=>[er`
        ...
        `];import{LitElement as Si,html as ir,css as Ai}from"./lit-all.min.js";function Ci(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var pe=class extends Si{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Ci())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>kt())}e.remove()})}render(){let{href:t}=this;return t?ir`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(pe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(pe,"styles",Ai`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",pe);var pn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),hn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var x='span[is="inline-price"][data-wcs-osi]',G='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Ti='a[is="upt-link"]',ar=`${x},${G},${Ti}`;var nr="merch-offer-select:ready",or="merch-card:action-menu-toggle";var H="merch-quantity-selector:change",sr="merch-card-quantity:change",St="merch-modal:addon-and-quantity-update";var he="merch-card-collection:literals-changed";var me="aem:load",ge="aem:error",cr="mas:ready",lr="mas:error",dr="placeholder-failed",pr="placeholder-pending",hr="placeholder-resolved";var mr="mas:failed",Ne="mas:resolved",gr="mas/commerce";var V="failed",Z="pending",W="resolved";var tt="X-Request-Id",mn=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var gn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var rt=":start",it=":duration";var ue="legal",ur="mas-ff-defaults";var Li="mas-commerce-service";function fr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function L(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function fe(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function At(){return window.matchMedia("(max-width: 1024px)").matches}function J(){return document.getElementsByTagName(Li)?.[0]}function $e(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Fe,ee,Ie,Be,xe,at=class extends HTMLElement{constructor(){super();g(this,Fe,"");g(this,ee);g(this,Ie,[]);g(this,Be,[]);g(this,xe);m(this,xe,fr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,ee)?this.parentElement.style.borderRadius=c(this,ee):c(this,ee)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Ie).map((r,a)=>{let n=c(this,Be)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Fe)}, ${e})`}connectedCallback(){c(this,xe).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&m(this,ee,a?.trim()),e==="colors"&&a?m(this,Ie,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?m(this,Be,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Fe,a?.trim()??""),c(this,xe).call(this)}};Fe=new WeakMap,ee=new WeakMap,Ie=new WeakMap,Be=new WeakMap,xe=new WeakMap;customElements.define("merch-gradient",at);import{LitElement as zi,html as Pi,css as _i}from"./lit-all.min.js";var ve=class extends zi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${x}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Ne,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Ne,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Pi` <input
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(ve,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),d(ve,"styles",_i`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",ve);import{html as nt,nothing as Mi}from"./lit-all.min.js";var be,He=class He{constructor(t){d(this,"card");g(this,be);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,be,c(this,be)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,be)}insertVariantStyle(){let t=this.constructor.name;if(!He.styleMap[t]){He.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),nt`
        ...
        `}get cardImage(){return nt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:Mi}get secureLabelFooter(){return nt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async adjustTitleWidth(){let t=new IntersectionObserver(([e])=>{if(e.boundingClientRect.width===0)return;let r=this.card.getBoundingClientRect().width,n=this.card.querySelector('[slot="badge"]')?.getBoundingClientRect().width||0;r===0||n===0||(this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(r-n-16)}px`),t.disconnect())});t.observe(this.card)}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return ot(this.card.variant)}};be=new WeakMap,d(He,"styleMap",{});var v=He;import{html as Ct,css as Ri}from"./lit-all.min.js";var xr=`
:root {
...
`;var st=class extends v{constructor(t){super(t)}getGlobalCSS(){return br}renderLayout(){return qe`${this.cardImage}
            <div class="body">
...
`;var ct=class extends v{constructor(t){super(t)}getGlobalCSS(){return yr}renderLayout(){return wr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":wr`<hr />`} ${this.secureLabelFooter}`}};import{html as we,css as Oi,unsafeCSS as kr}from"./lit-all.min.js";var Er=`
  :root {
...
`;var Di=32,Ee=class extends v{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?we`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),f.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};d(Ee,"variantStyle",Oi`
    ...
    `);import{html as Ue,css as Ni,nothing as lt}from"./lit-all.min.js";var Sr=`
:root {
...
`;var ke=class extends v{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Pr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Tt` ${this.badge}
    ...
    `);import{html as Lt,css as Ii}from"./lit-all.min.js";var _r=`
:root {
...
`;var Mr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-red-700-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},te=class extends v{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===ue&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return _r}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${x}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}connectedCallbackHook(){this.adjustTitleWidth()}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Lt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Or={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Se=class extends v{constructor(t){super(t)}getGlobalCSS(){return Rr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return zt`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?zt`
                  ...
                  `:zt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(Se,"variantStyle",Bi`
...
`;var Ir={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Te=class extends v{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Fr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${x}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Gi`
            ${this.badge}
            <div class="body">
    ...
    `);var ht=new Map,Br=new WeakMap,Hr=new Map,A=(i,t,e=null,r=null,a)=>{ht.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};A("catalog",ye,vr,ye.variantStyle);A("image",st);A("inline-heading",ct);A("mini-compare-chart",Ee,null,Ee.variantStyle);A("plans",z,dt,z.variantStyle,z.collectionOptions);A("plans-students",z,Cr,z.variantStyle,z.collectionOptions);A("plans-education",z,Ar,z.variantStyle,z.collectionOptions);A("plans-v2",Y,zr,Y.variantStyle,Y.collectionOptions);A("product",ke,null,ke.variantStyle);A("segment",te,Mr,te.variantStyle,te.collectionOptions);A("special-offers",Se,Or,Se.variantStyle);A("simplified-pricing-express",Ae,Pt,Ae.variantStyle);A("full-pricing-express",Ce,_t,Ce.variantStyle);A("mini",Te,Ir,Te.variantStyle);var Vi=(i,t,e)=>{try{let r=Hr.get(i.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),Hr.set(i.variant,r)),e?.styleSheet&&e.styleSheet!==r){let a=i.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);a!==-1&&i.shadowRoot.adoptedStyleSheets.splice(a,1)}return i.shadowRoot.adoptedStyleSheets.includes(r)||i.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",i.variant);let n=e?.styleElement||i.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),i.shadowRoot.appendChild(a),{styleElement:a}}},Mt=i=>{let t=ht.get(i.variant);if(!t)return;let{class:e,style:r}=t,a=Br.get(i);if(a?.appliedVariant===i.variant)return new e(i);let n=r?Vi(i,r,a):{};return Br.set(i,{appliedVariant:i.variant,...n}),new e(i)};function ot(i){return ht.get(i)?.fragmentMapping}function qr(i){return ht.get(i)?.collectionOptions}var Ur=document.createElement("style");Ur.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var ie={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Gr=1e3;function Ki(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Vr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!ie.serializableTypes.includes(e))return e}return i}function Qi(i,t){if(!ie.ignoredProperties.includes(i))return Vr(t)}var Ot={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(p=>{p!=null&&(Ki(p)?r:a).push(p)}),r.length&&(n+=" "+r.map(Vr).join(" "));let{pathname:o,search:s}=window.location,l=`${ie.delimiter}page=${o}${s}`;l.length>Gr&&(l=`${l.slice(0,Gr)}<trunc>`),n+=l,a.length&&(n+=`${ie.delimiter}facts=`,n+=JSON.stringify(a,Qi)),window.lana?.log(n,ie)}};function Wr(i){Object.assign(ie,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in ie&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Yr={LOCAL:"local",PROD:"prod",STAGE:"stage"},Dt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Nt=new Set,$t=new Set,Kr=new Map,Qr={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},Xr={filter:({level:i})=>i!==Dt.DEBUG},Xi={filter:()=>!1};function Zi(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&gt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function Ji(i){[...$t].every(t=>t(i))&&Nt.forEach(t=>t(i))}function Zr(i){let t=(Kr.get(i)??0)+1;Kr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>Zr(`${r.namespace}/${a}`),updateConfig:Wr};return Object.values(Dt).forEach(a=>{r[a]=(n,...o)=>Ji(Zi(a,n,i,o,e))}),Object.seal(r)}function ut(...i){i.forEach(t=>{let{append:e,filter:r}=t;gt(r)&&$t.add(r),gt(e)&&Nt.add(e)})}function ea(i={}){let{name:t}=i,e=jr(mt("commerce.debug",{search:!0,storage:!0}),t===Yr.LOCAL);return ut(e?Qr:Xr),t===Yr.PROD&&ut(Ot),je}function ta(){Nt.clear(),$t.clear()}var je={...Zr(gr),Level:Dt,Plugins:{consoleAppender:Qr,debugFilter:Xr,quietFilter:Xi,lanaAppender:Ot},init:ea,reset:ta,use:ut};var ra="mas-commerce-service",js=je.module("utilities"),ia={requestId:tt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ft=i=>window.setTimeout(i);function Ft(){return document.getElementsByTagName(ra)?.[0]}function Jr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(ia)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function ei(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var ti="fragment",ri="author",ii="preview",ai="loading",ni="timeout",It="aem-fragment",oi="eager",si="cache",aa=[oi,si],I,ae,D,Bt=class{constructor(){g(this,I,new Map);g(this,ae,new Map);g(this,D,new Map)}clear(){c(this,I).clear(),c(this,ae).clear(),c(this,D).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,D).has(t.id)){let[,r]=c(this,D).get(t.id);r()}if(c(this,D).has(t.fields?.originalId)){let[,r]=c(this,D).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,D).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,D).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ae).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ae).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,ae).delete(t),c(this,D).delete(t)}};I=new WeakMap,ae=new WeakMap,D=new WeakMap;var K=new Bt,Le,N,U,R,P,k,Ge,Ve,$,We,Ye,ze,F,ci,li,Ht,di,xt=class extends HTMLElement{constructor(){super(...arguments);g(this,F);d(this,"cache",K);g(this,Le);g(this,N,null);g(this,U,null);g(this,R,null);g(this,P);g(this,k);g(this,Ge,oi);g(this,Ve,5e3);g(this,$);g(this,We,!1);g(this,Ye,0);g(this,ze)}static get observedAttributes(){return[ti,ai,ni,ri,ii]}attributeChangedCallback(e,r,a){e===ti&&(m(this,P,a),m(this,k,K.getFetchInfo(a))),e===ai&&aa.includes(a)&&m(this,Ge,a),e===ni&&m(this,Ve,parseInt(a,10)),e===ri&&m(this,We,["","true"].includes(a)),e===ii&&m(this,ze,a)}connectedCallback(){if(!c(this,$)){if(c(this,R)??m(this,R,J(this)),m(this,ze,c(this,R).settings?.preview),c(this,Le)??m(this,Le,c(this,R).log.module(`${It}[${c(this,P)}]`)),!c(this,P)||c(this,P)==="#"){c(this,k)??m(this,k,K.getFetchInfo("missing-fragment-id")),S(this,F,Ht).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,$)&&!await Promise.race([c(this,$),Promise.resolve(!1)]))return;e&&K.remove(c(this,P)),c(this,Ge)===si&&await Promise.race([K.getAsPromise(c(this,P)),new Promise(s=>setTimeout(s,c(this,Ve)))]);try{m(this,$,S(this,F,di).call(this)),await c(this,$)}catch(s){return S(this,F,Ht).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,N)||{};return o&&!mt("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(me,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,$)}get updateComplete(){return c(this,$)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,We)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,N)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,N);m(this,U,e.reduce((p,{name:h,multiple:b,values:_})=>(p.fields[h]=b?_:_[0],p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,N);m(this,U,Object.entries(e).reduce((p,[h,b])=>(p.fields[h]=b?.mimeType?b.value:b??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,P),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};Le=new WeakMap,N=new WeakMap,U=new WeakMap,R=new WeakMap,P=new WeakMap,k=new WeakMap,Ge=new WeakMap,Ve=new WeakMap,$=new WeakMap,We=new WeakMap,Ye=new WeakMap,ze=new WeakMap,F=new WeakSet,ci=async function(e){Xt(this,Ye)._++;let r=`${It}:${c(this,P)}:${c(this,Ye)}`,a=`${r}${rt}`,n=`${r}${it}`;if(c(this,ze))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await ei(e,{cache:"default",credentials:"omit"}),S(this,F,li).call(this,o),c(this,k).status=o?.status,c(this,k).measure=fe(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new re("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,k).measure=fe(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,N))return c(this,k).stale=!0,c(this,Le).error("Serving stale data",c(this,k)),c(this,N);let l=s.message??"unknown";throw new re(`Failed to fetch fragment: ${l}`,{})}},li=function(e){Object.assign(c(this,k),Jr(e))},Ht=function(e){m(this,$,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,R).duration};c(this,Le).error(e,r),this.dispatchEvent(new CustomEvent(ge,{detail:r,bubbles:!0,composed:!0}))},di=async function(){var l;this.classList.remove("error"),m(this,U,null);let e=K.get(c(this,P));if(e)return m(this,N,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,R).settings,s=`${r}/fragment?id=${c(this,P)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await S(this,F,ci).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,P)),K.add(e),m(this,N,e),!0},d(xt,"cache",K);customElements.define(It,xt);import{LitElement as na,html as qt,css as oa,nothing as sa}from"./lit-all.min.js";import{unsafeHTML as ca}from"./lit-all.min.js";var la=i=>i?i.startsWith("sp-icon-")?qt`${ca(`<${i} class="badge-icon"></${i}>`)}`:qt`<img src="${i}" class="badge-icon" />`:sa,Pe=class extends na{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return qt`<div class="badge">
    ...
    `),d(Ke,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ke);import{html as Ut,css as ma,LitElement as ga,nothing as pi}from"./lit-all.min.js";var Qe=class extends ga{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Ut`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Ut`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:pi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(Qe,"styles",ma`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

...
describe('MasFragmentVariations', () => {
    ...
    describe('promotion variations tab', () => {
        ...
        it('shows "Inherits tags from project" when a promo variation has no pznTags of its own', async () => {
            ...
            const picker = el.querySelector('aem-tag-picker-field');
            expect(picker.getAttribute('value')).to.equal('');
            expect(picker.noTagsText).to.equal('Inherits tags from project');
        });

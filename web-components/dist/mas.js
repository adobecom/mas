...
`;document.head.appendChild(vc);var bc="fragment",yc="author",Ec="preview",wc="loading",Ac="timeout",ya="aem-fragment",Sc="eager",_c="cache",xh=[Sc,_c],Le,bt,Se,Ea=class{constructor(){E(this,Le,new Map);E(this,bt,new Map);E(this,Se,new Map)}clear(){h(this,Le).clear(),h(this,bt).clear(),h(this,Se).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,Le).set(t.id,t),t.fields?.originalId&&h(this,Le).set(t.fields.originalId,t),h(this,Se).has(t.id)){let[,i]=h(this,Se).get(t.id);i()}if(h(this,Se).has(t.fields?.originalId)){let[,i]=h(this,Se).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:n,value:a}=t.references[i];n==="content-fragment"&&(a.settings={...t?.settings,...a.settings},a.placeholders={...t?.placeholders,...a.placeholders},a.dictionary={...t?.dictionary,...a.dictionary},a.priceLiterals={...t?.priceLiterals,...a.priceLiterals},this.add(a,t))}}}has(t){return h(this,Le).has(t)}entries(){return h(this,Le).entries()}get(t){return h(this,Le).get(t)}getAsPromise(t){let[r]=h(this,Se).get(t)??[];if(r)return r;let i;return r=new Promise(n=>{i=n,this.has(t)&&n()}),h(this,Se).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,bt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,bt).set(t,r)),r}remove(t){h(this,Le).delete(t),h(this,bt).delete(t),h(this,Se).delete(t)}};Le=new WeakMap,bt=new WeakMap,Se=new WeakMap;var Xe=new Ea,Xt,Re,He,ve,pe,J,Ur,Fr,_e,Gr,qr,Kt,Te,Tc,Cc,wa,kc,$i=class extends HTMLElement{constructor(){super(...arguments);E(this,Te);m(this,"cache",Xe);E(this,Xt);E(this,Re,null);E(this,He,null);E(this,ve,null);E(this,pe);E(this,J);E(this,Ur,Sc);E(this,Fr,5e3);E(this,_e);E(this,Gr,!1);E(this,qr,0);E(this,Kt)}static get observedAttributes(){return[bc,wc,Ac,yc,Ec]}attributeChangedCallback(r,i,n){r===bc&&(y(this,pe,n),y(this,J,Xe.getFetchInfo(n))),r===wc&&xh.includes(n)&&y(this,Ur,n),r===Ac&&y(this,Fr,parseInt(n,10)),r===yc&&y(this,Gr,["","true"].includes(n)),r===Ec&&y(this,Kt,n)}connectedCallback(){if(!h(this,_e)){if(h(this,ve)??y(this,ve,dt(this)),y(this,Kt,h(this,ve).settings?.preview),h(this,Xt)??y(this,Xt,h(this,ve).log.module(`${ya}[${h(this,pe)}]`)),!h(this,pe)||h(this,pe)==="#"){h(this,J)??y(this,J,Xe.getFetchInfo("missing-fragment-id")),te(this,Te,wa).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,_e)&&!await Promise.race([h(this,_e),Promise.resolve(!1)]))return;r&&Xe.remove(h(this,pe)),h(this,Ur)===_c&&await Promise.race([Xe.getAsPromise(h(this,pe)),new Promise(s=>setTimeout(s,h(this,Fr)))]);try{y(this,_e,te(this,Te,kc).call(this)),await h(this,_e)}catch(s){return te(this,Te,wa).call(this,s.message),!1}let{references:i,referencesTree:n,placeholders:a,wcs:o}=h(this,Re)||{};return o&&!B("mas.disableWcsCache")&&h(this,ve).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(tt,{detail:{...this.data,references:i,referencesTree:n,placeholders:a,...h(this,J)},bubbles:!0,composed:!0})),h(this,_e)}get updateComplete(){return h(this,_e)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,He)?h(this,He):(h(this,Gr)?this.transformAuthorData():this.transformPublishData(),h(this,He))}transformAuthorData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,Re);y(this,He,r.reduce((l,{name:d,multiple:p,values:u})=>(l.fields[d]=p?u:u[0],l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,Re);y(this,He,Object.entries(r).reduce((l,[d,p])=>(l.fields[d]=p?.mimeType?p.value:p??"",l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=i.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,o=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${o}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,pe),{locale:h(this,ve).settings.locale,apiKey:h(this,ve).settings.wcsApiKey})}};Xt=new WeakMap,Re=new WeakMap,He=new WeakMap,ve=new WeakMap,pe=new WeakMap,J=new WeakMap,Ur=new WeakMap,Fr=new WeakMap,_e=new WeakMap,Gr=new WeakMap,qr=new WeakMap,Kt=new WeakMap,Te=new WeakSet,Tc=async function(r){Ha(this,qr)._++;let i=`${ya}:${h(this,pe)}:${h(this,qr)}`,n=`${i}${nt}`,a=`${i}${at}`;if(h(this,Kt))return await this.generatePreview();performance.mark(n);let o;try{if(h(this,J).stale=!1,h(this,J).url=r,o=await Ai(r,{cache:"default",credentials:"omit"}),te(this,Te,Cc).call(this,o),h(this,J).status=o?.status,h(this,J).measure=Pe(performance.measure(a,n)),h(this,J).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...h(this,ve).duration});return await o.json()}catch(s){if(h(this,J).measure=Pe(performance.measure(a,n)),h(this,J).retryCount=s.retryCount,h(this,Re))return h(this,J).stale=!0,h(this,Xt).error("Serving stale data",h(this,J)),h(this,Re);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},Cc=function(r){Object.assign(h(this,J),si(r))},wa=function(r){y(this,_e,null),h(this,J).message=r,this.classList.add("error");let i={...h(this,J),...h(this,ve).duration};h(this,Xt).error(r,i),this.dispatchEvent(new CustomEvent(rt,{detail:i,bubbles:!0,composed:!0}))},kc=async function(){var c;this.classList.remove("error"),y(this,He,null);let r=Xe.get(h(this,pe));if(r)return y(this,Re,r),!0;let{masIOUrl:i,wcsApiKey:n,country:a,locale:o}=h(this,ve).settings,s=`${i}/fragment?id=${h(this,pe)}&api_key=${n}&locale=${o}`;return a&&!o.endsWith(`_${a}`)&&(s+=`&country=${a}`),r=await te(this,Te,Tc).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,pe)),Xe.add(r),y(this,Re,r),!0},m($i,"cache",Xe);customElements.define(ya,$i);R();var Qt=class extends ${constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">${this.text}</div>`}};m(Qt,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),m(Qt,"styles",b`
        :host {
            display: block;
...
`;var Ma={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},sr=class extends T{getGlobalCSS(){return jc}get aemFragmentMapping(){return Ma}renderLayout(){return f`
    ...
    `);V("ccd-suggested",ir,Uc,ir.variantStyle);V("ccd-slice",nr,Gc,nr.variantStyle);V("ah-try-buy-widget",ar,La,ar.variantStyle);V("ah-promoted-plans",or,Ra,or.variantStyle);V("fries",sr,Ma,sr.variantStyle);

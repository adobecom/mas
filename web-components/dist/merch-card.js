var Ir=Object.defineProperty;var Hr=a=>{throw TypeError(a)};var qi=(a,r,e)=>r in a?Ir(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Ui=(a,r,e)=>()=>{if(e)throw e[0];try{return a&&(r=a(a=0)),r}catch(t){throw e=[t],t}};var ji=(a,r)=>{for(var e in r)Ir(a,e,{get:r[e],enumerable:!0})};var d=(a,r,e)=>qi(a,typeof r!="symbol"?r+"":r,e),tr=(a,r,e)=>r.has(a)||Hr("Cannot "+e);var p=(a,r,e)=>(tr(a,r,"read from private field"),e?e.call(a):r.get(a)),v=(a,r,e)=>r.has(a)?Hr("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),g=(a,r,e,t)=>(tr(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),C=(a,r,e)=>(tr(a,r,"access private method"),e);var cr={};ji(cr,{default:()=>it});import{LitElement as Ki,html as ke,css as Qi,nothing as Zi}from"./lit-all.min.js";import{unsafeHTML as da}from"./lit-all.min.js";import{ifDefined as Xi}from"./lit-all.min.js";function Ji(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var N,it,sr=Ui(()=>{N=class N extends Ki{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();N.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,s=this.shadowRoot?.querySelector(".css-tooltip-body"),l=s?s.offsetWidth:o,h=s?s.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-h-n<0?u="bottom":u==="bottom"&&e.bottom+h+n>i?u="top":u==="left"&&e.left-l-n<0?u="right":u==="right"&&e.right+l+n>t&&(u="left");let y=e.left+e.width/2,k=e.top+e.height/2,L=6,Q=(Ii,Hi,Bi)=>Math.max(Ii,Math.min(Hi,Bi)),Z,ce,er;u==="top"||u==="bottom"?(Z=u==="top"?e.top-h-n:e.bottom+n,ce=Q(0,t-l,y-l/2),er=Q(L,l-L*2,y-ce-L)):(ce=u==="left"?e.left-l-n:e.right+n,Z=Q(0,i-h,k-h/2),er=Q(L,h-L*2,k-Z-L)),this._tooltipTop=Z,this._tooltipLeft=ce,this._arrowOffset=er,this._computedPlacement=u}showTooltip(){N.activeTooltip&&N.activeTooltip!==this&&(N.activeTooltip.closeOverlay(),N.activeTooltip.tooltipVisible=!1,N.activeTooltip.requestUpdate()),N.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){N.activeTooltip===this&&(N.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?ke`<merch-icon
    ...
    `);it=N;customElements.define("mas-mnemonic",it)});import{LitElement as pc}from"./lit-all.min.js";import{css as Ur,unsafeCSS as qr}from"./lit-all.min.js";var S="(max-width: 767px)",z="(max-width: 1199px)",E="(min-width: 768px)",b="(min-width: 1200px)",R="(min-width: 1600px)",et="(min-width: 1280px)",Br={matchMobile:window.matchMedia(S),matchDesktop:window.matchMedia(`${b} and (not ${R})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(R),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Br;function Lt(){return Br.isDesktop}var jr=Ur`
    :host {

...
`;function Ve(e){let r=td(e);return ed`
    ...
    `}import{html as Ni}from"./lit-all.min.js";var rd="(min-width: 1200px)",ad="(min-width: 600px)";function Po(e,r){if(!e)return"";let t=new DOMParser().parseFromString(`<picture>${e}</picture>`,"text/html");return r==="desktop"?t.querySelector(`source[media="${rd}"]`)?.getAttribute("srcset")??"":r==="tablet"?t.querySelector(`source[media="${ad}"]`)?.getAttribute("srcset")??"":r==="mobile"?t.querySelector("img")?.getAttribute("src")??"":""}var Mo=["desktop","tablet","mobile"];function id(e,r){let a=e.querySelector('[slot="backgrounds"]')?.innerHTML??"";Mo.forEach(i=>{let n=r.querySelector(`[data-backgrounds-breakpoint="${i}"]`);if(!n)return;n.replaceChildren();let o=Po(a,i);if(!o){n.textContent="\u2014";return}let s=document.createElement("img");s.loading="lazy",s.alt="",s.src=o,n.append(s)})}function Lt(e){return function(t){let a=e(),i=a.shadowRoot?.querySelector(".headless-backgrounds-detail");if(!i)return;let n=i.classList.contains("hidden");n&&id(a,i),i.classList.toggle("hidden",!n),t.target.textContent=n?"Show default only":"See all breakpoints"}}function Pt(e){return Ni`
        <button
            type="button"
    ...
    `}var Ro={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},image:{tag:"picture",slot:"image"},backgrounds:{tag:"picture",slot:"backgrounds"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},nd=[{slot:"bg-image",label:"Background Image"},{slot:"image",label:"Image"},{slot:"backgrounds",label:"Backgrounds"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Rt=class extends E{constructor(t){super(t);g(this,"toggleBackgroundsDetail",Lt(()=>this.card))}getGlobalCSS(){return qe}renderLayout(){let t=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return mr`
        ...
        `}};g(Rt,"variantStyle",Ve("headless"));import{css as od,html as sd}from"./lit-all.min.js";var No=`
...
`;var Oo={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Nt=class extends E{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return No}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${q}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return sd`
    ...
    `);import{html as cd,css as ld}from"./lit-all.min.js";var Io=`
...
`;var Oi={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},dd=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],na,Do,Ot=class extends E{constructor(t){super(t);S(this,na);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Io}get aemFragmentMapping(){return Oi}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,U(this,na,Do).call(this))}renderLayout(){return cd`
            <div class="card">
            ...
            <slot></slot>
        `}};na=new WeakSet,Do=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;dd.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(Ot,"variantStyle",ld`
    ...
    `);import{html as hd,css as pd}from"./lit-all.min.js";var zo=`
...
`;var Ii={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},It=class extends E{getGlobalCSS(){return zo}get aemFragmentMapping(){return Ii}renderLayout(){return hd`
    ...
    `);import{html as Di,nothing as zi}from"./lit-all.min.js";var Ho={cardName:{attribute:"name"},image:{tag:"picture",slot:"image"},backgrounds:{tag:"picture",slot:"backgrounds"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},md=[{slot:"image",label:"Image"},{slot:"backgrounds",label:"Backgrounds"},{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Dt=class extends E{constructor(t){super(t);g(this,"toggleBackgroundsDetail",Lt(()=>this.card))}getGlobalCSS(){return qe}renderLayout(){return Di`
            <div class="headless">
                ${md.map(({slot:t,label:a})=>Di`
                        <div class="headless-row">
        ...
        `}};g(Dt,"variantStyle",Ve("marquee"));import{html as Fo}from"./lit-all.min.js";var Bo={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},ud=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],zt=class extends E{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return Fo`
            <div class="headless">
                ${ud.map(({slot:r,label:t})=>Fo`
                        <div class="headless-row">
        ...
        `}};g(zt,"variantStyle",Ve("faq"));import{html as Uo,nothing as $o}from"./lit-all.min.js";var Go={cardName:{attribute:"name"},image:{tag:"picture",slot:"image"},backgrounds:{tag:"picture",slot:"backgrounds"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},gd=[{slot:"image",label:"Image"},{slot:"backgrounds",label:"Backgrounds"},{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],Ht=class extends E{constructor(t){super(t);g(this,"toggleBackgroundsDetail",Lt(()=>this.card))}getGlobalCSS(){return qe}renderLayout(){return Uo`
            <div class="headless">
                ${gd.map(({slot:t,label:a})=>Uo`
                        <div class="headless-row">
                            <span class="headless-label">${a}</span>
                            <span class="headless-value" data-slot="${t}">
                                <slot name="${t}"></slot>
...
`,ot.MISSING_INTL_API,o);var L=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[L]||d.options.other}if(!b)throw new tn(d.value,m,Object.keys(d.options),o);s.push.apply(s,Er(b.value,r,t,a,i,m-(d.offset||0)));continue}}return Th(s)}function _h(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=P(P({},e[a]),r[a]||{}),t},{})):e}function Lh(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=_h(e[a],r[a]),t},P({},e)):e}function rn(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function Ph(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:yr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,da([void 0],t,!1)))},{cache:rn(e.number),strategy:xa.variadic}),getDateTimeFormat:yr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,da([void 0],t,!1)))},{cache:rn(e.dateTime),strategy:xa.variadic}),getPluralRules:yr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,da([void 0],t,!1)))},{cache:rn(e.pluralRules),strategy:xa.variadic})}}var Ws=(function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==ie.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Er(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Lh(e.formats,a),this.formatters=i&&i.formatters||Ph(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=$s,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e})();var Ys=Ws;var Ar={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}",discountLabel:"{discount}%"},Mh=In("ConsonantTemplates/price"),Rh=/<\/?[^>]+(>|$)/g,j={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Le={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},an="TAX_EXCLUSIVE",Nh=e=>Nn(e)?Object.entries(e).filter(([,r])=>mt(r)||Br(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Rn(a)}"`}`,""):"",Y=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${j.disabled}`}"${Nh(t)}>${a?ls(r):r??""}</span>`;function Oh(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function Ih(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function ye(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?Oh(i):i,i=n?i.replace(Rh,""):i;let s=new Ys(i,r).format(a);return o?Ih(s):s}catch{return Mh.error("Failed to format literal:",i),""}}function Dh(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:u},m={}){let h=Y(j.currencySymbol,a),p=Y(j.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+p),f+=Y(j.integer,s),f+=Y(j.decimalsDelimiter,n),f+=Y(j.decimals,i),c||(f+=p+h),f+=Y(j.recurrence,l,null,!0),f+=Y(j.unitType,d,null,!0),f+=Y(j.taxInclusivity,u,!0),Y(e,f,{...m})}var ee=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:u,literals:m={},quantity:h=1,space:p=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:w,price:b,priceWithoutDiscount:L,taxDisplay:O,taxTerm:I,term:B,usePrecision:W,promotion:X}={},te={})=>{Object.entries({country:o,formatString:w,language:u,price:b}).forEach(([Rc,Nc])=>{if(Nc==null)throw new Error(`Argument "${Rc}" is missing for osi ${y?.toString()}, country ${o}, language ${u}`)});let H={...Ar,...m},D=`${u.toLowerCase()}-${o.toUpperCase()}`,re;X&&!f&&L?re=e||a?b:L:t&&L?re=L:re=b;let Z=r?hs:ps;i&&(Z=ms);let{accessiblePrice:ze,recurrenceTerm:ge,...lt}=Z({commitment:x,formatString:w,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:L,price:r?b:re,promotion:X,quantity:h,term:B,usePrecision:W}),He="",wa="",Ea="";T(c)&&ge&&(Ea=ye(H,D,Le.recurrenceLabel,{recurrenceTerm:ge}));let Lr="";T(l)&&(p&&(Lr+=" "),Lr+=ye(H,D,Le.perUnitLabel,{perUnit:"LICENSE"}));let Pr="";T(d)&&I&&(p&&(Pr+=" "),Pr+=ye(H,D,O===an?Le.taxExclusiveLabel:Le.taxInclusiveLabel,{taxTerm:I})),t&&(He=ye(H,D,Le.strikethroughAriaLabel,{strikethroughPrice:He})),e&&(wa=ye(H,D,Le.alternativePriceAriaLabel,{alternativePrice:wa}));let Ye=j.container;if(r&&(Ye+=` ${j.containerOptical}`),t&&(Ye+=` ${j.containerStrikethrough}`),a&&(Ye+=` ${j.containerPromoStrikethrough}`),e&&(Ye+=` ${j.containerAlternative}`),i&&(Ye+=` ${j.containerAnnual}`),T(s))return Dh(Ye,{...lt,accessibleLabel:He,altAccessibleLabel:wa,recurrenceLabel:Ea,perUnitLabel:Lr,taxInclusivityLabel:Pr},te);let{currencySymbol:pn,decimals:kc,decimalsDelimiter:_c,hasCurrencySpace:mn,integer:Lc,isCurrencyFirst:Pc}=lt,dt=[Lc,_c,kc];Pc?(dt.unshift(mn?"\xA0":""),dt.unshift(pn)):(dt.push(mn?"\xA0":""),dt.push(pn)),dt.push(Ea,Lr,Pr);let Mc=dt.join("");return Y(Ye,Mc,te)},Ks=()=>(e,r,t)=>{let a=it(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${ee({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},Xs=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=it(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return ee()(e,{...r,price:r.priceWithoutDiscount},t)+Y(j.containerAnnualPrefix," (")+ee({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+Y(j.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${ee({displayStrikethrough:!0})(n,r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${Y(j.containerAnnualPrefix," (")}${ee({displayAnnual:!0,instant:a})(n,r,t)}${Y(j.containerAnnualSuffix,")")}`},Qs=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${ee({isAlternativePrice:e.displayOldPrice})(e,r,t)}${Y(j.containerAnnualPrefix," (")}${ee({displayAnnual:!0})(a,r,t)}${Y(j.containerAnnualSuffix,")")}`};var Sr={...j,containerLegal:"price-legal",planType:"price-plan-type"},ba={...Le,planTypeLabel:"planTypeLabel"};function zh(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=Y(Sr.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=Y(Sr.taxInclusivity,t,!0),o+=Y(Sr.planType,a,null),Y(e,o,{...i})}var Zs=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,planTypeCase:n,language:o,literals:s={}}={},{taxDisplay:c,taxTerm:l,planType:d}={},u={})=>{let m={...Ar,...s},h=`${o.toLowerCase()}-${e.toUpperCase()}`,p="";T(r)&&(p=ye(m,h,ba.perUnitLabel,{perUnit:"LICENSE"}));let f="";e==="US"&&o==="en"&&(t=!1),T(t)&&l&&(f=ye(m,h,c===an?ba.taxExclusiveLabel:ba.taxInclusiveLabel,{taxTerm:l}));let x="";T(a)&&d&&(x=ye(m,h,ba.planTypeLabel,{planType:d})),x&&n&&(x=(n==="lower"?x[0].toLowerCase():x[0].toUpperCase())+x.slice(1));let y=Sr.container;return y+=` ${Sr.containerLegal}`,zh(y,{perUnitLabel:p,taxInclusivityLabel:f,planTypeLabel:x},u,i)};var Js=ee(),ec=Ks(),tc=ee({displayOptical:!0}),rc=ee({displayStrikethrough:!0}),ac=ee({displayPromoStrikethrough:!0}),ic=ee({displayAnnual:!0}),nc=ee({displayOptical:!0,isAlternativePrice:!0}),oc=ee({isAlternativePrice:!0}),sc=Qs(),cc=Xs(),lc=Zs;var Hh={...Le,discountLabel:"discountLabel"},Fh=(e,r)=>{if(!r&&ut(e))return 0;if(!(!ut(e)||!ut(r)))return Math.floor((r-e)/r*100)},dc=()=>(e,r)=>{let{country:t,language:a,literals:i={}}=e??{},{price:n,priceWithoutDiscount:o}=r,s=Fh(n,o);if(s===void 0)return'<span class="no-discount"></span>';let c={...Ar,...i},l=a&&t?`${a.toLowerCase()}-${t.toUpperCase()}`:"en-US";return`<span class="discount">${ye(c,l,Hh.discountLabel,{discount:s,remainingPercent:100-s})}</span>`};var hc=dc();var pc="INDIVIDUAL_COM",on="TEAM_COM",mc="INDIVIDUAL_EDU",sn="TEAM_EDU",Bh=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh","KE_en","GH_en","TZ_en","AM_en","AZ_en","GE_en","MD_en","KZ_en","KG_en","TJ_en","UZ_en","OM_en","BH_en"],Uh={[pc]:[],[on]:[],[mc]:[],[sn]:[]},$h={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Gh=[pc,on,mc,sn],qh=e=>[on,sn].includes(e);function nn(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Vh=(e,r,t,a)=>{let i=`${t}_${a}`,n=nn($h,e,r,!1);if(n){let o=Gh.indexOf(i);return n[o]}return qh(i)},jh=(e,r,t,a)=>{if(nn(Bh,e,r,!0))return!0;let i=Uh[`${t}_${a}`];return i?nn(i,e,r,!0)?!0:N.displayTax:N.displayTax},cn=async(e,r,t,a)=>{let i=jh(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Vh(e,r,t,a):N.forceTaxExclusive}},Cr=class Cr extends HTMLSpanElement{constructor(){super();g(this,"masElement",new je(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=V();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:h,alternativePrice:p,template:f,wcsOsi:x}=a.collectPriceOptions(t);return oa(Cr,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:h,alternativePrice:p,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===xe}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=V();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let p=rr(h,n);return p?.length?p[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,u=yi(l);if(a.featureFlags[Pe]||n[Pe]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=u.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:p}=n,[f=""]=u.marketSegments,x=await cn(h,p,u.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let w=rr(y,n);return w?.length?w[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[he]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,p]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:p.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=yi(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=V();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(Cr,"is","inline-price"),g(Cr,"tag","span");var Ie=Cr;window.customElements.get(Ie.is)||window.customElements.define(Ie.is,Ie,{extends:Ie.tag});function uc({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let X of r.price)X(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:u,displayTax:m,displayPlanType:h,forceTaxExclusive:p,perpetual:f,displayAnnual:x,promotionCode:y,quantity:w,alternativePrice:b,wcsOsi:L,...O}=Object.assign(c,s?.dataset??{},o??{}),{wcsOsi:I,promotionCodes:B}=Kr(L,y),W=B.map(X=>qr(X).effectivePromoCode);return c=Ur(Object.assign({...c,...O,displayOldPrice:T(l),displayPerUnit:T(d),displayRecurrence:T(u),displayTax:T(m),displayPlanType:T(h),forceTaxExclusive:T(p),perpetual:T(f),displayAnnual:T(x),promotionCode:W[0],promotionCodes:W,quantity:gt(w,N.quantity),alternativePrice:T(b),wcsOsi:I})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=hc;break;case"strikethrough":l=rc;break;case"promo-strikethrough":l=ac;break;case"annual":l=ic;break;case"legal":l=lc;break;default:s.template==="optical"&&s.alternativePrice?l=nc:s.template==="optical"?l=tc:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?cc:sc:s.alternativePrice?l=oc:l=s.promotionCode&&o[0].promotion?ec:Js}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Ie.createInlinePrice;return{InlinePrice:Ie,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Wh({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||N.language),r??(r=e?.split("_")?.[1]||N.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function gc(e={},r){let t=r.featureFlags[Pe],{commerce:a={}}=e,i=Ee.PRODUCTION,n=ja,o=F("checkoutClientId",a)??N.checkoutClientId,s=tr(F("checkoutWorkflowStep",a),ce,N.checkoutWorkflowStep),c=T(F("displayOldPrice",a),N.displayOldPrice),l=N.displayPerUnit,d=T(F("displayRecurrence",a),N.displayRecurrence),u=T(F("displayTax",a),N.displayTax),m=T(F("displayPlanType",a),N.displayPlanType),h=T(F("entitlement",a),N.entitlement),p=T(F("modal",a),N.modal),f=T(F("forceTaxExclusive",a),N.forceTaxExclusive),x=F("promotionCode",a)??N.promotionCode,y=gt(F("quantity",a)),w=F("wcsApiKey",a)??N.wcsApiKey,b=a?.env==="stage",L=Be.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(F(qa,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",L=tr(F(Va,a),Be,L)),b&&(i=Ee.STAGE,n=Wa);let I=F(Ga)??e.preview,B=typeof I<"u"&&I!=="off"&&I!=="false",W={};B&&(W={preview:B});let X=F("mas-io-url")??e.masIOUrl,te=An(X)?X:`https://www${i===Ee.STAGE?".stage":""}.adobe.com/mas/io`,H=F("preselect-plan")??void 0,D=F("instant")??e.instant;return{...Wh(e),...W,aupSelect:F("aup-select",{"aup-select":r.getAttribute("aup-select")},{search:!0,storage:!1})==="on",displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:u,displayPlanType:m,entitlement:h,extraOptions:N.extraOptions,modal:p,env:i,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:N.alternativePrice,wcsApiKey:w,wcsURL:n,landscape:L,masIOUrl:te,...H&&{preselectPlan:H},...D&&{instant:D}}}async function fc(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var ln="wcs";function vc({settings:e}){let r=ae.module(ln),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(p,f,x=!0){let y=V(),w=Ba;r.debug("Fetching:",p);let b="",L;if(p.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let O=new Map(f),[I]=p.offerSelectorIds,B=Date.now()+Math.random().toString(36).substring(2,7),W=`${ln}:${I}:${B}${Ka}`,X=`${ln}:${I}:${B}${Xa}`,te;try{if(performance.mark(W),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",I),b.searchParams.set("country",p.country),b.searchParams.set("locale",p.locale),b.searchParams.set("landscape",t===Ee.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),p.language&&b.searchParams.set("language",p.language),p.promotionCode&&b.searchParams.set("promotion_code",p.promotionCode),p.currency&&b.searchParams.set("currency",p.currency),L=await fc(b.toString(),{credentials:"omit"}),L.ok){let H=[];try{let D=await L.json();r.debug("Fetched:",p,D),H=D.resolvedOffers??[]}catch(D){r.error(`Error parsing JSON: ${D.message}`,{...D.context,...y?.duration})}H=H.map(Vr),f.forEach(({resolve:D},re)=>{let Z=H.filter(({offerSelectorIds:ze})=>ze.includes(re)).flat();Z.length&&(O.delete(re),f.delete(re),D(Z))})}else w=Fa}catch(H){w=`Network error: ${H.message}`}finally{te=performance.measure(X,W),performance.clearMarks(W),performance.clearMeasures(X)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let H=Yn(L);f.forEach(D=>{D.reject(new Ft(w,{...p,...H,response:L,measure:Ir(te),...y?.duration}))})}}function l(){clearTimeout(o);let p=[...n.values()];n.clear(),p.forEach(({options:f,promises:x})=>c(f,x))}function d(p){if(!p||typeof p!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===Ee.STAGE?"stage":"prod",x=p[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,w]of Object.entries(x))i.set(y,Promise.resolve(w.map(Vr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function u(){let p=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${p} cache entries to stale cache`)}function m(p,f,x){let y=p!=="GB"&&!x?"MULT":"en",w=Qa.includes(p)?p:N.country;return{validCountry:w,validLanguage:y,locale:`${f}_${w}`}}function h({country:p,language:f,perpetual:x=!1,promotionCode:y="",promotionCodes:w,wcsOsi:b=[]}){let{validCountry:L,validLanguage:O,locale:I}=m(p,f,x),B=Array.isArray(w)&&w.length?w:[y];return b.map((W,X)=>{let te=B.length===1?B[0]:B[X]??"",H=[L,O,te].filter(Z=>Z).join("-").toLowerCase(),D=`${W}-${H}`;if(i.has(D))return i.get(D);let re=new Promise((Z,ze)=>{let ge=n.get(H);ge||(ge={options:{country:L,locale:I,...O==="MULT"&&{language:O},offerSelectorIds:[]},promises:new Map},n.set(H,ge)),te&&(ge.options.promotionCode=te),ge.options.offerSelectorIds.push(W),ge.promises.set(W,{resolve:Z,reject:ze}),l()}).catch(Z=>{if(s.has(D))return s.get(D);throw Z});return i.set(D,re),re})}return{Commitment:Ke,PlanType:zn,Term:me,applyPlanType:Vr,resolveOfferSelectors:h,flushWcsCacheInternal:u,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var xc="mas-commerce-service",bc="mas-commerce-service:start",yc="mas-commerce-service:ready",Tr,Ut,st,wc,hn,dn=class extends HTMLElement{constructor(){super(...arguments);S(this,st);S(this,Tr);S(this,Ut);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,Ut)||A(this,Ut,{[Pe]:U(this,st,hn).call(this,Pe),[he]:U(this,st,hn).call(this,he)}),v(this,Ut)}activate(){let t=v(this,st,wc),a=gc(t,this);jr(t.lana);let i=ae.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:ws(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...xs(c),...bs(c),...uc(c),...vc(c),...Za,Log:ae,resolvePriceTaxFlags:cn,get defaults(){return N},get log(){return ae},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(Rr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(yc),A(this,Tr,performance.measure(yc,bc)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(bc),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(ka).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Ir(v(this,Tr))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Tr=new WeakMap,Ut=new WeakMap,st=new WeakSet,wc=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},hn=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||F(t))};window.customElements.get(xc)||window.customElements.define(xc,dn);var Cc="merch-card-collection",Yh=3e4,Kh={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Xh={plans:!0},Qh=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Zh=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,Jh=(e,r)=>{let t=r.tagGroups;if(!t?.length)return e;let a=Sa();return e.filter(i=>Ko((i.getAttribute("filter-tags")||"").split(",").filter(Boolean),t,a))},ep=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),tp=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),rp=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,We,Gt,ct,_r,ya,Tc,$t=class extends Ac{constructor(){super();S(this,ya);S(this,We,{});S(this,Gt);S(this,ct);S(this,_r);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=wn(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return De` <slot></slot>
    ...
    `);$t.SortOrder=be;customElements.define(Cc,$t);var ap={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},ip=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(i=>{i.innerText=t||""})},np={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},op={catalog:"l"},de,qt,kr=class extends Ac{constructor(){super();S(this,de);S(this,qt);g(this,"tablet",new jt(this,R));g(this,"desktop",new jt(this,_));this.collection=null,A(this,de,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(fe,this.updateLiterals),this.collection?.addEventListener(Yt,this.handleSidenavAttached),A(this,qt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(fe,this.updateLiterals),this.collection?.removeEventListener(Yt,this.handleSidenavAttached)}willUpdate(){v(this,de).search=this.getVisibility("search"),v(this,de).filter=this.getVisibility("filter"),v(this,de).sort=this.getVisibility("sort"),v(this,de).result=this.getVisibility("result"),v(this,de).custom=this.getVisibility("custom")}parseVisibilityOptions(t,a){if(!t||!Object.hasOwn(t,a))return null;let i=t[a];return i===!1?!1:i===!0?!0:i.includes(this.currentMedia)}getVisibility(t){let a=v(this,qt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,i=this.parseVisibilityOptions(a,t);return i!==null?i:this.parseVisibilityOptions(np,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,de).search)return we;let t=Xt(this,"searchText");return t?De`
        ...
        >
            ...
            ${a}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(a=>{ip(this,a,t.detail[a])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return De`
            <sp-theme color="light" scale="medium">
                <div id="header">

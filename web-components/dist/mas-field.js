...
`;if(!document.querySelector("style[data-mas-field]")){let e=document.createElement("style");e.setAttribute("data-mas-field",""),e.textContent=Nt,document.head.append(e)}var g,C,T,S,L,s,w,F,it,st,G,k,B,at,P,ct,lt,$,V=class extends HTMLElement{constructor(){super(...arguments);_(this,s);_(this,g,null);_(this,C,!1);_(this,T,null);D(this,"settings",null);_(this,S,null);D(this,"compatVersion");_(this,L,t=>{t.target===this.aemFragment&&(R(this,T,t.detail?.fields||null),this.settings=t.detail?.settings??null,R(this,C,!0),l(this,s,k).call(this),this.dispatchEvent(new CustomEvent(z,{bubbles:!0,composed:!0,detail:t.detail})))})}static get observedAttributes(){return["field"]}attributeChangedCallback(t,i,n){t==="field"&&(R(this,g,n),l(this,s,k).call(this))}connectedCallback(){this.addEventListener(M,p(this,L)),l(this,s,w).call(this),this.aemFragment?.setAttribute("hidden",""),bt(tt())}disconnectedCallback(){this.removeEventListener(M,p(this,L))}checkReady(){return p(this,C)?Promise.resolve(!0):new Promise(t=>{this.addEventListener(M,()=>t(!0),{once:!0})})}get aemFragment(){return this.querySelector("aem-fragment")}get osi(){return ot(this)}};g=new WeakMap,C=new WeakMap,T=new WeakMap,S=new WeakMap,L=new WeakMap,s=new WeakSet,w=function(){if(p(this,S)?.isConnected)return p(this,S);let t=this.querySelector(':scope > span[data-role="mas-field-content"]');if(t)return R(this,S,t),t;let i=document.createElement("span");return i.setAttribute("data-role","mas-field-content"),this.append(i),R(this,S,i),i},F=function(t){return t&&typeof t=="object"&&"value"in t?t.value:t},it=function(t){let i=t?.match(/^(.+)\[(\d+)\]$/);if(i)return{fieldName:i[1],index:parseInt(i[2],10)};let n=t?.match(/^(.+)\[(.+)\]$/);return n?{fieldName:n[1],index:n[2]}:{fieldName:t,index:null}},st=function(t,i){if(typeof t!="string")return null;let n=document.createElement("template");n.innerHTML=t;let r;if(!isNaN(i)){let c=parseInt(i,10);r=[...n.content.querySelectorAll("a")][c-1]}return r||(r=n.content.querySelector(`a[data-key="${i}"]`)),r?(r.removeAttribute("class"),r.outerHTML):null},G=function(){if(!this.aemFragment)return;this.setAttribute("fragment-id",this.aemFragment.data?.id);let t=this.aemFragment.data;t&&(t.variationId&&this.setAttribute("variation-id",t.variationId),t.maskId&&this.setAttribute("mask-id",t.maskId),t.promoProject&&this.setAttribute("data-promotion-project",t.promoProject),t.promoVariationProject&&this.setAttribute("data-promotion-variation-project",t.promoVariationProject),this.compatVersion=t.fields?.compatVersion,t.fields?.promoCode&&this.setAttribute("data-promotion-code",t.fields.promoCode))},k=function(){if(!p(this,T)||!p(this,g))return;this.hidden=!1;let{fieldName:t,index:i}=l(this,s,it).call(this,p(this,g));if(i!==null&&isNaN(i)){let a=`${t.replace(/s$/,"")}Labels`,d=p(this,T)[a];if(d!==void 0){let m=(Array.isArray(d)?d:[d]).indexOf(i);if(m===-1){this.hidden=!0;return}let h=p(this,T)[t],u=Array.isArray(h)?h:h?[h]:[],f=l(this,s,F).call(this,u[m]);if(!f){this.hidden=!0;return}if(t==="ctas"&&this.settings?.hideTrialCTAs&&(f=nt(f,!0),f===null)){this.hidden=!0;return}l(this,s,G).call(this);let b=l(this,s,w).call(this);b.innerHTML=l(this,s,$).call(this,f)??"",l(this,s,B).call(this,b),l(this,s,P).call(this,b);return}}let n=l(this,s,F).call(this,p(this,T)[t]);if(n===void 0){this.hidden=!0;return}l(this,s,G).call(this);let r=l(this,s,w).call(this),c;if(i!==null){if(c=l(this,s,st).call(this,n,i),c===null){this.hidden=!0;return}}else c=l(this,s,$).call(this,n);if(typeof c=="string"){if(t==="ctas"&&this.settings?.hideTrialCTAs&&(c=nt(c,i!==null),c===null)){this.hidden=!0;return}if(p(this,g)==="ctas"){let a=l(this,s,lt).call(this,c);if(a){r.replaceChildren(a),l(this,s,P).call(this,r);return}}r.innerHTML=c,l(this,s,B).call(this,r),l(this,s,P).call(this,r);return}if(c==null){this.hidden=!0;return}r.textContent=String(c)},B=function(t){let i=t.querySelectorAll(".icon-button[data-tooltip]");for(let n of i){if(n.dataset.tooltipWired)continue;n.dataset.tooltipWired="1",n.querySelector("svg")||n.insertAdjacentHTML("afterbegin",'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" height="18" width="18" class="icon-milo icon-milo-info" aria-hidden="true"><path fill="currentcolor" d="M10.075,6A1.075,1.075,0,1,1,9,4.925H9A1.075,1.075,0,0,1,10.075,6Zm.09173,6H10V8.2A.20005.20005,0,0,0,9.8,8H7.83324S7.25,8.01612,7.25,8.5c0,.48365.58325.5.58325.5H8v3H7.83325s-.58325.01612-.58325.5c0,.48365.58325.5.58325.5h2.3335s.58325-.01635.58325-.5C10.75,12.01612,10.16673,12,10.16673,12ZM9,.5A8.5,8.5,0,1,0,17.5,9,8.5,8.5,0,0,0,9,.5ZM9,15.6748A6.67481,6.67481,0,1,1,15.67484,9,6.67481,6.67481,0,0,1,9,15.6748Z"></path></svg>'),n.hasAttribute("tabindex")||n.setAttribute("tabindex","0"),n.hasAttribute("role")||n.setAttribute("role","button"),n.hasAttribute("aria-label")||n.setAttribute("aria-label",n.dataset.tooltip);let r=["top","bottom","left","right"],c=[...n.classList].find(m=>r.includes(m)),a=c||"top";c||n.classList.add(a),n.dataset.originalPosition=a,n.classList.add("hide-tooltip");let d=()=>{n.classList.remove("hide-tooltip"),l(this,s,at).call(this,n)},E=()=>n.classList.add("hide-tooltip");n.addEventListener("mouseenter",d),n.addEventListener("focus",d),n.addEventListener("mouseleave",E),n.addEventListener("blur",E),n.addEventListener("keydown",m=>{m.key==="Escape"&&E()})}},at=function(t){let i=["top","bottom","right","left"],n=window.innerWidth,r=12,c=document.querySelector("header")?.getBoundingClientRect().height||0,a=window.getComputedStyle(t,"::before"),d=H=>parseFloat(H)||0,E=d(a.width)+d(a.paddingLeft)+d(a.paddingRight),m=d(a.height)+d(a.paddingTop)+d(a.paddingBottom),h=t.getBoundingClientRect(),u=t.dataset.originalPosition||"top",f=i.find(H=>t.classList.contains(H)),q=u==="top"||u==="bottom"?E/2:E,dt=u==="top"?m+(u==="top"?r:0):m/2,N=h.top-dt<c,y=h.bottom+(u==="bottom"?m+r:0)>window.innerHeight,x=h.right+q+r>n,O=h.left-q-r<0,v=h.left+E/2+r>n,I=h.left-E/2-r<0;if(u!==f&&!(x||O||N||y||v||I)){t.classList.remove(...i),t.classList.add(u);return}let A=u;x&&v?A="left":O&&I?A="right":x&&N||O&&N?A=v&&"left"||I&&"right"||"bottom":x!==O&&!y?A=x?"left":"right":N&&["top","left","right"].includes(u)?A="bottom":y&&["bottom","left","right"].includes(u)&&(A="top"),f!==A&&(t.classList.remove(...i),t.classList.add(A))},P=function(t){let i=t.querySelectorAll('a[data-wcs-osi],button[is="checkout-button"],span[is="inline-price"]');if(!i.length)return;let n=(r,c)=>{if(c!=null)for(let a of i)a.hasAttribute(r)||a.setAttribute(r,c)};for(let r of Ct)n(r,this.getAttribute(r));n("data-promotion-code",K(this))},ct=function(t){if(!!!t.getAttribute("data-wcs-osi"))return t.cloneNode(!0);let r=customElements.get("checkout-link")?.createCheckoutLink(t.dataset,t.textContent)??(()=>{let a=document.createElement("a",{is:"checkout-link"});return a.innerHTML=`<span style="pointer-events: none;">${t.textContent}</span>`,a})();for(let{name:a,value:d}of t.attributes)["class","is","href"].includes(a)||r.setAttribute(a,d);if(r.firstElementChild?.classList.add("spectrum-Button-label"),t.className){let a=xt.exec(t.className)?.[0]??"accent",d=a.startsWith("accent");return a.includes("-link")||(r.classList.add("button","con-button"),d?r.classList.add("blue"):a.startsWith("primary")&&!a.includes("-outline")&&r.classList.add("fill")),r}let c=t.parentElement?.tagName;if(c==="STRONG"||c==="EM"){let a=document.createElement(c.toLowerCase());return a.append(r),a}return r},lt=function(t){let n=[...new DOMParser().parseFromString(t,"text/html").body.querySelectorAll("a")];if(!n.length)return null;let r=document.createElement("div");return r.setAttribute("slot","footer"),r.append(...n.map(c=>l(this,s,ct).call(this,c))),r},$=function(t){if(typeof t!="string")return t;let i=t.trim();if(!(i.startsWith("<p>")&&i.endsWith("</p>")))return t;let r=i.slice(3,-4);return r.includes("<p>")?t:r};customElements.define(W,V);export{Lt as checkoutOptionsProvider,rt as priceOptionsProvider};

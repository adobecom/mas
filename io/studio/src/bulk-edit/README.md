...
3. Edit CSV locally                   → optional: delete rows you do not want in the subset
4. POST  /bulk-edit-find?jobId={id}   → optional: upload CSV to filter exports

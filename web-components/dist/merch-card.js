var pr=Object.defineProperty;var mr=a=>{throw TypeError(a)};var Za=(a,t,e)=>t in a?pr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var Ja=(a,t)=>()=>(a&&(t=a(a=0)),t);var ei=(a,t)=>{for(var e in t)pr(a,e,{get:t[e],enumerable:!0})};var h=(a,t,e)=>Za(a,typeof t!="symbol"?t+"":t,e),It=(a,t,e)=>t.has(a)||mr("Cannot "+e);var s=(a,t,e)=>(It(a,t,"read from private field"),e?e.call(a):t.get(a)),f=(a,t,e)=>t.has(a)?mr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),g=(a,t,e,r)=>(It(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),_=(a,t,e)=>(It(a,t,"access private method"),e);var gr=(a,t,e,r)=>({set _(i){g(a,t,i,e)},get _(){return s(a,t,r)}});var $t={};ei($t,{default:()=>Ve});import{LitElement as ti,html as ve,css as ri,nothing as ai}from"./lit-all.min.js";import{unsafeHTML as yr}from"./lit-all.min.js";import{ifDefined as ii}from"./lit-all.min.js";function ni(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var P,Ve,Bt=Ja(()=>{P=class P extends ti{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();P.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>i?u="top":u==="left"&&e.left-d-n<0?u="right":u==="right"&&e.right+d+n>r&&(u="left");let C=e.left+e.width/2,$=e.top+e.height/2,Q=6,ht=(Ya,Qa,Xa)=>Math.max(Ya,Math.min(Qa,Xa)),pt,mt,Ft;u==="top"||u==="bottom"?(pt=u==="top"?e.top-p-n:e.bottom+n,mt=ht(0,r-d,C-d/2),Ft=ht(Q,d-Q*2,C-mt-Q)):(mt=u==="left"?e.left-d-n:e.right+n,pt=ht(0,i-p,$-p/2),Ft=ht(Q,p-Q*2,$-pt-Q)),this._tooltipTop=pt,this._tooltipLeft=mt,this._arrowOffset=Ft,this._computedPlacement=u}showTooltip(){P.activeTooltip&&P.activeTooltip!==this&&(P.activeTooltip.closeOverlay(),P.activeTooltip.tooltipVisible=!1,P.activeTooltip.requestUpdate()),P.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){P.activeTooltip===this&&(P.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?ve`<merch-icon
    ...
    `);Ve=P;customElements.define("mas-mnemonic",Ve)});import{LitElement as Kn}from"./lit-all.min.js";import{css as vr,unsafeCSS as fr}from"./lit-all.min.js";var w="(max-width: 767px)",T="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",L="(min-width: 1600px)",ur={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${L})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=ur;function gt(){return ur.isDesktop}var xr=vr`
    :host {
...
`,br=()=>[vr`
    ...
    `);customElements.define("merch-icon",xe);var lo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ho=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var be=2e4;var y='span[is="inline-price"][data-wcs-osi]',W='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var li='a[is="upt-link"]',Er=`${y},${W},${li}`;var kr="merch-offer-select:ready",Sr="merch-card:action-menu-toggle";var N="merch-quantity-selector:change",Cr="merch-card-quantity:change",Ht="merch-modal:addon-and-quantity-update";var ye="merch-card-collection:literals-changed";var we="aem:load",Ee="aem:error",ut="mas:ready",Ar="mas:error",Tr="placeholder-failed",Lr="placeholder-pending",zr="placeholder-resolved";var _r="mas:failed",X="mas:resolved",Pr="mas/commerce";var Z="failed",oe="pending",J="resolved";var ft="X-Request-Id",po=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var mo=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var vt=":start",xt=":duration";var M="legal",Mr="mas-ff-defaults";var di="mas-commerce-service";function Rr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function z(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function ke(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function qt(){return window.matchMedia("(max-width: 1024px)").matches}function ce(){return document.getElementsByTagName(di)?.[0]}function We(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Ke,se,Ye,Qe,Se,bt=class extends HTMLElement{constructor(){super();f(this,Ke,"");f(this,se);f(this,Ye,[]);f(this,Qe,[]);f(this,Se);g(this,Se,Rr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,se)?this.parentElement.style.borderRadius=s(this,se):s(this,se)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Ye).map((r,i)=>{let n=s(this,Qe)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,Ke)}, ${e})`}connectedCallback(){s(this,Se).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&g(this,se,i?.trim()),e==="colors"&&i?g(this,Ye,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?g(this,Qe,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&g(this,Ke,i?.trim()??""),s(this,Se).call(this)}};Ke=new WeakMap,se=new WeakMap,Ye=new WeakMap,Qe=new WeakMap,Se=new WeakMap;customElements.define("merch-gradient",bt);import{LitElement as hi,html as pi,css as mi}from"./lit-all.min.js";var Ce=class extends hi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(X,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(X,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return pi` <input
                type="checkbox"
                id="addon-checkbox"
...
`;var Et=class extends b{constructor(t){super(t)}getGlobalCSS(){return Ir}renderLayout(){return $r` ${this.badge}
            ...
            ${this.card.customHr?"":$r`<hr />`} ${this.secureLabelFooter}`}};import{html as ee,css as vi,unsafeCSS as Hr}from"./lit-all.min.js";var Br=`
  :root {
...
`;var wi=32,jr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},ze=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>kt` <footer>
    ...
    `);import{html as Je,css as Ei,nothing as St}from"./lit-all.min.js";var Vr=`
:root {
...
`;var Ct={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Wr={...function(){let{whatsIncluded:a,size:t,...e}=Ct;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Kr={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=Ct;return i}()},et,R=class extends b{constructor(e){super(e);f(this,et);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Vr}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(c)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&l){if(d)l.remove();else{let m=p.querySelector(`[data-placeholder-for="${e}"]`);m?m.replaceWith(l):p.appendChild(l)}return}if(i&&d){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",e),m.classList.add("slot-placeholder"),!l){let u=d.cloneNode(!0);o.prepend(u)}d.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=We(p));let m=this.card.querySelector('[slot="subtitle"]');m&&(d+=We(m));let u=this.card.querySelector('[slot="heading-m"]');u&&(d+=8+We(u));for(let $ of r.childNodes){if($.classList.contains("spacer"))break;d+=We($)}let C=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(C)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Je`<div class="divider"></div>`:St}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?Je`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};et=new WeakMap,h(R,"variantStyle",Ei`
        :host([variant^='plans']) {
            min-height: 273px;
...
`;var Jr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},G,_e=class extends b{constructor(e){super(e);f(this,G);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Zr}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Gt` ${this.badge}
...
`;var ta={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Pe=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ea}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return jt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var pa={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Fe=class extends b{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return ha}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ni`
            ${this.badge}
            <div class="body">
...
`;var Qt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ie=class extends b{getGlobalCSS(){return ma}get aemFragmentMapping(){return Qt}renderLayout(){return Fi`
    ...
    `);var Tt=new Map,ga=new WeakMap,ua=new Map,k=(a,t,e=null,r=null,i)=>{Tt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",Te,Dr,Te.variantStyle);k("image",le);k("inline-heading",Et);k("mini-compare-chart",Le,qr,Le.variantStyle);k("mini-compare-chart-mweb",ze,jr,ze.variantStyle);k("plans",R,Ct,R.variantStyle,R.collectionOptions);k("plans-students",R,Kr,R.variantStyle,R.collectionOptions);k("plans-education",R,Wr,R.variantStyle,R.collectionOptions);k("plans-v2",te,Xr,te.variantStyle,te.collectionOptions);k("product",_e,Jr,_e.variantStyle);k("segment",Pe,ta,Pe.variantStyle);k("media",Me,aa,Me.variantStyle);k("headless",Ne,da,Ne.variantStyle);k("special-offers",Re,na,Re.variantStyle);k("simplified-pricing-express",Oe,Wt,Oe.variantStyle);k("full-pricing-express",De,Kt,De.variantStyle);k("mini",Fe,pa,Fe.variantStyle);k("image",le,Fr,le.variantStyle);k("fries",Ie,Qt,Ie.variantStyle);var $i=(a,t,e)=>{try{let r=ua.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ua.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Xt=a=>{let t=Tt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=ga.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?$i(a,r,i):{};return ga.set(a,{appliedVariant:a.variant,...n}),new e(a)};function wt(a){return Tt.get(a)?.fragmentMapping}function fa(a){return Tt.get(a)?.collectionOptions}var va=document.createElement("style");va.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var de={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ba=1e3;function qi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ya(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!de.serializableTypes.includes(e))return e}return a}function Ui(a,t){if(!de.ignoredProperties.includes(a))return ya(t)}var Jt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(qi(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(ya).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${de.delimiter}page=${o}${c}`;l.length>ba&&(l=`${l.slice(0,ba)}<trunc>`),n+=l,i.length&&(n+=`${de.delimiter}facts=`,n+=JSON.stringify(i,Ui)),window.lana?.log(n,de)}};function wa(a){Object.assign(de,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in de&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Ea={LOCAL:"local",PROD:"prod",STAGE:"stage"},er={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},tr=new Set,rr=new Set,ka=new Map,Sa={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Ca={filter:({level:a})=>a!==er.DEBUG},Gi={filter:()=>!1};function ji(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&zt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Vi(a){[...rr].every(t=>t(a))&&tr.forEach(t=>t(a))}function Aa(a){let t=(ka.get(a)??0)+1;ka.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Aa(`${r.namespace}/${i}`),updateConfig:wa};return Object.values(er).forEach(i=>{r[i]=(n,...o)=>Vi(ji(i,n,a,o,e))}),Object.seal(r)}function _t(...a){a.forEach(t=>{let{append:e,filter:r}=t;zt(r)&&rr.add(r),zt(e)&&tr.add(e)})}function Wi(a={}){let{name:t}=a,e=xa(Lt("commerce.debug",{search:!0,storage:!0}),t===Ea.LOCAL);return _t(e?Sa:Ca),t===Ea.PROD&&_t(Jt),tt}function Ki(){tr.clear(),rr.clear()}var tt={...Aa(Pr),Level:er,Plugins:{consoleAppender:Sa,debugFilter:Ca,quietFilter:Gi,lanaAppender:Jt},init:Wi,reset:Ki,use:_t};var Yi="mas-commerce-service",El=tt.module("utilities"),Qi={requestId:ft,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Pt=a=>window.setTimeout(a);function ar(){return document.getElementsByTagName(Yi)?.[0]}function Ta(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Qi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function La(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var za="fragment",_a="author",Pa="preview",Ma="loading",Ra="timeout",ir="aem-fragment",Oa="eager",Da="cache",Xi=[Oa,Da],j,he,B,nr=class{constructor(){f(this,j,new Map);f(this,he,new Map);f(this,B,new Map)}clear(){s(this,j).clear(),s(this,he).clear(),s(this,B).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,j).set(t.id,t),t.fields?.originalId&&s(this,j).set(t.fields.originalId,t),s(this,B).has(t.id)){let[,r]=s(this,B).get(t.id);r()}if(s(this,B).has(t.fields?.originalId)){let[,r]=s(this,B).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,j).has(t)}entries(){return s(this,j).entries()}get(t){return s(this,j).get(t)}getAsPromise(t){let[e]=s(this,B).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,B).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,he).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,he).set(t,e)),e}remove(t){s(this,j).delete(t),s(this,he).delete(t),s(this,B).delete(t)}};j=new WeakMap,he=new WeakMap,B=new WeakMap;var ae=new nr,$e,H,Y,D,O,A,rt,at,q,it,nt,Be,U,Na,Fa,or,Ia,Mt=class extends HTMLElement{constructor(){super(...arguments);f(this,U);h(this,"cache",ae);f(this,$e);f(this,H,null);f(this,Y,null);f(this,D,null);f(this,O);f(this,A);f(this,rt,Oa);f(this,at,5e3);f(this,q);f(this,it,!1);f(this,nt,0);f(this,Be)}static get observedAttributes(){return[za,Ma,Ra,_a,Pa]}attributeChangedCallback(e,r,i){e===za&&(g(this,O,i),g(this,A,ae.getFetchInfo(i))),e===Ma&&Xi.includes(i)&&g(this,rt,i),e===Ra&&g(this,at,parseInt(i,10)),e===_a&&g(this,it,["","true"].includes(i)),e===Pa&&g(this,Be,i)}connectedCallback(){if(!s(this,q)){if(s(this,D)??g(this,D,ce(this)),g(this,Be,s(this,D).settings?.preview),s(this,$e)??g(this,$e,s(this,D).log.module(`${ir}[${s(this,O)}]`)),!s(this,O)||s(this,O)==="#"){s(this,A)??g(this,A,ae.getFetchInfo("missing-fragment-id")),_(this,U,or).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,A)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&ae.remove(s(this,O)),s(this,rt)===Da&&await Promise.race([ae.getAsPromise(s(this,O)),new Promise(c=>setTimeout(c,s(this,at)))]);try{g(this,q,_(this,U,Ia).call(this)),await s(this,q)}catch(c){return _(this,U,or).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,H)||{};return o&&!Lt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(we,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,A)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,Y)?s(this,Y):(s(this,it)?this.transformAuthorData():this.transformPublishData(),s(this,Y))}get rawData(){return s(this,H)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:d={}}=s(this,H);g(this,Y,e.reduce((p,{name:m,multiple:u,values:C})=>(p.fields[m]=u?C:C[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:d,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:d}=s(this,H);g(this,Y,Object.entries(e).reduce((p,[m,u])=>(p.fields[m]=u?.mimeType?u.value:u??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,D).settings.instant;return n&&(i.instant=n),await r(s(this,O),i)}};$e=new WeakMap,H=new WeakMap,Y=new WeakMap,D=new WeakMap,O=new WeakMap,A=new WeakMap,rt=new WeakMap,at=new WeakMap,q=new WeakMap,it=new WeakMap,nt=new WeakMap,Be=new WeakMap,U=new WeakSet,Na=async function(e){gr(this,nt)._++;let r=`${ir}:${s(this,O)}:${s(this,nt)}`,i=`${r}${vt}`,n=`${r}${xt}`;if(s(this,Be)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new re(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,A).stale=!1,s(this,A).url=e,o=await La(e,{cache:"default",credentials:"omit"}),_(this,U,Fa).call(this,o),s(this,A).status=o?.status,s(this,A).measure=ke(performance.measure(n,i)),s(this,A).retryCount=o.retryCount,!o?.ok)throw new re("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,A).measure=ke(performance.measure(n,i)),s(this,A).retryCount=c.retryCount,s(this,H))return s(this,A).stale=!0,s(this,$e).error("Serving stale data",s(this,A)),s(this,H);let l=c.message??"unknown";throw new re(`Failed to fetch fragment: ${l}`,{})}},Fa=function(e){Object.assign(s(this,A),Ta(e))},or=function(e){g(this,q,null),s(this,A).message=e,this.classList.add("error");let r={...s(this,A),...s(this,D).duration};s(this,$e).error(e,r),this.dispatchEvent(new CustomEvent(Ee,{detail:r,bubbles:!0,composed:!0}))},Ia=async function(){var l;this.classList.remove("error"),g(this,Y,null);let e=ae.get(s(this,O));if(e)return g(this,H,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,O)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await _(this,U,Na).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,O)),ae.add(e),g(this,H,e),!0},h(Mt,"cache",ae);customElements.define(ir,Mt);import{LitElement as Zi,html as cr,css as Ji,nothing as en}from"./lit-all.min.js";import{unsafeHTML as tn}from"./lit-all.min.js";var rn=a=>a?a.startsWith("sp-icon-")?cr`${tn(`<${a} class="badge-icon"></${a}>`)}`:cr`<img src="${a}" class="badge-icon" />`:en,He=class extends Zi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return cr`<div class="badge">
    ...
    `);customElements.define("merch-badge",He);import{html as an,css as nn,LitElement as on}from"./lit-all.min.js";var ot=class extends on{constructor(){super()}render(){return an`
            <slot name="icon"></slot>

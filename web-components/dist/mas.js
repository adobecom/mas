...
`;var Ii=class extends _{constructor(t){super(t)}getGlobalCSS(){return rc}renderLayout(){return f`${this.cardImage}
            <div class="body">
...
`;var Di=class extends _{constructor(t){super(t)}getGlobalCSS(){return ic}renderLayout(){return f` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var qt=class extends _{constructor(t){super(t)}getGlobalCSS(){return hc}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return f` ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?"":f`<slot name="promo-text"></slot
...
`;var xc={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Yt=class extends _{constructor(){super(...arguments);m(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return fc}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${H}[data-template="price"]`);if(!r)return;let i=r.cloneNode(!0);this.legal=i,r.dataset.displayTax="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return f`
    ...
    `);var zi=new Map,j=(e,t,r=null,i=null,n)=>{zi.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:n})};j("catalog",Ut,tc,Ut.variantStyle);j("image",Ii);j("inline-heading",Di);j("mini-compare-chart",Ft,null,Ft.variantStyle);j("plans",de,$i,de.variantStyle,de.collectionOptions);j("plans-students",de,sc,de.variantStyle,de.collectionOptions);j("plans-education",de,oc,de.variantStyle,de.collectionOptions);j("plans-v2",Xe,lc,Xe.variantStyle,Xe.collectionOptions);j("product",Gt,null,Gt.variantStyle);j("segment",qt,null,qt.variantStyle);j("special-offers",Vt,mc,Vt.variantStyle);j("simplified-pricing-express",jt,va,jt.variantStyle);j("full-pricing-express",Wt,ba,Wt.variantStyle);j("mini",Yt,xc,Yt.variantStyle);var ya=e=>{let t=zi.get(e.variant);if(!t)return;let{class:r,style:i}=t;if(i)try{let n=new CSSStyleSheet;n.replaceSync(i.cssText),e.shadowRoot.adoptedStyleSheets.push(n)}catch{let a=document.createElement("style");a.textContent=i.cssText,e.shadowRoot.appendChild(a)}return new r(e)};function Ni(e){return zi.get(e)?.fragmentMapping}function vc(e){return zi.get(e)?.collectionOptions}var bc=document.createElement("style");bc.innerHTML=`
:root {
...
`;document.head.appendChild(bc);var yc="fragment",Ec="author",wc="preview",Ac="loading",Sc="timeout",Ea="aem-fragment",Tc="eager",_c="cache",vh=[Tc,_c],Me,bt,Te,wa=class{constructor(){E(this,Me,new Map);E(this,bt,new Map);E(this,Te,new Map)}clear(){h(this,Me).clear(),h(this,bt).clear(),h(this,Te).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,Me).set(t.id,t),t.fields?.originalId&&h(this,Me).set(t.fields.originalId,t),h(this,Te).has(t.id)){let[,i]=h(this,Te).get(t.id);i()}if(h(this,Te).has(t.fields?.originalId)){let[,i]=h(this,Te).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:n,value:a}=t.references[i];n==="content-fragment"&&(a.settings={...t?.settings,...a.settings},a.placeholders={...t?.placeholders,...a.placeholders},a.dictionary={...t?.dictionary,...a.dictionary},a.priceLiterals={...t?.priceLiterals,...a.priceLiterals},this.add(a,t))}}}has(t){return h(this,Me).has(t)}entries(){return h(this,Me).entries()}get(t){return h(this,Me).get(t)}getAsPromise(t){let[r]=h(this,Te).get(t)??[];if(r)return r;let i;return r=new Promise(n=>{i=n,this.has(t)&&n()}),h(this,Te).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,bt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,bt).set(t,r)),r}remove(t){h(this,Me).delete(t),h(this,bt).delete(t),h(this,Te).delete(t)}};Me=new WeakMap,bt=new WeakMap,Te=new WeakMap;var Ke=new wa,Xt,_e,Be,be,he,J,Fr,Gr,Ce,qr,Vr,Kt,ke,Cc,kc,Aa,Pc,Hi=class extends HTMLElement{constructor(){super(...arguments);E(this,ke);m(this,"cache",Ke);E(this,Xt);E(this,_e,null);E(this,Be,null);E(this,be,null);E(this,he);E(this,J);E(this,Fr,Tc);E(this,Gr,5e3);E(this,Ce);E(this,qr,!1);E(this,Vr,0);E(this,Kt)}static get observedAttributes(){return[yc,Ac,Sc,Ec,wc]}attributeChangedCallback(r,i,n){r===yc&&(y(this,he,n),y(this,J,Ke.getFetchInfo(n))),r===Ac&&vh.includes(n)&&y(this,Fr,n),r===Sc&&y(this,Gr,parseInt(n,10)),r===Ec&&y(this,qr,["","true"].includes(n)),r===wc&&y(this,Kt,n)}connectedCallback(){if(!h(this,Ce)){if(h(this,be)??y(this,be,ht(this)),y(this,Kt,h(this,be).settings?.preview),h(this,Xt)??y(this,Xt,h(this,be).log.module(`${Ea}[${h(this,he)}]`)),!h(this,he)||h(this,he)==="#"){h(this,J)??y(this,J,Ke.getFetchInfo("missing-fragment-id")),te(this,ke,Aa).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,Ce)&&!await Promise.race([h(this,Ce),Promise.resolve(!1)]))return;r&&Ke.remove(h(this,he)),h(this,Fr)===_c&&await Promise.race([Ke.getAsPromise(h(this,he)),new Promise(s=>setTimeout(s,h(this,Gr)))]);try{y(this,Ce,te(this,ke,Pc).call(this)),await h(this,Ce)}catch(s){return te(this,ke,Aa).call(this,s.message),!1}let{references:i,referencesTree:n,placeholders:a,wcs:o}=h(this,_e)||{};return o&&!B("mas.disableWcsCache")&&h(this,be).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(rt,{detail:{...this.data,references:i,referencesTree:n,placeholders:a,...h(this,J)},bubbles:!0,composed:!0})),h(this,Ce)}get updateComplete(){return h(this,Ce)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,Be)?h(this,Be):(h(this,qr)?this.transformAuthorData():this.transformPublishData(),h(this,Be))}get rawData(){return h(this,_e)}transformAuthorData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,_e);y(this,Be,r.reduce((l,{name:d,multiple:p,values:u})=>(l.fields[d]=p?u:u[0],l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,_e);y(this,Be,Object.entries(r).reduce((l,[d,p])=>(l.fields[d]=p?.mimeType?p.value:p??"",l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=i.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,o=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${o}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,he),{locale:h(this,be).settings.locale,apiKey:h(this,be).settings.wcsApiKey})}};Xt=new WeakMap,_e=new WeakMap,Be=new WeakMap,be=new WeakMap,he=new WeakMap,J=new WeakMap,Fr=new WeakMap,Gr=new WeakMap,Ce=new WeakMap,qr=new WeakMap,Vr=new WeakMap,Kt=new WeakMap,ke=new WeakSet,Cc=async function(r){Ba(this,Vr)._++;let i=`${Ea}:${h(this,he)}:${h(this,Vr)}`,n=`${i}${at}`,a=`${i}${ot}`;if(h(this,Kt))return await this.generatePreview();performance.mark(n);let o;try{if(h(this,J).stale=!1,h(this,J).url=r,o=await Si(r,{cache:"default",credentials:"omit"}),te(this,ke,kc).call(this,o),h(this,J).status=o?.status,h(this,J).measure=Re(performance.measure(a,n)),h(this,J).retryCount=o.retryCount,!o?.ok)throw new Ie("Unexpected fragment response",{response:o,...h(this,be).duration});return await o.json()}catch(s){if(h(this,J).measure=Re(performance.measure(a,n)),h(this,J).retryCount=s.retryCount,h(this,_e))return h(this,J).stale=!0,h(this,Xt).error("Serving stale data",h(this,J)),h(this,_e);let c=s.message??"unknown";throw new Ie(`Failed to fetch fragment: ${c}`,{})}},kc=function(r){Object.assign(h(this,J),ci(r))},Aa=function(r){y(this,Ce,null),h(this,J).message=r,this.classList.add("error");let i={...h(this,J),...h(this,be).duration};h(this,Xt).error(r,i),this.dispatchEvent(new CustomEvent(it,{detail:i,bubbles:!0,composed:!0}))},Pc=async function(){var c;this.classList.remove("error"),y(this,Be,null);let r=Ke.get(h(this,he));if(r)return y(this,_e,r),!0;let{masIOUrl:i,wcsApiKey:n,country:a,locale:o}=h(this,be).settings,s=`${i}/fragment?id=${h(this,he)}&api_key=${n}&locale=${o}`;return a&&!o.endsWith(`_${a}`)&&(s+=`&country=${a}`),r=await te(this,ke,Cc).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,he)),Ke.add(r),y(this,_e,r),!0},m(Hi,"cache",Ke);customElements.define(Ea,Hi);R();var Qt=class extends z{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">${this.text}</div>`}};m(Qt,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),m(Qt,"styles",b`
    ...
    `);customElements.define("merch-badge",Qt);R();var jr=class extends z{constructor(){super()}render(){return f`
            <slot name="icon"></slot>
...
`;var[ib,nb,ka,Pa,Hc,Bc]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var La=class extends z{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return zc}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=_r(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=_r(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(_t,this.debouncedQuantityUpdate)}get button(){return this.shadowRoot.querySelector("button")}handleKeyup(t){t.key===Pa||t.key===ka||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let t=this.options[this.highlightedIndex];if(!t){this.closed=!0;return}this.selectedValue=t,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(t){switch(t.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case Bc:this.selectValue();break;case Pa:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,t.preventDefault();break;case ka:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),t.preventDefault();break;case Hc:this.selectValue(),this.button.classList.contains("focused")&&t.preventDefault();break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=t.value.replace(/\D/g,"");t.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let n=i;this.maxInput&&i>this.maxInput&&(n=this.maxInput),this.min&&n<this.min&&(n=this.min),this.adjustInput(t,n)}else this.adjustInput(t,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(_t,this.debouncedQuantityUpdate)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}update(t){(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue"))&&(this.options=this.generateOptionsArray(),this.highlightedIndex=this.defaultValue?this.options.indexOf(this.defaultValue):0,this.handleMenuOption(this.defaultValue?this.defaultValue:this.options[0])),super.update(t)}handleClickOutside(t){t.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let t=this.shadowRoot.querySelector(".popover");this.closed||t.getBoundingClientRect().bottom<=window.innerHeight?t.setAttribute("placement","bottom"):t.setAttribute("placement","top")}handleMouseEnter(t){this.highlightedIndex=t}handleMenuOption(t,r){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let t=new CustomEvent(ne,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return f` <div
        ...
        `}};customElements.define("merch-quantity-select",La);Mi();R();var Uc=`
...
`;var Oa={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},sr=class extends _{getGlobalCSS(){return Wc}get aemFragmentMapping(){return Oa}renderLayout(){return f`
    ...
    `);j("ccd-suggested",ir,Fc,ir.variantStyle);j("ccd-slice",nr,qc,nr.variantStyle);j("ah-try-buy-widget",ar,Ra,ar.variantStyle);j("ah-promoted-plans",or,Ma,or.variantStyle);j("fries",sr,Oa,sr.variantStyle);

...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as ht,css as en}from"./lit-all.min.js";var ca=`
:root {
...
`;var $t=class extends v{constructor(r){super(r)}getGlobalCSS(){return la}renderLayout(){return da` ${this.badge}
            ...
            ${this.card.customHr?"":da`<hr />`} ${this.secureLabelFooter}`}};import{html as le,css as tn,unsafeCSS as pa}from"./lit-all.min.js";var ha=`
  :root {
...
`;var on=32,ua={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Q,He=class extends v{constructor(e){super(e);u(this,Q);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Ht` <footer>
    ...
    `);import{html as pt,css as cn,nothing as Bt}from"./lit-all.min.js";var fa=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?re`
        ...
        `:re`
            ...
            <slot></slot>`}};h(de,"variantStyle",sn`
...
`;var[_s,Ms,ka,Ca,Sa,Aa]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var hn="pro",Ta=`--consonant-merch-card-${hn}-top-card-height`,La={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ie,ye,ft,L,za,mt,Pa,gt,hr,jt,Gt=class Gt extends v{constructor(e){super(e);u(this,L);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,ie,null);u(this,ye,null);h(this,"lastSyncKey",null);u(this,ft,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of y(this,L,za).call(this)){let n=i.variantLayout;n instanceof Gt&&(n.expanded=t,i._proExpanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?y(this,L,hr).call(this):y(this,L,gt).call(this),this.card.requestUpdate()});u(this,jt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Ca:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:y(this,L,gt).call(this);break;case ka:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:y(this,L,gt).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Sa:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}y(this,L,gt).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),y(this,L,hr).call(this);break;case Aa:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,y(this,L,mt).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(M,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._proExpanded??!1}getGlobalCSS(){return Ea}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(U,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let t=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=t?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=t.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!!this.card.querySelector('[slot="edu-disclaimer"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${E}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=Ta,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1),o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}for(let c of o.values()){let l=0;for(let d of c){d.style.removeProperty(i);let p=d.shadowRoot?.querySelector(".top-card");p&&(l=Math.max(l,parseInt(getComputedStyle(p).height)||0))}l>0&&c.length>1&&c.forEach(d=>d.style.setProperty(i,`${l}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),i=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(nt,s(this,ft)),this.card.addEventListener(M,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;m(this,ye,new ResizeObserver(()=>this.resyncOnReflow())),s(this,ye).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&s(this,ye).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(M,this.updatePriceQuantity),y(this,L,mt).call(this),s(this,ye)?.disconnect(),this.card?.removeEventListener(nt,s(this,ft))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t)return null;let o=[];for(let c=t;c<=i;c+=n)o.push(String(c));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return ae`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return ae`
        ...
        `}renderLayout(){let e=!!this.expanded;return ae`
            ...
            ${this.hasWhatsIncluded?ae`
                  ...
                  `:Be}
            ${this.hasEduDisclaimer&&!this.card?.settings?.hideEduDisclaimer?ae`<div class="edu-disclaimer">
                      <slot name="edu-disclaimer"></slot>
                  </div>`:Be}
            <slot></slot>
        `}};ie=new WeakMap,ye=new WeakMap,ft=new WeakMap,L=new WeakSet,za=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},mt=function(){s(this,ie)&&(document.removeEventListener("mousedown",s(this,ie)),m(this,ie,null))},Pa=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},gt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=y(this,L,Pa).call(this),s(this,ie)||(m(this,ie,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),y(this,L,mt).call(this))}),document.addEventListener("mousedown",s(this,ie)))},hr=function(){this.licenseOpen=!1,y(this,L,mt).call(this)},jt=new WeakMap,h(Gt,"variantStyle",ln`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
...
`;var Ma={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},J,qe=class extends v{constructor(e){super(e);u(this,J);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return _a}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return pr` ${this.badge}
...
`;var Oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ue=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===R&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Ra}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${E}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return mr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Ia={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Ge=class extends v{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Fa}renderLayout(){return gr`${this.cardImage}
            ...
            ${this.evergreen?gr`
                  ...
                  `:gr`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(Ge,"variantStyle",fn`
...
`;var br={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Tn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Vt,Wa,Ye=class extends v{constructor(e){super(e);u(this,Vt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Va}get aemFragmentMapping(){return br}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Vt,Wa).call(this))}renderLayout(){return Sn`
            <div class="card">
            ...
            <slot></slot>
        `}};Vt=new WeakSet,Wa=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Tn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ye,"variantStyle",An`
...
`;var xr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Qe=class extends v{getGlobalCSS(){return Ka}get aemFragmentMapping(){return xr}renderLayout(){return Ln`
    ...
    `);var Wt=new Map,Ya=new WeakMap,Qa=new Map,S=(a,r,e=null,t=null,i)=>{Wt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",Ie,oa,Ie.variantStyle);S("image",xe);S("inline-heading",$t);S("mini-compare-chart",$e,ma,$e.variantStyle);S("mini-compare-chart-mweb",He,ua,He.variantStyle);S("plans",F,qt,F.variantStyle,F.collectionOptions);S("plans-students",F,ba,F.variantStyle,F.collectionOptions);S("plans-education",F,va,F.variantStyle,F.collectionOptions);S("plans-v2",de,wa,de.variantStyle,de.collectionOptions);S("pro",ut,La,ut.variantStyle);S("product",qe,Ma,qe.variantStyle);S("segment",Ue,Oa,Ue.variantStyle);S("media",je,Na,je.variantStyle);S("headless",We,Ua,We.variantStyle);S("special-offers",Ge,Ia,Ge.variantStyle);S("simplified-pricing-express",Ve,ur,Ve.variantStyle);S("full-pricing-express",bt,fr,bt.variantStyle);S("mini",Ke,Ga,Ke.variantStyle);S("image",xe,sa,xe.variantStyle);S("compare-chart-column",Ye,br,Ye.variantStyle);S("fries",Qe,xr,Qe.variantStyle);var Pn=(a,r,e)=>{try{let t=Qa.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),Qa.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},yr=a=>{let r=Wt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=Ya.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?Pn(a,t,i):{};return Ya.set(a,{appliedVariant:a.variant,...n}),new e(a)};function It(a){return Wt.get(a)?.fragmentMapping}function Za(a){return Wt.get(a)?.collectionOptions}var Xa=document.createElement("style");Xa.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var we={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ei=1e3;function Rn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ti(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!we.serializableTypes.includes(e))return e}return a}function On(a,r){if(!we.ignoredProperties.includes(a))return ti(r)}var Er={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(Rn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(ti).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${we.delimiter}page=${o}${c}`;l.length>ei&&(l=`${l.slice(0,ei)}<trunc>`),n+=l,i.length&&(n+=`${we.delimiter}facts=`,n+=JSON.stringify(i,On)),window.lana?.log(n,we)}};function ri(a){Object.assign(we,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in we&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ai={LOCAL:"local",PROD:"prod",STAGE:"stage"},kr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Cr=new Set,Sr=new Set,ii=new Map,ni={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},oi={filter:({level:a})=>a!==kr.DEBUG},Dn={filter:()=>!1};function Nn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Yt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function Fn(a){[...Sr].every(r=>r(a))&&Cr.forEach(r=>r(a))}function ci(a){let r=(ii.get(a)??0)+1;ii.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>ci(`${t.namespace}/${i}`),updateConfig:ri};return Object.values(kr).forEach(i=>{t[i]=(n,...o)=>Fn(Nn(i,n,a,o,e))}),Object.seal(t)}function Qt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Yt(t)&&Sr.add(t),Yt(e)&&Cr.add(e)})}function In(a={}){let{name:r}=a,e=Ja(Kt("commerce.debug",{search:!0,storage:!0}),r===ai.LOCAL);return Qt(e?ni:oi),r===ai.PROD&&Qt(Er),xt}function $n(){Cr.clear(),Sr.clear()}var xt={...ci(ta),Level:kr,Plugins:{consoleAppender:ni,debugFilter:oi,quietFilter:Dn,lanaAppender:Er},init:In,reset:$n,use:Qt};var Hn="mas-commerce-service",Od=xt.module("utilities"),Bn={requestId:Rt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Zt=a=>window.setTimeout(a);function Ar(){return document.getElementsByTagName(Hn)?.[0]}function si(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Bn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function li(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,t*(n+1)))}throw i}var di="fragment",hi="author",pi="preview",mi="loading",gi="mask",ui="pzn",fi="timeout",Tr="aem-fragment",vi="eager",bi="cache",qn=[vi,bi],j,Ee,I,Lr=class{constructor(){u(this,j,new Map);u(this,Ee,new Map);u(this,I,new Map)}clear(){s(this,j).clear(),s(this,Ee).clear(),s(this,I).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(s(this,j).set(r.id,r),r.fields?.originalId&&s(this,j).set(r.fields.originalId,r),s(this,I).has(r.id)){let[,t]=s(this,I).get(r.id);t()}if(s(this,I).has(r.fields?.originalId)){let[,t]=s(this,I).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return s(this,j).has(r)}entries(){return s(this,j).entries()}get(r){return s(this,j).get(r)}getAsPromise(r){let[e]=s(this,I).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),s(this,I).set(r,[e,t]),e}getFetchInfo(r){let e=s(this,Ee).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,Ee).set(r,e)),e}set(r,e){if(s(this,j).set(r,e),s(this,I).has(r)){let[,t]=s(this,I).get(r);t()}}remove(r){s(this,j).delete(r),s(this,Ee).delete(r),s(this,I).delete(r)}};j=new WeakMap,Ee=new WeakMap,I=new WeakMap;var ne=new Lr,Ze,H,oe,$,G,z,yt,V,W,wt,K,Et,kt,Xe,Y,xi,yi,zr,wi,Xt=class extends HTMLElement{constructor(){super(...arguments);u(this,Y);h(this,"cache",ne);u(this,Ze);u(this,H,null);u(this,oe,null);u(this,$,null);u(this,G);u(this,z);u(this,yt,vi);u(this,V);u(this,W);u(this,wt,5e3);u(this,K);u(this,Et,!1);u(this,kt,0);u(this,Xe)}static get observedAttributes(){return[di,mi,fi,hi,pi,gi,ui]}cacheKey(){return`${s(this,G)}${s(this,W)?`-p_${s(this,W)}`:""}${s(this,V)?`-m_${s(this,V)}`:""}`}attributeChangedCallback(e,t,i){e===di&&(m(this,G,i),m(this,z,ne.getFetchInfo(this.cacheKey()))),e===gi&&m(this,V,i),e===ui&&m(this,W,i),e===mi&&qn.includes(i)&&m(this,yt,i),e===fi&&m(this,wt,parseInt(i,10)),e===hi&&m(this,Et,["","true"].includes(i)),e===pi&&m(this,Xe,i)}connectedCallback(){if(!s(this,K)){if(s(this,$)??m(this,$,ve(this)),m(this,Xe,s(this,$).settings?.preview),s(this,Ze)??m(this,Ze,s(this,$).log.module(`${Tr}[${s(this,G)}]`)),!s(this,G)||s(this,G)==="#"){s(this,z)??m(this,z,ne.getFetchInfo("missing-fragment-id")),y(this,Y,zr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,z)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(s(this,K)&&!await Promise.race([s(this,K),Promise.resolve(!1)]))return;e&&ne.remove(this.cacheKey()),s(this,yt)===bi&&await Promise.race([ne.getAsPromise(this.cacheKey()),new Promise(c=>setTimeout(c,s(this,wt)))]);try{m(this,K,y(this,Y,wi).call(this)),await s(this,K)}catch(c){return y(this,Y,zr).call(this,c.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=s(this,H)||{};return o&&!Kt("mas.disableWcsCache")&&s(this,$).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Me,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...s(this,z)},bubbles:!0,composed:!0})),s(this,K)}get updateComplete(){return s(this,K)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,oe)?s(this,oe):(s(this,Et)?this.transformAuthorData():this.transformPublishData(),s(this,oe))}get rawData(){return s(this,H)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,promoProject:c,promoVariationProject:l,settings:d={},priceLiterals:p={},dictionary:g={},placeholders:f={}}=s(this,H);m(this,oe,e.reduce((k,{name:O,multiple:D,values:ge})=>(k.fields[O]=D?ge:ge[0],k),{fields:{},id:t,tags:n,settings:d,priceLiterals:p,dictionary:g,maskId:i,placeholders:f,variationId:o,promoProject:c,promoVariationProject:l}))}transformPublishData(){if(!s(this,H))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},maskId:l,placeholders:d={},variationId:p,promoProject:g,promoVariationProject:f}=s(this,H);m(this,oe,Object.entries(e).reduce((k,[O,D])=>(k.fields[O]=D?.mimeType?D.value:D??"",k),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:c,maskId:l,placeholders:d,variationId:p,promoProject:g,promoVariationProject:f}))}getFragmentClientUrl(){let t=new URLSearchParams(window.location.search).get("maslibs");if(!t||t.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=t.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:s(this,$).settings.locale,apiKey:s(this,$).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,$).settings.instant,o={...i,...n!=null?{instant:n}:{},...s(this,V)!=null?{mask:s(this,V)}:{},...s(this,W)!=null?{pzn:s(this,W)}:{}};return await t(s(this,G),o)}};Ze=new WeakMap,H=new WeakMap,oe=new WeakMap,$=new WeakMap,G=new WeakMap,z=new WeakMap,yt=new WeakMap,V=new WeakMap,W=new WeakMap,wt=new WeakMap,K=new WeakMap,Et=new WeakMap,kt=new WeakMap,Xe=new WeakMap,Y=new WeakSet,xi=async function(e){Ir(this,kt)._++;let t=`${Tr}:${this.cacheKey()}:${s(this,kt)}`,i=`${t}${Ot}`,n=`${t}${Dt}`;if(s(this,Xe)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new he(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,z).stale=!1,s(this,z).url=e,o=await li(e,{cache:"default",credentials:"omit"}),y(this,Y,yi).call(this,o),s(this,z).status=o?.status,s(this,z).measure=Oe(performance.measure(n,i)),s(this,z).retryCount=o.retryCount,!o?.ok)throw new he("Unexpected fragment response",{response:o,...s(this,$).duration});return await o.json()}catch(c){if(s(this,z).measure=Oe(performance.measure(n,i)),s(this,z).retryCount=c.retryCount,s(this,H))return s(this,z).stale=!0,s(this,Ze).error("Serving stale data",s(this,z)),s(this,H);let l=c.message??"unknown";throw new he(`Failed to fetch fragment: ${l}`,{})}},yi=function(e){Object.assign(s(this,z),si(e))},zr=function(e){m(this,K,null),s(this,z).message=e,this.classList.add("error");let t={...s(this,z),...s(this,$).duration};s(this,Ze).error(e,t),this.dispatchEvent(new CustomEvent(Re,{detail:t,bubbles:!0,composed:!0}))},wi=async function(){var l;this.classList.remove("error"),m(this,oe,null);let e=ne.get(this.cacheKey());if(e)return m(this,H,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=s(this,$).settings,c=`${t}/fragment?id=${s(this,G)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),s(this,V)&&(c+=`&mask=${s(this,V)}`),s(this,W)&&(c+=`&pzn=${s(this,W)}`),e=await y(this,Y,xi).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,G)),s(this,V)||s(this,W)?ne.set(this.cacheKey(),e):ne.add(e),m(this,H,e),!0},h(Xt,"cache",ne);customElements.define(Tr,Xt);import{LitElement as Un,html as Pr,css as jn,nothing as Gn}from"./lit-all.min.js";import{unsafeHTML as Vn}from"./lit-all.min.js";var Wn=a=>a?a.startsWith("sp-icon-")?Pr`${Vn(`<${a} class="badge-icon"></${a}>`)}`:Pr`<img src="${a}" class="badge-icon" />`:Gn,Je=class extends Un{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Pr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Je);import{html as Kn,css as Yn,LitElement as Qn}from"./lit-all.min.js";var Ct=class extends Qn{constructor(){super()}render(){return Kn`
            <slot name="icon"></slot>

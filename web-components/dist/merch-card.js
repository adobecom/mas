var Ir=Object.defineProperty;var $r=a=>{throw TypeError(a)};var Fi=(a,r,e)=>r in a?Ir(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Ii=(a,r)=>()=>(a&&(r=a(a=0)),r);var $i=(a,r)=>{for(var e in r)Ir(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>Fi(a,typeof r!="symbol"?r+"":r,e),nr=(a,r,e)=>r.has(a)||$r("Cannot "+e);var l=(a,r,e)=>(nr(a,r,"read from private field"),e?e.call(a):r.get(a)),u=(a,r,e)=>r.has(a)?$r("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(nr(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),w=(a,r,e)=>(nr(a,r,"access private method"),e);var Hr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return l(a,r,t)}});var or={};$i(or,{default:()=>at});import{LitElement as Hi,html as Le,css as Bi,nothing as qi}from"./lit-all.min.js";import{unsafeHTML as Vr}from"./lit-all.min.js";import{ifDefined as Ui}from"./lit-all.min.js";function ji(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var N,at,sr=Ii(()=>{N=class N extends Hi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();N.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),d=c?c.offsetWidth:o,p=c?c.offsetHeight:s,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>t&&(f="left");let C=e.left+e.width/2,O=e.top+e.height/2,D=6,ge=(Oi,Di,Ni)=>Math.max(Oi,Math.min(Di,Ni)),Pt,_t,ir;f==="top"||f==="bottom"?(Pt=f==="top"?e.top-p-n:e.bottom+n,_t=ge(0,t-d,C-d/2),ir=ge(D,d-D*2,C-_t-D)):(_t=f==="left"?e.left-d-n:e.right+n,Pt=ge(0,i-p,O-p/2),ir=ge(D,p-D*2,O-Pt-D)),this._tooltipTop=Pt,this._tooltipLeft=_t,this._arrowOffset=ir,this._computedPlacement=f}showTooltip(){N.activeTooltip&&N.activeTooltip!==this&&(N.activeTooltip.closeOverlay(),N.activeTooltip.tooltipVisible=!1,N.activeTooltip.requestUpdate()),N.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){N.activeTooltip===this&&(N.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Le`<merch-icon
        ...
        ></merch-icon>`:Le`<slot></slot>`}render(){let r=this.effectiveContent,e=this.effectivePlacement;if(!r)return Le`<span class="icon-only">${this.renderIcon()}</span>`;if(ji())return Le`
            ...
            `;let i=r.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:g=>{this.lastPointerType=g.pointerType},pointerenter:g=>g.pointerType!=="touch"&&this.showTooltip(),pointerleave:g=>g.pointerType!=="touch"&&this.hideTooltip(),click:g=>{this.lastPointerType==="touch"&&this.handleTap(g),this.lastPointerType=null}},s=this._computedPlacement,c=s==="top"||s==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=c?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return Le`
            <span

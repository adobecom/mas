var Yt=Object.defineProperty;var Kt=i=>{throw TypeError(i)};var fi=(i,t,e)=>t in i?Yt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var xi=(i,t)=>()=>(i&&(t=i(i=0)),t);var vi=(i,t)=>{for(var e in t)Yt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>fi(i,typeof t!="symbol"?t+"":t,e),wt=(i,t,e)=>t.has(i)||Kt("Cannot "+e);var c=(i,t,e)=>(wt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Kt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),m=(i,t,e,r)=>(wt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),S=(i,t,e)=>(wt(i,t,"access private method"),e);var Qt=(i,t,e,r)=>({set _(a){m(i,t,a,e)},get _(){return c(i,t,r)}});var Et={};vi(Et,{default:()=>De});import{LitElement as bi,html as et,css as yi}from"./lit-all.min.js";function wi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var T,De,kt=xi(()=>{T=class T extends bi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();T.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}showTooltip(){T.activeTooltip&&T.activeTooltip!==this&&(T.activeTooltip.closeOverlay(),T.activeTooltip.tooltipVisible=!1,T.activeTooltip.requestUpdate()),T.activeTooltip=this,this.tooltipVisible=!0}hideTooltip(){T.activeTooltip===this&&(T.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?et`<merch-icon
    ...
    `);De=T;customElements.define("mas-mnemonic",De)});import{LitElement as Va}from"./lit-all.min.js";import{css as Jt,unsafeCSS as Zt}from"./lit-all.min.js";var b="(max-width: 767px)",M="(max-width: 1199px)",y="(min-width: 768px)",u="(min-width: 1200px)",C="(min-width: 1600px)",Xt={matchMobile:window.matchMedia(b),matchDesktop:window.matchMedia(`${u} and (not ${C})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(C),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},f=Xt;function Je(){return Xt.isDesktop}var er=Jt`
    :host {
...
`,tr=()=>[Jt`
        ...
        `];import{LitElement as Ei,html as rr,css as ki}from"./lit-all.min.js";function Si(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var pe=class extends Ei{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Si())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>kt())}e.remove()})}render(){let{href:t}=this;return t?rr`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};l(pe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(pe,"styles",ki`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",pe);var sn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),cn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var x='span[is="inline-price"][data-wcs-osi]',G='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Ai='a[is="upt-link"]',ir=`${x},${G},${Ai}`;var ar="merch-offer-select:ready",nr="merch-card:action-menu-toggle";var H="merch-quantity-selector:change",or="merch-card-quantity:change",St="merch-modal:addon-and-quantity-update";var he="merch-card-collection:literals-changed";var me="aem:load",ge="aem:error",sr="mas:ready",cr="mas:error",lr="placeholder-failed",dr="placeholder-pending",pr="placeholder-resolved";var hr="mas:failed",Ne="mas:resolved",mr="mas/commerce";var V="failed",Z="pending",W="resolved";var tt="X-Request-Id",ln=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var dn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var rt=":start",it=":duration";var ue="legal",gr="mas-ff-defaults";var Ci="mas-commerce-service";function ur(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function L(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function fe(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function At(){return window.matchMedia("(max-width: 1024px)").matches}function J(){return document.getElementsByTagName(Ci)?.[0]}function $e(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Fe,ee,Ie,Be,xe,at=class extends HTMLElement{constructor(){super();g(this,Fe,"");g(this,ee);g(this,Ie,[]);g(this,Be,[]);g(this,xe);m(this,xe,ur(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,ee)?this.parentElement.style.borderRadius=c(this,ee):c(this,ee)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Ie).map((r,a)=>{let n=c(this,Be)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Fe)}, ${e})`}connectedCallback(){c(this,xe).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&m(this,ee,a?.trim()),e==="colors"&&a?m(this,Ie,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?m(this,Be,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Fe,a?.trim()??""),c(this,xe).call(this)}};Fe=new WeakMap,ee=new WeakMap,Ie=new WeakMap,Be=new WeakMap,xe=new WeakMap;customElements.define("merch-gradient",at);import{LitElement as Ti,html as Li,css as zi}from"./lit-all.min.js";var ve=class extends Ti{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${x}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Ne,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Ne,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Li` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};l(ve,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),l(ve,"styles",zi`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as qe}from"./lit-all.min.js";var vr=`
:root {
...
`;var st=class extends v{constructor(t){super(t)}getGlobalCSS(){return vr}renderLayout(){return qe`${this.cardImage}
            <div class="body">
...
`;var ct=class extends v{constructor(t){super(t)}getGlobalCSS(){return br}renderLayout(){return yr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":yr`<hr />`} ${this.secureLabelFooter}`}};import{html as we,css as Mi,unsafeCSS as Er}from"./lit-all.min.js";var wr=`
  :root {
...
`;var Ri=32,Ee=class extends v{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?we`<slot name="secure-transaction-label">
                  <span class="secure-transaction-label"
                      >${this.card.secureLabel}</span
                  ></slot
              >`:we`<slot name="secure-transaction-label"></slot>`;return we`<footer>${e}<slot name="footer"></slot></footer>`});this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(H,this.updatePriceQuantity)}disconnectedCallbackHook(){this.card.removeEventListener(H,this.updatePriceQuantity)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}getGlobalCSS(){return wr}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer"),this.card.shadowRoot.querySelector(".mini-compare-chart-badge")?.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,a)=>{let n=Math.max(Ri,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let a=r.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&r.remove()})}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${x}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}toggleAddon(e){let r=this.mainPrice,a=this.headingMPriceSlot;if(!r&&a){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(s=>s.remove()),e.checked){if(o){let s=L("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},o.innerHTML);this.card.appendChild(s)}}else{let s=L("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,a=this.card.planType;if(r&&(await r.onceSettled(),a=r.value?.[0]?.planType),!a)return;e.planType=a,this.card.querySelector("merch-addon[plan-type]")?.updateComplete.then(()=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="addon"]'),"addon")})}renderLayout(){return we` <div class="top-section${this.badge?" badge":""}">
                <slot name="icons"></slot> ${this.badge}
            </div>
            <slot name="heading-m"></slot>
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),f.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(Ee,"variantStyle",Mi`
    ...
    `);import{html as Ue,css as Oi,nothing as lt}from"./lit-all.min.js";var kr=`
:root {
...
`;var ke=class extends v{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return zr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Tt` ${this.badge}
...
`;var _r={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-red-700-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},te=class extends v{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===ue&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Pr}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${x}[data-template="price"]`)}async postCardUpdateHook(){this.adjustTitleWidth(),this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Lt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as zt,css as Fi}from"./lit-all.min.js";var Mr=`
:root {
...
`;var Rr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Se=class extends v{constructor(t){super(t)}getGlobalCSS(){return Mr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return zt`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?zt`
                  ...
                  `:zt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};l(Se,"variantStyle",Fi`
    ...
    `);import{html as Ii,css as Bi}from"./lit-all.min.js";var Or=`
:root {
...
`;var Pt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ae=class extends v{getGlobalCSS(){return Or}get aemFragmentMapping(){return Pt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),f.isDesktopOrUp)){let t=this.getContainer();if(!t)return;requestAnimationFrame(()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(r=>r.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Je()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(Je())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};e();let r=window.matchMedia(b);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(b).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||Je())return;let a=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",a)}renderLayout(){return Ii`
    ...
    `);import{html as Nr,css as Hi}from"./lit-all.min.js";var Dr=`
:root {
...
`;var _t={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},Ce=class extends v{getGlobalCSS(){return Dr}get aemFragmentMapping(){return _t}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Nr`
    ...
    `);import{css as qi,html as Ui}from"./lit-all.min.js";var $r=`
...
`;var Fr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Te=class extends v{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return $r}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${x}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ui`
            ${this.badge}
            <div class="body">
    ...
    `);var ht=new Map,Ir=new WeakMap,Br=new Map,A=(i,t,e=null,r=null,a)=>{ht.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};A("catalog",ye,xr,ye.variantStyle);A("image",st);A("inline-heading",ct);A("mini-compare-chart",Ee,null,Ee.variantStyle);A("plans",z,dt,z.variantStyle,z.collectionOptions);A("plans-students",z,Ar,z.variantStyle,z.collectionOptions);A("plans-education",z,Sr,z.variantStyle,z.collectionOptions);A("plans-v2",Y,Lr,Y.variantStyle,Y.collectionOptions);A("product",ke,null,ke.variantStyle);A("segment",te,_r,te.variantStyle,te.collectionOptions);A("special-offers",Se,Rr,Se.variantStyle);A("simplified-pricing-express",Ae,Pt,Ae.variantStyle);A("full-pricing-express",Ce,_t,Ce.variantStyle);A("mini",Te,Fr,Te.variantStyle);var ji=(i,t,e)=>{try{let r=Br.get(i.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),Br.set(i.variant,r)),e?.styleSheet&&e.styleSheet!==r){let a=i.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);a!==-1&&i.shadowRoot.adoptedStyleSheets.splice(a,1)}return i.shadowRoot.adoptedStyleSheets.includes(r)||i.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",i.variant);let n=e?.styleElement||i.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),i.shadowRoot.appendChild(a),{styleElement:a}}},Mt=i=>{let t=ht.get(i.variant);if(!t)return;let{class:e,style:r}=t,a=Ir.get(i);if(a?.appliedVariant===i.variant)return new e(i);let n=r?ji(i,r,a):{};return Ir.set(i,{appliedVariant:i.variant,...n}),new e(i)};function ot(i){return ht.get(i)?.fragmentMapping}function Hr(i){return ht.get(i)?.collectionOptions}var qr=document.createElement("style");qr.innerHTML=`
:root {
...
`;document.head.appendChild(qr);function mt(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Rt(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Rt(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Vi(Rt(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Gi=i=>typeof i=="boolean",gt=i=>typeof i=="function";var Rt=i=>typeof i=="string";function Ur(i,t){if(Gi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Vi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var re=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(tt);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var ie={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},jr=1e3;function Wi(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Gr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!ie.serializableTypes.includes(e))return e}return i}function Yi(i,t){if(!ie.ignoredProperties.includes(i))return Gr(t)}var Ot={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(h=>{h!=null&&(Wi(h)?r:a).push(h)}),r.length&&(n+=" "+r.map(Gr).join(" "));let{pathname:o,search:s}=window.location,d=`${ie.delimiter}page=${o}${s}`;d.length>jr&&(d=`${d.slice(0,jr)}<trunc>`),n+=d,a.length&&(n+=`${ie.delimiter}facts=`,n+=JSON.stringify(a,Yi)),window.lana?.log(n,ie)}};function Vr(i){Object.assign(ie,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in ie&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Wr={LOCAL:"local",PROD:"prod",STAGE:"stage"},Dt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Nt=new Set,$t=new Set,Yr=new Map,Kr={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},Qr={filter:({level:i})=>i!==Dt.DEBUG},Ki={filter:()=>!1};function Qi(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&gt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function Xi(i){[...$t].every(t=>t(i))&&Nt.forEach(t=>t(i))}function Xr(i){let t=(Yr.get(i)??0)+1;Yr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>Xr(`${r.namespace}/${a}`),updateConfig:Vr};return Object.values(Dt).forEach(a=>{r[a]=(n,...o)=>Xi(Qi(a,n,i,o,e))}),Object.seal(r)}function ut(...i){i.forEach(t=>{let{append:e,filter:r}=t;gt(r)&&$t.add(r),gt(e)&&Nt.add(e)})}function Zi(i={}){let{name:t}=i,e=Ur(mt("commerce.debug",{search:!0,storage:!0}),t===Wr.LOCAL);return ut(e?Kr:Qr),t===Wr.PROD&&ut(Ot),je}function Ji(){Nt.clear(),$t.clear()}var je={...Xr(mr),Level:Dt,Plugins:{consoleAppender:Kr,debugFilter:Qr,quietFilter:Ki,lanaAppender:Ot},init:Zi,reset:Ji,use:ut};var ea="mas-commerce-service",Bs=je.module("utilities"),ta={requestId:tt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ft=i=>window.setTimeout(i);function Ft(){return document.getElementsByTagName(ea)?.[0]}function Zr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(ta)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Jr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var ei="fragment",ti="author",ri="preview",ii="loading",ai="timeout",It="aem-fragment",ni="eager",oi="cache",ra=[ni,oi],I,ae,D,Bt=class{constructor(){g(this,I,new Map);g(this,ae,new Map);g(this,D,new Map)}clear(){c(this,I).clear(),c(this,ae).clear(),c(this,D).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,D).has(t.id)){let[,r]=c(this,D).get(t.id);r()}if(c(this,D).has(t.fields?.originalId)){let[,r]=c(this,D).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,D).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,D).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ae).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ae).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,ae).delete(t),c(this,D).delete(t)}};I=new WeakMap,ae=new WeakMap,D=new WeakMap;var K=new Bt,Le,N,U,R,P,k,Ge,Ve,$,We,Ye,ze,F,si,ci,Ht,li,xt=class extends HTMLElement{constructor(){super(...arguments);g(this,F);l(this,"cache",K);g(this,Le);g(this,N,null);g(this,U,null);g(this,R,null);g(this,P);g(this,k);g(this,Ge,ni);g(this,Ve,5e3);g(this,$);g(this,We,!1);g(this,Ye,0);g(this,ze)}static get observedAttributes(){return[ei,ii,ai,ti,ri]}attributeChangedCallback(e,r,a){e===ei&&(m(this,P,a),m(this,k,K.getFetchInfo(a))),e===ii&&ra.includes(a)&&m(this,Ge,a),e===ai&&m(this,Ve,parseInt(a,10)),e===ti&&m(this,We,["","true"].includes(a)),e===ri&&m(this,ze,a)}connectedCallback(){if(!c(this,$)){if(c(this,R)??m(this,R,J(this)),m(this,ze,c(this,R).settings?.preview),c(this,Le)??m(this,Le,c(this,R).log.module(`${It}[${c(this,P)}]`)),!c(this,P)||c(this,P)==="#"){c(this,k)??m(this,k,K.getFetchInfo("missing-fragment-id")),S(this,F,Ht).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,$)&&!await Promise.race([c(this,$),Promise.resolve(!1)]))return;e&&K.remove(c(this,P)),c(this,Ge)===oi&&await Promise.race([K.getAsPromise(c(this,P)),new Promise(s=>setTimeout(s,c(this,Ve)))]);try{m(this,$,S(this,F,li).call(this)),await c(this,$)}catch(s){return S(this,F,Ht).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,N)||{};return o&&!mt("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(me,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,$)}get updateComplete(){return c(this,$)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,We)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,N)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,U,e.reduce((h,{name:p,multiple:w,values:_})=>(h.fields[p]=w?_:_[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,U,Object.entries(e).reduce((h,[p,w])=>(h.fields[p]=w?.mimeType?w.value:w??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,P),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};Le=new WeakMap,N=new WeakMap,U=new WeakMap,R=new WeakMap,P=new WeakMap,k=new WeakMap,Ge=new WeakMap,Ve=new WeakMap,$=new WeakMap,We=new WeakMap,Ye=new WeakMap,ze=new WeakMap,F=new WeakSet,si=async function(e){Qt(this,Ye)._++;let r=`${It}:${c(this,P)}:${c(this,Ye)}`,a=`${r}${rt}`,n=`${r}${it}`;if(c(this,ze))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await Jr(e,{cache:"default",credentials:"omit"}),S(this,F,ci).call(this,o),c(this,k).status=o?.status,c(this,k).measure=fe(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new re("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,k).measure=fe(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,N))return c(this,k).stale=!0,c(this,Le).error("Serving stale data",c(this,k)),c(this,N);let d=s.message??"unknown";throw new re(`Failed to fetch fragment: ${d}`,{})}},ci=function(e){Object.assign(c(this,k),Zr(e))},Ht=function(e){m(this,$,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,R).duration};c(this,Le).error(e,r),this.dispatchEvent(new CustomEvent(ge,{detail:r,bubbles:!0,composed:!0}))},li=async function(){var d;this.classList.remove("error"),m(this,U,null);let e=K.get(c(this,P));if(e)return m(this,N,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,R).settings,s=`${r}/fragment?id=${c(this,P)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await S(this,F,si).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,P)),K.add(e),m(this,N,e),!0},l(xt,"cache",K);customElements.define(It,xt);import{LitElement as ia,html as aa,css as na}from"./lit-all.min.js";var Pe=class extends ia{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return aa`<div class="badge">${this.text}</div>`}};l(Pe,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),l(Pe,"styles",na`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Pe);import{html as oa,css as sa,LitElement as ca}from"./lit-all.min.js";var Ke=class extends ca{constructor(){super()}render(){return oa`
            <slot name="icon"></slot>
    ...
    `),l(Ke,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ke);import{html as qt,css as la,LitElement as da}from"./lit-all.min.js";var Qe=class extends da{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return qt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?qt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:qt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(Qe,"styles",la`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

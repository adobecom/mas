    ...
    "data": [
        {
            ...
            "taxInclusiveLabel": "{taxTerm, select, GST {incl. GST} VAT {شاملاً الضريبة} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",
        ...
        },
        {
            ...
            "taxInclusiveLabel": "{taxTerm, select, GST {incl. GST} VAT {с включен ДДС} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",
...
`;var fh=32,Ft=class extends T{constructor(r){super(r);m(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);m(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?f`<slot name="secure-transaction-label">

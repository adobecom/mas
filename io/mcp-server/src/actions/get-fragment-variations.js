 ...
 * Adobe I/O Runtime action for studio_get_variations operation
 */
async function main(params) {
    ...
    try {
        ...
        const result = await studioOps.getFragmentVariations({ id });
        ...
        console.error('Get fragment variations error:', error);
        return {
            statusCode: 500,

var Ca=Object.defineProperty;var Ta=e=>{throw TypeError(e)};var Ps=(e,r,t)=>r in e?Ca(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Ls=(e,r)=>{for(var t in r)Ca(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Ps(e,typeof r!="symbol"?r+"":r,t),Vr=(e,r,t)=>r.has(e)||Ta("Cannot "+t);var v=(e,r,t)=>(Vr(e,r,"read from private field"),t?t.call(e):r.get(e)),z=(e,r,t)=>r.has(e)?Ta("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),L=(e,r,t,i)=>(Vr(e,r,"write to private field"),i?i.call(e,t):r.set(e,t),t),j=(e,r,t)=>(Vr(e,r,"access private method"),t);import{html as Pe,LitElement as xs,css as bs,unsafeCSS as vs,nothing as fe}from"./lit-all.min.js";var O="(max-width: 767px)",Z="(max-width: 1199px)",N="(min-width: 768px)",T="(min-width: 1200px)",J="(min-width: 1600px)",ka="(min-width: 1280px)",_a={matchMobile:window.matchMedia(O),matchDesktop:window.matchMedia(`${T} and (not ${J})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(J),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},k=_a;function nr(){return _a.isDesktop}var At=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var Pa="hashchange";function Ms(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let i of t){let[a,n=""]=i.split("=");a&&r.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function Ct(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([a,n])=>{n?r.set(a,n):r.delete(a)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,i)}function La(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=Ms(window.location.hash);e(t)};return r(),window.addEventListener(Pa,r),()=>{window.removeEventListener(Pa,r)}}var vi={};Ls(vi,{CLASS_NAME_FAILED:()=>ti,CLASS_NAME_HIDDEN:()=>Rs,CLASS_NAME_PENDING:()=>ri,CLASS_NAME_RESOLVED:()=>ii,CheckoutWorkflow:()=>Xs,CheckoutWorkflowStep:()=>ae,Commitment:()=>Fe,ERROR_MESSAGE_BAD_REQUEST:()=>ai,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>js,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>ni,EVENT_AEM_ERROR:()=>Jr,EVENT_AEM_LOAD:()=>Qr,EVENT_COMPARE_CHART_REHYDRATE:()=>qs,EVENT_EXPANDED_GROUPS_CHANGE:()=>Vs,EVENT_MAS_ERROR:()=>ei,EVENT_MAS_READY:()=>Gs,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>Us,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Yr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>me,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Kr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Tt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Xr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>sr,EVENT_MERCH_OFFER_READY:()=>Is,EVENT_MERCH_OFFER_SELECT_READY:()=>Ds,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ie,EVENT_MERCH_SEARCH_CHANGE:()=>$s,EVENT_MERCH_SIDENAV_SELECT:()=>Zr,EVENT_MERCH_STOCK_CHANGE:()=>Bs,EVENT_MERCH_STORAGE_CHANGE:()=>Fs,EVENT_OFFER_SELECTED:()=>Hs,EVENT_TYPE_FAILED:()=>oi,EVENT_TYPE_READY:()=>or,EVENT_TYPE_RESOLVED:()=>Le,Env:()=>ve,FF_ANNUAL_PRICE:()=>rt,FF_DEFAULTS:()=>Se,HEADER_X_REQUEST_ID:()=>kt,LOG_NAMESPACE:()=>si,Landscape:()=>ze,MARK_DURATION_SUFFIX:()=>gi,MARK_START_SUFFIX:()=>ui,MERCH_CARD_LOAD_TIMEOUT:()=>jr,MODAL_TYPE_3_IN_1:()=>Ue,NAMESPACE:()=>zs,PARAM_AOS_API_KEY:()=>Ws,PARAM_ENV:()=>li,PARAM_LANDSCAPE:()=>di,PARAM_MAS_PREVIEW:()=>ci,PARAM_WCS_API_KEY:()=>Ys,PROVIDER_ENVIRONMENT:()=>mi,SELECTOR_MAS_CHECKOUT_LINK:()=>Ma,SELECTOR_MAS_ELEMENT:()=>Wr,SELECTOR_MAS_INLINE_PRICE:()=>W,SELECTOR_MAS_SP_BUTTON:()=>Os,SELECTOR_MAS_UPT_LINK:()=>za,SORT_ORDER:()=>ge,STATE_FAILED:()=>ue,STATE_PENDING:()=>Me,STATE_RESOLVED:()=>Ee,SUPPORTED_COUNTRIES:()=>fi,TAG_NAME_SERVICE:()=>Ns,TEMPLATE_PRICE:()=>Ks,TEMPLATE_PRICE_ANNUAL:()=>Qs,TEMPLATE_PRICE_LEGAL:()=>ee,TEMPLATE_PRICE_STRIKETHROUGH:()=>Zs,Term:()=>he,WCS_PROD_URL:()=>hi,WCS_STAGE_URL:()=>pi});var Fe=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),he=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),zs="merch",jr=2e4,Rs="hidden",or="wcms:commerce:ready",Ns="mas-commerce-service",W='span[is="inline-price"][data-wcs-osi]',Ma='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Os="sp-button[data-wcs-osi]",za='a[is="upt-link"]',Wr=`${W},${Ma},${za}`,Is="merch-offer:ready",Ds="merch-offer-select:ready",Yr="merch-card:action-menu-toggle",Hs="merch-offer:selected",Bs="merch-stock:change",Fs="merch-storage:change",ie="merch-quantity-selector:change",sr="merch-card-quantity:change",Us="merch-modal:addon-and-quantity-update",$s="merch-search:change",Xr="merch-card-collection:sort",me="merch-card-collection:literals-changed",Tt="merch-card-collection:sidenav-attached",Kr="merch-card-collection:showmore",Zr="merch-sidenav:select",Qr="aem:load",Jr="aem:error",Gs="mas:ready",ei="mas:error",qs="mas-compare-chart:rehydrate",Vs="expanded-groups-change",ti="placeholder-failed",ri="placeholder-pending",ii="placeholder-resolved",ai="Bad WCS request",ni="Commerce offer not found",js="Literals URL not provided",oi="mas:failed",Le="mas:resolved",si="mas/commerce",ci="mas.preview",li="commerce.env",di="commerce.landscape",Ws="commerce.aosKey",Ys="commerce.wcsKey",hi="https://www.adobe.com/web_commerce_artifact",pi="https://www.stage.adobe.com/web_commerce_artifact_stage",ue="failed",Me="pending",Ee="resolved",ze={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},kt="X-Request-Id",ae=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Xs="UCv3",ve=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),mi={PRODUCTION:"PRODUCTION"},Ue={TWP:"twp",D2P:"d2p",CRM:"crm"},ui=":start",gi=":duration",Ks="price",Zs="price-strikethrough",Qs="annual",ee="legal",Se="mas-ff-defaults",rt="mas-ff-annual-price",ge={alphabetical:"alphabetical",authored:"authored"},fi=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Js="mas-commerce-service";function Ra(e,r){let t;return function(){let i=this,a=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(i,a),r)}}var _t=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function xe(e,r={},t=null,i=null){let a=i?document.createElement(e,{is:i}):document.createElement(e);t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t;for(let[n,s]of Object.entries(r))a.setAttribute(n,s);return a}function cr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function xi(){return window.matchMedia("(max-width: 1024px)").matches}function Pt(){return document.getElementsByTagName(Js)?.[0]}function Lt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}import{html as lr,nothing as ec}from"./lit-all.min.js";var it,Mt=class Mt{constructor(r){g(this,"card");z(this,it);this.card=r,this.insertVariantStyle()}getContainer(){return L(this,it,v(this,it)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,it)}insertVariantStyle(){let r=this.constructor.name;if(!Mt.styleMap[r]){Mt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=window.getComputedStyle(r),n=parseInt(a.height)||0,s=parseInt(a.marginBlockEnd)||0,o=Math.max(0,n+s),c=this.getContainer(),l=parseInt(c.style.getPropertyValue(i))||0;o>l&&c.style.setProperty(i,`${o}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let i=this.card.variant,a=Array.from(t.querySelectorAll(`merch-card[variant="${i}"]`)).filter(s=>s.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:s}of r){let o=`--consonant-merch-card-${i}-${s}-height`;t.style.getPropertyValue(o)&&t.style.removeProperty(o)}let n=new Map;for(let s of a){let o=s.getBoundingClientRect();if(o.width<=2)continue;let c=Math.round(o.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(s)}for(let s of n.values())for(let{name:o,getElement:c}of r){let l=`--consonant-merch-card-${i}-${o}-height`,d=s.map(m=>m.style.getPropertyValue(l)),p=0;for(let m of s){m.style.removeProperty(l);let h=c(m);if(!h)continue;let u=Math.max(0,parseInt(window.getComputedStyle(h).height)||0);u>p&&(p=u)}s.forEach((m,h)=>{p>0?m.style.setProperty(l,`${p}px`):d[h]&&m.style.setProperty(l,d[h])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),lr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            ${this.card.actionMenuContent?"":"hidden"}"
                ...
                ${this.promoBottom?"":bi`<slot name="promo-text"></slot
...
`;var hr=class extends w{constructor(r){super(r)}getGlobalCSS(){return Ha}renderLayout(){return Ba` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var ac=32,$a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},nt=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Re`<slot name="secure-transaction-label">
    ...
    `);import{html as pr,css as nc,unsafeCSS as yi,nothing as oc}from"./lit-all.min.js";var Ga=`
  :root {
...
`;var sc=32,qa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},ot=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>pr` <footer>
    ...
    `);import{html as Rt,css as cc,nothing as mr}from"./lit-all.min.js";var Va=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(k.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?k.isMobile?Ae`
        ...
        `:Ae`
            ...
            `:gr}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?Ae`<slot name="icons"></slot>`:gr}get secureLabelFooter(){return Ae`<footer>
...
`;var[tp,rp,Qa,Ja,en,tn]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var rn={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},Ce,Ge,Ht,Y,an,Ot,nn,It,wi,fr,vr=class vr extends w{constructor(t){super(t);z(this,Y);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);z(this,Ce,null);z(this,Ge,null);g(this,"lastSyncKey",null);z(this,Ht,({detail:t})=>{let i=t?.quantity==null?null:String(t.quantity);i==null||i===this.licenseQty||this.licenseOptions?.includes(i)&&(this.licenseQty=i,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let i=!this.expanded;for(let a of j(this,Y,an).call(this)){let n=a.variantLayout;n instanceof vr&&(n.expanded=i,a._bizproExpanded=i,a.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?j(this,Y,wi).call(this):j(this,Y,It).call(this),this.card.requestUpdate()});z(this,fr,t=>{let i=this.licenseOptions;if(!i?.length)return;let a=i.length-1;switch(t.key){case Ja:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%i.length:j(this,Y,It).call(this);break;case Qa:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+i.length)%i.length:j(this,Y,It).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=a;break;case en:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(i[this.licenseHighlightedIndex]);return}j(this,Y,It).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),j(this,Y,wi).call(this);break;case tn:this.licenseOpen&&this.selectLicenseQty(i[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,j(this,Y,Ot).call(this);let i=this.quantitySelectEl;i&&(i.selectedValue=Number(t),i.dispatchEvent(new CustomEvent(ie,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._bizproExpanded??!1}getGlobalCSS(){return Za}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let i=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),i.dataset.displayPerUnit="false",t.parentNode.insertBefore(i,t.nextSibling),await i.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),i.addEventListener(Le,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),a=i?.querySelector(".price-plan-type");if(!a)return;a.textContent=t;let n=i.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled?.();let a=i.value?.[0]?.planType;a&&(t.planType=a)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(i=>{let a=window.getComputedStyle(i),n=`${a.fontWeight} ${a.fontSize} ${a.fontFamily}`;return document.fonts.load(n,i.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(o=>requestAnimationFrame(o)),await new Promise(o=>requestAnimationFrame(o));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let i=this.card.variant,a=`--consonant-merch-card-${i}-top-card-height`,n=[...t.querySelectorAll(`merch-card[variant="${i}"]`)].filter(o=>o.getBoundingClientRect().width>2&&o.variantLayout?.card?.heightSync!==!1),s=new Map;for(let o of n){let c=s.get(o.offsetTop)??[];c.push(o),s.set(o.offsetTop,c)}for(let o of s.values()){let c=0;for(let l of o){l.style.removeProperty(a);let d=l.shadowRoot?.querySelector(".top-card");d&&(c=Math.max(c,parseInt(getComputedStyle(d).height)||0))}c>0&&o.length>1&&o.forEach(l=>l.style.setProperty(a,`${c}px`))}}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let i=this.card.querySelector('[slot="body-xs"]'),a=i?Math.round(i.getBoundingClientRect().height):0,n=`${Math.round(t)}:${a}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(sr,v(this,Ht)),this.card.addEventListener(ie,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;L(this,Ge,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Ge).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Ge).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ie,this.updatePriceQuantity),j(this,Y,Ot).call(this),v(this,Ge)?.disconnect(),this.card?.removeEventListener(sr,v(this,Ht))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let i=parseInt(t.getAttribute("min"),10),a=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(i)||Number.isNaN(a)||a<i)return null;let s=[];for(let o=i;o<=a;o+=n)s.push(String(o));return s.length?s:null}licenseLabel(t){let i=this.quantitySelectEl?.getAttribute("title")||"License",[a,n]=i.split("|").map(s=>s.trim());return Number(t)===1?a:n||a}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let i=this.quantitySelectEl?.getAttribute("default-value");return i!=null&&t.includes(i)?i:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Oe`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,i=this.currentLicenseValue,a=!!this.licenseOpen,n=this.licenseLabel(Number(i));return Oe`
        ...
        `}renderLayout(){let t=!!this.expanded;return Oe`
            ...
            ${this.hasWhatsIncluded?Oe`
                  ...
                  `:Nt}
            <slot></slot>
        `}};Ce=new WeakMap,Ge=new WeakMap,Ht=new WeakMap,Y=new WeakSet,an=function(){let t=this.card.offsetTop,i=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(a=>a.getBoundingClientRect().width>2&&a.offsetTop===t);return i.length?i:[this.card]},Ot=function(){v(this,Ce)&&(document.removeEventListener("mousedown",v(this,Ce)),L(this,Ce,null))},nn=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},It=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=j(this,Y,nn).call(this),v(this,Ce)||(L(this,Ce,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),j(this,Y,Ot).call(this))}),document.addEventListener("mousedown",v(this,Ce)))},wi=function(){this.licenseOpen=!1,j(this,Y,Ot).call(this)},fr=new WeakMap,g(vr,"variantStyle",dc`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Dt=vr;import{html as Ei,css as hc}from"./lit-all.min.js";var on=`
:root {
...
`;var sn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},we,st=class extends w{constructor(t){super(t);z(this,we);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return on}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return Ei` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){this.handleResize=()=>{v(this,we)&&cancelAnimationFrame(v(this,we)),L(this,we,requestAnimationFrame(()=>{L(this,we,null),this.postCardUpdateHook()}))},window.addEventListener("resize",this.handleResize),this.card.addEventListener(ie,this.updatePriceQuantity)}disconnectedCallbackHook(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),v(this,we)&&(cancelAnimationFrame(v(this,we)),L(this,we,null)),this.card.removeEventListener(ie,this.updatePriceQuantity)}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),k.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let i=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),t.parentNode.insertBefore(i,t.nextSibling),await i.onceSettled()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${W}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}toggleAddon(t){let i=this.mainPrice,a=this.headingXSSlot;if(!i&&a){let n=t?.getAttribute("plan-type"),s=null;if(t&&n&&(s=t.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(o=>o.remove()),t.checked){if(s){let o=xe("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},s.innerHTML);this.card.appendChild(o)}}else{let o=xe("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(o)}}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let i=this.mainPrice,a=this.card.planType;i&&(await i.onceSettled?.(),a=i.value?.[0]?.planType),a&&(t.planType=a)}};we=new WeakMap,g(st,"variantStyle",hc`
    ...
    `);import{html as Si,css as pc}from"./lit-all.min.js";var cn=`
:root {
...
`;var ln={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ct=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===ee&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return cn}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${W}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return Si`
    ...
    `);import{html as mc,css as uc}from"./lit-all.min.js";var dn=`
...
`;var hn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},lt=class extends w{constructor(r){super(r)}getGlobalCSS(){return dn}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return mc`
    ...
    `);import{html as Ai,css as gc}from"./lit-all.min.js";var pn=`
:root {
...
`;var mn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},dt=class extends w{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return pn}renderLayout(){return Ai`${this.cardImage}
    ...
    `);import{html as fc,css as vc}from"./lit-all.min.js";var un=`
:root {
...
`;var Ci={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ht=class extends w{getGlobalCSS(){return un}get aemFragmentMapping(){return Ci}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(a=>this.updateCardElementMinHeight(r.querySelector(`.${a}`),a));let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let i=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');i&&this.updateCardElementMinHeight(i,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),i=34;t.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(s=>{let o=s.textContent.trim().length>i;s.classList.toggle("small-font-size-button",o)})}),k.isDesktopOrUp&&t.forEach(a=>a.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!nr()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(t=>t.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let t=()=>{if(nr())r.removeAttribute("data-expanded");else{let a=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",a?"true":"false")}};t();let i=window.matchMedia(O);this.mediaQueryListener=()=>{t()},i.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(O).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||nr())return;let a=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",a)}renderLayout(){return fc`
    ...
    `);import{html as fn,css as xc}from"./lit-all.min.js";var gn=`
:root {
...
`;var Ti={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Bt=class Bt extends w{getGlobalCSS(){return gn}get aemFragmentMapping(){return Ti}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return fn`
    ...
    `);var Ft=Bt;import{html as ki,css as bc,nothing as yc}from"./lit-all.min.js";var vn=`
...
`;var xn={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},wc=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],pt=class extends w{constructor(r){super(r)}getGlobalCSS(){return vn}renderLayout(){return ki`
    ...
    `);import{css as Ec,html as Sc}from"./lit-all.min.js";var bn=`
...
`;var yn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},mt=class extends w{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return bn}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${W}[data-template="price"]`);if(!t)return;let i=t.cloneNode(!0);this.legal=i,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return Sc`
            ${this.badge}
            <div class="body">
...
`;var _i={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Tc=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],xr,En,ut=class extends w{constructor(t){super(t);z(this,xr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return wn}get aemFragmentMapping(){return _i}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,j(this,xr,En).call(this))}renderLayout(){return Ac`
            <div class="card">
            ...
            <slot></slot>
        `}};xr=new WeakSet,En=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Tc.forEach(({key:i,selector:a})=>this.updateCardElementMinHeight(t.querySelector(a),i))},g(ut,"variantStyle",Cc`
    ...
    `);import{html as kc,css as _c}from"./lit-all.min.js";var Sn=`

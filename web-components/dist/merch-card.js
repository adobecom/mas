...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as ot,css as Qi}from"./lit-all.min.js";var ia=`
:root {
...
`;var Nt=class extends v{constructor(r){super(r)}getGlobalCSS(){return oa}renderLayout(){return sa` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var tn=32,ma={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Fe=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Ft` <footer>
    ...
    `);import{html as st,css as rn,nothing as It}from"./lit-all.min.js";var ga=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?ee`
        ...
        `:ee`
            ...
            `:Bt}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?ee`<slot name="icons"></slot>`:Bt}get secureLabelFooter(){return ee`<footer>
...
`;var[Sc,Ac,wa,Ea,ka,Ca]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Sa={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},te,ve,T,Aa,lt,za,dt,sr,Ht,qt=class qt extends v{constructor(){super(...arguments);u(this,T);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,te,null);u(this,ve,null);h(this,"lastSyncKey",null);h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of y(this,T,Aa).call(this)){let n=i.variantLayout;n instanceof qt&&(n.expanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?y(this,T,sr).call(this):y(this,T,dt).call(this),this.card.requestUpdate()});u(this,Ht,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Ea:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:y(this,T,dt).call(this);break;case wa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:y(this,T,dt).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case ka:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}y(this,T,dt).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),y(this,T,sr).call(this);break;case Ca:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,y(this,T,lt).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(O,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return ya}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(K,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]')?.querySelector(".price-plan-type");i&&(i.textContent=e)}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=`--consonant-merch-card-${t}-top-card-height`,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(s=>s.getBoundingClientRect().width>2&&s.variantLayout?.card?.heightSync!==!1),o=new Map;for(let s of n){let l=o.get(s.offsetTop)??[];l.push(s),o.set(s.offsetTop,l)}for(let s of o.values()){let l=0;for(let d of s){d.style.removeProperty(i);let p=d.shadowRoot?.querySelector(".top-card");p&&(l=Math.max(l,parseInt(getComputedStyle(p).height)||0))}l>0&&s.length>1&&s.forEach(d=>d.style.setProperty(i,`${l}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),i=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;m(this,ve,new ResizeObserver(()=>this.resyncOnReflow())),c(this,ve).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&c(this,ve).observe(e)}disconnectedCallbackHook(){y(this,T,lt).call(this),c(this,ve)?.disconnect()}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t)return null;let o=[];for(let s=t;s<=i;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return le`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return le`
        ...
        `}renderLayout(){let e=!!this.expanded;return le`
            ...
            ${this.hasWhatsIncluded?le`
                  ...
                  `:ct}
            <slot></slot>
        `}};te=new WeakMap,ve=new WeakMap,T=new WeakSet,Aa=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},lt=function(){c(this,te)&&(document.removeEventListener("mousedown",c(this,te)),m(this,te,null))},za=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},dt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=y(this,T,za).call(this),c(this,te)||(m(this,te,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),y(this,T,lt).call(this))}),document.addEventListener("mousedown",c(this,te)))},sr=function(){this.licenseOpen=!1,y(this,T,lt).call(this)},Ht=new WeakMap,h(qt,"variantStyle",nn`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var ht=qt;import{html as cr,css as on}from"./lit-all.min.js";var Ta=`
:root {
...
`;var pr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},pt=class pt extends v{getGlobalCSS(){return Fa}get aemFragmentMapping(){return pr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ia`
    ...
    `);var mt=pt;import{html as mr,css as gn,nothing as un}from"./lit-all.min.js";var $a=`
...
`;var gr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},wn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Ut,Ga,je=class extends v{constructor(e){super(e);u(this,Ut);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ua}get aemFragmentMapping(){return gr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Ut,Ga).call(this))}renderLayout(){return xn`
            ...
            <slot></slot>
        `}};Ut=new WeakSet,Ga=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;wn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(je,"variantStyle",yn`
...
`;var ur={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ve=class extends v{getGlobalCSS(){return ja}get aemFragmentMapping(){return ur}renderLayout(){return En`
    ...
    `);var Gt=new Map,Va=new WeakMap,Wa=new Map,S=(a,r,e=null,t=null,i)=>{Gt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",De,aa,De.variantStyle);S("image",fe);S("inline-heading",Nt);S("mini-compare-chart",Ne,da,Ne.variantStyle);S("mini-compare-chart-mweb",Fe,ma,Fe.variantStyle);S("plans",D,$t,D.variantStyle,D.collectionOptions);S("plans-students",D,fa,D.variantStyle,D.collectionOptions);S("plans-education",D,ua,D.variantStyle,D.collectionOptions);S("plans-v2",ce,xa,ce.variantStyle,ce.collectionOptions);S("bizpro",ht,Sa,ht.variantStyle);S("product",Ie,La,Ie.variantStyle);S("segment",$e,_a,$e.variantStyle);S("media",Be,Ra,Be.variantStyle);S("headless",Ue,Ba,Ue.variantStyle);S("special-offers",He,Da,He.variantStyle);S("simplified-pricing-express",qe,hr,qe.variantStyle);S("full-pricing-express",mt,pr,mt.variantStyle);S("mini",Ge,qa,Ge.variantStyle);S("image",fe,na,fe.variantStyle);S("compare-chart-column",je,gr,je.variantStyle);S("fries",Ve,ur,Ve.variantStyle);var Cn=(a,r,e)=>{try{let t=Wa.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),Wa.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},fr=a=>{let r=Gt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=Va.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?Cn(a,t,i):{};return Va.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Dt(a){return Gt.get(a)?.fragmentMapping}function Ka(a){return Gt.get(a)?.collectionOptions}var Ya=document.createElement("style");Ya.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var be={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Za=1e3;function zn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Xa(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!be.serializableTypes.includes(e))return e}return a}function Tn(a,r){if(!be.ignoredProperties.includes(a))return Xa(r)}var br={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(zn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(Xa).join(" ")}`);let{pathname:o,search:s}=window.location,l=`${be.delimiter}page=${o}${s}`;l.length>Za&&(l=`${l.slice(0,Za)}<trunc>`),n+=l,i.length&&(n+=`${be.delimiter}facts=`,n+=JSON.stringify(i,Tn)),window.lana?.log(n,be)}};function Ja(a){Object.assign(be,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in be&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ei={LOCAL:"local",PROD:"prod",STAGE:"stage"},xr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},yr=new Set,wr=new Set,ti=new Map,ri={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},ai={filter:({level:a})=>a!==xr.DEBUG},Ln={filter:()=>!1};function Pn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Vt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function _n(a){[...wr].every(r=>r(a))&&yr.forEach(r=>r(a))}function ii(a){let r=(ti.get(a)??0)+1;ti.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>ii(`${t.namespace}/${i}`),updateConfig:Ja};return Object.values(xr).forEach(i=>{t[i]=(n,...o)=>_n(Pn(i,n,a,o,e))}),Object.seal(t)}function Wt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Vt(t)&&wr.add(t),Vt(e)&&yr.add(e)})}function Mn(a={}){let{name:r}=a,e=Qa(jt("commerce.debug",{search:!0,storage:!0}),r===ei.LOCAL);return Wt(e?ri:ai),r===ei.PROD&&Wt(br),gt}function Rn(){yr.clear(),wr.clear()}var gt={...ii(Xr),Level:xr,Plugins:{consoleAppender:ri,debugFilter:ai,quietFilter:Ln,lanaAppender:br},init:Mn,reset:Rn,use:Wt};var On="mas-commerce-service",Td=gt.module("utilities"),Dn={requestId:Pt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Kt=a=>window.setTimeout(a);function Er(){return document.getElementsByTagName(On)?.[0]}function ni(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Dn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function oi(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,t*(n+1)))}throw i}var si="fragment",ci="author",li="preview",di="loading",hi="mask",pi="pzn",mi="timeout",kr="aem-fragment",gi="eager",ui="cache",Nn=[gi,ui],q,xe,F,Cr=class{constructor(){u(this,q,new Map);u(this,xe,new Map);u(this,F,new Map)}clear(){c(this,q).clear(),c(this,xe).clear(),c(this,F).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(c(this,q).set(r.id,r),r.fields?.originalId&&c(this,q).set(r.fields.originalId,r),c(this,F).has(r.id)){let[,t]=c(this,F).get(r.id);t()}if(c(this,F).has(r.fields?.originalId)){let[,t]=c(this,F).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return c(this,q).has(r)}entries(){return c(this,q).entries()}get(r){return c(this,q).get(r)}getAsPromise(r){let[e]=c(this,F).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),c(this,F).set(r,[e,t]),e}getFetchInfo(r){let e=c(this,xe).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,xe).set(r,e)),e}set(r,e){if(c(this,q).set(r,e),c(this,F).has(r)){let[,t]=c(this,F).get(r);t()}}remove(r){c(this,q).delete(r),c(this,xe).delete(r),c(this,F).delete(r)}};q=new WeakMap,xe=new WeakMap,F=new WeakMap;var re=new Cr,We,$,ae,I,U,L,ut,G,j,ft,V,vt,bt,Ke,W,fi,vi,Sr,bi,Yt=class extends HTMLElement{constructor(){super(...arguments);u(this,W);h(this,"cache",re);u(this,We);u(this,$,null);u(this,ae,null);u(this,I,null);u(this,U);u(this,L);u(this,ut,gi);u(this,G);u(this,j);u(this,ft,5e3);u(this,V);u(this,vt,!1);u(this,bt,0);u(this,Ke)}static get observedAttributes(){return[si,di,mi,ci,li,hi,pi]}cacheKey(){return`${c(this,U)}${c(this,j)?`-p_${c(this,j)}`:""}${c(this,G)?`-m_${c(this,G)}`:""}`}attributeChangedCallback(e,t,i){e===si&&(m(this,U,i),m(this,L,re.getFetchInfo(this.cacheKey()))),e===hi&&m(this,G,i),e===pi&&m(this,j,i),e===di&&Nn.includes(i)&&m(this,ut,i),e===mi&&m(this,ft,parseInt(i,10)),e===ci&&m(this,vt,["","true"].includes(i)),e===li&&m(this,Ke,i)}connectedCallback(){if(!c(this,V)){if(c(this,I)??m(this,I,ge(this)),m(this,Ke,c(this,I).settings?.preview),c(this,We)??m(this,We,c(this,I).log.module(`${kr}[${c(this,U)}]`)),!c(this,U)||c(this,U)==="#"){c(this,L)??m(this,L,re.getFetchInfo("missing-fragment-id")),y(this,W,Sr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,L)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(c(this,V)&&!await Promise.race([c(this,V),Promise.resolve(!1)]))return;e&&re.remove(this.cacheKey()),c(this,ut)===ui&&await Promise.race([re.getAsPromise(this.cacheKey()),new Promise(s=>setTimeout(s,c(this,ft)))]);try{m(this,V,y(this,W,bi).call(this)),await c(this,V)}catch(s){return y(this,W,Sr).call(this,s.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=c(this,$)||{};return o&&!jt("mas.disableWcsCache")&&c(this,I).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Le,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...c(this,L)},bubbles:!0,composed:!0})),c(this,V)}get updateComplete(){return c(this,V)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,ae)?c(this,ae):(c(this,vt)?this.transformAuthorData():this.transformPublishData(),c(this,ae))}get rawData(){return c(this,$)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,settings:s={},priceLiterals:l={},dictionary:d={},placeholders:p={}}=c(this,$);m(this,ae,e.reduce((g,{name:f,multiple:C,values:N})=>(g.fields[f]=C?N:N[0],g),{fields:{},id:t,tags:n,settings:s,priceLiterals:l,dictionary:d,maskId:i,placeholders:p,variationId:o}))}transformPublishData(){if(!c(this,$))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},maskId:l,placeholders:d={},variationId:p}=c(this,$);m(this,ae,Object.entries(e).reduce((g,[f,C])=>(g.fields[f]=C?.mimeType?C.value:C??"",g),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:s,maskId:l,placeholders:d,variationId:p}))}getFragmentClientUrl(){let t=new URLSearchParams(window.location.search).get("maslibs");if(!t||t.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=t.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:c(this,I).settings.locale,apiKey:c(this,I).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??c(this,I).settings.instant,o={...i,...n!=null?{instant:n}:{},...c(this,G)!=null?{mask:c(this,G)}:{},...c(this,j)!=null?{pzn:c(this,j)}:{}};return await t(c(this,U),o)}};We=new WeakMap,$=new WeakMap,ae=new WeakMap,I=new WeakMap,U=new WeakMap,L=new WeakMap,ut=new WeakMap,G=new WeakMap,j=new WeakMap,ft=new WeakMap,V=new WeakMap,vt=new WeakMap,bt=new WeakMap,Ke=new WeakMap,W=new WeakSet,fi=async function(e){Or(this,bt)._++;let t=`${kr}:${this.cacheKey()}:${c(this,bt)}`,i=`${t}${_t}`,n=`${t}${Mt}`;if(c(this,Ke)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new de(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(c(this,L).stale=!1,c(this,L).url=e,o=await oi(e,{cache:"default",credentials:"omit"}),y(this,W,vi).call(this,o),c(this,L).status=o?.status,c(this,L).measure=_e(performance.measure(n,i)),c(this,L).retryCount=o.retryCount,!o?.ok)throw new de("Unexpected fragment response",{response:o,...c(this,I).duration});return await o.json()}catch(s){if(c(this,L).measure=_e(performance.measure(n,i)),c(this,L).retryCount=s.retryCount,c(this,$))return c(this,L).stale=!0,c(this,We).error("Serving stale data",c(this,L)),c(this,$);let l=s.message??"unknown";throw new de(`Failed to fetch fragment: ${l}`,{})}},vi=function(e){Object.assign(c(this,L),ni(e))},Sr=function(e){m(this,V,null),c(this,L).message=e,this.classList.add("error");let t={...c(this,L),...c(this,I).duration};c(this,We).error(e,t),this.dispatchEvent(new CustomEvent(Pe,{detail:t,bubbles:!0,composed:!0}))},bi=async function(){var l;this.classList.remove("error"),m(this,ae,null);let e=re.get(this.cacheKey());if(e)return m(this,$,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=c(this,I).settings,s=`${t}/fragment?id=${c(this,U)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),c(this,G)&&(s+=`&mask=${c(this,G)}`),c(this,j)&&(s+=`&pzn=${c(this,j)}`),e=await y(this,W,fi).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,U)),c(this,G)||c(this,j)?re.set(this.cacheKey(),e):re.add(e),m(this,$,e),!0},h(Yt,"cache",re);customElements.define(kr,Yt);import{LitElement as Fn,html as Ar,css as In,nothing as $n}from"./lit-all.min.js";import{unsafeHTML as Bn}from"./lit-all.min.js";var Hn=a=>a?a.startsWith("sp-icon-")?Ar`${Bn(`<${a} class="badge-icon"></${a}>`)}`:Ar`<img src="${a}" class="badge-icon" />`:$n,Ye=class extends Fn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Ar`<div class="badge">
    ...
    `),h(xt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",xt);import{html as zr,css as jn,LitElement as Vn,nothing as xi}from"./lit-all.min.js";var yt=class extends Vn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return zr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?zr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:xi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(yt,"styles",jn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

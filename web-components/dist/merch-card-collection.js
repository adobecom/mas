var Ja=Object.defineProperty;var ei=e=>{throw TypeError(e)};var jo=(e,t,r)=>t in e?Ja(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var Wo=(e,t)=>{for(var r in t)Ja(e,r,{get:t[r],enumerable:!0})};var f=(e,t,r)=>jo(e,typeof t!="symbol"?t+"":t,r),Sr=(e,t,r)=>t.has(e)||ei("Cannot "+r);var S=(e,t,r)=>(Sr(e,t,"read from private field"),r?r.call(e):t.get(e)),G=(e,t,r)=>t.has(e)?ei("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),W=(e,t,r,a)=>(Sr(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),mt=(e,t,r)=>(Sr(e,t,"access private method"),r);import{html as Ae,LitElement as Io,css as Do,unsafeCSS as Oo,nothing as me}from"./lit-all.min.js";var O="(max-width: 767px)",X="(max-width: 1199px)",I="(min-width: 768px)",T="(min-width: 1200px)",Z="(min-width: 1600px)",ti={matchMobile:window.matchMedia(O),matchDesktop:window.matchMedia(`${T} and (not ${Z})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(Z),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},C=ti;function Gt(){return ti.isDesktop}var ut=class{constructor(t,r){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(r),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};var ri="hashchange";function Yo(e=window.location.hash){let t=[],r=e.replace(/^#/,"").split("&");for(let a of r){let[i,n=""]=a.split("=");i&&t.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(t)}function gt(e){let t=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?t.set(i,n):t.delete(i)}),t.sort();let r=t.toString();if(r===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=r,window.scrollTo(0,a)}function ai(e){let t=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let r=Yo(window.location.hash);e(r)};return t(),window.addEventListener(ri,t),()=>{window.removeEventListener(ri,t)}}var Kr={};Wo(Kr,{CLASS_NAME_FAILED:()=>Nr,CLASS_NAME_HIDDEN:()=>Ko,CLASS_NAME_PENDING:()=>Or,CLASS_NAME_RESOLVED:()=>Ir,CheckoutWorkflow:()=>hs,CheckoutWorkflowStep:()=>ee,Commitment:()=>Re,ERROR_MESSAGE_BAD_REQUEST:()=>Dr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>cs,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Hr,EVENT_AEM_ERROR:()=>Mr,EVENT_AEM_LOAD:()=>kr,EVENT_MAS_ERROR:()=>Rr,EVENT_MAS_READY:()=>ss,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>ns,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Cr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>de,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Pr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>ft,EVENT_MERCH_CARD_COLLECTION_SORT:()=>_r,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>is,EVENT_MERCH_OFFER_READY:()=>Jo,EVENT_MERCH_OFFER_SELECT_READY:()=>es,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ue,EVENT_MERCH_SEARCH_CHANGE:()=>os,EVENT_MERCH_SIDENAV_SELECT:()=>Lr,EVENT_MERCH_STOCK_CHANGE:()=>rs,EVENT_MERCH_STORAGE_CHANGE:()=>as,EVENT_OFFER_SELECTED:()=>ts,EVENT_TYPE_FAILED:()=>zr,EVENT_TYPE_READY:()=>qt,EVENT_TYPE_RESOLVED:()=>Br,Env:()=>ge,FF_ANNUAL_PRICE:()=>je,FF_DEFAULTS:()=>xe,HEADER_X_REQUEST_ID:()=>vt,LOG_NAMESPACE:()=>Fr,Landscape:()=>Te,MARK_DURATION_SUFFIX:()=>Yr,MARK_START_SUFFIX:()=>Wr,MODAL_TYPE_3_IN_1:()=>Ne,NAMESPACE:()=>Xo,PARAM_AOS_API_KEY:()=>ls,PARAM_ENV:()=>$r,PARAM_LANDSCAPE:()=>Gr,PARAM_MAS_PREVIEW:()=>Ur,PARAM_WCS_API_KEY:()=>ds,PROVIDER_ENVIRONMENT:()=>jr,SELECTOR_MAS_CHECKOUT_LINK:()=>ii,SELECTOR_MAS_ELEMENT:()=>Tr,SELECTOR_MAS_INLINE_PRICE:()=>q,SELECTOR_MAS_SP_BUTTON:()=>Qo,SELECTOR_MAS_UPT_LINK:()=>ni,SORT_ORDER:()=>pe,STATE_FAILED:()=>he,STATE_PENDING:()=>Se,STATE_RESOLVED:()=>ve,SUPPORTED_COUNTRIES:()=>Xr,TAG_NAME_SERVICE:()=>Zo,TEMPLATE_PRICE:()=>ps,TEMPLATE_PRICE_ANNUAL:()=>us,TEMPLATE_PRICE_LEGAL:()=>ne,TEMPLATE_PRICE_STRIKETHROUGH:()=>ms,Term:()=>ce,WCS_PROD_URL:()=>qr,WCS_STAGE_URL:()=>Vr});var Re=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ce=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Xo="merch",Ko="hidden",qt="wcms:commerce:ready",Zo="mas-commerce-service",q='span[is="inline-price"][data-wcs-osi]',ii='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Qo="sp-button[data-wcs-osi]",ni='a[is="upt-link"]',Tr=`${q},${ii},${ni}`,Jo="merch-offer:ready",es="merch-offer-select:ready",Cr="merch-card:action-menu-toggle",ts="merch-offer:selected",rs="merch-stock:change",as="merch-storage:change",ue="merch-quantity-selector:change",is="merch-card-quantity:change",ns="merch-modal:addon-and-quantity-update",os="merch-search:change",_r="merch-card-collection:sort",de="merch-card-collection:literals-changed",ft="merch-card-collection:sidenav-attached",Pr="merch-card-collection:showmore",Lr="merch-sidenav:select",kr="aem:load",Mr="aem:error",ss="mas:ready",Rr="mas:error",Nr="placeholder-failed",Or="placeholder-pending",Ir="placeholder-resolved",Dr="Bad WCS request",Hr="Commerce offer not found",cs="Literals URL not provided",zr="mas:failed",Br="mas:resolved",Fr="mas/commerce",Ur="mas.preview",$r="commerce.env",Gr="commerce.landscape",ls="commerce.aosKey",ds="commerce.wcsKey",qr="https://www.adobe.com/web_commerce_artifact",Vr="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",Se="pending",ve="resolved",Te={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},vt="X-Request-Id",ee=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),hs="UCv3",ge=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),jr={PRODUCTION:"PRODUCTION"},Ne={TWP:"twp",D2P:"d2p",CRM:"crm"},Wr=":start",Yr=":duration",ps="price",ms="price-strikethrough",us="annual",ne="legal",xe="mas-ff-defaults",je="mas-ff-annual-price",pe={alphabetical:"alphabetical",authored:"authored"},Xr=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var gs="mas-commerce-service";var xt=(e,t)=>e?.querySelector(`[slot="${t}"]`)?.textContent?.trim();function fe(e,t={},r=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function Vt(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Zr(){return window.matchMedia("(max-width: 1024px)").matches}function bt(){return document.getElementsByTagName(gs)?.[0]}function yt(e){let t=window.getComputedStyle(e);return e.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}import{html as jt,nothing as fs}from"./lit-all.min.js";var We,wt=class wt{constructor(t){f(this,"card");G(this,We);this.card=t,this.insertVariantStyle()}getContainer(){return W(this,We,S(this,We)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),S(this,We)}insertVariantStyle(){let t=this.constructor.name;if(!wt.styleMap[t]){wt.styleMap[t]=!0;let r=document.createElement("style");r.innerHTML=this.getGlobalCSS(),document.head.appendChild(r)}}updateCardElementMinHeight(t,r){if(!t||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${r}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),jt`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return this.constructor.fragmentMapping??null}};We=new WeakMap,f(wt,"styleMap",{});var L=wt;import{html as Qr,css as vs}from"./lit-all.min.js";var oi=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Et,css as xs}from"./lit-all.min.js";var ci=`
:root {
...
`;var Wt=class extends L{constructor(t){super(t)}getGlobalCSS(){return di}renderLayout(){return hi` ${this.badge}
            ...
            ${this.card.customHr?"":hi`<hr />`} ${this.secureLabelFooter}`}};import{html as Ce,css as bs,unsafeCSS as mi}from"./lit-all.min.js";var pi=`
  :root {
...
`;var Kt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},bi={...function(){let{whatsIncluded:e,size:t,...r}=Kt;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},yi={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:a,...i}=Kt;return i}()},te=class extends L{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,r){t.dataset.template===ne&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return xi}adjustSlotPlacement(t,r,a){let i=this.card.shadowRoot,n=i.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=i.querySelector(`footer slot[name="${t}"]`),c=i.querySelector(`.body slot[name="${t}"]`),l=i.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(o)){if(n?.classList.toggle("wide-footer",C.isDesktopOrUp),!a&&s){if(c)s.remove();else{let d=l.querySelector(`[data-placeholder-for="${t}"]`);d?d.replaceWith(s):l.appendChild(s)}return}if(a&&c){let d=document.createElement("div");if(d.setAttribute("data-placeholder-for",t),d.classList.add("slot-placeholder"),!s){let p=c.cloneNode(!0);n.prepend(p)}c.replaceWith(d)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],C.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],C.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let a=r.querySelector("ul");if(!a)return;let i=a.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),r.insertBefore(n,i);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let c=0,l=this.card.querySelector('[slot="heading-s"]');l&&(c+=yt(l));let d=this.card.querySelector('[slot="subtitle"]');d&&(c+=yt(d));let p=this.card.querySelector('[slot="heading-m"]');p&&(c+=8+yt(p));for(let h of r.childNodes){if(h.classList.contains("spacer"))break;c+=yt(h)}let u=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");c>(parseFloat(u)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${c}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${c}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${q}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?At`<div class="divider"></div>`:Xt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],r=this.card.querySelector(`[slot="heading-m"] ${q}[data-template="price"]`);r&&t.push(r);let a=t.map(async i=>{let n=i.cloneNode(!0);await i.onceSettled(),i?.options&&(i.options.displayPerUnit&&(i.dataset.displayPerUnit="false"),i.options.displayTax&&(i.dataset.displayTax="false"),i.options.displayPlanType&&(i.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),i.parentNode.insertBefore(n,i.nextSibling),await n.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let a=r.value?.[0]?.planType;a&&(t.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?At`<label id="stock-checkbox">
    ...
    `),f(te,"collectionOptions",{customHeaderArea:t=>t.sidenav?At`<slot name="resultsText"></slot>`:Xt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let r=()=>{let a=t.querySelectorAll("merch-card");for(let n of a)n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"));if(!C.isDesktop)return;let i=0;for(let n of a){if(n.style.display==="none")continue;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),i+=s}};C.matchDesktop.addEventListener("change",r),t.addEventListener(de,r),t.onUnmount.push(()=>{C.matchDesktop.removeEventListener("change",r),t.removeEventListener(de,r)})}});import{html as be,css as Ts,unsafeCSS as Ei,nothing as Zt}from"./lit-all.min.js";var wi=`
:root {
...
`;var Ti={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ze=class extends L{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Si}priceOptionsProvider(t,r){t.dataset.template===ne&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Jr` ${this.badge}
    ...
    `);import{html as ea,css as _s}from"./lit-all.min.js";var Ci=`
:root {
...
`;var _i={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Qe=class extends L{constructor(t){super(t)}priceOptionsProvider(t,r){t.dataset.template===ne&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}getGlobalCSS(){return Ci}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${q}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let r=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),t.parentNode.insertBefore(r,t.nextSibling),await r.onceSettled()}catch{}}renderLayout(){return ea`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Li={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Je=class extends L{constructor(t){super(t)}getGlobalCSS(){return Pi}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return Ps`
    ...
    `);import{html as ta,css as ks}from"./lit-all.min.js";var ki=`
:root {
...
`;var ra={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},tt=class extends L{getGlobalCSS(){return Ri}get aemFragmentMapping(){return ra}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let r=this.card.querySelector('[slot="price"]');r&&this.updateCardElementMinHeight(r,"price");let a=this.card.querySelector('[slot="callout-content"]');a&&this.updateCardElementMinHeight(a,"callout");let i=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');i&&this.updateCardElementMinHeight(i,"icons")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),C.isDesktopOrUp)){let t=this.getContainer();if(!t)return;requestAnimationFrame(()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(a=>a.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Gt()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let r=()=>{if(Gt())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};r();let a=window.matchMedia(O);this.mediaQueryListener=()=>{r()},a.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(O).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||Gt())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return Ms`
    ...
    `);import{html as Oi,css as Ns}from"./lit-all.min.js";var Ni=`
:root {
...
`,$e.MISSING_INTL_API,o);var A=r.getPluralRules(t,{type:d.pluralType}).select(u-(d.offset||0));v=d.options[A]||d.options.other}if(!v)throw new za(d.value,u,Object.keys(d.options),o);s.push.apply(s,Ot(v.value,t,r,a,i,u-(d.offset||0)));continue}}return ll(s)}function hl(e,t){return t?_(_(_({},e||{}),t||{}),Object.keys(e).reduce(function(r,a){return r[a]=_(_({},e[a]),t[a]||{}),r},{})):e}function pl(e,t){return t?Object.keys(e).reduce(function(r,a){return r[a]=hl(e[a],t[a]),r},_({},e)):e}function Ba(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function ml(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Rt(function(){for(var t,r=[],a=0;a<arguments.length;a++)r[a]=arguments[a];return new((t=Intl.NumberFormat).bind.apply(t,dr([void 0],r,!1)))},{cache:Ba(e.number),strategy:xr.variadic}),getDateTimeFormat:Rt(function(){for(var t,r=[],a=0;a<arguments.length;a++)r[a]=arguments[a];return new((t=Intl.DateTimeFormat).bind.apply(t,dr([void 0],r,!1)))},{cache:Ba(e.dateTime),strategy:xr.variadic}),getPluralRules:Rt(function(){for(var t,r=[],a=0;a<arguments.length;a++)r[a]=arguments[a];return new((t=Intl.PluralRules).bind.apply(t,dr([void 0],r,!1)))},{cache:Ba(e.pluralRules),strategy:xr.variadic})}}var io=function(){function e(t,r,a,i){var n=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==K.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Ot(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=pl(e.formats,a),this.formatters=i&&i.formatters||ml(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Jn,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var no=io;var Fa={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},ul=ji("ConsonantTemplates/price"),gl=/<\/?[^>]+(>|$)/g,B={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Le={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ua="TAX_EXCLUSIVE",fl=e=>Gi(e)?Object.entries(e).filter(([,t])=>nt(t)||Jt(t)||t===!0).reduce((t,[r,a])=>t+` ${r}${a===!0?"":'="'+$i(a)+'"'}`,""):"",U=(e,t,r,a=!1)=>`<span class="${e}${t?"":" "+B.disabled}"${fl(r)}>${a?fn(t):t??""}</span>`;function vl(e){e=e.replaceAll("</a>","&lt;/a&gt;");let t=/<a [^>]+(>|$)/g;return e.match(t)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function xl(e){e=e.replaceAll("&lt;/a&gt;","</a>");let t=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(t)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function we(e,t,r,a){let i=e[r];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?vl(i):i,i=n?i.replace(gl,""):i;let s=new no(i,t).format(a);return o?xl(s):s}catch{return ul.error("Failed to format literal:",i),""}}function bl(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},u={}){let h=U(B.currencySymbol,a),m=U(B.currencySpace,o?"&nbsp;":""),g="";return t?g=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(g=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(g+=h+m),g+=U(B.integer,s),g+=U(B.decimalsDelimiter,n),g+=U(B.decimals,i),c||(g+=m+h),g+=U(B.recurrence,l,null,!0),g+=U(B.unitType,d,null,!0),g+=U(B.taxInclusivity,p,!0),U(e,g,{...u})}var Y=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:u={},quantity:h=1,space:m=!1,isPromoApplied:g=!1}={},{commitment:x,offerSelectorIds:b,formatString:E,price:v,priceWithoutDiscount:A,taxDisplay:N,taxTerm:M,term:z,usePrecision:$,promotion:Q}={},j={})=>{Object.entries({country:o,formatString:E,language:p,price:v}).forEach(([qo,Vo])=>{if(Vo==null)throw new Error(`Argument "${qo}" is missing for osi ${b?.toString()}, country ${o}, language ${p}`)});let F={...Fa,...u},R=`${p.toLowerCase()}-${o.toUpperCase()}`,J;Q&&!g&&A?J=e||a?v:A:r&&A?J=A:J=v;let se=t?xn:bn;i&&(se=yn);let{accessiblePrice:qe,recurrenceTerm:Xa,...Ka}=se({commitment:x,formatString:E,instant:n,isIndianPrice:o==="IN",originalPrice:v,priceWithoutDiscount:A,price:t?v:J,promotion:Q,quantity:h,term:z,usePrecision:$}),wr="",Er="",Ar="";y(c)&&Xa&&(Ar=we(F,R,Le.recurrenceLabel,{recurrenceTerm:Xa}));let Ut="";y(l)&&(m&&(Ut+=" "),Ut+=we(F,R,Le.perUnitLabel,{perUnit:"LICENSE"}));let $t="";y(d)&&M&&(m&&($t+=" "),$t+=we(F,R,N===Ua?Le.taxExclusiveLabel:Le.taxInclusiveLabel,{taxTerm:M})),r&&(wr=we(F,R,Le.strikethroughAriaLabel,{strikethroughPrice:wr})),e&&(Er=we(F,R,Le.alternativePriceAriaLabel,{alternativePrice:Er}));let Me=B.container;if(t&&(Me+=" "+B.containerOptical),r&&(Me+=" "+B.containerStrikethrough),a&&(Me+=" "+B.containerPromoStrikethrough),e&&(Me+=" "+B.containerAlternative),i&&(Me+=" "+B.containerAnnual),y(s))return bl(Me,{...Ka,accessibleLabel:wr,altAccessibleLabel:Er,recurrenceLabel:Ar,perUnitLabel:Ut,taxInclusivityLabel:$t},j);let{currencySymbol:Za,decimals:Bo,decimalsDelimiter:Fo,hasCurrencySpace:Qa,integer:Uo,isCurrencyFirst:$o}=Ka,Ve=[Uo,Fo,Bo];$o?(Ve.unshift(Qa?"\xA0":""),Ve.unshift(Za)):(Ve.push(Qa?"\xA0":""),Ve.push(Za)),Ve.push(Ar,Ut,$t);let Go=Ve.join("");return U(Me,Go,j)},oo=()=>(e,t,r)=>{let a=Fe(t.promotion,t.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||y(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price&&(!t.promotion||a);return`${n?Y({displayStrikethrough:!0})({isPromoApplied:a,...e},t,r)+"&nbsp;":""}${Y({isAlternativePrice:n})({isPromoApplied:a,...e},t,r)}`},so=()=>(e,t,r)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=Fe(t.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return Y()(e,{...t,price:t.priceWithoutDiscount},r)+U(B.containerAnnualPrefix,"&nbsp;(")+Y({displayAnnual:!0,instant:a})(n,{...t,price:t.priceWithoutDiscount},r)+U(B.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||y(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${s?Y({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${Y({isAlternativePrice:s})({isPromoApplied:i,...e},t,r)}${U(B.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0,instant:a})(n,t,r)}${U(B.containerAnnualSuffix,")")}`},co=()=>(e,t,r)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${Y({isAlternativePrice:e.displayOldPrice})(e,t,r)}${U(B.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0})(a,t,r)}${U(B.containerAnnualSuffix,")")}`};var It={...B,containerLegal:"price-legal",planType:"price-plan-type"},br={...Le,planTypeLabel:"planTypeLabel"};function yl(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:a},i={}){let n="";return n+=U(It.unitType,t,null,!0),r&&a&&(r+=". "),n+=U(It.taxInclusivity,r,!0),n+=U(It.planType,a,null),U(e,n,{...i})}var lo=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:a=!1,language:i,literals:n={}}={},{taxDisplay:o,taxTerm:s,planType:c}={},l={})=>{let d={...Fa,...n},p=`${i.toLowerCase()}-${e.toUpperCase()}`,u="";y(t)&&(u=we(d,p,br.perUnitLabel,{perUnit:"LICENSE"}));let h="";e==="US"&&i==="en"&&(r=!1),y(r)&&s&&(h=we(d,p,o===Ua?br.taxExclusiveLabel:br.taxInclusiveLabel,{taxTerm:s}));let m="";y(a)&&c&&(m=we(d,p,br.planTypeLabel,{planType:c}));let g=It.container;return g+=" "+It.containerLegal,yl(g,{perUnitLabel:u,taxInclusivityLabel:h,planTypeLabel:m},l)};var ho=Y(),po=oo(),mo=Y({displayOptical:!0}),uo=Y({displayStrikethrough:!0}),go=Y({displayPromoStrikethrough:!0}),fo=Y({displayAnnual:!0}),vo=Y({displayOptical:!0,isAlternativePrice:!0}),xo=Y({isAlternativePrice:!0}),bo=co(),yo=so(),wo=lo;var wl=(e,t)=>{if(!(!St(e)||!St(t)))return Math.floor((t-e)/t*100)},Eo=()=>(e,t)=>{let{price:r,priceWithoutDiscount:a}=t,i=wl(r,a);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Ao=Eo();var So="INDIVIDUAL_COM",Ga="TEAM_COM",To="INDIVIDUAL_EDU",qa="TEAM_EDU",El=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","LU_de","LU_en","LU_fr","MY_en","MY_ms","MU_en","NL_nl","NO_nb","NZ_en","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TH_en","TH_th","TR_tr","UA_uk"],Al={[So]:["LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko","ZA_en"],[Ga]:["LT_lt","LV_lv","NG_en","CO_es","KR_ko","ZA_en"],[To]:["LT_lt","LV_lv","SA_en","SG_en","SA_ar"],[qa]:["SG_en","KR_ko"]},Sl={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0],ZA_en:[!1,!1,!1,!1]},Tl=[So,Ga,To,qa],Cl=e=>[Ga,qa].includes(e);function $a(e,t,r,a){if(e[t])return e[t];let i=`${t}_${r}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${t}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${t}_`));n=o?e[o]:null}return n}var _l=(e,t,r,a)=>{let i=`${r}_${a}`,n=$a(Sl,e,t,!1);if(n){let o=Tl.indexOf(i);return n[o]}return Cl(i)},Pl=(e,t,r,a)=>{if($a(El,e,t,!0))return!0;let i=Al[`${r}_${a}`];return i?$a(i,e,t,!0)?!0:k.displayTax:k.displayTax},Va=async(e,t,r,a)=>{let i=Pl(e,t,r,a);return{displayTax:i,forceTaxExclusive:i?_l(e,t,r,a):k.forceTaxExclusive}},Dt=class Dt extends HTMLSpanElement{constructor(){super();f(this,"masElement",new Pe(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(r){let a=ae();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:u,quantity:h,alternativePrice:m,template:g,wcsOsi:x}=a.collectPriceOptions(r);return cr(Dt,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:u,quantity:h,alternativePrice:m,template:g,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(r,a,i){this.masElement.attributeChangedCallback(r,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===he}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let a=ae();if(!a)return!1;let i=a.collectPriceOptions(r,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let m=Ct(h,n);return m?.length?m[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=wa(l);if(a.featureFlags[xe]||n[xe]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:m}=n,[g=""]=p.marketSegments,x=await Va(h,m,p.customerSegment,g);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(b=>{let E=Ct(b,n);return E?.length?E[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[je]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,m]=d,g={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:m.priceDetails?.price}};return this.renderOffers([g],n,o)}let u=wa(d);return this.renderOffers([u],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(r,a,i=void 0){if(!this.isConnected)return;let n=ae();if(!n)return!1;if(i??(i=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(i,r,a)){this.innerHTML=n.buildPriceHTML(r,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(r,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};f(Dt,"is","inline-price"),f(Dt,"tag","span");var Ee=Dt;window.customElements.get(Ee.is)||window.customElements.define(Ee.is,Ee,{extends:Ee.tag});function Co({literals:e,providers:t,settings:r}){function a(o,s=null){let c={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(s&&t?.price)for(let M of t.price)M(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:u,displayPlanType:h,forceTaxExclusive:m,perpetual:g,displayAnnual:x,promotionCode:b,quantity:E,alternativePrice:v,wcsOsi:A,...N}=Object.assign(c,s?.dataset??{},o??{});return c=er(Object.assign({...c,...N,displayOldPrice:y(l),displayPerUnit:y(d),displayRecurrence:y(p),displayTax:y(u),displayPlanType:y(h),forceTaxExclusive:y(m),perpetual:y(g),displayAnnual:y(x),promotionCode:rr(b).effectivePromoCode,quantity:ot(E,k.quantity),alternativePrice:y(v),wcsOsi:sr(A)})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Ao;break;case"strikethrough":l=uo;break;case"promo-strikethrough":l=go;break;case"annual":l=fo;break;case"legal":l=wo;break;default:s.template==="optical"&&s.alternativePrice?l=vo:s.template==="optical"?l=mo:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode?yo:bo:s.alternativePrice?l=xo:l=s.promotionCode?po:ho}let[d]=o;return d={...d,...d.priceDetails},l({...r,...s},d)}let n=Ee.createInlinePrice;return{InlinePrice:Ee,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Ll({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||k.language),t??(t=e?.split("_")?.[1]||k.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function _o(e={},t){let r=t.featureFlags[xe],{commerce:a={}}=e,i=ge.PRODUCTION,n=qr,o=H("checkoutClientId",a)??k.checkoutClientId,s=Tt(H("checkoutWorkflowStep",a),ee,k.checkoutWorkflowStep),c=y(H("displayOldPrice",a),k.displayOldPrice),l=k.displayPerUnit,d=y(H("displayRecurrence",a),k.displayRecurrence),p=y(H("displayTax",a),k.displayTax),u=y(H("displayPlanType",a),k.displayPlanType),h=y(H("entitlement",a),k.entitlement),m=y(H("modal",a),k.modal),g=y(H("forceTaxExclusive",a),k.forceTaxExclusive),x=H("promotionCode",a)??k.promotionCode,b=ot(H("quantity",a)),E=H("wcsApiKey",a)??k.wcsApiKey,v=a?.env==="stage",A=Te.PUBLISHED;["true",""].includes(a.allowOverride)&&(v=(H($r,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",A=Tt(H(Gr,a),Te,A)),v&&(i=ge.STAGE,n=Vr);let M=H(Ur)??e.preview,z=typeof M<"u"&&M!=="off"&&M!=="false",$={};z&&($={preview:z});let Q=H("mas-io-url")??e.masIOUrl??`https://www${i===ge.STAGE?".stage":""}.adobe.com/mas/io`,j=H("preselect-plan")??void 0;return{...Ll(e),...$,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:u,entitlement:h,extraOptions:k.extraOptions,modal:m,env:i,forceTaxExclusive:g,promotionCode:x,quantity:b,alternativePrice:k.alternativePrice,wcsApiKey:E,wcsURL:n,landscape:A,masIOUrl:Q,...j&&{preselectPlan:j}}}async function Po(e,t={},r=2,a=100){let i;for(let n=0;n<=r;n++)try{let o=await fetch(e,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>r)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var ja="wcs";function Lo({settings:e}){let t=re.module(ja),{env:r,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(m,g,x=!0){let b=ae(),E=Hr;t.debug("Fetching:",m);let v="",A;if(m.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let N=new Map(g),[M]=m.offerSelectorIds,z=Date.now()+Math.random().toString(36).substring(2,7),$=`${ja}:${M}:${z}${Wr}`,Q=`${ja}:${M}:${z}${Yr}`,j;try{if(performance.mark($),v=new URL(e.wcsURL),v.searchParams.set("offer_selector_ids",M),v.searchParams.set("country",m.country),v.searchParams.set("locale",m.locale),v.searchParams.set("landscape",r===ge.STAGE?"ALL":e.landscape),v.searchParams.set("api_key",a),m.language&&v.searchParams.set("language",m.language),m.promotionCode&&v.searchParams.set("promotion_code",m.promotionCode),m.currency&&v.searchParams.set("currency",m.currency),A=await Po(v.toString(),{credentials:"omit"}),A.ok){let F=[];try{let R=await A.json();t.debug("Fetched:",m,R),F=R.resolvedOffers??[]}catch(R){t.error(`Error parsing JSON: ${R.message}`,{...R.context,...b?.duration})}F=F.map(ar),g.forEach(({resolve:R},J)=>{let se=F.filter(({offerSelectorIds:qe})=>qe.includes(J)).flat();se.length&&(N.delete(J),g.delete(J),R(se))})}else E=Dr}catch(F){E=`Network error: ${F.message}`}finally{j=performance.measure(Q,$),performance.clearMarks($),performance.clearMeasures(Q)}if(x&&g.size){t.debug("Missing:",{offerSelectorIds:[...g.keys()]});let F=on(A);g.forEach(R=>{R.reject(new st(E,{...m,...F,response:A,measure:Vt(j),...b?.duration}))})}}function l(){clearTimeout(o);let m=[...n.values()];n.clear(),m.forEach(({options:g,promises:x})=>c(g,x))}function d(m){if(!m||typeof m!="object")throw new TypeError("Cache must be a Map or similar object");let g=r===ge.STAGE?"stage":"prod",x=m[g];if(!x||typeof x!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[b,E]of Object.entries(x))i.set(b,Promise.resolve(E.map(ar)));t.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let m=i.size;s=new Map(i),i.clear(),t.debug(`Moved ${m} cache entries to stale cache`)}function u(m,g,x){let b=m!=="GB"&&!x?"MULT":"en",E=Xr.includes(m)?m:k.country;return{validCountry:E,validLanguage:b,locale:`${g}_${E}`}}function h({country:m,language:g,perpetual:x=!1,promotionCode:b="",wcsOsi:E=[]}){let{validCountry:v,validLanguage:A,locale:N}=u(m,g,x),M=[v,A,b].filter(z=>z).join("-").toLowerCase();return E.map(z=>{let $=`${z}-${M}`;if(i.has($))return i.get($);let Q=new Promise((j,F)=>{let R=n.get(M);R||(R={options:{country:v,locale:N,...A==="MULT"&&{language:A},offerSelectorIds:[]},promises:new Map},n.set(M,R)),b&&(R.options.promotionCode=b),R.options.offerSelectorIds.push(z),R.promises.set(z,{resolve:j,reject:F}),l()}).catch(j=>{if(s.has($))return s.get($);throw j});return i.set($,Q),Q})}return{Commitment:Re,PlanType:Yi,Term:ce,applyPlanType:ar,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:u}}var ko="mas-commerce-service",Mo="mas-commerce-service:start",Ro="mas-commerce-service:ready",Ht,lt,Ge,No,Ya,Wa=class extends HTMLElement{constructor(){super(...arguments);G(this,Ge);G(this,Ht);G(this,lt);f(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await r?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return S(this,lt)||W(this,lt,{[xe]:mt(this,Ge,Ya).call(this,xe),[je]:mt(this,Ge,Ya).call(this,je)}),S(this,lt)}activate(){let r=S(this,Ge,No),a=_o(r,this);ir(r.lana);let i=re.init(r.hostEnv).module("service");i.debug("Activating:",r);let o={price:Rn(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Ln(c),...kn(c),...Co(c),...Lo(c),...Kr,Log:re,resolvePriceTaxFlags:Va,get defaults(){return k},get log(){return re},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(qt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ro),W(this,Ht,performance.measure(Ro,Mo)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Mo),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Tr).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Vt(S(this,Ht))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(r.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Ht=new WeakMap,lt=new WeakMap,Ge=new WeakSet,No=function(){let r=this.getAttribute("env")??"prod",a={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},Ya=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||H(r))};window.customElements.get(ko)||window.customElements.define(ko,Wa);var Ho="merch-card-collection",kl=2e4,Ml={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Rl={plans:!0},Nl=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),Ol=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(a=>r.types.includes(a)))):e,Il=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),Dl=(e,{filter:t})=>e.sort((r,a)=>a.filters[t]?.order==null||isNaN(a.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-a.filters[t].order),Hl=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,ke,ht,Bt,Ft,yr,zo,dt=class extends Io{constructor(){super();G(this,yr);G(this,ke,{});G(this,ht);G(this,Bt);G(this,Ft);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return Ae` <slot></slot>
        ...
        </sp-button>`}sortChanged(r){r.target.value===pe.authored?gt({sort:void 0}):gt({sort:r.target.value}),this.dispatchEvent(new CustomEvent(_r,{bubbles:!0,composed:!0,detail:{value:r.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(Pr,{bubbles:!0,composed:!0}));let r=this.page+1;gt({page:r}),this.page=r,await this.updateComplete}startDeeplink(){this.stopDeeplink=ai(({category:r,filter:a,types:i,sort:n,search:o,single_app:s,page:c})=>{a=a||r,!this.filtered&&a&&a!==this.filter&&setTimeout(()=>{gt({page:void 0}),this.page=1},1),this.filtered||(this.filter=a??this.filter),this.types=i??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(c)||1})}openFilters(r){this.sidenav?.showModal(r)}};ke=new WeakMap,ht=new WeakMap,Bt=new WeakMap,Ft=new WeakMap,yr=new WeakSet,zo=function(r,a={},i=!0){S(this,Bt).error(`merch-card-collection: ${r}`,a),this.failed=!0,i&&this.dispatchEvent(new CustomEvent(Rr,{detail:{...a,message:r},bubbles:!0,composed:!0}))},f(dt,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:pe.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),f(dt,"styles",Do`
        #footer {
            grid-column: 1 / -1;

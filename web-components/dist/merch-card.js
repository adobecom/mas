var Kt=Object.defineProperty;var Wt=i=>{throw TypeError(i)};var hi=(i,t,e)=>t in i?Kt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var mi=(i,t)=>()=>(i&&(t=i(i=0)),t);var gi=(i,t)=>{for(var e in t)Kt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>hi(i,typeof t!="symbol"?t+"":t,e),bt=(i,t,e)=>t.has(i)||Wt("Cannot "+e);var c=(i,t,e)=>(bt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Wt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),m=(i,t,e,r)=>(bt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),S=(i,t,e)=>(bt(i,t,"access private method"),e);var Qt=(i,t,e,r)=>({set _(a){m(i,t,a,e)},get _(){return c(i,t,r)}});var yt={};gi(yt,{default:()=>X});import{LitElement as ui,html as Xe,css as fi}from"./lit-all.min.js";function xi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var X,wt=mi(()=>{X=class extends ui{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Xe`<merch-icon
            src="${this.src}"
            size="${this.size}"
    ...
    `);customElements.define("mas-mnemonic",X)});import{LitElement as ja}from"./lit-all.min.js";import{css as Jt,unsafeCSS as Zt}from"./lit-all.min.js";var E="(max-width: 767px)",A="(max-width: 1199px)",v="(min-width: 768px)",u="(min-width: 1200px)",T="(min-width: 1600px)",Xt={matchMobile:window.matchMedia(E),matchDesktop:window.matchMedia(`${u} and (not ${T})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(T),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},f=Xt;function Oe(){return Xt.isDesktop}var er=Jt`
    :host {
...
`;var nt=class extends x{constructor(t){super(t)}getGlobalCSS(){return vr}renderLayout(){return He`${this.cardImage}
            <div class="body">
...
`;var ot=class extends x{constructor(t){super(t)}getGlobalCSS(){return br}renderLayout(){return yr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var zi=32,ye=class extends x{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?be`<slot name="secure-transaction-label">
    ...
    `);import{html as qe,css as _i,nothing as st}from"./lit-all.min.js";var kr=`
:root {
...
`;var we=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return zr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return At` ${this.badge}
    ...
    `);import{html as Ct,css as Ri}from"./lit-all.min.js";var _r=`
:root {
...
`;var Ee=class extends x{constructor(t){super(t)}getGlobalCSS(){return _r}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Ct` ${this.badge}
    ...
    `);import{html as Tt,css as Oi}from"./lit-all.min.js";var Pr=`
:root {
...
`;var Dr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ce=class extends x{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Nr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Bi`
            ${this.badge}
            <div class="body">
    ...
    `);var dt=new Map,C=(i,t,e=null,r=null,a)=>{dt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};C("catalog",ve,xr,ve.variantStyle);C("image",nt);C("inline-heading",ot);C("mini-compare-chart",ye,null,ye.variantStyle);C("plans",z,ct,z.variantStyle,z.collectionOptions);C("plans-students",z,Ar,z.variantStyle,z.collectionOptions);C("plans-education",z,Sr,z.variantStyle,z.collectionOptions);C("plans-v2",Y,Lr,Y.variantStyle,Y.collectionOptions);C("product",we,null,we.variantStyle);C("segment",Ee,null,Ee.variantStyle);C("special-offers",ke,Mr,ke.variantStyle);C("simplified-pricing-express",Se,Lt,Se.variantStyle);C("full-pricing-express",Ae,zt,Ae.variantStyle);C("mini",Ce,Dr,Ce.variantStyle);var _t=i=>{let t=dt.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let a=new CSSStyleSheet;a.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(a)}catch{let n=document.createElement("style");n.textContent=r.cssText,i.shadowRoot.appendChild(n)}return new e(i)};function at(i){return dt.get(i)?.fragmentMapping}function $r(i){return dt.get(i)?.collectionOptions}var Ir=document.createElement("style");Ir.innerHTML=`
:root {

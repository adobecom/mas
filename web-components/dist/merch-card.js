var Sr=Object.defineProperty;var Ar=i=>{throw TypeError(i)};var wi=(i,r,e)=>r in i?Sr(i,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[r]=e;var Ei=(i,r)=>()=>(i&&(r=i(i=0)),r);var ki=(i,r)=>{for(var e in r)Sr(i,e,{get:r[e],enumerable:!0})};var h=(i,r,e)=>wi(i,typeof r!="symbol"?r+"":r,e),Qt=(i,r,e)=>r.has(i)||Ar("Cannot "+e);var c=(i,r,e)=>(Qt(i,r,"read from private field"),e?e.call(i):r.get(i)),u=(i,r,e)=>r.has(i)?Ar("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(i):r.set(i,e),m=(i,r,e,t)=>(Qt(i,r,"write to private field"),t?t.call(i,e):r.set(i,e),e),w=(i,r,e)=>(Qt(i,r,"access private method"),e);var zr=(i,r,e,t)=>({set _(a){m(i,r,a,e)},get _(){return c(i,r,t)}});var Zt={};ki(Zt,{default:()=>Ze});import{LitElement as Ci,html as ke,css as Si,nothing as Ai}from"./lit-all.min.js";import{unsafeHTML as Or}from"./lit-all.min.js";import{ifDefined as zi}from"./lit-all.min.js";function Ti(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var R,Ze,Xt=Ei(()=>{R=class R extends Ci{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();R.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,a=window.innerHeight,n=14,o=200,s=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:s,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>a?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>t&&(f="left");let C=e.left+e.width/2,G=e.top+e.height/2,te=6,wt=(bi,xi,yi)=>Math.max(bi,Math.min(xi,yi)),Et,kt,Yt;f==="top"||f==="bottom"?(Et=f==="top"?e.top-p-n:e.bottom+n,kt=wt(0,t-d,C-d/2),Yt=wt(te,d-te*2,C-kt-te)):(kt=f==="left"?e.left-d-n:e.right+n,Et=wt(0,a-p,G-p/2),Yt=wt(te,p-te*2,G-Et-te)),this._tooltipTop=Et,this._tooltipLeft=kt,this._arrowOffset=Yt,this._computedPlacement=f}showTooltip(){R.activeTooltip&&R.activeTooltip!==this&&(R.activeTooltip.closeOverlay(),R.activeTooltip.tooltipVisible=!1,R.activeTooltip.requestUpdate()),R.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){R.activeTooltip===this&&(R.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?ke`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:ke`<slot></slot>`}render(){let r=this.effectiveContent,e=this.effectivePlacement;if(!r)return ke`<span class="icon-only">${this.renderIcon()}</span>`;if(Ti())return ke`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let a=r.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:g=>{this.lastPointerType=g.pointerType},pointerenter:g=>g.pointerType!=="touch"&&this.showTooltip(),pointerleave:g=>g.pointerType!=="touch"&&this.hideTooltip(),click:g=>{this.lastPointerType==="touch"&&this.handleTap(g),this.lastPointerType=null}},s=this._computedPlacement,l=s==="top"||s==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=l?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return ke`
            <span
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${zi(d)}>
                    ${Or(r)}
    ...
    `);Ze=R;customElements.define("mas-mnemonic",Ze)});import{LitElement as xo}from"./lit-all.min.js";import{css as _r,unsafeCSS as Pr}from"./lit-all.min.js";var E="(max-width: 767px)",L="(max-width: 1199px)",k="(min-width: 768px)",v="(min-width: 1200px)",P="(min-width: 1600px)",Tr="(min-width: 1280px)",Lr={matchMobile:window.matchMedia(E),matchDesktop:window.matchMedia(`${v} and (not ${P})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(P),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Lr;function Ct(){return Lr.isDesktop}var Mr=_r`
    :host {
...
`,Rr=()=>[_r`
            ...
            /* Laptop */
            @media screen and ${Pr(v)} {
                :host([size='wide']) {
                    grid-column: span 2;
                }
            }
        `];import{LitElement as Li,html as Dr,css as Pi}from"./lit-all.min.js";function _i(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Ce=class extends Li{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(_i())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let t="",a="top";if(e.tagName==="SP-TOOLTIP")t=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(t=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(t){let n=document.createElement("mas-mnemonic");n.setAttribute("content",t),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Xt())}e.remove()})}render(){let{href:r}=this;return r?Dr`<a href="${r}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(Ce,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(Ce,"styles",Pi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Ce);var Oo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Do=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var Se=2e4;var y='span[is="inline-price"][data-wcs-osi]',Z='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Mi='a[is="upt-link"]',Nr=`${y},${Z},${Mi}`;var Fr="merch-offer-select:ready",Ir="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",$r="merch-card-quantity:change",Jt="merch-modal:addon-and-quantity-update";var Ae="merch-card-collection:literals-changed";var ze="aem:load",Te="aem:error",St="mas:ready",Br="mas:error",Hr="placeholder-failed",qr="placeholder-pending",Ur="placeholder-resolved";var Gr="mas:failed",j="mas:resolved",jr="mas/commerce";var re="failed",he="pending",ae="resolved";var At="X-Request-Id",No=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Fo=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var zt=":start",Tt=":duration";var M="legal",Vr="mas-ff-defaults";var Ri="mas-commerce-service";function Wr(i,r){let e;return function(){let t=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(t,a),r)}}function _(i,r={},e=null,t=null){let a=t?document.createElement(i,{is:t}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(r))a.setAttribute(n,o);return a}function Le(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function er(){return window.matchMedia("(max-width: 1024px)").matches}function pe(){return document.getElementsByTagName(Ri)?.[0]}function Xe(i){let r=window.getComputedStyle(i);return i.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function Kr(i){let r=i.nextElementSibling?.nodeName==="BR"?i.nextElementSibling.nextElementSibling:i.nextElementSibling;return i.dataset.template==="strikethrough"&&(i.nextSibling?.nodeName!=="#text"||i.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var Je,me,et,tt,Pe,Lt=class extends HTMLElement{constructor(){super();u(this,Je,"");u(this,me);u(this,et,[]);u(this,tt,[]);u(this,Pe);m(this,Pe,Wr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,me)?this.parentElement.style.borderRadius=c(this,me):c(this,me)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,et).map((t,a)=>{let n=c(this,tt)[a]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${c(this,Je)}, ${e})`}connectedCallback(){c(this,Pe).call(this)}attributeChangedCallback(e,t,a){e==="border-radius"&&m(this,me,a?.trim()),e==="colors"&&a?m(this,et,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?m(this,tt,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Je,a?.trim()??""),c(this,Pe).call(this)}};Je=new WeakMap,me=new WeakMap,et=new WeakMap,tt=new WeakMap,Pe=new WeakMap;customElements.define("merch-gradient",Lt);import{LitElement as Oi,html as Di,css as Ni}from"./lit-all.min.js";var _e=class extends Oi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${r}"] ${y}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(j,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(j,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];t&&(e.setAttribute("data-offer-type",t.offerType),e.closest("p").setAttribute("data-plan-type",t.planType))}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return Di` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(_e,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),h(_e,"styles",Ni`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",_e);import{html as Pt,nothing as Fi}from"./lit-all.min.js";var Me,rt=class rt{constructor(r){h(this,"card");u(this,Me);this.card=r,this.insertVariantStyle()}getContainer(){return m(this,Me,c(this,Me)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,Me)}insertVariantStyle(){let r=this.constructor.name;if(!rt.styleMap[r]){rt.styleMap[r]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(r,e){if(!r||this.card.heightSync===!1)return;let t=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(t))||0;a>o&&n.style.setProperty(t,`${a}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let t=this.card.variant,a=Array.from(e.querySelectorAll(`merch-card[variant="${t}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${t}-${o}-height`;e.style.getPropertyValue(s)&&e.style.removeProperty(s)}let n=new Map;for(let o of a){let s=o.getBoundingClientRect();if(s.width<=2)continue;let l=Math.round(s.top),d=n.get(l);d||(d=[],n.set(l,d)),d.push(o)}for(let o of n.values())for(let{name:s,getElement:l}of r){let d=`--consonant-merch-card-${t}-${s}-height`,p=o.map(f=>f.style.getPropertyValue(d)),g=0;for(let f of o){f.style.removeProperty(d);let C=l(f);if(!C)continue;let G=Math.max(0,parseInt(window.getComputedStyle(C).height)||0);G>g&&(g=G)}o.forEach((f,C)=>{g>0?f.style.setProperty(d,`${g}px`):p[C]&&f.style.setProperty(d,p[C])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Pt`
            <div
                id="badge"
        ...
        `}get cardImage(){return Pt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:Fi}get secureLabelFooter(){return Pt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let r=Promise.allSettled(this.card.prices.map(a=>a.onceSettled?.()||Promise.resolve())),e,t=new Promise(a=>{e=setTimeout(a,Se)});await Promise.race([r,t]),clearTimeout(e)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return _t(this.card.variant)}};Me=new WeakMap,h(rt,"styleMap",{});var b=rt;import{html as tr,css as Ii}from"./lit-all.min.js";var Yr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return Yr}setAriaExpanded(e,t){e.setAttribute("aria-expanded",t)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};h(Re,"variantStyle",Ii`
    ...
    `);import{html as at,css as $i}from"./lit-all.min.js";var Zr=`
:root {
...
`;var Xr={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},ge=class extends b{constructor(r){super(r)}getGlobalCSS(){return Zr}renderLayout(){return at`<div class="image">
                <slot name="bg-image"></slot>
    ...
    `);import{html as ea}from"./lit-all.min.js";var Jr=`
:root {
...
`;var Mt=class extends b{constructor(r){super(r)}getGlobalCSS(){return Jr}renderLayout(){return ea` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":ea`<hr />`} ${this.secureLabelFooter}`}};import{html as ie,css as Bi,unsafeCSS as ra}from"./lit-all.min.js";var ta=`
  :root {
...
`;var Hi=32,aa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Oe=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ie`<slot name="secure-transaction-label">
            ...
            </footer>`:ie`<footer>${e}<slot name="footer"></slot></footer>`});this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(O,this.updatePriceQuantity),this.visibilityObserver=new IntersectionObserver(([e])=>{e.boundingClientRect.height!==0&&e.isIntersecting&&(x.isMobile||requestAnimationFrame(()=>{let t=this.getContainer();if(!t)return;t.querySelectorAll('merch-card[variant="mini-compare-chart"]').forEach(n=>n.variantLayout?.syncHeights?.())}),this.visibilityObserver.disconnect())}),this.visibilityObserver.observe(this.card)}disconnectedCallbackHook(){if(this.card.removeEventListener(O,this.updatePriceQuantity),this.visibilityObserver?.disconnect(),this.legalElement&&this.legalResolvedHandler&&(this.legalElement.removeEventListener(j,this.legalResolvedHandler),this.legalResolvedHandler=null,this.legalElement=null),this.calloutListenersAdded){document.removeEventListener("touchstart",this.handleCalloutTouch),document.removeEventListener("mouseover",this.handleCalloutMouse);let e=this.card.querySelector('[slot="callout-content"] .icon-button');e?.removeEventListener("focusin",this.handleCalloutFocusin),e?.removeEventListener("focusout",this.handleCalloutFocusout),e?.removeEventListener("keydown",this.handleCalloutKeydown),this.calloutListenersAdded=!1}}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}priceOptionsProvider(e,t){if(this.isNewVariant){if(e.dataset.template===M){t.displayPlanType=this.card?.settings?.displayPlanType??!1;return}(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1)}}getGlobalCSS(){return ta}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","subtitle","body-m","heading-m-price","body-xxs","price-commitment","quantity-select","offers","promo-text","callout-content","addon"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer"),this.card.shadowRoot.querySelector(".mini-compare-chart-badge")?.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e;if(this.isNewVariant){let t=this.card.querySelector("merch-whats-included");if(!t)return;e=[...t.querySelectorAll('[slot="content"] merch-mnemonic-list')]}else{let t=this.card.querySelector('[slot="footer-rows"] ul');if(!t||!t.children)return;e=[...t.children]}e.length&&e.forEach((t,a)=>{let n=Math.max(Hi,parseFloat(window.getComputedStyle(t).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.isNewVariant?this.card.querySelectorAll('merch-whats-included [slot="content"] merch-mnemonic-list').forEach(t=>{if(t.hasAttribute("data-placeholder"))return;let a=t.querySelector('[slot="icon"]'),n=!!a?.querySelector(".sp-icon")||!!a?.querySelector('merch-icon[src]:not([src=""]), img[src]:not([src=""])'),s=t.querySelector('[slot="description"]')?.textContent?.replace(/\u00a0/g," ")?.trim()??"";!n&&!s&&t.remove()}):this.card.querySelectorAll(".footer-row-cell").forEach(t=>{if(t.hasAttribute("data-placeholder"))return;let a=t.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&t.remove()})}padFooterRows(){let e=this.getContainer();if(!e)return;let t=e.querySelectorAll('merch-card[variant="mini-compare-chart"]');if(this.isNewVariant){let a=0;if(t.forEach(d=>{let p=d.querySelector("merch-whats-included");if(!p)return;let g=p.querySelectorAll('[slot="content"] merch-mnemonic-list:not([data-placeholder])');a=Math.max(a,g.length)}),a===0)return;let n=this.card.querySelector("merch-whats-included");if(!n)return;let o=n.querySelector('[slot="content"]');if(!o)return;o.querySelectorAll("merch-mnemonic-list[data-placeholder]").forEach(d=>d.remove());let s=o.querySelectorAll("merch-mnemonic-list").length,l=a-s;for(let d=0;d<l;d++){let p=document.createElement("merch-mnemonic-list");p.setAttribute("data-placeholder","");let g=document.createElement("div");g.setAttribute("slot","icon");let f=document.createElement("div");f.setAttribute("slot","description"),p.append(g,f),o.appendChild(p)}}else{let a=0;if(t.forEach(l=>{let d=l.querySelector('[slot="footer-rows"] ul');if(!d)return;let p=d.querySelectorAll("li.footer-row-cell:not([data-placeholder])");a=Math.max(a,p.length)}),a===0)return;let n=this.card.querySelector('[slot="footer-rows"] ul');if(!n)return;n.querySelectorAll("li.footer-row-cell[data-placeholder]").forEach(l=>l.remove());let o=n.querySelectorAll("li.footer-row-cell").length,s=a-o;for(let l=0;l<s;l++){let d=document.createElement("li");d.className="footer-row-cell",d.setAttribute("data-placeholder",""),n.appendChild(d)}}}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${y}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}get isNewVariant(){return!!this.card.querySelector("merch-whats-included")}toggleAddon(e){let t=this.mainPrice,a=this.headingMPriceSlot;if(!t&&a){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(s=>s.remove()),e.checked){if(o){let s=_("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},o.innerHTML);this.card.appendChild(s)}}else{let s=_("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(s)}}}showTooltip(e){e.classList.remove("hide-tooltip"),e.setAttribute("aria-expanded","true")}hideTooltip(e){e.classList.add("hide-tooltip"),e.setAttribute("aria-expanded","false")}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');if(!e||this.calloutListenersAdded)return;let t=e.title||e.dataset.tooltip;if(!t)return;e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"));let a=e.parentElement;if(a&&a.tagName==="P"){let n=document.createElement("div"),o=document.createElement("div");o.className="callout-row";let s=document.createElement("div");for(s.className="callout-text";a.firstChild&&a.firstChild!==e;)s.appendChild(a.firstChild);o.appendChild(s),o.appendChild(e),n.appendChild(o),a.replaceWith(n)}e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",t),e.setAttribute("aria-expanded","false"),this.hideTooltip(e),this.handleCalloutTouch=n=>{n.target!==e?this.hideTooltip(e):e.classList.contains("hide-tooltip")?this.showTooltip(e):this.hideTooltip(e)},this.handleCalloutMouse=n=>{n.target!==e?this.hideTooltip(e):this.showTooltip(e)},this.handleCalloutFocusin=()=>{this.showTooltip(e)},this.handleCalloutFocusout=()=>{this.hideTooltip(e)},this.handleCalloutKeydown=n=>{n.key==="Escape"&&(this.hideTooltip(e),e.blur())},document.addEventListener("touchstart",this.handleCalloutTouch),document.addEventListener("mouseover",this.handleCalloutMouse),e.addEventListener("focusin",this.handleCalloutFocusin),e.addEventListener("focusout",this.handleCalloutFocusout),e.addEventListener("keydown",this.handleCalloutKeydown),this.calloutListenersAdded=!0}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let t=this.mainPrice,a=this.card.planType;if(t&&(await t.onceSettled?.(),a=t.value?.[0]?.planType),!a)return;e.planType=a,this.card.querySelector("merch-addon[plan-type]")?.updateComplete.then(()=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="addon"]'),"addon")})}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayPerUnit&&(e.dataset.displayPerUnit="false"),e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(j,this.legalResolvedHandler),this.legalElement=t)}catch{}}adjustShortDescription(){if(!this.shortDescriptionSource){let o=this.card.querySelector('[slot="body-xxs"]');if(!o)return;this.shortDescriptionSource=o,o.remove()}let e=this.shortDescriptionSource.textContent?.trim();if(!e)return;let a=this.card.querySelector('[slot="heading-m-price"] [data-template="legal"]')?.querySelector(".price-plan-type");if(!a||a.querySelector("em"))return;let n=document.createElement("em");n.textContent=` ${e}`,a.appendChild(n)}renderLayout(){return this.isNewVariant?ie` <div class="top-section${this.badge?" badge":""}">
                <slot name="icons"></slot> ${this.badge}
                <slot name="badge"></slot>
            </div>
            <slot name="heading-m"></slot>
    ...
    `);import{html as Rt,css as qi,unsafeCSS as na,nothing as Ui}from"./lit-all.min.js";var ia=`
  :root {
...
`;var Gi=32,oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},De=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Rt` <footer>
        ...
        </footer>`);h(this,"getMiniCompareFooterRows",()=>Rt` <div class="footer-rows-container">
            <slot name="body-xs"></slot>
            <slot name="footer-rows"></slot>
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(O,this.updatePriceQuantity)}disconnectedCallbackHook(){this.card.removeEventListener(O,this.updatePriceQuantity),this._syncObserver?.disconnect(),this._syncObserver=null}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}priceOptionsProvider(e,t){if(e.dataset.template===M){t.displayPlanType=this.card?.settings?.displayPlanType??!1;return}(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1)}getGlobalCSS(){return ia}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2){this._syncObserver||(this._syncObserver=new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(this._syncObserver?.disconnect(),this._syncObserver=null,this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}),this._syncObserver.observe(this.card));return}["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs","footer-rows"].forEach(t=>{let n=this.card.querySelector(`[slot="${t}"]`)??this.card.shadowRoot.querySelector(`slot[name="${t}"]`);this.updateCardElementMinHeight(n,t)}),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="promo-text"]'),"promo-text"),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((t,a)=>{let n=Math.max(Gi,parseFloat(window.getComputedStyle(t).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(t=>{let a=t.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&t.remove()})}setupToggle(){if(this.toggleSetupDone)return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let t=e.querySelector("p"),a=e.querySelector("ul");if(!t||!a||e.querySelector(".footer-rows-title"))return;this.toggleSetupDone=!0;let n=t.textContent.trim(),o=this.card.querySelector("h3")?.id,s=o?`${o}-list`:`mweb-list-${Date.now()}`;a.setAttribute("id",s),a.classList.add("checkmark-copy-container");let l=_("div",{class:"footer-rows-title"},n);if(x.isMobile){let d=_("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":s});l.appendChild(d),l.addEventListener("click",()=>{let p=a.classList.toggle("open");d.classList.toggle("expanded",p),d.setAttribute("aria-expanded",String(p))})}else a.classList.add("open");t.replaceWith(l)}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${y}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayPerUnit&&(e.dataset.displayPerUnit="false"),e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Ui:Rt`<slot name="icons"></slot>`}renderLayout(){return Rt`
            ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="badge"></slot>
    ...
    `);import{html as it,css as ji,nothing as Ot}from"./lit-all.min.js";var sa=`
:root {
...
`;var Dt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ca={...function(){let{whatsIncluded:i,size:r,...e}=Dt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},la={...function(){let{subtitle:i,whatsIncluded:r,size:e,quantitySelect:t,...a}=Dt;return a}()},V,W,D=class extends b{constructor(e){super(e);u(this,V);u(this,W);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return sa}adjustSlotPlacement(e,t,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let l=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!t.includes(s)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!a&&l){if(d)l.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(l):p.appendChild(l)}return}if(a&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!l){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){c(this,V)||(m(this,V,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(c(this,V)?.disconnect(),m(this,V,null),this.syncHeights())})),c(this,V).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:a=>a.querySelector(`[slot="${t}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let a=t.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),t.insertBefore(o,n);let s=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=Xe(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(d+=Xe(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+Xe(f));for(let G of t.childNodes){if(G.classList.contains("spacer"))break;d+=Xe(G)}let C=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(C)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?it`<div class="divider"></div>`:Ot}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);t&&e.push(t);let a=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let a=t.value?.[0]?.planType;a&&(e.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?it`<label id="stock-checkbox">
                <input type="checkbox" @change=${this.card.toggleStockOffer}></input>
                <span></span>
                ${this.card.checkboxLabel}
            </label>`:Ot}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Ot:it`<slot name="icons"></slot>`}connectedCallbackHook(){x.matchMobile.addEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.addEventListener("change",this.adaptForMedia),this.handleResize=()=>{c(this,W)&&cancelAnimationFrame(c(this,W)),m(this,W,requestAnimationFrame(()=>{m(this,W,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))},window.addEventListener("resize",this.handleResize)}disconnectedCallbackHook(){x.matchMobile.removeEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.removeEventListener("change",this.adaptForMedia),c(this,V)?.disconnect(),m(this,V,null),this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),c(this,W)&&(cancelAnimationFrame(c(this,W)),m(this,W,null))}renderLayout(){return it` ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="heading-xs"></slot>
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};V=new WeakMap,W=new WeakMap,h(D,"variantStyle",ji`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),h(D,"collectionOptions",{customHeaderArea:e=>e.sidenav?it`<slot name="resultsText"></slot>`:Ot,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let t=()=>{let a=e.querySelectorAll("merch-card");for(let o of a)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of a){if(o.style.display==="none")continue;let s=o.getAttribute("size"),l=s==="wide"?2:s==="super-wide"?3:1;l===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),l=1),n+=l}};x.matchDesktop.addEventListener("change",t),e.addEventListener(Ae,t),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",t),e.removeEventListener(Ae,t)})}});import{html as X,css as Vi,unsafeCSS as ha,nothing as Nt}from"./lit-all.min.js";var da=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?X`
        ...
        `:X`
            ...
            `:Nt}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?X`<slot name="icons"></slot>`:Nt}get secureLabelFooter(){return X`<footer>
            ...
            <slot></slot>`}};h(ne,"variantStyle",Vi`
    ...
    `),h(ne,"collectionOptions",{customHeaderArea:r=>r.sidenav?X`<slot name="resultsText"></slot>`:Nt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let e=()=>{let t=r.querySelectorAll("merch-card");if(t.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!x.isDesktop)return;let a=0;t.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&a%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),a+=s})};x.matchDesktop.addEventListener("change",e),r.addEventListener(Ae,e),r.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",e),r.removeEventListener(Ae,e)})}});import{html as oe,css as Wi,nothing as nt}from"./lit-all.min.js";var ma=`
:root {
...
`;var[lc,dc,ga,ua,fa,va]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var ba={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},J,ue,z,xa,ot,ya,st,rr,Ft,It=class It extends b{constructor(){super(...arguments);u(this,z);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,J,null);u(this,ue,null);h(this,"lastSyncKey",null);h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let a of w(this,z,xa).call(this)){let n=a.variantLayout;n instanceof It&&(n.expanded=t,a.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?w(this,z,rr).call(this):w(this,z,st).call(this),this.card.requestUpdate()});u(this,Ft,e=>{let t=this.licenseOptions;if(!t?.length)return;let a=t.length-1;switch(e.key){case ua:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:w(this,z,st).call(this);break;case ga:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:w(this,z,st).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=a;break;case fa:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}w(this,z,st).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),w(this,z,rr).call(this);break;case va:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,w(this,z,ot).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(O,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return ma}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(j,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let a=this.card.querySelector('[slot="heading-m"] [data-template="legal"]')?.querySelector(".price-plan-type");a&&(a.textContent=e)}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let a=t.value?.[0]?.planType;a&&(e.planType=a)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let a=window.getComputedStyle(t),n=`${a.fontWeight} ${a.fontSize} ${a.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,a=`--consonant-merch-card-${t}-top-card-height`,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(s=>s.getBoundingClientRect().width>2&&s.variantLayout?.card?.heightSync!==!1),o=new Map;for(let s of n){let l=o.get(s.offsetTop)??[];l.push(s),o.set(s.offsetTop,l)}for(let s of o.values()){let l=0;for(let d of s){d.style.removeProperty(a);let p=d.shadowRoot?.querySelector(".top-card");p&&(l=Math.max(l,parseInt(getComputedStyle(p).height)||0))}l>0&&s.length>1&&s.forEach(d=>d.style.setProperty(a,`${l}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),a=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${a}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;m(this,ue,new ResizeObserver(()=>this.resyncOnReflow())),c(this,ue).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&c(this,ue).observe(e)}disconnectedCallbackHook(){w(this,z,ot).call(this),c(this,ue)?.disconnect()}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),a=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(a)||a<t)return null;let o=[];for(let s=t;s<=a;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[a,n]=t.split("|").map(o=>o.trim());return Number(e)===1?a:n||a}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return oe`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,a=!!this.licenseOpen,n=this.licenseLabel(Number(t));return oe`
        ...
        `}renderLayout(){let e=!!this.expanded;return oe`
            <div class="top-card">
                <div class="mnemonic">
                    <slot name="icons"></slot>
                    <slot name="subtitle"></slot>
            ...
            ${this.hasWhatsIncluded?oe`
                  ...
                  `:nt}
            <slot></slot>
        `}};J=new WeakMap,ue=new WeakMap,z=new WeakSet,xa=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(a=>a.getBoundingClientRect().width>2&&a.offsetTop===e);return t.length?t:[this.card]},ot=function(){c(this,J)&&(document.removeEventListener("mousedown",c(this,J)),m(this,J,null))},ya=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},st=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=w(this,z,ya).call(this),c(this,J)||(m(this,J,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),w(this,z,ot).call(this))}),document.addEventListener("mousedown",c(this,J)))},rr=function(){this.licenseOpen=!1,w(this,z,ot).call(this)},Ft=new WeakMap,h(It,"variantStyle",Wi`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var ct=It;import{html as ar,css as Ki}from"./lit-all.min.js";var wa=`
:root {
...
`;var Ea={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},K,Ne=class extends b{constructor(e){super(e);u(this,K);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return wa}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return ar` ${this.badge}
            <div class="body" aria-live="polite">
                <slot name="icons"></slot>
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?"":ar`<slot name="promo-text"></slot>`}
                <slot name="body-xs"></slot>
                ${this.promoBottom?ar`<slot name="promo-text"></slot>`:""}
                <slot name="whats-included"></slot>
                <slot name="callout-content"></slot>
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){this.handleResize=()=>{c(this,K)&&cancelAnimationFrame(c(this,K)),m(this,K,requestAnimationFrame(()=>{m(this,K,null),this.postCardUpdateHook()}))},window.addEventListener("resize",this.handleResize),this.card.addEventListener(O,this.updatePriceQuantity)}disconnectedCallbackHook(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),c(this,K)&&(cancelAnimationFrame(c(this,K)),m(this,K,null)),this.card.removeEventListener(O,this.updatePriceQuantity)}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),x.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayPerUnit&&(e.dataset.displayPerUnit="false"),e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}toggleAddon(e){let t=this.mainPrice,a=this.headingXSSlot;if(!t&&a){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(s=>s.remove()),e.checked){if(o){let s=_("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},o.innerHTML);this.card.appendChild(s)}}else{let s=_("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let t=this.mainPrice,a=this.card.planType;t&&(await t.onceSettled?.(),a=t.value?.[0]?.planType),a&&(e.planType=a)}};K=new WeakMap,h(Ne,"variantStyle",Ki`
    ...
    `);import{html as ir,css as Yi}from"./lit-all.min.js";var ka=`
:root {
...
`;var Ca={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Fe=class extends b{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ka}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return ir`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Qi,css as Zi}from"./lit-all.min.js";var Sa=`
...
`;var Aa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ie=class extends b{constructor(r){super(r)}getGlobalCSS(){return Sa}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Qi`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as nr,css as Xi}from"./lit-all.min.js";var za=`
:root {
...
`;var Ta={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},$e=class extends b{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return za}renderLayout(){return nr`${this.cardImage}
    ...
    `);import{html as Ji,css as en}from"./lit-all.min.js";var La=`
:root {
...
`;var or={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Be=class extends b{getGlobalCSS(){return La}get aemFragmentMapping(){return or}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(a=>this.updateCardElementMinHeight(r.querySelector(`.${a}`),a));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let t=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');t&&this.updateCardElementMinHeight(t,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=34;e.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",s)})}),x.isDesktopOrUp&&e.forEach(a=>a.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Ct()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let e=()=>{if(Ct())r.removeAttribute("data-expanded");else{let a=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",a?"true":"false")}};e();let t=window.matchMedia(E);this.mediaQueryListener=()=>{e()},t.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(E).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||Ct())return;let a=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",a)}renderLayout(){return Ji`
            <div
                class="badge-wrapper"
    ...
    `);import{html as _a,css as tn}from"./lit-all.min.js";var Pa=`
:root {
...
`;var sr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},lt=class lt extends b{getGlobalCSS(){return Pa}get aemFragmentMapping(){return sr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return _a`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let e=window.getComputedStyle(r),t=`${e.fontWeight} ${e.fontSize} ${e.fontFamily}`;await document.fonts.load(t,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let r=lt.SYNCED_SECTIONS.map(s=>({name:s,getElement:l=>l.shadowRoot?.querySelector(`.${s}`)})),e=this.getContainer(),t=e?e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],a='[slot="body-s"] > *',n=Math.max(0,...Array.from(t,s=>s.querySelectorAll(a).length)),o=Array.from({length:n},(s,l)=>({name:`description-row-${l}`,getElement:d=>d.querySelectorAll(a)[l]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=49;e.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let e=this.card.querySelector(this.headingSelector),t=e?Math.round(e.getBoundingClientRect().height):0,a=`${Math.round(r)}:${t}`;a!==this.lastSyncedKey&&(this.lastSyncedKey=a,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return _a`
            ${this.badge}
            ...
            <slot></slot>
        `}};h(lt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),h(lt,"variantStyle",tn`
    ...
    `);var dt=lt;import{html as cr,css as rn,nothing as an}from"./lit-all.min.js";var Ma=`
...
`;var Ra={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},nn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],He=class extends b{constructor(r){super(r)}getGlobalCSS(){return Ma}renderLayout(){return cr`
    ...
    `);import{css as on,html as sn}from"./lit-all.min.js";var Oa=`
...
`;var Da={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},qe=class extends b{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Oa}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,t){t.literals={...t.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},t.space=!0,t.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",t.dataset.template="legal",t.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return sn`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as cn,css as ln}from"./lit-all.min.js";var Na=`
...
`;var lr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ue=class extends b{getGlobalCSS(){return Na}get aemFragmentMapping(){return lr}renderLayout(){return cn`
    ...
    `);var $t=new Map,Fa=new WeakMap,Ia=new Map,S=(i,r,e=null,t=null,a)=>{$t.set(i,{class:r,fragmentMapping:e,style:t,collectionOptions:a})};S("catalog",Re,Qr,Re.variantStyle);S("image",ge);S("inline-heading",Mt);S("mini-compare-chart",Oe,aa,Oe.variantStyle);S("mini-compare-chart-mweb",De,oa,De.variantStyle);S("plans",D,Dt,D.variantStyle,D.collectionOptions);S("plans-students",D,la,D.variantStyle,D.collectionOptions);S("plans-education",D,ca,D.variantStyle,D.collectionOptions);S("plans-v2",ne,pa,ne.variantStyle,ne.collectionOptions);S("bizpro",ct,ba,ct.variantStyle);S("product",Ne,Ea,Ne.variantStyle);S("segment",Fe,Ca,Fe.variantStyle);S("media",Ie,Aa,Ie.variantStyle);S("headless",He,Ra,He.variantStyle);S("special-offers",$e,Ta,$e.variantStyle);S("simplified-pricing-express",Be,or,Be.variantStyle);S("full-pricing-express",dt,sr,dt.variantStyle);S("mini",qe,Da,qe.variantStyle);S("image",ge,Xr,ge.variantStyle);S("fries",Ue,lr,Ue.variantStyle);var dn=(i,r,e)=>{try{let t=Ia.get(i.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),Ia.set(i.variant,t)),e?.styleSheet&&e.styleSheet!==t){let a=i.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);a!==-1&&i.shadowRoot.adoptedStyleSheets.splice(a,1)}return i.shadowRoot.adoptedStyleSheets.includes(t)||i.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let a=document.createElement("style");a.textContent=r.cssText,a.setAttribute("data-variant-style",i.variant);let n=e?.styleElement||i.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),i.shadowRoot.appendChild(a),{styleElement:a}}},dr=i=>{let r=$t.get(i.variant);if(!r)return;let{class:e,style:t}=r,a=Fa.get(i);if(a?.appliedVariant===i.variant)return new e(i);let n=t?dn(i,t,a):{};return Fa.set(i,{appliedVariant:i.variant,...n}),new e(i)};function _t(i){return $t.get(i)?.fragmentMapping}function $a(i){return $t.get(i)?.collectionOptions}var Ba=document.createElement("style");Ba.innerHTML=`
:root {
...
`;document.head.appendChild(Ba);function Bt(i,r={},{metadata:e=!0,search:t=!0,storage:a=!0}={}){let n;if(t&&n==null){let o=new URLSearchParams(window.location.search),s=hr(t)?t:i;n=o.get(s)}if(a&&n==null){let o=hr(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=pn(hr(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[i]}var hn=i=>typeof i=="boolean",Ht=i=>typeof i=="function";var hr=i=>typeof i=="string";function Ha(i,r){if(hn(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:r}function pn(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,e,t)=>`${e}-${t}`).replace(/\W+/gu,"-").toLowerCase()}var se=class i extends Error{constructor(r,e,t){if(super(r,{cause:t}),this.name="MasError",e.response){let a=e.response.headers?.get(At);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let r=Object.entries(this.context||{}).map(([t,a])=>`${t}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return r&&(e+=` (${r})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var fe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},qa=1e3;function mn(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Ua(i){if(i==null)return;let r=typeof i;if(r==="function")return i.name?`function ${i.name}`:"function";if(r==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:t,originatingRequest:a,status:n}=i;return[t,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!fe.serializableTypes.includes(e))return e}return i}function gn(i,r){if(!fe.ignoredProperties.includes(i))return Ua(r)}var pr={append(i){if(i.level!=="error")return;let{message:r,params:e}=i,t=[],a=[],n=r;e.forEach(d=>{d!=null&&(mn(d)?t:a).push(d)}),t.length&&(n+=` ${t.map(Ua).join(" ")}`);let{pathname:o,search:s}=window.location,l=`${fe.delimiter}page=${o}${s}`;l.length>qa&&(l=`${l.slice(0,qa)}<trunc>`),n+=l,a.length&&(n+=`${fe.delimiter}facts=`,n+=JSON.stringify(a,gn)),window.lana?.log(n,fe)}};function Ga(i){Object.assign(fe,Object.fromEntries(Object.entries(i).filter(([r,e])=>r in fe&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ja={LOCAL:"local",PROD:"prod",STAGE:"stage"},mr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},gr=new Set,ur=new Set,Va=new Map,Wa={append({level:i,message:r,params:e,timestamp:t,source:a}){console[i](`${t}ms [${a}] %c${r}`,"font-weight: bold;",...e)}},Ka={filter:({level:i})=>i!==mr.DEBUG},un={filter:()=>!1};function fn(i,r,e,t,a){return{level:i,message:r,namespace:e,get params(){return t.length===1&&Ht(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:a,timestamp:performance.now().toFixed(3)}}function vn(i){[...ur].every(r=>r(i))&&gr.forEach(r=>r(i))}function Ya(i){let r=(Va.get(i)??0)+1;Va.set(i,r);let e=`${i} #${r}`,t={id:e,namespace:i,module:a=>Ya(`${t.namespace}/${a}`),updateConfig:Ga};return Object.values(mr).forEach(a=>{t[a]=(n,...o)=>vn(fn(a,n,i,o,e))}),Object.seal(t)}function qt(...i){i.forEach(r=>{let{append:e,filter:t}=r;Ht(t)&&ur.add(t),Ht(e)&&gr.add(e)})}function bn(i={}){let{name:r}=i,e=Ha(Bt("commerce.debug",{search:!0,storage:!0}),r===ja.LOCAL);return qt(e?Wa:Ka),r===ja.PROD&&qt(pr),ht}function xn(){gr.clear(),ur.clear()}var ht={...Ya(jr),Level:mr,Plugins:{consoleAppender:Wa,debugFilter:Ka,quietFilter:un,lanaAppender:pr},init:bn,reset:xn,use:qt};var yn="mas-commerce-service",nd=ht.module("utilities"),wn={requestId:At,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Ut=i=>window.setTimeout(i);function fr(){return document.getElementsByTagName(yn)?.[0]}function Qa(i){let r={};if(!i?.headers)return r;let e=i.headers;for(let[t,a]of Object.entries(wn)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function Za(i,r={},e=2,t=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,r);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,t*(n+1)))}throw a}var Xa="fragment",Ja="author",ei="preview",ti="loading",ri="timeout",vr="aem-fragment",ai="eager",ii="cache",En=[ai,ii],Y,ve,H,br=class{constructor(){u(this,Y,new Map);u(this,ve,new Map);u(this,H,new Map)}clear(){c(this,Y).clear(),c(this,ve).clear(),c(this,H).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(c(this,Y).set(r.id,r),r.fields?.originalId&&c(this,Y).set(r.fields.originalId,r),c(this,H).has(r.id)){let[,t]=c(this,H).get(r.id);t()}if(c(this,H).has(r.fields?.originalId)){let[,t]=c(this,H).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:a,value:n}=r.references[t];a==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return c(this,Y).has(r)}entries(){return c(this,Y).entries()}get(r){return c(this,Y).get(r)}getAsPromise(r){let[e]=c(this,H).get(r)??[];if(e)return e;let t;return e=new Promise(a=>{t=a,this.has(r)&&a()}),c(this,H).set(r,[e,t]),e}getFetchInfo(r){let e=c(this,ve).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ve).set(r,e)),e}remove(r){c(this,Y).delete(r),c(this,ve).delete(r),c(this,H).delete(r)}};Y=new WeakMap,ve=new WeakMap,H=new WeakMap;var ce=new br,Ge,I,ee,F,N,T,pt,mt,q,gt,ut,je,U,ni,oi,xr,si,Gt=class extends HTMLElement{constructor(){super(...arguments);u(this,U);h(this,"cache",ce);u(this,Ge);u(this,I,null);u(this,ee,null);u(this,F,null);u(this,N);u(this,T);u(this,pt,ai);u(this,mt,5e3);u(this,q);u(this,gt,!1);u(this,ut,0);u(this,je)}static get observedAttributes(){return[Xa,ti,ri,Ja,ei]}attributeChangedCallback(e,t,a){e===Xa&&(m(this,N,a),m(this,T,ce.getFetchInfo(a))),e===ti&&En.includes(a)&&m(this,pt,a),e===ri&&m(this,mt,parseInt(a,10)),e===Ja&&m(this,gt,["","true"].includes(a)),e===ei&&m(this,je,a)}connectedCallback(){if(!c(this,q)){if(c(this,F)??m(this,F,pe(this)),m(this,je,c(this,F).settings?.preview),c(this,Ge)??m(this,Ge,c(this,F).log.module(`${vr}[${c(this,N)}]`)),!c(this,N)||c(this,N)==="#"){c(this,T)??m(this,T,ce.getFetchInfo("missing-fragment-id")),w(this,U,xr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,T)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(c(this,q)&&!await Promise.race([c(this,q),Promise.resolve(!1)]))return;e&&ce.remove(c(this,N)),c(this,pt)===ii&&await Promise.race([ce.getAsPromise(c(this,N)),new Promise(s=>setTimeout(s,c(this,mt)))]);try{m(this,q,w(this,U,si).call(this)),await c(this,q)}catch(s){return w(this,U,xr).call(this,s.message),!1}let{references:t,referencesTree:a,placeholders:n,wcs:o}=c(this,I)||{};return o&&!Bt("mas.disableWcsCache")&&c(this,F).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ze,{detail:{...this.data,references:t,referencesTree:a,placeholders:n,...c(this,T)},bubbles:!0,composed:!0})),c(this,q)}get updateComplete(){return c(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,ee)?c(this,ee):(c(this,gt)?this.transformAuthorData():this.transformPublishData(),c(this,ee))}get rawData(){return c(this,I)}transformAuthorData(){let{fields:e,id:t,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:l={},placeholders:d={}}=c(this,I);m(this,ee,e.reduce((p,{name:g,multiple:f,values:C})=>(p.fields[g]=f?C:C[0],p),{fields:{},id:t,tags:a,settings:o,priceLiterals:s,dictionary:l,placeholders:d,variationId:n}))}transformPublishData(){if(!c(this,I))return;let{fields:e,id:t,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={},variationId:d}=c(this,I);m(this,ee,Object.entries(e).reduce((p,[g,f])=>(p.fields[g]=f?.mimeType?f.value:f??"",p),{fields:{},id:t,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l,variationId:d}))}getFragmentClientUrl(){let t=new URLSearchParams(window.location.search).get("maslibs");if(!t||t.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=t.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),a={locale:c(this,F).settings.locale,apiKey:c(this,F).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??c(this,F).settings.instant;return n&&(a.instant=n),await t(c(this,N),a)}};Ge=new WeakMap,I=new WeakMap,ee=new WeakMap,F=new WeakMap,N=new WeakMap,T=new WeakMap,pt=new WeakMap,mt=new WeakMap,q=new WeakMap,gt=new WeakMap,ut=new WeakMap,je=new WeakMap,U=new WeakSet,ni=async function(e){zr(this,ut)._++;let t=`${vr}:${c(this,N)}:${c(this,ut)}`,a=`${t}${zt}`,n=`${t}${Tt}`;if(c(this,je)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new se(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(c(this,T).stale=!1,c(this,T).url=e,o=await Za(e,{cache:"default",credentials:"omit"}),w(this,U,oi).call(this,o),c(this,T).status=o?.status,c(this,T).measure=Le(performance.measure(n,a)),c(this,T).retryCount=o.retryCount,!o?.ok)throw new se("Unexpected fragment response",{response:o,...c(this,F).duration});return await o.json()}catch(s){if(c(this,T).measure=Le(performance.measure(n,a)),c(this,T).retryCount=s.retryCount,c(this,I))return c(this,T).stale=!0,c(this,Ge).error("Serving stale data",c(this,T)),c(this,I);let l=s.message??"unknown";throw new se(`Failed to fetch fragment: ${l}`,{})}},oi=function(e){Object.assign(c(this,T),Qa(e))},xr=function(e){m(this,q,null),c(this,T).message=e,this.classList.add("error");let t={...c(this,T),...c(this,F).duration};c(this,Ge).error(e,t),this.dispatchEvent(new CustomEvent(Te,{detail:t,bubbles:!0,composed:!0}))},si=async function(){var l;this.classList.remove("error"),m(this,ee,null);let e=ce.get(c(this,N));if(e)return m(this,I,e),!0;let{masIOUrl:t,wcsApiKey:a,country:n,locale:o}=c(this,F).settings,s=`${t}/fragment?id=${c(this,N)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await w(this,U,ni).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,N)),ce.add(e),m(this,I,e),!0},h(Gt,"cache",ce);customElements.define(vr,Gt);import{LitElement as kn,html as yr,css as Cn,nothing as Sn}from"./lit-all.min.js";import{unsafeHTML as An}from"./lit-all.min.js";var zn=i=>i?i.startsWith("sp-icon-")?yr`${An(`<${i} class="badge-icon"></${i}>`)}`:yr`<img src="${i}" class="badge-icon" />`:Sn,Ve=class extends kn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return yr`<div class="badge">
            ${zn(this.icon)}<slot>${this.text}</slot>
        </div>`}};h(Ve,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),h(Ve,"styles",Cn`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Ve);import{html as Tn,css as Ln,LitElement as Pn}from"./lit-all.min.js";var ft=class extends Pn{constructor(){super()}render(){return Tn`
            <slot name="icon"></slot>
    ...
    `),h(ft,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ft);import{html as wr,css as _n,LitElement as Mn,nothing as ci}from"./lit-all.min.js";var vt=class extends Mn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return wr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?wr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:ci}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(vt,"styles",_n`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),h(vt,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",vt);var Rn={[re]:Hr,[he]:qr,[ae]:Ur},On={[re]:Gr,[ae]:j},bt,jt=class{constructor(r){u(this,bt);h(this,"changes",new Map);h(this,"connected",!1);h(this,"error");h(this,"log");h(this,"options");h(this,"promises",[]);h(this,"state",he);h(this,"timer",null);h(this,"value");h(this,"version",0);h(this,"wrapperElement");this.wrapperElement=r,this.log=ht.module("mas-element")}update(){[re,he,ae].forEach(r=>{this.wrapperElement.classList.toggle(Rn[r],r===this.state)})}notify(){(this.state===ae||this.state===re)&&(this.state===ae?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===re&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let r=this.error;this.error instanceof se&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(On[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,e,t){this.changes.set(r,t),this.requestUpdate()}connectedCallback(){m(this,bt,fr()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:e,state:t}=this;return ae===t?Promise.resolve(this.wrapperElement):re===t?Promise.reject(r):new Promise((a,n)=>{e.push({resolve:a,reject:n})})}toggleResolved(r,e,t){return r!==this.version?!1:(t!==void 0&&(this.options=t),this.state=ae,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),Ut(()=>this.notify()),!0)}toggleFailed(r,e,t){if(r!==this.version)return!1;t!==void 0&&(this.options=t),this.error=e,this.state=re,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...c(this,bt)?.duration}),Ut(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=he,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!fr()||this.timer)return;let{error:e,options:t,state:a,value:n,version:o}=this;this.state=he,this.timer=Ut(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===he&&this.version===o&&(this.state=a,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,t)}})}};bt=new WeakMap;function Dn(i){return`https://${i==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var xe,be=class be extends HTMLAnchorElement{constructor(){super();h(this,"masElement",new jt(this));u(this,xe);this.setAttribute("is",be.is)}get isUptLink(){return!0}initializeWcsData(e,t){this.setAttribute("data-wcs-osi",e),t&&this.setAttribute("data-promotion-code",t)}attributeChangedCallback(e,t,a){this.masElement.attributeChangedCallback(e,t,a)}connectedCallback(){this.masElement.connectedCallback(),m(this,xe,pe()),c(this,xe)&&(this.log=c(this,xe).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,xe,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=pe();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let t=e.collectCheckoutOptions({},this);if(!t.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(t),n=e.resolveOfferSelectors(t);try{let[[o]]=await Promise.all(n),{country:s,language:l,env:d}=t,p=`locale=${l}_${s}&country=${s}&offer_id=${o.offerId}`,g=this.getAttribute("data-promotion-code");g&&(p+=`&promotion_code=${encodeURIComponent(g)}`),this.href=`${Dn(d)}?${p}`,this.masElement.toggleResolved(a,o,t)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${t.wcsOsi}.`,o.message);return this.masElement.toggleFailed(a,s,t),!1}}static createFrom(e){let t=new be;for(let a of e.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?t.setAttribute("class",a.value.replace("upt-link","").trim()):t.setAttribute(a.name,a.value));return t.innerHTML=e.innerHTML,t.setAttribute("tabindex",0),t}};xe=new WeakMap,h(be,"is","upt-link"),h(be,"tag","a"),h(be,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var le=be;window.customElements.get(le.is)||window.customElements.define(le.is,le,{extends:le.tag});var Nn="#000000",Er="#F8D904",Fn="#EAEAEA",In="#31A547",$n=/(accent|primary|secondary)(-(outline|link))?/,Bn="mas:product_code/",Hn="daa-ll",Vt="daa-lh",qn=["XL","L","M","S"],kr="...",Un=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function $(i,r,e,t){let a=t[i];if(r[i]&&a){let n={slot:a?.slot,...a?.attributes},o=r[i];if(a.maxCount&&typeof o=="string"){let[l,d]=lo(o,a.maxCount,a.withSuffix);l!==o&&(n.title=d,o=l)}let s=_(a.tag,n,o);e.append(s)}}function Gn(i,r,e){let a=(i.mnemonicIcon||[]).filter(o=>o).map((o,s)=>({icon:o,alt:i.mnemonicAlt?.[s]??"",link:i.mnemonicLink?.[s]??""}));a?.forEach(({icon:o,alt:s,link:l})=>{if(l&&!/^https?:/.test(l))try{l=new URL(`https://${l}`).href.toString()}catch{l="#"}let d={slot:"icons",src:o,loading:r.loading,size:e?.size??"l"};s&&(d.alt=s),l&&(d.href=l);let p=_("merch-icon",d);r.append(p)});let n=r.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=a?.length?null:"none")}function jn(i,r,e){if(e.badge?.slot){if(i.badge?.length&&!i.badge?.startsWith("<merch-badge")){let t=Er,a=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(t=e.badge?.default,i.borderColor||(a=!0));let n=i.badgeBackgroundColor||t,o=i.borderColor||"";a&&(o=e.badge?.default,i.borderColor=e.badge?.default),i.badge=`<merch-badge variant="${i.variant}" background-color="${n}" border-color="${o}">${i.badge}</merch-badge>`}$("badge",i,r,e)}else i.badge?(r.setAttribute("badge-text",i.badge),e.disabledAttributes?.includes("badgeColor")||r.setAttribute("badge-color",i.badgeColor||Nn),e.disabledAttributes?.includes("badgeBackgroundColor")||r.setAttribute("badge-background-color",i.badgeBackgroundColor||Er),r.setAttribute("border-color",i.badgeBackgroundColor||Er)):r.setAttribute("border-color",i.borderColor||Fn)}function Vn(i,r,e){if(e.trialBadge&&i.trialBadge){if(!i.trialBadge.startsWith("<merch-badge")){let t=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&i.trialBadgeBorderColor||In;i.trialBadge=`<merch-badge variant="${i.variant}" border-color="${t}">${i.trialBadge}</merch-badge>`}$("trialBadge",i,r,e)}}function Wn(i,r,e){e?.includes(i.size)&&r.setAttribute("size",i.size)}function Kn(i,r){i.cardName&&r.setAttribute("name",i.cardName)}function Yn(i,r,e){i.cardTitle&&(i.cardTitle=We(i.cardTitle)),$("cardTitle",i,r,{cardTitle:e})}function Qn(i,r,e){$("subtitle",i,r,e)}function Zn(i,r,e,t){if(!i.backgroundColor||i.backgroundColor.toLowerCase()==="default"){r.style.removeProperty("--merch-card-custom-background-color"),r.removeAttribute("background-color");return}e?.[i.backgroundColor]?(r.style.setProperty("--merch-card-custom-background-color",`var(${e[i.backgroundColor]})`),r.setAttribute("background-color",i.backgroundColor)):t?.attribute&&i.backgroundColor&&(r.setAttribute(t.attribute,i.backgroundColor),r.style.removeProperty("--merch-card-custom-background-color"))}function Xn(i,r,e){let t=e?.borderColor,a="--consonant-merch-card-border-color";if(i.borderColor?.toLowerCase()==="transparent")r.style.setProperty(a,"transparent");else if(i.borderColor&&t){let o=t?.specialValues?.[i.borderColor]?.includes("gradient")||/-gradient/.test(i.borderColor),s=/^spectrum-.*-(plans|special-offers)$/.test(i.borderColor);if(o){r.setAttribute("gradient-border","true");let l=i.borderColor;if(t?.specialValues){for(let[d,p]of Object.entries(t.specialValues))if(p===i.borderColor){l=d;break}}r.setAttribute("border-color",l),r.style.removeProperty(a)}else s?(r.setAttribute("border-color",i.borderColor),r.style.setProperty(a,`var(--${i.borderColor})`)):r.style.setProperty(a,`var(--${i.borderColor})`)}}var Jn=new Set(["","default"]);function eo(i,r,e){let t=e?.whatsIncludedDividerColor,a="--consonant-merch-card-whats-included-divider-color";if(!t)return;let o=(r.querySelector('[slot="footer-rows"] merch-whats-included')??r.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),s=i.whatsIncludedDividerColor!=null?String(i.whatsIncludedDividerColor).trim():"",l=o||s;if(l==null||Jn.has(String(l).trim().toLowerCase())){r.removeAttribute("whats-included-divider-color"),r.style.removeProperty(a);return}let d=String(l).trim();if(d.toLowerCase()==="transparent"){r.removeAttribute("whats-included-divider-color"),r.style.setProperty(a,"transparent");return}let g=t.specialValues?.[d]?.includes("gradient")||/-gradient/.test(d)||/^gradient-/.test(d),f=/^spectrum-.*-(plans|special-offers)$/.test(d);if(g){let C=d;if(t.specialValues){for(let[G,te]of Object.entries(t.specialValues))if(te===d){C=G;break}}r.setAttribute("whats-included-divider-color",C),r.style.removeProperty(a)}else f?(r.setAttribute("whats-included-divider-color",d),r.style.setProperty(a,`var(--${d})`)):(r.removeAttribute("whats-included-divider-color"),r.style.setProperty(a,`var(--${d})`))}function to(i,r,e){if(i.backgroundImage){let t={loading:r.loading??"lazy",src:i.backgroundImage};if(i.backgroundImageAltText?t.alt=i.backgroundImageAltText:t.role="none",!e)return;if(e?.attribute){r.setAttribute(e.attribute,i.backgroundImage);return}r.append(_(e.tag,{slot:e.slot},_("img",t)))}}function We(i){return!i||typeof i!="string"||i.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(Xt(),Zt)).catch(console.error),i}function ro(i,r,e){i.prices&&(i.prices=We(i.prices)),$("prices",i,r,e)}function di(i,r,e){let t=i.hasAttribute("data-wcs-osi")&&!!i.getAttribute("data-wcs-osi"),a=i.className||"",n=$n.exec(a)?.[0]??"accent",o=n.includes("accent"),s=n.includes("primary"),l=n.includes("secondary"),d=n.includes("-outline"),p=n.includes("-link");i.classList.remove("accent","primary","secondary");let g;if(r.consonant)g=go(i,o,t,p,s,l,e?.ctas?.size);else if(p)g=i;else{let f;o?f="accent":s?f="primary":l&&(f="secondary"),g=r.spectrum==="swc"?mo(i,e,d,f,t):po(i,e,d,f,t)}return g}function ao(i,r){let{slot:e}=r?.description,t=i.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);t.length&&t.forEach(a=>{let n=di(a,i,r);a.replaceWith(n)})}function io(i,r,e,t){i.description&&(i.description=We(i.description)),i.promoText&&(i.promoText=We(i.promoText)),i.shortDescription&&(i.shortDescription=We(i.shortDescription)),$("promoText",i,r,e),$("description",i,r,e),$("shortDescription",i,r,e),i.shortDescription&&(r.setAttribute("action-menu","true"),i.actionMenuLabel||r.setAttribute("action-menu-label","More options")),ao(r,e),$("callout",i,r,e),no(i,r,e,t),$("whatsIncluded",i,r,e)}function no(i,r,e,t={}){e.quantitySelect&&(i.quantitySelect||(i.quantitySelect=t.quantitySelect),$("quantitySelect",i,r,e))}function oo(i,r,e,t={}){if(!e.addon)return;let n=(i.addon??t.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o=_("merch-addon",{slot:"addon"},n);[...o.querySelectorAll(y)].forEach(s=>{let l=s.parentElement;l?.nodeName==="P"&&l.setAttribute("data-plan-type","")}),r.append(o)}function so(i,r,e){i.addonConfirmation&&$("addonConfirmation",i,r,e)}function co(i,r,e,t){t?.secureLabel&&e?.secureLabel&&r.setAttribute("secure-label",t.secureLabel)}function lo(i,r,e=!0){try{let t=typeof i!="string"?"":i,a=li(t);if(a.length<=r)return[t,a];let n=0,o=!1,s=e?r-kr.length<1?1:r-kr.length:r,l=[];for(let g of t){if(n++,g==="<")if(o=!0,t[n]==="/")l.pop();else{let f="";for(let C of t.substring(n)){if(C===" "||C===">")break;f+=C}l.push(f)}if(g==="/"&&t[n]===">"&&l.pop(),g===">"){o=!1;continue}if(!o&&(s--,s===0))break}let d=t.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let g of l.reverse())d+=`</${g}>`}return[`${d}${e?kr:""}`,a]}catch{let a=typeof i=="string"?i:"",n=li(a);return[a,n]}}function li(i){if(!i)return"";let r="",e=!1;for(let t of i){if(t==="<"&&(e=!0),t===">"){e=!1;continue}e||(r+=t)}return r}function ho(i,r){r.querySelectorAll("a.upt-link").forEach(t=>{let a=le.createFrom(t);t.replaceWith(a),a.initializeWcsData(i.osi,i.promoCode)})}function po(i,r,e,t,a){let n=i;a?n=customElements.get("checkout-button").createCheckoutButton({},i.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of i.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=r?.ctas?.size??"M",s=`spectrum-Button--${t}`,l=qn.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",d=["spectrum-Button",s,l];return e&&d.push("spectrum-Button--outline"),n.classList.add(...d),n}function mo(i,r,e,t,a){let n=i;a&&(n=customElements.get("checkout-button").createCheckoutButton(i.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let s=_("sp-button",{treatment:o,variant:t,tabIndex:0,size:r?.ctas?.size??"m",...i.dataset.analyticsId&&{"data-analytics-id":i.dataset.analyticsId}},i.innerHTML);return s.source=n,(a?n.onceSettled():Promise.resolve(n)).then(l=>{s.setAttribute("data-navigation-url",l.href)}),s.addEventListener("click",l=>{l.defaultPrevented||n.click()}),s}function go(i,r,e,t,a,n,o){let s=i;if(e)try{let l=customElements.get("checkout-link");l&&(s=l.createCheckoutLink(i.dataset,i.innerHTML)??i)}catch{}return t||(s.classList.add("button","con-button"),o&&o!=="m"&&s.classList.add(`button-${o}`),r&&s.classList.add("blue"),a&&s.classList.add("primary"),n&&s.classList.add("secondary")),s}function uo(i,r,e,t,a){if(i.ctas){i.ctas=We(i.ctas);let{slot:n}=e.ctas,o=_("div",{slot:n},i.ctas),s=[...o.querySelectorAll("a")],l=a?.hideTrialCTAs?s.filter(p=>!Un.has(p.dataset.analyticsId)):s,d=(l.length>0?l:s).map(p=>di(p,r,e));o.textContent="",o.append(...d),r.append(o),a?.hideTrialCTAs&&l.length>0&&d.forEach(p=>{let g=p.source??p;g.onceSettled&&(p.hidden=!0,g.onceSettled().then(()=>{g.value?.[0]?.offerType==="TRIAL"&&d.some(C=>C!==p&&!C.hidden)?p.remove():p.hidden=!1}).catch(()=>{p.hidden=!1}))})}}function fo(i,r){let{tags:e}=i,t=e?.find(n=>typeof n=="string"&&n.startsWith(Bn))?.split("/").pop();if(!t)return;r.setAttribute(Vt,t),[...r.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...r.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(Hn,`${n.dataset.analyticsId}-${o+1}`)})}function vo(i){i.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([r,e])=>{i.querySelectorAll(`a.${r}`).forEach(t=>{t.classList.remove(r),t.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function bo(i){i.querySelectorAll("[slot]").forEach(t=>{t.remove()}),i.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",Vt].forEach(t=>i.removeAttribute(t));let e=["wide-strip","thin-strip"];i.classList.remove(...e)}async function hi(i,r){if(!i){let l=r?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!i.fields){let l=i.id||"unknown",d=r?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'.`)}let{id:e,fields:t,settings:a={},priceLiterals:n}=i,{variant:o}=t;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);bo(r),r.compatVersion=t.compatVersion,r.contextPromotionCode=t.promoCode,r.settings=a,n&&(r.priceLiterals=n),r.id??(r.id=i.id),i.variationId&&r.setAttribute("variation-id",i.variationId??""),r.variant=o,await r.updateComplete;let{aemFragmentMapping:s}=r.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&r.setAttribute("consonant",!0),Gn(t,r,s.mnemonics),Vn(t,r,s),Wn(t,r,s.size),Kn(t,r),Yn(t,r,s.title),jn(t,r,s),Qn(t,r,s),ro(t,r,s),to(t,r,s.backgroundImage),Zn(t,r,s.allowedColors,s.backgroundColor),Xn(t,r,s),io(t,r,s,a),eo(t,r,s),oo(t,r,s,a),so(t,r,s),co(t,r,s,a);try{ho(t,r)}catch{}uo(t,r,s,o,a),fo(t,r),vo(r)}var Kt="merch-card",pi="merch-card:",fi=["full-pricing-express","simplified-pricing-express"],vi=["segment","product"];function mi(i,r){let e=i.closest(Kt);if(!e)return r;e.priceLiterals&&(r.literals??(r.literals={}),Object.assign(r.literals,e.priceLiterals)),Kr(i)&&(r.displayPerUnit=!1,r.displayTax=!1),!r.promotionCode&&e.compatVersion>=1&&(r.promotionCode=e.contextPromotionCode),e.aemFragment&&(r[Vr]=!0),e.variantLayout?.priceOptionsProvider?.(i,r),i.dataset.template===M&&(r.displayDot??(r.displayDot=e.variantLayout?.legalDisplayDot??!0))}function gi(i,r){let e=i.closest(Kt);if(!e)return r;!r.promotionCode&&e.compatVersion>=1&&(r.promotionCode=e.contextPromotionCode)}function yo(i){i.providers.has(mi)||i.providers.price(mi),i.providers.has(gi)||i.providers.checkout(gi)}var xt=new IntersectionObserver(i=>{i.forEach(r=>{let e=r.target;if(fi.includes(e.variant)){if(e.clientHeight===0)return;xt.unobserve(e),e.requestUpdate();return}if(vi.includes(e.variant)){if(r.boundingClientRect.width===0)return;if(e.variant==="product"&&e.querySelector('merch-icon[slot="icons"]')){xt.unobserve(e);return}let t=e.getBoundingClientRect().width,n=e.querySelector('[slot="badge"]')?.getBoundingClientRect().width||0;if(t===0||n===0){xt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-n-16)}px`),xt.unobserve(e)}})}),wo=0,Ke,Ye,Qe,Q,we,B,Ee,A,ye,yt,Cr,Wt,de=class extends xo{constructor(){super();u(this,A);h(this,"contextPromotionCode");u(this,Ke);u(this,Ye);u(this,Qe);u(this,Q);u(this,we);u(this,B);u(this,Ee,new Promise(e=>{m(this,B,e)}));h(this,"compatVersion");h(this,"customerSegment");h(this,"marketSegment");h(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=dr(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=dr(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(t){w(this,A,ye).call(this,`Error in postCardUpdateHook: ${t.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(y)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(Z)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(Z)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(Z)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let t=this.checkoutLinks;if(t.length!==0)for(let a of t){await a.onceSettled();let n=a.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let s=a.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&s.push(o),a.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length===0)return;let a=n=>{let{offerType:o,planType:s}=n.value?.[0]??{};if(!o||!s)return;let l=e.getOsi(s,o),d=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==l);e.checked&&d.push(l),n.dataset.wcsOsi=d.join(",")};t.forEach(a)}handleQuantitySelection(e){let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length!==0)for(let a of t)a.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let t={...this.filters};Object.keys(t).forEach(a=>{if(e){t[a].order=Math.min(t[a].order||2,2);return}let n=t[a].order;n===1||isNaN(n)||(t[a].order=Number(n)+1)}),this.filters=t}showInfoTooltip(e,t){let a="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(a),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(a),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(t)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(t=>this.iconButton.addEventListener(t,a=>this.showInfoTooltip(a.target,e),!1)),["mouseleave","blur"].forEach(t=>this.iconButton.addEventListener(t,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",t=>{t.key==="Escape"&&this.iconButton.classList.remove(e)}))}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var t;super.connectedCallback(),c(this,Ye)||m(this,Ye,wo++),this.aemFragment||((t=c(this,B))==null||t.call(this),m(this,B,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??c(this,Ye);m(this,we,`${pi}${e}${zt}`),m(this,Ke,`${pi}${e}${Tt}`),performance.mark(c(this,we)),m(this,Q,pe()),yo(c(this,Q)),m(this,Qe,c(this,Q).Log.module(Kt)),this.addEventListener(O,this.handleQuantitySelection),this.addEventListener(Jt,this.handleAddonAndQuantityUpdate),this.addEventListener(Fr,this.handleMerchOfferSelectReady),this.addEventListener(Te,this.handleAemFragmentEvents),this.addEventListener(ze,this.handleAemFragmentEvents),this.addEventListener(St,this.handleInfoIconEvents),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(O,this.handleQuantitySelection),this.removeEventListener(Te,this.handleAemFragmentEvents),this.removeEventListener(ze,this.handleAemFragmentEvents),this.removeEventListener(St,this.handleInfoIconEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(Jt,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var t;if(this.isConnected&&(e.type===Te&&w(this,A,ye).call(this,"AEM fragment cannot be loaded"),e.type===ze&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let a=e.detail;try{c(this,B)||m(this,Ee,new Promise(n=>{m(this,B,n)})),hi(a,this)}catch(n){w(this,A,ye).call(this,`hydration has failed: ${n.message}`)}finally{(t=c(this,B))==null||t.call(this),m(this,B,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;c(this,Ee)&&(await c(this,Ee),(fi.includes(this.variant)||vi.includes(this.variant))&&xt.observe(this),m(this,Ee,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(o=>setTimeout(()=>o("timeout"),Se));if(this.aemFragment){let o=await Promise.race([this.aemFragment.updateComplete,e]);if(o===!1||o==="timeout"){let s=o==="timeout"?`AEM fragment was not resolved within ${Se} timeout`:"AEM fragment cannot be loaded";w(this,A,ye).call(this,s,{},!1);return}}let t=[...this.querySelectorAll(Nr)],a=Promise.all(t.map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(s=>s.classList.contains("placeholder-resolved"))),n=await Promise.race([a,e]);if(n===!0){this.measure=performance.measure(c(this,Ke),c(this,we));let o={...this.aemFragment?.fetchInfo,...c(this,Q).duration,measure:Le(this.measure)};return this.dispatchEvent(new CustomEvent(St,{bubbles:!0,composed:!0,detail:o})),this}else{this.measure=performance.measure(c(this,Ke),c(this,we));let o={measure:Le(this.measure),...c(this,Q).duration};if(n==="timeout")w(this,A,ye).call(this,`Contains offers that were not resolved within ${Se} timeout`,o);else{let s=t.some(l=>l.matches(Z)&&l.classList.contains("placeholder-failed"));w(this,A,ye).call(this,s?"CTA has an invalid offer":"Contains unresolved offers",o)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(Z)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:t}}){if(!e||!t?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let s=new URL(n.getAttribute("href")).searchParams.get("pa"),l=t.find(p=>p.productArrangementCode===s)?.quantity,d=!!t.find(p=>p.productArrangementCode!==s);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent($r,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==d){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:d}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(y))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${y}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return c(this,A,yt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${y}[data-promotion-code],${Z}[data-promotion-code]`)].map(a=>a.dataset.promotionCode).filter(a=>![void 0,"cancel-context"].includes(a));if(e.length===0)return this.contextPromotionCode;let t=[...new Set(e)];return t.length>1&&c(this,Qe)?.warn(`Multiple different promotion codes found: ${t.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${y}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(c(this,A,Cr)??c(this,A,yt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return c(this,A,yt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return c(this,A,Cr)?.querySelector(e)?.textContent?.trim()??c(this,A,yt)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return w(this,A,Wt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${Z}, a`);return Array.from(e??[])}get primaryCta(){return w(this,A,Wt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return w(this,A,Wt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Ke=new WeakMap,Ye=new WeakMap,Qe=new WeakMap,Q=new WeakMap,we=new WeakMap,B=new WeakMap,Ee=new WeakMap,A=new WeakSet,ye=function(e,t={},a=!0){var l;if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let s={...this.aemFragment.fetchInfo,...c(this,Q).duration,...t,message:e};c(this,Qe).error(`merch-card${o}: ${e}`,s),this.failed=!0,(l=c(this,B))==null||l.call(this),m(this,B,void 0),c(this,Q).isPreview()||(this.style.display="none"),a&&this.dispatchEvent(new CustomEvent(Br,{bubbles:!0,composed:!0,detail:s}))},yt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${y}[data-template="price"] > span`)},Cr=function(){return this.querySelector(`${y}[data-template="legal"]`)},Wt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},h(de,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[t,a,n]=e.split(",");return{PUF:t,ABM:a,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(t=>{let[a,n,o]=t.split(":"),s=Number(n);return[a,{order:isNaN(s)?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([t,{order:a,size:n}])=>[t,a,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Vt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),h(de,"styles",[Mr,...Rr()]),h(de,"registerVariant",S),h(de,"getCollectionOptions",$a),h(de,"getFragmentMapping",_t);customElements.define(Kt,de);export{de as MerchCard};

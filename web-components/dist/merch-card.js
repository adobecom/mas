var Er=Object.defineProperty;var kr=a=>{throw TypeError(a)};var pi=(a,t,e)=>t in a?Er(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var mi=(a,t)=>()=>(a&&(t=a(a=0)),t);var gi=(a,t)=>{for(var e in t)Er(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>pi(a,typeof t!="symbol"?t+"":t,e),Kt=(a,t,e)=>t.has(a)||kr("Cannot "+e);var c=(a,t,e)=>(Kt(a,t,"read from private field"),e?e.call(a):t.get(a)),u=(a,t,e)=>t.has(a)?kr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Kt(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),S=(a,t,e)=>(Kt(a,t,"access private method"),e);var Cr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return c(a,t,r)}});var Yt={};gi(Yt,{default:()=>Je});import{LitElement as ui,html as Ce,css as fi,nothing as vi}from"./lit-all.min.js";import{unsafeHTML as _r}from"./lit-all.min.js";import{ifDefined as bi}from"./lit-all.min.js";function xi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var _,Je,Qt=mi(()=>{_=class _ extends ui{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();_.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),h=l?l.offsetWidth:o,p=l?l.offsetHeight:s,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-h-n<0?f="right":f==="right"&&e.right+h+n>r&&(f="left");let k=e.left+e.width/2,U=e.top+e.height/2,ee=6,wt=(li,di,hi)=>Math.max(li,Math.min(di,hi)),Et,kt,Wt;f==="top"||f==="bottom"?(Et=f==="top"?e.top-p-n:e.bottom+n,kt=wt(0,r-h,k-h/2),Wt=wt(ee,h-ee*2,k-kt-ee)):(kt=f==="left"?e.left-h-n:e.right+n,Et=wt(0,i-p,U-p/2),Wt=wt(ee,p-ee*2,U-Et-ee)),this._tooltipTop=Et,this._tooltipLeft=kt,this._arrowOffset=Wt,this._computedPlacement=f}showTooltip(){_.activeTooltip&&_.activeTooltip!==this&&(_.activeTooltip.closeOverlay(),_.activeTooltip.tooltipVisible=!1,_.activeTooltip.requestUpdate()),_.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){_.activeTooltip===this&&(_.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ce`<merch-icon
        ...
        ></merch-icon>`:Ce`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return Ce`<span class="icon-only">${this.renderIcon()}</span>`;if(xi())return Ce`
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${bi(h)}>
                    ${_r(t)}
    ...
    `);Je=_;customElements.define("mas-mnemonic",Je)});import{LitElement as lo}from"./lit-all.min.js";import{css as Tr,unsafeCSS as zr}from"./lit-all.min.js";var w="(max-width: 767px)",T="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",L="(min-width: 1600px)",Sr="(min-width: 1280px)",Ar={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${L})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Ar;function Ct(){return Ar.isDesktop}var Lr=Tr`
    :host {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as nt,css as Pi}from"./lit-all.min.js";var Kr=`
:root {
...
`;var Mt=class extends b{constructor(t){super(t)}getGlobalCSS(){return Qr}renderLayout(){return Zr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Di=32,aa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Fe=class extends b{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>Rt` <footer>
    ...
    `);import{html as ot,css as Fi,nothing as Ot}from"./lit-all.min.js";var ia=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?Z`
        ...
        `:Z`
            ...
            <slot></slot>`}};d(ne,"variantStyle",Ni`
...
`;var ha={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},oe,V,ue,fe,ct,Ne=class extends b{constructor(){super(...arguments);u(this,fe);d(this,"expanded",!1);d(this,"licenseOpen",!1);d(this,"licenseQty",null);u(this,oe,null);u(this,V,null);u(this,ue,null);d(this,"handleResize",()=>{c(this,V)&&cancelAnimationFrame(c(this,V)),m(this,V,requestAnimationFrame(()=>{m(this,V,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))});d(this,"toggleExpanded",e=>{e.preventDefault(),this.expanded=!this.expanded,this.card.requestUpdate()});d(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen=!this.licenseOpen,this.licenseOpen?(m(this,oe,r=>{r.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),S(this,fe,ct).call(this))}),document.addEventListener("mousedown",c(this,oe))):S(this,fe,ct).call(this),this.card.requestUpdate()});d(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,S(this,fe,ct).call(this);let r=this.quantitySelectEl;r&&(r.selectedValue=Number(e),r.dispatchEvent(new CustomEvent(M,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return da}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights())}syncHeights(){this.card.getBoundingClientRect().width<=2||this.syncRowHeights([{name:"top-card",getElement:e=>e.shadowRoot?.querySelector(".top-card")}])}connectedCallbackHook(){window.addEventListener("resize",this.handleResize),m(this,ue,new IntersectionObserver(([e])=>{e.boundingClientRect.height!==0&&e.isIntersecting&&(window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights()),c(this,ue)?.disconnect())})),c(this,ue).observe(this.card)}disconnectedCallbackHook(){S(this,fe,ct).call(this),window.removeEventListener("resize",this.handleResize),c(this,V)&&(cancelAnimationFrame(c(this,V)),m(this,V,null)),c(this,ue)?.disconnect()}get hasLegalText(){return!!this.card.querySelector('[slot="legal-text"]')}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let r=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(r)||Number.isNaN(i)||i<r)return null;let o=[];for(let s=r;s<=i;s+=n)o.push(String(s));return o.length?o:null}get licenseLabel(){return this.quantitySelectEl?.getAttribute("title")||"License"}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let r=this.quantitySelectEl?.getAttribute("default-value");return r!=null&&e.includes(r)?r:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return X`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,r=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel;return X`
        ...
        `}renderLayout(){let e=!!this.expanded;return X`
            ...
            ${this.hasWhatsIncluded?X`
                  ...
                  `:st}
            <slot></slot>
        `}};oe=new WeakMap,V=new WeakMap,ue=new WeakMap,fe=new WeakSet,ct=function(){c(this,oe)&&(document.removeEventListener("mousedown",c(this,oe)),m(this,oe,null))},d(Ne,"variantStyle",Ii`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
...
`;var ma={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},W,Ie=class extends b{constructor(e){super(e);u(this,W);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return pa}priceOptionsProvider(e,r){e.dataset.template===R&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return er` ${this.badge}
...
`;var ua={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},$e=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===R&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ga}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return tr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var va={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Be=class extends b{constructor(t){super(t)}getGlobalCSS(){return fa}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return qi`
    ...
    `);import{html as rr,css as Ui}from"./lit-all.min.js";var ba=`
:root {
...
`;var ir={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},lt=class lt extends b{getGlobalCSS(){return wa}get aemFragmentMapping(){return ir}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ea`
    ...
    `);var dt=lt;import{html as nr,css as Wi,nothing as Ki}from"./lit-all.min.js";var ka=`
...
`;var or={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},je=class extends b{getGlobalCSS(){return za}get aemFragmentMapping(){return or}renderLayout(){return Xi`
    ...
    `);var Nt=new Map,Ta=new WeakMap,La=new Map,C=(a,t,e=null,r=null,i)=>{Nt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};C("catalog",Oe,Wr,Oe.variantStyle);C("image",ge);C("inline-heading",Mt);C("mini-compare-chart",De,ea,De.variantStyle);C("mini-compare-chart-mweb",Fe,aa,Fe.variantStyle);C("plans",O,Dt,O.variantStyle,O.collectionOptions);C("plans-students",O,oa,O.variantStyle,O.collectionOptions);C("plans-education",O,na,O.variantStyle,O.collectionOptions);C("plans-v2",ne,la,ne.variantStyle,ne.collectionOptions);C("bizpro",Ne,ha,Ne.variantStyle);C("product",Ie,ma,Ie.variantStyle);C("segment",$e,ua,$e.variantStyle);C("media",Be,va,Be.variantStyle);C("headless",Ue,Ca,Ue.variantStyle);C("special-offers",qe,xa,qe.variantStyle);C("simplified-pricing-express",He,ar,He.variantStyle);C("full-pricing-express",dt,ir,dt.variantStyle);C("mini",Ge,Aa,Ge.variantStyle);C("image",ge,Yr,ge.variantStyle);C("fries",je,or,je.variantStyle);var en=(a,t,e)=>{try{let r=La.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),La.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},sr=a=>{let t=Nt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=Ta.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?en(a,r,i):{};return Ta.set(a,{appliedVariant:a.variant,...n}),new e(a)};function _t(a){return Nt.get(a)?.fragmentMapping}function Pa(a){return Nt.get(a)?.collectionOptions}var _a=document.createElement("style");_a.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var ve={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ra=1e3;function an(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Oa(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ve.serializableTypes.includes(e))return e}return a}function nn(a,t){if(!ve.ignoredProperties.includes(a))return Oa(t)}var lr={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(h=>{h!=null&&(an(h)?r:i).push(h)}),r.length&&(n+=` ${r.map(Oa).join(" ")}`);let{pathname:o,search:s}=window.location,l=`${ve.delimiter}page=${o}${s}`;l.length>Ra&&(l=`${l.slice(0,Ra)}<trunc>`),n+=l,i.length&&(n+=`${ve.delimiter}facts=`,n+=JSON.stringify(i,nn)),window.lana?.log(n,ve)}};function Da(a){Object.assign(ve,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in ve&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Fa={LOCAL:"local",PROD:"prod",STAGE:"stage"},dr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},hr=new Set,pr=new Set,Na=new Map,Ia={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},$a={filter:({level:a})=>a!==dr.DEBUG},on={filter:()=>!1};function sn(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&$t(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function cn(a){[...pr].every(t=>t(a))&&hr.forEach(t=>t(a))}function Ba(a){let t=(Na.get(a)??0)+1;Na.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Ba(`${r.namespace}/${i}`),updateConfig:Da};return Object.values(dr).forEach(i=>{r[i]=(n,...o)=>cn(sn(i,n,a,o,e))}),Object.seal(r)}function Bt(...a){a.forEach(t=>{let{append:e,filter:r}=t;$t(r)&&pr.add(r),$t(e)&&hr.add(e)})}function ln(a={}){let{name:t}=a,e=Ma(It("commerce.debug",{search:!0,storage:!0}),t===Fa.LOCAL);return Bt(e?Ia:$a),t===Fa.PROD&&Bt(lr),ht}function dn(){hr.clear(),pr.clear()}var ht={...Ba(Hr),Level:dr,Plugins:{consoleAppender:Ia,debugFilter:$a,quietFilter:on,lanaAppender:lr},init:ln,reset:dn,use:Bt};var hn="mas-commerce-service",Vl=ht.module("utilities"),pn={requestId:At,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var qt=a=>window.setTimeout(a);function mr(){return document.getElementsByTagName(hn)?.[0]}function qa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(pn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ha(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw i}var Ua="fragment",Ga="author",ja="preview",Va="loading",Wa="timeout",gr="aem-fragment",Ka="eager",Ya="cache",mn=[Ka,Ya],K,be,B,ur=class{constructor(){u(this,K,new Map);u(this,be,new Map);u(this,B,new Map)}clear(){c(this,K).clear(),c(this,be).clear(),c(this,B).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,K).set(t.id,t),t.fields?.originalId&&c(this,K).set(t.fields.originalId,t),c(this,B).has(t.id)){let[,r]=c(this,B).get(t.id);r()}if(c(this,B).has(t.fields?.originalId)){let[,r]=c(this,B).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,K).has(t)}entries(){return c(this,K).entries()}get(t){return c(this,K).get(t)}getAsPromise(t){let[e]=c(this,B).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),c(this,B).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,be).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,be).set(t,e)),e}remove(t){c(this,K).delete(t),c(this,be).delete(t),c(this,B).delete(t)}};K=new WeakMap,be=new WeakMap,B=new WeakMap;var ce=new ur,Ve,N,J,F,D,z,pt,mt,q,gt,ut,We,H,Qa,Za,fr,Xa,Ht=class extends HTMLElement{constructor(){super(...arguments);u(this,H);d(this,"cache",ce);u(this,Ve);u(this,N,null);u(this,J,null);u(this,F,null);u(this,D);u(this,z);u(this,pt,Ka);u(this,mt,5e3);u(this,q);u(this,gt,!1);u(this,ut,0);u(this,We)}static get observedAttributes(){return[Ua,Va,Wa,Ga,ja]}attributeChangedCallback(e,r,i){e===Ua&&(m(this,D,i),m(this,z,ce.getFetchInfo(i))),e===Va&&mn.includes(i)&&m(this,pt,i),e===Wa&&m(this,mt,parseInt(i,10)),e===Ga&&m(this,gt,["","true"].includes(i)),e===ja&&m(this,We,i)}connectedCallback(){if(!c(this,q)){if(c(this,F)??m(this,F,pe(this)),m(this,We,c(this,F).settings?.preview),c(this,Ve)??m(this,Ve,c(this,F).log.module(`${gr}[${c(this,D)}]`)),!c(this,D)||c(this,D)==="#"){c(this,z)??m(this,z,ce.getFetchInfo("missing-fragment-id")),S(this,H,fr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,z)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,q)&&!await Promise.race([c(this,q),Promise.resolve(!1)]))return;e&&ce.remove(c(this,D)),c(this,pt)===Ya&&await Promise.race([ce.getAsPromise(c(this,D)),new Promise(s=>setTimeout(s,c(this,mt)))]);try{m(this,q,S(this,H,Xa).call(this)),await c(this,q)}catch(s){return S(this,H,fr).call(this,s.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=c(this,N)||{};return o&&!It("mas.disableWcsCache")&&c(this,F).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Te,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...c(this,z)},bubbles:!0,composed:!0})),c(this,q)}get updateComplete(){return c(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,J)?c(this,J):(c(this,gt)?this.transformAuthorData():this.transformPublishData(),c(this,J))}get rawData(){return c(this,N)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:s={},dictionary:l={},placeholders:h={}}=c(this,N);m(this,J,e.reduce((p,{name:g,multiple:f,values:k})=>(p.fields[g]=f?k:k[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:s,dictionary:l,placeholders:h,variationId:n}))}transformPublishData(){if(!c(this,N))return;let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={},variationId:h}=c(this,N);m(this,J,Object.entries(e).reduce((p,[g,f])=>(p.fields[g]=f?.mimeType?f.value:f??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:s,placeholders:l,variationId:h}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:c(this,F).settings.locale,apiKey:c(this,F).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??c(this,F).settings.instant;return n&&(i.instant=n),await r(c(this,D),i)}};Ve=new WeakMap,N=new WeakMap,J=new WeakMap,F=new WeakMap,D=new WeakMap,z=new WeakMap,pt=new WeakMap,mt=new WeakMap,q=new WeakMap,gt=new WeakMap,ut=new WeakMap,We=new WeakMap,H=new WeakSet,Qa=async function(e){Cr(this,ut)._++;let r=`${gr}:${c(this,D)}:${c(this,ut)}`,i=`${r}${zt}`,n=`${r}${Tt}`;if(c(this,We)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new se(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(c(this,z).stale=!1,c(this,z).url=e,o=await Ha(e,{cache:"default",credentials:"omit"}),S(this,H,Za).call(this,o),c(this,z).status=o?.status,c(this,z).measure=Pe(performance.measure(n,i)),c(this,z).retryCount=o.retryCount,!o?.ok)throw new se("Unexpected fragment response",{response:o,...c(this,F).duration});return await o.json()}catch(s){if(c(this,z).measure=Pe(performance.measure(n,i)),c(this,z).retryCount=s.retryCount,c(this,N))return c(this,z).stale=!0,c(this,Ve).error("Serving stale data",c(this,z)),c(this,N);let l=s.message??"unknown";throw new se(`Failed to fetch fragment: ${l}`,{})}},Za=function(e){Object.assign(c(this,z),qa(e))},fr=function(e){m(this,q,null),c(this,z).message=e,this.classList.add("error");let r={...c(this,z),...c(this,F).duration};c(this,Ve).error(e,r),this.dispatchEvent(new CustomEvent(Le,{detail:r,bubbles:!0,composed:!0}))},Xa=async function(){var l;this.classList.remove("error"),m(this,J,null);let e=ce.get(c(this,D));if(e)return m(this,N,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=c(this,F).settings,s=`${r}/fragment?id=${c(this,D)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await S(this,H,Qa).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,D)),ce.add(e),m(this,N,e),!0},d(Ht,"cache",ce);customElements.define(gr,Ht);import{LitElement as gn,html as vr,css as un,nothing as fn}from"./lit-all.min.js";import{unsafeHTML as vn}from"./lit-all.min.js";var bn=a=>a?a.startsWith("sp-icon-")?vr`${vn(`<${a} class="badge-icon"></${a}>`)}`:vr`<img src="${a}" class="badge-icon" />`:fn,Ke=class extends gn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return vr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Ke);import{html as xn,css as yn,LitElement as wn}from"./lit-all.min.js";var ft=class extends wn{constructor(){super()}render(){return xn`
            <slot name="icon"></slot>
    ...
    `),d(ft,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ft);import{html as br,css as En,LitElement as kn,nothing as Ja}from"./lit-all.min.js";var vt=class extends kn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return br`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?br`<slot name="content"></slot>`:Ja}

var pr=Object.defineProperty;var mr=a=>{throw TypeError(a)};var Za=(a,t,e)=>t in a?pr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var Ja=(a,t)=>()=>(a&&(t=a(a=0)),t);var ei=(a,t)=>{for(var e in t)pr(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>Za(a,typeof t!="symbol"?t+"":t,e),It=(a,t,e)=>t.has(a)||mr("Cannot "+e);var s=(a,t,e)=>(It(a,t,"read from private field"),e?e.call(a):t.get(a)),u=(a,t,e)=>t.has(a)?mr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(It(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),P=(a,t,e)=>(It(a,t,"access private method"),e);var gr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return s(a,t,r)}});var Ft={};ei(Ft,{default:()=>Ge});import{LitElement as ti,html as fe,css as ri,nothing as ai}from"./lit-all.min.js";import{unsafeHTML as yr}from"./lit-all.min.js";import{ifDefined as ii}from"./lit-all.min.js";function ni(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var _,Ge,$t=Ja(()=>{_=class _ extends ti{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();_.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),h=l?l.offsetWidth:o,p=l?l.offsetHeight:c,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-h-n<0?f="right":f==="right"&&e.right+h+n>r&&(f="left");let T=e.left+e.width/2,ie=e.top+e.height/2,K=6,dt=(Ya,Qa,Xa)=>Math.max(Ya,Math.min(Qa,Xa)),ht,pt,Dt;f==="top"||f==="bottom"?(ht=f==="top"?e.top-p-n:e.bottom+n,pt=dt(0,r-h,T-h/2),Dt=dt(K,h-K*2,T-pt-K)):(pt=f==="left"?e.left-h-n:e.right+n,ht=dt(0,i-p,ie-p/2),Dt=dt(K,p-K*2,ie-ht-K)),this._tooltipTop=ht,this._tooltipLeft=pt,this._arrowOffset=Dt,this._computedPlacement=f}showTooltip(){_.activeTooltip&&_.activeTooltip!==this&&(_.activeTooltip.closeOverlay(),_.activeTooltip.tooltipVisible=!1,_.activeTooltip.requestUpdate()),_.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){_.activeTooltip===this&&(_.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?fe`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:fe`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return fe`<span class="icon-only">${this.renderIcon()}</span>`;if(ni())return fe`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let i=t.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:g=>{this.lastPointerType=g.pointerType},pointerenter:g=>g.pointerType!=="touch"&&this.showTooltip(),pointerleave:g=>g.pointerType!=="touch"&&this.hideTooltip(),click:g=>{this.lastPointerType==="touch"&&this.handleTap(g),this.lastPointerType=null}},c=this._computedPlacement,l=c==="top"||c==="bottom",h=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=l?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return fe`
            <span
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${ii(h)}>
                    ${yr(t)}
    ...
    `);Ge=_;customElements.define("mas-mnemonic",Ge)});import{LitElement as Kn}from"./lit-all.min.js";import{css as vr,unsafeCSS as fr}from"./lit-all.min.js";var w="(max-width: 767px)",A="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",L="(min-width: 1600px)",ur={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${L})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=ur;function mt(){return ur.isDesktop}var xr=vr`
    :host {
...
`,br=()=>[vr`
        ...
        `];import{LitElement as oi,html as wr,css as ci}from"./lit-all.min.js";function si(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var ve=class extends oi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(si())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>$t())}e.remove()})}render(){let{href:t}=this;return t?wr`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(ve,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(ve,"styles",ci`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",ve);var lo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ho=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var y='span[is="inline-price"][data-wcs-osi]',Y='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var li='a[is="upt-link"]',Er=`${y},${Y},${li}`;var kr="merch-offer-select:ready",Sr="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",Cr="merch-card-quantity:change",Bt="merch-modal:addon-and-quantity-update";var xe="merch-card-collection:literals-changed";var be="aem:load",ye="aem:error",gt="mas:ready",Ar="mas:error",Tr="placeholder-failed",Lr="placeholder-pending",zr="placeholder-resolved";var Pr="mas:failed",je="mas:resolved",_r="mas/commerce";var Q="failed",ne="pending",X="resolved";var ut="X-Request-Id",po=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var mo=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var ft=":start",vt=":duration";var N="legal",Mr="mas-ff-defaults";var di="mas-commerce-service";function Rr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function z(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function we(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function qt(){return window.matchMedia("(max-width: 1024px)").matches}function oe(){return document.getElementsByTagName(di)?.[0]}function Ve(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var We,ce,Ke,Ye,Ee,xt=class extends HTMLElement{constructor(){super();u(this,We,"");u(this,ce);u(this,Ke,[]);u(this,Ye,[]);u(this,Ee);m(this,Ee,Rr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,ce)?this.parentElement.style.borderRadius=s(this,ce):s(this,ce)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Ke).map((r,i)=>{let n=s(this,Ye)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,We)}, ${e})`}connectedCallback(){s(this,Ee).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,ce,i?.trim()),e==="colors"&&i?m(this,Ke,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,Ye,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,We,i?.trim()??""),s(this,Ee).call(this)}};We=new WeakMap,ce=new WeakMap,Ke=new WeakMap,Ye=new WeakMap,Ee=new WeakMap;customElements.define("merch-gradient",xt);import{LitElement as hi,html as pi,css as mi}from"./lit-all.min.js";var ke=class extends hi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(je,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(je,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return pi` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(ke,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),d(ke,"styles",mi`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",ke);import{html as bt,nothing as gi}from"./lit-all.min.js";var Se,Qe=class Qe{constructor(t){d(this,"card");u(this,Se);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,Se,s(this,Se)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,Se)}insertVariantStyle(){let t=this.constructor.name;if(!Qe.styleMap[t]){Qe.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),bt`
            <div
                id="badge"
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return yt(this.card.variant)}};Se=new WeakMap,d(Qe,"styleMap",{});var b=Qe;import{html as Ht,css as ui}from"./lit-all.min.js";var Or=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Xe,css as fi}from"./lit-all.min.js";var Dr=`
:root {
...
`;var wt=class extends b{constructor(t){super(t)}getGlobalCSS(){return Fr}renderLayout(){return $r` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":$r`<hr />`} ${this.secureLabelFooter}`}};import{html as Z,css as vi,unsafeCSS as qr}from"./lit-all.min.js";var Br=`
  :root {
...
`;var wi=32,jr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Te=class extends b{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>Et` <footer>
    ...
    `);import{html as Ze,css as Ei,nothing as kt}from"./lit-all.min.js";var Vr=`
:root {
...
`;var St={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Wr={...function(){let{whatsIncluded:a,size:t,...e}=St;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Kr={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=St;return i}()},U,M=class extends b{constructor(e){super(e);u(this,U);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===N&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Vr}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),h=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(c)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&l){if(h)l.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(l):p.appendChild(l)}return}if(i&&h){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!l){let f=h.cloneNode(!0);o.prepend(f)}h.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,U)||(m(this,U,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,U)?.disconnect(),m(this,U,null),this.syncHeights())})),s(this,U).observe(this.card));return}["heading-xs","subtitle","heading-m","promo-text","body-xs"].forEach(r=>{let i=this.card.querySelector(`[slot="${r}"]`);i&&this.updateCardElementMinHeight(i,r)})}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let h=0,p=this.card.querySelector('[slot="heading-s"]');p&&(h+=Ve(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(h+=Ve(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(h+=8+Ve(f));for(let ie of r.childNodes){if(ie.classList.contains("spacer"))break;h+=Ve(ie)}let T=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");h>(parseFloat(T)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${h}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${h}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){if(this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),window.matchMedia("(min-width: 768px)").matches){let e=this.getContainer();if(!e)return;let r=`--consonant-merch-card-${this.card.variant}`,i=e.style.getPropertyValue(`${r}-heading-xs-height`);requestAnimationFrame(i?()=>{this.syncHeights()}:()=>{e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(o=>o.variantLayout?.syncHeights?.())})}}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ze`<div class="divider"></div>`:kt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?Ze`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};U=new WeakMap,d(M,"variantStyle",Ei`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),d(M,"collectionOptions",{customHeaderArea:e=>e.sidenav?Ze`<slot name="resultsText"></slot>`:kt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let r=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let c=o.getAttribute("size"),l=c==="wide"?2:c==="super-wide"?3:1;l===2&&n%3===2&&(o.setAttribute("data-size",c),o.removeAttribute("size"),l=1),n+=l}};x.matchDesktop.addEventListener("change",r),e.addEventListener(xe,r),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",r),e.removeEventListener(xe,r)})}});import{html as V,css as ki,unsafeCSS as Qr,nothing as Ct}from"./lit-all.min.js";var Yr=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?V`
        ...
        `:V`
            ...
            `:Ct}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?V`<slot name="icons"></slot>`:Ct}get secureLabelFooter(){return V`<footer>
...
`;var Jr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Le=class extends b{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Zr}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ut` ${this.badge}
...
`;var ta={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ze=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ea}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Gt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var aa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Pe=class extends b{constructor(t){super(t)}getGlobalCSS(){return ra}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return Ai`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
...
`;var na={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},_e=class extends b{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ia}renderLayout(){return jt`${this.cardImage}
            ...
            ${this.evergreen?jt`
                  ...
                  `:jt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(_e,"variantStyle",Li`
...
`;var pa={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ne=class extends b{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return ha}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Di`
    ...
    `);import{html as Ii,css as Fi}from"./lit-all.min.js";var ma=`
...
`;var Yt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},De=class extends b{getGlobalCSS(){return ma}get aemFragmentMapping(){return Yt}renderLayout(){return Ii`
    ...
    `);var At=new Map,ga=new WeakMap,ua=new Map,k=(a,t,e=null,r=null,i)=>{At.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",Ce,Nr,Ce.variantStyle);k("image",se);k("inline-heading",wt);k("mini-compare-chart",Ae,Hr,Ae.variantStyle);k("mini-compare-chart-mweb",Te,jr,Te.variantStyle);k("plans",M,St,M.variantStyle,M.collectionOptions);k("plans-students",M,Kr,M.variantStyle,M.collectionOptions);k("plans-education",M,Wr,M.variantStyle,M.collectionOptions);k("plans-v2",J,Xr,J.variantStyle,J.collectionOptions);k("product",Le,Jr,Le.variantStyle);k("segment",ze,ta,ze.variantStyle);k("media",Pe,aa,Pe.variantStyle);k("headless",Oe,da,Oe.variantStyle);k("special-offers",_e,na,_e.variantStyle);k("simplified-pricing-express",Me,Vt,Me.variantStyle);k("full-pricing-express",Re,Wt,Re.variantStyle);k("mini",Ne,pa,Ne.variantStyle);k("image",se,Ir,se.variantStyle);k("fries",De,Yt,De.variantStyle);var $i=(a,t,e)=>{try{let r=ua.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ua.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Qt=a=>{let t=At.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=ga.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?$i(a,r,i):{};return ga.set(a,{appliedVariant:a.variant,...n}),new e(a)};function yt(a){return At.get(a)?.fragmentMapping}function fa(a){return At.get(a)?.collectionOptions}var va=document.createElement("style");va.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var le={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ba=1e3;function Hi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ya(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!le.serializableTypes.includes(e))return e}return a}function Ui(a,t){if(!le.ignoredProperties.includes(a))return ya(t)}var Zt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(h=>{h!=null&&(Hi(h)?r:i).push(h)}),r.length&&(n+=` ${r.map(ya).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${le.delimiter}page=${o}${c}`;l.length>ba&&(l=`${l.slice(0,ba)}<trunc>`),n+=l,i.length&&(n+=`${le.delimiter}facts=`,n+=JSON.stringify(i,Ui)),window.lana?.log(n,le)}};function wa(a){Object.assign(le,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in le&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Ea={LOCAL:"local",PROD:"prod",STAGE:"stage"},Jt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},er=new Set,tr=new Set,ka=new Map,Sa={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Ca={filter:({level:a})=>a!==Jt.DEBUG},Gi={filter:()=>!1};function ji(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Lt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Vi(a){[...tr].every(t=>t(a))&&er.forEach(t=>t(a))}function Aa(a){let t=(ka.get(a)??0)+1;ka.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Aa(`${r.namespace}/${i}`),updateConfig:wa};return Object.values(Jt).forEach(i=>{r[i]=(n,...o)=>Vi(ji(i,n,a,o,e))}),Object.seal(r)}function zt(...a){a.forEach(t=>{let{append:e,filter:r}=t;Lt(r)&&tr.add(r),Lt(e)&&er.add(e)})}function Wi(a={}){let{name:t}=a,e=xa(Tt("commerce.debug",{search:!0,storage:!0}),t===Ea.LOCAL);return zt(e?Sa:Ca),t===Ea.PROD&&zt(Zt),Je}function Ki(){er.clear(),tr.clear()}var Je={...Aa(_r),Level:Jt,Plugins:{consoleAppender:Sa,debugFilter:Ca,quietFilter:Gi,lanaAppender:Zt},init:Wi,reset:Ki,use:zt};var Yi="mas-commerce-service",wl=Je.module("utilities"),Qi={requestId:ut,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Pt=a=>window.setTimeout(a);function rr(){return document.getElementsByTagName(Yi)?.[0]}function Ta(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Qi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function La(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var za="fragment",Pa="author",_a="preview",Ma="loading",Ra="timeout",ar="aem-fragment",Oa="eager",Na="cache",Xi=[Oa,Na],G,de,$,ir=class{constructor(){u(this,G,new Map);u(this,de,new Map);u(this,$,new Map)}clear(){s(this,G).clear(),s(this,de).clear(),s(this,$).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,G).set(t.id,t),t.fields?.originalId&&s(this,G).set(t.fields.originalId,t),s(this,$).has(t.id)){let[,r]=s(this,$).get(t.id);r()}if(s(this,$).has(t.fields?.originalId)){let[,r]=s(this,$).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,G).has(t)}entries(){return s(this,G).entries()}get(t){return s(this,G).get(t)}getAsPromise(t){let[e]=s(this,$).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,$).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,de).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,de).set(t,e)),e}remove(t){s(this,G).delete(t),s(this,de).delete(t),s(this,$).delete(t)}};G=new WeakMap,de=new WeakMap,$=new WeakMap;var te=new ir,Ie,B,W,D,R,C,et,tt,q,rt,at,Fe,H,Da,Ia,nr,Fa,_t=class extends HTMLElement{constructor(){super(...arguments);u(this,H);d(this,"cache",te);u(this,Ie);u(this,B,null);u(this,W,null);u(this,D,null);u(this,R);u(this,C);u(this,et,Oa);u(this,tt,5e3);u(this,q);u(this,rt,!1);u(this,at,0);u(this,Fe)}static get observedAttributes(){return[za,Ma,Ra,Pa,_a]}attributeChangedCallback(e,r,i){e===za&&(m(this,R,i),m(this,C,te.getFetchInfo(i))),e===Ma&&Xi.includes(i)&&m(this,et,i),e===Ra&&m(this,tt,parseInt(i,10)),e===Pa&&m(this,rt,["","true"].includes(i)),e===_a&&m(this,Fe,i)}connectedCallback(){if(!s(this,q)){if(s(this,D)??m(this,D,oe(this)),m(this,Fe,s(this,D).settings?.preview),s(this,Ie)??m(this,Ie,s(this,D).log.module(`${ar}[${s(this,R)}]`)),!s(this,R)||s(this,R)==="#"){s(this,C)??m(this,C,te.getFetchInfo("missing-fragment-id")),P(this,H,nr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,C)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&te.remove(s(this,R)),s(this,et)===Na&&await Promise.race([te.getAsPromise(s(this,R)),new Promise(c=>setTimeout(c,s(this,tt)))]);try{m(this,q,P(this,H,Fa).call(this)),await s(this,q)}catch(c){return P(this,H,nr).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,B)||{};return o&&!Tt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(be,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,C)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,W)?s(this,W):(s(this,rt)?this.transformAuthorData():this.transformPublishData(),s(this,W))}get rawData(){return s(this,B)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:h={}}=s(this,B);m(this,W,e.reduce((p,{name:g,multiple:f,values:T})=>(p.fields[g]=f?T:T[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:h,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:h}=s(this,B);m(this,W,Object.entries(e).reduce((p,[g,f])=>(p.fields[g]=f?.mimeType?f.value:f??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:h}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,R),{locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0})}};Ie=new WeakMap,B=new WeakMap,W=new WeakMap,D=new WeakMap,R=new WeakMap,C=new WeakMap,et=new WeakMap,tt=new WeakMap,q=new WeakMap,rt=new WeakMap,at=new WeakMap,Fe=new WeakMap,H=new WeakSet,Da=async function(e){gr(this,at)._++;let r=`${ar}:${s(this,R)}:${s(this,at)}`,i=`${r}${ft}`,n=`${r}${vt}`;if(s(this,Fe)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new ee(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,C).stale=!1,s(this,C).url=e,o=await La(e,{cache:"default",credentials:"omit"}),P(this,H,Ia).call(this,o),s(this,C).status=o?.status,s(this,C).measure=we(performance.measure(n,i)),s(this,C).retryCount=o.retryCount,!o?.ok)throw new ee("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,C).measure=we(performance.measure(n,i)),s(this,C).retryCount=c.retryCount,s(this,B))return s(this,C).stale=!0,s(this,Ie).error("Serving stale data",s(this,C)),s(this,B);let l=c.message??"unknown";throw new ee(`Failed to fetch fragment: ${l}`,{})}},Ia=function(e){Object.assign(s(this,C),Ta(e))},nr=function(e){m(this,q,null),s(this,C).message=e,this.classList.add("error");let r={...s(this,C),...s(this,D).duration};s(this,Ie).error(e,r),this.dispatchEvent(new CustomEvent(ye,{detail:r,bubbles:!0,composed:!0}))},Fa=async function(){var l;this.classList.remove("error"),m(this,W,null);let e=te.get(s(this,R));if(e)return m(this,B,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,R)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await P(this,H,Da).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,R)),te.add(e),m(this,B,e),!0},d(_t,"cache",te);customElements.define(ar,_t);import{LitElement as Zi,html as or,css as Ji,nothing as en}from"./lit-all.min.js";import{unsafeHTML as tn}from"./lit-all.min.js";var rn=a=>a?a.startsWith("sp-icon-")?or`${tn(`<${a} class="badge-icon"></${a}>`)}`:or`<img src="${a}" class="badge-icon" />`:en,$e=class extends Zi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return or`<div class="badge">
            ${rn(this.icon)}<slot>${this.text}</slot>
        </div>`}};d($e,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),d($e,"styles",Ji`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",$e);import{html as an,css as nn,LitElement as on}from"./lit-all.min.js";var it=class extends on{constructor(){super()}render(){return an`
            <slot name="icon"></slot>
    ...
    `),d(it,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",it);import{html as cr,css as cn,LitElement as sn,nothing as $a}from"./lit-all.min.js";var nt=class extends sn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return cr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?cr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:$a}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(nt,"styles",cn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

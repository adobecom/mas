...
`;var Ne="mas-compare-chart",ft=3e4,X=4,xt=900,bt=64,yt=["icons","header","badge","price","description","detail","cta"],M={included:["\u2713","\u2714","\u2705"],excluded:["\u2717","\u2718","\u2716","\xD7"],notApplicable:["\u2014","-"]},Et=p=>M.included.includes(p),At=p=>M.excluded.includes(p),vt=p=>!p||M.notApplicable.includes(p)||/^-+$/.test(p),$=(p,h,e)=>p.placeholders?.[h]??e,F,E,T,S,R,_,G,I,A,z,k,w,C,V,Y,P,O,B,N,H,j,K,W,r,le,pe,Le,Me,Pe,Oe,Ie,He,D,$e,De,Ue,Q,Fe,de,Ge,ze,he,me,Ve,J,ue,wt,ee,ge,fe,Ye,Be,qe,xe,je,be,Ke,ye,te,We,re,Ze,Xe,Qe,U,Je,L,et,tt,rt,ot,at,it,Ee,q=class extends gt{constructor(){super();u(this,r);u(this,F);u(this,E,[]);u(this,T,[]);u(this,S,new Map);u(this,R,new Map);u(this,_,[]);u(this,G,[]);u(this,I,new Map);u(this,A,new Set);u(this,z);u(this,k,!1);u(this,w,0);u(this,C,1);u(this,V,!1);u(this,Y,!1);u(this,P,null);u(this,O,null);u(this,B,!1);u(this,N,0);u(this,H,()=>s(this,r,te).call(this));u(this,j,e=>{let t=e.target;if(t?.parentElement===this){s(this,r,Ie).call(this,e.detail,t);return}t?.closest?.("merch-card")?.parentElement===this&&s(this,r,D).call(this)});u(this,K,e=>{var t;e.target?.parentElement===this&&(m(this,_,[]),m(this,T,[]),m(this,E,[]),a(this,S).clear(),a(this,R).clear(),this.requestUpdate(),(t=a(this,O))==null||t.call(this,!1),m(this,P,null),m(this,O,null))});u(this,W,e=>{e.target?.parentElement===this&&s(this,r,D).call(this)});m(this,F,this.attachInternals?.()),a(this,F)&&(a(this,F).role="table")}connectedCallback(){super.connectedCallback(),this.addEventListener(ve,()=>s(this,r,D).call(this)),this.addEventListener(ie,a(this,j)),this.addEventListener(se,a(this,K)),this.addEventListener(ne,a(this,W)),m(this,z,new ResizeObserver(()=>s(this,r,ue).call(this))),a(this,z).observe(this),s(this,r,Ke).call(this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(ie,a(this,j)),this.removeEventListener(se,a(this,K)),this.removeEventListener(ne,a(this,W)),a(this,z)?.disconnect(),s(this,r,ye).call(this)}firstUpdated(){s(this,r,D).call(this)}updated(e){e.has("expandedGroups")&&s(this,r,de).call(this),(e.has("consonant")||e.has("spectrum"))&&s(this,r,pe).call(this),(e.has("stickyOffset")||e.has("stickyTop"))&&(s(this,r,be).call(this),s(this,r,te).call(this))}checkReady(){if(!this.querySelector(":scope > aem-fragment"))return Promise.resolve(!0);s(this,r,le).call(this);let t=new Promise(o=>setTimeout(()=>o(!1),ft));return Promise.race([a(this,P),t])}render(){return this.collapsed?y:v`
        ...
        `},Je=function(e){let t=new Set;for(let o of e)for(let i of o.presentSlots)t.add(i);return t},L=function(e,t,o){return o.has(t)?v`<slot name=${e.slots[t]}></slot>`:y},et=function(e,t,o,i,c,n){let l=["header-card-segment",`${t}-segment`],d=e.cellColor;return v`<div
            class=${l.join(" ")}
        ...
        </div>`},tt=function(e,t){if(!a(this,k)||a(this,T).length<=2)return y;let o=a(this,T).findIndex(n=>n.cardId===e.cardId),i=t===0?"A":"B",c=i==="A"?a(this,C):a(this,w);return v`<select
        ...
        </select>`},rt=function(e){let t=a(this,A).has(e.groupIndex);return v`
        ...
        `},it=function(e){let t=["cell"];return e.isCellPrimary&&t.push("primary-cell"),e.isEmojiPrimary&&t.push("emoji-primary-cell"),e.isItem&&t.push("item-cell"),v`<p
            role="cell"
            class=${t.join(" ")}
            data-card-id=${e.cardId}
            style="--col: ${e.col};"
        ...
        </p>`},Ee=function(e,t){return e?v`<span class="tooltip-wrapper" data-tooltip-position=${t||"top-center"}>

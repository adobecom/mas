...
`,xc=()=>[b`
    ...
    `);customElements.define("merch-addon",jt);M();var Wt,Qr=class Qr{constructor(t){u(this,"card");E(this,Wt);this.card=t,this.insertVariantStyle()}getContainer(){return y(this,Wt,m(this,Wt)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),m(this,Wt)}insertVariantStyle(){let t=this.constructor.name;if(!Qr.styleMap[t]){Qr.styleMap[t]=!0;let r=document.createElement("style");r.innerHTML=this.getGlobalCSS(),document.head.appendChild(r)}}updateCardElementMinHeight(t,r){if(!t||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let r=this.getContainer();if(!r)return;let i=this.card.variant,a=Array.from(r.querySelectorAll(`merch-card[variant="${i}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:o}of t){let s=`--consonant-merch-card-${i}-${o}-height`;r.style.getPropertyValue(s)&&r.style.removeProperty(s)}let n=new Map;for(let o of a){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of t){let l=`--consonant-merch-card-${i}-${s}-height`,d=0,h=[];for(let p of o){p.style.removeProperty(l);let g=c(p);if(!g){h.push({card:p,height:0});continue}let v=Math.max(0,parseInt(window.getComputedStyle(g).height)||0);h.push({card:p,height:v}),v>d&&(d=v)}if(!(d<=0))for(let{card:p}of h)p.style.setProperty(l,`${d}px`)}}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),f`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Ki(this.card.variant)}};Wt=new WeakMap,u(Qr,"styleMap",{});var C=Qr;M();var Tc=`
:root {
...
`;var Fc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Qt=class extends C{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Bc}priceOptionsProvider(t,r){t.dataset.template===ve&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return f` ${this.badge}
...
`;var Gc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Zt=class extends C{constructor(t){super(t)}priceOptionsProvider(t,r){t.dataset.template===ve&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}getGlobalCSS(){return Uc}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${D}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let r=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),t.parentNode.insertBefore(r,t.nextSibling),await r.onceSettled()}catch{}}renderLayout(){return f`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Vc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Jt=class extends C{constructor(t){super(t)}getGlobalCSS(){return qc}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return f`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Hn={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},ar=class extends C{getGlobalCSS(){return el}get aemFragmentMapping(){return Hn}renderLayout(){return f`
    ...
    `);var Ji=new Map,tl=new WeakMap,rl=new Map,q=(e,t,r=null,i=null,a)=>{Ji.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:a})};q("catalog",Yt,kc,Yt.variantStyle);q("image",At);q("inline-heading",Qi);q("mini-compare-chart",Xt,Mc,Xt.variantStyle);q("mini-compare-chart-mweb",Kt,Nc,Kt.variantStyle);q("plans",ge,Zi,ge.variantStyle,ge.collectionOptions);q("plans-students",ge,Dc,ge.variantStyle,ge.collectionOptions);q("plans-education",ge,zc,ge.variantStyle,ge.collectionOptions);q("plans-v2",et,Hc,et.variantStyle,et.collectionOptions);q("product",Qt,Fc,Qt.variantStyle);q("segment",Zt,Gc,Zt.variantStyle);q("media",Jt,Vc,Jt.variantStyle);q("headless",rr,Qc,rr.variantStyle);q("special-offers",er,Wc,er.variantStyle);q("simplified-pricing-express",tr,Dn,tr.variantStyle);q("full-pricing-express",Zr,$n,Zr.variantStyle);q("mini",ir,Jc,ir.variantStyle);q("image",At,Pc,At.variantStyle);q("fries",ar,Hn,ar.variantStyle);var hp=(e,t,r)=>{try{let i=rl.get(e.variant);if(i||(i=new CSSStyleSheet,i.replaceSync(t.cssText),rl.set(e.variant,i)),r?.styleSheet&&r.styleSheet!==i){let a=e.shadowRoot.adoptedStyleSheets.indexOf(r.styleSheet);a!==-1&&e.shadowRoot.adoptedStyleSheets.splice(a,1)}return e.shadowRoot.adoptedStyleSheets.includes(i)||e.shadowRoot.adoptedStyleSheets.push(i),{styleSheet:i}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",e.variant);let n=r?.styleElement||e.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),e.shadowRoot.appendChild(a),{styleElement:a}}},Bn=e=>{let t=Ji.get(e.variant);if(!t)return;let{class:r,style:i}=t,a=tl.get(e);if(a?.appliedVariant===e.variant)return new r(e);let n=i?hp(e,i,a):{};return tl.set(e,{appliedVariant:e.variant,...n}),new r(e)};function Ki(e){return Ji.get(e)?.fragmentMapping}function il(e){return Ji.get(e)?.collectionOptions}var al=document.createElement("style");al.innerHTML=`
:root {
...
`;document.head.appendChild(al);var nl="fragment",ol="author",sl="preview",cl="loading",ll="timeout",Fn="aem-fragment",dl="eager",hl="cache",pp=[dl,hl],$e,Tt,Pe,Un=class{constructor(){E(this,$e,new Map);E(this,Tt,new Map);E(this,Pe,new Map)}clear(){m(this,$e).clear(),m(this,Tt).clear(),m(this,Pe).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(m(this,$e).set(t.id,t),t.fields?.originalId&&m(this,$e).set(t.fields.originalId,t),m(this,Pe).has(t.id)){let[,i]=m(this,Pe).get(t.id);i()}if(m(this,Pe).has(t.fields?.originalId)){let[,i]=m(this,Pe).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return m(this,$e).has(t)}entries(){return m(this,$e).entries()}get(t){return m(this,$e).get(t)}getAsPromise(t){let[r]=m(this,Pe).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),m(this,Pe).set(t,[r,i]),r}getFetchInfo(t){let r=m(this,Tt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},m(this,Tt).set(t,r)),r}remove(t){m(this,$e).delete(t),m(this,Tt).delete(t),m(this,Pe).delete(t)}};$e=new WeakMap,Tt=new WeakMap,Pe=new WeakMap;var tt=new Un,nr,Le,We,Se,fe,J,Jr,ei,Re,ti,ri,or,Me,pl,ml,Gn,ul,ea=class extends HTMLElement{constructor(){super(...arguments);E(this,Me);u(this,"cache",tt);E(this,nr);E(this,Le,null);E(this,We,null);E(this,Se,null);E(this,fe);E(this,J);E(this,Jr,dl);E(this,ei,5e3);E(this,Re);E(this,ti,!1);E(this,ri,0);E(this,or)}static get observedAttributes(){return[nl,cl,ll,ol,sl]}attributeChangedCallback(r,i,a){r===nl&&(y(this,fe,a),y(this,J,tt.getFetchInfo(a))),r===cl&&pp.includes(a)&&y(this,Jr,a),r===ll&&y(this,ei,parseInt(a,10)),r===ol&&y(this,ti,["","true"].includes(a)),r===sl&&y(this,or,a)}connectedCallback(){if(!m(this,Re)){if(m(this,Se)??y(this,Se,ft(this)),y(this,or,m(this,Se).settings?.preview),m(this,nr)??y(this,nr,m(this,Se).log.module(`${Fn}[${m(this,fe)}]`)),!m(this,fe)||m(this,fe)==="#"){m(this,J)??y(this,J,tt.getFetchInfo("missing-fragment-id")),Z(this,Me,Gn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(m(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(m(this,Re)&&!await Promise.race([m(this,Re),Promise.resolve(!1)]))return;r&&tt.remove(m(this,fe)),m(this,Jr)===hl&&await Promise.race([tt.getAsPromise(m(this,fe)),new Promise(s=>setTimeout(s,m(this,ei)))]);try{y(this,Re,Z(this,Me,ul).call(this)),await m(this,Re)}catch(s){return Z(this,Me,Gn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=m(this,Le)||{};return o&&!U("mas.disableWcsCache")&&m(this,Se).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(st,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...m(this,J)},bubbles:!0,composed:!0})),m(this,Re)}get updateComplete(){return m(this,Re)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return m(this,We)?m(this,We):(m(this,ti)?this.transformAuthorData():this.transformPublishData(),m(this,We))}get rawData(){return m(this,Le)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=m(this,Le);y(this,We,r.reduce((d,{name:h,multiple:p,values:g})=>(d.fields[h]=p?g:g[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=m(this,Le);y(this,We,Object.entries(r).reduce((d,[h,p])=>(d.fields[h]=p?.mimeType?p.value:p??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(m(this,fe),{locale:m(this,Se).settings.locale,apiKey:m(this,Se).settings.wcsApiKey,fullContext:!0})}};nr=new WeakMap,Le=new WeakMap,We=new WeakMap,Se=new WeakMap,fe=new WeakMap,J=new WeakMap,Jr=new WeakMap,ei=new WeakMap,Re=new WeakMap,ti=new WeakMap,ri=new WeakMap,or=new WeakMap,Me=new WeakSet,pl=async function(r){oo(this,ri)._++;let i=`${Fn}:${m(this,fe)}:${m(this,ri)}`,a=`${i}${dt}`,n=`${i}${ht}`;if(m(this,or)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Ne(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(m(this,J).stale=!1,m(this,J).url=r,o=await Hi(r,{cache:"default",credentials:"omit"}),Z(this,Me,ml).call(this,o),m(this,J).status=o?.status,m(this,J).measure=Ie(performance.measure(n,a)),m(this,J).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...m(this,Se).duration});return await o.json()}catch(s){if(m(this,J).measure=Ie(performance.measure(n,a)),m(this,J).retryCount=s.retryCount,m(this,Le))return m(this,J).stale=!0,m(this,nr).error("Serving stale data",m(this,J)),m(this,Le);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},ml=function(r){Object.assign(m(this,J),Si(r))},Gn=function(r){y(this,Re,null),m(this,J).message=r,this.classList.add("error");let i={...m(this,J),...m(this,Se).duration};m(this,nr).error(r,i),this.dispatchEvent(new CustomEvent(ct,{detail:i,bubbles:!0,composed:!0}))},ul=async function(){var c;this.classList.remove("error"),y(this,We,null);let r=tt.get(m(this,fe));if(r)return y(this,Le,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=m(this,Se).settings,s=`${i}/fragment?id=${m(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Me,pl).call(this,s),(c=r.fields).originalId??(c.originalId=m(this,fe)),tt.add(r),y(this,Le,r),!0},u(ea,"cache",tt);customElements.define(Fn,ea);M();In();var mp=e=>e?e.startsWith("sp-icon-")?f`${jr(`<${e} class="badge-icon"></${e}>`)}`:f`<img src="${e}" class="badge-icon" />`:w,sr=class extends G{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">
    ...
    `),u(ci,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",ci);M();M();var Al=b`
    :host {
...
`;var[ry,iy,Yn,Xn,Tl,kl]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Kn=class extends G{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return Cl}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=Ir(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=Ir(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(Ot,this.debouncedQuantityUpdate)}get button(){return this.shadowRoot.querySelector("button")}handleKeyup(t){t.key===Xn||t.key===Yn||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let t=this.options[this.highlightedIndex];if(!t){this.closed=!0;return}this.selectedValue=t,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(t){switch(t.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case kl:this.selectValue();break;case Xn:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,t.preventDefault();break;case Yn:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),t.preventDefault();break;case Tl:this.selectValue(),this.button.classList.contains("focused")&&t.preventDefault();break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=t.value.replace(/\D/g,"");t.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let a=i;this.maxInput&&i>this.maxInput&&(a=this.maxInput),this.min&&a<this.min&&(a=this.min),this.adjustInput(t,a)}else this.adjustInput(t,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(Ot,this.debouncedQuantityUpdate)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}update(t){if(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue")){this.options=this.generateOptionsArray();let r=this.options[0],i=this.defaultValue!=null&&this.options.includes(this.defaultValue)?this.defaultValue:r;this.highlightedIndex=this.options.indexOf(i),this.handleMenuOption(i)}super.update(t)}handleClickOutside(t){t.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let t=this.shadowRoot.querySelector(".popover");this.closed||t.getBoundingClientRect().bottom<=window.innerHeight?t.setAttribute("placement","bottom"):t.setAttribute("placement","top")}handleMouseEnter(t){this.highlightedIndex=t}handleMenuOption(t,r){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let t=new CustomEvent(te,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}get configured(){return this.title||this.min||this.step}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return f` <div
        ...
        `:w}};customElements.define("merch-quantity-select",Kn);Yi();M();var _l=`
...
`;var Rl={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},ur=class extends C{getGlobalCSS(){return Ll}renderLayout(){return f` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Zn={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},fr=class extends C{getGlobalCSS(){return Ol}get aemFragmentMapping(){return Zn}renderLayout(){return f`
    ...
    `);q("ccd-suggested",mr,Pl,mr.variantStyle);q("ccd-slice",ur,Rl,ur.variantStyle);q("ah-try-buy-widget",gr,Qn,gr.variantStyle);q("ah-promoted-plans",fr,Zn,fr.variantStyle);

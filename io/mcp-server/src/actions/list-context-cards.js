 ...
 * Adobe I/O Runtime action for list_context_cards operation
 */
async function main(params) {
    const { fragmentIds, operationType, __ow_headers } = params;
    ...
    try {
        ...
        const result = await studioOps.listContextCards({ fragmentIds, operationType });
        ...
        console.error('List context cards error:', error);
        return {
            statusCode: 500,

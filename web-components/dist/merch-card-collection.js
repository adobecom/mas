var ln=Object.defineProperty;var dn=e=>{throw TypeError(e)};var Tc=(e,r,t)=>r in e?ln(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var kc=(e,r)=>{for(var t in r)ln(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Tc(e,typeof r!="symbol"?r+"":r,t),ya=(e,r,t)=>r.has(e)||dn("Cannot "+t);var v=(e,r,t)=>(ya(e,r,"read from private field"),t?t.call(e):r.get(e)),S=(e,r,t)=>r.has(e)?dn("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),E=(e,r,t,a)=>(ya(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),U=(e,r,t)=>(ya(e,r,"access private method"),t);import{html as De,LitElement as gc,css as fc,unsafeCSS as uc,nothing as we}from"./lit-all.min.js";var z="(max-width: 767px)",Q="(max-width: 1199px)",R="(min-width: 768px)",L="(min-width: 1200px)",ne="(min-width: 1600px)",$t="(min-width: 1280px)",hn={matchMobile:window.matchMedia(z),matchDesktop:window.matchMedia(`${L} and (not ${ne})`),matchDesktopOrUp:window.matchMedia(L),matchLargeDesktop:window.matchMedia(ne),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},T=hn;function _r(){return hn.isDesktop}var Gt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var pn="hashchange";function wa(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function qt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function Ea(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=wa(window.location.hash);e(t)};return r(),window.addEventListener(pn,r),()=>{window.removeEventListener(pn,r)}}var Xa={};kc(Xa,{CLASS_NAME_FAILED:()=>Na,CLASS_NAME_HIDDEN:()=>Lc,CLASS_NAME_PENDING:()=>Oa,CLASS_NAME_RESOLVED:()=>Ia,CheckoutWorkflow:()=>Gc,CheckoutWorkflowStep:()=>ce,Commitment:()=>Xe,ERROR_MESSAGE_BAD_REQUEST:()=>Da,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Bc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>za,EVENT_AEM_ERROR:()=>Ma,EVENT_AEM_LOAD:()=>Pa,EVENT_COMPARE_CHART_REHYDRATE:()=>Hc,EVENT_EXPANDED_GROUPS_CHANGE:()=>Fc,EVENT_MAS_ERROR:()=>Ra,EVENT_MAS_READY:()=>Mr,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>Ta,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Ca,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>fe,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>_a,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Vt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>ka,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Pr,EVENT_MERCH_OFFER_READY:()=>Rc,EVENT_MERCH_OFFER_SELECT_READY:()=>Nc,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>oe,EVENT_MERCH_SEARCH_CHANGE:()=>zc,EVENT_MERCH_SIDENAV_SELECT:()=>La,EVENT_MERCH_STOCK_CHANGE:()=>Ic,EVENT_MERCH_STORAGE_CHANGE:()=>Dc,EVENT_OFFER_SELECTED:()=>Oc,EVENT_TYPE_FAILED:()=>Ha,EVENT_TYPE_READY:()=>Lr,EVENT_TYPE_RESOLVED:()=>ve,Env:()=>Ee,FF_ANNUAL_PRICE:()=>he,FF_DEFAULTS:()=>Pe,HEADER_X_REQUEST_ID:()=>jt,LOG_NAMESPACE:()=>Fa,Landscape:()=>Be,MARK_DURATION_SUFFIX:()=>Wa,MARK_START_SUFFIX:()=>ja,MERCH_CARD_LOAD_TIMEOUT:()=>Aa,MODAL_TYPE_3_IN_1:()=>Ae,NAMESPACE:()=>_c,PARAM_AOS_API_KEY:()=>Uc,PARAM_ENV:()=>Ua,PARAM_LANDSCAPE:()=>$a,PARAM_MAS_PREVIEW:()=>Ba,PARAM_WCS_API_KEY:()=>$c,PLACEHOLDER_PLAN_TYPE_TEXT:()=>Wc,PROVIDER_ENVIRONMENT:()=>Va,SELECTOR_MAS_CHECKOUT_LINK:()=>mn,SELECTOR_MAS_ELEMENT:()=>Sa,SELECTOR_MAS_INLINE_PRICE:()=>q,SELECTOR_MAS_SP_BUTTON:()=>Mc,SELECTOR_MAS_UPT_LINK:()=>un,SORT_ORDER:()=>be,STATE_FAILED:()=>xe,STATE_PENDING:()=>Fe,STATE_RESOLVED:()=>se,SUPPORTED_COUNTRIES:()=>Ya,TAG_NAME_SERVICE:()=>Pc,TEMPLATE_PRICE:()=>qc,TEMPLATE_PRICE_ANNUAL:()=>jc,TEMPLATE_PRICE_LEGAL:()=>J,TEMPLATE_PRICE_STRIKETHROUGH:()=>Vc,TRIAL_ANALYTICS_IDS:()=>gn,Term:()=>me,WCS_PROD_URL:()=>Ga,WCS_STAGE_URL:()=>qa});var Xe=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),me=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),_c="merch",Aa=2e4,Lc="hidden",Lr="wcms:commerce:ready",Pc="mas-commerce-service",q='span[is="inline-price"][data-wcs-osi]',mn='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Mc="sp-button[data-wcs-osi]",un='a[is="upt-link"]',Sa=`${q},${mn},${un}`,gn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]),Rc="merch-offer:ready",Nc="merch-offer-select:ready",Ca="merch-card:action-menu-toggle",Oc="merch-offer:selected",Ic="merch-stock:change",Dc="merch-storage:change",oe="merch-quantity-selector:change",Pr="merch-card-quantity:change",Ta="merch-modal:addon-and-quantity-update",zc="merch-search:change",ka="merch-card-collection:sort",fe="merch-card-collection:literals-changed",Vt="merch-card-collection:sidenav-attached",_a="merch-card-collection:showmore",La="merch-sidenav:select",Pa="aem:load",Ma="aem:error",Mr="mas:ready",Ra="mas:error",Hc="mas-compare-chart:rehydrate",Fc="expanded-groups-change",Na="placeholder-failed",Oa="placeholder-pending",Ia="placeholder-resolved",Da="Bad WCS request",za="Commerce offer not found",Bc="Literals URL not provided",Ha="mas:failed",ve="mas:resolved",Fa="mas/commerce",Ba="mas.preview",Ua="commerce.env",$a="commerce.landscape",Uc="commerce.aosKey",$c="commerce.wcsKey",Ga="https://www.adobe.com/web_commerce_artifact",qa="https://www.stage.adobe.com/web_commerce_artifact_stage",xe="failed",Fe="pending",se="resolved",Be={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},jt="X-Request-Id",ce=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Gc="UCv3",Ee=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Va={PRODUCTION:"PRODUCTION"},Ae={TWP:"twp",D2P:"d2p",CRM:"crm"},ja=":start",Wa=":duration",qc="price",Vc="price-strikethrough",jc="annual",J="legal",Wc="plan-type-text",Pe="mas-ff-defaults",he="mas-ff-annual-price",be={alphabetical:"alphabetical",authored:"authored"},Ya=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Yc="mas-commerce-service";function fn(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Wt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function Se(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Rr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Qa(){return window.matchMedia("(max-width: 1024px)").matches}var Ka=new Map,Xc=0;function vn(e,r){let t=++Xc,a=r,i=performance.now(),n,o=()=>{Za(t),e()},s=()=>{i=performance.now(),n=setTimeout(o,a)},c=()=>{document.visibilityState==="hidden"?(clearTimeout(n),a-=performance.now()-i):s()};return Ka.set(t,()=>{clearTimeout(n),document.removeEventListener("visibilitychange",c)}),document.addEventListener("visibilitychange",c),document.visibilityState!=="hidden"&&s(),t}function Za(e){let r=Ka.get(e);r&&(r(),Ka.delete(e))}function Yt(){return document.getElementsByTagName(Yc)?.[0]}function Xt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var Kc=["adobe.com","adobeioruntime.net","aem.live","aem.page"],Qc=["localhost","127.0.0.1"];function xn(e){try{let r=new URL(e);return Qc.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:Kc.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as Nr,nothing as Zc}from"./lit-all.min.js";var ht,Kt=class Kt{constructor(r){g(this,"card");S(this,ht);this.card=r,this.insertVariantStyle()}getContainer(){return E(this,ht,v(this,ht)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,ht)}insertVariantStyle(){let r=this.constructor.name;if(!Kt.styleMap[r]){Kt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(h=>h.style.getPropertyValue(l)),m=0,u=o.map(h=>{h.style.removeProperty(l);let p=c(h);if(!p)return p;let f=Math.max(0,parseInt(window.getComputedStyle(p).height)||0);return f>m&&(m=f),p});o.forEach((h,p)=>{u[p]?.tagName!=="HR"&&(m>0?h.style.setProperty(l,`${m}px`):d[p]&&h.style.setProperty(l,d[p]))})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Nr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Qt,css as el}from"./lit-all.min.js";var wn=`
:root {
...
`;var Ir=class extends w{constructor(r){super(r)}getGlobalCSS(){return An}renderLayout(){return Sn` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Sn`<hr />`} ${this.secureLabelFooter}`}};import{html as Ue,css as Sl,unsafeCSS as qn}from"./lit-all.min.js";var Cn=`
  :root {
...
`;var Tn="tacocat.js";var ei=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),kn=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function F(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=mt(a)?a:e;n=o.get(s)}if(i&&n==null){let o=mt(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=rl(mt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var tl=e=>typeof e=="boolean",Dr=e=>typeof e=="function",zr=e=>typeof e=="number",_n=e=>e!=null&&typeof e=="object";var mt=e=>typeof e=="string",ti=e=>mt(e)&&e,ut=e=>zr(e)&&Number.isFinite(e)&&e>0;function Hr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function k(e,r){if(tl(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Zt(e,r,t){let a=Object.values(r);return a.find(i=>ei(i,e))??t??a[0]}function rl(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function Ln(e,r=1){return zr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var al=Date.now(),ri=()=>`(+${Date.now()-al}ms)`,Fr=new Set,il=k(F("tacocat.debug",{},{metadata:!1}),!1);function Pn(e){let r=`[${Tn}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=il?(o,...s)=>{console.debug(`${r} ${o}`,...s,ri())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;Fr.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;Fr.forEach(([,l])=>l(c,...s))}}}function nl(e,r){let t=[e,r];return Fr.add(t),()=>{Fr.delete(t)}}nl((e,...r)=>{console.error(e,...r,ri())},(e,...r)=>{console.warn(e,...r,ri())});var ol="no promo",Mn="promo-tag",sl="yellow",cl="neutral",ll=(e,r,t)=>{let a=n=>n||ol,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Br="cancel-context",Ur=(e,r)=>{let t=e===Br,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?Mn:`${Mn} no-promo`,text:ll(o,r,i),variant:n?sl:cl,isOverriden:i}};var ai;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(ai||(ai={}));var pe;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(pe||(pe={}));var ue;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(ue||(ue={}));var ii;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(ii||(ii={}));var ni;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ni||(ni={}));var oi;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(oi||(oi={}));var si;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(si||(si={}));var ci="ABM",li="PUF",di="M2M",hi="PERPETUAL",pi="P3Y",dl="TAX_INCLUSIVE_DETAILS",hl="TAX_EXCLUSIVE",Rn={ABM:ci,PUF:li,M2M:di,PERPETUAL:hi,P3Y:pi},Bp={[ci]:{commitment:pe.YEAR,term:ue.MONTHLY},[li]:{commitment:pe.YEAR,term:ue.ANNUAL},[di]:{commitment:pe.MONTH,term:ue.MONTHLY},[hi]:{commitment:pe.PERPETUAL,term:void 0},[pi]:{commitment:pe.THREE_MONTHS,term:ue.P3Y}},Nn="Value is not an offer",$r=e=>{if(typeof e!="object")return Nn;let{commitment:r,term:t}=e,a=pl(r,t);return{...e,planType:a}};var pl=(e,r)=>{switch(e){case void 0:return Nn;case"":return"";case pe.YEAR:return r===ue.MONTHLY?ci:r===ue.ANNUAL?li:"";case pe.MONTH:return r===ue.MONTHLY?di:"";case pe.PERPETUAL:return hi;case pe.TERM_LICENSE:return r===ue.P3Y?pi:"";default:return""}};function On(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==dl)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:hl}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Qe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},In=1e3;function ml(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Dn(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Qe.serializableTypes.includes(t))return t}return e}function ul(e,r){if(!Qe.ignoredProperties.includes(e))return Dn(r)}var mi={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(ml(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(Dn).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${Qe.delimiter}page=${o}${s}`;c.length>In&&(c=`${c.slice(0,In)}<trunc>`),n+=c,i.length&&(n+=`${Qe.delimiter}facts=`,n+=JSON.stringify(i,ul)),window.lana?.log(n,Qe)}};function Gr(e){Object.assign(Qe,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in Qe&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var zn={LOCAL:"local",PROD:"prod",STAGE:"stage"},ui={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},gi=new Set,fi=new Set,Hn=new Map,Fn={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},Bn={filter:({level:e})=>e!==ui.DEBUG},gl={filter:()=>!1};function fl(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&Dr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function vl(e){[...fi].every(r=>r(e))&&gi.forEach(r=>r(e))}function Un(e){let r=(Hn.get(e)??0)+1;Hn.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>Un(`${a.namespace}/${i}`),updateConfig:Gr};return Object.values(ui).forEach(i=>{a[i]=(n,...o)=>vl(fl(i,n,e,o,t))}),Object.seal(a)}function qr(...e){e.forEach(r=>{let{append:t,filter:a}=r;Dr(a)&&fi.add(a),Dr(t)&&gi.add(t)})}function xl(e={}){let{name:r}=e,t=k(F("commerce.debug",{search:!0,storage:!0}),r===zn.LOCAL);return qr(t?Fn:Bn),r===zn.PROD&&qr(mi),ae}function bl(){gi.clear(),fi.clear()}var ae={...Un(Fa),Level:ui,Plugins:{consoleAppender:Fn,debugFilter:Bn,quietFilter:gl,lanaAppender:mi},init:xl,reset:bl,use:qr};var yl="mas-commerce-service",wl=ae.module("utilities"),El={requestId:jt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Jt(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map(On)),a}var $n=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function vi(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let m=l.includes(".")?r.priceDetails?.formatString:r[l],u=l.includes(".")?s.priceDetails?.formatString:s[l];u!==m&&wl.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:m,actual:u})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=$n(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=$n(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var Vr=e=>window.setTimeout(e);function gt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(Ln).filter(ut);return t.length||(t=[r]),t}function Al(e){return e==null?[]:Array.isArray(e)?e:String(e).split(",").map(r=>r.trim())}function jr(e,r){let t=Al(r);if(e==null)return{wcsOsi:[],promotionCodes:t};let a=Array.isArray(e)?e:String(e).split(",");if(t.length<=1)return{wcsOsi:a.filter(ti),promotionCodes:t};let i=[],n=[];return a.forEach((o,s)=>{ti(o)&&(i.push(o),n.push(t[s]??""))}),{wcsOsi:i,promotionCodes:n}}function V(){return document.getElementsByTagName(yl)?.[0]}function Gn(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(El)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var Cl=32,Vn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"};function er(e,r,t,a){e?.featureFlags[he]&&r.options[a]?t.dataset[a]="false":r.options[a]&&(r.dataset[a]="false")}var ft=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Ue`<slot name="secure-transaction-label">
    ...
    `);import{html as Wr,css as Tl,unsafeCSS as xi,nothing as kl}from"./lit-all.min.js";var jn=`
  :root {
...
`;var _l=32,Ll=0,Pl=()=>`mweb-list-${Ll+=1}`,Ml=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],Rl=8,Wn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ce,Ze,xt,bt,yt,$e,bi,yi,vt=class extends w{constructor(t){super(t);S(this,$e);S(this,Ce);S(this,Ze);S(this,xt);S(this,bt,0);S(this,yt);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Wr` <footer>
        ...
        `}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),T.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),T.isMobile||await U(this,$e,yi).call(this)}resetSyncedHeights(){let t=this.getContainer();if(!t)return;let a=this.card.variant,i=U(this,$e,bi).call(this,t);for(let n of Ml){let o=`--consonant-merch-card-${a}-${n}-height`;t.style.removeProperty(o),i.forEach(s=>s.style.removeProperty(o))}for(let n=1;n<=Rl;n+=1)t.style.removeProperty(this.getRowMinHeightPropertyName(n))}};Ce=new WeakMap,Ze=new WeakMap,xt=new WeakMap,bt=new WeakMap,yt=new WeakMap,$e=new WeakSet,bi=function(t){return t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)},yi=async function(){let t=this.getContainer();if(!t)return;let a=Array.from(U(this,$e,bi).call(this,t));this.card===a[0]&&(await Promise.all(a.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),requestAnimationFrame(()=>{this.resetSyncedHeights(),this.syncHeights()}))},g(vt,"variantStyle",Tl`
    ...
    `);import{html as tr,css as Nl,nothing as Yr}from"./lit-all.min.js";var Yn=`
:root {
...
`;var[Bm,Um,to,ro,ao,io]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Zr="pro",wi=`--consonant-merch-card-${Zr}-top-card-height`,Qr=[{prop:`--consonant-merch-card-${Zr}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Zr}-name-description-height`,selector:".name-description"}],no=`--consonant-merch-card-${Zr}-strike-reserve`,Ei='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',Dl="(min-width: 768px)",oo={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Ne,Je,or,sr,X,so,ar,co,ir,Ai,Jr,ea=class ea extends w{constructor(t){super(t);S(this,X);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);S(this,Ne,null);S(this,Je,null);S(this,or,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);S(this,sr,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of U(this,X,so).call(this)){let n=i.variantLayout;n instanceof ea&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?U(this,X,Ai).call(this):U(this,X,ir).call(this),this.card.requestUpdate()});S(this,Jr,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case ro:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:U(this,X,ir).call(this);break;case to:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:U(this,X,ir).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case ao:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}U(this,X,ir).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),U(this,X,Ai).call(this);break;case io:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,U(this,X,ar).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(oe,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return eo}priceOptionsProvider(t,a){t.dataset.template===J&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(ve,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]');if(!t?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=t.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${q}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=wi,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(Dl).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,m)=>{let u=l(m);return u?Math.max(d,parseInt(getComputedStyle(u).height)||0):d},0);for(let c of o.values()){if(c.forEach(u=>this.clearSyncedHeights(u)),c.length<2)continue;let l=c.map(u=>u.querySelector(Ei)&&parseInt(getComputedStyle(u.querySelector(Ei)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((u,h)=>{let p=d-l[h];p>0&&u.style.setProperty(no,`${p}px`)});for(let u of Qr){let h=s(c,p=>p.shadowRoot?.querySelector(u.selector));h>0&&c.forEach(p=>p.style.setProperty(u.prop,`${h}px`))}let m=s(c,u=>u.shadowRoot?.querySelector(".top-card"));m>0&&c.forEach(u=>u.style.setProperty(i,`${m}px`))}}clearSyncedHeights(t){t.style.removeProperty(wi),t.style.removeProperty(no),Qr.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(Ei),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Pr,v(this,sr)),this.card.addEventListener(oe,this.updatePriceQuantity),this.card.addEventListener(ve,v(this,or)),typeof ResizeObserver>"u"))return;E(this,Je,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Je).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Je).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(oe,this.updatePriceQuantity),this.card?.removeEventListener(ve,v(this,or)),U(this,X,ar).call(this),v(this,Je)?.disconnect(),this.card?.removeEventListener(Pr,v(this,sr))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Re`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Re`
    ...
    `);var nr=ea;import{html as Si,css as zl}from"./lit-all.min.js";var lo=`
:root {
...
`;var ho={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},_e,Et=class extends w{constructor(t){super(t);S(this,_e);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return lo}priceOptionsProvider(t,a){t.dataset.template===J&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return Si` ${this.badge}
    ...
    `);import{html as Hl,css as Fl}from"./lit-all.min.js";var po=`
...
`;var mo={cardName:{attribute:"name"},mnemonics:{size:"l"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},planType:!0,promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},At=class extends w{getGlobalCSS(){return po}priceOptionsProvider(r,t){r.dataset.template===J&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.card.querySelector(`[slot="heading-xs"] ${q}[data-template="price"]`);if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}renderLayout(){return Hl` ${this.badge}
    ...
    `);import{html as Ci,css as Bl}from"./lit-all.min.js";var uo=`
:root {
...
`;var go={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},St=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===J&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return uo}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${q}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return Ci`
    ...
    `);import{html as Ul,css as $l}from"./lit-all.min.js";var fo=`
...
`;var vo={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ct=class extends w{constructor(r){super(r)}getGlobalCSS(){return fo}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Ul`
    ...
    `);import{html as Ti,css as Gl}from"./lit-all.min.js";var xo=`
:root {
...
`;var bo={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Tt=class extends w{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return xo}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${q}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Ti`${this.cardImage}
    ...
    `);import{html as wo,css as ql}from"./lit-all.min.js";var yo=`
:root {
...
`;var ki={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},kt=class extends w{getGlobalCSS(){return yo}get aemFragmentMapping(){return ki}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return wo`<div
    ...
    `);import{html as Ao,css as Vl}from"./lit-all.min.js";var Eo=`
:root {
...
`;var _i={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},cr=class cr extends w{getGlobalCSS(){return Eo}get aemFragmentMapping(){return _i}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return Ao`<div
    ...
    `);var lr=cr;import{html as dr,nothing as Co}from"./lit-all.min.js";import{css as jl,unsafeCSS as Wl}from"./lit-all.min.js";var So=["headless","marquee","faq","banner-blade"],_t=(e,r="")=>So.map(t=>`merch-card[variant='${t}'] [slot='${e}']${r}`).join(`,
...
`;function Ve(e){let r=Wl(e);return jl`
    ...
    `}var To={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},Yl=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Lt=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return dr`
        ...
        `}};g(Lt,"variantStyle",Ve("headless"));import{css as Xl,html as Kl}from"./lit-all.min.js";var ko=`
...
`;var _o={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Pt=class extends w{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return ko}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${q}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Kl`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Ql,css as Zl}from"./lit-all.min.js";var Lo=`
...
`;var Pi={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Jl=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],ta,Po,Mt=class extends w{constructor(t){super(t);S(this,ta);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Lo}get aemFragmentMapping(){return Pi}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,U(this,ta,Po).call(this))}renderLayout(){return Ql`
            <div class="card">
            ...
            <slot></slot>
        `}};ta=new WeakSet,Po=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Jl.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(Mt,"variantStyle",Zl`
...
`;var Mi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Rt=class extends w{getGlobalCSS(){return Mo}get aemFragmentMapping(){return Mi}renderLayout(){return ed`
    ...
    `);import{html as Ri,nothing as rd}from"./lit-all.min.js";var Ro={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},ad=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Nt=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return Ri`
            <div class="headless">
                ${ad.map(({slot:r,label:t})=>Ri`
                        <div class="headless-row">
        ...
        `}};g(Nt,"variantStyle",Ve("marquee"));import{html as No}from"./lit-all.min.js";var Oo={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},id=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],Ot=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return No`
            <div class="headless">
                ${id.map(({slot:r,label:t})=>No`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value">
                                <slot name="${r}"></slot>

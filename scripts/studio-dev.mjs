...
const mcpPort = parsePort(process.env.MCP_PORT, DEFAULT_MCP_PORT);
...
if (mcpPort !== DEFAULT_MCP_PORT) query.set('mcp.port', String(mcpPort));
...
console.info(`[M@S Studio] MCP port: http://localhost:${mcpPort}`);

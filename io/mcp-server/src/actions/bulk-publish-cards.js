...
/**
 * Bulk publish/unpublish multiple cards
 * Adobe I/O Runtime action for studio_bulk_publish_cards operation
 */
async function main(params) {
    ...
    try {
        ...
        const result = await studioOps.bulkPublishCards({ fragmentIds, action });
        ...
        console.error('Bulk publish cards error:', error);
        return {
            statusCode: 500,

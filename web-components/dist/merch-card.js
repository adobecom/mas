var Ur=Object.defineProperty;var jr=a=>{throw TypeError(a)};var ji=(a,r,e)=>r in a?Ur(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Vi=(a,r)=>()=>(a&&(r=a(a=0)),r);var Gi=(a,r)=>{for(var e in r)Ur(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>ji(a,typeof r!="symbol"?r+"":r,e),dr=(a,r,e)=>r.has(a)||jr("Cannot "+e);var l=(a,r,e)=>(dr(a,r,"read from private field"),e?e.call(a):r.get(a)),f=(a,r,e)=>r.has(a)?jr("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(dr(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),k=(a,r,e)=>(dr(a,r,"access private method"),e);var Vr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return l(a,r,t)}});var hr={};Gi(hr,{default:()=>nt});import{LitElement as Wi,html as Le,css as Ki,nothing as Yi}from"./lit-all.min.js";import{unsafeHTML as Zr}from"./lit-all.min.js";import{ifDefined as Qi}from"./lit-all.min.js";function Zi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var N,nt,pr=Vi(()=>{N=class N extends Wi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();N.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),d=c?c.offsetWidth:o,p=c?c.offsetHeight:s,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>i?u="top":u==="left"&&e.left-d-n<0?u="right":u==="right"&&e.right+d+n>t&&(u="left");let b=e.left+e.width/2,S=e.top+e.height/2,_=6,ge=(Bi,qi,Ui)=>Math.max(Bi,Math.min(qi,Ui)),Ot,Dt,lr;u==="top"||u==="bottom"?(Ot=u==="top"?e.top-p-n:e.bottom+n,Dt=ge(0,t-d,b-d/2),lr=ge(_,d-_*2,b-Dt-_)):(Dt=u==="left"?e.left-d-n:e.right+n,Ot=ge(0,i-p,S-p/2),lr=ge(_,p-_*2,S-Ot-_)),this._tooltipTop=Ot,this._tooltipLeft=Dt,this._arrowOffset=lr,this._computedPlacement=u}showTooltip(){N.activeTooltip&&N.activeTooltip!==this&&(N.activeTooltip.closeOverlay(),N.activeTooltip.tooltipVisible=!1,N.activeTooltip.requestUpdate()),N.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){N.activeTooltip===this&&(N.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Le`<merch-icon
    ...
    `);nt=N;customElements.define("mas-mnemonic",nt)});import{LitElement as Zo}from"./lit-all.min.js";import{css as Kr,unsafeCSS as Wr}from"./lit-all.min.js";var C="(max-width: 767px)",L="(max-width: 1199px)",w="(min-width: 768px)",x="(min-width: 1200px)",R="(min-width: 1600px)",it="(min-width: 1280px)",Gr={matchMobile:window.matchMedia(C),matchDesktop:window.matchMedia(`${x} and (not ${R})`),matchDesktopOrUp:window.matchMedia(x),matchLargeDesktop:window.matchMedia(R),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},y=Gr;function Nt(){return Gr.isDesktop}var Yr=Kr`
    :host {
...
`;var $a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},J,qe=class extends v{constructor(e){super(e);f(this,J);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ia}priceOptionsProvider(e,t){e.dataset.template===D&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return yr` ${this.badge}
...
`;var Ba={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ue=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===D&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Ha}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${E}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return wr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Ar={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Qe=class extends v{getGlobalCSS(){return ri}get aemFragmentMapping(){return Ar}renderLayout(){return Fn`
    ...
    `);var Jt=new Map,ai=new WeakMap,ii=new Map,A=(a,r,e=null,t=null,i)=>{Jt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};A("catalog",Ie,ma,Ie.variantStyle);A("image",xe);A("inline-heading",Ut);A("mini-compare-chart",$e,ya,$e.variantStyle);A("mini-compare-chart-mweb",He,Ea,He.variantStyle);A("plans",F,Gt,F.variantStyle,F.collectionOptions);A("plans-students",F,Sa,F.variantStyle,F.collectionOptions);A("plans-education",F,Ca,F.variantStyle,F.collectionOptions);A("plans-v2",de,La,de.variantStyle,de.collectionOptions);A("pro",vt,Da,vt.variantStyle);A("product",qe,$a,qe.variantStyle);A("segment",Ue,Ba,Ue.variantStyle);A("media",je,Ua,je.variantStyle);A("headless",We,Za,We.variantStyle);A("special-offers",Ve,Va,Ve.variantStyle);A("simplified-pricing-express",Ge,kr,Ge.variantStyle);A("full-pricing-express",wt,Cr,wt.variantStyle);A("mini",Ke,Ja,Ke.variantStyle);A("image",xe,ua,xe.variantStyle);A("compare-chart-column",Ye,Sr,Ye.variantStyle);A("fries",Qe,Ar,Qe.variantStyle);var $n=(a,r,e)=>{try{let t=ii.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),ii.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Tr=a=>{let r=Jt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=ai.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?$n(a,t,i):{};return ai.set(a,{appliedVariant:a.variant,...n}),new e(a)};function qt(a){return Jt.get(a)?.fragmentMapping}function ni(a){return Jt.get(a)?.collectionOptions}var oi=document.createElement("style");oi.innerHTML=`
:root {

...
`;var Pi=class extends k{constructor(t){super(t)}getGlobalCSS(){return Ks}renderLayout(){return g`${this.cardImage}
            <div class="body">
...
`;var Li=class extends k{constructor(t){super(t)}getGlobalCSS(){return Qs}renderLayout(){return g` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var oh=32,Dt=class extends k{constructor(r){super(r);u(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);u(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?g`<slot name="secure-transaction-label">
...
`;var zt=class extends k{constructor(t){super(t)}getGlobalCSS(){return ic}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?"":g`<slot name="promo-text"></slot
            ...
            <hr />
            ${this.secureLabelFooter}`}};u(zt,"variantStyle",y`
...
`;var oc={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ut=class extends k{constructor(t){super(t)}getGlobalCSS(){return nc}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return g`${this.cardImage}
            <div class="body">
...
`;var cc={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Gt=class extends k{constructor(){super(...arguments);u(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return sc}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${U}[data-template="price"]`);if(!r)return;let i=r.cloneNode(!0);this.legal=i,r.dataset.displayTax="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return g`
    ...
    `);var Mi=new Map,q=(e,t,r=null,i=null,n)=>{Mi.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:n})};q("catalog",Ht,Xs,Ht.variantStyle);q("image",Pi);q("inline-heading",Li);q("mini-compare-chart",Dt,null,Dt.variantStyle);q("plans",oe,Ri,oe.variantStyle,oe.collectionOptions);q("plans-students",oe,tc,oe.variantStyle,oe.collectionOptions);q("plans-education",oe,ec,oe.variantStyle,oe.collectionOptions);q("product",Bt,null,Bt.variantStyle);q("segment",zt,null,zt.variantStyle);q("special-offers",Ut,oc,Ut.variantStyle);q("simplified-pricing-express",Ft,fo,Ft.variantStyle);q("mini",Gt,cc,Gt.variantStyle);var go=e=>{let t=Mi.get(e.variant);if(!t)return;let{class:r,style:i}=t;if(i)try{let n=new CSSStyleSheet;n.replaceSync(i.cssText),e.shadowRoot.adoptedStyleSheets.push(n)}catch{let o=document.createElement("style");o.textContent=i.cssText,e.shadowRoot.appendChild(o)}return new r(e)};function ki(e){return Mi.get(e)?.fragmentMapping}function lc(e){return Mi.get(e)?.collectionOptions}var dc=document.createElement("style");dc.innerHTML=`
:root {
...
`;var Nc={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Zt=class extends k{getGlobalCSS(){return Mc}renderLayout(){return g` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>

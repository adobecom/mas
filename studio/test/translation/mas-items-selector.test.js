...
describe('MasItemsSelector', () => {
    ...
    describe('repository getter', () => {
        ...
        it('should return mas-repository element when found', async () => {
            const originalQuerySelector = document.querySelector.bind(document);
            const mockRepository = { searchFragments: () => {}, loadPlaceholders: () => {} };
            const querySelectorStub = sandbox.stub(document, 'querySelector').callsFake((selector) => {
    ...
    describe('connectedCallback', () => {
        it('should call repository.searchFragments on connect if repository exists', async () => {
            ...
            await fixture(html`<mas-items-selector></mas-items-selector>`);

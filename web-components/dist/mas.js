...
`;var Ki=class extends S{constructor(e){super(e)}getGlobalCSS(){return Ic}renderLayout(){return u` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":u`<hr />`} ${this.secureLabelFooter}`}};P();var zc=`
  :root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let e=this.card.querySelector('[slot="short-description"]');if(!e)return;let r=e.querySelector("strong, b, p");r&&(R.isMobile?r.style.display="none":r.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?R.isMobile?u`
...
`;document.head.appendChild(cl);var ll="fragment",dl="author",hl="preview",pl="loading",ml="timeout",qn="aem-fragment",ul="eager",gl="cache",fp=[ul,gl],Ne,St,_e,Vn=class{constructor(){E(this,Ne,new Map);E(this,St,new Map);E(this,_e,new Map)}clear(){p(this,Ne).clear(),p(this,St).clear(),p(this,_e).clear()}add(e,r=!0){if(!this.has(e.id)&&!this.has(e.fields?.originalId)){if(p(this,Ne).set(e.id,e),e.fields?.originalId&&p(this,Ne).set(e.fields.originalId,e),p(this,_e).has(e.id)){let[,i]=p(this,_e).get(e.id);i()}if(p(this,_e).has(e.fields?.originalId)){let[,i]=p(this,_e).get(e.fields?.originalId);i()}if(!(!r||typeof e.references!="object"||Array.isArray(e.references)))for(let i in e.references){let{type:a,value:n}=e.references[i];a==="content-fragment"&&(n.settings={...e?.settings,...n.settings},n.placeholders={...e?.placeholders,...n.placeholders},n.dictionary={...e?.dictionary,...n.dictionary},n.priceLiterals={...e?.priceLiterals,...n.priceLiterals},this.add(n,e))}}}has(e){return p(this,Ne).has(e)}entries(){return p(this,Ne).entries()}get(e){return p(this,Ne).get(e)}getAsPromise(e){let[r]=p(this,_e).get(e)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(e)&&a()}),p(this,_e).set(e,[r,i]),r}getFetchInfo(e){let r=p(this,St).get(e);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},p(this,St).set(e,r)),r}remove(e){p(this,Ne).delete(e),p(this,St).delete(e),p(this,_e).delete(e)}};Ne=new WeakMap,St=new WeakMap,_e=new WeakMap;var Ze=new Vn,rr,ke,Ge,Ee,fe,J,Xr,Kr,Pe,Qr,Zr,ir,Le,fl,xl,jn,vl,Ji=class extends HTMLElement{constructor(){super(...arguments);E(this,Le);m(this,"cache",Ze);E(this,rr);E(this,ke,null);E(this,Ge,null);E(this,Ee,null);E(this,fe);E(this,J);E(this,Xr,ul);E(this,Kr,5e3);E(this,Pe);E(this,Qr,!1);E(this,Zr,0);E(this,ir)}static get observedAttributes(){return[ll,pl,ml,dl,hl]}attributeChangedCallback(r,i,a){r===ll&&(y(this,fe,a),y(this,J,Ze.getFetchInfo(a))),r===pl&&fp.includes(a)&&y(this,Xr,a),r===ml&&y(this,Kr,parseInt(a,10)),r===dl&&y(this,Qr,["","true"].includes(a)),r===hl&&y(this,ir,a)}connectedCallback(){if(!p(this,Pe)){if(p(this,Ee)??y(this,Ee,mt(this)),y(this,ir,p(this,Ee).settings?.preview),p(this,rr)??y(this,rr,p(this,Ee).log.module(`${qn}[${p(this,fe)}]`)),!p(this,fe)||p(this,fe)==="#"){p(this,J)??y(this,J,Ze.getFetchInfo("missing-fragment-id")),Z(this,Le,jn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(p(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(p(this,Pe)&&!await Promise.race([p(this,Pe),Promise.resolve(!1)]))return;r&&Ze.remove(p(this,fe)),p(this,Xr)===gl&&await Promise.race([Ze.getAsPromise(p(this,fe)),new Promise(s=>setTimeout(s,p(this,Kr)))]);try{y(this,Pe,Z(this,Le,vl).call(this)),await p(this,Pe)}catch(s){return Z(this,Le,jn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=p(this,ke)||{};return o&&!F("mas.disableWcsCache")&&p(this,Ee).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(at,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...p(this,J)},bubbles:!0,composed:!0})),p(this,Pe)}get updateComplete(){return p(this,Pe)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return p(this,Ge)?p(this,Ge):(p(this,Qr)?this.transformAuthorData():this.transformPublishData(),p(this,Ge))}get rawData(){return p(this,ke)}transformAuthorData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=p(this,ke);y(this,Ge,r.reduce((l,{name:d,multiple:h,values:g})=>(l.fields[d]=h?g:g[0],l),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=p(this,ke);y(this,Ge,Object.entries(r).reduce((l,[d,h])=>(l.fields[d]=h?.mimeType?h.value:h??"",l),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(p(this,fe),{locale:p(this,Ee).settings.locale,apiKey:p(this,Ee).settings.wcsApiKey,fullContext:!0})}};rr=new WeakMap,ke=new WeakMap,Ge=new WeakMap,Ee=new WeakMap,fe=new WeakMap,J=new WeakMap,Xr=new WeakMap,Kr=new WeakMap,Pe=new WeakMap,Qr=new WeakMap,Zr=new WeakMap,ir=new WeakMap,Le=new WeakSet,fl=async function(r){po(this,Zr)._++;let i=`${qn}:${p(this,fe)}:${p(this,Zr)}`,a=`${i}${st}`,n=`${i}${ct}`;if(p(this,ir)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Re(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(p(this,J).stale=!1,p(this,J).url=r,o=await Ii(r,{cache:"default",credentials:"omit"}),Z(this,Le,xl).call(this,o),p(this,J).status=o?.status,p(this,J).measure=Oe(performance.measure(n,a)),p(this,J).retryCount=o.retryCount,!o?.ok)throw new Re("Unexpected fragment response",{response:o,...p(this,Ee).duration});return await o.json()}catch(s){if(p(this,J).measure=Oe(performance.measure(n,a)),p(this,J).retryCount=s.retryCount,p(this,ke))return p(this,J).stale=!0,p(this,rr).error("Serving stale data",p(this,J)),p(this,ke);let c=s.message??"unknown";throw new Re(`Failed to fetch fragment: ${c}`,{})}},xl=function(r){Object.assign(p(this,J),bi(r))},jn=function(r){y(this,Pe,null),p(this,J).message=r,this.classList.add("error");let i={...p(this,J),...p(this,Ee).duration};p(this,rr).error(r,i),this.dispatchEvent(new CustomEvent(nt,{detail:i,bubbles:!0,composed:!0}))},vl=async function(){var c;this.classList.remove("error"),y(this,Ge,null);let r=Ze.get(p(this,fe));if(r)return y(this,ke,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=p(this,Ee).settings,s=`${i}/fragment?id=${p(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Le,fl).call(this,s),(c=r.fields).originalId??(c.originalId=p(this,fe)),Ze.add(r),y(this,ke,r),!0},m(Ji,"cache",Ze);customElements.define(qn,Ji);P();Ur();var bl={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},yl=t=>(...e)=>({_$litDirective$:t,values:e}),ea=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,r,i){this._$Ct=e,this._$AM=r,this._$Ci=i}_$AS(e,r){return this.update(e,r)}update(e,r){return this.render(...r)}};var Jr=class extends ea{constructor(e){if(super(e),this.et=w,e.type!==bl.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===w||e==null)return this.ft=void 0,this.et=e;if(e===Fe)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;let r=[e];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};Jr.directiveName="unsafeHTML",Jr.resultType=1;var wl=yl(Jr);var xp=t=>t?t.startsWith("sp-icon-")?u`${wl(`<${t} class="badge-icon"></${t}>`)}`:u`<img src="${t}" class="badge-icon" />`:w,ar=class extends U{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let e=this.closest("merch-card"),r=e?.getAttribute("size"),i=e?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return u`<div class="badge">
    ...
    `);customElements.define("merch-badge",ar);P();var ei=class extends U{constructor(){super()}render(){return u`
            <slot name="icon"></slot>
...
`;var[G0,q0,Zn,Jn,Ml,Rl]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var eo=class extends U{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return Ll}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=Or(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=Or(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(Lt,this.debouncedQuantityUpdate)}get button(){return this.shadowRoot.querySelector("button")}handleKeyup(e){e.key===Jn||e.key===Zn||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let e=this.options[this.highlightedIndex];if(!e){this.closed=!0;return}this.selectedValue=e,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(e){switch(e.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case Rl:this.selectValue();break;case Jn:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,e.preventDefault();break;case Zn:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),e.preventDefault();break;case Ml:this.selectValue(),this.button.classList.contains("focused")&&e.preventDefault();break}e.composedPath().includes(this)&&e.stopPropagation()}adjustInput(e,r){this.selectedValue=r,e.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let e=this.shadowRoot.querySelector(".text-field-input"),r=e.value.replace(/\D/g,"");e.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let a=i;this.maxInput&&i>this.maxInput&&(a=this.maxInput),this.min&&a<this.min&&(a=this.min),this.adjustInput(e,a)}else this.adjustInput(e,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(Lt,this.debouncedQuantityUpdate)}generateOptionsArray(){let e=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)e.push(r);return e}update(e){(e.has("min")||e.has("max")||e.has("step")||e.has("defaultValue"))&&(this.options=this.generateOptionsArray(),this.highlightedIndex=this.defaultValue?this.options.indexOf(this.defaultValue):0,this.handleMenuOption(this.defaultValue?this.defaultValue:this.options[0])),super.update(e)}handleClickOutside(e){e.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let e=this.shadowRoot.querySelector(".popover");this.closed||e.getBoundingClientRect().bottom<=window.innerHeight?e.setAttribute("placement","bottom"):e.setAttribute("placement","top")}handleMouseEnter(e){this.highlightedIndex=e}handleMenuOption(e,r){e===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=e,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let e=new CustomEvent(te,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(e)}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return u` <div
        ...
        >
            ${this.options.map((e,r)=>u`
                ...
                `)}
        </div>`}handleQuantityUpdate({detail:{quantity:e}}){if(e&&e!==this.selectedValue){this.selectedValue=e;let r=this.shadowRoot.querySelector(".text-field-input");r&&(r.value=e),this.sendEvent()}}onButtonFocus(e){e.target.classList.add("focused")}onButtonBlur(e){e.target.classList.remove("focused")}render(){return u`
...
`;var zl={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},hr=class extends S{getGlobalCSS(){return Il}renderLayout(){return u` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>

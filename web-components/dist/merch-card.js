...
`;var st=class extends x{constructor(t){super(t)}getGlobalCSS(){return br}renderLayout(){return qe`${this.cardImage}
            <div class="body">
...
`;var Di=32,Ee=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?we`<slot name="secure-transaction-label">
...
`;var _r={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-variation"},allowedBadgeColors:["spectrum-yellow-300-variation","spectrum-gray-300-variation","spectrum-gray-700-variation","spectrum-green-900-variation","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-variation","spectrum-gray-300-variation","spectrum-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},te=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Pr}priceOptionsProvider(t,e){t.dataset.template===ue&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Tt` ${this.badge}
...
`;var ke=class extends x{constructor(t){super(t)}getGlobalCSS(){return Mr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Lt` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}};d(ke,"variantStyle",Ii`

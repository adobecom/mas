...
import '../../src/components/mas-ost-selection-list.js';
...
describe('mas-ost-selection-list', () => {
    beforeEach(() => {
        resetStore();
    });
    ...
    it('renders nothing in single flow', async () => {
        store.authoringFlow = 'single';
        const el = await fixture(html`<mas-ost-selection-list></mas-ost-selection-list>`);

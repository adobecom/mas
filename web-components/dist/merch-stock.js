...
var d = (o, e, t) =>
    e in o
        ...
        : (o[e] = t);
var r = (o, e, t) => d(o, typeof e != 'symbol' ? e + '' : e, t),
    R = (o, e, t) => e.has(o) || a('Cannot ' + t);
var p = (o, e, t) => (
        R(o, e, 'read from private field'), t ? t.call(o) : e.get(o)
    ),
    _ = (o, e, t) =>
        e.has(o)
            ...
            : e instanceof WeakSet
              ? e.add(o)
              : e.set(o, t);
import { LitElement as S, css as N, html as x } from './lit-all.min.js';
var M = Object.freeze({
        MONTH: 'MONTH',
        YEAR: 'YEAR',
        TWO_YEARS: 'TWO_YEARS',
...
var h = '(min-width: 1200px)',
    A = '(min-width: 1600px)',
    U = {
        matchMobile: window.matchMedia(n),
        matchDesktop: window.matchMedia(`${h} and (not ${A})`),
        matchDesktopOrUp: window.matchMedia(h),
...
var s,
    E = class extends S {
        ...
        render() {
            if (this.planType && !p(this, s).matches)
                return x`
            <sp-checkbox
                size="s"

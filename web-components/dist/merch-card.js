var Ir=Object.defineProperty;var Fr=a=>{throw TypeError(a)};var $i=(a,r,e)=>r in a?Ir(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Hi=(a,r)=>()=>(a&&(r=a(a=0)),r);var Bi=(a,r)=>{for(var e in r)Ir(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>$i(a,typeof r!="symbol"?r+"":r,e),nr=(a,r,e)=>r.has(a)||Fr("Cannot "+e);var l=(a,r,e)=>(nr(a,r,"read from private field"),e?e.call(a):r.get(a)),u=(a,r,e)=>r.has(a)?Fr("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(nr(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),y=(a,r,e)=>(nr(a,r,"access private method"),e);var $r=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return l(a,r,t)}});var or={};Bi(or,{default:()=>nt});import{LitElement as qi,html as Le,css as Ui,nothing as ji}from"./lit-all.min.js";import{unsafeHTML as Vr}from"./lit-all.min.js";import{ifDefined as Gi}from"./lit-all.min.js";function Vi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var N,nt,cr=Hi(()=>{N=class N extends qi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();N.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,s=this.shadowRoot?.querySelector(".css-tooltip-body"),d=s?s.offsetWidth:o,p=s?s.offsetHeight:c,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>t&&(f="left");let C=e.left+e.width/2,O=e.top+e.height/2,D=6,Te=(Ni,Ii,Fi)=>Math.max(Ni,Math.min(Ii,Fi)),ge,Mt,ir;f==="top"||f==="bottom"?(ge=f==="top"?e.top-p-n:e.bottom+n,Mt=Te(0,t-d,C-d/2),ir=Te(D,d-D*2,C-Mt-D)):(Mt=f==="left"?e.left-d-n:e.right+n,ge=Te(0,i-p,O-p/2),ir=Te(D,p-D*2,O-ge-D)),this._tooltipTop=ge,this._tooltipLeft=Mt,this._arrowOffset=ir,this._computedPlacement=f}showTooltip(){N.activeTooltip&&N.activeTooltip!==this&&(N.activeTooltip.closeOverlay(),N.activeTooltip.tooltipVisible=!1,N.activeTooltip.requestUpdate()),N.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){N.activeTooltip===this&&(N.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Le`<merch-icon
    ...
    `);nt=N;customElements.define("mas-mnemonic",nt)});import{LitElement as Go}from"./lit-all.min.js";import{css as Ur,unsafeCSS as qr}from"./lit-all.min.js";var k="(max-width: 767px)",z="(max-width: 1199px)",w="(min-width: 768px)",v="(min-width: 1200px)",_="(min-width: 1600px)",Hr="(min-width: 1280px)",Br={matchMobile:window.matchMedia(k),matchDesktop:window.matchMedia(`${v} and (not ${_})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(_),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Br;function Rt(){return Br.isDesktop}var jr=Ur`
    :host {
...
`,Gr=()=>[Ur`
        ...
        `];import{LitElement as Wi,html as Wr,css as Ki}from"./lit-all.min.js";function Yi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Pe=class extends Wi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Yi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let t="",i="top";if(e.tagName==="SP-TOOLTIP")t=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(t=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(t){let n=document.createElement("mas-mnemonic");n.setAttribute("content",t),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>cr())}e.remove()})}render(){let{href:r}=this;return r?Wr`<a href="${r}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(Pe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(Pe,"styles",Ki`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Pe);var oc=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),cc=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var _e=2e4;var E='span[is="inline-price"][data-wcs-osi]',te='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Qi='a[is="upt-link"]',Kr=`${E},${te},${Qi}`;var Yr="merch-offer-select:ready",Qr="merch-card:action-menu-toggle";var M="merch-quantity-selector:change",ot="merch-card-quantity:change",sr="merch-modal:addon-and-quantity-update";var Me="merch-card-collection:literals-changed";var Re="aem:load",Oe="aem:error",ue="mas:ready",Zr="mas:error";var Xr="placeholder-failed",Jr="placeholder-pending",ea="placeholder-resolved";var ta="mas:failed",Y="mas:resolved",ra="mas/commerce";var oe="failed",fe="pending",ce="resolved";var Ot="X-Request-Id",sc=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var lc=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Dt=":start",Nt=":duration";var R="legal",aa="mas-ff-defaults";var Zi="mas-commerce-service";function ia(a,r){let e;return function(){let t=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(t,i),r)}}function T(a,r={},e=null,t=null){let i=t?document.createElement(a,{is:t}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function De(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function lr(){return window.matchMedia("(max-width: 1024px)").matches}function be(){return document.getElementsByTagName(Zi)?.[0]}function ct(a){let r=window.getComputedStyle(a);return a.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function na(a){let r=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var st,ve,lt,dt,Ne,It=class extends HTMLElement{constructor(){super();u(this,st,"");u(this,ve);u(this,lt,[]);u(this,dt,[]);u(this,Ne);m(this,Ne,ia(()=>{this.isConnected&&(this.parentElement.style.background=this.value,l(this,ve)?this.parentElement.style.borderRadius=l(this,ve):l(this,ve)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=l(this,lt).map((t,i)=>{let n=l(this,dt)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${l(this,st)}, ${e})`}connectedCallback(){l(this,Ne).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&m(this,ve,i?.trim()),e==="colors"&&i?m(this,lt,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,dt,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,st,i?.trim()??""),l(this,Ne).call(this)}};st=new WeakMap,ve=new WeakMap,lt=new WeakMap,dt=new WeakMap,Ne=new WeakMap;customElements.define("merch-gradient",It);import{LitElement as Xi,html as Ji,css as en}from"./lit-all.min.js";var Ie=class extends Xi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${r}"] ${E}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Y,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Y,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];t&&(e.setAttribute("data-offer-type",t.offerType),e.closest("p").setAttribute("data-plan-type",t.planType))}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return Ji` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(Ie,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0},background:{type:String,attribute:"background"}}),h(Ie,"styles",en`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as pt,css as an}from"./lit-all.min.js";var sa=`
:root {
...
`;var ln=32,fa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Q,Be=class extends b{constructor(e){super(e);u(this,Q);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Bt` <footer>
    ...
    `);import{html as mt,css as dn,nothing as qt}from"./lit-all.min.js";var ba=`
:root {
...
`;var Ut={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},va={...function(){let{whatsIncluded:a,size:r,...e}=Ut;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},xa={...function(){let{subtitle:a,whatsIncluded:r,size:e,quantitySelect:t,...i}=Ut;return i}()},Z,X,I=class extends b{constructor(e){super(e);u(this,Z);u(this,X);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ba}adjustSlotPlacement(e,t,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let s=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),s&&s.remove()),!!t.includes(c)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&s){if(d)s.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(s):p.appendChild(s)}return}if(i&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!s){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){l(this,Z)||(m(this,Z,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(l(this,Z)?.disconnect(),m(this,Z,null),this.syncHeights())})),l(this,Z).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let i=t.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),t.insertBefore(o,n);let c=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=ct(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(d+=ct(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+ct(f));for(let O of t.childNodes){if(O.classList.contains("spacer"))break;d+=ct(O)}let C=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(C)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${E}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?mt`<div class="divider"></div>`:qt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${E}[data-template="price"]`);t&&e.push(t);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?mt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Z=new WeakMap,X=new WeakMap,h(I,"variantStyle",dn`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),h(I,"collectionOptions",{customHeaderArea:e=>e.sidenav?mt`<slot name="resultsText"></slot>`:qt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let t=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let c=o.getAttribute("size"),s=c==="wide"?2:c==="super-wide"?3:1;s===2&&n%3===2&&(o.setAttribute("data-size",c),o.removeAttribute("size"),s=1),n+=s}};x.matchDesktop.addEventListener("change",t),e.addEventListener(Me,t),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",t),e.removeEventListener(Me,t)})}});import{html as re,css as hn,unsafeCSS as wa,nothing as jt}from"./lit-all.min.js";var ya=`
:root {
...
`;var[Ds,Ns,Ca,Sa,Aa,za]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Ta={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ae,ye,vt,L,La,ut,Pa,ft,pr,Gt,Vt=class Vt extends b{constructor(e){super(e);u(this,L);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,ae,null);u(this,ye,null);h(this,"lastSyncKey",null);u(this,vt,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of y(this,L,La).call(this)){let n=i.variantLayout;n instanceof Vt&&(n.expanded=t,i._bizproExpanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?y(this,L,pr).call(this):y(this,L,ft).call(this),this.card.requestUpdate()});u(this,Gt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Sa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:y(this,L,ft).call(this);break;case Ca:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:y(this,L,ft).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Aa:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}y(this,L,ft).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),y(this,L,pr).call(this);break;case za:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,y(this,L,ut).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(M,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._bizproExpanded??!1}getGlobalCSS(){return ka}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(Y,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let t=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=t?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=t.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${E}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=`--consonant-merch-card-${t}-top-card-height`,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1),o=new Map;for(let c of n){let s=o.get(c.offsetTop)??[];s.push(c),o.set(c.offsetTop,s)}for(let c of o.values()){let s=0;for(let d of c){d.style.removeProperty(i);let p=d.shadowRoot?.querySelector(".top-card");p&&(s=Math.max(s,parseInt(getComputedStyle(p).height)||0))}s>0&&c.length>1&&c.forEach(d=>d.style.setProperty(i,`${s}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),i=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(ot,l(this,vt)),this.card.addEventListener(M,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;m(this,ye,new ResizeObserver(()=>this.resyncOnReflow())),l(this,ye).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&l(this,ye).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(M,this.updatePriceQuantity),y(this,L,ut).call(this),l(this,ye)?.disconnect(),this.card?.removeEventListener(ot,l(this,vt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t)return null;let o=[];for(let c=t;c<=i;c+=n)o.push(String(c));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return de`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return de`
        ...
        `}renderLayout(){let e=!!this.expanded;return de`
            ...
            ${this.hasWhatsIncluded?de`
                  ...
                  `:gt}
            <slot></slot>
        `}};ae=new WeakMap,ye=new WeakMap,vt=new WeakMap,L=new WeakSet,La=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},ut=function(){l(this,ae)&&(document.removeEventListener("mousedown",l(this,ae)),m(this,ae,null))},Pa=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},ft=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=y(this,L,Pa).call(this),l(this,ae)||(m(this,ae,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),y(this,L,ut).call(this))}),document.addEventListener("mousedown",l(this,ae)))},pr=function(){this.licenseOpen=!1,y(this,L,ut).call(this)},Gt=new WeakMap,h(Vt,"variantStyle",pn`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var bt=Vt;import{html as mr,css as mn}from"./lit-all.min.js";var _a=`
:root {
...
`;var Ma={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},J,qe=class extends b{constructor(e){super(e);u(this,J);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return _a}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return mr` ${this.badge}
...
`;var Oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ue=class extends b{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===R&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Ra}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${E}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return gr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Fa={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Ge=class extends b{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Ia}renderLayout(){return ur`${this.cardImage}
            ...
            ${this.evergreen?ur`
                  ...
                  `:ur`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(Ge,"variantStyle",bn`
...
`;var br={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},xt=class xt extends b{getGlobalCSS(){return Ba}get aemFragmentMapping(){return br}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')?qa`<div class="badge-wrapper">
            ...
            <slot></slot>
        `}};h(xt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),h(xt,"variantStyle",yn`
    ...
    `);var yt=xt;import{html as vr,css as En,nothing as kn}from"./lit-all.min.js";var Ua=`
...
`;var xr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Ln=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Wt,Ka,Ye=class extends b{constructor(e){super(e);u(this,Wt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Wa}get aemFragmentMapping(){return xr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Wt,Ka).call(this))}renderLayout(){return zn`
            <div class="card">
            ...
            <slot></slot>
        `}};Wt=new WeakSet,Ka=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Ln.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ye,"variantStyle",Tn`
...
`;var yr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Qe=class extends b{getGlobalCSS(){return Ya}get aemFragmentMapping(){return yr}renderLayout(){return Pn`
    ...
    `);var Kt=new Map,Qa=new WeakMap,Za=new Map,S=(a,r,e=null,t=null,i)=>{Kt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",$e,ca,$e.variantStyle);S("image",xe);S("inline-heading",Ht);S("mini-compare-chart",He,ga,He.variantStyle);S("mini-compare-chart-mweb",Be,fa,Be.variantStyle);S("plans",I,Ut,I.variantStyle,I.collectionOptions);S("plans-students",I,xa,I.variantStyle,I.collectionOptions);S("plans-education",I,va,I.variantStyle,I.collectionOptions);S("plans-v2",le,Ea,le.variantStyle,le.collectionOptions);S("bizpro",bt,Ta,bt.variantStyle);S("product",qe,Ma,qe.variantStyle);S("segment",Ue,Oa,Ue.variantStyle);S("media",je,Na,je.variantStyle);S("headless",We,ja,We.variantStyle);S("special-offers",Ge,Fa,Ge.variantStyle);S("simplified-pricing-express",Ve,fr,Ve.variantStyle);S("full-pricing-express",yt,br,yt.variantStyle);S("mini",Ke,Va,Ke.variantStyle);S("image",xe,la,xe.variantStyle);S("compare-chart-column",Ye,xr,Ye.variantStyle);S("fries",Qe,yr,Qe.variantStyle);var Mn=(a,r,e)=>{try{let t=Za.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),Za.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},wr=a=>{let r=Kt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=Qa.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?Mn(a,t,i):{};return Qa.set(a,{appliedVariant:a.variant,...n}),new e(a)};function $t(a){return Kt.get(a)?.fragmentMapping}function Xa(a){return Kt.get(a)?.collectionOptions}var Ja=document.createElement("style");Ja.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var we={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ti=1e3;function Dn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ri(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!we.serializableTypes.includes(e))return e}return a}function Nn(a,r){if(!we.ignoredProperties.includes(a))return ri(r)}var kr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(Dn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(ri).join(" ")}`);let{pathname:o,search:c}=window.location,s=`${we.delimiter}page=${o}${c}`;s.length>ti&&(s=`${s.slice(0,ti)}<trunc>`),n+=s,i.length&&(n+=`${we.delimiter}facts=`,n+=JSON.stringify(i,Nn)),window.lana?.log(n,we)}};function ai(a){Object.assign(we,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in we&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ii={LOCAL:"local",PROD:"prod",STAGE:"stage"},Cr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Sr=new Set,Ar=new Set,ni=new Map,oi={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},ci={filter:({level:a})=>a!==Cr.DEBUG},In={filter:()=>!1};function Fn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Qt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function $n(a){[...Ar].every(r=>r(a))&&Sr.forEach(r=>r(a))}function si(a){let r=(ni.get(a)??0)+1;ni.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>si(`${t.namespace}/${i}`),updateConfig:ai};return Object.values(Cr).forEach(i=>{t[i]=(n,...o)=>$n(Fn(i,n,a,o,e))}),Object.seal(t)}function Zt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Qt(t)&&Ar.add(t),Qt(e)&&Sr.add(e)})}function Hn(a={}){let{name:r}=a,e=ei(Yt("commerce.debug",{search:!0,storage:!0}),r===ii.LOCAL);return Zt(e?oi:ci),r===ii.PROD&&Zt(kr),wt}function Bn(){Sr.clear(),Ar.clear()}var wt={...si(ra),Level:Cr,Plugins:{consoleAppender:oi,debugFilter:ci,quietFilter:In,lanaAppender:kr},init:Hn,reset:Bn,use:Zt};var qn="mas-commerce-service",Fd=wt.module("utilities"),Un={requestId:Ot,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Xt=a=>window.setTimeout(a);function zr(){return document.getElementsByTagName(qn)?.[0]}function li(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Un)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function di(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,t*(n+1)))}throw i}var jn="<explicit_empty/>";function Ze(a){return a===jn}function hi(a){return Array.isArray(a)&&a.length===1&&Ze(a[0])}function pi(a){if(Array.isArray(a))return a.map(e=>{let t=e.values??[],i=e.multiple===!0;return hi(t)?{...e,values:i?[]:[""]}:t.some(Ze)?{...e,values:t.map(n=>Ze(n)?"":n)}:e});if(!a||typeof a!="object")return a;let r={};for(let[e,t]of Object.entries(a))Array.isArray(t)?r[e]=hi(t)?[]:t.map(i=>Ze(i)?"":i):Ze(t)?r[e]="":t&&typeof t=="object"&&Ze(t.value)?r[e]={...t,value:""}:r[e]=t;return r}var mi="fragment",gi="author",ui="preview",fi="loading",bi="mask",vi="pzn",xi="timeout",Tr="aem-fragment",yi="eager",wi="cache",Gn=[yi,wi],U,Ee,F,Lr=class{constructor(){u(this,U,new Map);u(this,Ee,new Map);u(this,F,new Map)}clear(){l(this,U).clear(),l(this,Ee).clear(),l(this,F).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(l(this,U).set(r.id,r),r.fields?.originalId&&l(this,U).set(r.fields.originalId,r),l(this,F).has(r.id)){let[,t]=l(this,F).get(r.id);t()}if(l(this,F).has(r.fields?.originalId)){let[,t]=l(this,F).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return l(this,U).has(r)}entries(){return l(this,U).entries()}get(r){return l(this,U).get(r)}getAsPromise(r){let[e]=l(this,F).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),l(this,F).set(r,[e,t]),e}getFetchInfo(r){let e=l(this,Ee).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},l(this,Ee).set(r,e)),e}set(r,e){if(l(this,U).set(r,e),l(this,F).has(r)){let[,t]=l(this,F).get(r);t()}}remove(r){l(this,U).delete(r),l(this,Ee).delete(r),l(this,F).delete(r)}};U=new WeakMap,Ee=new WeakMap,F=new WeakMap;var ie=new Lr,Xe,H,ne,$,j,P,Et,G,V,kt,W,Ct,St,Je,K,Ei,ki,Pr,Ci,Jt=class extends HTMLElement{constructor(){super(...arguments);u(this,K);h(this,"cache",ie);u(this,Xe);u(this,H,null);u(this,ne,null);u(this,$,null);u(this,j);u(this,P);u(this,Et,yi);u(this,G);u(this,V);u(this,kt,5e3);u(this,W);u(this,Ct,!1);u(this,St,0);u(this,Je)}static get observedAttributes(){return[mi,fi,xi,gi,ui,bi,vi]}cacheKey(){return`${l(this,j)}${l(this,V)?`-p_${l(this,V)}`:""}${l(this,G)?`-m_${l(this,G)}`:""}`}attributeChangedCallback(e,t,i){e===mi&&(m(this,j,i),m(this,P,ie.getFetchInfo(this.cacheKey()))),e===bi&&m(this,G,i),e===vi&&m(this,V,i),e===fi&&Gn.includes(i)&&m(this,Et,i),e===xi&&m(this,kt,parseInt(i,10)),e===gi&&m(this,Ct,["","true"].includes(i)),e===ui&&m(this,Je,i)}connectedCallback(){if(!l(this,W)){if(l(this,$)??m(this,$,be(this)),m(this,Je,l(this,$).settings?.preview),l(this,Xe)??m(this,Xe,l(this,$).log.module(`${Tr}[${l(this,j)}]`)),!l(this,j)||l(this,j)==="#"){l(this,P)??m(this,P,ie.getFetchInfo("missing-fragment-id")),y(this,K,Pr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(l(this,P)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(l(this,W)&&!await Promise.race([l(this,W),Promise.resolve(!1)]))return;e&&ie.remove(this.cacheKey()),l(this,Et)===wi&&await Promise.race([ie.getAsPromise(this.cacheKey()),new Promise(c=>setTimeout(c,l(this,kt)))]);try{m(this,W,y(this,K,Ci).call(this)),await l(this,W)}catch(c){return y(this,K,Pr).call(this,c.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=l(this,H)||{};return o&&!Yt("mas.disableWcsCache")&&l(this,$).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Re,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...l(this,P)},bubbles:!0,composed:!0})),l(this,W)}get updateComplete(){return l(this,W)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return l(this,ne)?l(this,ne):(l(this,Ct)?this.transformAuthorData():this.transformPublishData(),l(this,ne))}get rawData(){return l(this,H)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,promoProject:c,promoVariationProject:s,settings:d={},priceLiterals:p={},dictionary:g={},placeholders:f={}}=l(this,H),C=pi(e);m(this,ne,C.reduce((O,{name:D,multiple:Te,values:ge})=>(O.fields[D]=Te?ge:ge[0],O),{fields:{},id:t,tags:n,settings:d,priceLiterals:p,dictionary:g,maskId:i,placeholders:f,variationId:o,promoProject:c,promoVariationProject:s}))}transformPublishData(){if(!l(this,H))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},maskId:s,placeholders:d={},variationId:p,promoProject:g,promoVariationProject:f}=l(this,H);m(this,ne,Object.entries(e).reduce((C,[O,D])=>(C.fields[O]=D?.mimeType?D.value:D??"",C),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:c,maskId:s,placeholders:d,variationId:p,promoProject:g,promoVariationProject:f}))}getFragmentClientUrl(){let t=new URLSearchParams(window.location.search).get("maslibs");if(!t||t.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=t.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:l(this,$).settings.locale,apiKey:l(this,$).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??l(this,$).settings.instant,o={...i,...n!=null?{instant:n}:{},...l(this,G)!=null?{mask:l(this,G)}:{},...l(this,V)!=null?{pzn:l(this,V)}:{}};return await t(l(this,j),o)}};Xe=new WeakMap,H=new WeakMap,ne=new WeakMap,$=new WeakMap,j=new WeakMap,P=new WeakMap,Et=new WeakMap,G=new WeakMap,V=new WeakMap,kt=new WeakMap,W=new WeakMap,Ct=new WeakMap,St=new WeakMap,Je=new WeakMap,K=new WeakSet,Ei=async function(e){$r(this,St)._++;let t=`${Tr}:${this.cacheKey()}:${l(this,St)}`,i=`${t}${Dt}`,n=`${t}${Nt}`;if(l(this,Je)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new he(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(l(this,P).stale=!1,l(this,P).url=e,o=await di(e,{cache:"default",credentials:"omit"}),y(this,K,ki).call(this,o),l(this,P).status=o?.status,l(this,P).measure=De(performance.measure(n,i)),l(this,P).retryCount=o.retryCount,!o?.ok)throw new he("Unexpected fragment response",{response:o,...l(this,$).duration});return await o.json()}catch(c){if(l(this,P).measure=De(performance.measure(n,i)),l(this,P).retryCount=c.retryCount,l(this,H))return l(this,P).stale=!0,l(this,Xe).error("Serving stale data",l(this,P)),l(this,H);let s=c.message??"unknown";throw new he(`Failed to fetch fragment: ${s}`,{})}},ki=function(e){Object.assign(l(this,P),li(e))},Pr=function(e){m(this,W,null),l(this,P).message=e,this.classList.add("error");let t={...l(this,P),...l(this,$).duration};l(this,Xe).error(e,t),this.dispatchEvent(new CustomEvent(Oe,{detail:t,bubbles:!0,composed:!0}))},Ci=async function(){var s;this.classList.remove("error"),m(this,ne,null);let e=ie.get(this.cacheKey());if(e)return m(this,H,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=l(this,$).settings,c=`${t}/fragment?id=${l(this,j)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),l(this,G)&&(c+=`&mask=${l(this,G)}`),l(this,V)&&(c+=`&pzn=${l(this,V)}`),e=await y(this,K,Ei).call(this,c),(s=e.fields).originalId??(s.originalId=l(this,j)),l(this,G)||l(this,V)?ie.set(this.cacheKey(),e):ie.add(e),m(this,H,e),!0},h(Jt,"cache",ie);customElements.define(Tr,Jt);import{LitElement as Vn,html as _r,css as Wn,nothing as Kn}from"./lit-all.min.js";import{unsafeHTML as Yn}from"./lit-all.min.js";var Qn=a=>a?a.startsWith("sp-icon-")?_r`${Yn(`<${a} class="badge-icon"></${a}>`)}`:_r`<img src="${a}" class="badge-icon" />`:Kn,et=class extends Vn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return _r`<div class="badge">
            ${Qn(this.icon)}<slot>${this.text}</slot>
        </div>`}};h(et,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),h(et,"styles",Wn`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",et);import{html as Zn,css as Xn,LitElement as Jn}from"./lit-all.min.js";var At=class extends Jn{constructor(){super()}render(){return Zn`
            <slot name="icon"></slot>
    ...
    `),h(At,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",At);import{html as Mr,css as eo,LitElement as to,nothing as Si}from"./lit-all.min.js";var zt=class extends to{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Mr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Mr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:Si}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(zt,"styles",eo`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

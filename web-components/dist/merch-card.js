var pr=Object.defineProperty;var mr=a=>{throw TypeError(a)};var Za=(a,t,e)=>t in a?pr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var Ja=(a,t)=>()=>(a&&(t=a(a=0)),t);var ei=(a,t)=>{for(var e in t)pr(a,e,{get:t[e],enumerable:!0})};var h=(a,t,e)=>Za(a,typeof t!="symbol"?t+"":t,e),Ft=(a,t,e)=>t.has(a)||mr("Cannot "+e);var s=(a,t,e)=>(Ft(a,t,"read from private field"),e?e.call(a):t.get(a)),f=(a,t,e)=>t.has(a)?mr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),g=(a,t,e,r)=>(Ft(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),P=(a,t,e)=>(Ft(a,t,"access private method"),e);var gr=(a,t,e,r)=>({set _(i){g(a,t,i,e)},get _(){return s(a,t,r)}});var It={};ei(It,{default:()=>je});import{LitElement as ti,html as ve,css as ri,nothing as ai}from"./lit-all.min.js";import{unsafeHTML as yr}from"./lit-all.min.js";import{ifDefined as ii}from"./lit-all.min.js";function ni(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var _,je,$t=Ja(()=>{_=class _ extends ti{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();_.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>i?u="top":u==="left"&&e.left-d-n<0?u="right":u==="right"&&e.right+d+n>r&&(u="left");let C=e.left+e.width/2,$=e.top+e.height/2,Q=6,dt=(Ya,Qa,Xa)=>Math.max(Ya,Math.min(Qa,Xa)),ht,pt,Dt;u==="top"||u==="bottom"?(ht=u==="top"?e.top-p-n:e.bottom+n,pt=dt(0,r-d,C-d/2),Dt=dt(Q,d-Q*2,C-pt-Q)):(pt=u==="left"?e.left-d-n:e.right+n,ht=dt(0,i-p,$-p/2),Dt=dt(Q,p-Q*2,$-ht-Q)),this._tooltipTop=ht,this._tooltipLeft=pt,this._arrowOffset=Dt,this._computedPlacement=u}showTooltip(){_.activeTooltip&&_.activeTooltip!==this&&(_.activeTooltip.closeOverlay(),_.activeTooltip.tooltipVisible=!1,_.activeTooltip.requestUpdate()),_.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){_.activeTooltip===this&&(_.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?ve`<merch-icon
        ...
        ></merch-icon>`:ve`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return ve`<span class="icon-only">${this.renderIcon()}</span>`;if(ni())return ve`
            ...
            `;let i=t.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:m=>{this.lastPointerType=m.pointerType},pointerenter:m=>m.pointerType!=="touch"&&this.showTooltip(),pointerleave:m=>m.pointerType!=="touch"&&this.hideTooltip(),click:m=>{this.lastPointerType==="touch"&&this.handleTap(m),this.lastPointerType=null}},c=this._computedPlacement,l=c==="top"||c==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=l?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return ve`
            <span
    ...
    `);je=_;customElements.define("mas-mnemonic",je)});import{LitElement as Kn}from"./lit-all.min.js";import{css as vr,unsafeCSS as fr}from"./lit-all.min.js";var w="(max-width: 767px)",T="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",L="(min-width: 1600px)",ur={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${L})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=ur;function mt(){return ur.isDesktop}var xr=vr`
    :host {
...
`,br=()=>[vr`
        ...
        `];import{LitElement as oi,html as wr,css as ci}from"./lit-all.min.js";function si(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var xe=class extends oi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(si())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>$t())}e.remove()})}render(){let{href:t}=this;return t?wr`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(xe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(xe,"styles",ci`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",xe);var lo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ho=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var y='span[is="inline-price"][data-wcs-osi]',X='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var li='a[is="upt-link"]',Er=`${y},${X},${li}`;var kr="merch-offer-select:ready",Sr="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",Cr="merch-card-quantity:change",Bt="merch-modal:addon-and-quantity-update";var be="merch-card-collection:literals-changed";var ye="aem:load",we="aem:error",gt="mas:ready",Ar="mas:error",Tr="placeholder-failed",Lr="placeholder-pending",zr="placeholder-resolved";var Pr="mas:failed",Ve="mas:resolved",_r="mas/commerce";var Z="failed",oe="pending",J="resolved";var ut="X-Request-Id",po=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var mo=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var ft=":start",vt=":duration";var N="legal",Mr="mas-ff-defaults";var di="mas-commerce-service";function Rr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function z(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function Ee(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function qt(){return window.matchMedia("(max-width: 1024px)").matches}function ce(){return document.getElementsByTagName(di)?.[0]}function We(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Ke,se,Ye,Qe,ke,xt=class extends HTMLElement{constructor(){super();f(this,Ke,"");f(this,se);f(this,Ye,[]);f(this,Qe,[]);f(this,ke);g(this,ke,Rr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,se)?this.parentElement.style.borderRadius=s(this,se):s(this,se)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Ye).map((r,i)=>{let n=s(this,Qe)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,Ke)}, ${e})`}connectedCallback(){s(this,ke).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&g(this,se,i?.trim()),e==="colors"&&i?g(this,Ye,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?g(this,Qe,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&g(this,Ke,i?.trim()??""),s(this,ke).call(this)}};Ke=new WeakMap,se=new WeakMap,Ye=new WeakMap,Qe=new WeakMap,ke=new WeakMap;customElements.define("merch-gradient",xt);import{LitElement as hi,html as pi,css as mi}from"./lit-all.min.js";var Se=class extends hi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Ve,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Ve,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return pi` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(Se,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),h(Se,"styles",mi`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",Se);import{html as bt,nothing as gi}from"./lit-all.min.js";var Ce,Xe=class Xe{constructor(t){h(this,"card");f(this,Ce);this.card=t,this.insertVariantStyle()}getContainer(){return g(this,Ce,s(this,Ce)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,Ce)}insertVariantStyle(){let t=this.constructor.name;if(!Xe.styleMap[t]){Xe.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let r=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${r}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of t){let c=`--consonant-merch-card-${r}-${o}-height`;e.style.getPropertyValue(c)&&e.style.removeProperty(c)}let n=new Map;for(let o of i){let c=o.getBoundingClientRect();if(c.width<=2)continue;let l=Math.round(c.top),d=n.get(l);d||(d=[],n.set(l,d)),d.push(o)}for(let o of n.values())for(let{name:c,getElement:l}of t){let d=`--consonant-merch-card-${r}-${c}-height`,p=0,m=[];for(let u of o){u.style.removeProperty(d);let C=l(u);if(!C){m.push({card:u,height:0});continue}let $=Math.max(0,parseInt(window.getComputedStyle(C).height)||0);m.push({card:u,height:$}),$>p&&(p=$)}if(!(p<=0))for(let{card:u}of m)u.style.setProperty(d,`${p}px`)}}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),bt`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return yt(this.card.variant)}};Ce=new WeakMap,h(Xe,"styleMap",{});var b=Xe;import{html as Ht,css as ui}from"./lit-all.min.js";var Or=`
:root {
...
`;var wt=class extends b{constructor(t){super(t)}getGlobalCSS(){return Ir}renderLayout(){return $r` ${this.badge}
            ...
            ${this.card.customHr?"":$r`<hr />`} ${this.secureLabelFooter}`}};import{html as ee,css as vi,unsafeCSS as qr}from"./lit-all.min.js";var Br=`
  :root {
...
`;var St={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Wr={...function(){let{whatsIncluded:a,size:t,...e}=St;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Kr={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=St;return i}()},G,j,M=class extends b{constructor(e){super(e);f(this,G);f(this,j);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===N&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Vr}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(c)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&l){if(d)l.remove();else{let m=p.querySelector(`[data-placeholder-for="${e}"]`);m?m.replaceWith(l):p.appendChild(l)}return}if(i&&d){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",e),m.classList.add("slot-placeholder"),!l){let u=d.cloneNode(!0);o.prepend(u)}d.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,G)||(g(this,G,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,G)?.disconnect(),g(this,G,null),this.syncHeights())})),s(this,G).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=We(p));let m=this.card.querySelector('[slot="subtitle"]');m&&(d+=We(m));let u=this.card.querySelector('[slot="heading-m"]');u&&(d+=8+We(u));for(let $ of r.childNodes){if($.classList.contains("spacer"))break;d+=We($)}let C=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(C)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Je`<div class="divider"></div>`:kt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?Je`<label id="stock-checkbox">
    ...
    `),h(M,"collectionOptions",{customHeaderArea:e=>e.sidenav?Je`<slot name="resultsText"></slot>`:kt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let r=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let c=o.getAttribute("size"),l=c==="wide"?2:c==="super-wide"?3:1;l===2&&n%3===2&&(o.setAttribute("data-size",c),o.removeAttribute("size"),l=1),n+=l}};x.matchDesktop.addEventListener("change",r),e.addEventListener(be,r),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",r),e.removeEventListener(be,r)})}});import{html as K,css as ki,unsafeCSS as Qr,nothing as Ct}from"./lit-all.min.js";var Yr=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?K`
        ...
        `:K`
            ...
            <slot></slot>`}};h(te,"variantStyle",ki`
...
`;var Jr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ze=class extends b{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Zr}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ut` ${this.badge}
...
`;var ta={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Pe=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ea}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Gt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var na={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Me=class extends b{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ia}renderLayout(){return jt`${this.cardImage}
            ...
            ${this.evergreen?jt`
                  ...
                  `:jt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(Me,"variantStyle",Li`
...
`;var Yt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Fe=class extends b{getGlobalCSS(){return ma}get aemFragmentMapping(){return Yt}renderLayout(){return Fi`
    ...
    `);var At=new Map,ga=new WeakMap,ua=new Map,k=(a,t,e=null,r=null,i)=>{At.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",Ae,Nr,Ae.variantStyle);k("image",le);k("inline-heading",wt);k("mini-compare-chart",Te,Hr,Te.variantStyle);k("mini-compare-chart-mweb",Le,jr,Le.variantStyle);k("plans",M,St,M.variantStyle,M.collectionOptions);k("plans-students",M,Kr,M.variantStyle,M.collectionOptions);k("plans-education",M,Wr,M.variantStyle,M.collectionOptions);k("plans-v2",te,Xr,te.variantStyle,te.collectionOptions);k("product",ze,Jr,ze.variantStyle);k("segment",Pe,ta,Pe.variantStyle);k("media",_e,aa,_e.variantStyle);k("headless",Ne,da,Ne.variantStyle);k("special-offers",Me,na,Me.variantStyle);k("simplified-pricing-express",Re,Vt,Re.variantStyle);k("full-pricing-express",Oe,Wt,Oe.variantStyle);k("mini",De,pa,De.variantStyle);k("image",le,Fr,le.variantStyle);k("fries",Fe,Yt,Fe.variantStyle);var $i=(a,t,e)=>{try{let r=ua.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ua.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Qt=a=>{let t=At.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=ga.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?$i(a,r,i):{};return ga.set(a,{appliedVariant:a.variant,...n}),new e(a)};function yt(a){return At.get(a)?.fragmentMapping}function fa(a){return At.get(a)?.collectionOptions}var va=document.createElement("style");va.innerHTML=`
:root {
...
`;document.head.appendChild(va);function Tt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=Xt(r)?r:a;n=o.get(c)}if(i&&n==null){let o=Xt(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=qi(Xt(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var Bi=a=>typeof a=="boolean",Lt=a=>typeof a=="function";var Xt=a=>typeof a=="string";function xa(a,t){if(Bi(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function qi(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var re=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(ut);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var de={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ba=1e3;function Hi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ya(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!de.serializableTypes.includes(e))return e}return a}function Ui(a,t){if(!de.ignoredProperties.includes(a))return ya(t)}var Zt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(Hi(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(ya).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${de.delimiter}page=${o}${c}`;l.length>ba&&(l=`${l.slice(0,ba)}<trunc>`),n+=l,i.length&&(n+=`${de.delimiter}facts=`,n+=JSON.stringify(i,Ui)),window.lana?.log(n,de)}};function wa(a){Object.assign(de,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in de&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Ea={LOCAL:"local",PROD:"prod",STAGE:"stage"},Jt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},er=new Set,tr=new Set,ka=new Map,Sa={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Ca={filter:({level:a})=>a!==Jt.DEBUG},Gi={filter:()=>!1};function ji(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Lt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Vi(a){[...tr].every(t=>t(a))&&er.forEach(t=>t(a))}function Aa(a){let t=(ka.get(a)??0)+1;ka.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Aa(`${r.namespace}/${i}`),updateConfig:wa};return Object.values(Jt).forEach(i=>{r[i]=(n,...o)=>Vi(ji(i,n,a,o,e))}),Object.seal(r)}function zt(...a){a.forEach(t=>{let{append:e,filter:r}=t;Lt(r)&&tr.add(r),Lt(e)&&er.add(e)})}function Wi(a={}){let{name:t}=a,e=xa(Tt("commerce.debug",{search:!0,storage:!0}),t===Ea.LOCAL);return zt(e?Sa:Ca),t===Ea.PROD&&zt(Zt),et}function Ki(){er.clear(),tr.clear()}var et={...Aa(_r),Level:Jt,Plugins:{consoleAppender:Sa,debugFilter:Ca,quietFilter:Gi,lanaAppender:Zt},init:Wi,reset:Ki,use:zt};var Yi="mas-commerce-service",wl=et.module("utilities"),Qi={requestId:ut,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Pt=a=>window.setTimeout(a);function rr(){return document.getElementsByTagName(Yi)?.[0]}function Ta(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Qi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function La(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var za="fragment",Pa="author",_a="preview",Ma="loading",Ra="timeout",ar="aem-fragment",Oa="eager",Na="cache",Xi=[Oa,Na],V,he,B,ir=class{constructor(){f(this,V,new Map);f(this,he,new Map);f(this,B,new Map)}clear(){s(this,V).clear(),s(this,he).clear(),s(this,B).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,V).set(t.id,t),t.fields?.originalId&&s(this,V).set(t.fields.originalId,t),s(this,B).has(t.id)){let[,r]=s(this,B).get(t.id);r()}if(s(this,B).has(t.fields?.originalId)){let[,r]=s(this,B).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,V).has(t)}entries(){return s(this,V).entries()}get(t){return s(this,V).get(t)}getAsPromise(t){let[e]=s(this,B).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,B).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,he).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,he).set(t,e)),e}remove(t){s(this,V).delete(t),s(this,he).delete(t),s(this,B).delete(t)}};V=new WeakMap,he=new WeakMap,B=new WeakMap;var ae=new ir,Ie,q,Y,D,R,A,tt,rt,H,at,it,$e,U,Da,Fa,nr,Ia,_t=class extends HTMLElement{constructor(){super(...arguments);f(this,U);h(this,"cache",ae);f(this,Ie);f(this,q,null);f(this,Y,null);f(this,D,null);f(this,R);f(this,A);f(this,tt,Oa);f(this,rt,5e3);f(this,H);f(this,at,!1);f(this,it,0);f(this,$e)}static get observedAttributes(){return[za,Ma,Ra,Pa,_a]}attributeChangedCallback(e,r,i){e===za&&(g(this,R,i),g(this,A,ae.getFetchInfo(i))),e===Ma&&Xi.includes(i)&&g(this,tt,i),e===Ra&&g(this,rt,parseInt(i,10)),e===Pa&&g(this,at,["","true"].includes(i)),e===_a&&g(this,$e,i)}connectedCallback(){if(!s(this,H)){if(s(this,D)??g(this,D,ce(this)),g(this,$e,s(this,D).settings?.preview),s(this,Ie)??g(this,Ie,s(this,D).log.module(`${ar}[${s(this,R)}]`)),!s(this,R)||s(this,R)==="#"){s(this,A)??g(this,A,ae.getFetchInfo("missing-fragment-id")),P(this,U,nr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,A)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,H)&&!await Promise.race([s(this,H),Promise.resolve(!1)]))return;e&&ae.remove(s(this,R)),s(this,tt)===Na&&await Promise.race([ae.getAsPromise(s(this,R)),new Promise(c=>setTimeout(c,s(this,rt)))]);try{g(this,H,P(this,U,Ia).call(this)),await s(this,H)}catch(c){return P(this,U,nr).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,q)||{};return o&&!Tt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ye,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,A)},bubbles:!0,composed:!0})),s(this,H)}get updateComplete(){return s(this,H)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,Y)?s(this,Y):(s(this,at)?this.transformAuthorData():this.transformPublishData(),s(this,Y))}get rawData(){return s(this,q)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:d={}}=s(this,q);g(this,Y,e.reduce((p,{name:m,multiple:u,values:C})=>(p.fields[m]=u?C:C[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:d,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:d}=s(this,q);g(this,Y,Object.entries(e).reduce((p,[m,u])=>(p.fields[m]=u?.mimeType?u.value:u??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,R),{locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0})}};Ie=new WeakMap,q=new WeakMap,Y=new WeakMap,D=new WeakMap,R=new WeakMap,A=new WeakMap,tt=new WeakMap,rt=new WeakMap,H=new WeakMap,at=new WeakMap,it=new WeakMap,$e=new WeakMap,U=new WeakSet,Da=async function(e){gr(this,it)._++;let r=`${ar}:${s(this,R)}:${s(this,it)}`,i=`${r}${ft}`,n=`${r}${vt}`;if(s(this,$e)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new re(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,A).stale=!1,s(this,A).url=e,o=await La(e,{cache:"default",credentials:"omit"}),P(this,U,Fa).call(this,o),s(this,A).status=o?.status,s(this,A).measure=Ee(performance.measure(n,i)),s(this,A).retryCount=o.retryCount,!o?.ok)throw new re("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,A).measure=Ee(performance.measure(n,i)),s(this,A).retryCount=c.retryCount,s(this,q))return s(this,A).stale=!0,s(this,Ie).error("Serving stale data",s(this,A)),s(this,q);let l=c.message??"unknown";throw new re(`Failed to fetch fragment: ${l}`,{})}},Fa=function(e){Object.assign(s(this,A),Ta(e))},nr=function(e){g(this,H,null),s(this,A).message=e,this.classList.add("error");let r={...s(this,A),...s(this,D).duration};s(this,Ie).error(e,r),this.dispatchEvent(new CustomEvent(we,{detail:r,bubbles:!0,composed:!0}))},Ia=async function(){var l;this.classList.remove("error"),g(this,Y,null);let e=ae.get(s(this,R));if(e)return g(this,q,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,R)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await P(this,U,Da).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,R)),ae.add(e),g(this,q,e),!0},h(_t,"cache",ae);customElements.define(ar,_t);import{LitElement as Zi,html as or,css as Ji,nothing as en}from"./lit-all.min.js";import{unsafeHTML as tn}from"./lit-all.min.js";var rn=a=>a?a.startsWith("sp-icon-")?or`${tn(`<${a} class="badge-icon"></${a}>`)}`:or`<img src="${a}" class="badge-icon" />`:en,Be=class extends Zi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return or`<div class="badge">
            ${rn(this.icon)}<slot>${this.text}</slot>
        </div>`}};h(Be,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),h(Be,"styles",Ji`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Be);import{html as an,css as nn,LitElement as on}from"./lit-all.min.js";var nt=class extends on{constructor(){super()}render(){return an`
            <slot name="icon"></slot>

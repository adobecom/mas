    ...
    `);customElements.define("merch-addon",ve);import{html as ot,nothing as Ni}from"./lit-all.min.js";var be,qe=class qe{constructor(t){d(this,"card");g(this,be);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,be,c(this,be)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,be)}insertVariantStyle(){let t=this.constructor.name;if(!qe.styleMap[t]){qe.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;a>o&&n.style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),ot`
        ...
        `}get cardImage(){return ot` <div class="image">
            ...
            ${this.badge}
              ...
              >`:Ni}get secureLabelFooter(){return ot`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return st(this.card.variant)}};be=new WeakMap,d(qe,"styleMap",{});var v=qe;import{html as Tt,css as $i}from"./lit-all.min.js";var vr=`
:root {
...
`;var Bi=32,Ee=class extends v{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?we`<slot name="secure-transaction-label">
    ...
    `);import{html as Ge,css as Hi,nothing as lt}from"./lit-all.min.js";var Cr=`
:root {
...
`;var dt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Tr={...function(){let{whatsIncluded:i,size:t,...e}=dt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Lr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=dt;return a}()},z=class extends v{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===W&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Cr}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=a.querySelector(`footer slot[name="${t}"]`),l=a.querySelector(`.body slot[name="${t}"]`),p=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",f.isDesktopOrUp),!r&&s){if(l)s.remove();else{let h=p.querySelector(`[data-placeholder-for="${t}"]`);h?h.replaceWith(s):p.appendChild(s)}return}if(r&&l){let h=document.createElement("div");if(h.setAttribute("data-placeholder-for",t),h.classList.add("slot-placeholder"),!s){let b=l.cloneNode(!0);n.prepend(b)}l.replaceWith(h)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],f.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],f.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let a=r.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),e.insertBefore(n,a);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let l=0,p=this.card.querySelector('[slot="heading-s"]');p&&(l+=Ie(p));let h=this.card.querySelector('[slot="subtitle"]');h&&(l+=Ie(h));let b=this.card.querySelector('[slot="heading-m"]');b&&(l+=8+Ie(b));for(let pe of e.childNodes){if(pe.classList.contains("spacer"))break;l+=Ie(pe)}let _=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(_)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${x}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ge`<div class="divider"></div>`:lt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${x}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling),await n.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Ge`<label id="stock-checkbox">
    ...
    `),d(z,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ge`<slot name="resultsText"></slot>`:lt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let e=()=>{let r=t.querySelectorAll("merch-card");for(let n of r)n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"));if(!f.isDesktop)return;let a=0;for(let n of r){if(n.style.display==="none")continue;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&a%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),a+=s}};f.matchDesktop.addEventListener("change",e),t.addEventListener(me,e),t.onUnmount.push(()=>{f.matchDesktop.removeEventListener("change",e),t.removeEventListener(me,e)})}});import{html as q,css as qi,unsafeCSS as Pr,nothing as pt}from"./lit-all.min.js";var zr=`
:root {
...
`;var Or={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Se=class extends v{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===W&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Dr}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${x}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return zt`
    ...
    `);import{html as Pt,css as ji}from"./lit-all.min.js";var Nr=`
:root {
...
`;var qr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Le=class extends v{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Hr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${x}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Qi`
    ...
    `);var ht=new Map,Ur=new WeakMap,Gr=new Map,S=(i,t,e=null,r=null,a)=>{ht.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};S("catalog",ye,br,ye.variantStyle);S("image",re);S("inline-heading",ct);S("mini-compare-chart",Ee,null,Ee.variantStyle);S("plans",z,dt,z.variantStyle,z.collectionOptions);S("plans-students",z,Lr,z.variantStyle,z.collectionOptions);S("plans-education",z,Tr,z.variantStyle,z.collectionOptions);S("plans-v2",K,_r,K.variantStyle,K.collectionOptions);S("product",ke,Rr,ke.variantStyle);S("segment",Se,Or,Se.variantStyle);S("special-offers",Ae,$r,Ae.variantStyle);S("simplified-pricing-express",Ce,_t,Ce.variantStyle);S("full-pricing-express",Te,Mt,Te.variantStyle);S("mini",Le,qr,Le.variantStyle);S("image",re,wr,re.variantStyle);var Xi=(i,t,e)=>{try{let r=Gr.get(i.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),Gr.set(i.variant,r)),e?.styleSheet&&e.styleSheet!==r){let a=i.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);a!==-1&&i.shadowRoot.adoptedStyleSheets.splice(a,1)}return i.shadowRoot.adoptedStyleSheets.includes(r)||i.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",i.variant);let n=e?.styleElement||i.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),i.shadowRoot.appendChild(a),{styleElement:a}}},Rt=i=>{let t=ht.get(i.variant);if(!t)return;let{class:e,style:r}=t,a=Ur.get(i);if(a?.appliedVariant===i.variant)return new e(i);let n=r?Xi(i,r,a):{};return Ur.set(i,{appliedVariant:i.variant,...n}),new e(i)};function st(i){return ht.get(i)?.fragmentMapping}function jr(i){return ht.get(i)?.collectionOptions}var Vr=document.createElement("style");Vr.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var ae={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Wr=1e3;function ea(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Kr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!ae.serializableTypes.includes(e))return e}return i}function ta(i,t){if(!ae.ignoredProperties.includes(i))return Kr(t)}var Ot={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(p=>{p!=null&&(ea(p)?r:a).push(p)}),r.length&&(n+=" "+r.map(Kr).join(" "));let{pathname:o,search:s}=window.location,l=`${ae.delimiter}page=${o}${s}`;l.length>Wr&&(l=`${l.slice(0,Wr)}<trunc>`),n+=l,a.length&&(n+=`${ae.delimiter}facts=`,n+=JSON.stringify(a,ta)),window.lana?.log(n,ae)}};function Qr(i){Object.assign(ae,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in ae&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Xr={LOCAL:"local",PROD:"prod",STAGE:"stage"},Nt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},$t=new Set,It=new Set,Zr=new Map,Jr={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},ei={filter:({level:i})=>i!==Nt.DEBUG},ra={filter:()=>!1};function ia(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&gt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function aa(i){[...It].every(t=>t(i))&&$t.forEach(t=>t(i))}function ti(i){let t=(Zr.get(i)??0)+1;Zr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>ti(`${r.namespace}/${a}`),updateConfig:Qr};return Object.values(Nt).forEach(a=>{r[a]=(n,...o)=>aa(ia(a,n,i,o,e))}),Object.seal(r)}function ut(...i){i.forEach(t=>{let{append:e,filter:r}=t;gt(r)&&It.add(r),gt(e)&&$t.add(e)})}function na(i={}){let{name:t}=i,e=Yr(mt("commerce.debug",{search:!0,storage:!0}),t===Xr.LOCAL);return ut(e?Jr:ei),t===Xr.PROD&&ut(Ot),je}function oa(){$t.clear(),It.clear()}var je={...ti(ur),Level:Nt,Plugins:{consoleAppender:Jr,debugFilter:ei,quietFilter:ra,lanaAppender:Ot},init:na,reset:oa,use:ut};var sa="mas-commerce-service",Ks=je.module("utilities"),ca={requestId:rt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ft=i=>window.setTimeout(i);function Ft(){return document.getElementsByTagName(sa)?.[0]}function ri(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(ca)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function ii(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var ai="fragment",ni="author",oi="preview",si="loading",ci="timeout",Bt="aem-fragment",li="eager",di="cache",la=[li,di],F,ne,O,Ht=class{constructor(){g(this,F,new Map);g(this,ne,new Map);g(this,O,new Map)}clear(){c(this,F).clear(),c(this,ne).clear(),c(this,O).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,F).set(t.id,t),t.fields?.originalId&&c(this,F).set(t.fields.originalId,t),c(this,O).has(t.id)){let[,r]=c(this,O).get(t.id);r()}if(c(this,O).has(t.fields?.originalId)){let[,r]=c(this,O).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,F).has(t)}entries(){return c(this,F).entries()}get(t){return c(this,F).get(t)}getAsPromise(t){let[e]=c(this,O).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,O).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ne).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ne).set(t,e)),e}remove(t){c(this,F).delete(t),c(this,ne).delete(t),c(this,O).delete(t)}};F=new WeakMap,ne=new WeakMap,O=new WeakMap;var Q=new Ht,ze,N,U,R,P,k,Ve,Ye,$,We,Ke,Pe,I,pi,hi,qt,mi,xt=class extends HTMLElement{constructor(){super(...arguments);g(this,I);d(this,"cache",Q);g(this,ze);g(this,N,null);g(this,U,null);g(this,R,null);g(this,P);g(this,k);g(this,Ve,li);g(this,Ye,5e3);g(this,$);g(this,We,!1);g(this,Ke,0);g(this,Pe)}static get observedAttributes(){return[ai,si,ci,ni,oi]}attributeChangedCallback(e,r,a){e===ai&&(m(this,P,a),m(this,k,Q.getFetchInfo(a))),e===si&&la.includes(a)&&m(this,Ve,a),e===ci&&m(this,Ye,parseInt(a,10)),e===ni&&m(this,We,["","true"].includes(a)),e===oi&&m(this,Pe,a)}connectedCallback(){if(!c(this,$)){if(c(this,R)??m(this,R,ee(this)),m(this,Pe,c(this,R).settings?.preview),c(this,ze)??m(this,ze,c(this,R).log.module(`${Bt}[${c(this,P)}]`)),!c(this,P)||c(this,P)==="#"){c(this,k)??m(this,k,Q.getFetchInfo("missing-fragment-id")),A(this,I,qt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,$)&&!await Promise.race([c(this,$),Promise.resolve(!1)]))return;e&&Q.remove(c(this,P)),c(this,Ve)===di&&await Promise.race([Q.getAsPromise(c(this,P)),new Promise(s=>setTimeout(s,c(this,Ye)))]);try{m(this,$,A(this,I,mi).call(this)),await c(this,$)}catch(s){return A(this,I,qt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,N)||{};return o&&!mt("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ge,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,$)}get updateComplete(){return c(this,$)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,We)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,N)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,N);m(this,U,e.reduce((p,{name:h,multiple:b,values:_})=>(p.fields[h]=b?_:_[0],p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,N);m(this,U,Object.entries(e).reduce((p,[h,b])=>(p.fields[h]=b?.mimeType?b.value:b??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,P),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};ze=new WeakMap,N=new WeakMap,U=new WeakMap,R=new WeakMap,P=new WeakMap,k=new WeakMap,Ve=new WeakMap,Ye=new WeakMap,$=new WeakMap,We=new WeakMap,Ke=new WeakMap,Pe=new WeakMap,I=new WeakSet,pi=async function(e){Zt(this,Ke)._++;let r=`${Bt}:${c(this,P)}:${c(this,Ke)}`,a=`${r}${it}`,n=`${r}${at}`;if(c(this,Pe))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await ii(e,{cache:"default",credentials:"omit"}),A(this,I,hi).call(this,o),c(this,k).status=o?.status,c(this,k).measure=fe(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new ie("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,k).measure=fe(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,N))return c(this,k).stale=!0,c(this,ze).error("Serving stale data",c(this,k)),c(this,N);let l=s.message??"unknown";throw new ie(`Failed to fetch fragment: ${l}`,{})}},hi=function(e){Object.assign(c(this,k),ri(e))},qt=function(e){m(this,$,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,R).duration};c(this,ze).error(e,r),this.dispatchEvent(new CustomEvent(ue,{detail:r,bubbles:!0,composed:!0}))},mi=async function(){var l;this.classList.remove("error"),m(this,U,null);let e=Q.get(c(this,P));if(e)return m(this,N,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,R).settings,s=`${r}/fragment?id=${c(this,P)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await A(this,I,pi).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,P)),Q.add(e),m(this,N,e),!0},d(xt,"cache",Q);customElements.define(Bt,xt);import{LitElement as da,html as Ut,css as pa,nothing as ha}from"./lit-all.min.js";import{unsafeHTML as ma}from"./lit-all.min.js";var ga=i=>i?i.startsWith("sp-icon-")?Ut`${ma(`<${i} class="badge-icon"></${i}>`)}`:Ut`<img src="${i}" class="badge-icon" />`:ha,_e=class extends da{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Ut`<div class="badge">
    ...
    `),d(Qe,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Qe);import{html as Gt,css as va,LitElement as ba,nothing as gi}from"./lit-all.min.js";var Xe=class extends ba{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Gt`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?Gt`<slot name="content"></slot>`:gi}

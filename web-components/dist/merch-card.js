var Rr=Object.defineProperty;var Or=a=>{throw TypeError(a)};var Ri=(a,r,e)=>r in a?Rr(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Oi=(a,r)=>()=>(a&&(r=a(a=0)),r);var Di=(a,r)=>{for(var e in r)Rr(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>Ri(a,typeof r!="symbol"?r+"":r,e),rr=(a,r,e)=>r.has(a)||Or("Cannot "+e);var c=(a,r,e)=>(rr(a,r,"read from private field"),e?e.call(a):r.get(a)),u=(a,r,e)=>r.has(a)?Or("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(rr(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),y=(a,r,e)=>(rr(a,r,"access private method"),e);var Dr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return c(a,r,t)}});var ar={};Di(ar,{default:()=>et});import{LitElement as Ni,html as Se,css as Fi,nothing as Ii}from"./lit-all.min.js";import{unsafeHTML as qr}from"./lit-all.min.js";import{ifDefined as $i}from"./lit-all.min.js";function Bi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var O,et,ir=Oi(()=>{O=class O extends Ni{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();O.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:s,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>t&&(f="left");let C=e.left+e.width/2,N=e.top+e.height/2,ie=6,At=(Pi,_i,Mi)=>Math.max(Pi,Math.min(_i,Mi)),zt,Tt,tr;f==="top"||f==="bottom"?(zt=f==="top"?e.top-p-n:e.bottom+n,Tt=At(0,t-d,C-d/2),tr=At(ie,d-ie*2,C-Tt-ie)):(Tt=f==="left"?e.left-d-n:e.right+n,zt=At(0,i-p,N-p/2),tr=At(ie,p-ie*2,N-zt-ie)),this._tooltipTop=zt,this._tooltipLeft=Tt,this._arrowOffset=tr,this._computedPlacement=f}showTooltip(){O.activeTooltip&&O.activeTooltip!==this&&(O.activeTooltip.closeOverlay(),O.activeTooltip.tooltipVisible=!1,O.activeTooltip.requestUpdate()),O.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){O.activeTooltip===this&&(O.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Se`<merch-icon
        ...
        `}};h(O,"activeTooltip",null),h(O,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"},mnemonicText:{type:String,attribute:"mnemonic-text"},mnemonicPlacement:{type:String,attribute:"mnemonic-placement"},alt:{type:String},smartPlacement:{type:Boolean,attribute:"smart-placement"},tooltipVisible:{type:Boolean,state:!0},_tooltipTop:{type:Number,state:!0},_tooltipLeft:{type:Number,state:!0},_arrowOffset:{type:Number,state:!0},_computedPlacement:{type:String,state:!0}}),h(O,"styles",Fi`
        :host {
            display: contents;
            overflow: visible;
        }
...
`;var La={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Z,Ie=class extends v{constructor(e){super(e);u(this,Z);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ta}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return lr` ${this.badge}
...
`;var _a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},$e=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===R&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Pa}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return dr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var ur={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},En=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],jt,ja,Ge=class extends v{constructor(e){super(e);u(this,jt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ua}get aemFragmentMapping(){return ur}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,jt,ja).call(this))}renderLayout(){return yn`
            <div class="card">
            ...
            <slot></slot>
        `}};jt=new WeakSet,ja=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;En.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ge,"variantStyle",wn`
    ...
    `);import{html as kn,css as Cn}from"./lit-all.min.js";var Ga=`
...
Caused by: ${this.cause}`),e}};var be={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Za=1e3;function Tn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Xa(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!be.serializableTypes.includes(e))return e}return a}function Ln(a,r){if(!be.ignoredProperties.includes(a))return Xa(r)}var xr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(Tn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(Xa).join(" ")}`);let{pathname:o,search:s}=window.location,l=`${be.delimiter}page=${o}${s}`;l.length>Za&&(l=`${l.slice(0,Za)}<trunc>`),n+=l,i.length&&(n+=`${be.delimiter}facts=`,n+=JSON.stringify(i,Ln)),window.lana?.log(n,be)}};function Ja(a){Object.assign(be,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in be&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ei={LOCAL:"local",PROD:"prod",STAGE:"stage"},yr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},wr=new Set,Er=new Set,ti=new Map,ri={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},ai={filter:({level:a})=>a!==yr.DEBUG},Pn={filter:()=>!1};function _n(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Wt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function Mn(a){[...Er].every(r=>r(a))&&wr.forEach(r=>r(a))}function ii(a){let r=(ti.get(a)??0)+1;ti.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>ii(`${t.namespace}/${i}`),updateConfig:Ja};return Object.values(yr).forEach(i=>{t[i]=(n,...o)=>Mn(_n(i,n,a,o,e))}),Object.seal(t)}function Kt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Wt(t)&&Er.add(t),Wt(e)&&wr.add(e)})}function Rn(a={}){let{name:r}=a,e=Qa(Vt("commerce.debug",{search:!0,storage:!0}),r===ei.LOCAL);return Kt(e?ri:ai),r===ei.PROD&&Kt(xr),ft}function On(){wr.clear(),Er.clear()}var ft={...ii(Xr),Level:yr,Plugins:{consoleAppender:ri,debugFilter:ai,quietFilter:Pn,lanaAppender:xr},init:Rn,reset:On,use:Kt};var Dn="mas-commerce-service",Pd=ft.module("utilities"),Nn={requestId:_t,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Yt=a=>window.setTimeout(a);function kr(){return document.getElementsByTagName(Dn)?.[0]}function ni(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Nn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function oi(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,t*(n+1)))}throw i}var si="fragment",ci="author",li="preview",di="loading",hi="mask",pi="pzn",mi="timeout",Cr="aem-fragment",gi="eager",ui="cache",Fn=[gi,ui],U,xe,F,Sr=class{constructor(){u(this,U,new Map);u(this,xe,new Map);u(this,F,new Map)}clear(){c(this,U).clear(),c(this,xe).clear(),c(this,F).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(c(this,U).set(r.id,r),r.fields?.originalId&&c(this,U).set(r.fields.originalId,r),c(this,F).has(r.id)){let[,t]=c(this,F).get(r.id);t()}if(c(this,F).has(r.fields?.originalId)){let[,t]=c(this,F).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return c(this,U).has(r)}entries(){return c(this,U).entries()}get(r){return c(this,U).get(r)}getAsPromise(r){let[e]=c(this,F).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),c(this,F).set(r,[e,t]),e}getFetchInfo(r){let e=c(this,xe).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,xe).set(r,e)),e}set(r,e){if(c(this,U).set(r,e),c(this,F).has(r)){let[,t]=c(this,F).get(r);t()}}remove(r){c(this,U).delete(r),c(this,xe).delete(r),c(this,F).delete(r)}};U=new WeakMap,xe=new WeakMap,F=new WeakMap;var re=new Sr,We,B,ae,I,j,L,vt,G,V,bt,W,xt,yt,Ke,K,fi,vi,Ar,bi,Qt=class extends HTMLElement{constructor(){super(...arguments);u(this,K);h(this,"cache",re);u(this,We);u(this,B,null);u(this,ae,null);u(this,I,null);u(this,j);u(this,L);u(this,vt,gi);u(this,G);u(this,V);u(this,bt,5e3);u(this,W);u(this,xt,!1);u(this,yt,0);u(this,Ke)}static get observedAttributes(){return[si,di,mi,ci,li,hi,pi]}cacheKey(){return`${c(this,j)}${c(this,V)?`-p_${c(this,V)}`:""}${c(this,G)?`-m_${c(this,G)}`:""}`}attributeChangedCallback(e,t,i){e===si&&(m(this,j,i),m(this,L,re.getFetchInfo(this.cacheKey()))),e===hi&&m(this,G,i),e===pi&&m(this,V,i),e===di&&Fn.includes(i)&&m(this,vt,i),e===mi&&m(this,bt,parseInt(i,10)),e===ci&&m(this,xt,["","true"].includes(i)),e===li&&m(this,Ke,i)}connectedCallback(){if(!c(this,W)){if(c(this,I)??m(this,I,ge(this)),m(this,Ke,c(this,I).settings?.preview),c(this,We)??m(this,We,c(this,I).log.module(`${Cr}[${c(this,j)}]`)),!c(this,j)||c(this,j)==="#"){c(this,L)??m(this,L,re.getFetchInfo("missing-fragment-id")),y(this,K,Ar).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,L)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(c(this,W)&&!await Promise.race([c(this,W),Promise.resolve(!1)]))return;e&&re.remove(this.cacheKey()),c(this,vt)===ui&&await Promise.race([re.getAsPromise(this.cacheKey()),new Promise(s=>setTimeout(s,c(this,bt)))]);try{m(this,W,y(this,K,bi).call(this)),await c(this,W)}catch(s){return y(this,K,Ar).call(this,s.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=c(this,B)||{};return o&&!Vt("mas.disableWcsCache")&&c(this,I).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Le,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...c(this,L)},bubbles:!0,composed:!0})),c(this,W)}get updateComplete(){return c(this,W)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,ae)?c(this,ae):(c(this,xt)?this.transformAuthorData():this.transformPublishData(),c(this,ae))}get rawData(){return c(this,B)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,settings:s={},priceLiterals:l={},dictionary:d={},placeholders:p={}}=c(this,B);m(this,ae,e.reduce((g,{name:f,multiple:C,values:N})=>(g.fields[f]=C?N:N[0],g),{fields:{},id:t,tags:n,settings:s,priceLiterals:l,dictionary:d,maskId:i,placeholders:p,variationId:o}))}transformPublishData(){if(!c(this,B))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},maskId:l,placeholders:d={},variationId:p}=c(this,B);m(this,ae,Object.entries(e).reduce((g,[f,C])=>(g.fields[f]=C?.mimeType?C.value:C??"",g),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:s,maskId:l,placeholders:d,variationId:p}))}getFragmentClientUrl(){let t=new URLSearchParams(window.location.search).get("maslibs");if(!t||t.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=t.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:c(this,I).settings.locale,apiKey:c(this,I).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??c(this,I).settings.instant,o={...i,...n!=null?{instant:n}:{},...c(this,G)!=null?{mask:c(this,G)}:{},...c(this,V)!=null?{pzn:c(this,V)}:{}};return await t(c(this,j),o)}};We=new WeakMap,B=new WeakMap,ae=new WeakMap,I=new WeakMap,j=new WeakMap,L=new WeakMap,vt=new WeakMap,G=new WeakMap,V=new WeakMap,bt=new WeakMap,W=new WeakMap,xt=new WeakMap,yt=new WeakMap,Ke=new WeakMap,K=new WeakSet,fi=async function(e){Dr(this,yt)._++;let t=`${Cr}:${this.cacheKey()}:${c(this,yt)}`,i=`${t}${Mt}`,n=`${t}${Rt}`;if(c(this,Ke)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new de(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(c(this,L).stale=!1,c(this,L).url=e,o=await oi(e,{cache:"default",credentials:"omit"}),y(this,K,vi).call(this,o),c(this,L).status=o?.status,c(this,L).measure=_e(performance.measure(n,i)),c(this,L).retryCount=o.retryCount,!o?.ok)throw new de("Unexpected fragment response",{response:o,...c(this,I).duration});return await o.json()}catch(s){if(c(this,L).measure=_e(performance.measure(n,i)),c(this,L).retryCount=s.retryCount,c(this,B))return c(this,L).stale=!0,c(this,We).error("Serving stale data",c(this,L)),c(this,B);let l=s.message??"unknown";throw new de(`Failed to fetch fragment: ${l}`,{})}},vi=function(e){Object.assign(c(this,L),ni(e))},Ar=function(e){m(this,W,null),c(this,L).message=e,this.classList.add("error");let t={...c(this,L),...c(this,I).duration};c(this,We).error(e,t),this.dispatchEvent(new CustomEvent(Pe,{detail:t,bubbles:!0,composed:!0}))},bi=async function(){var l;this.classList.remove("error"),m(this,ae,null);let e=re.get(this.cacheKey());if(e)return m(this,B,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=c(this,I).settings,s=`${t}/fragment?id=${c(this,j)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),c(this,G)&&(s+=`&mask=${c(this,G)}`),c(this,V)&&(s+=`&pzn=${c(this,V)}`),e=await y(this,K,fi).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,j)),c(this,G)||c(this,V)?re.set(this.cacheKey(),e):re.add(e),m(this,B,e),!0},h(Qt,"cache",re);customElements.define(Cr,Qt);import{LitElement as In,html as zr,css as $n,nothing as Bn}from"./lit-all.min.js";import{unsafeHTML as Hn}from"./lit-all.min.js";var qn=a=>a?a.startsWith("sp-icon-")?zr`${Hn(`<${a} class="badge-icon"></${a}>`)}`:zr`<img src="${a}" class="badge-icon" />`:Bn,Ye=class extends In{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return zr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Ye);import{html as Un,css as jn,LitElement as Gn}from"./lit-all.min.js";var wt=class extends Gn{constructor(){super()}render(){return Un`
            <slot name="icon"></slot>

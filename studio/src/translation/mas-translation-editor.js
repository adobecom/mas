                                      ...
                                      <div class="icon">
                                          ...
                                          >
                                              ...
                                              <sp-button
                                                  ...
                                                  size="xl"
                                                  icon-only
                                                  class="ghost-button empty-state-plus"
                                              >
                                                  <sp-icon slot="icon" label="Add Languages">${addPlusIcon}</sp-icon>
                                              </sp-button>
                                          </overlay-trigger>
                                      </div>
                                      <div class="label">
                          ...
                          >
                              <div class="selected-langs-header">
                                  ...
                                  <div>
                                      ...
                                      <sp-button
                                          icon-only
                                          class="toggle-btn ghost-button ${this.isSelectedLangsOpen ? 'is-open' : ''}"
                                      >
                                      ...
                                      <div class="icon">
                                          ...
                                          >
                                              ...
                                              <sp-button
                                                  ...
                                                  class="ghost-button empty-state-plus"
                                              >
                                                  <sp-icon slot="icon" label="Add Items">${addPlusIcon}</sp-icon>
                                              </sp-button>
                                          </overlay-trigger>
                                      </div>
                                      <div class="label">
                        ...
                        : html`<div class="form-field selected-items" @click=${this.#toggleSelectedItemsOpen}>
                              <div class="selected-items-header">
                                  ...
                                  <div>
                                      ...
                                      <sp-button
                                          icon-only
                                          class="toggle-btn ghost-button ${this.isSelectedItemsOpen ? 'is-open' : ''}"
                                      >

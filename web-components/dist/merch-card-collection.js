var ya=Object.defineProperty;var wa=e=>{throw TypeError(e)};var Es=(e,r,t)=>r in e?ya(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Ss=(e,r)=>{for(var t in r)ya(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Es(e,typeof r!="symbol"?r+"":r,t),$r=(e,r,t)=>r.has(e)||wa("Cannot "+t);var v=(e,r,t)=>($r(e,r,"read from private field"),t?t.call(e):r.get(e)),z=(e,r,t)=>r.has(e)?wa("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),_=(e,r,t,i)=>($r(e,r,"write to private field"),i?i.call(e,t):r.set(e,t),t),Y=(e,r,t)=>($r(e,r,"access private method"),t);import{html as Le,LitElement as hs,css as ps,unsafeCSS as ds,nothing as fe}from"./lit-all.min.js";var O="(max-width: 767px)",Z="(max-width: 1199px)",I="(min-width: 768px)",C="(min-width: 1200px)",J="(min-width: 1600px)",Ea="(min-width: 1280px)",Sa={matchMobile:window.matchMedia(O),matchDesktop:window.matchMedia(`${C} and (not ${J})`),matchDesktopOrUp:window.matchMedia(C),matchLargeDesktop:window.matchMedia(J),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},k=Sa;function ar(){return Sa.isDesktop}var At=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var Aa="hashchange";function As(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let i of t){let[a,n=""]=i.split("=");a&&r.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function Ct(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([a,n])=>{n?r.set(a,n):r.delete(a)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,i)}function Ca(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=As(window.location.hash);e(t)};return r(),window.addEventListener(Aa,r),()=>{window.removeEventListener(Aa,r)}}var ui={};Ss(ui,{CLASS_NAME_FAILED:()=>Qr,CLASS_NAME_HIDDEN:()=>Ts,CLASS_NAME_PENDING:()=>Jr,CLASS_NAME_RESOLVED:()=>ei,CheckoutWorkflow:()=>Us,CheckoutWorkflowStep:()=>ie,Commitment:()=>Ue,ERROR_MESSAGE_BAD_REQUEST:()=>ti,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Hs,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>ri,EVENT_AEM_ERROR:()=>Kr,EVENT_AEM_LOAD:()=>Xr,EVENT_MAS_ERROR:()=>Zr,EVENT_MAS_READY:()=>Ds,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>Ns,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Vr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>me,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Wr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Tt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>jr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Os,EVENT_MERCH_OFFER_READY:()=>Ps,EVENT_MERCH_OFFER_SELECT_READY:()=>Ls,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>he,EVENT_MERCH_SEARCH_CHANGE:()=>Is,EVENT_MERCH_SIDENAV_SELECT:()=>Yr,EVENT_MERCH_STOCK_CHANGE:()=>Rs,EVENT_MERCH_STORAGE_CHANGE:()=>zs,EVENT_OFFER_SELECTED:()=>Ms,EVENT_TYPE_FAILED:()=>ii,EVENT_TYPE_READY:()=>nr,EVENT_TYPE_RESOLVED:()=>Me,Env:()=>ve,FF_ANNUAL_PRICE:()=>it,FF_DEFAULTS:()=>Ae,HEADER_X_REQUEST_ID:()=>_t,LOG_NAMESPACE:()=>ai,Landscape:()=>ze,MARK_DURATION_SUFFIX:()=>pi,MARK_START_SUFFIX:()=>hi,MERCH_CARD_LOAD_TIMEOUT:()=>Gr,MODAL_TYPE_3_IN_1:()=>$e,NAMESPACE:()=>Cs,PARAM_AOS_API_KEY:()=>Bs,PARAM_ENV:()=>oi,PARAM_LANDSCAPE:()=>si,PARAM_MAS_PREVIEW:()=>ni,PARAM_WCS_API_KEY:()=>Fs,PROVIDER_ENVIRONMENT:()=>di,SELECTOR_MAS_CHECKOUT_LINK:()=>Ta,SELECTOR_MAS_ELEMENT:()=>qr,SELECTOR_MAS_INLINE_PRICE:()=>V,SELECTOR_MAS_SP_BUTTON:()=>ks,SELECTOR_MAS_UPT_LINK:()=>_a,SORT_ORDER:()=>ge,STATE_FAILED:()=>ue,STATE_PENDING:()=>Re,STATE_RESOLVED:()=>Se,SUPPORTED_COUNTRIES:()=>mi,TAG_NAME_SERVICE:()=>_s,TEMPLATE_PRICE:()=>$s,TEMPLATE_PRICE_ANNUAL:()=>qs,TEMPLATE_PRICE_LEGAL:()=>ee,TEMPLATE_PRICE_STRIKETHROUGH:()=>Gs,Term:()=>de,WCS_PROD_URL:()=>ci,WCS_STAGE_URL:()=>li});var Ue=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),de=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Cs="merch",Gr=2e4,Ts="hidden",nr="wcms:commerce:ready",_s="mas-commerce-service",V='span[is="inline-price"][data-wcs-osi]',Ta='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',ks="sp-button[data-wcs-osi]",_a='a[is="upt-link"]',qr=`${V},${Ta},${_a}`,Ps="merch-offer:ready",Ls="merch-offer-select:ready",Vr="merch-card:action-menu-toggle",Ms="merch-offer:selected",Rs="merch-stock:change",zs="merch-storage:change",he="merch-quantity-selector:change",Os="merch-card-quantity:change",Ns="merch-modal:addon-and-quantity-update",Is="merch-search:change",jr="merch-card-collection:sort",me="merch-card-collection:literals-changed",Tt="merch-card-collection:sidenav-attached",Wr="merch-card-collection:showmore",Yr="merch-sidenav:select",Xr="aem:load",Kr="aem:error",Ds="mas:ready",Zr="mas:error",Qr="placeholder-failed",Jr="placeholder-pending",ei="placeholder-resolved",ti="Bad WCS request",ri="Commerce offer not found",Hs="Literals URL not provided",ii="mas:failed",Me="mas:resolved",ai="mas/commerce",ni="mas.preview",oi="commerce.env",si="commerce.landscape",Bs="commerce.aosKey",Fs="commerce.wcsKey",ci="https://www.adobe.com/web_commerce_artifact",li="https://www.stage.adobe.com/web_commerce_artifact_stage",ue="failed",Re="pending",Se="resolved",ze={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},_t="X-Request-Id",ie=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Us="UCv3",ve=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),di={PRODUCTION:"PRODUCTION"},$e={TWP:"twp",D2P:"d2p",CRM:"crm"},hi=":start",pi=":duration",$s="price",Gs="price-strikethrough",qs="annual",ee="legal",Ae="mas-ff-defaults",it="mas-ff-annual-price",ge={alphabetical:"alphabetical",authored:"authored"},mi=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Vs="mas-commerce-service";var kt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function xe(e,r={},t=null,i=null){let a=i?document.createElement(e,{is:i}):document.createElement(e);t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t;for(let[n,o]of Object.entries(r))a.setAttribute(n,o);return a}function or(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function gi(){return window.matchMedia("(max-width: 1024px)").matches}function Pt(){return document.getElementsByTagName(Vs)?.[0]}function Lt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}import{html as sr,nothing as js}from"./lit-all.min.js";var at,Mt=class Mt{constructor(r){g(this,"card");z(this,at);this.card=r,this.insertVariantStyle()}getContainer(){return _(this,at,v(this,at)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,at)}insertVariantStyle(){let r=this.constructor.name;if(!Mt.styleMap[r]){Mt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let i=this.card.variant,a=Array.from(t.querySelectorAll(`merch-card[variant="${i}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${i}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of a){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${i}-${s}-height`,d=o.map(m=>m.style.getPropertyValue(l)),p=0;for(let m of o){m.style.removeProperty(l);let h=c(m);if(!h)continue;let u=Math.max(0,parseInt(window.getComputedStyle(h).height)||0);u>p&&(p=u)}o.forEach((m,h)=>{p>0?m.style.setProperty(l,`${p}px`):d[h]&&m.style.setProperty(l,d[h])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),sr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return ka}setAriaExpanded(t,i){t.setAttribute("aria-expanded",i)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};g(nt,"variantStyle",Ws`
    ...
    `);import{html as Rt,css as Ys}from"./lit-all.min.js";var La=`
:root {
...
`;var Ma={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},Ge=class extends T{constructor(r){super(r)}getGlobalCSS(){return La}renderLayout(){return Rt`<div class="image">
    ...
    `);import{html as za}from"./lit-all.min.js";var Ra=`
:root {
...
`;var lr=class extends T{constructor(r){super(r)}getGlobalCSS(){return Ra}renderLayout(){return za` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":za`<hr />`} ${this.secureLabelFooter}`}};import{html as Oe,css as Xs,unsafeCSS as Na}from"./lit-all.min.js";var Oa=`
  :root {
...
`;var Ks=32,Ia={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},ot=class extends T{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Oe`<slot name="secure-transaction-label">
    ...
    `);import{html as dr,css as Zs,unsafeCSS as Ha,nothing as Qs}from"./lit-all.min.js";var Da=`
  :root {
...
`;var Js=32,Ba={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},st=class extends T{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>dr` <footer>
    ...
    `);import{html as zt,css as ec,nothing as hr}from"./lit-all.min.js";var Fa=`
:root {
...
`;var pr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ua={...function(){let{whatsIncluded:e,size:r,...t}=pr;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},$a={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:i,...a}=pr;return a}()},be,ye,ae=class extends T{constructor(t){super(t);z(this,be);z(this,ye);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Fa}adjustSlotPlacement(t,i,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!i.includes(s)){if(o?.classList.toggle("wide-footer",k.isDesktopOrUp),!a&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(a&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);o.prepend(m)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],k.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],k.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,be)||(_(this,be,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,be)?.disconnect(),_(this,be,null),this.syncHeights())})),v(this,be).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(i=>({name:i,getElement:a=>a.querySelector(`[slot="${i}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),i.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Lt(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=Lt(p));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+Lt(m));for(let u of i.childNodes){if(u.classList.contains("spacer"))break;l+=Lt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${V}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?zt`<div class="divider"></div>`:hr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],i=this.card.querySelector(`[slot="heading-m"] ${V}[data-template="price"]`);i&&t.push(i);let a=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled?.();let a=i.value?.[0]?.planType;a&&(t.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?zt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};be=new WeakMap,ye=new WeakMap,g(ae,"variantStyle",ec`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(k.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?k.isMobile?Ce`
        ...
        `:Ce`
            ...
            <slot></slot>`}};g(Ne,"variantStyle",tc`
...
`;var[qh,Vh,Wa,Ya,Xa,Ka]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Za={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},Te,we,qe,W,Qa,Nt,Ja,It,vi,ur,gr=class gr extends T{constructor(){super(...arguments);z(this,W);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);z(this,Te,null);z(this,we,null);z(this,qe,null);g(this,"handleResize",()=>{v(this,we)&&cancelAnimationFrame(v(this,we)),_(this,we,requestAnimationFrame(()=>{_(this,we,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))});g(this,"toggleExpanded",t=>{t.preventDefault();let i=!this.expanded;for(let a of Y(this,W,Qa).call(this)){let n=a.variantLayout;n instanceof gr&&(n.expanded=i,a.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?Y(this,W,vi).call(this):Y(this,W,It).call(this),this.card.requestUpdate()});z(this,ur,t=>{let i=this.licenseOptions;if(!i?.length)return;let a=i.length-1;switch(t.key){case Ya:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%i.length:Y(this,W,It).call(this);break;case Wa:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+i.length)%i.length:Y(this,W,It).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=a;break;case Xa:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(i[this.licenseHighlightedIndex]);return}Y(this,W,It).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),Y(this,W,vi).call(this);break;case Ka:this.licenseOpen&&this.selectLicenseQty(i[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,Y(this,W,Nt).call(this);let i=this.quantitySelectEl;i&&(i.selectedValue=Number(t),i.dispatchEvent(new CustomEvent(he,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return ja}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let i=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),i.dataset.displayPerUnit="false",t.parentNode.insertBefore(i,t.nextSibling),await i.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),i.addEventListener(Me,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let a=this.card.querySelector('[slot="heading-m"] [data-template="legal"]')?.querySelector(".price-plan-type");a&&(a.textContent=t)}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${V}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled?.();let a=i.value?.[0]?.planType;a&&(t.planType=a)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights())}syncHeights(){this.card.getBoundingClientRect().width<=2||this.syncRowHeights([{name:"top-card",getElement:t=>t.shadowRoot?.querySelector(".top-card")}])}connectedCallbackHook(){window.addEventListener("resize",this.handleResize),_(this,qe,new IntersectionObserver(([t])=>{t.boundingClientRect.height!==0&&t.isIntersecting&&(window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights()),v(this,qe)?.disconnect())})),v(this,qe).observe(this.card)}disconnectedCallbackHook(){Y(this,W,Nt).call(this),window.removeEventListener("resize",this.handleResize),v(this,we)&&(cancelAnimationFrame(v(this,we)),_(this,we,null)),v(this,qe)?.disconnect()}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let i=parseInt(t.getAttribute("min"),10),a=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(i)||Number.isNaN(a)||a<i)return null;let o=[];for(let s=i;s<=a;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(t){let i=this.quantitySelectEl?.getAttribute("title")||"License",[a,n]=i.split("|").map(o=>o.trim());return Number(t)===1?a:n||a}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let i=this.quantitySelectEl?.getAttribute("default-value");return i!=null&&t.includes(i)?i:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Ie`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,i=this.currentLicenseValue,a=!!this.licenseOpen,n=this.licenseLabel(Number(i));return Ie`
        ...
        `}renderLayout(){let t=!!this.expanded;return Ie`
            ...
            ${this.hasWhatsIncluded?Ie`
                  ...
                  `:Ot}
            <slot></slot>
        `}};Te=new WeakMap,we=new WeakMap,qe=new WeakMap,W=new WeakSet,Qa=function(){let t=Math.round(this.card.getBoundingClientRect().top),i=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(a=>{let n=a.getBoundingClientRect();return n.width>2&&Math.round(n.top)===t});return i.length?i:[this.card]},Nt=function(){v(this,Te)&&(document.removeEventListener("mousedown",v(this,Te)),_(this,Te,null))},Ja=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},It=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=Y(this,W,Ja).call(this),v(this,Te)||(_(this,Te,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),Y(this,W,Nt).call(this))}),document.addEventListener("mousedown",v(this,Te)))},vi=function(){this.licenseOpen=!1,Y(this,W,Nt).call(this)},ur=new WeakMap,g(gr,"variantStyle",rc`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Dt=gr;import{html as xi,css as ic}from"./lit-all.min.js";var en=`
:root {
...
`;var tn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ee,ct=class extends T{constructor(t){super(t);z(this,Ee);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return en}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return xi` ${this.badge}
    ...
    `);import{html as bi,css as ac}from"./lit-all.min.js";var rn=`
:root {
...
`;var an={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},lt=class extends T{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===ee&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return rn}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${V}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return bi`
    ...
    `);import{html as nc,css as oc}from"./lit-all.min.js";var nn=`
...
`;var on={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},dt=class extends T{constructor(r){super(r)}getGlobalCSS(){return nn}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return nc`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as yi,css as sc}from"./lit-all.min.js";var sn=`
:root {
...
`;var cn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},ht=class extends T{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return sn}renderLayout(){return yi`${this.cardImage}
    ...
    `);import{html as cc,css as lc}from"./lit-all.min.js";var ln=`
:root {
...
`;var wi={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},pt=class extends T{getGlobalCSS(){return ln}get aemFragmentMapping(){return wi}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(a=>this.updateCardElementMinHeight(r.querySelector(`.${a}`),a));let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let i=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');i&&this.updateCardElementMinHeight(i,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),i=34;t.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>i;o.classList.toggle("small-font-size-button",s)})}),k.isDesktopOrUp&&t.forEach(a=>a.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!ar()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(t=>t.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let t=()=>{if(ar())r.removeAttribute("data-expanded");else{let a=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",a?"true":"false")}};t();let i=window.matchMedia(O);this.mediaQueryListener=()=>{t()},i.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(O).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||ar())return;let a=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",a)}renderLayout(){return cc`
    ...
    `);import{html as hn,css as dc}from"./lit-all.min.js";var dn=`
:root {
...
`;var Ei={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Ht=class Ht extends T{getGlobalCSS(){return dn}get aemFragmentMapping(){return Ei}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return hn`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let t=window.getComputedStyle(r),i=`${t.fontWeight} ${t.fontSize} ${t.fontFamily}`;await document.fonts.load(i,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let r=Ht.SYNCED_SECTIONS.map(s=>({name:s,getElement:c=>c.shadowRoot?.querySelector(`.${s}`)})),t=this.getContainer(),i=t?t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],a='[slot="body-s"] > *',n=Math.max(0,...Array.from(i,s=>s.querySelectorAll(a).length)),o=Array.from({length:n},(s,c)=>({name:`description-row-${c}`,getElement:l=>l.querySelectorAll(a)[c]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),i=49;t.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>i;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let t=this.card.querySelector(this.headingSelector),i=t?Math.round(t.getBoundingClientRect().height):0,a=`${Math.round(r)}:${i}`;a!==this.lastSyncedKey&&(this.lastSyncedKey=a,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return hn`
            ...
            <slot></slot>
        `}};g(Ht,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(Ht,"variantStyle",dc`
    ...
    `);var Bt=Ht;import{html as Si,css as hc,nothing as pc}from"./lit-all.min.js";var pn=`
...
`;var mn={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},mc=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],mt=class extends T{constructor(r){super(r)}getGlobalCSS(){return pn}renderLayout(){return Si`
    ...
    `);import{css as uc,html as gc}from"./lit-all.min.js";var un=`
...
`;var gn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},ut=class extends T{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return un}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${V}[data-template="price"]`);if(!t)return;let i=t.cloneNode(!0);this.legal=i,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return gc`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as fc,css as vc}from"./lit-all.min.js";var fn=`
...
`;var Ai={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},gt=class extends T{getGlobalCSS(){return fn}get aemFragmentMapping(){return Ai}renderLayout(){return fc`
    ...
    `);var vn=new Map;var j=(e,r,t=null,i=null,a)=>{vn.set(e,{class:r,fragmentMapping:t,style:i,collectionOptions:a})};j("catalog",nt,Pa,nt.variantStyle);j("image",Ge);j("inline-heading",lr);j("mini-compare-chart",ot,Ia,ot.variantStyle);j("mini-compare-chart-mweb",st,Ba,st.variantStyle);j("plans",ae,pr,ae.variantStyle,ae.collectionOptions);j("plans-students",ae,$a,ae.variantStyle,ae.collectionOptions);j("plans-education",ae,Ua,ae.variantStyle,ae.collectionOptions);j("plans-v2",Ne,Va,Ne.variantStyle,Ne.collectionOptions);j("bizpro",Dt,Za,Dt.variantStyle);j("product",ct,tn,ct.variantStyle);j("segment",lt,an,lt.variantStyle);j("media",dt,on,dt.variantStyle);j("headless",mt,mn,mt.variantStyle);j("special-offers",ht,cn,ht.variantStyle);j("simplified-pricing-express",pt,wi,pt.variantStyle);j("full-pricing-express",Bt,Ei,Bt.variantStyle);j("mini",ut,gn,ut.variantStyle);j("image",Ge,Ma,Ge.variantStyle);j("fries",gt,Ai,gt.variantStyle);function cr(e){return vn.get(e)?.fragmentMapping}var xn="tacocat.js";var Ci=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),bn=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function H(e,r={},{metadata:t=!0,search:i=!0,storage:a=!0}={}){let n;if(i&&n==null){let o=new URLSearchParams(window.location.search),s=ft(i)?i:e;n=o.get(s)}if(a&&n==null){let o=ft(a)?a:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=bc(ft(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var xc=e=>typeof e=="boolean",fr=e=>typeof e=="function",vr=e=>typeof e=="number",yn=e=>e!=null&&typeof e=="object";var ft=e=>typeof e=="string",wn=e=>ft(e)&&e,Ft=e=>vr(e)&&Number.isFinite(e)&&e>0;function xr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,i])=>{r(i)&&delete e[t]}),e}function w(e,r){if(xc(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Ut(e,r,t){let i=Object.values(r);return i.find(a=>Ci(a,e))??t??i[0]}function bc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,i)=>`${t}-${i}`).replace(/\W+/gu,"-").toLowerCase()}function En(e,r=1){return vr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var yc=Date.now(),Ti=()=>`(+${Date.now()-yc}ms)`,br=new Set,wc=w(H("tacocat.debug",{},{metadata:!1}),!1);function Sn(e){let r=`[${xn}/${e}]`,t=(o,s,...c)=>o?!0:(a(s,...c),!1),i=wc?(o,...s)=>{console.debug(`${r} ${o}`,...s,Ti())}:()=>{},a=(o,...s)=>{let c=`${r} ${o}`;br.forEach(([l])=>l(c,...s))};return{assert:t,debug:i,error:a,warn:(o,...s)=>{let c=`${r} ${o}`;br.forEach(([,l])=>l(c,...s))}}}function Ec(e,r){let t=[e,r];return br.add(t),()=>{br.delete(t)}}Ec((e,...r)=>{console.error(e,...r,Ti())},(e,...r)=>{console.warn(e,...r,Ti())});var Sc="no promo",An="promo-tag",Ac="yellow",Cc="neutral",Tc=(e,r,t)=>{let i=n=>n||Sc,a=t?` (was "${i(r)}")`:"";return`${i(e)}${a}`},_c="cancel-context",yr=(e,r)=>{let t=e===_c,i=!t&&e?.length>0,a=(i||t)&&(r&&r!=e||!r&&!t),n=a&&i||!a&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?An:`${An} no-promo`,text:Tc(o,r,a),variant:n?Ac:Cc,isOverriden:a}};var _i;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(_i||(_i={}));var ce;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(ce||(ce={}));var pe;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(pe||(pe={}));var ki;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(ki||(ki={}));var Pi;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(Pi||(Pi={}));var Li;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(Li||(Li={}));var Mi;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Mi||(Mi={}));var Ri="ABM",zi="PUF",Oi="M2M",Ni="PERPETUAL",Ii="P3Y",kc="TAX_INCLUSIVE_DETAILS",Pc="TAX_EXCLUSIVE",Cn={ABM:Ri,PUF:zi,M2M:Oi,PERPETUAL:Ni,P3Y:Ii},Dm={[Ri]:{commitment:ce.YEAR,term:pe.MONTHLY},[zi]:{commitment:ce.YEAR,term:pe.ANNUAL},[Oi]:{commitment:ce.MONTH,term:pe.MONTHLY},[Ni]:{commitment:ce.PERPETUAL,term:void 0},[Ii]:{commitment:ce.THREE_MONTHS,term:pe.P3Y}},Tn="Value is not an offer",wr=e=>{if(typeof e!="object")return Tn;let{commitment:r,term:t}=e,i=Lc(r,t);return{...e,planType:i}};var Lc=(e,r)=>{switch(e){case void 0:return Tn;case"":return"";case ce.YEAR:return r===pe.MONTHLY?Ri:r===pe.ANNUAL?zi:"";case ce.MONTH:return r===pe.MONTHLY?Oi:"";case ce.PERPETUAL:return Ni;case ce.TERM_LICENSE:return r===pe.P3Y?Ii:"";default:return""}};function _n(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:i,priceWithoutTax:a,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==kc)return e;let s={...e,priceDetails:{...r,price:a??t,priceWithoutDiscount:n??i,taxDisplay:Pc}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Ve={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},kn=1e3;function Mc(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Pn(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:i,originatingRequest:a,status:n}=e;return[i,n,a].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ve.serializableTypes.includes(t))return t}return e}function Rc(e,r){if(!Ve.ignoredProperties.includes(e))return Pn(r)}var Di={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,i=[],a=[],n=r;t.forEach(l=>{l!=null&&(Mc(l)?i:a).push(l)}),i.length&&(n+=` ${i.map(Pn).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${Ve.delimiter}page=${o}${s}`;c.length>kn&&(c=`${c.slice(0,kn)}<trunc>`),n+=c,a.length&&(n+=`${Ve.delimiter}facts=`,n+=JSON.stringify(a,Rc)),window.lana?.log(n,Ve)}};function Er(e){Object.assign(Ve,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in Ve&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Ln={LOCAL:"local",PROD:"prod",STAGE:"stage"},Hi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Bi=new Set,Fi=new Set,Mn=new Map,Rn={append({level:e,message:r,params:t,timestamp:i,source:a}){console[e](`${i}ms [${a}] %c${r}`,"font-weight: bold;",...t)}},zn={filter:({level:e})=>e!==Hi.DEBUG},zc={filter:()=>!1};function Oc(e,r,t,i,a){return{level:e,message:r,namespace:t,get params(){return i.length===1&&fr(i[0])&&(i=i[0](),Array.isArray(i)||(i=[i])),i},source:a,timestamp:performance.now().toFixed(3)}}function Nc(e){[...Fi].every(r=>r(e))&&Bi.forEach(r=>r(e))}function On(e){let r=(Mn.get(e)??0)+1;Mn.set(e,r);let t=`${e} #${r}`,i={id:t,namespace:e,module:a=>On(`${i.namespace}/${a}`),updateConfig:Er};return Object.values(Hi).forEach(a=>{i[a]=(n,...o)=>Nc(Oc(a,n,e,o,t))}),Object.seal(i)}function Sr(...e){e.forEach(r=>{let{append:t,filter:i}=r;fr(i)&&Fi.add(i),fr(t)&&Bi.add(t)})}function Ic(e={}){let{name:r}=e,t=w(H("commerce.debug",{search:!0,storage:!0}),r===Ln.LOCAL);return Sr(t?Rn:zn),r===Ln.PROD&&Sr(Di),ne}function Dc(){Bi.clear(),Fi.clear()}var ne={...On(ai),Level:Hi,Plugins:{consoleAppender:Rn,debugFilter:zn,quietFilter:zc,lanaAppender:Di},init:Ic,reset:Dc,use:Sr};var Hc="mas-commerce-service",Bc=ne.module("utilities"),Fc={requestId:_t,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function $t(e,{country:r,forceTaxExclusive:t}){let i;if(e.length<2)i=e;else{let a=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===a?-1:o.language===a?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),i=[e[0]]}return t&&(i=i.map(_n)),i}var Nn=(e,r)=>{let t=e.reduce((i,a)=>i+(r(a)||0),0);return t>0?Math.round(t*100)/100:void 0};function Ui(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let p=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?s.priceDetails?.formatString:s[l];m!==p&&Bc.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:p,actual:m})}}let i=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],a={};for(let[s,c]of i){let l=Nn(e,c);l!==void 0&&(a[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=Nn(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...a,...o&&{annualized:o}}}}var Ar=e=>window.setTimeout(e);function vt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(En).filter(Ft);return t.length||(t=[r]),t}function Cr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(wn)}function oe(){return document.getElementsByTagName(Hc)?.[0]}function In(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[i,a]of Object.entries(Fc)){let n=t.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[i]=n)}return r}var xt=class e extends Error{constructor(r,t,i){if(super(r,{cause:i}),this.name="MasError",t.response){let a=t.response.headers?.get(_t);a&&(t.requestId=a),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([i,a])=>`${i}: ${JSON.stringify(a)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var Uc={[ue]:Qr,[Re]:Jr,[Se]:ei},$c={[ue]:ii,[Se]:Me},Gt,De=class{constructor(r){z(this,Gt);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",Re);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=ne.module("mas-element")}update(){[ue,Re,Se].forEach(r=>{this.wrapperElement.classList.toggle(Uc[r],r===this.state)})}notify(){(this.state===Se||this.state===ue)&&(this.state===Se?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ue&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof xt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent($c[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,i){this.changes.set(r,i),this.requestUpdate()}connectedCallback(){_(this,Gt,oe()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:i}=this;return Se===i?Promise.resolve(this.wrapperElement):ue===i?Promise.reject(r):new Promise((a,n)=>{t.push({resolve:a,reject:n})})}toggleResolved(r,t,i){return r!==this.version?!1:(i!==void 0&&(this.options=i),this.state=Se,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Ar(()=>this.notify()),!0)}toggleFailed(r,t,i){if(r!==this.version)return!1;i!==void 0&&(this.options=i),this.error=t,this.state=ue,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,Gt)?.duration}),Ar(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=Re,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!oe()||this.timer)return;let{error:t,options:i,state:a,value:n,version:o}=this;this.state=Re,this.timer=Ar(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===Re&&this.version===o&&(this.state=a,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,i)}})}};Gt=new WeakMap;function Dn(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function Tr(e,r={}){let{tag:t,is:i}=e,a=document.createElement(t,{is:i});return a.setAttribute("is",i),Object.assign(a.dataset,Dn(r)),a}function Hn(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Dn(r)),e):null}function Gc(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Ye,je=class je extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new De(this));z(this,Ye);this.setAttribute("is",je.is)}get isUptLink(){return!0}initializeWcsData(t,i){this.setAttribute("data-wcs-osi",t),i&&this.setAttribute("data-promotion-code",i)}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),_(this,Ye,Pt()),v(this,Ye)&&(this.log=v(this,Ye).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),_(this,Ye,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Pt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let i=t.collectCheckoutOptions({},this);if(!i.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(i),n=t.resolveOfferSelectors(i);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=i,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,p=this.getAttribute("data-promotion-code");p&&(d+=`&promotion_code=${encodeURIComponent(p)}`),this.href=`${Gc(l)}?${d}`,this.masElement.toggleResolved(a,o,i)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${i.wcsOsi}.`,o.message);return this.masElement.toggleFailed(a,s,i),!1}}static createFrom(t){let i=new je;for(let a of t.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?i.setAttribute("class",a.value.replace("upt-link","").trim()):i.setAttribute(a.name,a.value));return i.innerHTML=t.innerHTML,i.setAttribute("tabindex",0),i}};Ye=new WeakMap,g(je,"is","upt-link"),g(je,"tag","a"),g(je,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var We=je;window.customElements.get(We.is)||window.customElements.define(We.is,We,{extends:We.tag});function Bn(e){return e&&(e==="bizpro"||e.startsWith("plans")?"plans":e)}var qc="p_draft_landscape",Vc="/store/",jc=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),$i=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Wc=["env","workflowStep","clientId","country"],Yc=["/tw/","/hk_zh/"];function Xc(e){let r=e??"";return Yc.some(t=>r.startsWith(t))}function Kc(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(Xc)}function Gi(e){if(!Kc())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var Fn=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),Un=e=>jc.get(e)??e;function _r(e,r,t){for(let[i,a]of Object.entries(e)){let n=Un(i);a!=null&&t.has(n)&&r.set(n,a)}}function Zc(e){switch(e){case di.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function Qc(e,r){for(let t in e){let i=e[t];for(let[a,n]of Object.entries(i)){if(n==null)continue;let o=Un(a);r.set(`items[${t}][${o}]`,n)}}}function Jc({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let i=e.searchParams.get("af");return e.searchParams.set("af",[i,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===$e.CRM?"creative":"mini_plans"),e}function el(e){let r=new URLSearchParams(window.location.search),t={};Fn.forEach(i=>{let a=r.get(i);a!==null&&(t[i]=a)}),Object.keys(t).length>0&&_r(t,e.searchParams,Fn)}function $n(e){tl(e);let{env:r,items:t,workflowStep:i,marketSegment:a,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:p,...m}=e,h=new URL(Zc(r));if(h.pathname=`${Vc}${i}`,i!==ie.SEGMENTATION&&i!==ie.CHANGE_PLAN_TEAM_PLANS&&Qc(t,h.searchParams),_r({...m},h.searchParams,$i),el(h),c===ze.DRAFT&&_r({af:qc},h.searchParams,$i),i===ie.SEGMENTATION){let u={marketSegment:a,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};p?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):p?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),_r(u,h.searchParams,$i),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=Jc({url:h,modal:l,is3in1:d})}return Gi(h)}function tl(e){for(let r of Wc)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==ie.SEGMENTATION&&e.workflowStep!==ie.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var rl=/[0-9\-+#]/,il=/[^\d\-+#]/g;function Gn(e){return e.search(rl)}function al(e="#.##"){let r={},t=e.length,i=Gn(e);r.prefix=i>0?e.substring(0,i):"";let a=Gn(e.split("").reverse().join("")),n=t-a,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=a>0?e.substring(s,t):"",r.mask=e.substring(i,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(il);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function nl(e,r,t){let i=!1,a={value:e};e<0&&(i=!0,a.value=-a.value),a.sign=i?"-":"",a.value=Number(a.value).toFixed(r.fraction&&r.fraction.length),a.value=Number(a.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=a.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),a.integer=o,a.fraction=s,ol(a,r),(a.result==="0"||a.result==="")&&(i=!1,a.sign=""),!i&&r.maskHasPositiveSign?a.sign="+":i&&r.maskHasPositiveSign?a.sign="-":i&&(a.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),a}function ol(e,r){e.result="";let t=r.integer.split(r.separator),i=t.join(""),a=i&&i.indexOf("0");if(a>-1)for(;e.integer.length<i.length-a;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function sl(e,r,t={}){if(!e||isNaN(Number(r)))return r;let i=al(e),a=nl(r,i,t);return i.prefix+a.sign+a.result+i.suffix}var qn=sl;var Vn=".",cl=",",Wn=/^\s+/,Yn=/\s+$/,jn="&nbsp;",qi=e=>e*12,Ke=(e,r,t=1)=>{if(!e)return!1;let{start:i,end:a,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!i||!a)return!1;let d=new Date(i),p=new Date(a);return l>=d&&l<=p},Xe={MONTH:"MONTH",YEAR:"YEAR"},ll={[de.ANNUAL]:12,[de.MONTHLY]:1,[de.THREE_YEARS]:36,[de.TWO_YEARS]:24},Vi=(e,r)=>({accept:e,round:r}),dl=[Vi(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),Vi(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),Vi(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],ji={[Ue.YEAR]:{[de.MONTHLY]:Xe.MONTH,[de.ANNUAL]:Xe.YEAR},[Ue.MONTH]:{[de.MONTHLY]:Xe.MONTH}},hl=(e,r)=>e.indexOf(`'${r}'`)===0,pl=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),i=Kn(t);return!!i?r||(t=t.replace(/[,\.]0+/,i)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${ul(e)}`),t},ml=e=>{let r=gl(e),t=hl(e,r),i=e.replace(/'.*?'/,""),a=Wn.test(i)||Yn.test(i);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:a}},Xn=e=>e.replace(Wn,jn).replace(Yn,jn),ul=e=>e.match(/#(.?)#/)?.[1]===Vn?cl:Vn,gl=e=>e.match(/'(.*?)'/)?.[1]??"",Kn=e=>e.match(/0(.?)0/)?.[1]??"";function bt({formatString:e,price:r,usePrecision:t,isIndianPrice:i=!1},a,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=ml(e),l=t?Kn(e):"",d=pl(e,t),p=t?2:0,m=n(r,{currencySymbol:o}),h=i?m.toLocaleString("hi-IN",{minimumFractionDigits:p,maximumFractionDigits:p}):qn(d,m),u=t?h.lastIndexOf(l):h.length,f=h.substring(0,u),x=h.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:a}}var Zn=e=>{let{commitment:r,term:t,usePrecision:i}=e,a=ll[t]??1;return bt(e,a>1?Xe.MONTH:ji[r]?.[t],n=>{let o={divisor:a,price:n,usePrecision:i},{round:s}=dl.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},Qn=({commitment:e,term:r,...t})=>bt(t,ji[e]?.[r]),Jn=e=>{let{commitment:r,instant:t,price:i,originalPrice:a,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===Ue.YEAR&&c===de.MONTHLY){if(!o)return bt(e,Xe.YEAR,qi);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(Ke(o,t,s)){let p=parseInt(d.replace("P","").replace("M",""));if(isNaN(p))return qi(i);let m=a*p,h=n*(12-p),u=Math.round((m+h)*100)/100;return bt({...e,price:u},Xe.YEAR)}default:return bt(e,Xe.YEAR,()=>qi(n??i))}}return bt(e,ji[r]?.[c])};var eo="download",to="upgrade",ro={e:"EDU",t:"TEAM"};function io(e,r={},t=""){let i=oe();if(!i)return null;let{checkoutMarketSegment:a,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f}=i.collectCheckoutOptions(r),x=Tr(e,{checkoutMarketSegment:a,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function ao(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new De(this))}attributeChangedCallback(i,a,n){this.masElement.attributeChangedCallback(i,a,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let i=this.options?.ms??this.value?.[0].marketSegments?.[0];return ro[i]??i}get customerSegment(){let i=this.options?.cs??this.value?.[0]?.customerSegment;return ro[i]??i}get is3in1Modal(){return Object.values($e).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let i=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!i||i.content!=="off")}requestUpdate(i=!1){return this.masElement.requestUpdate(i)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(i={}){let a=oe();if(!a)return!1;this.dataset.imsCountry||a.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),i.imsCountry=null;let n=a.collectCheckoutOptions(i,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=a.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>$t(h,n));let d=l.flat().find(h=>h.promotion);!Ke(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let m=await a.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},m,s)}renderOffers(i,a,n={},o=void 0,s=void 0){let c=oe();if(!c)return!1;if(a={...JSON.parse(this.dataset.extraOptions??"{}"),...a,...n},s??(s=this.masElement.togglePending(a)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(eo,to),this.masElement.toggleResolved(s,i,a);let{url:d,text:p,className:m,handler:h}=o;d&&this.setCheckoutUrl(Gi(d)),p&&(this.firstElementChild.innerHTML=p),m&&this.classList.add(...m.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(i.length){if(this.masElement.toggleResolved(s,i,a)){if(!this.classList.contains(eo)&&!this.classList.contains(to)){let d=c.buildCheckoutURL(i,a);this.setCheckoutUrl(a.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,a))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(i){}updateOptions(i={}){let a=oe();if(!a)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}=a.collectCheckoutOptions(i);return Hn(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}),!0}}}var qt=class qt extends ao(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return io(qt,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(qt,"is","checkout-link"),g(qt,"tag","a");var _e=qt;window.customElements.get(_e.is)||window.customElements.define(_e.is,_e,{extends:_e.tag});var M=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:ie.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:ve.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:ze.PUBLISHED});function no({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u};if(o)for(let tt of r.checkout)tt(o,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:y=c,imsCountry:S,country:b=S??l,language:A=d,quantity:D=m,entitlement:R,upgrade:U,modal:q,perpetual:te,promotionCode:X=p,wcsOsi:F,extraOptions:N,...re}=Object.assign(f,o?.dataset??{},n??{}),le=Ut(y,ie,M.checkoutWorkflowStep);return f=xr({...re,extraOptions:N,checkoutClientId:s,checkoutMarketSegment:x,country:b,quantity:vt(D,M.quantity),checkoutWorkflowStep:le,language:A,entitlement:w(R),upgrade:w(U),modal:q,perpetual:w(te),promotionCode:yr(X).effectivePromoCode,wcsOsi:Cr(F),preselectPlan:h}),f}function i(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:p,country:m,promotionCode:h,quantity:u,preselectPlan:f,ms:x,cs:y,...S}=t(o),b=document.querySelector("meta[name=mas-ff-3in1]"),A=Object.values($e).includes(o.modal)&&(!b||b.content!=="off"),D=window.frameElement||A?"if":"fp",[{productArrangementCode:R,marketSegments:[U],customerSegment:q,offerType:te}]=n,X=x??U??d,F=y??q;f?.toLowerCase()==="edu"?X="EDU":f?.toLowerCase()==="team"&&(F="TEAM");let N={is3in1:A,checkoutPromoCode:h,clientId:l,context:D,country:m,env:s,items:[],marketSegment:X,customerSegment:F,offerType:te,productArrangementCode:R,workflowStep:p,landscape:c,...S},re=u[0]>1?u[0]:void 0;if(n.length===1){let{offerId:le}=n[0];N.items.push({id:le,quantity:re})}else N.items.push(...n.map(({offerId:le,productArrangementCode:tt})=>({id:le,quantity:re,...A?{productArrangementCode:tt}:{}})));return $n(N)}let{createCheckoutLink:a}=_e;return{CheckoutLink:_e,CheckoutWorkflowStep:ie,buildCheckoutURL:i,collectCheckoutOptions:t,createCheckoutLink:a}}function fl({interval:e=200,maxAttempts:r=25}={}){let t=ne.module("ims");return new Promise(i=>{t.debug("Waing for IMS to be ready");let a=0;function n(){window.adobeIMS?.initialized?i():++a>r?(t.debug("Timeout"),i()):setTimeout(n,e)}n()})}function vl(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function xl(e){let r=ne.module("ims");return e.then(t=>t?window.adobeIMS.getProfile().then(({countryCode:i})=>(r.debug("Got user country:",i),i),i=>{r.error("Unable to get user country:",i)}):null)}function oo({}){let e=fl(),r=vl(e),t=xl(r);return{imsReadyPromise:e,imsSignedInPromise:r,imsCountryPromise:t}}var so=window.masPriceLiterals;function co(e){if(Array.isArray(so)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=a=>so.find(n=>Ci(n.lang,a)),i=t(r)??t(M.language);if(i)return Object.freeze(i)}return{}}var Wi=function(e,r){return Wi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,i){t.__proto__=i}||function(t,i){for(var a in i)Object.prototype.hasOwnProperty.call(i,a)&&(t[a]=i[a])},Wi(e,r)};function Vt(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");Wi(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var P=function(){return P=Object.assign||function(r){for(var t,i=1,a=arguments.length;i<a;i++){t=arguments[i];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},P.apply(this,arguments)};function kr(e,r,t){if(t||arguments.length===2)for(var i=0,a=r.length,n;i<a;i++)(n||!(i in r))&&(n||(n=Array.prototype.slice.call(r,0,i)),n[i]=r[i]);return e.concat(n||Array.prototype.slice.call(r))}var E;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(E||(E={}));var B;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(B||(B={}));var Ze;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Ze||(Ze={}));function Yi(e){return e.type===B.literal}function lo(e){return e.type===B.argument}function Pr(e){return e.type===B.number}function Lr(e){return e.type===B.date}function Mr(e){return e.type===B.time}function Rr(e){return e.type===B.select}function zr(e){return e.type===B.plural}function ho(e){return e.type===B.pound}function Or(e){return e.type===B.tag}function Nr(e){return!!(e&&typeof e=="object"&&e.type===Ze.number)}function jt(e){return!!(e&&typeof e=="object"&&e.type===Ze.dateTime)}var Xi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var bl=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function po(e){var r={};return e.replace(bl,function(t){var i=t.length;switch(t[0]){case"G":r.era=i===4?"long":i===5?"narrow":"short";break;case"y":r.year=i===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][i-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][i-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=i===4?"short":i===5?"narrow":"short";break;case"e":if(i<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][i-4];break;case"c":if(i<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][i-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][i-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][i-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][i-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][i-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][i-1];break;case"s":r.second=["numeric","2-digit"][i-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=i<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var mo=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function vo(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(mo).filter(function(m){return m.length>0}),t=[],i=0,a=r;i<a.length;i++){var n=a[i],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var p=d[l];if(p.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function yl(e){return e.replace(/^(.*?)-/,"")}var uo=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,xo=/^(@+)?(\+|#+)?[rs]?$/g,wl=/(\*)(0+)|(#+)(0+)|(0+)/g,bo=/^(0+)$/;function go(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(xo,function(t,i,a){return typeof a!="string"?(r.minimumSignificantDigits=i.length,r.maximumSignificantDigits=i.length):a==="+"?r.minimumSignificantDigits=i.length:i[0]==="#"?r.maximumSignificantDigits=i.length:(r.minimumSignificantDigits=i.length,r.maximumSignificantDigits=i.length+(typeof a=="string"?a.length:0)),""}),r}function yo(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function El(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!bo.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function fo(e){var r={},t=yo(e);return t||r}function wo(e){for(var r={},t=0,i=e;t<i.length;t++){var a=i[t];switch(a.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=a.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=yl(a.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=P(P(P({},r),{notation:"scientific"}),a.options.reduce(function(c,l){return P(P({},c),fo(l))},{}));continue;case"engineering":r=P(P(P({},r),{notation:"engineering"}),a.options.reduce(function(c,l){return P(P({},c),fo(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(a.options[0]);continue;case"integer-width":if(a.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");a.options[0].replace(wl,function(c,l,d,p,m,h){if(l)r.minimumIntegerDigits=d.length;else{if(p&&m)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(bo.test(a.stem)){r.minimumIntegerDigits=a.stem.length;continue}if(uo.test(a.stem)){if(a.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");a.stem.replace(uo,function(c,l,d,p,m,h){return d==="*"?r.minimumFractionDigits=l.length:p&&p[0]==="#"?r.maximumFractionDigits=p.length:m&&h?(r.minimumFractionDigits=m.length,r.maximumFractionDigits=m.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=a.options[0];n==="w"?r=P(P({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=P(P({},r),go(n)));continue}if(xo.test(a.stem)){r=P(P({},r),go(a.stem));continue}var o=yo(a.stem);o&&(r=P(P({},r),o));var s=El(a.stem);s&&(r=P(P({},r),s))}return r}var Wt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function Eo(e,r){for(var t="",i=0;i<e.length;i++){var a=e.charAt(i);if(a==="j"){for(var n=0;i+1<e.length&&e.charAt(i+1)===a;)n++,i++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=Sl(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else a==="J"?t+="H":t+=a}return t}function Sl(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,i;t!=="root"&&(i=e.maximize().region);var a=Wt[i||""]||Wt[t||""]||Wt["".concat(t,"-001")]||Wt["001"];return a[0]}var Ki,Al=new RegExp("^".concat(Xi.source,"*")),Cl=new RegExp("".concat(Xi.source,"*$"));function L(e,r){return{start:e,end:r}}var Tl=!!String.prototype.startsWith,_l=!!String.fromCodePoint,kl=!!Object.fromEntries,Pl=!!String.prototype.codePointAt,Ll=!!String.prototype.trimStart,Ml=!!String.prototype.trimEnd,Rl=!!Number.isSafeInteger,zl=Rl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Qi=!0;try{So=_o("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Qi=((Ki=So.exec("a"))===null||Ki===void 0?void 0:Ki[0])==="a"}catch{Qi=!1}var So,Ao=Tl?function(r,t,i){return r.startsWith(t,i)}:function(r,t,i){return r.slice(i,i+t.length)===t},Ji=_l?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var i="",a=r.length,n=0,o;a>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");i+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return i},Co=kl?Object.fromEntries:function(r){for(var t={},i=0,a=r;i<a.length;i++){var n=a[i],o=n[0],s=n[1];t[o]=s}return t},To=Pl?function(r,t){return r.codePointAt(t)}:function(r,t){var i=r.length;if(!(t<0||t>=i)){var a=r.charCodeAt(t),n;return a<55296||a>56319||t+1===i||(n=r.charCodeAt(t+1))<56320||n>57343?a:(a-55296<<10)+(n-56320)+65536}},Ol=Ll?function(r){return r.trimStart()}:function(r){return r.replace(Al,"")},Nl=Ml?function(r){return r.trimEnd()}:function(r){return r.replace(Cl,"")};function _o(e,r){return new RegExp(e,r)}var ea;Qi?(Zi=_o("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),ea=function(r,t){var i;Zi.lastIndex=t;var a=Zi.exec(r);return(i=a[1])!==null&&i!==void 0?i:""}):ea=function(r,t){for(var i=[];;){var a=To(r,t);if(a===void 0||Po(a)||Hl(a))break;i.push(a),t+=a>=65536?2:1}return Ji.apply(void 0,i)};var Zi,ko=function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,i){for(var a=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,i);if(o.err)return o;a.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),a.push({type:B.pound,location:L(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(i)break;return this.error(E.UNMATCHED_CLOSING_TAG,L(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&ta(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;a.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;a.push(o.val)}}}return{val:a,err:null}},e.prototype.parseTag=function(r,t){var i=this.clonePosition();this.bump();var a=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:B.literal,value:"<".concat(a,"/>"),location:L(i,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!ta(this.char()))return this.error(E.INVALID_TAG,L(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return a!==l?this.error(E.UNMATCHED_CLOSING_TAG,L(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:B.tag,value:a,children:o,location:L(i,this.clonePosition())},err:null}:this.error(E.INVALID_TAG,L(s,this.clonePosition())))}else return this.error(E.UNCLOSED_TAG,L(i,this.clonePosition()))}else return this.error(E.INVALID_TAG,L(i,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&Dl(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var i=this.clonePosition(),a="";;){var n=this.tryParseQuote(t);if(n){a+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){a+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){a+=s;continue}break}var c=L(i,this.clonePosition());return{val:{type:B.literal,value:a,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!Il(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var i=this.char();if(i===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(i);this.bump()}return Ji.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var i=this.char();return i===60||i===123||i===35&&(t==="plural"||t==="selectordinal")||i===125&&r>0?null:(this.bump(),Ji(i))},e.prototype.parseArgument=function(r,t){var i=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(E.EXPECT_ARGUMENT_CLOSING_BRACE,L(i,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(E.EMPTY_ARGUMENT,L(i,this.clonePosition()));var a=this.parseIdentifierIfPossible().value;if(!a)return this.error(E.MALFORMED_ARGUMENT,L(i,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(E.EXPECT_ARGUMENT_CLOSING_BRACE,L(i,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:B.argument,value:a,location:L(i,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(E.EXPECT_ARGUMENT_CLOSING_BRACE,L(i,this.clonePosition())):this.parseArgumentOptions(r,t,a,i);default:return this.error(E.MALFORMED_ARGUMENT,L(i,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),i=ea(this.message,t),a=t+i.length;this.bumpTo(a);var n=this.clonePosition(),o=L(r,n);return{value:i,location:o}},e.prototype.parseArgumentOptions=function(r,t,i,a){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(E.EXPECT_ARGUMENT_TYPE,L(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),p=this.parseSimpleArgStyleIfPossible();if(p.err)return p;var m=Nl(p.val);if(m.length===0)return this.error(E.EXPECT_ARGUMENT_STYLE,L(this.clonePosition(),this.clonePosition()));var h=L(d,this.clonePosition());l={style:m,styleLocation:h}}var u=this.tryParseArgumentClose(a);if(u.err)return u;var f=L(a,this.clonePosition());if(l&&Ao(l?.style,"::",0)){var x=Ol(l.style.slice(2));if(s==="number"){var p=this.parseNumberSkeletonFromString(x,l.styleLocation);return p.err?p:{val:{type:B.number,value:i,location:f,style:p.val},err:null}}else{if(x.length===0)return this.error(E.EXPECT_DATE_TIME_SKELETON,f);var y=x;this.locale&&(y=Eo(x,this.locale));var m={type:Ze.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?po(y):{}},S=s==="date"?B.date:B.time;return{val:{type:S,value:i,location:f,style:m},err:null}}}return{val:{type:s==="number"?B.number:s==="date"?B.date:B.time,value:i,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(E.EXPECT_SELECT_ARGUMENT_OPTIONS,L(b,P({},b)));this.bumpSpace();var A=this.parseIdentifierIfPossible(),D=0;if(s!=="select"&&A.value==="offset"){if(!this.bumpIf(":"))return this.error(E.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,L(this.clonePosition(),this.clonePosition()));this.bumpSpace();var p=this.tryParseDecimalInteger(E.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,E.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(p.err)return p;this.bumpSpace(),A=this.parseIdentifierIfPossible(),D=p.val}var R=this.tryParsePluralOrSelectOptions(r,s,t,A);if(R.err)return R;var u=this.tryParseArgumentClose(a);if(u.err)return u;var U=L(a,this.clonePosition());return s==="select"?{val:{type:B.select,value:i,options:Co(R.val),location:U},err:null}:{val:{type:B.plural,value:i,options:Co(R.val),offset:D,pluralType:s==="plural"?"cardinal":"ordinal",location:U},err:null}}default:return this.error(E.INVALID_ARGUMENT_TYPE,L(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(E.EXPECT_ARGUMENT_CLOSING_BRACE,L(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var i=this.char();switch(i){case 39:{this.bump();var a=this.clonePosition();if(!this.bumpUntil("'"))return this.error(E.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,L(a,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var i=[];try{i=vo(r)}catch{return this.error(E.INVALID_NUMBER_SKELETON,t)}return{val:{type:Ze.number,tokens:i,location:t,parsedOptions:this.shouldParseSkeletons?wo(i):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,i,a){for(var n,o=!1,s=[],c=new Set,l=a.value,d=a.location;;){if(l.length===0){var p=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var m=this.tryParseDecimalInteger(E.EXPECT_PLURAL_ARGUMENT_SELECTOR,E.INVALID_PLURAL_ARGUMENT_SELECTOR);if(m.err)return m;d=L(p,this.clonePosition()),l=this.message.slice(p.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?E.DUPLICATE_SELECT_ARGUMENT_SELECTOR:E.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?E.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:E.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,L(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(r+1,t,i);if(u.err)return u;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:u.val,location:L(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?E.EXPECT_SELECT_ARGUMENT_SELECTOR:E.EXPECT_PLURAL_ARGUMENT_SELECTOR,L(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(E.MISSING_OTHER_CLAUSE,L(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var i=1,a=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(i=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=L(a,this.clonePosition());return n?(o*=i,zl(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=To(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(Ao(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),i=this.message.indexOf(r,t);return i>=0?(this.bumpTo(i),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Po(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),i=this.message.charCodeAt(t+(r>=65536?2:1));return i??null},e}();function ta(e){return e>=97&&e<=122||e>=65&&e<=90}function Il(e){return ta(e)||e===47}function Dl(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Po(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function Hl(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function ra(e){e.forEach(function(r){if(delete r.location,Rr(r)||zr(r))for(var t in r.options)delete r.options[t].location,ra(r.options[t].value);else Pr(r)&&Nr(r.style)||(Lr(r)||Mr(r))&&jt(r.style)?delete r.style.location:Or(r)&&ra(r.children)})}function Lo(e,r){r===void 0&&(r={}),r=P({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new ko(e,r).parse();if(t.err){var i=SyntaxError(E[t.err.kind]);throw i.location=t.err.location,i.originalMessage=t.err.message,i}return r?.captureLocation||ra(t.val),t.val}function Yt(e,r){var t=r&&r.cache?r.cache:ql,i=r&&r.serializer?r.serializer:Gl,a=r&&r.strategy?r.strategy:Fl;return a(e,{cache:t,serializer:i})}function Bl(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Mo(e,r,t,i){var a=Bl(i)?i:t(i),n=r.get(a);return typeof n>"u"&&(n=e.call(this,i),r.set(a,n)),n}function Ro(e,r,t){var i=Array.prototype.slice.call(arguments,3),a=t(i),n=r.get(a);return typeof n>"u"&&(n=e.apply(this,i),r.set(a,n)),n}function ia(e,r,t,i,a){return t.bind(r,e,i,a)}function Fl(e,r){var t=e.length===1?Mo:Ro;return ia(e,this,t,r.cache.create(),r.serializer)}function Ul(e,r){return ia(e,this,Ro,r.cache.create(),r.serializer)}function $l(e,r){return ia(e,this,Mo,r.cache.create(),r.serializer)}var Gl=function(){return JSON.stringify(arguments)};function aa(){this.cache=Object.create(null)}aa.prototype.get=function(e){return this.cache[e]};aa.prototype.set=function(e,r){this.cache[e]=r};var ql={create:function(){return new aa}},Ir={variadic:Ul,monadic:$l};var Qe;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Qe||(Qe={}));var Xt=function(e){Vt(r,e);function r(t,i,a){var n=e.call(this,t)||this;return n.code=i,n.originalMessage=a,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r}(Error);var na=function(e){Vt(r,e);function r(t,i,a,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(i,'". Options are "').concat(Object.keys(a).join('", "'),'"'),Qe.INVALID_VALUE,n)||this}return r}(Xt);var zo=function(e){Vt(r,e);function r(t,i,a){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(i),Qe.INVALID_VALUE,a)||this}return r}(Xt);var Oo=function(e){Vt(r,e);function r(t,i){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(i,'"'),Qe.MISSING_VALUE,i)||this}return r}(Xt);var Q;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(Q||(Q={}));function Vl(e){return e.length<2?e:e.reduce(function(r,t){var i=r[r.length-1];return!i||i.type!==Q.literal||t.type!==Q.literal?r.push(t):i.value+=t.value,r},[])}function jl(e){return typeof e=="function"}function Kt(e,r,t,i,a,n,o){if(e.length===1&&Yi(e[0]))return[{type:Q.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(Yi(d)){s.push({type:Q.literal,value:d.value});continue}if(ho(d)){typeof n=="number"&&s.push({type:Q.literal,value:t.getNumberFormat(r).format(n)});continue}var p=d.value;if(!(a&&p in a))throw new Oo(p,o);var m=a[p];if(lo(d)){(!m||typeof m=="string"||typeof m=="number")&&(m=typeof m=="string"||typeof m=="number"?String(m):""),s.push({type:typeof m=="string"?Q.literal:Q.object,value:m});continue}if(Lr(d)){var h=typeof d.style=="string"?i.date[d.style]:jt(d.style)?d.style.parsedOptions:void 0;s.push({type:Q.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(Mr(d)){var h=typeof d.style=="string"?i.time[d.style]:jt(d.style)?d.style.parsedOptions:i.time.medium;s.push({type:Q.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(Pr(d)){var h=typeof d.style=="string"?i.number[d.style]:Nr(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(m=m*(h.scale||1)),s.push({type:Q.literal,value:t.getNumberFormat(r,h).format(m)});continue}if(Or(d)){var u=d.children,f=d.value,x=a[f];if(!jl(x))throw new zo(f,"function",o);var y=Kt(u,r,t,i,a,n),S=x(y.map(function(D){return D.value}));Array.isArray(S)||(S=[S]),s.push.apply(s,S.map(function(D){return{type:typeof D=="string"?Q.literal:Q.object,value:D}}))}if(Rr(d)){var b=d.options[m]||d.options.other;if(!b)throw new na(d.value,m,Object.keys(d.options),o);s.push.apply(s,Kt(b.value,r,t,i,a));continue}if(zr(d)){var b=d.options["=".concat(m)];if(!b){if(!Intl.PluralRules)throw new Xt(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Qe.MISSING_INTL_API,o);var A=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[A]||d.options.other}if(!b)throw new na(d.value,m,Object.keys(d.options),o);s.push.apply(s,Kt(b.value,r,t,i,a,m-(d.offset||0)));continue}}return Vl(s)}function Wl(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,i){return t[i]=P(P({},e[i]),r[i]||{}),t},{})):e}function Yl(e,r){return r?Object.keys(e).reduce(function(t,i){return t[i]=Wl(e[i],r[i]),t},P({},e)):e}function oa(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function Xl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Yt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.NumberFormat).bind.apply(r,kr([void 0],t,!1)))},{cache:oa(e.number),strategy:Ir.variadic}),getDateTimeFormat:Yt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.DateTimeFormat).bind.apply(r,kr([void 0],t,!1)))},{cache:oa(e.dateTime),strategy:Ir.variadic}),getPluralRules:Yt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.PluralRules).bind.apply(r,kr([void 0],t,!1)))},{cache:oa(e.pluralRules),strategy:Ir.variadic})}}var No=function(){function e(r,t,i,a){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==Q.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Kt(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Yl(e.formats,i),this.formatters=a&&a.formatters||Xl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Lo,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Io=No;var sa={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Kl=Sn("ConsonantTemplates/price"),Zl=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},He={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},ca="TAX_EXCLUSIVE",Ql=e=>yn(e)?Object.entries(e).filter(([,r])=>ft(r)||vr(r)||r===!0).reduce((r,[t,i])=>`${r} ${t}${i===!0?"":`="${bn(i)}"`}`,""):"",G=(e,r,t,i=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${Ql(t)}>${i?Xn(r):r??""}</span>`;function Jl(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function ed(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function ke(e,r,t,i){let a=e[t];if(a==null)return"";let n=a.includes("<"),o=a.includes("<a ");try{a=o?Jl(a):a,a=n?a.replace(Zl,""):a;let s=new Io(a,r).format(i);return o?ed(s):s}catch{return Kl.error("Failed to format literal:",a),""}}function td(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=G($.currencySymbol,i),u=G($.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=G($.integer,s),f+=G($.decimalsDelimiter,n),f+=G($.decimals,a),c||(f+=u+h),f+=G($.recurrence,l,null,!0),f+=G($.unitType,d,null,!0),f+=G($.taxInclusivity,p,!0),G(e,f,{...m})}var K=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:S,price:b,priceWithoutDiscount:A,taxDisplay:D,taxTerm:R,term:U,usePrecision:q,promotion:te}={},X={})=>{Object.entries({country:o,formatString:S,language:p,price:b}).forEach(([ys,ws])=>{if(ws==null)throw new Error(`Argument "${ys}" is missing for osi ${y?.toString()}, country ${o}, language ${p}`)});let F={...sa,...m},N=`${p.toLowerCase()}-${o.toUpperCase()}`,re;te&&!f&&A?re=e||i?b:A:t&&A?re=A:re=b;let le=r?Zn:Qn;a&&(le=Jn);let{accessiblePrice:tt,recurrenceTerm:fa,...va}=le({commitment:x,formatString:S,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:A,price:r?b:re,promotion:te,quantity:h,term:U,usePrecision:q}),Br="",Fr="",Ur="";w(c)&&fa&&(Ur=ke(F,N,He.recurrenceLabel,{recurrenceTerm:fa}));let rr="";w(l)&&(u&&(rr+=" "),rr+=ke(F,N,He.perUnitLabel,{perUnit:"LICENSE"}));let ir="";w(d)&&R&&(u&&(ir+=" "),ir+=ke(F,N,D===ca?He.taxExclusiveLabel:He.taxInclusiveLabel,{taxTerm:R})),t&&(Br=ke(F,N,He.strikethroughAriaLabel,{strikethroughPrice:Br})),e&&(Fr=ke(F,N,He.alternativePriceAriaLabel,{alternativePrice:Fr}));let Fe=$.container;if(r&&(Fe+=` ${$.containerOptical}`),t&&(Fe+=` ${$.containerStrikethrough}`),i&&(Fe+=` ${$.containerPromoStrikethrough}`),e&&(Fe+=` ${$.containerAlternative}`),a&&(Fe+=` ${$.containerAnnual}`),w(s))return td(Fe,{...va,accessibleLabel:Br,altAccessibleLabel:Fr,recurrenceLabel:Ur,perUnitLabel:rr,taxInclusivityLabel:ir},X);let{currencySymbol:xa,decimals:gs,decimalsDelimiter:fs,hasCurrencySpace:ba,integer:vs,isCurrencyFirst:xs}=va,rt=[vs,fs,gs];xs?(rt.unshift(ba?"\xA0":""),rt.unshift(xa)):(rt.push(ba?"\xA0":""),rt.push(xa)),rt.push(Ur,rr,ir);let bs=rt.join("");return G(Fe,bs,X)},Do=()=>(e,r,t)=>{let i=Ke(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||i);return`${n?`${K({displayStrikethrough:!0})({isPromoApplied:i,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${K({isAlternativePrice:n})({isPromoApplied:i,...e},r,t)}`},Ho=()=>(e,r,t)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=Ke(r.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return K()(e,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualPrefix," (")+K({displayAnnual:!0,instant:i})(n,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${K({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${K({isAlternativePrice:s})({isPromoApplied:a,...e},r,t)}${G($.containerAnnualPrefix," (")}${K({displayAnnual:!0,instant:i})(n,r,t)}${G($.containerAnnualSuffix,")")}`},Bo=()=>(e,r,t)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${K({isAlternativePrice:e.displayOldPrice})(e,r,t)}${G($.containerAnnualPrefix," (")}${K({displayAnnual:!0})(i,r,t)}${G($.containerAnnualSuffix,")")}`};var Zt={...$,containerLegal:"price-legal",planType:"price-plan-type"},Dr={...He,planTypeLabel:"planTypeLabel"};function rd(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:i},a={},n=!0){let o="";return o+=G(Zt.unitType,r,null,!0),t&&i&&n&&(t+=". "),o+=G(Zt.taxInclusivity,t,!0),o+=G(Zt.planType,i,null),G(e,o,{...a})}var Fo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:i=!1,displayDot:a=!0,language:n,literals:o={}}={},{taxDisplay:s,taxTerm:c,planType:l}={},d={})=>{let p={...sa,...o},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";w(r)&&(h=ke(p,m,Dr.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),w(t)&&c&&(u=ke(p,m,s===ca?Dr.taxExclusiveLabel:Dr.taxInclusiveLabel,{taxTerm:c}));let f="";w(i)&&l&&(f=ke(p,m,Dr.planTypeLabel,{planType:l}));let x=Zt.container;return x+=` ${Zt.containerLegal}`,rd(x,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,a)};var Uo=K(),$o=Do(),Go=K({displayOptical:!0}),qo=K({displayStrikethrough:!0}),Vo=K({displayPromoStrikethrough:!0}),jo=K({displayAnnual:!0}),Wo=K({displayOptical:!0,isAlternativePrice:!0}),Yo=K({isAlternativePrice:!0}),Xo=Bo(),Ko=Ho(),Zo=Fo;var id=(e,r)=>{if(!(!Ft(e)||!Ft(r)))return Math.floor((r-e)/r*100)},Qo=()=>(e,r)=>{let{price:t,priceWithoutDiscount:i}=r,a=id(t,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var Jo=Qo();var es="INDIVIDUAL_COM",da="TEAM_COM",ts="INDIVIDUAL_EDU",ha="TEAM_EDU",ad=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],nd={[es]:[],[da]:[],[ts]:[],[ha]:[]},od={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},sd=[es,da,ts,ha],cd=e=>[da,ha].includes(e);function la(e,r,t,i){if(e[r])return e[r];let a=`${r}_${t}`;if(e[a])return e[a];let n;if(i)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var ld=(e,r,t,i)=>{let a=`${t}_${i}`,n=la(od,e,r,!1);if(n){let o=sd.indexOf(a);return n[o]}return cd(a)},dd=(e,r,t,i)=>{if(la(ad,e,r,!0))return!0;let a=nd[`${t}_${i}`];return a?la(a,e,r,!0)?!0:M.displayTax:M.displayTax},pa=async(e,r,t,i)=>{let a=dd(e,r,t,i);return{displayTax:a,forceTaxExclusive:a?ld(e,r,t,i):M.forceTaxExclusive}},Qt=class Qt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new De(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let i=oe();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=i.collectPriceOptions(t);return Tr(Qt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ue}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let i=oe();if(!i)return!1;let a=i.collectPriceOptions(t,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=i.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let u=$t(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=Ui(l);if(i.featureFlags[Ae]||n[Ae]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,x=await pa(h,u,p.customerSegment,f);a.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let S=$t(y,n);return S?.length?S[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(i.featureFlags[it]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=Ui(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,i,a=void 0){if(!this.isConnected)return;let n=oe();if(!n)return!1;if(a??(a=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(a,t,i)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,o,this.options))return this.innerHTML="",!0}return!1}};g(Qt,"is","inline-price"),g(Qt,"tag","span");var Pe=Qt;window.customElements.get(Pe.is)||window.customElements.define(Pe.is,Pe,{extends:Pe.tag});function rs({literals:e,providers:r,settings:t}){function i(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let R of r.price)R(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:y,quantity:S,alternativePrice:b,wcsOsi:A,...D}=Object.assign(c,s?.dataset??{},o??{});return c=xr(Object.assign({...c,...D,displayOldPrice:w(l),displayPerUnit:w(d),displayRecurrence:w(p),displayTax:w(m),displayPlanType:w(h),forceTaxExclusive:w(u),perpetual:w(f),displayAnnual:w(x),promotionCode:yr(y).effectivePromoCode,quantity:vt(S,M.quantity),alternativePrice:w(b),wcsOsi:Cr(A)})),c}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Jo;break;case"strikethrough":l=qo;break;case"promo-strikethrough":l=Vo;break;case"annual":l=jo;break;case"legal":l=Zo;break;default:s.template==="optical"&&s.alternativePrice?l=Wo:s.template==="optical"?l=Go:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?Ko:Xo:s.alternativePrice?l=Yo:l=s.promotionCode&&o[0].promotion?$o:Uo}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Pe.createInlinePrice;return{InlinePrice:Pe,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function hd({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||M.language),r??(r=e?.split("_")?.[1]||M.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function is(e={},r){let t=r.featureFlags[Ae],{commerce:i={}}=e,a=ve.PRODUCTION,n=ci,o=H("checkoutClientId",i)??M.checkoutClientId,s=Ut(H("checkoutWorkflowStep",i),ie,M.checkoutWorkflowStep),c=w(H("displayOldPrice",i),M.displayOldPrice),l=M.displayPerUnit,d=w(H("displayRecurrence",i),M.displayRecurrence),p=w(H("displayTax",i),M.displayTax),m=w(H("displayPlanType",i),M.displayPlanType),h=w(H("entitlement",i),M.entitlement),u=w(H("modal",i),M.modal),f=w(H("forceTaxExclusive",i),M.forceTaxExclusive),x=H("promotionCode",i)??M.promotionCode,y=vt(H("quantity",i)),S=H("wcsApiKey",i)??M.wcsApiKey,b=i?.env==="stage",A=ze.PUBLISHED;["true",""].includes(i.allowOverride)&&(b=(H(oi,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",A=Ut(H(si,i),ze,A)),b&&(a=ve.STAGE,n=li);let R=H(ni)??e.preview,U=typeof R<"u"&&R!=="off"&&R!=="false",q={};U&&(q={preview:U});let te=H("mas-io-url")??e.masIOUrl??`https://www${a===ve.STAGE?".stage":""}.adobe.com/mas/io`,X=H("preselect-plan")??void 0,F=H("instant")??e.instant;return{...hd(e),...q,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:M.extraOptions,modal:u,env:a,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:M.alternativePrice,wcsApiKey:S,wcsURL:n,landscape:A,masIOUrl:te,...X&&{preselectPlan:X},...F&&{instant:F}}}async function as(e,r={},t=2,i=100){let a;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,i*(n+1)))}throw a}var ma="wcs";function ns({settings:e}){let r=ne.module(ma),{env:t,wcsApiKey:i}=e,a=new Map,n=new Map,o,s=new Map;async function c(u,f,x=!0){let y=oe(),S=ri;r.debug("Fetching:",u);let b="",A;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let D=new Map(f),[R]=u.offerSelectorIds,U=Date.now()+Math.random().toString(36).substring(2,7),q=`${ma}:${R}:${U}${hi}`,te=`${ma}:${R}:${U}${pi}`,X;try{if(performance.mark(q),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",R),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===ve.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",i),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),A=await as(b.toString(),{credentials:"omit"}),A.ok){let F=[];try{let N=await A.json();r.debug("Fetched:",u,N),F=N.resolvedOffers??[]}catch(N){r.error(`Error parsing JSON: ${N.message}`,{...N.context,...y?.duration})}F=F.map(wr),f.forEach(({resolve:N},re)=>{let le=F.filter(({offerSelectorIds:tt})=>tt.includes(re)).flat();le.length&&(D.delete(re),f.delete(re),N(le))})}else S=ti}catch(F){S=`Network error: ${F.message}`}finally{X=performance.measure(te,q),performance.clearMarks(q),performance.clearMeasures(te)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=In(A);f.forEach(N=>{N.reject(new xt(S,{...u,...F,response:A,measure:or(X),...y?.duration}))})}}function l(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ve.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,S]of Object.entries(x))a.set(y,Promise.resolve(S.map(wr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let u=a.size;s=new Map(a),a.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,x){let y=u!=="GB"&&!x?"MULT":"en",S=mi.includes(u)?u:M.country;return{validCountry:S,validLanguage:y,locale:`${f}_${S}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:S=[]}){let{validCountry:b,validLanguage:A,locale:D}=m(u,f,x),R=[b,A,y].filter(U=>U).join("-").toLowerCase();return S.map(U=>{let q=`${U}-${R}`;if(a.has(q))return a.get(q);let te=new Promise((X,F)=>{let N=n.get(R);N||(N={options:{country:b,locale:D,...A==="MULT"&&{language:A},offerSelectorIds:[]},promises:new Map},n.set(R,N)),y&&(N.options.promotionCode=y),N.options.offerSelectorIds.push(U),N.promises.set(U,{resolve:X,reject:F}),l()}).catch(X=>{if(s.has(q))return s.get(q);throw X});return a.set(q,te),te})}return{Commitment:Ue,PlanType:Cn,Term:de,applyPlanType:wr,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var os="mas-commerce-service",ss="mas-commerce-service:start",cs="mas-commerce-service:ready",Jt,yt,Je,ls,ga,ua=class extends HTMLElement{constructor(){super(...arguments);z(this,Je);z(this,Jt);z(this,yt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let o=await t?.(i,a,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,yt)||_(this,yt,{[Ae]:Y(this,Je,ga).call(this,Ae),[it]:Y(this,Je,ga).call(this,it)}),v(this,yt)}activate(){let t=v(this,Je,ls),i=is(t,this);Er(t.lana);let a=ne.init(t.hostEnv).module("service");a.debug("Activating:",t);let o={price:co(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...no(c),...oo(c),...rs(c),...ns(c),...ui,Log:ne,resolvePriceTaxFlags:pa,get defaults(){return M},get log(){return ne},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(nr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(cs),_(this,Jt,performance.measure(cs,ss)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(ss),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(qr).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":or(v(this,Jt))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:o})=>a===0&&n===0&&o<200||o>=400),i=Array.from(new Map(t.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Jt=new WeakMap,yt=new WeakMap,Je=new WeakSet,ls=function(){let t=this.getAttribute("env")??"prod",i={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=n}}),i},ga=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(os)||window.customElements.define(os,ua);var ms="merch-card-collection",pd=3e4,md={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},ud={plans:!0},gd=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),fd=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(i=>t.types.includes(i)))):e,vd=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),xd=(e,{filter:r})=>e.sort((t,i)=>i.filters[r]?.order==null||isNaN(i.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-i.filters[r].order),bd=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Be,Et,et,tr,Hr,us,wt=class extends hs{constructor(){super();z(this,Hr);z(this,Be,{});z(this,Et);z(this,et);z(this,tr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return Le` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let i=new Promise(a=>setTimeout(()=>a(!1),pd));return Promise.race([this.hydrationReady,i])}updated(t){if(!this.querySelector("merch-card"))return;let i=window.scrollY||document.documentElement.scrollTop,a=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(a.length===0)return;t.has("singleApp")&&this.singleApp&&a.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===ge.alphabetical?vd:xd,s=[gd,fd,bd,n].reduce((l,d)=>d(l,this),a).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);a.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,i),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Yr,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(me,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){_(this,Be,{}),this.overrides?.split(",").forEach(t=>{let[i,a]=t?.split(":");i&&a&&(v(this,Be)[i]=a)})}connectedCallback(){super.connectedCallback(),_(this,Et,Pt()),v(this,Et)&&_(this,et,v(this,Et).Log.module(ms)),_(this,tr,customElements.get("merch-card")),this.buildOverrideMap(),this.init()}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t()}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(a=>{let n=a.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(a)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let i of Object.keys(t)){let a=t[i],n=a.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",i),o.setAttribute("placeholder",""),o.innerHTML=a,this.append(o)}}attachSidenav(t,i=!0){if(!t)return;i&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),ud[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Tt));let a=v(this,tr)?.getCollectionOptions(this.variant)?.onSidenavAttached;a&&a(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let i;this.hydrationReady=new Promise(s=>{i=s});let a=this;function n(s){let c;return s.fields?.checkboxGroups?c=s.fields.checkboxGroups:s.fields?.tagFilters&&(c=[{title:s.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:s.fields.tagFilters.map(l=>{let d=l.split("/").pop(),p=s.settings?.tagLabels?.[d]||d;return p=p.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):p,{name:d,label:p}})}]),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(p,m){for(let h of m){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){v(a,et)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let u=s.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)u=b,f=b.referencesTree,s.references={...s.references,...b.references};else{v(a,et)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!u?.fields)continue;let{fields:y}=u,S={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(b=>c[b]||b):[],collections:[]};y.defaultchild&&(S.defaultchild=c[y.defaultchild]||y.defaultchild),p.push(S),d(S.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(a.filtered="all"),l}t.addEventListener(Kr,s=>{Y(this,Hr,us).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(Xr,async s=>{this.limit=27,this.data=o(s.detail,v(this,Be)),s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?v(this,Be)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let p=(u,f)=>{for(let x of u)if(x.defaultchild===f||x.collections&&p(x.collections,f))return!0;return!1};for(let u of c){let b=function(D){for(let R of D){let U=R.cards.indexOf(x);if(U===-1)continue;let q=R.queryLabel??R?.label?.toLowerCase()??"";f.filters[q]={order:U+1,size:u.fields.size},b(R.collections)}},f=document.createElement("merch-card"),x=v(this,Be)[u.id]||u.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=u.fields.tags?.filter(D=>D.startsWith("mas:types/")).map(D=>D.split("/")[1]).join(",");y&&f.setAttribute("types",y),cr(u.fields.variant)?.supportsDefaultChild&&(d?x===d:p(l,x))&&f.setAttribute("data-default-card","true"),b(l);let A=document.createElement("aem-fragment");A.setAttribute("fragment",x),f.append(A),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(u)+1,size:u.fields.size}}),this.append(f)}let m="",h=Bn(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(u=>u.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?m=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(m=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...md[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),i(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Le`<div id="footer">

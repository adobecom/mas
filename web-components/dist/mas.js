...
`;var xh=32,Ft=class extends T{constructor(r){super(r);m(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);m(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?f`<slot name="secure-transaction-label">
...
`;document.head.appendChild(bc);var yc="fragment",Ec="author",wc="preview",Ac="loading",Sc="timeout",wa="aem-fragment",_c="eager",Tc="cache",vh=[_c,Tc],Re,bt,Se,Aa=class{constructor(){E(this,Re,new Map);E(this,bt,new Map);E(this,Se,new Map)}clear(){h(this,Re).clear(),h(this,bt).clear(),h(this,Se).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,Re).set(t.id,t),t.fields?.originalId&&h(this,Re).set(t.fields.originalId,t),h(this,Se).has(t.id)){let[,i]=h(this,Se).get(t.id);i()}if(h(this,Se).has(t.fields?.originalId)){let[,i]=h(this,Se).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:n,value:a}=t.references[i];n==="content-fragment"&&(a.settings={...t?.settings,...a.settings},a.placeholders={...t?.placeholders,...a.placeholders},a.dictionary={...t?.dictionary,...a.dictionary},a.priceLiterals={...t?.priceLiterals,...a.priceLiterals},this.add(a,t))}}}has(t){return h(this,Re).has(t)}entries(){return h(this,Re).entries()}get(t){return h(this,Re).get(t)}getAsPromise(t){let[r]=h(this,Se).get(t)??[];if(r)return r;let i;return r=new Promise(n=>{i=n,this.has(t)&&n()}),h(this,Se).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,bt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,bt).set(t,r)),r}remove(t){h(this,Re).delete(t),h(this,bt).delete(t),h(this,Se).delete(t)}};Re=new WeakMap,bt=new WeakMap,Se=new WeakMap;var Xe=new Aa,Xt,_e,He,ve,pe,ee,Ur,Fr,Te,Gr,qr,Kt,Ce,Cc,kc,Sa,Pc,Bi=class extends HTMLElement{constructor(){super(...arguments);E(this,Ce);m(this,"cache",Xe);E(this,Xt);E(this,_e,null);E(this,He,null);E(this,ve,null);E(this,pe);E(this,ee);E(this,Ur,_c);E(this,Fr,5e3);E(this,Te);E(this,Gr,!1);E(this,qr,0);E(this,Kt)}static get observedAttributes(){return[yc,Ac,Sc,Ec,wc]}attributeChangedCallback(r,i,n){r===yc&&(y(this,pe,n),y(this,ee,Xe.getFetchInfo(n))),r===Ac&&vh.includes(n)&&y(this,Ur,n),r===Sc&&y(this,Fr,parseInt(n,10)),r===Ec&&y(this,Gr,["","true"].includes(n)),r===wc&&y(this,Kt,n)}connectedCallback(){if(!h(this,Te)){if(h(this,ve)??y(this,ve,dt(this)),y(this,Kt,h(this,ve).settings?.preview),h(this,Xt)??y(this,Xt,h(this,ve).log.module(`${wa}[${h(this,pe)}]`)),!h(this,pe)||h(this,pe)==="#"){h(this,ee)??y(this,ee,Xe.getFetchInfo("missing-fragment-id")),te(this,Ce,Sa).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,ee)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,Te)&&!await Promise.race([h(this,Te),Promise.resolve(!1)]))return;r&&Xe.remove(h(this,pe)),h(this,Ur)===Tc&&await Promise.race([Xe.getAsPromise(h(this,pe)),new Promise(s=>setTimeout(s,h(this,Fr)))]);try{y(this,Te,te(this,Ce,Pc).call(this)),await h(this,Te)}catch(s){return te(this,Ce,Sa).call(this,s.message),!1}let{references:i,referencesTree:n,placeholders:a,wcs:o}=h(this,_e)||{};return o&&!B("mas.disableWcsCache")&&h(this,ve).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(tt,{detail:{...this.data,references:i,referencesTree:n,placeholders:a,...h(this,ee)},bubbles:!0,composed:!0})),h(this,Te)}get updateComplete(){return h(this,Te)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,He)?h(this,He):(h(this,Gr)?this.transformAuthorData():this.transformPublishData(),h(this,He))}get rawData(){return h(this,_e)}transformAuthorData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,_e);y(this,He,r.reduce((l,{name:d,multiple:p,values:u})=>(l.fields[d]=p?u:u[0],l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,_e);y(this,He,Object.entries(r).reduce((l,[d,p])=>(l.fields[d]=p?.mimeType?p.value:p??"",l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=i.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,o=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${o}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,pe),{locale:h(this,ve).settings.locale,apiKey:h(this,ve).settings.wcsApiKey})}};Xt=new WeakMap,_e=new WeakMap,He=new WeakMap,ve=new WeakMap,pe=new WeakMap,ee=new WeakMap,Ur=new WeakMap,Fr=new WeakMap,Te=new WeakMap,Gr=new WeakMap,qr=new WeakMap,Kt=new WeakMap,Ce=new WeakSet,Cc=async function(r){Fa(this,qr)._++;let i=`${wa}:${h(this,pe)}:${h(this,qr)}`,n=`${i}${nt}`,a=`${i}${at}`;if(h(this,Kt))return await this.generatePreview();performance.mark(n);let o;try{if(h(this,ee).stale=!1,h(this,ee).url=r,o=await _i(r,{cache:"default",credentials:"omit"}),te(this,Ce,kc).call(this,o),h(this,ee).status=o?.status,h(this,ee).measure=Le(performance.measure(a,n)),h(this,ee).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...h(this,ve).duration});return await o.json()}catch(s){if(h(this,ee).measure=Le(performance.measure(a,n)),h(this,ee).retryCount=s.retryCount,h(this,_e))return h(this,ee).stale=!0,h(this,Xt).error("Serving stale data",h(this,ee)),h(this,_e);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},kc=function(r){Object.assign(h(this,ee),ci(r))},Sa=function(r){y(this,Te,null),h(this,ee).message=r,this.classList.add("error");let i={...h(this,ee),...h(this,ve).duration};h(this,Xt).error(r,i),this.dispatchEvent(new CustomEvent(rt,{detail:i,bubbles:!0,composed:!0}))},Pc=async function(){var c;this.classList.remove("error"),y(this,He,null);let r=Xe.get(h(this,pe));if(r)return y(this,_e,r),!0;let{masIOUrl:i,wcsApiKey:n,country:a,locale:o}=h(this,ve).settings,s=`${i}/fragment?id=${h(this,pe)}&api_key=${n}&locale=${o}`;return a&&!o.endsWith(`_${a}`)&&(s+=`&country=${a}`),r=await te(this,Ce,Cc).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,pe)),Xe.add(r),y(this,_e,r),!0},m(Bi,"cache",Xe);customElements.define(wa,Bi);R();var Qt=class extends ${constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">${this.text}</div>`}};m(Qt,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),m(Qt,"styles",b`
    ...
    `),m(Yr,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Yr);R();R();var Dc=b`
    :host {
...
`;var[nb,ab,La,Ra,$c,Hc]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Ma=class extends ${static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return zc}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=Tr(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=Tr(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(Tt,this.debouncedQuantityUpdate)}get button(){return this.shadowRoot.querySelector("button")}handleKeyup(t){t.key===Ra||t.key===La||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let t=this.options[this.highlightedIndex];if(!t){this.closed=!0;return}this.selectedValue=t,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(t){switch(t.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case Hc:this.selectValue();break;case Ra:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,t.preventDefault();break;case La:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),t.preventDefault();break;case $c:this.selectValue(),this.button.classList.contains("focused")&&t.preventDefault();break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=t.value.replace(/\D/g,"");t.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let n=i;this.maxInput&&i>this.maxInput&&(n=this.maxInput),this.min&&n<this.min&&(n=this.min),this.adjustInput(t,n)}else this.adjustInput(t,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(Tt,this.debouncedQuantityUpdate)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}update(t){(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue"))&&(this.options=this.generateOptionsArray(),this.highlightedIndex=this.defaultValue?this.options.indexOf(this.defaultValue):0,this.handleMenuOption(this.defaultValue?this.defaultValue:this.options[0])),super.update(t)}handleClickOutside(t){t.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let t=this.shadowRoot.querySelector(".popover");this.closed||t.getBoundingClientRect().bottom<=window.innerHeight?t.setAttribute("placement","bottom"):t.setAttribute("placement","top")}handleMouseEnter(t){this.highlightedIndex=t}handleMenuOption(t,r){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let t=new CustomEvent(ae,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return f` <div
        ...
        `}};customElements.define("merch-quantity-select",Ma);Oi();R();var Bc=`
...
`;var Gc={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},nr=class extends T{getGlobalCSS(){return Fc}renderLayout(){return f` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Ia={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},sr=class extends T{getGlobalCSS(){return jc}get aemFragmentMapping(){return Ia}renderLayout(){return f`
    ...
    `);V("ccd-suggested",ir,Uc,ir.variantStyle);V("ccd-slice",nr,Gc,nr.variantStyle);V("ah-try-buy-widget",ar,Oa,ar.variantStyle);V("ah-promoted-plans",or,Na,or.variantStyle);V("fries",sr,Ia,sr.variantStyle);

...
export const features = [
    ...
    },
    {
        ...
        data: {
            ...
            description:
                'Save over 65% on Photoshop and more than 20 apps for the first year. Plus get the first month on us when purchase by Sep 2',
            price: PRICE_PATTERN.US.mo,
    ...
    },
    {
        ...
        data: {
            ...
            eyebrow: 'STUDENTS AND TEACHERS',
            description:
                'Save over 65% on Photoshop and more than 20 apps for the first year. Plus get the first month on us until Sep 2',
            price: PRICE_PATTERN.US.mo,
            cta: 'Buy now',
            linkText: 'See terms',
            linkUrl: '',
    ...
    },
    {
        ...
        data: {
            ...
            description:
                'The full version of Photoshop plus Adobe Express Premium plan, more than 20 apps for design, video, and exclusive business features',
            price: PRICE_PATTERN.US.mo,
            cta: 'Buy now',
            background: 'media_1d63dab9ee1edbf371d6f0548516c9e12b3ea3ff4.png',
            iconUrl: '',
    ...
    },
    {
        ...
        data: {
            ...
            title: 'Creative Cloud All Apps for teams',
            description:
                'The full version of Photoshop plus more than 20 apps for design, video, and exclusive business features.',
            price: PRICE_PATTERN.US.mo,
            cta: 'Buy now',
            background: 'media_196e39eda2ba7ce0343ec138f3e3e41e5adcb787f.png',
            iconUrl: '',
    ...
    },
    {
        ...
        data: {
            ...
            description:
                'Get industry-leading creative apps designed just for business. Creative Cloud All Apps for Teams. Starting at',
            linkText: 'See terms',
            linkUrl: '',
            price: PRICE_PATTERN.US.mo,
            cta: 'Buy now',
    ...
    },
    {
        ...
        data: {
            ...
            uptLinkUrl:
                'https://www.adobe.com/offers/promo-terms.html?locale=en_US&country=US&offer_id=3B8086C370FDF28C8AEEE1C5BD233E5A&promotion_code=MHYXZS',
            // iconLink: '',
        },
        browserParams: '?theme=darkest',
        tags: '@mas-ccd @slice-card @slice-single @commerce @smoke @regression @milo',
    ...
    },
    {
        ...
        data: {
            ...
            description:
                'La version complète de Photoshop plus le plan Adobe Express Premium, plus de 20 applications pour la conception, la vidéo et des fonctionnalités professionnelles exclusives.',
            price: PRICE_PATTERN.FR.mo,
    ...
    {
        tcid: '25',
        name: '@MAS-CCD-loc-masio-id',
        path: 'https://www.adobe.com/mas/io/fragment',
        data: {
            id: '45783ec8-ed85-4595-a445-3f018ac4ad9d',

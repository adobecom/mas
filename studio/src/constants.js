...
export const LOCALES = [
    ...
    { code: 'ar_SA', lang: 'ar', flag: '🇸🇦', name: 'Saudi Arabia', default: ['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region:[] },
    { code: 'bg_BG', lang: 'bg', flag: '🇧🇬', name: 'Bulgaria', default: ['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region:[] },
    { code: 'cs_CZ', lang: 'cs', flag: '🇨🇿', name: 'Czech Republic', default: ['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region:[] },
    { code: 'da_DK', lang: 'da', flag: '🇩🇰', name: 'Denmark', default: ['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region:[] },
    ...
    { code: 'de_DE', lang: 'de', flag: '🇩🇪', name: 'Germany', default: ['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region:[] },
    { code: 'de_LU', lang: 'de', flag: '🇱🇺', name: 'Luxembourg (German)', default: [], region:['acom'] },
    { code: 'el_GR', lang: 'el', flag: '🇬🇷', name: 'Greece', default: ['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'] },
    ...
    { code: 'en_US', lang: 'en', flag: '🇺🇸', name: 'United States', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'] },
    ...
    { code: 'es_ES', lang: 'es', flag: '🇪🇸', name: 'Spain', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    ...
    { code: 'fi_FI', lang: 'fi', flag: '🇫🇮', name: 'Finland', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    ...
    { code: 'fr_FR', lang: 'fr', flag: '🇫🇷', name: 'France', default: ['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'] },
    { code: 'fr_LU', lang: 'fr', flag: '🇱🇺', name: 'Luxembourg (French)', default:[], region: ['acom'] },
    { code: 'he_IL', lang: 'he', flag: '🇮🇱', name: 'Israel', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'hi_IN', lang: 'hi', flag: '🇮🇳', name: 'India (Hindi)', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'hu_HU', lang: 'hu', flag: '🇭🇺', name: 'Hungary', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'id_ID', lang: 'id', flag: '🇮🇩', name: 'Indonesia', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'it_CH', lang: 'it', flag: '🇨🇭', name: 'Switzerland (Italian)', default:[], region: ['acom'] },
    { code: 'it_IT', lang: 'it', flag: '🇮🇹', name: 'Italy', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'ja_JP', lang: 'ja', flag: '🇯🇵', name: 'Japan', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'ko_KR', lang: 'ko', flag: '🇰🇷', name: 'South Korea', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'lt_LT', lang: 'lt', flag: '🇱🇹', name: 'Lithuania', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'lv_LV', lang: 'lv', flag: '🇱🇻', name: 'Latvia', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'ms_MY', lang: 'ms', flag: '🇲🇾', name: 'Malaysia', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'nb_NO', lang: 'nb', flag: '🇳🇴', name: 'Norway', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },
    { code: 'nl_BE', lang: 'nl', flag: '🇧🇪', name: 'Belgium (Dutch)', default:[], region: ['acom'] },
    { code: 'nl_NL', lang: 'nl', flag: '🇳🇱', name: 'Netherlands', default:['sandbox','nala','acom','express','commerce','adobe-home','docs','ccd'], region: [] },

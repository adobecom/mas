...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as ht,css as nn}from"./lit-all.min.js";var sa=`
:root {
...
`;var $t=class extends v{constructor(r){super(r)}getGlobalCSS(){return da}renderLayout(){return ha` ${this.badge}
            ...
            ${this.card.customHr?"":ha`<hr />`} ${this.secureLabelFooter}`}};import{html as le,css as on,unsafeCSS as ma}from"./lit-all.min.js";var pa=`
  :root {
...
`;var dn=32,fa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Q,He=class extends v{constructor(e){super(e);u(this,Q);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Ht` <footer>
    ...
    `);import{html as pt,css as hn,nothing as Bt}from"./lit-all.min.js";var va=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?re`
        ...
        `:re`
            ...
            <slot></slot>`}};h(de,"variantStyle",pn`
...
`;var br={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},_n=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Vt,Ka,Ye=class extends v{constructor(e){super(e);u(this,Vt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Wa}get aemFragmentMapping(){return br}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Vt,Ka).call(this))}renderLayout(){return zn`
            <div class="card">
            ...
            <slot></slot>
        `}};Vt=new WeakSet,Ka=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;_n.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ye,"variantStyle",Pn`
...
Caused by: ${this.cause}`),e}};var we={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ti=1e3;function In(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ri(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!we.serializableTypes.includes(e))return e}return a}function Fn(a,r){if(!we.ignoredProperties.includes(a))return ri(r)}var Er={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(In(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(ri).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${we.delimiter}page=${o}${c}`;l.length>ti&&(l=`${l.slice(0,ti)}<trunc>`),n+=l,i.length&&(n+=`${we.delimiter}facts=`,n+=JSON.stringify(i,Fn)),window.lana?.log(n,we)}};function ai(a){Object.assign(we,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in we&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ii={LOCAL:"local",PROD:"prod",STAGE:"stage"},kr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Cr=new Set,Sr=new Set,ni=new Map,oi={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},ci={filter:({level:a})=>a!==kr.DEBUG},$n={filter:()=>!1};function Hn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Yt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function Bn(a){[...Sr].every(r=>r(a))&&Cr.forEach(r=>r(a))}function si(a){let r=(ni.get(a)??0)+1;ni.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>si(`${t.namespace}/${i}`),updateConfig:ai};return Object.values(kr).forEach(i=>{t[i]=(n,...o)=>Bn(Hn(i,n,a,o,e))}),Object.seal(t)}function Qt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Yt(t)&&Sr.add(t),Yt(e)&&Cr.add(e)})}function qn(a={}){let{name:r}=a,e=ei(Kt("commerce.debug",{search:!0,storage:!0}),r===ii.LOCAL);return Qt(e?oi:ci),r===ii.PROD&&Qt(Er),xt}function Un(){Cr.clear(),Sr.clear()}var xt={...si(ta),Level:kr,Plugins:{consoleAppender:oi,debugFilter:ci,quietFilter:$n,lanaAppender:Er},init:qn,reset:Un,use:Qt};var jn="mas-commerce-service",Fd=xt.module("utilities"),Gn={requestId:Rt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Zt=a=>window.setTimeout(a);function Ar(){return document.getElementsByTagName(jn)?.[0]}function li(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Gn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function di(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,t*(n+1)))}throw i}var hi="fragment",pi="author",mi="preview",gi="loading",ui="mask",fi="pzn",vi="timeout",Tr="aem-fragment",bi="eager",xi="cache",Vn=[bi,xi],j,Ee,F,Lr=class{constructor(){u(this,j,new Map);u(this,Ee,new Map);u(this,F,new Map)}clear(){s(this,j).clear(),s(this,Ee).clear(),s(this,F).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(s(this,j).set(r.id,r),r.fields?.originalId&&s(this,j).set(r.fields.originalId,r),s(this,F).has(r.id)){let[,t]=s(this,F).get(r.id);t()}if(s(this,F).has(r.fields?.originalId)){let[,t]=s(this,F).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return s(this,j).has(r)}entries(){return s(this,j).entries()}get(r){return s(this,j).get(r)}getAsPromise(r){let[e]=s(this,F).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),s(this,F).set(r,[e,t]),e}getFetchInfo(r){let e=s(this,Ee).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,Ee).set(r,e)),e}set(r,e){if(s(this,j).set(r,e),s(this,F).has(r)){let[,t]=s(this,F).get(r);t()}}remove(r){s(this,j).delete(r),s(this,Ee).delete(r),s(this,F).delete(r)}};j=new WeakMap,Ee=new WeakMap,F=new WeakMap;var ne=new Lr,Ze,H,oe,$,G,z,yt,V,W,wt,K,Et,kt,Xe,Y,yi,wi,zr,Ei,Xt=class extends HTMLElement{constructor(){super(...arguments);u(this,Y);h(this,"cache",ne);u(this,Ze);u(this,H,null);u(this,oe,null);u(this,$,null);u(this,G);u(this,z);u(this,yt,bi);u(this,V);u(this,W);u(this,wt,5e3);u(this,K);u(this,Et,!1);u(this,kt,0);u(this,Xe)}static get observedAttributes(){return[hi,gi,vi,pi,mi,ui,fi]}cacheKey(){return`${s(this,G)}${s(this,W)?`-p_${s(this,W)}`:""}${s(this,V)?`-m_${s(this,V)}`:""}`}attributeChangedCallback(e,t,i){e===hi&&(m(this,G,i),m(this,z,ne.getFetchInfo(this.cacheKey()))),e===ui&&m(this,V,i),e===fi&&m(this,W,i),e===gi&&Vn.includes(i)&&m(this,yt,i),e===vi&&m(this,wt,parseInt(i,10)),e===pi&&m(this,Et,["","true"].includes(i)),e===mi&&m(this,Xe,i)}connectedCallback(){if(!s(this,K)){if(s(this,$)??m(this,$,ve(this)),m(this,Xe,s(this,$).settings?.preview),s(this,Ze)??m(this,Ze,s(this,$).log.module(`${Tr}[${s(this,G)}]`)),!s(this,G)||s(this,G)==="#"){s(this,z)??m(this,z,ne.getFetchInfo("missing-fragment-id")),y(this,Y,zr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,z)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(s(this,K)&&!await Promise.race([s(this,K),Promise.resolve(!1)]))return;e&&ne.remove(this.cacheKey()),s(this,yt)===xi&&await Promise.race([ne.getAsPromise(this.cacheKey()),new Promise(c=>setTimeout(c,s(this,wt)))]);try{m(this,K,y(this,Y,Ei).call(this)),await s(this,K)}catch(c){return y(this,Y,zr).call(this,c.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=s(this,H)||{};return o&&!Kt("mas.disableWcsCache")&&s(this,$).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Me,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...s(this,z)},bubbles:!0,composed:!0})),s(this,K)}get updateComplete(){return s(this,K)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,oe)?s(this,oe):(s(this,Et)?this.transformAuthorData():this.transformPublishData(),s(this,oe))}get rawData(){return s(this,H)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,promoProject:c,promoVariationProject:l,settings:d={},priceLiterals:p={},dictionary:g={},placeholders:f={}}=s(this,H);m(this,oe,e.reduce((k,{name:O,multiple:D,values:ge})=>(k.fields[O]=D?ge:ge[0],k),{fields:{},id:t,tags:n,settings:d,priceLiterals:p,dictionary:g,maskId:i,placeholders:f,variationId:o,promoProject:c,promoVariationProject:l}))}transformPublishData(){if(!s(this,H))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},maskId:l,placeholders:d={},variationId:p,promoProject:g,promoVariationProject:f}=s(this,H);m(this,oe,Object.entries(e).reduce((k,[O,D])=>(k.fields[O]=D?.mimeType?D.value:D??"",k),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:c,maskId:l,placeholders:d,variationId:p,promoProject:g,promoVariationProject:f}))}getFragmentClientUrl(){let e=new URLSearchParams(window.location.search),{hostname:t}=window.location,i=t.endsWith(".page")?"page":"live";return`${na(e.get("maslibs"),i)??"https://mas.adobe.com"}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:s(this,$).settings.locale,apiKey:s(this,$).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,$).settings.instant,o={...i,...n!=null?{instant:n}:{},...s(this,V)!=null?{mask:s(this,V)}:{},...s(this,W)!=null?{pzn:s(this,W)}:{}};return await t(s(this,G),o)}};Ze=new WeakMap,H=new WeakMap,oe=new WeakMap,$=new WeakMap,G=new WeakMap,z=new WeakMap,yt=new WeakMap,V=new WeakMap,W=new WeakMap,wt=new WeakMap,K=new WeakMap,Et=new WeakMap,kt=new WeakMap,Xe=new WeakMap,Y=new WeakSet,yi=async function(e){Fr(this,kt)._++;let t=`${Tr}:${this.cacheKey()}:${s(this,kt)}`,i=`${t}${Ot}`,n=`${t}${Dt}`;if(s(this,Xe)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new he(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,z).stale=!1,s(this,z).url=e,o=await di(e,{cache:"default",credentials:"omit"}),y(this,Y,wi).call(this,o),s(this,z).status=o?.status,s(this,z).measure=Oe(performance.measure(n,i)),s(this,z).retryCount=o.retryCount,!o?.ok)throw new he("Unexpected fragment response",{response:o,...s(this,$).duration});return await o.json()}catch(c){if(s(this,z).measure=Oe(performance.measure(n,i)),s(this,z).retryCount=c.retryCount,s(this,H))return s(this,z).stale=!0,s(this,Ze).error("Serving stale data",s(this,z)),s(this,H);let l=c.message??"unknown";throw new he(`Failed to fetch fragment: ${l}`,{})}},wi=function(e){Object.assign(s(this,z),li(e))},zr=function(e){m(this,K,null),s(this,z).message=e,this.classList.add("error");let t={...s(this,z),...s(this,$).duration};s(this,Ze).error(e,t),this.dispatchEvent(new CustomEvent(Re,{detail:t,bubbles:!0,composed:!0}))},Ei=async function(){var l;this.classList.remove("error"),m(this,oe,null);let e=ne.get(this.cacheKey());if(e)return m(this,H,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=s(this,$).settings,c=`${t}/fragment?id=${s(this,G)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),s(this,V)&&(c+=`&mask=${s(this,V)}`),s(this,W)&&(c+=`&pzn=${s(this,W)}`),e=await y(this,Y,yi).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,G)),s(this,V)||s(this,W)?ne.set(this.cacheKey(),e):ne.add(e),m(this,H,e),!0},h(Xt,"cache",ne);customElements.define(Tr,Xt);import{LitElement as Wn,html as Pr,css as Kn,nothing as Yn}from"./lit-all.min.js";import{unsafeHTML as Qn}from"./lit-all.min.js";var Zn=a=>a?a.startsWith("sp-icon-")?Pr`${Qn(`<${a} class="badge-icon"></${a}>`)}`:Pr`<img src="${a}" class="badge-icon" />`:Yn,Je=class extends Wn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Pr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Je);import{html as Xn,css as Jn,LitElement as eo}from"./lit-all.min.js";var Ct=class extends eo{constructor(){super()}render(){return Xn`
            <slot name="icon"></slot>

...
/**
 * List the locales a card already has variations for
 * Backs the `list_variation_locales` intent.
 */
async function main(params) {
    ...
    try {
        ...
        const result = await studioOps.listVariationLocales({ id });
        ...
        console.error('List the locales a card already has variations for error:', error);
        return {
            statusCode: 500,

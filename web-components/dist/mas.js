...
`,uc=()=>[b`
    ...
    `);customElements.define("merch-addon",Gt);_();var qt,Yr=class Yr{constructor(t){m(this,"card");w(this,qt);this.card=t,this.insertVariantStyle()}getContainer(){return y(this,qt,p(this,qt)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),p(this,qt)}insertVariantStyle(){let t=this.constructor.name;if(!Yr.styleMap[t]){Yr.styleMap[t]=!0;let r=document.createElement("style");r.innerHTML=this.getGlobalCSS(),document.head.appendChild(r)}}updateCardElementMinHeight(t,r){if(!t||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),g`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return ji(this.card.variant)}};qt=new WeakMap,m(Yr,"styleMap",{});var A=Yr;_();var gc=`
:root {
...
`;var Wi=class extends A{constructor(t){super(t)}getGlobalCSS(){return bc}renderLayout(){return g` ${this.badge}
            ...
            ${this.card.customHr?"":g`<hr />`} ${this.secureLabelFooter}`}};_();var yc=`
  :root {
...
`;var Yi={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Cc={...function(){let{whatsIncluded:e,size:t,...r}=Yi;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Tc={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...a}=Yi;return a}()},Ne,ge=class extends A{constructor(r){super(r);w(this,Ne);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(r,i){r.dataset.template===xe&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Sc}adjustSlotPlacement(r,i,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${r}"]`),l=n.querySelector(`.body slot[name="${r}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!i.includes(s)){if(o?.classList.toggle("wide-footer",R.isDesktopOrUp),!a&&c){if(l)c.remove();else{let h=d.querySelector(`[data-placeholder-for="${r}"]`);h?h.replaceWith(c):d.appendChild(c)}return}if(a&&l){let h=document.createElement("div");if(h.setAttribute("data-placeholder-for",r),h.classList.add("slot-placeholder"),!c){let u=l.cloneNode(!0);o.prepend(u)}l.replaceWith(h)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],R.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],R.isDesktopOrUp)}adjustCallout(){let r=this.card.querySelector('[slot="callout-content"] .icon-button');r&&r.title&&(r.dataset.tooltip=r.title,r.removeAttribute("title"),r.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==r?r.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==r?r.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){p(this,Ne)||(y(this,Ne,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(p(this,Ne)?.disconnect(),y(this,Ne,null),this.syncHeights())})),p(this,Ne).observe(this.card));return}["heading-xs","subtitle","heading-m","promo-text","body-xs"].forEach(i=>{let a=this.card.querySelector(`[slot="${i}"]`);a&&this.updateCardElementMinHeight(a,i)})}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),i.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Nr(d));let h=this.card.querySelector('[slot="subtitle"]');h&&(l+=Nr(h));let u=this.card.querySelector('[slot="heading-m"]');u&&(l+=8+Nr(u));for(let x of i.childNodes){if(x.classList.contains("spacer"))break;l+=Nr(x)}let f=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(f)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){if(this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),window.matchMedia("(min-width: 768px)").matches){let r=this.getContainer();if(!r)return;let i=`--consonant-merch-card-${this.card.variant}`,a=r.style.getPropertyValue(`${i}-heading-xs-height`);requestAnimationFrame(a?()=>{this.syncHeights()}:()=>{r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(o=>o.variantLayout?.syncHeights?.())})}}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${D}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?g`<div class="divider"></div>`:E}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=[],i=this.card.querySelector(`[slot="heading-m"] ${D}[data-template="price"]`);i&&r.push(i);let a=r.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let r=this.card.addon;if(!r)return;r.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(r.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?g`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Ne=new WeakMap,m(ge,"variantStyle",b`
        :host([variant^='plans']) {
            min-height: 273px;
...
`;document.head.appendChild(Wc);var Yc="fragment",Xc="author",Kc="preview",Qc="loading",Zc="timeout",Dn="aem-fragment",Jc="eager",el="cache",ap=[Jc,el],Ie,At,_e,$n=class{constructor(){w(this,Ie,new Map);w(this,At,new Map);w(this,_e,new Map)}clear(){p(this,Ie).clear(),p(this,At).clear(),p(this,_e).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(p(this,Ie).set(t.id,t),t.fields?.originalId&&p(this,Ie).set(t.fields.originalId,t),p(this,_e).has(t.id)){let[,i]=p(this,_e).get(t.id);i()}if(p(this,_e).has(t.fields?.originalId)){let[,i]=p(this,_e).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return p(this,Ie).has(t)}entries(){return p(this,Ie).entries()}get(t){return p(this,Ie).get(t)}getAsPromise(t){let[r]=p(this,_e).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),p(this,_e).set(t,[r,i]),r}getFetchInfo(t){let r=p(this,At).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},p(this,At).set(t,r)),r}remove(t){p(this,Ie).delete(t),p(this,At).delete(t),p(this,_e).delete(t)}};Ie=new WeakMap,At=new WeakMap,_e=new WeakMap;var Ze=new $n,ir,Pe,qe,Ee,fe,J,Xr,Kr,Le,Qr,Zr,ar,Me,tl,rl,Hn,il,Ki=class extends HTMLElement{constructor(){super(...arguments);w(this,Me);m(this,"cache",Ze);w(this,ir);w(this,Pe,null);w(this,qe,null);w(this,Ee,null);w(this,fe);w(this,J);w(this,Xr,Jc);w(this,Kr,5e3);w(this,Le);w(this,Qr,!1);w(this,Zr,0);w(this,ar)}static get observedAttributes(){return[Yc,Qc,Zc,Xc,Kc]}attributeChangedCallback(r,i,a){r===Yc&&(y(this,fe,a),y(this,J,Ze.getFetchInfo(a))),r===Qc&&ap.includes(a)&&y(this,Xr,a),r===Zc&&y(this,Kr,parseInt(a,10)),r===Xc&&y(this,Qr,["","true"].includes(a)),r===Kc&&y(this,ar,a)}connectedCallback(){if(!p(this,Le)){if(p(this,Ee)??y(this,Ee,ut(this)),y(this,ar,p(this,Ee).settings?.preview),p(this,ir)??y(this,ir,p(this,Ee).log.module(`${Dn}[${p(this,fe)}]`)),!p(this,fe)||p(this,fe)==="#"){p(this,J)??y(this,J,Ze.getFetchInfo("missing-fragment-id")),Z(this,Me,Hn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(p(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(p(this,Le)&&!await Promise.race([p(this,Le),Promise.resolve(!1)]))return;r&&Ze.remove(p(this,fe)),p(this,Xr)===el&&await Promise.race([Ze.getAsPromise(p(this,fe)),new Promise(s=>setTimeout(s,p(this,Kr)))]);try{y(this,Le,Z(this,Me,il).call(this)),await p(this,Le)}catch(s){return Z(this,Me,Hn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=p(this,Pe)||{};return o&&!F("mas.disableWcsCache")&&p(this,Ee).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(nt,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...p(this,J)},bubbles:!0,composed:!0})),p(this,Le)}get updateComplete(){return p(this,Le)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return p(this,qe)?p(this,qe):(p(this,Qr)?this.transformAuthorData():this.transformPublishData(),p(this,qe))}get rawData(){return p(this,Pe)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=p(this,Pe),d=Array.isArray(r)?r:[];y(this,qe,d.reduce((h,{name:u,multiple:f,values:x})=>(h.fields[u]=f?x:x[0],h),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=p(this,Pe);y(this,qe,Object.entries(r).reduce((d,[h,u])=>(d.fields[h]=u?.mimeType?u.value:u??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(p(this,fe),{locale:p(this,Ee).settings.locale,apiKey:p(this,Ee).settings.wcsApiKey})}};ir=new WeakMap,Pe=new WeakMap,qe=new WeakMap,Ee=new WeakMap,fe=new WeakMap,J=new WeakMap,Xr=new WeakMap,Kr=new WeakMap,Le=new WeakMap,Qr=new WeakMap,Zr=new WeakMap,ar=new WeakMap,Me=new WeakSet,tl=async function(r){ro(this,Zr)._++;let i=`${Dn}:${p(this,fe)}:${p(this,Zr)}`,a=`${i}${ct}`,n=`${i}${lt}`;if(p(this,ar))return await this.generatePreview();performance.mark(a);let o;try{if(p(this,J).stale=!1,p(this,J).url=r,o=await zi(r,{cache:"default",credentials:"omit"}),Z(this,Me,rl).call(this,o),p(this,J).status=o?.status,p(this,J).measure=Oe(performance.measure(n,a)),p(this,J).retryCount=o.retryCount,!o?.ok)throw new $e("Unexpected fragment response",{response:o,...p(this,Ee).duration});return await o.json()}catch(s){if(p(this,J).measure=Oe(performance.measure(n,a)),p(this,J).retryCount=s.retryCount,p(this,Pe))return p(this,J).stale=!0,p(this,ir).error("Serving stale data",p(this,J)),p(this,Pe);let c=s.message??"unknown";throw new $e(`Failed to fetch fragment: ${c}`,{})}},rl=function(r){Object.assign(p(this,J),yi(r))},Hn=function(r){y(this,Le,null),p(this,J).message=r,this.classList.add("error");let i={...p(this,J),...p(this,Ee).duration};p(this,ir).error(r,i),this.dispatchEvent(new CustomEvent(ot,{detail:i,bubbles:!0,composed:!0}))},il=async function(){var c;this.classList.remove("error"),y(this,qe,null);let r=Ze.get(p(this,fe));if(r)return y(this,Pe,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=p(this,Ee).settings,s=`${i}/fragment?id=${p(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Me,tl).call(this,s),(c=r.fields).originalId??(c.originalId=p(this,fe)),Ze.add(r),y(this,Pe,r),!0},m(Ki,"cache",Ze);customElements.define(Dn,Ki);_();Gr();var al={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},nl=e=>(...t)=>({_$litDirective$:e,values:t}),Qi=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,i){this._$Ct=t,this._$AM=r,this._$Ci=i}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};var Jr=class extends Qi{constructor(t){if(super(t),this.et=E,t.type!==al.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===E||t==null)return this.ft=void 0,this.et=t;if(t===Ge)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let r=[t];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};Jr.directiveName="unsafeHTML",Jr.resultType=1;var ol=nl(Jr);var np=e=>e?e.startsWith("sp-icon-")?g`${ol(`<${e} class="badge-icon"></${e}>`)}`:g`<img src="${e}" class="badge-icon" />`:E,nr=class extends U{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return g`<div class="badge">
    ...
    `);customElements.define("merch-badge",nr);_();var ei=class extends U{constructor(){super()}render(){return g`
            <slot name="icon"></slot>
    ...
    `),m(ei,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ei);_();var ti=class extends U{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return g`<slot name="heading"></slot>
    ...
    `),m(ni,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",ni);_();_();var fl=b`
    :host {
...
`;var[U0,G0,qn,Vn,vl,bl]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var jn=class extends U{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return xl}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=Or(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=Or(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(Lt,this.debouncedQuantityUpdate)}get button(){return this.shadowRoot.querySelector("button")}handleKeyup(t){t.key===Vn||t.key===qn||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let t=this.options[this.highlightedIndex];if(!t){this.closed=!0;return}this.selectedValue=t,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(t){switch(t.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case bl:this.selectValue();break;case Vn:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,t.preventDefault();break;case qn:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),t.preventDefault();break;case vl:this.selectValue(),this.button.classList.contains("focused")&&t.preventDefault();break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=t.value.replace(/\D/g,"");t.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let a=i;this.maxInput&&i>this.maxInput&&(a=this.maxInput),this.min&&a<this.min&&(a=this.min),this.adjustInput(t,a)}else this.adjustInput(t,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(Lt,this.debouncedQuantityUpdate)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}update(t){(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue"))&&(this.options=this.generateOptionsArray(),this.highlightedIndex=this.defaultValue?this.options.indexOf(this.defaultValue):0,this.handleMenuOption(this.defaultValue?this.defaultValue:this.options[0])),super.update(t)}handleClickOutside(t){t.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let t=this.shadowRoot.querySelector(".popover");this.closed||t.getBoundingClientRect().bottom<=window.innerHeight?t.setAttribute("placement","bottom"):t.setAttribute("placement","top")}handleMouseEnter(t){this.highlightedIndex=t}handleMenuOption(t,r){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let t=new CustomEvent(te,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}get configured(){return this.title||this.min||this.step}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return g` <div
        ...
        `:E}};customElements.define("merch-quantity-select",jn);qi();_();var yl=`

var xr=Object.defineProperty;var yr=a=>{throw TypeError(a)};var li=(a,t,e)=>t in a?xr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var di=(a,t)=>()=>(a&&(t=a(a=0)),t);var hi=(a,t)=>{for(var e in t)xr(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>li(a,typeof t!="symbol"?t+"":t,e),jt=(a,t,e)=>t.has(a)||yr("Cannot "+e);var c=(a,t,e)=>(jt(a,t,"read from private field"),e?e.call(a):t.get(a)),f=(a,t,e)=>t.has(a)?yr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(jt(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),C=(a,t,e)=>(jt(a,t,"access private method"),e);var wr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return c(a,t,r)}});var Vt={};hi(Vt,{default:()=>Je});import{LitElement as pi,html as ke,css as mi,nothing as gi}from"./lit-all.min.js";import{unsafeHTML as Tr}from"./lit-all.min.js";import{ifDefined as ui}from"./lit-all.min.js";function fi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var _,Je,Wt=di(()=>{_=class _ extends pi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();_.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),h=l?l.offsetWidth:o,p=l?l.offsetHeight:s,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>i?u="top":u==="left"&&e.left-h-n<0?u="right":u==="right"&&e.right+h+n>r&&(u="left");let A=e.left+e.width/2,$=e.top+e.height/2,J=6,bt=(oi,si,ci)=>Math.max(oi,Math.min(si,ci)),xt,yt,Gt;u==="top"||u==="bottom"?(xt=u==="top"?e.top-p-n:e.bottom+n,yt=bt(0,r-h,A-h/2),Gt=bt(J,h-J*2,A-yt-J)):(yt=u==="left"?e.left-h-n:e.right+n,xt=bt(0,i-p,$-p/2),Gt=bt(J,p-J*2,$-xt-J)),this._tooltipTop=xt,this._tooltipLeft=yt,this._arrowOffset=Gt,this._computedPlacement=u}showTooltip(){_.activeTooltip&&_.activeTooltip!==this&&(_.activeTooltip.closeOverlay(),_.activeTooltip.tooltipVisible=!1,_.activeTooltip.requestUpdate()),_.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){_.activeTooltip===this&&(_.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?ke`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:ke`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return ke`<span class="icon-only">${this.renderIcon()}</span>`;if(fi())return ke`
                <overlay-trigger
                    placement="${e}"
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${ui(h)}>
                    ${Tr(t)}
    ...
    `);Je=_;customElements.define("mas-mnemonic",Je)});import{LitElement as oo}from"./lit-all.min.js";import{css as Sr,unsafeCSS as Cr}from"./lit-all.min.js";var w="(max-width: 767px)",T="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",L="(min-width: 1600px)",Er="(min-width: 1280px)",kr={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${L})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=kr;function wt(){return kr.isDesktop}var Ar=Sr`
    :host {
...
`,zr=()=>[Sr`
        ...
        `];import{LitElement as vi,html as Lr,css as bi}from"./lit-all.min.js";function xi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Ce=class extends vi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(xi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Wt())}e.remove()})}render(){let{href:t}=this;return t?Lr`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(Ce,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(Ce,"styles",bi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Ce);var Eo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ko=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var Se=2e4;var y='span[is="inline-price"][data-wcs-osi]',Q='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var yi='a[is="upt-link"]',Pr=`${y},${Q},${yi}`;var _r="merch-offer-select:ready",Mr="merch-card:action-menu-toggle";var M="merch-quantity-selector:change",Rr="merch-card-quantity:change",Kt="merch-modal:addon-and-quantity-update";var Ae="merch-card-collection:literals-changed";var ze="aem:load",Te="aem:error",Et="mas:ready",Or="mas:error",Dr="placeholder-failed",Nr="placeholder-pending",Fr="placeholder-resolved";var Ir="mas:failed",ee="mas:resolved",$r="mas/commerce";var te="failed",de="pending",re="resolved";var kt="X-Request-Id",Co=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var So=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Ct=":start",St=":duration";var R="legal",Br="mas-ff-defaults";var wi="mas-commerce-service";function Hr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function P(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function Le(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function Yt(){return window.matchMedia("(max-width: 1024px)").matches}function he(){return document.getElementsByTagName(wi)?.[0]}function et(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}function qr(a){let t=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&t?.isInlinePrice&&t?.dataset?.template==="price"}var tt,pe,rt,at,Pe,At=class extends HTMLElement{constructor(){super();f(this,tt,"");f(this,pe);f(this,rt,[]);f(this,at,[]);f(this,Pe);m(this,Pe,Hr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,pe)?this.parentElement.style.borderRadius=c(this,pe):c(this,pe)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,rt).map((r,i)=>{let n=c(this,at)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,tt)}, ${e})`}connectedCallback(){c(this,Pe).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,pe,i?.trim()),e==="colors"&&i?m(this,rt,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,at,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,tt,i?.trim()??""),c(this,Pe).call(this)}};tt=new WeakMap,pe=new WeakMap,rt=new WeakMap,at=new WeakMap,Pe=new WeakMap;customElements.define("merch-gradient",At);import{LitElement as Ei,html as ki,css as Ci}from"./lit-all.min.js";var _e=class extends Ei{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(ee,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(ee,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return ki` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(_e,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),d(_e,"styles",Ci`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as nt,css as zi}from"./lit-all.min.js";var jr=`
:root {
...
`;var Vr={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},me=class extends b{constructor(t){super(t)}getGlobalCSS(){return jr}renderLayout(){return nt`<div class="image">
    ...
    `);import{html as Kr}from"./lit-all.min.js";var Wr=`
:root {
...
`;var Lt=class extends b{constructor(t){super(t)}getGlobalCSS(){return Wr}renderLayout(){return Kr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Kr`<hr />`} ${this.secureLabelFooter}`}};import{html as ae,css as Ti,unsafeCSS as Qr}from"./lit-all.min.js";var Yr=`
  :root {
...
`;var Li=32,Zr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Oe=class extends b{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ae`<slot name="secure-transaction-label">
    ...
    `);import{html as Pt,css as Pi,unsafeCSS as Jr,nothing as _i}from"./lit-all.min.js";var Xr=`
  :root {
...
`;var Mi=32,ea={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},De=class extends b{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>Pt` <footer>
    ...
    `);import{html as ot,css as Ri,nothing as _t}from"./lit-all.min.js";var ta=`
:root {
...
`;var Mt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ra={...function(){let{whatsIncluded:a,size:t,...e}=Mt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},aa={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=Mt;return i}()},j,V,O=class extends b{constructor(e){super(e);f(this,j);f(this,V);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===R&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ta}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let l=n.querySelector(`footer slot[name="${e}"]`),h=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(s)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&l){if(h)l.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(l):p.appendChild(l)}return}if(i&&h){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!l){let u=h.cloneNode(!0);o.prepend(u)}h.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){c(this,j)||(m(this,j,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(c(this,j)?.disconnect(),m(this,j,null),this.syncHeights())})),c(this,j).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let s=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let h=0,p=this.card.querySelector('[slot="heading-s"]');p&&(h+=et(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(h+=et(g));let u=this.card.querySelector('[slot="heading-m"]');u&&(h+=8+et(u));for(let $ of r.childNodes){if($.classList.contains("spacer"))break;h+=et($)}let A=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");h>(parseFloat(A)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${h}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${h}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?ot`<div class="divider"></div>`:_t}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?ot`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};j=new WeakMap,V=new WeakMap,d(O,"variantStyle",Ri`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?Z`
        ...
        `:Z`
            ...
            <slot></slot>`}};d(ie,"variantStyle",Oi`
...
`;var ca={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ne,ue,st,Ne=class extends b{constructor(){super(...arguments);f(this,ue);d(this,"expanded",!1);d(this,"licenseOpen",!1);d(this,"licenseQty",null);f(this,ne,null);d(this,"toggleExpanded",e=>{e.preventDefault(),this.expanded=!this.expanded,this.card.requestUpdate()});d(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen=!this.licenseOpen,this.licenseOpen?(m(this,ne,r=>{r.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),C(this,ue,st).call(this))}),document.addEventListener("mousedown",c(this,ne))):C(this,ue,st).call(this),this.card.requestUpdate()});d(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,C(this,ue,st).call(this);let r=this.quantitySelectEl;r&&(r.selectedValue=Number(e),r.dispatchEvent(new CustomEvent(M,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return sa}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasPriceOriginal(){return!!this.card.querySelector('[slot="price-original"]')}get hasTermsLink(){return!!this.card.querySelector('[slot="terms-link"]')}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),await super.postCardUpdateHook()}disconnectedCallbackHook(){C(this,ue,st).call(this)}get hasLegalText(){return!!this.card.querySelector('[slot="legal-text"]')}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let r=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(r)||Number.isNaN(i)||i<r)return null;let o=[];for(let s=r;s<=i;s+=n)o.push(String(s));return o.length?o:null}get licenseLabel(){return this.quantitySelectEl?.getAttribute("title")||"License"}get licenseLabelPlural(){return`${this.licenseLabel}s`}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let r=this.quantitySelectEl?.getAttribute("default-value");return r!=null&&e.includes(r)?r:e[0]}formatLicenseRow(e){let i=String(e).replace(/\D/g,"")==="1"?this.licenseLabel:this.licenseLabelPlural;return{value:e,label:i}}renderLicenseSelector(){if(!this.hasLicenseSelector)return B`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,r=this.currentLicenseValue,i=!!this.licenseOpen,{value:n,label:o}=this.formatLicenseRow(r);return B`
        ...
        `}renderLayout(){let e=!!this.expanded;return B`
            ...
            ${this.hasWhatsIncluded?B`
                  ...
                  `:ge}
            <slot></slot>
        `}};ne=new WeakMap,ue=new WeakSet,st=function(){c(this,ne)&&(document.removeEventListener("mousedown",c(this,ne)),m(this,ne,null))},d(Ne,"variantStyle",Di`
    ...
    `);import{html as Zt,css as Ni}from"./lit-all.min.js";var la=`
:root {
...
`;var da={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},W,Fe=class extends b{constructor(e){super(e);f(this,W);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return la}priceOptionsProvider(e,r){e.dataset.template===R&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Zt` ${this.badge}
    ...
    `);import{html as Xt,css as Fi}from"./lit-all.min.js";var ha=`
:root {
...
`;var pa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ie=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===R&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ha}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Xt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Ii,css as $i}from"./lit-all.min.js";var ma=`
...
`;var ga={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},$e=class extends b{constructor(t){super(t)}getGlobalCSS(){return ma}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Ii`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as Jt,css as Bi}from"./lit-all.min.js";var ua=`
:root {
...
`;var fa={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Be=class extends b{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ua}renderLayout(){return Jt`${this.cardImage}
            ...
            ${this.evergreen?Jt`
                  ...
                  `:Jt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(Be,"variantStyle",Bi`
    ...
    `);import{html as Hi,css as qi}from"./lit-all.min.js";var va=`
:root {
...
`;var er={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},He=class extends b{getGlobalCSS(){return va}get aemFragmentMapping(){return er}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;if(!t)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(t.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",s)})}),x.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!wt()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let t=this.getContainer();t&&t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t<=2||t===this.lastSyncedWidth||(this.lastSyncedWidth=t,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(wt())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};e();let r=window.matchMedia(w);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(w).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||wt())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return Hi`
    ...
    `);import{html as xa,css as Ui}from"./lit-all.min.js";var ba=`
:root {
...
`;var tr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},qe=class extends b{getGlobalCSS(){return ba}get aemFragmentMapping(){return tr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return xa`
    ...
    `);import{html as rr,css as Gi,nothing as ji}from"./lit-all.min.js";var ya=`
...
`;var wa={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Vi=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Ue=class extends b{constructor(t){super(t)}getGlobalCSS(){return ya}renderLayout(){return rr`
    ...
    `);import{css as Wi,html as Ki}from"./lit-all.min.js";var Ea=`
...
`;var ka={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ge=class extends b{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Ea}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ki`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Yi,css as Qi}from"./lit-all.min.js";var Ca=`
...
`;var ar={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},je=class extends b{getGlobalCSS(){return Ca}get aemFragmentMapping(){return ar}renderLayout(){return Yi`
    ...
    `);var Ot=new Map,Sa=new WeakMap,Aa=new Map,k=(a,t,e=null,r=null,i)=>{Ot.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",Re,Gr,Re.variantStyle);k("image",me);k("inline-heading",Lt);k("mini-compare-chart",Oe,Zr,Oe.variantStyle);k("mini-compare-chart-mweb",De,ea,De.variantStyle);k("plans",O,Mt,O.variantStyle,O.collectionOptions);k("plans-students",O,aa,O.variantStyle,O.collectionOptions);k("plans-education",O,ra,O.variantStyle,O.collectionOptions);k("plans-v2",ie,oa,ie.variantStyle,ie.collectionOptions);k("plans-bizpro",Ne,ca,Ne.variantStyle);k("product",Fe,da,Fe.variantStyle);k("segment",Ie,pa,Ie.variantStyle);k("media",$e,ga,$e.variantStyle);k("headless",Ue,wa,Ue.variantStyle);k("special-offers",Be,fa,Be.variantStyle);k("simplified-pricing-express",He,er,He.variantStyle);k("full-pricing-express",qe,tr,qe.variantStyle);k("mini",Ge,ka,Ge.variantStyle);k("image",me,Vr,me.variantStyle);k("fries",je,ar,je.variantStyle);var Zi=(a,t,e)=>{try{let r=Aa.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),Aa.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},ir=a=>{let t=Ot.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=Sa.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?Zi(a,r,i):{};return Sa.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Tt(a){return Ot.get(a)?.fragmentMapping}function za(a){return Ot.get(a)?.collectionOptions}var Ta=document.createElement("style");Ta.innerHTML=`
:root {
...
`;document.head.appendChild(Ta);function Dt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=nr(r)?r:a;n=o.get(s)}if(i&&n==null){let o=nr(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Ji(nr(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var Xi=a=>typeof a=="boolean",Nt=a=>typeof a=="function";var nr=a=>typeof a=="string";function La(a,t){if(Xi(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Ji(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var oe=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(kt);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var fe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Pa=1e3;function en(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function _a(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!fe.serializableTypes.includes(e))return e}return a}function tn(a,t){if(!fe.ignoredProperties.includes(a))return _a(t)}var or={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(h=>{h!=null&&(en(h)?r:i).push(h)}),r.length&&(n+=` ${r.map(_a).join(" ")}`);let{pathname:o,search:s}=window.location,l=`${fe.delimiter}page=${o}${s}`;l.length>Pa&&(l=`${l.slice(0,Pa)}<trunc>`),n+=l,i.length&&(n+=`${fe.delimiter}facts=`,n+=JSON.stringify(i,tn)),window.lana?.log(n,fe)}};function Ma(a){Object.assign(fe,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in fe&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Ra={LOCAL:"local",PROD:"prod",STAGE:"stage"},sr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},cr=new Set,lr=new Set,Oa=new Map,Da={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Na={filter:({level:a})=>a!==sr.DEBUG},rn={filter:()=>!1};function an(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Nt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function nn(a){[...lr].every(t=>t(a))&&cr.forEach(t=>t(a))}function Fa(a){let t=(Oa.get(a)??0)+1;Oa.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Fa(`${r.namespace}/${i}`),updateConfig:Ma};return Object.values(sr).forEach(i=>{r[i]=(n,...o)=>nn(an(i,n,a,o,e))}),Object.seal(r)}function Ft(...a){a.forEach(t=>{let{append:e,filter:r}=t;Nt(r)&&lr.add(r),Nt(e)&&cr.add(e)})}function on(a={}){let{name:t}=a,e=La(Dt("commerce.debug",{search:!0,storage:!0}),t===Ra.LOCAL);return Ft(e?Da:Na),t===Ra.PROD&&Ft(or),ct}function sn(){cr.clear(),lr.clear()}var ct={...Fa($r),Level:sr,Plugins:{consoleAppender:Da,debugFilter:Na,quietFilter:rn,lanaAppender:or},init:on,reset:sn,use:Ft};var cn="mas-commerce-service",Ul=ct.module("utilities"),ln={requestId:kt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var It=a=>window.setTimeout(a);function dr(){return document.getElementsByTagName(cn)?.[0]}function Ia(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(ln)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function $a(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw i}var Ba="fragment",Ha="author",qa="preview",Ua="loading",Ga="timeout",hr="aem-fragment",ja="eager",Va="cache",dn=[ja,Va],K,ve,H,pr=class{constructor(){f(this,K,new Map);f(this,ve,new Map);f(this,H,new Map)}clear(){c(this,K).clear(),c(this,ve).clear(),c(this,H).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,K).set(t.id,t),t.fields?.originalId&&c(this,K).set(t.fields.originalId,t),c(this,H).has(t.id)){let[,r]=c(this,H).get(t.id);r()}if(c(this,H).has(t.fields?.originalId)){let[,r]=c(this,H).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,K).has(t)}entries(){return c(this,K).entries()}get(t){return c(this,K).get(t)}getAsPromise(t){let[e]=c(this,H).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),c(this,H).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ve).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ve).set(t,e)),e}remove(t){c(this,K).delete(t),c(this,ve).delete(t),c(this,H).delete(t)}};K=new WeakMap,ve=new WeakMap,H=new WeakMap;var se=new pr,Ve,q,X,N,D,z,lt,dt,U,ht,pt,We,G,Wa,Ka,mr,Ya,$t=class extends HTMLElement{constructor(){super(...arguments);f(this,G);d(this,"cache",se);f(this,Ve);f(this,q,null);f(this,X,null);f(this,N,null);f(this,D);f(this,z);f(this,lt,ja);f(this,dt,5e3);f(this,U);f(this,ht,!1);f(this,pt,0);f(this,We)}static get observedAttributes(){return[Ba,Ua,Ga,Ha,qa]}attributeChangedCallback(e,r,i){e===Ba&&(m(this,D,i),m(this,z,se.getFetchInfo(i))),e===Ua&&dn.includes(i)&&m(this,lt,i),e===Ga&&m(this,dt,parseInt(i,10)),e===Ha&&m(this,ht,["","true"].includes(i)),e===qa&&m(this,We,i)}connectedCallback(){if(!c(this,U)){if(c(this,N)??m(this,N,he(this)),m(this,We,c(this,N).settings?.preview),c(this,Ve)??m(this,Ve,c(this,N).log.module(`${hr}[${c(this,D)}]`)),!c(this,D)||c(this,D)==="#"){c(this,z)??m(this,z,se.getFetchInfo("missing-fragment-id")),C(this,G,mr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,z)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,U)&&!await Promise.race([c(this,U),Promise.resolve(!1)]))return;e&&se.remove(c(this,D)),c(this,lt)===Va&&await Promise.race([se.getAsPromise(c(this,D)),new Promise(s=>setTimeout(s,c(this,dt)))]);try{m(this,U,C(this,G,Ya).call(this)),await c(this,U)}catch(s){return C(this,G,mr).call(this,s.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=c(this,q)||{};return o&&!Dt("mas.disableWcsCache")&&c(this,N).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ze,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...c(this,z)},bubbles:!0,composed:!0})),c(this,U)}get updateComplete(){return c(this,U)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,X)?c(this,X):(c(this,ht)?this.transformAuthorData():this.transformPublishData(),c(this,X))}get rawData(){return c(this,q)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:s={},dictionary:l={},placeholders:h={}}=c(this,q);m(this,X,e.reduce((p,{name:g,multiple:u,values:A})=>(p.fields[g]=u?A:A[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:s,dictionary:l,placeholders:h,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={},variationId:h}=c(this,q);m(this,X,Object.entries(e).reduce((p,[g,u])=>(p.fields[g]=u?.mimeType?u.value:u??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:s,placeholders:l,variationId:h}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:c(this,N).settings.locale,apiKey:c(this,N).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??c(this,N).settings.instant;return n&&(i.instant=n),await r(c(this,D),i)}};Ve=new WeakMap,q=new WeakMap,X=new WeakMap,N=new WeakMap,D=new WeakMap,z=new WeakMap,lt=new WeakMap,dt=new WeakMap,U=new WeakMap,ht=new WeakMap,pt=new WeakMap,We=new WeakMap,G=new WeakSet,Wa=async function(e){wr(this,pt)._++;let r=`${hr}:${c(this,D)}:${c(this,pt)}`,i=`${r}${Ct}`,n=`${r}${St}`;if(c(this,We)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new oe(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(c(this,z).stale=!1,c(this,z).url=e,o=await $a(e,{cache:"default",credentials:"omit"}),C(this,G,Ka).call(this,o),c(this,z).status=o?.status,c(this,z).measure=Le(performance.measure(n,i)),c(this,z).retryCount=o.retryCount,!o?.ok)throw new oe("Unexpected fragment response",{response:o,...c(this,N).duration});return await o.json()}catch(s){if(c(this,z).measure=Le(performance.measure(n,i)),c(this,z).retryCount=s.retryCount,c(this,q))return c(this,z).stale=!0,c(this,Ve).error("Serving stale data",c(this,z)),c(this,q);let l=s.message??"unknown";throw new oe(`Failed to fetch fragment: ${l}`,{})}},Ka=function(e){Object.assign(c(this,z),Ia(e))},mr=function(e){m(this,U,null),c(this,z).message=e,this.classList.add("error");let r={...c(this,z),...c(this,N).duration};c(this,Ve).error(e,r),this.dispatchEvent(new CustomEvent(Te,{detail:r,bubbles:!0,composed:!0}))},Ya=async function(){var l;this.classList.remove("error"),m(this,X,null);let e=se.get(c(this,D));if(e)return m(this,q,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=c(this,N).settings,s=`${r}/fragment?id=${c(this,D)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await C(this,G,Wa).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,D)),se.add(e),m(this,q,e),!0},d($t,"cache",se);customElements.define(hr,$t);import{LitElement as hn,html as gr,css as pn,nothing as mn}from"./lit-all.min.js";import{unsafeHTML as gn}from"./lit-all.min.js";var un=a=>a?a.startsWith("sp-icon-")?gr`${gn(`<${a} class="badge-icon"></${a}>`)}`:gr`<img src="${a}" class="badge-icon" />`:mn,Ke=class extends hn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return gr`<div class="badge">
            ${un(this.icon)}<slot>${this.text}</slot>
        </div>`}};d(Ke,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),d(Ke,"styles",pn`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Ke);import{html as fn,css as vn,LitElement as bn}from"./lit-all.min.js";var mt=class extends bn{constructor(){super()}render(){return fn`
            <slot name="icon"></slot>
    ...
    `),d(mt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",mt);import{html as ur,css as xn,LitElement as yn,nothing as Qa}from"./lit-all.min.js";var gt=class extends yn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return ur`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?ur`<slot name="content"></slot>`:Qa}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?ur`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Qa}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(gt,"styles",xn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

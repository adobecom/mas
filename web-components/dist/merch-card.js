...
Caused by: ${this.cause}`),e}};var re={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ur=1e3;function Vi(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function jr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!re.serializableTypes.includes(e))return e}return i}function Yi(i,t){if(!re.ignoredProperties.includes(i))return jr(t)}var Ot={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(h=>{h!=null&&(Vi(h)?r:a).push(h)}),r.length&&(n+=" "+r.map(jr).join(" "));let{pathname:o,search:s}=window.location,d=`${re.delimiter}page=${o}${s}`;d.length>Ur&&(d=`${d.slice(0,Ur)}<trunc>`),n+=d,a.length&&(n+=`${re.delimiter}facts=`,n+=JSON.stringify(a,Yi)),window.lana?.log(n,re)}};function Gr(i){Object.assign(re,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in re&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Vr={LOCAL:"local",PROD:"prod",STAGE:"stage"},Dt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Nt=new Set,$t=new Set,Yr=new Map,Kr={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},Wr={filter:({level:i})=>i!==Dt.DEBUG},Ki={filter:()=>!1};function Wi(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&gt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function Qi(i){[...$t].every(t=>t(i))&&Nt.forEach(t=>t(i))}function Qr(i){let t=(Yr.get(i)??0)+1;Yr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>Qr(`${r.namespace}/${a}`),updateConfig:Gr};return Object.values(Dt).forEach(a=>{r[a]=(n,...o)=>Qi(Wi(a,n,i,o,e))}),Object.seal(r)}function ut(...i){i.forEach(t=>{let{append:e,filter:r}=t;gt(r)&&$t.add(r),gt(e)&&Nt.add(e)})}function Xi(i={}){let{name:t}=i,e=qr(mt("commerce.debug",{search:!0,storage:!0}),t===Vr.LOCAL);return ut(e?Kr:Wr),t===Vr.PROD&&ut(Ot),Ue}function Zi(){Nt.clear(),$t.clear()}var Ue={...Qr(mr),Level:Dt,Plugins:{consoleAppender:Kr,debugFilter:Wr,quietFilter:Ki,lanaAppender:Ot},init:Xi,reset:Zi,use:ut};var Ji="mas-commerce-service",Fs=Ue.module("utilities"),ea={requestId:et,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ft=i=>window.setTimeout(i);function Ft(){return document.getElementsByTagName(Ji)?.[0]}function Xr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(ea)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Zr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Jr="fragment",ei="author",ti="preview",ri="loading",ii="timeout",It="aem-fragment",ai="eager",ni="cache",ta=[ai,ni],I,ie,D,Bt=class{constructor(){g(this,I,new Map);g(this,ie,new Map);g(this,D,new Map)}clear(){c(this,I).clear(),c(this,ie).clear(),c(this,D).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,D).has(t.id)){let[,r]=c(this,D).get(t.id);r()}if(c(this,D).has(t.fields?.originalId)){let[,r]=c(this,D).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,D).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,D).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ie).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ie).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,ie).delete(t),c(this,D).delete(t)}};I=new WeakMap,ie=new WeakMap,D=new WeakMap;var W=new Bt,Te,N,U,R,_,k,je,Ge,$,Ve,Ye,Le,F,oi,si,Ht,ci,xt=class extends HTMLElement{constructor(){super(...arguments);g(this,F);l(this,"cache",W);g(this,Te);g(this,N,null);g(this,U,null);g(this,R,null);g(this,_);g(this,k);g(this,je,ai);g(this,Ge,5e3);g(this,$);g(this,Ve,!1);g(this,Ye,0);g(this,Le)}static get observedAttributes(){return[Jr,ri,ii,ei,ti]}attributeChangedCallback(e,r,a){e===Jr&&(m(this,_,a),m(this,k,W.getFetchInfo(a))),e===ri&&ta.includes(a)&&m(this,je,a),e===ii&&m(this,Ge,parseInt(a,10)),e===ei&&m(this,Ve,["","true"].includes(a)),e===ti&&m(this,Le,a)}connectedCallback(){if(!c(this,$)){if(c(this,R)??m(this,R,J(this)),m(this,Le,c(this,R).settings?.preview),c(this,Te)??m(this,Te,c(this,R).log.module(`${It}[${c(this,_)}]`)),!c(this,_)||c(this,_)==="#"){c(this,k)??m(this,k,W.getFetchInfo("missing-fragment-id")),S(this,F,Ht).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,$)&&!await Promise.race([c(this,$),Promise.resolve(!1)]))return;e&&W.remove(c(this,_)),c(this,je)===ni&&await Promise.race([W.getAsPromise(c(this,_)),new Promise(s=>setTimeout(s,c(this,Ge)))]);try{m(this,$,S(this,F,ci).call(this)),await c(this,$)}catch(s){return S(this,F,Ht).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,N)||{};return o&&!mt("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(he,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,$)}get updateComplete(){return c(this,$)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,Ve)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,N)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,U,e.reduce((h,{name:p,multiple:y,values:P})=>(h.fields[p]=y?P:P[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,U,Object.entries(e).reduce((h,[p,y])=>(h.fields[p]=y?.mimeType?y.value:y??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,_),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};Te=new WeakMap,N=new WeakMap,U=new WeakMap,R=new WeakMap,_=new WeakMap,k=new WeakMap,je=new WeakMap,Ge=new WeakMap,$=new WeakMap,Ve=new WeakMap,Ye=new WeakMap,Le=new WeakMap,F=new WeakSet,oi=async function(e){Qt(this,Ye)._++;let r=`${It}:${c(this,_)}:${c(this,Ye)}`,a=`${r}${tt}`,n=`${r}${rt}`;if(c(this,Le))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await Zr(e,{cache:"default",credentials:"omit"}),S(this,F,si).call(this,o),c(this,k).status=o?.status,c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new te("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,N))return c(this,k).stale=!0,c(this,Te).error("Serving stale data",c(this,k)),c(this,N);let d=s.message??"unknown";throw new te(`Failed to fetch fragment: ${d}`,{})}},si=function(e){Object.assign(c(this,k),Xr(e))},Ht=function(e){m(this,$,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,R).duration};c(this,Te).error(e,r),this.dispatchEvent(new CustomEvent(me,{detail:r,bubbles:!0,composed:!0}))},ci=async function(){var d;this.classList.remove("error"),m(this,U,null);let e=W.get(c(this,_));if(e)return m(this,N,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,R).settings,s=`${r}/fragment?id=${c(this,_)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await S(this,F,oi).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,_)),W.add(e),m(this,N,e),!0},l(xt,"cache",W);customElements.define(It,xt);import{LitElement as ra,html as ia,css as aa}from"./lit-all.min.js";var ze=class extends ra{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return ia`<div class="badge">${this.text}</div>`}};l(ze,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),l(ze,"styles",aa`
    ...
    `);customElements.define("merch-badge",ze);import{html as na,css as oa,LitElement as sa}from"./lit-all.min.js";var Ke=class extends sa{constructor(){super()}render(){return na`
            <slot name="icon"></slot>
    ...
    `),l(Ke,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ke);import{html as qt,css as ca,LitElement as la}from"./lit-all.min.js";var We=class extends la{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return qt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?qt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:qt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(We,"styles",ca`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

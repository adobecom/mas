...
`;function ie(a){let r=Qn(a);return Kn`
    ...
    `}import{html as Mr}from"./lit-all.min.js";function Zn(a,r){if(typeof a!="string"||!a)return null;let e;try{e=new URL(a,r)}catch{return null}return e.hostname.endsWith(".aem.page")?`${r}${e.pathname}${e.search}`:null}function Xn(a){return a?.hostname==="www.adobe.com"||a?.hostname==="adobe.com"}function _r(a,r=globalThis.location){if(typeof a!="string"||!a||!Xn(r))return a;let e=document.createElement("template");return e.innerHTML=`<picture>${a}</picture>`,e.content.querySelectorAll("source[srcset], img[src]").forEach(t=>{let i=t.tagName==="IMG"?"src":"srcset",n=Zn(t.getAttribute(i),r.origin);n&&t.setAttribute(i,n)}),e.content.querySelector("picture").innerHTML}var Jn="(min-width: 1200px)",eo="(min-width: 600px)";function fi(a,r){if(!a)return"";let e=new DOMParser().parseFromString(`<picture>${a}</picture>`,"text/html");if(r==="desktop")return e.querySelector(`source[media="${Jn}"]`)?.getAttribute("srcset")??"";if(r==="tablet")return e.querySelector(`source[media="${eo}"]`)?.getAttribute("srcset")??"";if(r==="mobile"){let t=e.querySelector("img");return t?.hasAttribute("data-mobile-set")?t.getAttribute("src")??"":""}return""}var vi=["tablet","mobile"];function to(a,r){let t=a.querySelector('[slot="backgrounds"]')?.innerHTML??"";vi.forEach(i=>{let n=r.querySelector(`[data-backgrounds-breakpoint="${i}"]`);if(!n)return;n.replaceChildren();let o=fi(t,i);if(!o){n.textContent="\u2014";return}let c=document.createElement("img");c.loading="lazy",c.alt="",c.src=o,n.append(c)})}function qe(a){return function(e){let t=a(),i=t.shadowRoot?.querySelector(".headless-backgrounds-detail");if(!i)return;let n=i.classList.contains("hidden");n&&to(t,i),i.classList.toggle("hidden",!n),e.target.textContent=n?"Show default only":"See all backgrounds"}}function Ue(a){return Mr`
        <button
            type="button"
    ...
    `}function ro(a){return`Background ${a[0].toUpperCase()}${a.slice(1)}`}function je(){return Mr`
    ...
    `}var bi={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},image:{tag:"picture",slot:"image"},backgrounds:{tag:"picture",slot:"backgrounds"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},ao=[{slot:"bg-image",label:"Background Image"},{slot:"image",label:"Image"},{slot:"backgrounds",label:"Background Desktop"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Ge=class extends f{constructor(e){super(e);d(this,"toggleBackgroundsDetail",qe(()=>this.card))}getGlobalCSS(){return ae}renderLayout(){let e=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return St`
        ...
        `}};d(Ge,"variantStyle",ie("headless"));import{css as io,html as no}from"./lit-all.min.js";var xi=`
...
`;var yi={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ve=class extends f{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return xi}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,t){t.literals={...t.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},t.space=!0,t.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",t.dataset.template="legal",t.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return no`
    ...
    `);import{html as oo,css as co}from"./lit-all.min.js";var wi=`
...
`;var Rr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},so=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Zt,Ei,We=class extends f{constructor(e){super(e);v(this,Zt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return wi}get aemFragmentMapping(){return Rr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,S(this,Zt,Ei).call(this))}renderLayout(){return oo`
            <div class="card">
            ...
            <slot></slot>
        `}};Zt=new WeakSet,Ei=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;so.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},d(We,"variantStyle",co`
    ...
    `);import{html as lo,css as ho}from"./lit-all.min.js";var ki=`
...
`;var Or={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ye=class extends f{getGlobalCSS(){return ki}get aemFragmentMapping(){return Or}renderLayout(){return lo`
    ...
    `);import{html as Nr,nothing as Dr}from"./lit-all.min.js";var Si={cardName:{attribute:"name"},image:{tag:"picture",slot:"image"},backgrounds:{tag:"picture",slot:"backgrounds"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},po=[{slot:"image",label:"Image"},{slot:"backgrounds",label:"Background Desktop"},{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Ke=class extends f{constructor(e){super(e);d(this,"toggleBackgroundsDetail",qe(()=>this.card))}getGlobalCSS(){return ae}renderLayout(){return Nr`
            <div class="headless">
                ${po.map(({slot:e,label:t})=>Nr`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value" data-slot="${e}">
                                <slot name="${e}"></slot>
                                ${e==="backgrounds"?Ue(this.toggleBackgroundsDetail):Dr}
                            </span>
                        </div>
                        ${e==="backgrounds"?je():Dr}
                    `)}
        ...
        `}};d(Ke,"variantStyle",ie("marquee"));import{html as Ci}from"./lit-all.min.js";var Ai={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},mo=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],Qe=class extends f{constructor(r){super(r)}getGlobalCSS(){return ae}renderLayout(){return Ci`
            <div class="headless">
                ${mo.map(({slot:r,label:e})=>Ci`
                        <div class="headless-row">
...
`;document.head.appendChild(Ri);import{LitElement as fo,html as Fr,css as vo,nothing as bo}from"./lit-all.min.js";import{unsafeHTML as xo}from"./lit-all.min.js";var yo=a=>a?a.startsWith("sp-icon-")?Fr`${xo(`<${a} class="badge-icon"></${a}>`)}`:Fr`<img src="${a}" class="badge-icon" />`:bo,Xe=class extends fo{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Fr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Xe);import{html as wo,css as Eo,LitElement as ko}from"./lit-all.min.js";var Ct=class extends ko{constructor(){super()}render(){return wo`
            <slot name="icon"></slot>
    ...
    `),d(Ct,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ct);import{html as Ir,css as So,LitElement as Co,nothing as Oi}from"./lit-all.min.js";var At=class extends Co{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Ir`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?Ir`<slot name="content"></slot>`:Oi}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Ir`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Oi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(At,"styles",So`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

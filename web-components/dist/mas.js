...
`;var Di=class extends T{constructor(t){super(t)}getGlobalCSS(){return rc}renderLayout(){return f`${this.cardImage}
            <div class="body">
...
`;var zi=class extends T{constructor(t){super(t)}getGlobalCSS(){return ic}renderLayout(){return f` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":f`<hr />`} ${this.secureLabelFooter}`}};R();var nc=`
  :root {
...
`;var qt=class extends T{constructor(t){super(t)}getGlobalCSS(){return hc}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return f` ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?"":f`<slot name="promo-text"></slot
...
`;document.head.appendChild(Ec);var wc="fragment",Sc="author",Ac="preview",_c="loading",Tc="timeout",wa="aem-fragment",Cc="eager",kc="cache",Eh=[Cc,kc],Re,bt,Ae,Sa=class{constructor(){E(this,Re,new Map);E(this,bt,new Map);E(this,Ae,new Map)}clear(){h(this,Re).clear(),h(this,bt).clear(),h(this,Ae).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,Re).set(t.id,t),t.fields?.originalId&&h(this,Re).set(t.fields.originalId,t),h(this,Ae).has(t.id)){let[,i]=h(this,Ae).get(t.id);i()}if(h(this,Ae).has(t.fields?.originalId)){let[,i]=h(this,Ae).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:n,value:a}=t.references[i];n==="content-fragment"&&(a.settings={...t?.settings,...a.settings},a.placeholders={...t?.placeholders,...a.placeholders},a.dictionary={...t?.dictionary,...a.dictionary},a.priceLiterals={...t?.priceLiterals,...a.priceLiterals},this.add(a,t))}}}has(t){return h(this,Re).has(t)}entries(){return h(this,Re).entries()}get(t){return h(this,Re).get(t)}getAsPromise(t){let[r]=h(this,Ae).get(t)??[];if(r)return r;let i;return r=new Promise(n=>{i=n,this.has(t)&&n()}),h(this,Ae).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,bt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,bt).set(t,r)),r}remove(t){h(this,Re).delete(t),h(this,bt).delete(t),h(this,Ae).delete(t)}};Re=new WeakMap,bt=new WeakMap,Ae=new WeakMap;var Xe=new Sa,Xt,_e,He,ve,pe,ee,Ur,Fr,Te,Gr,qr,Kt,Ce,Pc,Lc,Aa,Rc,Bi=class extends HTMLElement{constructor(){super(...arguments);E(this,Ce);m(this,"cache",Xe);E(this,Xt);E(this,_e,null);E(this,He,null);E(this,ve,null);E(this,pe);E(this,ee);E(this,Ur,Cc);E(this,Fr,5e3);E(this,Te);E(this,Gr,!1);E(this,qr,0);E(this,Kt)}static get observedAttributes(){return[wc,_c,Tc,Sc,Ac]}attributeChangedCallback(r,i,n){r===wc&&(y(this,pe,n),y(this,ee,Xe.getFetchInfo(n))),r===_c&&Eh.includes(n)&&y(this,Ur,n),r===Tc&&y(this,Fr,parseInt(n,10)),r===Sc&&y(this,Gr,["","true"].includes(n)),r===Ac&&y(this,Kt,n)}connectedCallback(){if(!h(this,Te)){if(h(this,ve)??y(this,ve,dt(this)),y(this,Kt,h(this,ve).settings?.preview),h(this,Xt)??y(this,Xt,h(this,ve).log.module(`${wa}[${h(this,pe)}]`)),!h(this,pe)||h(this,pe)==="#"){h(this,ee)??y(this,ee,Xe.getFetchInfo("missing-fragment-id")),te(this,Ce,Aa).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,ee)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,Te)&&!await Promise.race([h(this,Te),Promise.resolve(!1)]))return;r&&Xe.remove(h(this,pe)),h(this,Ur)===kc&&await Promise.race([Xe.getAsPromise(h(this,pe)),new Promise(s=>setTimeout(s,h(this,Fr)))]);try{y(this,Te,te(this,Ce,Rc).call(this)),await h(this,Te)}catch(s){return te(this,Ce,Aa).call(this,s.message),!1}let{references:i,referencesTree:n,placeholders:a,wcs:o}=h(this,_e)||{};return o&&!B("mas.disableWcsCache")&&h(this,ve).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(tt,{detail:{...this.data,references:i,referencesTree:n,placeholders:a,...h(this,ee)},bubbles:!0,composed:!0})),h(this,Te)}get updateComplete(){return h(this,Te)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,He)?h(this,He):(h(this,Gr)?this.transformAuthorData():this.transformPublishData(),h(this,He))}get rawData(){return h(this,_e)}transformAuthorData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,_e);y(this,He,r.reduce((l,{name:d,multiple:p,values:u})=>(l.fields[d]=p?u:u[0],l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,_e);y(this,He,Object.entries(r).reduce((l,[d,p])=>(l.fields[d]=p?.mimeType?p.value:p??"",l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=i.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,o=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${o}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,pe),{locale:h(this,ve).settings.locale,apiKey:h(this,ve).settings.wcsApiKey})}};Xt=new WeakMap,_e=new WeakMap,He=new WeakMap,ve=new WeakMap,pe=new WeakMap,ee=new WeakMap,Ur=new WeakMap,Fr=new WeakMap,Te=new WeakMap,Gr=new WeakMap,qr=new WeakMap,Kt=new WeakMap,Ce=new WeakSet,Pc=async function(r){Fa(this,qr)._++;let i=`${wa}:${h(this,pe)}:${h(this,qr)}`,n=`${i}${nt}`,a=`${i}${at}`;if(h(this,Kt))return await this.generatePreview();performance.mark(n);let o;try{if(h(this,ee).stale=!1,h(this,ee).url=r,o=await _i(r,{cache:"default",credentials:"omit"}),te(this,Ce,Lc).call(this,o),h(this,ee).status=o?.status,h(this,ee).measure=Le(performance.measure(a,n)),h(this,ee).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...h(this,ve).duration});return await o.json()}catch(s){if(h(this,ee).measure=Le(performance.measure(a,n)),h(this,ee).retryCount=s.retryCount,h(this,_e))return h(this,ee).stale=!0,h(this,Xt).error("Serving stale data",h(this,ee)),h(this,_e);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},Lc=function(r){Object.assign(h(this,ee),ci(r))},Aa=function(r){y(this,Te,null),h(this,ee).message=r,this.classList.add("error");let i={...h(this,ee),...h(this,ve).duration};h(this,Xt).error(r,i),this.dispatchEvent(new CustomEvent(rt,{detail:i,bubbles:!0,composed:!0}))},Rc=async function(){var c;this.classList.remove("error"),y(this,He,null);let r=Xe.get(h(this,pe));if(r)return y(this,_e,r),!0;let{masIOUrl:i,wcsApiKey:n,country:a,locale:o}=h(this,ve).settings,s=`${i}/fragment?id=${h(this,pe)}&api_key=${n}&locale=${o}`;return a&&!o.endsWith(`_${a}`)&&(s+=`&country=${a}`),r=await te(this,Ce,Pc).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,pe)),Xe.add(r),y(this,_e,r),!0},m(Bi,"cache",Xe);customElements.define(wa,Bi);R();var Qt=class extends ${constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">${this.text}</div>`}};m(Qt,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),m(Qt,"styles",b`
    ...
    `);customElements.define("merch-badge",Qt);R();var Vr=class extends ${constructor(){super()}render(){return f`
            <slot name="icon"></slot>
    ...
    `),m(Vr,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Vr);R();var jr=class extends ${updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return f`<slot name="heading"></slot>

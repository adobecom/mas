...
describe('mas-ost-placeholder-panel', () => {
    ...
    it('renders all 8 type chips', async () => {
        const el = await fixture(html`<mas-ost-placeholder-panel></mas-ost-placeholder-panel>`);
    ...
    it('shows placeholder-options by default (price type)', async () => {
        const el = await fixture(html`<mas-ost-placeholder-panel></mas-ost-placeholder-panel>`);
        const options = el.shadowRoot.querySelector('mas-ost-placeholder-options');
        const checkout = el.shadowRoot.querySelector('mas-ost-checkout-options');

...
/**
 * Preview bulk update for multiple cards
 * Adobe I/O Runtime action for studio_preview_bulk_update operation
 * Returns preview of what would change without executing the updates
 */
async function main(params) {
    const { fragmentIds, updates, textReplacements, __ow_headers } = params;
    ...
    try {
        ...
        const result = await studioOps.previewBulkUpdate({ fragmentIds, updates, textReplacements });

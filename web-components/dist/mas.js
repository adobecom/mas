...
`;document.head.appendChild(Gc);var qc="fragment",Vc="author",jc="preview",Wc="loading",Yc="timeout",Rn="aem-fragment",Xc="eager",Kc="cache",Kh=[Xc,Kc],Ne,Et,ke,On=class{constructor(){E(this,Ne,new Map);E(this,Et,new Map);E(this,ke,new Map)}clear(){h(this,Ne).clear(),h(this,Et).clear(),h(this,ke).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,Ne).set(t.id,t),t.fields?.originalId&&h(this,Ne).set(t.fields.originalId,t),h(this,ke).has(t.id)){let[,i]=h(this,ke).get(t.id);i()}if(h(this,ke).has(t.fields?.originalId)){let[,i]=h(this,ke).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return h(this,Ne).has(t)}entries(){return h(this,Ne).entries()}get(t){return h(this,Ne).get(t)}getAsPromise(t){let[r]=h(this,ke).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),h(this,ke).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,Et).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,Et).set(t,r)),r}remove(t){h(this,Ne).delete(t),h(this,Et).delete(t),h(this,ke).delete(t)}};Ne=new WeakMap,Et=new WeakMap,ke=new WeakMap;var Ue=new On,tr,_e,Ge,Ee,de,J,Yr,Xr,Pe,Kr,Qr,rr,Le,Qc,Zc,Nn,Jc,Yi=class extends HTMLElement{constructor(){super(...arguments);E(this,Le);m(this,"cache",Ue);E(this,tr);E(this,_e,null);E(this,Ge,null);E(this,Ee,null);E(this,de);E(this,J);E(this,Yr,Xc);E(this,Xr,5e3);E(this,Pe);E(this,Kr,!1);E(this,Qr,0);E(this,rr)}static get observedAttributes(){return[qc,Wc,Yc,Vc,jc]}attributeChangedCallback(r,i,a){r===qc&&(y(this,de,a),y(this,J,Ue.getFetchInfo(a))),r===Wc&&Kh.includes(a)&&y(this,Yr,a),r===Yc&&y(this,Xr,parseInt(a,10)),r===Vc&&y(this,Kr,["","true"].includes(a)),r===jc&&y(this,rr,a)}connectedCallback(){if(!h(this,Pe)){if(h(this,Ee)??y(this,Ee,mt(this)),y(this,rr,h(this,Ee).settings?.preview),h(this,tr)??y(this,tr,h(this,Ee).log.module(`${Rn}[${h(this,de)}]`)),!h(this,de)||h(this,de)==="#"){h(this,J)??y(this,J,Ue.getFetchInfo("missing-fragment-id")),Z(this,Le,Nn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,Pe)&&!await Promise.race([h(this,Pe),Promise.resolve(!1)]))return;r&&Ue.remove(h(this,de)),h(this,Yr)===Kc&&await Promise.race([Ue.getAsPromise(h(this,de)),new Promise(s=>setTimeout(s,h(this,Xr)))]);try{y(this,Pe,Z(this,Le,Jc).call(this)),await h(this,Pe)}catch(s){return Z(this,Le,Nn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=h(this,_e)||{};return o&&!F("mas.disableWcsCache")&&h(this,Ee).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(at,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...h(this,J)},bubbles:!0,composed:!0})),h(this,Pe)}get updateComplete(){return h(this,Pe)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,Ge)?h(this,Ge):(h(this,Kr)?this.transformAuthorData():this.transformPublishData(),h(this,Ge))}get rawData(){return h(this,_e)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=h(this,_e);y(this,Ge,r.reduce((d,{name:p,multiple:u,values:f})=>(d.fields[p]=u?f:f[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=h(this,_e);y(this,Ge,Object.entries(r).reduce((d,[p,u])=>(d.fields[p]=u?.mimeType?u.value:u??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,de),{locale:h(this,Ee).settings.locale,apiKey:h(this,Ee).settings.wcsApiKey,fullContext:!0})}};tr=new WeakMap,_e=new WeakMap,Ge=new WeakMap,Ee=new WeakMap,de=new WeakMap,J=new WeakMap,Yr=new WeakMap,Xr=new WeakMap,Pe=new WeakMap,Kr=new WeakMap,Qr=new WeakMap,rr=new WeakMap,Le=new WeakSet,Qc=async function(r){Jn(this,Qr)._++;let i=`${Rn}:${h(this,de)}:${h(this,Qr)}`,a=`${i}${st}`,n=`${i}${ct}`;if(h(this,rr)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Re(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(h(this,J).stale=!1,h(this,J).url=r,o=await Ni(r,{cache:"default",credentials:"omit"}),Z(this,Le,Zc).call(this,o),h(this,J).status=o?.status,h(this,J).measure=Oe(performance.measure(n,a)),h(this,J).retryCount=o.retryCount,!o?.ok)throw new Re("Unexpected fragment response",{response:o,...h(this,Ee).duration});return await o.json()}catch(s){if(h(this,J).measure=Oe(performance.measure(n,a)),h(this,J).retryCount=s.retryCount,h(this,_e))return h(this,J).stale=!0,h(this,tr).error("Serving stale data",h(this,J)),h(this,_e);let c=s.message??"unknown";throw new Re(`Failed to fetch fragment: ${c}`,{})}},Zc=function(r){Object.assign(h(this,J),vi(r))},Nn=function(r){y(this,Pe,null),h(this,J).message=r,this.classList.add("error");let i={...h(this,J),...h(this,Ee).duration};h(this,tr).error(r,i),this.dispatchEvent(new CustomEvent(nt,{detail:i,bubbles:!0,composed:!0}))},Jc=async function(){var c;this.classList.remove("error"),y(this,Ge,null);let r=Ue.get(h(this,de));if(r)return y(this,_e,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=h(this,Ee).settings,s=`${i}/fragment?id=${h(this,de)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Le,Qc).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,de)),Ue.add(r),y(this,_e,Ue.get(h(this,de))??r),!0},m(Yi,"cache",Ue);customElements.define(Rn,Yi);P();Ur();var el={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},tl=e=>(...t)=>({_$litDirective$:e,values:t}),Xi=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,i){this._$Ct=t,this._$AM=r,this._$Ci=i}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};var Zr=class extends Xi{constructor(t){if(super(t),this.et=w,t.type!==el.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===w||t==null)return this.ft=void 0,this.et=t;if(t===Fe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let r=[t];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};Zr.directiveName="unsafeHTML",Zr.resultType=1;var rl=tl(Zr);var Qh=e=>e?e.startsWith("sp-icon-")?g`${rl(`<${e} class="badge-icon"></${e}>`)}`:g`<img src="${e}" class="badge-icon" />`:w,ir=class extends U{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return g`<div class="badge">

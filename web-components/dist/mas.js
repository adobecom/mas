...
`;var Wi=class extends A{constructor(t){super(t)}getGlobalCSS(){return bc}renderLayout(){return g` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":g`<hr />`} ${this.secureLabelFooter}`}};P();var yc=`
  :root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let r=t.querySelector("strong, b, p");r&&(R.isMobile?r.style.display="none":r.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?R.isMobile?g`
...
`;document.head.appendChild(Wc);var Yc="fragment",Xc="author",Kc="preview",Qc="loading",Zc="timeout",Dn="aem-fragment",Jc="eager",el="cache",ap=[Jc,el],ze,At,_e,$n=class{constructor(){w(this,ze,new Map);w(this,At,new Map);w(this,_e,new Map)}clear(){p(this,ze).clear(),p(this,At).clear(),p(this,_e).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(p(this,ze).set(t.id,t),t.fields?.originalId&&p(this,ze).set(t.fields.originalId,t),p(this,_e).has(t.id)){let[,i]=p(this,_e).get(t.id);i()}if(p(this,_e).has(t.fields?.originalId)){let[,i]=p(this,_e).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return p(this,ze).has(t)}entries(){return p(this,ze).entries()}get(t){return p(this,ze).get(t)}getAsPromise(t){let[r]=p(this,_e).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),p(this,_e).set(t,[r,i]),r}getFetchInfo(t){let r=p(this,At).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},p(this,At).set(t,r)),r}remove(t){p(this,ze).delete(t),p(this,At).delete(t),p(this,_e).delete(t)}};ze=new WeakMap,At=new WeakMap,_e=new WeakMap;var Ze=new $n,ir,Pe,Ge,Ee,fe,J,Xr,Kr,Le,Qr,Zr,ar,Me,tl,rl,Hn,il,Ki=class extends HTMLElement{constructor(){super(...arguments);w(this,Me);m(this,"cache",Ze);w(this,ir);w(this,Pe,null);w(this,Ge,null);w(this,Ee,null);w(this,fe);w(this,J);w(this,Xr,Jc);w(this,Kr,5e3);w(this,Le);w(this,Qr,!1);w(this,Zr,0);w(this,ar)}static get observedAttributes(){return[Yc,Qc,Zc,Xc,Kc]}attributeChangedCallback(r,i,a){r===Yc&&(y(this,fe,a),y(this,J,Ze.getFetchInfo(a))),r===Qc&&ap.includes(a)&&y(this,Xr,a),r===Zc&&y(this,Kr,parseInt(a,10)),r===Xc&&y(this,Qr,["","true"].includes(a)),r===Kc&&y(this,ar,a)}connectedCallback(){if(!p(this,Le)){if(p(this,Ee)??y(this,Ee,ut(this)),y(this,ar,p(this,Ee).settings?.preview),p(this,ir)??y(this,ir,p(this,Ee).log.module(`${Dn}[${p(this,fe)}]`)),!p(this,fe)||p(this,fe)==="#"){p(this,J)??y(this,J,Ze.getFetchInfo("missing-fragment-id")),Z(this,Me,Hn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(p(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(p(this,Le)&&!await Promise.race([p(this,Le),Promise.resolve(!1)]))return;r&&Ze.remove(p(this,fe)),p(this,Xr)===el&&await Promise.race([Ze.getAsPromise(p(this,fe)),new Promise(s=>setTimeout(s,p(this,Kr)))]);try{y(this,Le,Z(this,Me,il).call(this)),await p(this,Le)}catch(s){return Z(this,Me,Hn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=p(this,Pe)||{};return o&&!F("mas.disableWcsCache")&&p(this,Ee).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(nt,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...p(this,J)},bubbles:!0,composed:!0})),p(this,Le)}get updateComplete(){return p(this,Le)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return p(this,Ge)?p(this,Ge):(p(this,Qr)?this.transformAuthorData():this.transformPublishData(),p(this,Ge))}get rawData(){return p(this,Pe)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=p(this,Pe);y(this,Ge,r.reduce((d,{name:h,multiple:u,values:f})=>(d.fields[h]=u?f:f[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=p(this,Pe);y(this,Ge,Object.entries(r).reduce((d,[h,u])=>(d.fields[h]=u?.mimeType?u.value:u??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(p(this,fe),{locale:p(this,Ee).settings.locale,apiKey:p(this,Ee).settings.wcsApiKey,fullContext:!0})}};ir=new WeakMap,Pe=new WeakMap,Ge=new WeakMap,Ee=new WeakMap,fe=new WeakMap,J=new WeakMap,Xr=new WeakMap,Kr=new WeakMap,Le=new WeakMap,Qr=new WeakMap,Zr=new WeakMap,ar=new WeakMap,Me=new WeakSet,tl=async function(r){ro(this,Zr)._++;let i=`${Dn}:${p(this,fe)}:${p(this,Zr)}`,a=`${i}${ct}`,n=`${i}${lt}`;if(p(this,ar)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Oe(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(p(this,J).stale=!1,p(this,J).url=r,o=await zi(r,{cache:"default",credentials:"omit"}),Z(this,Me,rl).call(this,o),p(this,J).status=o?.status,p(this,J).measure=Ne(performance.measure(n,a)),p(this,J).retryCount=o.retryCount,!o?.ok)throw new Oe("Unexpected fragment response",{response:o,...p(this,Ee).duration});return await o.json()}catch(s){if(p(this,J).measure=Ne(performance.measure(n,a)),p(this,J).retryCount=s.retryCount,p(this,Pe))return p(this,J).stale=!0,p(this,ir).error("Serving stale data",p(this,J)),p(this,Pe);let c=s.message??"unknown";throw new Oe(`Failed to fetch fragment: ${c}`,{})}},rl=function(r){Object.assign(p(this,J),yi(r))},Hn=function(r){y(this,Le,null),p(this,J).message=r,this.classList.add("error");let i={...p(this,J),...p(this,Ee).duration};p(this,ir).error(r,i),this.dispatchEvent(new CustomEvent(ot,{detail:i,bubbles:!0,composed:!0}))},il=async function(){var c;this.classList.remove("error"),y(this,Ge,null);let r=Ze.get(p(this,fe));if(r)return y(this,Pe,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=p(this,Ee).settings,s=`${i}/fragment?id=${p(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Me,tl).call(this,s),(c=r.fields).originalId??(c.originalId=p(this,fe)),Ze.add(r),y(this,Pe,r),!0},m(Ki,"cache",Ze);customElements.define(Dn,Ki);P();Gr();var al={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},nl=e=>(...t)=>({_$litDirective$:e,values:t}),Qi=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,i){this._$Ct=t,this._$AM=r,this._$Ci=i}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};var Jr=class extends Qi{constructor(t){if(super(t),this.et=E,t.type!==al.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===E||t==null)return this.ft=void 0,this.et=t;if(t===Ue)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let r=[t];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};Jr.directiveName="unsafeHTML",Jr.resultType=1;var ol=nl(Jr);var np=e=>e?e.startsWith("sp-icon-")?g`${ol(`<${e} class="badge-icon"></${e}>`)}`:g`<img src="${e}" class="badge-icon" />`:E,nr=class extends U{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return g`<div class="badge">
    ...
    `);customElements.define("merch-badge",nr);P();var ei=class extends U{constructor(){super()}render(){return g`
            <slot name="icon"></slot>
...
`;var Al={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},pr=class extends A{getGlobalCSS(){return El}renderLayout(){return g` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>

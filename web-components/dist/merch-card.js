var pr=Object.defineProperty;var mr=a=>{throw TypeError(a)};var Ya=(a,t,e)=>t in a?pr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var Ka=(a,t)=>()=>(a&&(t=a(a=0)),t);var Qa=(a,t)=>{for(var e in t)pr(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>Ya(a,typeof t!="symbol"?t+"":t,e),Dt=(a,t,e)=>t.has(a)||mr("Cannot "+e);var s=(a,t,e)=>(Dt(a,t,"read from private field"),e?e.call(a):t.get(a)),g=(a,t,e)=>t.has(a)?mr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Dt(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),P=(a,t,e)=>(Dt(a,t,"access private method"),e);var gr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return s(a,t,r)}});var It={};Qa(It,{default:()=>We});import{LitElement as Xa,html as Ve,css as Za}from"./lit-all.min.js";import{unsafeHTML as Ft}from"./lit-all.min.js";function Ja(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var _,We,$t=Ka(()=>{_=class _ extends Xa{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();_.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),h=l?l.offsetWidth:o,p=l?l.offsetHeight:c,b=this.effectivePlacement;b==="top"&&e.top-p-n<0?b="bottom":b==="bottom"&&e.bottom+p+n>i?b="top":b==="left"&&e.left-h-n<0?b="right":b==="right"&&e.right+h+n>r&&(b="left");let z=e.left+e.width/2,ie=e.top+e.height/2,O=6,ne,oe,je;b==="top"?(ne=e.top-p-n,oe=Math.max(0,Math.min(r-h,z-h/2)),je=Math.max(O,Math.min(h-O*2,z-oe-O))):b==="bottom"?(ne=e.bottom+n,oe=Math.max(0,Math.min(r-h,z-h/2)),je=Math.max(O,Math.min(h-O*2,z-oe-O))):b==="left"?(oe=e.left-h-n,ne=Math.max(0,Math.min(i-p,ie-p/2)),je=Math.max(O,Math.min(p-O*2,ie-ne-O))):(oe=e.right+n,ne=Math.max(0,Math.min(i-p,ie-p/2)),je=Math.max(O,Math.min(p-O*2,ie-ne-O))),this._tooltipTop=ne,this._tooltipLeft=oe,this._arrowOffset=je,this._computedPlacement=b,this._anchorRect=e}showTooltip(){_.activeTooltip&&_.activeTooltip!==this&&(_.activeTooltip.closeOverlay(),_.activeTooltip.tooltipVisible=!1,_.activeTooltip.requestUpdate()),_.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){_.activeTooltip===this&&(_.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ve`<merch-icon
        ...
        ></merch-icon>`:Ve`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return this.renderIcon();if(Ja())return Ve`
            ...
            `;{let i=t.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:c=>{this.lastPointerType=c.pointerType},pointerenter:c=>c.pointerType!=="touch"&&this.showTooltip(),pointerleave:c=>c.pointerType!=="touch"&&this.hideTooltip(),click:c=>{this.lastPointerType==="touch"&&this.handleTap(c),this.lastPointerType=null}};if(this.smartPlacement){let c=this._computedPlacement,l=c==="top"||c==="bottom",h=`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`,p=l?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return Ve`
                    <span
                    ...
                    >
                        ${this.renderIcon()}
                        <span class="css-tooltip-body" style="${h}">
                            ${Ft(t)}
                            <span
                                aria-hidden="true"
                                role="presentation"
    ...
    `);We=_;customElements.define("mas-mnemonic",We)});import{LitElement as Bn}from"./lit-all.min.js";import{css as vr,unsafeCSS as fr}from"./lit-all.min.js";var w="(max-width: 767px)",A="(max-width: 1199px)",E="(min-width: 768px)",f="(min-width: 1200px)",T="(min-width: 1600px)",ur={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${f} and (not ${T})`),matchDesktopOrUp:window.matchMedia(f),matchLargeDesktop:window.matchMedia(T),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},v=ur;function mt(){return ur.isDesktop}var xr=vr`
    :host {
...
`,br=()=>[vr`
    ...
    `);customElements.define("merch-icon",xe);var eo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),to=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var y='span[is="inline-price"][data-wcs-osi]',K='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var ai='a[is="upt-link"]',wr=`${y},${K},${ai}`;var Er="merch-offer-select:ready",kr="merch-card:action-menu-toggle";var N="merch-quantity-selector:change",Sr="merch-card-quantity:change",Bt="merch-modal:addon-and-quantity-update";var be="merch-card-collection:literals-changed";var ye="aem:load",we="aem:error",gt="mas:ready",Cr="mas:error",Ar="placeholder-failed",Tr="placeholder-pending",Lr="placeholder-resolved";var zr="mas:failed",Ye="mas:resolved",Pr="mas/commerce";var Q="failed",ce="pending",X="resolved";var ut="X-Request-Id",ro=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var ao=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var ft=":start",vt=":duration";var D="legal",_r="mas-ff-defaults";var ii="mas-commerce-service";function Mr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function L(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function Ee(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function qt(){return window.matchMedia("(max-width: 1024px)").matches}function se(){return document.getElementsByTagName(ii)?.[0]}function Ke(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Qe,le,Xe,Ze,ke,xt=class extends HTMLElement{constructor(){super();g(this,Qe,"");g(this,le);g(this,Xe,[]);g(this,Ze,[]);g(this,ke);m(this,ke,Mr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,le)?this.parentElement.style.borderRadius=s(this,le):s(this,le)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Xe).map((r,i)=>{let n=s(this,Ze)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,Qe)}, ${e})`}connectedCallback(){s(this,ke).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,le,i?.trim()),e==="colors"&&i?m(this,Xe,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,Ze,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Qe,i?.trim()??""),s(this,ke).call(this)}};Qe=new WeakMap,le=new WeakMap,Xe=new WeakMap,Ze=new WeakMap,ke=new WeakMap;customElements.define("merch-gradient",xt);import{LitElement as ni,html as oi,css as ci}from"./lit-all.min.js";var Se=class extends ni{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Ye,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Ye,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return oi` <input
                type="checkbox"
                id="addon-checkbox"
    ...
    `);customElements.define("merch-addon",Se);import{html as bt,nothing as si}from"./lit-all.min.js";var Ce,Je=class Je{constructor(t){d(this,"card");g(this,Ce);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,Ce,s(this,Ce)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,Ce)}insertVariantStyle(){let t=this.constructor.name;if(!Je.styleMap[t]){Je.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),bt`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return yt(this.card.variant)}};Ce=new WeakMap,d(Je,"styleMap",{});var x=Je;import{html as Ht,css as li}from"./lit-all.min.js";var Rr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as et,css as di}from"./lit-all.min.js";var Nr=`
:root {
...
`;var wt=class extends x{constructor(t){super(t)}getGlobalCSS(){return Fr}renderLayout(){return Ir` ${this.badge}
            ...
            ${this.card.customHr?"":Ir`<hr />`} ${this.secureLabelFooter}`}};import{html as Z,css as hi,unsafeCSS as Br}from"./lit-all.min.js";var $r=`
  :root {
...
`;var ui=32,Gr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Le=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>Et` <footer>
    ...
    `);import{html as tt,css as fi,nothing as kt}from"./lit-all.min.js";var jr=`
:root {
...
`;var Zr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ze=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Xr}priceOptionsProvider(t,e){t.dataset.template===D&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ut` ${this.badge}
    ...
    `);import{html as Gt,css as bi}from"./lit-all.min.js";var Jr=`
:root {
...
`;var ea={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Pe=class extends x{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===D&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Jr}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Gt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var ra={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},_e=class extends x{constructor(t){super(t)}getGlobalCSS(){return ta}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return yi`
    ...
    `);import{html as jt,css as Ei}from"./lit-all.min.js";var aa=`
:root {
...
`;var Wt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Oe=class extends x{getGlobalCSS(){return oa}get aemFragmentMapping(){return Wt}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return ca`
    ...
    `);import{html as Yt,css as Ai,nothing as Ti}from"./lit-all.min.js";var sa=`
...
`;var la={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Li=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Ne=class extends x{constructor(t){super(t)}getGlobalCSS(){return sa}renderLayout(){return Yt`
    ...
    `);import{css as zi,html as Pi}from"./lit-all.min.js";var da=`
...
`;var ha={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},De=class extends x{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return da}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Pi`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as _i,css as Mi}from"./lit-all.min.js";var pa=`
...
`;document.head.appendChild(fa);function Tt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=Xt(r)?r:a;n=o.get(c)}if(i&&n==null){let o=Xt(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Ni(Xt(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var Oi=a=>typeof a=="boolean",Lt=a=>typeof a=="function";var Xt=a=>typeof a=="string";function va(a,t){if(Oi(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Ni(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var ee=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(ut);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var he={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},xa=1e3;function Di(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ba(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!he.serializableTypes.includes(e))return e}return a}function Fi(a,t){if(!he.ignoredProperties.includes(a))return ba(t)}var Zt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(h=>{h!=null&&(Di(h)?r:i).push(h)}),r.length&&(n+=" "+r.map(ba).join(" "));let{pathname:o,search:c}=window.location,l=`${he.delimiter}page=${o}${c}`;l.length>xa&&(l=`${l.slice(0,xa)}<trunc>`),n+=l,i.length&&(n+=`${he.delimiter}facts=`,n+=JSON.stringify(i,Fi)),window.lana?.log(n,he)}};function ya(a){Object.assign(he,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in he&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var wa={LOCAL:"local",PROD:"prod",STAGE:"stage"},Jt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},er=new Set,tr=new Set,Ea=new Map,ka={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Sa={filter:({level:a})=>a!==Jt.DEBUG},Ii={filter:()=>!1};function $i(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Lt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Bi(a){[...tr].every(t=>t(a))&&er.forEach(t=>t(a))}function Ca(a){let t=(Ea.get(a)??0)+1;Ea.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Ca(`${r.namespace}/${i}`),updateConfig:ya};return Object.values(Jt).forEach(i=>{r[i]=(n,...o)=>Bi($i(i,n,a,o,e))}),Object.seal(r)}function zt(...a){a.forEach(t=>{let{append:e,filter:r}=t;Lt(r)&&tr.add(r),Lt(e)&&er.add(e)})}function qi(a={}){let{name:t}=a,e=va(Tt("commerce.debug",{search:!0,storage:!0}),t===wa.LOCAL);return zt(e?ka:Sa),t===wa.PROD&&zt(Zt),rt}function Hi(){er.clear(),tr.clear()}var rt={...Ca(Pr),Level:Jt,Plugins:{consoleAppender:ka,debugFilter:Sa,quietFilter:Ii,lanaAppender:Zt},init:qi,reset:Hi,use:zt};var Ui="mas-commerce-service",pl=rt.module("utilities"),Gi={requestId:ut,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Pt=a=>window.setTimeout(a);function rr(){return document.getElementsByTagName(Ui)?.[0]}function Aa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Gi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ta(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var La="fragment",za="author",Pa="preview",_a="loading",Ma="timeout",ar="aem-fragment",Ra="eager",Oa="cache",ji=[Ra,Oa],j,pe,B,ir=class{constructor(){g(this,j,new Map);g(this,pe,new Map);g(this,B,new Map)}clear(){s(this,j).clear(),s(this,pe).clear(),s(this,B).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,j).set(t.id,t),t.fields?.originalId&&s(this,j).set(t.fields.originalId,t),s(this,B).has(t.id)){let[,r]=s(this,B).get(t.id);r()}if(s(this,B).has(t.fields?.originalId)){let[,r]=s(this,B).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,j).has(t)}entries(){return s(this,j).entries()}get(t){return s(this,j).get(t)}getAsPromise(t){let[e]=s(this,B).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,B).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,pe).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,pe).set(t,e)),e}remove(t){s(this,j).delete(t),s(this,pe).delete(t),s(this,B).delete(t)}};j=new WeakMap,pe=new WeakMap,B=new WeakMap;var te=new ir,Ie,q,Y,F,R,C,at,it,H,nt,ot,$e,U,Na,Da,nr,Fa,_t=class extends HTMLElement{constructor(){super(...arguments);g(this,U);d(this,"cache",te);g(this,Ie);g(this,q,null);g(this,Y,null);g(this,F,null);g(this,R);g(this,C);g(this,at,Ra);g(this,it,5e3);g(this,H);g(this,nt,!1);g(this,ot,0);g(this,$e)}static get observedAttributes(){return[La,_a,Ma,za,Pa]}attributeChangedCallback(e,r,i){e===La&&(m(this,R,i),m(this,C,te.getFetchInfo(i))),e===_a&&ji.includes(i)&&m(this,at,i),e===Ma&&m(this,it,parseInt(i,10)),e===za&&m(this,nt,["","true"].includes(i)),e===Pa&&m(this,$e,i)}connectedCallback(){if(!s(this,H)){if(s(this,F)??m(this,F,se(this)),m(this,$e,s(this,F).settings?.preview),s(this,Ie)??m(this,Ie,s(this,F).log.module(`${ar}[${s(this,R)}]`)),!s(this,R)||s(this,R)==="#"){s(this,C)??m(this,C,te.getFetchInfo("missing-fragment-id")),P(this,U,nr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,C)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,H)&&!await Promise.race([s(this,H),Promise.resolve(!1)]))return;e&&te.remove(s(this,R)),s(this,at)===Oa&&await Promise.race([te.getAsPromise(s(this,R)),new Promise(c=>setTimeout(c,s(this,it)))]);try{m(this,H,P(this,U,Fa).call(this)),await s(this,H)}catch(c){return P(this,U,nr).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,q)||{};return o&&!Tt("mas.disableWcsCache")&&s(this,F).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ye,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,C)},bubbles:!0,composed:!0})),s(this,H)}get updateComplete(){return s(this,H)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,Y)?s(this,Y):(s(this,nt)?this.transformAuthorData():this.transformPublishData(),s(this,Y))}get rawData(){return s(this,q)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:h={}}=s(this,q);m(this,Y,e.reduce((p,{name:u,multiple:b,values:z})=>(p.fields[u]=b?z:z[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:h,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:h}=s(this,q);m(this,Y,Object.entries(e).reduce((p,[u,b])=>(p.fields[u]=b?.mimeType?b.value:b??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:h}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,R),{locale:s(this,F).settings.locale,apiKey:s(this,F).settings.wcsApiKey,fullContext:!0})}};Ie=new WeakMap,q=new WeakMap,Y=new WeakMap,F=new WeakMap,R=new WeakMap,C=new WeakMap,at=new WeakMap,it=new WeakMap,H=new WeakMap,nt=new WeakMap,ot=new WeakMap,$e=new WeakMap,U=new WeakSet,Na=async function(e){gr(this,ot)._++;let r=`${ar}:${s(this,R)}:${s(this,ot)}`,i=`${r}${ft}`,n=`${r}${vt}`;if(s(this,$e)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new ee(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,C).stale=!1,s(this,C).url=e,o=await Ta(e,{cache:"default",credentials:"omit"}),P(this,U,Da).call(this,o),s(this,C).status=o?.status,s(this,C).measure=Ee(performance.measure(n,i)),s(this,C).retryCount=o.retryCount,!o?.ok)throw new ee("Unexpected fragment response",{response:o,...s(this,F).duration});return await o.json()}catch(c){if(s(this,C).measure=Ee(performance.measure(n,i)),s(this,C).retryCount=c.retryCount,s(this,q))return s(this,C).stale=!0,s(this,Ie).error("Serving stale data",s(this,C)),s(this,q);let l=c.message??"unknown";throw new ee(`Failed to fetch fragment: ${l}`,{})}},Da=function(e){Object.assign(s(this,C),Aa(e))},nr=function(e){m(this,H,null),s(this,C).message=e,this.classList.add("error");let r={...s(this,C),...s(this,F).duration};s(this,Ie).error(e,r),this.dispatchEvent(new CustomEvent(we,{detail:r,bubbles:!0,composed:!0}))},Fa=async function(){var l;this.classList.remove("error"),m(this,Y,null);let e=te.get(s(this,R));if(e)return m(this,q,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,F).settings,c=`${r}/fragment?id=${s(this,R)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await P(this,U,Na).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,R)),te.add(e),m(this,q,e),!0},d(_t,"cache",te);customElements.define(ar,_t);import{LitElement as Vi,html as or,css as Wi,nothing as Yi}from"./lit-all.min.js";import{unsafeHTML as Ki}from"./lit-all.min.js";var Qi=a=>a?a.startsWith("sp-icon-")?or`${Ki(`<${a} class="badge-icon"></${a}>`)}`:or`<img src="${a}" class="badge-icon" />`:Yi,Be=class extends Vi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return or`<div class="badge">
    ...
    `);customElements.define("merch-badge",Be);import{html as Xi,css as Zi,LitElement as Ji}from"./lit-all.min.js";var ct=class extends Ji{constructor(){super()}render(){return Xi`
            <slot name="icon"></slot>
    ...
    `),d(ct,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ct);import{html as cr,css as en,LitElement as tn,nothing as Ia}from"./lit-all.min.js";var st=class extends tn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return cr`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?cr`<slot name="content"></slot>`:Ia}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?cr`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Ia}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(st,"styles",en`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

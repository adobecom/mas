var Ir=Object.defineProperty;var $r=a=>{throw TypeError(a)};var $i=(a,r,e)=>r in a?Ir(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Hi=(a,r)=>()=>(a&&(r=a(a=0)),r);var Bi=(a,r)=>{for(var e in r)Ir(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>$i(a,typeof r!="symbol"?r+"":r,e),or=(a,r,e)=>r.has(a)||$r("Cannot "+e);var l=(a,r,e)=>(or(a,r,"read from private field"),e?e.call(a):r.get(a)),u=(a,r,e)=>r.has(a)?$r("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(or(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),w=(a,r,e)=>(or(a,r,"access private method"),e);var Hr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return l(a,r,t)}});var cr={};Bi(cr,{default:()=>at});import{LitElement as qi,html as Le,css as Ui,nothing as ji}from"./lit-all.min.js";import{unsafeHTML as Vr}from"./lit-all.min.js";import{ifDefined as Gi}from"./lit-all.min.js";function Vi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var F,at,sr=Hi(()=>{F=class F extends qi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();F.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,s=this.shadowRoot?.querySelector(".css-tooltip-body"),d=s?s.offsetWidth:o,p=s?s.offsetHeight:c,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>t&&(f="left");let E=e.left+e.width/2,O=e.top+e.height/2,D=6,ge=(Fi,Ni,Ii)=>Math.max(Fi,Math.min(Ni,Ii)),Mt,_t,nr;f==="top"||f==="bottom"?(Mt=f==="top"?e.top-p-n:e.bottom+n,_t=ge(0,t-d,E-d/2),nr=ge(D,d-D*2,E-_t-D)):(_t=f==="left"?e.left-d-n:e.right+n,Mt=ge(0,i-p,O-p/2),nr=ge(D,p-D*2,O-Mt-D)),this._tooltipTop=Mt,this._tooltipLeft=_t,this._arrowOffset=nr,this._computedPlacement=f}showTooltip(){F.activeTooltip&&F.activeTooltip!==this&&(F.activeTooltip.closeOverlay(),F.activeTooltip.tooltipVisible=!1,F.activeTooltip.requestUpdate()),F.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){F.activeTooltip===this&&(F.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Le`<merch-icon
    ...
    `);at=F;customElements.define("mas-mnemonic",at)});import{LitElement as Vo}from"./lit-all.min.js";import{css as Ur,unsafeCSS as qr}from"./lit-all.min.js";var k="(max-width: 767px)",T="(max-width: 1199px)",y="(min-width: 768px)",b="(min-width: 1200px)",M="(min-width: 1600px)",Rt="(min-width: 1280px)",Br={matchMobile:window.matchMedia(k),matchDesktop:window.matchMedia(`${b} and (not ${M})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(M),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Br;function Ot(){return Br.isDesktop}var jr=Ur`
    :host {
...
`;var pn=32,va={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Q,He=class extends v{constructor(e){super(e);u(this,Q);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>qt` <footer>
    ...
    `);import{html as ht,css as mn,nothing as Ut}from"./lit-all.min.js";var ba=`
:root {
...
`;var[Fs,Ns,Sa,Aa,Ta,La]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var fn="pro",za=`--consonant-merch-card-${fn}-top-card-height`,Pa={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ae,ye,ft,z,Ma,mt,_a,gt,gr,Vt,Wt=class Wt extends v{constructor(e){super(e);u(this,z);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,ae,null);u(this,ye,null);h(this,"lastSyncKey",null);u(this,ft,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of w(this,z,Ma).call(this)){let n=i.variantLayout;n instanceof Wt&&(n.expanded=t,i._proExpanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?w(this,z,gr).call(this):w(this,z,gt).call(this),this.card.requestUpdate()});u(this,Vt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Aa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:w(this,z,gt).call(this);break;case Sa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:w(this,z,gt).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Ta:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}w(this,z,gt).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),w(this,z,gr).call(this);break;case La:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,w(this,z,mt).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(_,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._proExpanded??!1}getGlobalCSS(){return Ca}priceOptionsProvider(e,t){e.dataset.template===R&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(U,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let t=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=t?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=t.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${C}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let e=this.card.querySelector('[slot="whats-included"]');if(!e||e.querySelector(".whats-included-title"))return;let t=e.querySelector(".whats-included-label");if(!t)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=t.innerHTML,t.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},c=document.createElement("p");if(c.className="whats-included-label",c.textContent=n??"",i.after(c),e.querySelectorAll(".section h4").forEach(s=>{let d=document.createElement("p");d.innerHTML=s.innerHTML,s.replaceWith(d)}),e.querySelectorAll(".section ul").forEach(s=>{[...s.children].forEach(d=>{let p=document.createElement("p");p.innerHTML=d.innerHTML,s.before(p)}),s.remove()}),o){let s=document.createElement("div");s.className="whats-included-disclaimer",s.innerHTML=o,e.append(s)}}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=za,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1),o=new Map;for(let c of n){let s=o.get(c.offsetTop)??[];s.push(c),o.set(c.offsetTop,s)}for(let c of o.values()){let s=0;for(let d of c){d.style.removeProperty(i);let p=d.shadowRoot?.querySelector(".top-card");p&&(s=Math.max(s,parseInt(getComputedStyle(p).height)||0))}s>0&&c.length>1&&c.forEach(d=>d.style.setProperty(i,`${s}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),i=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(it,l(this,ft)),this.card.addEventListener(_,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;m(this,ye,new ResizeObserver(()=>this.resyncOnReflow())),l(this,ye).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&l(this,ye).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(_,this.updatePriceQuantity),w(this,z,mt).call(this),l(this,ye)?.disconnect(),this.card?.removeEventListener(it,l(this,ft))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t)return null;let o=[];for(let c=t;c<=i;c+=n)o.push(String(c));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return de`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return de`
        ...
        `}renderLayout(){let e=!!this.expanded;return de`
            ...
            ${this.hasWhatsIncluded?de`
                  ...
                  `:pt}
            <slot></slot>
        `}};ae=new WeakMap,ye=new WeakMap,ft=new WeakMap,z=new WeakSet,Ma=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},mt=function(){l(this,ae)&&(document.removeEventListener("mousedown",l(this,ae)),m(this,ae,null))},_a=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},gt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=w(this,z,_a).call(this),l(this,ae)||(m(this,ae,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),w(this,z,mt).call(this))}),document.addEventListener("mousedown",l(this,ae)))},gr=function(){this.licenseOpen=!1,w(this,z,mt).call(this)},Vt=new WeakMap,h(Wt,"variantStyle",un`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var ut=Wt;import{html as ur,css as vn}from"./lit-all.min.js";var Ra=`
:root {
...
`;var Fa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},qe=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===R&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Da}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${C}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return fr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var xr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},vt=class vt extends v{getGlobalCSS(){return qa}get aemFragmentMapping(){return xr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ua`
    ...
    `);var bt=vt;import{html as xt,css as Sn,nothing as Ga}from"./lit-all.min.js";var ja=`
...
`;var yr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Mn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Kt,Qa,Ke=class extends v{constructor(e){super(e);u(this,Kt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ya}get aemFragmentMapping(){return yr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,w(this,Kt,Qa).call(this))}renderLayout(){return zn`
            <div class="card">
            ...
            <slot></slot>
        `}};Kt=new WeakSet,Qa=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Mn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ke,"variantStyle",Pn`
    ...
    `);import{html as _n,css as Rn}from"./lit-all.min.js";var Za=`
...
Caused by: ${this.cause}`),e}};var we={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ai=1e3;function Nn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ii(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!we.serializableTypes.includes(e))return e}return a}function In(a,r){if(!we.ignoredProperties.includes(a))return ii(r)}var Cr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(Nn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(ii).join(" ")}`);let{pathname:o,search:c}=window.location,s=`${we.delimiter}page=${o}${c}`;s.length>ai&&(s=`${s.slice(0,ai)}<trunc>`),n+=s,i.length&&(n+=`${we.delimiter}facts=`,n+=JSON.stringify(i,In)),window.lana?.log(n,we)}};function ni(a){Object.assign(we,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in we&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var oi={LOCAL:"local",PROD:"prod",STAGE:"stage"},Sr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Ar=new Set,Tr=new Set,ci=new Map,si={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},li={filter:({level:a})=>a!==Sr.DEBUG},$n={filter:()=>!1};function Hn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Zt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function Bn(a){[...Tr].every(r=>r(a))&&Ar.forEach(r=>r(a))}function di(a){let r=(ci.get(a)??0)+1;ci.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>di(`${t.namespace}/${i}`),updateConfig:ni};return Object.values(Sr).forEach(i=>{t[i]=(n,...o)=>Bn(Hn(i,n,a,o,e))}),Object.seal(t)}function Xt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Zt(t)&&Tr.add(t),Zt(e)&&Ar.add(e)})}function qn(a={}){let{name:r}=a,e=ri(Qt("commerce.debug",{search:!0,storage:!0}),r===oi.LOCAL);return Xt(e?si:li),r===oi.PROD&&Xt(Cr),yt}function Un(){Ar.clear(),Tr.clear()}var yt={...di(ra),Level:Sr,Plugins:{consoleAppender:si,debugFilter:li,quietFilter:$n,lanaAppender:Cr},init:qn,reset:Un,use:Xt};var jn="mas-commerce-service",Bd=yt.module("utilities"),Gn={requestId:Dt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Jt=a=>window.setTimeout(a);function Lr(){return document.getElementsByTagName(jn)?.[0]}function hi(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Gn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function pi(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,t*(n+1)))}throw i}var mi="fragment",gi="author",ui="preview",fi="loading",vi="mask",bi="pzn",xi="timeout",zr="aem-fragment",yi="eager",wi="cache",Vn=[yi,wi],j,Ee,I,Pr=class{constructor(){u(this,j,new Map);u(this,Ee,new Map);u(this,I,new Map)}clear(){l(this,j).clear(),l(this,Ee).clear(),l(this,I).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(l(this,j).set(r.id,r),r.fields?.originalId&&l(this,j).set(r.fields.originalId,r),l(this,I).has(r.id)){let[,t]=l(this,I).get(r.id);t()}if(l(this,I).has(r.fields?.originalId)){let[,t]=l(this,I).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return l(this,j).has(r)}entries(){return l(this,j).entries()}get(r){return l(this,j).get(r)}getAsPromise(r){let[e]=l(this,I).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),l(this,I).set(r,[e,t]),e}getFetchInfo(r){let e=l(this,Ee).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},l(this,Ee).set(r,e)),e}set(r,e){if(l(this,j).set(r,e),l(this,I).has(r)){let[,t]=l(this,I).get(r);t()}}remove(r){l(this,j).delete(r),l(this,Ee).delete(r),l(this,I).delete(r)}};j=new WeakMap,Ee=new WeakMap,I=new WeakMap;var ie=new Pr,Qe,H,ne,$,G,P,wt,V,W,Et,K,kt,Ct,Ze,Y,Ei,ki,Mr,Ci,er=class extends HTMLElement{constructor(){super(...arguments);u(this,Y);h(this,"cache",ie);u(this,Qe);u(this,H,null);u(this,ne,null);u(this,$,null);u(this,G);u(this,P);u(this,wt,yi);u(this,V);u(this,W);u(this,Et,5e3);u(this,K);u(this,kt,!1);u(this,Ct,0);u(this,Ze)}static get observedAttributes(){return[mi,fi,xi,gi,ui,vi,bi]}cacheKey(){return`${l(this,G)}${l(this,W)?`-p_${l(this,W)}`:""}${l(this,V)?`-m_${l(this,V)}`:""}`}attributeChangedCallback(e,t,i){e===mi&&(m(this,G,i),m(this,P,ie.getFetchInfo(this.cacheKey()))),e===vi&&m(this,V,i),e===bi&&m(this,W,i),e===fi&&Vn.includes(i)&&m(this,wt,i),e===xi&&m(this,Et,parseInt(i,10)),e===gi&&m(this,kt,["","true"].includes(i)),e===ui&&m(this,Ze,i)}connectedCallback(){if(!l(this,K)){if(l(this,$)??m(this,$,ve(this)),m(this,Ze,l(this,$).settings?.preview),l(this,Qe)??m(this,Qe,l(this,$).log.module(`${zr}[${l(this,G)}]`)),!l(this,G)||l(this,G)==="#"){l(this,P)??m(this,P,ie.getFetchInfo("missing-fragment-id")),w(this,Y,Mr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(l(this,P)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(l(this,K)&&!await Promise.race([l(this,K),Promise.resolve(!1)]))return;e&&ie.remove(this.cacheKey()),l(this,wt)===wi&&await Promise.race([ie.getAsPromise(this.cacheKey()),new Promise(c=>setTimeout(c,l(this,Et)))]);try{m(this,K,w(this,Y,Ci).call(this)),await l(this,K)}catch(c){return w(this,Y,Mr).call(this,c.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=l(this,H)||{};return o&&!Qt("mas.disableWcsCache")&&l(this,$).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(_e,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...l(this,P)},bubbles:!0,composed:!0})),l(this,K)}get updateComplete(){return l(this,K)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return l(this,ne)?l(this,ne):(l(this,kt)?this.transformAuthorData():this.transformPublishData(),l(this,ne))}get rawData(){return l(this,H)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,promoProject:c,promoVariationProject:s,settings:d={},priceLiterals:p={},dictionary:g={},placeholders:f={}}=l(this,H);m(this,ne,e.reduce((E,{name:O,multiple:D,values:ge})=>(E.fields[O]=D?ge:ge[0],E),{fields:{},id:t,tags:n,settings:d,priceLiterals:p,dictionary:g,maskId:i,placeholders:f,variationId:o,promoProject:c,promoVariationProject:s}))}transformPublishData(){if(!l(this,H))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},maskId:s,placeholders:d={},variationId:p,promoProject:g,promoVariationProject:f}=l(this,H);m(this,ne,Object.entries(e).reduce((E,[O,D])=>(E.fields[O]=D?.mimeType?D.value:D??"",E),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:c,maskId:s,placeholders:d,variationId:p,promoProject:g,promoVariationProject:f}))}getFragmentClientUrl(){let e=new URLSearchParams(window.location.search),{hostname:t}=window.location,i=t.endsWith(".page")?"page":"live";return`${oa(e.get("maslibs"),i)??"https://mas.adobe.com"}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:l(this,$).settings.locale,apiKey:l(this,$).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??l(this,$).settings.instant,o={...i,...n!=null?{instant:n}:{},...l(this,V)!=null?{mask:l(this,V)}:{},...l(this,W)!=null?{pzn:l(this,W)}:{}};return await t(l(this,G),o)}};Qe=new WeakMap,H=new WeakMap,ne=new WeakMap,$=new WeakMap,G=new WeakMap,P=new WeakMap,wt=new WeakMap,V=new WeakMap,W=new WeakMap,Et=new WeakMap,K=new WeakMap,kt=new WeakMap,Ct=new WeakMap,Ze=new WeakMap,Y=new WeakSet,Ei=async function(e){Hr(this,Ct)._++;let t=`${zr}:${this.cacheKey()}:${l(this,Ct)}`,i=`${t}${Ft}`,n=`${t}${Nt}`;if(l(this,Ze)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new he(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(l(this,P).stale=!1,l(this,P).url=e,o=await pi(e,{cache:"default",credentials:"omit"}),w(this,Y,ki).call(this,o),l(this,P).status=o?.status,l(this,P).measure=Oe(performance.measure(n,i)),l(this,P).retryCount=o.retryCount,!o?.ok)throw new he("Unexpected fragment response",{response:o,...l(this,$).duration});return await o.json()}catch(c){if(l(this,P).measure=Oe(performance.measure(n,i)),l(this,P).retryCount=c.retryCount,l(this,H))return l(this,P).stale=!0,l(this,Qe).error("Serving stale data",l(this,P)),l(this,H);let s=c.message??"unknown";throw new he(`Failed to fetch fragment: ${s}`,{})}},ki=function(e){Object.assign(l(this,P),hi(e))},Mr=function(e){m(this,K,null),l(this,P).message=e,this.classList.add("error");let t={...l(this,P),...l(this,$).duration};l(this,Qe).error(e,t),this.dispatchEvent(new CustomEvent(Re,{detail:t,bubbles:!0,composed:!0}))},Ci=async function(){var s;this.classList.remove("error"),m(this,ne,null);let e=ie.get(this.cacheKey());if(e)return m(this,H,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=l(this,$).settings,c=`${t}/fragment?id=${l(this,G)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),l(this,V)&&(c+=`&mask=${l(this,V)}`),l(this,W)&&(c+=`&pzn=${l(this,W)}`),e=await w(this,Y,Ei).call(this,c),(s=e.fields).originalId??(s.originalId=l(this,G)),l(this,V)||l(this,W)?ie.set(this.cacheKey(),e):ie.add(e),m(this,H,e),!0},h(er,"cache",ie);customElements.define(zr,er);import{LitElement as Wn,html as _r,css as Kn,nothing as Yn}from"./lit-all.min.js";import{unsafeHTML as Qn}from"./lit-all.min.js";var Zn=a=>a?a.startsWith("sp-icon-")?_r`${Qn(`<${a} class="badge-icon"></${a}>`)}`:_r`<img src="${a}" class="badge-icon" />`:Yn,Xe=class extends Wn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return _r`<div class="badge">
    ...
    `),h(St,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",St);import{html as Rr,css as to,LitElement as ro,nothing as Si}from"./lit-all.min.js";var At=class extends ro{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Rr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Rr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:Si}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(At,"styles",to`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

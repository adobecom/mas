...
`,nc=()=>[b`
    ...
    `);customElements.define("merch-addon",Bt);M();var Ut,Br=class Br{constructor(t){m(this,"card");E(this,Ut);this.card=t,this.insertVariantStyle()}getContainer(){return y(this,Ut,h(this,Ut)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),h(this,Ut)}insertVariantStyle(){let t=this.constructor.name;if(!Br.styleMap[t]){Br.styleMap[t]=!0;let r=document.createElement("style");r.innerHTML=this.getGlobalCSS(),document.head.appendChild(r)}}updateCardElementMinHeight(t,r){if(!t)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,n=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),a=parseInt(this.getContainer().style.getPropertyValue(i))||0;n>a&&this.getContainer().style.setProperty(i,`${n}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),f`
            <div
                id="badge"
...
`;var zi=class extends C{constructor(t){super(t)}getGlobalCSS(){return sc}renderLayout(){return f`${this.cardImage}
            <div class="body">
...
`;var $i=class extends C{constructor(t){super(t)}getGlobalCSS(){return cc}renderLayout(){return f` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;document.head.appendChild(_c);var kc="fragment",Pc="author",Lc="preview",Rc="loading",Mc="timeout",Aa="aem-fragment",Oc="eager",Nc="cache",kh=[Oc,Nc],Me,yt,Ce,Ta=class{constructor(){E(this,Me,new Map);E(this,yt,new Map);E(this,Ce,new Map)}clear(){h(this,Me).clear(),h(this,yt).clear(),h(this,Ce).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,Me).set(t.id,t),t.fields?.originalId&&h(this,Me).set(t.fields.originalId,t),h(this,Ce).has(t.id)){let[,i]=h(this,Ce).get(t.id);i()}if(h(this,Ce).has(t.fields?.originalId)){let[,i]=h(this,Ce).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:n,value:a}=t.references[i];n==="content-fragment"&&(a.settings={...t?.settings,...a.settings},a.placeholders={...t?.placeholders,...a.placeholders},a.dictionary={...t?.dictionary,...a.dictionary},a.priceLiterals={...t?.priceLiterals,...a.priceLiterals},this.add(a,t))}}}has(t){return h(this,Me).has(t)}entries(){return h(this,Me).entries()}get(t){return h(this,Me).get(t)}getAsPromise(t){let[r]=h(this,Ce).get(t)??[];if(r)return r;let i;return r=new Promise(n=>{i=n,this.has(t)&&n()}),h(this,Ce).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,yt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,yt).set(t,r)),r}remove(t){h(this,Me).delete(t),h(this,yt).delete(t),h(this,Ce).delete(t)}};Me=new WeakMap,yt=new WeakMap,Ce=new WeakMap;var Xe=new Ta,Xt,_e,Be,ye,ue,Z,Ur,Fr,ke,Gr,qr,Kt,Pe,Ic,Dc,Ca,zc,Ui=class extends HTMLElement{constructor(){super(...arguments);E(this,Pe);m(this,"cache",Xe);E(this,Xt);E(this,_e,null);E(this,Be,null);E(this,ye,null);E(this,ue);E(this,Z);E(this,Ur,Oc);E(this,Fr,5e3);E(this,ke);E(this,Gr,!1);E(this,qr,0);E(this,Kt)}static get observedAttributes(){return[kc,Rc,Mc,Pc,Lc]}attributeChangedCallback(r,i,n){r===kc&&(y(this,ue,n),y(this,Z,Xe.getFetchInfo(n))),r===Rc&&kh.includes(n)&&y(this,Ur,n),r===Mc&&y(this,Fr,parseInt(n,10)),r===Pc&&y(this,Gr,["","true"].includes(n)),r===Lc&&y(this,Kt,n)}connectedCallback(){if(!h(this,ke)){if(h(this,ye)??y(this,ye,ht(this)),y(this,Kt,h(this,ye).settings?.preview),h(this,Xt)??y(this,Xt,h(this,ye).log.module(`${Aa}[${h(this,ue)}]`)),!h(this,ue)||h(this,ue)==="#"){h(this,Z)??y(this,Z,Xe.getFetchInfo("missing-fragment-id")),ee(this,Pe,Ca).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,Z)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,ke)&&!await Promise.race([h(this,ke),Promise.resolve(!1)]))return;r&&Xe.remove(h(this,ue)),h(this,Ur)===Nc&&await Promise.race([Xe.getAsPromise(h(this,ue)),new Promise(s=>setTimeout(s,h(this,Fr)))]);try{y(this,ke,ee(this,Pe,zc).call(this)),await h(this,ke)}catch(s){return ee(this,Pe,Ca).call(this,s.message),!1}let{references:i,referencesTree:n,placeholders:a,wcs:o}=h(this,_e)||{};return o&&!U("mas.disableWcsCache")&&h(this,ye).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(rt,{detail:{...this.data,references:i,referencesTree:n,placeholders:a,...h(this,Z)},bubbles:!0,composed:!0})),h(this,ke)}get updateComplete(){return h(this,ke)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,Be)?h(this,Be):(h(this,Gr)?this.transformAuthorData():this.transformPublishData(),h(this,Be))}get rawData(){return h(this,_e)}transformAuthorData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,_e);y(this,Be,r.reduce((l,{name:d,multiple:p,values:u})=>(l.fields[d]=p?u:u[0],l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,_e);y(this,Be,Object.entries(r).reduce((l,[d,p])=>(l.fields[d]=p?.mimeType?p.value:p??"",l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=i.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,o=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${o}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,ue),{locale:h(this,ye).settings.locale,apiKey:h(this,ye).settings.wcsApiKey})}};Xt=new WeakMap,_e=new WeakMap,Be=new WeakMap,ye=new WeakMap,ue=new WeakMap,Z=new WeakMap,Ur=new WeakMap,Fr=new WeakMap,ke=new WeakMap,Gr=new WeakMap,qr=new WeakMap,Kt=new WeakMap,Pe=new WeakSet,Ic=async function(r){Va(this,qr)._++;let i=`${Aa}:${h(this,ue)}:${h(this,qr)}`,n=`${i}${at}`,a=`${i}${ot}`;if(h(this,Kt))return await this.generatePreview();performance.mark(n);let o;try{if(h(this,Z).stale=!1,h(this,Z).url=r,o=await Ti(r,{cache:"default",credentials:"omit"}),ee(this,Pe,Dc).call(this,o),h(this,Z).status=o?.status,h(this,Z).measure=Re(performance.measure(a,n)),h(this,Z).retryCount=o.retryCount,!o?.ok)throw new Ie("Unexpected fragment response",{response:o,...h(this,ye).duration});return await o.json()}catch(s){if(h(this,Z).measure=Re(performance.measure(a,n)),h(this,Z).retryCount=s.retryCount,h(this,_e))return h(this,Z).stale=!0,h(this,Xt).error("Serving stale data",h(this,Z)),h(this,_e);let c=s.message??"unknown";throw new Ie(`Failed to fetch fragment: ${c}`,{})}},Dc=function(r){Object.assign(h(this,Z),li(r))},Ca=function(r){y(this,ke,null),h(this,Z).message=r,this.classList.add("error");let i={...h(this,Z),...h(this,ye).duration};h(this,Xt).error(r,i),this.dispatchEvent(new CustomEvent(it,{detail:i,bubbles:!0,composed:!0}))},zc=async function(){var c;this.classList.remove("error"),y(this,Be,null);let r=Xe.get(h(this,ue));if(r)return y(this,_e,r),!0;let{masIOUrl:i,wcsApiKey:n,country:a,locale:o}=h(this,ye).settings,s=`${i}/fragment?id=${h(this,ue)}&api_key=${n}&locale=${o}`;return a&&!o.endsWith(`_${a}`)&&(s+=`&country=${a}`),r=await ee(this,Pe,Ic).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,ue)),Xe.add(r),y(this,_e,r),!0},m(Ui,"cache",Xe);customElements.define(Aa,Ui);M();var Qt=class extends ${constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">${this.text}</div>`}};m(Qt,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),m(Qt,"styles",b`
    ...
    `);customElements.define("merch-badge",Qt);M();var Vr=class extends ${constructor(){super()}render(){return f`
            <slot name="icon"></slot>
    ...
    `),m(Vr,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Vr);M();var jr=class extends ${updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return f`<slot name="heading"></slot>
...
`;var Qc={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},nr=class extends C{getGlobalCSS(){return Kc}renderLayout(){return f` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var za={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},sr=class extends C{getGlobalCSS(){return el}get aemFragmentMapping(){return za}renderLayout(){return f`
    ...
    `);j("ccd-suggested",ir,Xc,ir.variantStyle);j("ccd-slice",nr,Qc,nr.variantStyle);j("ah-try-buy-widget",ar,Ia,ar.variantStyle);j("ah-promoted-plans",or,Da,or.variantStyle);j("fries",sr,za,sr.variantStyle);

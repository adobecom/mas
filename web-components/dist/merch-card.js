var Pr=Object.defineProperty;var _r=a=>{throw TypeError(a)};var Li=(a,t,e)=>t in a?Pr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var Pi=(a,t)=>()=>(a&&(t=a(a=0)),t);var _i=(a,t)=>{for(var e in t)Pr(a,e,{get:t[e],enumerable:!0})};var h=(a,t,e)=>Li(a,typeof t!="symbol"?t+"":t,e),Jt=(a,t,e)=>t.has(a)||_r("Cannot "+e);var l=(a,t,e)=>(Jt(a,t,"read from private field"),e?e.call(a):t.get(a)),u=(a,t,e)=>t.has(a)?_r("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Jt(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),y=(a,t,e)=>(Jt(a,t,"access private method"),e);var Mr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return l(a,t,r)}});var er={};_i(er,{default:()=>Je});import{LitElement as Mi,html as Ce,css as Ri,nothing as Oi}from"./lit-all.min.js";import{unsafeHTML as $r}from"./lit-all.min.js";import{ifDefined as Di}from"./lit-all.min.js";function Ni(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var R,Je,tr=Pi(()=>{R=class R extends Mi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();R.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),d=c?c.offsetWidth:o,p=c?c.offsetHeight:s,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>r&&(f="left");let C=e.left+e.width/2,G=e.top+e.height/2,re=6,kt=(Ai,zi,Ti)=>Math.max(Ai,Math.min(zi,Ti)),Ct,St,Xt;f==="top"||f==="bottom"?(Ct=f==="top"?e.top-p-n:e.bottom+n,St=kt(0,r-d,C-d/2),Xt=kt(re,d-re*2,C-St-re)):(St=f==="left"?e.left-d-n:e.right+n,Ct=kt(0,i-p,G-p/2),Xt=kt(re,p-re*2,G-Ct-re)),this._tooltipTop=Ct,this._tooltipLeft=St,this._arrowOffset=Xt,this._computedPlacement=f}showTooltip(){R.activeTooltip&&R.activeTooltip!==this&&(R.activeTooltip.closeOverlay(),R.activeTooltip.tooltipVisible=!1,R.activeTooltip.requestUpdate()),R.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){R.activeTooltip===this&&(R.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ce`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:Ce`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return Ce`<span class="icon-only">${this.renderIcon()}</span>`;if(Ni())return Ce`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let i=t.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:g=>{this.lastPointerType=g.pointerType},pointerenter:g=>g.pointerType!=="touch"&&this.showTooltip(),pointerleave:g=>g.pointerType!=="touch"&&this.hideTooltip(),click:g=>{this.lastPointerType==="touch"&&this.handleTap(g),this.lastPointerType=null}},s=this._computedPlacement,c=s==="top"||s==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=c?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return Ce`
            <span
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${Di(d)}>
                    ${$r(t)}
    ...
    `);Je=R;customElements.define("mas-mnemonic",Je)});import{LitElement as Ro}from"./lit-all.min.js";import{css as Nr,unsafeCSS as Dr}from"./lit-all.min.js";var E="(max-width: 767px)",P="(max-width: 1199px)",k="(min-width: 768px)",b="(min-width: 1200px)",_="(min-width: 1600px)",Rr="(min-width: 1280px)",Or={matchMobile:window.matchMedia(E),matchDesktop:window.matchMedia(`${b} and (not ${_})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(_),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Or;function At(){return Or.isDesktop}var Fr=Nr`
    :host {
...
`,Ir=()=>[Nr`
        ...
        `];import{LitElement as Fi,html as Br,css as Ii}from"./lit-all.min.js";function $i(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Se=class extends Fi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if($i())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>tr())}e.remove()})}render(){let{href:t}=this;return t?Br`<a href="${t}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(Se,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(Se,"styles",Ii`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Se);var Ko=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Yo=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var Ae=2e4;var w='span[is="inline-price"][data-wcs-osi]',X='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Bi='a[is="upt-link"]',Hr=`${w},${X},${Bi}`;var qr="merch-offer-select:ready",Ur="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",Gr="merch-card-quantity:change",rr="merch-modal:addon-and-quantity-update";var ze="merch-card-collection:literals-changed";var Te="aem:load",Le="aem:error",zt="mas:ready",jr="mas:error";var Vr="placeholder-failed",Wr="placeholder-pending",Kr="placeholder-resolved";var Yr="mas:failed",j="mas:resolved",Qr="mas/commerce";var ae="failed",pe="pending",ie="resolved";var Tt="X-Request-Id",Qo=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Zo=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Lt=":start",Pt=":duration";var M="legal",Zr="mas-ff-defaults";var Hi="mas-commerce-service";function Xr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function z(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function Pe(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function ar(){return window.matchMedia("(max-width: 1024px)").matches}function me(){return document.getElementsByTagName(Hi)?.[0]}function et(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}function Jr(a){let t=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&t?.isInlinePrice&&t?.dataset?.template==="price"}var tt,ge,rt,at,_e,_t=class extends HTMLElement{constructor(){super();u(this,tt,"");u(this,ge);u(this,rt,[]);u(this,at,[]);u(this,_e);m(this,_e,Xr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,l(this,ge)?this.parentElement.style.borderRadius=l(this,ge):l(this,ge)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=l(this,rt).map((r,i)=>{let n=l(this,at)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${l(this,tt)}, ${e})`}connectedCallback(){l(this,_e).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,ge,i?.trim()),e==="colors"&&i?m(this,rt,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,at,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,tt,i?.trim()??""),l(this,_e).call(this)}};tt=new WeakMap,ge=new WeakMap,rt=new WeakMap,at=new WeakMap,_e=new WeakMap;customElements.define("merch-gradient",_t);import{LitElement as qi,html as Ui,css as Gi}from"./lit-all.min.js";var Me=class extends qi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${w}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(j,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(j,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Ui` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(Me,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),h(Me,"styles",Gi`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",Me);import{html as Mt,nothing as ji}from"./lit-all.min.js";var Re,it=class it{constructor(t){h(this,"card");u(this,Re);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,Re,l(this,Re)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),l(this,Re)}insertVariantStyle(){let t=this.constructor.name;if(!it.styleMap[t]){it.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let r=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${r}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of t){let s=`--consonant-merch-card-${r}-${o}-height`;e.style.getPropertyValue(s)&&e.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),d=n.get(c);d||(d=[],n.set(c,d)),d.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of t){let d=`--consonant-merch-card-${r}-${s}-height`,p=o.map(f=>f.style.getPropertyValue(d)),g=0;for(let f of o){f.style.removeProperty(d);let C=c(f);if(!C)continue;let G=Math.max(0,parseInt(window.getComputedStyle(C).height)||0);G>g&&(g=G)}o.forEach((f,C)=>{g>0?f.style.setProperty(d,`${g}px`):p[C]&&f.style.setProperty(d,p[C])})}}get legalDisplayDot(){return!0}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Mt`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return ea}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};h(Oe,"variantStyle",Vi`
    ...
    `);import{html as nt,css as Wi}from"./lit-all.min.js";var ra=`
:root {
...
`;var aa={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},ue=class extends v{constructor(t){super(t)}getGlobalCSS(){return ra}renderLayout(){return nt`<div class="image">
                <slot name="bg-image"></slot>
    ...
    `);import{html as na}from"./lit-all.min.js";var ia=`
:root {
...
`;var Ot=class extends v{constructor(t){super(t)}getGlobalCSS(){return ia}renderLayout(){return na` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":na`<hr />`} ${this.secureLabelFooter}`}};import{html as ne,css as Ki,unsafeCSS as sa}from"./lit-all.min.js";var oa=`
  :root {
...
`;var Yi=32,ca={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},De=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ne`<slot name="secure-transaction-label">
    ...
    `);import{html as Dt,css as Qi,unsafeCSS as da,nothing as Zi}from"./lit-all.min.js";var la=`
  :root {
...
`;var Xi=32,ha={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ne=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Dt` <footer>
    ...
    `);import{html as ot,css as Ji,nothing as Nt}from"./lit-all.min.js";var pa=`
:root {
...
`;var Ft={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ma={...function(){let{whatsIncluded:a,size:t,...e}=Ft;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},ga={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=Ft;return i}()},V,W,D=class extends v{constructor(e){super(e);u(this,V);u(this,W);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return pa}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!r.includes(s)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&c){if(d)c.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(c):p.appendChild(c)}return}if(i&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!c){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){l(this,V)||(m(this,V,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(l(this,V)?.disconnect(),m(this,V,null),this.syncHeights())})),l(this,V).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=et(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(d+=et(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+et(f));for(let G of r.childNodes){if(G.classList.contains("spacer"))break;d+=et(G)}let C=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(C)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${w}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?ot`<div class="divider"></div>`:Nt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled?.();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?ot`<label id="stock-checkbox">
                <input type="checkbox" @change=${this.card.toggleStockOffer}></input>
                <span></span>
                ${this.card.checkboxLabel}
            </label>`:Nt}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Nt:ot`<slot name="icons"></slot>`}connectedCallbackHook(){x.matchMobile.addEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.addEventListener("change",this.adaptForMedia),this.handleResize=()=>{l(this,W)&&cancelAnimationFrame(l(this,W)),m(this,W,requestAnimationFrame(()=>{m(this,W,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))},window.addEventListener("resize",this.handleResize)}disconnectedCallbackHook(){x.matchMobile.removeEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.removeEventListener("change",this.adaptForMedia),l(this,V)?.disconnect(),m(this,V,null),this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),l(this,W)&&(cancelAnimationFrame(l(this,W)),m(this,W,null))}renderLayout(){return ot` ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="heading-xs"></slot>
    ...
    `),h(D,"collectionOptions",{customHeaderArea:e=>e.sidenav?ot`<slot name="resultsText"></slot>`:Nt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let r=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};x.matchDesktop.addEventListener("change",r),e.addEventListener(ze,r),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",r),e.removeEventListener(ze,r)})}});import{html as J,css as en,unsafeCSS as fa,nothing as It}from"./lit-all.min.js";var ua=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?J`
        ...
        `:J`
            ...
            `:It}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?J`<slot name="icons"></slot>`:It}get secureLabelFooter(){return J`<footer>
            ...
            <slot></slot>`}};h(oe,"variantStyle",en`
...
`;var[kc,Cc,xa,ya,wa,Ea]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var ka={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ee,K,fe,T,Ca,ct,Sa,lt,nr,$t,Bt=class Bt extends v{constructor(){super(...arguments);u(this,T);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,ee,null);u(this,K,null);u(this,fe,null);h(this,"handleResize",()=>{l(this,K)&&cancelAnimationFrame(l(this,K)),m(this,K,requestAnimationFrame(()=>{m(this,K,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))});h(this,"toggleExpanded",e=>{e.preventDefault();let r=!this.expanded;for(let i of y(this,T,Ca).call(this)){let n=i.variantLayout;n instanceof Bt&&(n.expanded=r,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?y(this,T,nr).call(this):y(this,T,lt).call(this),this.card.requestUpdate()});u(this,$t,e=>{let r=this.licenseOptions;if(!r?.length)return;let i=r.length-1;switch(e.key){case ya:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%r.length:y(this,T,lt).call(this);break;case xa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+r.length)%r.length:y(this,T,lt).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case wa:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(r[this.licenseHighlightedIndex]);return}y(this,T,lt).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),y(this,T,nr).call(this);break;case Ea:this.licenseOpen&&this.selectLicenseQty(r[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,y(this,T,ct).call(this);let r=this.quantitySelectEl;r&&(r.selectedValue=Number(e),r.dispatchEvent(new CustomEvent(O,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return ba}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),r.dataset.displayPerUnit="false",e.parentNode.insertBefore(r,e.nextSibling),await r.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),r.addEventListener(j,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]')?.querySelector(".price-plan-type");i&&(i.textContent=e)}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled?.();let i=r.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights())}syncHeights(){this.card.getBoundingClientRect().width<=2||this.syncRowHeights([{name:"top-card",getElement:e=>e.shadowRoot?.querySelector(".top-card")}])}connectedCallbackHook(){window.addEventListener("resize",this.handleResize),m(this,fe,new IntersectionObserver(([e])=>{e.boundingClientRect.height!==0&&e.isIntersecting&&(window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights()),l(this,fe)?.disconnect())})),l(this,fe).observe(this.card)}disconnectedCallbackHook(){y(this,T,ct).call(this),window.removeEventListener("resize",this.handleResize),l(this,K)&&(cancelAnimationFrame(l(this,K)),m(this,K,null)),l(this,fe)?.disconnect()}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let r=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(r)||Number.isNaN(i)||i<r)return null;let o=[];for(let s=r;s<=i;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(e){let r=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=r.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let r=this.quantitySelectEl?.getAttribute("default-value");return r!=null&&e.includes(r)?r:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return se`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,r=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(r));return se`
        ...
        `}renderLayout(){let e=!!this.expanded;return se`
            ...
            ${this.hasWhatsIncluded?se`
                  ...
                  `:st}
            <slot></slot>
        `}};ee=new WeakMap,K=new WeakMap,fe=new WeakMap,T=new WeakSet,Ca=function(){let e=Math.round(this.card.getBoundingClientRect().top),r=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(i=>{let n=i.getBoundingClientRect();return n.width>2&&Math.round(n.top)===e});return r.length?r:[this.card]},ct=function(){l(this,ee)&&(document.removeEventListener("mousedown",l(this,ee)),m(this,ee,null))},Sa=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},lt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=y(this,T,Sa).call(this),l(this,ee)||(m(this,ee,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),y(this,T,ct).call(this))}),document.addEventListener("mousedown",l(this,ee)))},nr=function(){this.licenseOpen=!1,y(this,T,ct).call(this)},$t=new WeakMap,h(Bt,"variantStyle",tn`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var dt=Bt;import{html as or,css as rn}from"./lit-all.min.js";var Aa=`
:root {
...
`;var za={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Y,Fe=class extends v{constructor(e){super(e);u(this,Y);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Aa}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return or` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){this.handleResize=()=>{l(this,Y)&&cancelAnimationFrame(l(this,Y)),m(this,Y,requestAnimationFrame(()=>{m(this,Y,null),this.postCardUpdateHook()}))},window.addEventListener("resize",this.handleResize),this.card.addEventListener(O,this.updatePriceQuantity)}disconnectedCallbackHook(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),l(this,Y)&&(cancelAnimationFrame(l(this,Y)),m(this,Y,null)),this.card.removeEventListener(O,this.updatePriceQuantity)}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),x.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayPerUnit&&(e.dataset.displayPerUnit="false"),e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),e.parentNode.insertBefore(r,e.nextSibling),await r.onceSettled()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}toggleAddon(e){let r=this.mainPrice,i=this.headingXSSlot;if(!r&&i){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(s=>s.remove()),e.checked){if(o){let s=z("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},o.innerHTML);this.card.appendChild(s)}}else{let s=z("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,i=this.card.planType;r&&(await r.onceSettled?.(),i=r.value?.[0]?.planType),i&&(e.planType=i)}};Y=new WeakMap,h(Fe,"variantStyle",rn`
    ...
    `);import{html as sr,css as an}from"./lit-all.min.js";var Ta=`
:root {
...
`;var La={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ie=class extends v{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Ta}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return sr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as nn,css as on}from"./lit-all.min.js";var Pa=`
...
`;var _a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},$e=class extends v{constructor(t){super(t)}getGlobalCSS(){return Pa}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return nn`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as cr,css as sn}from"./lit-all.min.js";var Ma=`
:root {
...
`;var Ra={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Be=class extends v{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Ma}renderLayout(){return cr`${this.cardImage}
            ...
            ${this.evergreen?cr`
                  ...
                  `:cr`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(Be,"variantStyle",sn`
    ...
    `);import{html as cn,css as ln}from"./lit-all.min.js";var Oa=`
:root {
...
`;var lr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},He=class extends v{getGlobalCSS(){return Oa}get aemFragmentMapping(){return lr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;if(!t)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(t.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",s)})}),x.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!At()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let t=this.getContainer();t&&t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t<=2||t===this.lastSyncedWidth||(this.lastSyncedWidth=t,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(At())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};e();let r=window.matchMedia(E);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(E).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||At())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return cn`
    ...
    `);import{html as Na,css as dn}from"./lit-all.min.js";var Da=`
:root {
...
`;var dr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},ht=class ht extends v{getGlobalCSS(){return Da}get aemFragmentMapping(){return dr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Na`
        ...
        `}async waitForTitleFont(){let t=this.card.querySelector(this.headingSelector);if(t&&document.fonts?.load){let e=window.getComputedStyle(t),r=`${e.fontWeight} ${e.fontSize} ${e.fontFamily}`;await document.fonts.load(r,t.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let t=ht.SYNCED_SECTIONS.map(s=>({name:s,getElement:c=>c.shadowRoot?.querySelector(`.${s}`)})),e=this.getContainer(),r=e?e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(r,s=>s.querySelectorAll(i).length)),o=Array.from({length:n},(s,c)=>({name:`description-row-${c}`,getElement:d=>d.querySelectorAll(i)[c]}));this.syncRowHeights([...t,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let t=this.getContainer();if(t){let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=49;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let e=this.card.querySelector(this.headingSelector),r=e?Math.round(e.getBoundingClientRect().height):0,i=`${Math.round(t)}:${r}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let t=this.card.querySelector(this.headingSelector);t&&this.sizeObserver.observe(t)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return Na`
            ...
            <slot></slot>
        `}};h(ht,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),h(ht,"variantStyle",dn`
    ...
    `);var pt=ht;import{html as hr,css as hn,nothing as pn}from"./lit-all.min.js";var Fa=`
...
`;var Ia={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},mn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],qe=class extends v{constructor(t){super(t)}getGlobalCSS(){return Fa}renderLayout(){return hr`
    ...
    `);import{css as gn,html as un}from"./lit-all.min.js";var $a=`
...
`;var Ba={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ue=class extends v{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return $a}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return un`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as fn,css as vn}from"./lit-all.min.js";var Ha=`
...
`;var pr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},bn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Ht,qa,Ge=class extends v{constructor(e){super(e);u(this,Ht);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ha}get aemFragmentMapping(){return pr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Ht,qa).call(this))}renderLayout(){return fn`
            <div class="card">
            ...
            <slot></slot>
        `}};Ht=new WeakSet,qa=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;bn.forEach(({key:r,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),r))},h(Ge,"variantStyle",vn`
    ...
    `);import{html as xn,css as yn}from"./lit-all.min.js";var Ua=`
...
`;var mr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},je=class extends v{getGlobalCSS(){return Ua}get aemFragmentMapping(){return mr}renderLayout(){return xn`
    ...
    `);var qt=new Map,Ga=new WeakMap,ja=new Map,S=(a,t,e=null,r=null,i)=>{qt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};S("catalog",Oe,ta,Oe.variantStyle);S("image",ue);S("inline-heading",Ot);S("mini-compare-chart",De,ca,De.variantStyle);S("mini-compare-chart-mweb",Ne,ha,Ne.variantStyle);S("plans",D,Ft,D.variantStyle,D.collectionOptions);S("plans-students",D,ga,D.variantStyle,D.collectionOptions);S("plans-education",D,ma,D.variantStyle,D.collectionOptions);S("plans-v2",oe,va,oe.variantStyle,oe.collectionOptions);S("bizpro",dt,ka,dt.variantStyle);S("product",Fe,za,Fe.variantStyle);S("segment",Ie,La,Ie.variantStyle);S("media",$e,_a,$e.variantStyle);S("headless",qe,Ia,qe.variantStyle);S("special-offers",Be,Ra,Be.variantStyle);S("simplified-pricing-express",He,lr,He.variantStyle);S("full-pricing-express",pt,dr,pt.variantStyle);S("mini",Ue,Ba,Ue.variantStyle);S("image",ue,aa,ue.variantStyle);S("compare-chart-column",Ge,pr,Ge.variantStyle);S("fries",je,mr,je.variantStyle);var wn=(a,t,e)=>{try{let r=ja.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ja.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},gr=a=>{let t=qt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=Ga.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?wn(a,r,i):{};return Ga.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Rt(a){return qt.get(a)?.fragmentMapping}function Va(a){return qt.get(a)?.collectionOptions}var Wa=document.createElement("style");Wa.innerHTML=`
:root {
...
`;document.head.appendChild(Wa);function Ut(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=ur(r)?r:a;n=o.get(s)}if(i&&n==null){let o=ur(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=kn(ur(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var En=a=>typeof a=="boolean",Gt=a=>typeof a=="function";var ur=a=>typeof a=="string";function Ka(a,t){if(En(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function kn(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var ce=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(Tt);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var ve={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ya=1e3;function Cn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Qa(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ve.serializableTypes.includes(e))return e}return a}function Sn(a,t){if(!ve.ignoredProperties.includes(a))return Qa(t)}var fr={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(Cn(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(Qa).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${ve.delimiter}page=${o}${s}`;c.length>Ya&&(c=`${c.slice(0,Ya)}<trunc>`),n+=c,i.length&&(n+=`${ve.delimiter}facts=`,n+=JSON.stringify(i,Sn)),window.lana?.log(n,ve)}};function Za(a){Object.assign(ve,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in ve&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Xa={LOCAL:"local",PROD:"prod",STAGE:"stage"},vr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},br=new Set,xr=new Set,Ja=new Map,ei={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},ti={filter:({level:a})=>a!==vr.DEBUG},An={filter:()=>!1};function zn(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Gt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Tn(a){[...xr].every(t=>t(a))&&br.forEach(t=>t(a))}function ri(a){let t=(Ja.get(a)??0)+1;Ja.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>ri(`${r.namespace}/${i}`),updateConfig:Za};return Object.values(vr).forEach(i=>{r[i]=(n,...o)=>Tn(zn(i,n,a,o,e))}),Object.seal(r)}function jt(...a){a.forEach(t=>{let{append:e,filter:r}=t;Gt(r)&&xr.add(r),Gt(e)&&br.add(e)})}function Ln(a={}){let{name:t}=a,e=Ka(Ut("commerce.debug",{search:!0,storage:!0}),t===Xa.LOCAL);return jt(e?ei:ti),t===Xa.PROD&&jt(fr),mt}function Pn(){br.clear(),xr.clear()}var mt={...ri(Qr),Level:vr,Plugins:{consoleAppender:ei,debugFilter:ti,quietFilter:An,lanaAppender:fr},init:Ln,reset:Pn,use:jt};var _n="mas-commerce-service",Ad=mt.module("utilities"),Mn={requestId:Tt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Vt=a=>window.setTimeout(a);function yr(){return document.getElementsByTagName(_n)?.[0]}function ai(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Mn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function ii(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw i}var ni="fragment",oi="author",si="preview",ci="loading",li="timeout",wr="aem-fragment",di="eager",hi="cache",Rn=[di,hi],Q,be,H,Er=class{constructor(){u(this,Q,new Map);u(this,be,new Map);u(this,H,new Map)}clear(){l(this,Q).clear(),l(this,be).clear(),l(this,H).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(l(this,Q).set(t.id,t),t.fields?.originalId&&l(this,Q).set(t.fields.originalId,t),l(this,H).has(t.id)){let[,r]=l(this,H).get(t.id);r()}if(l(this,H).has(t.fields?.originalId)){let[,r]=l(this,H).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return l(this,Q).has(t)}entries(){return l(this,Q).entries()}get(t){return l(this,Q).get(t)}getAsPromise(t){let[e]=l(this,H).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),l(this,H).set(t,[e,r]),e}getFetchInfo(t){let e=l(this,be).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},l(this,be).set(t,e)),e}remove(t){l(this,Q).delete(t),l(this,be).delete(t),l(this,H).delete(t)}};Q=new WeakMap,be=new WeakMap,H=new WeakMap;var le=new Er,Ve,I,te,F,N,L,gt,ut,q,ft,vt,We,U,pi,mi,kr,gi,Wt=class extends HTMLElement{constructor(){super(...arguments);u(this,U);h(this,"cache",le);u(this,Ve);u(this,I,null);u(this,te,null);u(this,F,null);u(this,N);u(this,L);u(this,gt,di);u(this,ut,5e3);u(this,q);u(this,ft,!1);u(this,vt,0);u(this,We)}static get observedAttributes(){return[ni,ci,li,oi,si]}attributeChangedCallback(e,r,i){e===ni&&(m(this,N,i),m(this,L,le.getFetchInfo(i))),e===ci&&Rn.includes(i)&&m(this,gt,i),e===li&&m(this,ut,parseInt(i,10)),e===oi&&m(this,ft,["","true"].includes(i)),e===si&&m(this,We,i)}connectedCallback(){if(!l(this,q)){if(l(this,F)??m(this,F,me(this)),m(this,We,l(this,F).settings?.preview),l(this,Ve)??m(this,Ve,l(this,F).log.module(`${wr}[${l(this,N)}]`)),!l(this,N)||l(this,N)==="#"){l(this,L)??m(this,L,le.getFetchInfo("missing-fragment-id")),y(this,U,kr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(l(this,L)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(l(this,q)&&!await Promise.race([l(this,q),Promise.resolve(!1)]))return;e&&le.remove(l(this,N)),l(this,gt)===hi&&await Promise.race([le.getAsPromise(l(this,N)),new Promise(s=>setTimeout(s,l(this,ut)))]);try{m(this,q,y(this,U,gi).call(this)),await l(this,q)}catch(s){return y(this,U,kr).call(this,s.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=l(this,I)||{};return o&&!Ut("mas.disableWcsCache")&&l(this,F).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Te,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...l(this,L)},bubbles:!0,composed:!0})),l(this,q)}get updateComplete(){return l(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return l(this,te)?l(this,te):(l(this,ft)?this.transformAuthorData():this.transformPublishData(),l(this,te))}get rawData(){return l(this,I)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:d={}}=l(this,I);m(this,te,e.reduce((p,{name:g,multiple:f,values:C})=>(p.fields[g]=f?C:C[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:s,dictionary:c,placeholders:d,variationId:n}))}transformPublishData(){if(!l(this,I))return;let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:d}=l(this,I);m(this,te,Object.entries(e).reduce((p,[g,f])=>(p.fields[g]=f?.mimeType?f.value:f??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:l(this,F).settings.locale,apiKey:l(this,F).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??l(this,F).settings.instant;return n&&(i.instant=n),await r(l(this,N),i)}};Ve=new WeakMap,I=new WeakMap,te=new WeakMap,F=new WeakMap,N=new WeakMap,L=new WeakMap,gt=new WeakMap,ut=new WeakMap,q=new WeakMap,ft=new WeakMap,vt=new WeakMap,We=new WeakMap,U=new WeakSet,pi=async function(e){Mr(this,vt)._++;let r=`${wr}:${l(this,N)}:${l(this,vt)}`,i=`${r}${Lt}`,n=`${r}${Pt}`;if(l(this,We)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new ce(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(l(this,L).stale=!1,l(this,L).url=e,o=await ii(e,{cache:"default",credentials:"omit"}),y(this,U,mi).call(this,o),l(this,L).status=o?.status,l(this,L).measure=Pe(performance.measure(n,i)),l(this,L).retryCount=o.retryCount,!o?.ok)throw new ce("Unexpected fragment response",{response:o,...l(this,F).duration});return await o.json()}catch(s){if(l(this,L).measure=Pe(performance.measure(n,i)),l(this,L).retryCount=s.retryCount,l(this,I))return l(this,L).stale=!0,l(this,Ve).error("Serving stale data",l(this,L)),l(this,I);let c=s.message??"unknown";throw new ce(`Failed to fetch fragment: ${c}`,{})}},mi=function(e){Object.assign(l(this,L),ai(e))},kr=function(e){m(this,q,null),l(this,L).message=e,this.classList.add("error");let r={...l(this,L),...l(this,F).duration};l(this,Ve).error(e,r),this.dispatchEvent(new CustomEvent(Le,{detail:r,bubbles:!0,composed:!0}))},gi=async function(){var c;this.classList.remove("error"),m(this,te,null);let e=le.get(l(this,N));if(e)return m(this,I,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=l(this,F).settings,s=`${r}/fragment?id=${l(this,N)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await y(this,U,pi).call(this,s),(c=e.fields).originalId??(c.originalId=l(this,N)),le.add(e),m(this,I,e),!0},h(Wt,"cache",le);customElements.define(wr,Wt);import{LitElement as On,html as Cr,css as Dn,nothing as Nn}from"./lit-all.min.js";import{unsafeHTML as Fn}from"./lit-all.min.js";var In=a=>a?a.startsWith("sp-icon-")?Cr`${Fn(`<${a} class="badge-icon"></${a}>`)}`:Cr`<img src="${a}" class="badge-icon" />`:Nn,Ke=class extends On{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Cr`<div class="badge">
            ${In(this.icon)}<slot>${this.text}</slot>
        </div>`}};h(Ke,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),h(Ke,"styles",Dn`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Ke);import{html as $n,css as Bn,LitElement as Hn}from"./lit-all.min.js";var bt=class extends Hn{constructor(){super()}render(){return $n`
            <slot name="icon"></slot>
    ...
    `),h(bt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",bt);import{html as Sr,css as qn,LitElement as Un,nothing as ui}from"./lit-all.min.js";var xt=class extends Un{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Sr`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?Sr`<slot name="content"></slot>`:ui}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Sr`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:ui}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(xt,"styles",qn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),h(xt,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",xt);var Gn={[ae]:Vr,[pe]:Wr,[ie]:Kr},jn={[ae]:Yr,[ie]:j},yt,Kt=class{constructor(t){u(this,yt);h(this,"changes",new Map);h(this,"connected",!1);h(this,"error");h(this,"log");h(this,"options");h(this,"promises",[]);h(this,"state",pe);h(this,"timer",null);h(this,"value");h(this,"version",0);h(this,"wrapperElement");this.wrapperElement=t,this.log=mt.module("mas-element")}update(){[ae,pe,ie].forEach(t=>{this.wrapperElement.classList.toggle(Gn[t],t===this.state)})}notify(){(this.state===ie||this.state===ae)&&(this.state===ie?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===ae&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof ce&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(jn[this.state],{bubbles:!0,composed:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){m(this,yt,yr()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return ie===r?Promise.resolve(this.wrapperElement):ae===r?Promise.reject(t):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=ie,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),Vt(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=ae,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...l(this,yt)?.duration}),Vt(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=pe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!yr()||this.timer)return;let{error:e,options:r,state:i,value:n,version:o}=this;this.state=pe,this.timer=Vt(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===pe&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,r)}})}};yt=new WeakMap;function Vn(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ye,xe=class xe extends HTMLAnchorElement{constructor(){super();h(this,"masElement",new Kt(this));u(this,ye);this.setAttribute("is",xe.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,i){this.masElement.attributeChangedCallback(e,r,i)}connectedCallback(){this.masElement.connectedCallback(),m(this,ye,me()),l(this,ye)&&(this.log=l(this,ye).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,ye,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=me();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:d}=r,p=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,g=this.getAttribute("data-promotion-code");g&&(p+=`&promotion_code=${encodeURIComponent(g)}`),this.href=`${Vn(d)}?${p}`,this.masElement.toggleResolved(i,o,r)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,r),!1}}static createFrom(e){let r=new xe;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?r.setAttribute("class",i.value.replace("upt-link","").trim()):r.setAttribute(i.name,i.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};ye=new WeakMap,h(xe,"is","upt-link"),h(xe,"tag","a"),h(xe,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var de=xe;window.customElements.get(de.is)||window.customElements.define(de.is,de,{extends:de.tag});var Wn="#000000",Ar="#F8D904",Kn="#EAEAEA",Yn="#31A547",Qn=/(accent|primary|secondary)(-(outline|link))?/,Zn="mas:product_code/",Xn="daa-ll",Yt="daa-lh",Jn=["XL","L","M","S"],zr="...",eo=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function $(a,t,e,r){let i=r[a];if(t[a]&&i){let n={slot:i?.slot,...i?.attributes},o=t[a];if(i.maxCount&&typeof o=="string"){let[c,d]=ko(o,i.maxCount,i.withSuffix);c!==o&&(n.title=d,o=c)}let s=z(i.tag,n,o);e.append(s)}}function to(a,t,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,s)=>({icon:o,alt:a.mnemonicAlt?.[s]??"",link:a.mnemonicLink?.[s]??""}));i?.forEach(({icon:o,alt:s,link:c})=>{if(c&&!/^https?:/.test(c))try{c=new URL(`https://${c}`).href.toString()}catch{c="#"}let d={slot:"icons",src:o,loading:t.loading,size:e?.size??"l"};s&&(d.alt=s),c&&(d.href=c);let p=z("merch-icon",d);t.append(p)});let n=t.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function ro(a,t,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let r=Ar,i=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,a.borderColor||(i=!0));let n=a.badgeBackgroundColor||r,o=a.borderColor||"";i&&(o=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${n}" border-color="${o}">${a.badge}</merch-badge>`}$("badge",a,t,e)}else a.badge?(t.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",a.badgeColor||Wn),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",a.badgeBackgroundColor||Ar),t.setAttribute("border-color",a.badgeBackgroundColor||Ar)):t.setAttribute("border-color",a.borderColor||Kn)}function ao(a,t,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||Yn;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${r}">${a.trialBadge}</merch-badge>`}$("trialBadge",a,t,e)}}function io(a,t,e){e?.includes(a.size)&&t.setAttribute("size",a.size)}function no(a,t){a.cardName&&t.setAttribute("name",a.cardName)}function oo(a,t,e){a.cardTitle&&(a.cardTitle=Ye(a.cardTitle)),$("cardTitle",a,t,{cardTitle:e})}function so(a,t,e){$("subtitle",a,t,e)}function co(a,t,e,r){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[a.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),t.setAttribute("background-color",a.backgroundColor)):r?.attribute&&a.backgroundColor&&(t.setAttribute(r.attribute,a.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function lo(a,t,e){let r=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")t.style.setProperty(i,"transparent");else if(a.borderColor&&r){let o=r?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),s=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){t.setAttribute("gradient-border","true");let c=a.borderColor;if(r?.specialValues){for(let[d,p]of Object.entries(r.specialValues))if(p===a.borderColor){c=d;break}}t.setAttribute("border-color",c),t.style.removeProperty(i)}else s?(t.setAttribute("border-color",a.borderColor),t.style.setProperty(i,`var(--${a.borderColor})`)):t.style.setProperty(i,`var(--${a.borderColor})`)}}var ho=new Set(["","default"]);function po(a,t,e){let r=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!r)return;let o=(t.querySelector('[slot="footer-rows"] merch-whats-included')??t.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),s=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",c=o||s;if(c==null||ho.has(String(c).trim().toLowerCase())){t.removeAttribute("whats-included-divider-color"),t.style.removeProperty(i);return}let d=String(c).trim();if(d.toLowerCase()==="transparent"){t.removeAttribute("whats-included-divider-color"),t.style.setProperty(i,"transparent");return}let g=r.specialValues?.[d]?.includes("gradient")||/-gradient/.test(d)||/^gradient-/.test(d),f=/^spectrum-.*-(plans|special-offers)$/.test(d);if(g){let C=d;if(r.specialValues){for(let[G,re]of Object.entries(r.specialValues))if(re===d){C=G;break}}t.setAttribute("whats-included-divider-color",C),t.style.removeProperty(i)}else f?(t.setAttribute("whats-included-divider-color",d),t.style.setProperty(i,`var(--${d})`)):(t.removeAttribute("whats-included-divider-color"),t.style.setProperty(i,`var(--${d})`))}function mo(a,t,e){if(a.backgroundImage){let r={loading:t.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?r.alt=a.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,a.backgroundImage);return}t.append(z(e.tag,{slot:e.slot},z("img",r)))}}function Ye(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(tr(),er)).catch(console.error),a}function go(a,t,e){a.prices&&(a.prices=Ye(a.prices)),$("prices",a,t,e)}function Tr(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap(Tr);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap(Tr);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function uo(a,t,e){let r=Tr(a.features).filter(n=>n.trim());if(!r.length)return;let i=z("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});r.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let s=o.body.querySelector("p[name]");if(s){i.append(s);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&t.append(i),vo(t,e)}function vi(a,t,e){let r=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=Qn.exec(i)?.[0]??"accent",o=n.includes("accent"),s=n.includes("primary"),c=n.includes("secondary"),d=n.includes("-outline"),p=n.includes("-link");a.classList.remove("accent","primary","secondary");let g;if(t.consonant)g=zo(a,o,r,p,s,c,e?.ctas?.size);else if(p)g=a;else{let f;o?f="accent":s?f="primary":c&&(f="secondary"),g=t.spectrum==="swc"?Ao(a,e,d,f,r):So(a,e,d,f,r)}return g}function fo(a,t){let{slot:e}=t?.description;bi(a,t,e)}function vo(a,t){let e=t?.features?.slot;e&&bi(a,t,e)}function bi(a,t,e){let r=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(i=>{let n=vi(i,a,t);i.replaceWith(n)})}function bo(a,t,e,r){a.description&&(a.description=Ye(a.description)),a.promoText&&(a.promoText=Ye(a.promoText)),a.shortDescription&&(a.shortDescription=Ye(a.shortDescription)),$("promoText",a,t,e),$("description",a,t,e),$("shortDescription",a,t,e),a.shortDescription&&(t.setAttribute("action-menu","true"),a.actionMenuLabel||t.setAttribute("action-menu-label","More options")),fo(t,e),$("callout",a,t,e),xo(a,t,e,r),$("whatsIncluded",a,t,e)}function xo(a,t,e,r={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=r.quantitySelect),$("quantitySelect",a,t,e))}function yo(a,t,e,r={}){if(!e.addon)return;let n=(a.addon??r.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o=z("merch-addon",{slot:"addon"},n);[...o.querySelectorAll(w)].forEach(s=>{let c=s.parentElement;c?.nodeName==="P"&&c.setAttribute("data-plan-type","")}),t.append(o)}function wo(a,t,e){a.addonConfirmation&&$("addonConfirmation",a,t,e)}function Eo(a,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function ko(a,t,e=!0){try{let r=typeof a!="string"?"":a,i=fi(r);if(i.length<=t)return[r,i];let n=0,o=!1,s=e?t-zr.length<1?1:t-zr.length:t,c=[];for(let g of r){if(n++,g==="<")if(o=!0,r[n]==="/")c.pop();else{let f="";for(let C of r.substring(n)){if(C===" "||C===">")break;f+=C}c.push(f)}if(g==="/"&&r[n]===">"&&c.pop(),g===">"){o=!1;continue}if(!o&&(s--,s===0))break}let d=r.substring(0,n).trim();if(c.length>0){c[0]==="p"&&c.shift();for(let g of c.reverse())d+=`</${g}>`}return[`${d}${e?zr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=fi(i);return[i,n]}}function fi(a){if(!a)return"";let t="",e=!1;for(let r of a){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function Co(a,t){t.querySelectorAll("a.upt-link").forEach(r=>{let i=de.createFrom(r);r.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function So(a,t,e,r,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of a.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",s=`spectrum-Button--${r}`,c=Jn.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",d=["spectrum-Button",s,c];return e&&d.push("spectrum-Button--outline"),n.classList.add(...d),n}function Ao(a,t,e,r,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let s=z("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return s.source=n,(i?n.onceSettled():Promise.resolve(n)).then(c=>{s.setAttribute("data-navigation-url",c.href)}),s.addEventListener("click",c=>{c.defaultPrevented||n.click()}),s}function zo(a,t,e,r,i,n,o){let s=a;if(e)try{let c=customElements.get("checkout-link");c&&(s=c.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return r||(s.classList.add("button","con-button"),o&&o!=="m"&&s.classList.add(`button-${o}`),t&&s.classList.add("blue"),i&&s.classList.add("primary"),n&&s.classList.add("secondary")),s}function To(a,t,e,r,i){if(a.ctas){a.ctas=Ye(a.ctas);let{slot:n}=e.ctas,o=z("div",{slot:n},a.ctas),s=[...o.querySelectorAll("a")],c=i?.hideTrialCTAs?s.filter(p=>!eo.has(p.dataset.analyticsId)):s,d=(c.length>0?c:s).map(p=>vi(p,t,e));o.textContent="",o.append(...d),t.append(o),i?.hideTrialCTAs&&c.length>0&&d.forEach(p=>{let g=p.source??p;g.onceSettled&&(p.hidden=!0,g.onceSettled().then(()=>{g.value?.[0]?.offerType==="TRIAL"&&d.some(C=>C!==p&&!C.hidden)?p.remove():p.hidden=!1}).catch(()=>{p.hidden=!1}))})}}function Lo(a,t){let{tags:e}=a,r=e?.find(n=>typeof n=="string"&&n.startsWith(Zn))?.split("/").pop();if(!r)return;t.setAttribute(Yt,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(Xn,`${n.dataset.analyticsId}-${o+1}`)})}function Po(a,t,e){let r={},i=[...a.classList].filter(n=>n!==t);for(let n of a.attributes)n.name!=="class"&&(r[n.name]=n.value);i.length&&(r.class=i.join(" ")),e==="secondary"&&(r.variant="secondary"),a.replaceWith(z("sp-link",r,a.innerHTML))}function _o(a){if(a.consonant)return;let{spectrum:t}=a;t!=="css"&&t!=="swc"||[["primary-link","primary"],["secondary-link","secondary"]].forEach(([e,r])=>{a.querySelectorAll(`a.${e}`).forEach(i=>{t==="swc"?Po(i,e,r):(i.classList.remove(e),i.classList.add("spectrum-Link",`spectrum-Link--${r}`))})})}function Mo(a){a.querySelectorAll("[slot]").forEach(r=>{r.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",Yt].forEach(r=>a.removeAttribute(r));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function xi(a,t){if(!a){let c=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${c}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${c}).`)}if(!a.fields){let c=a.id||"unknown",d=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${c}' (merchCard id: ${d}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${c}' (merchCard id: ${d}) is missing 'fields'.`)}let{id:e,fields:r,settings:i={},priceLiterals:n}=a,{variant:o}=r;if(!o)throw new Error(`hydrate: no template found in payload ${e}`);Mo(t),t.compatVersion=r.compatVersion,t.contextPromotionCode=r.promoCode,t.settings=i,n&&(t.priceLiterals=n),t.id??(t.id=a.id),a.variationId&&t.setAttribute("variation-id",a.variationId??""),t.variant=o,await t.updateComplete;let{aemFragmentMapping:s}=t.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&t.setAttribute("consonant",!0),to(r,t,s.mnemonics),ao(r,t,s),io(r,t,s.size),no(r,t),oo(r,t,s.title),ro(r,t,s),so(r,t,s),go(r,t,s),mo(r,t,s.backgroundImage),co(r,t,s.allowedColors,s.backgroundColor),lo(r,t,s),bo(r,t,s,i),uo(r,t,s),po(r,t,s),yo(r,t,s,i),wo(r,t,s),Eo(r,t,s,i);try{Co(r,t)}catch{}To(r,t,s,o,i),Lo(r,t),_o(t)}var Zt="merch-card",yi="merch-card:",Ci=["full-pricing-express","simplified-pricing-express"],Si=["segment","product"];function wi(a,t){let e=a.closest(Zt);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),Jr(a)&&(t.displayPerUnit=!1,t.displayTax=!1),!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.contextPromotionCode),e.aemFragment&&(t[Zr]=!0),e.variantLayout?.priceOptionsProvider?.(a,t),a.dataset.template===M&&(t.displayDot??(t.displayDot=e.variantLayout?.legalDisplayDot??!0))}function Ei(a,t){let e=a.closest(Zt);if(!e)return t;!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.contextPromotionCode)}function Oo(a){a.providers.has(wi)||a.providers.price(wi),a.providers.has(Ei)||a.providers.checkout(Ei)}var wt=new IntersectionObserver(a=>{a.forEach(t=>{let e=t.target;if(Ci.includes(e.variant)){if(e.clientHeight===0)return;wt.unobserve(e),e.requestUpdate();return}if(Si.includes(e.variant)){if(t.boundingClientRect.width===0)return;if(e.variant==="product"&&e.querySelector('merch-icon[slot="icons"]')){wt.unobserve(e);return}let r=e.getBoundingClientRect().width,n=e.querySelector('[slot="badge"]')?.getBoundingClientRect().width||0;if(r===0||n===0){wt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(r-n-16)}px`),wt.unobserve(e)}})}),Do=0,Qe,Ze,Xe,Z,Ee,B,ke,A,we,Et,Lr,Qt,he=class extends Ro{constructor(){super();u(this,A);h(this,"contextPromotionCode");u(this,Qe);u(this,Ze);u(this,Xe);u(this,Z);u(this,Ee);u(this,B);u(this,ke,new Promise(e=>{m(this,B,e)}));h(this,"compatVersion");h(this,"customerSegment");h(this,"marketSegment");h(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=gr(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=gr(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){y(this,A,we).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(w)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(X)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(X)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(X)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let i of r){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==o);e.checked&&s.push(o),i.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let i=n=>{let{offerType:o,planType:s}=n.value?.[0]??{};if(!o||!s)return;let c=e.getOsi(s,o),d=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==c);e.checked&&d.push(c),n.dataset.wcsOsi=d.join(",")};r.forEach(i)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let i of r)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(i=>{if(e){r[i].order=Math.min(r[i].order||2,2);return}let n=r[i].order;n===1||isNaN(n)||(r[i].order=Number(n)+1)}),this.filters=r}showInfoTooltip(e,r){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(r)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(r=>this.iconButton.addEventListener(r,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(r=>this.iconButton.addEventListener(r,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",r=>{r.key==="Escape"&&this.iconButton.classList.remove(e)}))}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),l(this,Ze)||m(this,Ze,Do++),this.aemFragment||((r=l(this,B))==null||r.call(this),m(this,B,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??l(this,Ze);m(this,Ee,`${yi}${e}${Lt}`),m(this,Qe,`${yi}${e}${Pt}`),performance.mark(l(this,Ee)),m(this,Z,me()),Oo(l(this,Z)),m(this,Xe,l(this,Z).Log.module(Zt)),this.addEventListener(O,this.handleQuantitySelection),this.addEventListener(rr,this.handleAddonAndQuantityUpdate),this.addEventListener(qr,this.handleMerchOfferSelectReady),this.addEventListener(Le,this.handleAemFragmentEvents),this.addEventListener(Te,this.handleAemFragmentEvents),this.addEventListener(zt,this.handleInfoIconEvents),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(O,this.handleQuantitySelection),this.removeEventListener(Le,this.handleAemFragmentEvents),this.removeEventListener(Te,this.handleAemFragmentEvents),this.removeEventListener(zt,this.handleInfoIconEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(rr,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===Le&&y(this,A,we).call(this,"AEM fragment cannot be loaded"),e.type===Te&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{l(this,B)||m(this,ke,new Promise(n=>{m(this,B,n)})),await xi(i,this)}catch(n){y(this,A,we).call(this,`hydration has failed: ${n.message}`)}finally{(r=l(this,B))==null||r.call(this),m(this,B,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;l(this,ke)&&(await l(this,ke),(Ci.includes(this.variant)||Si.includes(this.variant))&&wt.observe(this),m(this,ke,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(c=>setTimeout(()=>c("timeout"),Ae));if(this.aemFragment){let c=await Promise.race([this.aemFragment.updateComplete,e]);if(c===!1||c==="timeout"){let d=c==="timeout"?`AEM fragment was not resolved within ${Ae} timeout`:"AEM fragment cannot be loaded";y(this,A,we).call(this,d,{},!1);return}}let r=[...this.querySelectorAll(Hr)],i=Promise.all(r.map(c=>{let d=c.onceSettled?.();return d?d.catch(()=>c):Promise.resolve(c)})).then(c=>{let d=c.filter(p=>p.isConnected);return d.length===0||d.every(p=>p.classList.contains("placeholder-resolved"))}),n=await Promise.race([i,e]);if(!this.isConnected)return;let o=r.filter(c=>c.isConnected);if(o.length===0||o.every(c=>c.classList.contains("placeholder-resolved"))){this.measure=performance.measure(l(this,Qe),l(this,Ee));let c={...this.aemFragment?.fetchInfo,...l(this,Z).duration,measure:Pe(this.measure)};return this.dispatchEvent(new CustomEvent(zt,{bubbles:!0,composed:!0,detail:c})),this}else{this.measure=performance.measure(l(this,Qe),l(this,Ee));let c={measure:Pe(this.measure),...l(this,Z).duration};if(n==="timeout")y(this,A,we).call(this,`Contains offers that were not resolved within ${Ae} timeout`,c);else{let d=o.some(p=>p.matches(X)&&p.classList.contains("placeholder-failed"));y(this,A,we).call(this,d?"CTA has an invalid offer":"Contains unresolved offers",c)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(X)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let s=new URL(n.getAttribute("href")).searchParams.get("pa"),c=r.find(p=>p.productArrangementCode===s)?.quantity,d=!!r.find(p=>p.productArrangementCode!==s);if(c&&this.quantitySelect?.dispatchEvent(new CustomEvent(Gr,{detail:{quantity:c},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==d){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:d}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(w))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${w}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return l(this,A,Et)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${w}[data-promotion-code],${X}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return this.contextPromotionCode;let r=[...new Set(e)];return r.length>1&&l(this,Xe)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${w}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(l(this,A,Lr)??l(this,A,Et))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return l(this,A,Et)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return l(this,A,Lr)?.querySelector(e)?.textContent?.trim()??l(this,A,Et)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return y(this,A,Qt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${X}, a`);return Array.from(e??[])}get primaryCta(){return y(this,A,Qt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return y(this,A,Qt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Qe=new WeakMap,Ze=new WeakMap,Xe=new WeakMap,Z=new WeakMap,Ee=new WeakMap,B=new WeakMap,ke=new WeakMap,A=new WeakSet,we=function(e,r={},i=!0){var c;if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let s={...this.aemFragment.fetchInfo,...l(this,Z).duration,...r,message:e};l(this,Xe).error(`merch-card${o}: ${e}`,s),this.failed=!0,(c=l(this,B))==null||c.call(this),m(this,B,void 0),l(this,Z).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(jr,{bubbles:!0,composed:!0,detail:s}))},Et=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${w}[data-template="price"] > span`)},Lr=function(){return this.querySelector(`${w}[data-template="legal"]`)},Qt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},h(he,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,i,n]=e.split(",");return{PUF:r,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[i,n,o]=r.split(":"),s=Number(n);return[i,{order:isNaN(s)?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:i,size:n}])=>[r,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Yt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),h(he,"styles",[Fr,...Ir()]),h(he,"registerVariant",S),h(he,"getCollectionOptions",Va),h(he,"getFragmentMapping",Rt);customElements.define(Zt,he);export{he as MerchCard};

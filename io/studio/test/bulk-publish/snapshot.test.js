...
describe('bulk-publish/snapshot.js', () => {
    ...
    describe('createSnapshot()', () => {
        it('returns { entries, expandedPaths } with fragmentId, versionId, wasPublished, createdAt', async () => {
        ...
        it('throws when a required fragment is not found at path (items empty)', async () => {
            fetchOdinStub.callsFake((endpoint, uri) => {
                if (uri.includes('/adobe/sites/cf/fragments?path=')) {
        ...
        it('throws when createVersion returns no versionId for a required fragment (empty Location header)', async () => {
            fetchOdinStub.callsFake((endpoint, uri) => {
                if (uri.includes('/adobe/sites/cf/fragments?path=')) {
        ...
        it('throws when any required path in the batch is missing', async () => {
            fetchOdinStub.callsFake((endpoint, uri) => {
                if (uri.includes('/adobe/sites/cf/fragments?path=')) {

var Ur=Object.defineProperty;var jr=a=>{throw TypeError(a)};var Ui=(a,t,e)=>t in a?Ur(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var ji=(a,t)=>()=>(a&&(t=a(a=0)),t);var Gi=(a,t)=>{for(var e in t)Ur(a,e,{get:t[e],enumerable:!0})};var p=(a,t,e)=>Ui(a,typeof t!="symbol"?t+"":t,e),lr=(a,t,e)=>t.has(a)||jr("Cannot "+e);var s=(a,t,e)=>(lr(a,t,"read from private field"),e?e.call(a):t.get(a)),u=(a,t,e)=>t.has(a)?jr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),g=(a,t,e,r)=>(lr(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),y=(a,t,e)=>(lr(a,t,"access private method"),e);var Gr=(a,t,e,r)=>({set _(i){g(a,t,i,e)},get _(){return s(a,t,r)}});var dr={};Gi(dr,{default:()=>at});import{LitElement as Vi,html as Le,css as Wi,nothing as Ki}from"./lit-all.min.js";import{unsafeHTML as Xr}from"./lit-all.min.js";import{ifDefined as Yi}from"./lit-all.min.js";function Qi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var D,at,hr=ji(()=>{D=class D extends Vi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();D.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,h=l?l.offsetHeight:c,f=this.effectivePlacement;f==="top"&&e.top-h-n<0?f="bottom":f==="bottom"&&e.bottom+h+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>r&&(f="left");let k=e.left+e.width/2,q=e.top+e.height/2,O=6,ue=(Hi,Bi,qi)=>Math.max(Hi,Math.min(Bi,qi)),_t,Mt,sr;f==="top"||f==="bottom"?(_t=f==="top"?e.top-h-n:e.bottom+n,Mt=ue(0,r-d,k-d/2),sr=ue(O,d-O*2,k-Mt-O)):(Mt=f==="left"?e.left-d-n:e.right+n,_t=ue(0,i-h,q-h/2),sr=ue(O,h-O*2,q-_t-O)),this._tooltipTop=_t,this._tooltipLeft=Mt,this._arrowOffset=sr,this._computedPlacement=f}showTooltip(){D.activeTooltip&&D.activeTooltip!==this&&(D.activeTooltip.closeOverlay(),D.activeTooltip.tooltipVisible=!1,D.activeTooltip.requestUpdate()),D.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){D.activeTooltip===this&&(D.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Le`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:Le`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return Le`<span class="icon-only">${this.renderIcon()}</span>`;if(Qi())return Le`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let i=t.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:m=>{this.lastPointerType=m.pointerType},pointerenter:m=>m.pointerType!=="touch"&&this.showTooltip(),pointerleave:m=>m.pointerType!=="touch"&&this.hideTooltip(),click:m=>{this.lastPointerType==="touch"&&this.handleTap(m),this.lastPointerType=null}},c=this._computedPlacement,l=c==="top"||c==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,h=l?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return Le`
            <span
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${Yi(d)}>
                    ${Xr(t)}
        ...
        `}};p(D,"activeTooltip",null),p(D,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"},mnemonicText:{type:String,attribute:"mnemonic-text"},mnemonicPlacement:{type:String,attribute:"mnemonic-placement"},alt:{type:String},smartPlacement:{type:Boolean,attribute:"smart-placement"},tooltipVisible:{type:Boolean,state:!0},_tooltipTop:{type:Number,state:!0},_tooltipLeft:{type:Number,state:!0},_arrowOffset:{type:Number,state:!0},_computedPlacement:{type:String,state:!0}}),p(D,"styles",Wi`
        :host {
            display: contents;
            overflow: visible;
        }
    ...
    `);at=D;customElements.define("mas-mnemonic",at)});import{LitElement as Wo}from"./lit-all.min.js";import{css as Yr,unsafeCSS as Kr}from"./lit-all.min.js";var C="(max-width: 767px)",z="(max-width: 1199px)",w="(min-width: 768px)",v="(min-width: 1200px)",_="(min-width: 1600px)",Vr="(min-width: 1280px)",Wr={matchMobile:window.matchMedia(C),matchDesktop:window.matchMedia(`${v} and (not ${_})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(_),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Wr;function Rt(){return Wr.isDesktop}var Qr=Yr`
    :host {
...
`,Zr=()=>[Yr`
            ...
            /* Laptop */
            @media screen and ${Kr(v)} {
                :host([size='wide']) {
                    grid-column: span 2;
                }
            }
        `];import{LitElement as Zi,html as Jr,css as Xi}from"./lit-all.min.js";function Ji(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Pe=class extends Zi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Ji())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>hr())}e.remove()})}render(){let{href:t}=this;return t?Jr`<a href="${t}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};p(Pe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),p(Pe,"styles",Xi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Pe);var sc=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),lc=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var _e=2e4;var E='span[is="inline-price"][data-wcs-osi]',re='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var en='a[is="upt-link"]',ea=`${E},${re},${en}`;var ta="merch-offer-select:ready",ra="merch-card:action-menu-toggle";var M="merch-quantity-selector:change",it="merch-card-quantity:change",pr="merch-modal:addon-and-quantity-update";var Me="merch-card-collection:literals-changed";var Re="aem:load",Oe="aem:error",fe="mas:ready",aa="mas:error";var ia="placeholder-failed",na="placeholder-pending",oa="placeholder-resolved";var ca="mas:failed",U="mas:resolved",sa="mas/commerce";var ce="failed",be="pending",se="resolved";var Ot="X-Request-Id",dc=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var hc=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Dt=":start",Nt=":duration";var R="legal",la="mas-ff-defaults";var tn="mas-commerce-service";function da(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function P(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function De(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function mr(){return window.matchMedia("(max-width: 1024px)").matches}function ve(){return document.getElementsByTagName(tn)?.[0]}function nt(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}function ha(a){let t=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&t?.isInlinePrice&&t?.dataset?.template==="price"}var ot,xe,ct,st,Ne,It=class extends HTMLElement{constructor(){super();u(this,ot,"");u(this,xe);u(this,ct,[]);u(this,st,[]);u(this,Ne);g(this,Ne,da(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,xe)?this.parentElement.style.borderRadius=s(this,xe):s(this,xe)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,ct).map((r,i)=>{let n=s(this,st)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,ot)}, ${e})`}connectedCallback(){s(this,Ne).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&g(this,xe,i?.trim()),e==="colors"&&i?g(this,ct,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?g(this,st,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&g(this,ot,i?.trim()??""),s(this,Ne).call(this)}};ot=new WeakMap,xe=new WeakMap,ct=new WeakMap,st=new WeakMap,Ne=new WeakMap;customElements.define("merch-gradient",It);import{LitElement as rn,html as an,css as nn}from"./lit-all.min.js";var Ie=class extends rn{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${E}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(U,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(U,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return an` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};p(Ie,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0},background:{type:String,attribute:"background"}}),p(Ie,"styles",nn`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",Ie);import{html as $t,nothing as on}from"./lit-all.min.js";var $e,lt=class lt{constructor(t){p(this,"card");u(this,$e);this.card=t,this.insertVariantStyle()}getContainer(){return g(this,$e,s(this,$e)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,$e)}insertVariantStyle(){let t=this.constructor.name;if(lt.styleMap[t])return;lt.styleMap[t]=!0;let e=this.getGlobalCSS(),r=document.head.querySelector(`style[data-mas-variant-style="${t}"]`);if(r&&r.textContent===e)return;let i=document.createElement("style");i.setAttribute("data-mas-variant-style",t),i.innerHTML=e,document.head.appendChild(i)}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let r=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${r}"]`)).filter(l=>l.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:l}of t){let d=`--consonant-merch-card-${r}-${l}-height`;e.style.getPropertyValue(d)&&e.style.removeProperty(d)}let n=new Map;for(let l of i){let d=l.getBoundingClientRect();if(d.width<=2)continue;let h=Math.round(d.top),m=n.get(h);m||(m=[],n.set(h,m)),m.push(l)}let o=new Map;for(let l of n.values())for(let d of l){let h={};for(let{name:m}of t){let f=`--consonant-merch-card-${r}-${m}-height`;h[m]=d.style.getPropertyValue(f),d.style.removeProperty(f)}o.set(d,h)}let c=new Map;for(let l of n.values())for(let d of l){let h={};for(let{name:m,getElement:f}of t){let k=f(d);k&&(h[m]=Math.max(0,parseInt(window.getComputedStyle(k).height)||0))}c.set(d,h)}for(let l of n.values())for(let{name:d}of t){let h=`--consonant-merch-card-${r}-${d}-height`,m=0;for(let f of l){let k=c.get(f)[d]??0;k>m&&(m=k)}l.forEach(f=>{m>0?f.style.setProperty(h,`${m}px`):o.get(f)[d]&&f.style.setProperty(h,o.get(f)[d])})}}get legalDisplayDot(){return!0}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),$t`
            <div
                id="badge"
        ...
        `}get cardImage(){return $t` <div class="image">
            ...
            ${this.badge}
              ...
              >`:on}get secureLabelFooter(){return $t`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let t=Promise.allSettled(this.card.prices.map(i=>i.onceSettled?.()||Promise.resolve())),e,r=new Promise(i=>{e=setTimeout(i,_e)});await Promise.race([t,r]),clearTimeout(e)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Ft(this.card.variant)}};$e=new WeakMap,p(lt,"styleMap",{});var b=lt;import{html as gr,css as cn}from"./lit-all.min.js";var pa=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return pa}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};p(Fe,"variantStyle",cn`
    ...
    `);import{html as dt,css as sn}from"./lit-all.min.js";var ga=`
:root {
...
`;var ua={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},ye=class extends b{constructor(t){super(t)}getGlobalCSS(){return ga}renderLayout(){return dt`<div class="image">
    ...
    `);import{html as ba}from"./lit-all.min.js";var fa=`
:root {
...
`;var Ht=class extends b{constructor(t){super(t)}getGlobalCSS(){return fa}renderLayout(){return ba` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":ba`<hr />`} ${this.secureLabelFooter}`}};import{html as le,css as ln,unsafeCSS as xa}from"./lit-all.min.js";var va=`
  :root {
...
`;var dn=32,ur=new WeakSet;function ya(a){!a||ur.has(a)||(ur.add(a),requestAnimationFrame(()=>{ur.delete(a),a.querySelector('merch-card[variant="mini-compare-chart"]')?.variantLayout?.syncHeights?.()}))}var wa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Bt=class Bt extends b{constructor(e){super(e);p(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);p(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?le`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`:le` <div class="top-section${this.badge?" badge":""}">
                ...
                <slot name="addon"></slot>
                ${this.getMiniCompareFooter()}
                <slot name="footer-rows"><slot name="body-s"></slot></slot>`}syncHeights(){let e=this.getContainer();if(!e)return;let r=[...e.querySelectorAll('merch-card[variant="mini-compare-chart"]')].map(n=>n.variantLayout).filter(n=>n instanceof Bt);if(!r.length)return;let i=r.map(n=>n.measureMinHeights());for(let n of i)for(let[o,c]of n){let l=parseFloat(e.style.getPropertyValue(o))||0;c>l&&e.style.setProperty(o,`${c}px`)}}async postCardUpdateHook(){await super.postCardUpdateHook(),this.isNewVariant&&(this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),this.adjustCallout()),await this.adjustAddon(),this.isNewVariant&&this.removeEmptyRows(),x.isMobile?this.isNewVariant||this.removeEmptyRows():(this.padFooterRows(),ya(this.getContainer()))}};p(Bt,"variantStyle",ln`
    ...
    `);var ht=Bt;import{html as qt,css as hn,unsafeCSS as fr,nothing as pn}from"./lit-all.min.js";var Ea=`
  :root {
...
`;var mn=32,ka={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Z,He=class extends b{constructor(e){super(e);u(this,Z);p(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);p(this,"getMiniCompareFooter",()=>qt` <footer>
        ...
        </footer>`);p(this,"getMiniCompareFooterRows",()=>qt` <div class="footer-rows-container">
            <slot name="body-xs"></slot>
            <slot name="footer-rows"></slot>
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(M,this.updatePriceQuantity)}disconnectedCallbackHook(){this.card.removeEventListener(M,this.updatePriceQuantity),this._syncObserver?.disconnect(),this._syncObserver=null,s(this,Z)?.disconnect(),g(this,Z,null)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,Z)||(g(this,Z,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,Z)?.disconnect(),g(this,Z,null),this.syncHeights())})),s(this,Z).observe(this.card));return}let e=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)}))),this.adjustMiniCompareFooterRows()}priceOptionsProvider(e,r){if(e.dataset.template===R){r.displayPlanType=this.card?.settings?.displayPlanType??!1;return}(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1)}getGlobalCSS(){return Ea}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2){this._syncObserver||(this._syncObserver=new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(this._syncObserver?.disconnect(),this._syncObserver=null,this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}),this._syncObserver.observe(this.card));return}["heading-xs","subtitle","heading-m-price","price-wrapping","promo-text","body-m","body-xs","footer-rows"].forEach(r=>{let n=this.card.querySelector(`[slot="${r}"]`)??this.card.shadowRoot.querySelector(`slot[name="${r}"]`);this.updateCardElementMinHeight(n,r)}),[['slot[name="promo-text"]',"promo-text"],["footer","footer"]].forEach(([r,i])=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(r),i)})}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,i)=>{let n=Math.max(mn,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let i=r.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&r.remove()})}setupToggle(){if(this.toggleSetupDone)return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("p"),i=e.querySelector("ul");if(!r||!i||e.querySelector(".footer-rows-title"))return;this.toggleSetupDone=!0;let n=r.textContent.trim(),o=this.card.querySelector("h3")?.id,c=o?`${o}-list`:`mweb-list-${Date.now()}`;i.setAttribute("id",c),i.classList.add("checkmark-copy-container");let l=P("h4",{class:"footer-rows-title"},n);if(x.isMobile){let d=P("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":c});l.appendChild(d),l.addEventListener("click",()=>{let h=i.classList.toggle("open");d.classList.toggle("expanded",h),d.setAttribute("aria-expanded",String(h))})}else i.classList.add("open");r.replaceWith(l)}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${E}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayPerUnit&&(e.dataset.displayPerUnit="false"),e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),e.parentNode.insertBefore(r,e.nextSibling),await r.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?pn:qt`<slot name="icons"></slot>`}renderLayout(){return qt`
            ${this.badge}
            <div class="body">
                <div class="body-main">
                    ${this.icons}
        ...
        `}async postCardUpdateHook(){if(this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),x.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches){let e=this.card.parentElement,r=Array.from(e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`));await Promise.all(r.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),this.card===e.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}}};Z=new WeakMap,p(He,"variantStyle",hn`
    ...
    `);import{html as pt,css as gn,nothing as Ut}from"./lit-all.min.js";var Ca=`
:root {
...
`;var Wt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Aa={...function(){let{whatsIncluded:a,size:t,...e}=Wt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},za={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=Wt;return i}()},jt=new Set,Gt=!1;function Vt(a){let t=a.target.closest?.('[slot="callout-content"] .icon-button');for(let e of jt)e===t?a.type==="touchstart"?e.classList.toggle("hide-tooltip"):e.classList.remove("hide-tooltip"):e.classList.add("hide-tooltip")}function un(a){jt.add(a),!Gt&&(document.addEventListener("touchstart",Vt,{passive:!0}),document.addEventListener("mouseover",Vt,{passive:!0}),Gt=!0)}function Sa(a){!a||!jt.delete(a)||jt.size||!Gt||(document.removeEventListener("touchstart",Vt),document.removeEventListener("mouseover",Vt),Gt=!1)}var X,J,N=class extends b{constructor(e){super(e);u(this,X);u(this,J);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===R&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Ca}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),h=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(c)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&l){if(d)l.remove();else{let m=h.querySelector(`[data-placeholder-for="${e}"]`);m?m.replaceWith(l):h.appendChild(l)}return}if(i&&d){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",e),m.classList.add("slot-placeholder"),!l){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){if(this.calloutIcon?.isConnected)return;let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&(!e.title&&!(e.dataset.tooltip&&e.classList.contains("hide-tooltip"))||(e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title")),e.classList.add("hide-tooltip"),Sa(this.calloutIcon),un(e),this.calloutIcon=e))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,X)||(g(this,X,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,X)?.disconnect(),g(this,X,null),this.syncHeights())})),s(this,X).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let d=0,h=this.card.querySelector('[slot="heading-s"]');h&&(d+=nt(h));let m=this.card.querySelector('[slot="subtitle"]');m&&(d+=nt(m));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+nt(f));for(let q of r.childNodes){if(q.classList.contains("spacer"))break;d+=nt(q)}let k=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(k)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(e){(!e||e.has("variant")||e.has("size"))&&this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement?.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${E}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?pt`<div class="divider"></div>`:Ut}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${E}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){if(this.addonAdjusted)return;await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled?.();let i=r.value?.[0]?.planType;i&&(e.planType=i,this.addonAdjusted=!0)}get stockCheckbox(){return this.card.checkboxLabel?pt`<label id="stock-checkbox">
                <input type="checkbox" @change=${this.card.toggleStockOffer}></input>
                <span></span>
                ${this.card.checkboxLabel}
            </label>`:Ut}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Ut:pt`<slot name="icons"></slot>`}resizeHandler(){s(this,J)&&cancelAnimationFrame(s(this,J)),g(this,J,requestAnimationFrame(()=>{g(this,J,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))}connectedCallbackHook(){x.matchMobile.addEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.addEventListener("change",this.adaptForMedia)}disconnectedCallbackHook(){x.matchMobile.removeEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.removeEventListener("change",this.adaptForMedia),Sa(this.calloutIcon),this.calloutIcon=null,s(this,X)?.disconnect(),g(this,X,null),s(this,J)&&(cancelAnimationFrame(s(this,J)),g(this,J,null))}renderLayout(){return pt` ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="heading-xs"></slot>
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};X=new WeakMap,J=new WeakMap,p(N,"variantStyle",gn`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),p(N,"collectionOptions",{customHeaderArea:e=>e.sidenav?pt`<slot name="resultsText"></slot>`:Ut,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let r=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let c=o.getAttribute("size"),l=c==="wide"?2:c==="super-wide"?3:1;l===2&&n%3===2&&(o.setAttribute("data-size",c),o.removeAttribute("size"),l=1),n+=l}};x.matchDesktop.addEventListener("change",r),e.addEventListener(Me,r),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",r),e.removeEventListener(Me,r)})}});import{html as ae,css as fn,unsafeCSS as La,nothing as Kt}from"./lit-all.min.js";var Ta=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?ae`
        ...
        `:ae`
            ...
            `:Kt}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?ae`<slot name="icons"></slot>`:Kt}get secureLabelFooter(){return ae`<footer>
            ...
            <slot></slot>`}};p(de,"variantStyle",fn`
...
`;var[Is,$s,Ma,Ra,Oa,Da]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Na={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ie,we,bt,T,Ia,gt,$a,ut,br,Yt,Qt=class Qt extends b{constructor(e){super(e);u(this,T);p(this,"expanded",!1);p(this,"licenseOpen",!1);p(this,"licenseQty",null);p(this,"licenseHighlightedIndex",0);u(this,ie,null);u(this,we,null);p(this,"lastSyncKey",null);u(this,bt,({detail:e})=>{let r=e?.quantity==null?null:String(e.quantity);r==null||r===this.licenseQty||this.licenseOptions?.includes(r)&&(this.licenseQty=r,this.card.requestUpdate())});p(this,"toggleExpanded",e=>{e.preventDefault();let r=!this.expanded;for(let i of y(this,T,Ia).call(this)){let n=i.variantLayout;n instanceof Qt&&(n.expanded=r,i._bizproExpanded=r,i.requestUpdate())}});p(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?y(this,T,br).call(this):y(this,T,ut).call(this),this.card.requestUpdate()});u(this,Yt,e=>{let r=this.licenseOptions;if(!r?.length)return;let i=r.length-1;switch(e.key){case Ra:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%r.length:y(this,T,ut).call(this);break;case Ma:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+r.length)%r.length:y(this,T,ut).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Oa:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(r[this.licenseHighlightedIndex]);return}y(this,T,ut).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),y(this,T,br).call(this);break;case Da:this.licenseOpen&&this.selectLicenseQty(r[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});p(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,y(this,T,gt).call(this);let r=this.quantitySelectEl;r&&(r.selectedValue=Number(e),r.dispatchEvent(new CustomEvent(M,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._bizproExpanded??!1}getGlobalCSS(){return _a}priceOptionsProvider(e,r){e.dataset.template===R&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),r.dataset.displayPerUnit="false",e.parentNode.insertBefore(r,e.nextSibling),await r.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),r.addEventListener(U,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let r=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=r?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=r.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${E}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled?.();let i=r.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(r=>{let i=window.getComputedStyle(r),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,r.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(l=>requestAnimationFrame(l)),await new Promise(l=>requestAnimationFrame(l));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let r=this.card.variant,i=`--consonant-merch-card-${r}-top-card-height`,n=[...e.querySelectorAll(`merch-card[variant="${r}"]`)].filter(l=>l.getBoundingClientRect().width>2&&l.variantLayout?.card?.heightSync!==!1),o=new Map;for(let l of n){let d=o.get(l.offsetTop)??[];d.push(l),o.set(l.offsetTop,d)}for(let l of o.values())for(let d of l)d.style.removeProperty(i);let c=new Map;for(let l of o.values())for(let d of l){let h=d.shadowRoot?.querySelector(".top-card");c.set(d,h&&parseInt(getComputedStyle(h).height)||0)}for(let l of o.values()){let d=0;for(let h of l)d=Math.max(d,c.get(h));d>0&&l.length>1&&l.forEach(h=>h.style.setProperty(i,`${d}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let r=this.card.querySelector('[slot="body-xs"]'),i=r?Math.round(r.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(it,s(this,bt)),this.card.addEventListener(M,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;g(this,we,new ResizeObserver(()=>this.resyncOnReflow())),s(this,we).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&s(this,we).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(M,this.updatePriceQuantity),y(this,T,gt).call(this),s(this,we)?.disconnect(),this.card?.removeEventListener(it,s(this,bt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let r=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(r)||Number.isNaN(i)||i<r)return null;let o=[];for(let c=r;c<=i;c+=n)o.push(String(c));return o.length?o:null}licenseLabel(e){let r=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=r.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let r=this.quantitySelectEl?.getAttribute("default-value");return r!=null&&e.includes(r)?r:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return he`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,r=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(r));return he`
        ...
        `}renderLayout(){let e=!!this.expanded;return he`
            ...
            ${this.hasWhatsIncluded?he`
                  ...
                  `:mt}
            <slot></slot>
        `}};ie=new WeakMap,we=new WeakMap,bt=new WeakMap,T=new WeakSet,Ia=function(){let e=this.card.offsetTop,r=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return r.length?r:[this.card]},gt=function(){s(this,ie)&&(document.removeEventListener("mousedown",s(this,ie)),g(this,ie,null))},$a=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},ut=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=y(this,T,$a).call(this),s(this,ie)||(g(this,ie,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),y(this,T,gt).call(this))}),document.addEventListener("mousedown",s(this,ie)))},br=function(){this.licenseOpen=!1,y(this,T,gt).call(this)},Yt=new WeakMap,p(Qt,"variantStyle",bn`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var ft=Qt;import{html as vr,css as vn}from"./lit-all.min.js";var Fa=`
:root {
...
`;var Ha={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ee,Be=class extends b{constructor(e){super(e);u(this,ee);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Fa}priceOptionsProvider(e,r){e.dataset.template===R&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return vr` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){this.handleResize=()=>{s(this,ee)&&cancelAnimationFrame(s(this,ee)),g(this,ee,requestAnimationFrame(()=>{g(this,ee,null),this.postCardUpdateHook()}))},this.adjustShortDescriptionBound=this.adjustShortDescription.bind(this),window.addEventListener("resize",this.handleResize),this.card.addEventListener(M,this.updatePriceQuantity),this.card.addEventListener(fe,this.adjustShortDescriptionBound)}disconnectedCallbackHook(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),s(this,ee)&&(cancelAnimationFrame(s(this,ee)),g(this,ee,null)),this.card.removeEventListener(M,this.updatePriceQuantity),this.card.removeEventListener(fe,this.adjustShortDescriptionBound)}adjustShortDescription(){let e=this.card.querySelector('[slot="short-description"]');if(!e?.textContent?.trim())return;let r=this.card.querySelector('span[data-template="legal"]');if(!r)return;this.card.querySelector(".merch-short-description")?.remove();let i=document.createElement("span");i.className="merch-short-description";let n=e.querySelector("p")??e;i.innerHTML=n.innerHTML,i.querySelectorAll(".icon-button").forEach(o=>{o.dataset.eventsWired||(o.dataset.eventsWired="1",["mouseenter","focus"].forEach(c=>o.addEventListener(c,()=>o.classList.add("tooltip-visible"))),["mouseleave","blur"].forEach(c=>o.addEventListener(c,()=>o.classList.remove("tooltip-visible"))),o.addEventListener("keydown",c=>{c.key==="Escape"&&o.classList.remove("tooltip-visible")}))}),r.after(i),e.hidden=!0}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),x.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),e.closest('[slot="heading-xs"]').appendChild(r),await r.onceSettled(),r.querySelector(".price-unit-type")?.remove()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${E}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}toggleAddon(e){let r=this.mainPrice,i=this.headingXSSlot;if(!r&&i){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(c=>c.remove()),e.checked){if(o){let c=P("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},o.innerHTML);this.card.appendChild(c)}}else{let c=P("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(c)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,i=this.card.planType;r&&(await r.onceSettled?.(),i=r.value?.[0]?.planType),i&&(e.planType=i)}};ee=new WeakMap,p(Be,"variantStyle",vn`
    ...
    `);import{html as xr,css as xn}from"./lit-all.min.js";var Ba=`
:root {
...
`;var qa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},qe=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===R&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Ba}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${E}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return xr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as yn,css as wn}from"./lit-all.min.js";var Ua=`
...
`;var ja={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ue=class extends b{constructor(t){super(t)}getGlobalCSS(){return Ua}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return yn`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as yr,css as En}from"./lit-all.min.js";var Ga=`
:root {
...
`;var Va={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},je=class extends b{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Ga}renderLayout(){return yr`${this.cardImage}
            ...
            ${this.evergreen?yr`
                  ...
                  `:yr`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};p(je,"variantStyle",En`
    ...
    `);import{html as kn,css as Cn}from"./lit-all.min.js";var Wa=`
:root {
...
`;var wr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ge=class extends b{getGlobalCSS(){return Wa}get aemFragmentMapping(){return wr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;if(!t)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(t.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",c)})}),x.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Rt()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let t=this.getContainer();t&&t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t<=2||t===this.lastSyncedWidth||(this.lastSyncedWidth=t,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(Rt())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};e();let r=window.matchMedia(C);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(C).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||Rt())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return kn`
    ...
    `);import{html as Ya,css as Sn}from"./lit-all.min.js";var Ka=`
:root {
...
`;var Er={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},vt=class vt extends b{getGlobalCSS(){return Ka}get aemFragmentMapping(){return Er}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ya`
        ...
        `}async waitForTitleFont(){let t=this.card.querySelector(this.headingSelector);if(t&&document.fonts?.load){let e=window.getComputedStyle(t),r=`${e.fontWeight} ${e.fontSize} ${e.fontFamily}`;await document.fonts.load(r,t.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c)),this.card.getBoundingClientRect().width<=2)return;let t=vt.SYNCED_SECTIONS.map(c=>({name:c,getElement:l=>l.shadowRoot?.querySelector(`.${c}`)})),e=this.getContainer(),r=e?e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(r,c=>c.querySelectorAll(i).length)),o=Array.from({length:n},(c,l)=>({name:`description-row-${l}`,getElement:d=>d.querySelectorAll(i)[l]}));this.syncRowHeights([...t,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let t=this.getContainer();if(t){let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=49;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",c)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let e=this.card.querySelector(this.headingSelector),r=e?Math.round(e.getBoundingClientRect().height):0,i=`${Math.round(t)}:${r}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let t=this.card.querySelector(this.headingSelector);t&&this.sizeObserver.observe(t)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return Ya`
            ...
            <slot></slot>
        `}};p(vt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),p(vt,"variantStyle",Sn`
    ...
    `);var xt=vt;import{html as kr,css as An,nothing as zn}from"./lit-all.min.js";var Qa=`
...
`;var Za={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Tn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Ve=class extends b{constructor(t){super(t)}getGlobalCSS(){return Qa}renderLayout(){return kr`
    ...
    `);import{css as Ln,html as Pn}from"./lit-all.min.js";var Xa=`
...
`;var Ja={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},We=class extends b{constructor(){super(...arguments);p(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Xa}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${E}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Pn`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as _n,css as Mn}from"./lit-all.min.js";var ei=`
...
`;var Cr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Rn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Zt,ti,Ke=class extends b{constructor(e){super(e);u(this,Zt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return ei}get aemFragmentMapping(){return Cr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Zt,ti).call(this))}renderLayout(){return _n`
            <div class="card">
            ...
            <slot></slot>
        `}};Zt=new WeakSet,ti=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Rn.forEach(({key:r,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),r))},p(Ke,"variantStyle",Mn`
    ...
    `);import{html as On,css as Dn}from"./lit-all.min.js";var ri=`
...
`;var Sr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ye=class extends b{getGlobalCSS(){return ri}get aemFragmentMapping(){return Sr}renderLayout(){return On`
    ...
    `);var Xt=new Map,ai=new WeakMap,ii=new Map,S=(a,t,e=null,r=null,i)=>{Xt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};S("catalog",Fe,ma,Fe.variantStyle);S("image",ye);S("inline-heading",Ht);S("mini-compare-chart",ht,wa,ht.variantStyle);S("mini-compare-chart-mweb",He,ka,He.variantStyle);S("plans",N,Wt,N.variantStyle,N.collectionOptions);S("plans-students",N,za,N.variantStyle,N.collectionOptions);S("plans-education",N,Aa,N.variantStyle,N.collectionOptions);S("plans-v2",de,Pa,de.variantStyle,de.collectionOptions);S("bizpro",ft,Na,ft.variantStyle);S("product",Be,Ha,Be.variantStyle);S("segment",qe,qa,qe.variantStyle);S("media",Ue,ja,Ue.variantStyle);S("headless",Ve,Za,Ve.variantStyle);S("special-offers",je,Va,je.variantStyle);S("simplified-pricing-express",Ge,wr,Ge.variantStyle);S("full-pricing-express",xt,Er,xt.variantStyle);S("mini",We,Ja,We.variantStyle);S("image",ye,ua,ye.variantStyle);S("compare-chart-column",Ke,Cr,Ke.variantStyle);S("fries",Ye,Sr,Ye.variantStyle);var Nn=(a,t,e)=>{try{let r=ii.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ii.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Ar=a=>{let t=Xt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=ai.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?Nn(a,r,i):{};return ai.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Ft(a){return Xt.get(a)?.fragmentMapping}function ni(a){return Xt.get(a)?.collectionOptions}var zr=document.createElement("style");zr.innerHTML=`
:root {
...
`;zr.setAttribute("data-mas-global","");document.head.querySelector("style[data-mas-global]")||document.head.appendChild(zr);function Jt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=Tr(r)?r:a;n=o.get(c)}if(i&&n==null){let o=Tr(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=$n(Tr(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var In=a=>typeof a=="boolean",er=a=>typeof a=="function";var Tr=a=>typeof a=="string";function oi(a,t){if(In(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function $n(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var pe=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(Ot);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Ee={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ci=1e3;function Fn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function si(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!Ee.serializableTypes.includes(e))return e}return a}function Hn(a,t){if(!Ee.ignoredProperties.includes(a))return si(t)}var Lr={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(Fn(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(si).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${Ee.delimiter}page=${o}${c}`;l.length>ci&&(l=`${l.slice(0,ci)}<trunc>`),n+=l,i.length&&(n+=`${Ee.delimiter}facts=`,n+=JSON.stringify(i,Hn)),window.lana?.log(n,Ee)}};function li(a){Object.assign(Ee,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in Ee&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var di={LOCAL:"local",PROD:"prod",STAGE:"stage"},Pr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},_r=new Set,Mr=new Set,hi=new Map,pi={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},mi={filter:({level:a})=>a!==Pr.DEBUG},Bn={filter:()=>!1};function qn(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&er(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Un(a){[...Mr].every(t=>t(a))&&_r.forEach(t=>t(a))}function gi(a){let t=(hi.get(a)??0)+1;hi.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>gi(`${r.namespace}/${i}`),updateConfig:li};return Object.values(Pr).forEach(i=>{r[i]=(n,...o)=>Un(qn(i,n,a,o,e))}),Object.seal(r)}function tr(...a){a.forEach(t=>{let{append:e,filter:r}=t;er(r)&&Mr.add(r),er(e)&&_r.add(e)})}function jn(a={}){let{name:t}=a,e=oi(Jt("commerce.debug",{search:!0,storage:!0}),t===di.LOCAL);return tr(e?pi:mi),t===di.PROD&&tr(Lr),yt}function Gn(){_r.clear(),Mr.clear()}var yt={...gi(sa),Level:Pr,Plugins:{consoleAppender:pi,debugFilter:mi,quietFilter:Bn,lanaAppender:Lr},init:jn,reset:Gn,use:tr};var Vn="mas-commerce-service",Hd=yt.module("utilities"),Wn={requestId:Ot,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var rr=a=>window.setTimeout(a);function Rr(){return document.getElementsByTagName(Vn)?.[0]}function ui(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Wn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function fi(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n===e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var bi="fragment",vi="author",xi="preview",yi="loading",wi="mask",Ei="pzn",ki="timeout",Or="aem-fragment",Ci="eager",Si="cache",Kn=[Ci,Si],G,ke,I,ne,Dr=class{constructor(){u(this,G,new Map);u(this,ke,new Map);u(this,I,new Map);u(this,ne,new Map)}clear(){s(this,G).clear(),s(this,ke).clear(),s(this,I).clear(),s(this,ne).clear()}getInflight(t){return s(this,ne).get(t)}setInflight(t,e){s(this,ne).set(t,e),e.catch(()=>{}).finally(()=>{s(this,ne).get(t)===e&&s(this,ne).delete(t)})}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,G).set(t.id,t),t.fields?.originalId&&s(this,G).set(t.fields.originalId,t),s(this,I).has(t.id)){let[,r]=s(this,I).get(t.id);r()}if(s(this,I).has(t.fields?.originalId)){let[,r]=s(this,I).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,G).has(t)}entries(){return s(this,G).entries()}get(t){return s(this,G).get(t)}getAsPromise(t){let[e]=s(this,I).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,I).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,ke).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,ke).set(t,e)),e}set(t,e){if(s(this,G).set(t,e),s(this,I).has(t)){let[,r]=s(this,I).get(t);r()}}remove(t){s(this,G).delete(t),s(this,ke).delete(t),s(this,I).delete(t),s(this,ne).delete(t)}};G=new WeakMap,ke=new WeakMap,I=new WeakMap,ne=new WeakMap;var j=new Dr,Qe,F,oe,$,V,L,wt,W,K,Et,Y,kt,Ct,Ze,Q,Ai,zi,Nr,Ti,ar=class extends HTMLElement{constructor(){super(...arguments);u(this,Q);p(this,"cache",j);u(this,Qe);u(this,F,null);u(this,oe,null);u(this,$,null);u(this,V);u(this,L);u(this,wt,Ci);u(this,W);u(this,K);u(this,Et,5e3);u(this,Y);u(this,kt,!1);u(this,Ct,0);u(this,Ze)}static get observedAttributes(){return[bi,yi,ki,vi,xi,wi,Ei]}cacheKey(){return`${s(this,V)}${s(this,K)?`-p_${s(this,K)}`:""}${s(this,W)?`-m_${s(this,W)}`:""}`}attributeChangedCallback(e,r,i){e===bi&&(g(this,V,i),g(this,L,j.getFetchInfo(this.cacheKey()))),e===wi&&g(this,W,i),e===Ei&&g(this,K,i),e===yi&&Kn.includes(i)&&g(this,wt,i),e===ki&&g(this,Et,parseInt(i,10)),e===vi&&g(this,kt,["","true"].includes(i)),e===xi&&g(this,Ze,i)}connectedCallback(){if(!s(this,Y)){if(s(this,$)??g(this,$,ve(this)),g(this,Ze,s(this,$).settings?.preview),s(this,Qe)??g(this,Qe,s(this,$).log.module(`${Or}[${s(this,V)}]`)),!s(this,V)||s(this,V)==="#"){s(this,L)??g(this,L,j.getFetchInfo("missing-fragment-id")),y(this,Q,Nr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,L)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,Y)&&!await Promise.race([s(this,Y),Promise.resolve(!1)]))return;e&&j.remove(this.cacheKey()),s(this,wt)===Si&&await Promise.race([j.getAsPromise(this.cacheKey()),new Promise(c=>setTimeout(c,s(this,Et)))]);try{g(this,Y,y(this,Q,Ti).call(this)),await s(this,Y)}catch(c){return y(this,Q,Nr).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,F)||{};return o&&!Jt("mas.disableWcsCache")&&s(this,$).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Re,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,L)},bubbles:!0,composed:!0})),s(this,Y)}get updateComplete(){return s(this,Y)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,oe)?s(this,oe):(s(this,kt)?this.transformAuthorData():this.transformPublishData(),s(this,oe))}get rawData(){return s(this,F)}transformAuthorData(){let{fields:e,id:r,maskId:i,tags:n,variationId:o,promoProject:c,promoVariationProject:l,settings:d={},priceLiterals:h={},dictionary:m={},placeholders:f={}}=s(this,F);g(this,oe,e.reduce((k,{name:q,multiple:O,values:ue})=>(k.fields[q]=O?ue:ue[0],k),{fields:{},id:r,tags:n,settings:d,priceLiterals:h,dictionary:m,maskId:i,placeholders:f,variationId:o,promoProject:c,promoVariationProject:l}))}transformPublishData(){if(!s(this,F))return;let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},maskId:l,placeholders:d={},variationId:h,promoProject:m,promoVariationProject:f}=s(this,F);g(this,oe,Object.entries(e).reduce((k,[q,O])=>(k.fields[q]=O?.mimeType?O.value:O??"",k),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,maskId:l,placeholders:d,variationId:h,promoProject:m,promoVariationProject:f}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:s(this,$).settings.locale,apiKey:s(this,$).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,$).settings.instant,o={...i,...n!=null?{instant:n}:{},...s(this,W)!=null?{mask:s(this,W)}:{},...s(this,K)!=null?{pzn:s(this,K)}:{}};return await r(s(this,V),o)}};Qe=new WeakMap,F=new WeakMap,oe=new WeakMap,$=new WeakMap,V=new WeakMap,L=new WeakMap,wt=new WeakMap,W=new WeakMap,K=new WeakMap,Et=new WeakMap,Y=new WeakMap,kt=new WeakMap,Ct=new WeakMap,Ze=new WeakMap,Q=new WeakSet,Ai=async function(e){Gr(this,Ct)._++;let r=`${Or}:${this.cacheKey()}:${s(this,Ct)}`,i=`${r}${Dt}`,n=`${r}${Nt}`;if(s(this,Ze)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new pe(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,L).stale=!1,s(this,L).url=e,o=await fi(e,{cache:"default",credentials:"omit"}),y(this,Q,zi).call(this,o),s(this,L).status=o?.status,s(this,L).measure=De(performance.measure(n,i)),s(this,L).retryCount=o.retryCount,!o?.ok)throw new pe("Unexpected fragment response",{response:o,...s(this,$).duration});return await o.json()}catch(c){if(s(this,L).measure=De(performance.measure(n,i)),s(this,L).retryCount=c.retryCount,s(this,F))return s(this,L).stale=!0,s(this,Qe).error("Serving stale data",s(this,L)),s(this,F);let l=c.message??"unknown";throw new pe(`Failed to fetch fragment: ${l}`,{})}},zi=function(e){Object.assign(s(this,L),ui(e))},Nr=function(e){g(this,Y,null),s(this,L).message=e,this.classList.add("error");let r={...s(this,L),...s(this,$).duration};s(this,Qe).error(e,r),this.dispatchEvent(new CustomEvent(Oe,{detail:r,bubbles:!0,composed:!0}))},Ti=async function(){this.classList.remove("error"),g(this,oe,null);let e=j.get(this.cacheKey());if(e)return g(this,F,e),!0;let r=this.cacheKey(),i=j.getInflight(r);if(!i){let{masIOUrl:n,wcsApiKey:o,country:c,locale:l}=s(this,$).settings,d=`${n}/fragment?id=${s(this,V)}&api_key=${o}&locale=${l}`;c&&!l.endsWith(`_${c}`)&&(d+=`&country=${c}`),s(this,W)&&(d+=`&mask=${s(this,W)}`),s(this,K)&&(d+=`&pzn=${s(this,K)}`),i=y(this,Q,Ai).call(this,d).then(h=>{var m;return(m=h.fields).originalId??(m.originalId=s(this,V)),s(this,W)||s(this,K)?j.set(r,h):j.add(h),h}),j.setInflight(r,i)}return g(this,F,await i),!0},p(ar,"cache",j);customElements.define(Or,ar);import{LitElement as Yn,html as Ir,css as Qn,nothing as Zn}from"./lit-all.min.js";import{unsafeHTML as Xn}from"./lit-all.min.js";var Jn=a=>a?a.startsWith("sp-icon-")?Ir`${Xn(`<${a} class="badge-icon"></${a}>`)}`:Ir`<img src="${a}" class="badge-icon" />`:Zn,Xe=class extends Yn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Ir`<div class="badge">
            ${Jn(this.icon)}<slot>${this.text}</slot>
        </div>`}};p(Xe,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),p(Xe,"styles",Qn`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Xe);import{html as eo,css as to,LitElement as ro}from"./lit-all.min.js";var St=class extends ro{constructor(){super()}render(){return eo`
            <slot name="icon"></slot>
    ...
    `),p(St,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",St);import{html as $r,css as ao,LitElement as io,nothing as Li}from"./lit-all.min.js";var At=class extends io{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return $r`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?$r`<slot name="content"></slot>`:Li}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?$r`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Li}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};p(At,"styles",ao`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),p(At,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",At);var no={[ce]:ia,[be]:na,[se]:oa},oo={[ce]:ca,[se]:U},zt,ir=class{constructor(t){u(this,zt);p(this,"changes",new Map);p(this,"connected",!1);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",be);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t,this.log=yt.module("mas-element")}update(){[ce,be,se].forEach(t=>{this.wrapperElement.classList.toggle(no[t],t===this.state)})}notify(){(this.state===se||this.state===ce)&&(this.state===se?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===ce&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof pe&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(oo[this.state],{bubbles:!0,composed:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){g(this,zt,Rr()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return se===r?Promise.resolve(this.wrapperElement):ce===r?Promise.reject(t):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=se,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),rr(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=ce,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...s(this,zt)?.duration}),rr(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=be,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!Rr()||this.timer)return;let{error:e,options:r,state:i,value:n,version:o}=this;this.state=be,this.timer=rr(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===be&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,r)}})}};zt=new WeakMap;function co(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Se,Ce=class Ce extends HTMLAnchorElement{constructor(){super();p(this,"masElement",new ir(this));u(this,Se);this.setAttribute("is",Ce.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,i){this.masElement.attributeChangedCallback(e,r,i)}connectedCallback(){this.masElement.connectedCallback(),g(this,Se,ve()),s(this,Se)&&(this.log=s(this,Se).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),g(this,Se,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=ve();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:c,language:l,env:d}=r,h=`locale=${l}_${c}&country=${c}&offer_id=${o.offerId}`,m=this.getAttribute("data-promotion-code");m&&(h+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${co(d)}?${h}`,this.masElement.toggleResolved(i,o,r)}catch(o){let c=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,c,r),!1}}static createFrom(e){let r=new Ce;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?r.setAttribute("class",i.value.replace("upt-link","").trim()):r.setAttribute(i.name,i.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};Se=new WeakMap,p(Ce,"is","upt-link"),p(Ce,"tag","a"),p(Ce,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var me=Ce;window.customElements.get(me.is)||window.customElements.define(me.is,me,{extends:me.tag});var so="#000000",Fr="#F8D904",lo="#EAEAEA",ho="#31A547",po=/(accent|primary|secondary)(-(outline|link))?/,mo="mas:product_code/",go="daa-ll",nr="daa-lh",uo=["XL","L","M","S"],Hr="...",fo=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function H(a,t,e,r){let i=r[a];if(t[a]&&i){let n={slot:i?.slot,...i?.attributes},o=t[a];if(i.maxCount&&typeof o=="string"){let[l,d]=$o(o,i.maxCount,i.withSuffix);l!==o&&(n.title=d,o=l)}let c=P(i.tag,n,o);e.append(c)}}function bo(a,t,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,c)=>({icon:o,alt:a.mnemonicAlt?.[c]??"",link:a.mnemonicLink?.[c]??""}));i?.forEach(({icon:o,alt:c,link:l})=>{if(l&&!/^https?:/.test(l))try{l=new URL(`https://${l}`).href.toString()}catch{l="#"}let d={slot:"icons",src:o,loading:t.loading,size:e?.size??"l"};c&&(d.alt=c),l&&(d.href=l);let h=P("merch-icon",d);t.append(h)});let n=t.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function vo(a,t,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let r=Fr,i=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,a.borderColor||(i=!0));let n=a.badgeBackgroundColor||r,o=a.borderColor||"";i&&(o=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${n}" border-color="${o}">${a.badge}</merch-badge>`}H("badge",a,t,e)}else a.badge?(t.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",a.badgeColor||so),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",a.badgeBackgroundColor||Fr),t.setAttribute("border-color",a.badgeBackgroundColor||Fr)):t.setAttribute("border-color",a.borderColor||lo)}function xo(a,t,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||ho;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${r}">${a.trialBadge}</merch-badge>`}H("trialBadge",a,t,e)}}function yo(a,t,e){e?.includes(a.size)&&t.setAttribute("size",a.size)}function wo(a,t){a.cardName&&t.setAttribute("name",a.cardName)}function Eo(a,t,e){a.cardTitle&&(a.cardTitle=Je(a.cardTitle)),H("cardTitle",a,t,{cardTitle:e})}function ko(a,t,e){H("subtitle",a,t,e)}function Co(a,t,e,r){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[a.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),t.setAttribute("background-color",a.backgroundColor)):r?.attribute&&a.backgroundColor&&(t.setAttribute(r.attribute,a.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function So(a,t,e){let r=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")t.style.setProperty(i,"transparent");else if(a.borderColor&&r){let o=r?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),c=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){t.setAttribute("gradient-border","true");let l=a.borderColor;if(r?.specialValues){for(let[d,h]of Object.entries(r.specialValues))if(h===a.borderColor){l=d;break}}t.setAttribute("border-color",l),t.style.removeProperty(i)}else c?(t.setAttribute("border-color",a.borderColor),t.style.setProperty(i,`var(--${a.borderColor})`)):t.style.setProperty(i,`var(--${a.borderColor})`)}}var Ao=new Set(["","default"]);function zo(a,t,e){let r=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!r)return;let o=(t.querySelector('[slot="footer-rows"] merch-whats-included')??t.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),c=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",l=o||c;if(l==null||Ao.has(String(l).trim().toLowerCase())){t.removeAttribute("whats-included-divider-color"),t.style.removeProperty(i);return}let d=String(l).trim();if(d.toLowerCase()==="transparent"){t.removeAttribute("whats-included-divider-color"),t.style.setProperty(i,"transparent");return}let m=r.specialValues?.[d]?.includes("gradient")||/-gradient/.test(d)||/^gradient-/.test(d),f=/^spectrum-.*-(plans|special-offers)$/.test(d);if(m){let k=d;if(r.specialValues){for(let[q,O]of Object.entries(r.specialValues))if(O===d){k=q;break}}t.setAttribute("whats-included-divider-color",k),t.style.removeProperty(i)}else f?(t.setAttribute("whats-included-divider-color",d),t.style.setProperty(i,`var(--${d})`)):(t.removeAttribute("whats-included-divider-color"),t.style.setProperty(i,`var(--${d})`))}function To(a,t,e){if(a.backgroundImage){let r={loading:t.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?r.alt=a.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,a.backgroundImage);return}t.append(P(e.tag,{slot:e.slot},P("img",r)))}}function Je(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(hr(),dr)).catch(console.error),a}function Lo(a,t,e){a.prices&&(a.prices=Je(a.prices)),H("prices",a,t,e)}function Br(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap(Br);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap(Br);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function Po(a,t,e){let r=Br(a.features).filter(n=>n.trim());if(!r.length)return;let i=P("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});r.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let c=o.body.querySelector("p[name]");if(c){i.append(c);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&t.append(i),Mo(t,e)}function _i(a,t,e){let r=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=po.exec(i)?.[0]??"accent",o=n.includes("accent"),c=n.includes("primary"),l=n.includes("secondary"),d=n.includes("-outline"),h=n.includes("-link");a.classList.remove("accent","primary","secondary");let m;if(t.consonant)m=qo(a,o,r,h,c,l,e?.ctas?.size);else if(h)m=a;else{let f;o?f="accent":c?f="primary":l&&(f="secondary"),m=t.spectrum==="swc"?Bo(a,e,d,f,r):Ho(a,e,d,f,r)}return m}function _o(a,t){let{slot:e}=t?.description;Mi(a,t,e)}function Mo(a,t){let e=t?.features?.slot;e&&Mi(a,t,e)}function Mi(a,t,e){let r=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(i=>{let n=_i(i,a,t);i.replaceWith(n)})}function Ro(a,t,e,r){a.description&&(a.description=Je(a.description)),a.promoText&&(a.promoText=Je(a.promoText)),a.shortDescription&&(a.shortDescription=Je(a.shortDescription)),H("promoText",a,t,e),H("description",a,t,e),H("shortDescription",a,t,e),a.shortDescription&&(t.setAttribute("action-menu","true"),a.actionMenuLabel||t.setAttribute("action-menu-label","More options")),_o(t,e),H("callout",a,t,e),Oo(a,t,e,r),H("whatsIncluded",a,t,e)}function Oo(a,t,e,r={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=r.quantitySelect),H("quantitySelect",a,t,e))}function Do(a,t,e,r={}){if(!e.addon)return;let n=(a.addon??r.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o,c=n,l=document.createElement("div");l.innerHTML=n;let d=l.firstElementChild;d?.tagName?.toLowerCase()==="merch-addon"&&(o=d.getAttribute("background")||void 0,c=d.innerHTML);let h={slot:"addon"};o&&(h.background=o);let m=P("merch-addon",h,c);[...m.querySelectorAll(E)].forEach(f=>{let k=f.parentElement;k?.nodeName==="P"&&k.setAttribute("data-plan-type","")}),t.append(m)}function No(a,t,e){a.addonConfirmation&&H("addonConfirmation",a,t,e)}function Io(a,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function $o(a,t,e=!0){try{let r=typeof a!="string"?"":a,i=Pi(r);if(i.length<=t)return[r,i];let n=0,o=!1,c=e?t-Hr.length<1?1:t-Hr.length:t,l=[];for(let m of r){if(n++,m==="<")if(o=!0,r[n]==="/")l.pop();else{let f="";for(let k of r.substring(n)){if(k===" "||k===">")break;f+=k}l.push(f)}if(m==="/"&&r[n]===">"&&l.pop(),m===">"){o=!1;continue}if(!o&&(c--,c===0))break}let d=r.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let m of l.reverse())d+=`</${m}>`}return[`${d}${e?Hr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=Pi(i);return[i,n]}}function Pi(a){if(!a)return"";let t="",e=!1;for(let r of a){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function Fo(a,t){t.querySelectorAll("a.upt-link").forEach(r=>{let i=me.createFrom(r);r.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function Ho(a,t,e,r,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let h of a.attributes)["class","is"].includes(h.name)||n.setAttribute(h.name,h.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",c=`spectrum-Button--${r}`,l=uo.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",d=["spectrum-Button",c,l];return e&&d.push("spectrum-Button--outline"),n.classList.add(...d),n}function Bo(a,t,e,r,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let c=P("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return c.source=n,(i?n.onceSettled():Promise.resolve(n)).then(l=>{c.setAttribute("data-navigation-url",l.href)}),c.addEventListener("click",l=>{l.defaultPrevented||n.click()}),c}function qo(a,t,e,r,i,n,o){let c=a;if(e)try{let l=customElements.get("checkout-link");l&&(c=l.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return r||(c.classList.add("button","con-button"),o&&o!=="m"&&c.classList.add(`button-${o}`),t&&c.classList.add("blue"),i&&c.classList.add("primary"),n&&c.classList.add("secondary")),c}function Uo(a,t,e,r,i){if(a.ctas){a.ctas=Je(a.ctas);let{slot:n}=e.ctas,o=P("div",{slot:n},a.ctas),c=[...o.querySelectorAll("a")],l=i?.hideTrialCTAs?c.filter(h=>!fo.has(h.dataset.analyticsId)):c,d=(l.length>0?l:c).map(h=>_i(h,t,e));o.textContent="",o.append(...d),t.append(o),i?.hideTrialCTAs&&l.length>0&&d.forEach(h=>{let m=h.source??h;m.onceSettled&&(h.hidden=!0,m.onceSettled().then(()=>{m.value?.[0]?.offerType==="TRIAL"&&d.some(k=>k!==h&&!k.hidden)?h.remove():h.hidden=!1}).catch(()=>{h.hidden=!1}))})}}function jo(a,t){let{tags:e}=a,r=e?.find(n=>typeof n=="string"&&n.startsWith(mo))?.split("/").pop();if(!r)return;t.setAttribute(nr,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(go,`${n.dataset.analyticsId}-${o+1}`)})}function Go(a){a.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{a.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function Vo(a){a.querySelectorAll("[slot]").forEach(r=>{r.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",nr].forEach(r=>a.removeAttribute(r));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function Ri(a,t){if(!a){let l=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!a.fields){let l=a.id||"unknown",d=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'.`)}let{id:e,fields:r,settings:i={},priceLiterals:n}=a,{variant:o}=r;if(!o)throw new Error(`hydrate: no template found in payload ${e}`);Vo(t),t.compatVersion=r.compatVersion,t.contextPromotionCode=r.promoCode,t.settings=i,n&&(t.priceLiterals=n),t.id??(t.id=a.id),a.variationId&&t.setAttribute("variation-id",a.variationId),a.maskId&&t.setAttribute("mask-id",a.maskId),a.promoProject&&t.setAttribute("data-promotion-project",a.promoProject),a.promoVariationProject&&t.setAttribute("data-promotion-variation-project",a.promoVariationProject),t.variant=o,await t.updateComplete;let{aemFragmentMapping:c}=t.variantLayout;if(!c)throw new Error(`hydrate: variant mapping not found for ${e}`);c.style==="consonant"&&t.setAttribute("consonant",!0),bo(r,t,c.mnemonics),xo(r,t,c),yo(r,t,c.size),wo(r,t),Eo(r,t,c.title),vo(r,t,c),ko(r,t,c),Lo(r,t,c),To(r,t,c.backgroundImage),Co(r,t,c.allowedColors,c.backgroundColor),So(r,t,c),Ro(r,t,c,i),Po(r,t,c),zo(r,t,c),Do(r,t,c,i),No(r,t,c),Io(r,t,c,i);try{Fo(r,t)}catch{}Uo(r,t,c,o,i),jo(r,t),Go(t)}var cr="merch-card",Oi="merch-card:",$i=["full-pricing-express","simplified-pricing-express"],Fi=["segment","product","plans-education","mini-compare-chart-mweb"];function Di(a,t){let e=a.closest(cr);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),ha(a)&&(t.displayPerUnit=!1,t.displayTax=!1),!t.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(t.promotionCode=e.contextPromotionCode),e.aemFragment&&(t[la]=!0),e.variantLayout?.priceOptionsProvider?.(a,t),a.dataset.template===R&&(t.displayDot??(t.displayDot=e.variantLayout?.legalDisplayDot??!0))}function Ni(a,t){let e=a.closest(cr);if(!e)return t;!t.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(t.promotionCode=e.contextPromotionCode)}function Ko(a){a.providers.has(Di)||a.providers.price(Di),a.providers.has(Ni)||a.providers.checkout(Ni)}var Tt=new IntersectionObserver(a=>{a.forEach(t=>{let e=t.target;if($i.includes(e.variant)){if(e.clientHeight===0)return;Tt.unobserve(e),e.requestUpdate();return}if(Fi.includes(e.variant)){if(t.boundingClientRect.width===0)return;if((e.variant==="product"||e.variant==="mini-compare-chart-mweb"||e.variant==="plans-education")&&e.querySelector('merch-icon[slot="icons"]')){Tt.unobserve(e);return}let r=e.getBoundingClientRect().width,i=e.querySelector('[slot="badge"] > merch-badge'),n=i?.getBoundingClientRect().width||0;if(r===0||!i){Tt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(r-n-16)}px`),Tt.unobserve(e)}})}),Yo=0,Pt,et,tt,rt,te,ze,B,Te,A,Ae,Lt,qr,or,ge=class extends Wo{constructor(){super();u(this,A);u(this,Pt);u(this,et);u(this,tt);u(this,rt);u(this,te);u(this,ze);u(this,B);u(this,Te,new Promise(e=>{g(this,B,e)}));p(this,"compatVersion");p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMasReady=this.handleMasReady.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}get contextPromotionCode(){return s(this,Pt)}set contextPromotionCode(e){g(this,Pt,e),e?this.setAttribute("data-promotion-code",e):this.removeAttribute("data-promotion-code")}firstUpdated(){this.variantLayout=Ar(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=Ar(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){y(this,A,Ae).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(E)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(re)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(re)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(re)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let i of r){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let c=i.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&c.push(o),i.dataset.wcsOsi=c.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let i=n=>{let{offerType:o,planType:c}=n.value?.[0]??{};if(!o||!c)return;let l=e.getOsi(c,o),d=(n.dataset.wcsOsi||"").split(",").filter(h=>h&&h!==l);e.checked&&d.push(l),n.dataset.wcsOsi=d.join(",")};r.forEach(i)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let i of r)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(i=>{if(e){r[i].order=Math.min(r[i].order||2,2);return}let n=r[i].order;n===1||isNaN(n)||(r[i].order=Number(n)+1)}),this.filters=r}showInfoTooltip(e,r){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(r)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(r=>this.iconButton.addEventListener(r,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(r=>this.iconButton.addEventListener(r,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",r=>{r.key==="Escape"&&this.iconButton.classList.remove(e)}))}additionalModalTriggers(){if(!this.settings?.additionalModalTriggers)return;let e=this.variantLayout.aemFragmentMapping.title;this.makeElementModalTrigger(e?.tag,e?.slot),this.makeElementModalTrigger("merch-icon","icons")}handleMasReady(){this.handleInfoIconEvents(),this.additionalModalTriggers()}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),s(this,tt)||g(this,tt,Yo++),this.aemFragment||((r=s(this,B))==null||r.call(this),g(this,B,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??s(this,tt);g(this,ze,`${Oi}${e}${Dt}`),g(this,et,`${Oi}${e}${Nt}`),performance.mark(s(this,ze)),g(this,te,ve()),Ko(s(this,te)),g(this,rt,s(this,te).Log.module(cr)),this.addEventListener(M,this.handleQuantitySelection),this.addEventListener(pr,this.handleAddonAndQuantityUpdate),this.addEventListener(ta,this.handleMerchOfferSelectReady),this.addEventListener(Oe,this.handleAemFragmentEvents),this.addEventListener(Re,this.handleAemFragmentEvents),this.addEventListener(fe,this.handleMasReady),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}makeElementModalTrigger(e,r){let i=e==="merch-icon",n=this.querySelector(`${e}[slot="${r}"]:not(.modal-trigger)`);if(!n)return;let o=this.querySelector("a.button.placeholder-resolved[data-modal]");if(!o)return;n.setAttribute("tabindex","0"),n.addEventListener("click",d=>{o.checkoutActionHandler?.(d)}),n.addEventListener("keypress",d=>{d.code==="Enter"&&o.checkoutActionHandler?.(d)}),n.classList.add("modal-trigger");let l=`${this.title.replace(/\s+/g,"-").toLowerCase()}${i?"-icon":""}--${this.analyticsId}--card`;n.setAttribute("daa-ll",l),n.setAttribute("role","link"),i&&n.setAttribute("alt",this.title)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(M,this.handleQuantitySelection),this.removeEventListener(Oe,this.handleAemFragmentEvents),this.removeEventListener(Re,this.handleAemFragmentEvents),this.removeEventListener(fe,this.handleMasReady),this.removeEventListener("change",this.changeHandler),this.removeEventListener(pr,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===Oe&&y(this,A,Ae).call(this,"AEM fragment cannot be loaded"),e.type===Re&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{s(this,B)||g(this,Te,new Promise(n=>{g(this,B,n)})),await Ri(i,this)}catch(n){y(this,A,Ae).call(this,`hydration has failed: ${n.message}`)}finally{(r=s(this,B))==null||r.call(this),g(this,B,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;s(this,Te)&&(await s(this,Te),($i.includes(this.variant)||Fi.includes(this.variant))&&Tt.observe(this),g(this,Te,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e,r=new Promise(d=>{e=setTimeout(()=>d("timeout"),_e)});if(this.aemFragment){let d=await Promise.race([this.aemFragment.updateComplete,r]);if(d===!1||d==="timeout"){clearTimeout(e);let h=d==="timeout"?`AEM fragment was not resolved within ${_e} timeout`:"AEM fragment cannot be loaded";y(this,A,Ae).call(this,h,{},!1);return}}let i=[...this.querySelectorAll(ea)],n=Promise.all(i.map(d=>{let h=d.onceSettled?.();return h?h.catch(()=>d):Promise.resolve(d)})).then(d=>{let h=d.filter(m=>m.isConnected);return h.length===0||h.every(m=>m.classList.contains("placeholder-resolved"))}),o=await Promise.race([n,r]);if(clearTimeout(e),!this.isConnected)return;let c=i.filter(d=>d.isConnected);if(c.length===0||c.every(d=>d.classList.contains("placeholder-resolved"))){this.measure=performance.measure(s(this,et),s(this,ze));let d={...this.aemFragment?.fetchInfo,...s(this,te).duration,measure:De(this.measure)};return this.dispatchEvent(new CustomEvent(fe,{bubbles:!0,composed:!0,detail:d})),this}else{this.measure=performance.measure(s(this,et),s(this,ze));let d={measure:De(this.measure),...s(this,te).duration};if(o==="timeout")y(this,A,Ae).call(this,`Contains offers that were not resolved within ${_e} timeout`,d);else{let h=c.some(m=>m.matches(re)&&m.classList.contains("placeholder-failed"));y(this,A,Ae).call(this,h?"CTA has an invalid offer":"Contains unresolved offers",d)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(re)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(h=>h.getAttribute("data-modal-id")===e);if(!n)return;let c=new URL(n.getAttribute("href")).searchParams.get("pa"),l=r.find(h=>h.productArrangementCode===c)?.quantity,d=!!r.find(h=>h.productArrangementCode!==c);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(it,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==d){this.toggleStockOffer({target:this.addonCheckbox});let h=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(h,"target",{writable:!1,value:{checked:d}}),this.addonCheckbox.handleChange(h)}}get prices(){return Array.from(this.querySelectorAll(E))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${E}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return s(this,A,Lt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${E}[data-promotion-code],${re}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return this.contextPromotionCode;let r=[...new Set(e)];return r.length>1&&s(this,rt)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${E}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(s(this,A,qr)??s(this,A,Lt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return s(this,A,Lt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return s(this,A,qr)?.querySelector(e)?.textContent?.trim()??s(this,A,Lt)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return y(this,A,or).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${re}, a`);return Array.from(e??[])}get primaryCta(){return y(this,A,or).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return y(this,A,or).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Pt=new WeakMap,et=new WeakMap,tt=new WeakMap,rt=new WeakMap,te=new WeakMap,ze=new WeakMap,B=new WeakMap,Te=new WeakMap,A=new WeakSet,Ae=function(e,r={},i=!0){var l;if(!this.isConnected)return;let n=this.aemFragment,o=n?.getAttribute("fragment");o=`[${o}]`;let c={...n?.fetchInfo,...s(this,te).duration,...r,message:e};s(this,rt).error(`merch-card${o}: ${e}`,c),this.failed=!0,(l=s(this,B))==null||l.call(this),g(this,B,void 0),s(this,te).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(aa,{bubbles:!0,composed:!0,detail:c}))},Lt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${E}[data-template="price"] > span`)},qr=function(){return this.querySelector(`${E}[data-template="legal"]`)},or=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},p(ge,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,i,n]=e.split(",");return{PUF:r,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[i,n,o]=r.split(":"),c=Number(n);return[i,{order:isNaN(c)?void 0:c,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:i,size:n}])=>[r,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:nr,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),p(ge,"styles",[Qr,...Zr()]),p(ge,"registerVariant",S),p(ge,"getCollectionOptions",ni),p(ge,"getFragmentMapping",Ft);customElements.define(cr,ge);export{ge as MerchCard};

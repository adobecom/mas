...
`;var Cn="tacocat.js";var Za=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),Tn=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function F(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=mt(a)?a:e;n=o.get(s)}if(i&&n==null){let o=mt(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=Zc(mt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var Qc=e=>typeof e=="boolean",Dr=e=>typeof e=="function",zr=e=>typeof e=="number",kn=e=>e!=null&&typeof e=="object";var mt=e=>typeof e=="string",Ja=e=>mt(e)&&e,ut=e=>zr(e)&&Number.isFinite(e)&&e>0;function Hr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function T(e,r){if(Qc(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Zt(e,r,t){let a=Object.values(r);return a.find(i=>Za(i,e))??t??a[0]}function Zc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function _n(e,r=1){return zr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var Jc=Date.now(),ei=()=>`(+${Date.now()-Jc}ms)`,Fr=new Set,el=T(F("tacocat.debug",{},{metadata:!1}),!1);function Ln(e){let r=`[${Cn}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=el?(o,...s)=>{console.debug(`${r} ${o}`,...s,ei())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;Fr.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;Fr.forEach(([,l])=>l(c,...s))}}}function tl(e,r){let t=[e,r];return Fr.add(t),()=>{Fr.delete(t)}}tl((e,...r)=>{console.error(e,...r,ei())},(e,...r)=>{console.warn(e,...r,ei())});var rl="no promo",Pn="promo-tag",al="yellow",il="neutral",nl=(e,r,t)=>{let a=n=>n||rl,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Br="cancel-context",Ur=(e,r)=>{let t=e===Br,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?Pn:`${Pn} no-promo`,text:nl(o,r,i),variant:n?al:il,isOverriden:i}};var ti;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(ti||(ti={}));var pe;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(pe||(pe={}));var ue;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(ue||(ue={}));var ri;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(ri||(ri={}));var ai;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ai||(ai={}));var ii;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(ii||(ii={}));var ni;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(ni||(ni={}));var oi="ABM",si="PUF",ci="M2M",li="PERPETUAL",di="P3Y",ol="TAX_INCLUSIVE_DETAILS",sl="TAX_EXCLUSIVE",Mn={ABM:oi,PUF:si,M2M:ci,PERPETUAL:li,P3Y:di},Ip={[oi]:{commitment:pe.YEAR,term:ue.MONTHLY},[si]:{commitment:pe.YEAR,term:ue.ANNUAL},[ci]:{commitment:pe.MONTH,term:ue.MONTHLY},[li]:{commitment:pe.PERPETUAL,term:void 0},[di]:{commitment:pe.THREE_MONTHS,term:ue.P3Y}},Rn="Value is not an offer",$r=e=>{if(typeof e!="object")return Rn;let{commitment:r,term:t}=e,a=cl(r,t);return{...e,planType:a}};var cl=(e,r)=>{switch(e){case void 0:return Rn;case"":return"";case pe.YEAR:return r===ue.MONTHLY?oi:r===ue.ANNUAL?si:"";case pe.MONTH:return r===ue.MONTHLY?ci:"";case pe.PERPETUAL:return li;case pe.TERM_LICENSE:return r===ue.P3Y?di:"";default:return""}};function Nn(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==ol)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:sl}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Qe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},On=1e3;function ll(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function In(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Qe.serializableTypes.includes(t))return t}return e}function dl(e,r){if(!Qe.ignoredProperties.includes(e))return In(r)}var hi={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(ll(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(In).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${Qe.delimiter}page=${o}${s}`;c.length>On&&(c=`${c.slice(0,On)}<trunc>`),n+=c,i.length&&(n+=`${Qe.delimiter}facts=`,n+=JSON.stringify(i,dl)),window.lana?.log(n,Qe)}};function Gr(e){Object.assign(Qe,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in Qe&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Dn={LOCAL:"local",PROD:"prod",STAGE:"stage"},pi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},mi=new Set,ui=new Set,zn=new Map,Hn={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},Fn={filter:({level:e})=>e!==pi.DEBUG},hl={filter:()=>!1};function pl(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&Dr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function ml(e){[...ui].every(r=>r(e))&&mi.forEach(r=>r(e))}function Bn(e){let r=(zn.get(e)??0)+1;zn.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>Bn(`${a.namespace}/${i}`),updateConfig:Gr};return Object.values(pi).forEach(i=>{a[i]=(n,...o)=>ml(pl(i,n,e,o,t))}),Object.seal(a)}function qr(...e){e.forEach(r=>{let{append:t,filter:a}=r;Dr(a)&&ui.add(a),Dr(t)&&mi.add(t)})}function ul(e={}){let{name:r}=e,t=T(F("commerce.debug",{search:!0,storage:!0}),r===Dn.LOCAL);return qr(t?Hn:Fn),r===Dn.PROD&&qr(hi),ae}function gl(){mi.clear(),ui.clear()}var ae={...Bn(Da),Level:pi,Plugins:{consoleAppender:Hn,debugFilter:Fn,quietFilter:hl,lanaAppender:hi},init:ul,reset:gl,use:qr};var fl="mas-commerce-service",vl=ae.module("utilities"),xl={requestId:jt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Jt(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map(Nn)),a}var Un=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function gi(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let u=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?s.priceDetails?.formatString:s[l];m!==u&&vl.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:u,actual:m})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=Un(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=Un(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var Vr=e=>window.setTimeout(e);function gt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(_n).filter(ut);return t.length||(t=[r]),t}function bl(e){return e==null?[]:Array.isArray(e)?e:String(e).split(",").map(r=>r.trim())}function jr(e,r){let t=bl(r);if(e==null)return{wcsOsi:[],promotionCodes:t};let a=Array.isArray(e)?e:String(e).split(",");if(t.length<=1)return{wcsOsi:a.filter(Ja),promotionCodes:t};let i=[],n=[];return a.forEach((o,s)=>{Ja(o)&&(i.push(o),n.push(t[s]??""))}),{wcsOsi:i,promotionCodes:n}}function q(){return document.getElementsByTagName(fl)?.[0]}function $n(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(xl)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var wl=32,qn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"};function er(e,r,t,a){e?.featureFlags[he]&&r.options[a]?t.dataset[a]="false":r.options[a]&&(r.dataset[a]="false")}var ft=class extends E{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Ue`<slot name="secure-transaction-label">
    ...
    `);import{html as Wr,css as El,unsafeCSS as fi,nothing as Al}from"./lit-all.min.js";var Vn=`
  :root {
...
`;var Sl=32,Cl=0,Tl=()=>`mweb-list-${Cl+=1}`,kl=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],_l=8,jn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ce,Ze,xt,bt,yt,$e,vi,xi,vt=class extends E{constructor(t){super(t);S(this,$e);S(this,Ce);S(this,Ze);S(this,xt);S(this,bt,0);S(this,yt);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Wr` <footer>
    ...
    `);import{html as tr,css as Ll,nothing as Yr}from"./lit-all.min.js";var Wn=`
:root {
...
`;var[Im,Dm,eo,to,ro,ao]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Zr="pro",bi=`--consonant-merch-card-${Zr}-top-card-height`,Qr=[{prop:`--consonant-merch-card-${Zr}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Zr}-name-description-height`,selector:".name-description"}],io=`--consonant-merch-card-${Zr}-strike-reserve`,yi='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',Rl="(min-width: 768px)",no={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Ne,Je,or,sr,X,oo,ar,so,ir,wi,Jr,ea=class ea extends E{constructor(t){super(t);S(this,X);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);S(this,Ne,null);S(this,Je,null);S(this,or,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);S(this,sr,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of B(this,X,oo).call(this)){let n=i.variantLayout;n instanceof ea&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?B(this,X,wi).call(this):B(this,X,ir).call(this),this.card.requestUpdate()});S(this,Jr,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case to:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:B(this,X,ir).call(this);break;case eo:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:B(this,X,ir).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case ro:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}B(this,X,ir).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),B(this,X,wi).call(this);break;case ao:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,B(this,X,ar).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(oe,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return Jn}priceOptionsProvider(t,a){t.dataset.template===J&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(ve,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]');if(!t?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=t.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${G}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=bi,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(Rl).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,u)=>{let m=l(u);return m?Math.max(d,parseInt(getComputedStyle(m).height)||0):d},0);for(let c of o.values()){if(c.forEach(m=>this.clearSyncedHeights(m)),c.length<2)continue;let l=c.map(m=>m.querySelector(yi)&&parseInt(getComputedStyle(m.querySelector(yi)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((m,h)=>{let p=d-l[h];p>0&&m.style.setProperty(io,`${p}px`)});for(let m of Qr){let h=s(c,p=>p.shadowRoot?.querySelector(m.selector));h>0&&c.forEach(p=>p.style.setProperty(m.prop,`${h}px`))}let u=s(c,m=>m.shadowRoot?.querySelector(".top-card"));u>0&&c.forEach(m=>m.style.setProperty(i,`${u}px`))}}clearSyncedHeights(t){t.style.removeProperty(bi),t.style.removeProperty(io),Qr.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(yi),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Pr,v(this,sr)),this.card.addEventListener(oe,this.updatePriceQuantity),this.card.addEventListener(ve,v(this,or)),typeof ResizeObserver>"u"))return;A(this,Je,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Je).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Je).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(oe,this.updatePriceQuantity),this.card?.removeEventListener(ve,v(this,or)),B(this,X,ar).call(this),v(this,Je)?.disconnect(),this.card?.removeEventListener(Pr,v(this,sr))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Re`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Re`
    ...
    `);var nr=ea;import{html as Ei,css as Nl}from"./lit-all.min.js";var co=`
:root {
...
`;var _i={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Xl=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],ta,Lo,Mt=class extends E{constructor(t){super(t);S(this,ta);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return _o}get aemFragmentMapping(){return _i}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,B(this,ta,Lo).call(this))}renderLayout(){return Wl`
            <div class="card">
            ...
            <slot></slot>
        `}};ta=new WeakSet,Lo=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Xl.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(Mt,"variantStyle",Yl`

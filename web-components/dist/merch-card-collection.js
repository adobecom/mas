var zi=Object.defineProperty;var Di=e=>{throw TypeError(e)};var qs=(e,r,t)=>r in e?zi(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Vs=(e,r)=>{for(var t in r)zi(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>qs(e,typeof r!="symbol"?r+"":r,t),ia=(e,r,t)=>r.has(e)||Di("Cannot "+t);var v=(e,r,t)=>(ia(e,r,"read from private field"),t?t.call(e):r.get(e)),_=(e,r,t)=>r.has(e)?Di("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),C=(e,r,t,a)=>(ia(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),j=(e,r,t)=>(ia(e,r,"access private method"),t);import{html as Ie,LitElement as Os,css as Ns,unsafeCSS as Rs,nothing as be}from"./lit-all.min.js";var D="(max-width: 767px)",X="(max-width: 1199px)",R="(min-width: 768px)",T="(min-width: 1200px)",te="(min-width: 1600px)",_t="(min-width: 1280px)",Hi={matchMobile:window.matchMedia(D),matchDesktop:window.matchMedia(`${T} and (not ${te})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(te),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},L=Hi;function mr(){return Hi.isDesktop}var Lt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var Fi="hashchange";function js(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function Pt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function Bi(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=js(window.location.hash);e(t)};return r(),window.addEventListener(Fi,r),()=>{window.removeEventListener(Fi,r)}}var Pa={};Vs(Pa,{CLASS_NAME_FAILED:()=>ua,CLASS_NAME_HIDDEN:()=>Ys,CLASS_NAME_PENDING:()=>ga,CLASS_NAME_RESOLVED:()=>fa,CheckoutWorkflow:()=>lc,CheckoutWorkflowStep:()=>ne,Commitment:()=>Ge,ERROR_MESSAGE_BAD_REQUEST:()=>va,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>oc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>xa,EVENT_AEM_ERROR:()=>pa,EVENT_AEM_LOAD:()=>ha,EVENT_COMPARE_CHART_REHYDRATE:()=>ic,EVENT_EXPANDED_GROUPS_CHANGE:()=>nc,EVENT_MAS_ERROR:()=>ma,EVENT_MAS_READY:()=>fr,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>rc,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>sa,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>ue,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>la,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Mt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>ca,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>gr,EVENT_MERCH_OFFER_READY:()=>Zs,EVENT_MERCH_OFFER_SELECT_READY:()=>Qs,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ie,EVENT_MERCH_SEARCH_CHANGE:()=>ac,EVENT_MERCH_SIDENAV_SELECT:()=>da,EVENT_MERCH_STOCK_CHANGE:()=>ec,EVENT_MERCH_STORAGE_CHANGE:()=>tc,EVENT_OFFER_SELECTED:()=>Js,EVENT_TYPE_FAILED:()=>ba,EVENT_TYPE_READY:()=>ur,EVENT_TYPE_RESOLVED:()=>ge,Env:()=>ye,FF_ANNUAL_PRICE:()=>it,FF_DEFAULTS:()=>Le,HEADER_X_REQUEST_ID:()=>Rt,LOG_NAMESPACE:()=>ya,Landscape:()=>De,MARK_DURATION_SUFFIX:()=>_a,MARK_START_SUFFIX:()=>ka,MERCH_CARD_LOAD_TIMEOUT:()=>na,MODAL_TYPE_3_IN_1:()=>qe,NAMESPACE:()=>Ws,PARAM_AOS_API_KEY:()=>sc,PARAM_ENV:()=>Ea,PARAM_LANDSCAPE:()=>Sa,PARAM_MAS_PREVIEW:()=>wa,PARAM_WCS_API_KEY:()=>cc,PROVIDER_ENVIRONMENT:()=>Ta,SELECTOR_MAS_CHECKOUT_LINK:()=>Ui,SELECTOR_MAS_ELEMENT:()=>oa,SELECTOR_MAS_INLINE_PRICE:()=>G,SELECTOR_MAS_SP_BUTTON:()=>Ks,SELECTOR_MAS_UPT_LINK:()=>$i,SORT_ORDER:()=>ve,STATE_FAILED:()=>fe,STATE_PENDING:()=>ze,STATE_RESOLVED:()=>_e,SUPPORTED_COUNTRIES:()=>La,TAG_NAME_SERVICE:()=>Xs,TEMPLATE_PRICE:()=>dc,TEMPLATE_PRICE_ANNUAL:()=>pc,TEMPLATE_PRICE_LEGAL:()=>re,TEMPLATE_PRICE_STRIKETHROUGH:()=>hc,TRIAL_ANALYTICS_IDS:()=>Gi,Term:()=>pe,WCS_PROD_URL:()=>Aa,WCS_STAGE_URL:()=>Ca});var Ge=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),pe=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Ws="merch",na=2e4,Ys="hidden",ur="wcms:commerce:ready",Xs="mas-commerce-service",G='span[is="inline-price"][data-wcs-osi]',Ui='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Ks="sp-button[data-wcs-osi]",$i='a[is="upt-link"]',oa=`${G},${Ui},${$i}`,Gi=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]),Zs="merch-offer:ready",Qs="merch-offer-select:ready",sa="merch-card:action-menu-toggle",Js="merch-offer:selected",ec="merch-stock:change",tc="merch-storage:change",ie="merch-quantity-selector:change",gr="merch-card-quantity:change",rc="merch-modal:addon-and-quantity-update",ac="merch-search:change",ca="merch-card-collection:sort",ue="merch-card-collection:literals-changed",Mt="merch-card-collection:sidenav-attached",la="merch-card-collection:showmore",da="merch-sidenav:select",ha="aem:load",pa="aem:error",fr="mas:ready",ma="mas:error",ic="mas-compare-chart:rehydrate",nc="expanded-groups-change",ua="placeholder-failed",ga="placeholder-pending",fa="placeholder-resolved",va="Bad WCS request",xa="Commerce offer not found",oc="Literals URL not provided",ba="mas:failed",ge="mas:resolved",ya="mas/commerce",wa="mas.preview",Ea="commerce.env",Sa="commerce.landscape",sc="commerce.aosKey",cc="commerce.wcsKey",Aa="https://www.adobe.com/web_commerce_artifact",Ca="https://www.stage.adobe.com/web_commerce_artifact_stage",fe="failed",ze="pending",_e="resolved",De={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Rt="X-Request-Id",ne=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),lc="UCv3",ye=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Ta={PRODUCTION:"PRODUCTION"},qe={TWP:"twp",D2P:"d2p",CRM:"crm"},ka=":start",_a=":duration",dc="price",hc="price-strikethrough",pc="annual",re="legal",Le="mas-ff-defaults",it="mas-ff-annual-price",ve={alphabetical:"alphabetical",authored:"authored"},La=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var mc="mas-commerce-service";function qi(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Ot=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function we(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function vr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Ma(){return window.matchMedia("(max-width: 1024px)").matches}function Nt(){return document.getElementsByTagName(mc)?.[0]}function It(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var uc=["adobe.com","adobeioruntime.net","aem.live","aem.page"],gc=["localhost","127.0.0.1"];function Vi(e){try{let r=new URL(e);return gc.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:uc.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as xr,nothing as fc}from"./lit-all.min.js";var nt,zt=class zt{constructor(r){g(this,"card");_(this,nt);this.card=r,this.insertVariantStyle()}getContainer(){return C(this,nt,v(this,nt)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,nt)}insertVariantStyle(){let r=this.constructor.name;if(!zt.styleMap[r]){zt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(h=>h.style.getPropertyValue(l)),p=0,m=o.map(h=>{h.style.removeProperty(l);let u=c(h);if(!u)return u;let f=Math.max(0,parseInt(window.getComputedStyle(u).height)||0);return f>p&&(p=f),u});o.forEach((h,u)=>{m[u]?.tagName!=="HR"&&(p>0?h.style.setProperty(l,`${p}px`):d[u]&&h.style.setProperty(l,d[u]))})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),xr`
            <div
                id="badge"
        ...
        `}get cardImage(){return xr` <div class="image">
            <slot name="bg-image"></slot>
            ${this.badge}
        </div>`}getGlobalCSS(){return""}get theme(){return document.querySelector("sp-theme")}get evergreen(){return this.card.classList.contains("intro-pricing")}get promoBottom(){return this.card.classList.contains("promo-bottom")}get headingSelector(){return'[slot="heading-xs"]'}get secureLabel(){return this.card.secureLabel?xr`<span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              >`:fc}get secureLabelFooter(){return xr`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let r=Promise.allSettled(this.card.prices.map(i=>i.onceSettled?.()||Promise.resolve())),t,a=new Promise(i=>{t=setTimeout(i,na)});await Promise.race([r,a]),clearTimeout(t)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return br(this.card.variant)}};nt=new WeakMap,g(zt,"styleMap",{});var E=zt;import{html as Ra,css as vc}from"./lit-all.min.js";var ji=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Dt,css as xc}from"./lit-all.min.js";var Yi=`
:root {
...
`;var Xi={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},Ve=class extends E{constructor(r){super(r)}getGlobalCSS(){return Yi}renderLayout(){return Dt`<div class="image">
                <slot name="bg-image"></slot>
    ...
    `);import{html as Zi}from"./lit-all.min.js";var Ki=`
:root {
...
`;var yr=class extends E{constructor(r){super(r)}getGlobalCSS(){return Ki}renderLayout(){return Zi` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Zi`<hr />`} ${this.secureLabelFooter}`}};import{html as He,css as bc,unsafeCSS as Ji}from"./lit-all.min.js";var Qi=`
  :root {
...
`;var yc=32,en={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},st=class extends E{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?He`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`:He` <div class="top-section${this.badge?" badge":""}">
                    <slot name="icons"></slot> ${this.badge}
                </div>
                <slot name="heading-m"></slot>
    ...
    `);import{html as wr,css as wc,unsafeCSS as Oa,nothing as Ec}from"./lit-all.min.js";var tn=`
  :root {
...
`;var Sc=32,rn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ee,ct=class extends E{constructor(t){super(t);_(this,Ee);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>wr` <footer>
        ...
        @media screen and ${Oa(T)} {
            :host([variant='mini-compare-chart-mweb']) footer {
                padding: 0;
            }
        }

        @media screen and ${Oa(R)} {
            :host([variant='mini-compare-chart-mweb'])
                .price-wrapping
                > slot[name='subtitle'] {
                min-height: var(
    ...
    `);import{html as Ht,css as Ac,nothing as Er}from"./lit-all.min.js";var an=`
:root {
...
`;var Sr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},nn={...(function(){let{whatsIncluded:e,size:r,...t}=Sr;return t})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},on={...(function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=Sr;return i})()},Se,Ae,oe=class extends E{constructor(t){super(t);_(this,Se);_(this,Ae);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===re&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return an}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(s)){if(o?.classList.toggle("wide-footer",L.isDesktopOrUp),!i&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(i&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);o.prepend(m)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],L.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],L.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,Se)||(C(this,Se,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Se)?.disconnect(),C(this,Se,null),this.syncHeights())})),v(this,Se).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),a.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=It(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=It(p));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+It(m));for(let u of a.childNodes){if(u.classList.contains("spacer"))break;l+=It(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${G}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ht`<div class="divider"></div>`:Er}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${G}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?Ht`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Se=new WeakMap,Ae=new WeakMap,g(oe,"variantStyle",Ac`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),g(oe,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ht`<slot name="resultsText"></slot>`:Er,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let a=()=>{let i=t.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!L.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};L.matchDesktop.addEventListener("change",a),t.addEventListener(ue,a),t.onUnmount.push(()=>{L.matchDesktop.removeEventListener("change",a),t.removeEventListener(ue,a)})}});import{html as Pe,css as Cc,unsafeCSS as cn,nothing as Ar}from"./lit-all.min.js";var sn=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(L.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?L.isMobile?Pe`
        ...
        `:Pe`
            ...
            `:Ar}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?Pe`<slot name="icons"></slot>`:Ar}get secureLabelFooter(){return Pe`<footer>
            ...
            <slot></slot>`}};g(Fe,"variantStyle",Cc`
    ...
    `),g(Fe,"collectionOptions",{customHeaderArea:r=>r.sidenav?Pe`<slot name="resultsText"></slot>`:Ar,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let t=()=>{let a=r.querySelectorAll("merch-card");if(a.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!L.isDesktop)return;let i=0;a.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),i+=s})};L.matchDesktop.addEventListener("change",t),r.addEventListener(ue,t),r.onUnmount.push(()=>{L.matchDesktop.removeEventListener("change",t),r.removeEventListener(ue,t)})}});import{html as Me,css as Tc,nothing as lt,unsafeCSS as Ft}from"./lit-all.min.js";var dn=`
:root {
...
`;var[bp,yp,hn,pn,mn,un]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Tr="pro",Na=`--consonant-merch-card-${Tr}-top-card-height`,Cr=[{prop:`--consonant-merch-card-${Tr}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Tr}-name-description-height`,selector:".name-description"}],gn=`--consonant-merch-card-${Tr}-strike-reserve`,Ia='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',kc="(min-width: 768px)",fn={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Re,je,Gt,qt,W,vn,Bt,xn,Ut,za,kr,_r=class _r extends E{constructor(t){super(t);_(this,W);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);_(this,Re,null);_(this,je,null);_(this,Gt,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);_(this,qt,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of j(this,W,vn).call(this)){let n=i.variantLayout;n instanceof _r&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?j(this,W,za).call(this):j(this,W,Ut).call(this),this.card.requestUpdate()});_(this,kr,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case pn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:j(this,W,Ut).call(this);break;case hn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:j(this,W,Ut).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case mn:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}j(this,W,Ut).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),j(this,W,za).call(this);break;case un:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,j(this,W,Bt).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(ie,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return dn}priceOptionsProvider(t,a){t.dataset.template===re&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(ge,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let a=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=a?.querySelector(".price-plan-type");if(!i)return;i.textContent=t;let n=a.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${G}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=Na,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(kc).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,p)=>{let m=l(p);return m?Math.max(d,parseInt(getComputedStyle(m).height)||0):d},0);for(let c of o.values()){if(c.forEach(m=>this.clearSyncedHeights(m)),c.length<2)continue;let l=c.map(m=>m.querySelector(Ia)&&parseInt(getComputedStyle(m.querySelector(Ia)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((m,h)=>{let u=d-l[h];u>0&&m.style.setProperty(gn,`${u}px`)});for(let m of Cr){let h=s(c,u=>u.shadowRoot?.querySelector(m.selector));h>0&&c.forEach(u=>u.style.setProperty(m.prop,`${h}px`))}let p=s(c,m=>m.shadowRoot?.querySelector(".top-card"));p>0&&c.forEach(m=>m.style.setProperty(i,`${p}px`))}}clearSyncedHeights(t){t.style.removeProperty(Na),t.style.removeProperty(gn),Cr.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(Ia),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(gr,v(this,qt)),this.card.addEventListener(ie,this.updatePriceQuantity),this.card.addEventListener(ge,v(this,Gt)),typeof ResizeObserver>"u"))return;C(this,je,new ResizeObserver(()=>this.resyncOnReflow())),v(this,je).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,je).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ie,this.updatePriceQuantity),this.card?.removeEventListener(ge,v(this,Gt)),j(this,W,Bt).call(this),v(this,je)?.disconnect(),this.card?.removeEventListener(gr,v(this,qt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Me`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Me`
            <div class="license-select" ?data-open=${i}>
                <div
                    ...
                    aria-activedescendant=${i?`license-option-${this.licenseHighlightedIndex}`:lt}
        ...
        `}renderLayout(){let t=!!this.expanded;return Me`
            ...
            <slot></slot>
        `}};Re=new WeakMap,je=new WeakMap,Gt=new WeakMap,qt=new WeakMap,W=new WeakSet,vn=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},Bt=function(){v(this,Re)&&(document.removeEventListener("mousedown",v(this,Re)),C(this,Re,null))},xn=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},Ut=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=j(this,W,xn).call(this),v(this,Re)||(C(this,Re,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),j(this,W,Bt).call(this))}),document.addEventListener("mousedown",v(this,Re)))},za=function(){this.licenseOpen=!1,j(this,W,Bt).call(this)},kr=new WeakMap,g(_r,"variantStyle",Tc`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
        ...
        :host([variant='pro']) .mnemonic {
            ...
            align-items: center;
            gap: 12px;
            min-height: var(${Ft(Cr[0].prop)}, auto);
        }
        ...
        :host([variant='pro']) .name-description {
            ...
            flex: 0 0 auto;
            min-height: var(${Ft(Cr[1].prop)}, auto);
        }
    ...
    `);var $t=_r;import{html as Da,css as _c}from"./lit-all.min.js";var bn=`
:root {
...
`;var yn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ce,dt=class extends E{constructor(t){super(t);_(this,Ce);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return bn}priceOptionsProvider(t,a){t.dataset.template===re&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return Da` ${this.badge}
    ...
    `);import{html as Ha,css as Lc}from"./lit-all.min.js";var wn=`
:root {
...
`;var En={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ht=class extends E{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===re&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return wn}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${G}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return Ha`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Pc,css as Mc}from"./lit-all.min.js";var Sn=`
...
`;var An={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},pt=class extends E{constructor(r){super(r)}getGlobalCSS(){return Sn}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Pc`
    ...
    `);import{html as Fa,css as Rc}from"./lit-all.min.js";var Cn=`
:root {
...
`;var Tn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},mt=class extends E{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Cn}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${G}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Fa`${this.cardImage}
            ...
            ${this.evergreen?Fa`
                  ...
                  `:Fa`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(mt,"variantStyle",Rc`
    ...
    `);import{html as _n,css as Oc}from"./lit-all.min.js";var kn=`
:root {
...
`;var Ba={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ut=class extends E{getGlobalCSS(){return kn}get aemFragmentMapping(){return Ba}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return _n`<div
    ...
    `);import{html as Pn,css as Nc}from"./lit-all.min.js";var Ln=`
:root {
...
`;var Ua={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Vt=class Vt extends E{getGlobalCSS(){return Ln}get aemFragmentMapping(){return Ua}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return Pn`<div
        ...
        >
            ...
            <slot></slot>
        `}};g(Vt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(Vt,"variantStyle",Nc`
    ...
    `);var jt=Vt;import{html as Wt,css as Ic,nothing as Rn}from"./lit-all.min.js";var Mn=`
...
`;var On={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},zc=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],gt=class extends E{constructor(r){super(r)}getGlobalCSS(){return Mn}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return Wt`
    ...
    `);import{css as Dc,html as Hc}from"./lit-all.min.js";var Nn=`
...
`;var In={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},ft=class extends E{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Nn}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${G}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Hc`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Fc,css as Bc}from"./lit-all.min.js";var zn=`
...
`;var $a={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Uc=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Lr,Dn,vt=class extends E{constructor(t){super(t);_(this,Lr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return zn}get aemFragmentMapping(){return $a}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,j(this,Lr,Dn).call(this))}renderLayout(){return Fc`
            <div class="card">
            ...
            <slot></slot>
        `}};Lr=new WeakSet,Dn=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Uc.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(vt,"variantStyle",Bc`
    ...
    `);import{html as $c,css as Gc}from"./lit-all.min.js";var Hn=`
...
`;var Ga={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},xt=class extends E{getGlobalCSS(){return Hn}get aemFragmentMapping(){return Ga}renderLayout(){return $c`
    ...
    `);var Fn=new Map;var q=(e,r,t=null,a=null,i)=>{Fn.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};q("catalog",ot,Wi,ot.variantStyle);q("image",Ve);q("inline-heading",yr);q("mini-compare-chart",st,en,st.variantStyle);q("mini-compare-chart-mweb",ct,rn,ct.variantStyle);q("plans",oe,Sr,oe.variantStyle,oe.collectionOptions);q("plans-students",oe,on,oe.variantStyle,oe.collectionOptions);q("plans-education",oe,nn,oe.variantStyle,oe.collectionOptions);q("plans-v2",Fe,ln,Fe.variantStyle,Fe.collectionOptions);q("pro",$t,fn,$t.variantStyle);q("product",dt,yn,dt.variantStyle);q("segment",ht,En,ht.variantStyle);q("media",pt,An,pt.variantStyle);q("headless",gt,On,gt.variantStyle);q("special-offers",mt,Tn,mt.variantStyle);q("simplified-pricing-express",ut,Ba,ut.variantStyle);q("full-pricing-express",jt,Ua,jt.variantStyle);q("mini",ft,In,ft.variantStyle);q("image",Ve,Xi,Ve.variantStyle);q("compare-chart-column",vt,$a,vt.variantStyle);q("fries",xt,Ga,xt.variantStyle);function br(e){return Fn.get(e)?.fragmentMapping}var Bn="tacocat.js";var qa=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),Un=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function B(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=bt(a)?a:e;n=o.get(s)}if(i&&n==null){let o=bt(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=Vc(bt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var qc=e=>typeof e=="boolean",Pr=e=>typeof e=="function",Mr=e=>typeof e=="number",$n=e=>e!=null&&typeof e=="object";var bt=e=>typeof e=="string",Gn=e=>bt(e)&&e,yt=e=>Mr(e)&&Number.isFinite(e)&&e>0;function Rr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function S(e,r){if(qc(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Yt(e,r,t){let a=Object.values(r);return a.find(i=>qa(i,e))??t??a[0]}function Vc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function qn(e,r=1){return Mr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var jc=Date.now(),Va=()=>`(+${Date.now()-jc}ms)`,Or=new Set,Wc=S(B("tacocat.debug",{},{metadata:!1}),!1);function Vn(e){let r=`[${Bn}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=Wc?(o,...s)=>{console.debug(`${r} ${o}`,...s,Va())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;Or.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;Or.forEach(([,l])=>l(c,...s))}}}function Yc(e,r){let t=[e,r];return Or.add(t),()=>{Or.delete(t)}}Yc((e,...r)=>{console.error(e,...r,Va())},(e,...r)=>{console.warn(e,...r,Va())});var Xc="no promo",jn="promo-tag",Kc="yellow",Zc="neutral",Qc=(e,r,t)=>{let a=n=>n||Xc,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Nr="cancel-context",Ir=(e,r)=>{let t=e===Nr,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?jn:`${jn} no-promo`,text:Qc(o,r,i),variant:n?Kc:Zc,isOverriden:i}};var ja;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(ja||(ja={}));var he;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(he||(he={}));var me;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(me||(me={}));var Wa;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Wa||(Wa={}));var Ya;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(Ya||(Ya={}));var Xa;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(Xa||(Xa={}));var Ka;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Ka||(Ka={}));var Za="ABM",Qa="PUF",Ja="M2M",ei="PERPETUAL",ti="P3Y",Jc="TAX_INCLUSIVE_DETAILS",el="TAX_EXCLUSIVE",Wn={ABM:Za,PUF:Qa,M2M:Ja,PERPETUAL:ei,P3Y:ti},Au={[Za]:{commitment:he.YEAR,term:me.MONTHLY},[Qa]:{commitment:he.YEAR,term:me.ANNUAL},[Ja]:{commitment:he.MONTH,term:me.MONTHLY},[ei]:{commitment:he.PERPETUAL,term:void 0},[ti]:{commitment:he.THREE_MONTHS,term:me.P3Y}},Yn="Value is not an offer",zr=e=>{if(typeof e!="object")return Yn;let{commitment:r,term:t}=e,a=tl(r,t);return{...e,planType:a}};var tl=(e,r)=>{switch(e){case void 0:return Yn;case"":return"";case he.YEAR:return r===me.MONTHLY?Za:r===me.ANNUAL?Qa:"";case he.MONTH:return r===me.MONTHLY?Ja:"";case he.PERPETUAL:return ei;case he.TERM_LICENSE:return r===me.P3Y?ti:"";default:return""}};function Xn(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==Jc)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:el}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var We={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Kn=1e3;function rl(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Zn(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!We.serializableTypes.includes(t))return t}return e}function al(e,r){if(!We.ignoredProperties.includes(e))return Zn(r)}var ri={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(rl(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(Zn).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${We.delimiter}page=${o}${s}`;c.length>Kn&&(c=`${c.slice(0,Kn)}<trunc>`),n+=c,i.length&&(n+=`${We.delimiter}facts=`,n+=JSON.stringify(i,al)),window.lana?.log(n,We)}};function Dr(e){Object.assign(We,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in We&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Qn={LOCAL:"local",PROD:"prod",STAGE:"stage"},ai={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},ii=new Set,ni=new Set,Jn=new Map,eo={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},to={filter:({level:e})=>e!==ai.DEBUG},il={filter:()=>!1};function nl(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&Pr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function ol(e){[...ni].every(r=>r(e))&&ii.forEach(r=>r(e))}function ro(e){let r=(Jn.get(e)??0)+1;Jn.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>ro(`${a.namespace}/${i}`),updateConfig:Dr};return Object.values(ai).forEach(i=>{a[i]=(n,...o)=>ol(nl(i,n,e,o,t))}),Object.seal(a)}function Hr(...e){e.forEach(r=>{let{append:t,filter:a}=r;Pr(a)&&ni.add(a),Pr(t)&&ii.add(t)})}function sl(e={}){let{name:r}=e,t=S(B("commerce.debug",{search:!0,storage:!0}),r===Qn.LOCAL);return Hr(t?eo:to),r===Qn.PROD&&Hr(ri),se}function cl(){ii.clear(),ni.clear()}var se={...ro(ya),Level:ai,Plugins:{consoleAppender:eo,debugFilter:to,quietFilter:il,lanaAppender:ri},init:sl,reset:cl,use:Hr};var ll="mas-commerce-service",dl=se.module("utilities"),hl={requestId:Rt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Xt(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map(Xn)),a}var ao=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function oi(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let p=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?s.priceDetails?.formatString:s[l];m!==p&&dl.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:p,actual:m})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=ao(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=ao(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var Fr=e=>window.setTimeout(e);function wt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(qn).filter(yt);return t.length||(t=[r]),t}function Br(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(Gn)}function Ur(e){return e==null?[]:Array.isArray(e)?e:String(e).split(",").map(r=>r.trim())}function ce(){return document.getElementsByTagName(ll)?.[0]}function io(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(hl)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var Et=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(Rt);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var pl={[fe]:ua,[ze]:ga,[_e]:fa},ml={[fe]:ba,[_e]:ge},Kt,Be=class{constructor(r){_(this,Kt);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",ze);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=se.module("mas-element")}update(){[fe,ze,_e].forEach(r=>{this.wrapperElement.classList.toggle(pl[r],r===this.state)})}notify(){(this.state===_e||this.state===fe)&&(this.state===_e?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===fe&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof Et&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(ml[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){C(this,Kt,ce()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return _e===a?Promise.resolve(this.wrapperElement):fe===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=_e,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Fr(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=fe,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,Kt)?.duration}),Fr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=ze,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!ce()||this.timer)return;let{error:t,options:a,state:i,value:n,version:o}=this;this.state=ze,this.timer=Fr(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===ze&&this.version===o&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};Kt=new WeakMap;function no(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function $r(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,no(r)),i}function oo(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,no(r)),e):null}function ul(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Ke,Ye=class Ye extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new Be(this));_(this,Ke);this.setAttribute("is",Ye.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),C(this,Ke,Nt()),v(this,Ke)&&(this.log=v(this,Ke).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),C(this,Ke,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Nt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=a,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,p=this.getAttribute("data-promotion-code");p&&(d+=`&promotion_code=${encodeURIComponent(p)}`),this.href=`${ul(l)}?${d}`,this.masElement.toggleResolved(i,o,a)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,a),!1}}static createFrom(t){let a=new Ye;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};Ke=new WeakMap,g(Ye,"is","upt-link"),g(Ye,"tag","a"),g(Ye,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Xe=Ye;window.customElements.get(Xe.is)||window.customElements.define(Xe.is,Xe,{extends:Xe.tag});function so(e){return e&&(e==="bizpro"&&(e="pro"),e==="pro"||e.startsWith("plans")?"plans":e)}var gl="p_draft_landscape",fl="/store/",vl=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),si=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),xl=["env","workflowStep","clientId","country"],bl=["/tw/","/hk_zh/"];function yl(e){let r=e??"";return bl.some(t=>r.startsWith(t))}function wl(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(yl)}function ci(e){if(!wl())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var co=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),lo=e=>vl.get(e)??e;function Gr(e,r,t){for(let[a,i]of Object.entries(e)){let n=lo(a);i!=null&&t.has(n)&&r.set(n,i)}}function El(e){return e===Ta.PRODUCTION?"https://commerce.adobe.com":"https://commerce-stg.adobe.com"}function Sl(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let o=lo(i);r.set(`items[${t}][${o}]`,n)}}}function Al({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===qe.CRM?"creative":"mini_plans"),e}function Cl(e){let r=e.indexOf("?");return r===-1?e:e.slice(0,r)}function Tl(e){let r=new URLSearchParams(window.location.search),t={};co.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=Cl(i))}),Object.keys(t).length>0&&Gr(t,e.searchParams,co)}function ho(e){kl(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:p,...m}=e,h=new URL(El(r));if(h.pathname=`${fl}${a}`,a!==ne.SEGMENTATION&&a!==ne.CHANGE_PLAN_TEAM_PLANS&&Sl(t,h.searchParams),Gr({...m},h.searchParams,si),Tl(h),c===De.DRAFT&&Gr({af:gl},h.searchParams,si),a===ne.SEGMENTATION){let u={marketSegment:i,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};p?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):p?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),Gr(u,h.searchParams,si),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=Al({url:h,modal:l,is3in1:d})}return ci(h)}function kl(e){for(let r of xl)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==ne.SEGMENTATION&&e.workflowStep!==ne.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var _l=/[0-9\-+#]/,Ll=/[^\d\-+#]/g;function po(e){return e.search(_l)}function Pl(e="#.##"){let r={},t=e.length,a=po(e);r.prefix=a>0?e.substring(0,a):"";let i=po(e.split("").reverse().join("")),n=t-i,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=i>0?e.substring(s,t):"",r.mask=e.substring(a,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(Ll);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function Ml(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=i.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),i.integer=o,i.fraction=s,Rl(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function Rl(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function Ol(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=Pl(e),i=Ml(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var mo=Ol;var uo=".",Nl=",",fo=/^\s+/,vo=/\s+$/,go="&nbsp;",li=e=>e*12,Qe=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),p=new Date(i);return l>=d&&l<=p},Ze={MONTH:"MONTH",YEAR:"YEAR"},Il={[pe.ANNUAL]:12,[pe.MONTHLY]:1,[pe.THREE_YEARS]:36,[pe.TWO_YEARS]:24},di=(e,r)=>({accept:e,round:r}),zl=[di(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),di(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),di(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],hi={[Ge.YEAR]:{[pe.MONTHLY]:Ze.MONTH,[pe.ANNUAL]:Ze.YEAR},[Ge.MONTH]:{[pe.MONTHLY]:Ze.MONTH}},Dl=(e,r)=>e.indexOf(`'${r}'`)===0,Hl=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=bo(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Bl(e)}`),t},Fl=e=>{let r=Ul(e),t=Dl(e,r),a=e.replace(/'.*?'/,""),i=fo.test(a)||vo.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},xo=e=>e.replace(fo,go).replace(vo,go),Bl=e=>e.match(/#(.?)#/)?.[1]===uo?Nl:uo,Ul=e=>e.match(/'(.*?)'/)?.[1]??"",bo=e=>e.match(/0(.?)0/)?.[1]??"";function St({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1},i,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=Fl(e),l=t?bo(e):"",d=Hl(e,t),p=t?2:0,m=n(r,{currencySymbol:o}),h=a?m.toLocaleString("hi-IN",{minimumFractionDigits:p,maximumFractionDigits:p}):mo(d,m),u=t?h.lastIndexOf(l):h.length,f=h.substring(0,u),x=h.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var yo=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=Il[t]??1;return St(e,i>1?Ze.MONTH:hi[r]?.[t],n=>{let o={divisor:i,price:n,usePrecision:a},{round:s}=zl.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},wo=({commitment:e,term:r,...t})=>St(t,hi[e]?.[r]),Eo=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===Ge.YEAR&&c===pe.MONTHLY){if(!o)return St(e,Ze.YEAR,li);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(Qe(o,t,s)){let p=parseInt(d.replace("P","").replace("M",""));if(isNaN(p))return li(a);let m=i*p,h=n*(12-p),u=Math.round((m+h)*100)/100;return St({...e,price:u},Ze.YEAR)}default:return St(e,Ze.YEAR,()=>li(n??a))}}return St(e,hi[r]?.[c])};var So="download",Ao="upgrade",Co={e:"EDU",t:"TEAM"};function To(e,r={},t=""){let a=ce();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f}=a.collectCheckoutOptions(r),x=$r(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:r.promotionCode===Nr?Nr:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function ko(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new Be(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0].marketSegments?.[0];return Co[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return Co[a]??a}get is3in1Modal(){return Object.values(qe).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=ce();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>Xt(h,n));let d=l.flat().find(h=>h.promotion);!Qe(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let m=await i.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},m,s)}renderOffers(a,i,n={},o=void 0,s=void 0){let c=ce();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(So,Ao),this.masElement.toggleResolved(s,a,i);let{url:d,text:p,className:m,handler:h}=o;d&&this.setCheckoutUrl(ci(d)),p&&(this.firstElementChild.innerHTML=p),m&&this.classList.add(...m.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(a.length){if(this.masElement.toggleResolved(s,a,i)){if(!this.classList.contains(So)&&!this.classList.contains(Ao)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(a){}updateOptions(a={}){let i=ce();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}=i.collectCheckoutOptions(a);return oo(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}),!0}}}var Zt=class Zt extends ko(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return To(Zt,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(Zt,"is","checkout-link"),g(Zt,"tag","a");var Oe=Zt;window.customElements.get(Oe.is)||window.customElements.define(Oe.is,Oe,{extends:Oe.tag});var O=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:ne.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:ye.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:De.PUBLISHED});function _o({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u};if(o)for(let de of r.checkout)de(o,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:y=c,imsCountry:w,country:b=w??l,language:k=d,quantity:I=m,entitlement:z,upgrade:F,modal:Y,perpetual:ae,promotionCode:Q=p,wcsOsi:H,extraOptions:N,...J}=Object.assign(f,o?.dataset??{},n??{}),K=Yt(y,ne,O.checkoutWorkflowStep),ke=Ur(Q).map(de=>Ir(de).effectivePromoCode);return f=Rr({...J,extraOptions:N,checkoutClientId:s,checkoutMarketSegment:x,country:b,quantity:wt(I,O.quantity),checkoutWorkflowStep:K,language:k,entitlement:S(z),upgrade:S(F),modal:Y,perpetual:S(ae),promotionCode:ke[0],promotionCodes:ke,wcsOsi:Br(H),preselectPlan:h}),f}function a(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:p,country:m,promotionCode:h,quantity:u,preselectPlan:f,ms:x,cs:y,...w}=t(o),b=document.querySelector("meta[name=mas-ff-3in1]"),k=Object.values(qe).includes(o.modal)&&(!b||b.content!=="off"),I=window.frameElement||k?"if":"fp",[{productArrangementCode:z,marketSegments:[F],customerSegment:Y,offerType:ae}]=n,Q=x??F??d,H=y??Y;f?.toLowerCase()==="edu"?Q="EDU":f?.toLowerCase()==="team"&&(H="TEAM");let N={is3in1:k,checkoutPromoCode:h,clientId:l,context:I,country:m,env:s,items:[],marketSegment:Q,customerSegment:H,offerType:ae,productArrangementCode:z,workflowStep:p,landscape:c,...w},J=u[0]>1?u[0]:void 0;if(n.length===1){let{offerId:K}=n[0];N.items.push({id:K,quantity:J})}else N.items.push(...n.map(({offerId:K,productArrangementCode:ke})=>({id:K,quantity:J,...k?{productArrangementCode:ke}:{}})));return ho(N)}let{createCheckoutLink:i}=Oe;return{CheckoutLink:Oe,CheckoutWorkflowStep:ne,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}var $l="ims_country_code";function Gl(){if(typeof document>"u")return null;let e=document.cookie.match(new RegExp(`(?:^|;\\s*)${$l}=([^;]*)`));if(!e)return null;let r;try{r=decodeURIComponent(e[1])}catch{return null}return r.trim().toUpperCase()||null}function ql({interval:e=200,maxAttempts:r=25}={}){let t=se.module("ims");return new Promise(a=>{t.debug("Waiting for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function Vl(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function jl(){let e=Gl();return e&&se.module("ims").debug("Got user country from cookie:",e),Promise.resolve(e)}function Lo(){let e=ql();return{imsReadyPromise:e,imsSignedInPromise:Vl(e),imsCountryPromise:jl()}}var Po=window.masPriceLiterals;function Mo(e){if(Array.isArray(Po)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>Po.find(n=>qa(n.lang,i)),a=t(r)??t(O.language);if(a)return Object.freeze(a)}return{}}var pi=function(e,r){return pi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},pi(e,r)};function Qt(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");pi(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var P=function(){return P=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},P.apply(this,arguments)};function qr(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var A;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(A||(A={}));var U;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(U||(U={}));var Je;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Je||(Je={}));function mi(e){return e.type===U.literal}function Ro(e){return e.type===U.argument}function Vr(e){return e.type===U.number}function jr(e){return e.type===U.date}function Wr(e){return e.type===U.time}function Yr(e){return e.type===U.select}function Xr(e){return e.type===U.plural}function Oo(e){return e.type===U.pound}function Kr(e){return e.type===U.tag}function Zr(e){return!!(e&&typeof e=="object"&&e.type===Je.number)}function Jt(e){return!!(e&&typeof e=="object"&&e.type===Je.dateTime)}var ui=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var Wl=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function No(e){var r={};return e.replace(Wl,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var Io=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Fo(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(Io).filter(function(m){return m.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var p=d[l];if(p.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function Yl(e){return e.replace(/^(.*?)-/,"")}var zo=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Bo=/^(@+)?(\+|#+)?[rs]?$/g,Xl=/(\*)(0+)|(#+)(0+)|(0+)/g,Uo=/^(0+)$/;function Do(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(Bo,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function $o(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Kl(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!Uo.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function Ho(e){var r={},t=$o(e);return t||r}function Go(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=Yl(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=P(P(P({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return P(P({},c),Ho(l))},{}));continue;case"engineering":r=P(P(P({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return P(P({},c),Ho(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(Xl,function(c,l,d,p,m,h){if(l)r.minimumIntegerDigits=d.length;else{if(p&&m)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Uo.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(zo.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(zo,function(c,l,d,p,m,h){return d==="*"?r.minimumFractionDigits=l.length:p&&p[0]==="#"?r.maximumFractionDigits=p.length:m&&h?(r.minimumFractionDigits=m.length,r.maximumFractionDigits=m.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=P(P({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=P(P({},r),Do(n)));continue}if(Bo.test(i.stem)){r=P(P({},r),Do(i.stem));continue}var o=$o(i.stem);o&&(r=P(P({},r),o));var s=Kl(i.stem);s&&(r=P(P({},r),s))}return r}var er={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function qo(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=Zl(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function Zl(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=er[a||""]||er[t||""]||er["".concat(t,"-001")]||er["001"];return i[0]}var gi,Ql=new RegExp("^".concat(ui.source,"*")),Jl=new RegExp("".concat(ui.source,"*$"));function M(e,r){return{start:e,end:r}}var ed=!!String.prototype.startsWith,td=!!String.fromCodePoint,rd=!!Object.fromEntries,ad=!!String.prototype.codePointAt,id=!!String.prototype.trimStart,nd=!!String.prototype.trimEnd,od=!!Number.isSafeInteger,sd=od?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},vi=!0;try{Vo=Xo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),vi=((gi=Vo.exec("a"))===null||gi===void 0?void 0:gi[0])==="a"}catch{vi=!1}var Vo,jo=ed?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},xi=td?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,o;i>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");a+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return a},Wo=rd?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],o=n[0],s=n[1];t[o]=s}return t},Yo=ad?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},cd=id?function(r){return r.trimStart()}:function(r){return r.replace(Ql,"")},ld=nd?function(r){return r.trimEnd()}:function(r){return r.replace(Jl,"")};function Xo(e,r){return new RegExp(e,r)}var bi;vi?(fi=Xo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),bi=function(r,t){var a;fi.lastIndex=t;var i=fi.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):bi=function(r,t){for(var a=[];;){var i=Yo(r,t);if(i===void 0||Zo(i)||pd(i))break;a.push(i),t+=i>=65536?2:1}return xi.apply(void 0,a)};var fi,Ko=(function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,a);if(o.err)return o;i.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:U.pound,location:M(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(A.UNMATCHED_CLOSING_TAG,M(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&yi(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;i.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;i.push(o.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:U.literal,value:"<".concat(i,"/>"),location:M(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!yi(this.char()))return this.error(A.INVALID_TAG,M(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(A.UNMATCHED_CLOSING_TAG,M(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:U.tag,value:i,children:o,location:M(a,this.clonePosition())},err:null}:this.error(A.INVALID_TAG,M(s,this.clonePosition())))}else return this.error(A.UNCLOSED_TAG,M(a,this.clonePosition()))}else return this.error(A.INVALID_TAG,M(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&hd(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){i+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=M(a,this.clonePosition());return{val:{type:U.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!dd(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return xi.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),xi(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(A.EMPTY_ARGUMENT,M(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(A.MALFORMED_ARGUMENT,M(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:U.argument,value:i,location:M(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(A.MALFORMED_ARGUMENT,M(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=bi(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),o=M(r,n);return{value:a,location:o}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(A.EXPECT_ARGUMENT_TYPE,M(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),p=this.parseSimpleArgStyleIfPossible();if(p.err)return p;var m=ld(p.val);if(m.length===0)return this.error(A.EXPECT_ARGUMENT_STYLE,M(this.clonePosition(),this.clonePosition()));var h=M(d,this.clonePosition());l={style:m,styleLocation:h}}var u=this.tryParseArgumentClose(i);if(u.err)return u;var f=M(i,this.clonePosition());if(l&&jo(l?.style,"::",0)){var x=cd(l.style.slice(2));if(s==="number"){var p=this.parseNumberSkeletonFromString(x,l.styleLocation);return p.err?p:{val:{type:U.number,value:a,location:f,style:p.val},err:null}}else{if(x.length===0)return this.error(A.EXPECT_DATE_TIME_SKELETON,f);var y=x;this.locale&&(y=qo(x,this.locale));var m={type:Je.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?No(y):{}},w=s==="date"?U.date:U.time;return{val:{type:w,value:a,location:f,style:m},err:null}}}return{val:{type:s==="number"?U.number:s==="date"?U.date:U.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(A.EXPECT_SELECT_ARGUMENT_OPTIONS,M(b,P({},b)));this.bumpSpace();var k=this.parseIdentifierIfPossible(),I=0;if(s!=="select"&&k.value==="offset"){if(!this.bumpIf(":"))return this.error(A.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,M(this.clonePosition(),this.clonePosition()));this.bumpSpace();var p=this.tryParseDecimalInteger(A.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,A.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(p.err)return p;this.bumpSpace(),k=this.parseIdentifierIfPossible(),I=p.val}var z=this.tryParsePluralOrSelectOptions(r,s,t,k);if(z.err)return z;var u=this.tryParseArgumentClose(i);if(u.err)return u;var F=M(i,this.clonePosition());return s==="select"?{val:{type:U.select,value:a,options:Wo(z.val),location:F},err:null}:{val:{type:U.plural,value:a,options:Wo(z.val),offset:I,pluralType:s==="plural"?"cardinal":"ordinal",location:F},err:null}}default:return this.error(A.INVALID_ARGUMENT_TYPE,M(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,M(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(A.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,M(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=Fo(r)}catch{return this.error(A.INVALID_NUMBER_SKELETON,t)}return{val:{type:Je.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?Go(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,o=!1,s=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var p=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var m=this.tryParseDecimalInteger(A.EXPECT_PLURAL_ARGUMENT_SELECTOR,A.INVALID_PLURAL_ARGUMENT_SELECTOR);if(m.err)return m;d=M(p,this.clonePosition()),l=this.message.slice(p.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?A.DUPLICATE_SELECT_ARGUMENT_SELECTOR:A.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?A.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:A.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,M(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(r+1,t,a);if(u.err)return u;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:u.val,location:M(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?A.EXPECT_SELECT_ARGUMENT_SELECTOR:A.EXPECT_PLURAL_ARGUMENT_SELECTOR,M(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(A.MISSING_OTHER_CLAUSE,M(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=M(i,this.clonePosition());return n?(o*=a,sd(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=Yo(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(jo(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Zo(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e})();function yi(e){return e>=97&&e<=122||e>=65&&e<=90}function dd(e){return yi(e)||e===47}function hd(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Zo(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function pd(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function wi(e){e.forEach(function(r){if(delete r.location,Yr(r)||Xr(r))for(var t in r.options)delete r.options[t].location,wi(r.options[t].value);else Vr(r)&&Zr(r.style)||(jr(r)||Wr(r))&&Jt(r.style)?delete r.style.location:Kr(r)&&wi(r.children)})}function Qo(e,r){r===void 0&&(r={}),r=P({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new Ko(e,r).parse();if(t.err){var a=SyntaxError(A[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||wi(t.val),t.val}function tr(e,r){var t=r&&r.cache?r.cache:xd,a=r&&r.serializer?r.serializer:vd,i=r&&r.strategy?r.strategy:ud;return i(e,{cache:t,serializer:a})}function md(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Jo(e,r,t,a){var i=md(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function es(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function Ei(e,r,t,a,i){return t.bind(r,e,a,i)}function ud(e,r){var t=e.length===1?Jo:es;return Ei(e,this,t,r.cache.create(),r.serializer)}function gd(e,r){return Ei(e,this,es,r.cache.create(),r.serializer)}function fd(e,r){return Ei(e,this,Jo,r.cache.create(),r.serializer)}var vd=function(){return JSON.stringify(arguments)};function Si(){this.cache=Object.create(null)}Si.prototype.get=function(e){return this.cache[e]};Si.prototype.set=function(e,r){this.cache[e]=r};var xd={create:function(){return new Si}},Qr={variadic:gd,monadic:fd};var et;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(et||(et={}));var rr=(function(e){Qt(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r})(Error);var Ai=(function(e){Qt(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),et.INVALID_VALUE,n)||this}return r})(rr);var ts=(function(e){Qt(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),et.INVALID_VALUE,i)||this}return r})(rr);var rs=(function(e){Qt(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),et.MISSING_VALUE,a)||this}return r})(rr);var ee;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(ee||(ee={}));function bd(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==ee.literal||t.type!==ee.literal?r.push(t):a.value+=t.value,r},[])}function yd(e){return typeof e=="function"}function ar(e,r,t,a,i,n,o){if(e.length===1&&mi(e[0]))return[{type:ee.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(mi(d)){s.push({type:ee.literal,value:d.value});continue}if(Oo(d)){typeof n=="number"&&s.push({type:ee.literal,value:t.getNumberFormat(r).format(n)});continue}var p=d.value;if(!(i&&p in i))throw new rs(p,o);var m=i[p];if(Ro(d)){(!m||typeof m=="string"||typeof m=="number")&&(m=typeof m=="string"||typeof m=="number"?String(m):""),s.push({type:typeof m=="string"?ee.literal:ee.object,value:m});continue}if(jr(d)){var h=typeof d.style=="string"?a.date[d.style]:Jt(d.style)?d.style.parsedOptions:void 0;s.push({type:ee.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(Wr(d)){var h=typeof d.style=="string"?a.time[d.style]:Jt(d.style)?d.style.parsedOptions:a.time.medium;s.push({type:ee.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(Vr(d)){var h=typeof d.style=="string"?a.number[d.style]:Zr(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(m=m*(h.scale||1)),s.push({type:ee.literal,value:t.getNumberFormat(r,h).format(m)});continue}if(Kr(d)){var u=d.children,f=d.value,x=i[f];if(!yd(x))throw new ts(f,"function",o);var y=ar(u,r,t,a,i,n),w=x(y.map(function(I){return I.value}));Array.isArray(w)||(w=[w]),s.push.apply(s,w.map(function(I){return{type:typeof I=="string"?ee.literal:ee.object,value:I}}))}if(Yr(d)){var b=d.options[m]||d.options.other;if(!b)throw new Ai(d.value,m,Object.keys(d.options),o);s.push.apply(s,ar(b.value,r,t,a,i));continue}if(Xr(d)){var b=d.options["=".concat(m)];if(!b){if(!Intl.PluralRules)throw new rr(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,et.MISSING_INTL_API,o);var k=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[k]||d.options.other}if(!b)throw new Ai(d.value,m,Object.keys(d.options),o);s.push.apply(s,ar(b.value,r,t,a,i,m-(d.offset||0)));continue}}return bd(s)}function wd(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=P(P({},e[a]),r[a]||{}),t},{})):e}function Ed(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=wd(e[a],r[a]),t},P({},e)):e}function Ci(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function Sd(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:tr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,qr([void 0],t,!1)))},{cache:Ci(e.number),strategy:Qr.variadic}),getDateTimeFormat:tr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,qr([void 0],t,!1)))},{cache:Ci(e.dateTime),strategy:Qr.variadic}),getPluralRules:tr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,qr([void 0],t,!1)))},{cache:Ci(e.pluralRules),strategy:Qr.variadic})}}var as=(function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==ee.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return ar(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Ed(e.formats,a),this.formatters=i&&i.formatters||Sd(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Qo,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e})();var is=as;var ir={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}",discountLabel:"{discount}%"},Ad=Vn("ConsonantTemplates/price"),Cd=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Te={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ti="TAX_EXCLUSIVE",Td=e=>$n(e)?Object.entries(e).filter(([,r])=>bt(r)||Mr(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Un(a)}"`}`,""):"",V=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${Td(t)}>${a?xo(r):r??""}</span>`;function kd(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function _d(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function xe(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?kd(i):i,i=n?i.replace(Cd,""):i;let s=new is(i,r).format(a);return o?_d(s):s}catch{return Ad.error("Failed to format literal:",i),""}}function Ld(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=V($.currencySymbol,a),u=V($.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=V($.integer,s),f+=V($.decimalsDelimiter,n),f+=V($.decimals,i),c||(f+=u+h),f+=V($.recurrence,l,null,!0),f+=V($.unitType,d,null,!0),f+=V($.taxInclusivity,p,!0),V(e,f,{...m})}var Z=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:w,price:b,priceWithoutDiscount:k,taxDisplay:I,taxTerm:z,term:F,usePrecision:Y,promotion:ae}={},Q={})=>{Object.entries({country:o,formatString:w,language:p,price:b}).forEach(([$s,Gs])=>{if(Gs==null)throw new Error(`Argument "${$s}" is missing for osi ${y?.toString()}, country ${o}, language ${p}`)});let H={...ir,...m},N=`${p.toLowerCase()}-${o.toUpperCase()}`,J;ae&&!f&&k?J=e||a?b:k:t&&k?J=k:J=b;let K=r?yo:wo;i&&(K=Eo);let{accessiblePrice:ke,recurrenceTerm:de,...ta}=K({commitment:x,formatString:w,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:k,price:r?b:J,promotion:ae,quantity:h,term:F,usePrecision:Y}),dr="",ra="",aa="";S(c)&&de&&(aa=xe(H,N,Te.recurrenceLabel,{recurrenceTerm:de}));let hr="";S(l)&&(u&&(hr+=" "),hr+=xe(H,N,Te.perUnitLabel,{perUnit:"LICENSE"}));let pr="";S(d)&&z&&(u&&(pr+=" "),pr+=xe(H,N,I===Ti?Te.taxExclusiveLabel:Te.taxInclusiveLabel,{taxTerm:z})),t&&(dr=xe(H,N,Te.strikethroughAriaLabel,{strikethroughPrice:dr})),e&&(ra=xe(H,N,Te.alternativePriceAriaLabel,{alternativePrice:ra}));let $e=$.container;if(r&&($e+=` ${$.containerOptical}`),t&&($e+=` ${$.containerStrikethrough}`),a&&($e+=` ${$.containerPromoStrikethrough}`),e&&($e+=` ${$.containerAlternative}`),i&&($e+=` ${$.containerAnnual}`),S(s))return Ld($e,{...ta,accessibleLabel:dr,altAccessibleLabel:ra,recurrenceLabel:aa,perUnitLabel:hr,taxInclusivityLabel:pr},Q);let{currencySymbol:Ni,decimals:Ds,decimalsDelimiter:Hs,hasCurrencySpace:Ii,integer:Fs,isCurrencyFirst:Bs}=ta,at=[Fs,Hs,Ds];Bs?(at.unshift(Ii?"\xA0":""),at.unshift(Ni)):(at.push(Ii?"\xA0":""),at.push(Ni)),at.push(aa,hr,pr);let Us=at.join("");return V($e,Us,Q)},ns=()=>(e,r,t)=>{let a=Qe(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||S(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${Z({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${Z({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},os=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=Qe(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return Z()(e,{...r,price:r.priceWithoutDiscount},t)+V($.containerAnnualPrefix," (")+Z({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+V($.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||S(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${Z({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${Z({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${V($.containerAnnualPrefix," (")}${Z({displayAnnual:!0,instant:a})(n,r,t)}${V($.containerAnnualSuffix,")")}`},ss=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${Z({isAlternativePrice:e.displayOldPrice})(e,r,t)}${V($.containerAnnualPrefix," (")}${Z({displayAnnual:!0})(a,r,t)}${V($.containerAnnualSuffix,")")}`};var nr={...$,containerLegal:"price-legal",planType:"price-plan-type"},Jr={...Te,planTypeLabel:"planTypeLabel"};function Pd(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=V(nr.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=V(nr.taxInclusivity,t,!0),o+=V(nr.planType,a,null),V(e,o,{...i})}var cs=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,language:n,literals:o={}}={},{taxDisplay:s,taxTerm:c,planType:l}={},d={})=>{let p={...ir,...o},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";S(r)&&(h=xe(p,m,Jr.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),S(t)&&c&&(u=xe(p,m,s===Ti?Jr.taxExclusiveLabel:Jr.taxInclusiveLabel,{taxTerm:c}));let f="";S(a)&&l&&(f=xe(p,m,Jr.planTypeLabel,{planType:l}));let x=nr.container;return x+=` ${nr.containerLegal}`,Pd(x,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,i)};var ls=Z(),ds=ns(),hs=Z({displayOptical:!0}),ps=Z({displayStrikethrough:!0}),ms=Z({displayPromoStrikethrough:!0}),us=Z({displayAnnual:!0}),gs=Z({displayOptical:!0,isAlternativePrice:!0}),fs=Z({isAlternativePrice:!0}),vs=ss(),xs=os(),bs=cs;var Md={...Te,discountLabel:"discountLabel"},Rd=(e,r)=>{if(!r&&yt(e))return 0;if(!(!yt(e)||!yt(r)))return Math.floor((r-e)/r*100)},ys=()=>(e,r)=>{let{country:t,language:a,literals:i={}}=e??{},{price:n,priceWithoutDiscount:o}=r,s=Rd(n,o);if(s===void 0)return'<span class="no-discount"></span>';let c={...ir,...i},l=a&&t?`${a.toLowerCase()}-${t.toUpperCase()}`:"en-US";return`<span class="discount">${xe(c,l,Md.discountLabel,{discount:s,remainingPercent:100-s})}</span>`};var ws=ys();var Es="INDIVIDUAL_COM",_i="TEAM_COM",Ss="INDIVIDUAL_EDU",Li="TEAM_EDU",Od=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],Nd={[Es]:[],[_i]:[],[Ss]:[],[Li]:[]},Id={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},zd=[Es,_i,Ss,Li],Dd=e=>[_i,Li].includes(e);function ki(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Hd=(e,r,t,a)=>{let i=`${t}_${a}`,n=ki(Id,e,r,!1);if(n){let o=zd.indexOf(i);return n[o]}return Dd(i)},Fd=(e,r,t,a)=>{if(ki(Od,e,r,!0))return!0;let i=Nd[`${t}_${a}`];return i?ki(i,e,r,!0)?!0:O.displayTax:O.displayTax},Pi=async(e,r,t,a)=>{let i=Fd(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Hd(e,r,t,a):O.forceTaxExclusive}},or=class or extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Be(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=ce();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=a.collectPriceOptions(t);return $r(or,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===fe}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=ce();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let u=Xt(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=oi(l);if(a.featureFlags[Le]||n[Le]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,x=await Pi(h,u,p.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let w=Xt(y,n);return w?.length?w[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[it]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=oi(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=ce();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(or,"is","inline-price"),g(or,"tag","span");var Ne=or;window.customElements.get(Ne.is)||window.customElements.define(Ne.is,Ne,{extends:Ne.tag});function As({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let F of r.price)F(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:y,quantity:w,alternativePrice:b,wcsOsi:k,...I}=Object.assign(c,s?.dataset??{},o??{}),z=Ur(y).map(F=>Ir(F).effectivePromoCode);return c=Rr(Object.assign({...c,...I,displayOldPrice:S(l),displayPerUnit:S(d),displayRecurrence:S(p),displayTax:S(m),displayPlanType:S(h),forceTaxExclusive:S(u),perpetual:S(f),displayAnnual:S(x),promotionCode:z[0],promotionCodes:z,quantity:wt(w,O.quantity),alternativePrice:S(b),wcsOsi:Br(k)})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=ws;break;case"strikethrough":l=ps;break;case"promo-strikethrough":l=ms;break;case"annual":l=us;break;case"legal":l=bs;break;default:s.template==="optical"&&s.alternativePrice?l=gs:s.template==="optical"?l=hs:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?xs:vs:s.alternativePrice?l=fs:l=s.promotionCode&&o[0].promotion?ds:ls}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Ne.createInlinePrice;return{InlinePrice:Ne,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Bd({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||O.language),r??(r=e?.split("_")?.[1]||O.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function Cs(e={},r){let t=r.featureFlags[Le],{commerce:a={}}=e,i=ye.PRODUCTION,n=Aa,o=B("checkoutClientId",a)??O.checkoutClientId,s=Yt(B("checkoutWorkflowStep",a),ne,O.checkoutWorkflowStep),c=S(B("displayOldPrice",a),O.displayOldPrice),l=O.displayPerUnit,d=S(B("displayRecurrence",a),O.displayRecurrence),p=S(B("displayTax",a),O.displayTax),m=S(B("displayPlanType",a),O.displayPlanType),h=S(B("entitlement",a),O.entitlement),u=S(B("modal",a),O.modal),f=S(B("forceTaxExclusive",a),O.forceTaxExclusive),x=B("promotionCode",a)??O.promotionCode,y=wt(B("quantity",a)),w=B("wcsApiKey",a)??O.wcsApiKey,b=a?.env==="stage",k=De.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(B(Ea,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",k=Yt(B(Sa,a),De,k)),b&&(i=ye.STAGE,n=Ca);let z=B(wa)??e.preview,F=typeof z<"u"&&z!=="off"&&z!=="false",Y={};F&&(Y={preview:F});let ae=B("mas-io-url")??e.masIOUrl,Q=Vi(ae)?ae:`https://www${i===ye.STAGE?".stage":""}.adobe.com/mas/io`,H=B("preselect-plan")??void 0,N=B("instant")??e.instant;return{...Bd(e),...Y,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:O.extraOptions,modal:u,env:i,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:O.alternativePrice,wcsApiKey:w,wcsURL:n,landscape:k,masIOUrl:Q,...H&&{preselectPlan:H},...N&&{instant:N}}}async function Ts(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var Mi="wcs";function ks({settings:e}){let r=se.module(Mi),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(u,f,x=!0){let y=ce(),w=xa;r.debug("Fetching:",u);let b="",k;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let I=new Map(f),[z]=u.offerSelectorIds,F=Date.now()+Math.random().toString(36).substring(2,7),Y=`${Mi}:${z}:${F}${ka}`,ae=`${Mi}:${z}:${F}${_a}`,Q;try{if(performance.mark(Y),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",z),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===ye.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),k=await Ts(b.toString(),{credentials:"omit"}),k.ok){let H=[];try{let N=await k.json();r.debug("Fetched:",u,N),H=N.resolvedOffers??[]}catch(N){r.error(`Error parsing JSON: ${N.message}`,{...N.context,...y?.duration})}H=H.map(zr),f.forEach(({resolve:N},J)=>{let K=H.filter(({offerSelectorIds:ke})=>ke.includes(J)).flat();K.length&&(I.delete(J),f.delete(J),N(K))})}else w=va}catch(H){w=`Network error: ${H.message}`}finally{Q=performance.measure(ae,Y),performance.clearMarks(Y),performance.clearMeasures(ae)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let H=io(k);f.forEach(N=>{N.reject(new Et(w,{...u,...H,response:k,measure:vr(Q),...y?.duration}))})}}function l(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ye.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,w]of Object.entries(x))i.set(y,Promise.resolve(w.map(zr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let u=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,x){let y=u!=="GB"&&!x?"MULT":"en",w=La.includes(u)?u:O.country;return{validCountry:w,validLanguage:y,locale:`${f}_${w}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:y="",promotionCodes:w,wcsOsi:b=[]}){let{validCountry:k,validLanguage:I,locale:z}=m(u,f,x),F=Array.isArray(w)&&w.length?w:[y];return b.map((Y,ae)=>{let Q=F.length===1?F[0]:F[ae]??"",H=[k,I,Q].filter(K=>K).join("-").toLowerCase(),N=`${Y}-${H}`;if(i.has(N))return i.get(N);let J=new Promise((K,ke)=>{let de=n.get(H);de||(de={options:{country:k,locale:z,...I==="MULT"&&{language:I},offerSelectorIds:[]},promises:new Map},n.set(H,de)),Q&&(de.options.promotionCode=Q),de.options.offerSelectorIds.push(Y),de.promises.set(Y,{resolve:K,reject:ke}),l()}).catch(K=>{if(s.has(N))return s.get(N);throw K});return i.set(N,J),J})}return{Commitment:Ge,PlanType:Wn,Term:pe,applyPlanType:zr,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var _s="mas-commerce-service",Ls="mas-commerce-service:start",Ps="mas-commerce-service:ready",sr,At,tt,Ms,Oi,Ri=class extends HTMLElement{constructor(){super(...arguments);_(this,tt);_(this,sr);_(this,At);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,At)||C(this,At,{[Le]:j(this,tt,Oi).call(this,Le),[it]:j(this,tt,Oi).call(this,it)}),v(this,At)}activate(){let t=v(this,tt,Ms),a=Cs(t,this);Dr(t.lana);let i=se.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:Mo(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({..._o(c),...Lo(c),...As(c),...ks(c),...Pa,Log:se,resolvePriceTaxFlags:Pi,get defaults(){return O},get log(){return se},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(ur,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ps),C(this,sr,performance.measure(Ps,Ls)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Ls),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(oa).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":vr(v(this,sr))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};sr=new WeakMap,At=new WeakMap,tt=new WeakSet,Ms=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},Oi=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||B(t))};window.customElements.get(_s)||window.customElements.define(_s,Ri);var Is="merch-card-collection",Ud=3e4,$d={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Gd={plans:!0},qd=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Vd=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,jd=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Wd=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),Yd=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Ue,Tt,rt,lr,ea,zs,Ct=class extends Os{constructor(){super();_(this,ea);_(this,Ue,{});_(this,Tt);_(this,rt);_(this,lr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=qi(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Ie` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a=new Promise(i=>setTimeout(()=>i(!1),Ud));return Promise.race([this.hydrationReady,a])}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===ve.alphabetical?jd:Wd,s=[qd,Vd,Yd,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(da,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(ue,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){C(this,Ue,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,Ue)[a]=i)})}connectedCallback(){super.connectedCallback(),C(this,Tt,Nt()),v(this,Tt)&&C(this,rt,v(this,Tt).Log.module(Is)),C(this,lr,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",a),o.setAttribute("placeholder",""),o.innerHTML=i,this.append(o)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Gd[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Mt));let i=v(this,lr)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(s=>{a=s});let i=this;function n(s){let c;return s.fields?.checkboxGroups?c=s.fields.checkboxGroups:s.fields?.tagFilters&&(c=[{title:s.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:s.fields.tagFilters.map(l=>{let d=l.split("/").pop(),p=s.settings?.tagLabels?.[d]||d;return p=p.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):p,{name:d,label:p}})}]),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(p,m){for(let h of m){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){v(i,rt)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let u=s.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)u=b,f=b.referencesTree,s.references={...s.references,...b.references};else{v(i,rt)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!u?.fields)continue;let{fields:y}=u,w={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(b=>c[b]||b):[],collections:[]};y.defaultchild&&(w.defaultchild=c[y.defaultchild]||y.defaultchild),p.push(w),d(w.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(pa,s=>{j(this,ea,zs).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(ha,async s=>{this.limit=27,this.data=o(s.detail,v(this,Ue)),s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?v(this,Ue)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let p=(u,f)=>{for(let x of u)if(x.defaultchild===f||x.collections&&p(x.collections,f))return!0;return!1};for(let u of c){let b=function(I){for(let z of I){let F=z.cards.indexOf(x);if(F===-1)continue;let Y=z.queryLabel??z?.label?.toLowerCase()??"";f.filters[Y]={order:F+1,size:u.fields.size},b(z.collections)}},f=document.createElement("merch-card"),x=v(this,Ue)[u.id]||u.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=u.fields.tags?.filter(I=>I.startsWith("mas:types/")).map(I=>I.split("/")[1]).join(",");y&&f.setAttribute("types",y),br(u.fields.variant)?.supportsDefaultChild&&(d?x===d:p(l,x))&&f.setAttribute("data-default-card","true"),b(l);let k=document.createElement("aem-fragment");k.setAttribute("fragment",x),f.append(k),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(u)+1,size:u.fields.size}}),this.append(f)}let m="",h=so(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(u=>u.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?m=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(m=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...$d[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Ie`<div id="footer">
        ...
        </sp-button>`}sortChanged(t){t.target.value===ve.authored?Pt({sort:void 0}):Pt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(ca,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(la,{bubbles:!0,composed:!0}));let t=this.page+1;Pt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=Bi(({category:t,filter:a,types:i,sort:n,search:o,single_app:s,page:c})=>{a=a||t,!this.filtered&&a&&a!==this.filter&&setTimeout(()=>{Pt({page:void 0}),this.page=1},1),this.filtered||(this.filter=a??this.filter),this.types=i??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(c)||1})}openFilters(t){this.sidenav?.showModal(t)}};Ue=new WeakMap,Tt=new WeakMap,rt=new WeakMap,lr=new WeakMap,ea=new WeakSet,zs=function(t,a={},i=!0){v(this,rt)?.error(`merch-card-collection: ${t}`,a),this.failed=!0,i&&this.dispatchEvent(new CustomEvent(ma,{detail:{...a,message:t},bubbles:!0,composed:!0}))},g(Ct,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:ve.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(Ct,"styles",Ns`
        #footer {
            grid-column: 1 / -1;
    ...
    `);Ct.SortOrder=ve;customElements.define(Is,Ct);var Xd={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},Kd=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(i=>{i.innerText=t||""})},Zd={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},Qd={catalog:"l"},le,kt,cr=class extends Os{constructor(){super();_(this,le);_(this,kt);g(this,"tablet",new Lt(this,R));g(this,"desktop",new Lt(this,T));this.collection=null,C(this,le,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(ue,this.updateLiterals),this.collection?.addEventListener(Mt,this.handleSidenavAttached),C(this,kt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(ue,this.updateLiterals),this.collection?.removeEventListener(Mt,this.handleSidenavAttached)}willUpdate(){v(this,le).search=this.getVisibility("search"),v(this,le).filter=this.getVisibility("filter"),v(this,le).sort=this.getVisibility("sort"),v(this,le).result=this.getVisibility("result"),v(this,le).custom=this.getVisibility("custom")}parseVisibilityOptions(t,a){if(!t||!Object.hasOwn(t,a))return null;let i=t[a];return i===!1?!1:i===!0?!0:i.includes(this.currentMedia)}getVisibility(t){let a=v(this,kt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,i=this.parseVisibilityOptions(a,t);return i!==null?i:this.parseVisibilityOptions(Zd,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,le).search)return be;let t=Ot(this,"searchText");return t?Ie`
        ...
        `:be}get filterAction(){return v(this,le).filter?this.sidenav?Ie`
            <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
            ...
            ></sp-action-button>
        `:be:be}get sortAction(){if(!v(this,le).sort)return be;let t=Ot(this,"sortText");if(!t)return;let a=Ot(this,"popularityText"),i=Ot(this,"alphabeticallyText");if(!(a&&i))return;let n=this.collection?.sort===ve.alphabetical;return Ie`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        </div>`}get customArea(){if(!v(this,le).custom)return be;let t=v(this,kt)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return be;let a=t(this.collection);return!a||a===be?be:Ie`<div id="custom" role="heading" aria-level="2">
            ${a}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(a=>{Kd(this,a,t.detail[a])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return Ie`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};le=new WeakMap,kt=new WeakMap,g(cr,"styles",Ns`
        :host {
    ...
    `);customElements.define("merch-card-collection-header",cr);export{Ct as MerchCardCollection,cr as default};

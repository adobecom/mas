var na=Object.defineProperty;var oa=e=>{throw TypeError(e)};var Qo=(e,r,t)=>r in e?na(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Jo=(e,r)=>{for(var t in r)na(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Qo(e,typeof r!="symbol"?r+"":r,t),_r=(e,r,t)=>r.has(e)||oa("Cannot "+t);var y=(e,r,t)=>(_r(e,r,"read from private field"),t?t.call(e):r.get(e)),q=(e,r,t)=>r.has(e)?oa("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),U=(e,r,t,i)=>(_r(e,r,"write to private field"),i?i.call(e,t):r.set(e,t),t),ft=(e,r,t)=>(_r(e,r,"access private method"),t);import{html as Se,LitElement as Uo,css as $o,unsafeCSS as Fo,nothing as me}from"./lit-all.min.js";var O="(max-width: 767px)",X="(max-width: 1199px)",I="(min-width: 768px)",T="(min-width: 1200px)",Z="(min-width: 1600px)",sa={matchMobile:window.matchMedia(O),matchDesktop:window.matchMedia(`${T} and (not ${Z})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(Z),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},C=sa;function Vt(){return sa.isDesktop}var vt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var ca="hashchange";function es(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let i of t){let[a,n=""]=i.split("=");a&&r.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function xt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([a,n])=>{n?r.set(a,n):r.delete(a)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,i)}function la(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=es(window.location.hash);e(t)};return r(),window.addEventListener(ca,r),()=>{window.removeEventListener(ca,r)}}var ei={};Jo(ei,{CLASS_NAME_FAILED:()=>Hr,CLASS_NAME_HIDDEN:()=>rs,CLASS_NAME_PENDING:()=>zr,CLASS_NAME_RESOLVED:()=>Br,CheckoutWorkflow:()=>vs,CheckoutWorkflowStep:()=>ee,Commitment:()=>Ne,ERROR_MESSAGE_BAD_REQUEST:()=>Fr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>us,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Ur,EVENT_AEM_ERROR:()=>Ir,EVENT_AEM_LOAD:()=>Or,EVENT_MAS_ERROR:()=>Dr,EVENT_MAS_READY:()=>ms,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>hs,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>kr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>de,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Rr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>bt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Mr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>ds,EVENT_MERCH_OFFER_READY:()=>ns,EVENT_MERCH_OFFER_SELECT_READY:()=>os,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ue,EVENT_MERCH_SEARCH_CHANGE:()=>ps,EVENT_MERCH_SIDENAV_SELECT:()=>Nr,EVENT_MERCH_STOCK_CHANGE:()=>cs,EVENT_MERCH_STORAGE_CHANGE:()=>ls,EVENT_OFFER_SELECTED:()=>ss,EVENT_TYPE_FAILED:()=>$r,EVENT_TYPE_READY:()=>jt,EVENT_TYPE_RESOLVED:()=>Gr,Env:()=>ge,FF_ANNUAL_PRICE:()=>Ye,FF_DEFAULTS:()=>be,HEADER_X_REQUEST_ID:()=>yt,LOG_NAMESPACE:()=>qr,Landscape:()=>Ce,MARK_DURATION_SUFFIX:()=>Qr,MARK_START_SUFFIX:()=>Zr,MERCH_CARD_LOAD_TIMEOUT:()=>Pr,MODAL_TYPE_3_IN_1:()=>Oe,NAMESPACE:()=>ts,PARAM_AOS_API_KEY:()=>gs,PARAM_ENV:()=>jr,PARAM_LANDSCAPE:()=>Wr,PARAM_MAS_PREVIEW:()=>Vr,PARAM_WCS_API_KEY:()=>fs,PROVIDER_ENVIRONMENT:()=>Kr,SELECTOR_MAS_CHECKOUT_LINK:()=>da,SELECTOR_MAS_ELEMENT:()=>Lr,SELECTOR_MAS_INLINE_PRICE:()=>j,SELECTOR_MAS_SP_BUTTON:()=>as,SELECTOR_MAS_UPT_LINK:()=>ha,SORT_ORDER:()=>pe,STATE_FAILED:()=>he,STATE_PENDING:()=>Te,STATE_RESOLVED:()=>xe,SUPPORTED_COUNTRIES:()=>Jr,TAG_NAME_SERVICE:()=>is,TEMPLATE_PRICE:()=>xs,TEMPLATE_PRICE_ANNUAL:()=>ys,TEMPLATE_PRICE_LEGAL:()=>ne,TEMPLATE_PRICE_STRIKETHROUGH:()=>bs,Term:()=>ce,WCS_PROD_URL:()=>Yr,WCS_STAGE_URL:()=>Xr});var Ne=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ce=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),ts="merch",Pr=2e4,rs="hidden",jt="wcms:commerce:ready",is="mas-commerce-service",j='span[is="inline-price"][data-wcs-osi]',da='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',as="sp-button[data-wcs-osi]",ha='a[is="upt-link"]',Lr=`${j},${da},${ha}`,ns="merch-offer:ready",os="merch-offer-select:ready",kr="merch-card:action-menu-toggle",ss="merch-offer:selected",cs="merch-stock:change",ls="merch-storage:change",ue="merch-quantity-selector:change",ds="merch-card-quantity:change",hs="merch-modal:addon-and-quantity-update",ps="merch-search:change",Mr="merch-card-collection:sort",de="merch-card-collection:literals-changed",bt="merch-card-collection:sidenav-attached",Rr="merch-card-collection:showmore",Nr="merch-sidenav:select",Or="aem:load",Ir="aem:error",ms="mas:ready",Dr="mas:error",Hr="placeholder-failed",zr="placeholder-pending",Br="placeholder-resolved",Fr="Bad WCS request",Ur="Commerce offer not found",us="Literals URL not provided",$r="mas:failed",Gr="mas:resolved",qr="mas/commerce",Vr="mas.preview",jr="commerce.env",Wr="commerce.landscape",gs="commerce.aosKey",fs="commerce.wcsKey",Yr="https://www.adobe.com/web_commerce_artifact",Xr="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",Te="pending",xe="resolved",Ce={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},yt="X-Request-Id",ee=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),vs="UCv3",ge=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Kr={PRODUCTION:"PRODUCTION"},Oe={TWP:"twp",D2P:"d2p",CRM:"crm"},Zr=":start",Qr=":duration",xs="price",bs="price-strikethrough",ys="annual",ne="legal",be="mas-ff-defaults",Ye="mas-ff-annual-price",pe={alphabetical:"alphabetical",authored:"authored"},Jr=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var ws="mas-commerce-service";var wt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function fe(e,r={},t=null,i=null){let a=i?document.createElement(e,{is:i}):document.createElement(e);t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t;for(let[n,o]of Object.entries(r))a.setAttribute(n,o);return a}function Wt(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function ti(){return window.matchMedia("(max-width: 1024px)").matches}function Et(){return document.getElementsByTagName(ws)?.[0]}function At(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}import{html as Yt,nothing as Es}from"./lit-all.min.js";var Xe,St=class St{constructor(r){g(this,"card");q(this,Xe);this.card=r,this.insertVariantStyle()}getContainer(){return U(this,Xe,y(this,Xe)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),y(this,Xe)}insertVariantStyle(){let r=this.constructor.name;if(!St.styleMap[r]){St.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Yt`
            <div
                id="badge"
        ...
        `}get cardImage(){return Yt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:Es}get secureLabelFooter(){return Yt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let r=Promise.allSettled(this.card.prices.map(i=>i.onceSettled?.()||Promise.resolve())),t=new Promise(i=>setTimeout(i,Pr));await Promise.race([r,t])}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Xt(this.card.variant)}};Xe=new WeakMap,g(St,"styleMap",{});var _=St;import{html as ri,css as As}from"./lit-all.min.js";var pa=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Tt,css as Ss}from"./lit-all.min.js";var ua=`
:root {
...
`;var Kt=class extends _{constructor(r){super(r)}getGlobalCSS(){return fa}renderLayout(){return va` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":va`<hr />`} ${this.secureLabelFooter}`}};import{html as _e,css as Ts,unsafeCSS as ba}from"./lit-all.min.js";var xa=`
  :root {
...
`;var Cs=32,ya={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Ze=class extends _{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?_e`<slot name="secure-transaction-label">
    ...
    `);import{html as Zt,css as _s,unsafeCSS as Ea,nothing as Ps}from"./lit-all.min.js";var wa=`
  :root {
...
`;var Ls=32,Aa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Qe=class extends _{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Zt` <footer>
    ...
    `);import{html as Ct,css as ks,nothing as Qt}from"./lit-all.min.js";var Sa=`
:root {
...
`;var Jt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ta={...function(){let{whatsIncluded:e,size:r,...t}=Jt;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Ca={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:i,...a}=Jt;return a}()},ve,te=class extends _{constructor(t){super(t);q(this,ve);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,i){t.dataset.template===ne&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Sa}adjustSlotPlacement(t,i,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!i.includes(s)){if(o?.classList.toggle("wide-footer",C.isDesktopOrUp),!a&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(a&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!c){let u=l.cloneNode(!0);o.prepend(u)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],C.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],C.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){y(this,ve)||(U(this,ve,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(y(this,ve)?.disconnect(),U(this,ve,null),this.syncHeights())})),y(this,ve).observe(this.card));return}["heading-xs","subtitle","heading-m","promo-text","body-xs"].forEach(i=>{let a=this.card.querySelector(`[slot="${i}"]`);a&&this.updateCardElementMinHeight(a,i)})}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),i.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=At(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=At(p));let u=this.card.querySelector('[slot="heading-m"]');u&&(l+=8+At(u));for(let m of i.childNodes){if(m.classList.contains("spacer"))break;l+=At(m)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){if(this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches){let t=this.getContainer();if(!t)return;let i=`--consonant-merch-card-${this.card.variant}`,a=t.style.getPropertyValue(`${i}-heading-xs-height`);requestAnimationFrame(a?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(o=>o.variantLayout?.syncHeights?.())})}}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${j}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ct`<div class="divider"></div>`:Qt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],i=this.card.querySelector(`[slot="heading-m"] ${j}[data-template="price"]`);i&&t.push(i);let a=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(t.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?Ct`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};ve=new WeakMap,g(te,"variantStyle",ks`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(C.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?C.isMobile?ye`
        ...
        `:ye`
            ...
            <slot></slot>`}};g(Pe,"variantStyle",Ms`
...
`;var Ma={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Je=class extends _{constructor(r){super(r),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return ka}priceOptionsProvider(r,t){r.dataset.template===ne&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return ii` ${this.badge}
...
`;var Ia={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},tt=class extends _{constructor(r){super(r)}getGlobalCSS(){return Oa}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Os`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Ha={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},rt=class extends _{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Da}renderLayout(){return ni`${this.cardImage}
            ...
            ${this.evergreen?ni`
                  ...
                  `:ni`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(rt,"variantStyle",Ds`
    ...
    `);import{html as Hs,css as zs}from"./lit-all.min.js";var za=`
:root {
...
`;var qa={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},ot=class extends _{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal(),await super.postCardUpdateHook()}getGlobalCSS(){return Ga}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${j}[data-template="price"]`);if(!t)return;let i=t.cloneNode(!0);this.legal=i,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return qs`
            ${this.badge}
            <div class="body">
...
`,Ge.MISSING_INTL_API,o);var S=t.getPluralRules(r,{type:d.pluralType}).select(u-(d.offset||0));x=d.options[S]||d.options.other}if(!x)throw new qi(d.value,u,Object.keys(d.options),o);s.push.apply(s,Ht(x.value,r,t,i,a,u-(d.offset||0)));continue}}return yl(s)}function El(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,i){return t[i]=P(P({},e[i]),r[i]||{}),t},{})):e}function Al(e,r){return r?Object.keys(e).reduce(function(t,i){return t[i]=El(e[i],r[i]),t},P({},e)):e}function Vi(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function Sl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:It(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.NumberFormat).bind.apply(r,mr([void 0],t,!1)))},{cache:Vi(e.number),strategy:wr.variadic}),getDateTimeFormat:It(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.DateTimeFormat).bind.apply(r,mr([void 0],t,!1)))},{cache:Vi(e.dateTime),strategy:wr.variadic}),getPluralRules:It(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.PluralRules).bind.apply(r,mr([void 0],t,!1)))},{cache:Vi(e.pluralRules),strategy:wr.variadic})}}var ho=function(){function e(r,t,i,a){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==K.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Ht(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Al(e.formats,i),this.formatters=a&&a.formatters||Sl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=no,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var po=ho;var ji={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Tl=Qa("ConsonantTemplates/price"),Cl=/<\/?[^>]+(>|$)/g,B={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ke={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Wi="TAX_EXCLUSIVE",_l=e=>Xa(e)?Object.entries(e).filter(([,r])=>ct(r)||rr(r)||r===!0).reduce((r,[t,i])=>`${r} ${t}${i===!0?"":`="${Ya(i)}"`}`,""):"",$=(e,r,t,i=!1)=>`<span class="${e}${r?"":` ${B.disabled}`}"${_l(t)}>${i?Tn(r):r??""}</span>`;function Pl(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function Ll(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function Ee(e,r,t,i){let a=e[t];if(a==null)return"";let n=a.includes("<"),o=a.includes("<a ");try{a=o?Pl(a):a,a=n?a.replace(Cl,""):a;let s=new po(a,r).format(i);return o?Ll(s):s}catch{return Tl.error("Failed to format literal:",a),""}}function kl(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},u={}){let h=$(B.currencySymbol,i),m=$(B.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+m),f+=$(B.integer,s),f+=$(B.decimalsDelimiter,n),f+=$(B.decimals,a),c||(f+=m+h),f+=$(B.recurrence,l,null,!0),f+=$(B.unitType,d,null,!0),f+=$(B.taxInclusivity,p,!0),$(e,f,{...u})}var Y=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:u={},quantity:h=1,space:m=!1,isPromoApplied:f=!1}={},{commitment:v,offerSelectorIds:b,formatString:A,price:x,priceWithoutDiscount:S,taxDisplay:N,taxTerm:M,term:z,usePrecision:G,promotion:Q}={},W={})=>{Object.entries({country:o,formatString:A,language:p,price:x}).forEach(([Ko,Zo])=>{if(Zo==null)throw new Error(`Argument "${Ko}" is missing for osi ${b?.toString()}, country ${o}, language ${p}`)});let F={...ji,...u},R=`${p.toLowerCase()}-${o.toUpperCase()}`,J;Q&&!f&&S?J=e||i?x:S:t&&S?J=S:J=x;let se=r?_n:Pn;a&&(se=Ln);let{accessiblePrice:je,recurrenceTerm:ta,...ra}=se({commitment:v,formatString:A,instant:n,isIndianPrice:o==="IN",originalPrice:x,priceWithoutDiscount:S,price:r?x:J,promotion:Q,quantity:h,term:z,usePrecision:G}),Sr="",Tr="",Cr="";w(c)&&ta&&(Cr=Ee(F,R,ke.recurrenceLabel,{recurrenceTerm:ta}));let Gt="";w(l)&&(m&&(Gt+=" "),Gt+=Ee(F,R,ke.perUnitLabel,{perUnit:"LICENSE"}));let qt="";w(d)&&M&&(m&&(qt+=" "),qt+=Ee(F,R,N===Wi?ke.taxExclusiveLabel:ke.taxInclusiveLabel,{taxTerm:M})),t&&(Sr=Ee(F,R,ke.strikethroughAriaLabel,{strikethroughPrice:Sr})),e&&(Tr=Ee(F,R,ke.alternativePriceAriaLabel,{alternativePrice:Tr}));let Re=B.container;if(r&&(Re+=` ${B.containerOptical}`),t&&(Re+=` ${B.containerStrikethrough}`),i&&(Re+=` ${B.containerPromoStrikethrough}`),e&&(Re+=` ${B.containerAlternative}`),a&&(Re+=` ${B.containerAnnual}`),w(s))return kl(Re,{...ra,accessibleLabel:Sr,altAccessibleLabel:Tr,recurrenceLabel:Cr,perUnitLabel:Gt,taxInclusivityLabel:qt},W);let{currencySymbol:ia,decimals:Vo,decimalsDelimiter:jo,hasCurrencySpace:aa,integer:Wo,isCurrencyFirst:Yo}=ra,We=[Wo,jo,Vo];Yo?(We.unshift(aa?"\xA0":""),We.unshift(ia)):(We.push(aa?"\xA0":""),We.push(ia)),We.push(Cr,Gt,qt);let Xo=We.join("");return $(Re,Xo,W)},mo=()=>(e,r,t)=>{let i=Ue(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||i);return`${n?`${Y({displayStrikethrough:!0})({isPromoApplied:i,...e},r,t)}&nbsp;`:""}${Y({isAlternativePrice:n})({isPromoApplied:i,...e},r,t)}`},uo=()=>(e,r,t)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=Ue(r.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return Y()(e,{...r,price:r.priceWithoutDiscount},t)+$(B.containerAnnualPrefix," (")+Y({displayAnnual:!0,instant:i})(n,{...r,price:r.priceWithoutDiscount},t)+$(B.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${Y({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${Y({isAlternativePrice:s})({isPromoApplied:a,...e},r,t)}${$(B.containerAnnualPrefix," (")}${Y({displayAnnual:!0,instant:i})(n,r,t)}${$(B.containerAnnualSuffix,")")}`},go=()=>(e,r,t)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${Y({isAlternativePrice:e.displayOldPrice})(e,r,t)}${$(B.containerAnnualPrefix," (")}${Y({displayAnnual:!0})(i,r,t)}${$(B.containerAnnualSuffix,")")}`};var zt={...B,containerLegal:"price-legal",planType:"price-plan-type"},Er={...ke,planTypeLabel:"planTypeLabel"};function Ml(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:i},a={}){let n="";return n+=$(zt.unitType,r,null,!0),t&&i&&(t+=". "),n+=$(zt.taxInclusivity,t,!0),n+=$(zt.planType,i,null),$(e,n,{...a})}var fo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:i=!1,language:a,literals:n={}}={},{taxDisplay:o,taxTerm:s,planType:c}={},l={})=>{let d={...ji,...n},p=`${a.toLowerCase()}-${e.toUpperCase()}`,u="";w(r)&&(u=Ee(d,p,Er.perUnitLabel,{perUnit:"LICENSE"}));let h="";e==="US"&&a==="en"&&(t=!1),w(t)&&s&&(h=Ee(d,p,o===Wi?Er.taxExclusiveLabel:Er.taxInclusiveLabel,{taxTerm:s}));let m="";w(i)&&c&&(m=Ee(d,p,Er.planTypeLabel,{planType:c}));let f=zt.container;return f+=` ${zt.containerLegal}`,Ml(f,{perUnitLabel:u,taxInclusivityLabel:h,planTypeLabel:m},l)};var vo=Y(),xo=mo(),bo=Y({displayOptical:!0}),yo=Y({displayStrikethrough:!0}),wo=Y({displayPromoStrikethrough:!0}),Eo=Y({displayAnnual:!0}),Ao=Y({displayOptical:!0,isAlternativePrice:!0}),So=Y({isAlternativePrice:!0}),To=go(),Co=uo(),_o=fo;var Rl=(e,r)=>{if(!(!_t(e)||!_t(r)))return Math.floor((r-e)/r*100)},Po=()=>(e,r)=>{let{price:t,priceWithoutDiscount:i}=r,a=Rl(t,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var Lo=Po();var ko="INDIVIDUAL_COM",Xi="TEAM_COM",Mo="INDIVIDUAL_EDU",Ki="TEAM_EDU",Nl=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","AR_es","PH_en","PH_fil"],Ol={[ko]:[],[Xi]:["VN_vi","VN_en","TW_zh"],[Mo]:[],[Ki]:["VN_vi","VN_en","TW_zh"]},Il={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Dl=[ko,Xi,Mo,Ki],Hl=e=>[Xi,Ki].includes(e);function Yi(e,r,t,i){if(e[r])return e[r];let a=`${r}_${t}`;if(e[a])return e[a];let n;if(i)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var zl=(e,r,t,i)=>{let a=`${t}_${i}`,n=Yi(Il,e,r,!1);if(n){let o=Dl.indexOf(a);return n[o]}return Hl(a)},Bl=(e,r,t,i)=>{if(Yi(Nl,e,r,!0))return!0;let a=Ol[`${t}_${i}`];return a?Yi(a,e,r,!0)?!0:k.displayTax:k.displayTax},Zi=async(e,r,t,i)=>{let a=Bl(e,r,t,i);return{displayTax:a,forceTaxExclusive:a?zl(e,r,t,i):k.forceTaxExclusive}},Bt=class Bt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Le(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let i=ie();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:u,quantity:h,alternativePrice:m,template:f,wcsOsi:v}=i.collectPriceOptions(t);return hr(Bt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:u,quantity:h,alternativePrice:m,template:f,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===he}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let i=ie();if(!i)return!1;let a=i.collectPriceOptions(t,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=i.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let m=Lt(h,n);return m?.length?m[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=Ci(l);if(i.featureFlags[be]||n[be]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:h,language:m}=n,[f=""]=p.marketSegments,v=await Zi(h,m,p.customerSegment,f);a.displayTax===void 0&&(n.displayTax=v?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=v?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(b=>{let A=Lt(b,n);return A?.length?A[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(i.featureFlags[Ye]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,m]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:m.priceDetails?.price}};return this.renderOffers([f],n,o)}let u=Ci(d);return this.renderOffers([u],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,i,a=void 0){if(!this.isConnected)return;let n=ie();if(!n)return!1;if(a??(a=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(a,t,i)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,o,this.options))return this.innerHTML="",!0}return!1}};g(Bt,"is","inline-price"),g(Bt,"tag","span");var Ae=Bt;window.customElements.get(Ae.is)||window.customElements.define(Ae.is,Ae,{extends:Ae.tag});function Ro({literals:e,providers:r,settings:t}){function i(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let M of r.price)M(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:u,displayPlanType:h,forceTaxExclusive:m,perpetual:f,displayAnnual:v,promotionCode:b,quantity:A,alternativePrice:x,wcsOsi:S,...N}=Object.assign(c,s?.dataset??{},o??{});return c=ir(Object.assign({...c,...N,displayOldPrice:w(l),displayPerUnit:w(d),displayRecurrence:w(p),displayTax:w(u),displayPlanType:w(h),forceTaxExclusive:w(m),perpetual:w(f),displayAnnual:w(v),promotionCode:nr(b).effectivePromoCode,quantity:lt(A,k.quantity),alternativePrice:w(x),wcsOsi:dr(S)})),c}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Lo;break;case"strikethrough":l=yo;break;case"promo-strikethrough":l=wo;break;case"annual":l=Eo;break;case"legal":l=_o;break;default:s.template==="optical"&&s.alternativePrice?l=Ao:s.template==="optical"?l=bo:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode?Co:To:s.alternativePrice?l=So:l=s.promotionCode?xo:vo}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Ae.createInlinePrice;return{InlinePrice:Ae,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function Fl({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||k.language),r??(r=e?.split("_")?.[1]||k.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function No(e={},r){let t=r.featureFlags[be],{commerce:i={}}=e,a=ge.PRODUCTION,n=Yr,o=H("checkoutClientId",i)??k.checkoutClientId,s=Pt(H("checkoutWorkflowStep",i),ee,k.checkoutWorkflowStep),c=w(H("displayOldPrice",i),k.displayOldPrice),l=k.displayPerUnit,d=w(H("displayRecurrence",i),k.displayRecurrence),p=w(H("displayTax",i),k.displayTax),u=w(H("displayPlanType",i),k.displayPlanType),h=w(H("entitlement",i),k.entitlement),m=w(H("modal",i),k.modal),f=w(H("forceTaxExclusive",i),k.forceTaxExclusive),v=H("promotionCode",i)??k.promotionCode,b=lt(H("quantity",i)),A=H("wcsApiKey",i)??k.wcsApiKey,x=i?.env==="stage",S=Ce.PUBLISHED;["true",""].includes(i.allowOverride)&&(x=(H(jr,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",S=Pt(H(Wr,i),Ce,S)),x&&(a=ge.STAGE,n=Xr);let M=H(Vr)??e.preview,z=typeof M<"u"&&M!=="off"&&M!=="false",G={};z&&(G={preview:z});let Q=H("mas-io-url")??e.masIOUrl??`https://www${a===ge.STAGE?".stage":""}.adobe.com/mas/io`,W=H("preselect-plan")??void 0;return{...Fl(e),...G,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:u,entitlement:h,extraOptions:k.extraOptions,modal:m,env:a,forceTaxExclusive:f,promotionCode:v,quantity:b,alternativePrice:k.alternativePrice,wcsApiKey:A,wcsURL:n,landscape:S,masIOUrl:Q,...W&&{preselectPlan:W}}}async function Oo(e,r={},t=2,i=100){let a;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,i*(n+1)))}throw a}var Qi="wcs";function Io({settings:e}){let r=re.module(Qi),{env:t,wcsApiKey:i}=e,a=new Map,n=new Map,o,s=new Map;async function c(m,f,v=!0){let b=ie(),A=Ur;r.debug("Fetching:",m);let x="",S;if(m.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let N=new Map(f),[M]=m.offerSelectorIds,z=Date.now()+Math.random().toString(36).substring(2,7),G=`${Qi}:${M}:${z}${Zr}`,Q=`${Qi}:${M}:${z}${Qr}`,W;try{if(performance.mark(G),x=new URL(e.wcsURL),x.searchParams.set("offer_selector_ids",M),x.searchParams.set("country",m.country),x.searchParams.set("locale",m.locale),x.searchParams.set("landscape",t===ge.STAGE?"ALL":e.landscape),x.searchParams.set("api_key",i),m.language&&x.searchParams.set("language",m.language),m.promotionCode&&x.searchParams.set("promotion_code",m.promotionCode),m.currency&&x.searchParams.set("currency",m.currency),S=await Oo(x.toString(),{credentials:"omit"}),S.ok){let F=[];try{let R=await S.json();r.debug("Fetched:",m,R),F=R.resolvedOffers??[]}catch(R){r.error(`Error parsing JSON: ${R.message}`,{...R.context,...b?.duration})}F=F.map(or),f.forEach(({resolve:R},J)=>{let se=F.filter(({offerSelectorIds:je})=>je.includes(J)).flat();se.length&&(N.delete(J),f.delete(J),R(se))})}else A=Fr}catch(F){A=`Network error: ${F.message}`}finally{W=performance.measure(Q,G),performance.clearMarks(G),performance.clearMeasures(Q)}if(v&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=pn(S);f.forEach(R=>{R.reject(new dt(A,{...m,...F,response:S,measure:Wt(W),...b?.duration}))})}}function l(){clearTimeout(o);let m=[...n.values()];n.clear(),m.forEach(({options:f,promises:v})=>c(f,v))}function d(m){if(!m||typeof m!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ge.STAGE?"stage":"prod",v=m[f];if(!v||typeof v!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[b,A]of Object.entries(v))a.set(b,Promise.resolve(A.map(or)));r.debug(`Prefilled WCS cache with ${v.size} entries`)}function p(){let m=a.size;s=new Map(a),a.clear(),r.debug(`Moved ${m} cache entries to stale cache`)}function u(m,f,v){let b=m!=="GB"&&!v?"MULT":"en",A=Jr.includes(m)?m:k.country;return{validCountry:A,validLanguage:b,locale:`${f}_${A}`}}function h({country:m,language:f,perpetual:v=!1,promotionCode:b="",wcsOsi:A=[]}){let{validCountry:x,validLanguage:S,locale:N}=u(m,f,v),M=[x,S,b].filter(z=>z).join("-").toLowerCase();return A.map(z=>{let G=`${z}-${M}`;if(a.has(G))return a.get(G);let Q=new Promise((W,F)=>{let R=n.get(M);R||(R={options:{country:x,locale:N,...S==="MULT"&&{language:S},offerSelectorIds:[]},promises:new Map},n.set(M,R)),b&&(R.options.promotionCode=b),R.options.offerSelectorIds.push(z),R.promises.set(z,{resolve:W,reject:F}),l()}).catch(W=>{if(s.has(G))return s.get(G);throw W});return a.set(G,Q),Q})}return{Commitment:Ne,PlanType:en,Term:ce,applyPlanType:or,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:u}}var Do="mas-commerce-service",Ho="mas-commerce-service:start",zo="mas-commerce-service:ready",Ft,pt,qe,Bo,ea,Ji=class extends HTMLElement{constructor(){super(...arguments);q(this,qe);q(this,Ft);q(this,pt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let o=await t?.(i,a,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return y(this,pt)||U(this,pt,{[be]:ft(this,qe,ea).call(this,be),[Ye]:ft(this,qe,ea).call(this,Ye)}),y(this,pt)}activate(){let t=y(this,qe,Bo),i=No(t,this);sr(t.lana);let a=re.init(t.hostEnv).module("service");a.debug("Activating:",t);let o={price:zn(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...In(c),...Dn(c),...Ro(c),...Io(c),...ei,Log:re,resolvePriceTaxFlags:Zi,get defaults(){return k},get log(){return re},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(jt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(zo),U(this,Ft,performance.measure(zo,Ho)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Ho),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Lr).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Wt(y(this,Ft))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:o})=>a===0&&n===0&&o<200||o>=400),i=Array.from(new Map(t.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Ft=new WeakMap,pt=new WeakMap,qe=new WeakSet,Bo=function(){let t=this.getAttribute("env")??"prod",i={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=n}}),i},ea=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(Do)||window.customElements.define(Do,Ji);var Go="merch-card-collection",Ul=3e4,$l={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Gl={plans:!0},ql=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Vl=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(i=>t.types.includes(i)))):e,jl=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Wl=(e,{filter:r})=>e.sort((t,i)=>i.filters[r]?.order==null||isNaN(i.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-i.filters[r].order),Yl=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Me,ut,Ve,$t,Ar,qo,mt=class extends Uo{constructor(){super();q(this,Ar);q(this,Me,{});q(this,ut);q(this,Ve);q(this,$t);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return Se` <slot></slot>
        ...
        </sp-button>`}sortChanged(t){t.target.value===pe.authored?xt({sort:void 0}):xt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(Mr,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(Rr,{bubbles:!0,composed:!0}));let t=this.page+1;xt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=la(({category:t,filter:i,types:a,sort:n,search:o,single_app:s,page:c})=>{i=i||t,!this.filtered&&i&&i!==this.filter&&setTimeout(()=>{xt({page:void 0}),this.page=1},1),this.filtered||(this.filter=i??this.filter),this.types=a??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(c)||1})}openFilters(t){this.sidenav?.showModal(t)}};Me=new WeakMap,ut=new WeakMap,Ve=new WeakMap,$t=new WeakMap,Ar=new WeakSet,qo=function(t,i={},a=!0){y(this,Ve)?.error(`merch-card-collection: ${t}`,i),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(Dr,{detail:{...i,message:t},bubbles:!0,composed:!0}))},g(mt,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:pe.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(mt,"styles",$o`
        #footer {
            grid-column: 1 / -1;

var Ki=Object.defineProperty;var Qi=e=>{throw TypeError(e)};var lc=(e,r,t)=>r in e?Ki(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var dc=(e,r)=>{for(var t in r)Ki(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>lc(e,typeof r!="symbol"?r+"":r,t),pa=(e,r,t)=>r.has(e)||Qi("Cannot "+t);var v=(e,r,t)=>(pa(e,r,"read from private field"),t?t.call(e):r.get(e)),S=(e,r,t)=>r.has(e)?Qi("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),E=(e,r,t,a)=>(pa(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),H=(e,r,t)=>(pa(e,r,"access private method"),t);import{html as Ne,LitElement as Zs,css as Js,unsafeCSS as Qs,nothing as xe}from"./lit-all.min.js";var z="(max-width: 767px)",X="(max-width: 1199px)",R="(min-width: 768px)",L="(min-width: 1200px)",ee="(min-width: 1600px)",Ht="(min-width: 1280px)",Zi={matchMobile:window.matchMedia(z),matchDesktop:window.matchMedia(`${L} and (not ${ee})`),matchDesktopOrUp:window.matchMedia(L),matchLargeDesktop:window.matchMedia(ee),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},A=Zi;function Er(){return Zi.isDesktop}var Ft=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var Ji="hashchange";function hc(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function Bt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function en(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=hc(window.location.hash);e(t)};return r(),window.addEventListener(Ji,r),()=>{window.removeEventListener(Ji,r)}}var Ha={};dc(Ha,{CLASS_NAME_FAILED:()=>Ea,CLASS_NAME_HIDDEN:()=>mc,CLASS_NAME_PENDING:()=>Sa,CLASS_NAME_RESOLVED:()=>Aa,CheckoutWorkflow:()=>_c,CheckoutWorkflowStep:()=>ie,Commitment:()=>qe,ERROR_MESSAGE_BAD_REQUEST:()=>Ca,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Cc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Ta,EVENT_AEM_ERROR:()=>ya,EVENT_AEM_LOAD:()=>ba,EVENT_COMPARE_CHART_REHYDRATE:()=>Sc,EVENT_EXPANDED_GROUPS_CHANGE:()=>Ac,EVENT_MAS_ERROR:()=>wa,EVENT_MAS_READY:()=>Cr,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>wc,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>ga,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>me,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>va,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Ut,EVENT_MERCH_CARD_COLLECTION_SORT:()=>fa,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Ar,EVENT_MERCH_OFFER_READY:()=>fc,EVENT_MERCH_OFFER_SELECT_READY:()=>vc,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ae,EVENT_MERCH_SEARCH_CHANGE:()=>Ec,EVENT_MERCH_SIDENAV_SELECT:()=>xa,EVENT_MERCH_STOCK_CHANGE:()=>bc,EVENT_MERCH_STORAGE_CHANGE:()=>yc,EVENT_OFFER_SELECTED:()=>xc,EVENT_TYPE_FAILED:()=>ka,EVENT_TYPE_READY:()=>Sr,EVENT_TYPE_RESOLVED:()=>ue,Env:()=>be,FF_ANNUAL_PRICE:()=>st,FF_DEFAULTS:()=>ke,HEADER_X_REQUEST_ID:()=>$t,LOG_NAMESPACE:()=>_a,Landscape:()=>Ie,MARK_DURATION_SUFFIX:()=>za,MARK_START_SUFFIX:()=>Ia,MERCH_CARD_LOAD_TIMEOUT:()=>ma,MODAL_TYPE_3_IN_1:()=>Ve,NAMESPACE:()=>pc,PARAM_AOS_API_KEY:()=>Tc,PARAM_ENV:()=>Pa,PARAM_LANDSCAPE:()=>Ma,PARAM_MAS_PREVIEW:()=>La,PARAM_WCS_API_KEY:()=>kc,PROVIDER_ENVIRONMENT:()=>Oa,SELECTOR_MAS_CHECKOUT_LINK:()=>tn,SELECTOR_MAS_ELEMENT:()=>ua,SELECTOR_MAS_INLINE_PRICE:()=>V,SELECTOR_MAS_SP_BUTTON:()=>gc,SELECTOR_MAS_UPT_LINK:()=>rn,SORT_ORDER:()=>fe,STATE_FAILED:()=>ge,STATE_PENDING:()=>Oe,STATE_RESOLVED:()=>Te,SUPPORTED_COUNTRIES:()=>Da,TAG_NAME_SERVICE:()=>uc,TEMPLATE_PRICE:()=>Lc,TEMPLATE_PRICE_ANNUAL:()=>Mc,TEMPLATE_PRICE_LEGAL:()=>te,TEMPLATE_PRICE_STRIKETHROUGH:()=>Pc,TRIAL_ANALYTICS_IDS:()=>an,Term:()=>he,WCS_PROD_URL:()=>Ra,WCS_STAGE_URL:()=>Na});var qe=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),he=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),pc="merch",ma=2e4,mc="hidden",Sr="wcms:commerce:ready",uc="mas-commerce-service",V='span[is="inline-price"][data-wcs-osi]',tn='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',gc="sp-button[data-wcs-osi]",rn='a[is="upt-link"]',ua=`${V},${tn},${rn}`,an=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]),fc="merch-offer:ready",vc="merch-offer-select:ready",ga="merch-card:action-menu-toggle",xc="merch-offer:selected",bc="merch-stock:change",yc="merch-storage:change",ae="merch-quantity-selector:change",Ar="merch-card-quantity:change",wc="merch-modal:addon-and-quantity-update",Ec="merch-search:change",fa="merch-card-collection:sort",me="merch-card-collection:literals-changed",Ut="merch-card-collection:sidenav-attached",va="merch-card-collection:showmore",xa="merch-sidenav:select",ba="aem:load",ya="aem:error",Cr="mas:ready",wa="mas:error",Sc="mas-compare-chart:rehydrate",Ac="expanded-groups-change",Ea="placeholder-failed",Sa="placeholder-pending",Aa="placeholder-resolved",Ca="Bad WCS request",Ta="Commerce offer not found",Cc="Literals URL not provided",ka="mas:failed",ue="mas:resolved",_a="mas/commerce",La="mas.preview",Pa="commerce.env",Ma="commerce.landscape",Tc="commerce.aosKey",kc="commerce.wcsKey",Ra="https://www.adobe.com/web_commerce_artifact",Na="https://www.stage.adobe.com/web_commerce_artifact_stage",ge="failed",Oe="pending",Te="resolved",Ie={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},$t="X-Request-Id",ie=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),_c="UCv3",be=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Oa={PRODUCTION:"PRODUCTION"},Ve={TWP:"twp",D2P:"d2p",CRM:"crm"},Ia=":start",za=":duration",Lc="price",Pc="price-strikethrough",Mc="annual",te="legal",ke="mas-ff-defaults",st="mas-ff-annual-price",fe={alphabetical:"alphabetical",authored:"authored"},Da=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Rc="mas-commerce-service";function nn(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Gt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function ye(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Tr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Fa(){return window.matchMedia("(max-width: 1024px)").matches}function qt(){return document.getElementsByTagName(Rc)?.[0]}function Vt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var Nc=["adobe.com","adobeioruntime.net","aem.live","aem.page"],Oc=["localhost","127.0.0.1"];function on(e){try{let r=new URL(e);return Oc.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:Nc.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as kr,nothing as Ic}from"./lit-all.min.js";var ct,jt=class jt{constructor(r){g(this,"card");S(this,ct);this.card=r,this.insertVariantStyle()}getContainer(){return E(this,ct,v(this,ct)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,ct)}insertVariantStyle(){let r=this.constructor.name;if(!jt.styleMap[r]){jt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(h=>h.style.getPropertyValue(l)),p=0,m=o.map(h=>{h.style.removeProperty(l);let u=c(h);if(!u)return u;let f=Math.max(0,parseInt(window.getComputedStyle(u).height)||0);return f>p&&(p=f),u});o.forEach((h,u)=>{m[u]?.tagName!=="HR"&&(p>0?h.style.setProperty(l,`${p}px`):d[u]&&h.style.setProperty(l,d[u]))})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),kr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Wt,css as Dc}from"./lit-all.min.js";var ln=`
:root {
...
`;var Lr=class extends y{constructor(r){super(r)}getGlobalCSS(){return hn}renderLayout(){return pn` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":pn`<hr />`} ${this.secureLabelFooter}`}};import{html as ze,css as Hc,unsafeCSS as un}from"./lit-all.min.js";var mn=`
  :root {
...
`;var Fc=32,gn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},dt=class extends y{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?ze`<slot name="secure-transaction-label">
    ...
    `);import{html as Pr,css as Bc,unsafeCSS as Ua,nothing as Uc}from"./lit-all.min.js";var fn=`
  :root {
...
`;var $c=32,Gc=0,qc=()=>`mweb-list-${Gc+=1}`,Vc=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],jc=8,vn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},we,We,pt,mt,ut,De,$a,Ga,ht=class extends y{constructor(t){super(t);S(this,De);S(this,we);S(this,We);S(this,pt);S(this,mt,0);S(this,ut);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Pr` <footer>
        ...
        `}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),A.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),A.isMobile||await H(this,De,Ga).call(this)}resetSyncedHeights(){let t=this.getContainer();if(!t)return;let a=this.card.variant,i=H(this,De,$a).call(this,t);for(let n of Vc){let o=`--consonant-merch-card-${a}-${n}-height`;t.style.removeProperty(o),i.forEach(s=>s.style.removeProperty(o))}for(let n=1;n<=jc;n+=1)t.style.removeProperty(this.getRowMinHeightPropertyName(n))}};we=new WeakMap,We=new WeakMap,pt=new WeakMap,mt=new WeakMap,ut=new WeakMap,De=new WeakSet,$a=function(t){return t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)},Ga=async function(){let t=this.getContainer();if(!t)return;let a=Array.from(H(this,De,$a).call(this,t));this.card===a[0]&&(await Promise.all(a.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),requestAnimationFrame(()=>{this.resetSyncedHeights(),this.syncHeights()}))},g(ht,"variantStyle",Bc`
    ...
    `);import{html as Yt,css as Wc,nothing as Mr}from"./lit-all.min.js";var xn=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(A.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?A.isMobile?_e`
        ...
        `:_e`
            ...
            <slot></slot>`}};g(He,"variantStyle",Yc`
...
`;var[Wp,Yp,Cn,Tn,kn,_n]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Ir="pro",qa=`--consonant-merch-card-${Ir}-top-card-height`,Or=[{prop:`--consonant-merch-card-${Ir}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Ir}-name-description-height`,selector:".name-description"}],Ln=`--consonant-merch-card-${Ir}-strike-reserve`,Va='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',Kc="(min-width: 768px)",Pn={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Pe,Ye,Jt,er,Y,Mn,Kt,Rn,Qt,ja,zr,Dr=class Dr extends y{constructor(t){super(t);S(this,Y);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);S(this,Pe,null);S(this,Ye,null);S(this,Jt,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);S(this,er,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of H(this,Y,Mn).call(this)){let n=i.variantLayout;n instanceof Dr&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?H(this,Y,ja).call(this):H(this,Y,Qt).call(this),this.card.requestUpdate()});S(this,zr,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case Tn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:H(this,Y,Qt).call(this);break;case Cn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:H(this,Y,Qt).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case kn:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}H(this,Y,Qt).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),H(this,Y,ja).call(this);break;case _n:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,H(this,Y,Kt).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(ae,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return An}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(ue,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let a=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=a?.querySelector(".price-plan-type");if(!i)return;i.textContent=t;let n=a.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${V}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=qa,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(Kc).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,p)=>{let m=l(p);return m?Math.max(d,parseInt(getComputedStyle(m).height)||0):d},0);for(let c of o.values()){if(c.forEach(m=>this.clearSyncedHeights(m)),c.length<2)continue;let l=c.map(m=>m.querySelector(Va)&&parseInt(getComputedStyle(m.querySelector(Va)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((m,h)=>{let u=d-l[h];u>0&&m.style.setProperty(Ln,`${u}px`)});for(let m of Or){let h=s(c,u=>u.shadowRoot?.querySelector(m.selector));h>0&&c.forEach(u=>u.style.setProperty(m.prop,`${h}px`))}let p=s(c,m=>m.shadowRoot?.querySelector(".top-card"));p>0&&c.forEach(m=>m.style.setProperty(i,`${p}px`))}}clearSyncedHeights(t){t.style.removeProperty(qa),t.style.removeProperty(Ln),Or.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(Va),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Ar,v(this,er)),this.card.addEventListener(ae,this.updatePriceQuantity),this.card.addEventListener(ue,v(this,Jt)),typeof ResizeObserver>"u"))return;E(this,Ye,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Ye).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Ye).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ae,this.updatePriceQuantity),this.card?.removeEventListener(ue,v(this,Jt)),H(this,Y,Kt).call(this),v(this,Ye)?.disconnect(),this.card?.removeEventListener(Ar,v(this,er))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Le`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Le`
        ...
        `}renderLayout(){let t=!!this.expanded;return Le`
            ...
            <slot></slot>
        `}};Pe=new WeakMap,Ye=new WeakMap,Jt=new WeakMap,er=new WeakMap,Y=new WeakSet,Mn=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},Kt=function(){v(this,Pe)&&(document.removeEventListener("mousedown",v(this,Pe)),E(this,Pe,null))},Rn=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},Qt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=H(this,Y,Rn).call(this),v(this,Pe)||(E(this,Pe,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),H(this,Y,Kt).call(this))}),document.addEventListener("mousedown",v(this,Pe)))},ja=function(){this.licenseOpen=!1,H(this,Y,Kt).call(this)},zr=new WeakMap,g(Dr,"variantStyle",Xc`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Zt=Dr;import{html as Wa,css as Qc}from"./lit-all.min.js";var Nn=`
:root {
...
`;var On={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ae,ft=class extends y{constructor(t){super(t);S(this,Ae);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Nn}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return Wa` ${this.badge}
    ...
    `);import{html as Ya,css as Zc}from"./lit-all.min.js";var In=`
:root {
...
`;var zn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},vt=class extends y{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===te&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return In}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${V}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return Ya`
    ...
    `);import{html as Jc,css as el}from"./lit-all.min.js";var Dn=`
...
`;var Hn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},xt=class extends y{constructor(r){super(r)}getGlobalCSS(){return Dn}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Jc`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as Xa,css as tl}from"./lit-all.min.js";var Fn=`
:root {
...
`;var Bn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},bt=class extends y{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Fn}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${V}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Xa`${this.cardImage}
            ...
            ${this.evergreen?Xa`
                  ...
                  `:Xa`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(bt,"variantStyle",tl`
    ...
    `);import{html as $n,css as rl}from"./lit-all.min.js";var Un=`
:root {
...
`;var Ka={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},yt=class extends y{getGlobalCSS(){return Un}get aemFragmentMapping(){return Ka}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return $n`<div
    ...
    `);import{html as qn,css as al}from"./lit-all.min.js";var Gn=`
:root {
...
`;var Qa={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},tr=class tr extends y{getGlobalCSS(){return Gn}get aemFragmentMapping(){return Qa}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return qn`<div
        ...
        >
            ...
            <slot></slot>
        `}};g(tr,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(tr,"variantStyle",al`
    ...
    `);var rr=tr;import{html as ar,nothing as jn}from"./lit-all.min.js";import{css as il,unsafeCSS as nl}from"./lit-all.min.js";var Vn=["headless","marquee","faq","banner-blade"],wt=(e,r="")=>Vn.map(t=>`merch-card[variant='${t}'] [slot='${e}']${r}`).join(`,
`),Za=e=>Vn.map(r=>`merch-card[variant='${r}'] ${e}`).join(`,
`),Fe=`
...
${Za(".headless-cta-item")} {
    display: inline-flex;
    align-items: center;
}
${Za(".headless-cta-variant-label")} {
    font-size: 0.75em;
...
${Za(".headless-cta-item:not(:last-child)::after")} {
    content: ', ';
}
`;function Be(e){let r=nl(e);return il`
        :host([variant='${r}']) {
            border: none;
            background: transparent;
            box-shadow: none;
    ...
    `}var Wn={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},ol=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Et=class extends y{constructor(r){super(r)}getGlobalCSS(){return Fe}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return ar`
        ...
        `}};g(Et,"variantStyle",Be("headless"));import{css as sl,html as cl}from"./lit-all.min.js";var Yn=`
...
`;var Xn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},St=class extends y{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Yn}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${V}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return cl`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as ll,css as dl}from"./lit-all.min.js";var Kn=`
...
`;var Ja={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},hl=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Hr,Qn,At=class extends y{constructor(t){super(t);S(this,Hr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Kn}get aemFragmentMapping(){return Ja}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,H(this,Hr,Qn).call(this))}renderLayout(){return ll`
            <div class="card">
            ...
            <slot></slot>
        `}};Hr=new WeakSet,Qn=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;hl.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(At,"variantStyle",dl`
    ...
    `);import{html as pl,css as ml}from"./lit-all.min.js";var Zn=`
...
`;var ei={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ct=class extends y{getGlobalCSS(){return Zn}get aemFragmentMapping(){return ei}renderLayout(){return pl`
    ...
    `);import{html as ti,nothing as ul}from"./lit-all.min.js";var Jn={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},gl=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Tt=class extends y{constructor(r){super(r)}getGlobalCSS(){return Fe}renderLayout(){return ti`
            <div class="headless">
                ${gl.map(({slot:r,label:t})=>ti`
                        <div class="headless-row">
        ...
        `}};g(Tt,"variantStyle",Be("marquee"));import{html as eo}from"./lit-all.min.js";var to={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},fl=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],kt=class extends y{constructor(r){super(r)}getGlobalCSS(){return Fe}renderLayout(){return eo`
            <div class="headless">
        ...
        `}};g(kt,"variantStyle",Be("faq"));import{html as ro}from"./lit-all.min.js";var ao={cardName:{attribute:"name"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},vl=[{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],_t=class extends y{constructor(r){super(r)}getGlobalCSS(){return Fe}renderLayout(){return ro`
            <div class="headless">
                ${vl.map(({slot:r,label:t})=>ro`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value" data-slot="${r}">
                                <slot name="${r}"></slot>

var hn=Object.defineProperty;var pn=e=>{throw TypeError(e)};var Oc=(e,r,t)=>r in e?hn(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Ic=(e,r)=>{for(var t in r)hn(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Oc(e,typeof r!="symbol"?r+"":r,t),Ea=(e,r,t)=>r.has(e)||pn("Cannot "+t);var v=(e,r,t)=>(Ea(e,r,"read from private field"),t?t.call(e):r.get(e)),A=(e,r,t)=>r.has(e)?pn("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),S=(e,r,t,a)=>(Ea(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),G=(e,r,t)=>(Ea(e,r,"access private method"),t);import{html as ze,LitElement as Sc,css as Ac,unsafeCSS as Ec,nothing as we}from"./lit-all.min.js";var D="(max-width: 767px)",Z="(max-width: 1199px)",L="(min-width: 768px)",_="(min-width: 1200px)",ne="(min-width: 1600px)",Xe="(min-width: 1280px)",mn="(min-width: 1440px)",un={matchMobile:window.matchMedia(D),matchDesktop:window.matchMedia(`${_} and (not ${ne})`),matchDesktopOrUp:window.matchMedia(_),matchLargeDesktop:window.matchMedia(ne),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},C=un;function Mr(){return un.isDesktop}var Vt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var gn="hashchange";function Sa(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function jt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function Aa(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=Sa(window.location.hash);e(t)};return r(),window.addEventListener(gn,r),()=>{window.removeEventListener(gn,r)}}var Qa={};Ic(Qa,{CLASS_NAME_FAILED:()=>Ia,CLASS_NAME_HIDDEN:()=>Dc,CLASS_NAME_PENDING:()=>za,CLASS_NAME_RESOLVED:()=>Da,CheckoutWorkflow:()=>Qc,CheckoutWorkflowStep:()=>le,Commitment:()=>Qe,ERROR_MESSAGE_BAD_REQUEST:()=>Ha,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Yc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Fa,EVENT_AEM_ERROR:()=>Na,EVENT_AEM_LOAD:()=>Ra,EVENT_COMPARE_CHART_REHYDRATE:()=>jc,EVENT_EXPANDED_GROUPS_CHANGE:()=>Wc,EVENT_MAS_ERROR:()=>Oa,EVENT_MAS_READY:()=>Or,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>_a,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>ka,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>ve,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Pa,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Wt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>La,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Nr,EVENT_MERCH_OFFER_READY:()=>Bc,EVENT_MERCH_OFFER_SELECT_READY:()=>Uc,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>oe,EVENT_MERCH_SEARCH_CHANGE:()=>Vc,EVENT_MERCH_SIDENAV_SELECT:()=>Ma,EVENT_MERCH_STOCK_CHANGE:()=>Gc,EVENT_MERCH_STORAGE_CHANGE:()=>qc,EVENT_OFFER_SELECTED:()=>$c,EVENT_TYPE_FAILED:()=>Ba,EVENT_TYPE_READY:()=>Rr,EVENT_TYPE_RESOLVED:()=>se,Env:()=>Ee,FF_ANNUAL_PRICE:()=>pe,FF_DEFAULTS:()=>Pe,HEADER_X_REQUEST_ID:()=>Yt,LOG_NAMESPACE:()=>Ua,Landscape:()=>Be,MARK_DURATION_SUFFIX:()=>Ka,MARK_START_SUFFIX:()=>Ya,MERCH_CARD_LOAD_TIMEOUT:()=>Ca,MODAL_TYPE_3_IN_1:()=>Se,NAMESPACE:()=>zc,PARAM_AOS_API_KEY:()=>Kc,PARAM_ENV:()=>Ga,PARAM_LANDSCAPE:()=>qa,PARAM_MAS_PREVIEW:()=>$a,PARAM_WCS_API_KEY:()=>Xc,PLACEHOLDER_PLAN_TYPE_TEXT:()=>tl,PROVIDER_ENVIRONMENT:()=>Wa,SELECTOR_MAS_CHECKOUT_LINK:()=>fn,SELECTOR_MAS_ELEMENT:()=>Ta,SELECTOR_MAS_INLINE_PRICE:()=>F,SELECTOR_MAS_SP_BUTTON:()=>Fc,SELECTOR_MAS_UPT_LINK:()=>vn,SORT_ORDER:()=>be,STATE_FAILED:()=>xe,STATE_PENDING:()=>Fe,STATE_RESOLVED:()=>ce,SUPPORTED_COUNTRIES:()=>Xa,TAG_NAME_SERVICE:()=>Hc,TEMPLATE_PRICE:()=>Zc,TEMPLATE_PRICE_ANNUAL:()=>el,TEMPLATE_PRICE_LEGAL:()=>K,TEMPLATE_PRICE_STRIKETHROUGH:()=>Jc,TRIAL_ANALYTICS_IDS:()=>xn,Term:()=>ue,WCS_PROD_URL:()=>Va,WCS_STAGE_URL:()=>ja});var Qe=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ue=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),zc="merch",Ca=2e4,Dc="hidden",Rr="wcms:commerce:ready",Hc="mas-commerce-service",F='span[is="inline-price"][data-wcs-osi]',fn='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Fc="sp-button[data-wcs-osi]",vn='a[is="upt-link"]',Ta=`${F},${fn},${vn}`,xn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]),Bc="merch-offer:ready",Uc="merch-offer-select:ready",ka="merch-card:action-menu-toggle",$c="merch-offer:selected",Gc="merch-stock:change",qc="merch-storage:change",oe="merch-quantity-selector:change",Nr="merch-card-quantity:change",_a="merch-modal:addon-and-quantity-update",Vc="merch-search:change",La="merch-card-collection:sort",ve="merch-card-collection:literals-changed",Wt="merch-card-collection:sidenav-attached",Pa="merch-card-collection:showmore",Ma="merch-sidenav:select",Ra="aem:load",Na="aem:error",Or="mas:ready",Oa="mas:error",jc="mas-compare-chart:rehydrate",Wc="expanded-groups-change",Ia="placeholder-failed",za="placeholder-pending",Da="placeholder-resolved",Ha="Bad WCS request",Fa="Commerce offer not found",Yc="Literals URL not provided",Ba="mas:failed",se="mas:resolved",Ua="mas/commerce",$a="mas.preview",Ga="commerce.env",qa="commerce.landscape",Kc="commerce.aosKey",Xc="commerce.wcsKey",Va="https://www.adobe.com/web_commerce_artifact",ja="https://www.stage.adobe.com/web_commerce_artifact_stage",xe="failed",Fe="pending",ce="resolved",Be={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Yt="X-Request-Id",le=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Qc="UCv3",Ee=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Wa={PRODUCTION:"PRODUCTION"},Se={TWP:"twp",D2P:"d2p",CRM:"crm"},Ya=":start",Ka=":duration",Zc="price",Jc="price-strikethrough",el="annual",K="legal",tl="plan-type-text",Pe="mas-ff-defaults",pe="mas-ff-annual-price",be={alphabetical:"alphabetical",authored:"authored"},Xa=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var rl="mas-commerce-service";function bn(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Kt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function Ae(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Ir(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Ja(){return window.matchMedia("(max-width: 1024px)").matches}var Za=new Map,al=0;function yn(e,r){let t=++al,a=r,i=performance.now(),n,o=()=>{ei(t),e()},s=()=>{i=performance.now(),n=setTimeout(o,a)},c=()=>{document.visibilityState==="hidden"?(clearTimeout(n),a-=performance.now()-i):s()};return Za.set(t,()=>{clearTimeout(n),document.removeEventListener("visibilitychange",c)}),document.addEventListener("visibilitychange",c),document.visibilityState!=="hidden"&&s(),t}function ei(e){let r=Za.get(e);r&&(r(),Za.delete(e))}function Xt(){return document.getElementsByTagName(rl)?.[0]}function Qt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var il=["adobe.com","adobeioruntime.net","aem.live","aem.page"],nl=["localhost","127.0.0.1"];function wn(e){try{let r=new URL(e);return nl.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:il.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as zr,nothing as ol}from"./lit-all.min.js";var mt,Zt=class Zt{constructor(r){g(this,"card");A(this,mt);this.card=r,this.insertVariantStyle()}getContainer(){return S(this,mt,v(this,mt)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,mt)}insertVariantStyle(){let r=this.constructor.name;if(!Zt.styleMap[r]){Zt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(h=>h.style.getPropertyValue(l)),u=0,m=o.map(h=>{h.style.removeProperty(l);let p=c(h);if(!p)return p;let f=Math.max(0,parseInt(window.getComputedStyle(p).height)||0);return f>u&&(u=f),p});o.forEach((h,p)=>{m[p]?.tagName!=="HR"&&(u>0?h.style.setProperty(l,`${u}px`):d[p]&&h.style.setProperty(l,d[p]))})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),zr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Jt,css as cl}from"./lit-all.min.js";var An=`
:root {
...
`;var Hr=class extends y{constructor(r){super(r)}getGlobalCSS(){return Tn}renderLayout(){return kn` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":kn`<hr />`} ${this.secureLabelFooter}`}};import{html as Ue,css as Rl,unsafeCSS as Wn}from"./lit-all.min.js";var _n=`
  :root {
...
`;var Ln="tacocat.js";var ri=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),Pn=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function B(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=gt(a)?a:e;n=o.get(s)}if(i&&n==null){let o=gt(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=dl(gt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var ll=e=>typeof e=="boolean",Fr=e=>typeof e=="function",Br=e=>typeof e=="number",Mn=e=>e!=null&&typeof e=="object";var gt=e=>typeof e=="string",ai=e=>gt(e)&&e,ft=e=>Br(e)&&Number.isFinite(e)&&e>0;function Ur(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function T(e,r){if(ll(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function er(e,r,t){let a=Object.values(r);return a.find(i=>ri(i,e))??t??a[0]}function dl(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function Rn(e,r=1){return Br(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var hl=Date.now(),ii=()=>`(+${Date.now()-hl}ms)`,$r=new Set,pl=T(B("tacocat.debug",{},{metadata:!1}),!1);function Nn(e){let r=`[${Ln}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=pl?(o,...s)=>{console.debug(`${r} ${o}`,...s,ii())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;$r.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;$r.forEach(([,l])=>l(c,...s))}}}function ml(e,r){let t=[e,r];return $r.add(t),()=>{$r.delete(t)}}ml((e,...r)=>{console.error(e,...r,ii())},(e,...r)=>{console.warn(e,...r,ii())});var ul="no promo",On="promo-tag",gl="yellow",fl="neutral",vl=(e,r,t)=>{let a=n=>n||ul,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Gr="cancel-context",qr=(e,r)=>{let t=e===Gr,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?On:`${On} no-promo`,text:vl(o,r,i),variant:n?gl:fl,isOverriden:i}};var ni;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(ni||(ni={}));var me;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(me||(me={}));var ge;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(ge||(ge={}));var oi;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(oi||(oi={}));var si;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(si||(si={}));var ci;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(ci||(ci={}));var li;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(li||(li={}));var di="ABM",hi="PUF",pi="M2M",mi="PERPETUAL",ui="P3Y",xl="TAX_INCLUSIVE_DETAILS",bl="TAX_EXCLUSIVE",In={ABM:di,PUF:hi,M2M:pi,PERPETUAL:mi,P3Y:ui},Xp={[di]:{commitment:me.YEAR,term:ge.MONTHLY},[hi]:{commitment:me.YEAR,term:ge.ANNUAL},[pi]:{commitment:me.MONTH,term:ge.MONTHLY},[mi]:{commitment:me.PERPETUAL,term:void 0},[ui]:{commitment:me.THREE_MONTHS,term:ge.P3Y}},zn="Value is not an offer",Vr=e=>{if(typeof e!="object")return zn;let{commitment:r,term:t}=e,a=yl(r,t);return{...e,planType:a}};var yl=(e,r)=>{switch(e){case void 0:return zn;case"":return"";case me.YEAR:return r===ge.MONTHLY?di:r===ge.ANNUAL?hi:"";case me.MONTH:return r===ge.MONTHLY?pi:"";case me.PERPETUAL:return mi;case me.TERM_LICENSE:return r===ge.P3Y?ui:"";default:return""}};function Dn(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==xl)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:bl}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Je={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Hn=1e3;function wl(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Fn(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Je.serializableTypes.includes(t))return t}return e}function El(e,r){if(!Je.ignoredProperties.includes(e))return Fn(r)}var gi={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(wl(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(Fn).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${Je.delimiter}page=${o}${s}`;c.length>Hn&&(c=`${c.slice(0,Hn)}<trunc>`),n+=c,i.length&&(n+=`${Je.delimiter}facts=`,n+=JSON.stringify(i,El)),window.lana?.log(n,Je)}};function jr(e){Object.assign(Je,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in Je&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Bn={LOCAL:"local",PROD:"prod",STAGE:"stage"},fi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},vi=new Set,xi=new Set,Un=new Map,$n={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},Gn={filter:({level:e})=>e!==fi.DEBUG},Sl={filter:()=>!1};function Al(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&Fr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function Cl(e){[...xi].every(r=>r(e))&&vi.forEach(r=>r(e))}function qn(e){let r=(Un.get(e)??0)+1;Un.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>qn(`${a.namespace}/${i}`),updateConfig:jr};return Object.values(fi).forEach(i=>{a[i]=(n,...o)=>Cl(Al(i,n,e,o,t))}),Object.seal(a)}function Wr(...e){e.forEach(r=>{let{append:t,filter:a}=r;Fr(a)&&xi.add(a),Fr(t)&&vi.add(t)})}function Tl(e={}){let{name:r}=e,t=T(B("commerce.debug",{search:!0,storage:!0}),r===Bn.LOCAL);return Wr(t?$n:Gn),r===Bn.PROD&&Wr(gi),ae}function kl(){vi.clear(),xi.clear()}var ae={...qn(Ua),Level:fi,Plugins:{consoleAppender:$n,debugFilter:Gn,quietFilter:Sl,lanaAppender:gi},init:Tl,reset:kl,use:Wr};var _l="mas-commerce-service",Ll=ae.module("utilities"),Pl={requestId:Yt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function tr(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map(Dn)),a}var Vn=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function bi(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let u=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?s.priceDetails?.formatString:s[l];m!==u&&Ll.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:u,actual:m})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=Vn(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=Vn(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var Yr=e=>window.setTimeout(e);function vt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(Rn).filter(ft);return t.length||(t=[r]),t}function Ml(e){return e==null?[]:Array.isArray(e)?e:String(e).split(",").map(r=>r.trim())}function Kr(e,r){let t=Ml(r);if(e==null)return{wcsOsi:[],promotionCodes:t};let a=Array.isArray(e)?e:String(e).split(",");if(t.length<=1)return{wcsOsi:a.filter(ai),promotionCodes:t};let i=[],n=[];return a.forEach((o,s)=>{ai(o)&&(i.push(o),n.push(t[s]??""))}),{wcsOsi:i,promotionCodes:n}}function V(){return document.getElementsByTagName(_l)?.[0]}function jn(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(Pl)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var Nl=32,Yn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"};function rr(e,r,t,a){e?.featureFlags[pe]&&r.options[a]?t.dataset[a]="false":r.options[a]&&(r.dataset[a]="false")}var xt=class extends y{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Ue`<slot name="secure-transaction-label">
    ...
    `);import{html as Xr,css as Ol,unsafeCSS as yi,nothing as Il}from"./lit-all.min.js";var Kn=`
  :root {
...
`;var zl=32,Dl=0,Hl=()=>`mweb-list-${Dl+=1}`,Fl=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],Bl=8,Xn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ce,et,yt,wt,Et,$e,wi,Ei,bt=class extends y{constructor(t){super(t);A(this,$e);A(this,Ce);A(this,et);A(this,yt);A(this,wt,0);A(this,Et);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Xr` <footer>
        ...
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(oe,this.updatePriceQuantity),S(this,wt,this.card.getBoundingClientRect().width),S(this,et,new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t!==v(this,wt)&&(S(this,wt,t),clearTimeout(v(this,yt)),S(this,yt,setTimeout(()=>this.reconcileBreakpoint(),150)))})),v(this,et).observe(this.card)}disconnectedCallbackHook(){this.card.removeEventListener(oe,this.updatePriceQuantity),clearTimeout(v(this,yt)),v(this,et)?.disconnect(),S(this,et,null),v(this,Ce)?.disconnect(),S(this,Ce,null)}reconcileBreakpoint(){C.isMobile?(this.resetSyncedHeights(),this.removeEmptyRows()):G(this,$e,Ei).call(this)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}syncHeights(){if(C.isMobile)return;if(this.card.getBoundingClientRect().width<=2){v(this,Ce)||(S(this,Ce,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Ce)?.disconnect(),S(this,Ce,null),this.syncHeights())})),v(this,Ce).observe(this.card));return}let t=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)}))),this.adjustMiniCompareFooterRows()}priceOptionsProvider(t,a){if(t.dataset.template===K){a.displayPlanType=this.card?.settings?.displayPlanType??!1;return}let i=V();(t.dataset.template==="strikethrough"||t.dataset.template==="price"&&!i.featureFlags[pe])&&(a.displayPerUnit=!1)}getGlobalCSS(){return Kn}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="footer-rows"] ul');!t||!t.children||[...t.children].forEach((a,i)=>{let n=Math.max(zl,parseFloat(window.getComputedStyle(a).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(a=>{let i=a.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&a.remove()})}setupToggle(){let t=this.card.querySelector('[slot="body-xs"]'),a=t?.querySelector("p"),i=t?.querySelector("ul");if(!a||!i||t.querySelector(".footer-rows-title"))return;let n=a.textContent.trim(),o=this.card.querySelector("h3")?.id,s=o?`${o}-list`:Hl();i.id=s,i.classList.add("checkmark-copy-container");let c=Ae("h4",{class:"footer-rows-title"},n),l=Ae("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":s});S(this,Et,{toggleBtn:l,listEl:i}),c.append(l),c.addEventListener("click",()=>{C.isMobile&&this.setListOpen(!this.isListOpen)}),a.replaceWith(c)}get isListOpen(){return v(this,Et)?.listEl.classList.contains("open")??!1}setListOpen(t){let{toggleBtn:a,listEl:i}=v(this,Et);i.classList.toggle("open",t),a.classList.toggle("expanded",t),a.setAttribute("aria-expanded",String(t))}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${F}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{let t=V();this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let a=this.mainPrice;if(!a)return;let i=a.cloneNode(!0);if(await a.onceSettled(),!a?.options)return;a.options.displayPlanType&&(a.dataset.displayPlanType="false"),rr(t,a,i,"displayTax"),rr(t,a,i,"displayPerUnit"),i.setAttribute("data-template","legal"),a.parentNode.insertBefore(i,a.nextSibling),await i.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Il:Xr`<slot name="icons"></slot>`}renderLayout(){return Xr`
            ${this.badge}
            <div class="body">
                <div class="body-main">
                    ${this.icons}
        ...
        `}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),C.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),C.isMobile||await G(this,$e,Ei).call(this)}resetSyncedHeights(){let t=this.getContainer();if(!t)return;let a=this.card.variant,i=G(this,$e,wi).call(this,t);for(let n of Fl){let o=`--consonant-merch-card-${a}-${n}-height`;t.style.removeProperty(o),i.forEach(s=>s.style.removeProperty(o))}for(let n=1;n<=Bl;n+=1)t.style.removeProperty(this.getRowMinHeightPropertyName(n))}};Ce=new WeakMap,et=new WeakMap,yt=new WeakMap,wt=new WeakMap,Et=new WeakMap,$e=new WeakSet,wi=function(t){return t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)},Ei=async function(){let t=this.getContainer();if(!t)return;let a=Array.from(G(this,$e,wi).call(this,t));this.card===a[0]&&(await Promise.all(a.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),requestAnimationFrame(()=>{this.resetSyncedHeights(),this.syncHeights()}))},g(bt,"variantStyle",Ol`
        ...
        @media screen and ${yi(_)} {
            :host([variant='mini-compare-chart-mweb']) footer {
                padding: 0;
            }
        }

        @media screen and ${yi(L)} {
            :host([variant='mini-compare-chart-mweb'])
                .price-wrapping
                > slot[name='subtitle'] {
                min-height: var(
    ...
    `);import{html as ar,css as Ul,nothing as Qr}from"./lit-all.min.js";var Qn=`
:root {
...
`;var Zr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Zn={...(function(){let{whatsIncluded:e,size:r,...t}=Zr;return t})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Jn={...(function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=Zr;return i})()},Te,ke,de=class extends y{constructor(t){super(t);A(this,Te);A(this,ke);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===K&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Qn}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(s)){if(o?.classList.toggle("wide-footer",C.isDesktopOrUp),!i&&c){if(l)c.remove();else{let u=d.querySelector(`[data-placeholder-for="${t}"]`);u?u.replaceWith(c):d.appendChild(c)}return}if(i&&l){let u=document.createElement("div");if(u.setAttribute("data-placeholder-for",t),u.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);o.prepend(m)}l.replaceWith(u)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],C.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],C.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,Te)||(S(this,Te,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Te)?.disconnect(),S(this,Te,null),this.syncHeights())})),v(this,Te).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),a.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Qt(d));let u=this.card.querySelector('[slot="subtitle"]');u&&(l+=Qt(u));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+Qt(m));for(let p of a.childNodes){if(p.classList.contains("spacer"))break;l+=Qt(p)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${F}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?ar`<div class="divider"></div>`:Qr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${F}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?ar`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Te=new WeakMap,ke=new WeakMap,g(de,"variantStyle",Ul`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(C.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?C.isMobile?Me`
        ...
        `:Me`
            ...
            `:Jr}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?Me`<slot name="icons"></slot>`:Jr}get secureLabelFooter(){return Me`<footer>
    ...
    `),g(Ge,"collectionOptions",{customHeaderArea:r=>r.sidenav?Me`<slot name="resultsText"></slot>`:Jr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let t=()=>{let a=r.querySelectorAll("merch-card");if(a.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!C.isDesktop)return;let i=0;a.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),i+=s})};C.matchDesktop.addEventListener("change",t),r.addEventListener(ve,t),r.onUnmount.push(()=>{C.matchDesktop.removeEventListener("change",t),r.removeEventListener(ve,t)})}});import{html as Re,css as Gl,nothing as St,unsafeCSS as ir}from"./lit-all.min.js";var ao=`
:root {
...
`;var[Xm,Qm,io,no,oo,so]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var ta="pro",Si=`--consonant-merch-card-${ta}-top-card-height`,ea=[{prop:`--consonant-merch-card-${ta}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${ta}-name-description-height`,selector:".name-description"}],co=`--consonant-merch-card-${ta}-strike-reserve`,Ai='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',ql="(min-width: 768px)",lo={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Ne,tt,cr,lr,X,ho,nr,po,or,Ci,ra,aa=class aa extends y{constructor(t){super(t);A(this,X);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);A(this,Ne,null);A(this,tt,null);A(this,cr,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);A(this,lr,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of G(this,X,ho).call(this)){let n=i.variantLayout;n instanceof aa&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?G(this,X,Ci).call(this):G(this,X,or).call(this),this.card.requestUpdate()});A(this,ra,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case no:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:G(this,X,or).call(this);break;case io:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:G(this,X,or).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case oo:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}G(this,X,or).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),G(this,X,Ci).call(this);break;case so:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,G(this,X,nr).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(oe,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return ao}priceOptionsProvider(t,a){t.dataset.template===K&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(se,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]');if(!t?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=t.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${F}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=Si,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(ql).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,u)=>{let m=l(u);return m?Math.max(d,parseInt(getComputedStyle(m).height)||0):d},0);for(let c of o.values()){if(c.forEach(m=>this.clearSyncedHeights(m)),c.length<2)continue;let l=c.map(m=>m.querySelector(Ai)&&parseInt(getComputedStyle(m.querySelector(Ai)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((m,h)=>{let p=d-l[h];p>0&&m.style.setProperty(co,`${p}px`)});for(let m of ea){let h=s(c,p=>p.shadowRoot?.querySelector(m.selector));h>0&&c.forEach(p=>p.style.setProperty(m.prop,`${h}px`))}let u=s(c,m=>m.shadowRoot?.querySelector(".top-card"));u>0&&c.forEach(m=>m.style.setProperty(i,`${u}px`))}}clearSyncedHeights(t){t.style.removeProperty(Si),t.style.removeProperty(co),ea.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(Ai),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Nr,v(this,lr)),this.card.addEventListener(oe,this.updatePriceQuantity),this.card.addEventListener(se,v(this,cr)),typeof ResizeObserver>"u"))return;S(this,tt,new ResizeObserver(()=>this.resyncOnReflow())),v(this,tt).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,tt).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(oe,this.updatePriceQuantity),this.card?.removeEventListener(se,v(this,cr)),G(this,X,nr).call(this),v(this,tt)?.disconnect(),this.card?.removeEventListener(Nr,v(this,lr))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Re`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Re`
        ...
        `}renderLayout(){let t=!!this.expanded;return Re`
            ...
            <slot></slot>
        `}};Ne=new WeakMap,tt=new WeakMap,cr=new WeakMap,lr=new WeakMap,X=new WeakSet,ho=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},nr=function(){v(this,Ne)&&(document.removeEventListener("mousedown",v(this,Ne)),S(this,Ne,null))},po=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},or=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=G(this,X,po).call(this),v(this,Ne)||(S(this,Ne,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),G(this,X,nr).call(this))}),document.addEventListener("mousedown",v(this,Ne)))},Ci=function(){this.licenseOpen=!1,G(this,X,nr).call(this)},ra=new WeakMap,g(aa,"variantStyle",Gl`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
        ...
        :host([variant='pro']) .mnemonic {
            ...
            align-items: center;
            gap: 12px;
            min-height: var(${ir(ea[0].prop)}, auto);
        }
        ...
        :host([variant='pro']) .name-description {
            ...
            flex: 0 0 auto;
            min-height: var(${ir(ea[1].prop)}, auto);
        }
    ...
    `);var sr=aa;import{html as Ti,css as Vl}from"./lit-all.min.js";var mo=`
:root {
...
`;var uo={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},_e,At=class extends y{constructor(t){super(t);A(this,_e);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return mo}priceOptionsProvider(t,a){t.dataset.template===K&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return Ti` ${this.badge}
    ...
    `);import{html as jl,css as Wl}from"./lit-all.min.js";var go=`
...
`;var fo={cardName:{attribute:"name"},mnemonics:{size:"l"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},planType:!0,promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},Ct=class extends y{getGlobalCSS(){return go}priceOptionsProvider(r,t){r.dataset.template===K&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.card.querySelector(`[slot="heading-xs"] ${F}[data-template="price"]`);if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}renderLayout(){return jl` ${this.badge}
            <div class="body">
                <slot name="icons"></slot>
                <slot name="badge"></slot>
                <slot name="heading-s"></slot>
            ...
            <slot></slot>`}};g(Ct,"variantStyle",Wl`
    ...
    `);import{html as ki,css as Yl}from"./lit-all.min.js";var vo=`
:root {
...
`;var xo={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Tt=class extends y{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===K&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return vo}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${F}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return ki`
    ...
    `);import{html as Kl,css as Xl}from"./lit-all.min.js";var bo=`
...
`;var yo={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},kt=class extends y{constructor(r){super(r)}getGlobalCSS(){return bo}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Kl`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as _i,css as Ql}from"./lit-all.min.js";var wo=`
:root {
...
`;var Eo={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},_t=class extends y{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return wo}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${F}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return _i`${this.cardImage}
            ...
            ${this.evergreen?_i`
                  ...
                  `:_i`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(_t,"variantStyle",Ql`
    ...
    `);import{html as Ao,css as Zl}from"./lit-all.min.js";var So=`
:root {
...
`;var Li={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Lt=class extends y{getGlobalCSS(){return So}get aemFragmentMapping(){return Li}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return Ao`<div
    ...
    `);import{html as To,css as Jl}from"./lit-all.min.js";var Co=`
:root {
...
`;var Pi={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},dr=class dr extends y{getGlobalCSS(){return Co}get aemFragmentMapping(){return Pi}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return To`<div
        ...
        >
            ...
            <slot></slot>
        `}};g(dr,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(dr,"variantStyle",Jl`
    ...
    `);var hr=dr;import{html as pr,nothing as _o}from"./lit-all.min.js";import{css as ed,unsafeCSS as td}from"./lit-all.min.js";var ko=["headless","marquee","faq","banner-blade"],Pt=(e,r="")=>ko.map(t=>`merch-card[variant='${t}'] [slot='${e}']${r}`).join(`,
`),Mi=e=>ko.map(r=>`merch-card[variant='${r}'] ${e}`).join(`,
`),qe=`
...
`;function Ve(e){let r=td(e);return ed`
        :host([variant='${r}']) {
            border: none;
            background: transparent;
            box-shadow: none;
    ...
    `}var Lo={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},rd=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Mt=class extends y{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return pr`
        ...
        `}};g(Mt,"variantStyle",Ve("headless"));import{css as ad,html as id}from"./lit-all.min.js";var Po=`
...
`;var Mo={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Rt=class extends y{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Po}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${F}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return id`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as nd,css as od}from"./lit-all.min.js";var Ro=`
...
`;var Ri={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},sd=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],ia,No,Nt=class extends y{constructor(t){super(t);A(this,ia);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ro}get aemFragmentMapping(){return Ri}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,G(this,ia,No).call(this))}renderLayout(){return nd`
            <div class="card">
            ...
            <slot></slot>
        `}};ia=new WeakSet,No=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;sd.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(Nt,"variantStyle",od`
    ...
    `);import{html as cd,css as ld}from"./lit-all.min.js";var Oo=`
...
`;var Ni={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ot=class extends y{getGlobalCSS(){return Oo}get aemFragmentMapping(){return Ni}renderLayout(){return cd`
    ...
    `);import{html as Oi,nothing as dd}from"./lit-all.min.js";var Io={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},hd=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],It=class extends y{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return Oi`
            <div class="headless">
                ${hd.map(({slot:r,label:t})=>Oi`
                        <div class="headless-row">
        ...
        `}};g(It,"variantStyle",Ve("marquee"));import{html as zo}from"./lit-all.min.js";var Do={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},pd=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],zt=class extends y{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return zo`
            <div class="headless">
                ${pd.map(({slot:r,label:t})=>zo`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value">
                                <slot name="${r}"></slot>
        ...
        `}};g(zt,"variantStyle",Ve("faq"));import{html as Ho}from"./lit-all.min.js";var Fo={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},md=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],Dt=class extends y{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return Ho`
            <div class="headless">
                ${md.map(({slot:r,label:t})=>Ho`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value" data-slot="${r}">
                                <slot name="${r}"></slot>
        ...
        `}};g(Dt,"variantStyle",Ve("banner-blade"));import{html as ud,css as gd}from"./lit-all.min.js";var Bo=`
...
`;var Uo=L,$o=["heading-s","body-xs","heading-xs"],Go={cardName:{attribute:"name"},mnemonics:{size:"s"},badge:{tag:"div",slot:"badge"},title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},planType:!0,style:"consonant"},je,mr,Ht=class extends y{constructor(){super(...arguments);A(this,je,null);A(this,mr,()=>this.resyncOnReflow());g(this,"lastSyncKey",null)}getGlobalCSS(){return Bo}get headingSelector(){return'[slot="heading-s"]'}priceOptionsProvider(t,a){t.dataset.template===K&&(a.displayPlanType=this.card?.settings?.displayPlanType??!0)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.card.querySelector(`[slot="heading-xs"] ${F}:not([data-template="legal"])`);if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook(),this.flagPriceRow(),window.matchMedia(Uo).matches&&requestAnimationFrame(()=>this.syncHeights()))}syncHeights(){this.card.getBoundingClientRect().width<=2||window.matchMedia(Uo).matches&&this.syncRowHeights($o.map(t=>({name:t,getElement:a=>a.querySelector(`[slot="${t}"]`)})))}flagPriceRow(){this.card.toggleAttribute("no-price",!this.card.querySelector('[slot="heading-xs"]'))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=n=>Math.round(this.card.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),...$o.map(n=>a(`[slot="${n}"]`))].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(this.card.addEventListener(se,v(this,mr)),typeof ResizeObserver>"u")return;S(this,je,new ResizeObserver(()=>this.resyncOnReflow())),v(this,je).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,je).observe(t)}disconnectedCallbackHook(){this.card.removeEventListener(se,v(this,mr)),v(this,je)?.disconnect(),S(this,je,null)}renderLayout(){return ud` <div class="header">
                <slot name="icons"></slot>
                <slot name="badge"></slot>
            </div>
            <div class="panel">
            ...
            <slot></slot>`}};je=new WeakMap,mr=new WeakMap,g(Ht,"variantStyle",gd`
    ...
    `);var qo=new Map;var U=(e,r,t=null,a=null,i)=>{qo.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};U("catalog",ut,Sn,ut.variantStyle);U("image",Ze);U("inline-heading",Hr);U("mini-compare-chart",xt,Yn,xt.variantStyle);U("mini-compare-chart-mweb",bt,Xn,bt.variantStyle);U("plans",de,Zr,de.variantStyle,de.collectionOptions);U("plans-students",de,Jn,de.variantStyle,de.collectionOptions);U("plans-education",de,Zn,de.variantStyle,de.collectionOptions);U("plans-v2",Ge,ro,Ge.variantStyle,Ge.collectionOptions);U("pro",sr,lo,sr.variantStyle);U("product",At,uo,At.variantStyle);U("brand-concierge-product",Ct,fo,Ct.variantStyle);U("segment",Tt,xo,Tt.variantStyle);U("media",kt,yo,kt.variantStyle);U("headless",Mt,Lo,Mt.variantStyle);U("special-offers",_t,Eo,_t.variantStyle);U("simplified-pricing-express",Lt,Li,Lt.variantStyle);U("full-pricing-express",hr,Pi,hr.variantStyle);U("mini",Rt,Mo,Rt.variantStyle);U("image",Ze,Cn,Ze.variantStyle);U("compare-chart-column",Nt,Ri,Nt.variantStyle);U("fries",Ot,Ni,Ot.variantStyle);U("marquee",It,Io,It.variantStyle);U("faq",zt,Do,zt.variantStyle);U("banner-blade",Dt,Fo,Dt.variantStyle);U("product-pricing",Ht,Go,Ht.variantStyle);function Dr(e){return qo.get(e)?.fragmentMapping}var jo=e=>{let r=e.replace(/^mas:/,"").split("/");return r.length<2?[null,null]:[r[0],r[r.length-1]]},Vo=(e,r)=>{let t=r?.tagLabels?.[e]||e;return t.startsWith("coll-tag-filter")?e.charAt(0).toUpperCase()+e.slice(1):t},Wo=(e,r,t)=>{let a=new Map;for(let n of e){let[o,s]=jo(n);!o||!s||(a.has(o)||a.set(o,[]),a.get(o).push({name:s,label:Vo(s,t)}))}let i=a.size===1;return[...a.entries()].map(([n,o])=>({title:i&&r?r:Vo(n,t),label:n,deeplink:n,checkboxes:o}))},Yo=(e,r)=>(e??[]).map(jo).filter(([t,a])=>t&&a&&r.has(t)).map(([t,a])=>`${t}:${a}`),Ko=(e,r,t)=>r.every(a=>{let i=(t[a.deeplink]||"").split(",").filter(Boolean);return i.length?i.some(n=>e.includes(`${a.deeplink}:${n}`)):!0});var Ft=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(Yt);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var fd={[xe]:Ia,[Fe]:za,[ce]:Da},vd={[xe]:Ba,[ce]:se},ur,We=class{constructor(r){A(this,ur);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",Fe);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=ae.module("mas-element")}update(){[xe,Fe,ce].forEach(r=>{this.wrapperElement.classList.toggle(fd[r],r===this.state)})}notify(){(this.state===ce||this.state===xe)&&(this.state===ce?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===xe&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof Ft&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(vd[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){S(this,ur,V()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return ce===a?Promise.resolve(this.wrapperElement):xe===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=ce,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Yr(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=xe,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,ur)?.duration}),Yr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=Fe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!V()||this.timer)return;let{error:t,options:a,state:i,value:n,version:o}=this;this.state=Fe,this.timer=Yr(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===Fe&&this.version===o&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};ur=new WeakMap;function Xo(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function na(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,Xo(r)),i}function Qo(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Xo(r)),e):null}function xd(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var it,rt=class rt extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new We(this));A(this,it);this.setAttribute("is",rt.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),S(this,it,Xt()),v(this,it)&&(this.log=v(this,it).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),S(this,it,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Xt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=a,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,u=this.getAttribute("data-promotion-code");u&&(d+=`&promotion_code=${encodeURIComponent(u)}`),this.href=`${xd(l)}?${d}`,this.masElement.toggleResolved(i,o,a)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,a),!1}}static createFrom(t){let a=new rt;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};it=new WeakMap,g(rt,"is","upt-link"),g(rt,"tag","a"),g(rt,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var at=rt;window.customElements.get(at.is)||window.customElements.define(at.is,at,{extends:at.tag});function Zo(e){return e&&(e==="bizpro"&&(e="pro"),e==="pro"||e.startsWith("plans")?"plans":e)}var bd="p_draft_landscape",yd="/store/",wd=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),Ii=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Ed=["env","workflowStep","clientId","country"],Sd=["/tw/","/hk_zh/"];function Ad(e){let r=e??"";return Sd.some(t=>r.startsWith(t))}function Cd(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(Ad)}function gr(e){if(!Cd())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var Jo=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),es=e=>wd.get(e)??e;function oa(e,r,t){for(let[a,i]of Object.entries(e)){let n=es(a);i!=null&&t.has(n)&&r.set(n,i)}}function Td(e){return e===Wa.PRODUCTION?"https://commerce.adobe.com":"https://commerce-stg.adobe.com"}function kd(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let o=es(i);r.set(`items[${t}][${o}]`,n)}}}function _d({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===Se.CRM?"creative":"mini_plans"),e}function Ld(e){let r=e.indexOf("?");return r===-1?e:e.slice(0,r)}function Pd(e){let r=new URLSearchParams(window.location.search),t={};Jo.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=Ld(i))}),Object.keys(t).length>0&&oa(t,e.searchParams,Jo)}function ts(e){Md(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:u,...m}=e,h=new URL(Td(r));if(h.pathname=`${yd}${a}`,a!==le.SEGMENTATION&&a!==le.CHANGE_PLAN_TEAM_PLANS&&kd(t,h.searchParams),oa({...m},h.searchParams,Ii),Pd(h),c===Be.DRAFT&&oa({af:bd},h.searchParams,Ii),a===le.SEGMENTATION){let p={marketSegment:i,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};u?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):u?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),oa(p,h.searchParams,Ii),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=_d({url:h,modal:l,is3in1:d})}return gr(h)}function Md(e){for(let r of Ed)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==le.SEGMENTATION&&e.workflowStep!==le.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var Rd=2e4;function Nd(e,r,t){let a,i=new Promise((n,o)=>{a=setTimeout(()=>o(new Error(`AUP host timed out: ${r}`)),t)});return Promise.race([e,i]).finally(()=>clearTimeout(a))}function sa(e,r){return e.length>0&&!r.upgrade&&!r.perpetual&&!e.some(t=>t.commitment==="PERPETUAL")}function Od(e,r){if(!sa(e,r))return;let[t]=e,a={clientId:r.checkoutClientId,clientType:"web",co:r.country,pa:t.productArrangementCode,cs:r.cs,ms:r.ms};a.clientId!=="doc_cloud"&&Object.values(Se).includes(r.modal)&&(a.clientId=r.modal===Se.CRM?"creative":"mini_plans");let i=r.preselectPlan?.toLowerCase();i==="edu"&&(a.ms="EDU"),i==="team"&&(a.cs="TEAM");let n=t.productArrangement?.productCode;n&&(a.pc=n);for(let c of["svar","customerIntent","sid"])r[c]&&(a[c]=r[c]);let o=new URL("https://commerce.adobe.com");o.searchParams.set("lang",r.language);let s={lang:new URL(gr(o)).searchParams.get("lang"),nr:"stable",ctxrturl:r.ctxrturl??window.location.href,ot:t.offerType,items:e.map(({offerId:c},l)=>{let d=r.q??r.quantity?.[l]??r.quantity?.[0];return d==null?c:`${c}|${d}`}).join(",")};for(let[c,l]of Object.entries({step:r.checkoutWorkflowStep,apc:r.promotionCode,ao:r.addonProductArrangementCode,code:r.authCode,soSu:r["so.su"],soCa:r["so.ca"],soVa:r["so.va"],soTr:r["so.tr"],contextGuid:r["context.guid"],dcwatc:r.DCWATC}))l!=null&&(s[c]=l);for(let c of["step","apc","ao","ctx","ijt","otac","nglwfdata","appctxid","soSu","soCa","soVa","soTr","promoid","sdid","trackingid","mv","mv2","contextGuid","ai","sc","th","lo","gsp","spint","mal","csm","af","rf","usid","dcwatc","cf","rtc","ccli","csc","referrer","code","ew","pp","token","mat","pcid"])r[c]!=null&&(s[c]=r[c]);return{intent:t.offerType==="TRIAL"?"try":"buy",context:a,params:s,enableRenderIn:"iframe"}}async function rs(e,r,t,a,i=Rd){let n=Od(r,t);if(!n)return!1;let o=await Nd(e.getOrchestratorContext(),"getOrchestratorContext",i);if(typeof o?.launchWorkflowInModal!="function")return!1;let s,c;if(a){let d=o.clientMessageHandler;c=(u,m,h)=>{let p=m?.data?.actions;return u==="System"&&m?.subType==="AppClosed"&&Array.isArray(p)&&(s=p.find(f=>f?.required&&f.actionMessage?.type==="System"&&f.actionMessage?.subType==="ReportState")?.actionMessage.data?.commerce?.cart),typeof d=="function"?d(u,m,h):h(u,m)}}ae.module("aup-select").debug("Launching workflow:",n);let l=await(c?o.launchWorkflowInModal(n,c):o.launchWorkflowInModal(n));return l?.status==="cancel"&&Array.isArray(s)&&s.every(d=>typeof d?.productArrangementCode=="string")&&s.some(d=>d?.productArrangementCode===n.context.pa)&&a?.(s),l?.status!=="no-workflow-found"}var Id=/[0-9\-+#]/,zd=/[^\d\-+#]/g;function as(e){return e.search(Id)}function Dd(e="#.##"){let r={},t=e.length,a=as(e);r.prefix=a>0?e.substring(0,a):"";let i=as(e.split("").reverse().join("")),n=t-i,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=i>0?e.substring(s,t):"",r.mask=e.substring(a,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(zd);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function Hd(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=i.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),i.integer=o,i.fraction=s,Fd(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function Fd(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function Bd(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=Dd(e),i=Hd(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var is=Bd;var ns=".",Ud=",",ss=/^\s+/,cs=/\s+$/,os="&nbsp;",zi=e=>e*12,ot=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),u=new Date(i);return l>=d&&l<=u},nt={MONTH:"MONTH",YEAR:"YEAR"},$d={[ue.ANNUAL]:12,[ue.MONTHLY]:1,[ue.THREE_YEARS]:36,[ue.TWO_YEARS]:24},Di=(e,r)=>({accept:e,round:r}),Gd=[Di(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),Di(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),Di(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],Hi={[Qe.YEAR]:{[ue.MONTHLY]:nt.MONTH,[ue.ANNUAL]:nt.YEAR},[Qe.MONTH]:{[ue.MONTHLY]:nt.MONTH}},qd=(e,r)=>e.indexOf(`'${r}'`)===0,Vd=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=ds(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Wd(e)}`),t},jd=e=>{let r=Yd(e),t=qd(e,r),a=e.replace(/'.*?'/,""),i=ss.test(a)||cs.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},ls=e=>e.replace(ss,os).replace(cs,os),Wd=e=>e.match(/#(.?)#/)?.[1]===ns?Ud:ns,Yd=e=>e.match(/'(.*?)'/)?.[1]??"",ds=e=>e.match(/0(.?)0/)?.[1]??"";function Bt({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1},i,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=jd(e),l=t?ds(e):"",d=Vd(e,t),u=t?2:0,m=n(r,{currencySymbol:o}),h=a?m.toLocaleString("hi-IN",{minimumFractionDigits:u,maximumFractionDigits:u}):is(d,m),p=t?h.lastIndexOf(l):h.length,f=h.substring(0,p),x=h.substring(p+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var hs=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=$d[t]??1;return Bt(e,i>1?nt.MONTH:Hi[r]?.[t],n=>{let o={divisor:i,price:n,usePrecision:a},{round:s}=Gd.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},ps=({commitment:e,term:r,...t})=>Bt(t,Hi[e]?.[r]),ms=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===Qe.YEAR&&c===ue.MONTHLY){if(!o)return Bt(e,nt.YEAR,zi);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(ot(o,t,s)){let u=parseInt(d.replace("P","").replace("M",""));if(isNaN(u))return zi(a);let m=i*u,h=n*(12-u),p=Math.round((m+h)*100)/100;return Bt({...e,price:p},nt.YEAR)}default:return Bt(e,nt.YEAR,()=>zi(n??a))}}return Bt(e,Hi[r]?.[c])};var ca="download",us="upgrade",gs={e:"EDU",t:"TEAM"},Fi=!1;function fs(e,r={},t=""){let a=V();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:u,quantity:m,wcsOsi:h,extraOptions:p,analyticsId:f}=a.collectCheckoutOptions(r),x=na(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:r.promotionCode===Gr?Gr:u,quantity:m,wcsOsi:h,extraOptions:p,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function vs(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new We(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler),this.addEventListener("auxclick",this.handleAupModifiedClick),this.updateCheckoutUrl()}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler),this.removeEventListener("auxclick",this.handleAupModifiedClick)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0]?.marketSegments?.[0];return gs[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return gs[a]??a}get is3in1Modal(){return Object.values(Se).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=V();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>tr(h,n));let d=l.flat().find(h=>h.promotion);!ot(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let m=await i.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},m,s)}renderOffers(a,i,n={},o=void 0,s=void 0){let c=V();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(ca,us),this.masElement.toggleResolved(s,a,i);let{url:d,text:u,className:m,handler:h}=o;d&&this.setCheckoutUrl(gr(d)),u&&(this.firstElementChild.innerHTML=u),m&&this.classList.add(...m.split(" ")),h&&(this.setCheckoutUrl(this.isOpen3in1Modal?c.buildCheckoutURL(a,i):"#"),this.checkoutActionHandler=h.bind(this)),this.updateCheckoutUrl()}if(a.length){if(this.masElement.toggleResolved(s,a,i)){if(!this.classList.contains(ca)&&!this.classList.contains(us)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(a){this.checkoutUrl=a,this.updateCheckoutUrl()}updateCheckoutUrl(a=V()?.settings?.aupSelect){if(this.checkoutUrl===void 0)return;let i=a&&this.checkoutUrl&&this.masElement.state===ce&&!this.classList.contains(ca)&&!this.hasAttribute("download")&&(!this.target||this.target==="_self")&&sa(this.value,this.options);return this.setAttribute(this.isCheckoutLink?"href":"data-href",i?"#":this.checkoutUrl),i}handleAupModifiedClick(a){return(a.metaKey||a.ctrlKey||a.shiftKey||a.altKey||a.button!==0)&&this.updateCheckoutUrl()?(a.preventDefault(),!0):!1}handleAupCheckout(a){if(this.handleAupModifiedClick(a))return!0;if(this.updateCheckoutUrl(!1),setTimeout(()=>this.updateCheckoutUrl(),0),a.defaultPrevented||a.button!==0||a.metaKey||a.ctrlKey||a.shiftKey||a.altKey||this.classList.contains(ca)||this.hasAttribute("download")||this.target&&this.target!=="_self")return!1;let i=window.aupsdk;if(this.masElement.state!==ce||!V()?.settings.aupSelect||typeof i?.getOrchestratorContext!="function")return!1;let{checkoutActionHandler:n,href:o,value:s}=this,c=this.closest("merch-card"),l=this.getAttribute("data-modal-id"),d={...this.options,cs:this.customerSegment,ms:this.marketSegment};if(!sa(s,d))return!1;if(this.updateCheckoutUrl(),a.preventDefault(),Fi)return!0;let u=()=>{if(n)return n(a);o&&(window.location.href=o)},m;return Fi=!0,this.aupCheckoutPromise=rs(i,s,d,c&&l?h=>{m=h}:void 0).catch(h=>(this.masElement.log?.error("AUP checkout launch failed",h),!1)).then(async h=>{if(!h)try{return await u()}catch(p){this.masElement.log?.error("AUP checkout fallback failed",p);return}if(m)try{let p=s[0].productArrangementCode;if(this.masElement.state!==ce||this.value[0]?.productArrangementCode!==p)return;let f=[...c.querySelectorAll('merch-addon [is="inline-price"]')];if(c.addonCheckbox&&(!f.length||f.some(E=>E.masElement.state!==ce||!E.value?.length)))return;let x=f.flatMap(E=>E.value),w=m.filter(E=>E.productArrangementCode===p||x.some(b=>b.productArrangementCode===E.productArrangementCode));c.dispatchEvent(new CustomEvent(_a,{detail:{id:l,items:w,productArrangementCode:p}}))}catch(p){this.masElement.log?.warn("AUP checkout cart synchronization failed",p)}}).finally(()=>{Fi=!1}),!0}clickHandler(a){}updateOptions(a={}){let i=V();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:u,promotionCode:m,quantity:h,wcsOsi:p}=i.collectCheckoutOptions(a);return Qo(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:u,promotionCode:m,quantity:h,wcsOsi:p}),!0}}}var fr=class fr extends vs(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return fs(fr,r,t)}get isCheckoutLink(){return!0}clickHandler(r){if(!this.handleAupCheckout(r)&&this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(fr,"is","checkout-link"),g(fr,"tag","a");var Oe=fr;window.customElements.get(Oe.is)||window.customElements.define(Oe.is,Oe,{extends:Oe.tag});var N=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:le.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:Ee.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Be.PUBLISHED});function xs({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:u,quantity:m,preselectPlan:h,env:p}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:u,quantity:m,preselectPlan:h,env:p};if(o)for(let He of r.checkout)He(o,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:w=c,imsCountry:E,country:b=E??l,language:P=d,quantity:O=m,entitlement:I,upgrade:$,modal:W,perpetual:Q,promotionCode:te=u,wcsOsi:H,extraOptions:z,...re}=Object.assign(f,o?.dataset??{},n??{}),J=er(w,le,N.checkoutWorkflowStep),{wcsOsi:De,promotionCodes:fe}=Kr(H,te),ht=fe.map(He=>qr(He).effectivePromoCode);return f=Ur({...re,extraOptions:z,checkoutClientId:s,checkoutMarketSegment:x,country:b,quantity:vt(O,N.quantity),checkoutWorkflowStep:J,language:P,entitlement:T(I),upgrade:T($),modal:W,perpetual:T(Q),promotionCode:ht[0],promotionCodes:ht,wcsOsi:De,preselectPlan:h}),f}function a(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:u,country:m,promotionCode:h,quantity:p,preselectPlan:f,ms:x,cs:w,...E}=t(o),b=document.querySelector("meta[name=mas-ff-3in1]"),P=Object.values(Se).includes(o.modal)&&(!b||b.content!=="off"),O=window.frameElement||P?"if":"fp",[{productArrangementCode:I,marketSegments:[$],customerSegment:W,offerType:Q}]=n,te=x??$??d,H=w??W;f?.toLowerCase()==="edu"?te="EDU":f?.toLowerCase()==="team"&&(H="TEAM");let z={is3in1:P,checkoutPromoCode:h,clientId:l,context:O,country:m,env:s,items:[],marketSegment:te,customerSegment:H,offerType:Q,productArrangementCode:I,workflowStep:u,landscape:c,...E},re=p[0]>1?p[0]:void 0;if(n.length===1){let{offerId:J}=n[0];z.items.push({id:J,quantity:re})}else z.items.push(...n.map(({offerId:J,productArrangementCode:De})=>({id:J,quantity:re,...P?{productArrangementCode:De}:{}})));return ts(z)}let{createCheckoutLink:i}=Oe;return{CheckoutLink:Oe,CheckoutWorkflowStep:le,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}var Kd="ims_country_code";function Xd(){if(typeof document>"u")return null;let e=document.cookie.match(new RegExp(`(?:^|;\\s*)${Kd}=([^;]*)`));if(!e)return null;let r;try{r=decodeURIComponent(e[1])}catch{return null}return r.trim().toUpperCase()||null}function Qd({interval:e=200,maxAttempts:r=25}={}){let t=ae.module("ims");return new Promise(a=>{t.debug("Waiting for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function Zd(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Jd(){let e=Xd();return e&&ae.module("ims").debug("Got user country from cookie:",e),Promise.resolve(e)}function bs(){let e=Qd();return{imsReadyPromise:e,imsSignedInPromise:Zd(e),imsCountryPromise:Jd()}}var ys=window.masPriceLiterals;function ws(e){if(Array.isArray(ys)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>ys.find(n=>ri(n.lang,i)),a=t(r)??t(N.language);if(a)return Object.freeze(a)}return{}}var Bi=function(e,r){return Bi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},Bi(e,r)};function vr(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");Bi(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var M=function(){return M=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},M.apply(this,arguments)};function la(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var k;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(k||(k={}));var q;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(q||(q={}));var st;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(st||(st={}));function Ui(e){return e.type===q.literal}function Es(e){return e.type===q.argument}function da(e){return e.type===q.number}function ha(e){return e.type===q.date}function pa(e){return e.type===q.time}function ma(e){return e.type===q.select}function ua(e){return e.type===q.plural}function Ss(e){return e.type===q.pound}function ga(e){return e.type===q.tag}function fa(e){return!!(e&&typeof e=="object"&&e.type===st.number)}function xr(e){return!!(e&&typeof e=="object"&&e.type===st.dateTime)}var $i=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var eh=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function As(e){var r={};return e.replace(eh,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var Cs=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Ls(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(Cs).filter(function(m){return m.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var u=d[l];if(u.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function th(e){return e.replace(/^(.*?)-/,"")}var Ts=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Ps=/^(@+)?(\+|#+)?[rs]?$/g,rh=/(\*)(0+)|(#+)(0+)|(0+)/g,Ms=/^(0+)$/;function ks(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(Ps,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function Rs(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function ah(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!Ms.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function _s(e){var r={},t=Rs(e);return t||r}function Ns(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=th(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=M(M(M({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return M(M({},c),_s(l))},{}));continue;case"engineering":r=M(M(M({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return M(M({},c),_s(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(rh,function(c,l,d,u,m,h){if(l)r.minimumIntegerDigits=d.length;else{if(u&&m)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Ms.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(Ts.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(Ts,function(c,l,d,u,m,h){return d==="*"?r.minimumFractionDigits=l.length:u&&u[0]==="#"?r.maximumFractionDigits=u.length:m&&h?(r.minimumFractionDigits=m.length,r.maximumFractionDigits=m.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=M(M({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=M(M({},r),ks(n)));continue}if(Ps.test(i.stem)){r=M(M({},r),ks(i.stem));continue}var o=Rs(i.stem);o&&(r=M(M({},r),o));var s=ah(i.stem);s&&(r=M(M({},r),s))}return r}var br={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function Os(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=ih(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function ih(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=br[a||""]||br[t||""]||br["".concat(t,"-001")]||br["001"];return i[0]}var Gi,nh=new RegExp("^".concat($i.source,"*")),oh=new RegExp("".concat($i.source,"*$"));function R(e,r){return{start:e,end:r}}var sh=!!String.prototype.startsWith,ch=!!String.fromCodePoint,lh=!!Object.fromEntries,dh=!!String.prototype.codePointAt,hh=!!String.prototype.trimStart,ph=!!String.prototype.trimEnd,mh=!!Number.isSafeInteger,uh=mh?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Vi=!0;try{Is=Fs("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Vi=((Gi=Is.exec("a"))===null||Gi===void 0?void 0:Gi[0])==="a"}catch{Vi=!1}var Is,zs=sh?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},ji=ch?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,o;i>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");a+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return a},Ds=lh?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],o=n[0],s=n[1];t[o]=s}return t},Hs=dh?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},gh=hh?function(r){return r.trimStart()}:function(r){return r.replace(nh,"")},fh=ph?function(r){return r.trimEnd()}:function(r){return r.replace(oh,"")};function Fs(e,r){return new RegExp(e,r)}var Wi;Vi?(qi=Fs("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Wi=function(r,t){var a;qi.lastIndex=t;var i=qi.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):Wi=function(r,t){for(var a=[];;){var i=Hs(r,t);if(i===void 0||Us(i)||bh(i))break;a.push(i),t+=i>=65536?2:1}return ji.apply(void 0,a)};var qi,Bs=(function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,a);if(o.err)return o;i.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:q.pound,location:R(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(k.UNMATCHED_CLOSING_TAG,R(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&Yi(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;i.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;i.push(o.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:q.literal,value:"<".concat(i,"/>"),location:R(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Yi(this.char()))return this.error(k.INVALID_TAG,R(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(k.UNMATCHED_CLOSING_TAG,R(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:q.tag,value:i,children:o,location:R(a,this.clonePosition())},err:null}:this.error(k.INVALID_TAG,R(s,this.clonePosition())))}else return this.error(k.UNCLOSED_TAG,R(a,this.clonePosition()))}else return this.error(k.INVALID_TAG,R(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&xh(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){i+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=R(a,this.clonePosition());return{val:{type:q.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!vh(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return ji.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),ji(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,R(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(k.EMPTY_ARGUMENT,R(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(k.MALFORMED_ARGUMENT,R(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,R(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:q.argument,value:i,location:R(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,R(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(k.MALFORMED_ARGUMENT,R(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=Wi(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),o=R(r,n);return{value:a,location:o}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(k.EXPECT_ARGUMENT_TYPE,R(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),u=this.parseSimpleArgStyleIfPossible();if(u.err)return u;var m=fh(u.val);if(m.length===0)return this.error(k.EXPECT_ARGUMENT_STYLE,R(this.clonePosition(),this.clonePosition()));var h=R(d,this.clonePosition());l={style:m,styleLocation:h}}var p=this.tryParseArgumentClose(i);if(p.err)return p;var f=R(i,this.clonePosition());if(l&&zs(l?.style,"::",0)){var x=gh(l.style.slice(2));if(s==="number"){var u=this.parseNumberSkeletonFromString(x,l.styleLocation);return u.err?u:{val:{type:q.number,value:a,location:f,style:u.val},err:null}}else{if(x.length===0)return this.error(k.EXPECT_DATE_TIME_SKELETON,f);var w=x;this.locale&&(w=Os(x,this.locale));var m={type:st.dateTime,pattern:w,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?As(w):{}},E=s==="date"?q.date:q.time;return{val:{type:E,value:a,location:f,style:m},err:null}}}return{val:{type:s==="number"?q.number:s==="date"?q.date:q.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(k.EXPECT_SELECT_ARGUMENT_OPTIONS,R(b,M({},b)));this.bumpSpace();var P=this.parseIdentifierIfPossible(),O=0;if(s!=="select"&&P.value==="offset"){if(!this.bumpIf(":"))return this.error(k.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,R(this.clonePosition(),this.clonePosition()));this.bumpSpace();var u=this.tryParseDecimalInteger(k.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,k.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(u.err)return u;this.bumpSpace(),P=this.parseIdentifierIfPossible(),O=u.val}var I=this.tryParsePluralOrSelectOptions(r,s,t,P);if(I.err)return I;var p=this.tryParseArgumentClose(i);if(p.err)return p;var $=R(i,this.clonePosition());return s==="select"?{val:{type:q.select,value:a,options:Ds(I.val),location:$},err:null}:{val:{type:q.plural,value:a,options:Ds(I.val),offset:O,pluralType:s==="plural"?"cardinal":"ordinal",location:$},err:null}}default:return this.error(k.INVALID_ARGUMENT_TYPE,R(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,R(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(k.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,R(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=Ls(r)}catch{return this.error(k.INVALID_NUMBER_SKELETON,t)}return{val:{type:st.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?Ns(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,o=!1,s=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var u=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var m=this.tryParseDecimalInteger(k.EXPECT_PLURAL_ARGUMENT_SELECTOR,k.INVALID_PLURAL_ARGUMENT_SELECTOR);if(m.err)return m;d=R(u,this.clonePosition()),l=this.message.slice(u.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?k.DUPLICATE_SELECT_ARGUMENT_SELECTOR:k.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?k.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:k.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,R(this.clonePosition(),this.clonePosition()));var p=this.parseMessage(r+1,t,a);if(p.err)return p;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:p.val,location:R(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?k.EXPECT_SELECT_ARGUMENT_SELECTOR:k.EXPECT_PLURAL_ARGUMENT_SELECTOR,R(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(k.MISSING_OTHER_CLAUSE,R(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=R(i,this.clonePosition());return n?(o*=a,uh(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=Hs(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(zs(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Us(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e})();function Yi(e){return e>=97&&e<=122||e>=65&&e<=90}function vh(e){return Yi(e)||e===47}function xh(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Us(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function bh(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Ki(e){e.forEach(function(r){if(delete r.location,ma(r)||ua(r))for(var t in r.options)delete r.options[t].location,Ki(r.options[t].value);else da(r)&&fa(r.style)||(ha(r)||pa(r))&&xr(r.style)?delete r.style.location:ga(r)&&Ki(r.children)})}function $s(e,r){r===void 0&&(r={}),r=M({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new Bs(e,r).parse();if(t.err){var a=SyntaxError(k[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||Ki(t.val),t.val}function yr(e,r){var t=r&&r.cache?r.cache:Ch,a=r&&r.serializer?r.serializer:Ah,i=r&&r.strategy?r.strategy:wh;return i(e,{cache:t,serializer:a})}function yh(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Gs(e,r,t,a){var i=yh(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function qs(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function Xi(e,r,t,a,i){return t.bind(r,e,a,i)}function wh(e,r){var t=e.length===1?Gs:qs;return Xi(e,this,t,r.cache.create(),r.serializer)}function Eh(e,r){return Xi(e,this,qs,r.cache.create(),r.serializer)}function Sh(e,r){return Xi(e,this,Gs,r.cache.create(),r.serializer)}var Ah=function(){return JSON.stringify(arguments)};function Qi(){this.cache=Object.create(null)}Qi.prototype.get=function(e){return this.cache[e]};Qi.prototype.set=function(e,r){this.cache[e]=r};var Ch={create:function(){return new Qi}},va={variadic:Eh,monadic:Sh};var ct;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(ct||(ct={}));var wr=(function(e){vr(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r})(Error);var Zi=(function(e){vr(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),ct.INVALID_VALUE,n)||this}return r})(wr);var Vs=(function(e){vr(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),ct.INVALID_VALUE,i)||this}return r})(wr);var js=(function(e){vr(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),ct.MISSING_VALUE,a)||this}return r})(wr);var ie;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(ie||(ie={}));function Th(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==ie.literal||t.type!==ie.literal?r.push(t):a.value+=t.value,r},[])}function kh(e){return typeof e=="function"}function Er(e,r,t,a,i,n,o){if(e.length===1&&Ui(e[0]))return[{type:ie.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(Ui(d)){s.push({type:ie.literal,value:d.value});continue}if(Ss(d)){typeof n=="number"&&s.push({type:ie.literal,value:t.getNumberFormat(r).format(n)});continue}var u=d.value;if(!(i&&u in i))throw new js(u,o);var m=i[u];if(Es(d)){(!m||typeof m=="string"||typeof m=="number")&&(m=typeof m=="string"||typeof m=="number"?String(m):""),s.push({type:typeof m=="string"?ie.literal:ie.object,value:m});continue}if(ha(d)){var h=typeof d.style=="string"?a.date[d.style]:xr(d.style)?d.style.parsedOptions:void 0;s.push({type:ie.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(pa(d)){var h=typeof d.style=="string"?a.time[d.style]:xr(d.style)?d.style.parsedOptions:a.time.medium;s.push({type:ie.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(da(d)){var h=typeof d.style=="string"?a.number[d.style]:fa(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(m=m*(h.scale||1)),s.push({type:ie.literal,value:t.getNumberFormat(r,h).format(m)});continue}if(ga(d)){var p=d.children,f=d.value,x=i[f];if(!kh(x))throw new Vs(f,"function",o);var w=Er(p,r,t,a,i,n),E=x(w.map(function(O){return O.value}));Array.isArray(E)||(E=[E]),s.push.apply(s,E.map(function(O){return{type:typeof O=="string"?ie.literal:ie.object,value:O}}))}if(ma(d)){var b=d.options[m]||d.options.other;if(!b)throw new Zi(d.value,m,Object.keys(d.options),o);s.push.apply(s,Er(b.value,r,t,a,i));continue}if(ua(d)){var b=d.options["=".concat(m)];if(!b){if(!Intl.PluralRules)throw new wr(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,ct.MISSING_INTL_API,o);var P=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[P]||d.options.other}if(!b)throw new Zi(d.value,m,Object.keys(d.options),o);s.push.apply(s,Er(b.value,r,t,a,i,m-(d.offset||0)));continue}}return Th(s)}function _h(e,r){return r?M(M(M({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=M(M({},e[a]),r[a]||{}),t},{})):e}function Lh(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=_h(e[a],r[a]),t},M({},e)):e}function Ji(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function Ph(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:yr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,la([void 0],t,!1)))},{cache:Ji(e.number),strategy:va.variadic}),getDateTimeFormat:yr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,la([void 0],t,!1)))},{cache:Ji(e.dateTime),strategy:va.variadic}),getPluralRules:yr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,la([void 0],t,!1)))},{cache:Ji(e.pluralRules),strategy:va.variadic})}}var Ws=(function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==ie.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Er(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Lh(e.formats,a),this.formatters=i&&i.formatters||Ph(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=$s,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e})();var Ys=Ws;var Sr={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}",discountLabel:"{discount}%"},Mh=Nn("ConsonantTemplates/price"),Rh=/<\/?[^>]+(>|$)/g,j={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Le={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},en="TAX_EXCLUSIVE",Nh=e=>Mn(e)?Object.entries(e).filter(([,r])=>gt(r)||Br(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Pn(a)}"`}`,""):"",Y=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${j.disabled}`}"${Nh(t)}>${a?ls(r):r??""}</span>`;function Oh(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function Ih(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function ye(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?Oh(i):i,i=n?i.replace(Rh,""):i;let s=new Ys(i,r).format(a);return o?Ih(s):s}catch{return Mh.error("Failed to format literal:",i),""}}function zh(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:u},m={}){let h=Y(j.currencySymbol,a),p=Y(j.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+p),f+=Y(j.integer,s),f+=Y(j.decimalsDelimiter,n),f+=Y(j.decimals,i),c||(f+=p+h),f+=Y(j.recurrence,l,null,!0),f+=Y(j.unitType,d,null,!0),f+=Y(j.taxInclusivity,u,!0),Y(e,f,{...m})}var ee=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:u,literals:m={},quantity:h=1,space:p=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:w,formatString:E,price:b,priceWithoutDiscount:P,taxDisplay:O,taxTerm:I,term:$,usePrecision:W,promotion:Q}={},te={})=>{Object.entries({country:o,formatString:E,language:u,price:b}).forEach(([Rc,Nc])=>{if(Nc==null)throw new Error(`Argument "${Rc}" is missing for osi ${w?.toString()}, country ${o}, language ${u}`)});let H={...Sr,...m},z=`${u.toLowerCase()}-${o.toUpperCase()}`,re;Q&&!f&&P?re=e||a?b:P:t&&P?re=P:re=b;let J=r?hs:ps;i&&(J=ms);let{accessiblePrice:De,recurrenceTerm:fe,...ht}=J({commitment:x,formatString:E,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:P,price:r?b:re,promotion:Q,quantity:h,term:$,usePrecision:W}),He="",ya="",wa="";T(c)&&fe&&(wa=ye(H,z,Le.recurrenceLabel,{recurrenceTerm:fe}));let Lr="";T(l)&&(p&&(Lr+=" "),Lr+=ye(H,z,Le.perUnitLabel,{perUnit:"LICENSE"}));let Pr="";T(d)&&I&&(p&&(Pr+=" "),Pr+=ye(H,z,O===en?Le.taxExclusiveLabel:Le.taxInclusiveLabel,{taxTerm:I})),t&&(He=ye(H,z,Le.strikethroughAriaLabel,{strikethroughPrice:He})),e&&(ya=ye(H,z,Le.alternativePriceAriaLabel,{alternativePrice:ya}));let Ke=j.container;if(r&&(Ke+=` ${j.containerOptical}`),t&&(Ke+=` ${j.containerStrikethrough}`),a&&(Ke+=` ${j.containerPromoStrikethrough}`),e&&(Ke+=` ${j.containerAlternative}`),i&&(Ke+=` ${j.containerAnnual}`),T(s))return zh(Ke,{...ht,accessibleLabel:He,altAccessibleLabel:ya,recurrenceLabel:wa,perUnitLabel:Lr,taxInclusivityLabel:Pr},te);let{currencySymbol:ln,decimals:kc,decimalsDelimiter:_c,hasCurrencySpace:dn,integer:Lc,isCurrencyFirst:Pc}=ht,pt=[Lc,_c,kc];Pc?(pt.unshift(dn?"\xA0":""),pt.unshift(ln)):(pt.push(dn?"\xA0":""),pt.push(ln)),pt.push(wa,Lr,Pr);let Mc=pt.join("");return Y(Ke,Mc,te)},Ks=()=>(e,r,t)=>{let a=ot(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${ee({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},Xs=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=ot(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return ee()(e,{...r,price:r.priceWithoutDiscount},t)+Y(j.containerAnnualPrefix," (")+ee({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+Y(j.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${ee({displayStrikethrough:!0})(n,r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${Y(j.containerAnnualPrefix," (")}${ee({displayAnnual:!0,instant:a})(n,r,t)}${Y(j.containerAnnualSuffix,")")}`},Qs=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${ee({isAlternativePrice:e.displayOldPrice})(e,r,t)}${Y(j.containerAnnualPrefix," (")}${ee({displayAnnual:!0})(a,r,t)}${Y(j.containerAnnualSuffix,")")}`};var Ar={...j,containerLegal:"price-legal",planType:"price-plan-type"},xa={...Le,planTypeLabel:"planTypeLabel"};function Dh(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=Y(Ar.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=Y(Ar.taxInclusivity,t,!0),o+=Y(Ar.planType,a,null),Y(e,o,{...i})}var Zs=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,planTypeCase:n,language:o,literals:s={}}={},{taxDisplay:c,taxTerm:l,planType:d}={},u={})=>{let m={...Sr,...s},h=`${o.toLowerCase()}-${e.toUpperCase()}`,p="";T(r)&&(p=ye(m,h,xa.perUnitLabel,{perUnit:"LICENSE"}));let f="";e==="US"&&o==="en"&&(t=!1),T(t)&&l&&(f=ye(m,h,c===en?xa.taxExclusiveLabel:xa.taxInclusiveLabel,{taxTerm:l}));let x="";T(a)&&d&&(x=ye(m,h,xa.planTypeLabel,{planType:d})),x&&n&&(x=(n==="lower"?x[0].toLowerCase():x[0].toUpperCase())+x.slice(1));let w=Ar.container;return w+=` ${Ar.containerLegal}`,Dh(w,{perUnitLabel:p,taxInclusivityLabel:f,planTypeLabel:x},u,i)};var Js=ee(),ec=Ks(),tc=ee({displayOptical:!0}),rc=ee({displayStrikethrough:!0}),ac=ee({displayPromoStrikethrough:!0}),ic=ee({displayAnnual:!0}),nc=ee({displayOptical:!0,isAlternativePrice:!0}),oc=ee({isAlternativePrice:!0}),sc=Qs(),cc=Xs(),lc=Zs;var Hh={...Le,discountLabel:"discountLabel"},Fh=(e,r)=>{if(!r&&ft(e))return 0;if(!(!ft(e)||!ft(r)))return Math.floor((r-e)/r*100)},dc=()=>(e,r)=>{let{country:t,language:a,literals:i={}}=e??{},{price:n,priceWithoutDiscount:o}=r,s=Fh(n,o);if(s===void 0)return'<span class="no-discount"></span>';let c={...Sr,...i},l=a&&t?`${a.toLowerCase()}-${t.toUpperCase()}`:"en-US";return`<span class="discount">${ye(c,l,Hh.discountLabel,{discount:s,remainingPercent:100-s})}</span>`};var hc=dc();var pc="INDIVIDUAL_COM",rn="TEAM_COM",mc="INDIVIDUAL_EDU",an="TEAM_EDU",Bh=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh","KE_en","GH_en","TZ_en","AM_en","AZ_en","GE_en","MD_en","KZ_en","KG_en","TJ_en","UZ_en","OM_en","BH_en"],Uh={[pc]:[],[rn]:[],[mc]:[],[an]:[]},$h={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Gh=[pc,rn,mc,an],qh=e=>[rn,an].includes(e);function tn(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Vh=(e,r,t,a)=>{let i=`${t}_${a}`,n=tn($h,e,r,!1);if(n){let o=Gh.indexOf(i);return n[o]}return qh(i)},jh=(e,r,t,a)=>{if(tn(Bh,e,r,!0))return!0;let i=Uh[`${t}_${a}`];return i?tn(i,e,r,!0)?!0:N.displayTax:N.displayTax},nn=async(e,r,t,a)=>{let i=jh(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Vh(e,r,t,a):N.forceTaxExclusive}},Cr=class Cr extends HTMLSpanElement{constructor(){super();g(this,"masElement",new We(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=V();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:h,alternativePrice:p,template:f,wcsOsi:x}=a.collectPriceOptions(t);return na(Cr,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:h,alternativePrice:p,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===xe}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=V();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let p=tr(h,n);return p?.length?p[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,u=bi(l);if(a.featureFlags[Pe]||n[Pe]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=u.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:p}=n,[f=""]=u.marketSegments,x=await nn(h,p,u.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(w=>{let E=tr(w,n);return E?.length?E[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[pe]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,p]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:p.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=bi(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=V();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(Cr,"is","inline-price"),g(Cr,"tag","span");var Ie=Cr;window.customElements.get(Ie.is)||window.customElements.define(Ie.is,Ie,{extends:Ie.tag});function uc({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let Q of r.price)Q(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:u,displayTax:m,displayPlanType:h,forceTaxExclusive:p,perpetual:f,displayAnnual:x,promotionCode:w,quantity:E,alternativePrice:b,wcsOsi:P,...O}=Object.assign(c,s?.dataset??{},o??{}),{wcsOsi:I,promotionCodes:$}=Kr(P,w),W=$.map(Q=>qr(Q).effectivePromoCode);return c=Ur(Object.assign({...c,...O,displayOldPrice:T(l),displayPerUnit:T(d),displayRecurrence:T(u),displayTax:T(m),displayPlanType:T(h),forceTaxExclusive:T(p),perpetual:T(f),displayAnnual:T(x),promotionCode:W[0],promotionCodes:W,quantity:vt(E,N.quantity),alternativePrice:T(b),wcsOsi:I})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=hc;break;case"strikethrough":l=rc;break;case"promo-strikethrough":l=ac;break;case"annual":l=ic;break;case"legal":l=lc;break;default:s.template==="optical"&&s.alternativePrice?l=nc:s.template==="optical"?l=tc:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?cc:sc:s.alternativePrice?l=oc:l=s.promotionCode&&o[0].promotion?ec:Js}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Ie.createInlinePrice;return{InlinePrice:Ie,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Wh({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||N.language),r??(r=e?.split("_")?.[1]||N.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function gc(e={},r){let t=r.featureFlags[Pe],{commerce:a={}}=e,i=Ee.PRODUCTION,n=Va,o=B("checkoutClientId",a)??N.checkoutClientId,s=er(B("checkoutWorkflowStep",a),le,N.checkoutWorkflowStep),c=T(B("displayOldPrice",a),N.displayOldPrice),l=N.displayPerUnit,d=T(B("displayRecurrence",a),N.displayRecurrence),u=T(B("displayTax",a),N.displayTax),m=T(B("displayPlanType",a),N.displayPlanType),h=T(B("entitlement",a),N.entitlement),p=T(B("modal",a),N.modal),f=T(B("forceTaxExclusive",a),N.forceTaxExclusive),x=B("promotionCode",a)??N.promotionCode,w=vt(B("quantity",a)),E=B("wcsApiKey",a)??N.wcsApiKey,b=a?.env==="stage",P=Be.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(B(Ga,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",P=er(B(qa,a),Be,P)),b&&(i=Ee.STAGE,n=ja);let I=B($a)??e.preview,$=typeof I<"u"&&I!=="off"&&I!=="false",W={};$&&(W={preview:$});let Q=B("mas-io-url")??e.masIOUrl,te=wn(Q)?Q:`https://www${i===Ee.STAGE?".stage":""}.adobe.com/mas/io`,H=B("preselect-plan")??void 0,z=B("instant")??e.instant;return{...Wh(e),...W,aupSelect:B("aup-select",{"aup-select":r.getAttribute("aup-select")},{search:!0,storage:!1})==="on",displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:u,displayPlanType:m,entitlement:h,extraOptions:N.extraOptions,modal:p,env:i,forceTaxExclusive:f,promotionCode:x,quantity:w,alternativePrice:N.alternativePrice,wcsApiKey:E,wcsURL:n,landscape:P,masIOUrl:te,...H&&{preselectPlan:H},...z&&{instant:z}}}async function fc(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var on="wcs";function vc({settings:e}){let r=ae.module(on),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(p,f,x=!0){let w=V(),E=Fa;r.debug("Fetching:",p);let b="",P;if(p.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let O=new Map(f),[I]=p.offerSelectorIds,$=Date.now()+Math.random().toString(36).substring(2,7),W=`${on}:${I}:${$}${Ya}`,Q=`${on}:${I}:${$}${Ka}`,te;try{if(performance.mark(W),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",I),b.searchParams.set("country",p.country),b.searchParams.set("locale",p.locale),b.searchParams.set("landscape",t===Ee.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),p.language&&b.searchParams.set("language",p.language),p.promotionCode&&b.searchParams.set("promotion_code",p.promotionCode),p.currency&&b.searchParams.set("currency",p.currency),P=await fc(b.toString(),{credentials:"omit"}),P.ok){let H=[];try{let z=await P.json();r.debug("Fetched:",p,z),H=z.resolvedOffers??[]}catch(z){r.error(`Error parsing JSON: ${z.message}`,{...z.context,...w?.duration})}H=H.map(Vr),f.forEach(({resolve:z},re)=>{let J=H.filter(({offerSelectorIds:De})=>De.includes(re)).flat();J.length&&(O.delete(re),f.delete(re),z(J))})}else E=Ha}catch(H){E=`Network error: ${H.message}`}finally{te=performance.measure(Q,W),performance.clearMarks(W),performance.clearMeasures(Q)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let H=jn(P);f.forEach(z=>{z.reject(new Ft(E,{...p,...H,response:P,measure:Ir(te),...w?.duration}))})}}function l(){clearTimeout(o);let p=[...n.values()];n.clear(),p.forEach(({options:f,promises:x})=>c(f,x))}function d(p){if(!p||typeof p!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===Ee.STAGE?"stage":"prod",x=p[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[w,E]of Object.entries(x))i.set(w,Promise.resolve(E.map(Vr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function u(){let p=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${p} cache entries to stale cache`)}function m(p,f,x){let w=p!=="GB"&&!x?"MULT":"en",E=Xa.includes(p)?p:N.country;return{validCountry:E,validLanguage:w,locale:`${f}_${E}`}}function h({country:p,language:f,perpetual:x=!1,promotionCode:w="",promotionCodes:E,wcsOsi:b=[]}){let{validCountry:P,validLanguage:O,locale:I}=m(p,f,x),$=Array.isArray(E)&&E.length?E:[w];return b.map((W,Q)=>{let te=$.length===1?$[0]:$[Q]??"",H=[P,O,te].filter(J=>J).join("-").toLowerCase(),z=`${W}-${H}`;if(i.has(z))return i.get(z);let re=new Promise((J,De)=>{let fe=n.get(H);fe||(fe={options:{country:P,locale:I,...O==="MULT"&&{language:O},offerSelectorIds:[]},promises:new Map},n.set(H,fe)),te&&(fe.options.promotionCode=te),fe.options.offerSelectorIds.push(W),fe.promises.set(W,{resolve:J,reject:De}),l()}).catch(J=>{if(s.has(z))return s.get(z);throw J});return i.set(z,re),re})}return{Commitment:Qe,PlanType:In,Term:ue,applyPlanType:Vr,resolveOfferSelectors:h,flushWcsCacheInternal:u,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var xc="mas-commerce-service",bc="mas-commerce-service:start",yc="mas-commerce-service:ready",Tr,Ut,lt,wc,cn,sn=class extends HTMLElement{constructor(){super(...arguments);A(this,lt);A(this,Tr);A(this,Ut);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,Ut)||S(this,Ut,{[Pe]:G(this,lt,cn).call(this,Pe),[pe]:G(this,lt,cn).call(this,pe)}),v(this,Ut)}activate(){let t=v(this,lt,wc),a=gc(t,this);jr(t.lana);let i=ae.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:ws(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...xs(c),...bs(c),...uc(c),...vc(c),...Qa,Log:ae,resolvePriceTaxFlags:nn,get defaults(){return N},get log(){return ae},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(Rr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(yc),S(this,Tr,performance.measure(yc,bc)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(bc),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Ta).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Ir(v(this,Tr))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Tr=new WeakMap,Ut=new WeakMap,lt=new WeakSet,wc=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},cn=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||B(t))};window.customElements.get(xc)||window.customElements.define(xc,sn);var Cc="merch-card-collection",Yh=3e4,Kh={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Xh={plans:!0},Qh=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Zh=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,Jh=(e,r)=>{let t=r.tagGroups;if(!t?.length)return e;let a=Sa();return e.filter(i=>Ko((i.getAttribute("filter-tags")||"").split(",").filter(Boolean),t,a))},ep=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),tp=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),rp=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Ye,Gt,dt,_r,ba,Tc,$t=class extends Sc{constructor(){super();A(this,ba);A(this,Ye,{});A(this,Gt);A(this,dt);A(this,_r);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=bn(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return ze` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a,i=new Promise(o=>{a=yn(()=>o(!1),Yh)}),n=Promise.race([this.hydrationReady,i]);return n.finally(()=>ei(a)),n}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===be.alphabetical?ep:tp,s=[Qh,Zh,Jh,rp,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Ma,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(ve,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){S(this,Ye,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,Ye)[a]=i)})}connectedCallback(){super.connectedCallback(),S(this,Gt,Xt()),v(this,Gt)&&S(this,dt,v(this,Gt).Log.module(Cc)),S(this,_r,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.tagGroups?.length&&(this.stopFilterDeeplink=Aa(()=>this.requestUpdate())),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.(),this.stopFilterDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",a),o.setAttribute("placeholder",""),o.innerHTML=i,this.append(o)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Xh[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Wt));let i=v(this,_r)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(s=>{a=s});let i=this;function n(s){let c;return s.fields?.tagFilters?.length&&(c=Wo(s.fields.tagFilters,s.fields.tagFiltersTitle,s.settings)),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(u,m){for(let h of m){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){v(i,dt)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let p=s.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)p=b,f=b.referencesTree,s.references={...s.references,...b.references};else{v(i,dt)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!p?.fields)continue;let{fields:w}=p,E={label:w.label||"",icon:w.icon,iconLight:w.iconLight,queryLabel:w.queryLabel,cards:w.cards?w.cards.map(b=>c[b]||b):[],collections:[]};w.defaultchild&&(E.defaultchild=c[w.defaultchild]||w.defaultchild),u.push(E),d(E.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(Na,s=>{G(this,ba,Tc).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(Ra,async s=>{this.limit=27,this.data=o(s.detail,v(this,Ye)),this.tagGroups=this.data.sidenavSettings?.tagFilters??null,s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?v(this,Ye)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let u=(p,f)=>{for(let x of p)if(x.defaultchild===f||x.collections&&u(x.collections,f))return!0;return!1};for(let p of c){let b=function(O){for(let I of O){let $=I.cards.indexOf(x);if($===-1)continue;let W=I.queryLabel??I?.label?.toLowerCase()??"";f.filters[W]={order:$+1,size:p.fields.size},b(I.collections)}},f=document.createElement("merch-card"),x=v(this,Ye)[p.id]||p.id;f.setAttribute("consonant",""),f.setAttribute("style","");let w=p.fields.tags?.filter(O=>O.startsWith("mas:types/")).map(O=>O.split("/")[1]).join(",");if(w&&f.setAttribute("types",w),this.tagGroups){let O=new Set(this.tagGroups.map($=>$.deeplink)),I=Yo(p.fields.tags,O);I.length&&f.setAttribute("filter-tags",I.join(","))}Dr(p.fields.variant)?.supportsDefaultChild&&(d?x===d:u(l,x))&&f.setAttribute("data-default-card","true"),b(l);let P=document.createElement("aem-fragment");P.setAttribute("fragment",x),f.append(P),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(p)+1,size:p.fields.size}}),this.append(f)}let m="",h=Zo(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(p=>p.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?m=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(m=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Kh[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return ze`<div id="footer">
            <sp-theme color="light" scale="medium">
                ${this.showMoreButton}
            </sp-theme>
        </div>`}get showMoreButton(){if(this.hasMore)return ze`<sp-button
            variant="secondary"
            treatment="outline"
            style="order: 1000;"
            @click="${this.showMore}"
        ...
        </sp-button>`}sortChanged(t){t.target.value===be.authored?jt({sort:void 0}):jt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(La,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(Pa,{bubbles:!0,composed:!0}));let t=this.page+1;jt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=Aa(({category:t,filter:a,types:i,sort:n,search:o,single_app:s,page:c})=>{a=a||t,!this.filtered&&a&&a!==this.filter&&setTimeout(()=>{jt({page:void 0}),this.page=1},1),this.filtered||(this.filter=a??this.filter),this.types=i??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(c)||1})}openFilters(t){this.sidenav?.showModal(t)}};Ye=new WeakMap,Gt=new WeakMap,dt=new WeakMap,_r=new WeakMap,ba=new WeakSet,Tc=function(t,a={},i=!0){v(this,dt)?.error(`merch-card-collection: ${t}`,a),this.failed=!0,i&&this.dispatchEvent(new CustomEvent(Oa,{detail:{...a,message:t},bubbles:!0,composed:!0}))},g($t,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:be.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g($t,"styles",Ac`
        #footer {
            grid-column: 1 / -1;
    ...
    `);$t.SortOrder=be;customElements.define(Cc,$t);var ap={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},ip=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(i=>{i.innerText=t||""})},np={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},op={catalog:"l"},he,qt,kr=class extends Sc{constructor(){super();A(this,he);A(this,qt);g(this,"tablet",new Vt(this,L));g(this,"desktop",new Vt(this,_));this.collection=null,S(this,he,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(ve,this.updateLiterals),this.collection?.addEventListener(Wt,this.handleSidenavAttached),S(this,qt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(ve,this.updateLiterals),this.collection?.removeEventListener(Wt,this.handleSidenavAttached)}willUpdate(){v(this,he).search=this.getVisibility("search"),v(this,he).filter=this.getVisibility("filter"),v(this,he).sort=this.getVisibility("sort"),v(this,he).result=this.getVisibility("result"),v(this,he).custom=this.getVisibility("custom")}parseVisibilityOptions(t,a){if(!t||!Object.hasOwn(t,a))return null;let i=t[a];return i===!1?!1:i===!0?!0:i.includes(this.currentMedia)}getVisibility(t){let a=v(this,qt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,i=this.parseVisibilityOptions(a,t);return i!==null?i:this.parseVisibilityOptions(np,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,he).search)return we;let t=Kt(this,"searchText");return t?ze`
            <merch-search deeplink="search" id="search">
                <sp-search
                    id="search-bar"
                    placeholder="${t}"
                    .size=${op[this.variant]}
                    aria-label="${t}"
                ></sp-search>
            </merch-search>
        `:we}get filterAction(){return v(this,he).filter?this.sidenav?ze`
            <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
            ...
            ></sp-action-button>
        `:we:we}get sortAction(){if(!v(this,he).sort)return we;let t=Kt(this,"sortText");if(!t)return;let a=Kt(this,"popularityText"),i=Kt(this,"alphabeticallyText");if(!(a&&i))return;let n=this.collection?.sort===be.alphabetical;return ze`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        `}get resultSlotName(){let t=`${this.search?"search":"filters"}${this.isMobile||this.isTablet?"Mobile":""}`;return ap[t][Math.min(this.resultCount,2)]}get resultLabel(){if(!v(this,he).result)return we;if(!this.sidenav)return we;let t=this.search?"search":"filter",a=this.resultCount?this.resultCount===1?"single":"multiple":"none";return ze` <div
            id="result"
            aria-live="polite"
            type=${t}
            quantity=${a}
        ...
        </div>`}get customArea(){if(!v(this,he).custom)return we;let t=v(this,qt)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return we;let a=t(this.collection);return!a||a===we?we:ze`<div id="custom" role="heading" aria-level="2">
            ${a}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(a=>{ip(this,a,t.detail[a])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return ze`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};he=new WeakMap,qt=new WeakMap,g(kr,"styles",Ac`
        :host {
    ...
    `);customElements.define("merch-card-collection-header",kr);export{$t as MerchCardCollection,kr as default};

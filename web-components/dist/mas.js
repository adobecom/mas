...
`,ec=()=>[b`
        ...
        `];M();function xh(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Dt=class extends z{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(xh())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(r=>{let i="",n="top";if(r.tagName==="SP-TOOLTIP")i=r.textContent,n=r.getAttribute("placement")||"top";else if(r.tagName==="OVERLAY-TRIGGER"){let a=r.querySelector("sp-tooltip");a&&(i=a.textContent,n=a.getAttribute("placement")||r.getAttribute("placement")||"top")}if(i){let a=document.createElement("mas-mnemonic");a.setAttribute("content",i),a.setAttribute("placement",n);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?a.appendChild(s):o&&a.appendChild(o),this.innerHTML="",this.appendChild(a),Promise.resolve().then(()=>Ri())}r.remove()})}render(){let{href:t}=this;return t?f`<a href="${t}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
...
`;var Ni=class extends T{constructor(t){super(t)}getGlobalCSS(){return ic}renderLayout(){return f`${this.cardImage}
            <div class="body">
...
`;var Ii=class extends T{constructor(t){super(t)}getGlobalCSS(){return nc}renderLayout(){return f` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":f`<hr />`} ${this.secureLabelFooter}`}};M();var ac=`
  :root {
...
`;var Gt=class extends T{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return hc}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return f` ${this.badge}
...
`;var qt=class extends T{constructor(t){super(t)}getGlobalCSS(){return pc}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return f` ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?"":f`<slot name="promo-text"></slot
...
`;var uc={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Vt=class extends T{constructor(t){super(t)}getGlobalCSS(){return mc}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return f`${this.cardImage}
            <div class="body">
...
`;var vc={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Yt=class extends T{constructor(){super(...arguments);m(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return xc}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${B}[data-template="price"]`);if(!r)return;let i=r.cloneNode(!0);this.legal=i,r.dataset.displayTax="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return f`
            ${this.badge}
            <div class="body">
    ...
    `);var Di=new Map,V=(e,t,r=null,i=null,n)=>{Di.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:n})};V("catalog",Ut,rc,Ut.variantStyle);V("image",Ni);V("inline-heading",Ii);V("mini-compare-chart",Ft,null,Ft.variantStyle);V("plans",pe,$i,pe.variantStyle,pe.collectionOptions);V("plans-students",pe,cc,pe.variantStyle,pe.collectionOptions);V("plans-education",pe,sc,pe.variantStyle,pe.collectionOptions);V("plans-v2",We,dc,We.variantStyle,We.collectionOptions);V("product",Gt,null,Gt.variantStyle);V("segment",qt,null,qt.variantStyle);V("special-offers",Vt,uc,Vt.variantStyle);V("simplified-pricing-express",jt,xa,jt.variantStyle);V("full-pricing-express",Wt,va,Wt.variantStyle);V("mini",Yt,vc,Yt.variantStyle);var ba=e=>{let t=Di.get(e.variant);if(!t)return;let{class:r,style:i}=t;if(i)try{let n=new CSSStyleSheet;n.replaceSync(i.cssText),e.shadowRoot.adoptedStyleSheets.push(n)}catch{let a=document.createElement("style");a.textContent=i.cssText,e.shadowRoot.appendChild(a)}return new r(e)};function Oi(e){return Di.get(e)?.fragmentMapping}function bc(e){return Di.get(e)?.collectionOptions}var yc=document.createElement("style");yc.innerHTML=`
:root {
...
`;document.head.appendChild(yc);var Ec="fragment",wc="author",Ac="preview",Sc="loading",_c="timeout",ya="aem-fragment",Tc="eager",Cc="cache",bh=[Tc,Cc],Re,bt,_e,Ea=class{constructor(){E(this,Re,new Map);E(this,bt,new Map);E(this,_e,new Map)}clear(){h(this,Re).clear(),h(this,bt).clear(),h(this,_e).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,Re).set(t.id,t),t.fields?.originalId&&h(this,Re).set(t.fields.originalId,t),h(this,_e).has(t.id)){let[,i]=h(this,_e).get(t.id);i()}if(h(this,_e).has(t.fields?.originalId)){let[,i]=h(this,_e).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:n,value:a}=t.references[i];n==="content-fragment"&&(a.settings={...t?.settings,...a.settings},a.placeholders={...t?.placeholders,...a.placeholders},a.dictionary={...t?.dictionary,...a.dictionary},a.priceLiterals={...t?.priceLiterals,...a.priceLiterals},this.add(a,t))}}}has(t){return h(this,Re).has(t)}entries(){return h(this,Re).entries()}get(t){return h(this,Re).get(t)}getAsPromise(t){let[r]=h(this,_e).get(t)??[];if(r)return r;let i;return r=new Promise(n=>{i=n,this.has(t)&&n()}),h(this,_e).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,bt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,bt).set(t,r)),r}remove(t){h(this,Re).delete(t),h(this,bt).delete(t),h(this,_e).delete(t)}};Re=new WeakMap,bt=new WeakMap,_e=new WeakMap;var Ye=new Ea,Xt,Te,He,be,me,Q,Ur,Fr,Ce,Gr,qr,Kt,ke,kc,Pc,wa,Lc,zi=class extends HTMLElement{constructor(){super(...arguments);E(this,ke);m(this,"cache",Ye);E(this,Xt);E(this,Te,null);E(this,He,null);E(this,be,null);E(this,me);E(this,Q);E(this,Ur,Tc);E(this,Fr,5e3);E(this,Ce);E(this,Gr,!1);E(this,qr,0);E(this,Kt)}static get observedAttributes(){return[Ec,Sc,_c,wc,Ac]}attributeChangedCallback(r,i,n){r===Ec&&(y(this,me,n),y(this,Q,Ye.getFetchInfo(n))),r===Sc&&bh.includes(n)&&y(this,Ur,n),r===_c&&y(this,Fr,parseInt(n,10)),r===wc&&y(this,Gr,["","true"].includes(n)),r===Ac&&y(this,Kt,n)}connectedCallback(){if(!h(this,Ce)){if(h(this,be)??y(this,be,dt(this)),y(this,Kt,h(this,be).settings?.preview),h(this,Xt)??y(this,Xt,h(this,be).log.module(`${ya}[${h(this,me)}]`)),!h(this,me)||h(this,me)==="#"){h(this,Q)??y(this,Q,Ye.getFetchInfo("missing-fragment-id")),ee(this,ke,wa).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,Q)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,Ce)&&!await Promise.race([h(this,Ce),Promise.resolve(!1)]))return;r&&Ye.remove(h(this,me)),h(this,Ur)===Cc&&await Promise.race([Ye.getAsPromise(h(this,me)),new Promise(s=>setTimeout(s,h(this,Fr)))]);try{y(this,Ce,ee(this,ke,Lc).call(this)),await h(this,Ce)}catch(s){return ee(this,ke,wa).call(this,s.message),!1}let{references:i,referencesTree:n,placeholders:a,wcs:o}=h(this,Te)||{};return o&&!U("mas.disableWcsCache")&&h(this,be).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(tt,{detail:{...this.data,references:i,referencesTree:n,placeholders:a,...h(this,Q)},bubbles:!0,composed:!0})),h(this,Ce)}get updateComplete(){return h(this,Ce)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,He)?h(this,He):(h(this,Gr)?this.transformAuthorData():this.transformPublishData(),h(this,He))}get rawData(){return h(this,Te)}transformAuthorData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,Te);y(this,He,r.reduce((l,{name:d,multiple:p,values:u})=>(l.fields[d]=p?u:u[0],l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,Te);y(this,He,Object.entries(r).reduce((l,[d,p])=>(l.fields[d]=p?.mimeType?p.value:p??"",l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=i.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,o=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${o}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,me),{locale:h(this,be).settings.locale,apiKey:h(this,be).settings.wcsApiKey})}};Xt=new WeakMap,Te=new WeakMap,He=new WeakMap,be=new WeakMap,me=new WeakMap,Q=new WeakMap,Ur=new WeakMap,Fr=new WeakMap,Ce=new WeakMap,Gr=new WeakMap,qr=new WeakMap,Kt=new WeakMap,ke=new WeakSet,kc=async function(r){Ba(this,qr)._++;let i=`${ya}:${h(this,me)}:${h(this,qr)}`,n=`${i}${nt}`,a=`${i}${at}`;if(h(this,Kt))return await this.generatePreview();performance.mark(n);let o;try{if(h(this,Q).stale=!1,h(this,Q).url=r,o=await Ai(r,{cache:"default",credentials:"omit"}),ee(this,ke,Pc).call(this,o),h(this,Q).status=o?.status,h(this,Q).measure=Le(performance.measure(a,n)),h(this,Q).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...h(this,be).duration});return await o.json()}catch(s){if(h(this,Q).measure=Le(performance.measure(a,n)),h(this,Q).retryCount=s.retryCount,h(this,Te))return h(this,Q).stale=!0,h(this,Xt).error("Serving stale data",h(this,Q)),h(this,Te);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},Pc=function(r){Object.assign(h(this,Q),si(r))},wa=function(r){y(this,Ce,null),h(this,Q).message=r,this.classList.add("error");let i={...h(this,Q),...h(this,be).duration};h(this,Xt).error(r,i),this.dispatchEvent(new CustomEvent(rt,{detail:i,bubbles:!0,composed:!0}))},Lc=async function(){var c;this.classList.remove("error"),y(this,He,null);let r=Ye.get(h(this,me));if(r)return y(this,Te,r),!0;let{masIOUrl:i,wcsApiKey:n,country:a,locale:o}=h(this,be).settings,s=`${i}/fragment?id=${h(this,me)}&api_key=${n}&locale=${o}`;return a&&!o.endsWith(`_${a}`)&&(s+=`&country=${a}`),r=await ee(this,ke,kc).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,me)),Ye.add(r),y(this,Te,r),!0},m(zi,"cache",Ye);customElements.define(ya,zi);M();var Qt=class extends z{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">${this.text}</div>`}};m(Qt,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),m(Qt,"styles",b`
    ...
    `),m(Wr,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Wr);M();M();var zc=b`
    :host {
...
`;var[nb,ab,Ca,ka,Bc,Uc]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Pa=class extends z{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return Hc}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=Tr(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=Tr(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(Tt,this.debouncedQuantityUpdate)}get button(){return this.shadowRoot.querySelector("button")}handleKeyup(t){t.key===ka||t.key===Ca||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let t=this.options[this.highlightedIndex];if(!t){this.closed=!0;return}this.selectedValue=t,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(t){switch(t.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case Uc:this.selectValue();break;case ka:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,t.preventDefault();break;case Ca:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),t.preventDefault();break;case Bc:this.selectValue(),this.button.classList.contains("focused")&&t.preventDefault();break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=t.value.replace(/\D/g,"");t.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let n=i;this.maxInput&&i>this.maxInput&&(n=this.maxInput),this.min&&n<this.min&&(n=this.min),this.adjustInput(t,n)}else this.adjustInput(t,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(Tt,this.debouncedQuantityUpdate)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}update(t){(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue"))&&(this.options=this.generateOptionsArray(),this.highlightedIndex=this.defaultValue?this.options.indexOf(this.defaultValue):0,this.handleMenuOption(this.defaultValue?this.defaultValue:this.options[0])),super.update(t)}handleClickOutside(t){t.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let t=this.shadowRoot.querySelector(".popover");this.closed||t.getBoundingClientRect().bottom<=window.innerHeight?t.setAttribute("placement","bottom"):t.setAttribute("placement","top")}handleMouseEnter(t){this.highlightedIndex=t}handleMenuOption(t,r){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let t=new CustomEvent(ae,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return f` <div
        ...
        `}};customElements.define("merch-quantity-select",Pa);Ri();M();var Fc=`
...
`;var Ma={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},sr=class extends T{getGlobalCSS(){return Yc}get aemFragmentMapping(){return Ma}renderLayout(){return f`
    ...
    `);V("ccd-suggested",ir,Gc,ir.variantStyle);V("ccd-slice",nr,Vc,nr.variantStyle);V("ah-try-buy-widget",ar,La,ar.variantStyle);V("ah-promoted-plans",or,Ra,or.variantStyle);V("fries",sr,Ma,sr.variantStyle);

...
`,Wr=()=>[Gr`
    ...
    `);customElements.define("merch-icon",Se);var ct,pe,st,lt,Ae,Nt=class extends HTMLElement{constructor(){super();v(this,ct,"");v(this,pe);v(this,st,[]);v(this,lt,[]);v(this,Ae);g(this,Ae,sa(()=>{this.isConnected&&(this.parentElement.style.background=this.value,p(this,pe)?this.parentElement.style.borderRadius=p(this,pe):p(this,pe)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=p(this,st).map((t,i)=>{let n=p(this,lt)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${p(this,ct)}, ${e})`}connectedCallback(){p(this,Ae).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&g(this,pe,i?.trim()),e==="colors"&&i?g(this,st,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?g(this,lt,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&g(this,ct,i?.trim()??""),p(this,Ae).call(this)}};ct=new WeakMap,pe=new WeakMap,st=new WeakMap,lt=new WeakMap,Ae=new WeakMap;customElements.define("merch-gradient",Nt);import{LitElement as ln,html as dn,css as hn}from"./lit-all.min.js";var Te=class extends ln{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${r}"] ${y}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(N,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(N,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];if(!t)return;e.setAttribute("data-offer-type",t.offerType);let i=e.closest("p");if(i.getAttribute("data-plan-type"))return;let n=this.querySelector(`p[data-plan-type="${t.planType}"]`);n&&n!==i||i.setAttribute("data-plan-type",t.planType)}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return dn` <input
                type="checkbox"
                id="addon-checkbox"
...
`;var zn=32,Pn=0,_n=()=>`mweb-list-${Pn+=1}`,Mn=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],Rn=8,Na={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},B,ue,Me,Re,Oe,te,xr,yr,_e=class extends f{constructor(e){super(e);v(this,te);v(this,B);v(this,ue);v(this,Me);v(this,Re,0);v(this,Oe);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>qt` <footer>
        ...
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(O,this.updatePriceQuantity),g(this,Re,this.card.getBoundingClientRect().width),g(this,ue,new ResizeObserver(()=>{let e=this.card.getBoundingClientRect().width;e!==p(this,Re)&&(g(this,Re,e),clearTimeout(p(this,Me)),g(this,Me,setTimeout(()=>this.reconcileBreakpoint(),150)))})),p(this,ue).observe(this.card)}disconnectedCallbackHook(){this.card.removeEventListener(O,this.updatePriceQuantity),clearTimeout(p(this,Me)),p(this,ue)?.disconnect(),g(this,ue,null),p(this,B)?.disconnect(),g(this,B,null)}reconcileBreakpoint(){x.isMobile?(this.resetSyncedHeights(),this.removeEmptyRows()):C(this,te,yr).call(this)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}syncHeights(){if(x.isMobile)return;if(this.card.getBoundingClientRect().width<=2){p(this,B)||(g(this,B,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(p(this,B)?.disconnect(),g(this,B,null),this.syncHeights())})),p(this,B).observe(this.card));return}let e=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)}))),this.adjustMiniCompareFooterRows()}priceOptionsProvider(e,t){if(e.dataset.template===P){t.displayPlanType=this.card?.settings?.displayPlanType??!1;return}let i=H();(e.dataset.template==="strikethrough"||e.dataset.template==="price"&&!i.featureFlags[he])&&(t.displayPerUnit=!1)}getGlobalCSS(){return Oa}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((t,i)=>{let n=Math.max(zn,parseFloat(window.getComputedStyle(t).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(t=>{let i=t.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&t.remove()})}setupToggle(){let e=this.card.querySelector('[slot="body-xs"]'),t=e?.querySelector("p"),i=e?.querySelector("ul");if(!t||!i||e.querySelector(".footer-rows-title"))return;let n=t.textContent.trim(),o=this.card.querySelector("h3")?.id,c=o?`${o}-list`:_n();i.id=c,i.classList.add("checkmark-copy-container");let s=_("h4",{class:"footer-rows-title"},n),l=_("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":c});g(this,Oe,{toggleBtn:l,listEl:i}),s.append(l),s.addEventListener("click",()=>{x.isMobile&&this.setListOpen(!this.isListOpen)}),t.replaceWith(s)}get isListOpen(){return p(this,Oe)?.listEl.classList.contains("open")??!1}setListOpen(e){let{toggleBtn:t,listEl:i}=p(this,Oe);i.classList.toggle("open",e),t.classList.toggle("expanded",e),t.setAttribute("aria-expanded",String(e))}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${y}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{let e=H();this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let i=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPlanType&&(t.dataset.displayPlanType="false"),mt(e,t,i,"displayTax"),mt(e,t,i,"displayPerUnit"),i.setAttribute("data-template","legal"),t.parentNode.insertBefore(i,t.nextSibling),await i.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Ln:qt`<slot name="icons"></slot>`}renderLayout(){return qt`
            ${this.badge}
            <div class="body">
                <div class="body-main">
                    ${this.icons}

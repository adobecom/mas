...
`,ir=()=>[tr`
        ...
        `];import{LitElement as Ci,html as ar,css as Ti}from"./lit-all.min.js";function Li(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var he=class extends Ci{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Li())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>St())}e.remove()})}render(){let{href:t}=this;return t?ar`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};l(he,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(he,"styles",Ti`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-addon",be);import{html as ot,nothing as Oi}from"./lit-all.min.js";var ye,qe=class qe{constructor(t){l(this,"card");g(this,ye);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,ye,c(this,ye)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,ye)}insertVariantStyle(){let t=this.constructor.name;if(!qe.styleMap[t]){qe.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;a>o&&n.style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),ot`
        ...
        `}get cardImage(){return ot` <div class="image">
            ...
            ${this.badge}
              ...
              >`:Oi}get secureLabelFooter(){return ot`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return st(this.card.variant)}};ye=new WeakMap,l(qe,"styleMap",{});var v=qe;import{html as Tt,css as Di}from"./lit-all.min.js";var vr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Ue,css as Ni}from"./lit-all.min.js";var yr=`
:root {
...
`;var ct=class extends v{constructor(t){super(t)}getGlobalCSS(){return Er}renderLayout(){return kr` ${this.badge}
            ...
            ${this.card.customHr?"":kr`<hr />`} ${this.secureLabelFooter}`}};import{html as Ee,css as $i,unsafeCSS as Ar}from"./lit-all.min.js";var Sr=`
  :root {
...
`;var Ii=32,ke=class extends v{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?Ee`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),f.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(ke,"variantStyle",$i`
    ...
    `);import{html as Ge,css as Fi,nothing as lt}from"./lit-all.min.js";var Cr=`
:root {
...
`;var Nr={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Ae=class extends v{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Dr}renderLayout(){return _t`${this.cardImage}
            ...
            ${this.evergreen?_t`
                  ...
                  `:_t`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};l(Ae,"variantStyle",Ui`
...
`;var Pt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ce=class extends v{getGlobalCSS(){return $r}get aemFragmentMapping(){return Pt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),f.isDesktopOrUp)){let t=this.getContainer();if(!t)return;requestAnimationFrame(()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(r=>r.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!et()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(et())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};e();let r=window.matchMedia(y);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(y).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||et())return;let a=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",a)}renderLayout(){return Gi`
    ...
    `);import{html as Fr,css as Vi}from"./lit-all.min.js";var Ir=`
:root {
...
`;var Mt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},multiWhatsIncluded:"true",disabledAttributes:[]},Te=class extends v{getGlobalCSS(){return Ir}get aemFragmentMapping(){return Mt}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Fr`
    ...
    `);import{css as Yi,html as Wi}from"./lit-all.min.js";var Br=`
...
`;var Hr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Le=class extends v{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Br}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${x}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Wi`
            ${this.badge}
            <div class="body">
...
Caused by: ${this.cause}`),e}};var ae={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Yr=1e3;function Zi(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Wr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!ae.serializableTypes.includes(e))return e}return i}function Ji(i,t){if(!ae.ignoredProperties.includes(i))return Wr(t)}var Dt={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(p=>{p!=null&&(Zi(p)?r:a).push(p)}),r.length&&(n+=" "+r.map(Wr).join(" "));let{pathname:o,search:s}=window.location,d=`${ae.delimiter}page=${o}${s}`;d.length>Yr&&(d=`${d.slice(0,Yr)}<trunc>`),n+=d,a.length&&(n+=`${ae.delimiter}facts=`,n+=JSON.stringify(a,Ji)),window.lana?.log(n,ae)}};function Kr(i){Object.assign(ae,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in ae&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Qr={LOCAL:"local",PROD:"prod",STAGE:"stage"},Nt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},$t=new Set,It=new Set,Xr=new Map,Zr={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},Jr={filter:({level:i})=>i!==Nt.DEBUG},ea={filter:()=>!1};function ta(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&gt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function ra(i){[...It].every(t=>t(i))&&$t.forEach(t=>t(i))}function ei(i){let t=(Xr.get(i)??0)+1;Xr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>ei(`${r.namespace}/${a}`),updateConfig:Kr};return Object.values(Nt).forEach(a=>{r[a]=(n,...o)=>ra(ta(a,n,i,o,e))}),Object.seal(r)}function ut(...i){i.forEach(t=>{let{append:e,filter:r}=t;gt(r)&&It.add(r),gt(e)&&$t.add(e)})}function ia(i={}){let{name:t}=i,e=Vr(mt("commerce.debug",{search:!0,storage:!0}),t===Qr.LOCAL);return ut(e?Zr:Jr),t===Qr.PROD&&ut(Dt),je}function aa(){$t.clear(),It.clear()}var je={...ei(ur),Level:Nt,Plugins:{consoleAppender:Zr,debugFilter:Jr,quietFilter:ea,lanaAppender:Dt},init:ia,reset:aa,use:ut};var na="mas-commerce-service",Ks=je.module("utilities"),oa={requestId:rt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ft=i=>window.setTimeout(i);function Ft(){return document.getElementsByTagName(na)?.[0]}function ti(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(oa)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function ri(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var ii="fragment",ai="author",ni="preview",oi="loading",si="timeout",Bt="aem-fragment",ci="eager",li="cache",sa=[ci,li],F,ne,D,Ht=class{constructor(){g(this,F,new Map);g(this,ne,new Map);g(this,D,new Map)}clear(){c(this,F).clear(),c(this,ne).clear(),c(this,D).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,F).set(t.id,t),t.fields?.originalId&&c(this,F).set(t.fields.originalId,t),c(this,D).has(t.id)){let[,r]=c(this,D).get(t.id);r()}if(c(this,D).has(t.fields?.originalId)){let[,r]=c(this,D).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,F).has(t)}entries(){return c(this,F).entries()}get(t){return c(this,F).get(t)}getAsPromise(t){let[e]=c(this,D).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,D).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ne).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ne).set(t,e)),e}remove(t){c(this,F).delete(t),c(this,ne).delete(t),c(this,D).delete(t)}};F=new WeakMap,ne=new WeakMap,D=new WeakMap;var K=new Ht,ze,N,U,R,_,k,Ve,Ye,$,We,Ke,_e,I,di,pi,qt,hi,xt=class extends HTMLElement{constructor(){super(...arguments);g(this,I);l(this,"cache",K);g(this,ze);g(this,N,null);g(this,U,null);g(this,R,null);g(this,_);g(this,k);g(this,Ve,ci);g(this,Ye,5e3);g(this,$);g(this,We,!1);g(this,Ke,0);g(this,_e)}static get observedAttributes(){return[ii,oi,si,ai,ni]}attributeChangedCallback(e,r,a){e===ii&&(m(this,_,a),m(this,k,K.getFetchInfo(a))),e===oi&&sa.includes(a)&&m(this,Ve,a),e===si&&m(this,Ye,parseInt(a,10)),e===ai&&m(this,We,["","true"].includes(a)),e===ni&&m(this,_e,a)}connectedCallback(){if(!c(this,$)){if(c(this,R)??m(this,R,J(this)),m(this,_e,c(this,R).settings?.preview),c(this,ze)??m(this,ze,c(this,R).log.module(`${Bt}[${c(this,_)}]`)),!c(this,_)||c(this,_)==="#"){c(this,k)??m(this,k,K.getFetchInfo("missing-fragment-id")),A(this,I,qt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,$)&&!await Promise.race([c(this,$),Promise.resolve(!1)]))return;e&&K.remove(c(this,_)),c(this,Ve)===li&&await Promise.race([K.getAsPromise(c(this,_)),new Promise(s=>setTimeout(s,c(this,Ye)))]);try{m(this,$,A(this,I,hi).call(this)),await c(this,$)}catch(s){return A(this,I,qt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,N)||{};return o&&!mt("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ge,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,$)}get updateComplete(){return c(this,$)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,We)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,N)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,U,e.reduce((p,{name:h,multiple:b,values:P})=>(p.fields[h]=b?P:P[0],p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,U,Object.entries(e).reduce((p,[h,b])=>(p.fields[h]=b?.mimeType?b.value:b??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,_),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};ze=new WeakMap,N=new WeakMap,U=new WeakMap,R=new WeakMap,_=new WeakMap,k=new WeakMap,Ve=new WeakMap,Ye=new WeakMap,$=new WeakMap,We=new WeakMap,Ke=new WeakMap,_e=new WeakMap,I=new WeakSet,di=async function(e){Zt(this,Ke)._++;let r=`${Bt}:${c(this,_)}:${c(this,Ke)}`,a=`${r}${it}`,n=`${r}${at}`;if(c(this,_e))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await ri(e,{cache:"default",credentials:"omit"}),A(this,I,pi).call(this,o),c(this,k).status=o?.status,c(this,k).measure=xe(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new ie("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,k).measure=xe(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,N))return c(this,k).stale=!0,c(this,ze).error("Serving stale data",c(this,k)),c(this,N);let d=s.message??"unknown";throw new ie(`Failed to fetch fragment: ${d}`,{})}},pi=function(e){Object.assign(c(this,k),ti(e))},qt=function(e){m(this,$,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,R).duration};c(this,ze).error(e,r),this.dispatchEvent(new CustomEvent(ue,{detail:r,bubbles:!0,composed:!0}))},hi=async function(){var d;this.classList.remove("error"),m(this,U,null);let e=K.get(c(this,_));if(e)return m(this,N,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,R).settings,s=`${r}/fragment?id=${c(this,_)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await A(this,I,di).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,_)),K.add(e),m(this,N,e),!0},l(xt,"cache",K);customElements.define(Bt,xt);import{LitElement as ca,html as Ut,css as la,nothing as da}from"./lit-all.min.js";import{unsafeHTML as pa}from"./lit-all.min.js";var ha=i=>i?i.startsWith("sp-icon-")?Ut`${pa(`<${i} class="badge-icon"></${i}>`)}`:Ut`<img src="${i}" class="badge-icon" />`:da,Pe=class extends ca{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Ut`<div class="badge">
    ...
    `);customElements.define("merch-badge",Pe);import{html as ma,css as ga,LitElement as ua}from"./lit-all.min.js";var Qe=class extends ua{constructor(){super()}render(){return ma`
            <slot name="icon"></slot>
    ...
    `),l(Qe,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Qe);import{html as Gt,css as fa,LitElement as xa,nothing as mi}from"./lit-all.min.js";var Xe=class extends xa{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Gt`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Gt`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:mi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};l(Xe,"styles",fa`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

...
`,rr=()=>[er`
    ...
    `);customElements.define("merch-addon",fe);import{html as nt,nothing as Pi}from"./lit-all.min.js";var xe,Be=class Be{constructor(t){d(this,"card");g(this,xe);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,xe,c(this,xe)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,xe)}insertVariantStyle(){let t=this.constructor.name;if(!Be.styleMap[t]){Be.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=t.style.minHeight;t.style.minHeight="auto";let n=Math.max(0,parseInt(window.getComputedStyle(t).height)||0);t.style.minHeight=a;let o=this.getContainer(),s=parseInt(o.style.getPropertyValue(r))||0;n>s&&o.style.setProperty(r,`${n}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),nt`
            <div
                id="badge"

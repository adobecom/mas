var Rr=Object.defineProperty;var Or=a=>{throw TypeError(a)};var Pi=(a,r,e)=>r in a?Rr(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var _i=(a,r,e)=>()=>{if(e)throw e[0];try{return a&&(r=a(a=0)),r}catch(t){throw e=[t],t}};var Mi=(a,r)=>{for(var e in r)Rr(a,e,{get:r[e],enumerable:!0})};var d=(a,r,e)=>Pi(a,typeof r!="symbol"?r+"":r,e),Jt=(a,r,e)=>r.has(a)||Or("Cannot "+e);var p=(a,r,e)=>(Jt(a,r,"read from private field"),e?e.call(a):r.get(a)),v=(a,r,e)=>r.has(a)?Or("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),u=(a,r,e,t)=>(Jt(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),k=(a,r,e)=>(Jt(a,r,"access private method"),e);var ir={};Mi(ir,{default:()=>tt});import{LitElement as Di,html as ye,css as Fi,nothing as $i}from"./lit-all.min.js";import{unsafeHTML as ra}from"./lit-all.min.js";import{ifDefined as Ii}from"./lit-all.min.js";function Hi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var O,tt,nr=_i(()=>{O=class O extends Di{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();O.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),l=c?c.offsetWidth:o,h=c?c.offsetHeight:s,g=this.effectivePlacement;g==="top"&&e.top-h-n<0?g="bottom":g==="bottom"&&e.bottom+h+n>i?g="top":g==="left"&&e.left-l-n<0?g="right":g==="right"&&e.right+l+n>t&&(g="left");let E=e.left+e.width/2,A=e.top+e.height/2,I=6,Ct=(Ti,Li,zi)=>Math.max(Ti,Math.min(Li,zi)),St,At,Xt;g==="top"||g==="bottom"?(St=g==="top"?e.top-h-n:e.bottom+n,At=Ct(0,t-l,E-l/2),Xt=Ct(I,l-I*2,E-At-I)):(At=g==="left"?e.left-l-n:e.right+n,St=Ct(0,i-h,A-h/2),Xt=Ct(I,h-I*2,A-St-I)),this._tooltipTop=St,this._tooltipLeft=At,this._arrowOffset=Xt,this._computedPlacement=g}showTooltip(){O.activeTooltip&&O.activeTooltip!==this&&(O.activeTooltip.closeOverlay(),O.activeTooltip.tooltipVisible=!1,O.activeTooltip.requestUpdate()),O.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){O.activeTooltip===this&&(O.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?ye`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:ye`<slot></slot>`}render(){let r=this.effectiveContent,e=this.effectivePlacement;if(!r)return ye`<span class="icon-only">${this.renderIcon()}</span>`;if(Hi())return ye`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let i=r.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:m=>{this.lastPointerType=m.pointerType},pointerenter:m=>m.pointerType!=="touch"&&this.showTooltip(),pointerleave:m=>m.pointerType!=="touch"&&this.hideTooltip(),click:m=>{this.lastPointerType==="touch"&&this.handleTap(m),this.lastPointerType=null}},s=this._computedPlacement,c=s==="top"||s==="bottom",l=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,h=c?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return ye`
            <span
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${Ii(l)}>
                    ${ra(r)}
                    ${this.smartPlacement?ye`<span
                              aria-hidden="true"
                              role="presentation"
    ...
    `);tt=O;customElements.define("mas-mnemonic",tt)});import{LitElement as jo}from"./lit-all.min.js";import{css as Fr,unsafeCSS as Dr}from"./lit-all.min.js";var C="(max-width: 767px)",L="(max-width: 1199px)",w="(min-width: 768px)",b="(min-width: 1200px)",M="(min-width: 1600px)",Ze="(min-width: 1280px)",Nr={matchMobile:window.matchMedia(C),matchDesktop:window.matchMedia(`${b} and (not ${M})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(M),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Nr;function Tt(){return Nr.isDesktop}var $r=Fr`
    :host {
...
`,Ir=()=>[Fr`
        ...
        `];import{LitElement as Bi,html as aa,css as qi}from"./lit-all.min.js";var Xo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Jo=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var be=2e4;var y='span[is="inline-price"][data-wcs-osi]',W='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Ri='a[is="upt-link"]',Hr=`${y},${W},${Ri}`,Br=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);var qr="merch-offer-select:ready",Ur="merch-card:action-menu-toggle";var R="merch-quantity-selector:change",Xe="merch-card-quantity:change",er="merch-modal:addon-and-quantity-update";var xe="merch-card-collection:literals-changed";var Lt="aem:load",zt="aem:error",oe="mas:ready",jr="mas:error";var Gr="placeholder-failed",Vr="placeholder-pending",Wr="placeholder-resolved";var Yr="mas:failed",D="mas:resolved",Kr="mas/commerce";var Z="failed",ce="pending",X="resolved";var tr="X-Request-Id",ec=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var tc=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Qr=":start",Zr=":duration";var _="legal",Xr="mas-ff-defaults",B="mas-ff-annual-price";var Oi="mas-commerce-service";function Jr(a,r){let e;return function(){let t=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(t,i),r)}}function z(a,r={},e=null,t=null){let i=t?document.createElement(a,{is:t}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function rr(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function ar(){return window.matchMedia("(max-width: 1024px)").matches}function Je(){return document.getElementsByTagName(Oi)?.[0]}function et(a){let r=window.getComputedStyle(a);return a.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function ea(a){let r=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var Ni=["www.adobe.com","www.stage.adobe.com"];function ta(a,r=window.location.hostname){if(!a||!Ni.includes(r))return a;try{let e=new URL(a,`https://${r}`);return/\.aem\.(live|page)$/.test(e.hostname)?`${e.pathname}${e.search}${e.hash}`:a}catch{return a}}function Ui(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var we=class extends Bi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Ui())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let t="",i="top";if(e.tagName==="SP-TOOLTIP")t=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(t=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(t){let n=document.createElement("mas-mnemonic");n.setAttribute("content",t),n.setAttribute("placement",i);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>nr())}e.remove()})}render(){let{href:r}=this,e=ta(this.src);return r?aa`<a href="${r}">
                  <img
                      src="${e}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(we,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(we,"styles",qi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",we);var rt,se,at,it,Ee,Pt=class extends HTMLElement{constructor(){super();v(this,rt,"");v(this,se);v(this,at,[]);v(this,it,[]);v(this,Ee);u(this,Ee,Jr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,p(this,se)?this.parentElement.style.borderRadius=p(this,se):p(this,se)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=p(this,at).map((t,i)=>{let n=p(this,it)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${p(this,rt)}, ${e})`}connectedCallback(){p(this,Ee).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&u(this,se,i?.trim()),e==="colors"&&i?u(this,at,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?u(this,it,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&u(this,rt,i?.trim()??""),p(this,Ee).call(this)}};rt=new WeakMap,se=new WeakMap,at=new WeakMap,it=new WeakMap,Ee=new WeakMap;customElements.define("merch-gradient",Pt);import{LitElement as ji,html as Gi,css as Vi}from"./lit-all.min.js";var ke=class extends ji{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${r}"] ${y}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(D,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(D,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];if(!t)return;e.setAttribute("data-offer-type",t.offerType);let i=e.closest("p");if(i.getAttribute("data-plan-type"))return;let n=this.querySelector(`p[data-plan-type="${t.planType}"]`);n&&n!==i||i.setAttribute("data-plan-type",t.planType)}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return Gi` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(ke,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0},background:{type:String,attribute:"background"}}),d(ke,"styles",Vi`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as ot,css as Ki}from"./lit-all.min.js";var oa=`
:root {
...
`;var ca={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},le=class extends f{constructor(r){super(r)}getGlobalCSS(){return oa}renderLayout(){return ot`<div class="image">
    ...
    `);import{html as la}from"./lit-all.min.js";var sa=`
:root {
...
`;var Rt=class extends f{constructor(r){super(r)}getGlobalCSS(){return sa}renderLayout(){return la` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":la`<hr />`} ${this.secureLabelFooter}`}};import{html as J,css as cn,unsafeCSS as wa}from"./lit-all.min.js";var da=`
  :root {
...
`;function ha(a,r={},{metadata:e=!0,search:t=!0,storage:i=!0}={}){let n;if(t&&n==null){let o=new URLSearchParams(window.location.search),s=cr(t)?t:a;n=o.get(s)}if(i&&n==null){let o=cr(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Zi(cr(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[a]}var Qi=a=>typeof a=="boolean",Ot=a=>typeof a=="function";var cr=a=>typeof a=="string";function pa(a,r){if(Qi(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:r}function Zi(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,e,t)=>`${e}-${t}`).replace(/\W+/gu,"-").toLowerCase()}var de={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ma=1e3;function Xi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ga(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!de.serializableTypes.includes(e))return e}return a}function Ji(a,r){if(!de.ignoredProperties.includes(a))return ga(r)}var sr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(l=>{l!=null&&(Xi(l)?t:i).push(l)}),t.length&&(n+=` ${t.map(ga).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${de.delimiter}page=${o}${s}`;c.length>ma&&(c=`${c.slice(0,ma)}<trunc>`),n+=c,i.length&&(n+=`${de.delimiter}facts=`,n+=JSON.stringify(i,Ji)),window.lana?.log(n,de)}};function ua(a){Object.assign(de,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in de&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var fa={LOCAL:"local",PROD:"prod",STAGE:"stage"},lr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},dr=new Set,hr=new Set,va=new Map,ba={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},xa={filter:({level:a})=>a!==lr.DEBUG},en={filter:()=>!1};function tn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Ot(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function rn(a){[...hr].every(r=>r(a))&&dr.forEach(r=>r(a))}function ya(a){let r=(va.get(a)??0)+1;va.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>ya(`${t.namespace}/${i}`),updateConfig:ua};return Object.values(lr).forEach(i=>{t[i]=(n,...o)=>rn(tn(i,n,a,o,e))}),Object.seal(t)}function Nt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Ot(t)&&hr.add(t),Ot(e)&&dr.add(e)})}function an(a={}){let{name:r}=a,e=pa(ha("commerce.debug",{search:!0,storage:!0}),r===fa.LOCAL);return Nt(e?ba:xa),r===fa.PROD&&Nt(sr),ct}function nn(){dr.clear(),hr.clear()}var ct={...ya(Kr),Level:lr,Plugins:{consoleAppender:ba,debugFilter:xa,quietFilter:en,lanaAppender:sr},init:an,reset:nn,use:Nt};var on="mas-commerce-service",is=ct.module("utilities");var Dt=a=>window.setTimeout(a);function H(){return document.getElementsByTagName(on)?.[0]}var sn=32,Ea={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Ae=class extends f{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?J`<slot name="secure-transaction-label">
    ...
    `);import{html as Ft,css as ln,unsafeCSS as pr,nothing as dn}from"./lit-all.min.js";var ka=`
  :root {
...
`;var hn=32,pn=0,mn=()=>`mweb-list-${pn+=1}`,gn=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],un=8,Ca={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},q,he,Le,ze,Pe,ee,mr,gr,Te=class extends f{constructor(e){super(e);v(this,ee);v(this,q);v(this,he);v(this,Le);v(this,ze,0);v(this,Pe);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>Ft` <footer>
        ...
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(R,this.updatePriceQuantity),u(this,ze,this.card.getBoundingClientRect().width),u(this,he,new ResizeObserver(()=>{let e=this.card.getBoundingClientRect().width;e!==p(this,ze)&&(u(this,ze,e),clearTimeout(p(this,Le)),u(this,Le,setTimeout(()=>this.reconcileBreakpoint(),150)))})),p(this,he).observe(this.card)}disconnectedCallbackHook(){this.card.removeEventListener(R,this.updatePriceQuantity),clearTimeout(p(this,Le)),p(this,he)?.disconnect(),u(this,he,null),p(this,q)?.disconnect(),u(this,q,null)}reconcileBreakpoint(){x.isMobile?(this.resetSyncedHeights(),this.removeEmptyRows()):k(this,ee,gr).call(this)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}syncHeights(){if(x.isMobile)return;if(this.card.getBoundingClientRect().width<=2){p(this,q)||(u(this,q,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(p(this,q)?.disconnect(),u(this,q,null),this.syncHeights())})),p(this,q).observe(this.card));return}let e=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)}))),this.adjustMiniCompareFooterRows()}priceOptionsProvider(e,t){if(e.dataset.template===_){t.displayPlanType=this.card?.settings?.displayPlanType??!1;return}let i=H();(e.dataset.template==="strikethrough"||e.dataset.template==="price"&&!i.featureFlags[B])&&(t.displayPerUnit=!1)}getGlobalCSS(){return ka}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((t,i)=>{let n=Math.max(hn,parseFloat(window.getComputedStyle(t).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(t=>{let i=t.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&t.remove()})}setupToggle(){let e=this.card.querySelector('[slot="body-xs"]'),t=e?.querySelector("p"),i=e?.querySelector("ul");if(!t||!i||e.querySelector(".footer-rows-title"))return;let n=t.textContent.trim(),o=this.card.querySelector("h3")?.id,s=o?`${o}-list`:mn();i.id=s,i.classList.add("checkmark-copy-container");let c=z("h4",{class:"footer-rows-title"},n),l=z("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":s});u(this,Pe,{toggleBtn:l,listEl:i}),c.append(l),c.addEventListener("click",()=>{x.isMobile&&this.setListOpen(!this.isListOpen)}),t.replaceWith(c)}get isListOpen(){return p(this,Pe)?.listEl.classList.contains("open")??!1}setListOpen(e){let{toggleBtn:t,listEl:i}=p(this,Pe);i.classList.toggle("open",e),t.classList.toggle("expanded",e),t.setAttribute("aria-expanded",String(e))}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${y}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{let e=H();this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let i=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.featureFlags[B]&&t.options.displayTax?i.dataset.displayTax="false":t.options.displayTax&&(t.dataset.displayTax="false"),e.featureFlags[B]&&t.options.displayPerUnit?i.dataset.displayPerUnit="false":t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),i.setAttribute("data-template","legal"),t.parentNode.insertBefore(i,t.nextSibling),await i.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?dn:Ft`<slot name="icons"></slot>`}renderLayout(){return Ft`
            ${this.badge}
            <div class="body">
                <div class="body-main">
                    ${this.icons}
        ...
        `}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),x.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),x.isMobile||await k(this,ee,gr).call(this)}resetSyncedHeights(){let e=this.getContainer();if(!e)return;let t=this.card.variant,i=k(this,ee,mr).call(this,e);for(let n of gn){let o=`--consonant-merch-card-${t}-${n}-height`;e.style.removeProperty(o),i.forEach(s=>s.style.removeProperty(o))}for(let n=1;n<=un;n+=1)e.style.removeProperty(this.getRowMinHeightPropertyName(n))}};q=new WeakMap,he=new WeakMap,Le=new WeakMap,ze=new WeakMap,Pe=new WeakMap,ee=new WeakSet,mr=function(e){return e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)},gr=async function(){let e=this.getContainer();if(!e)return;let t=Array.from(k(this,ee,mr).call(this,e));this.card===t[0]&&(await Promise.all(t.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),requestAnimationFrame(()=>{this.resetSyncedHeights(),this.syncHeights()}))},d(Te,"variantStyle",ln`
    ...
    `);import{html as st,css as fn,nothing as $t}from"./lit-all.min.js";var Sa=`
:root {
...
`;var It={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Aa={...(function(){let{whatsIncluded:a,size:r,...e}=It;return e})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Ta={...(function(){let{subtitle:a,whatsIncluded:r,size:e,quantitySelect:t,...i}=It;return i})()},U,j,N=class extends f{constructor(e){super(e);v(this,U);v(this,j);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===_&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Sa}adjustSlotPlacement(e,t,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${e}"]`),l=n.querySelector(`.body slot[name="${e}"]`),h=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!t.includes(s)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&c){if(l)c.remove();else{let m=h.querySelector(`[data-placeholder-for="${e}"]`);m?m.replaceWith(c):h.appendChild(c)}return}if(i&&l){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",e),m.classList.add("slot-placeholder"),!c){let g=l.cloneNode(!0);o.prepend(g)}l.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){p(this,U)||(u(this,U,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(p(this,U)?.disconnect(),u(this,U,null),this.syncHeights())})),p(this,U).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let i=t.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),t.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,h=this.card.querySelector('[slot="heading-s"]');h&&(l+=et(h));let m=this.card.querySelector('[slot="subtitle"]');m&&(l+=et(m));let g=this.card.querySelector('[slot="heading-m"]');g&&(l+=8+et(g));for(let A of t.childNodes){if(A.classList.contains("spacer"))break;l+=et(A)}let E=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(E)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?st`<div class="divider"></div>`:$t}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);t&&e.push(t);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?st`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};U=new WeakMap,j=new WeakMap,d(N,"variantStyle",fn`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),d(N,"collectionOptions",{customHeaderArea:e=>e.sidenav?st`<slot name="resultsText"></slot>`:$t,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let t=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};x.matchDesktop.addEventListener("change",t),e.addEventListener(xe,t),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",t),e.removeEventListener(xe,t)})}});import{html as Y,css as vn,unsafeCSS as za,nothing as Ht}from"./lit-all.min.js";var La=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?Y`
    ...
    `),d(te,"collectionOptions",{customHeaderArea:r=>r.sidenav?Y`<slot name="resultsText"></slot>`:Ht,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let e=()=>{let t=r.querySelectorAll("merch-card");if(t.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!x.isDesktop)return;let i=0;t.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),i+=s})};x.matchDesktop.addEventListener("change",e),r.addEventListener(xe,e),r.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",e),r.removeEventListener(xe,e)})}});import{html as K,css as bn,nothing as _e,unsafeCSS as lt}from"./lit-all.min.js";var _a=`
:root {
...
`;var[Ys,Ks,Ma,Ra,Oa,Na]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var qt="pro",ur=`--consonant-merch-card-${qt}-top-card-height`,Bt=[{prop:`--consonant-merch-card-${qt}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${qt}-name-description-height`,selector:".name-description"}],Da=`--consonant-merch-card-${qt}-strike-reserve`,fr='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',xn="(min-width: 768px)",Fa={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Q,pe,mt,gt,P,$a,dt,Ia,ht,vr,Ut,jt=class jt extends f{constructor(e){super(e);v(this,P);d(this,"expanded",!1);d(this,"licenseOpen",!1);d(this,"licenseQty",null);d(this,"licenseHighlightedIndex",0);v(this,Q,null);v(this,pe,null);v(this,mt,()=>this.resyncOnReflow());d(this,"lastSyncKey",null);v(this,gt,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});d(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of k(this,P,$a).call(this)){let n=i.variantLayout;n instanceof jt&&(n.expanded=t,i._proExpanded=t,i.requestUpdate())}});d(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?k(this,P,vr).call(this):k(this,P,ht).call(this),this.card.requestUpdate()});v(this,Ut,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Ra:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:k(this,P,ht).call(this);break;case Ma:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:k(this,P,ht).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Oa:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}k(this,P,ht).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),k(this,P,vr).call(this);break;case Na:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});d(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,k(this,P,dt).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(R,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._proExpanded??!1}getGlobalCSS(){return _a}priceOptionsProvider(e,t){e.dataset.template===_&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(D,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let t=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=t?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=t.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let e=this.card.querySelector('[slot="whats-included"]');if(!e||e.querySelector(".whats-included-title"))return;let t=e.querySelector(".whats-included-label");if(!t)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=t.innerHTML,t.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),e.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,e.append(c)}}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=ur,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(xn).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((h,m)=>{let g=l(m);return g?Math.max(h,parseInt(getComputedStyle(g).height)||0):h},0);for(let c of o.values()){if(c.forEach(g=>this.clearSyncedHeights(g)),c.length<2)continue;let l=c.map(g=>g.querySelector(fr)&&parseInt(getComputedStyle(g.querySelector(fr)).height)||0),h=Math.max(0,...l);h>0&&c.forEach((g,E)=>{let A=h-l[E];A>0&&g.style.setProperty(Da,`${A}px`)});for(let g of Bt){let E=s(c,A=>A.shadowRoot?.querySelector(g.selector));E>0&&c.forEach(A=>A.style.setProperty(g.prop,`${E}px`))}let m=s(c,g=>g.shadowRoot?.querySelector(".top-card"));m>0&&c.forEach(g=>g.style.setProperty(i,`${m}px`))}}clearSyncedHeights(e){e.style.removeProperty(ur),e.style.removeProperty(Da),Bt.forEach(t=>e.style.removeProperty(t.prop))}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(e),t('[slot="body-xs"]'),t(fr),t('[slot="heading-m"] span[is="inline-price"]'),t('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),t(".license-zone",this.card.shadowRoot),t(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Xe,p(this,gt)),this.card.addEventListener(R,this.updatePriceQuantity),this.card.addEventListener(D,p(this,mt)),typeof ResizeObserver>"u"))return;u(this,pe,new ResizeObserver(()=>this.resyncOnReflow())),p(this,pe).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&p(this,pe).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(R,this.updatePriceQuantity),this.card?.removeEventListener(D,p(this,mt)),k(this,P,dt).call(this),p(this,pe)?.disconnect(),this.card?.removeEventListener(Xe,p(this,gt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t||n<1)return null;let o=[];for(let s=t;s<=i;s+=n)o.push(String(s));return o}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return K`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return K`
            <div class="license-select" ?data-open=${i}>
                <div
                    ...
                    aria-activedescendant=${i?`license-option-${this.licenseHighlightedIndex}`:_e}
        ...
        `}renderLayout(){let e=!!this.expanded;return K`
            <div class="top-card">
                <div class="mnemonic">
                    <slot name="icons"></slot>
                    <slot name="subtitle"></slot>
                ...
                ${this.hasLicenseSelector||this.hasCallout||this.hasQuantitySelect?K`<div class="license-zone">
                          ${this.renderLicenseSelector()}
                          ${this.hasCallout?K`<div class="callout">
                                    <slot name="callout-content"></slot>
                                </div>`:_e}
                      </div>`:_e}
                ${this.hasAddOn?K`<div class="add-on">
                          <slot name="addon"></slot>
                      </div>`:_e}
                <footer>
                    <slot name="footer"></slot>
            ...
            ${this.hasWhatsIncluded?K`
                  ...
                  `:_e}
            ${this.hasEduDisclaimer?K`<div class="edu-disclaimer">
                      <slot name="edu-disclaimer"></slot>
                  </div>`:_e}
            <slot></slot>
        `}};Q=new WeakMap,pe=new WeakMap,mt=new WeakMap,gt=new WeakMap,P=new WeakSet,$a=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},dt=function(){p(this,Q)&&(document.removeEventListener("mousedown",p(this,Q)),u(this,Q,null))},Ia=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},ht=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=k(this,P,Ia).call(this),p(this,Q)||(u(this,Q,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),k(this,P,dt).call(this))}),document.addEventListener("mousedown",p(this,Q)))},vr=function(){this.licenseOpen=!1,k(this,P,dt).call(this)},Ut=new WeakMap,d(jt,"variantStyle",bn`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
        ...
        :host([variant='pro']) .mnemonic {
            ...
            align-items: center;
            gap: 12px;
            min-height: var(${lt(Bt[0].prop)}, auto);
        }
        ...
        :host([variant='pro']) .name-description {
            ...
            flex: 0 0 auto;
            min-height: var(${lt(Bt[1].prop)}, auto);
        }
    ...
    `);var pt=jt;import{html as br,css as yn}from"./lit-all.min.js";var Ha=`
:root {
...
`;var Ba={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},G,Me=class extends f{constructor(e){super(e);v(this,G);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ha}priceOptionsProvider(e,t){e.dataset.template===_&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return br` ${this.badge}
    ...
    `);import{html as wn,css as En}from"./lit-all.min.js";var qa=`
...
`;var Ua={cardName:{attribute:"name"},mnemonics:{size:"l"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},planType:!0,promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},Re=class extends f{getGlobalCSS(){return qa}priceOptionsProvider(r,e){r.dataset.template===_&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`);if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}renderLayout(){return wn` ${this.badge}
            ...
            <slot></slot>`}};d(Re,"variantStyle",En`
    ...
    `);import{html as xr,css as kn}from"./lit-all.min.js";var ja=`
:root {
...
`;var Ga={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Oe=class extends f{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===_&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ja}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return xr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Wa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ne=class extends f{constructor(r){super(r)}getGlobalCSS(){return Va}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Cn`
    ...
    `);import{html as yr,css as An}from"./lit-all.min.js";var Ya=`
:root {
...
`;var Ka={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},De=class extends f{constructor(e){super(e);d(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Ya}priceOptionsProvider(e,t){t.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayPlanType="false",t.dataset.template="legal",t.dataset.displayPerUnit="false",t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return yr`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?yr`
                  ...
                  `:yr`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(De,"variantStyle",An`
    ...
    `);import{html as Za,css as Tn}from"./lit-all.min.js";var Qa=`
:root {
...
`;var wr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Fe=class extends f{getGlobalCSS(){return Qa}get aemFragmentMapping(){return wr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return Za`<div
    ...
    `);import{html as Ja,css as Ln}from"./lit-all.min.js";var Xa=`
:root {
...
`;var Er={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},ut=class ut extends f{getGlobalCSS(){return Xa}get aemFragmentMapping(){return Er}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return Ja`<div
        ...
        >
            ...
            <slot></slot>
        `}};d(ut,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),d(ut,"variantStyle",Ln`
    ...
    `);var ft=ut;import{html as vt,nothing as ei}from"./lit-all.min.js";import{css as zn,unsafeCSS as Pn}from"./lit-all.min.js";var _n=["headless","marquee","faq","banner-blade"],$e=(a,r="")=>_n.map(e=>`merch-card[variant='${e}'] [slot='${a}']${r}`).join(`,
`),re=`
...
${$e("callout-content"," > p")},
${$e("callout-content"," > div")},
${$e("callout-content"," > div > div")} {
    background: transparent;
    padding: 0;
    border-radius: 0;
    width: auto;
}
`;function ae(a){let r=Pn(a);return zn`
        :host([variant='${r}']) {
            border: none;
            background: transparent;
            box-shadow: none;
    ...
    `}var ti={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},Mn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Ie=class extends f{constructor(r){super(r)}getGlobalCSS(){return re}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return vt`
        ...
        `}};d(Ie,"variantStyle",ae("headless"));import{css as Rn,html as On}from"./lit-all.min.js";var ri=`
...
`;var ai={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},He=class extends f{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return ri}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,t){t.literals={...t.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},t.space=!0,t.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",t.dataset.template="legal",t.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return On`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Nn,css as Dn}from"./lit-all.min.js";var ii=`
...
`;var kr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Fn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Gt,ni,Be=class extends f{constructor(e){super(e);v(this,Gt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return ii}get aemFragmentMapping(){return kr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,k(this,Gt,ni).call(this))}renderLayout(){return Nn`
            <div class="card">
            ...
            <slot></slot>
        `}};Gt=new WeakSet,ni=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Fn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},d(Be,"variantStyle",Dn`
    ...
    `);import{html as $n,css as In}from"./lit-all.min.js";var oi=`
...
`;var Cr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},qe=class extends f{getGlobalCSS(){return oi}get aemFragmentMapping(){return Cr}renderLayout(){return $n`
    ...
    `);import{html as Sr,nothing as Hn}from"./lit-all.min.js";var ci={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},Bn=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Ue=class extends f{constructor(r){super(r)}getGlobalCSS(){return re}renderLayout(){return Sr`
            <div class="headless">
                ${Bn.map(({slot:r,label:e})=>Sr`
                        <div class="headless-row">
        ...
        `}};d(Ue,"variantStyle",ae("marquee"));import{html as si}from"./lit-all.min.js";var li={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},qn=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],je=class extends f{constructor(r){super(r)}getGlobalCSS(){return re}renderLayout(){return si`
            <div class="headless">
                ${qn.map(({slot:r,label:e})=>si`
                        <div class="headless-row">
                            <span class="headless-label">${e}</span>
                            <span class="headless-value">
                                <slot name="${r}"></slot>
        ...
        `}};d(je,"variantStyle",ae("faq"));import{html as di}from"./lit-all.min.js";var hi={cardName:{attribute:"name"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},Un=[{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],Ge=class extends f{constructor(r){super(r)}getGlobalCSS(){return re}renderLayout(){return di`
            <div class="headless">
                ${Un.map(({slot:r,label:e})=>di`
                        <div class="headless-row">
                            <span class="headless-label">${e}</span>
                            <span class="headless-value">
                                <slot name="${r}"></slot>
        ...
        `}};d(Ge,"variantStyle",ae("banner-blade"));var Vt=new Map,pi=new WeakMap,mi=new Map,S=(a,r,e=null,t=null,i)=>{Vt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",Se,na,Se.variantStyle);S("image",le);S("inline-heading",Rt);S("mini-compare-chart",Ae,Ea,Ae.variantStyle);S("mini-compare-chart-mweb",Te,Ca,Te.variantStyle);S("plans",N,It,N.variantStyle,N.collectionOptions);S("plans-students",N,Ta,N.variantStyle,N.collectionOptions);S("plans-education",N,Aa,N.variantStyle,N.collectionOptions);S("plans-v2",te,Pa,te.variantStyle,te.collectionOptions);S("pro",pt,Fa,pt.variantStyle);S("product",Me,Ba,Me.variantStyle);S("brand-concierge-product",Re,Ua,Re.variantStyle);S("segment",Oe,Ga,Oe.variantStyle);S("media",Ne,Wa,Ne.variantStyle);S("headless",Ie,ti,Ie.variantStyle);S("special-offers",De,Ka,De.variantStyle);S("simplified-pricing-express",Fe,wr,Fe.variantStyle);S("full-pricing-express",ft,Er,ft.variantStyle);S("mini",He,ai,He.variantStyle);S("image",le,ca,le.variantStyle);S("compare-chart-column",Be,kr,Be.variantStyle);S("fries",qe,Cr,qe.variantStyle);S("marquee",Ue,ci,Ue.variantStyle);S("faq",je,li,je.variantStyle);S("banner-blade",Ge,hi,Ge.variantStyle);var jn=(a,r,e)=>{try{let t=mi.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),mi.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Ar=a=>{let r=Vt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=pi.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?jn(a,t,i):{};return pi.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Mt(a){return Vt.get(a)?.fragmentMapping}function gi(a){return Vt.get(a)?.collectionOptions}var ui=document.createElement("style");ui.innerHTML=`
:root {
...
`;document.head.appendChild(ui);import{LitElement as Gn,html as Tr,css as Vn,nothing as Wn}from"./lit-all.min.js";import{unsafeHTML as Yn}from"./lit-all.min.js";var Kn=a=>a?a.startsWith("sp-icon-")?Tr`${Yn(`<${a} class="badge-icon"></${a}>`)}`:Tr`<img src="${a}" class="badge-icon" />`:Wn,Ve=class extends Gn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Tr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Ve);import{html as Qn,css as Zn,LitElement as Xn}from"./lit-all.min.js";var bt=class extends Xn{constructor(){super()}render(){return Qn`
            <slot name="icon"></slot>
    ...
    `),d(bt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",bt);import{html as Lr,css as Jn,LitElement as eo,nothing as fi}from"./lit-all.min.js";var xt=class extends eo{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Lr`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?Lr`<slot name="content"></slot>`:fi}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Lr`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:fi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(xt,"styles",Jn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),d(xt,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",xt);var Wt=class a extends Error{constructor(r,e,t){if(super(r,{cause:t}),this.name="MasError",e.response){let i=e.response.headers?.get(tr);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let r=Object.entries(this.context||{}).map(([t,i])=>`${t}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return r&&(e+=` (${r})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var to={[Z]:Gr,[ce]:Vr,[X]:Wr},ro={[Z]:Yr,[X]:D},yt,Yt=class{constructor(r){v(this,yt);d(this,"changes",new Map);d(this,"connected",!1);d(this,"error");d(this,"log");d(this,"options");d(this,"promises",[]);d(this,"state",ce);d(this,"timer",null);d(this,"value");d(this,"version",0);d(this,"wrapperElement");this.wrapperElement=r,this.log=ct.module("mas-element")}update(){[Z,ce,X].forEach(r=>{this.wrapperElement.classList.toggle(to[r],r===this.state)})}notify(){(this.state===X||this.state===Z)&&(this.state===X?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===Z&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let r=this.error;this.error instanceof Wt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(ro[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,e,t){this.changes.set(r,t),this.requestUpdate()}connectedCallback(){u(this,yt,H()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:e,state:t}=this;return X===t?Promise.resolve(this.wrapperElement):Z===t?Promise.reject(r):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(r,e,t){return r!==this.version?!1:(t!==void 0&&(this.options=t),this.state=X,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),Dt(()=>this.notify()),!0)}toggleFailed(r,e,t){if(r!==this.version)return!1;t!==void 0&&(this.options=t),this.error=e,this.state=Z,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...p(this,yt)?.duration}),Dt(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=ce,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!H()||this.timer)return;let{error:e,options:t,state:i,value:n,version:o}=this;this.state=ce,this.timer=Dt(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===ce&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,t)}})}};yt=new WeakMap;function ao(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ge,me=class me extends HTMLAnchorElement{constructor(){super();d(this,"masElement",new Yt(this));v(this,ge);this.setAttribute("is",me.is)}get isUptLink(){return!0}initializeWcsData(e,t){this.setAttribute("data-wcs-osi",e),t&&this.setAttribute("data-promotion-code",t)}attributeChangedCallback(e,t,i){this.masElement.attributeChangedCallback(e,t,i)}connectedCallback(){this.masElement.connectedCallback(),u(this,ge,Je()),p(this,ge)&&(this.log=p(this,ge).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),u(this,ge,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=Je();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let t=e.collectCheckoutOptions({},this);if(!t.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(t),n=e.resolveOfferSelectors(t);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=t,h=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,m=this.getAttribute("data-promotion-code");m&&(h+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${ao(l)}?${h}`,this.masElement.toggleResolved(i,o,t)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${t.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,t),!1}}static createFrom(e){let t=new me;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?t.setAttribute("class",i.value.replace("upt-link","").trim()):t.setAttribute(i.name,i.value));return t.innerHTML=e.innerHTML,t.setAttribute("tabindex",0),t}};ge=new WeakMap,d(me,"is","upt-link"),d(me,"tag","a"),d(me,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var ie=me;window.customElements.get(ie.is)||window.customElements.define(ie.is,ie,{extends:ie.tag});var io="#000000",zr="#F8D904",no="#EAEAEA",oo="#31A547",co=/(accent|primary|secondary)(-(outline|link))?/,so="mas:product_code/",lo="daa-ll",Kt="daa-lh",ho=["XL","L","M","S"],Pr="...";function F(a,r,e,t){let i=t[a];if(r[a]&&i){let n={slot:i?.slot,...i?.attributes},o=r[a];if(i.maxCount&&typeof o=="string"){let[c,l]=No(o,i.maxCount,i.withSuffix);c!==o&&(n.title=l,o=c)}let s=z(i.tag,n,o);e.append(s)}}function po(a,r,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,s)=>({icon:o,alt:a.mnemonicAlt?.[s]??"",link:a.mnemonicLink?.[s]??""}));i?.forEach(({icon:o,alt:s,link:c})=>{if(c&&!/^https?:/.test(c))try{c=new URL(`https://${c}`).href.toString()}catch{c="#"}let l={slot:"icons",src:o,loading:r.loading,size:e?.size??"l"};s&&(l.alt=s),c&&(l.href=c);let h=z("merch-icon",l);r.append(h)});let n=r.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function mo(a){let r=new DOMParser().parseFromString(a,"text/html").querySelector("merch-badge");return r?r.querySelector('span[is="inline-price"]')?!1:!r.textContent?.trim():!0}function go(a,r,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let i=zr,n=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(i=e.badge?.default,a.borderColor||(n=!0));let o=a.badgeBackgroundColor||i,s=a.borderColor||"";n&&(s=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${o}" border-color="${s}">${a.badge}</merch-badge>`}a.badge?.startsWith("<merch-badge")&&mo(a.badge)&&(a.badge=""),F("badge",a,r,e)}else a.badge?(r.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||r.setAttribute("badge-color",a.badgeColor||io),e.disabledAttributes?.includes("badgeBackgroundColor")||r.setAttribute("badge-background-color",a.badgeBackgroundColor||zr),r.setAttribute("border-color",a.badgeBackgroundColor||zr)):r.setAttribute("border-color",a.borderColor||no)}function uo(a,r,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let t=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||oo;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${t}">${a.trialBadge}</merch-badge>`}F("trialBadge",a,r,e)}}function fo(a,r,e){e?.includes(a.size)&&r.setAttribute("size",a.size)}function vo(a,r){a.cardName&&r.setAttribute("name",a.cardName)}function bo(a,r,e){a.cardTitle&&(a.cardTitle=We(a.cardTitle)),F("cardTitle",a,r,{cardTitle:e})}function xo(a,r,e){F("subtitle",a,r,e)}function yo(a,r,e,t){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){r.style.removeProperty("--merch-card-custom-background-color"),r.removeAttribute("background-color");return}e?.[a.backgroundColor]?(r.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),r.setAttribute("background-color",a.backgroundColor)):t?.attribute&&a.backgroundColor&&(r.setAttribute(t.attribute,a.backgroundColor),r.style.removeProperty("--merch-card-custom-background-color"))}function wo(a,r,e){let t=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")r.style.setProperty(i,"transparent");else if(a.borderColor&&t){let o=t?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),s=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){r.setAttribute("gradient-border","true");let c=a.borderColor;if(t?.specialValues){for(let[l,h]of Object.entries(t.specialValues))if(h===a.borderColor){c=l;break}}r.setAttribute("border-color",c),r.style.removeProperty(i)}else s?(r.setAttribute("border-color",a.borderColor),r.style.setProperty(i,`var(--${a.borderColor})`)):r.style.setProperty(i,`var(--${a.borderColor})`)}else r.style.removeProperty(i)}var Eo=new Set(["","default"]);function ko(a,r,e){let t=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!t)return;let o=(r.querySelector('[slot="footer-rows"] merch-whats-included')??r.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),s=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",c=o||s;if(c==null||Eo.has(String(c).trim().toLowerCase())){r.removeAttribute("whats-included-divider-color"),r.style.removeProperty(i);return}let l=String(c).trim();if(l.toLowerCase()==="transparent"){r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,"transparent");return}let m=t.specialValues?.[l]?.includes("gradient")||/-gradient/.test(l)||/^gradient-/.test(l),g=/^spectrum-.*-(plans|special-offers)$/.test(l);if(m){let E=l;if(t.specialValues){for(let[A,I]of Object.entries(t.specialValues))if(I===l){E=A;break}}r.setAttribute("whats-included-divider-color",E),r.style.removeProperty(i)}else g?(r.setAttribute("whats-included-divider-color",l),r.style.setProperty(i,`var(--${l})`)):(r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,`var(--${l})`))}function Co(a,r,e){if(a.backgroundImage){let t={loading:r.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?t.alt=a.backgroundImageAltText:t.role="none",!e)return;if(e?.attribute){r.setAttribute(e.attribute,a.backgroundImage);return}r.append(z(e.tag,{slot:e.slot},z("img",t)))}}function We(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(nr(),ir)).catch(console.error),a}function So(a,r,e){a.prices&&(a.prices=We(a.prices)),F("prices",a,r,e)}function _r(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap(_r);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap(_r);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function Ao(a,r,e){let t=_r(a.features).filter(n=>n.trim());if(!t.length)return;let i=z("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});t.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let s=o.body.querySelector("p[name]");if(s){i.append(s);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&r.append(i),Lo(r,e)}function bi(a,r,e){let t=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=co.exec(i)?.[0]??"accent",o=n.includes("accent"),s=n.includes("primary"),c=n.includes("secondary"),l=n.includes("-outline"),h=n.includes("-link");a.classList.remove("accent","primary","secondary");let m;if(r.consonant)m=Io(a,o,t,h,s,c,e?.ctas?.size);else if(h)m=a;else{let g;o?g="accent":s?g="primary":c&&(g="secondary"),m=r.spectrum==="swc"?$o(a,e,l,g,t):Fo(a,e,l,g,t)}return m}function To(a,r){let{slot:e}=r?.description;xi(a,r,e)}function Lo(a,r){let e=r?.features?.slot;e&&xi(a,r,e)}function xi(a,r,e){let t=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);t.length&&t.forEach(i=>{let n=bi(i,a,r);i.replaceWith(n)})}function zo(a,r,e,t){a.description&&(a.description=We(a.description)),a.promoText&&(a.promoText=We(a.promoText)),a.shortDescription&&(a.shortDescription=We(a.shortDescription)),F("promoText",a,r,e),F("description",a,r,e),F("shortDescription",a,r,e),a.shortDescription&&(r.setAttribute("action-menu","true"),a.actionMenuLabel||r.setAttribute("action-menu-label","More options")),To(r,e),F("callout",a,r,e),Po(a,r,e,t),F("whatsIncluded",a,r,e)}function Po(a,r,e,t={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=t.quantitySelect),F("quantitySelect",a,r,e))}function _o(a,r,e,t={}){if(!e.addon)return;let n=(a.addon??t.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o,s=n,c=document.createElement("div");c.innerHTML=n;let l=c.firstElementChild;l?.tagName?.toLowerCase()==="merch-addon"&&(o=l.getAttribute("background")||void 0,s=l.innerHTML);let h={slot:"addon"};o&&(h.background=o);let m=z("merch-addon",h,s);[...m.querySelectorAll(y)].forEach(g=>{let E=g.parentElement;E?.nodeName==="P"&&(E.hasAttribute("data-plan-type")||E.setAttribute("data-plan-type",""))}),r.append(m)}function Mo(a,r,e){a.addonConfirmation&&F("addonConfirmation",a,r,e)}function Ro(a,r,e){let t=e?.customFields;if(!t)return;let i=Array.isArray(a.customFields)?a.customFields:a.customFields?[a.customFields]:[],n=Array.isArray(a.customFieldLabels)?a.customFieldLabels:a.customFieldLabels?[a.customFieldLabels]:[];i.filter(Boolean).forEach((o,s)=>{let c=n[s],l=z(t.tag,{slot:`custom-field-${s}`,"data-label":c||""},o);r.append(l)})}function Oo(a,r,e,t){t?.secureLabel&&e?.secureLabel&&r.setAttribute("secure-label",t.secureLabel)}function No(a,r,e=!0){try{let t=typeof a!="string"?"":a,i=vi(t);if(i.length<=r)return[t,i];let n=0,o=!1,s=e?r-Pr.length<1?1:r-Pr.length:r,c=[];for(let m of t){if(n++,m==="<")if(o=!0,t[n]==="/")c.pop();else{let g="";for(let E of t.substring(n)){if(E===" "||E===">")break;g+=E}c.push(g)}if(m==="/"&&t[n]===">"&&c.pop(),m===">"){o=!1;continue}if(!o&&(s--,s===0))break}let l=t.substring(0,n).trim();if(c.length>0){c[0]==="p"&&c.shift();for(let m of c.reverse())l+=`</${m}>`}return[`${l}${e?Pr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=vi(i);return[i,n]}}function vi(a){if(!a)return"";let r="",e=!1;for(let t of a){if(t==="<"&&(e=!0),t===">"){e=!1;continue}e||(r+=t)}return r}function Do(a,r){r.querySelectorAll("a.upt-link").forEach(t=>{let i=ie.createFrom(t);t.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function Fo(a,r,e,t,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let h of a.attributes)["class","is"].includes(h.name)||n.setAttribute(h.name,h.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=r?.ctas?.size??"M",s=`spectrum-Button--${t}`,c=ho.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",l=["spectrum-Button",s,c];return e&&l.push("spectrum-Button--outline"),n.classList.add(...l),n}function $o(a,r,e,t,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let s=z("sp-button",{treatment:o,variant:t,tabIndex:0,size:r?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return s.source=n,(i?n.onceSettled():Promise.resolve(n)).then(c=>{s.setAttribute("data-navigation-url",c.href)}),s.addEventListener("click",c=>{c.defaultPrevented||n.click()}),s}function Io(a,r,e,t,i,n,o){let s=a;if(e)try{let c=customElements.get("checkout-link");c&&(s=c.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return t||(s.classList.add("button","con-button"),o&&o!=="m"&&s.classList.add(`button-${o}`),r&&s.classList.add("blue"),i&&s.classList.add("primary"),n&&s.classList.add("secondary")),s}function Ho(a,r,e,t,i){if(a.ctas&&e.ctas){a.ctas=We(a.ctas);let{slot:n}=e.ctas,o=z("div",{slot:n},a.ctas),s=[...o.querySelectorAll("a")],c=i?.hideTrialCTAs?s.filter(h=>!Br.has(h.dataset.analyticsId)):s,l=(c.length>0?c:s).map(h=>bi(h,r,e));o.textContent="",o.append(...l),r.append(o),i?.hideTrialCTAs&&c.length>0&&l.forEach(h=>{let m=h.source??h;m.onceSettled&&(h.hidden=!0,m.onceSettled().then(()=>{m.value?.[0]?.offerType==="TRIAL"&&l.some(E=>E!==h&&!E.hidden)?h.remove():h.hidden=!1}).catch(()=>{h.hidden=!1}))})}}function Bo(a,r){let{tags:e}=a,t=e?.find(n=>typeof n=="string"&&n.startsWith(so))?.split("/").pop();if(!t)return;r.setAttribute(Kt,t),[...r.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...r.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(lo,`${n.dataset.analyticsId}-${o+1}`)})}function qo(a){a.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([r,e])=>{a.querySelectorAll(`a.${r}`).forEach(t=>{t.classList.remove(r),t.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function Uo(a){a.querySelectorAll("[slot]").forEach(t=>{t.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",Kt].forEach(t=>a.removeAttribute(t));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function yi(a,r){if(!a){let l=r?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!a.fields){let l=a.id||"unknown",h=r?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'.`)}let{id:e,fields:t,settings:i={},priceLiterals:n,placeholders:o}=a;t.variant==="bizpro"&&(t.variant="pro");let{variant:s}=t;if(!s)throw new Error(`hydrate: no template found in payload ${e}`);Uo(r),r.compatVersion=t.compatVersion,r.contextPromotionCode=t.promoCode,r.settings=i,n&&(r.priceLiterals=n),o&&(r.placeholders=o),r.id??(r.id=a.id),a.variationId&&r.setAttribute("variation-id",a.variationId),a.maskId&&r.setAttribute("mask-id",a.maskId),a.promoProject&&r.setAttribute("data-promotion-project",a.promoProject),a.promoVariationProject&&r.setAttribute("data-promotion-variation-project",a.promoVariationProject),r.variant=s,await r.updateComplete;let{aemFragmentMapping:c}=r.variantLayout;if(!c)throw new Error(`hydrate: variant mapping not found for ${e}`);c.style==="consonant"&&r.setAttribute("consonant",!0),po(t,r,c.mnemonics),uo(t,r,c),fo(t,r,c.size),vo(t,r),bo(t,r,c.title),go(t,r,c),xo(t,r,c),So(t,r,c),Co(t,r,c.backgroundImage),yo(t,r,c.allowedColors,c.backgroundColor),wo(t,r,c),zo(t,r,c,i),Ao(t,r,c),ko(t,r,c),_o(t,r,c,i),Mo(t,r,c),Ro(t,r,c),Oo(t,r,c,i);try{Do(t,r)}catch{}Ho(t,r,c,s,i),Bo(t,r),qo(r)}var Zt="merch-card",wi="merch-card:",Si=["full-pricing-express","simplified-pricing-express"],Ai=["segment","product","plans-education","mini-compare-chart-mweb"];function Ei(a,r){let e=a.closest(Zt);if(!e)return r;e.priceLiterals&&(r.literals??(r.literals={}),Object.assign(r.literals,e.priceLiterals)),ea(a)&&(r.displayPerUnit=!1,r.displayTax=!1),!r.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(r.promotionCode=e.contextPromotionCode),e.aemFragment&&(r[Xr]=!0),e.variantLayout?.priceOptionsProvider?.(a,r),a.dataset.template===_&&(r.displayDot??(r.displayDot=e.variantLayout?.legalDisplayDot??!0)),r.displayAnnual===void 0&&typeof e.settings?.displayAnnual=="boolean"&&(r.displayAnnual=e.settings.displayAnnual)}function ki(a,r){let e=a.closest(Zt);if(!e)return r;!r.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(r.promotionCode=e.contextPromotionCode)}function Go(a){a.providers.has(Ei)||a.providers.price(Ei),a.providers.has(ki)||a.providers.checkout(ki)}var wt=new IntersectionObserver(a=>{a.forEach(r=>{let e=r.target;if(Si.includes(e.variant)){if(e.clientHeight===0)return;wt.unobserve(e),e.requestUpdate();return}if(Ai.includes(e.variant)){if(r.boundingClientRect.width===0)return;if((e.variant==="product"||e.variant==="mini-compare-chart-mweb"||e.variant==="plans-education")&&e.querySelector('merch-icon[slot="icons"]')){wt.unobserve(e);return}let t=e.getBoundingClientRect().width,i=e.querySelector('[slot="badge"] > merch-badge'),n=i?.getBoundingClientRect().width||0;if(t===0||!i){wt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-n-16)}px`),wt.unobserve(e)}})}),Vo=0,kt,Ye,Ke,Qe,V,fe,$,ve,T,ue,Et,Mr,Qt,ne=class extends jo{constructor(){super();v(this,T);v(this,kt);v(this,Ye);v(this,Ke);v(this,Qe);v(this,V);v(this,fe);v(this,$);v(this,ve,new Promise(e=>{u(this,$,e)}));d(this,"compatVersion");d(this,"customerSegment");d(this,"marketSegment");d(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMasReady=this.handleMasReady.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}get contextPromotionCode(){return p(this,kt)}set contextPromotionCode(e){u(this,kt,e),e?this.setAttribute("data-promotion-code",e):this.removeAttribute("data-promotion-code")}firstUpdated(){this.variantLayout=Ar(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=Ar(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(t){k(this,T,ue).call(this,`Error in postCardUpdateHook: ${t.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(y)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(W)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(W)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(W)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let t=this.checkoutLinks;if(t.length!==0)for(let i of t){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==o);e.checked&&s.push(o),i.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length===0)return;let i=n=>{let{offerType:o,planType:s}=n.value?.[0]??{};if(!o||!s)return;let c=e.getOsi(s,o),l=(n.dataset.wcsOsi||"").split(",").filter(h=>h&&h!==c);e.checked&&l.push(c),n.dataset.wcsOsi=l.join(",")};t.forEach(i)}handleQuantitySelection(e){let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length!==0)for(let i of t)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let t={...this.filters};Object.keys(t).forEach(i=>{if(e){t[i].order=Math.min(t[i].order||2,2);return}let n=t[i].order;n===1||isNaN(n)||(t[i].order=Number(n)+1)}),this.filters=t}showInfoTooltip(e,t){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(t)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(t=>this.iconButton.addEventListener(t,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(t=>this.iconButton.addEventListener(t,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",t=>{t.key==="Escape"&&this.iconButton.classList.remove(e)}))}additionalModalTriggers(){if(!this.settings?.additionalModalTriggers)return;let e=this.variantLayout.aemFragmentMapping.title;this.makeElementModalTrigger(e?.tag,e?.slot),this.makeElementModalTrigger("merch-icon","icons")}handleMasReady(){this.handleInfoIconEvents(),this.additionalModalTriggers()}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var t;super.connectedCallback(),p(this,Ke)||u(this,Ke,Vo++),this.aemFragment||((t=p(this,$))==null||t.call(this),u(this,$,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??p(this,Ke);u(this,fe,`${wi}${e}${Qr}`),u(this,Ye,`${wi}${e}${Zr}`),performance.mark(p(this,fe)),u(this,V,Je()),Go(p(this,V)),u(this,Qe,p(this,V).Log.module(Zt)),this.addEventListener(R,this.handleQuantitySelection),this.addEventListener(er,this.handleAddonAndQuantityUpdate),this.addEventListener(qr,this.handleMerchOfferSelectReady),this.addEventListener(zt,this.handleAemFragmentEvents),this.addEventListener(Lt,this.handleAemFragmentEvents),this.addEventListener(oe,this.handleMasReady),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}makeElementModalTrigger(e,t){let i=e==="merch-icon",n=this.querySelector(`${e}[slot="${t}"]:not(.modal-trigger)`);if(!n)return;let o=this.querySelector("a.button.placeholder-resolved[data-modal]");if(!o)return;n.setAttribute("tabindex","0"),n.addEventListener("click",l=>{o.checkoutActionHandler?.(l)}),n.addEventListener("keypress",l=>{l.code==="Enter"&&o.checkoutActionHandler?.(l)}),n.classList.add("modal-trigger");let c=`${this.title.replace(/\s+/g,"-").toLowerCase()}${i?"-icon":""}--${this.analyticsId}--card`;n.setAttribute("daa-ll",c),n.setAttribute("role","link"),i&&n.setAttribute("alt",this.title)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(R,this.handleQuantitySelection),this.removeEventListener(zt,this.handleAemFragmentEvents),this.removeEventListener(Lt,this.handleAemFragmentEvents),this.removeEventListener(oe,this.handleMasReady),this.removeEventListener("change",this.changeHandler),this.removeEventListener(er,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var t;if(this.isConnected&&(e.type===zt&&k(this,T,ue).call(this,"AEM fragment cannot be loaded"),e.type===Lt&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{p(this,$)||u(this,ve,new Promise(n=>{u(this,$,n)})),await yi(i,this)}catch(n){k(this,T,ue).call(this,`hydration has failed: ${n.message}`)}finally{(t=p(this,$))==null||t.call(this),u(this,$,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;p(this,ve)&&(await p(this,ve),(Si.includes(this.variant)||Ai.includes(this.variant))&&wt.observe(this),u(this,ve,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(c=>setTimeout(()=>c("timeout"),be));if(this.aemFragment){let c=await Promise.race([this.aemFragment.updateComplete,e]);if(c===!1||c==="timeout"){let l=c==="timeout"?`AEM fragment was not resolved within ${be} timeout`:"AEM fragment cannot be loaded";k(this,T,ue).call(this,l,{},!1);return}}let t=[...this.querySelectorAll(Hr)],i=Promise.all(t.map(c=>{let l=c.onceSettled?.();return l?l.catch(()=>c):Promise.resolve(c)})).then(c=>{let l=c.filter(h=>h.isConnected);return l.length===0||l.every(h=>h.classList.contains("placeholder-resolved"))}),n=await Promise.race([i,e]);if(!this.isConnected)return;let o=t.filter(c=>c.isConnected);if(o.length===0||o.every(c=>c.classList.contains("placeholder-resolved"))){this.measure=performance.measure(p(this,Ye),p(this,fe));let c={...this.aemFragment?.fetchInfo,...p(this,V).duration,measure:rr(this.measure)};return this.dispatchEvent(new CustomEvent(oe,{bubbles:!0,composed:!0,detail:c})),this}else{this.measure=performance.measure(p(this,Ye),p(this,fe));let c={measure:rr(this.measure),...p(this,V).duration};if(n==="timeout")k(this,T,ue).call(this,`Contains offers that were not resolved within ${be} timeout`,c);else{let l=o.some(h=>h.matches(W)&&h.classList.contains("placeholder-failed"));k(this,T,ue).call(this,l?"CTA has an invalid offer":"Contains unresolved offers",c)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(W)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:t}}){if(!e||!t?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(h=>h.getAttribute("data-modal-id")===e);if(!n)return;let s=new URL(n.getAttribute("href")).searchParams.get("pa"),c=t.find(h=>h.productArrangementCode===s)?.quantity,l=!!t.find(h=>h.productArrangementCode!==s);if(c&&this.quantitySelect?.dispatchEvent(new CustomEvent(Xe,{detail:{quantity:c},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==l){this.toggleStockOffer({target:this.addonCheckbox});let h=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(h,"target",{writable:!1,value:{checked:l}}),this.addonCheckbox.handleChange(h)}}get prices(){return Array.from(this.querySelectorAll(y))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${y}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return p(this,T,Et)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${y}[data-promotion-code],${W}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return this.contextPromotionCode;let t=[...new Set(e)];return t.length>1&&p(this,Qe)?.warn(`Multiple different promotion codes found: ${t.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${y}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(p(this,T,Mr)??p(this,T,Et))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return p(this,T,Et)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return p(this,T,Mr)?.querySelector(e)?.textContent?.trim()??p(this,T,Et)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return k(this,T,Qt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${W}, a`);return Array.from(e??[])}get primaryCta(){return k(this,T,Qt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return k(this,T,Qt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};kt=new WeakMap,Ye=new WeakMap,Ke=new WeakMap,Qe=new WeakMap,V=new WeakMap,fe=new WeakMap,$=new WeakMap,ve=new WeakMap,T=new WeakSet,ue=function(e,t={},i=!0){var c;if(!this.isConnected)return;let n=this.aemFragment,o=n?.getAttribute("fragment");o=`[${o}]`;let s={...n?.fetchInfo,...p(this,V).duration,...t,message:e};p(this,Qe).error(`merch-card${o}: ${e}`,s),this.failed=!0,(c=p(this,$))==null||c.call(this),u(this,$,void 0),p(this,V).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(jr,{bubbles:!0,composed:!0,detail:s}))},Et=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${y}[data-template="price"] > span`)},Mr=function(){return this.querySelector(`${y}[data-template="legal"]`)},Qt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},d(ne,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[t,i,n]=e.split(",");return{PUF:t,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(t=>{let[i,n,o]=t.split(":"),s=Number(n);return[i,{order:isNaN(s)?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([t,{order:i,size:n}])=>[t,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Kt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),d(ne,"styles",[$r,...Ir()]),d(ne,"registerVariant",S),d(ne,"getCollectionOptions",gi),d(ne,"getFragmentMapping",Mt);customElements.define(Zt,ne);export{ne as MerchCard};

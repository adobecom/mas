...
`;var Ee=class extends x{constructor(t){super(t)}getGlobalCSS(){return _r}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Tt` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}};d(Ee,"variantStyle",Di`
...
Caused by: ${this.cause}`),e}};var Vi="mas-commerce-service",Yi={requestId:Je,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var gt=i=>window.setTimeout(i);function Rt(){return document.getElementsByTagName(Vi)?.[0]}function Ur(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Yi)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function jr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Gr="fragment",Vr="author",Yr="preview",Kr="loading",Wr="timeout",Ot="aem-fragment",Qr="eager",Xr="cache",Ki=[Qr,Xr],I,re,N,Nt=class{constructor(){g(this,I,new Map);g(this,re,new Map);g(this,N,new Map)}clear(){c(this,I).clear(),c(this,re).clear(),c(this,N).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,N).has(t.id)){let[,r]=c(this,N).get(t.id);r()}if(c(this,N).has(t.fields?.originalId)){let[,r]=c(this,N).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,N).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,N).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,re).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,re).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,re).delete(t),c(this,N).delete(t)}};I=new WeakMap,re=new WeakMap,N=new WeakMap;var W=new Nt,Te,D,U,R,_,k,Ue,je,$,Ge,Ve,Le,F,Zr,Jr,Dt,ei,ut=class extends HTMLElement{constructor(){super(...arguments);g(this,F);d(this,"cache",W);g(this,Te);g(this,D,null);g(this,U,null);g(this,R,null);g(this,_);g(this,k);g(this,Ue,Qr);g(this,je,5e3);g(this,$);g(this,Ge,!1);g(this,Ve,0);g(this,Le)}static get observedAttributes(){return[Gr,Kr,Wr,Vr,Yr]}attributeChangedCallback(e,r,a){e===Gr&&(m(this,_,a),m(this,k,W.getFetchInfo(a))),e===Kr&&Ki.includes(a)&&m(this,Ue,a),e===Wr&&m(this,je,parseInt(a,10)),e===Vr&&m(this,Ge,["","true"].includes(a)),e===Yr&&m(this,Le,a)}connectedCallback(){if(!c(this,$)){if(c(this,R)??m(this,R,J(this)),m(this,Le,c(this,R).settings?.preview),c(this,Te)??m(this,Te,c(this,R).log.module(`${Ot}[${c(this,_)}]`)),!c(this,_)||c(this,_)==="#"){c(this,k)??m(this,k,W.getFetchInfo("missing-fragment-id")),S(this,F,Dt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,$)&&!await Promise.race([c(this,$),Promise.resolve(!1)]))return;e&&W.remove(c(this,_)),c(this,Ue)===Xr&&await Promise.race([W.getAsPromise(c(this,_)),new Promise(s=>setTimeout(s,c(this,je)))]);try{m(this,$,S(this,F,ei).call(this)),await c(this,$)}catch(s){return S(this,F,Dt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,D)||{};return o&&!ht("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(he,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,$)}get updateComplete(){return c(this,$)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,Ge)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,D)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,D);m(this,U,e.reduce((p,{name:h,multiple:v,values:P})=>(p.fields[h]=v?P:P[0],p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,D);m(this,U,Object.entries(e).reduce((p,[h,v])=>(p.fields[h]=v?.mimeType?v.value:v??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,_),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};Te=new WeakMap,D=new WeakMap,U=new WeakMap,R=new WeakMap,_=new WeakMap,k=new WeakMap,Ue=new WeakMap,je=new WeakMap,$=new WeakMap,Ge=new WeakMap,Ve=new WeakMap,Le=new WeakMap,F=new WeakSet,Zr=async function(e){Qt(this,Ve)._++;let r=`${Ot}:${c(this,_)}:${c(this,Ve)}`,a=`${r}${et}`,n=`${r}${tt}`;if(c(this,Le))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await jr(e,{cache:"default",credentials:"omit"}),S(this,F,Jr).call(this,o),c(this,k).status=o?.status,c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new te("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,D))return c(this,k).stale=!0,c(this,Te).error("Serving stale data",c(this,k)),c(this,D);let l=s.message??"unknown";throw new te(`Failed to fetch fragment: ${l}`,{})}},Jr=function(e){Object.assign(c(this,k),Ur(e))},Dt=function(e){m(this,$,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,R).duration};c(this,Te).error(e,r),this.dispatchEvent(new CustomEvent(me,{detail:r,bubbles:!0,composed:!0}))},ei=async function(){var l;this.classList.remove("error"),m(this,U,null);let e=W.get(c(this,_));if(e)return m(this,D,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,R).settings,s=`${r}/fragment?id=${c(this,_)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await S(this,F,Zr).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,_)),W.add(e),m(this,D,e),!0},d(ut,"cache",W);customElements.define(Ot,ut);import{LitElement as Wi,html as Qi,css as Xi}from"./lit-all.min.js";var ze=class extends Wi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Qi`<div class="badge">${this.text}</div>`}};d(ze,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),d(ze,"styles",Xi`
    ...
    `),d(Ye,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ye);import{html as $t,css as ta,LitElement as ra}from"./lit-all.min.js";var Ke=class extends ra{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return $t`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows?$t`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:$t``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};d(Ke,"styles",ta`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

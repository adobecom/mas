...
`,dr=()=>[sr`
    ...
    `);customElements.define("merch-addon",be);import{html as pt,nothing as Qa}from"./lit-all.min.js";var ye,je=class je{constructor(t){d(this,"card");g(this,ye);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,ye,s(this,ye)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,ye)}insertVariantStyle(){let t=this.constructor.name;if(!je.styleMap[t]){je.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),pt`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return mt(this.card.variant)}};ye=new WeakMap,d(je,"styleMap",{});var x=je;import{html as Rt,css as Xa}from"./lit-all.min.js";var Cr=`
:root {
...
`;var Ur={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ce=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Hr}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ot` ${this.badge}
    ...
    `);import{html as Nt,css as ci}from"./lit-all.min.js";var Gr=`
:root {
...
`;var It={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},ze=class extends x{getGlobalCSS(){return Xr}get aemFragmentMapping(){return It}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Zr`
    ...
    `);import{html as $t,css as gi,nothing as ui}from"./lit-all.min.js";var Jr=`
...
Caused by: ${this.cause}`),e}};var oe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},sa=1e3;function Ei(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function la(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!oe.serializableTypes.includes(e))return e}return a}function ki(a,t){if(!oe.ignoredProperties.includes(a))return la(t)}var Ht={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(p=>{p!=null&&(Ei(p)?r:i).push(p)}),r.length&&(n+=" "+r.map(la).join(" "));let{pathname:o,search:c}=window.location,l=`${oe.delimiter}page=${o}${c}`;l.length>sa&&(l=`${l.slice(0,sa)}<trunc>`),n+=l,i.length&&(n+=`${oe.delimiter}facts=`,n+=JSON.stringify(i,ki)),window.lana?.log(n,oe)}};function da(a){Object.assign(oe,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in oe&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ha={LOCAL:"local",PROD:"prod",STAGE:"stage"},Ut={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Gt=new Set,jt=new Set,pa=new Map,ma={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},ga={filter:({level:a})=>a!==Ut.DEBUG},Ci={filter:()=>!1};function Si(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&wt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Ai(a){[...jt].every(t=>t(a))&&Gt.forEach(t=>t(a))}function ua(a){let t=(pa.get(a)??0)+1;pa.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>ua(`${r.namespace}/${i}`),updateConfig:da};return Object.values(Ut).forEach(i=>{r[i]=(n,...o)=>Ai(Si(i,n,a,o,e))}),Object.seal(r)}function Et(...a){a.forEach(t=>{let{append:e,filter:r}=t;wt(r)&&jt.add(r),wt(e)&&Gt.add(e)})}function Ti(a={}){let{name:t}=a,e=ca(yt("commerce.debug",{search:!0,storage:!0}),t===ha.LOCAL);return Et(e?ma:ga),t===ha.PROD&&Et(Ht),Ke}function Li(){Gt.clear(),jt.clear()}var Ke={...ua(wr),Level:Ut,Plugins:{consoleAppender:ma,debugFilter:ga,quietFilter:Ci,lanaAppender:Ht},init:Ti,reset:Li,use:Et};var zi="mas-commerce-service",Gs=Ke.module("utilities"),Pi={requestId:st,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var kt=a=>window.setTimeout(a);function Vt(){return document.getElementsByTagName(zi)?.[0]}function fa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Pi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function va(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var xa="fragment",ba="author",ya="preview",wa="loading",Ea="timeout",Wt="aem-fragment",ka="eager",Ca="cache",_i=[ka,Ca],U,ce,$,Kt=class{constructor(){g(this,U,new Map);g(this,ce,new Map);g(this,$,new Map)}clear(){s(this,U).clear(),s(this,ce).clear(),s(this,$).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,U).set(t.id,t),t.fields?.originalId&&s(this,U).set(t.fields.originalId,t),s(this,$).has(t.id)){let[,r]=s(this,$).get(t.id);r()}if(s(this,$).has(t.fields?.originalId)){let[,r]=s(this,$).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,U).has(t)}entries(){return s(this,U).entries()}get(t){return s(this,U).get(t)}getAsPromise(t){let[e]=s(this,$).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,$).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,ce).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,ce).set(t,e)),e}remove(t){s(this,U).delete(t),s(this,ce).delete(t),s(this,$).delete(t)}};U=new WeakMap,ce=new WeakMap,$=new WeakMap;var J=new Kt,Me,B,V,D,M,C,Ye,Qe,q,Xe,Ze,Re,H,Sa,Aa,Yt,Ta,Ct=class extends HTMLElement{constructor(){super(...arguments);g(this,H);d(this,"cache",J);g(this,Me);g(this,B,null);g(this,V,null);g(this,D,null);g(this,M);g(this,C);g(this,Ye,ka);g(this,Qe,5e3);g(this,q);g(this,Xe,!1);g(this,Ze,0);g(this,Re)}static get observedAttributes(){return[xa,wa,Ea,ba,ya]}attributeChangedCallback(e,r,i){e===xa&&(m(this,M,i),m(this,C,J.getFetchInfo(i))),e===wa&&_i.includes(i)&&m(this,Ye,i),e===Ea&&m(this,Qe,parseInt(i,10)),e===ba&&m(this,Xe,["","true"].includes(i)),e===ya&&m(this,Re,i)}connectedCallback(){if(!s(this,q)){if(s(this,D)??m(this,D,ae(this)),m(this,Re,s(this,D).settings?.preview),s(this,Me)??m(this,Me,s(this,D).log.module(`${Wt}[${s(this,M)}]`)),!s(this,M)||s(this,M)==="#"){s(this,C)??m(this,C,J.getFetchInfo("missing-fragment-id")),z(this,H,Yt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,C)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&J.remove(s(this,M)),s(this,Ye)===Ca&&await Promise.race([J.getAsPromise(s(this,M)),new Promise(c=>setTimeout(c,s(this,Qe)))]);try{m(this,q,z(this,H,Ta).call(this)),await s(this,q)}catch(c){return z(this,H,Yt).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,B)||{};return o&&!yt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ue,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,C)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,V)?s(this,V):(s(this,Xe)?this.transformAuthorData():this.transformPublishData(),s(this,V))}get rawData(){return s(this,B)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:p={}}=s(this,B);m(this,V,e.reduce((h,{name:v,multiple:A,values:R})=>(h.fields[v]=A?R:R[0],h),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:p,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:p}=s(this,B);m(this,V,Object.entries(e).reduce((h,[v,A])=>(h.fields[v]=A?.mimeType?A.value:A??"",h),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:p}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,M),{locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0})}};Me=new WeakMap,B=new WeakMap,V=new WeakMap,D=new WeakMap,M=new WeakMap,C=new WeakMap,Ye=new WeakMap,Qe=new WeakMap,q=new WeakMap,Xe=new WeakMap,Ze=new WeakMap,Re=new WeakMap,H=new WeakSet,Sa=async function(e){nr(this,Ze)._++;let r=`${Wt}:${s(this,M)}:${s(this,Ze)}`,i=`${r}${lt}`,n=`${r}${dt}`;if(s(this,Re)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new Z(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,C).stale=!1,s(this,C).url=e,o=await va(e,{cache:"default",credentials:"omit"}),z(this,H,Aa).call(this,o),s(this,C).status=o?.status,s(this,C).measure=ve(performance.measure(n,i)),s(this,C).retryCount=o.retryCount,!o?.ok)throw new Z("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,C).measure=ve(performance.measure(n,i)),s(this,C).retryCount=c.retryCount,s(this,B))return s(this,C).stale=!0,s(this,Me).error("Serving stale data",s(this,C)),s(this,B);let l=c.message??"unknown";throw new Z(`Failed to fetch fragment: ${l}`,{})}},Aa=function(e){Object.assign(s(this,C),fa(e))},Yt=function(e){m(this,q,null),s(this,C).message=e,this.classList.add("error");let r={...s(this,C),...s(this,D).duration};s(this,Me).error(e,r),this.dispatchEvent(new CustomEvent(fe,{detail:r,bubbles:!0,composed:!0}))},Ta=async function(){var l;this.classList.remove("error"),m(this,V,null);let e=J.get(s(this,M));if(e)return m(this,B,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,M)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await z(this,H,Sa).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,M)),J.add(e),m(this,B,e),!0},d(Ct,"cache",J);customElements.define(Wt,Ct);import{LitElement as Mi,html as Qt,css as Ri,nothing as Oi}from"./lit-all.min.js";import{unsafeHTML as Ni}from"./lit-all.min.js";var Di=a=>a?a.startsWith("sp-icon-")?Qt`${Ni(`<${a} class="badge-icon"></${a}>`)}`:Qt`<img src="${a}" class="badge-icon" />`:Oi,Oe=class extends Mi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Qt`<div class="badge">
    ...
    `);customElements.define("merch-badge",Oe);import{html as Fi,css as Ii,LitElement as $i}from"./lit-all.min.js";var Je=class extends $i{constructor(){super()}render(){return Fi`
            <slot name="icon"></slot>
    ...
    `),d(Je,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Je);import{html as Xt,css as Bi,LitElement as qi,nothing as La}from"./lit-all.min.js";var et=class extends qi{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Xt`<slot name="heading"></slot>

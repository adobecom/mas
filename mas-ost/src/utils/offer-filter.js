 ...
 * @param {string} landscape - 'DRAFT' or 'PUBLISHED'
...
function offerFilter(
    ...
    const matchesCustomerSegment =
        !aos.customerSegment || customerSegments[aos.customerSegment] === true;
    const matchesMarketSegment =
        !aos.marketSegment || marketSegments[aos.marketSegment] === true;

    return (
        matchesCustomerSegment &&
        matchesMarketSegment &&
        (landscape === 'DRAFT' || !draft) &&

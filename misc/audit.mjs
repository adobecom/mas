 ...
 * for a full configured set of URLs and/or sitemap you can use -m parameter with a manifest composed of URLs/Sitemap 
 * separated by new lines character
 * 
 * for faster execution, buffer size (number of parallel page being audited) can be increased but will impact your connection.
 * with parameter -b (you can move it lower to the default that is 100).
 * 

...
`;var Zt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Be=class extends b{getGlobalCSS(){return va}get aemFragmentMapping(){return Zt}renderLayout(){return qi`
    ...
    `);var zt=new Map,xa=new WeakMap,ba=new Map,k=(a,t,e=null,r=null,i)=>{zt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",ze,$r,ze.variantStyle);k("image",he);k("inline-heading",St);k("mini-compare-chart",Pe,Vr,Pe.variantStyle);k("mini-compare-chart-mweb",_e,Yr,_e.variantStyle);k("plans",R,Tt,R.variantStyle,R.collectionOptions);k("plans-students",R,Zr,R.variantStyle,R.collectionOptions);k("plans-education",R,Xr,R.variantStyle,R.collectionOptions);k("plans-v2",ae,ta,ae.variantStyle,ae.collectionOptions);k("product",Me,aa,Me.variantStyle);k("segment",Re,na,Re.variantStyle);k("media",Oe,ca,Oe.variantStyle);k("headless",Ie,ga,Ie.variantStyle);k("special-offers",De,la,De.variantStyle);k("simplified-pricing-express",Ne,Yt,Ne.variantStyle);k("full-pricing-express",Fe,Qt,Fe.variantStyle);k("mini",$e,fa,$e.variantStyle);k("image",he,Hr,he.variantStyle);k("fries",Be,Zt,Be.variantStyle);var Gi=(a,t,e)=>{try{let r=ba.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ba.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Jt=a=>{let t=zt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=xa.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?Gi(a,r,i):{};return xa.set(a,{appliedVariant:a.variant,...n}),new e(a)};function kt(a){return zt.get(a)?.fragmentMapping}function ya(a){return zt.get(a)?.collectionOptions}var wa=document.createElement("style");wa.innerHTML=`
:root {

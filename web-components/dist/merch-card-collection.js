...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as zt,css as fc}from"./lit-all.min.js";var Wi=`
:root {
...
`;var vr=class extends w{constructor(r){super(r)}getGlobalCSS(){return Xi}renderLayout(){return Ki` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Ki`<hr />`} ${this.secureLabelFooter}`}};import{html as Ie,css as vc,unsafeCSS as Qi}from"./lit-all.min.js";var Zi=`
  :root {
...
`;var xc=32,Ji={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},ot=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Ie`<slot name="secure-transaction-label">
    ...
    `);import{html as xr,css as bc,unsafeCSS as La,nothing as yc}from"./lit-all.min.js";var en=`
  :root {
...
`;var wc=32,tn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},ye,st=class extends w{constructor(t){super(t);_(this,ye);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>xr` <footer>
    ...
    `);import{html as Dt,css as Ec,nothing as br}from"./lit-all.min.js";var rn=`
:root {
...
`;var[gp,fp,dn,hn,pn,mn]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Sr="pro",Pa=`--consonant-merch-card-${Sr}-top-card-height`,Er=[{prop:`--consonant-merch-card-${Sr}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Sr}-name-description-height`,selector:".name-description"}],un=`--consonant-merch-card-${Sr}-strike-reserve`,Ma='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',Cc="(min-width: 768px)",gn={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},_e,qe,$t,Gt,Y,fn,Ft,vn,Bt,Ra,Ar,Cr=class Cr extends w{constructor(t){super(t);_(this,Y);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);_(this,_e,null);_(this,qe,null);_(this,$t,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);_(this,Gt,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of W(this,Y,fn).call(this)){let n=i.variantLayout;n instanceof Cr&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?W(this,Y,Ra).call(this):W(this,Y,Bt).call(this),this.card.requestUpdate()});_(this,Ar,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case hn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:W(this,Y,Bt).call(this);break;case dn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:W(this,Y,Bt).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case pn:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}W(this,Y,Bt).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),W(this,Y,Ra).call(this);break;case mn:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,W(this,Y,Ft).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(ae,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return ln}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(ue,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let a=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=a?.querySelector(".price-plan-type");if(!i)return;i.textContent=t;let n=a.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${G}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=Pa,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(Cc).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,m)=>{let h=l(m);return h?Math.max(d,parseInt(getComputedStyle(h).height)||0):d},0);for(let c of o.values()){if(c.forEach(h=>this.clearSyncedHeights(h)),c.length<2)continue;let l=c.map(h=>h.querySelector(Ma)&&parseInt(getComputedStyle(h.querySelector(Ma)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((h,p)=>{let u=d-l[p];u>0&&h.style.setProperty(un,`${u}px`)});for(let h of Er){let p=s(c,u=>u.shadowRoot?.querySelector(h.selector));p>0&&c.forEach(u=>u.style.setProperty(h.prop,`${p}px`))}let m=s(c,h=>h.shadowRoot?.querySelector(".top-card"));m>0&&c.forEach(h=>h.style.setProperty(i,`${m}px`))}}clearSyncedHeights(t){t.style.removeProperty(Pa),t.style.removeProperty(un),Er.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(Ma),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(pr,v(this,Gt)),this.card.addEventListener(ae,this.updatePriceQuantity),this.card.addEventListener(ue,v(this,$t)),typeof ResizeObserver>"u"))return;T(this,qe,new ResizeObserver(()=>this.resyncOnReflow())),v(this,qe).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,qe).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ae,this.updatePriceQuantity),this.card?.removeEventListener(ue,v(this,$t)),W(this,Y,Ft).call(this),v(this,qe)?.disconnect(),this.card?.removeEventListener(pr,v(this,Gt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return ke`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return ke`
        ...
        `}renderLayout(){let t=!!this.expanded;return ke`
            ...
            <slot></slot>
        `}};_e=new WeakMap,qe=new WeakMap,$t=new WeakMap,Gt=new WeakMap,Y=new WeakSet,fn=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},Ft=function(){v(this,_e)&&(document.removeEventListener("mousedown",v(this,_e)),T(this,_e,null))},vn=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},Bt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=W(this,Y,vn).call(this),v(this,_e)||(T(this,_e,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),W(this,Y,Ft).call(this))}),document.addEventListener("mousedown",v(this,_e)))},Ra=function(){this.licenseOpen=!1,W(this,Y,Ft).call(this)},Ar=new WeakMap,g(Cr,"variantStyle",Ac`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Ut=Cr;import{html as Oa,css as Tc}from"./lit-all.min.js";var xn=`
:root {
...
`;var bn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Se,lt=class extends w{constructor(t){super(t);_(this,Se);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return xn}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return Oa` ${this.badge}
    ...
    `);import{html as Na,css as kc}from"./lit-all.min.js";var yn=`
:root {
...
`;var wn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},dt=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===te&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return yn}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${G}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return Na`
    ...
    `);import{html as _c,css as Lc}from"./lit-all.min.js";var En=`
...
`;var Sn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},ht=class extends w{constructor(r){super(r)}getGlobalCSS(){return En}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return _c`
    ...
    `);import{html as Ia,css as Pc}from"./lit-all.min.js";var An=`
:root {
...
`;var Cn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},pt=class extends w{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return An}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${G}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Ia`${this.cardImage}
    ...
    `);import{html as Mc,css as Rc}from"./lit-all.min.js";var Tn=`
:root {
...
`;var Da={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},qt=class qt extends w{getGlobalCSS(){return kn}get aemFragmentMapping(){return Da}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return _n`
    ...
    `);var Vt=qt;import{html as jt,css as Nc,nothing as Pn}from"./lit-all.min.js";var Ln=`
...
`;var Ha={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Bc=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Tr,In,ft=class extends w{constructor(t){super(t);_(this,Tr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Nn}get aemFragmentMapping(){return Ha}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,W(this,Tr,In).call(this))}renderLayout(){return Hc`
            <div class="card">
            ...
            <slot></slot>
        `}};Tr=new WeakSet,In=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Bc.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(ft,"variantStyle",Fc`
...
`,Qe.MISSING_INTL_API,o);var C=t.getPluralRules(r,{type:d.pluralType}).select(h-(d.offset||0));b=d.options[C]||d.options.other}if(!b)throw new yi(d.value,h,Object.keys(d.options),o);s.push.apply(s,rr(b.value,r,t,a,i,h-(d.offset||0)));continue}}return fd(s)}function xd(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=P(P({},e[a]),r[a]||{}),t},{})):e}function bd(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=xd(e[a],r[a]),t},P({},e)):e}function wi(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function yd(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:er(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,Br([void 0],t,!1)))},{cache:wi(e.number),strategy:Yr.variadic}),getDateTimeFormat:er(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,Br([void 0],t,!1)))},{cache:wi(e.dateTime),strategy:Yr.variadic}),getPluralRules:er(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,Br([void 0],t,!1)))},{cache:wi(e.pluralRules),strategy:Yr.variadic})}}var ts=function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==Q.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return rr(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=bd(e.formats,a),this.formatters=i&&i.formatters||yd(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Ko,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var rs=ts;var Ei={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},wd=Gn("ConsonantTemplates/price"),Ed=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},He={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Si="TAX_EXCLUSIVE",Sd=e=>Bn(e)?Object.entries(e).filter(([,r])=>xt(r)||_r(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Fn(a)}"`}`,""):"",V=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${Sd(t)}>${a?fo(r):r??""}</span>`;function Ad(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function Cd(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function Pe(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?Ad(i):i,i=n?i.replace(Ed,""):i;let s=new rs(i,r).format(a);return o?Cd(s):s}catch{return wd.error("Failed to format literal:",i),""}}function Td(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:m},h={}){let p=V($.currencySymbol,a),u=V($.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=p+u),f+=V($.integer,s),f+=V($.decimalsDelimiter,n),f+=V($.decimals,i),c||(f+=u+p),f+=V($.recurrence,l,null,!0),f+=V($.unitType,d,null,!0),f+=V($.taxInclusivity,m,!0),V(e,f,{...h})}var K=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:m,literals:h={},quantity:p=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:A,price:b,priceWithoutDiscount:C,taxDisplay:D,taxTerm:I,term:U,usePrecision:j,promotion:J}={},Z={})=>{Object.entries({country:o,formatString:A,language:m,price:b}).forEach(([Bs,Us])=>{if(Us==null)throw new Error(`Argument "${Bs}" is missing for osi ${y?.toString()}, country ${o}, language ${m}`)});let B={...Ei,...h},N=`${m.toLowerCase()}-${o.toUpperCase()}`,re;J&&!f&&C?re=e||a?b:C:t&&C?re=C:re=b;let de=r?xo:bo;i&&(de=yo);let{accessiblePrice:tt,recurrenceTerm:Mi,...Ri}=de({commitment:x,formatString:A,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:C,price:r?b:re,promotion:J,quantity:p,term:U,usePrecision:j}),Zr="",Qr="",Jr="";E(c)&&Mi&&(Jr=Pe(B,N,He.recurrenceLabel,{recurrenceTerm:Mi}));let cr="";E(l)&&(u&&(cr+=" "),cr+=Pe(B,N,He.perUnitLabel,{perUnit:"LICENSE"}));let lr="";E(d)&&I&&(u&&(lr+=" "),lr+=Pe(B,N,D===Si?He.taxExclusiveLabel:He.taxInclusiveLabel,{taxTerm:I})),t&&(Zr=Pe(B,N,He.strikethroughAriaLabel,{strikethroughPrice:Zr})),e&&(Qr=Pe(B,N,He.alternativePriceAriaLabel,{alternativePrice:Qr}));let Be=$.container;if(r&&(Be+=` ${$.containerOptical}`),t&&(Be+=` ${$.containerStrikethrough}`),a&&(Be+=` ${$.containerPromoStrikethrough}`),e&&(Be+=` ${$.containerAlternative}`),i&&(Be+=` ${$.containerAnnual}`),E(s))return Td(Be,{...Ri,accessibleLabel:Zr,altAccessibleLabel:Qr,recurrenceLabel:Jr,perUnitLabel:cr,taxInclusivityLabel:lr},Z);let{currencySymbol:Oi,decimals:Is,decimalsDelimiter:zs,hasCurrencySpace:Ni,integer:Ds,isCurrencyFirst:Hs}=Ri,rt=[Ds,zs,Is];Hs?(rt.unshift(Ni?"\xA0":""),rt.unshift(Oi)):(rt.push(Ni?"\xA0":""),rt.push(Oi)),rt.push(Jr,cr,lr);let Fs=rt.join("");return V(Be,Fs,Z)},as=()=>(e,r,t)=>{let a=Ke(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${K({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${K({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},is=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=Ke(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return K()(e,{...r,price:r.priceWithoutDiscount},t)+V($.containerAnnualPrefix," (")+K({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+V($.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${K({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${K({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${V($.containerAnnualPrefix," (")}${K({displayAnnual:!0,instant:a})(n,r,t)}${V($.containerAnnualSuffix,")")}`},ns=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${K({isAlternativePrice:e.displayOldPrice})(e,r,t)}${V($.containerAnnualPrefix," (")}${K({displayAnnual:!0})(a,r,t)}${V($.containerAnnualSuffix,")")}`};var ar={...$,containerLegal:"price-legal",planType:"price-plan-type"},Xr={...He,planTypeLabel:"planTypeLabel"};function kd(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=V(ar.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=V(ar.taxInclusivity,t,!0),o+=V(ar.planType,a,null),V(e,o,{...i})}var os=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,language:n,literals:o={}}={},{taxDisplay:s,taxTerm:c,planType:l}={},d={})=>{let m={...Ei,...o},h=`${n.toLowerCase()}-${e.toUpperCase()}`,p="";E(r)&&(p=Pe(m,h,Xr.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),E(t)&&c&&(u=Pe(m,h,s===Si?Xr.taxExclusiveLabel:Xr.taxInclusiveLabel,{taxTerm:c}));let f="";E(a)&&l&&(f=Pe(m,h,Xr.planTypeLabel,{planType:l}));let x=ar.container;return x+=` ${ar.containerLegal}`,kd(x,{perUnitLabel:p,taxInclusivityLabel:u,planTypeLabel:f},d,i)};var ss=K(),cs=as(),ls=K({displayOptical:!0}),ds=K({displayStrikethrough:!0}),hs=K({displayPromoStrikethrough:!0}),ps=K({displayAnnual:!0}),ms=K({displayOptical:!0,isAlternativePrice:!0}),us=K({isAlternativePrice:!0}),gs=ns(),fs=is(),vs=os;var _d=(e,r)=>{if(!r&&bt(e))return 0;if(!(!bt(e)||!bt(r)))return Math.floor((r-e)/r*100)},xs=()=>(e,r)=>{let{price:t,priceWithoutDiscount:a}=r,i=_d(t,a);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var bs=xs();var ys="INDIVIDUAL_COM",Ci="TEAM_COM",ws="INDIVIDUAL_EDU",Ti="TEAM_EDU",Ld=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],Pd={[ys]:[],[Ci]:[],[ws]:[],[Ti]:[]},Md={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Rd=[ys,Ci,ws,Ti],Od=e=>[Ci,Ti].includes(e);function Ai(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Nd=(e,r,t,a)=>{let i=`${t}_${a}`,n=Ai(Md,e,r,!1);if(n){let o=Rd.indexOf(i);return n[o]}return Od(i)},Id=(e,r,t,a)=>{if(Ai(Ld,e,r,!0))return!0;let i=Pd[`${t}_${a}`];return i?Ai(i,e,r,!0)?!0:O.displayTax:O.displayTax},ki=async(e,r,t,a)=>{let i=Id(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Nd(e,r,t,a):O.forceTaxExclusive}},ir=class ir extends HTMLSpanElement{constructor(){super();g(this,"masElement",new De(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=se();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:h,quantity:p,alternativePrice:u,template:f,wcsOsi:x}=a.collectPriceOptions(t);return Hr(ir,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:h,quantity:p,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ge}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=se();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(p=>{let u=Yt(p,n);return u?.length?u[0]:null});if(l.some(p=>!p))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,m=ri(l);if(a.featureFlags[Ce]||n[Ce]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=m.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:p,language:u}=n,[f=""]=m.marketSegments,x=await ki(p,u,m.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let A=Yt(y,n);return A?.length?A[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[at]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[p,u]=d,f={...p,priceDetails:{...p.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let h=ri(d);return this.renderOffers([h],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=se();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(ir,"is","inline-price"),g(ir,"tag","span");var Me=ir;window.customElements.get(Me.is)||window.customElements.define(Me.is,Me,{extends:Me.tag});function Es({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let I of r.price)I(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:m,displayTax:h,displayPlanType:p,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:y,quantity:A,alternativePrice:b,wcsOsi:C,...D}=Object.assign(c,s?.dataset??{},o??{});return c=Lr(Object.assign({...c,...D,displayOldPrice:E(l),displayPerUnit:E(d),displayRecurrence:E(m),displayTax:E(h),displayPlanType:E(p),forceTaxExclusive:E(u),perpetual:E(f),displayAnnual:E(x),promotionCode:Rr(y).effectivePromoCode,quantity:yt(A,O.quantity),alternativePrice:E(b),wcsOsi:Dr(C)})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=bs;break;case"strikethrough":l=ds;break;case"promo-strikethrough":l=hs;break;case"annual":l=ps;break;case"legal":l=vs;break;default:s.template==="optical"&&s.alternativePrice?l=ms:s.template==="optical"?l=ls:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?fs:gs:s.alternativePrice?l=us:l=s.promotionCode&&o[0].promotion?cs:ss}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Me.createInlinePrice;return{InlinePrice:Me,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function zd({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||O.language),r??(r=e?.split("_")?.[1]||O.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function Ss(e={},r){let t=r.featureFlags[Ce],{commerce:a={}}=e,i=xe.PRODUCTION,n=ya,o=H("checkoutClientId",a)??O.checkoutClientId,s=Wt(H("checkoutWorkflowStep",a),ie,O.checkoutWorkflowStep),c=E(H("displayOldPrice",a),O.displayOldPrice),l=O.displayPerUnit,d=E(H("displayRecurrence",a),O.displayRecurrence),m=E(H("displayTax",a),O.displayTax),h=E(H("displayPlanType",a),O.displayPlanType),p=E(H("entitlement",a),O.entitlement),u=E(H("modal",a),O.modal),f=E(H("forceTaxExclusive",a),O.forceTaxExclusive),x=H("promotionCode",a)??O.promotionCode,y=yt(H("quantity",a)),A=H("wcsApiKey",a)??O.wcsApiKey,b=a?.env==="stage",C=Ne.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(H(xa,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",C=Wt(H(ba,a),Ne,C)),b&&(i=xe.STAGE,n=wa);let I=H(va)??e.preview,U=typeof I<"u"&&I!=="off"&&I!=="false",j={};U&&(j={preview:U});let J=H("mas-io-url")??e.masIOUrl,Z=qi(J)?J:`https://www${i===xe.STAGE?".stage":""}.adobe.com/mas/io`,B=H("preselect-plan")??void 0,N=H("instant")??e.instant;return{...zd(e),...j,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:m,displayPlanType:h,entitlement:p,extraOptions:O.extraOptions,modal:u,env:i,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:O.alternativePrice,wcsApiKey:A,wcsURL:n,landscape:C,masIOUrl:Z,...B&&{preselectPlan:B},...N&&{instant:N}}}async function As(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var _i="wcs";function Cs({settings:e}){let r=oe.module(_i),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(u,f,x=!0){let y=se(),A=ua;r.debug("Fetching:",u);let b="",C;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let D=new Map(f),[I]=u.offerSelectorIds,U=Date.now()+Math.random().toString(36).substring(2,7),j=`${_i}:${I}:${U}${Sa}`,J=`${_i}:${I}:${U}${Aa}`,Z;try{if(performance.mark(j),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",I),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===xe.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),C=await As(b.toString(),{credentials:"omit"}),C.ok){let B=[];try{let N=await C.json();r.debug("Fetched:",u,N),B=N.resolvedOffers??[]}catch(N){r.error(`Error parsing JSON: ${N.message}`,{...N.context,...y?.duration})}B=B.map(Or),f.forEach(({resolve:N},re)=>{let de=B.filter(({offerSelectorIds:tt})=>tt.includes(re)).flat();de.length&&(D.delete(re),f.delete(re),N(de))})}else A=ma}catch(B){A=`Network error: ${B.message}`}finally{Z=performance.measure(J,j),performance.clearMarks(j),performance.clearMeasures(J)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let B=ro(C);f.forEach(N=>{N.reject(new wt(A,{...u,...B,response:C,measure:ur(Z),...y?.duration}))})}}function l(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===xe.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,A]of Object.entries(x))i.set(y,Promise.resolve(A.map(Or)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function m(){let u=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function h(u,f,x){let y=u!=="GB"&&!x?"MULT":"en",A=Ca.includes(u)?u:O.country;return{validCountry:A,validLanguage:y,locale:`${f}_${A}`}}function p({country:u,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:A=[]}){let{validCountry:b,validLanguage:C,locale:D}=h(u,f,x),I=[b,C,y].filter(U=>U).join("-").toLowerCase();return A.map(U=>{let j=`${U}-${I}`;if(i.has(j))return i.get(j);let J=new Promise((Z,B)=>{let N=n.get(I);N||(N={options:{country:b,locale:D,...C==="MULT"&&{language:C},offerSelectorIds:[]},promises:new Map},n.set(I,N)),y&&(N.options.promotionCode=y),N.options.offerSelectorIds.push(U),N.promises.set(U,{resolve:Z,reject:B}),l()}).catch(Z=>{if(s.has(j))return s.get(j);throw Z});return i.set(j,J),J})}return{Commitment:Ue,PlanType:Vn,Term:he,applyPlanType:Or,resolveOfferSelectors:p,flushWcsCacheInternal:m,prefillWcsCache:d,normalizeCountryLanguageAndLocale:h}}var Ts="mas-commerce-service",ks="mas-commerce-service:start",_s="mas-commerce-service:ready",nr,St,Je,Ls,Pi,Li=class extends HTMLElement{constructor(){super(...arguments);_(this,Je);_(this,nr);_(this,St);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,St)||T(this,St,{[Ce]:W(this,Je,Pi).call(this,Ce),[at]:W(this,Je,Pi).call(this,at)}),v(this,St)}activate(){let t=v(this,Je,Ls),a=Ss(t,this);Nr(t.lana);let i=oe.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:Lo(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...To(c),...ko(c),...Es(c),...Cs(c),...Ta,Log:oe,resolvePriceTaxFlags:ki,get defaults(){return O},get log(){return oe},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(hr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(_s),T(this,nr,performance.measure(_s,ks)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(ks),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(ra).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":ur(v(this,nr))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};nr=new WeakMap,St=new WeakMap,Je=new WeakSet,Ls=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},Pi=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(Ts)||window.customElements.define(Ts,Li);var Os="merch-card-collection",Dd=3e4,Hd={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Fd={plans:!0},Bd=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Ud=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,$d=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Gd=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),qd=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Fe,Ct,et,sr,Kr,Ns,At=class extends Ms{constructor(){super();_(this,Kr);_(this,Fe,{});_(this,Ct);_(this,et);_(this,sr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=Gi(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Re` <slot></slot>
    ...
    `);At.SortOrder=fe;customElements.define(Os,At);var Vd={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},jd=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(i=>{i.innerText=t||""})},Wd={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},Yd={catalog:"l"},ce,Tt,or=class extends Ms{constructor(){super();_(this,ce);_(this,Tt);g(this,"tablet",new _t(this,R));g(this,"desktop",new _t(this,k));this.collection=null,T(this,ce,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(me,this.updateLiterals),this.collection?.addEventListener(Pt,this.handleSidenavAttached),T(this,Tt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(me,this.updateLiterals),this.collection?.removeEventListener(Pt,this.handleSidenavAttached)}willUpdate(){v(this,ce).search=this.getVisibility("search"),v(this,ce).filter=this.getVisibility("filter"),v(this,ce).sort=this.getVisibility("sort"),v(this,ce).result=this.getVisibility("result"),v(this,ce).custom=this.getVisibility("custom")}parseVisibilityOptions(t,a){if(!t||!Object.hasOwn(t,a))return null;let i=t[a];return i===!1?!1:i===!0?!0:i.includes(this.currentMedia)}getVisibility(t){let a=v(this,Tt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,i=this.parseVisibilityOptions(a,t);return i!==null?i:this.parseVisibilityOptions(Wd,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,ce).search)return ve;let t=Rt(this,"searchText");return t?Re`
        ...
        >
            ...
            ${a}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(a=>{jd(this,a,t.detail[a])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return Re`
            <sp-theme color="light" scale="medium">
                <div id="header">

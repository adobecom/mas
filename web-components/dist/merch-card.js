...
`,rr=()=>[er`
        ...
        `];import{LitElement as Ei,html as ir,css as ki}from"./lit-all.min.js";function Si(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var de=class extends Ei{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Si())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Et())}e.remove()})}render(){let{href:t}=this;return t?ir`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};l(de,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(de,"styles",ki`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",de);var ln=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),dn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var w='span[is="inline-price"][data-wcs-osi]',G='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Ci='a[is="upt-link"]',ar=`${w},${G},${Ci}`;var nr="merch-offer-select:ready",or="merch-card:action-menu-toggle";var H="merch-quantity-selector:change",sr="merch-card-quantity:change",kt="merch-modal:addon-and-quantity-update";var pe="merch-card-collection:literals-changed";var he="aem:load",me="aem:error",cr="mas:ready",lr="mas:error",dr="placeholder-failed",pr="placeholder-pending",hr="placeholder-resolved";var mr="mas:failed",$e="mas:resolved",gr="mas/commerce";var V="failed",Z="pending",Y="resolved";var Je="X-Request-Id",pn=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var hn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var et=":start",tt=":duration";var rt="legal",ur="mas-ff-defaults";var Ai="mas-commerce-service";function fr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function L(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function ge(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function St(){return window.matchMedia("(max-width: 1024px)").matches}function J(){return document.getElementsByTagName(Ai)?.[0]}function Ne(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var De,ee,Ie,Fe,ue,it=class extends HTMLElement{constructor(){super();g(this,De,"");g(this,ee);g(this,Ie,[]);g(this,Fe,[]);g(this,ue);m(this,ue,fr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,ee)?this.parentElement.style.borderRadius=c(this,ee):c(this,ee)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Ie).map((r,a)=>{let n=c(this,Fe)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,De)}, ${e})`}connectedCallback(){c(this,ue).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&m(this,ee,a?.trim()),e==="colors"&&a?m(this,Ie,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?m(this,Fe,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,De,a?.trim()??""),c(this,ue).call(this)}};De=new WeakMap,ee=new WeakMap,Ie=new WeakMap,Fe=new WeakMap,ue=new WeakMap;customElements.define("merch-gradient",it);import{LitElement as Ti,html as Li,css as zi}from"./lit-all.min.js";var fe=class extends Ti{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${w}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener($e,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener($e,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Li` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};l(fe,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),l(fe,"styles",zi`
        :host {
            --merch-addon-gap: 9px;
...
`;var st=class extends x{constructor(t){super(t)}getGlobalCSS(){return yr}renderLayout(){return wr` ${this.badge}
            ...
            ${this.card.customHr?"":wr`<hr />`} ${this.secureLabelFooter}`}};import{html as be,css as Mi,unsafeCSS as kr}from"./lit-all.min.js";var Er=`
  :root {
...
`;var Ri=32,ye=class extends x{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?be`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),f.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(ye,"variantStyle",Mi`
    ...
    `);import{html as qe,css as Oi,nothing as ct}from"./lit-all.min.js";var Sr=`
:root {
...
`;var we=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return _r}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return At` ${this.badge}
...
`;var Rr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ke=class extends x{constructor(t){super(t)}getGlobalCSS(){return Mr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Lt`${this.cardImage}
            ...
            ${this.evergreen?Lt`
                  ...
                  `:Lt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};l(ke,"variantStyle",Ii`
    ...
    `);import{html as Fi,css as Bi}from"./lit-all.min.js";var Or=`
:root {
...
`;var zt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Se=class extends x{getGlobalCSS(){return Or}get aemFragmentMapping(){return zt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),f.isDesktopOrUp)){let t=this.getContainer();if(!t)return;requestAnimationFrame(()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(r=>r.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Xe()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(Xe())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};e();let r=window.matchMedia(v);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(v).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||Xe())return;let a=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",a)}renderLayout(){return Fi`
    ...
    `);import{html as Nr,css as Hi}from"./lit-all.min.js";var $r=`
:root {
...
`;var Ir={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ae=class extends x{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Dr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ui`
            ${this.badge}
            <div class="body">
    ...
    `);var pt=new Map,Fr=new WeakMap,Br=new Map,C=(i,t,e=null,r=null,a)=>{pt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};C("catalog",ve,vr,ve.variantStyle);C("image",ot);C("inline-heading",st);C("mini-compare-chart",ye,null,ye.variantStyle);C("plans",z,lt,z.variantStyle,z.collectionOptions);C("plans-students",z,Ar,z.variantStyle,z.collectionOptions);C("plans-education",z,Cr,z.variantStyle,z.collectionOptions);C("plans-v2",K,zr,K.variantStyle,K.collectionOptions);C("product",we,null,we.variantStyle);C("segment",Ee,null,Ee.variantStyle);C("special-offers",ke,Rr,ke.variantStyle);C("simplified-pricing-express",Se,zt,Se.variantStyle);C("full-pricing-express",Ce,_t,Ce.variantStyle);C("mini",Ae,Ir,Ae.variantStyle);var ji=(i,t,e)=>{try{let r=Br.get(i.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),Br.set(i.variant,r)),e?.styleSheet&&e.styleSheet!==r){let a=i.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);a!==-1&&i.shadowRoot.adoptedStyleSheets.splice(a,1)}return i.shadowRoot.adoptedStyleSheets.includes(r)||i.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",i.variant);let n=e?.styleElement||i.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),i.shadowRoot.appendChild(a),{styleElement:a}}},Pt=i=>{let t=pt.get(i.variant);if(!t)return;let{class:e,style:r}=t,a=Fr.get(i);if(a?.appliedVariant===i.variant)return new e(i);let n=r?ji(i,r,a):{};return Fr.set(i,{appliedVariant:i.variant,...n}),new e(i)};function nt(i){return pt.get(i)?.fragmentMapping}function Hr(i){return pt.get(i)?.collectionOptions}var qr=document.createElement("style");qr.innerHTML=`
:root {
...
`;document.head.appendChild(qr);function ht(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Mt(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Mt(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Vi(Mt(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Gi=i=>typeof i=="boolean",mt=i=>typeof i=="function";var Mt=i=>typeof i=="string";function Ur(i,t){if(Gi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Vi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var te=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(Je);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Yi="mas-commerce-service",Ki={requestId:Je,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var gt=i=>window.setTimeout(i);function Rt(){return document.getElementsByTagName(Yi)?.[0]}function jr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Ki)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Gr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Vr="fragment",Yr="author",Kr="preview",Wr="loading",Qr="timeout",Ot="aem-fragment",Xr="eager",Zr="cache",Wi=[Xr,Zr],F,re,$,$t=class{constructor(){g(this,F,new Map);g(this,re,new Map);g(this,$,new Map)}clear(){c(this,F).clear(),c(this,re).clear(),c(this,$).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,F).set(t.id,t),t.fields?.originalId&&c(this,F).set(t.fields.originalId,t),c(this,$).has(t.id)){let[,r]=c(this,$).get(t.id);r()}if(c(this,$).has(t.fields?.originalId)){let[,r]=c(this,$).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,F).has(t)}entries(){return c(this,F).entries()}get(t){return c(this,F).get(t)}getAsPromise(t){let[e]=c(this,$).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,$).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,re).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,re).set(t,e)),e}remove(t){c(this,F).delete(t),c(this,re).delete(t),c(this,$).delete(t)}};F=new WeakMap,re=new WeakMap,$=new WeakMap;var W=new $t,Te,N,U,R,_,k,Ue,je,D,Ge,Ve,Le,I,Jr,ei,Nt,ti,ut=class extends HTMLElement{constructor(){super(...arguments);g(this,I);l(this,"cache",W);g(this,Te);g(this,N,null);g(this,U,null);g(this,R,null);g(this,_);g(this,k);g(this,Ue,Xr);g(this,je,5e3);g(this,D);g(this,Ge,!1);g(this,Ve,0);g(this,Le)}static get observedAttributes(){return[Vr,Wr,Qr,Yr,Kr]}attributeChangedCallback(e,r,a){e===Vr&&(m(this,_,a),m(this,k,W.getFetchInfo(a))),e===Wr&&Wi.includes(a)&&m(this,Ue,a),e===Qr&&m(this,je,parseInt(a,10)),e===Yr&&m(this,Ge,["","true"].includes(a)),e===Kr&&m(this,Le,a)}connectedCallback(){if(!c(this,D)){if(c(this,R)??m(this,R,J(this)),m(this,Le,c(this,R).settings?.preview),c(this,Te)??m(this,Te,c(this,R).log.module(`${Ot}[${c(this,_)}]`)),!c(this,_)||c(this,_)==="#"){c(this,k)??m(this,k,W.getFetchInfo("missing-fragment-id")),S(this,I,Nt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,D)&&!await Promise.race([c(this,D),Promise.resolve(!1)]))return;e&&W.remove(c(this,_)),c(this,Ue)===Zr&&await Promise.race([W.getAsPromise(c(this,_)),new Promise(s=>setTimeout(s,c(this,je)))]);try{m(this,D,S(this,I,ti).call(this)),await c(this,D)}catch(s){return S(this,I,Nt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,N)||{};return o&&!ht("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(he,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,D)}get updateComplete(){return c(this,D)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,Ge)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,N)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,U,e.reduce((h,{name:p,multiple:y,values:P})=>(h.fields[p]=y?P:P[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,U,Object.entries(e).reduce((h,[p,y])=>(h.fields[p]=y?.mimeType?y.value:y??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,_),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};Te=new WeakMap,N=new WeakMap,U=new WeakMap,R=new WeakMap,_=new WeakMap,k=new WeakMap,Ue=new WeakMap,je=new WeakMap,D=new WeakMap,Ge=new WeakMap,Ve=new WeakMap,Le=new WeakMap,I=new WeakSet,Jr=async function(e){Xt(this,Ve)._++;let r=`${Ot}:${c(this,_)}:${c(this,Ve)}`,a=`${r}${et}`,n=`${r}${tt}`;if(c(this,Le))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await Gr(e,{cache:"default",credentials:"omit"}),S(this,I,ei).call(this,o),c(this,k).status=o?.status,c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new te("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,N))return c(this,k).stale=!0,c(this,Te).error("Serving stale data",c(this,k)),c(this,N);let d=s.message??"unknown";throw new te(`Failed to fetch fragment: ${d}`,{})}},ei=function(e){Object.assign(c(this,k),jr(e))},Nt=function(e){m(this,D,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,R).duration};c(this,Te).error(e,r),this.dispatchEvent(new CustomEvent(me,{detail:r,bubbles:!0,composed:!0}))},ti=async function(){var d;this.classList.remove("error"),m(this,U,null);let e=W.get(c(this,_));if(e)return m(this,N,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,R).settings,s=`${r}/fragment?id=${c(this,_)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await S(this,I,Jr).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,_)),W.add(e),m(this,N,e),!0},l(ut,"cache",W);customElements.define(Ot,ut);import{LitElement as Qi,html as Dt,css as Xi,nothing as Zi}from"./lit-all.min.js";import{unsafeHTML as Ji}from"./lit-all.min.js";var ea=i=>i?i.startsWith("sp-icon-")?Dt`${Ji(`<${i} class="badge-icon"></${i}>`)}`:Dt`<img src="${i}" class="badge-icon" />`:Zi,ze=class extends Qi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Dt`<div class="badge">
            ${ea(this.icon)}${this.text}
        </div>`}};l(ze,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),l(ze,"styles",Xi`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",ze);import{html as ta,css as ra,LitElement as ia}from"./lit-all.min.js";var Ye=class extends ia{constructor(){super()}render(){return ta`
            <slot name="icon"></slot>
    ...
    `),l(Ye,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ye);import{html as It,css as aa,LitElement as na}from"./lit-all.min.js";var Ke=class extends na{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return It`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows?It`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:It``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(Ke,"styles",aa`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

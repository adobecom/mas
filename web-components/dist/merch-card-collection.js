var oa=Object.defineProperty;var sa=e=>{throw TypeError(e)};var Jo=(e,r,t)=>r in e?oa(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var es=(e,r)=>{for(var t in r)oa(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Jo(e,typeof r!="symbol"?r+"":r,t),Lr=(e,r,t)=>r.has(e)||sa("Cannot "+t);var b=(e,r,t)=>(Lr(e,r,"read from private field"),t?t.call(e):r.get(e)),$=(e,r,t)=>r.has(e)?sa("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),z=(e,r,t,i)=>(Lr(e,r,"write to private field"),i?i.call(e,t):r.set(e,t),t),vt=(e,r,t)=>(Lr(e,r,"access private method"),t);import{html as Te,LitElement as $o,css as Go,unsafeCSS as Uo,nothing as me}from"./lit-all.min.js";var O="(max-width: 767px)",X="(max-width: 1199px)",I="(min-width: 768px)",T="(min-width: 1200px)",Z="(min-width: 1600px)",ca={matchMobile:window.matchMedia(O),matchDesktop:window.matchMedia(`${T} and (not ${Z})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(Z),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},C=ca;function Wt(){return ca.isDesktop}var xt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var la="hashchange";function ts(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let i of t){let[a,n=""]=i.split("=");a&&r.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function bt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([a,n])=>{n?r.set(a,n):r.delete(a)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,i)}function da(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=ts(window.location.hash);e(t)};return r(),window.addEventListener(la,r),()=>{window.removeEventListener(la,r)}}var ti={};es(ti,{CLASS_NAME_FAILED:()=>Hr,CLASS_NAME_HIDDEN:()=>is,CLASS_NAME_PENDING:()=>Br,CLASS_NAME_RESOLVED:()=>Fr,CheckoutWorkflow:()=>xs,CheckoutWorkflowStep:()=>ee,Commitment:()=>Oe,ERROR_MESSAGE_BAD_REQUEST:()=>Ur,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>gs,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>$r,EVENT_AEM_ERROR:()=>Dr,EVENT_AEM_LOAD:()=>Ir,EVENT_MAS_ERROR:()=>zr,EVENT_MAS_READY:()=>us,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>ps,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Mr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>de,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Nr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>yt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Rr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>hs,EVENT_MERCH_OFFER_READY:()=>os,EVENT_MERCH_OFFER_SELECT_READY:()=>ss,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ue,EVENT_MERCH_SEARCH_CHANGE:()=>ms,EVENT_MERCH_SIDENAV_SELECT:()=>Or,EVENT_MERCH_STOCK_CHANGE:()=>ls,EVENT_MERCH_STORAGE_CHANGE:()=>ds,EVENT_OFFER_SELECTED:()=>cs,EVENT_TYPE_FAILED:()=>Gr,EVENT_TYPE_READY:()=>Yt,EVENT_TYPE_RESOLVED:()=>qr,Env:()=>ge,FF_ANNUAL_PRICE:()=>Ke,FF_DEFAULTS:()=>ye,HEADER_X_REQUEST_ID:()=>wt,LOG_NAMESPACE:()=>Vr,Landscape:()=>_e,MARK_DURATION_SUFFIX:()=>Jr,MARK_START_SUFFIX:()=>Qr,MODAL_TYPE_3_IN_1:()=>Ie,NAMESPACE:()=>rs,PARAM_AOS_API_KEY:()=>fs,PARAM_ENV:()=>Wr,PARAM_LANDSCAPE:()=>Yr,PARAM_MAS_PREVIEW:()=>jr,PARAM_WCS_API_KEY:()=>vs,PROVIDER_ENVIRONMENT:()=>Zr,SELECTOR_MAS_CHECKOUT_LINK:()=>ha,SELECTOR_MAS_ELEMENT:()=>kr,SELECTOR_MAS_INLINE_PRICE:()=>j,SELECTOR_MAS_SP_BUTTON:()=>ns,SELECTOR_MAS_UPT_LINK:()=>pa,SORT_ORDER:()=>pe,STATE_FAILED:()=>he,STATE_PENDING:()=>Ce,STATE_RESOLVED:()=>be,SUPPORTED_COUNTRIES:()=>ei,TAG_NAME_SERVICE:()=>as,TEMPLATE_PRICE:()=>bs,TEMPLATE_PRICE_ANNUAL:()=>ws,TEMPLATE_PRICE_LEGAL:()=>ne,TEMPLATE_PRICE_STRIKETHROUGH:()=>ys,Term:()=>ce,WCS_PROD_URL:()=>Xr,WCS_STAGE_URL:()=>Kr});var Oe=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ce=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),rs="merch",is="hidden",Yt="wcms:commerce:ready",as="mas-commerce-service",j='span[is="inline-price"][data-wcs-osi]',ha='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',ns="sp-button[data-wcs-osi]",pa='a[is="upt-link"]',kr=`${j},${ha},${pa}`,os="merch-offer:ready",ss="merch-offer-select:ready",Mr="merch-card:action-menu-toggle",cs="merch-offer:selected",ls="merch-stock:change",ds="merch-storage:change",ue="merch-quantity-selector:change",hs="merch-card-quantity:change",ps="merch-modal:addon-and-quantity-update",ms="merch-search:change",Rr="merch-card-collection:sort",de="merch-card-collection:literals-changed",yt="merch-card-collection:sidenav-attached",Nr="merch-card-collection:showmore",Or="merch-sidenav:select",Ir="aem:load",Dr="aem:error",us="mas:ready",zr="mas:error",Hr="placeholder-failed",Br="placeholder-pending",Fr="placeholder-resolved",Ur="Bad WCS request",$r="Commerce offer not found",gs="Literals URL not provided",Gr="mas:failed",qr="mas:resolved",Vr="mas/commerce",jr="mas.preview",Wr="commerce.env",Yr="commerce.landscape",fs="commerce.aosKey",vs="commerce.wcsKey",Xr="https://www.adobe.com/web_commerce_artifact",Kr="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",Ce="pending",be="resolved",_e={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},wt="X-Request-Id",ee=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),xs="UCv3",ge=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Zr={PRODUCTION:"PRODUCTION"},Ie={TWP:"twp",D2P:"d2p",CRM:"crm"},Qr=":start",Jr=":duration",bs="price",ys="price-strikethrough",ws="annual",ne="legal",ye="mas-ff-defaults",Ke="mas-ff-annual-price",pe={alphabetical:"alphabetical",authored:"authored"},ei=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Es="mas-commerce-service";var Et=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function fe(e,r={},t=null,i=null){let a=i?document.createElement(e,{is:i}):document.createElement(e);t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t;for(let[n,o]of Object.entries(r))a.setAttribute(n,o);return a}function Xt(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function ri(){return window.matchMedia("(max-width: 1024px)").matches}function St(){return document.getElementsByTagName(Es)?.[0]}function At(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}import{html as Kt,nothing as Ss}from"./lit-all.min.js";var Ze,Tt=class Tt{constructor(r){g(this,"card");$(this,Ze);this.card=r,this.insertVariantStyle()}getContainer(){return z(this,Ze,b(this,Ze)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),b(this,Ze)}insertVariantStyle(){let r=this.constructor.name;if(!Tt.styleMap[r]){Tt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let i=this.card.variant,a=Array.from(t.querySelectorAll(`merch-card[variant="${i}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${i}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of a){let s=o.getBoundingClientRect();if(s.width<=2)continue;let l=Math.round(s.top),c=n.get(l);c||(c=[],n.set(l,c)),c.push(o)}for(let o of n.values())for(let{name:s,getElement:l}of r){let c=`--consonant-merch-card-${i}-${s}-height`,d=0,p=[];for(let m of o){m.style.removeProperty(c);let h=l(m);if(!h){p.push({card:m,height:0});continue}let u=Math.max(0,parseInt(window.getComputedStyle(h).height)||0);p.push({card:m,height:u}),u>d&&(d=u)}if(!(d<=0))for(let{card:m}of p)m.style.setProperty(c,`${d}px`)}}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Kt`
        ...
        `}get cardImage(){return Kt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:Ss}get secureLabelFooter(){return Kt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Zt(this.card.variant)}};Ze=new WeakMap,g(Tt,"styleMap",{});var _=Tt;import{html as ii,css as As}from"./lit-all.min.js";var ma=`
:root {
...
`;var _s=32,wa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Je=class extends _{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Pe`<slot name="secure-transaction-label">
    ...
    `);import{html as Jt,css as Ps,unsafeCSS as Sa,nothing as Ls}from"./lit-all.min.js";var Ea=`
  :root {
...
`;var Ra={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},tt=class extends _{constructor(r){super(r),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ma}priceOptionsProvider(r,t){r.dataset.template===ne&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return ai` ${this.badge}
...
`;var Da={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},it=class extends _{constructor(r){super(r)}getGlobalCSS(){return Ia}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return Is`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
...
`;var ci={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},ze=class ze extends _{getGlobalCSS(){return Fa}get aemFragmentMapping(){return ci}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ua`
    ...
    `);var Pt=ze;import{html as li,css as Us,nothing as $s}from"./lit-all.min.js";var $a=`

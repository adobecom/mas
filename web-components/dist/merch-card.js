var Ur=Object.defineProperty;var jr=a=>{throw TypeError(a)};var ji=(a,r,e)=>r in a?Ur(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Vi=(a,r)=>()=>(a&&(r=a(a=0)),r);var Gi=(a,r)=>{for(var e in r)Ur(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>ji(a,typeof r!="symbol"?r+"":r,e),dr=(a,r,e)=>r.has(a)||jr("Cannot "+e);var l=(a,r,e)=>(dr(a,r,"read from private field"),e?e.call(a):r.get(a)),f=(a,r,e)=>r.has(a)?jr("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(dr(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),k=(a,r,e)=>(dr(a,r,"access private method"),e);var Vr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return l(a,r,t)}});var hr={};Gi(hr,{default:()=>nt});import{LitElement as Wi,html as Le,css as Ki,nothing as Yi}from"./lit-all.min.js";import{unsafeHTML as Zr}from"./lit-all.min.js";import{ifDefined as Qi}from"./lit-all.min.js";function Zi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var N,nt,pr=Vi(()=>{N=class N extends Wi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();N.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,s=this.shadowRoot?.querySelector(".css-tooltip-body"),d=s?s.offsetWidth:o,p=s?s.offsetHeight:c,g=this.effectivePlacement;g==="top"&&e.top-p-n<0?g="bottom":g==="bottom"&&e.bottom+p+n>i?g="top":g==="left"&&e.left-d-n<0?g="right":g==="right"&&e.right+d+n>t&&(g="left");let x=e.left+e.width/2,A=e.top+e.height/2,D=6,ge=(Bi,qi,Ui)=>Math.max(Bi,Math.min(qi,Ui)),Ot,Dt,lr;g==="top"||g==="bottom"?(Ot=g==="top"?e.top-p-n:e.bottom+n,Dt=ge(0,t-d,x-d/2),lr=ge(D,d-D*2,x-Dt-D)):(Dt=g==="left"?e.left-d-n:e.right+n,Ot=ge(0,i-p,A-p/2),lr=ge(D,p-D*2,A-Ot-D)),this._tooltipTop=Ot,this._tooltipLeft=Dt,this._arrowOffset=lr,this._computedPlacement=g}showTooltip(){N.activeTooltip&&N.activeTooltip!==this&&(N.activeTooltip.closeOverlay(),N.activeTooltip.tooltipVisible=!1,N.activeTooltip.requestUpdate()),N.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){N.activeTooltip===this&&(N.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Le`<merch-icon
    ...
    `);nt=N;customElements.define("mas-mnemonic",nt)});import{LitElement as Zo}from"./lit-all.min.js";import{css as Kr,unsafeCSS as Wr}from"./lit-all.min.js";var C="(max-width: 767px)",L="(max-width: 1199px)",w="(min-width: 768px)",b="(min-width: 1200px)",M="(min-width: 1600px)",it="(min-width: 1280px)",Gr={matchMobile:window.matchMedia(C),matchDesktop:window.matchMedia(`${b} and (not ${M})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(M),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},y=Gr;function Nt(){return Gr.isDesktop}var Yr=Kr`
    :host {

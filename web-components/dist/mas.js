...
`;var ji=class extends A{constructor(t){super(t)}getGlobalCSS(){return xc}renderLayout(){return g` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Jh=32,yc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue","spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue","spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans"],borderColor:{attribute:"border-color"},allowedWhatsIncludedDividerColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Vt=class extends A{constructor(r){super(r);m(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);m(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?g`<slot name="secure-transaction-label">
        ...
        /* Border color styles */
        :host(
            [variant='mini-compare-chart'][border-color='color-yellow-300-variation']
        ),
        :host(
        ...
        :host(
            [variant='mini-compare-chart'][border-color='color-gray-300-variation']
        ),
        :host(
        ...
        :host(
            [variant='mini-compare-chart'][border-color='color-green-900-variation']
        ),
        :host(
        ...
        :host(
            [variant='mini-compare-chart'][border-color='color-red-700-variation']
        ),
        :host(
        ...
        :host([variant='mini-compare-chart']) #badge.color-yellow-300-variation,
        ...
        :host([variant='mini-compare-chart']) #badge.color-gray-300-variation,
        ...
        :host([variant='mini-compare-chart']) #badge.color-gray-700-variation,
        ...
        :host([variant='mini-compare-chart']) #badge.color-green-900-variation,
        ...
        :host([variant='mini-compare-chart'])
            ::slotted([slot='badge'].spectrum-red-700-plans),
        :host([variant='mini-compare-chart']) #badge.color-red-700-variation,
...
`;var Pc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Wt=class extends A{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return _c}priceOptionsProvider(t,r){t.dataset.template===ve&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return g` ${this.badge}
...
`;var Mc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Yt=class extends A{constructor(t){super(t)}priceOptionsProvider(t,r){t.dataset.template===ve&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}getGlobalCSS(){return Lc}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${D}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let r=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),t.parentNode.insertBefore(r,t.nextSibling),await r.onceSettled()}catch{}}renderLayout(){return g`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Fc={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},er=class extends A{constructor(){super(...arguments);m(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Bc}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${D}[data-template="price"]`);if(!r)return;let i=r.cloneNode(!0);this.legal=i,r.dataset.displayTax="false",r.dataset.displayPerUnit="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return g`
    ...
    `);var Yi=new Map,Uc=new WeakMap,Gc=new Map,G=(e,t,r=null,i=null,a)=>{Yi.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:a})};G("catalog",qt,gc,qt.variantStyle);G("image",wt);G("inline-heading",ji);G("mini-compare-chart",Vt,yc,Vt.variantStyle);G("mini-compare-chart-mweb",jt,Ec,jt.variantStyle);G("plans",ge,Wi,ge.variantStyle,ge.collectionOptions);G("plans-students",ge,Cc,ge.variantStyle,ge.collectionOptions);G("plans-education",ge,Sc,ge.variantStyle,ge.collectionOptions);G("plans-v2",Ke,kc,Ke.variantStyle,Ke.collectionOptions);G("product",Wt,Pc,Wt.variantStyle);G("segment",Yt,Mc,Yt.variantStyle);G("media",Xt,Oc,Xt.variantStyle);G("headless",Jt,Hc,Jt.variantStyle);G("special-offers",Kt,Ic,Kt.variantStyle);G("simplified-pricing-express",Qt,Rn,Qt.variantStyle);G("full-pricing-express",Zt,On,Zt.variantStyle);G("mini",er,Fc,er.variantStyle);G("image",wt,vc,wt.variantStyle);var rp=(e,t,r)=>{try{let i=Gc.get(e.variant);if(i||(i=new CSSStyleSheet,i.replaceSync(t.cssText),Gc.set(e.variant,i)),r?.styleSheet&&r.styleSheet!==i){let a=e.shadowRoot.adoptedStyleSheets.indexOf(r.styleSheet);a!==-1&&e.shadowRoot.adoptedStyleSheets.splice(a,1)}return e.shadowRoot.adoptedStyleSheets.includes(i)||e.shadowRoot.adoptedStyleSheets.push(i),{styleSheet:i}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",e.variant);let n=r?.styleElement||e.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),e.shadowRoot.appendChild(a),{styleElement:a}}},Nn=e=>{let t=Yi.get(e.variant);if(!t)return;let{class:r,style:i}=t,a=Uc.get(e);if(a?.appliedVariant===e.variant)return new r(e);let n=i?rp(e,i,a):{};return Uc.set(e,{appliedVariant:e.variant,...n}),new r(e)};function Vi(e){return Yi.get(e)?.fragmentMapping}function qc(e){return Yi.get(e)?.collectionOptions}var Vc=document.createElement("style");Vc.innerHTML=`
:root {
...
`;document.head.appendChild(Vc);var jc="fragment",Wc="author",Yc="preview",Xc="loading",Kc="timeout",In="aem-fragment",Qc="eager",Zc="cache",ip=[Qc,Zc],Ie,Et,_e,zn=class{constructor(){w(this,Ie,new Map);w(this,Et,new Map);w(this,_e,new Map)}clear(){h(this,Ie).clear(),h(this,Et).clear(),h(this,_e).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,Ie).set(t.id,t),t.fields?.originalId&&h(this,Ie).set(t.fields.originalId,t),h(this,_e).has(t.id)){let[,i]=h(this,_e).get(t.id);i()}if(h(this,_e).has(t.fields?.originalId)){let[,i]=h(this,_e).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return h(this,Ie).has(t)}entries(){return h(this,Ie).entries()}get(t){return h(this,Ie).get(t)}getAsPromise(t){let[r]=h(this,_e).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),h(this,_e).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,Et).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,Et).set(t,r)),r}remove(t){h(this,Ie).delete(t),h(this,Et).delete(t),h(this,_e).delete(t)}};Ie=new WeakMap,Et=new WeakMap,_e=new WeakMap;var Qe=new zn,tr,Pe,Ge,Ee,fe,J,Yr,Xr,Le,Kr,Qr,rr,Me,Jc,el,Dn,tl,Xi=class extends HTMLElement{constructor(){super(...arguments);w(this,Me);m(this,"cache",Qe);w(this,tr);w(this,Pe,null);w(this,Ge,null);w(this,Ee,null);w(this,fe);w(this,J);w(this,Yr,Qc);w(this,Xr,5e3);w(this,Le);w(this,Kr,!1);w(this,Qr,0);w(this,rr)}static get observedAttributes(){return[jc,Xc,Kc,Wc,Yc]}attributeChangedCallback(r,i,a){r===jc&&(y(this,fe,a),y(this,J,Qe.getFetchInfo(a))),r===Xc&&ip.includes(a)&&y(this,Yr,a),r===Kc&&y(this,Xr,parseInt(a,10)),r===Wc&&y(this,Kr,["","true"].includes(a)),r===Yc&&y(this,rr,a)}connectedCallback(){if(!h(this,Le)){if(h(this,Ee)??y(this,Ee,mt(this)),y(this,rr,h(this,Ee).settings?.preview),h(this,tr)??y(this,tr,h(this,Ee).log.module(`${In}[${h(this,fe)}]`)),!h(this,fe)||h(this,fe)==="#"){h(this,J)??y(this,J,Qe.getFetchInfo("missing-fragment-id")),Z(this,Me,Dn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,Le)&&!await Promise.race([h(this,Le),Promise.resolve(!1)]))return;r&&Qe.remove(h(this,fe)),h(this,Yr)===Zc&&await Promise.race([Qe.getAsPromise(h(this,fe)),new Promise(s=>setTimeout(s,h(this,Xr)))]);try{y(this,Le,Z(this,Me,tl).call(this)),await h(this,Le)}catch(s){return Z(this,Me,Dn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=h(this,Pe)||{};return o&&!F("mas.disableWcsCache")&&h(this,Ee).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(at,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...h(this,J)},bubbles:!0,composed:!0})),h(this,Le)}get updateComplete(){return h(this,Le)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,Ge)?h(this,Ge):(h(this,Kr)?this.transformAuthorData():this.transformPublishData(),h(this,Ge))}get rawData(){return h(this,Pe)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=h(this,Pe);y(this,Ge,r.reduce((d,{name:p,multiple:u,values:f})=>(d.fields[p]=u?f:f[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=h(this,Pe);y(this,Ge,Object.entries(r).reduce((d,[p,u])=>(d.fields[p]=u?.mimeType?u.value:u??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,fe),{locale:h(this,Ee).settings.locale,apiKey:h(this,Ee).settings.wcsApiKey,fullContext:!0})}};tr=new WeakMap,Pe=new WeakMap,Ge=new WeakMap,Ee=new WeakMap,fe=new WeakMap,J=new WeakMap,Yr=new WeakMap,Xr=new WeakMap,Le=new WeakMap,Kr=new WeakMap,Qr=new WeakMap,rr=new WeakMap,Me=new WeakSet,Jc=async function(r){to(this,Qr)._++;let i=`${In}:${h(this,fe)}:${h(this,Qr)}`,a=`${i}${st}`,n=`${i}${ct}`;if(h(this,rr)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Oe(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(h(this,J).stale=!1,h(this,J).url=r,o=await Ii(r,{cache:"default",credentials:"omit"}),Z(this,Me,el).call(this,o),h(this,J).status=o?.status,h(this,J).measure=Ne(performance.measure(n,a)),h(this,J).retryCount=o.retryCount,!o?.ok)throw new Oe("Unexpected fragment response",{response:o,...h(this,Ee).duration});return await o.json()}catch(s){if(h(this,J).measure=Ne(performance.measure(n,a)),h(this,J).retryCount=s.retryCount,h(this,Pe))return h(this,J).stale=!0,h(this,tr).error("Serving stale data",h(this,J)),h(this,Pe);let c=s.message??"unknown";throw new Oe(`Failed to fetch fragment: ${c}`,{})}},el=function(r){Object.assign(h(this,J),bi(r))},Dn=function(r){y(this,Le,null),h(this,J).message=r,this.classList.add("error");let i={...h(this,J),...h(this,Ee).duration};h(this,tr).error(r,i),this.dispatchEvent(new CustomEvent(nt,{detail:i,bubbles:!0,composed:!0}))},tl=async function(){var c;this.classList.remove("error"),y(this,Ge,null);let r=Qe.get(h(this,fe));if(r)return y(this,Pe,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=h(this,Ee).settings,s=`${i}/fragment?id=${h(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Me,Jc).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,fe)),Qe.add(r),y(this,Pe,r),!0},m(Xi,"cache",Qe);customElements.define(In,Xi);P();Ur();var rl={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},il=e=>(...t)=>({_$litDirective$:e,values:t}),Ki=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,i){this._$Ct=t,this._$AM=r,this._$Ci=i}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};var Zr=class extends Ki{constructor(t){if(super(t),this.et=E,t.type!==rl.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===E||t==null)return this.ft=void 0,this.et=t;if(t===Ue)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let r=[t];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};Zr.directiveName="unsafeHTML",Zr.resultType=1;var al=il(Zr);var ap=e=>e?e.startsWith("sp-icon-")?g`${al(`<${e} class="badge-icon"></${e}>`)}`:g`<img src="${e}" class="badge-icon" />`:E,ir=class extends U{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return g`<div class="badge">
    ...
    `);customElements.define("merch-badge",ir);P();var Jr=class extends U{constructor(){super()}render(){return g`
            <slot name="icon"></slot>
    ...
    `),m(ai,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",ai);P();P();var ul=b`
    :host {
...
`;var[R0,O0,Un,Gn,fl,vl]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var qn=class extends U{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return gl}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=Rr(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=Rr(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(Pt,this.debouncedQuantityUpdate)}get button(){return this.shadowRoot.querySelector("button")}handleKeyup(t){t.key===Gn||t.key===Un||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let t=this.options[this.highlightedIndex];if(!t){this.closed=!0;return}this.selectedValue=t,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(t){switch(t.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case vl:this.selectValue();break;case Gn:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,t.preventDefault();break;case Un:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),t.preventDefault();break;case fl:this.selectValue(),this.button.classList.contains("focused")&&t.preventDefault();break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=t.value.replace(/\D/g,"");t.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let a=i;this.maxInput&&i>this.maxInput&&(a=this.maxInput),this.min&&a<this.min&&(a=this.min),this.adjustInput(t,a)}else this.adjustInput(t,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(Pt,this.debouncedQuantityUpdate)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}update(t){(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue"))&&(this.options=this.generateOptionsArray(),this.highlightedIndex=this.defaultValue?this.options.indexOf(this.defaultValue):0,this.handleMenuOption(this.defaultValue?this.defaultValue:this.options[0])),super.update(t)}handleClickOutside(t){t.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let t=this.shadowRoot.querySelector(".popover");this.closed||t.getBoundingClientRect().bottom<=window.innerHeight?t.setAttribute("placement","bottom"):t.setAttribute("placement","top")}handleMouseEnter(t){this.highlightedIndex=t}handleMenuOption(t,r){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let t=new CustomEvent(te,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return g` <div
        ...
        `}};customElements.define("merch-quantity-select",qn);Gi();P();var xl=`
...
`;var wl={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},dr=class extends A{getGlobalCSS(){return yl}renderLayout(){return g` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>

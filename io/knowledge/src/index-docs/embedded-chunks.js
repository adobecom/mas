 ...
 * Generated at: 2026-03-07T00:23:52.891Z
 * Total chunks: 468
 */
...
- All M@S content is in \\`,
    ...
    {
        id: 'authoring-bulk-operations-guide-0',
        text: `## Overview
...
Bulk operations allow users to update, publish, or delete multiple cards simultaneously. All bulk operations follow a preview-confirm-execute workflow to prevent accidental changes.`,
        metadata: {
            file: 'authoring/bulk-operations-guide.md',
            section: 'Overview',
            parentSection: '',
            category: 'authoring',
        },
    ...
    {
        id: 'authoring-bulk-operations-guide-1',
...
| Bulk Delete | Delete multiple cards at once |`,
        metadata: {
            file: 'authoring/bulk-operations-guide.md',
            section: 'Available Bulk Operations',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-bulk-operations-guide-2',
        text: `## Preview-Confirm-Execute Workflow
...
- Results include successful, failed, and skipped items`,
        metadata: {
            file: 'authoring/bulk-operations-guide.md',
            section: 'Preview-Confirm-Execute Workflow',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-bulk-operations-guide-3',
        text: `## Preview Summary Formats
...
\`\`\``,
        metadata: {
            file: 'authoring/bulk-operations-guide.md',
            section: 'Preview Summary Formats',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-bulk-operations-guide-4',
        text: `## Job Tracking
...
| skipped | Array of skipped items |`,
    ...
    {
        id: 'authoring-bulk-operations-guide-5',
        text: `## Using Bulk Operations via AI Assistant
...
5. **Track progress**: Real-time progress updates appear in the chat`,
        metadata: {
            file: 'authoring/bulk-operations-guide.md',
            section: 'Using Bulk Operations via AI Assistant',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-bulk-operations-guide-6',
        text: `## Parameters
...
- \`fragmentIds\`: Array of fragment IDs to delete`,
    ...
    {
        id: 'authoring-collections-guide-0',
        text: `## Overview
...
Collections in MAS Studio are groups of merch cards organized hierarchically. A collection can contain multiple cards, nested sub-collections (categories), and a designated default card. Collections support browse/category interfaces for organizing products.`,
        metadata: {
            file: 'authoring/collections-guide.md',
            section: 'Overview',
            parentSection: '',
            category: 'authoring',
        },
    ...
    {
        id: 'authoring-collections-guide-1',
        text: `## Collection Model Fields
...
| linkText | text | Link text |`,
        metadata: {
            file: 'authoring/collections-guide.md',
            section: 'Collection Model Fields',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-collections-guide-2',
...
3. The collection is saved as a Content Fragment at the current surface/locale path`,
    ...
    {
        id: 'authoring-collections-guide-3',
        text: `## Managing Collections in the Editor
...
- **Preview**: Hover over cards to see a live preview`,
        metadata: {
            file: 'authoring/collections-guide.md',
            section: 'Managing Collections in the Editor',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-collections-guide-4',
        text: `## Collection Model Path
...
- Collections field maps to: \`/conf/mas/settings/dam/cfm/models/collection\``,
        metadata: {
            file: 'authoring/collections-guide.md',
            section: 'Collection Model Path',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-collections-guide-5',
        text: `## Nested Collections (Categories)
...
Collections support hierarchical organization through nested collections. A parent collection can contain child collections, enabling category-based browsing structures. In the editor, nested collections are labeled as "Categories."`,
        metadata: {
            file: 'authoring/collections-guide.md',
            section: 'Nested Collections (Categories)',
            parentSection: '',
            category: 'authoring',
        },
    },
...
- Create a locale variation for different regions`,
    ...
    {
        id: 'authoring-promotions-guide-0',
        text: `## Overview
...
Promotions in MAS Studio are campaign management entities for time-based promotional campaigns. They use AEM Content Fragments to represent campaigns with defined lifecycles (scheduled, active, or expired).`,
        metadata: {
            file: 'authoring/promotions-guide.md',
            section: 'Overview',
            parentSection: '',
            category: 'authoring',
        },
    ...
    {
        id: 'authoring-promotions-guide-1',
        text: `## Key Concepts
...
- **Surface-aware**: Promotions can be scoped to specific surfaces`,
    ...
    {
        id: 'authoring-promotions-guide-2',
        text: `## Promotion Model Fields
...
| surfaces | long-text | No | Target surface names |`,
        metadata: {
            file: 'authoring/promotions-guide.md',
            section: 'Promotion Model Fields',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-promotions-guide-3',
        text: `## Promotion Lifecycle States
...
| unknown | Missing or invalid dates |`,
        metadata: {
            file: 'authoring/promotions-guide.md',
            section: 'Promotion Lifecycle States',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-promotions-guide-4',
        text: `## Creating a Promotion
...
4. Click Save to create the promotion in AEM`,
        metadata: {
            file: 'authoring/promotions-guide.md',
            section: 'Creating a Promotion',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-promotions-guide-5',
        text: `## Applying Promotions to Cards
...
4. The promotion variation displays different content during the campaign period`,
        metadata: {
            file: 'authoring/promotions-guide.md',
            section: 'Applying Promotions to Cards',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-promotions-guide-6',
        text: `## Promotion Variations
...
- **Promotion variations** - Campaign-specific content linked via promotion tags`,
        metadata: {
            file: 'authoring/promotions-guide.md',
            section: 'Promotion Variations',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-promotions-guide-7',
        text: `## Filtering Promotions
...
- Archived`,
        metadata: {
            file: 'authoring/promotions-guide.md',
            section: 'Filtering Promotions',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-promotions-guide-8',
...
- Use \\`,
    ...
    {
        id: 'authoring-translations-guide-0',
        text: `## Overview
...
Translation Projects (Loc v2) enable bulk localization workflows in MAS Studio. Authors select multiple content items and target locales, bundle them into a project, and send the project to WorldServer for translation.`,
        metadata: {
            file: 'authoring/translations-guide.md',
            section: 'Overview',
            parentSection: '',
            category: 'authoring',
        },
    ...
    {
        id: 'authoring-translations-guide-1',
        text: `## Key Concepts
...
- **Surface-aware**: Available on acom, express, sandbox, and nala surfaces`,
    ...
    {
        id: 'authoring-translations-guide-2',
...
6. Click "Save" to create the project in AEM`,
    ...
    {
        id: 'authoring-translations-guide-3',
...
- At least one item (fragment, collection, or placeholder) must be selected`,
    ...
    {
        id: 'authoring-translations-guide-4',
...
4. The project becomes readonly after submission`,
    ...
    {
        id: 'authoring-translations-guide-5',
        text: `## Project States
...
| Readonly | Same as submitted - form fields are locked |`,
    ...
    {
        id: 'authoring-translations-guide-6',
        text: `## Translation Project Fragment Model
...
| submissionDate | date-time | Set when project is sent to translation |`,
        metadata: {
            file: 'authoring/translations-guide.md',
            section: 'Translation Project Fragment Model',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-translations-guide-7',
        text: `## Available Target Locales
...
Target locales are loaded dynamically per surface. The source locale (en_US) is excluded from selection. Authors can use "Select all" to choose all available locales at once.`,
        metadata: {
            file: 'authoring/translations-guide.md',
            section: 'Available Target Locales',
            parentSection: '',
            category: 'authoring',
        },
    },
    {
        id: 'authoring-translations-guide-8',
        text: `## Storage Location
...
Translation projects are stored at: \`/content/dam/mas/{surface}/translations/\``,
    ...
    {
        id: 'authoring-translations-guide-9',
        text: `## WorldServer Integration
...
This payload is sent to AEM's \`/bin/sendToLocalisationAsync\` endpoint for WorldServer processing.`,
        metadata: {
            file: 'authoring/translations-guide.md',
            section: 'WorldServer Integration',
            parentSection: '',
            category: 'authoring',
        },
    },
...
\`\`\`html
<span[is="inline-price"]></span[is="inline-price"]>
\`\`\``,
        metadata: {
            file: 'developer/components/inline-price.md',
            section: 'Usage',
...
| --- | --- | --- |
| data-display-old-price | string |  |
| data-display-per-unit | string |  |
| data-display-recurrence | string |  |
| data-display-tax | string |  |
| data-display-plan-type | string |  |
| data-display-annual | string |  |
| data-perpetual | string |  |
| data-promotion-code | string |  |
| data-force-tax-exclusive | string |  |
...
\`\`\``,
    ...
    {
        id: 'developer/variants-headless-0',
        text: `## Overview

The Headless variant is used for displaying merch card content.`,
        metadata: {
            file: 'developer/variants/headless.md',
            section: 'Overview',
            parentSection: '',
            category: 'developer/variants',
        },
    ...
    {
        id: 'developer/variants-headless-1',
        text: `## Field Mappings
...
| cardName | - | - | - | Sets name attribute |`,
    ...
    {
        id: 'developer/variants-headless-2',
        text: `## Slot Structure
...
\`\`\``,
    ...
    {
        id: 'developer/variants-image-0',
        text: `## Overview

The Image variant is used for displaying merch card content.`,
        metadata: {
            file: 'developer/variants/image.md',
            section: 'Overview',
            parentSection: '',
            category: 'developer/variants',
        },
...
\`\`\``,
    ...
    {
        id: 'developer/variants-product-0',
        text: `## Overview

The Product variant is used for displaying merch card content.`,
        metadata: {
            file: 'developer/variants/product.md',
            section: 'Overview',
            parentSection: '',
            category: 'developer/variants',
        },
    ...
    {
        id: 'developer/variants-product-1',
        text: `## Field Mappings
...
| cardName | - | - | - | Sets name attribute |`,
    ...
    {
        id: 'developer/variants-product-2',
        text: `## Slot Structure
...
\`\`\``,
    ...
    {
        id: 'developer/variants-segment-0',
        text: `## Overview

The Segment variant is used for displaying merch card content.`,
        metadata: {
            file: 'developer/variants/segment.md',
            section: 'Overview',
            parentSection: '',
            category: 'developer/variants',
        },
    ...
    {
        id: 'developer/variants-segment-1',
        text: `## Field Mappings
...
| cardName | - | - | - | Sets name attribute |`,
    ...
    {
        id: 'developer/variants-segment-2',
        text: `## Slot Structure
...
---
        ...
        metadata: {
            ...
            parentSection: '',
            category: 'confluence',
            sourceUrl: 'https://wiki.corp.adobe.com/display/adobedotcom/A11Y',
        },
    },
    {
...
mas-ff-xxxxxxxx`,
        metadata: {
            ...
            parentSection: '',
            category: 'confluence',
            sourceUrl: 'https://wiki.corp.adobe.com/display/adobedotcom/Code+Conventions',
        },
    },
    {
...
- D2P Modal AA Dashboard`,
        metadata: {
            ...
            parentSection: '',
            category: 'confluence',
            sourceUrl: 'https://wiki.corp.adobe.com/display/adobedotcom/Dexter+CC+Plans+Page+FAQ',
        },
    },
    {
...
what is at stake here is the API https://<odin-host>.adobe.com/adobe/sites/fragments/<fragment-id>. Each usage of m@s references such a fragment and trigger a request to freyja to get corresponding payload. First usage is simple fragment query, no parameter. Any unwanted parameter gives 400 requests, any malformed UUID gives 400 requests. We can eventually test load with such malformed requests (voluntary or unvoluntary DDOS attack), but this is not primary goal. Main risk could be when a fragment gets published & invalidated, that too many requests hit the origin.`,
        metadata: {
            ...
            parentSection: '',
            category: 'confluence',
            sourceUrl: 'https://wiki.corp.adobe.com/display/adobedotcom/First+tests',
        },
    },
    {
...
- Serve stale content when errors happen`,
        metadata: {
            ...
            parentSection: '',
            category: 'confluence',
            sourceUrl: 'https://wiki.corp.adobe.com/pages/viewpage.action?pageId=3351574680',
        },
    },
    {
...
# High level - Regional Customizations`,
        metadata: {
            ...
            parentSection: '',
            category: 'confluence',
            sourceUrl: 'https://wiki.corp.adobe.com/display/WP4/Milo+Plans+page+-+Regional+customizations',
        },
    },
    {
...
---`,
        metadata: {
            ...
            parentSection: '',
            category: 'confluence',
            sourceUrl: 'https://wiki.corp.adobe.com/display/adobedotcom/Offer+Selector+Tool+Demo+Recordings',
        },
    },
    {
...
| T | P | Key | Summary | Status | Assignee |`,
        metadata: {
            ...
            parentSection: '',
            category: 'confluence',
            sourceUrl: 'https://wiki.corp.adobe.com/display/adobedotcom/Plans+Page+Milo+Migration+Dashboard',
        },
    },
    {
...
3. Check if merch-card fragment is published in odin`,
        metadata: {
            ...
            parentSection: '',
            category: 'confluence',
            sourceUrl: 'https://wiki.corp.adobe.com/display/adobedotcom/Troubleshooting',
        },
    },
    {

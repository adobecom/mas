var gr=Object.defineProperty;var ur=a=>{throw TypeError(a)};var ri=(a,t,e)=>t in a?gr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var ai=(a,t)=>()=>(a&&(t=a(a=0)),t);var ii=(a,t)=>{for(var e in t)gr(a,e,{get:t[e],enumerable:!0})};var h=(a,t,e)=>ri(a,typeof t!="symbol"?t+"":t,e),$t=(a,t,e)=>t.has(a)||ur("Cannot "+e);var s=(a,t,e)=>($t(a,t,"read from private field"),e?e.call(a):t.get(a)),f=(a,t,e)=>t.has(a)?ur("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>($t(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),_=(a,t,e)=>($t(a,t,"access private method"),e);var fr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return s(a,t,r)}});var Bt={};ii(Bt,{default:()=>Ye});import{LitElement as ni,html as be,css as oi,nothing as ci}from"./lit-all.min.js";import{unsafeHTML as Er}from"./lit-all.min.js";import{ifDefined as si}from"./lit-all.min.js";function li(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var P,Ye,Ht=ai(()=>{P=class P extends ni{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();P.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>i?u="top":u==="left"&&e.left-d-n<0?u="right":u==="right"&&e.right+d+n>r&&(u="left");let C=e.left+e.width/2,$=e.top+e.height/2,Z=6,pt=(Ja,ei,ti)=>Math.max(Ja,Math.min(ei,ti)),mt,gt,It;u==="top"||u==="bottom"?(mt=u==="top"?e.top-p-n:e.bottom+n,gt=pt(0,r-d,C-d/2),It=pt(Z,d-Z*2,C-gt-Z)):(gt=u==="left"?e.left-d-n:e.right+n,mt=pt(0,i-p,$-p/2),It=pt(Z,p-Z*2,$-mt-Z)),this._tooltipTop=mt,this._tooltipLeft=gt,this._arrowOffset=It,this._computedPlacement=u}showTooltip(){P.activeTooltip&&P.activeTooltip!==this&&(P.activeTooltip.closeOverlay(),P.activeTooltip.tooltipVisible=!1,P.activeTooltip.requestUpdate()),P.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){P.activeTooltip===this&&(P.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?be`<merch-icon
    ...
    `);Ye=P;customElements.define("mas-mnemonic",Ye)});import{LitElement as to}from"./lit-all.min.js";import{css as br,unsafeCSS as xr}from"./lit-all.min.js";var w="(max-width: 767px)",T="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",L="(min-width: 1600px)",vr={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${L})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=vr;function ut(){return vr.isDesktop}var yr=br`
    :host {
...
`,wr=()=>[br`
        ...
        `];import{LitElement as di,html as kr,css as hi}from"./lit-all.min.js";function pi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var ye=class extends di{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(pi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Ht())}e.remove()})}render(){let{href:t}=this;return t?kr`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(ye,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(ye,"styles",hi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",ye);var vo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),xo=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var we=2e4;var y='span[is="inline-price"][data-wcs-osi]',K='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var mi='a[is="upt-link"]',Sr=`${y},${K},${mi}`;var Cr="merch-offer-select:ready",Ar="merch-card:action-menu-toggle";var N="merch-quantity-selector:change",Tr="merch-card-quantity:change",qt="merch-modal:addon-and-quantity-update";var Ee="merch-card-collection:literals-changed";var ke="aem:load",Se="aem:error",ft="mas:ready",Lr="mas:error",zr="placeholder-failed",_r="placeholder-pending",Pr="placeholder-resolved";var Mr="mas:failed",J="mas:resolved",Rr="mas/commerce";var ee="failed",se="pending",te="resolved";var vt="X-Request-Id",bo=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var yo=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var xt=":start",bt=":duration";var M="legal",Or="mas-ff-defaults";var gi="mas-commerce-service";function Dr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function z(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function Ce(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function Ut(){return window.matchMedia("(max-width: 1024px)").matches}function le(){return document.getElementsByTagName(gi)?.[0]}function Ke(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Qe,de,Xe,Ze,Ae,yt=class extends HTMLElement{constructor(){super();f(this,Qe,"");f(this,de);f(this,Xe,[]);f(this,Ze,[]);f(this,Ae);m(this,Ae,Dr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,de)?this.parentElement.style.borderRadius=s(this,de):s(this,de)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Xe).map((r,i)=>{let n=s(this,Ze)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,Qe)}, ${e})`}connectedCallback(){s(this,Ae).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,de,i?.trim()),e==="colors"&&i?m(this,Xe,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,Ze,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Qe,i?.trim()??""),s(this,Ae).call(this)}};Qe=new WeakMap,de=new WeakMap,Xe=new WeakMap,Ze=new WeakMap,Ae=new WeakMap;customElements.define("merch-gradient",yt);import{LitElement as ui,html as fi,css as vi}from"./lit-all.min.js";var Te=class extends ui{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(J,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(J,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return fi` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(Te,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),h(Te,"styles",vi`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as et,css as yi}from"./lit-all.min.js";var Ir=`
:root {
...
`;var kt=class extends b{constructor(t){super(t)}getGlobalCSS(){return Br}renderLayout(){return Hr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Hr`<hr />`} ${this.secureLabelFooter}`}};import{html as re,css as wi,unsafeCSS as Ur}from"./lit-all.min.js";var qr=`
  :root {
...
`;var Ei=32,Gr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},_e=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?re`<slot name="secure-transaction-label">
    ...
    `);import{html as St,css as ki,unsafeCSS as Vr,nothing as Si}from"./lit-all.min.js";var jr=`
  :root {
...
`;var Ci=32,Wr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Pe=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>St` <footer>
    ...
    `);import{html as tt,css as Ai,nothing as Ct}from"./lit-all.min.js";var Yr=`
:root {
...
`;var At={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Kr={...function(){let{whatsIncluded:a,size:t,...e}=At;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Qr={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=At;return i}()},G,j,R=class extends b{constructor(e){super(e);f(this,G);f(this,j);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Yr}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(c)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&l){if(d)l.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(l):p.appendChild(l)}return}if(i&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!l){let u=d.cloneNode(!0);o.prepend(u)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,G)||(m(this,G,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,G)?.disconnect(),m(this,G,null),this.syncHeights())})),s(this,G).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=Ke(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(d+=Ke(g));let u=this.card.querySelector('[slot="heading-m"]');u&&(d+=8+Ke(u));for(let $ of r.childNodes){if($.classList.contains("spacer"))break;d+=Ke($)}let C=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(C)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?tt`<div class="divider"></div>`:Ct}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?tt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};G=new WeakMap,j=new WeakMap,h(R,"variantStyle",Ai`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?Q`
        ...
        `:Q`
            ...
            <slot></slot>`}};h(ae,"variantStyle",Ti`
...
`;var ta={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},V,Me=class extends b{constructor(e){super(e);f(this,V);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return ea}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return jt` ${this.badge}
    ...
    `);import{html as Vt,css as zi}from"./lit-all.min.js";var ra=`
:root {
...
`;var aa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Re=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ra}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Vt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as _i,css as Pi}from"./lit-all.min.js";var ia=`
...
`;var na={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Oe=class extends b{constructor(t){super(t)}getGlobalCSS(){return ia}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return _i`
    ...
    `);import{html as Wt,css as Mi}from"./lit-all.min.js";var oa=`
:root {
...
`;var ca={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},De=class extends b{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return oa}renderLayout(){return Wt`${this.cardImage}
            ...
            ${this.evergreen?Wt`
                  ...
                  `:Wt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(De,"variantStyle",Mi`
    ...
    `);import{html as la,css as Ri,nothing as Oi}from"./lit-all.min.js";var sa=`
:root {
...
`;var Yt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ne=class extends b{getGlobalCSS(){return sa}get aemFragmentMapping(){return Yt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')?la`<div class="badge-wrapper">
    ...
    `);import{html as ha,css as Di,nothing as Ni}from"./lit-all.min.js";var da=`
:root {
...
`;var Kt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Fe=class extends b{getGlobalCSS(){return da}get aemFragmentMapping(){return Kt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')?ha`<div class="badge-wrapper">
    ...
    `);import{html as Qt,css as Fi,nothing as Ii}from"./lit-all.min.js";var pa=`
...
`;var Xt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Be=class extends b{getGlobalCSS(){return fa}get aemFragmentMapping(){return Xt}renderLayout(){return qi`
    ...
    `);var Lt=new Map,va=new WeakMap,xa=new Map,k=(a,t,e=null,r=null,i)=>{Lt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",ze,Fr,ze.variantStyle);k("image",he);k("inline-heading",kt);k("mini-compare-chart",_e,Gr,_e.variantStyle);k("mini-compare-chart-mweb",Pe,Wr,Pe.variantStyle);k("plans",R,At,R.variantStyle,R.collectionOptions);k("plans-students",R,Qr,R.variantStyle,R.collectionOptions);k("plans-education",R,Kr,R.variantStyle,R.collectionOptions);k("plans-v2",ae,Jr,ae.variantStyle,ae.collectionOptions);k("product",Me,ta,Me.variantStyle);k("segment",Re,aa,Re.variantStyle);k("media",Oe,na,Oe.variantStyle);k("headless",Ie,ma,Ie.variantStyle);k("special-offers",De,ca,De.variantStyle);k("simplified-pricing-express",Ne,Yt,Ne.variantStyle);k("full-pricing-express",Fe,Kt,Fe.variantStyle);k("mini",$e,ua,$e.variantStyle);k("image",he,$r,he.variantStyle);k("fries",Be,Xt,Be.variantStyle);var Gi=(a,t,e)=>{try{let r=xa.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),xa.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Zt=a=>{let t=Lt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=va.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?Gi(a,r,i):{};return va.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Et(a){return Lt.get(a)?.fragmentMapping}function ba(a){return Lt.get(a)?.collectionOptions}var ya=document.createElement("style");ya.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var pe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ea=1e3;function Wi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ka(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!pe.serializableTypes.includes(e))return e}return a}function Yi(a,t){if(!pe.ignoredProperties.includes(a))return ka(t)}var er={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(Wi(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(ka).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${pe.delimiter}page=${o}${c}`;l.length>Ea&&(l=`${l.slice(0,Ea)}<trunc>`),n+=l,i.length&&(n+=`${pe.delimiter}facts=`,n+=JSON.stringify(i,Yi)),window.lana?.log(n,pe)}};function Sa(a){Object.assign(pe,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in pe&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Ca={LOCAL:"local",PROD:"prod",STAGE:"stage"},tr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},rr=new Set,ar=new Set,Aa=new Map,Ta={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},La={filter:({level:a})=>a!==tr.DEBUG},Ki={filter:()=>!1};function Qi(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&_t(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Xi(a){[...ar].every(t=>t(a))&&rr.forEach(t=>t(a))}function za(a){let t=(Aa.get(a)??0)+1;Aa.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>za(`${r.namespace}/${i}`),updateConfig:Sa};return Object.values(tr).forEach(i=>{r[i]=(n,...o)=>Xi(Qi(i,n,a,o,e))}),Object.seal(r)}function Pt(...a){a.forEach(t=>{let{append:e,filter:r}=t;_t(r)&&ar.add(r),_t(e)&&rr.add(e)})}function Zi(a={}){let{name:t}=a,e=wa(zt("commerce.debug",{search:!0,storage:!0}),t===Ca.LOCAL);return Pt(e?Ta:La),t===Ca.PROD&&Pt(er),rt}function Ji(){rr.clear(),ar.clear()}var rt={...za(Rr),Level:tr,Plugins:{consoleAppender:Ta,debugFilter:La,quietFilter:Ki,lanaAppender:er},init:Zi,reset:Ji,use:Pt};var en="mas-commerce-service",zl=rt.module("utilities"),tn={requestId:vt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Mt=a=>window.setTimeout(a);function ir(){return document.getElementsByTagName(en)?.[0]}function _a(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(tn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Pa(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var rn="explicit_empty";function nr(a){return a===rn}function an(a){return Array.isArray(a)&&a.length===1&&nr(a[0])}function Ma(a,t=[]){if(an(t))return a?[]:"";if(a)return t.map(r=>nr(r)?"":r);let e=t[0];return nr(e)?"":e}var Ra="fragment",Oa="author",Da="preview",Na="loading",Fa="timeout",or="aem-fragment",Ia="eager",$a="cache",nn=[Ia,$a],W,me,B,cr=class{constructor(){f(this,W,new Map);f(this,me,new Map);f(this,B,new Map)}clear(){s(this,W).clear(),s(this,me).clear(),s(this,B).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,W).set(t.id,t),t.fields?.originalId&&s(this,W).set(t.fields.originalId,t),s(this,B).has(t.id)){let[,r]=s(this,B).get(t.id);r()}if(s(this,B).has(t.fields?.originalId)){let[,r]=s(this,B).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,W).has(t)}entries(){return s(this,W).entries()}get(t){return s(this,W).get(t)}getAsPromise(t){let[e]=s(this,B).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,B).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,me).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,me).set(t,e)),e}remove(t){s(this,W).delete(t),s(this,me).delete(t),s(this,B).delete(t)}};W=new WeakMap,me=new WeakMap,B=new WeakMap;var ne=new cr,He,H,X,D,O,A,at,it,q,nt,ot,qe,U,Ba,Ha,sr,qa,Rt=class extends HTMLElement{constructor(){super(...arguments);f(this,U);h(this,"cache",ne);f(this,He);f(this,H,null);f(this,X,null);f(this,D,null);f(this,O);f(this,A);f(this,at,Ia);f(this,it,5e3);f(this,q);f(this,nt,!1);f(this,ot,0);f(this,qe)}static get observedAttributes(){return[Ra,Na,Fa,Oa,Da]}attributeChangedCallback(e,r,i){e===Ra&&(m(this,O,i),m(this,A,ne.getFetchInfo(i))),e===Na&&nn.includes(i)&&m(this,at,i),e===Fa&&m(this,it,parseInt(i,10)),e===Oa&&m(this,nt,["","true"].includes(i)),e===Da&&m(this,qe,i)}connectedCallback(){if(!s(this,q)){if(s(this,D)??m(this,D,le(this)),m(this,qe,s(this,D).settings?.preview),s(this,He)??m(this,He,s(this,D).log.module(`${or}[${s(this,O)}]`)),!s(this,O)||s(this,O)==="#"){s(this,A)??m(this,A,ne.getFetchInfo("missing-fragment-id")),_(this,U,sr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,A)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&ne.remove(s(this,O)),s(this,at)===$a&&await Promise.race([ne.getAsPromise(s(this,O)),new Promise(c=>setTimeout(c,s(this,it)))]);try{m(this,q,_(this,U,qa).call(this)),await s(this,q)}catch(c){return _(this,U,sr).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,H)||{};return o&&!zt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ke,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,A)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,X)?s(this,X):(s(this,nt)?this.transformAuthorData():this.transformPublishData(),s(this,X))}get rawData(){return s(this,H)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:d={}}=s(this,H);m(this,X,e.reduce((p,{name:g,multiple:u,values:C})=>(p.fields[g]=Ma(u,C),p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:d,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:d}=s(this,H);m(this,X,Object.entries(e).reduce((p,[g,u])=>(p.fields[g]=u?.mimeType?u.value:u??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),i={locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,D).settings.instant;return n&&(i.instant=n),await r(s(this,O),i)}};He=new WeakMap,H=new WeakMap,X=new WeakMap,D=new WeakMap,O=new WeakMap,A=new WeakMap,at=new WeakMap,it=new WeakMap,q=new WeakMap,nt=new WeakMap,ot=new WeakMap,qe=new WeakMap,U=new WeakSet,Ba=async function(e){fr(this,ot)._++;let r=`${or}:${s(this,O)}:${s(this,ot)}`,i=`${r}${xt}`,n=`${r}${bt}`;if(s(this,qe)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new ie(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,A).stale=!1,s(this,A).url=e,o=await Pa(e,{cache:"default",credentials:"omit"}),_(this,U,Ha).call(this,o),s(this,A).status=o?.status,s(this,A).measure=Ce(performance.measure(n,i)),s(this,A).retryCount=o.retryCount,!o?.ok)throw new ie("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,A).measure=Ce(performance.measure(n,i)),s(this,A).retryCount=c.retryCount,s(this,H))return s(this,A).stale=!0,s(this,He).error("Serving stale data",s(this,A)),s(this,H);let l=c.message??"unknown";throw new ie(`Failed to fetch fragment: ${l}`,{})}},Ha=function(e){Object.assign(s(this,A),_a(e))},sr=function(e){m(this,q,null),s(this,A).message=e,this.classList.add("error");let r={...s(this,A),...s(this,D).duration};s(this,He).error(e,r),this.dispatchEvent(new CustomEvent(Se,{detail:r,bubbles:!0,composed:!0}))},qa=async function(){var l;this.classList.remove("error"),m(this,X,null);let e=ne.get(s(this,O));if(e)return m(this,H,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,O)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await _(this,U,Ba).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,O)),ne.add(e),m(this,H,e),!0},h(Rt,"cache",ne);customElements.define(or,Rt);import{LitElement as on,html as lr,css as cn,nothing as sn}from"./lit-all.min.js";import{unsafeHTML as ln}from"./lit-all.min.js";var dn=a=>a?a.startsWith("sp-icon-")?lr`${ln(`<${a} class="badge-icon"></${a}>`)}`:lr`<img src="${a}" class="badge-icon" />`:sn,Ue=class extends on{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return lr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Ue);import{html as hn,css as pn,LitElement as mn}from"./lit-all.min.js";var ct=class extends mn{constructor(){super()}render(){return hn`
            <slot name="icon"></slot>
    ...
    `),h(ct,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ct);import{html as dr,css as gn,LitElement as un,nothing as Ua}from"./lit-all.min.js";var st=class extends un{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return dr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?dr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:Ua}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(st,"styles",gn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

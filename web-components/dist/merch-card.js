var br=Object.defineProperty;var yr=i=>{throw TypeError(i)};var pa=(i,t,e)=>t in i?br(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var ma=(i,t)=>()=>(i&&(t=i(i=0)),t);var ga=(i,t)=>{for(var e in t)br(i,e,{get:t[e],enumerable:!0})};var h=(i,t,e)=>pa(i,typeof t!="symbol"?t+"":t,e),Ht=(i,t,e)=>t.has(i)||yr("Cannot "+e);var l=(i,t,e)=>(Ht(i,t,"read from private field"),e?e.call(i):t.get(i)),f=(i,t,e)=>t.has(i)?yr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),g=(i,t,e,r)=>(Ht(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),_=(i,t,e)=>(Ht(i,t,"access private method"),e);var wr=(i,t,e,r)=>({set _(a){g(i,t,a,e)},get _(){return l(i,t,r)}});var qt={};ga(qt,{default:()=>Xe});import{LitElement as ua,html as we,css as fa,nothing as va}from"./lit-all.min.js";import{unsafeHTML as Tr}from"./lit-all.min.js";import{ifDefined as xa}from"./lit-all.min.js";function ba(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var M,Xe,Ut=ma(()=>{M=class M extends ua{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();M.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,a=window.innerHeight,n=14,o=200,c=60,s=this.shadowRoot?.querySelector(".css-tooltip-body"),d=s?s.offsetWidth:o,p=s?s.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>a?u="top":u==="left"&&e.left-d-n<0?u="right":u==="right"&&e.right+d+n>r&&(u="left");let y=e.left+e.width/2,L=e.top+e.height/2,F=6,ye=(la,da,ha)=>Math.max(la,Math.min(da,ha)),Qe,ut,Bt;u==="top"||u==="bottom"?(Qe=u==="top"?e.top-p-n:e.bottom+n,ut=ye(0,r-d,y-d/2),Bt=ye(F,d-F*2,y-ut-F)):(ut=u==="left"?e.left-d-n:e.right+n,Qe=ye(0,a-p,L-p/2),Bt=ye(F,p-F*2,L-Qe-F)),this._tooltipTop=Qe,this._tooltipLeft=ut,this._arrowOffset=Bt,this._computedPlacement=u}showTooltip(){M.activeTooltip&&M.activeTooltip!==this&&(M.activeTooltip.closeOverlay(),M.activeTooltip.tooltipVisible=!1,M.activeTooltip.requestUpdate()),M.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){M.activeTooltip===this&&(M.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?we`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:we`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return we`<span class="icon-only">${this.renderIcon()}</span>`;if(ba())return we`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let a=t.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:m=>{this.lastPointerType=m.pointerType},pointerenter:m=>m.pointerType!=="touch"&&this.showTooltip(),pointerleave:m=>m.pointerType!=="touch"&&this.hideTooltip(),click:m=>{this.lastPointerType==="touch"&&this.handleTap(m),this.lastPointerType=null}},c=this._computedPlacement,s=c==="top"||c==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=s?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return we`
            <span
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${xa(d)}>
                    ${Tr(t)}
        ...
        `}};h(M,"activeTooltip",null),h(M,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"},mnemonicText:{type:String,attribute:"mnemonic-text"},mnemonicPlacement:{type:String,attribute:"mnemonic-placement"},smartPlacement:{type:Boolean,attribute:"smart-placement"},tooltipVisible:{type:Boolean,state:!0},_tooltipTop:{type:Number,state:!0},_tooltipLeft:{type:Number,state:!0},_arrowOffset:{type:Number,state:!0},_computedPlacement:{type:String,state:!0}}),h(M,"styles",fa`
        :host {
            display: contents;
            overflow: visible;
        }
    ...
    `);Xe=M;customElements.define("mas-mnemonic",Xe)});import{LitElement as Co}from"./lit-all.min.js";import{css as Sr,unsafeCSS as kr}from"./lit-all.min.js";var E="(max-width: 767px)",T="(max-width: 1199px)",k="(min-width: 768px)",v="(min-width: 1200px)",z="(min-width: 1600px)",Er={matchMobile:window.matchMedia(E),matchDesktop:window.matchMedia(`${v} and (not ${z})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(z),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Er;function ft(){return Er.isDesktop}var Cr=Sr`
    :host {
...
`,Ar=()=>[Sr`
        ...
        `];import{LitElement as ya,html as Lr,css as wa}from"./lit-all.min.js";function Ea(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Ee=class extends ya{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Ea())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Ut())}e.remove()})}render(){let{href:t}=this;return t?Lr`<a href="${t}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(Ee,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(Ee,"styles",wa`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Ee);var Gt=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),J=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var ke=2e4;var w='span[is="inline-price"][data-wcs-osi]',Q='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var ka='a[is="upt-link"]',zr=`${w},${Q},${ka}`;var Pr="merch-offer-select:ready",_r="merch-card:action-menu-toggle";var I="merch-quantity-selector:change",Mr="merch-card-quantity:change",Vt="merch-modal:addon-and-quantity-update";var Se="merch-card-collection:literals-changed";var Ce="aem:load",Ae="aem:error",vt="mas:ready",Rr="mas:error",Nr="placeholder-failed",Dr="placeholder-pending",Or="placeholder-resolved";var Fr="mas:failed",ee="mas:resolved",Ir="mas/commerce";var te="failed",le="pending",re="resolved";var xt="X-Request-Id",Uo=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Go=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var bt=":start",yt=":duration";var R="legal",$r="mas-ff-defaults";var wt="[[promo-saved-amount]]";var Sa="mas-commerce-service";function Br(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function P(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function Te(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function jt(){return window.matchMedia("(max-width: 1024px)").matches}function de(){return document.getElementsByTagName(Sa)?.[0]}function Ze(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}function Hr(i){let t=i.nextElementSibling?.nodeName==="BR"?i.nextElementSibling.nextElementSibling:i.nextElementSibling;return i.dataset.template==="strikethrough"&&(i.nextSibling?.nodeName!=="#text"||i.nextSibling.textContent.trim().length<2)&&t?.isInlinePrice&&t?.dataset?.template==="price"}var Je,he,et,tt,Le,Et=class extends HTMLElement{constructor(){super();f(this,Je,"");f(this,he);f(this,et,[]);f(this,tt,[]);f(this,Le);g(this,Le,Br(()=>{this.isConnected&&(this.parentElement.style.background=this.value,l(this,he)?this.parentElement.style.borderRadius=l(this,he):l(this,he)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=l(this,et).map((r,a)=>{let n=l(this,tt)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${l(this,Je)}, ${e})`}connectedCallback(){l(this,Le).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&g(this,he,a?.trim()),e==="colors"&&a?g(this,et,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?g(this,tt,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&g(this,Je,a?.trim()??""),l(this,Le).call(this)}};Je=new WeakMap,he=new WeakMap,et=new WeakMap,tt=new WeakMap,Le=new WeakMap;customElements.define("merch-gradient",Et);import{LitElement as Ca,html as Aa,css as Ta}from"./lit-all.min.js";var ze=class extends Ca{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${w}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(ee,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(ee,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Aa` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(ze,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),h(ze,"styles",Ta`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",ze);import{html as kt,nothing as La}from"./lit-all.min.js";var Pe,rt=class rt{constructor(t){h(this,"card");f(this,Pe);this.card=t,this.insertVariantStyle()}getContainer(){return g(this,Pe,l(this,Pe)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),l(this,Pe)}insertVariantStyle(){let t=this.constructor.name;if(!rt.styleMap[t]){rt.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;a>o&&n.style.setProperty(r,`${a}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let r=this.card.variant,a=Array.from(e.querySelectorAll(`merch-card[variant="${r}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:o}of t){let c=`--consonant-merch-card-${r}-${o}-height`;e.style.getPropertyValue(c)&&e.style.removeProperty(c)}let n=new Map;for(let o of a){let c=o.getBoundingClientRect();if(c.width<=2)continue;let s=Math.round(c.top),d=n.get(s);d||(d=[],n.set(s,d)),d.push(o)}for(let o of n.values())for(let{name:c,getElement:s}of t){let d=`--consonant-merch-card-${r}-${c}-height`,p=0,m=[];for(let u of o){u.style.removeProperty(d);let y=s(u);if(!y){m.push({card:u,height:0});continue}let L=Math.max(0,parseInt(window.getComputedStyle(y).height)||0);m.push({card:u,height:L}),L>p&&(p=L)}if(!(p<=0))for(let{card:u}of m)u.style.setProperty(d,`${p}px`)}}get legalDisplayDot(){return!0}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),kt`
            <div
                id="badge"
        ...
        `}get cardImage(){return kt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:La}get secureLabelFooter(){return kt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let t=Promise.allSettled(this.card.prices.map(a=>a.onceSettled?.()||Promise.resolve())),e,r=new Promise(a=>{e=setTimeout(a,ke)});await Promise.race([t,r]),clearTimeout(e)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return St(this.card.variant)}};Pe=new WeakMap,h(rt,"styleMap",{});var b=rt;import{html as Wt,css as za}from"./lit-all.min.js";var qr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as it,css as Pa}from"./lit-all.min.js";var Gr=`
:root {
...
`;var Ct=class extends b{constructor(t){super(t)}getGlobalCSS(){return jr}renderLayout(){return Wr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Wr`<hr />`} ${this.secureLabelFooter}`}};import{html as ie,css as _a,unsafeCSS as Kr}from"./lit-all.min.js";var Yr=`
  :root {
...
`;var Ma=32,Qr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Me=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ie`<slot name="secure-transaction-label">
    ...
    `);import{html as At,css as Ra,unsafeCSS as Zr,nothing as Na}from"./lit-all.min.js";var Xr=`
  :root {
...
`;var Da=32,Jr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Re=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>At` <footer>
        ...
        </footer>`);h(this,"getMiniCompareFooterRows",()=>At` <div class="footer-rows-container">
            <slot name="body-xs"></slot>
            <slot name="footer-rows"></slot>
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(I,this.updatePriceQuantity)}disconnectedCallbackHook(){this.card.removeEventListener(I,this.updatePriceQuantity),this._syncObserver?.disconnect(),this._syncObserver=null}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}priceOptionsProvider(e,r){if(e.dataset.template===R){r.displayPlanType=this.card?.settings?.displayPlanType??!1;return}(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1)}getGlobalCSS(){return Xr}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2){this._syncObserver||(this._syncObserver=new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(this._syncObserver?.disconnect(),this._syncObserver=null,this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}),this._syncObserver.observe(this.card));return}["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs","footer-rows"].forEach(r=>{let n=this.card.querySelector(`[slot="${r}"]`)??this.card.shadowRoot.querySelector(`slot[name="${r}"]`);this.updateCardElementMinHeight(n,r)}),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="promo-text"]'),"promo-text"),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,a)=>{let n=Math.max(Da,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let a=r.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&r.remove()})}setupToggle(){if(this.toggleSetupDone)return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("p"),a=e.querySelector("ul");if(!r||!a||e.querySelector(".footer-rows-title"))return;this.toggleSetupDone=!0;let n=r.textContent.trim(),o=this.card.querySelector("h3")?.id,c=o?`${o}-list`:`mweb-list-${Date.now()}`;a.setAttribute("id",c),a.classList.add("checkmark-copy-container");let s=P("div",{class:"footer-rows-title"},n);if(x.isMobile){let d=P("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":c});s.appendChild(d),s.addEventListener("click",()=>{let p=a.classList.toggle("open");d.classList.toggle("expanded",p),d.setAttribute("aria-expanded",String(p))})}else a.classList.add("open");r.replaceWith(s)}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${w}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayPerUnit&&(e.dataset.displayPerUnit="false"),e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),e.parentNode.insertBefore(r,e.nextSibling),await r.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Na:At`<slot name="icons"></slot>`}renderLayout(){return At`
            ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="badge"></slot>
    ...
    `);import{html as at,css as Oa,nothing as Tt}from"./lit-all.min.js";var ei=`
:root {
...
`;var Lt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ti={...function(){let{whatsIncluded:i,size:t,...e}=Lt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},ri={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=Lt;return a}()},V,j,N=class extends b{constructor(e){super(e);f(this,V);f(this,j);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===R&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ei}adjustSlotPlacement(e,r,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let s=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(c)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!a&&s){if(d)s.remove();else{let m=p.querySelector(`[data-placeholder-for="${e}"]`);m?m.replaceWith(s):p.appendChild(s)}return}if(a&&d){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",e),m.classList.add("slot-placeholder"),!s){let u=d.cloneNode(!0);o.prepend(u)}d.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){l(this,V)||(g(this,V,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(l(this,V)?.disconnect(),g(this,V,null),this.syncHeights())})),l(this,V).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:a=>a.querySelector(`[slot="${r}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let a=r.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let c=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=Ze(p));let m=this.card.querySelector('[slot="subtitle"]');m&&(d+=Ze(m));let u=this.card.querySelector('[slot="heading-m"]');u&&(d+=8+Ze(u));for(let L of r.childNodes){if(L.classList.contains("spacer"))break;d+=Ze(L)}let y=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(y)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${w}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?at`<div class="divider"></div>`:Tt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`);r&&e.push(r);let a=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let a=r.value?.[0]?.planType;a&&(e.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?at`<label id="stock-checkbox">
                <input type="checkbox" @change=${this.card.toggleStockOffer}></input>
                <span></span>
                ${this.card.checkboxLabel}
            </label>`:Tt}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Tt:at`<slot name="icons"></slot>`}connectedCallbackHook(){x.matchMobile.addEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.addEventListener("change",this.adaptForMedia),this.handleResize=()=>{l(this,j)&&cancelAnimationFrame(l(this,j)),g(this,j,requestAnimationFrame(()=>{g(this,j,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))},window.addEventListener("resize",this.handleResize)}disconnectedCallbackHook(){x.matchMobile.removeEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.removeEventListener("change",this.adaptForMedia),l(this,V)?.disconnect(),g(this,V,null),this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),l(this,j)&&(cancelAnimationFrame(l(this,j)),g(this,j,null))}renderLayout(){return at` ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="heading-xs"></slot>
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};V=new WeakMap,j=new WeakMap,h(N,"variantStyle",Oa`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),h(N,"collectionOptions",{customHeaderArea:e=>e.sidenav?at`<slot name="resultsText"></slot>`:Tt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let r=()=>{let a=e.querySelectorAll("merch-card");for(let o of a)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of a){if(o.style.display==="none")continue;let c=o.getAttribute("size"),s=c==="wide"?2:c==="super-wide"?3:1;s===2&&n%3===2&&(o.setAttribute("data-size",c),o.removeAttribute("size"),s=1),n+=s}};x.matchDesktop.addEventListener("change",r),e.addEventListener(Se,r),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",r),e.removeEventListener(Se,r)})}});import{html as X,css as Fa,unsafeCSS as ai,nothing as zt}from"./lit-all.min.js";var ii=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?X`
        ...
        `:X`
            ...
            `:zt}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?X`<slot name="icons"></slot>`:zt}get secureLabelFooter(){return X`<footer>
            ...
            <slot></slot>`}};h(ae,"variantStyle",Fa`
    ...
    `),h(ae,"collectionOptions",{customHeaderArea:t=>t.sidenav?X`<slot name="resultsText"></slot>`:zt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let e=()=>{let r=t.querySelectorAll("merch-card");if(r.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!x.isDesktop)return;let a=0;r.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),c=o==="wide"?2:o==="super-wide"?3:1;c===2&&a%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),c=1),a+=c})};x.matchDesktop.addEventListener("change",e),t.addEventListener(Se,e),t.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",e),t.removeEventListener(Se,e)})}});import{html as Yt,css as Ia}from"./lit-all.min.js";var oi=`
:root {
...
`;var ci={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},W,Ne=class extends b{constructor(e){super(e);f(this,W);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return oi}priceOptionsProvider(e,r){e.dataset.template===R&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Yt` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){this.handleResize=()=>{l(this,W)&&cancelAnimationFrame(l(this,W)),g(this,W,requestAnimationFrame(()=>{g(this,W,null),this.postCardUpdateHook()}))},window.addEventListener("resize",this.handleResize),this.card.addEventListener(I,this.updatePriceQuantity)}disconnectedCallbackHook(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),l(this,W)&&(cancelAnimationFrame(l(this,W)),g(this,W,null)),this.card.removeEventListener(I,this.updatePriceQuantity)}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),x.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayPerUnit&&(e.dataset.displayPerUnit="false"),e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),e.parentNode.insertBefore(r,e.nextSibling),await r.onceSettled()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}toggleAddon(e){let r=this.mainPrice,a=this.headingXSSlot;if(!r&&a){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(c=>c.remove()),e.checked){if(o){let c=P("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},o.innerHTML);this.card.appendChild(c)}}else{let c=P("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(c)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,a=this.card.planType;r&&(await r.onceSettled(),a=r.value?.[0]?.planType),a&&(e.planType=a)}};W=new WeakMap,h(Ne,"variantStyle",Ia`
    ...
    `);import{html as Kt,css as $a}from"./lit-all.min.js";var si=`
:root {
...
`;var li={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},De=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===R&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return si}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Kt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Ba,css as Ha}from"./lit-all.min.js";var di=`
...
`;var hi={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Oe=class extends b{constructor(t){super(t)}getGlobalCSS(){return di}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Ba`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as Qt,css as qa}from"./lit-all.min.js";var pi=`
:root {
...
`;var mi={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Fe=class extends b{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return pi}renderLayout(){return Qt`${this.cardImage}
            ...
            ${this.evergreen?Qt`
                  ...
                  `:Qt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(Fe,"variantStyle",qa`
    ...
    `);import{html as Ua,css as Ga}from"./lit-all.min.js";var gi=`
:root {
...
`;var Xt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ie=class extends b{getGlobalCSS(){return gi}get aemFragmentMapping(){return Xt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;if(!t)return;["header","price-container","cta"].forEach(a=>this.updateCardElementMinHeight(t.querySelector(`.${a}`),a));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",c)})}),x.isDesktopOrUp&&e.forEach(a=>a.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!ft()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let t=this.getContainer();t&&t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t<=2||t===this.lastSyncedWidth||(this.lastSyncedWidth=t,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(ft())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};e();let r=window.matchMedia(E);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(E).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||ft())return;let a=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",a)}renderLayout(){return Ua`
            <div
                class="badge-wrapper"
    ...
    `);import{html as fi,css as Va}from"./lit-all.min.js";var ui=`
:root {
...
`;var Zt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},$e=class extends b{getGlobalCSS(){return ui}get aemFragmentMapping(){return Zt}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return fi`
    ...
    `);import{html as Jt,css as ja,nothing as Wa}from"./lit-all.min.js";var vi=`
...
`;var xi={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Ya=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Be=class extends b{constructor(t){super(t)}getGlobalCSS(){return vi}renderLayout(){return Jt`
    ...
    `);import{css as Ka,html as Qa}from"./lit-all.min.js";var bi=`
...
`;var yi={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},He=class extends b{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return bi}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Qa`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Xa,css as Za}from"./lit-all.min.js";var wi=`
...
`;var er={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},qe=class extends b{getGlobalCSS(){return wi}get aemFragmentMapping(){return er}renderLayout(){return Xa`
    ...
    `);var Pt=new Map,Ei=new WeakMap,ki=new Map,S=(i,t,e=null,r=null,a)=>{Pt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};S("catalog",_e,Ur,_e.variantStyle);S("image",pe);S("inline-heading",Ct);S("mini-compare-chart",Me,Qr,Me.variantStyle);S("mini-compare-chart-mweb",Re,Jr,Re.variantStyle);S("plans",N,Lt,N.variantStyle,N.collectionOptions);S("plans-students",N,ri,N.variantStyle,N.collectionOptions);S("plans-education",N,ti,N.variantStyle,N.collectionOptions);S("plans-v2",ae,ni,ae.variantStyle,ae.collectionOptions);S("product",Ne,ci,Ne.variantStyle);S("segment",De,li,De.variantStyle);S("media",Oe,hi,Oe.variantStyle);S("headless",Be,xi,Be.variantStyle);S("special-offers",Fe,mi,Fe.variantStyle);S("simplified-pricing-express",Ie,Xt,Ie.variantStyle);S("full-pricing-express",$e,Zt,$e.variantStyle);S("mini",He,yi,He.variantStyle);S("image",pe,Vr,pe.variantStyle);S("fries",qe,er,qe.variantStyle);var Ja=(i,t,e)=>{try{let r=ki.get(i.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ki.set(i.variant,r)),e?.styleSheet&&e.styleSheet!==r){let a=i.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);a!==-1&&i.shadowRoot.adoptedStyleSheets.splice(a,1)}return i.shadowRoot.adoptedStyleSheets.includes(r)||i.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",i.variant);let n=e?.styleElement||i.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),i.shadowRoot.appendChild(a),{styleElement:a}}},tr=i=>{let t=Pt.get(i.variant);if(!t)return;let{class:e,style:r}=t,a=Ei.get(i);if(a?.appliedVariant===i.variant)return new e(i);let n=r?Ja(i,r,a):{};return Ei.set(i,{appliedVariant:i.variant,...n}),new e(i)};function St(i){return Pt.get(i)?.fragmentMapping}function Si(i){return Pt.get(i)?.collectionOptions}var Ci=document.createElement("style");Ci.innerHTML=`
:root {
...
`;document.head.appendChild(Ci);function _t(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=rr(r)?r:i;n=o.get(c)}if(a&&n==null){let o=rr(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=tn(rr(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var en=i=>typeof i=="boolean",Mt=i=>typeof i=="function";var rr=i=>typeof i=="string";function Ai(i,t){if(en(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function tn(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var ne=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(xt);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var me={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ti=1e3;function rn(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Li(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!me.serializableTypes.includes(e))return e}return i}function an(i,t){if(!me.ignoredProperties.includes(i))return Li(t)}var ir={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(d=>{d!=null&&(rn(d)?r:a).push(d)}),r.length&&(n+=` ${r.map(Li).join(" ")}`);let{pathname:o,search:c}=window.location,s=`${me.delimiter}page=${o}${c}`;s.length>Ti&&(s=`${s.slice(0,Ti)}<trunc>`),n+=s,a.length&&(n+=`${me.delimiter}facts=`,n+=JSON.stringify(a,an)),window.lana?.log(n,me)}};function zi(i){Object.assign(me,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in me&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Pi={LOCAL:"local",PROD:"prod",STAGE:"stage"},ar={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},nr=new Set,or=new Set,_i=new Map,Mi={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},Ri={filter:({level:i})=>i!==ar.DEBUG},nn={filter:()=>!1};function on(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&Mt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function cn(i){[...or].every(t=>t(i))&&nr.forEach(t=>t(i))}function Ni(i){let t=(_i.get(i)??0)+1;_i.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>Ni(`${r.namespace}/${a}`),updateConfig:zi};return Object.values(ar).forEach(a=>{r[a]=(n,...o)=>cn(on(a,n,i,o,e))}),Object.seal(r)}function Rt(...i){i.forEach(t=>{let{append:e,filter:r}=t;Mt(r)&&or.add(r),Mt(e)&&nr.add(e)})}function sn(i={}){let{name:t}=i,e=Ai(_t("commerce.debug",{search:!0,storage:!0}),t===Pi.LOCAL);return Rt(e?Mi:Ri),t===Pi.PROD&&Rt(ir),nt}function ln(){nr.clear(),or.clear()}var nt={...Ni(Ir),Level:ar,Plugins:{consoleAppender:Mi,debugFilter:Ri,quietFilter:nn,lanaAppender:ir},init:sn,reset:ln,use:Rt};var dn="mas-commerce-service",Jl=nt.module("utilities"),hn={requestId:xt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Nt=i=>window.setTimeout(i);function cr(){return document.getElementsByTagName(dn)?.[0]}function Di(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(hn)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Oi(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw a}var Fi="fragment",Ii="author",$i="preview",Bi="loading",Hi="timeout",sr="aem-fragment",qi="eager",Ui="cache",pn=[qi,Ui],Y,ge,q,lr=class{constructor(){f(this,Y,new Map);f(this,ge,new Map);f(this,q,new Map)}clear(){l(this,Y).clear(),l(this,ge).clear(),l(this,q).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(l(this,Y).set(t.id,t),t.fields?.originalId&&l(this,Y).set(t.fields.originalId,t),l(this,q).has(t.id)){let[,r]=l(this,q).get(t.id);r()}if(l(this,q).has(t.fields?.originalId)){let[,r]=l(this,q).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return l(this,Y).has(t)}entries(){return l(this,Y).entries()}get(t){return l(this,Y).get(t)}getAsPromise(t){let[e]=l(this,q).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),l(this,q).set(t,[e,r]),e}getFetchInfo(t){let e=l(this,ge).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},l(this,ge).set(t,e)),e}remove(t){l(this,Y).delete(t),l(this,ge).delete(t),l(this,q).delete(t)}};Y=new WeakMap,ge=new WeakMap,q=new WeakMap;var oe=new lr,Ue,$,Z,O,D,A,ot,ct,U,st,lt,Ge,G,Gi,Vi,dr,ji,Dt=class extends HTMLElement{constructor(){super(...arguments);f(this,G);h(this,"cache",oe);f(this,Ue);f(this,$,null);f(this,Z,null);f(this,O,null);f(this,D);f(this,A);f(this,ot,qi);f(this,ct,5e3);f(this,U);f(this,st,!1);f(this,lt,0);f(this,Ge)}static get observedAttributes(){return[Fi,Bi,Hi,Ii,$i]}attributeChangedCallback(e,r,a){e===Fi&&(g(this,D,a),g(this,A,oe.getFetchInfo(a))),e===Bi&&pn.includes(a)&&g(this,ot,a),e===Hi&&g(this,ct,parseInt(a,10)),e===Ii&&g(this,st,["","true"].includes(a)),e===$i&&g(this,Ge,a)}connectedCallback(){if(!l(this,U)){if(l(this,O)??g(this,O,de(this)),g(this,Ge,l(this,O).settings?.preview),l(this,Ue)??g(this,Ue,l(this,O).log.module(`${sr}[${l(this,D)}]`)),!l(this,D)||l(this,D)==="#"){l(this,A)??g(this,A,oe.getFetchInfo("missing-fragment-id")),_(this,G,dr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(l(this,A)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(l(this,U)&&!await Promise.race([l(this,U),Promise.resolve(!1)]))return;e&&oe.remove(l(this,D)),l(this,ot)===Ui&&await Promise.race([oe.getAsPromise(l(this,D)),new Promise(c=>setTimeout(c,l(this,ct)))]);try{g(this,U,_(this,G,ji).call(this)),await l(this,U)}catch(c){return _(this,G,dr).call(this,c.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=l(this,$)||{};return o&&!_t("mas.disableWcsCache")&&l(this,O).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Ce,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...l(this,A)},bubbles:!0,composed:!0})),l(this,U)}get updateComplete(){return l(this,U)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return l(this,Z)?l(this,Z):(l(this,st)?this.transformAuthorData():this.transformPublishData(),l(this,Z))}get rawData(){return l(this,$)}transformAuthorData(){let{fields:e,id:r,tags:a,variationId:n,settings:o={},priceLiterals:c={},dictionary:s={},placeholders:d={}}=l(this,$);g(this,Z,e.reduce((p,{name:m,multiple:u,values:y})=>(p.fields[m]=u?y:y[0],p),{fields:{},id:r,tags:a,settings:o,priceLiterals:c,dictionary:s,placeholders:d,variationId:n}))}transformPublishData(){if(!l(this,$))return;let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:s={},variationId:d}=l(this,$);g(this,Z,Object.entries(e).reduce((p,[m,u])=>(p.fields[m]=u?.mimeType?u.value:u??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:c,placeholders:s,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e),a={locale:l(this,O).settings.locale,apiKey:l(this,O).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??l(this,O).settings.instant;return n&&(a.instant=n),await r(l(this,D),a)}};Ue=new WeakMap,$=new WeakMap,Z=new WeakMap,O=new WeakMap,D=new WeakMap,A=new WeakMap,ot=new WeakMap,ct=new WeakMap,U=new WeakMap,st=new WeakMap,lt=new WeakMap,Ge=new WeakMap,G=new WeakSet,Gi=async function(e){wr(this,lt)._++;let r=`${sr}:${l(this,D)}:${l(this,lt)}`,a=`${r}${bt}`,n=`${r}${yt}`;if(l(this,Ge)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new ne(`Failed to generate preview: ${c.message}`,{})}performance.mark(a);let o;try{if(l(this,A).stale=!1,l(this,A).url=e,o=await Oi(e,{cache:"default",credentials:"omit"}),_(this,G,Vi).call(this,o),l(this,A).status=o?.status,l(this,A).measure=Te(performance.measure(n,a)),l(this,A).retryCount=o.retryCount,!o?.ok)throw new ne("Unexpected fragment response",{response:o,...l(this,O).duration});return await o.json()}catch(c){if(l(this,A).measure=Te(performance.measure(n,a)),l(this,A).retryCount=c.retryCount,l(this,$))return l(this,A).stale=!0,l(this,Ue).error("Serving stale data",l(this,A)),l(this,$);let s=c.message??"unknown";throw new ne(`Failed to fetch fragment: ${s}`,{})}},Vi=function(e){Object.assign(l(this,A),Di(e))},dr=function(e){g(this,U,null),l(this,A).message=e,this.classList.add("error");let r={...l(this,A),...l(this,O).duration};l(this,Ue).error(e,r),this.dispatchEvent(new CustomEvent(Ae,{detail:r,bubbles:!0,composed:!0}))},ji=async function(){var s;this.classList.remove("error"),g(this,Z,null);let e=oe.get(l(this,D));if(e)return g(this,$,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=l(this,O).settings,c=`${r}/fragment?id=${l(this,D)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await _(this,G,Gi).call(this,c),(s=e.fields).originalId??(s.originalId=l(this,D)),oe.add(e),g(this,$,e),!0},h(Dt,"cache",oe);customElements.define(sr,Dt);import{LitElement as mn,html as hr,css as gn,nothing as un}from"./lit-all.min.js";import{unsafeHTML as fn}from"./lit-all.min.js";var vn=i=>i?i.startsWith("sp-icon-")?hr`${fn(`<${i} class="badge-icon"></${i}>`)}`:hr`<img src="${i}" class="badge-icon" />`:un,Ve=class extends mn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return hr`<div class="badge">
            ${vn(this.icon)}<slot>${this.text}</slot>
        </div>`}};h(Ve,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),h(Ve,"styles",gn`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Ve);import{html as xn,css as bn,LitElement as yn}from"./lit-all.min.js";var dt=class extends yn{constructor(){super()}render(){return xn`
            <slot name="icon"></slot>
    ...
    `),h(dt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",dt);import{html as pr,css as wn,LitElement as En,nothing as Wi}from"./lit-all.min.js";var ht=class extends En{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return pr`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?pr`<slot name="content"></slot>`:Wi}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?pr`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Wi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(ht,"styles",wn`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),h(ht,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",ht);var kn={[te]:Nr,[le]:Dr,[re]:Or},Sn={[te]:Fr,[re]:ee},pt,Ot=class{constructor(t){f(this,pt);h(this,"changes",new Map);h(this,"connected",!1);h(this,"error");h(this,"log");h(this,"options");h(this,"promises",[]);h(this,"state",le);h(this,"timer",null);h(this,"value");h(this,"version",0);h(this,"wrapperElement");this.wrapperElement=t,this.log=nt.module("mas-element")}update(){[te,le,re].forEach(t=>{this.wrapperElement.classList.toggle(kn[t],t===this.state)})}notify(){(this.state===re||this.state===te)&&(this.state===re?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===te&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof ne&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Sn[this.state],{bubbles:!0,composed:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){g(this,pt,cr()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return re===r?Promise.resolve(this.wrapperElement):te===r?Promise.reject(t):new Promise((a,n)=>{e.push({resolve:a,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=re,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),Nt(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=te,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...l(this,pt)?.duration}),Nt(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=le,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!cr()||this.timer)return;let{error:e,options:r,state:a,value:n,version:o}=this;this.state=le,this.timer=Nt(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===le&&this.version===o&&(this.state=a,this.error=e,this.value=n,this.update(),this.notify())}catch(s){this.toggleFailed(this.version,s,r)}})}};pt=new WeakMap;function Cn(i){return`https://${i==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var fe,ue=class ue extends HTMLAnchorElement{constructor(){super();h(this,"masElement",new Ot(this));f(this,fe);this.setAttribute("is",ue.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,a){this.masElement.attributeChangedCallback(e,r,a)}connectedCallback(){this.masElement.connectedCallback(),g(this,fe,de()),l(this,fe)&&(this.log=l(this,fe).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),g(this,fe,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=de();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:c,language:s,env:d}=r,p=`locale=${s}_${c}&country=${c}&offer_id=${o.offerId}`,m=this.getAttribute("data-promotion-code");m&&(p+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${Cn(d)}?${p}`,this.masElement.toggleResolved(a,o,r)}catch(o){let c=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(a,c,r),!1}}static createFrom(e){let r=new ue;for(let a of e.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?r.setAttribute("class",a.value.replace("upt-link","").trim()):r.setAttribute(a.name,a.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};fe=new WeakMap,h(ue,"is","upt-link"),h(ue,"tag","a"),h(ue,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var ce=ue;window.customElements.get(ce.is)||window.customElements.define(ce.is,ce,{extends:ce.tag});var An="#000000",mr="#F8D904",Tn="#EAEAEA",Ln="#31A547",zn=/(accent|primary|secondary)(-(outline|link))?/,Pn="mas:product_code/",_n="daa-ll",Ft="daa-lh",Mn=["XL","L","M","S"],gr="...",Rn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function B(i,t,e,r){let a=r[i];if(t[i]&&a){let n={slot:a?.slot,...a?.attributes},o=t[i];if(a.maxCount&&typeof o=="string"){let[s,d]=Jn(o,a.maxCount,a.withSuffix);s!==o&&(n.title=d,o=s)}let c=P(a.tag,n,o);e.append(c)}}function Nn(i,t,e){let a=(i.mnemonicIcon||[]).filter(o=>o).map((o,c)=>({icon:o,alt:i.mnemonicAlt?.[c]??"",link:i.mnemonicLink?.[c]??""}));a?.forEach(({icon:o,alt:c,link:s})=>{if(s&&!/^https?:/.test(s))try{s=new URL(`https://${s}`).href.toString()}catch{s="#"}let d={slot:"icons",src:o,loading:t.loading,size:e?.size??"l"};c&&(d.alt=c),s&&(d.href=s);let p=P("merch-icon",d);t.append(p)});let n=t.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=a?.length?null:"none")}function Dn(i,t,e){if(e.badge?.slot){if(i.badge?.length&&!i.badge?.startsWith("<merch-badge")){let r=mr,a=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,i.borderColor||(a=!0));let n=i.badgeBackgroundColor||r,o=i.borderColor||"";a&&(o=e.badge?.default,i.borderColor=e.badge?.default),i.badge=`<merch-badge variant="${i.variant}" background-color="${n}" border-color="${o}">${i.badge}</merch-badge>`}B("badge",i,t,e)}else i.badge?(t.setAttribute("badge-text",i.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",i.badgeColor||An),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",i.badgeBackgroundColor||mr),t.setAttribute("border-color",i.badgeBackgroundColor||mr)):t.setAttribute("border-color",i.borderColor||Tn)}function On(i,t,e){if(e.trialBadge&&i.trialBadge){if(!i.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&i.trialBadgeBorderColor||Ln;i.trialBadge=`<merch-badge variant="${i.variant}" border-color="${r}">${i.trialBadge}</merch-badge>`}B("trialBadge",i,t,e)}}function Fn(i,t,e){e?.includes(i.size)&&t.setAttribute("size",i.size)}function In(i,t){i.cardName&&t.setAttribute("name",i.cardName)}function $n(i,t,e){i.cardTitle&&(i.cardTitle=je(i.cardTitle)),B("cardTitle",i,t,{cardTitle:e})}function Bn(i,t,e){B("subtitle",i,t,e)}function Hn(i,t,e,r){if(!i.backgroundColor||i.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[i.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[i.backgroundColor]})`),t.setAttribute("background-color",i.backgroundColor)):r?.attribute&&i.backgroundColor&&(t.setAttribute(r.attribute,i.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function qn(i,t,e){let r=e?.borderColor,a="--consonant-merch-card-border-color";if(i.borderColor?.toLowerCase()==="transparent")t.style.setProperty(a,"transparent");else if(i.borderColor&&r){let o=r?.specialValues?.[i.borderColor]?.includes("gradient")||/-gradient/.test(i.borderColor),c=/^spectrum-.*-(plans|special-offers)$/.test(i.borderColor);if(o){t.setAttribute("gradient-border","true");let s=i.borderColor;if(r?.specialValues){for(let[d,p]of Object.entries(r.specialValues))if(p===i.borderColor){s=d;break}}t.setAttribute("border-color",s),t.style.removeProperty(a)}else c?(t.setAttribute("border-color",i.borderColor),t.style.setProperty(a,`var(--${i.borderColor})`)):t.style.setProperty(a,`var(--${i.borderColor})`)}}var Un=new Set(["","default"]);function Gn(i,t,e){let r=e?.whatsIncludedDividerColor,a="--consonant-merch-card-whats-included-divider-color";if(!r)return;let o=(t.querySelector('[slot="footer-rows"] merch-whats-included')??t.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),c=i.whatsIncludedDividerColor!=null?String(i.whatsIncludedDividerColor).trim():"",s=o||c;if(s==null||Un.has(String(s).trim().toLowerCase())){t.removeAttribute("whats-included-divider-color"),t.style.removeProperty(a);return}let d=String(s).trim();if(d.toLowerCase()==="transparent"){t.removeAttribute("whats-included-divider-color"),t.style.setProperty(a,"transparent");return}let m=r.specialValues?.[d]?.includes("gradient")||/-gradient/.test(d)||/^gradient-/.test(d),u=/^spectrum-.*-(plans|special-offers)$/.test(d);if(m){let y=d;if(r.specialValues){for(let[L,F]of Object.entries(r.specialValues))if(F===d){y=L;break}}t.setAttribute("whats-included-divider-color",y),t.style.removeProperty(a)}else u?(t.setAttribute("whats-included-divider-color",d),t.style.setProperty(a,`var(--${d})`)):(t.removeAttribute("whats-included-divider-color"),t.style.setProperty(a,`var(--${d})`))}function Vn(i,t,e){if(i.backgroundImage){let r={loading:t.loading??"lazy",src:i.backgroundImage};if(i.backgroundImageAltText?r.alt=i.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,i.backgroundImage);return}t.append(P(e.tag,{slot:e.slot},P("img",r)))}}function je(i){return!i||typeof i!="string"||i.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(Ut(),qt)).catch(console.error),i}function jn(i,t,e){i.prices&&(i.prices=je(i.prices)),B("prices",i,t,e)}function Ki(i,t,e){let r=i.hasAttribute("data-wcs-osi")&&!!i.getAttribute("data-wcs-osi"),a=i.className||"",n=zn.exec(a)?.[0]??"accent",o=n.includes("accent"),c=n.includes("primary"),s=n.includes("secondary"),d=n.includes("-outline"),p=n.includes("-link");i.classList.remove("accent","primary","secondary");let m;if(t.consonant)m=io(i,o,r,p,c,s,e?.ctas?.size);else if(p)m=i;else{let u;o?u="accent":c?u="primary":s&&(u="secondary"),m=t.spectrum==="swc"?ro(i,e,d,u,r):to(i,e,d,u,r)}return m}function Wn(i,t){let{slot:e}=t?.description,r=i.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(a=>{let n=Ki(a,i,t);a.replaceWith(n)})}function Yn(i,t,e,r){i.description&&(i.description=je(i.description)),i.promoText&&(i.promoText=je(i.promoText)),i.shortDescription&&(i.shortDescription=je(i.shortDescription)),B("promoText",i,t,e),B("description",i,t,e),B("shortDescription",i,t,e),i.shortDescription&&(t.setAttribute("action-menu","true"),i.actionMenuLabel||t.setAttribute("action-menu-label","More options")),Wn(t,e),B("callout",i,t,e),Kn(i,t,e,r),B("whatsIncluded",i,t,e)}function Kn(i,t,e,r={}){e.quantitySelect&&(i.quantitySelect||(i.quantitySelect=r.quantitySelect),B("quantitySelect",i,t,e))}function Qn(i,t,e,r={}){if(!e.addon)return;let n=(i.addon??r.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o=P("merch-addon",{slot:"addon"},n);[...o.querySelectorAll(w)].forEach(c=>{let s=c.parentElement;s?.nodeName==="P"&&s.setAttribute("data-plan-type","")}),t.append(o)}function Xn(i,t,e){i.addonConfirmation&&B("addonConfirmation",i,t,e)}function Zn(i,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function Jn(i,t,e=!0){try{let r=typeof i!="string"?"":i,a=Yi(r);if(a.length<=t)return[r,a];let n=0,o=!1,c=e?t-gr.length<1?1:t-gr.length:t,s=[];for(let m of r){if(n++,m==="<")if(o=!0,r[n]==="/")s.pop();else{let u="";for(let y of r.substring(n)){if(y===" "||y===">")break;u+=y}s.push(u)}if(m==="/"&&r[n]===">"&&s.pop(),m===">"){o=!1;continue}if(!o&&(c--,c===0))break}let d=r.substring(0,n).trim();if(s.length>0){s[0]==="p"&&s.shift();for(let m of s.reverse())d+=`</${m}>`}return[`${d}${e?gr:""}`,a]}catch{let a=typeof i=="string"?i:"",n=Yi(a);return[a,n]}}function Yi(i){if(!i)return"";let t="",e=!1;for(let r of i){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function eo(i,t){t.querySelectorAll("a.upt-link").forEach(r=>{let a=ce.createFrom(r);r.replaceWith(a),a.initializeWcsData(i.osi,i.promoCode)})}function to(i,t,e,r,a){let n=i;a?n=customElements.get("checkout-button").createCheckoutButton({},i.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of i.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",c=`spectrum-Button--${r}`,s=Mn.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",d=["spectrum-Button",c,s];return e&&d.push("spectrum-Button--outline"),n.classList.add(...d),n}function ro(i,t,e,r,a){let n=i;a&&(n=customElements.get("checkout-button").createCheckoutButton(i.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let c=P("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...i.dataset.analyticsId&&{"data-analytics-id":i.dataset.analyticsId}},i.innerHTML);return c.source=n,(a?n.onceSettled():Promise.resolve(n)).then(s=>{c.setAttribute("data-navigation-url",s.href)}),c.addEventListener("click",s=>{s.defaultPrevented||n.click()}),c}function io(i,t,e,r,a,n,o){let c=i;if(e)try{let s=customElements.get("checkout-link");s&&(c=s.createCheckoutLink(i.dataset,i.innerHTML)??i)}catch{}return r||(c.classList.add("button","con-button"),o&&o!=="m"&&c.classList.add(`button-${o}`),t&&c.classList.add("blue"),a&&c.classList.add("primary"),n&&c.classList.add("secondary")),c}function ao(i,t,e,r,a){if(i.ctas){i.ctas=je(i.ctas);let{slot:n}=e.ctas,o=P("div",{slot:n},i.ctas),c=[...o.querySelectorAll("a")],s=a?.hideTrialCTAs?c.filter(p=>!Rn.has(p.dataset.analyticsId)):c,d=(s.length>0?s:c).map(p=>Ki(p,t,e));o.textContent="",o.append(...d),t.append(o),a?.hideTrialCTAs&&s.length>0&&d.forEach(p=>{let m=p.source??p;m.onceSettled&&(p.hidden=!0,m.onceSettled().then(()=>{m.value?.[0]?.offerType==="TRIAL"&&d.some(y=>y!==p&&!y.hidden)?p.remove():p.hidden=!1}).catch(()=>{p.hidden=!1}))})}}function no(i,t){let{tags:e}=i,r=e?.find(n=>typeof n=="string"&&n.startsWith(Pn))?.split("/").pop();if(!r)return;t.setAttribute(Ft,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(_n,`${n.dataset.analyticsId}-${o+1}`)})}function oo(i){i.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{i.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function co(i){i.querySelectorAll("[slot]").forEach(r=>{r.remove()}),i.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",Ft].forEach(r=>i.removeAttribute(r));let e=["wide-strip","thin-strip"];i.classList.remove(...e)}async function Qi(i,t){if(!i){let s=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${s}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${s}).`)}if(!i.fields){let s=i.id||"unknown",d=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${s}' (merchCard id: ${d}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${s}' (merchCard id: ${d}) is missing 'fields'.`)}let{id:e,fields:r,settings:a={},priceLiterals:n}=i,{variant:o}=r;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);co(t),t.compatVersion=r.compatVersion,t.contextPromotionCode=r.promoCode,t.settings=a,n&&(t.priceLiterals=n),t.id??(t.id=i.id),i.variationId&&t.setAttribute("variation-id",i.variationId??""),t.variant=o,await t.updateComplete;let{aemFragmentMapping:c}=t.variantLayout;if(!c)throw new Error(`hydrate: variant mapping not found for ${e}`);c.style==="consonant"&&t.setAttribute("consonant",!0),Nn(r,t,c.mnemonics),On(r,t,c),Fn(r,t,c.size),In(r,t),$n(r,t,c.title),Dn(r,t,c),Bn(r,t,c),jn(r,t,c),Vn(r,t,c.backgroundImage),Hn(r,t,c.allowedColors,c.backgroundColor),qn(r,t,c),Yn(r,t,c,a),Gn(r,t,c),Qn(r,t,c,a),Xn(r,t,c),Zn(r,t,c,a);try{eo(r,t)}catch{}ao(r,t,c,o,a),no(r,t),oo(t)}var so=/[0-9\-+#]/,lo=/[^\d\-+#]/g;function Xi(i){return i.search(so)}function ho(i="#.##"){let t={},e=i.length,r=Xi(i);t.prefix=r>0?i.substring(0,r):"";let a=Xi(i.split("").reverse().join("")),n=e-a,o=i.substring(n,n+1),c=n+(o==="."||o===","?1:0);t.suffix=a>0?i.substring(c,e):"",t.mask=i.substring(r,c),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let s=t.mask.match(lo);return t.decimal=s&&s[s.length-1]||".",t.separator=s&&s[1]&&s[0]||",",s=t.mask.split(t.decimal),t.integer=s[0],t.fraction=s[1],t}function po(i,t,e){let r=!1,a={value:i};i<0&&(r=!0,a.value=-a.value),a.sign=r?"-":"",a.value=Number(a.value).toFixed(t.fraction&&t.fraction.length),a.value=Number(a.value).toString();let n=t.fraction&&t.fraction.lastIndexOf("0"),[o="0",c=""]=a.value.split(".");return(!c||c&&c.length<=n)&&(c=n<0?"":(+`0.${c}`).toFixed(n+1).replace("0.","")),a.integer=o,a.fraction=c,mo(a,t),(a.result==="0"||a.result==="")&&(r=!1,a.sign=""),!r&&t.maskHasPositiveSign?a.sign="+":r&&t.maskHasPositiveSign?a.sign="-":r&&(a.sign=e&&e.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),a}function mo(i,t){i.result="";let e=t.integer.split(t.separator),r=e.join(""),a=r&&r.indexOf("0");if(a>-1)for(;i.integer.length<r.length-a;)i.integer=`0${i.integer}`;else Number(i.integer)===0&&(i.integer="");let n=e[1]&&e[e.length-1].length;if(n){let o=i.integer.length,c=o%n;for(let s=0;s<o;s++)i.result+=i.integer.charAt(s),!((s-c+1)%n)&&s<o-n&&(i.result+=t.separator)}else i.result=i.integer;return i.result+=t.fraction&&i.fraction?t.decimal+i.fraction:"",i}function go(i,t,e={}){if(!i||isNaN(Number(t)))return t;let r=ho(i),a=po(t,r,e);return r.prefix+a.sign+a.result+r.suffix}var Zi=go;var Ji=".",uo=",",fo=/^\s+/,vo=/\s+$/;var ur={MONTH:"MONTH",YEAR:"YEAR"},Id={[J.ANNUAL]:12,[J.MONTHLY]:1,[J.THREE_YEARS]:36,[J.TWO_YEARS]:24},fr=(i,t)=>({accept:i,round:t}),$d=[fr(({divisor:i,price:t})=>t%i==0,({divisor:i,price:t})=>t/i),fr(({usePrecision:i})=>i,({divisor:i,price:t})=>Math.round(t/i*100)/100),fr(()=>!0,({divisor:i,price:t})=>Math.ceil(Math.floor(t*100/i)/100))],xo={[Gt.YEAR]:{[J.MONTHLY]:ur.MONTH,[J.ANNUAL]:ur.YEAR},[Gt.MONTH]:{[J.MONTHLY]:ur.MONTH}},bo=(i,t)=>i.indexOf(`'${t}'`)===0,yo=(i,t=!0)=>{let e=i.replace(/'.*?'/,"").trim(),r=ea(e);return!!r?t||(e=e.replace(/[,\.]0+/,r)):e=e.replace(/\s?(#.*0)(?!\s)?/,`$&${Eo(i)}`),e},wo=i=>{let t=ko(i),e=bo(i,t),r=i.replace(/'.*?'/,""),a=fo.test(r)||vo.test(r);return{currencySymbol:t,isCurrencyFirst:e,hasCurrencySpace:a}};var Eo=i=>i.match(/#(.?)#/)?.[1]===Ji?uo:Ji,ko=i=>i.match(/'(.*?)'/)?.[1]??"",ea=i=>i.match(/0(.?)0/)?.[1]??"";function So({formatString:i,price:t,usePrecision:e,isIndianPrice:r=!1},a,n=o=>o){let{currencySymbol:o,isCurrencyFirst:c,hasCurrencySpace:s}=wo(i),d=e?ea(i):"",p=yo(i,e),m=e?2:0,u=n(t,{currencySymbol:o}),y=r?u.toLocaleString("hi-IN",{minimumFractionDigits:m,maximumFractionDigits:m}):Zi(p,u),L=e?y.lastIndexOf(d):y.length,F=y.substring(0,L),ye=y.substring(L+1);return{accessiblePrice:i.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,y).replace(/SYMBOL/,o),currencySymbol:o,decimals:ye,decimalsDelimiter:d,hasCurrencySpace:s,integer:F,isCurrencyFirst:c,recurrenceTerm:a}}var ta=({commitment:i,term:t,...e})=>So(e,xo[i]?.[t]);var $t="merch-card",ra="merch-card:",ca=["full-pricing-express","simplified-pricing-express"],sa=["segment","product"];function vr(i,t,e){for(let r of i.childNodes)r.nodeType===Node.TEXT_NODE&&r.textContent.includes(e)?r.textContent=r.textContent.replaceAll(e,t):vr(r,t,e);i.shadowRoot&&vr(i.shadowRoot,t,e)}function ia(i){return parseFloat(`${i.querySelector(".price-integer").textContent.replace(/\D/g,"")}.${i.querySelector(".price-decimals").textContent}`)}function Ao(i){let t=document.createElement("div");return t.innerHTML=i,t.textContent}function To(i,t,e){let r=i?.masElement?.value?.[0];if(!r)return;let{commitment:a,term:n}=r,{formatString:o,usePrecision:c}=r.priceDetails,s=ta({formatString:o,price:t,isIndianPrice:e==="IN",usePrecision:c,commitment:a,term:n});return Ao(s?.accessiblePrice)}function Lo(i,t,e){let r=i.querySelector("merch-badge");if(!i.textContent.includes(wt)&&!r?.shadowRoot.textContent.includes(wt))return;let a=i?.variantLayout?.aemFragmentMapping?.prices;if(!a)return;let n=t.closest(`${a.tag}[slot="${a.slot}"]`);n&&t.onceSettled().then(()=>{let o=n.querySelector(".price-strikethrough"),c=n.querySelector(".price-alternative");if(!o||!c)return;let s=o.querySelector(".price-decimals-delimiter").textContent.trim(),d=o.querySelector(".strikethrough-aria-label").textContent,p=o.querySelector(".price-recurrence").textContent,m=ia(o),u=ia(c);if(u>=m)return;let y=m-u,L=To(t,y,e.country);if(!L)return;let F=`${L}${p}`;vr(i,F,wt)})}function aa(i,t){let e=i.closest($t);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),Hr(i)&&(t.displayPerUnit=!1,t.displayTax=!1),Lo(e,i,t),!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.contextPromotionCode),e.aemFragment&&(t[$r]=!0),e.variantLayout?.priceOptionsProvider?.(i,t),i.dataset.template===R&&(t.displayDot??(t.displayDot=e.variantLayout?.legalDisplayDot??!0))}function na(i,t){let e=i.closest($t);if(!e)return t;!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.contextPromotionCode)}function zo(i){i.providers.has(aa)||i.providers.price(aa),i.providers.has(na)||i.providers.checkout(na)}var mt=new IntersectionObserver(i=>{i.forEach(t=>{let e=t.target;if(ca.includes(e.variant)){if(e.clientHeight===0)return;mt.unobserve(e),e.requestUpdate();return}if(sa.includes(e.variant)){if(t.boundingClientRect.width===0)return;if(e.variant==="product"&&e.querySelector('merch-icon[slot="icons"]')){mt.unobserve(e);return}let r=e.getBoundingClientRect().width,n=e.querySelector('[slot="badge"]')?.getBoundingClientRect().width||0;if(r===0||n===0){mt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(r-n-16)}px`),mt.unobserve(e)}})}),Po=0,We,Ye,Ke,K,xe,H,be,C,ve,gt,xr,It,se=class extends Co{constructor(){super();f(this,C);h(this,"contextPromotionCode");f(this,We);f(this,Ye);f(this,Ke);f(this,K);f(this,xe);f(this,H);f(this,be,new Promise(e=>{g(this,H,e)}));h(this,"compatVersion");h(this,"customerSegment");h(this,"marketSegment");h(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=tr(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=tr(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){_(this,C,ve).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(w)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(Q)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(Q)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(Q)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let a of r){await a.onceSettled();let n=a.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let c=a.dataset.wcsOsi.split(",").filter(s=>s!==o);e.checked&&c.push(o),a.dataset.wcsOsi=c.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let a=n=>{let{offerType:o,planType:c}=n.value?.[0]??{};if(!o||!c)return;let s=e.getOsi(c,o),d=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==s);e.checked&&d.push(s),n.dataset.wcsOsi=d.join(",")};r.forEach(a)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let a of r)a.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(a=>{if(e){r[a].order=Math.min(r[a].order||2,2);return}let n=r[a].order;n===1||isNaN(n)||(r[a].order=Number(n)+1)}),this.filters=r}showInfoTooltip(e,r){let a="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(a),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(a),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(r)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(r=>this.iconButton.addEventListener(r,a=>this.showInfoTooltip(a.target,e),!1)),["mouseleave","blur"].forEach(r=>this.iconButton.addEventListener(r,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",r=>{r.key==="Escape"&&this.iconButton.classList.remove(e)}))}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),l(this,Ye)||g(this,Ye,Po++),this.aemFragment||((r=l(this,H))==null||r.call(this),g(this,H,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??l(this,Ye);g(this,xe,`${ra}${e}${bt}`),g(this,We,`${ra}${e}${yt}`),performance.mark(l(this,xe)),g(this,K,de()),zo(l(this,K)),g(this,Ke,l(this,K).Log.module($t)),this.addEventListener(I,this.handleQuantitySelection),this.addEventListener(Vt,this.handleAddonAndQuantityUpdate),this.addEventListener(Pr,this.handleMerchOfferSelectReady),this.addEventListener(Ae,this.handleAemFragmentEvents),this.addEventListener(Ce,this.handleAemFragmentEvents),this.addEventListener(vt,this.handleInfoIconEvents),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(I,this.handleQuantitySelection),this.removeEventListener(Ae,this.handleAemFragmentEvents),this.removeEventListener(Ce,this.handleAemFragmentEvents),this.removeEventListener(vt,this.handleInfoIconEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(Vt,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===Ae&&_(this,C,ve).call(this,"AEM fragment cannot be loaded"),e.type===Ce&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let a=e.detail;try{l(this,H)||g(this,be,new Promise(n=>{g(this,H,n)})),Qi(a,this)}catch(n){_(this,C,ve).call(this,`hydration has failed: ${n.message}`)}finally{(r=l(this,H))==null||r.call(this),g(this,H,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;l(this,be)&&(await l(this,be),(ca.includes(this.variant)||sa.includes(this.variant))&&mt.observe(this),g(this,be,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(o=>setTimeout(()=>o("timeout"),ke));if(this.aemFragment){let o=await Promise.race([this.aemFragment.updateComplete,e]);if(o===!1||o==="timeout"){let c=o==="timeout"?`AEM fragment was not resolved within ${ke} timeout`:"AEM fragment cannot be loaded";_(this,C,ve).call(this,c,{},!1);return}}let r=[...this.querySelectorAll(zr)],a=Promise.all(r.map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(c=>c.classList.contains("placeholder-resolved"))),n=await Promise.race([a,e]);if(n===!0){this.measure=performance.measure(l(this,We),l(this,xe));let o={...this.aemFragment?.fetchInfo,...l(this,K).duration,measure:Te(this.measure)};return this.dispatchEvent(new CustomEvent(vt,{bubbles:!0,composed:!0,detail:o})),this}else{this.measure=performance.measure(l(this,We),l(this,xe));let o={measure:Te(this.measure),...l(this,K).duration};if(n==="timeout")_(this,C,ve).call(this,`Contains offers that were not resolved within ${ke} timeout`,o);else{let c=r.some(s=>s.matches(Q)&&s.classList.contains("placeholder-failed"));_(this,C,ve).call(this,c?"CTA has an invalid offer":"Contains unresolved offers",o)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(Q)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let c=new URL(n.getAttribute("href")).searchParams.get("pa"),s=r.find(p=>p.productArrangementCode===c)?.quantity,d=!!r.find(p=>p.productArrangementCode!==c);if(s&&this.quantitySelect?.dispatchEvent(new CustomEvent(Mr,{detail:{quantity:s},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==d){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:d}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(w))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${w}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return l(this,C,gt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${w}[data-promotion-code],${Q}[data-promotion-code]`)].map(a=>a.dataset.promotionCode).filter(a=>![void 0,"cancel-context"].includes(a));if(e.length===0)return this.contextPromotionCode;let r=[...new Set(e)];return r.length>1&&l(this,Ke)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${w}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(l(this,C,xr)??l(this,C,gt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return l(this,C,gt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return l(this,C,xr)?.querySelector(e)?.textContent?.trim()??l(this,C,gt)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return _(this,C,It).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${Q}, a`);return Array.from(e??[])}get primaryCta(){return _(this,C,It).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return _(this,C,It).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};We=new WeakMap,Ye=new WeakMap,Ke=new WeakMap,K=new WeakMap,xe=new WeakMap,H=new WeakMap,be=new WeakMap,C=new WeakSet,ve=function(e,r={},a=!0){var s;if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let c={...this.aemFragment.fetchInfo,...l(this,K).duration,...r,message:e};l(this,Ke).error(`merch-card${o}: ${e}`,c),this.failed=!0,(s=l(this,H))==null||s.call(this),g(this,H,void 0),l(this,K).isPreview()||(this.style.display="none"),a&&this.dispatchEvent(new CustomEvent(Rr,{bubbles:!0,composed:!0,detail:c}))},gt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${w}[data-template="price"] > span`)},xr=function(){return this.querySelector(`${w}[data-template="legal"]`)},It=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},h(se,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,a,n]=e.split(",");return{PUF:r,ABM:a,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[a,n,o]=r.split(":"),c=Number(n);return[a,{order:isNaN(c)?void 0:c,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:a,size:n}])=>[r,a,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Ft,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),h(se,"styles",[Cr,...Ar()]),h(se,"registerVariant",S),h(se,"getCollectionOptions",Si),h(se,"getFragmentMapping",St);customElements.define($t,se);export{se as MerchCard};

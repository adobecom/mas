...
describe('ChatSessionManager', () => {
    ...
    describe('deleteSession', () => {
        ...
        it('clears any pending debounce timer for the deleted session', () => {
            const session = manager.createSession('Pending Update');
            manager.updateSessionDebounced(session.id, { name: 'Changed' });

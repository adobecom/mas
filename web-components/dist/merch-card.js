var hr=Object.defineProperty;var pr=a=>{throw TypeError(a)};var Ka=(a,t,e)=>t in a?hr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var Ya=(a,t)=>()=>(a&&(t=a(a=0)),t);var Qa=(a,t)=>{for(var e in t)hr(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>Ka(a,typeof t!="symbol"?t+"":t,e),Dt=(a,t,e)=>t.has(a)||pr("Cannot "+e);var s=(a,t,e)=>(Dt(a,t,"read from private field"),e?e.call(a):t.get(a)),g=(a,t,e)=>t.has(a)?pr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Dt(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),_=(a,t,e)=>(Dt(a,t,"access private method"),e);var mr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return s(a,t,r)}});var Ft={};Qa(Ft,{default:()=>Ve});import{LitElement as Za,html as mt,css as Xa}from"./lit-all.min.js";import{unsafeHTML as br}from"./lit-all.min.js";function Ja(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var P,Ve,It=Ya(()=>{P=class P extends Za{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();P.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),h=l?l.offsetWidth:o,p=l?l.offsetHeight:c,b=this.effectivePlacement;b==="top"&&e.top-p-n<0?b="bottom":b==="bottom"&&e.bottom+p+n>i?b="top":b==="left"&&e.left-h-n<0?b="right":b==="right"&&e.right+h+n>r&&(b="left");let z=e.left+e.width/2,ie=e.top+e.height/2,O=6,ne,oe,je;b==="top"?(ne=e.top-p-n,oe=Math.max(0,Math.min(r-h,z-h/2)),je=Math.max(O,Math.min(h-O*2,z-oe-O))):b==="bottom"?(ne=e.bottom+n,oe=Math.max(0,Math.min(r-h,z-h/2)),je=Math.max(O,Math.min(h-O*2,z-oe-O))):b==="left"?(oe=e.left-h-n,ne=Math.max(0,Math.min(i-p,ie-p/2)),je=Math.max(O,Math.min(p-O*2,ie-ne-O))):(oe=e.right+n,ne=Math.max(0,Math.min(i-p,ie-p/2)),je=Math.max(O,Math.min(p-O*2,ie-ne-O))),this._tooltipTop=ne,this._tooltipLeft=oe,this._arrowOffset=je,this._computedPlacement=b,this._anchorRect=e}showTooltip(){P.activeTooltip&&P.activeTooltip!==this&&(P.activeTooltip.closeOverlay(),P.activeTooltip.tooltipVisible=!1,P.activeTooltip.requestUpdate()),P.activeTooltip=this,this._computeTooltipPosition(),this.tooltipVisible=!0,this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){P.activeTooltip===this&&(P.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?mt`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:mt`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return this.renderIcon();if(Ja())return mt`
                <overlay-trigger
                    placement="${e}"
            ...
            `;{let i=t.replace(/<[^>]*>/g,""),n=this._computedPlacement,o=n==="top"||n==="bottom",c=`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`,l=o?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return mt`
                <span
                    class="css-tooltip ${this.tooltipVisible?"tooltip-visible":""}"
                    tabindex="0"
                    role="img"
                    aria-label="${i}"
                    @pointerdown=${h=>{this.lastPointerType=h.pointerType}}
                    @pointerenter=${h=>h.pointerType!=="touch"&&this.showTooltip()}
                    @pointerleave=${h=>h.pointerType!=="touch"&&this.hideTooltip()}
                    @click=${h=>{this.lastPointerType==="touch"&&this.handleTap(h),this.lastPointerType=null}}
                >
                    ${this.renderIcon()}
                    <span class="css-tooltip-body" style="${c}">
                        ${br(t)}
                        <span
                            aria-hidden="true"
                            role="presentation"
    ...
    `);Ve=P;customElements.define("mas-mnemonic",Ve)});import{LitElement as Bn}from"./lit-all.min.js";import{css as fr,unsafeCSS as ur}from"./lit-all.min.js";var w="(max-width: 767px)",A="(max-width: 1199px)",E="(min-width: 768px)",f="(min-width: 1200px)",T="(min-width: 1600px)",gr={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${f} and (not ${T})`),matchDesktopOrUp:window.matchMedia(f),matchLargeDesktop:window.matchMedia(T),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},v=gr;function pt(){return gr.isDesktop}var vr=fr`
    :host {
...
`,xr=()=>[fr`
        ...
        `];import{LitElement as ei,html as yr,css as ti}from"./lit-all.min.js";function ri(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var xe=class extends ei{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(ri())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>It())}e.remove()})}render(){let{href:t}=this;return t?yr`<a href="${t}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(xe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(xe,"styles",ti`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",xe);var eo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),to=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var y='span[is="inline-price"][data-wcs-osi]',Y='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var ai='a[is="upt-link"]',wr=`${y},${Y},${ai}`;var Er="merch-offer-select:ready",kr="merch-card:action-menu-toggle";var N="merch-quantity-selector:change",Sr="merch-card-quantity:change",$t="merch-modal:addon-and-quantity-update";var be="merch-card-collection:literals-changed";var ye="aem:load",we="aem:error",gt="mas:ready",Cr="mas:error",Ar="placeholder-failed",Tr="placeholder-pending",Lr="placeholder-resolved";var zr="mas:failed",We="mas:resolved",_r="mas/commerce";var Q="failed",ce="pending",Z="resolved";var ut="X-Request-Id",ro=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var ao=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var ft=":start",vt=":duration";var D="legal",Pr="mas-ff-defaults";var ii="mas-commerce-service";function Mr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function L(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function Ee(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function Bt(){return window.matchMedia("(max-width: 1024px)").matches}function se(){return document.getElementsByTagName(ii)?.[0]}function Ke(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Ye,le,Qe,Ze,ke,xt=class extends HTMLElement{constructor(){super();g(this,Ye,"");g(this,le);g(this,Qe,[]);g(this,Ze,[]);g(this,ke);m(this,ke,Mr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,le)?this.parentElement.style.borderRadius=s(this,le):s(this,le)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Qe).map((r,i)=>{let n=s(this,Ze)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,Ye)}, ${e})`}connectedCallback(){s(this,ke).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,le,i?.trim()),e==="colors"&&i?m(this,Qe,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,Ze,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Ye,i?.trim()??""),s(this,ke).call(this)}};Ye=new WeakMap,le=new WeakMap,Qe=new WeakMap,Ze=new WeakMap,ke=new WeakMap;customElements.define("merch-gradient",xt);import{LitElement as ni,html as oi,css as ci}from"./lit-all.min.js";var Se=class extends ni{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(We,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(We,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return oi` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(Se,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),d(Se,"styles",ci`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",Se);import{html as bt,nothing as si}from"./lit-all.min.js";var Ce,Xe=class Xe{constructor(t){d(this,"card");g(this,Ce);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,Ce,s(this,Ce)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,Ce)}insertVariantStyle(){let t=this.constructor.name;if(!Xe.styleMap[t]){Xe.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),bt`
        ...
        `}get cardImage(){return bt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:si}get secureLabelFooter(){return bt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return yt(this.card.variant)}};Ce=new WeakMap,d(Xe,"styleMap",{});var x=Xe;import{html as qt,css as li}from"./lit-all.min.js";var Rr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Je,css as di}from"./lit-all.min.js";var Nr=`
:root {
...
`;var wt=class extends x{constructor(t){super(t)}getGlobalCSS(){return Fr}renderLayout(){return Ir` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Ir`<hr />`} ${this.secureLabelFooter}`}};import{html as X,css as hi,unsafeCSS as Br}from"./lit-all.min.js";var $r=`
  :root {
...
`;var pi=32,qr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Te=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?X`<slot name="secure-transaction-label">
    ...
    `);import{html as Et,css as mi,unsafeCSS as Ur,nothing as gi}from"./lit-all.min.js";var Hr=`
  :root {
...
`;var ui=32,Gr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Le=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>Et` <footer>
    ...
    `);import{html as et,css as fi,nothing as kt}from"./lit-all.min.js";var jr=`
:root {
...
`;var St={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Vr={...function(){let{whatsIncluded:a,size:t,...e}=St;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Wr={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=St;return i}()},G,M=class extends x{constructor(e){super(e);g(this,G);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===D&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return jr}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),h=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(c)){if(o?.classList.toggle("wide-footer",v.isDesktopOrUp),!i&&l){if(h)l.remove();else{let u=p.querySelector(`[data-placeholder-for="${e}"]`);u?u.replaceWith(l):p.appendChild(l)}return}if(i&&h){let u=document.createElement("div");if(u.setAttribute("data-placeholder-for",e),u.classList.add("slot-placeholder"),!l){let b=h.cloneNode(!0);o.prepend(b)}h.replaceWith(u)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],v.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],v.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,G)||(m(this,G,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,G)?.disconnect(),m(this,G,null),this.syncHeights())})),s(this,G).observe(this.card));return}["heading-xs","subtitle","heading-m","promo-text","body-xs"].forEach(r=>{let i=this.card.querySelector(`[slot="${r}"]`);i&&this.updateCardElementMinHeight(i,r)})}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let h=0,p=this.card.querySelector('[slot="heading-s"]');p&&(h+=Ke(p));let u=this.card.querySelector('[slot="subtitle"]');u&&(h+=Ke(u));let b=this.card.querySelector('[slot="heading-m"]');b&&(h+=8+Ke(b));for(let ie of r.childNodes){if(ie.classList.contains("spacer"))break;h+=Ke(ie)}let z=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");h>(parseFloat(z)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${h}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${h}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){if(this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),window.matchMedia("(min-width: 768px)").matches){let e=this.getContainer();if(!e)return;let r=`--consonant-merch-card-${this.card.variant}`,i=e.style.getPropertyValue(`${r}-heading-xs-height`);requestAnimationFrame(i?()=>{this.syncHeights()}:()=>{e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(o=>o.variantLayout?.syncHeights?.())})}}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?et`<div class="divider"></div>`:kt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?et`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};G=new WeakMap,d(M,"variantStyle",fi`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),d(M,"collectionOptions",{customHeaderArea:e=>e.sidenav?et`<slot name="resultsText"></slot>`:kt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let r=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!v.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let c=o.getAttribute("size"),l=c==="wide"?2:c==="super-wide"?3:1;l===2&&n%3===2&&(o.setAttribute("data-size",c),o.removeAttribute("size"),l=1),n+=l}};v.matchDesktop.addEventListener("change",r),e.addEventListener(be,r),e.onUnmount.push(()=>{v.matchDesktop.removeEventListener("change",r),e.removeEventListener(be,r)})}});import{html as W,css as vi,unsafeCSS as Yr,nothing as Ct}from"./lit-all.min.js";var Kr=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(v.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?v.isMobile?W`
        ...
        `:W`
            ...
            `:Ct}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?W`<slot name="icons"></slot>`:Ct}get secureLabelFooter(){return W`<footer>
...
`;var Xr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ze=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Zr}priceOptionsProvider(t,e){t.dataset.template===D&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ht` ${this.badge}
    ...
    `);import{html as Ut,css as bi}from"./lit-all.min.js";var Jr=`
:root {
...
`;var ra={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Pe=class extends x{constructor(t){super(t)}getGlobalCSS(){return ta}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return yi`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as Gt,css as Ei}from"./lit-all.min.js";var aa=`
:root {
...
`;var ia={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Me=class extends x{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return aa}renderLayout(){return Gt`${this.cardImage}
            ...
            ${this.evergreen?Gt`
                  ...
                  `:Gt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(Me,"variantStyle",Ei`
    ...
    `);import{html as ki,css as Si}from"./lit-all.min.js";var na=`
:root {
...
`;var jt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Re=class extends x{getGlobalCSS(){return na}get aemFragmentMapping(){return jt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;if(!t)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(t.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(i=>i.onceSettled?.()));let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",c)})}),v.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!pt()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let t=this.getContainer();t&&t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t<=2||t===this.lastSyncedWidth||(this.lastSyncedWidth=t,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(pt())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};e();let r=window.matchMedia(w);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(w).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||pt())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return ki`
    ...
    `);import{html as ca,css as Ci}from"./lit-all.min.js";var oa=`
:root {
...
`;var Vt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Oe=class extends x{getGlobalCSS(){return oa}get aemFragmentMapping(){return Vt}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return ca`
    ...
    `);import{html as Wt,css as Ai,nothing as Ti}from"./lit-all.min.js";var sa=`
...
`;var la={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Li=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Ne=class extends x{constructor(t){super(t)}getGlobalCSS(){return sa}renderLayout(){return Wt`
    ...
    `);import{css as zi,html as _i}from"./lit-all.min.js";var da=`
...
`;var ha={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},De=class extends x{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return da}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return _i`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Pi,css as Mi}from"./lit-all.min.js";var pa=`
...
`;var Kt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Fe=class extends x{getGlobalCSS(){return pa}get aemFragmentMapping(){return Kt}renderLayout(){return Pi`
    ...
    `);var At=new Map,ma=new WeakMap,ga=new Map,k=(a,t,e=null,r=null,i)=>{At.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",Ae,Or,Ae.variantStyle);k("image",de);k("inline-heading",wt);k("mini-compare-chart",Te,qr,Te.variantStyle);k("mini-compare-chart-mweb",Le,Gr,Le.variantStyle);k("plans",M,St,M.variantStyle,M.collectionOptions);k("plans-students",M,Wr,M.variantStyle,M.collectionOptions);k("plans-education",M,Vr,M.variantStyle,M.collectionOptions);k("plans-v2",J,Qr,J.variantStyle,J.collectionOptions);k("product",ze,Xr,ze.variantStyle);k("segment",_e,ea,_e.variantStyle);k("media",Pe,ra,Pe.variantStyle);k("headless",Ne,la,Ne.variantStyle);k("special-offers",Me,ia,Me.variantStyle);k("simplified-pricing-express",Re,jt,Re.variantStyle);k("full-pricing-express",Oe,Vt,Oe.variantStyle);k("mini",De,ha,De.variantStyle);k("image",de,Dr,de.variantStyle);k("fries",Fe,Kt,Fe.variantStyle);var Ri=(a,t,e)=>{try{let r=ga.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ga.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Yt=a=>{let t=At.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=ma.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?Ri(a,r,i):{};return ma.set(a,{appliedVariant:a.variant,...n}),new e(a)};function yt(a){return At.get(a)?.fragmentMapping}function ua(a){return At.get(a)?.collectionOptions}var fa=document.createElement("style");fa.innerHTML=`
:root {
...
`;document.head.appendChild(fa);function Tt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=Qt(r)?r:a;n=o.get(c)}if(i&&n==null){let o=Qt(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Ni(Qt(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var Oi=a=>typeof a=="boolean",Lt=a=>typeof a=="function";var Qt=a=>typeof a=="string";function va(a,t){if(Oi(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Ni(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var ee=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(ut);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var he={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},xa=1e3;function Di(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ba(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!he.serializableTypes.includes(e))return e}return a}function Fi(a,t){if(!he.ignoredProperties.includes(a))return ba(t)}var Zt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(h=>{h!=null&&(Di(h)?r:i).push(h)}),r.length&&(n+=" "+r.map(ba).join(" "));let{pathname:o,search:c}=window.location,l=`${he.delimiter}page=${o}${c}`;l.length>xa&&(l=`${l.slice(0,xa)}<trunc>`),n+=l,i.length&&(n+=`${he.delimiter}facts=`,n+=JSON.stringify(i,Fi)),window.lana?.log(n,he)}};function ya(a){Object.assign(he,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in he&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var wa={LOCAL:"local",PROD:"prod",STAGE:"stage"},Xt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Jt=new Set,er=new Set,Ea=new Map,ka={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Sa={filter:({level:a})=>a!==Xt.DEBUG},Ii={filter:()=>!1};function $i(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Lt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Bi(a){[...er].every(t=>t(a))&&Jt.forEach(t=>t(a))}function Ca(a){let t=(Ea.get(a)??0)+1;Ea.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Ca(`${r.namespace}/${i}`),updateConfig:ya};return Object.values(Xt).forEach(i=>{r[i]=(n,...o)=>Bi($i(i,n,a,o,e))}),Object.seal(r)}function zt(...a){a.forEach(t=>{let{append:e,filter:r}=t;Lt(r)&&er.add(r),Lt(e)&&Jt.add(e)})}function qi(a={}){let{name:t}=a,e=va(Tt("commerce.debug",{search:!0,storage:!0}),t===wa.LOCAL);return zt(e?ka:Sa),t===wa.PROD&&zt(Zt),tt}function Hi(){Jt.clear(),er.clear()}var tt={...Ca(_r),Level:Xt,Plugins:{consoleAppender:ka,debugFilter:Sa,quietFilter:Ii,lanaAppender:Zt},init:qi,reset:Hi,use:zt};var Ui="mas-commerce-service",pl=tt.module("utilities"),Gi={requestId:ut,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var _t=a=>window.setTimeout(a);function tr(){return document.getElementsByTagName(Ui)?.[0]}function Aa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Gi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ta(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var La="fragment",za="author",_a="preview",Pa="loading",Ma="timeout",rr="aem-fragment",Ra="eager",Oa="cache",ji=[Ra,Oa],j,pe,B,ar=class{constructor(){g(this,j,new Map);g(this,pe,new Map);g(this,B,new Map)}clear(){s(this,j).clear(),s(this,pe).clear(),s(this,B).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,j).set(t.id,t),t.fields?.originalId&&s(this,j).set(t.fields.originalId,t),s(this,B).has(t.id)){let[,r]=s(this,B).get(t.id);r()}if(s(this,B).has(t.fields?.originalId)){let[,r]=s(this,B).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,j).has(t)}entries(){return s(this,j).entries()}get(t){return s(this,j).get(t)}getAsPromise(t){let[e]=s(this,B).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,B).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,pe).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,pe).set(t,e)),e}remove(t){s(this,j).delete(t),s(this,pe).delete(t),s(this,B).delete(t)}};j=new WeakMap,pe=new WeakMap,B=new WeakMap;var te=new ar,Ie,q,K,F,R,C,rt,at,H,it,nt,$e,U,Na,Da,ir,Fa,Pt=class extends HTMLElement{constructor(){super(...arguments);g(this,U);d(this,"cache",te);g(this,Ie);g(this,q,null);g(this,K,null);g(this,F,null);g(this,R);g(this,C);g(this,rt,Ra);g(this,at,5e3);g(this,H);g(this,it,!1);g(this,nt,0);g(this,$e)}static get observedAttributes(){return[La,Pa,Ma,za,_a]}attributeChangedCallback(e,r,i){e===La&&(m(this,R,i),m(this,C,te.getFetchInfo(i))),e===Pa&&ji.includes(i)&&m(this,rt,i),e===Ma&&m(this,at,parseInt(i,10)),e===za&&m(this,it,["","true"].includes(i)),e===_a&&m(this,$e,i)}connectedCallback(){if(!s(this,H)){if(s(this,F)??m(this,F,se(this)),m(this,$e,s(this,F).settings?.preview),s(this,Ie)??m(this,Ie,s(this,F).log.module(`${rr}[${s(this,R)}]`)),!s(this,R)||s(this,R)==="#"){s(this,C)??m(this,C,te.getFetchInfo("missing-fragment-id")),_(this,U,ir).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,C)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,H)&&!await Promise.race([s(this,H),Promise.resolve(!1)]))return;e&&te.remove(s(this,R)),s(this,rt)===Oa&&await Promise.race([te.getAsPromise(s(this,R)),new Promise(c=>setTimeout(c,s(this,at)))]);try{m(this,H,_(this,U,Fa).call(this)),await s(this,H)}catch(c){return _(this,U,ir).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,q)||{};return o&&!Tt("mas.disableWcsCache")&&s(this,F).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ye,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,C)},bubbles:!0,composed:!0})),s(this,H)}get updateComplete(){return s(this,H)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,K)?s(this,K):(s(this,it)?this.transformAuthorData():this.transformPublishData(),s(this,K))}get rawData(){return s(this,q)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:h={}}=s(this,q);m(this,K,e.reduce((p,{name:u,multiple:b,values:z})=>(p.fields[u]=b?z:z[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:h,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:h}=s(this,q);m(this,K,Object.entries(e).reduce((p,[u,b])=>(p.fields[u]=b?.mimeType?b.value:b??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:h}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,R),{locale:s(this,F).settings.locale,apiKey:s(this,F).settings.wcsApiKey,fullContext:!0})}};Ie=new WeakMap,q=new WeakMap,K=new WeakMap,F=new WeakMap,R=new WeakMap,C=new WeakMap,rt=new WeakMap,at=new WeakMap,H=new WeakMap,it=new WeakMap,nt=new WeakMap,$e=new WeakMap,U=new WeakSet,Na=async function(e){mr(this,nt)._++;let r=`${rr}:${s(this,R)}:${s(this,nt)}`,i=`${r}${ft}`,n=`${r}${vt}`;if(s(this,$e)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new ee(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,C).stale=!1,s(this,C).url=e,o=await Ta(e,{cache:"default",credentials:"omit"}),_(this,U,Da).call(this,o),s(this,C).status=o?.status,s(this,C).measure=Ee(performance.measure(n,i)),s(this,C).retryCount=o.retryCount,!o?.ok)throw new ee("Unexpected fragment response",{response:o,...s(this,F).duration});return await o.json()}catch(c){if(s(this,C).measure=Ee(performance.measure(n,i)),s(this,C).retryCount=c.retryCount,s(this,q))return s(this,C).stale=!0,s(this,Ie).error("Serving stale data",s(this,C)),s(this,q);let l=c.message??"unknown";throw new ee(`Failed to fetch fragment: ${l}`,{})}},Da=function(e){Object.assign(s(this,C),Aa(e))},ir=function(e){m(this,H,null),s(this,C).message=e,this.classList.add("error");let r={...s(this,C),...s(this,F).duration};s(this,Ie).error(e,r),this.dispatchEvent(new CustomEvent(we,{detail:r,bubbles:!0,composed:!0}))},Fa=async function(){var l;this.classList.remove("error"),m(this,K,null);let e=te.get(s(this,R));if(e)return m(this,q,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,F).settings,c=`${r}/fragment?id=${s(this,R)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await _(this,U,Na).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,R)),te.add(e),m(this,q,e),!0},d(Pt,"cache",te);customElements.define(rr,Pt);import{LitElement as Vi,html as nr,css as Wi,nothing as Ki}from"./lit-all.min.js";import{unsafeHTML as Yi}from"./lit-all.min.js";var Qi=a=>a?a.startsWith("sp-icon-")?nr`${Yi(`<${a} class="badge-icon"></${a}>`)}`:nr`<img src="${a}" class="badge-icon" />`:Ki,Be=class extends Vi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return nr`<div class="badge">
            ${Qi(this.icon)}<slot>${this.text}</slot>
        </div>`}};d(Be,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),d(Be,"styles",Wi`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Be);import{html as Zi,css as Xi,LitElement as Ji}from"./lit-all.min.js";var ot=class extends Ji{constructor(){super()}render(){return Zi`
            <slot name="icon"></slot>
    ...
    `),d(ot,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ot);import{html as or,css as en,LitElement as tn,nothing as Ia}from"./lit-all.min.js";var ct=class extends tn{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return or`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?or`<slot name="content"></slot>`:Ia}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?or`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Ia}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(ct,"styles",en`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),d(ct,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",ct);var rn={[Q]:Ar,[ce]:Tr,[Z]:Lr},an={[Q]:zr,[Z]:We},st,Mt=class{constructor(t){g(this,st);d(this,"changes",new Map);d(this,"connected",!1);d(this,"error");d(this,"log");d(this,"options");d(this,"promises",[]);d(this,"state",ce);d(this,"timer",null);d(this,"value");d(this,"version",0);d(this,"wrapperElement");this.wrapperElement=t,this.log=tt.module("mas-element")}update(){[Q,ce,Z].forEach(t=>{this.wrapperElement.classList.toggle(rn[t],t===this.state)})}notify(){(this.state===Z||this.state===Q)&&(this.state===Z?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===Q&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof ee&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(an[this.state],{bubbles:!0,composed:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){m(this,st,tr()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return Z===r?Promise.resolve(this.wrapperElement):Q===r?Promise.reject(t):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=Z,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),_t(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=Q,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...s(this,st)?.duration}),_t(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=ce,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!tr()||this.timer)return;let{error:e,options:r,state:i,value:n,version:o}=this;this.state=ce,this.timer=_t(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===ce&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,r)}})}};st=new WeakMap;function nn(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ge,me=class me extends HTMLAnchorElement{constructor(){super();d(this,"masElement",new Mt(this));g(this,ge);this.setAttribute("is",me.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,i){this.masElement.attributeChangedCallback(e,r,i)}connectedCallback(){this.masElement.connectedCallback(),m(this,ge,se()),s(this,ge)&&(this.log=s(this,ge).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,ge,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=se();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:c,language:l,env:h}=r,p=`locale=${l}_${c}&country=${c}&offer_id=${o.offerId}`,u=this.getAttribute("data-promotion-code");u&&(p+=`&promotion_code=${encodeURIComponent(u)}`),this.href=`${nn(h)}?${p}`,this.masElement.toggleResolved(i,o,r)}catch(o){let c=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,c,r),!1}}static createFrom(e){let r=new me;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?r.setAttribute("class",i.value.replace("upt-link","").trim()):r.setAttribute(i.name,i.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};ge=new WeakMap,d(me,"is","upt-link"),d(me,"tag","a"),d(me,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var re=me;window.customElements.get(re.is)||window.customElements.define(re.is,re,{extends:re.tag});var on="#000000",cr="#F8D904",cn="#EAEAEA",sn="#31A547",ln=/(accent|primary|secondary)(-(outline|link))?/,dn="mas:product_code/",hn="daa-ll",Rt="daa-lh",pn=["XL","L","M","S"],sr="...",mn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function I(a,t,e,r){let i=r[a];if(t[a]&&i){let n={slot:i?.slot,...i?.attributes},o=t[a];if(i.maxCount&&typeof o=="string"){let[l,h]=Pn(o,i.maxCount,i.withSuffix);l!==o&&(n.title=h,o=l)}let c=L(i.tag,n,o);e.append(c)}}function gn(a,t,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,c)=>({icon:o,alt:a.mnemonicAlt?.[c]??"",link:a.mnemonicLink?.[c]??""}));i?.forEach(({icon:o,alt:c,link:l})=>{if(l&&!/^https?:/.test(l))try{l=new URL(`https://${l}`).href.toString()}catch{l="#"}let h={slot:"icons",src:o,loading:t.loading,size:e?.size??"l"};c&&(h.alt=c),l&&(h.href=l);let p=L("merch-icon",h);t.append(p)});let n=t.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function un(a,t,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let r=cr,i=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,a.borderColor||(i=!0));let n=a.badgeBackgroundColor||r,o=a.borderColor||"";i&&(o=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${n}" border-color="${o}">${a.badge}</merch-badge>`}I("badge",a,t,e)}else a.badge?(t.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",a.badgeColor||on),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",a.badgeBackgroundColor||cr),t.setAttribute("border-color",a.badgeBackgroundColor||cr)):t.setAttribute("border-color",a.borderColor||cn)}function fn(a,t,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||sn;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${r}">${a.trialBadge}</merch-badge>`}I("trialBadge",a,t,e)}}function vn(a,t,e){e?.includes(a.size)&&t.setAttribute("size",a.size)}function xn(a,t){a.cardName&&t.setAttribute("name",a.cardName)}function bn(a,t,e){a.cardTitle&&(a.cardTitle=qe(a.cardTitle)),I("cardTitle",a,t,{cardTitle:e})}function yn(a,t,e){I("subtitle",a,t,e)}function wn(a,t,e,r){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[a.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),t.setAttribute("background-color",a.backgroundColor)):r?.attribute&&a.backgroundColor&&(t.setAttribute(r.attribute,a.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function En(a,t,e){let r=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")t.style.setProperty(i,"transparent");else if(a.borderColor&&r){let o=r?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),c=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){t.setAttribute("gradient-border","true");let l=a.borderColor;if(r?.specialValues){for(let[h,p]of Object.entries(r.specialValues))if(p===a.borderColor){l=h;break}}t.setAttribute("border-color",l),t.style.removeProperty(i)}else c?(t.setAttribute("border-color",a.borderColor),t.style.setProperty(i,`var(--${a.borderColor})`)):t.style.setProperty(i,`var(--${a.borderColor})`)}}function kn(a,t,e){if(a.backgroundImage){let r={loading:t.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?r.alt=a.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,a.backgroundImage);return}t.append(L(e.tag,{slot:e.slot},L("img",r)))}}function qe(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(It(),Ft)).catch(console.error),a}function Sn(a,t,e){a.prices&&(a.prices=qe(a.prices)),I("prices",a,t,e)}function Ba(a,t,e){let r=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=ln.exec(i)?.[0]??"accent",o=n.includes("accent"),c=n.includes("primary"),l=n.includes("secondary"),h=n.includes("-outline"),p=n.includes("-link");a.classList.remove("accent","primary","secondary");let u;if(t.consonant)u=Nn(a,o,r,p,c,l,e?.ctas?.size);else if(p)u=a;else{let b;o?b="accent":c?b="primary":l&&(b="secondary"),u=t.spectrum==="swc"?On(a,e,h,b,r):Rn(a,e,h,b,r)}return u}function Cn(a,t){let{slot:e}=t?.description,r=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(i=>{let n=Ba(i,a,t);i.replaceWith(n)})}function An(a,t,e,r){a.description&&(a.description=qe(a.description)),a.promoText&&(a.promoText=qe(a.promoText)),a.shortDescription&&(a.shortDescription=qe(a.shortDescription)),I("promoText",a,t,e),I("description",a,t,e),I("shortDescription",a,t,e),a.shortDescription&&(t.setAttribute("action-menu","true"),a.actionMenuLabel||t.setAttribute("action-menu-label","More options")),Cn(t,e),I("callout",a,t,e),Tn(a,t,e,r),I("whatsIncluded",a,t,e)}function Tn(a,t,e,r={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=r.quantitySelect),I("quantitySelect",a,t,e))}function Ln(a,t,e,r={}){if(!e.addon)return;let n=(a.addon??r.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o=L("merch-addon",{slot:"addon"},n);[...o.querySelectorAll(y)].forEach(c=>{let l=c.parentElement;l?.nodeName==="P"&&l.setAttribute("data-plan-type","")}),t.append(o)}function zn(a,t,e){a.addonConfirmation&&I("addonConfirmation",a,t,e)}function _n(a,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function Pn(a,t,e=!0){try{let r=typeof a!="string"?"":a,i=$a(r);if(i.length<=t)return[r,i];let n=0,o=!1,c=e?t-sr.length<1?1:t-sr.length:t,l=[];for(let u of r){if(n++,u==="<")if(o=!0,r[n]==="/")l.pop();else{let b="";for(let z of r.substring(n)){if(z===" "||z===">")break;b+=z}l.push(b)}if(u==="/"&&r[n]===">"&&l.pop(),u===">"){o=!1;continue}if(!o&&(c--,c===0))break}let h=r.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let u of l.reverse())h+=`</${u}>`}return[`${h}${e?sr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=$a(i);return[i,n]}}function $a(a){if(!a)return"";let t="",e=!1;for(let r of a){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function Mn(a,t){t.querySelectorAll("a.upt-link").forEach(r=>{let i=re.createFrom(r);r.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function Rn(a,t,e,r,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of a.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",c=`spectrum-Button--${r}`,l=pn.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",h=["spectrum-Button",c,l];return e&&h.push("spectrum-Button--outline"),n.classList.add(...h),n}function On(a,t,e,r,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let c=L("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return c.source=n,(i?n.onceSettled():Promise.resolve(n)).then(l=>{c.setAttribute("data-navigation-url",l.href)}),c.addEventListener("click",l=>{l.defaultPrevented||n.click()}),c}function Nn(a,t,e,r,i,n,o){let c=a;if(e)try{let l=customElements.get("checkout-link");l&&(c=l.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return r||(c.classList.add("button","con-button"),o&&o!=="m"&&c.classList.add(`button-${o}`),t&&c.classList.add("blue"),i&&c.classList.add("primary"),n&&c.classList.add("secondary")),c}function Dn(a,t,e,r,i){if(a.ctas){a.ctas=qe(a.ctas);let{slot:n}=e.ctas,o=L("div",{slot:n},a.ctas),c=[...o.querySelectorAll("a")],l=i?.hideTrialCTAs?c.filter(p=>!mn.has(p.dataset.analyticsId)):c,h=(l.length>0?l:c).map(p=>Ba(p,t,e));o.textContent="",o.append(...h),t.append(o),i?.hideTrialCTAs&&l.length>0&&h.forEach(p=>{let u=p.source??p;u.onceSettled&&(p.hidden=!0,u.onceSettled().then(()=>{u.value?.[0]?.offerType==="TRIAL"&&h.some(z=>z!==p&&!z.hidden)?p.remove():p.hidden=!1}).catch(()=>{p.hidden=!1}))})}}function Fn(a,t){let{tags:e}=a,r=e?.find(n=>typeof n=="string"&&n.startsWith(dn))?.split("/").pop();if(!r)return;t.setAttribute(Rt,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(hn,`${n.dataset.analyticsId}-${o+1}`)})}function In(a){a.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{a.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function $n(a){a.querySelectorAll("[slot]").forEach(r=>{r.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","gradient-border","size",Rt].forEach(r=>a.removeAttribute(r));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function qa(a,t){if(!a){let l=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!a.fields){let l=a.id||"unknown",h=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'.`)}let{id:e,fields:r,settings:i={},priceLiterals:n}=a,{variant:o}=r;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);$n(t),t.compatVersion=r.compatVersion,t.contextPromotionCode=r.promoCode,t.settings=i,n&&(t.priceLiterals=n),t.id??(t.id=a.id),a.variationId&&t.setAttribute("variation-id",a.variationId??""),t.variant=o,await t.updateComplete;let{aemFragmentMapping:c}=t.variantLayout;if(!c)throw new Error(`hydrate: variant mapping not found for ${e}`);c.style==="consonant"&&t.setAttribute("consonant",!0),gn(r,t,c.mnemonics),fn(r,t,c),vn(r,t,c.size),xn(r,t),bn(r,t,c.title),un(r,t,c),yn(r,t,c),Sn(r,t,c),kn(r,t,c.backgroundImage),wn(r,t,c.allowedColors,c.backgroundColor),En(r,t,c),An(r,t,c,i),Ln(r,t,c,i),zn(r,t,c),_n(r,t,c,i);try{Mn(r,t)}catch{}Dn(r,t,c,o,i),Fn(r,t),In(t)}var Nt="merch-card",lr=2e4,Ha="merch-card:",Va=["full-pricing-express","simplified-pricing-express"],Wa=["segment","product"];function Ua(a,t){let e=a.closest(Nt);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.promotionCode),e.aemFragment&&(t[Pr]=!0),e.variantLayout?.priceOptionsProvider?.(a,t)}function Ga(a,t){let e=a.closest(Nt);if(!e)return t;!t.promotionCode&&e.compatVersion>=1&&(t.promotionCode=e.promotionCode)}function qn(a){a.providers.has(Ua)||a.providers.price(Ua),a.providers.has(Ga)||a.providers.checkout(Ga)}var lt=new IntersectionObserver(a=>{a.forEach(t=>{let e=t.target;if(Va.includes(e.variant)){if(e.clientHeight===0)return;lt.unobserve(e),e.requestUpdate();return}if(Wa.includes(e.variant)){if(t.boundingClientRect.width===0)return;if(e.variant==="product"&&e.querySelector('merch-icon[slot="icons"]')){lt.unobserve(e);return}let r=e.getBoundingClientRect().width,n=e.querySelector('[slot="badge"]')?.getBoundingClientRect().width||0;if(r===0||n===0){lt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(r-n-16)}px`),lt.unobserve(e)}})}),Hn=0,ht,He,Ue,Ge,V,fe,$,ve,S,ue,dt,dr,Ot,ae=class extends Bn{constructor(){super();g(this,S);g(this,ht);g(this,He);g(this,Ue);g(this,Ge);g(this,V);g(this,fe);g(this,$);g(this,ve,new Promise(e=>{m(this,$,e)}));d(this,"compatVersion");d(this,"customerSegment");d(this,"marketSegment");d(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}set contextPromotionCode(e){m(this,ht,e)}firstUpdated(){this.variantLayout=Yt(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=Yt(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){_(this,S,ue).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(y)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(Y)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(Y)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(Y)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let i of r){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let c=i.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&c.push(o),i.dataset.wcsOsi=c.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let i=n=>{let{offerType:o,planType:c}=n.value?.[0]??{};if(!o||!c)return;let l=e.getOsi(c,o),h=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==l);e.checked&&h.push(l),n.dataset.wcsOsi=h.join(",")};r.forEach(i)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let i of r)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(i=>{if(e){r[i].order=Math.min(r[i].order||2,2);return}let n=r[i].order;n===1||isNaN(n)||(r[i].order=Number(n)+1)}),this.filters=r}showInfoTooltip(e,r){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(r)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(r=>this.iconButton.addEventListener(r,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(r=>this.iconButton.addEventListener(r,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",r=>{r.key==="Escape"&&this.iconButton.classList.remove(e)}))}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),s(this,Ue)||m(this,Ue,Hn++),this.aemFragment||((r=s(this,$))==null||r.call(this),m(this,$,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??s(this,Ue);m(this,fe,`${Ha}${e}${ft}`),m(this,He,`${Ha}${e}${vt}`),performance.mark(s(this,fe)),m(this,V,se()),qn(s(this,V)),m(this,Ge,s(this,V).Log.module(Nt)),this.addEventListener(N,this.handleQuantitySelection),this.addEventListener($t,this.handleAddonAndQuantityUpdate),this.addEventListener(Er,this.handleMerchOfferSelectReady),this.addEventListener(we,this.handleAemFragmentEvents),this.addEventListener(ye,this.handleAemFragmentEvents),this.addEventListener(gt,this.handleInfoIconEvents),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(N,this.handleQuantitySelection),this.removeEventListener(we,this.handleAemFragmentEvents),this.removeEventListener(ye,this.handleAemFragmentEvents),this.removeEventListener(gt,this.handleInfoIconEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener($t,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===we&&_(this,S,ue).call(this,"AEM fragment cannot be loaded"),e.type===ye&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{s(this,$)||m(this,ve,new Promise(n=>{m(this,$,n)})),qa(i,this)}catch(n){_(this,S,ue).call(this,`hydration has failed: ${n.message}`)}finally{(r=s(this,$))==null||r.call(this),m(this,$,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;s(this,ve)&&(await s(this,ve),(Va.includes(this.variant)||Wa.includes(this.variant))&&lt.observe(this),m(this,ve,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(o=>setTimeout(()=>o("timeout"),lr));if(this.aemFragment){let o=await Promise.race([this.aemFragment.updateComplete,e]);if(o===!1||o==="timeout"){let c=o==="timeout"?`AEM fragment was not resolved within ${lr} timeout`:"AEM fragment cannot be loaded";_(this,S,ue).call(this,c,{},!1);return}}let r=[...this.querySelectorAll(wr)],i=Promise.all(r.map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(c=>c.classList.contains("placeholder-resolved"))),n=await Promise.race([i,e]);if(n===!0){this.measure=performance.measure(s(this,He),s(this,fe));let o={...this.aemFragment?.fetchInfo,...s(this,V).duration,measure:Ee(this.measure)};return this.dispatchEvent(new CustomEvent(gt,{bubbles:!0,composed:!0,detail:o})),this}else{this.measure=performance.measure(s(this,He),s(this,fe));let o={measure:Ee(this.measure),...s(this,V).duration};n==="timeout"?_(this,S,ue).call(this,`Contains offers that were not resolved within ${lr} timeout`,o):_(this,S,ue).call(this,"Contains unresolved offers",o)}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(Y)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let c=new URL(n.getAttribute("href")).searchParams.get("pa"),l=r.find(p=>p.productArrangementCode===c)?.quantity,h=!!r.find(p=>p.productArrangementCode!==c);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(Sr,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==h){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:h}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(y))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${y}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return s(this,S,dt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${y}[data-promotion-code],${Y}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return s(this,ht);let r=[...new Set(e)];return r.length>1&&s(this,Ge)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${y}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(s(this,S,dr)??s(this,S,dt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return s(this,S,dt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return s(this,S,dr)?.querySelector(e)?.textContent?.trim()??s(this,S,dt)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return _(this,S,Ot).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${Y}, a`);return Array.from(e??[])}get primaryCta(){return _(this,S,Ot).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return _(this,S,Ot).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};ht=new WeakMap,He=new WeakMap,Ue=new WeakMap,Ge=new WeakMap,V=new WeakMap,fe=new WeakMap,$=new WeakMap,ve=new WeakMap,S=new WeakSet,ue=function(e,r={},i=!0){var l;if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let c={...this.aemFragment.fetchInfo,...s(this,V).duration,...r,message:e};s(this,Ge).error(`merch-card${o}: ${e}`,c),this.failed=!0,(l=s(this,$))==null||l.call(this),m(this,$,void 0),s(this,V).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(Cr,{bubbles:!0,composed:!0,detail:c}))},dt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${y}[data-template="price"] > span`)},dr=function(){return this.querySelector(`${y}[data-template="legal"]`)},Ot=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},d(ae,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,i,n]=e.split(",");return{PUF:r,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[i,n,o]=r.split(":"),c=Number(n);return[i,{order:isNaN(c)?void 0:c,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:i,size:n}])=>[r,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Rt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),d(ae,"styles",[vr,...xr()]),d(ae,"registerVariant",k),d(ae,"getCollectionOptions",ua),d(ae,"getFragmentMapping",yt);customElements.define(Nt,ae);export{ae as MerchCard};

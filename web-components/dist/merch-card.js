...
`;var Lr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ge=class extends f{getGlobalCSS(){return ui}get aemFragmentMapping(){return Lr}renderLayout(){return Kn`
    ...
    `);import{html as zr,nothing as Zn}from"./lit-all.min.js";var fi={cardName:{attribute:"name"},image:{tag:"picture",slot:"image"},backgrounds:!0,title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},Xn=[{slot:"image",label:"Image"},{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Ve=class extends f{constructor(r){super(r)}getGlobalCSS(){return ae}renderLayout(){return zr`
        ...
        `}};d(We,"variantStyle",ie("faq"));import{html as xi}from"./lit-all.min.js";var yi={cardName:{attribute:"name"},image:{tag:"picture",slot:"image"},backgrounds:!0,title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},eo=[{slot:"image",label:"Image"},{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],Ye=class extends f{constructor(r){super(r)}getGlobalCSS(){return ae}renderLayout(){return xi`
            <div class="headless">

...
export const features = [
    ...
    {
        tcid: '8',
        name: '@MAS-CCD-mini-card-fr-au',
        path: DOCS_GALLERY_PATH.CCD_MINI.FR_AU,
        data: {
            fragment: '03a36f0f-3e5d-4881-ae6b-273c517c9d38',
            title: 'CCD Apps: Photography',
            regularPrice: 'A$95.99/mois',
            annualPrice: 'A$1,151.88/an',
            unitText: '',
            promoPrice: undefined,
            promotionCode: undefined,
            planTypeText: 'Annuel, facturé mensuellement',
            ...
            seeTerms: {
                text: 'Voir les conditions',
                analyticsId: 'see-terms',
                href: 'https://www.adobe.com/offers/promo-terms.html?locale=fr_AU&country=AU&offer_id=DDDCDEBA96799A274FA982669CA74623',
            },
            primaryCta: {
                text: "S'abonner",
                analyticsId: 'buy-now',
                href: 'https://commerce.adobe.com/store/segmentation?cli=adobe_com&ctx=fp&co=AU&lang=fr&ms=COM&ot=BASE&cs=INDIVIDUAL&pa=PA-130',
            },
            secondaryCta: {
                text: 'Essai gratuit',
                analyticsId: 'free-trial',
    ...
    {
        tcid: '9',
        name: '@MAS-CCD-mini-card-fr-au-annual',
        path: DOCS_GALLERY_PATH.CCD_MINI.FR_AU,
        data: {
            fragment: '77e049ee-c611-437b-bbeb-c54cf72605b1',
            title: 'CCD Apps: Photoshop Promo',
            regularPrice: 'A$419.89/an',
            promoPrice: 'A$209.90/an',
            unitText: '',
            promotionCode: 'PCEMAP50CCDC2',
            planTypeText: "Annuel, facturé à l'avance",
            recurrenceText: '/an',
            renewalText:
                "Renouvellement automatique jusqu'à annulation. Renouvellement à A$419.89/an TPS comprise après 12 mois.",
            promoDurationText: 'Première année seulement, se termine le 15 décembre.',
            seeTerms: {
                text: 'Voir les conditions',
                analyticsId: 'see-terms',
                href: 'https://www.adobe.com/offers/promo-terms.html?locale=fr_AU&country=AU&offer_id=944C3B11874FCDF227A558851C2698BB&promotion_code=PCEMAP50CCDC2',
            },
            primaryCta: {
                text: 'S’abonner',
                analyticsId: 'buy-now',
                href: 'https://commerce.adobe.com/store/segmentation?apc=PCEMAP50CCDC2&cli=adobe_com&ctx=fp&co=AU&lang=fr&ms=COM&ot=BASE&cs=INDIVIDUAL&pa=phsp_direct_individual',
            },
            secondaryCta: {
                text: 'Essai gratuit',
                analyticsId: 'free-trial',
                href: 'https://commerce.adobe.com/store/segmentation?cli=adobe_com&ctx=fp&co=AU&lang=fr&ms=COM&ot=BASE&cs=INDIVIDUAL&pa=phsp_direct_individual',
            },
        },
        tags: '@mas-docs @ccd-mini @commerce @smoke @regression @milo',
    },

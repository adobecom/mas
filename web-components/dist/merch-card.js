...
`,ir=()=>[tr`
        ...
        `];import{LitElement as Ai,html as ar,css as Ci}from"./lit-all.min.js";function Ti(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var he=class extends Ai{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Ti())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>St())}e.remove()})}render(){let{href:t}=this;return t?ar`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(he,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(he,"styles",Ci`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
...
`;var Dr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ae=class extends v{constructor(t){super(t)}getGlobalCSS(){return Or}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Pt`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?Pt`
                  ...
                  `:Pt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(Ae,"variantStyle",Hi`

...
`;if(!document.querySelector("style[data-mas-field]")){let e=document.createElement("style");e.setAttribute("data-mas-field",""),e.textContent=zt,document.head.append(e)}function Et(e,n=globalThis.location){return typeof e!="string"||!e?"":`<picture>${pt(e,n)}</picture>`}var b,w,_,f,N,s,v,B,W,q,gt,At,K,j,Tt,z,X,_t,R,St,bt,C,G=class extends HTMLElement{constructor(){super(...arguments);S(this,s);S(this,b,null);S(this,w,!1);S(this,_,null);Y(this,"settings",null);S(this,f,null);Y(this,"compatVersion");S(this,N,t=>{t.target===this.aemFragment&&(T(this,_,t.detail?.fields||null),this.settings=t.detail?.settings??null,T(this,w,!0),c(this,s,j).call(this),this.dispatchEvent(new CustomEvent(nt,{bubbles:!0,composed:!0,detail:t.detail})))})}static get observedAttributes(){return["field"]}attributeChangedCallback(t,o,r){t==="field"&&(T(this,b,r),c(this,s,j).call(this))}connectedCallback(){this.addEventListener(y,p(this,N)),c(this,s,v).call(this),this.aemFragment?.setAttribute("hidden",""),jt(st())}disconnectedCallback(){this.removeEventListener(y,p(this,N))}checkReady(){return p(this,w)?Promise.resolve(!0):new Promise(t=>{this.addEventListener(y,()=>t(!0),{once:!0})})}get aemFragment(){return this.querySelector("aem-fragment")}get osi(){return ct(this)}};b=new WeakMap,w=new WeakMap,_=new WeakMap,f=new WeakMap,N=new WeakMap,s=new WeakSet,v=function(){if(p(this,f)?.isConnected&&p(this,f).matches('[data-role="mas-field-content"]'))return p(this,f);let t=this.querySelector(':scope > [data-role="mas-field-content"]');if(t)return T(this,f,t),t;let o=document.createElement("span");return o.setAttribute("data-role","mas-field-content"),this.append(o),T(this,f,o),o},B=function(){this.querySelector(':scope > [data-role="mas-field-content"]')?.remove(),T(this,f,null)},W=function(t){let o=document.createElement("template");o.innerHTML=t;let r=o.content.querySelector("picture");if(!r)return;r.innerHTML=ut(r.innerHTML),r.setAttribute("data-role","mas-field-content");let i=this.querySelector(':scope > [data-role="mas-field-content"]');i?i.replaceWith(r):this.append(r),T(this,f,r),c(this,s,R).call(this,r)},q=function(t){return t&&typeof t=="object"&&"value"in t?t.value:t},gt=function(t){let o=t?.match(/^(.+)\[(\d+)\]$/);if(o)return{fieldName:o[1],index:parseInt(o[2],10)};let r=t?.match(/^(.+)\[(.+)\]$/);return r?{fieldName:r[1],index:r[2]}:{fieldName:t,index:null}},At=function(t,o){if(typeof t!="string")return null;let r=document.createElement("template");r.innerHTML=t;let i;if(!isNaN(o)){let l=parseInt(o,10);i=[...r.content.querySelectorAll("a")][l-1]}return i||(i=r.content.querySelector(`a[data-key="${o}"]`)),i?(i.removeAttribute("class"),i.outerHTML):null},K=function(){if(!this.aemFragment)return;this.setAttribute("fragment-id",this.aemFragment.data?.id);let t=this.aemFragment.data;t&&(t.variationId&&this.setAttribute("variation-id",t.variationId),t.maskId&&this.setAttribute("mask-id",t.maskId),t.promoProject&&this.setAttribute("data-promotion-project",t.promoProject),t.promoVariationProject&&this.setAttribute("data-promotion-variation-project",t.promoVariationProject),this.compatVersion=t.fields?.compatVersion,t.fields?.promoCode&&this.setAttribute("data-promotion-code",t.fields.promoCode))},j=function(){if(!p(this,_)||!p(this,b))return;this.hidden=!1;let{fieldName:t,index:o}=c(this,s,gt).call(this,p(this,b));if(o!==null&&isNaN(o)){let a=`${t.replace(/s$/,"")}Labels`,d=p(this,_)[a];if(d!==void 0){let h=(Array.isArray(d)?d:[d]).indexOf(o);if(h===-1){this.hidden=!0;return}let m=p(this,_)[t],u=Array.isArray(m)?m:m?[m]:[],g=c(this,s,q).call(this,u[h]);if(!g){this.hidden=!0;return}if(t==="ctas"&&this.settings?.hideTrialCTAs&&(g=ht(g,!0),g===null)){this.hidden=!0;return}c(this,s,K).call(this);let x=c(this,s,v).call(this);x.innerHTML=c(this,s,C).call(this,g)??"",c(this,s,z).call(this,x),c(this,s,X).call(this,x),c(this,s,R).call(this,x);return}}let r=c(this,s,q).call(this,p(this,_)[t]);if(r===void 0){this.hidden=!0;return}if(c(this,s,K).call(this),o===null&&(t==="image"||t==="backgroundImage"||t==="backgrounds")){let a=c(this,s,C).call(this,r);if(typeof a=="string"&&a){let d=t==="image"||t==="backgrounds"?a:`<img loading="lazy" alt="" src="${$(a)}">`;c(this,s,W).call(this,Et(d))}else c(this,s,B).call(this),this.hidden=!0;return}if(t==="backgrounds"&&o!==null){let a=c(this,s,C).call(this,mt(r,o)),d=typeof a=="string"&&a?dt(a):"";d?c(this,s,W).call(this,Et(d)):(c(this,s,B).call(this),this.hidden=!0);return}let i=c(this,s,v).call(this),l;if(o!==null){if(l=c(this,s,At).call(this,r,o),l===null){this.hidden=!0;return}}else l=c(this,s,C).call(this,r);if(typeof l=="string"){if(t==="ctas"&&this.settings?.hideTrialCTAs&&(l=ht(l,o!==null),l===null)){this.hidden=!0;return}if(p(this,b)==="ctas"){let a=c(this,s,bt).call(this,l);if(a){i.replaceChildren(a),c(this,s,R).call(this,i);return}}i.innerHTML=l,c(this,s,z).call(this,i),c(this,s,X).call(this,i),c(this,s,R).call(this,i);return}if(l==null){this.hidden=!0;return}i.textContent=String(l)},Tt=function(t,o){return customElements.get("checkout-link")?.createCheckoutLink(t,o)??(()=>{let i=document.createElement("a",{is:"checkout-link"});return i.setAttribute("is","checkout-link"),i.innerHTML=`<span style="pointer-events: none;">${o}</span>`,i})()},z=function(t){for(let o of t.querySelectorAll("a[data-wcs-osi]:not([is])")){let r=c(this,s,Tt).call(this,o.dataset,o.innerHTML);for(let{name:i,value:l}of o.attributes)["is","href"].includes(i)||r.setAttribute(i,l);o.replaceWith(r)}},X=function(t){let o=t.querySelectorAll(".icon-button[data-tooltip]");for(let r of o){if(r.dataset.tooltipWired)continue;r.dataset.tooltipWired="1",r.querySelector("svg")||r.insertAdjacentHTML("afterbegin",'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" height="18" width="18" class="icon-milo icon-milo-info" aria-hidden="true"><path fill="currentcolor" d="M10.075,6A1.075,1.075,0,1,1,9,4.925H9A1.075,1.075,0,0,1,10.075,6Zm.09173,6H10V8.2A.20005.20005,0,0,0,9.8,8H7.83324S7.25,8.01612,7.25,8.5c0,.48365.58325.5.58325.5H8v3H7.83325s-.58325.01612-.58325.5c0,.48365.58325.5.58325.5h2.3335s.58325-.01635.58325-.5C10.75,12.01612,10.16673,12,10.16673,12ZM9,.5A8.5,8.5,0,1,0,17.5,9,8.5,8.5,0,0,0,9,.5ZM9,15.6748A6.67481,6.67481,0,1,1,15.67484,9,6.67481,6.67481,0,0,1,9,15.6748Z"></path></svg>'),r.hasAttribute("tabindex")||r.setAttribute("tabindex","0"),r.hasAttribute("role")||r.setAttribute("role","button"),r.hasAttribute("aria-label")||r.setAttribute("aria-label",r.dataset.tooltip);let i=["top","bottom","left","right"],l=[...r.classList].find(h=>i.includes(h)),a=l||"top";l||r.classList.add(a),r.dataset.originalPosition=a,r.classList.add("hide-tooltip");let d=()=>{r.classList.remove("hide-tooltip"),c(this,s,_t).call(this,r)},E=()=>r.classList.add("hide-tooltip");r.addEventListener("mouseenter",d),r.addEventListener("focus",d),r.addEventListener("mouseleave",E),r.addEventListener("blur",E),r.addEventListener("keydown",h=>{h.key==="Escape"&&E()})}},_t=function(t){let o=["top","bottom","right","left"],r=window.innerWidth,i=12,l=document.querySelector("header")?.getBoundingClientRect().height||0,a=window.getComputedStyle(t,"::before"),d=k=>parseFloat(k)||0,E=d(a.width)+d(a.paddingLeft)+d(a.paddingRight),h=d(a.height)+d(a.paddingTop)+d(a.paddingBottom),m=t.getBoundingClientRect(),u=t.dataset.originalPosition||"top",g=o.find(k=>t.classList.contains(k)),J=u==="top"||u==="bottom"?E/2:E,xt=u==="top"?h+(u==="top"?i:0):h/2,O=m.top-xt<l,H=m.bottom+(u==="bottom"?h+i:0)>window.innerHeight,L=m.right+J+i>r,M=m.left-J-i<0,D=m.left+E/2+i>r,U=m.left-E/2-i<0;if(u!==g&&!(L||M||O||H||D||U)){t.classList.remove(...o),t.classList.add(u);return}let A=u;L&&D?A="left":M&&U?A="right":L&&O||M&&O?A=D&&"left"||U&&"right"||"bottom":L!==M&&!H?A=L?"left":"right":O&&["top","left","right"].includes(u)?A="bottom":H&&["bottom","left","right"].includes(u)&&(A="top"),g!==A&&(t.classList.remove(...o),t.classList.add(A))},R=function(t){let o=t.querySelectorAll('a[data-wcs-osi],button[is="checkout-button"],span[is="inline-price"]');if(!o.length)return;let r=(i,l)=>{if(l!=null)for(let a of o)a.hasAttribute(i)||a.setAttribute(i,l)};for(let i of qt)r(i,this.getAttribute(i));r("data-promotion-code",Q(this))},St=function(t){if(!!!t.getAttribute("data-wcs-osi"))return t.cloneNode(!0);let i=customElements.get("checkout-link")?.createCheckoutLink(t.dataset,t.textContent)??(()=>{let a=document.createElement("a",{is:"checkout-link"});return a.innerHTML=`<span style="pointer-events: none;">${t.textContent}</span>`,a})();for(let{name:a,value:d}of t.attributes)["class","is","href"].includes(a)||i.setAttribute(a,d);if(i.firstElementChild?.classList.add("spectrum-Button-label"),t.className){let a=Wt.exec(t.className)?.[0]??"accent",d=a.startsWith("accent");return a.includes("-link")||(i.classList.add("button","con-button"),d?i.classList.add("blue"):a.startsWith("primary")&&!a.includes("-outline")&&i.classList.add("fill")),i}let l=t.parentElement?.tagName;if(l==="STRONG"||l==="EM"){let a=document.createElement(l.toLowerCase());return a.append(i),a}return i},bt=function(t){let r=[...new DOMParser().parseFromString(t,"text/html").body.querySelectorAll("a")];if(!r.length)return null;let i=document.createElement("div");return i.setAttribute("slot","footer"),i.append(...r.map(l=>c(this,s,St).call(this,l))),i},C=function(t){if(typeof t!="string")return t;let o=t.trim();if(!(o.startsWith("<p>")&&o.endsWith("</p>")))return t;let i=o.slice(3,-4);return i.includes("<p>")?t:i};customElements.define(Z,G);export{Kt as checkoutOptionsProvider,ft as priceOptionsProvider,Et as renderImageMarkup};

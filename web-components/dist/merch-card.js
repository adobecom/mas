...
`;var Dt=class extends v{constructor(r){super(r)}getGlobalCSS(){return ia}renderLayout(){return na` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":na`<hr />`} ${this.secureLabelFooter}`}};import{html as ie,css as Wi,unsafeCSS as sa}from"./lit-all.min.js";var oa=`
  :root {
...
`;var Ki=32,ca={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Oe=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ie`<slot name="secure-transaction-label">
    ...
    `);import{html as Nt,css as Yi,unsafeCSS as da,nothing as Qi}from"./lit-all.min.js";var la=`
  :root {
...
`;var Zi=32,ha={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},De=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Nt` <footer>
    ...
    `);import{html as ot,css as Xi,nothing as Ft}from"./lit-all.min.js";var pa=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?X`
        ...
        `:X`
            ...
            `:$t}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?X`<slot name="icons"></slot>`:$t}get secureLabelFooter(){return X`<footer>
            ...
            <slot></slot>`}};h(ne,"variantStyle",Ji`
...
`;var[wc,Ec,xa,ya,wa,Ea]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var ka={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},J,ue,ht,T,Ca,ct,Sa,lt,or,Bt,Ht=class Ht extends v{constructor(){super(...arguments);u(this,T);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,J,null);u(this,ue,null);h(this,"lastSyncKey",null);u(this,ht,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of y(this,T,Ca).call(this)){let n=i.variantLayout;n instanceof Ht&&(n.expanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?y(this,T,or).call(this):y(this,T,lt).call(this),this.card.requestUpdate()});u(this,Bt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case ya:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:y(this,T,lt).call(this);break;case xa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:y(this,T,lt).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case wa:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}y(this,T,lt).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),y(this,T,or).call(this);break;case Ea:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,y(this,T,ct).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(O,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return ba}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(j,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]')?.querySelector(".price-plan-type");i&&(i.textContent=e)}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=`--consonant-merch-card-${t}-top-card-height`,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(s=>s.getBoundingClientRect().width>2&&s.variantLayout?.card?.heightSync!==!1),o=new Map;for(let s of n){let c=o.get(s.offsetTop)??[];c.push(s),o.set(s.offsetTop,c)}for(let s of o.values()){let c=0;for(let d of s){d.style.removeProperty(i);let p=d.shadowRoot?.querySelector(".top-card");p&&(c=Math.max(c,parseInt(getComputedStyle(p).height)||0))}c>0&&s.length>1&&s.forEach(d=>d.style.setProperty(i,`${c}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),i=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Je,l(this,ht)),typeof ResizeObserver>"u"))return;m(this,ue,new ResizeObserver(()=>this.resyncOnReflow())),l(this,ue).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&l(this,ue).observe(e)}disconnectedCallbackHook(){y(this,T,ct).call(this),l(this,ue)?.disconnect(),this.card?.removeEventListener(Je,l(this,ht))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t)return null;let o=[];for(let s=t;s<=i;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return oe`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return oe`
        ...
        `}renderLayout(){let e=!!this.expanded;return oe`
            ...
            ${this.hasWhatsIncluded?oe`
                  ...
                  `:st}
            <slot></slot>
        `}};J=new WeakMap,ue=new WeakMap,ht=new WeakMap,T=new WeakSet,Ca=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},ct=function(){l(this,J)&&(document.removeEventListener("mousedown",l(this,J)),m(this,J,null))},Sa=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},lt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=y(this,T,Sa).call(this),l(this,J)||(m(this,J,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),y(this,T,ct).call(this))}),document.addEventListener("mousedown",l(this,J)))},or=function(){this.licenseOpen=!1,y(this,T,ct).call(this)},Bt=new WeakMap,h(Ht,"variantStyle",en`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var dt=Ht;import{html as sr,css as tn}from"./lit-all.min.js";var Aa=`
:root {
...
`;var za={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},K,Ne=class extends v{constructor(e){super(e);u(this,K);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Aa}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return sr` ${this.badge}
    ...
    `);import{html as cr,css as rn}from"./lit-all.min.js";var Ta=`
:root {
...
`;var _a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ie=class extends v{constructor(r){super(r)}getGlobalCSS(){return Pa}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return an`
    ...
    `);import{html as lr,css as on}from"./lit-all.min.js";var Ma=`
:root {
...
`;var hr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},pt=class pt extends v{getGlobalCSS(){return Da}get aemFragmentMapping(){return hr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Na`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let e=window.getComputedStyle(r),t=`${e.fontWeight} ${e.fontSize} ${e.fontFamily}`;await document.fonts.load(t,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let r=pt.SYNCED_SECTIONS.map(s=>({name:s,getElement:c=>c.shadowRoot?.querySelector(`.${s}`)})),e=this.getContainer(),t=e?e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(t,s=>s.querySelectorAll(i).length)),o=Array.from({length:n},(s,c)=>({name:`description-row-${c}`,getElement:d=>d.querySelectorAll(i)[c]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=49;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let e=this.card.querySelector(this.headingSelector),t=e?Math.round(e.getBoundingClientRect().height):0,i=`${Math.round(r)}:${t}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return Na`
            ...
            <slot></slot>
        `}};h(pt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),h(pt,"variantStyle",ln`
    ...
    `);var mt=pt;import{html as pr,css as dn,nothing as hn}from"./lit-all.min.js";var Fa=`
...
`;var mr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},vn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],qt,qa,Ue=class extends v{constructor(e){super(e);u(this,qt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ha}get aemFragmentMapping(){return mr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,qt,qa).call(this))}renderLayout(){return un`
            <div class="card">
            ...
            <slot></slot>
        `}};qt=new WeakSet,qa=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;vn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ue,"variantStyle",fn`
...
`;var gr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ge=class extends v{getGlobalCSS(){return Ua}get aemFragmentMapping(){return gr}renderLayout(){return bn`
    ...
    `);var Ut=new Map,Ga=new WeakMap,ja=new Map,S=(a,r,e=null,t=null,i)=>{Ut.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",Re,ta,Re.variantStyle);S("image",ge);S("inline-heading",Dt);S("mini-compare-chart",Oe,ca,Oe.variantStyle);S("mini-compare-chart-mweb",De,ha,De.variantStyle);S("plans",D,It,D.variantStyle,D.collectionOptions);S("plans-students",D,ga,D.variantStyle,D.collectionOptions);S("plans-education",D,ma,D.variantStyle,D.collectionOptions);S("plans-v2",ne,va,ne.variantStyle,ne.collectionOptions);S("bizpro",dt,ka,dt.variantStyle);S("product",Ne,za,Ne.variantStyle);S("segment",Fe,La,Fe.variantStyle);S("media",Ie,_a,Ie.variantStyle);S("headless",He,Ia,He.variantStyle);S("special-offers",$e,Ra,$e.variantStyle);S("simplified-pricing-express",Be,dr,Be.variantStyle);S("full-pricing-express",mt,hr,mt.variantStyle);S("mini",qe,Ba,qe.variantStyle);S("image",ge,aa,ge.variantStyle);S("compare-chart-column",Ue,mr,Ue.variantStyle);S("fries",Ge,gr,Ge.variantStyle);var yn=(a,r,e)=>{try{let t=ja.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),ja.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},ur=a=>{let r=Ut.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=Ga.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?yn(a,t,i):{};return Ga.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Ot(a){return Ut.get(a)?.fragmentMapping}function Va(a){return Ut.get(a)?.collectionOptions}var Wa=document.createElement("style");Wa.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var fe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ya=1e3;function kn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Qa(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!fe.serializableTypes.includes(e))return e}return a}function Cn(a,r){if(!fe.ignoredProperties.includes(a))return Qa(r)}var vr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(kn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(Qa).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${fe.delimiter}page=${o}${s}`;c.length>Ya&&(c=`${c.slice(0,Ya)}<trunc>`),n+=c,i.length&&(n+=`${fe.delimiter}facts=`,n+=JSON.stringify(i,Cn)),window.lana?.log(n,fe)}};function Za(a){Object.assign(fe,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in fe&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Xa={LOCAL:"local",PROD:"prod",STAGE:"stage"},br={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},xr=new Set,yr=new Set,Ja=new Map,ei={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},ti={filter:({level:a})=>a!==br.DEBUG},Sn={filter:()=>!1};function An(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&jt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function zn(a){[...yr].every(r=>r(a))&&xr.forEach(r=>r(a))}function ri(a){let r=(Ja.get(a)??0)+1;Ja.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>ri(`${t.namespace}/${i}`),updateConfig:Za};return Object.values(br).forEach(i=>{t[i]=(n,...o)=>zn(An(i,n,a,o,e))}),Object.seal(t)}function Vt(...a){a.forEach(r=>{let{append:e,filter:t}=r;jt(t)&&yr.add(t),jt(e)&&xr.add(e)})}function Tn(a={}){let{name:r}=a,e=Ka(Gt("commerce.debug",{search:!0,storage:!0}),r===Xa.LOCAL);return Vt(e?ei:ti),r===Xa.PROD&&Vt(vr),gt}function Ln(){xr.clear(),yr.clear()}var gt={...ri(Qr),Level:br,Plugins:{consoleAppender:ei,debugFilter:ti,quietFilter:Sn,lanaAppender:vr},init:Tn,reset:Ln,use:Vt};var Pn="mas-commerce-service",Cd=gt.module("utilities"),_n={requestId:Lt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Wt=a=>window.setTimeout(a);function wr(){return document.getElementsByTagName(Pn)?.[0]}function ai(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(_n)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function ii(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,t*(n+1)))}throw i}var ni="fragment",oi="author",si="preview",ci="loading",li="timeout",Er="aem-fragment",di="eager",hi="cache",Mn=[di,hi],Y,ve,H,kr=class{constructor(){u(this,Y,new Map);u(this,ve,new Map);u(this,H,new Map)}clear(){l(this,Y).clear(),l(this,ve).clear(),l(this,H).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(l(this,Y).set(r.id,r),r.fields?.originalId&&l(this,Y).set(r.fields.originalId,r),l(this,H).has(r.id)){let[,t]=l(this,H).get(r.id);t()}if(l(this,H).has(r.fields?.originalId)){let[,t]=l(this,H).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return l(this,Y).has(r)}entries(){return l(this,Y).entries()}get(r){return l(this,Y).get(r)}getAsPromise(r){let[e]=l(this,H).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),l(this,H).set(r,[e,t]),e}getFetchInfo(r){let e=l(this,ve).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},l(this,ve).set(r,e)),e}remove(r){l(this,Y).delete(r),l(this,ve).delete(r),l(this,H).delete(r)}};Y=new WeakMap,ve=new WeakMap,H=new WeakMap;var ce=new kr,je,I,ee,F,N,L,ut,ft,q,vt,bt,Ve,U,pi,mi,Cr,gi,Kt=class extends HTMLElement{constructor(){super(...arguments);u(this,U);h(this,"cache",ce);u(this,je);u(this,I,null);u(this,ee,null);u(this,F,null);u(this,N);u(this,L);u(this,ut,di);u(this,ft,5e3);u(this,q);u(this,vt,!1);u(this,bt,0);u(this,Ve)}static get observedAttributes(){return[ni,ci,li,oi,si]}attributeChangedCallback(e,t,i){e===ni&&(m(this,N,i),m(this,L,ce.getFetchInfo(i))),e===ci&&Mn.includes(i)&&m(this,ut,i),e===li&&m(this,ft,parseInt(i,10)),e===oi&&m(this,vt,["","true"].includes(i)),e===si&&m(this,Ve,i)}connectedCallback(){if(!l(this,q)){if(l(this,F)??m(this,F,pe(this)),m(this,Ve,l(this,F).settings?.preview),l(this,je)??m(this,je,l(this,F).log.module(`${Er}[${l(this,N)}]`)),!l(this,N)||l(this,N)==="#"){l(this,L)??m(this,L,ce.getFetchInfo("missing-fragment-id")),y(this,U,Cr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(l(this,L)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(l(this,q)&&!await Promise.race([l(this,q),Promise.resolve(!1)]))return;e&&ce.remove(l(this,N)),l(this,ut)===hi&&await Promise.race([ce.getAsPromise(l(this,N)),new Promise(s=>setTimeout(s,l(this,ft)))]);try{m(this,q,y(this,U,gi).call(this)),await l(this,q)}catch(s){return y(this,U,Cr).call(this,s.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=l(this,I)||{};return o&&!Gt("mas.disableWcsCache")&&l(this,F).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ze,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...l(this,L)},bubbles:!0,composed:!0})),l(this,q)}get updateComplete(){return l(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return l(this,ee)?l(this,ee):(l(this,vt)?this.transformAuthorData():this.transformPublishData(),l(this,ee))}get rawData(){return l(this,I)}transformAuthorData(){let{fields:e,id:t,tags:i,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:d={}}=l(this,I);m(this,ee,e.reduce((p,{name:g,multiple:f,values:C})=>(p.fields[g]=f?C:C[0],p),{fields:{},id:t,tags:i,settings:o,priceLiterals:s,dictionary:c,placeholders:d,variationId:n}))}transformPublishData(){if(!l(this,I))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:d}=l(this,I);m(this,ee,Object.entries(e).reduce((p,[g,f])=>(p.fields[g]=f?.mimeType?f.value:f??"",p),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:d}))}getFragmentClientUrl(){let t=new URLSearchParams(window.location.search).get("maslibs");if(!t||t.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=t.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:l(this,F).settings.locale,apiKey:l(this,F).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??l(this,F).settings.instant;return n&&(i.instant=n),await t(l(this,N),i)}};je=new WeakMap,I=new WeakMap,ee=new WeakMap,F=new WeakMap,N=new WeakMap,L=new WeakMap,ut=new WeakMap,ft=new WeakMap,q=new WeakMap,vt=new WeakMap,bt=new WeakMap,Ve=new WeakMap,U=new WeakSet,pi=async function(e){Rr(this,bt)._++;let t=`${Er}:${l(this,N)}:${l(this,bt)}`,i=`${t}${Pt}`,n=`${t}${_t}`;if(l(this,Ve)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new se(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(l(this,L).stale=!1,l(this,L).url=e,o=await ii(e,{cache:"default",credentials:"omit"}),y(this,U,mi).call(this,o),l(this,L).status=o?.status,l(this,L).measure=Le(performance.measure(n,i)),l(this,L).retryCount=o.retryCount,!o?.ok)throw new se("Unexpected fragment response",{response:o,...l(this,F).duration});return await o.json()}catch(s){if(l(this,L).measure=Le(performance.measure(n,i)),l(this,L).retryCount=s.retryCount,l(this,I))return l(this,L).stale=!0,l(this,je).error("Serving stale data",l(this,L)),l(this,I);let c=s.message??"unknown";throw new se(`Failed to fetch fragment: ${c}`,{})}},mi=function(e){Object.assign(l(this,L),ai(e))},Cr=function(e){m(this,q,null),l(this,L).message=e,this.classList.add("error");let t={...l(this,L),...l(this,F).duration};l(this,je).error(e,t),this.dispatchEvent(new CustomEvent(Te,{detail:t,bubbles:!0,composed:!0}))},gi=async function(){var c;this.classList.remove("error"),m(this,ee,null);let e=ce.get(l(this,N));if(e)return m(this,I,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=l(this,F).settings,s=`${t}/fragment?id=${l(this,N)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await y(this,U,pi).call(this,s),(c=e.fields).originalId??(c.originalId=l(this,N)),ce.add(e),m(this,I,e),!0},h(Kt,"cache",ce);customElements.define(Er,Kt);import{LitElement as Rn,html as Sr,css as On,nothing as Dn}from"./lit-all.min.js";import{unsafeHTML as Nn}from"./lit-all.min.js";var Fn=a=>a?a.startsWith("sp-icon-")?Sr`${Nn(`<${a} class="badge-icon"></${a}>`)}`:Sr`<img src="${a}" class="badge-icon" />`:Dn,We=class extends Rn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Sr`<div class="badge">
    ...
    `);customElements.define("merch-badge",We);import{html as In,css as $n,LitElement as Bn}from"./lit-all.min.js";var xt=class extends Bn{constructor(){super()}render(){return In`
            <slot name="icon"></slot>

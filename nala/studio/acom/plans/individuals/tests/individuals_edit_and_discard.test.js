...
test.describe('M@S Studio ACOM Plans Individuals card test suite', () => {
    ...
    //     await test.step('step-2: Add phone link to the description', async () => {
    ...
    //     await test.step('step-3: Validate phone link addition in Editor panel', async () => {
    //         await expect(await editor.description.locator(editor.phoneLink)).toHaveText(data.phoneNumber);
    //     });

    //     await test.step('step-4: Validate phone link addition on the card', async () => {
    ...
    //     await test.step('step-6: Verify no phone number is added to the card', async () => {

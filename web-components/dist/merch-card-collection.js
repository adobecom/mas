var Ca=Object.defineProperty;var Ta=e=>{throw TypeError(e)};var Ls=(e,r,t)=>r in e?Ca(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Ms=(e,r)=>{for(var t in r)Ca(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Ls(e,typeof r!="symbol"?r+"":r,t),jr=(e,r,t)=>r.has(e)||Ta("Cannot "+t);var v=(e,r,t)=>(jr(e,r,"read from private field"),t?t.call(e):r.get(e)),z=(e,r,t)=>r.has(e)?Ta("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),L=(e,r,t,i)=>(jr(e,r,"write to private field"),i?i.call(e,t):r.set(e,t),t),j=(e,r,t)=>(jr(e,r,"access private method"),t);import{html as Pe,LitElement as bs,css as ys,unsafeCSS as xs,nothing as fe}from"./lit-all.min.js";var N="(max-width: 767px)",Z="(max-width: 1199px)",I="(min-width: 768px)",T="(min-width: 1200px)",J="(min-width: 1600px)",ka="(min-width: 1280px)",_a={matchMobile:window.matchMedia(N),matchDesktop:window.matchMedia(`${T} and (not ${J})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(J),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},k=_a;function nr(){return _a.isDesktop}var At=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var Pa="hashchange";function zs(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let i of t){let[a,n=""]=i.split("=");a&&r.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function Ct(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([a,n])=>{n?r.set(a,n):r.delete(a)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,i)}function La(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=zs(window.location.hash);e(t)};return r(),window.addEventListener(Pa,r),()=>{window.removeEventListener(Pa,r)}}var xi={};Ms(xi,{CLASS_NAME_FAILED:()=>ri,CLASS_NAME_HIDDEN:()=>Ns,CLASS_NAME_PENDING:()=>ii,CLASS_NAME_RESOLVED:()=>ai,CheckoutWorkflow:()=>Xs,CheckoutWorkflowStep:()=>ae,Commitment:()=>Fe,ERROR_MESSAGE_BAD_REQUEST:()=>ni,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>js,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>oi,EVENT_AEM_ERROR:()=>ei,EVENT_AEM_LOAD:()=>Jr,EVENT_COMPARE_CHART_REHYDRATE:()=>qs,EVENT_EXPANDED_GROUPS_CHANGE:()=>Vs,EVENT_MAS_ERROR:()=>ti,EVENT_MAS_READY:()=>cr,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>$s,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Xr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>me,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Zr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Tt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Kr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>sr,EVENT_MERCH_OFFER_READY:()=>Ds,EVENT_MERCH_OFFER_SELECT_READY:()=>Hs,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ie,EVENT_MERCH_SEARCH_CHANGE:()=>Gs,EVENT_MERCH_SIDENAV_SELECT:()=>Qr,EVENT_MERCH_STOCK_CHANGE:()=>Fs,EVENT_MERCH_STORAGE_CHANGE:()=>Us,EVENT_OFFER_SELECTED:()=>Bs,EVENT_TYPE_FAILED:()=>si,EVENT_TYPE_READY:()=>or,EVENT_TYPE_RESOLVED:()=>Le,Env:()=>ve,FF_ANNUAL_PRICE:()=>rt,FF_DEFAULTS:()=>Se,HEADER_X_REQUEST_ID:()=>kt,LOG_NAMESPACE:()=>ci,Landscape:()=>ze,MARK_DURATION_SUFFIX:()=>fi,MARK_START_SUFFIX:()=>gi,MERCH_CARD_LOAD_TIMEOUT:()=>Wr,MODAL_TYPE_3_IN_1:()=>Ue,NAMESPACE:()=>Rs,PARAM_AOS_API_KEY:()=>Ws,PARAM_ENV:()=>di,PARAM_LANDSCAPE:()=>hi,PARAM_MAS_PREVIEW:()=>li,PARAM_WCS_API_KEY:()=>Ys,PROVIDER_ENVIRONMENT:()=>ui,SELECTOR_MAS_CHECKOUT_LINK:()=>Ma,SELECTOR_MAS_ELEMENT:()=>Yr,SELECTOR_MAS_INLINE_PRICE:()=>W,SELECTOR_MAS_SP_BUTTON:()=>Is,SELECTOR_MAS_UPT_LINK:()=>za,SORT_ORDER:()=>ge,STATE_FAILED:()=>ue,STATE_PENDING:()=>Me,STATE_RESOLVED:()=>Ee,SUPPORTED_COUNTRIES:()=>vi,TAG_NAME_SERVICE:()=>Os,TEMPLATE_PRICE:()=>Ks,TEMPLATE_PRICE_ANNUAL:()=>Qs,TEMPLATE_PRICE_LEGAL:()=>ee,TEMPLATE_PRICE_STRIKETHROUGH:()=>Zs,Term:()=>he,WCS_PROD_URL:()=>pi,WCS_STAGE_URL:()=>mi});var Fe=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),he=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Rs="merch",Wr=2e4,Ns="hidden",or="wcms:commerce:ready",Os="mas-commerce-service",W='span[is="inline-price"][data-wcs-osi]',Ma='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Is="sp-button[data-wcs-osi]",za='a[is="upt-link"]',Yr=`${W},${Ma},${za}`,Ds="merch-offer:ready",Hs="merch-offer-select:ready",Xr="merch-card:action-menu-toggle",Bs="merch-offer:selected",Fs="merch-stock:change",Us="merch-storage:change",ie="merch-quantity-selector:change",sr="merch-card-quantity:change",$s="merch-modal:addon-and-quantity-update",Gs="merch-search:change",Kr="merch-card-collection:sort",me="merch-card-collection:literals-changed",Tt="merch-card-collection:sidenav-attached",Zr="merch-card-collection:showmore",Qr="merch-sidenav:select",Jr="aem:load",ei="aem:error",cr="mas:ready",ti="mas:error",qs="mas-compare-chart:rehydrate",Vs="expanded-groups-change",ri="placeholder-failed",ii="placeholder-pending",ai="placeholder-resolved",ni="Bad WCS request",oi="Commerce offer not found",js="Literals URL not provided",si="mas:failed",Le="mas:resolved",ci="mas/commerce",li="mas.preview",di="commerce.env",hi="commerce.landscape",Ws="commerce.aosKey",Ys="commerce.wcsKey",pi="https://www.adobe.com/web_commerce_artifact",mi="https://www.stage.adobe.com/web_commerce_artifact_stage",ue="failed",Me="pending",Ee="resolved",ze={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},kt="X-Request-Id",ae=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Xs="UCv3",ve=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),ui={PRODUCTION:"PRODUCTION"},Ue={TWP:"twp",D2P:"d2p",CRM:"crm"},gi=":start",fi=":duration",Ks="price",Zs="price-strikethrough",Qs="annual",ee="legal",Se="mas-ff-defaults",rt="mas-ff-annual-price",ge={alphabetical:"alphabetical",authored:"authored"},vi=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Js="mas-commerce-service";function Ra(e,r){let t;return function(){let i=this,a=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(i,a),r)}}var _t=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function xe(e,r={},t=null,i=null){let a=i?document.createElement(e,{is:i}):document.createElement(e);t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t;for(let[n,s]of Object.entries(r))a.setAttribute(n,s);return a}function lr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function bi(){return window.matchMedia("(max-width: 1024px)").matches}function Pt(){return document.getElementsByTagName(Js)?.[0]}function Lt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}import{html as dr,nothing as ec}from"./lit-all.min.js";var it,Mt=class Mt{constructor(r){g(this,"card");z(this,it);this.card=r,this.insertVariantStyle()}getContainer(){return L(this,it,v(this,it)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,it)}insertVariantStyle(){let r=this.constructor.name;if(!Mt.styleMap[r]){Mt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),s=parseInt(n.style.getPropertyValue(i))||0;a>s&&n.style.setProperty(i,`${a}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let i=this.card.variant,a=Array.from(t.querySelectorAll(`merch-card[variant="${i}"]`)).filter(s=>s.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:s}of r){let o=`--consonant-merch-card-${i}-${s}-height`;t.style.getPropertyValue(o)&&t.style.removeProperty(o)}let n=new Map;for(let s of a){let o=s.getBoundingClientRect();if(o.width<=2)continue;let c=Math.round(o.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(s)}for(let s of n.values())for(let{name:o,getElement:c}of r){let l=`--consonant-merch-card-${i}-${o}-height`,d=s.map(m=>m.style.getPropertyValue(l)),p=0;for(let m of s){m.style.removeProperty(l);let h=c(m);if(!h)continue;let u=Math.max(0,parseInt(window.getComputedStyle(h).height)||0);u>p&&(p=u)}s.forEach((m,h)=>{p>0?m.style.setProperty(l,`${p}px`):d[h]&&m.style.setProperty(l,d[h])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),dr`
            <div
                id="badge"
        ...
        `}get cardImage(){return dr` <div class="image">
            <slot name="bg-image"></slot>
            ${this.badge}
        </div>`}getGlobalCSS(){return""}get theme(){return document.querySelector("sp-theme")}get evergreen(){return this.card.classList.contains("intro-pricing")}get promoBottom(){return this.card.classList.contains("promo-bottom")}get headingSelector(){return'[slot="heading-xs"]'}get secureLabel(){return this.card.secureLabel?dr`<span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              >`:ec}get secureLabelFooter(){return dr`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let r=Promise.allSettled(this.card.prices.map(a=>a.onceSettled?.()||Promise.resolve())),t,i=new Promise(a=>{t=setTimeout(a,Wr)});await Promise.race([r,i]),clearTimeout(t)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return hr(this.card.variant)}};it=new WeakMap,g(Mt,"styleMap",{});var w=Mt;import{html as yi,css as tc}from"./lit-all.min.js";var Na=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as zt,css as rc}from"./lit-all.min.js";var Ia=`
:root {
...
`;var Da={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},$e=class extends w{constructor(r){super(r)}getGlobalCSS(){return Ia}renderLayout(){return zt`<div class="image">
    ...
    `);import{html as Ba}from"./lit-all.min.js";var Ha=`
:root {
...
`;var pr=class extends w{constructor(r){super(r)}getGlobalCSS(){return Ha}renderLayout(){return Ba` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Ba`<hr />`} ${this.secureLabelFooter}`}};import{html as Re,css as ic,unsafeCSS as Ua}from"./lit-all.min.js";var Fa=`
  :root {
...
`;var ac=32,$a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},nt=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Re`<slot name="secure-transaction-label">
            ...
            </footer>`:Re`<footer>${t}<slot name="footer"></slot></footer>`});this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(ie,this.updatePriceQuantity),this.visibilityObserver=new IntersectionObserver(([t])=>{t.boundingClientRect.height!==0&&t.isIntersecting&&(k.isMobile||requestAnimationFrame(()=>{let i=this.getContainer();if(!i)return;i.querySelectorAll('merch-card[variant="mini-compare-chart"]').forEach(n=>n.variantLayout?.syncHeights?.())}),this.visibilityObserver.disconnect())}),this.visibilityObserver.observe(this.card)}disconnectedCallbackHook(){if(this.card.removeEventListener(ie,this.updatePriceQuantity),this.visibilityObserver?.disconnect(),this.legalElement&&this.legalResolvedHandler&&(this.legalElement.removeEventListener(Le,this.legalResolvedHandler),this.legalResolvedHandler=null,this.legalElement=null),this.calloutListenersAdded){document.removeEventListener("touchstart",this.handleCalloutTouch),document.removeEventListener("mouseover",this.handleCalloutMouse);let t=this.card.querySelector('[slot="callout-content"] .icon-button');t?.removeEventListener("focusin",this.handleCalloutFocusin),t?.removeEventListener("focusout",this.handleCalloutFocusout),t?.removeEventListener("keydown",this.handleCalloutKeydown),this.calloutListenersAdded=!1}}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}priceOptionsProvider(t,i){if(this.isNewVariant){if(t.dataset.template===ee){i.displayPlanType=this.card?.settings?.displayPlanType??!1;return}(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(i.displayPerUnit=!1)}}getGlobalCSS(){return Fa}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let t=["heading-m","subtitle","body-m","heading-m-price","body-xxs","price-commitment","quantity-select","offers","promo-text","callout-content","addon"];this.card.classList.contains("bullet-list")&&t.push("footer-rows"),t.forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer"),this.card.shadowRoot.querySelector(".mini-compare-chart-badge")?.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let t;if(this.isNewVariant){let i=this.card.querySelector("merch-whats-included");if(!i)return;t=[...i.querySelectorAll('[slot="content"] merch-mnemonic-list')]}else{let i=this.card.querySelector('[slot="footer-rows"] ul');if(!i||!i.children)return;t=[...i.children]}t.length&&t.forEach((i,a)=>{let n=Math.max(ac,parseFloat(window.getComputedStyle(i).height)||0),s=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>s&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.isNewVariant?this.card.querySelectorAll('merch-whats-included [slot="content"] merch-mnemonic-list').forEach(i=>{if(i.hasAttribute("data-placeholder"))return;let a=i.querySelector('[slot="icon"]'),n=!!a?.querySelector(".sp-icon")||!!a?.querySelector('merch-icon[src]:not([src=""]), img[src]:not([src=""])'),o=i.querySelector('[slot="description"]')?.textContent?.replace(/\u00a0/g," ")?.trim()??"";!n&&!o&&i.remove()}):this.card.querySelectorAll(".footer-row-cell").forEach(i=>{if(i.hasAttribute("data-placeholder"))return;let a=i.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&i.remove()})}padFooterRows(){let t=this.getContainer();if(!t)return;let i=t.querySelectorAll('merch-card[variant="mini-compare-chart"]');if(this.isNewVariant){let a=0;if(i.forEach(l=>{let d=l.querySelector("merch-whats-included");if(!d)return;let p=d.querySelectorAll('[slot="content"] merch-mnemonic-list:not([data-placeholder])');a=Math.max(a,p.length)}),a===0)return;let n=this.card.querySelector("merch-whats-included");if(!n)return;let s=n.querySelector('[slot="content"]');if(!s)return;s.querySelectorAll("merch-mnemonic-list[data-placeholder]").forEach(l=>l.remove());let o=s.querySelectorAll("merch-mnemonic-list").length,c=a-o;for(let l=0;l<c;l++){let d=document.createElement("merch-mnemonic-list");d.setAttribute("data-placeholder","");let p=document.createElement("div");p.setAttribute("slot","icon");let m=document.createElement("div");m.setAttribute("slot","description"),d.append(p,m),s.appendChild(d)}}else{let a=0;if(i.forEach(c=>{let l=c.querySelector('[slot="footer-rows"] ul');if(!l)return;let d=l.querySelectorAll("li.footer-row-cell:not([data-placeholder])");a=Math.max(a,d.length)}),a===0)return;let n=this.card.querySelector('[slot="footer-rows"] ul');if(!n)return;n.querySelectorAll("li.footer-row-cell[data-placeholder]").forEach(c=>c.remove());let s=n.querySelectorAll("li.footer-row-cell").length,o=a-s;for(let c=0;c<o;c++){let l=document.createElement("li");l.className="footer-row-cell",l.setAttribute("data-placeholder",""),n.appendChild(l)}}}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${W}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}get isNewVariant(){return!!this.card.querySelector("merch-whats-included")}toggleAddon(t){let i=this.mainPrice,a=this.headingMPriceSlot;if(!i&&a){let n=t?.getAttribute("plan-type"),s=null;if(t&&n&&(s=t.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(o=>o.remove()),t.checked){if(s){let o=xe("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},s.innerHTML);this.card.appendChild(o)}}else{let o=xe("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(o)}}}showTooltip(t){t.classList.remove("hide-tooltip"),t.setAttribute("aria-expanded","true")}hideTooltip(t){t.classList.add("hide-tooltip"),t.setAttribute("aria-expanded","false")}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');if(!t||this.calloutListenersAdded)return;let i=t.title||t.dataset.tooltip;if(!i)return;t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"));let a=t.parentElement;if(a&&a.tagName==="P"){let n=document.createElement("div"),s=document.createElement("div");s.className="callout-row";let o=document.createElement("div");for(o.className="callout-text";a.firstChild&&a.firstChild!==t;)o.appendChild(a.firstChild);s.appendChild(o),s.appendChild(t),n.appendChild(s),a.replaceWith(n)}t.setAttribute("role","button"),t.setAttribute("tabindex","0"),t.setAttribute("aria-label",i),t.setAttribute("aria-expanded","false"),this.hideTooltip(t),this.handleCalloutTouch=n=>{n.target!==t?this.hideTooltip(t):t.classList.contains("hide-tooltip")?this.showTooltip(t):this.hideTooltip(t)},this.handleCalloutMouse=n=>{n.target!==t?this.hideTooltip(t):this.showTooltip(t)},this.handleCalloutFocusin=()=>{this.showTooltip(t)},this.handleCalloutFocusout=()=>{this.hideTooltip(t)},this.handleCalloutKeydown=n=>{n.key==="Escape"&&(this.hideTooltip(t),t.blur())},document.addEventListener("touchstart",this.handleCalloutTouch),document.addEventListener("mouseover",this.handleCalloutMouse),t.addEventListener("focusin",this.handleCalloutFocusin),t.addEventListener("focusout",this.handleCalloutFocusout),t.addEventListener("keydown",this.handleCalloutKeydown),this.calloutListenersAdded=!0}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let i=this.mainPrice,a=this.card.planType;if(i&&(await i.onceSettled?.(),a=i.value?.[0]?.planType),!a)return;t.planType=a,this.card.querySelector("merch-addon[plan-type]")?.updateComplete.then(()=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="addon"]'),"addon")})}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let i=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),t.parentNode.insertBefore(i,t.nextSibling),await i.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),i.addEventListener(Le,this.legalResolvedHandler),this.legalElement=i)}catch{}}adjustShortDescription(){if(!this.shortDescriptionSource){let c=this.card.querySelector('[slot="body-xxs"]');if(!c)return;this.shortDescriptionSource=c,c.remove()}let t=this.shortDescriptionSource,i=t.textContent?.trim(),a=!!t.querySelector(".icon-button");if(!i&&!a)return;let s=this.card.querySelector('[slot="heading-m-price"] [data-template="legal"]')?.querySelector(".price-plan-type");if(!s||s.querySelector("em"))return;let o=document.createElement("em");o.innerHTML=` ${t.innerHTML}`,s.appendChild(o)}renderLayout(){return this.isNewVariant?Re` <div class="top-section${this.badge?" badge":""}">
                <slot name="icons"></slot> ${this.badge}
                <slot name="badge"></slot>
            </div>
            <slot name="heading-m"></slot>
    ...
    `);import{html as mr,css as nc,unsafeCSS as qa,nothing as oc}from"./lit-all.min.js";var Ga=`
  :root {
...
`;var sc=32,Va={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},ot=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>mr` <footer>
    ...
    `);import{html as Rt,css as cc,nothing as ur}from"./lit-all.min.js";var ja=`
:root {
...
`;var gr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Wa={...function(){let{whatsIncluded:e,size:r,...t}=gr;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Ya={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:i,...a}=gr;return a}()},be,ye,ne=class extends w{constructor(t){super(t);z(this,be);z(this,ye);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ja}adjustSlotPlacement(t,i,a){let n=this.card.shadowRoot,s=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(o.includes("wide")||(s?.classList.remove("wide-footer"),c&&c.remove()),!!i.includes(o)){if(s?.classList.toggle("wide-footer",k.isDesktopOrUp),!a&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(a&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);s.prepend(m)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],k.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],k.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,be)||(L(this,be,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,be)?.disconnect(),L(this,be,null),this.syncHeights())})),v(this,be).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(i=>({name:i,getElement:a=>a.querySelector(`[slot="${i}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,s=document.createElement("div");s.classList.add("spacer"),i.insertBefore(s,n);let o=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Lt(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=Lt(p));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+Lt(m));for(let u of i.childNodes){if(u.classList.contains("spacer"))break;l+=Lt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${W}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Rt`<div class="divider"></div>`:ur}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],i=this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`);i&&t.push(i);let a=t.map(async n=>{let s=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),s.setAttribute("data-template","legal"),n.parentNode.insertBefore(s,n.nextSibling),await s.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled?.();let a=i.value?.[0]?.planType;a&&(t.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?Rt`<label id="stock-checkbox">
                <input type="checkbox" @change=${this.card.toggleStockOffer}></input>
                <span></span>
                ${this.card.checkboxLabel}
            </label>`:ur}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?ur:Rt`<slot name="icons"></slot>`}resizeHandler(){v(this,ye)&&cancelAnimationFrame(v(this,ye)),L(this,ye,requestAnimationFrame(()=>{L(this,ye,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))}connectedCallbackHook(){k.matchMobile.addEventListener("change",this.adaptForMedia),k.matchDesktopOrUp.addEventListener("change",this.adaptForMedia)}disconnectedCallbackHook(){k.matchMobile.removeEventListener("change",this.adaptForMedia),k.matchDesktopOrUp.removeEventListener("change",this.adaptForMedia),v(this,be)?.disconnect(),L(this,be,null),v(this,ye)&&(cancelAnimationFrame(v(this,ye)),L(this,ye,null))}renderLayout(){return Rt` ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="heading-xs"></slot>
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};be=new WeakMap,ye=new WeakMap,g(ne,"variantStyle",cc`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),g(ne,"collectionOptions",{customHeaderArea:t=>t.sidenav?Rt`<slot name="resultsText"></slot>`:ur,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let i=()=>{let a=t.querySelectorAll("merch-card");for(let s of a)s.hasAttribute("data-size")&&(s.setAttribute("size",s.getAttribute("data-size")),s.removeAttribute("data-size"));if(!k.isDesktop)return;let n=0;for(let s of a){if(s.style.display==="none")continue;let o=s.getAttribute("size"),c=o==="wide"?2:o==="super-wide"?3:1;c===2&&n%3===2&&(s.setAttribute("data-size",o),s.removeAttribute("size"),c=1),n+=c}};k.matchDesktop.addEventListener("change",i),t.addEventListener(me,i),t.onUnmount.push(()=>{k.matchDesktop.removeEventListener("change",i),t.removeEventListener(me,i)})}});import{html as Ae,css as lc,unsafeCSS as Ka,nothing as fr}from"./lit-all.min.js";var Xa=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(k.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?k.isMobile?Ae`
        ...
        `:Ae`
            ...
            `:fr}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?Ae`<slot name="icons"></slot>`:fr}get secureLabelFooter(){return Ae`<footer>
            ...
            <slot></slot>`}};g(Ne,"variantStyle",lc`
    ...
    `),g(Ne,"collectionOptions",{customHeaderArea:r=>r.sidenav?Ae`<slot name="resultsText"></slot>`:fr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let t=()=>{let i=r.querySelectorAll("merch-card");if(i.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!k.isDesktop)return;let a=0;i.forEach(n=>{if(n.style.display==="none")return;let s=n.getAttribute("size"),o=s==="wide"?2:s==="super-wide"?3:1;o===2&&a%3===2&&(n.setAttribute("data-size",s),n.removeAttribute("size"),o=1),a+=o})};k.matchDesktop.addEventListener("change",t),r.addEventListener(me,t),r.onUnmount.push(()=>{k.matchDesktop.removeEventListener("change",t),r.removeEventListener(me,t)})}});import{html as Oe,css as dc,nothing as Nt}from"./lit-all.min.js";var Qa=`
:root {
...
`;var[tp,rp,Ja,en,tn,rn]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var an={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},Ce,Ge,Ht,Y,nn,Ot,on,It,wi,vr,xr=class xr extends w{constructor(t){super(t);z(this,Y);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);z(this,Ce,null);z(this,Ge,null);g(this,"lastSyncKey",null);z(this,Ht,({detail:t})=>{let i=t?.quantity==null?null:String(t.quantity);i==null||i===this.licenseQty||this.licenseOptions?.includes(i)&&(this.licenseQty=i,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let i=!this.expanded;for(let a of j(this,Y,nn).call(this)){let n=a.variantLayout;n instanceof xr&&(n.expanded=i,a._bizproExpanded=i,a.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?j(this,Y,wi).call(this):j(this,Y,It).call(this),this.card.requestUpdate()});z(this,vr,t=>{let i=this.licenseOptions;if(!i?.length)return;let a=i.length-1;switch(t.key){case en:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%i.length:j(this,Y,It).call(this);break;case Ja:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+i.length)%i.length:j(this,Y,It).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=a;break;case tn:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(i[this.licenseHighlightedIndex]);return}j(this,Y,It).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),j(this,Y,wi).call(this);break;case rn:this.licenseOpen&&this.selectLicenseQty(i[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,j(this,Y,Ot).call(this);let i=this.quantitySelectEl;i&&(i.selectedValue=Number(t),i.dispatchEvent(new CustomEvent(ie,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._bizproExpanded??!1}getGlobalCSS(){return Qa}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let i=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),i.dataset.displayPerUnit="false",t.parentNode.insertBefore(i,t.nextSibling),await i.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),i.addEventListener(Le,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),a=i?.querySelector(".price-plan-type");if(!a)return;a.textContent=t;let n=i.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled?.();let a=i.value?.[0]?.planType;a&&(t.planType=a)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(i=>{let a=window.getComputedStyle(i),n=`${a.fontWeight} ${a.fontSize} ${a.fontFamily}`;return document.fonts.load(n,i.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(o=>requestAnimationFrame(o)),await new Promise(o=>requestAnimationFrame(o));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let i=this.card.variant,a=`--consonant-merch-card-${i}-top-card-height`,n=[...t.querySelectorAll(`merch-card[variant="${i}"]`)].filter(o=>o.getBoundingClientRect().width>2&&o.variantLayout?.card?.heightSync!==!1),s=new Map;for(let o of n){let c=s.get(o.offsetTop)??[];c.push(o),s.set(o.offsetTop,c)}for(let o of s.values()){let c=0;for(let l of o){l.style.removeProperty(a);let d=l.shadowRoot?.querySelector(".top-card");d&&(c=Math.max(c,parseInt(getComputedStyle(d).height)||0))}c>0&&o.length>1&&o.forEach(l=>l.style.setProperty(a,`${c}px`))}}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let i=this.card.querySelector('[slot="body-xs"]'),a=i?Math.round(i.getBoundingClientRect().height):0,n=`${Math.round(t)}:${a}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(sr,v(this,Ht)),this.card.addEventListener(ie,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;L(this,Ge,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Ge).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Ge).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ie,this.updatePriceQuantity),j(this,Y,Ot).call(this),v(this,Ge)?.disconnect(),this.card?.removeEventListener(sr,v(this,Ht))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let i=parseInt(t.getAttribute("min"),10),a=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(i)||Number.isNaN(a)||a<i)return null;let s=[];for(let o=i;o<=a;o+=n)s.push(String(o));return s.length?s:null}licenseLabel(t){let i=this.quantitySelectEl?.getAttribute("title")||"License",[a,n]=i.split("|").map(s=>s.trim());return Number(t)===1?a:n||a}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let i=this.quantitySelectEl?.getAttribute("default-value");return i!=null&&t.includes(i)?i:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Oe`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,i=this.currentLicenseValue,a=!!this.licenseOpen,n=this.licenseLabel(Number(i));return Oe`
            <div class="license-select" ?data-open=${a}>
                <div
                    ...
                    aria-activedescendant=${a?`license-option-${this.licenseHighlightedIndex}`:Nt}
                ...
                >
                    ...
                    ${t.map((s,o)=>Oe`
                            <li
                                class="license-select-option ${o===this.licenseHighlightedIndex?"highlighted":""}${s===i?" selected":""}"
                                id="license-option-${o}"
                                role="option"
        ...
        `}renderLayout(){let t=!!this.expanded;return Oe`
            ...
            ${this.hasWhatsIncluded?Oe`
                  ...
                  `:Nt}
            <slot></slot>
        `}};Ce=new WeakMap,Ge=new WeakMap,Ht=new WeakMap,Y=new WeakSet,nn=function(){let t=this.card.offsetTop,i=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(a=>a.getBoundingClientRect().width>2&&a.offsetTop===t);return i.length?i:[this.card]},Ot=function(){v(this,Ce)&&(document.removeEventListener("mousedown",v(this,Ce)),L(this,Ce,null))},on=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},It=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=j(this,Y,on).call(this),v(this,Ce)||(L(this,Ce,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),j(this,Y,Ot).call(this))}),document.addEventListener("mousedown",v(this,Ce)))},wi=function(){this.licenseOpen=!1,j(this,Y,Ot).call(this)},vr=new WeakMap,g(xr,"variantStyle",dc`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Dt=xr;import{html as Ei,css as hc}from"./lit-all.min.js";var sn=`
:root {
...
`;var cn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},we,st=class extends w{constructor(t){super(t);z(this,we);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return sn}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return Ei` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){this.handleResize=()=>{v(this,we)&&cancelAnimationFrame(v(this,we)),L(this,we,requestAnimationFrame(()=>{L(this,we,null),this.postCardUpdateHook()}))},this.adjustShortDescriptionBound=this.adjustShortDescription.bind(this),window.addEventListener("resize",this.handleResize),this.card.addEventListener(ie,this.updatePriceQuantity),this.card.addEventListener(cr,this.adjustShortDescriptionBound)}disconnectedCallbackHook(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),v(this,we)&&(cancelAnimationFrame(v(this,we)),L(this,we,null)),this.card.removeEventListener(ie,this.updatePriceQuantity),this.card.removeEventListener(cr,this.adjustShortDescriptionBound)}adjustShortDescription(){let t=this.card.querySelector('[slot="short-description"]');if(!t?.textContent?.trim())return;let i=this.card.querySelector('span[data-template="legal"]');if(!i)return;i.querySelector(".merch-short-description")?.remove();let a=document.createElement("span");a.className="merch-short-description";let n=t.querySelector("p")??t;a.innerHTML=`\xA0${n.innerHTML}`,a.querySelectorAll(".icon-button").forEach(o=>{o.dataset.eventsWired||(o.dataset.eventsWired="1",["mouseenter","focus"].forEach(c=>o.addEventListener(c,()=>o.classList.add("tooltip-visible"))),["mouseleave","blur"].forEach(c=>o.addEventListener(c,()=>o.classList.remove("tooltip-visible"))),o.addEventListener("keydown",c=>{c.key==="Escape"&&o.classList.remove("tooltip-visible")}))});let s=i.querySelector(".price-plan-type");s?s.after(a):i.appendChild(a)}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),k.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let i=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),t.closest('[slot="heading-xs"]').appendChild(i),await i.onceSettled()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${W}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}toggleAddon(t){let i=this.mainPrice,a=this.headingXSSlot;if(!i&&a){let n=t?.getAttribute("plan-type"),s=null;if(t&&n&&(s=t.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(o=>o.remove()),t.checked){if(s){let o=xe("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},s.innerHTML);this.card.appendChild(o)}}else{let o=xe("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(o)}}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let i=this.mainPrice,a=this.card.planType;i&&(await i.onceSettled?.(),a=i.value?.[0]?.planType),a&&(t.planType=a)}};we=new WeakMap,g(st,"variantStyle",hc`
    ...
    `);import{html as Si,css as pc}from"./lit-all.min.js";var ln=`
:root {
...
`;var dn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ct=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===ee&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return ln}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${W}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return Si`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as mc,css as uc}from"./lit-all.min.js";var hn=`
...
`;var pn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},lt=class extends w{constructor(r){super(r)}getGlobalCSS(){return hn}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return mc`
    ...
    `);import{html as Ai,css as gc}from"./lit-all.min.js";var mn=`
:root {
...
`;var un={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},dt=class extends w{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return mn}renderLayout(){return Ai`${this.cardImage}
            ...
            ${this.evergreen?Ai`
                  ...
                  `:Ai`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(dt,"variantStyle",gc`
    ...
    `);import{html as fc,css as vc}from"./lit-all.min.js";var gn=`
:root {
...
`;var Ci={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ht=class extends w{getGlobalCSS(){return gn}get aemFragmentMapping(){return Ci}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(a=>this.updateCardElementMinHeight(r.querySelector(`.${a}`),a));let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let i=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');i&&this.updateCardElementMinHeight(i,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),i=34;t.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(s=>{let o=s.textContent.trim().length>i;s.classList.toggle("small-font-size-button",o)})}),k.isDesktopOrUp&&t.forEach(a=>a.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!nr()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(t=>t.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let t=()=>{if(nr())r.removeAttribute("data-expanded");else{let a=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",a?"true":"false")}};t();let i=window.matchMedia(N);this.mediaQueryListener=()=>{t()},i.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(N).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||nr())return;let a=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",a)}renderLayout(){return fc`
    ...
    `);import{html as vn,css as xc}from"./lit-all.min.js";var fn=`
:root {
...
`;var Ti={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Bt=class Bt extends w{getGlobalCSS(){return fn}get aemFragmentMapping(){return Ti}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return vn`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let t=window.getComputedStyle(r),i=`${t.fontWeight} ${t.fontSize} ${t.fontFamily}`;await document.fonts.load(i,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(o=>requestAnimationFrame(o)),await new Promise(o=>requestAnimationFrame(o)),this.card.getBoundingClientRect().width<=2)return;let r=Bt.SYNCED_SECTIONS.map(o=>({name:o,getElement:c=>c.shadowRoot?.querySelector(`.${o}`)})),t=this.getContainer(),i=t?t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],a='[slot="body-s"] > *',n=Math.max(0,...Array.from(i,o=>o.querySelectorAll(a).length)),s=Array.from({length:n},(o,c)=>({name:`description-row-${c}`,getElement:l=>l.querySelectorAll(a)[c]}));this.syncRowHeights([...r,...s])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),i=49;t.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(s=>{let o=s.textContent.trim().length>i;s.classList.toggle("small-font-size-button",o)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let t=this.card.querySelector(this.headingSelector),i=t?Math.round(t.getBoundingClientRect().height):0,a=`${Math.round(r)}:${i}`;a!==this.lastSyncedKey&&(this.lastSyncedKey=a,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return vn`
            ${this.badge}
            ...
            <slot></slot>
        `}};g(Bt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(Bt,"variantStyle",xc`
    ...
    `);var Ft=Bt;import{html as ki,css as bc,nothing as yc}from"./lit-all.min.js";var xn=`
...
`;var bn={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},wc=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],pt=class extends w{constructor(r){super(r)}getGlobalCSS(){return xn}renderLayout(){return ki`
    ...
    `);import{css as Ec,html as Sc}from"./lit-all.min.js";var yn=`
...
`;var wn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},mt=class extends w{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return yn}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${W}[data-template="price"]`);if(!t)return;let i=t.cloneNode(!0);this.legal=i,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return Sc`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Ac,css as Cc}from"./lit-all.min.js";var En=`
...
`;var _i={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Tc=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],br,Sn,ut=class extends w{constructor(t){super(t);z(this,br);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return En}get aemFragmentMapping(){return _i}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,j(this,br,Sn).call(this))}renderLayout(){return Ac`
            <div class="card">
            ...
            <slot></slot>
        `}};br=new WeakSet,Sn=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Tc.forEach(({key:i,selector:a})=>this.updateCardElementMinHeight(t.querySelector(a),i))},g(ut,"variantStyle",Cc`
    ...
    `);import{html as kc,css as _c}from"./lit-all.min.js";var An=`
...
`;var Pi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},gt=class extends w{getGlobalCSS(){return An}get aemFragmentMapping(){return Pi}renderLayout(){return kc`
    ...
    `);var Cn=new Map;var G=(e,r,t=null,i=null,a)=>{Cn.set(e,{class:r,fragmentMapping:t,style:i,collectionOptions:a})};G("catalog",at,Oa,at.variantStyle);G("image",$e);G("inline-heading",pr);G("mini-compare-chart",nt,$a,nt.variantStyle);G("mini-compare-chart-mweb",ot,Va,ot.variantStyle);G("plans",ne,gr,ne.variantStyle,ne.collectionOptions);G("plans-students",ne,Ya,ne.variantStyle,ne.collectionOptions);G("plans-education",ne,Wa,ne.variantStyle,ne.collectionOptions);G("plans-v2",Ne,Za,Ne.variantStyle,Ne.collectionOptions);G("bizpro",Dt,an,Dt.variantStyle);G("product",st,cn,st.variantStyle);G("segment",ct,dn,ct.variantStyle);G("media",lt,pn,lt.variantStyle);G("headless",pt,bn,pt.variantStyle);G("special-offers",dt,un,dt.variantStyle);G("simplified-pricing-express",ht,Ci,ht.variantStyle);G("full-pricing-express",Ft,Ti,Ft.variantStyle);G("mini",mt,wn,mt.variantStyle);G("image",$e,Da,$e.variantStyle);G("compare-chart-column",ut,_i,ut.variantStyle);G("fries",gt,Pi,gt.variantStyle);function hr(e){return Cn.get(e)?.fragmentMapping}var Tn="tacocat.js";var Li=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),kn=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function H(e,r={},{metadata:t=!0,search:i=!0,storage:a=!0}={}){let n;if(i&&n==null){let s=new URLSearchParams(window.location.search),o=ft(i)?i:e;n=s.get(o)}if(a&&n==null){let s=ft(a)?a:e;n=window.sessionStorage.getItem(s)??window.localStorage.getItem(s)}if(t&&n==null){let s=Lc(ft(t)?t:e);n=document.documentElement.querySelector(`meta[name="${s}"]`)?.content}return n??r[e]}var Pc=e=>typeof e=="boolean",yr=e=>typeof e=="function",wr=e=>typeof e=="number",_n=e=>e!=null&&typeof e=="object";var ft=e=>typeof e=="string",Pn=e=>ft(e)&&e,Ut=e=>wr(e)&&Number.isFinite(e)&&e>0;function Er(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,i])=>{r(i)&&delete e[t]}),e}function E(e,r){if(Pc(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function $t(e,r,t){let i=Object.values(r);return i.find(a=>Li(a,e))??t??i[0]}function Lc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,i)=>`${t}-${i}`).replace(/\W+/gu,"-").toLowerCase()}function Ln(e,r=1){return wr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var Mc=Date.now(),Mi=()=>`(+${Date.now()-Mc}ms)`,Sr=new Set,zc=E(H("tacocat.debug",{},{metadata:!1}),!1);function Mn(e){let r=`[${Tn}/${e}]`,t=(s,o,...c)=>s?!0:(a(o,...c),!1),i=zc?(s,...o)=>{console.debug(`${r} ${s}`,...o,Mi())}:()=>{},a=(s,...o)=>{let c=`${r} ${s}`;Sr.forEach(([l])=>l(c,...o))};return{assert:t,debug:i,error:a,warn:(s,...o)=>{let c=`${r} ${s}`;Sr.forEach(([,l])=>l(c,...o))}}}function Rc(e,r){let t=[e,r];return Sr.add(t),()=>{Sr.delete(t)}}Rc((e,...r)=>{console.error(e,...r,Mi())},(e,...r)=>{console.warn(e,...r,Mi())});var Nc="no promo",zn="promo-tag",Oc="yellow",Ic="neutral",Dc=(e,r,t)=>{let i=n=>n||Nc,a=t?` (was "${i(r)}")`:"";return`${i(e)}${a}`},Hc="cancel-context",Ar=(e,r)=>{let t=e===Hc,i=!t&&e?.length>0,a=(i||t)&&(r&&r!=e||!r&&!t),n=a&&i||!a&&!!r,s=n?e||r:void 0;return{effectivePromoCode:s,overridenPromoCode:e,className:n?zn:`${zn} no-promo`,text:Dc(s,r,a),variant:n?Oc:Ic,isOverriden:a}};var zi;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(zi||(zi={}));var le;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(le||(le={}));var pe;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(pe||(pe={}));var Ri;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Ri||(Ri={}));var Ni;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(Ni||(Ni={}));var Oi;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(Oi||(Oi={}));var Ii;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Ii||(Ii={}));var Di="ABM",Hi="PUF",Bi="M2M",Fi="PERPETUAL",Ui="P3Y",Bc="TAX_INCLUSIVE_DETAILS",Fc="TAX_EXCLUSIVE",Rn={ABM:Di,PUF:Hi,M2M:Bi,PERPETUAL:Fi,P3Y:Ui},tu={[Di]:{commitment:le.YEAR,term:pe.MONTHLY},[Hi]:{commitment:le.YEAR,term:pe.ANNUAL},[Bi]:{commitment:le.MONTH,term:pe.MONTHLY},[Fi]:{commitment:le.PERPETUAL,term:void 0},[Ui]:{commitment:le.THREE_MONTHS,term:pe.P3Y}},Nn="Value is not an offer",Cr=e=>{if(typeof e!="object")return Nn;let{commitment:r,term:t}=e,i=Uc(r,t);return{...e,planType:i}};var Uc=(e,r)=>{switch(e){case void 0:return Nn;case"":return"";case le.YEAR:return r===pe.MONTHLY?Di:r===pe.ANNUAL?Hi:"";case le.MONTH:return r===pe.MONTHLY?Bi:"";case le.PERPETUAL:return Fi;case le.TERM_LICENSE:return r===pe.P3Y?Ui:"";default:return""}};function On(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:i,priceWithoutTax:a,priceWithoutDiscountAndTax:n,taxDisplay:s}=r;if(s!==Bc)return e;let o={...e,priceDetails:{...r,price:a??t,priceWithoutDiscount:n??i,taxDisplay:Fc}};return o.offerType==="TRIAL"&&o.priceDetails.price===0&&(o.priceDetails.price=o.priceDetails.priceWithoutDiscount),o}var qe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},In=1e3;function $c(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Dn(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:i,originatingRequest:a,status:n}=e;return[i,n,a].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!qe.serializableTypes.includes(t))return t}return e}function Gc(e,r){if(!qe.ignoredProperties.includes(e))return Dn(r)}var $i={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,i=[],a=[],n=r;t.forEach(l=>{l!=null&&($c(l)?i:a).push(l)}),i.length&&(n+=` ${i.map(Dn).join(" ")}`);let{pathname:s,search:o}=window.location,c=`${qe.delimiter}page=${s}${o}`;c.length>In&&(c=`${c.slice(0,In)}<trunc>`),n+=c,a.length&&(n+=`${qe.delimiter}facts=`,n+=JSON.stringify(a,Gc)),window.lana?.log(n,qe)}};function Tr(e){Object.assign(qe,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in qe&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Hn={LOCAL:"local",PROD:"prod",STAGE:"stage"},Gi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},qi=new Set,Vi=new Set,Bn=new Map,Fn={append({level:e,message:r,params:t,timestamp:i,source:a}){console[e](`${i}ms [${a}] %c${r}`,"font-weight: bold;",...t)}},Un={filter:({level:e})=>e!==Gi.DEBUG},qc={filter:()=>!1};function Vc(e,r,t,i,a){return{level:e,message:r,namespace:t,get params(){return i.length===1&&yr(i[0])&&(i=i[0](),Array.isArray(i)||(i=[i])),i},source:a,timestamp:performance.now().toFixed(3)}}function jc(e){[...Vi].every(r=>r(e))&&qi.forEach(r=>r(e))}function $n(e){let r=(Bn.get(e)??0)+1;Bn.set(e,r);let t=`${e} #${r}`,i={id:t,namespace:e,module:a=>$n(`${i.namespace}/${a}`),updateConfig:Tr};return Object.values(Gi).forEach(a=>{i[a]=(n,...s)=>jc(Vc(a,n,e,s,t))}),Object.seal(i)}function kr(...e){e.forEach(r=>{let{append:t,filter:i}=r;yr(i)&&Vi.add(i),yr(t)&&qi.add(t)})}function Wc(e={}){let{name:r}=e,t=E(H("commerce.debug",{search:!0,storage:!0}),r===Hn.LOCAL);return kr(t?Fn:Un),r===Hn.PROD&&kr($i),oe}function Yc(){qi.clear(),Vi.clear()}var oe={...$n(ci),Level:Gi,Plugins:{consoleAppender:Fn,debugFilter:Un,quietFilter:qc,lanaAppender:$i},init:Wc,reset:Yc,use:kr};var Xc="mas-commerce-service",Kc=oe.module("utilities"),Zc={requestId:kt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Gt(e,{country:r,forceTaxExclusive:t}){let i;if(e.length<2)i=e;else{let a=r==="GB"?"EN":"MULT";e.sort((n,s)=>n.language===a?-1:s.language===a?1:0),e.sort((n,s)=>!n.term&&s.term?-1:n.term&&!s.term?1:0),i=[e[0]]}return t&&(i=i.map(On)),i}var Gn=(e,r)=>{let t=e.reduce((i,a)=>i+(r(a)||0),0);return t>0?Math.round(t*100)/100:void 0};function ji(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let o of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let p=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?o.priceDetails?.formatString:o[l];m!==p&&Kc.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:p,actual:m})}}let i=[["price",o=>o.priceDetails?.price],["priceWithoutDiscount",o=>o.priceDetails?.priceWithoutDiscount],["priceWithoutTax",o=>o.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",o=>o.priceDetails?.priceWithoutDiscountAndTax]],a={};for(let[o,c]of i){let l=Gn(e,c);l!==void 0&&(a[o]=l)}let n=e.some(o=>o.priceDetails?.annualized),s;if(n){let o=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];s={};for(let[c,l]of o){let d=Gn(e,l);d!==void 0&&(s[c]=d)}}return{...r,offerSelectorIds:e.flatMap(o=>o.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...a,...s&&{annualized:s}}}}var _r=e=>window.setTimeout(e);function vt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(Ln).filter(Ut);return t.length||(t=[r]),t}function Pr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(Pn)}function se(){return document.getElementsByTagName(Xc)?.[0]}function qn(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[i,a]of Object.entries(Zc)){let n=t.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[i]=n)}return r}var xt=class e extends Error{constructor(r,t,i){if(super(r,{cause:i}),this.name="MasError",t.response){let a=t.response.headers?.get(kt);a&&(t.requestId=a),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([i,a])=>`${i}: ${JSON.stringify(a)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var Qc={[ue]:ri,[Me]:ii,[Ee]:ai},Jc={[ue]:si,[Ee]:Le},qt,Ie=class{constructor(r){z(this,qt);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",Me);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=oe.module("mas-element")}update(){[ue,Me,Ee].forEach(r=>{this.wrapperElement.classList.toggle(Qc[r],r===this.state)})}notify(){(this.state===Ee||this.state===ue)&&(this.state===Ee?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ue&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof xt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Jc[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,i){this.changes.set(r,i),this.requestUpdate()}connectedCallback(){L(this,qt,se()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:i}=this;return Ee===i?Promise.resolve(this.wrapperElement):ue===i?Promise.reject(r):new Promise((a,n)=>{t.push({resolve:a,reject:n})})}toggleResolved(r,t,i){return r!==this.version?!1:(i!==void 0&&(this.options=i),this.state=Ee,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),_r(()=>this.notify()),!0)}toggleFailed(r,t,i){if(r!==this.version)return!1;i!==void 0&&(this.options=i),this.error=t,this.state=ue,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,qt)?.duration}),_r(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=Me,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!se()||this.timer)return;let{error:t,options:i,state:a,value:n,version:s}=this;this.state=Me,this.timer=_r(async()=>{this.timer=null;let o=null;if(this.changes.size&&(o=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:o}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:o})),o||r)try{await this.wrapperElement.render?.()===!1&&this.state===Me&&this.version===s&&(this.state=a,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,i)}})}};qt=new WeakMap;function Vn(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function Lr(e,r={}){let{tag:t,is:i}=e,a=document.createElement(t,{is:i});return a.setAttribute("is",i),Object.assign(a.dataset,Vn(r)),a}function jn(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Vn(r)),e):null}function el(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var We,Ve=class Ve extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new Ie(this));z(this,We);this.setAttribute("is",Ve.is)}get isUptLink(){return!0}initializeWcsData(t,i){this.setAttribute("data-wcs-osi",t),i&&this.setAttribute("data-promotion-code",i)}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),L(this,We,Pt()),v(this,We)&&(this.log=v(this,We).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),L(this,We,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Pt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(s=>{s&&(this.dataset.imsCountry=s)});let i=t.collectCheckoutOptions({},this);if(!i.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(i),n=t.resolveOfferSelectors(i);try{let[[s]]=await Promise.all(n),{country:o,language:c,env:l}=i,d=`locale=${c}_${o}&country=${o}&offer_id=${s.offerId}`,p=this.getAttribute("data-promotion-code");p&&(d+=`&promotion_code=${encodeURIComponent(p)}`),this.href=`${el(l)}?${d}`,this.masElement.toggleResolved(a,s,i)}catch(s){let o=new Error(`Could not resolve offer selectors for id: ${i.wcsOsi}.`,s.message);return this.masElement.toggleFailed(a,o,i),!1}}static createFrom(t){let i=new Ve;for(let a of t.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?i.setAttribute("class",a.value.replace("upt-link","").trim()):i.setAttribute(a.name,a.value));return i.innerHTML=t.innerHTML,i.setAttribute("tabindex",0),i}};We=new WeakMap,g(Ve,"is","upt-link"),g(Ve,"tag","a"),g(Ve,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var je=Ve;window.customElements.get(je.is)||window.customElements.define(je.is,je,{extends:je.tag});function Wn(e){return e&&(e==="bizpro"||e.startsWith("plans")?"plans":e)}var tl="p_draft_landscape",rl="/store/",il=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),Wi=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),al=["env","workflowStep","clientId","country"],nl=["/tw/","/hk_zh/"];function ol(e){let r=e??"";return nl.some(t=>r.startsWith(t))}function sl(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(ol)}function Yi(e){if(!sl())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var Yn=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),Xn=e=>il.get(e)??e;function Mr(e,r,t){for(let[i,a]of Object.entries(e)){let n=Xn(i);a!=null&&t.has(n)&&r.set(n,a)}}function cl(e){switch(e){case ui.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function ll(e,r){for(let t in e){let i=e[t];for(let[a,n]of Object.entries(i)){if(n==null)continue;let s=Xn(a);r.set(`items[${t}][${s}]`,n)}}}function dl({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let i=e.searchParams.get("af");return e.searchParams.set("af",[i,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===Ue.CRM?"creative":"mini_plans"),e}function hl(e){let r=new URLSearchParams(window.location.search),t={};Yn.forEach(i=>{let a=r.get(i);a!==null&&(t[i]=a)}),Object.keys(t).length>0&&Mr(t,e.searchParams,Yn)}function Kn(e){pl(e);let{env:r,items:t,workflowStep:i,marketSegment:a,customerSegment:n,offerType:s,productArrangementCode:o,landscape:c,modal:l,is3in1:d,preselectPlan:p,...m}=e,h=new URL(cl(r));if(h.pathname=`${rl}${i}`,i!==ae.SEGMENTATION&&i!==ae.CHANGE_PLAN_TEAM_PLANS&&ll(t,h.searchParams),Mr({...m},h.searchParams,Wi),hl(h),c===ze.DRAFT&&Mr({af:tl},h.searchParams,Wi),i===ae.SEGMENTATION){let u={marketSegment:a,offerType:s,customerSegment:n,productArrangementCode:o,quantity:t?.[0]?.quantity,addonProductArrangementCode:o?t?.find(f=>f.productArrangementCode!==o)?.productArrangementCode:t?.[1]?.productArrangementCode};p?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):p?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),Mr(u,h.searchParams,Wi),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=dl({url:h,modal:l,is3in1:d})}return Yi(h)}function pl(e){for(let r of al)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==ae.SEGMENTATION&&e.workflowStep!==ae.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var ml=/[0-9\-+#]/,ul=/[^\d\-+#]/g;function Zn(e){return e.search(ml)}function gl(e="#.##"){let r={},t=e.length,i=Zn(e);r.prefix=i>0?e.substring(0,i):"";let a=Zn(e.split("").reverse().join("")),n=t-a,s=e.substring(n,n+1),o=n+(s==="."||s===","?1:0);r.suffix=a>0?e.substring(o,t):"",r.mask=e.substring(i,o),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(ul);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function fl(e,r,t){let i=!1,a={value:e};e<0&&(i=!0,a.value=-a.value),a.sign=i?"-":"",a.value=Number(a.value).toFixed(r.fraction&&r.fraction.length),a.value=Number(a.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[s="0",o=""]=a.value.split(".");return(!o||o&&o.length<=n)&&(o=n<0?"":(+`0.${o}`).toFixed(n+1).replace("0.","")),a.integer=s,a.fraction=o,vl(a,r),(a.result==="0"||a.result==="")&&(i=!1,a.sign=""),!i&&r.maskHasPositiveSign?a.sign="+":i&&r.maskHasPositiveSign?a.sign="-":i&&(a.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),a}function vl(e,r){e.result="";let t=r.integer.split(r.separator),i=t.join(""),a=i&&i.indexOf("0");if(a>-1)for(;e.integer.length<i.length-a;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let s=e.integer.length,o=s%n;for(let c=0;c<s;c++)e.result+=e.integer.charAt(c),!((c-o+1)%n)&&c<s-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function xl(e,r,t={}){if(!e||isNaN(Number(r)))return r;let i=gl(e),a=fl(r,i,t);return i.prefix+a.sign+a.result+i.suffix}var Qn=xl;var Jn=".",bl=",",to=/^\s+/,ro=/\s+$/,eo="&nbsp;",Xi=e=>e*12,Xe=(e,r,t=1)=>{if(!e)return!1;let{start:i,end:a,displaySummary:{amount:n,duration:s,minProductQuantity:o=1,outcomeType:c}={}}=e;if(!(n&&s&&c)||t<o)return!1;let l=r?new Date(r):new Date;if(!i||!a)return!1;let d=new Date(i),p=new Date(a);return l>=d&&l<=p},Ye={MONTH:"MONTH",YEAR:"YEAR"},yl={[he.ANNUAL]:12,[he.MONTHLY]:1,[he.THREE_YEARS]:36,[he.TWO_YEARS]:24},Ki=(e,r)=>({accept:e,round:r}),wl=[Ki(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),Ki(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),Ki(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],Zi={[Fe.YEAR]:{[he.MONTHLY]:Ye.MONTH,[he.ANNUAL]:Ye.YEAR},[Fe.MONTH]:{[he.MONTHLY]:Ye.MONTH}},El=(e,r)=>e.indexOf(`'${r}'`)===0,Sl=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),i=ao(t);return!!i?r||(t=t.replace(/[,\.]0+/,i)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Cl(e)}`),t},Al=e=>{let r=Tl(e),t=El(e,r),i=e.replace(/'.*?'/,""),a=to.test(i)||ro.test(i);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:a}},io=e=>e.replace(to,eo).replace(ro,eo),Cl=e=>e.match(/#(.?)#/)?.[1]===Jn?bl:Jn,Tl=e=>e.match(/'(.*?)'/)?.[1]??"",ao=e=>e.match(/0(.?)0/)?.[1]??"";function bt({formatString:e,price:r,usePrecision:t,isIndianPrice:i=!1},a,n=s=>s){let{currencySymbol:s,isCurrencyFirst:o,hasCurrencySpace:c}=Al(e),l=t?ao(e):"",d=Sl(e,t),p=t?2:0,m=n(r,{currencySymbol:s}),h=i?m.toLocaleString("hi-IN",{minimumFractionDigits:p,maximumFractionDigits:p}):Qn(d,m),u=t?h.lastIndexOf(l):h.length,f=h.substring(0,u),x=h.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,s),currencySymbol:s,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:o,recurrenceTerm:a}}var no=e=>{let{commitment:r,term:t,usePrecision:i}=e,a=yl[t]??1;return bt(e,a>1?Ye.MONTH:Zi[r]?.[t],n=>{let s={divisor:a,price:n,usePrecision:i},{round:o}=wl.find(({accept:c})=>c(s));if(!o)throw new Error(`Missing rounding rule for: ${JSON.stringify(s)}`);return o(s)})},oo=({commitment:e,term:r,...t})=>bt(t,Zi[e]?.[r]),so=e=>{let{commitment:r,instant:t,price:i,originalPrice:a,priceWithoutDiscount:n,promotion:s,quantity:o=1,term:c}=e;if(r===Fe.YEAR&&c===he.MONTHLY){if(!s)return bt(e,Ye.YEAR,Xi);let{displaySummary:{outcomeType:l,duration:d}={}}=s;switch(l){case"PERCENTAGE_DISCOUNT":if(Xe(s,t,o)){let p=parseInt(d.replace("P","").replace("M",""));if(isNaN(p))return Xi(i);let m=a*p,h=n*(12-p),u=Math.round((m+h)*100)/100;return bt({...e,price:u},Ye.YEAR)}default:return bt(e,Ye.YEAR,()=>Xi(n??i))}}return bt(e,Zi[r]?.[c])};var co="download",lo="upgrade",ho={e:"EDU",t:"TEAM"};function po(e,r={},t=""){let i=se();if(!i)return null;let{checkoutMarketSegment:a,checkoutWorkflow:n,checkoutWorkflowStep:s,entitlement:o,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f}=i.collectCheckoutOptions(r),x=Lr(e,{checkoutMarketSegment:a,checkoutWorkflow:n,checkoutWorkflowStep:s,entitlement:o,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function mo(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new Ie(this))}attributeChangedCallback(i,a,n){this.masElement.attributeChangedCallback(i,a,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let i=this.options?.ms??this.value?.[0].marketSegments?.[0];return ho[i]??i}get customerSegment(){let i=this.options?.cs??this.value?.[0]?.customerSegment;return ho[i]??i}get is3in1Modal(){return Object.values(Ue).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let i=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!i||i.content!=="off")}requestUpdate(i=!1){return this.masElement.requestUpdate(i)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(i={}){let a=se();if(!a)return!1;this.dataset.imsCountry||a.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),i.imsCountry=null;let n=a.collectCheckoutOptions(i,this);if(!n.wcsOsi.length)return!1;let s;try{s=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let o=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=a.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>Gt(h,n));let d=l.flat().find(h=>h.promotion);!Xe(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let m=await a.buildCheckoutAction?.(l.flat(),{...s,...n},this);return this.renderOffers(l.flat(),n,{},m,o)}renderOffers(i,a,n={},s=void 0,o=void 0){let c=se();if(!c)return!1;if(a={...JSON.parse(this.dataset.extraOptions??"{}"),...a,...n},o??(o=this.masElement.togglePending(a)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),s){this.classList.remove(co,lo),this.masElement.toggleResolved(o,i,a);let{url:d,text:p,className:m,handler:h}=s;d&&this.setCheckoutUrl(Yi(d)),p&&(this.firstElementChild.innerHTML=p),m&&this.classList.add(...m.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(i.length){if(this.masElement.toggleResolved(o,i,a)){if(!this.classList.contains(co)&&!this.classList.contains(lo)){let d=c.buildCheckoutURL(i,a);this.setCheckoutUrl(a.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(o,d,a))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(i){}updateOptions(i={}){let a=se();if(!a)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:s,checkoutWorkflowStep:o,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}=a.collectCheckoutOptions(i);return jn(this,{checkoutMarketSegment:n,checkoutWorkflow:s,checkoutWorkflowStep:o,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}),!0}}}var Vt=class Vt extends mo(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return po(Vt,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(Vt,"is","checkout-link"),g(Vt,"tag","a");var Te=Vt;window.customElements.get(Te.is)||window.customElements.define(Te.is,Te,{extends:Te.tag});var M=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:ae.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:ve.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:ze.PUBLISHED});function uo({settings:e,providers:r}){function t(n,s){let{checkoutClientId:o,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u}=e,f={checkoutClientId:o,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u};if(s)for(let et of r.checkout)et(s,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:y=c,imsCountry:A,country:b=A??l,language:C=d,quantity:D=m,entitlement:R,upgrade:U,modal:V,perpetual:te,promotionCode:X=p,wcsOsi:F,extraOptions:O,...re}=Object.assign(f,s?.dataset??{},n??{}),de=$t(y,ae,M.checkoutWorkflowStep);return f=Er({...re,extraOptions:O,checkoutClientId:o,checkoutMarketSegment:x,country:b,quantity:vt(D,M.quantity),checkoutWorkflowStep:de,language:C,entitlement:E(R),upgrade:E(U),modal:V,perpetual:E(te),promotionCode:Ar(X).effectivePromoCode,wcsOsi:Pr(F),preselectPlan:h}),f}function i(n,s){if(!Array.isArray(n)||!n.length||!s)return"";let{env:o,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:p,country:m,promotionCode:h,quantity:u,preselectPlan:f,ms:x,cs:y,...A}=t(s),b=document.querySelector("meta[name=mas-ff-3in1]"),C=Object.values(Ue).includes(s.modal)&&(!b||b.content!=="off"),D=window.frameElement||C?"if":"fp",[{productArrangementCode:R,marketSegments:[U],customerSegment:V,offerType:te}]=n,X=x??U??d,F=y??V;f?.toLowerCase()==="edu"?X="EDU":f?.toLowerCase()==="team"&&(F="TEAM");let O={is3in1:C,checkoutPromoCode:h,clientId:l,context:D,country:m,env:o,items:[],marketSegment:X,customerSegment:F,offerType:te,productArrangementCode:R,workflowStep:p,landscape:c,...A},re=u[0]>1?u[0]:void 0;if(n.length===1){let{offerId:de}=n[0];O.items.push({id:de,quantity:re})}else O.items.push(...n.map(({offerId:de,productArrangementCode:et})=>({id:de,quantity:re,...C?{productArrangementCode:et}:{}})));return Kn(O)}let{createCheckoutLink:a}=Te;return{CheckoutLink:Te,CheckoutWorkflowStep:ae,buildCheckoutURL:i,collectCheckoutOptions:t,createCheckoutLink:a}}function kl({interval:e=200,maxAttempts:r=25}={}){let t=oe.module("ims");return new Promise(i=>{t.debug("Waing for IMS to be ready");let a=0;function n(){window.adobeIMS?.initialized?i():++a>r?(t.debug("Timeout"),i()):setTimeout(n,e)}n()})}function _l(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Pl(e){let r=oe.module("ims");return e.then(t=>t?window.adobeIMS.getProfile().then(({countryCode:i})=>(r.debug("Got user country:",i),i),i=>{r.error("Unable to get user country:",i)}):null)}function go({}){let e=kl(),r=_l(e),t=Pl(r);return{imsReadyPromise:e,imsSignedInPromise:r,imsCountryPromise:t}}var fo=window.masPriceLiterals;function vo(e){if(Array.isArray(fo)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=a=>fo.find(n=>Li(n.lang,a)),i=t(r)??t(M.language);if(i)return Object.freeze(i)}return{}}var Qi=function(e,r){return Qi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,i){t.__proto__=i}||function(t,i){for(var a in i)Object.prototype.hasOwnProperty.call(i,a)&&(t[a]=i[a])},Qi(e,r)};function jt(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");Qi(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var _=function(){return _=Object.assign||function(r){for(var t,i=1,a=arguments.length;i<a;i++){t=arguments[i];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},_.apply(this,arguments)};function zr(e,r,t){if(t||arguments.length===2)for(var i=0,a=r.length,n;i<a;i++)(n||!(i in r))&&(n||(n=Array.prototype.slice.call(r,0,i)),n[i]=r[i]);return e.concat(n||Array.prototype.slice.call(r))}var S;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(S||(S={}));var B;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(B||(B={}));var Ke;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Ke||(Ke={}));function Ji(e){return e.type===B.literal}function xo(e){return e.type===B.argument}function Rr(e){return e.type===B.number}function Nr(e){return e.type===B.date}function Or(e){return e.type===B.time}function Ir(e){return e.type===B.select}function Dr(e){return e.type===B.plural}function bo(e){return e.type===B.pound}function Hr(e){return e.type===B.tag}function Br(e){return!!(e&&typeof e=="object"&&e.type===Ke.number)}function Wt(e){return!!(e&&typeof e=="object"&&e.type===Ke.dateTime)}var ea=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var Ll=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function yo(e){var r={};return e.replace(Ll,function(t){var i=t.length;switch(t[0]){case"G":r.era=i===4?"long":i===5?"narrow":"short";break;case"y":r.year=i===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][i-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][i-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=i===4?"short":i===5?"narrow":"short";break;case"e":if(i<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][i-4];break;case"c":if(i<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][i-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][i-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][i-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][i-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][i-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][i-1];break;case"s":r.second=["numeric","2-digit"][i-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=i<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var wo=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Co(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(wo).filter(function(m){return m.length>0}),t=[],i=0,a=r;i<a.length;i++){var n=a[i],s=n.split("/");if(s.length===0)throw new Error("Invalid number skeleton");for(var o=s[0],c=s.slice(1),l=0,d=c;l<d.length;l++){var p=d[l];if(p.length===0)throw new Error("Invalid number skeleton")}t.push({stem:o,options:c})}return t}function Ml(e){return e.replace(/^(.*?)-/,"")}var Eo=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,To=/^(@+)?(\+|#+)?[rs]?$/g,zl=/(\*)(0+)|(#+)(0+)|(0+)/g,ko=/^(0+)$/;function So(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(To,function(t,i,a){return typeof a!="string"?(r.minimumSignificantDigits=i.length,r.maximumSignificantDigits=i.length):a==="+"?r.minimumSignificantDigits=i.length:i[0]==="#"?r.maximumSignificantDigits=i.length:(r.minimumSignificantDigits=i.length,r.maximumSignificantDigits=i.length+(typeof a=="string"?a.length:0)),""}),r}function _o(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Rl(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!ko.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function Ao(e){var r={},t=_o(e);return t||r}function Po(e){for(var r={},t=0,i=e;t<i.length;t++){var a=i[t];switch(a.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=a.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=Ml(a.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=_(_(_({},r),{notation:"scientific"}),a.options.reduce(function(c,l){return _(_({},c),Ao(l))},{}));continue;case"engineering":r=_(_(_({},r),{notation:"engineering"}),a.options.reduce(function(c,l){return _(_({},c),Ao(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(a.options[0]);continue;case"integer-width":if(a.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");a.options[0].replace(zl,function(c,l,d,p,m,h){if(l)r.minimumIntegerDigits=d.length;else{if(p&&m)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(ko.test(a.stem)){r.minimumIntegerDigits=a.stem.length;continue}if(Eo.test(a.stem)){if(a.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");a.stem.replace(Eo,function(c,l,d,p,m,h){return d==="*"?r.minimumFractionDigits=l.length:p&&p[0]==="#"?r.maximumFractionDigits=p.length:m&&h?(r.minimumFractionDigits=m.length,r.maximumFractionDigits=m.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=a.options[0];n==="w"?r=_(_({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=_(_({},r),So(n)));continue}if(To.test(a.stem)){r=_(_({},r),So(a.stem));continue}var s=_o(a.stem);s&&(r=_(_({},r),s));var o=Rl(a.stem);o&&(r=_(_({},r),o))}return r}var Yt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function Lo(e,r){for(var t="",i=0;i<e.length;i++){var a=e.charAt(i);if(a==="j"){for(var n=0;i+1<e.length&&e.charAt(i+1)===a;)n++,i++;var s=1+(n&1),o=n<2?1:3+(n>>1),c="a",l=Nl(r);for((l=="H"||l=="k")&&(o=0);o-- >0;)t+=c;for(;s-- >0;)t=l+t}else a==="J"?t+="H":t+=a}return t}function Nl(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,i;t!=="root"&&(i=e.maximize().region);var a=Yt[i||""]||Yt[t||""]||Yt["".concat(t,"-001")]||Yt["001"];return a[0]}var ta,Ol=new RegExp("^".concat(ea.source,"*")),Il=new RegExp("".concat(ea.source,"*$"));function P(e,r){return{start:e,end:r}}var Dl=!!String.prototype.startsWith,Hl=!!String.fromCodePoint,Bl=!!Object.fromEntries,Fl=!!String.prototype.codePointAt,Ul=!!String.prototype.trimStart,$l=!!String.prototype.trimEnd,Gl=!!Number.isSafeInteger,ql=Gl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},ia=!0;try{Mo=Oo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),ia=((ta=Mo.exec("a"))===null||ta===void 0?void 0:ta[0])==="a"}catch{ia=!1}var Mo,zo=Dl?function(r,t,i){return r.startsWith(t,i)}:function(r,t,i){return r.slice(i,i+t.length)===t},aa=Hl?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var i="",a=r.length,n=0,s;a>n;){if(s=r[n++],s>1114111)throw RangeError(s+" is not a valid code point");i+=s<65536?String.fromCharCode(s):String.fromCharCode(((s-=65536)>>10)+55296,s%1024+56320)}return i},Ro=Bl?Object.fromEntries:function(r){for(var t={},i=0,a=r;i<a.length;i++){var n=a[i],s=n[0],o=n[1];t[s]=o}return t},No=Fl?function(r,t){return r.codePointAt(t)}:function(r,t){var i=r.length;if(!(t<0||t>=i)){var a=r.charCodeAt(t),n;return a<55296||a>56319||t+1===i||(n=r.charCodeAt(t+1))<56320||n>57343?a:(a-55296<<10)+(n-56320)+65536}},Vl=Ul?function(r){return r.trimStart()}:function(r){return r.replace(Ol,"")},jl=$l?function(r){return r.trimEnd()}:function(r){return r.replace(Il,"")};function Oo(e,r){return new RegExp(e,r)}var na;ia?(ra=Oo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),na=function(r,t){var i;ra.lastIndex=t;var a=ra.exec(r);return(i=a[1])!==null&&i!==void 0?i:""}):na=function(r,t){for(var i=[];;){var a=No(r,t);if(a===void 0||Do(a)||Xl(a))break;i.push(a),t+=a>=65536?2:1}return aa.apply(void 0,i)};var ra,Io=function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,i){for(var a=[];!this.isEOF();){var n=this.char();if(n===123){var s=this.parseArgument(r,i);if(s.err)return s;a.push(s.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var o=this.clonePosition();this.bump(),a.push({type:B.pound,location:P(o,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(i)break;return this.error(S.UNMATCHED_CLOSING_TAG,P(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&oa(this.peek()||0)){var s=this.parseTag(r,t);if(s.err)return s;a.push(s.val)}else{var s=this.parseLiteral(r,t);if(s.err)return s;a.push(s.val)}}}return{val:a,err:null}},e.prototype.parseTag=function(r,t){var i=this.clonePosition();this.bump();var a=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:B.literal,value:"<".concat(a,"/>"),location:P(i,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var s=n.val,o=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!oa(this.char()))return this.error(S.INVALID_TAG,P(o,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return a!==l?this.error(S.UNMATCHED_CLOSING_TAG,P(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:B.tag,value:a,children:s,location:P(i,this.clonePosition())},err:null}:this.error(S.INVALID_TAG,P(o,this.clonePosition())))}else return this.error(S.UNCLOSED_TAG,P(i,this.clonePosition()))}else return this.error(S.INVALID_TAG,P(i,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&Yl(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var i=this.clonePosition(),a="";;){var n=this.tryParseQuote(t);if(n){a+=n;continue}var s=this.tryParseUnquoted(r,t);if(s){a+=s;continue}var o=this.tryParseLeftAngleBracket();if(o){a+=o;continue}break}var c=P(i,this.clonePosition());return{val:{type:B.literal,value:a,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!Wl(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var i=this.char();if(i===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(i);this.bump()}return aa.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var i=this.char();return i===60||i===123||i===35&&(t==="plural"||t==="selectordinal")||i===125&&r>0?null:(this.bump(),aa(i))},e.prototype.parseArgument=function(r,t){var i=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,P(i,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(S.EMPTY_ARGUMENT,P(i,this.clonePosition()));var a=this.parseIdentifierIfPossible().value;if(!a)return this.error(S.MALFORMED_ARGUMENT,P(i,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,P(i,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:B.argument,value:a,location:P(i,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,P(i,this.clonePosition())):this.parseArgumentOptions(r,t,a,i);default:return this.error(S.MALFORMED_ARGUMENT,P(i,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),i=na(this.message,t),a=t+i.length;this.bumpTo(a);var n=this.clonePosition(),s=P(r,n);return{value:i,location:s}},e.prototype.parseArgumentOptions=function(r,t,i,a){var n,s=this.clonePosition(),o=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(o){case"":return this.error(S.EXPECT_ARGUMENT_TYPE,P(s,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),p=this.parseSimpleArgStyleIfPossible();if(p.err)return p;var m=jl(p.val);if(m.length===0)return this.error(S.EXPECT_ARGUMENT_STYLE,P(this.clonePosition(),this.clonePosition()));var h=P(d,this.clonePosition());l={style:m,styleLocation:h}}var u=this.tryParseArgumentClose(a);if(u.err)return u;var f=P(a,this.clonePosition());if(l&&zo(l?.style,"::",0)){var x=Vl(l.style.slice(2));if(o==="number"){var p=this.parseNumberSkeletonFromString(x,l.styleLocation);return p.err?p:{val:{type:B.number,value:i,location:f,style:p.val},err:null}}else{if(x.length===0)return this.error(S.EXPECT_DATE_TIME_SKELETON,f);var y=x;this.locale&&(y=Lo(x,this.locale));var m={type:Ke.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?yo(y):{}},A=o==="date"?B.date:B.time;return{val:{type:A,value:i,location:f,style:m},err:null}}}return{val:{type:o==="number"?B.number:o==="date"?B.date:B.time,value:i,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(S.EXPECT_SELECT_ARGUMENT_OPTIONS,P(b,_({},b)));this.bumpSpace();var C=this.parseIdentifierIfPossible(),D=0;if(o!=="select"&&C.value==="offset"){if(!this.bumpIf(":"))return this.error(S.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,P(this.clonePosition(),this.clonePosition()));this.bumpSpace();var p=this.tryParseDecimalInteger(S.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,S.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(p.err)return p;this.bumpSpace(),C=this.parseIdentifierIfPossible(),D=p.val}var R=this.tryParsePluralOrSelectOptions(r,o,t,C);if(R.err)return R;var u=this.tryParseArgumentClose(a);if(u.err)return u;var U=P(a,this.clonePosition());return o==="select"?{val:{type:B.select,value:i,options:Ro(R.val),location:U},err:null}:{val:{type:B.plural,value:i,options:Ro(R.val),offset:D,pluralType:o==="plural"?"cardinal":"ordinal",location:U},err:null}}default:return this.error(S.INVALID_ARGUMENT_TYPE,P(s,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,P(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var i=this.char();switch(i){case 39:{this.bump();var a=this.clonePosition();if(!this.bumpUntil("'"))return this.error(S.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,P(a,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var i=[];try{i=Co(r)}catch{return this.error(S.INVALID_NUMBER_SKELETON,t)}return{val:{type:Ke.number,tokens:i,location:t,parsedOptions:this.shouldParseSkeletons?Po(i):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,i,a){for(var n,s=!1,o=[],c=new Set,l=a.value,d=a.location;;){if(l.length===0){var p=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var m=this.tryParseDecimalInteger(S.EXPECT_PLURAL_ARGUMENT_SELECTOR,S.INVALID_PLURAL_ARGUMENT_SELECTOR);if(m.err)return m;d=P(p,this.clonePosition()),l=this.message.slice(p.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?S.DUPLICATE_SELECT_ARGUMENT_SELECTOR:S.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(s=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?S.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:S.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,P(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(r+1,t,i);if(u.err)return u;var f=this.tryParseArgumentClose(h);if(f.err)return f;o.push([l,{value:u.val,location:P(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return o.length===0?this.error(t==="select"?S.EXPECT_SELECT_ARGUMENT_SELECTOR:S.EXPECT_PLURAL_ARGUMENT_SELECTOR,P(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!s?this.error(S.MISSING_OTHER_CLAUSE,P(this.clonePosition(),this.clonePosition())):{val:o,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var i=1,a=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(i=-1);for(var n=!1,s=0;!this.isEOF();){var o=this.char();if(o>=48&&o<=57)n=!0,s=s*10+(o-48),this.bump();else break}var c=P(a,this.clonePosition());return n?(s*=i,ql(s)?{val:s,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=No(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(zo(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),i=this.message.indexOf(r,t);return i>=0?(this.bumpTo(i),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Do(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),i=this.message.charCodeAt(t+(r>=65536?2:1));return i??null},e}();function oa(e){return e>=97&&e<=122||e>=65&&e<=90}function Wl(e){return oa(e)||e===47}function Yl(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Do(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function Xl(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function sa(e){e.forEach(function(r){if(delete r.location,Ir(r)||Dr(r))for(var t in r.options)delete r.options[t].location,sa(r.options[t].value);else Rr(r)&&Br(r.style)||(Nr(r)||Or(r))&&Wt(r.style)?delete r.style.location:Hr(r)&&sa(r.children)})}function Ho(e,r){r===void 0&&(r={}),r=_({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new Io(e,r).parse();if(t.err){var i=SyntaxError(S[t.err.kind]);throw i.location=t.err.location,i.originalMessage=t.err.message,i}return r?.captureLocation||sa(t.val),t.val}function Xt(e,r){var t=r&&r.cache?r.cache:td,i=r&&r.serializer?r.serializer:ed,a=r&&r.strategy?r.strategy:Zl;return a(e,{cache:t,serializer:i})}function Kl(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Bo(e,r,t,i){var a=Kl(i)?i:t(i),n=r.get(a);return typeof n>"u"&&(n=e.call(this,i),r.set(a,n)),n}function Fo(e,r,t){var i=Array.prototype.slice.call(arguments,3),a=t(i),n=r.get(a);return typeof n>"u"&&(n=e.apply(this,i),r.set(a,n)),n}function ca(e,r,t,i,a){return t.bind(r,e,i,a)}function Zl(e,r){var t=e.length===1?Bo:Fo;return ca(e,this,t,r.cache.create(),r.serializer)}function Ql(e,r){return ca(e,this,Fo,r.cache.create(),r.serializer)}function Jl(e,r){return ca(e,this,Bo,r.cache.create(),r.serializer)}var ed=function(){return JSON.stringify(arguments)};function la(){this.cache=Object.create(null)}la.prototype.get=function(e){return this.cache[e]};la.prototype.set=function(e,r){this.cache[e]=r};var td={create:function(){return new la}},Fr={variadic:Ql,monadic:Jl};var Ze;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Ze||(Ze={}));var Kt=function(e){jt(r,e);function r(t,i,a){var n=e.call(this,t)||this;return n.code=i,n.originalMessage=a,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r}(Error);var da=function(e){jt(r,e);function r(t,i,a,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(i,'". Options are "').concat(Object.keys(a).join('", "'),'"'),Ze.INVALID_VALUE,n)||this}return r}(Kt);var Uo=function(e){jt(r,e);function r(t,i,a){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(i),Ze.INVALID_VALUE,a)||this}return r}(Kt);var $o=function(e){jt(r,e);function r(t,i){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(i,'"'),Ze.MISSING_VALUE,i)||this}return r}(Kt);var Q;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(Q||(Q={}));function rd(e){return e.length<2?e:e.reduce(function(r,t){var i=r[r.length-1];return!i||i.type!==Q.literal||t.type!==Q.literal?r.push(t):i.value+=t.value,r},[])}function id(e){return typeof e=="function"}function Zt(e,r,t,i,a,n,s){if(e.length===1&&Ji(e[0]))return[{type:Q.literal,value:e[0].value}];for(var o=[],c=0,l=e;c<l.length;c++){var d=l[c];if(Ji(d)){o.push({type:Q.literal,value:d.value});continue}if(bo(d)){typeof n=="number"&&o.push({type:Q.literal,value:t.getNumberFormat(r).format(n)});continue}var p=d.value;if(!(a&&p in a))throw new $o(p,s);var m=a[p];if(xo(d)){(!m||typeof m=="string"||typeof m=="number")&&(m=typeof m=="string"||typeof m=="number"?String(m):""),o.push({type:typeof m=="string"?Q.literal:Q.object,value:m});continue}if(Nr(d)){var h=typeof d.style=="string"?i.date[d.style]:Wt(d.style)?d.style.parsedOptions:void 0;o.push({type:Q.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(Or(d)){var h=typeof d.style=="string"?i.time[d.style]:Wt(d.style)?d.style.parsedOptions:i.time.medium;o.push({type:Q.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(Rr(d)){var h=typeof d.style=="string"?i.number[d.style]:Br(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(m=m*(h.scale||1)),o.push({type:Q.literal,value:t.getNumberFormat(r,h).format(m)});continue}if(Hr(d)){var u=d.children,f=d.value,x=a[f];if(!id(x))throw new Uo(f,"function",s);var y=Zt(u,r,t,i,a,n),A=x(y.map(function(D){return D.value}));Array.isArray(A)||(A=[A]),o.push.apply(o,A.map(function(D){return{type:typeof D=="string"?Q.literal:Q.object,value:D}}))}if(Ir(d)){var b=d.options[m]||d.options.other;if(!b)throw new da(d.value,m,Object.keys(d.options),s);o.push.apply(o,Zt(b.value,r,t,i,a));continue}if(Dr(d)){var b=d.options["=".concat(m)];if(!b){if(!Intl.PluralRules)throw new Kt(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Ze.MISSING_INTL_API,s);var C=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[C]||d.options.other}if(!b)throw new da(d.value,m,Object.keys(d.options),s);o.push.apply(o,Zt(b.value,r,t,i,a,m-(d.offset||0)));continue}}return rd(o)}function ad(e,r){return r?_(_(_({},e||{}),r||{}),Object.keys(e).reduce(function(t,i){return t[i]=_(_({},e[i]),r[i]||{}),t},{})):e}function nd(e,r){return r?Object.keys(e).reduce(function(t,i){return t[i]=ad(e[i],r[i]),t},_({},e)):e}function ha(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function od(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Xt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.NumberFormat).bind.apply(r,zr([void 0],t,!1)))},{cache:ha(e.number),strategy:Fr.variadic}),getDateTimeFormat:Xt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.DateTimeFormat).bind.apply(r,zr([void 0],t,!1)))},{cache:ha(e.dateTime),strategy:Fr.variadic}),getPluralRules:Xt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.PluralRules).bind.apply(r,zr([void 0],t,!1)))},{cache:ha(e.pluralRules),strategy:Fr.variadic})}}var Go=function(){function e(r,t,i,a){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(s){var o=n.formatToParts(s);if(o.length===1)return o[0].value;var c=o.reduce(function(l,d){return!l.length||d.type!==Q.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(s){return Zt(n.ast,n.locales,n.formatters,n.formats,s,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=nd(e.formats,i),this.formatters=a&&a.formatters||od(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Ho,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var qo=Go;var pa={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},sd=Mn("ConsonantTemplates/price"),cd=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},De={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},ma="TAX_EXCLUSIVE",ld=e=>_n(e)?Object.entries(e).filter(([,r])=>ft(r)||wr(r)||r===!0).reduce((r,[t,i])=>`${r} ${t}${i===!0?"":`="${kn(i)}"`}`,""):"",q=(e,r,t,i=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${ld(t)}>${i?io(r):r??""}</span>`;function dd(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function hd(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function ke(e,r,t,i){let a=e[t];if(a==null)return"";let n=a.includes("<"),s=a.includes("<a ");try{a=s?dd(a):a,a=n?a.replace(cd,""):a;let o=new qo(a,r).format(i);return s?hd(o):o}catch{return sd.error("Failed to format literal:",a),""}}function pd(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:s,integer:o,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=q($.currencySymbol,i),u=q($.currencySpace,s?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=q($.integer,o),f+=q($.decimalsDelimiter,n),f+=q($.decimals,a),c||(f+=u+h),f+=q($.recurrence,l,null,!0),f+=q($.unitType,d,null,!0),f+=q($.taxInclusivity,p,!0),q(e,f,{...m})}var K=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:s,displayFormatted:o=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:A,price:b,priceWithoutDiscount:C,taxDisplay:D,taxTerm:R,term:U,usePrecision:V,promotion:te}={},X={})=>{Object.entries({country:s,formatString:A,language:p,price:b}).forEach(([_s,Ps])=>{if(Ps==null)throw new Error(`Argument "${_s}" is missing for osi ${y?.toString()}, country ${s}, language ${p}`)});let F={...pa,...m},O=`${p.toLowerCase()}-${s.toUpperCase()}`,re;te&&!f&&C?re=e||i?b:C:t&&C?re=C:re=b;let de=r?no:oo;a&&(de=so);let{accessiblePrice:et,recurrenceTerm:wa,...Ea}=de({commitment:x,formatString:A,instant:n,isIndianPrice:s==="IN",originalPrice:b,priceWithoutDiscount:C,price:r?b:re,promotion:te,quantity:h,term:U,usePrecision:V}),Gr="",qr="",Vr="";E(c)&&wa&&(Vr=ke(F,O,De.recurrenceLabel,{recurrenceTerm:wa}));let ir="";E(l)&&(u&&(ir+=" "),ir+=ke(F,O,De.perUnitLabel,{perUnit:"LICENSE"}));let ar="";E(d)&&R&&(u&&(ar+=" "),ar+=ke(F,O,D===ma?De.taxExclusiveLabel:De.taxInclusiveLabel,{taxTerm:R})),t&&(Gr=ke(F,O,De.strikethroughAriaLabel,{strikethroughPrice:Gr})),e&&(qr=ke(F,O,De.alternativePriceAriaLabel,{alternativePrice:qr}));let Be=$.container;if(r&&(Be+=` ${$.containerOptical}`),t&&(Be+=` ${$.containerStrikethrough}`),i&&(Be+=` ${$.containerPromoStrikethrough}`),e&&(Be+=` ${$.containerAlternative}`),a&&(Be+=` ${$.containerAnnual}`),E(o))return pd(Be,{...Ea,accessibleLabel:Gr,altAccessibleLabel:qr,recurrenceLabel:Vr,perUnitLabel:ir,taxInclusivityLabel:ar},X);let{currencySymbol:Sa,decimals:Ss,decimalsDelimiter:As,hasCurrencySpace:Aa,integer:Cs,isCurrencyFirst:Ts}=Ea,tt=[Cs,As,Ss];Ts?(tt.unshift(Aa?"\xA0":""),tt.unshift(Sa)):(tt.push(Aa?"\xA0":""),tt.push(Sa)),tt.push(Vr,ir,ar);let ks=tt.join("");return q(Be,ks,X)},Vo=()=>(e,r,t)=>{let i=Xe(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||i);return`${n?`${K({displayStrikethrough:!0})({isPromoApplied:i,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${K({isAlternativePrice:n})({isPromoApplied:i,...e},r,t)}`},jo=()=>(e,r,t)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=Xe(r.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return K()(e,{...r,price:r.priceWithoutDiscount},t)+q($.containerAnnualPrefix," (")+K({displayAnnual:!0,instant:i})(n,{...r,price:r.priceWithoutDiscount},t)+q($.containerAnnualSuffix,")");let o=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${o?`${K({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${K({isAlternativePrice:o})({isPromoApplied:a,...e},r,t)}${q($.containerAnnualPrefix," (")}${K({displayAnnual:!0,instant:i})(n,r,t)}${q($.containerAnnualSuffix,")")}`},Wo=()=>(e,r,t)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${K({isAlternativePrice:e.displayOldPrice})(e,r,t)}${q($.containerAnnualPrefix," (")}${K({displayAnnual:!0})(i,r,t)}${q($.containerAnnualSuffix,")")}`};var Qt={...$,containerLegal:"price-legal",planType:"price-plan-type"},Ur={...De,planTypeLabel:"planTypeLabel"};function md(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:i},a={},n=!0){let s="";return s+=q(Qt.unitType,r,null,!0),t&&i&&n&&(t+=t.endsWith(".")?" ":". "),s+=q(Qt.taxInclusivity,t,!0),s+=q(Qt.planType,i,null),q(e,s,{...a})}var Yo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:i=!1,displayDot:a=!0,language:n,literals:s={}}={},{taxDisplay:o,taxTerm:c,planType:l}={},d={})=>{let p={...pa,...s},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";E(r)&&(h=ke(p,m,Ur.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),E(t)&&c&&(u=ke(p,m,o===ma?Ur.taxExclusiveLabel:Ur.taxInclusiveLabel,{taxTerm:c}));let f="";E(i)&&l&&(f=ke(p,m,Ur.planTypeLabel,{planType:l}));let x=Qt.container;return x+=` ${Qt.containerLegal}`,md(x,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,a)};var Xo=K(),Ko=Vo(),Zo=K({displayOptical:!0}),Qo=K({displayStrikethrough:!0}),Jo=K({displayPromoStrikethrough:!0}),es=K({displayAnnual:!0}),ts=K({displayOptical:!0,isAlternativePrice:!0}),rs=K({isAlternativePrice:!0}),is=Wo(),as=jo(),ns=Yo;var ud=(e,r)=>{if(!(!Ut(e)||!Ut(r)))return Math.floor((r-e)/r*100)},os=()=>(e,r)=>{let{price:t,priceWithoutDiscount:i}=r,a=ud(t,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var ss=os();var cs="INDIVIDUAL_COM",ga="TEAM_COM",ls="INDIVIDUAL_EDU",fa="TEAM_EDU",gd=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],fd={[cs]:[],[ga]:[],[ls]:[],[fa]:[]},vd={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},xd=[cs,ga,ls,fa],bd=e=>[ga,fa].includes(e);function ua(e,r,t,i){if(e[r])return e[r];let a=`${r}_${t}`;if(e[a])return e[a];let n;if(i)n=e.find(s=>s.startsWith(`${r}_`));else{let s=Object.keys(e).find(o=>o.startsWith(`${r}_`));n=s?e[s]:null}return n}var yd=(e,r,t,i)=>{let a=`${t}_${i}`,n=ua(vd,e,r,!1);if(n){let s=xd.indexOf(a);return n[s]}return bd(a)},wd=(e,r,t,i)=>{if(ua(gd,e,r,!0))return!0;let a=fd[`${t}_${i}`];return a?ua(a,e,r,!0)?!0:M.displayTax:M.displayTax},va=async(e,r,t,i)=>{let a=wd(e,r,t,i);return{displayTax:a,forceTaxExclusive:a?yd(e,r,t,i):M.forceTaxExclusive}},Jt=class Jt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ie(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let i=se();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=i.collectPriceOptions(t);return Lr(Jt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ue}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let i=se();if(!i)return!1;let a=i.collectPriceOptions(t,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let s=this.masElement.togglePending({});this.innerHTML="";let o=i.resolveOfferSelectors(n),c=await Promise.all(o),l=c.map(h=>{let u=Gt(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=ji(l);if(i.featureFlags[Se]||n[Se]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,x=await va(h,u,p.customerSegment,f);a.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let A=Gt(y,n);return A?.length?A[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(i.featureFlags[rt]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,s)}let m=ji(d);return this.renderOffers([m],n,s)}catch(s){throw this.innerHTML="",s}}renderOffers(t,i,a=void 0){if(!this.isConnected)return;let n=se();if(!n)return!1;if(a??(a=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(a,t,i)){this.innerHTML=n.buildPriceHTML(t,this.options);let s=this.closest("p, h3, div");if(!s||!s.querySelector('span[data-template="strikethrough"]')||s.querySelector(".alt-aria-label"))return!0;let o=s?.querySelectorAll('span[is="inline-price"]');return o.length>1&&o.length===s.querySelectorAll('span[data-template="strikethrough"]').length*2&&o.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let s=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,s,this.options))return this.innerHTML="",!0}return!1}};g(Jt,"is","inline-price"),g(Jt,"tag","span");var _e=Jt;window.customElements.get(_e.is)||window.customElements.define(_e.is,_e,{extends:_e.tag});function ds({literals:e,providers:r,settings:t}){function i(s,o=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(o&&r?.price)for(let R of r.price)R(o,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:y,quantity:A,alternativePrice:b,wcsOsi:C,...D}=Object.assign(c,o?.dataset??{},s??{});return c=Er(Object.assign({...c,...D,displayOldPrice:E(l),displayPerUnit:E(d),displayRecurrence:E(p),displayTax:E(m),displayPlanType:E(h),forceTaxExclusive:E(u),perpetual:E(f),displayAnnual:E(x),promotionCode:Ar(y).effectivePromoCode,quantity:vt(A,M.quantity),alternativePrice:E(b),wcsOsi:Pr(C)})),c}function a(s,o){if(!Array.isArray(s)||!s.length||!o)return"";let{template:c}=o,l;switch(c){case"discount":l=ss;break;case"strikethrough":l=Qo;break;case"promo-strikethrough":l=Jo;break;case"annual":l=es;break;case"legal":l=ns;break;default:o.template==="optical"&&o.alternativePrice?l=ts:o.template==="optical"?l=Zo:o.displayAnnual&&s[0].planType==="ABM"?l=o.promotionCode&&s[0].promotion?as:is:o.alternativePrice?l=rs:l=o.promotionCode&&s[0].promotion?Ko:Xo}let[d]=s;return d={...d,...d.priceDetails},l({...t,...o},d)}let n=_e.createInlinePrice;return{InlinePrice:_e,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function Ed({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||M.language),r??(r=e?.split("_")?.[1]||M.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function hs(e={},r){let t=r.featureFlags[Se],{commerce:i={}}=e,a=ve.PRODUCTION,n=pi,s=H("checkoutClientId",i)??M.checkoutClientId,o=$t(H("checkoutWorkflowStep",i),ae,M.checkoutWorkflowStep),c=E(H("displayOldPrice",i),M.displayOldPrice),l=M.displayPerUnit,d=E(H("displayRecurrence",i),M.displayRecurrence),p=E(H("displayTax",i),M.displayTax),m=E(H("displayPlanType",i),M.displayPlanType),h=E(H("entitlement",i),M.entitlement),u=E(H("modal",i),M.modal),f=E(H("forceTaxExclusive",i),M.forceTaxExclusive),x=H("promotionCode",i)??M.promotionCode,y=vt(H("quantity",i)),A=H("wcsApiKey",i)??M.wcsApiKey,b=i?.env==="stage",C=ze.PUBLISHED;["true",""].includes(i.allowOverride)&&(b=(H(di,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",C=$t(H(hi,i),ze,C)),b&&(a=ve.STAGE,n=mi);let R=H(li)??e.preview,U=typeof R<"u"&&R!=="off"&&R!=="false",V={};U&&(V={preview:U});let te=H("mas-io-url")??e.masIOUrl??`https://www${a===ve.STAGE?".stage":""}.adobe.com/mas/io`,X=H("preselect-plan")??void 0,F=H("instant")??e.instant;return{...Ed(e),...V,displayOldPrice:c,checkoutClientId:s,checkoutWorkflowStep:o,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:M.extraOptions,modal:u,env:a,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:M.alternativePrice,wcsApiKey:A,wcsURL:n,landscape:C,masIOUrl:te,...X&&{preselectPlan:X},...F&&{instant:F}}}async function ps(e,r={},t=2,i=100){let a;for(let n=0;n<=t;n++)try{let s=await fetch(e,r);return s.retryCount=n,s}catch(s){if(a=s,a.retryCount=n,n>t)break;await new Promise(o=>setTimeout(o,i*(n+1)))}throw a}var xa="wcs";function ms({settings:e}){let r=oe.module(xa),{env:t,wcsApiKey:i}=e,a=new Map,n=new Map,s,o=new Map;async function c(u,f,x=!0){let y=se(),A=oi;r.debug("Fetching:",u);let b="",C;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let D=new Map(f),[R]=u.offerSelectorIds,U=Date.now()+Math.random().toString(36).substring(2,7),V=`${xa}:${R}:${U}${gi}`,te=`${xa}:${R}:${U}${fi}`,X;try{if(performance.mark(V),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",R),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===ve.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",i),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),C=await ps(b.toString(),{credentials:"omit"}),C.ok){let F=[];try{let O=await C.json();r.debug("Fetched:",u,O),F=O.resolvedOffers??[]}catch(O){r.error(`Error parsing JSON: ${O.message}`,{...O.context,...y?.duration})}F=F.map(Cr),f.forEach(({resolve:O},re)=>{let de=F.filter(({offerSelectorIds:et})=>et.includes(re)).flat();de.length&&(D.delete(re),f.delete(re),O(de))})}else A=ni}catch(F){A=`Network error: ${F.message}`}finally{X=performance.measure(te,V),performance.clearMarks(V),performance.clearMeasures(te)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=qn(C);f.forEach(O=>{O.reject(new xt(A,{...u,...F,response:C,measure:lr(X),...y?.duration}))})}}function l(){clearTimeout(s);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ve.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,A]of Object.entries(x))a.set(y,Promise.resolve(A.map(Cr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let u=a.size;o=new Map(a),a.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,x){let y=u!=="GB"&&!x?"MULT":"en",A=vi.includes(u)?u:M.country;return{validCountry:A,validLanguage:y,locale:`${f}_${A}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:A=[]}){let{validCountry:b,validLanguage:C,locale:D}=m(u,f,x),R=[b,C,y].filter(U=>U).join("-").toLowerCase();return A.map(U=>{let V=`${U}-${R}`;if(a.has(V))return a.get(V);let te=new Promise((X,F)=>{let O=n.get(R);O||(O={options:{country:b,locale:D,...C==="MULT"&&{language:C},offerSelectorIds:[]},promises:new Map},n.set(R,O)),y&&(O.options.promotionCode=y),O.options.offerSelectorIds.push(U),O.promises.set(U,{resolve:X,reject:F}),l()}).catch(X=>{if(o.has(V))return o.get(V);throw X});return a.set(V,te),te})}return{Commitment:Fe,PlanType:Rn,Term:he,applyPlanType:Cr,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var us="mas-commerce-service",gs="mas-commerce-service:start",fs="mas-commerce-service:ready",er,yt,Qe,vs,ya,ba=class extends HTMLElement{constructor(){super(...arguments);z(this,Qe);z(this,er);z(this,yt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let s=await t?.(i,a,this.imsSignedInPromise,n);return s||null})}get featureFlags(){return v(this,yt)||L(this,yt,{[Se]:j(this,Qe,ya).call(this,Se),[rt]:j(this,Qe,ya).call(this,rt)}),v(this,yt)}activate(){let t=v(this,Qe,vs),i=hs(t,this);Tr(t.lana);let a=oe.init(t.hostEnv).module("service");a.debug("Activating:",t);let s={price:vo(i)},o={checkout:new Set,price:new Set},c={literals:s,providers:o,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...uo(c),...go(c),...ds(c),...ms(c),...xi,Log:oe,resolvePriceTaxFlags:va,get defaults(){return M},get log(){return oe},get providers(){return{checkout(d){return o.checkout.add(d),()=>o.checkout.delete(d)},price(d){return o.price.add(d),()=>o.price.delete(d)},has:d=>o.price.has(d)||o.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:s,settings:i});let l=new CustomEvent(or,{bubbles:!0,cancelable:!1,detail:this});performance.mark(fs),L(this,er,performance.measure(fs,gs)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(gs),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Yr).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":lr(v(this,er))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:s})=>a===0&&n===0&&s<200||s>=400),i=Array.from(new Map(t.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};er=new WeakMap,yt=new WeakMap,Qe=new WeakSet,vs=function(){let t=this.getAttribute("env")??"prod",i={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let s=a.replace(/-([a-z])/g,o=>o[1].toUpperCase());i.commerce[s]=n}}),i},ya=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(us)||window.customElements.define(us,ba);var ws="merch-card-collection",Sd=3e4,Ad={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Cd={plans:!0},Td=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),kd=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(i=>t.types.includes(i)))):e,_d=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Pd=(e,{filter:r})=>e.sort((t,i)=>i.filters[r]?.order==null||isNaN(i.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-i.filters[r].order),Ld=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,He,Et,Je,rr,$r,Es,wt=class extends bs{constructor(){super();z(this,$r);z(this,He,{});z(this,Et);z(this,Je);z(this,rr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=Ra(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Pe` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let i=new Promise(a=>setTimeout(()=>a(!1),Sd));return Promise.race([this.hydrationReady,i])}updated(t){if(!this.querySelector("merch-card"))return;let i=window.scrollY||document.documentElement.scrollTop,a=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(a.length===0)return;t.has("singleApp")&&this.singleApp&&a.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===ge.alphabetical?_d:Pd,o=[Td,kd,Ld,n].reduce((l,d)=>d(l,this),a).map((l,d)=>[l,d]);if(this.resultCount=o.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=o.length>l,o=o.filter(([,d])=>d<l)}let c=new Map(o.reverse());for(let l of c.keys())this.prepend(l);a.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,i),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Qr,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(me,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){L(this,He,{}),this.overrides?.split(",").forEach(t=>{let[i,a]=t?.split(":");i&&a&&(v(this,He)[i]=a)})}connectedCallback(){super.connectedCallback(),L(this,Et,Pt()),v(this,Et)&&L(this,Je,v(this,Et).Log.module(ws)),L(this,rr,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(a=>{let n=a.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(a)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let i of Object.keys(t)){let a=t[i],n=a.includes("<p>")?"div":"p",s=document.createElement(n);s.setAttribute("slot",i),s.setAttribute("placeholder",""),s.innerHTML=a,this.append(s)}}attachSidenav(t,i=!0){if(!t)return;i&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Cd[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Tt));let a=v(this,rr)?.getCollectionOptions(this.variant)?.onSidenavAttached;a&&a(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let i;this.hydrationReady=new Promise(o=>{i=o});let a=this;function n(o){let c;return o.fields?.checkboxGroups?c=o.fields.checkboxGroups:o.fields?.tagFilters&&(c=[{title:o.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:o.fields.tagFilters.map(l=>{let d=l.split("/").pop(),p=o.settings?.tagLabels?.[d]||d;return p=p.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):p,{name:d,label:p}})}]),{searchText:o.fields?.searchText,tagFilters:c,linksTitle:o.fields?.linksTitle,link:o.fields?.link,linkText:o.fields?.linkText,linkIcon:o.fields?.linkIcon}}function s(o,c){let l={cards:[],hierarchy:[],placeholders:o.placeholders,sidenavSettings:n(o)};function d(p,m){for(let h of m){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!o.references[h.identifier]?.value){v(a,Je)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(o.references[h.identifier].value);continue}let u=o.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)u=b,f=b.referencesTree,o.references={...o.references,...b.references};else{v(a,Je)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!u?.fields)continue;let{fields:y}=u,A={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(b=>c[b]||b):[],collections:[]};y.defaultchild&&(A.defaultchild=c[y.defaultchild]||y.defaultchild),p.push(A),d(A.collections,f)}}return d(l.hierarchy,o.referencesTree),l.hierarchy.length===0&&(a.filtered="all"),l}t.addEventListener(ei,o=>{j(this,$r,Es).call(this,"Error loading AEM fragment",o.detail),this.hydrating=!1,t.remove()}),t.addEventListener(Jr,async o=>{this.limit=27,this.data=s(o.detail,v(this,He)),o.detail.variationId&&this.setAttribute("variation-id",o.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&o.detail.fields?.defaultchild?v(this,He)[o.detail.fields.defaultchild]||o.detail.fields.defaultchild:null;t.cache.add(...c);let p=(u,f)=>{for(let x of u)if(x.defaultchild===f||x.collections&&p(x.collections,f))return!0;return!1};for(let u of c){let b=function(D){for(let R of D){let U=R.cards.indexOf(x);if(U===-1)continue;let V=R.queryLabel??R?.label?.toLowerCase()??"";f.filters[V]={order:U+1,size:u.fields.size},b(R.collections)}},f=document.createElement("merch-card"),x=v(this,He)[u.id]||u.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=u.fields.tags?.filter(D=>D.startsWith("mas:types/")).map(D=>D.split("/")[1]).join(",");y&&f.setAttribute("types",y),hr(u.fields.variant)?.supportsDefaultChild&&(d?x===d:p(l,x))&&f.setAttribute("data-default-card","true"),b(l);let C=document.createElement("aem-fragment");C.setAttribute("fragment",x),f.append(C),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(u)+1,size:u.fields.size}}),this.append(f)}let m="",h=Wn(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(u=>u.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?m=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(m=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Ad[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),i(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Pe`<div id="footer">
        ...
        </sp-button>`}sortChanged(t){t.target.value===ge.authored?Ct({sort:void 0}):Ct({sort:t.target.value}),this.dispatchEvent(new CustomEvent(Kr,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(Zr,{bubbles:!0,composed:!0}));let t=this.page+1;Ct({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=La(({category:t,filter:i,types:a,sort:n,search:s,single_app:o,page:c})=>{i=i||t,!this.filtered&&i&&i!==this.filter&&setTimeout(()=>{Ct({page:void 0}),this.page=1},1),this.filtered||(this.filter=i??this.filter),this.types=a??"",this.search=s??"",this.singleApp=o,this.sort=n,this.page=Number(c)||1})}openFilters(t){this.sidenav?.showModal(t)}};He=new WeakMap,Et=new WeakMap,Je=new WeakMap,rr=new WeakMap,$r=new WeakSet,Es=function(t,i={},a=!0){v(this,Je)?.error(`merch-card-collection: ${t}`,i),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(ti,{detail:{...i,message:t},bubbles:!0,composed:!0}))},g(wt,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:ge.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(wt,"styles",ys`
        #footer {
            grid-column: 1 / -1;
    ...
    `);wt.SortOrder=ge;customElements.define(ws,wt);var Md={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},zd=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(a=>{a.innerText=t||""})},Rd={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},Nd={catalog:"l"},ce,St,tr=class extends bs{constructor(){super();z(this,ce);z(this,St);g(this,"tablet",new At(this,I));g(this,"desktop",new At(this,T));this.collection=null,L(this,ce,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(me,this.updateLiterals),this.collection?.addEventListener(Tt,this.handleSidenavAttached),L(this,St,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(me,this.updateLiterals),this.collection?.removeEventListener(Tt,this.handleSidenavAttached)}willUpdate(){v(this,ce).search=this.getVisibility("search"),v(this,ce).filter=this.getVisibility("filter"),v(this,ce).sort=this.getVisibility("sort"),v(this,ce).result=this.getVisibility("result"),v(this,ce).custom=this.getVisibility("custom")}parseVisibilityOptions(t,i){if(!t||!Object.hasOwn(t,i))return null;let a=t[i];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(t){let i=v(this,St)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(i,t);return a!==null?a:this.parseVisibilityOptions(Rd,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,ce).search)return fe;let t=_t(this,"searchText");return t?Pe`
        ...
        `:fe}get filterAction(){return v(this,ce).filter?this.sidenav?Pe`
            <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
            ...
            ></sp-action-button>
        `:fe:fe}get sortAction(){if(!v(this,ce).sort)return fe;let t=_t(this,"sortText");if(!t)return;let i=_t(this,"popularityText"),a=_t(this,"alphabeticallyText");if(!(i&&a))return;let n=this.collection?.sort===ge.alphabetical;return Pe`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        </div>`}get customArea(){if(!v(this,ce).custom)return fe;let t=v(this,St)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return fe;let i=t(this.collection);return!i||i===fe?fe:Pe`<div id="custom" role="heading" aria-level="2">
            ${i}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(i=>{zd(this,i,t.detail[i])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return Pe`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};ce=new WeakMap,St=new WeakMap,g(tr,"styles",ys`
        :host {
    ...
    `);customElements.define("merch-card-collection-header",tr);export{wt as MerchCardCollection,tr as default};

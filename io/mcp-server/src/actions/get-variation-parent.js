...
/**
 * Resolve the parent card a variation belongs to
 * Backs the `get_variation_parent` intent.
 */
async function main(params) {
    ...
    try {
        ...
        const result = await studioOps.getVariationParent({ id });
        ...
        console.error('Resolve the parent card a variation belongs to error:', error);
        return {
            statusCode: 500,

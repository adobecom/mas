var Wt=Object.defineProperty;var Qt=i=>{throw TypeError(i)};var gi=(i,t,e)=>t in i?Wt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var ui=(i,t)=>()=>(i&&(t=i(i=0)),t);var fi=(i,t)=>{for(var e in t)Wt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>gi(i,typeof t!="symbol"?t+"":t,e),yt=(i,t,e)=>t.has(i)||Qt("Cannot "+e);var c=(i,t,e)=>(yt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Qt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),m=(i,t,e,r)=>(yt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),S=(i,t,e)=>(yt(i,t,"access private method"),e);var Xt=(i,t,e,r)=>({set _(a){m(i,t,a,e)},get _(){return c(i,t,r)}});var wt={};fi(wt,{default:()=>Ne});import{LitElement as xi,html as Xe,css as vi}from"./lit-all.min.js";function bi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var O,Ne,Et=ui(()=>{O=class O extends xi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.tooltipVisible=!1}showTooltip(){O.activeTooltip&&O.activeTooltip!==this&&O.activeTooltip.hideTooltip(),O.activeTooltip=this,this.tooltipVisible=!0}hideTooltip(){O.activeTooltip===this&&(O.activeTooltip=null),this.tooltipVisible=!1}handleTouchStart(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Xe`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:Xe`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?bi()?Xe`
            ...
            `:Xe`
                <span
                    ...
                    @touchstart=${a=>this.handleTouchStart(a)}
                >
                    ${this.renderIcon()}
                </span>
            `:this.renderIcon()}};l(O,"activeTooltip",null),l(O,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"},mnemonicText:{type:String,attribute:"mnemonic-text"},mnemonicPlacement:{type:String,attribute:"mnemonic-placement"},tooltipVisible:{type:Boolean,state:!0}}),l(O,"styles",vi`
        :host {
            display: contents;
            overflow: visible;
        }
    ...
    `);Ne=O;customElements.define("mas-mnemonic",Ne)});import{LitElement as qa}from"./lit-all.min.js";import{css as er,unsafeCSS as Jt}from"./lit-all.min.js";var w="(max-width: 767px)",A="(max-width: 1199px)",v="(min-width: 768px)",u="(min-width: 1200px)",T="(min-width: 1600px)",Zt={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${u} and (not ${T})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(T),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},f=Zt;function Oe(){return Zt.isDesktop}var tr=er`
    :host {
...
`,rr=()=>[er`
        ...
        `];import{LitElement as yi,html as ir,css as wi}from"./lit-all.min.js";function Ei(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var de=class extends yi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Ei())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Et())}e.remove()})}render(){let{href:t}=this;return t?ir`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};l(de,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(de,"styles",wi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",de);var rn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),an=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var y='span[is="inline-price"][data-wcs-osi]',G='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var ki='a[is="upt-link"]',ar=`${y},${G},${ki}`;var nr="merch-offer-select:ready",or="merch-card:action-menu-toggle";var H="merch-quantity-selector:change",sr="merch-card-quantity:change",kt="merch-modal:addon-and-quantity-update";var pe="merch-card-collection:literals-changed";var he="aem:load",me="aem:error",cr="mas:ready",lr="mas:error",dr="placeholder-failed",pr="placeholder-pending",hr="placeholder-resolved";var mr="mas:failed",$e="mas:resolved",gr="mas/commerce";var V="failed",Z="pending",Y="resolved";var Ze="X-Request-Id",nn=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var on=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Je=":start",et=":duration";var tt="legal",ur="mas-ff-defaults";var Si="mas-commerce-service";function fr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function L(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function ge(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function St(){return window.matchMedia("(max-width: 1024px)").matches}function J(){return document.getElementsByTagName(Si)?.[0]}function De(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Ie,ee,Fe,Be,ue,rt=class extends HTMLElement{constructor(){super();g(this,Ie,"");g(this,ee);g(this,Fe,[]);g(this,Be,[]);g(this,ue);m(this,ue,fr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,ee)?this.parentElement.style.borderRadius=c(this,ee):c(this,ee)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Fe).map((r,a)=>{let n=c(this,Be)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Ie)}, ${e})`}connectedCallback(){c(this,ue).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&m(this,ee,a?.trim()),e==="colors"&&a?m(this,Fe,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?m(this,Be,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Ie,a?.trim()??""),c(this,ue).call(this)}};Ie=new WeakMap,ee=new WeakMap,Fe=new WeakMap,Be=new WeakMap,ue=new WeakMap;customElements.define("merch-gradient",rt);import{LitElement as Ai,html as Ci,css as Ti}from"./lit-all.min.js";var fe=class extends Ai{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener($e,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener($e,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Ci` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};l(fe,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),l(fe,"styles",Ti`
        :host {
            --merch-addon-gap: 9px;
...
`;var ot=class extends x{constructor(t){super(t)}getGlobalCSS(){return yr}renderLayout(){return wr` ${this.badge}
            ...
            ${this.card.customHr?"":wr`<hr />`} ${this.secureLabelFooter}`}};import{html as be,css as _i,unsafeCSS as kr}from"./lit-all.min.js";var Er=`
  :root {
...
`;var Pi=32,ye=class extends x{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?be`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),f.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(ye,"variantStyle",_i`
    ...
    `);import{html as Ue,css as Mi,nothing as st}from"./lit-all.min.js";var Sr=`
:root {
...
`;var we=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return _r}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ct` ${this.badge}
    ...
    `);import{html as Tt,css as Ni}from"./lit-all.min.js";var Pr=`
:root {
...
`;var Ee=class extends x{constructor(t){super(t)}getGlobalCSS(){return Pr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Tt` ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
            ...
            <hr />
            ${this.secureLabelFooter}`}};l(Ee,"variantStyle",Ni`
...
`;var Rr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ke=class extends x{constructor(t){super(t)}getGlobalCSS(){return Mr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Lt`${this.cardImage}
    ...
    `);import{html as zt,css as Di}from"./lit-all.min.js";var Or=`
:root {
...
`;var _t={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Se=class extends x{getGlobalCSS(){return Or}get aemFragmentMapping(){return _t}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),Oe())){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`,r=t.style.getPropertyValue(`${e}-description-height`);requestAnimationFrame(r?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(n=>n.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Oe()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(Oe())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};e();let r=window.matchMedia(A);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(A).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleHeaderClick(t){t.target.closest(".chevron-button")||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||Oe())return;let a=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",a)}renderLayout(){return zt`
    ...
    `);import{html as Pt,css as Ii}from"./lit-all.min.js";var Nr=`
:root {
...
`;var Mt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},Ae=class extends x{getGlobalCSS(){return Nr}get aemFragmentMapping(){return Mt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width<=2)return;let t=this.card.querySelector('[slot="short-description"]');t&&this.updateCardElementMinHeight(t,"short-description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="cta"]');r&&this.updateCardElementMinHeight(r,"cta")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,await Promise.all(this.card.prices.map(t=>t.onceSettled())),window.matchMedia("(min-width: 1025px)").matches)){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`,r=t.style.getPropertyValue(`${e}-price-height`);requestAnimationFrame(r?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(n=>n.variantLayout?.syncHeights?.())})}}renderLayout(){return Pt`
            ${this.badge?Pt`<div class="badge-wrapper">
                      <slot name="badge"></slot>
                  </div>`:Pt`<slot name="badge" hidden></slot>`}
            <div class="card-content">
                <div class="header">
                    <slot name="heading-xs"></slot>
                    <slot name="icons"></slot>
    ...
    `);import{css as Fi,html as Bi}from"./lit-all.min.js";var $r=`
...
`;var Dr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ce=class extends x{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return $r}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Bi`
            ${this.badge}
            <div class="body">
    ...
    `);var dt=new Map,C=(i,t,e=null,r=null,a)=>{dt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};C("catalog",ve,vr,ve.variantStyle);C("image",nt);C("inline-heading",ot);C("mini-compare-chart",ye,null,ye.variantStyle);C("plans",z,ct,z.variantStyle,z.collectionOptions);C("plans-students",z,Cr,z.variantStyle,z.collectionOptions);C("plans-education",z,Ar,z.variantStyle,z.collectionOptions);C("plans-v2",K,zr,K.variantStyle,K.collectionOptions);C("product",we,null,we.variantStyle);C("segment",Ee,null,Ee.variantStyle);C("special-offers",ke,Rr,ke.variantStyle);C("simplified-pricing-express",Se,_t,Se.variantStyle);C("full-pricing-express",Ae,Mt,Ae.variantStyle);C("mini",Ce,Dr,Ce.variantStyle);var Rt=i=>{let t=dt.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let a=new CSSStyleSheet;a.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(a)}catch{let n=document.createElement("style");n.textContent=r.cssText,i.shadowRoot.appendChild(n)}return new e(i)};function at(i){return dt.get(i)?.fragmentMapping}function Ir(i){return dt.get(i)?.collectionOptions}var Fr=document.createElement("style");Fr.innerHTML=`
:root {
...
`;document.head.appendChild(Fr);function pt(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Ot(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Ot(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=qi(Ot(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Hi=i=>typeof i=="boolean",ht=i=>typeof i=="function";var Ot=i=>typeof i=="string";function Br(i,t){if(Hi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function qi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var te=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(Ze);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Ui="mas-commerce-service",ji={requestId:Ze,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var mt=i=>window.setTimeout(i);function Nt(){return document.getElementsByTagName(Ui)?.[0]}function Hr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(ji)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function qr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Ur="fragment",jr="author",Gr="preview",Vr="loading",Yr="timeout",$t="aem-fragment",Kr="eager",Wr="cache",Gi=[Kr,Wr],F,re,N,Dt=class{constructor(){g(this,F,new Map);g(this,re,new Map);g(this,N,new Map)}clear(){c(this,F).clear(),c(this,re).clear(),c(this,N).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,F).set(t.id,t),t.fields?.originalId&&c(this,F).set(t.fields.originalId,t),c(this,N).has(t.id)){let[,r]=c(this,N).get(t.id);r()}if(c(this,N).has(t.fields?.originalId)){let[,r]=c(this,N).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,F).has(t)}entries(){return c(this,F).entries()}get(t){return c(this,F).get(t)}getAsPromise(t){let[e]=c(this,N).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,N).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,re).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,re).set(t,e)),e}remove(t){c(this,F).delete(t),c(this,re).delete(t),c(this,N).delete(t)}};F=new WeakMap,re=new WeakMap,N=new WeakMap;var W=new Dt,Te,$,U,M,_,E,je,Ge,D,Ve,Ye,Le,I,Qr,Xr,It,Zr,gt=class extends HTMLElement{constructor(){super(...arguments);g(this,I);l(this,"cache",W);g(this,Te);g(this,$,null);g(this,U,null);g(this,M,null);g(this,_);g(this,E);g(this,je,Kr);g(this,Ge,5e3);g(this,D);g(this,Ve,!1);g(this,Ye,0);g(this,Le)}static get observedAttributes(){return[Ur,Vr,Yr,jr,Gr]}attributeChangedCallback(e,r,a){e===Ur&&(m(this,_,a),m(this,E,W.getFetchInfo(a))),e===Vr&&Gi.includes(a)&&m(this,je,a),e===Yr&&m(this,Ge,parseInt(a,10)),e===jr&&m(this,Ve,["","true"].includes(a)),e===Gr&&m(this,Le,a)}connectedCallback(){if(!c(this,D)){if(c(this,M)??m(this,M,J(this)),m(this,Le,c(this,M).settings?.preview),c(this,Te)??m(this,Te,c(this,M).log.module(`${$t}[${c(this,_)}]`)),!c(this,_)||c(this,_)==="#"){c(this,E)??m(this,E,W.getFetchInfo("missing-fragment-id")),S(this,I,It).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,E)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,D)&&!await Promise.race([c(this,D),Promise.resolve(!1)]))return;e&&W.remove(c(this,_)),c(this,je)===Wr&&await Promise.race([W.getAsPromise(c(this,_)),new Promise(s=>setTimeout(s,c(this,Ge)))]);try{m(this,D,S(this,I,Zr).call(this)),await c(this,D)}catch(s){return S(this,I,It).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,$)||{};return o&&!pt("mas.disableWcsCache")&&c(this,M).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(he,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,E)},bubbles:!0,composed:!0})),c(this,D)}get updateComplete(){return c(this,D)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,Ve)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,$)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,$);m(this,U,e.reduce((h,{name:p,multiple:b,values:P})=>(h.fields[p]=b?P:P[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,$);m(this,U,Object.entries(e).reduce((h,[p,b])=>(h.fields[p]=b?.mimeType?b.value:b??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,_),{locale:c(this,M).settings.locale,apiKey:c(this,M).settings.wcsApiKey})}};Te=new WeakMap,$=new WeakMap,U=new WeakMap,M=new WeakMap,_=new WeakMap,E=new WeakMap,je=new WeakMap,Ge=new WeakMap,D=new WeakMap,Ve=new WeakMap,Ye=new WeakMap,Le=new WeakMap,I=new WeakSet,Qr=async function(e){Xt(this,Ye)._++;let r=`${$t}:${c(this,_)}:${c(this,Ye)}`,a=`${r}${Je}`,n=`${r}${et}`;if(c(this,Le))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,E).stale=!1,c(this,E).url=e,o=await qr(e,{cache:"default",credentials:"omit"}),S(this,I,Xr).call(this,o),c(this,E).status=o?.status,c(this,E).measure=ge(performance.measure(n,a)),c(this,E).retryCount=o.retryCount,!o?.ok)throw new te("Unexpected fragment response",{response:o,...c(this,M).duration});return await o.json()}catch(s){if(c(this,E).measure=ge(performance.measure(n,a)),c(this,E).retryCount=s.retryCount,c(this,$))return c(this,E).stale=!0,c(this,Te).error("Serving stale data",c(this,E)),c(this,$);let d=s.message??"unknown";throw new te(`Failed to fetch fragment: ${d}`,{})}},Xr=function(e){Object.assign(c(this,E),Hr(e))},It=function(e){m(this,D,null),c(this,E).message=e,this.classList.add("error");let r={...c(this,E),...c(this,M).duration};c(this,Te).error(e,r),this.dispatchEvent(new CustomEvent(me,{detail:r,bubbles:!0,composed:!0}))},Zr=async function(){var d;this.classList.remove("error"),m(this,U,null);let e=W.get(c(this,_));if(e)return m(this,$,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,M).settings,s=`${r}/fragment?id=${c(this,_)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await S(this,I,Qr).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,_)),W.add(e),m(this,$,e),!0},l(gt,"cache",W);customElements.define($t,gt);import{LitElement as Vi,html as Yi,css as Ki}from"./lit-all.min.js";var ze=class extends Vi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Yi`<div class="badge">${this.text}</div>`}};l(ze,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),l(ze,"styles",Ki`
        :host {
            display: block;
    ...
    `),l(Ke,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ke);import{html as Ft,css as Zi,LitElement as Ji}from"./lit-all.min.js";var We=class extends Ji{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Ft`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?Ft`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Ft``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(We,"styles",Zi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

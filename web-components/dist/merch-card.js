var Qr=Object.defineProperty;var Zr=a=>{throw TypeError(a)};var Ji=(a,t,e)=>t in a?Qr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var en=(a,t,e)=>()=>{if(e)throw e[0];try{return a&&(t=a(a=0)),t}catch(r){throw e=[r],r}};var tn=(a,t)=>{for(var e in t)Qr(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>Ji(a,typeof t!="symbol"?t+"":t,e),ir=(a,t,e)=>t.has(a)||Zr("Cannot "+e);var p=(a,t,e)=>(ir(a,t,"read from private field"),e?e.call(a):t.get(a)),v=(a,t,e)=>t.has(a)?Zr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),g=(a,t,e,r)=>(ir(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),S=(a,t,e)=>(ir(a,t,"access private method"),e);var dr={};tn(dr,{default:()=>rt});import{LitElement as cn,html as we,css as sn,nothing as ln}from"./lit-all.min.js";import{unsafeHTML as wa}from"./lit-all.min.js";import{ifDefined as dn}from"./lit-all.min.js";function hn(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var D,rt,hr=en(()=>{D=class D extends cn{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();D.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,s=this.shadowRoot?.querySelector(".css-tooltip-body"),l=s?s.offsetWidth:o,h=s?s.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-h-n<0?u="bottom":u==="bottom"&&e.bottom+h+n>i?u="top":u==="left"&&e.left-l-n<0?u="right":u==="right"&&e.right+l+n>r&&(u="left");let y=e.left+e.width/2,k=e.top+e.height/2,L=6,K=(Qi,Zi,Xi)=>Math.max(Qi,Math.min(Zi,Xi)),Q,oe,ar;u==="top"||u==="bottom"?(Q=u==="top"?e.top-h-n:e.bottom+n,oe=K(0,r-l,y-l/2),ar=K(L,l-L*2,y-oe-L)):(oe=u==="left"?e.left-l-n:e.right+n,Q=K(0,i-h,k-h/2),ar=K(L,h-L*2,k-Q-L)),this._tooltipTop=Q,this._tooltipLeft=oe,this._arrowOffset=ar,this._computedPlacement=u}showTooltip(){D.activeTooltip&&D.activeTooltip!==this&&(D.activeTooltip.closeOverlay(),D.activeTooltip.tooltipVisible=!1,D.activeTooltip.requestUpdate()),D.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){D.activeTooltip===this&&(D.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?we`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:we`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;if(!t)return we`<span class="icon-only">${this.renderIcon()}</span>`;if(hn())return we`
                <overlay-trigger
                    placement="${e}"
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${dn(l)}>
                    ${wa(t)}
    ...
    `);rt=D;customElements.define("mas-mnemonic",rt)});import{LitElement as Mc}from"./lit-all.min.js";import{css as ea,unsafeCSS as Jr}from"./lit-all.min.js";var C="(max-width: 767px)",z="(max-width: 1199px)",E="(min-width: 768px)",b="(min-width: 1200px)",R="(min-width: 1600px)",Xe="(min-width: 1280px)",Xr={matchMobile:window.matchMedia(C),matchDesktop:window.matchMedia(`${b} and (not ${R})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(R),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Xr;function At(){return Xr.isDesktop}var ta=ea`
    :host {
...
`,ra=()=>[ea`
        ...
        `];import{LitElement as pn,html as Ea,css as mn}from"./lit-all.min.js";var qc=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Uc=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var xe=2e4;var w='span[is="inline-price"][data-wcs-osi]',G='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var rn='a[is="upt-link"]',aa=`${w},${G},${rn}`,ia=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);var na="merch-offer-select:ready",oa="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",Je="merch-card-quantity:change",nr="merch-modal:addon-and-quantity-update";var ye="merch-card-collection:literals-changed";var Tt="aem:load",Lt="aem:error",ce="mas:ready",ca="mas:error";var sa="placeholder-failed",la="placeholder-pending",da="placeholder-resolved";var ha="mas:failed",F="mas:resolved",pa="mas/commerce";var Z="failed",se="pending",X="resolved";var or="X-Request-Id",jc=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Gc=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var ma=":start",ga=":duration";var M="legal",ua="plan-type-text",fa="mas-ff-defaults";var an="mas-commerce-service";function va(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function P(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function sr(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function lr(){return window.matchMedia("(max-width: 1024px)").matches}var cr=new Map,nn=0;function ba(a,t){let e=++nn,r=t,i=performance.now(),n,o=()=>{zt(e),a()},c=()=>{i=performance.now(),n=setTimeout(o,r)},s=()=>{document.visibilityState==="hidden"?(clearTimeout(n),r-=performance.now()-i):c()};return cr.set(e,()=>{clearTimeout(n),document.removeEventListener("visibilitychange",s)}),document.addEventListener("visibilitychange",s),document.visibilityState!=="hidden"&&c(),e}function zt(a){let t=cr.get(a);t&&(t(),cr.delete(a))}function et(){return document.getElementsByTagName(an)?.[0]}function tt(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}function xa(a){let t=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&t?.isInlinePrice&&t?.dataset?.template==="price"}var on=["www.adobe.com","www.stage.adobe.com"];function ya(a,t=window.location.hostname){if(!a||!on.includes(t))return a;try{let e=new URL(a,`https://${t}`);return/\.aem\.(live|page)$/.test(e.hostname)?`${e.pathname}${e.search}${e.hash}`:a}catch{return a}}function gn(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Ee=class extends pn{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(gn())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",i="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>hr())}e.remove()})}render(){let{href:t}=this,e=ya(this.src);return t?Ea`<a href="${t}">
                  <img
                      src="${e}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(Ee,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(Ee,"styles",mn`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Ee);var at,le,it,nt,ke,Pt=class extends HTMLElement{constructor(){super();v(this,at,"");v(this,le);v(this,it,[]);v(this,nt,[]);v(this,ke);g(this,ke,va(()=>{this.isConnected&&(this.parentElement.style.background=this.value,p(this,le)?this.parentElement.style.borderRadius=p(this,le):p(this,le)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=p(this,it).map((r,i)=>{let n=p(this,nt)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${p(this,at)}, ${e})`}connectedCallback(){p(this,ke).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&g(this,le,i?.trim()),e==="colors"&&i?g(this,it,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?g(this,nt,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&g(this,at,i?.trim()??""),p(this,ke).call(this)}};at=new WeakMap,le=new WeakMap,it=new WeakMap,nt=new WeakMap,ke=new WeakMap;customElements.define("merch-gradient",Pt);import{LitElement as un,html as fn,css as vn}from"./lit-all.min.js";var Se=class extends un{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${w}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(F,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(F,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];if(!r)return;e.setAttribute("data-offer-type",r.offerType);let i=e.closest("p");if(i.getAttribute("data-plan-type"))return;let n=this.querySelector(`p[data-plan-type="${r.planType}"]`);n&&n!==i||i.setAttribute("data-plan-type",r.planType)}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return fn` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(Se,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0},background:{type:String,attribute:"background"}}),d(Se,"styles",vn`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",Se);import{html as _t,nothing as bn}from"./lit-all.min.js";var Ce,ot=class ot{constructor(t){d(this,"card");v(this,Ce);this.card=t,this.insertVariantStyle()}getContainer(){return g(this,Ce,p(this,Ce)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),p(this,Ce)}insertVariantStyle(){let t=this.constructor.name;if(!ot.styleMap[t]){ot.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let r=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${r}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of t){let c=`--consonant-merch-card-${r}-${o}-height`;e.style.getPropertyValue(c)&&e.style.removeProperty(c)}let n=new Map;for(let o of i){let c=o.getBoundingClientRect();if(c.width<=2)continue;let s=Math.round(c.top),l=n.get(s);l||(l=[],n.set(s,l)),l.push(o)}for(let o of n.values())for(let{name:c,getElement:s}of t){let l=`--consonant-merch-card-${r}-${c}-height`,h=o.map(y=>y.style.getPropertyValue(l)),m=0,u=o.map(y=>{y.style.removeProperty(l);let k=s(y);if(!k)return k;let L=Math.max(0,parseInt(window.getComputedStyle(k).height)||0);return L>m&&(m=L),k});o.forEach((y,k)=>{u[k]?.tagName!=="HR"&&(m>0?y.style.setProperty(l,`${m}px`):h[k]&&y.style.setProperty(l,h[k]))})}}get legalDisplayDot(){return!0}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),_t`
        ...
        `}get cardImage(){return _t` <div class="image">
            ...
            ${this.badge}
              ...
              >`:bn}get secureLabelFooter(){return _t`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let t=Promise.allSettled(this.card.prices.map(i=>i.onceSettled?.()||Promise.resolve())),e,r=new Promise(i=>{e=setTimeout(i,xe)});await Promise.race([t,r]),clearTimeout(e)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Mt(this.card.variant)}};Ce=new WeakMap,d(ot,"styleMap",{});var f=ot;import{html as pr,css as xn}from"./lit-all.min.js";var ka=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return ka}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};d(Ae,"variantStyle",xn`
    ...
    `);import{html as ct,css as yn}from"./lit-all.min.js";var Ca=`
:root {
...
`;var Aa={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},de=class extends f{constructor(t){super(t)}getGlobalCSS(){return Ca}renderLayout(){return ct`<div class="image">
    ...
    `);import{html as La}from"./lit-all.min.js";var Ta=`
:root {
...
`;var Rt=class extends f{constructor(t){super(t)}getGlobalCSS(){return Ta}renderLayout(){return La` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":La`<hr />`} ${this.secureLabelFooter}`}};import{html as J,css as wn,unsafeCSS as Pa}from"./lit-all.min.js";var za=`
  :root {
...
`;var En=32,mr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"};function st(a,t,e,r){a.settings?.displayAnnual&&t?.options[r]?e.dataset[r]="false":t?.options[r]&&(t.dataset[r]="false")}var Te=class extends f{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?J`<slot name="secure-transaction-label">
    ...
    `);import{html as Ot,css as kn,unsafeCSS as gr,nothing as Sn}from"./lit-all.min.js";var _a=`
  :root {
...
`;var Cn=32,An=0,Tn=()=>`mweb-list-${An+=1}`,Ln=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],zn=8,vr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},B,he,ze,Pe,_e,ee,ur,fr,Le=class extends f{constructor(e){super(e);v(this,ee);v(this,B);v(this,he);v(this,ze);v(this,Pe,0);v(this,_e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>Ot` <footer>
        ...
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(O,this.updatePriceQuantity),g(this,Pe,this.card.getBoundingClientRect().width),g(this,he,new ResizeObserver(()=>{let e=this.card.getBoundingClientRect().width;e!==p(this,Pe)&&(g(this,Pe,e),clearTimeout(p(this,ze)),g(this,ze,setTimeout(()=>this.reconcileBreakpoint(),150)))})),p(this,he).observe(this.card)}disconnectedCallbackHook(){this.card.removeEventListener(O,this.updatePriceQuantity),clearTimeout(p(this,ze)),p(this,he)?.disconnect(),g(this,he,null),p(this,B)?.disconnect(),g(this,B,null)}reconcileBreakpoint(){x.isMobile?(this.resetSyncedHeights(),this.removeEmptyRows()):S(this,ee,fr).call(this)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}syncHeights(){if(x.isMobile)return;if(this.card.getBoundingClientRect().width<=2){p(this,B)||(g(this,B,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(p(this,B)?.disconnect(),g(this,B,null),this.syncHeights())})),p(this,B).observe(this.card));return}let e=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)}))),this.adjustMiniCompareFooterRows()}priceOptionsProvider(e,r){let i=vr.prices.slot;if(e.closest(`[slot="${i}"]`)){if(e.dataset.template===M){r.displayPlanType=this.card?.settings?.displayPlanType??!1;return}(e.dataset.template==="strikethrough"||e.dataset.template==="price"&&!e.closest?.("merch-card")?.settings?.displayAnnual)&&(r.displayPerUnit=!1)}}getGlobalCSS(){return _a}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,i)=>{let n=Math.max(Cn,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let i=r.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&r.remove()})}setupToggle(){let e=this.card.querySelector('[slot="body-xs"]'),r=e?.querySelector("p"),i=e?.querySelector("ul");if(!r||!i||e.querySelector(".footer-rows-title"))return;let n=r.textContent.trim(),o=this.card.querySelector("h3")?.id,c=o?`${o}-list`:Tn();i.id=c,i.classList.add("checkmark-copy-container");let s=P("h4",{class:"footer-rows-title"},n),l=P("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":c});g(this,_e,{toggleBtn:l,listEl:i}),s.append(l),s.addEventListener("click",()=>{x.isMobile&&this.setListOpen(!this.isListOpen)}),r.replaceWith(s)}get isListOpen(){return p(this,_e)?.listEl.classList.contains("open")??!1}setListOpen(e){let{toggleBtn:r,listEl:i}=p(this,_e);i.classList.toggle("open",e),r.classList.toggle("expanded",e),r.setAttribute("aria-expanded",String(e))}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${w}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayPlanType&&(e.dataset.displayPlanType="false"),st(this.card,e,r,"displayTax"),st(this.card,e,r,"displayPerUnit"),r.setAttribute("data-template","legal"),e.parentNode.insertBefore(r,e.nextSibling),await r.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Sn:Ot`<slot name="icons"></slot>`}renderLayout(){return Ot`
            ${this.badge}
            <div class="body">
                <div class="body-main">
                    ${this.icons}
        ...
        `}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),x.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),x.isMobile||await S(this,ee,fr).call(this)}resetSyncedHeights(){let e=this.getContainer();if(!e)return;let r=this.card.variant,i=S(this,ee,ur).call(this,e);for(let n of Ln){let o=`--consonant-merch-card-${r}-${n}-height`;e.style.removeProperty(o),i.forEach(c=>c.style.removeProperty(o))}for(let n=1;n<=zn;n+=1)e.style.removeProperty(this.getRowMinHeightPropertyName(n))}};B=new WeakMap,he=new WeakMap,ze=new WeakMap,Pe=new WeakMap,_e=new WeakMap,ee=new WeakSet,ur=function(e){return e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)},fr=async function(){let e=this.getContainer();if(!e)return;let r=Array.from(S(this,ee,ur).call(this,e));this.card===r[0]&&(await Promise.all(r.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),requestAnimationFrame(()=>{this.resetSyncedHeights(),this.syncHeights()}))},d(Le,"variantStyle",kn`
    ...
    `);import{html as lt,css as Pn,nothing as Dt}from"./lit-all.min.js";var Ma=`
:root {
...
`;var Nt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ra={...(function(){let{whatsIncluded:a,size:t,...e}=Nt;return e})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Oa={...(function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=Nt;return i})()},H,q,N=class extends f{constructor(e){super(e);v(this,H);v(this,q);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Ma}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let s=n.querySelector(`footer slot[name="${e}"]`),l=n.querySelector(`.body slot[name="${e}"]`),h=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(c)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&s){if(l)s.remove();else{let m=h.querySelector(`[data-placeholder-for="${e}"]`);m?m.replaceWith(s):h.appendChild(s)}return}if(i&&l){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",e),m.classList.add("slot-placeholder"),!s){let u=l.cloneNode(!0);o.prepend(u)}l.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){p(this,H)||(g(this,H,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(p(this,H)?.disconnect(),g(this,H,null),this.syncHeights())})),p(this,H).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(r=>({name:r,getElement:i=>i.querySelector(`[slot="${r}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let c=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let l=0,h=this.card.querySelector('[slot="heading-s"]');h&&(l+=tt(h));let m=this.card.querySelector('[slot="subtitle"]');m&&(l+=tt(m));let u=this.card.querySelector('[slot="heading-m"]');u&&(l+=8+tt(u));for(let k of r.childNodes){if(k.classList.contains("spacer"))break;l+=tt(k)}let y=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(y)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${w}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?lt`<div class="divider"></div>`:Dt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled?.();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?lt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};H=new WeakMap,q=new WeakMap,d(N,"variantStyle",Pn`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),d(N,"collectionOptions",{customHeaderArea:e=>e.sidenav?lt`<slot name="resultsText"></slot>`:Dt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let r=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let c=o.getAttribute("size"),s=c==="wide"?2:c==="super-wide"?3:1;s===2&&n%3===2&&(o.setAttribute("data-size",c),o.removeAttribute("size"),s=1),n+=s}};x.matchDesktop.addEventListener("change",r),e.addEventListener(ye,r),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",r),e.removeEventListener(ye,r)})}});import{html as V,css as _n,unsafeCSS as Na,nothing as $t}from"./lit-all.min.js";var Da=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?V`
        ...
        `:V`
            ...
            `:$t}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?V`<slot name="icons"></slot>`:$t}get secureLabelFooter(){return V`<footer>
            ...
            <slot></slot>`}};d(te,"variantStyle",_n`
    ...
    `),d(te,"collectionOptions",{customHeaderArea:t=>t.sidenav?V`<slot name="resultsText"></slot>`:$t,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let e=()=>{let r=t.querySelectorAll("merch-card");if(r.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!x.isDesktop)return;let i=0;r.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),c=o==="wide"?2:o==="super-wide"?3:1;c===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),c=1),i+=c})};x.matchDesktop.addEventListener("change",e),t.addEventListener(ye,e),t.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",e),t.removeEventListener(ye,e)})}});import{html as W,css as Mn,nothing as Me,unsafeCSS as dt}from"./lit-all.min.js";var $a=`
:root {
...
`;var[Al,Tl,Fa,Ia,Ba,Ha]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var It="pro",xr=`--consonant-merch-card-${It}-top-card-height`,Ft=[{prop:`--consonant-merch-card-${It}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${It}-name-description-height`,selector:".name-description"}],qa=`--consonant-merch-card-${It}-strike-reserve`,yr='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',Rn="(min-width: 768px)",Ua={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Y,pe,gt,ut,_,ja,ht,Ga,pt,wr,Bt,Ht=class Ht extends f{constructor(e){super(e);v(this,_);d(this,"expanded",!1);d(this,"licenseOpen",!1);d(this,"licenseQty",null);d(this,"licenseHighlightedIndex",0);v(this,Y,null);v(this,pe,null);v(this,gt,()=>this.resyncOnReflow());d(this,"lastSyncKey",null);v(this,ut,({detail:e})=>{let r=e?.quantity==null?null:String(e.quantity);r==null||r===this.licenseQty||this.licenseOptions?.includes(r)&&(this.licenseQty=r,this.card.requestUpdate())});d(this,"toggleExpanded",e=>{e.preventDefault();let r=!this.expanded;for(let i of S(this,_,ja).call(this)){let n=i.variantLayout;n instanceof Ht&&(n.expanded=r,i._proExpanded=r,i.requestUpdate())}});d(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?S(this,_,wr).call(this):S(this,_,pt).call(this),this.card.requestUpdate()});v(this,Bt,e=>{let r=this.licenseOptions;if(!r?.length)return;let i=r.length-1;switch(e.key){case Ia:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%r.length:S(this,_,pt).call(this);break;case Fa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+r.length)%r.length:S(this,_,pt).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Ba:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(r[this.licenseHighlightedIndex]);return}S(this,_,pt).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),S(this,_,wr).call(this);break;case Ha:this.licenseOpen&&this.selectLicenseQty(r[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});d(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,S(this,_,ht).call(this);let r=this.quantitySelectEl;r&&(r.selectedValue=Number(e),r.dispatchEvent(new CustomEvent(O,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._proExpanded??!1}getGlobalCSS(){return $a}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let r=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),r.dataset.displayPerUnit="false",e.parentNode.insertBefore(r,e.nextSibling),await r.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),r.addEventListener(F,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]');if(!e?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=e.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled?.();let i=r.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let e=this.card.querySelector('[slot="whats-included"]');if(!e||e.querySelector(".whats-included-title"))return;let r=e.querySelector(".whats-included-label");if(!r)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=r.innerHTML,r.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},c=document.createElement("p");if(c.className="whats-included-label",c.textContent=n??"",i.after(c),e.querySelectorAll(".section h4:not(.whats-included-title)").forEach(s=>{let l=document.createElement("p");l.innerHTML=s.innerHTML,s.replaceWith(l)}),o){let s=document.createElement("div");s.className="whats-included-disclaimer",s.innerHTML=o,e.append(s)}}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(r=>{let i=window.getComputedStyle(r),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,r.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let r=this.card.variant,i=xr,n=[...e.querySelectorAll(`merch-card[variant="${r}"]`)].filter(s=>s.getBoundingClientRect().width>2&&s.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(Rn).matches){n.forEach(s=>this.clearSyncedHeights(s));return}let o=new Map;for(let s of n){let l=o.get(s.offsetTop)??[];l.push(s),o.set(s.offsetTop,l)}let c=(s,l)=>s.reduce((h,m)=>{let u=l(m);return u?Math.max(h,parseInt(getComputedStyle(u).height)||0):h},0);for(let s of o.values()){if(s.forEach(u=>this.clearSyncedHeights(u)),s.length<2)continue;let l=s.map(u=>u.querySelector(yr)&&parseInt(getComputedStyle(u.querySelector(yr)).height)||0),h=Math.max(0,...l);h>0&&s.forEach((u,y)=>{let k=h-l[y];k>0&&u.style.setProperty(qa,`${k}px`)});for(let u of Ft){let y=c(s,k=>k.shadowRoot?.querySelector(u.selector));y>0&&s.forEach(k=>k.style.setProperty(u.prop,`${y}px`))}let m=c(s,u=>u.shadowRoot?.querySelector(".top-card"));m>0&&s.forEach(u=>u.style.setProperty(i,`${m}px`))}}clearSyncedHeights(e){e.style.removeProperty(xr),e.style.removeProperty(qa),Ft.forEach(r=>e.style.removeProperty(r.prop))}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let r=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(e),r('[slot="body-xs"]'),r(yr),r('[slot="heading-m"] span[is="inline-price"]'),r('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),r(".license-zone",this.card.shadowRoot),r(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Je,p(this,ut)),this.card.addEventListener(O,this.updatePriceQuantity),this.card.addEventListener(F,p(this,gt)),typeof ResizeObserver>"u"))return;g(this,pe,new ResizeObserver(()=>this.resyncOnReflow())),p(this,pe).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&p(this,pe).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(O,this.updatePriceQuantity),this.card?.removeEventListener(F,p(this,gt)),S(this,_,ht).call(this),p(this,pe)?.disconnect(),this.card?.removeEventListener(Je,p(this,ut))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let r=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(r)||Number.isNaN(i)||i<r||n<1)return null;let o=[];for(let c=r;c<=i;c+=n)o.push(String(c));return o}licenseLabel(e){let r=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=r.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let r=this.quantitySelectEl?.getAttribute("default-value");return r!=null&&e.includes(r)?r:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return W`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,r=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(r));return W`
        ...
        `}renderLayout(){let e=!!this.expanded;return W`
            ...
            <slot></slot>
        `}};Y=new WeakMap,pe=new WeakMap,gt=new WeakMap,ut=new WeakMap,_=new WeakSet,ja=function(){let e=this.card.offsetTop,r=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return r.length?r:[this.card]},ht=function(){p(this,Y)&&(document.removeEventListener("mousedown",p(this,Y)),g(this,Y,null))},Ga=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},pt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=S(this,_,Ga).call(this),p(this,Y)||(g(this,Y,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),S(this,_,ht).call(this))}),document.addEventListener("mousedown",p(this,Y)))},wr=function(){this.licenseOpen=!1,S(this,_,ht).call(this)},Bt=new WeakMap,d(Ht,"variantStyle",Mn`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
        ...
        :host([variant='pro']) .mnemonic {
            ...
            align-items: center;
            gap: 12px;
            min-height: var(${dt(Ft[0].prop)}, auto);
        }
        ...
        :host([variant='pro']) .name-description {
            ...
            flex: 0 0 auto;
            min-height: var(${dt(Ft[1].prop)}, auto);
        }
    ...
    `);var mt=Ht;import{html as Er,css as On}from"./lit-all.min.js";var Va=`
:root {
...
`;var Wa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},U,Re=class extends f{constructor(e){super(e);v(this,U);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Va}priceOptionsProvider(e,r){e.dataset.template===M&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Er` ${this.badge}
    ...
    `);import{html as Dn,css as Nn}from"./lit-all.min.js";var Ya=`
...
`;var Ka={cardName:{attribute:"name"},mnemonics:{size:"l"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},planType:!0,promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},Oe=class extends f{getGlobalCSS(){return Ya}priceOptionsProvider(t,e){t.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`);if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}renderLayout(){return Dn` ${this.badge}
            ...
            <slot></slot>`}};d(Oe,"variantStyle",Nn`
    ...
    `);import{html as kr,css as $n}from"./lit-all.min.js";var Qa=`
:root {
...
`;var Za={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},De=class extends f{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Qa}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return kr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Fn,css as In}from"./lit-all.min.js";var Xa=`
...
`;var Ja={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ne=class extends f{constructor(t){super(t)}getGlobalCSS(){return Xa}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Fn`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as Sr,css as Bn}from"./lit-all.min.js";var ei=`
:root {
...
`;var ti={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},$e=class extends f{constructor(e){super(e);d(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ei}priceOptionsProvider(e,r){r.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayPlanType="false",r.dataset.template="legal",r.dataset.displayPerUnit="false",r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Sr`${this.cardImage}
            <div class="body">
    ...
    `);import{html as ai,css as Hn}from"./lit-all.min.js";var ri=`
:root {
...
`;var Cr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Fe=class extends f{getGlobalCSS(){return ri}get aemFragmentMapping(){return Cr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let t=this.card.querySelector('[slot="badge"]');return ai`<div
    ...
    `);import{html as ni,css as qn}from"./lit-all.min.js";var ii=`
:root {
...
`;var Ar={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},ft=class ft extends f{getGlobalCSS(){return ii}get aemFragmentMapping(){return Ar}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let t=this.card.querySelector('[slot="badge"]');return ni`<div
        ...
        >
            ...
            <slot></slot>
        `}};d(ft,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),d(ft,"variantStyle",qn`
    ...
    `);var vt=ft;import{html as bt,nothing as ci}from"./lit-all.min.js";import{css as Un,unsafeCSS as jn}from"./lit-all.min.js";var oi=["headless","marquee","faq","banner-blade"],Ie=(a,t="")=>oi.map(e=>`merch-card[variant='${e}'] [slot='${a}']${t}`).join(`,
`),Tr=a=>oi.map(t=>`merch-card[variant='${t}'] ${a}`).join(`,
`),re=`
...
${Tr(".headless-cta-item")} {
    display: inline-flex;
    align-items: center;
}
${Tr(".headless-cta-variant-label")} {
    font-size: 0.75em;
...
${Tr(".headless-cta-item:not(:last-child)::after")} {
    content: ', ';
}
`;function ae(a){let t=jn(a);return Un`
        :host([variant='${t}']) {
            border: none;
            background: transparent;
            box-shadow: none;
        ...
        :host([variant='${t}']) .headless-backgrounds-toggle {
        ...
        :host([variant='${t}']) .headless-backgrounds-detail {
            flex-direction: column;
            padding-left: var(--consonant-merch-spacing-l, 24px);
        }
        :host([variant='${t}']) .headless-backgrounds-detail.hidden {
            display: none;
        }
        :host([variant='${t}']) .headless-backgrounds-detail-row {
            display: flex;
            gap: var(--consonant-merch-spacing-xs, 8px);
            padding: var(--consonant-merch-spacing-xxs, 4px) 0;
        }
    ...
    `}var si={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},Gn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Be=class extends f{constructor(t){super(t)}getGlobalCSS(){return re}renderLayout(){let t=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return bt`
        ...
        `}};d(Be,"variantStyle",ae("headless"));import{css as Vn,html as Wn}from"./lit-all.min.js";var li=`
...
`;var di={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},He=class extends f{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return li}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Wn`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Yn,css as Kn}from"./lit-all.min.js";var hi=`
...
`;var Lr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Qn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],qt,pi,qe=class extends f{constructor(e){super(e);v(this,qt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return hi}get aemFragmentMapping(){return Lr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,S(this,qt,pi).call(this))}renderLayout(){return Yn`
            <div class="card">
            ...
            <slot></slot>
        `}};qt=new WeakSet,pi=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Qn.forEach(({key:r,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),r))},d(qe,"variantStyle",Kn`
    ...
    `);import{html as Zn,css as Xn}from"./lit-all.min.js";var mi=`
...
`;var zr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ue=class extends f{getGlobalCSS(){return mi}get aemFragmentMapping(){return zr}renderLayout(){return Zn`
    ...
    `);import{html as Rr,nothing as Wt}from"./lit-all.min.js";import{html as Mr}from"./lit-all.min.js";function Jn(a,t){if(typeof a!="string"||!a)return null;let e;try{e=new URL(a,t)}catch{return null}return e.hostname.endsWith(".aem.page")?`${t}${e.pathname}${e.search}`:null}function eo(a){return a?.hostname==="www.adobe.com"||a?.hostname==="adobe.com"}function Pr(a,t=globalThis.location){if(typeof a!="string"||!a||!eo(t))return a;let e=document.createElement("template");return e.innerHTML=`<picture>${a}</picture>`,e.content.querySelectorAll("source[srcset], img[src]").forEach(r=>{let i=r.tagName==="IMG"?"src":"srcset",n=Jn(r.getAttribute(i),t.origin);n&&r.setAttribute(i,n)}),e.content.querySelector("picture").innerHTML}var to=new Set(["SOURCE","IMG"]),ro=new Set(["src","srcset","media","type","alt","role","loading","data-mobile-set","width","height"]);function _r(a){if(typeof a!="string"||!a)return"";let t=document.createElement("template"),e=/^\s*<picture[\s>]/i.test(a);t.innerHTML=e?a:`<picture>${a}</picture>`;let r=t.content.querySelector("picture");return r?(r.querySelectorAll("*").forEach(i=>{if(!to.has(i.tagName)){i.remove();return}[...i.attributes].forEach(n=>{ro.has(n.name.toLowerCase())||i.removeAttribute(n.name)})}),r.innerHTML):""}var ao="(min-width: 1200px)",io="(min-width: 600px)";function gi(a,t){if(!a)return"";let e=new DOMParser().parseFromString(`<picture>${a}</picture>`,"text/html");if(t==="desktop")return e.querySelector(`source[media="${ao}"]`)?.getAttribute("srcset")??"";if(t==="tablet")return e.querySelector(`source[media="${io}"]`)?.getAttribute("srcset")??"";if(t==="mobile"){let r=e.querySelector("img");return r?.hasAttribute("data-mobile-set")?r.getAttribute("src")??"":""}return""}var ui=["tablet","mobile"];function fi(a,t){let r=a.querySelector('[slot="backgrounds"]')?.innerHTML??"";ui.forEach(i=>{let n=t.querySelector(`[data-backgrounds-breakpoint="${i}"]`);if(!n)return;n.replaceChildren();let o=gi(r,i);if(!o){n.textContent="\u2014";return}let c=document.createElement("img");c.loading="lazy",c.alt="",c.src=o,n.append(c)})}function Ut(a){return function(e){let r=a(),i=r.shadowRoot?.querySelector(".headless-backgrounds-detail");if(!i)return;let n=i.classList.contains("hidden");n&&fi(r,i),i.classList.toggle("hidden",!n),e.target.textContent=n?"Show default only":"See all backgrounds"}}function jt(a){return function(){let e=a(),r=e.shadowRoot?.querySelector(".headless-backgrounds-detail");!r||r.classList.contains("hidden")||fi(e,r)}}function Gt(a){return Mr`
        <button
            type="button"
    ...
    `}function no(a){return`Background ${a[0].toUpperCase()}${a.slice(1)}`}function Vt(){return Mr`
    ...
    `}var vi={cardName:{attribute:"name"},image:{tag:"picture",slot:"image"},backgrounds:{tag:"picture",slot:"backgrounds"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},oo=[{slot:"image",label:"Image"},{slot:"backgrounds",label:"Background"},{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],je=class extends f{constructor(e){super(e);d(this,"toggleBackgroundsDetail",Ut(()=>this.card));d(this,"refreshBackgroundsDetail",jt(()=>this.card))}getGlobalCSS(){return re}renderLayout(){return Rr`
            <div class="headless">
                ${oo.map(({slot:e,label:r})=>Rr`
                        <div class="headless-row">
                            <span class="headless-label">${r}</span>
                            <span class="headless-value" data-slot="${e}">
                                <slot
                                    name="${e}"
                                    @slotchange=${e==="backgrounds"?this.refreshBackgroundsDetail:Wt}
                                ></slot>
                                ${e==="backgrounds"?Gt(this.toggleBackgroundsDetail):Wt}
                            </span>
                        </div>
                        ${e==="backgrounds"?Vt():Wt}
                    `)}
                ${this.card.secureLabel?Rr`
                          <div class="headless-row">
                              <span class="headless-label">Secure label</span>
                              <span class="headless-value">
                                  ${this.secureLabel}
        ...
        `}};d(je,"variantStyle",ae("marquee"));import{html as bi}from"./lit-all.min.js";var xi={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},co=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],Ge=class extends f{constructor(t){super(t)}getGlobalCSS(){return re}renderLayout(){return bi`
            <div class="headless">
                ${co.map(({slot:t,label:e})=>bi`
                        <div class="headless-row">
        ...
        `}};d(Ge,"variantStyle",ae("faq"));import{html as yi,nothing as Or}from"./lit-all.min.js";var wi={cardName:{attribute:"name"},image:{tag:"picture",slot:"image"},backgrounds:{tag:"picture",slot:"backgrounds"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},so=[{slot:"image",label:"Image"},{slot:"backgrounds",label:"Background"},{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],Ve=class extends f{constructor(e){super(e);d(this,"toggleBackgroundsDetail",Ut(()=>this.card));d(this,"refreshBackgroundsDetail",jt(()=>this.card))}getGlobalCSS(){return re}renderLayout(){return yi`
            <div class="headless">
                ${so.map(({slot:e,label:r})=>yi`
                        <div class="headless-row">
                            <span class="headless-label">${r}</span>
                            <span class="headless-value" data-slot="${e}">
                                <slot
                                    name="${e}"
                                    @slotchange=${e==="backgrounds"?this.refreshBackgroundsDetail:Or}
                                ></slot>
                                ${e==="backgrounds"?Gt(this.toggleBackgroundsDetail):Or}
                            </span>
                        </div>
                        ${e==="backgrounds"?Vt():Or}
                    `)}
            </div>
        `}};d(Ve,"variantStyle",ae("banner-blade"));var Yt=new Map,Ei=new WeakMap,ki=new Map,A=(a,t,e=null,r=null,i)=>{Yt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};A("catalog",Ae,Sa,Ae.variantStyle);A("image",de);A("inline-heading",Rt);A("mini-compare-chart",Te,mr,Te.variantStyle);A("mini-compare-chart-mweb",Le,vr,Le.variantStyle);A("plans",N,Nt,N.variantStyle,N.collectionOptions);A("plans-students",N,Oa,N.variantStyle,N.collectionOptions);A("plans-education",N,Ra,N.variantStyle,N.collectionOptions);A("plans-v2",te,br,te.variantStyle,te.collectionOptions);A("pro",mt,Ua,mt.variantStyle);A("product",Re,Wa,Re.variantStyle);A("brand-concierge-product",Oe,Ka,Oe.variantStyle);A("segment",De,Za,De.variantStyle);A("media",Ne,Ja,Ne.variantStyle);A("headless",Be,si,Be.variantStyle);A("special-offers",$e,ti,$e.variantStyle);A("simplified-pricing-express",Fe,Cr,Fe.variantStyle);A("full-pricing-express",vt,Ar,vt.variantStyle);A("mini",He,di,He.variantStyle);A("image",de,Aa,de.variantStyle);A("compare-chart-column",qe,Lr,qe.variantStyle);A("fries",Ue,zr,Ue.variantStyle);A("marquee",je,vi,je.variantStyle);A("faq",Ge,xi,Ge.variantStyle);A("banner-blade",Ve,wi,Ve.variantStyle);var lo=(a,t,e)=>{try{let r=ki.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),ki.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Dr=a=>{let t=Yt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=Ei.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?lo(a,r,i):{};return Ei.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Mt(a){return Yt.get(a)?.fragmentMapping}function Si(a){return Yt.get(a)?.collectionOptions}var Ci=document.createElement("style");Ci.innerHTML=`
:root {
...
`;document.head.appendChild(Ci);import{LitElement as ho,html as Nr,css as po,nothing as mo}from"./lit-all.min.js";import{unsafeHTML as go}from"./lit-all.min.js";var uo=a=>a?a.startsWith("sp-icon-")?Nr`${go(`<${a} class="badge-icon"></${a}>`)}`:Nr`<img src="${a}" class="badge-icon" />`:mo,We=class extends ho{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Nr`<div class="badge">
            ${uo(this.icon)}<slot>${this.text}</slot>
        </div>`}};d(We,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),d(We,"styles",po`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",We);import{html as fo,css as vo,LitElement as bo}from"./lit-all.min.js";var xt=class extends bo{constructor(){super()}render(){return fo`
            <slot name="icon"></slot>
    ...
    `),d(xt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",xt);import{html as $r,css as xo,LitElement as yo,nothing as Ai}from"./lit-all.min.js";var yt=class extends yo{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return $r`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?$r`<slot name="content"></slot>`:Ai}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?$r`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Ai}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(yt,"styles",xo`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),d(yt,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",yt);function Ti(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=Fr(r)?r:a;n=o.get(c)}if(i&&n==null){let o=Fr(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Eo(Fr(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var wo=a=>typeof a=="boolean",Kt=a=>typeof a=="function";var Fr=a=>typeof a=="string";function Li(a,t){if(wo(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Eo(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var me={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},zi=1e3;function ko(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Pi(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!me.serializableTypes.includes(e))return e}return a}function So(a,t){if(!me.ignoredProperties.includes(a))return Pi(t)}var Ir={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(l=>{l!=null&&(ko(l)?r:i).push(l)}),r.length&&(n+=` ${r.map(Pi).join(" ")}`);let{pathname:o,search:c}=window.location,s=`${me.delimiter}page=${o}${c}`;s.length>zi&&(s=`${s.slice(0,zi)}<trunc>`),n+=s,i.length&&(n+=`${me.delimiter}facts=`,n+=JSON.stringify(i,So)),window.lana?.log(n,me)}};function _i(a){Object.assign(me,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in me&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Mi={LOCAL:"local",PROD:"prod",STAGE:"stage"},Br={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Hr=new Set,qr=new Set,Ri=new Map,Oi={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Di={filter:({level:a})=>a!==Br.DEBUG},Co={filter:()=>!1};function Ao(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Kt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function To(a){[...qr].every(t=>t(a))&&Hr.forEach(t=>t(a))}function Ni(a){let t=(Ri.get(a)??0)+1;Ri.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Ni(`${r.namespace}/${i}`),updateConfig:_i};return Object.values(Br).forEach(i=>{r[i]=(n,...o)=>To(Ao(i,n,a,o,e))}),Object.seal(r)}function Qt(...a){a.forEach(t=>{let{append:e,filter:r}=t;Kt(r)&&qr.add(r),Kt(e)&&Hr.add(e)})}function Lo(a={}){let{name:t}=a,e=Li(Ti("commerce.debug",{search:!0,storage:!0}),t===Mi.LOCAL);return Qt(e?Oi:Di),t===Mi.PROD&&Qt(Ir),wt}function zo(){Hr.clear(),qr.clear()}var wt={...Ni(pa),Level:Br,Plugins:{consoleAppender:Oi,debugFilter:Di,quietFilter:Co,lanaAppender:Ir},init:Lo,reset:zo,use:Qt};var Po="mas-commerce-service",wp=wt.module("utilities");var Zt=a=>window.setTimeout(a);function $i(a){return a==null?[]:Array.isArray(a)?a:String(a).split(",").map(t=>t.trim())}function Ur(){return document.getElementsByTagName(Po)?.[0]}var Xt=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(or);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var _o={[Z]:sa,[se]:la,[X]:da},Mo={[Z]:ha,[X]:F},Et,Jt=class{constructor(t){v(this,Et);d(this,"changes",new Map);d(this,"connected",!1);d(this,"error");d(this,"log");d(this,"options");d(this,"promises",[]);d(this,"state",se);d(this,"timer",null);d(this,"value");d(this,"version",0);d(this,"wrapperElement");this.wrapperElement=t,this.log=wt.module("mas-element")}update(){[Z,se,X].forEach(t=>{this.wrapperElement.classList.toggle(_o[t],t===this.state)})}notify(){(this.state===X||this.state===Z)&&(this.state===X?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===Z&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof Xt&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Mo[this.state],{bubbles:!0,composed:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){g(this,Et,Ur()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return X===r?Promise.resolve(this.wrapperElement):Z===r?Promise.reject(t):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=X,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),Zt(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=Z,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...p(this,Et)?.duration}),Zt(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=se,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!Ur()||this.timer)return;let{error:e,options:r,state:i,value:n,version:o}=this;this.state=se,this.timer=Zt(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===se&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(s){this.toggleFailed(this.version,s,r)}})}};Et=new WeakMap;function Ro(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ue,ge=class ge extends HTMLAnchorElement{constructor(){super();d(this,"masElement",new Jt(this));v(this,ue);this.setAttribute("is",ge.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,i){this.masElement.attributeChangedCallback(e,r,i)}connectedCallback(){this.masElement.connectedCallback(),g(this,ue,et()),p(this,ue)&&(this.log=p(this,ue).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),g(this,ue,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=et();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:c,language:s,env:l}=r,h=`locale=${s}_${c}&country=${c}&offer_id=${o.offerId}`,m=this.getAttribute("data-promotion-code");m&&(h+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${Ro(l)}?${h}`,this.masElement.toggleResolved(i,o,r)}catch(o){let c=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,c,r),!1}}static createFrom(e){let r=new ge;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?r.setAttribute("class",i.value.replace("upt-link","").trim()):r.setAttribute(i.name,i.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};ue=new WeakMap,d(ge,"is","upt-link"),d(ge,"tag","a"),d(ge,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var ie=ge;window.customElements.get(ie.is)||window.customElements.define(ie.is,ie,{extends:ie.tag});var Oo="#000000",jr="#F8D904",Do="#EAEAEA",No="#31A547",$o=/(accent|primary|secondary)(-(outline|link))?/,Fo="mas:product_code/",Io="daa-ll",er="daa-lh",Bo=["XL","L","M","S"],Gr="...",Ho=new Set(["headless","marquee","banner-blade"]),qo={STRONG:"Primary",EM:"Secondary"};function $(a,t,e,r){let i=r[a];if(t[a]&&i){let n={slot:i?.slot,...i?.attributes},o=t[a];if(i.maxCount&&typeof o=="string"){let[s,l]=uc(o,i.maxCount,i.withSuffix);s!==o&&(n.title=l,o=s)}let c=P(i.tag,n,o);e.append(c)}}function Uo(a,t,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,c)=>({icon:o,alt:a.mnemonicAlt?.[c]??"",link:a.mnemonicLink?.[c]??""}));i?.forEach(({icon:o,alt:c,link:s})=>{if(s&&!/^https?:/.test(s))try{s=new URL(`https://${s}`).href.toString()}catch{s="#"}let l={slot:"icons",src:o,loading:t.loading,size:e?.size??"l"};c&&(l.alt=c),s&&(l.href=s);let h=P("merch-icon",l);t.append(h)});let n=t.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function jo(a){let t=new DOMParser().parseFromString(a,"text/html").querySelector("merch-badge");return t?t.querySelector('span[is="inline-price"]')?!1:!t.textContent?.trim():!0}function Go(a,t,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let i=jr,n=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(i=e.badge?.default,a.borderColor||(n=!0));let o=a.badgeBackgroundColor||i,c=a.borderColor||"";n&&(c=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${o}" border-color="${c}">${a.badge}</merch-badge>`}a.badge?.startsWith("<merch-badge")&&jo(a.badge)&&(a.badge=""),$("badge",a,t,e)}else a.badge?(t.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",a.badgeColor||Oo),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",a.badgeBackgroundColor||jr),t.setAttribute("border-color",a.badgeBackgroundColor||jr)):t.setAttribute("border-color",a.borderColor||Do)}function Vo(a,t,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||No;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${r}">${a.trialBadge}</merch-badge>`}$("trialBadge",a,t,e)}}function Wo(a,t,e){e?.includes(a.size)&&t.setAttribute("size",a.size)}function Yo(a,t){a.cardName&&t.setAttribute("name",a.cardName)}function Ko(a,t,e){a.cardTitle&&(a.cardTitle=Ye(a.cardTitle)),$("cardTitle",a,t,{cardTitle:e})}function Qo(a,t,e){$("subtitle",a,t,e)}function Zo(a,t,e,r){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[a.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),t.setAttribute("background-color",a.backgroundColor)):r?.attribute&&a.backgroundColor&&(t.setAttribute(r.attribute,a.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function Xo(a,t,e){let r=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")t.style.setProperty(i,"transparent");else if(a.borderColor&&r){let o=r?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),c=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){t.setAttribute("gradient-border","true");let s=a.borderColor;if(r?.specialValues){for(let[l,h]of Object.entries(r.specialValues))if(h===a.borderColor){s=l;break}}t.setAttribute("border-color",s),t.style.removeProperty(i)}else c?(t.setAttribute("border-color",a.borderColor),t.style.setProperty(i,`var(--${a.borderColor})`)):t.style.setProperty(i,`var(--${a.borderColor})`)}else t.style.removeProperty(i)}var Jo=new Set(["","default"]);function ec(a,t,e){let r=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!r)return;let o=(t.querySelector('[slot="footer-rows"] merch-whats-included')??t.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),c=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",s=o||c;if(s==null||Jo.has(String(s).trim().toLowerCase())){t.removeAttribute("whats-included-divider-color"),t.style.removeProperty(i);return}let l=String(s).trim();if(l.toLowerCase()==="transparent"){t.removeAttribute("whats-included-divider-color"),t.style.setProperty(i,"transparent");return}let m=r.specialValues?.[l]?.includes("gradient")||/-gradient/.test(l)||/^gradient-/.test(l),u=/^spectrum-.*-(plans|special-offers)$/.test(l);if(m){let y=l;if(r.specialValues){for(let[k,L]of Object.entries(r.specialValues))if(L===l){y=k;break}}t.setAttribute("whats-included-divider-color",y),t.style.removeProperty(i)}else u?(t.setAttribute("whats-included-divider-color",l),t.style.setProperty(i,`var(--${l})`)):(t.removeAttribute("whats-included-divider-color"),t.style.setProperty(i,`var(--${l})`))}function tc(a,t,e){if(a.backgroundImage){let r={loading:t.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?r.alt=a.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,a.backgroundImage);return}t.append(P(e.tag,{slot:e.slot},P("img",r)))}}function rc(a,t,e){e.image?.slot&&(a.image&&(a.image=Pr(_r(a.image))),$("image",a,t,e))}function ac(a,t,e){e.backgrounds?.slot&&(a.backgrounds&&(a.backgrounds=Pr(_r(a.backgrounds))),$("backgrounds",a,t,e))}function Ye(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(hr(),dr)).catch(console.error),a}function ic(a,t,e){a.prices&&(a.prices=Ye(a.prices)),$("prices",a,t,e)}function Vr(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap(Vr);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap(Vr);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function nc(a,t,e){let r=Vr(a.features).filter(n=>n.trim());if(!r.length)return;let i=P("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});r.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let c=o.body.querySelector("p[name]");if(c){i.append(c);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&t.append(i),sc(t,e)}function oc(a){let e=customElements.get("checkout-link")?.createCheckoutLink(a.dataset,a.innerHTML)??a;if(e===a)return e;for(let r of a.attributes)["class","is","href"].includes(r.name)||e.setAttribute(r.name,r.value);return e}function Ii(a,t,e,r=!1){let i=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),n=a.className||"",o=a.parentElement?.tagName,c=r&&!n&&Ho.has(t.variant),s=n?$o.exec(n)?.[0]??"accent":"accent",l=!c&&s.includes("accent"),h=!c&&s.includes("primary"),m=!c&&s.includes("secondary"),u=!c&&s.includes("-outline"),y=c||s.includes("-link");a.classList.remove("accent","primary","secondary");let k;if(t.consonant)k=xc(a,l,i,y,h,m,e?.ctas?.size);else if(y)k=c&&i?oc(a):a;else{let L;l?L="accent":h?L="primary":m&&(L="secondary"),k=t.spectrum==="swc"?bc(a,e,u,L,i):vc(a,e,u,L,i)}if(c){let L=k;if(o==="STRONG"||o==="EM"){let oe=document.createElement(o.toLowerCase());oe.append(k),L=oe}let K=document.createElement("span");K.className="headless-cta-variant-label",K.textContent=qo[o]??"Link";let Q=document.createElement("span");return Q.className="headless-cta-item",Q.append(L,K),Q}return k}function cc(a,t){let{slot:e}=t?.description;Bi(a,t,e)}function sc(a,t){let e=t?.features?.slot;e&&Bi(a,t,e)}function Bi(a,t,e){let r=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(i=>{let n=Ii(i,a,t);i.replaceWith(n)})}function lc(a,t,e,r){a.description&&(a.description=Ye(a.description)),a.promoText&&(a.promoText=Ye(a.promoText)),a.shortDescription&&(a.shortDescription=Ye(a.shortDescription)),$("promoText",a,t,e),$("description",a,t,e),$("shortDescription",a,t,e),a.shortDescription&&(t.setAttribute("action-menu","true"),a.actionMenuLabel||t.setAttribute("action-menu-label","More options")),cc(t,e),$("callout",a,t,e),dc(a,t,e,r),$("whatsIncluded",a,t,e)}function dc(a,t,e,r={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=r.quantitySelect),$("quantitySelect",a,t,e))}function hc(a,t,e,r={}){if(!e.addon)return;let n=(a.addon??r.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o,c=n,s=document.createElement("div");s.innerHTML=n;let l=s.firstElementChild;l?.tagName?.toLowerCase()==="merch-addon"&&(o=l.getAttribute("background")||void 0,c=l.innerHTML);let h={slot:"addon"};o&&(h.background=o);let m=P("merch-addon",h,c);[...m.querySelectorAll(w)].forEach(u=>{let y=u.parentElement;y?.nodeName==="P"&&(y.hasAttribute("data-plan-type")||y.setAttribute("data-plan-type",""))}),t.append(m)}function pc(a,t,e){a.addonConfirmation&&$("addonConfirmation",a,t,e)}function mc(a,t,e){let r=e?.customFields;if(!r)return;let i=Array.isArray(a.customFields)?a.customFields:a.customFields?[a.customFields]:[],n=Array.isArray(a.customFieldLabels)?a.customFieldLabels:a.customFieldLabels?[a.customFieldLabels]:[];i.filter(Boolean).forEach((o,c)=>{let s=n[c],l=P(r.tag,{slot:`custom-field-${c}`,"data-label":s||""},o);t.append(l)})}function gc(a,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function uc(a,t,e=!0){try{let r=typeof a!="string"?"":a,i=Fi(r);if(i.length<=t)return[r,i];let n=0,o=!1,c=e?t-Gr.length<1?1:t-Gr.length:t,s=[];for(let m of r){if(n++,m==="<")if(o=!0,r[n]==="/")s.pop();else{let u="";for(let y of r.substring(n)){if(y===" "||y===">")break;u+=y}s.push(u)}if(m==="/"&&r[n]===">"&&s.pop(),m===">"){o=!1;continue}if(!o&&(c--,c===0))break}let l=r.substring(0,n).trim();if(s.length>0){s[0]==="p"&&s.shift();for(let m of s.reverse())l+=`</${m}>`}return[`${l}${e?Gr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=Fi(i);return[i,n]}}function Fi(a){if(!a)return"";let t="",e=!1;for(let r of a){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function fc(a,t){t.querySelectorAll("a.upt-link").forEach(r=>{let i=ie.createFrom(r);r.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function vc(a,t,e,r,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let h of a.attributes)["class","is"].includes(h.name)||n.setAttribute(h.name,h.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",c=`spectrum-Button--${r}`,s=Bo.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",l=["spectrum-Button",c,s];return e&&l.push("spectrum-Button--outline"),n.classList.add(...l),n}function bc(a,t,e,r,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let c=P("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return c.source=n,(i?n.onceSettled():Promise.resolve(n)).then(s=>{c.setAttribute("data-navigation-url",s.href)}),c.addEventListener("click",s=>{s.defaultPrevented||n.click()}),c}function xc(a,t,e,r,i,n,o){let c=a;if(e){try{let s=customElements.get("checkout-link");s&&(c=s.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}a.hasAttribute("aria-label")&&c.setAttribute("aria-label",a.getAttribute("aria-label"))}return r||(c.classList.add("button","con-button"),o&&o!=="m"&&c.classList.add(`button-${o}`),t&&c.classList.add("blue"),i&&c.classList.add("primary"),n&&c.classList.add("secondary")),c}function yc(a,t,e,r,i){if(a.ctas&&e.ctas){a.ctas=Ye(a.ctas);let{slot:n}=e.ctas,o=P("div",{slot:n},a.ctas),c=[...o.querySelectorAll("a")],s=i?.hideTrialCTAs?c.filter(h=>!ia.has(h.dataset.analyticsId)):c,l=(s.length>0?s:c).map(h=>Ii(h,t,e,!0));o.textContent="",o.append(...l),t.append(o),i?.hideTrialCTAs&&s.length>0&&l.forEach(h=>{let m=h.source??h;m.onceSettled&&(h.hidden=!0,m.onceSettled().then(()=>{m.value?.[0]?.offerType==="TRIAL"&&l.some(y=>y!==h&&!y.hidden)?h.remove():h.hidden=!1}).catch(()=>{h.hidden=!1}))})}}function wc(a,t){let{tags:e}=a,r=e?.find(n=>typeof n=="string"&&n.startsWith(Fo))?.split("/").pop();if(!r)return;t.setAttribute(er,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(Io,`${n.dataset.analyticsId}-${o+1}`)})}function Ec(a){a.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{a.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function kc(a){a.querySelectorAll("[slot]").forEach(r=>{r.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",er].forEach(r=>a.removeAttribute(r));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function Hi(a,t){if(!a){let l=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!a.fields){let l=a.id||"unknown",h=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'.`)}let{id:e,fields:r,settings:i={},priceLiterals:n,placeholders:o}=a;r.variant==="bizpro"&&(r.variant="pro");let{variant:c}=r;if(!c)throw new Error(`hydrate: no template found in payload ${e}`);kc(t),t.compatVersion=r.compatVersion,t.contextPromotionCode=r.promoCode,t.settings=i,n&&(t.priceLiterals=n),o&&(t.placeholders=o),t.id??(t.id=a.id),a.variationId&&t.setAttribute("variation-id",a.variationId),a.maskId&&t.setAttribute("mask-id",a.maskId),a.promoProject&&t.setAttribute("data-promotion-project",a.promoProject),a.promoVariationProject&&t.setAttribute("data-promotion-variation-project",a.promoVariationProject),t.variant=c,await t.updateComplete;let{aemFragmentMapping:s}=t.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&t.setAttribute("consonant",!0),Uo(r,t,s.mnemonics),Vo(r,t,s),Wo(r,t,s.size),Yo(r,t),Ko(r,t,s.title),Go(r,t,s),Qo(r,t,s),ic(r,t,s),tc(r,t,s.backgroundImage),rc(r,t,s),ac(r,t,s),Zo(r,t,s.allowedColors,s.backgroundColor),Xo(r,t,s),lc(r,t,s,i),nc(r,t,s),ec(r,t,s),hc(r,t,s,i),pc(r,t,s),mc(r,t,s),gc(r,t,s,i);try{fc(r,t)}catch{}yc(r,t,s,c,i),wc(r,t),Ec(t)}var Sc=[".","!","?"],Cc=`
...
`;if(typeof document<"u"&&!document.querySelector("style[data-plan-type-text]")){let a=document.createElement("style");a.setAttribute("data-plan-type-text",""),a.textContent=Cc,document.head.append(a)}var Ac="p, div, li, td, th, h1, h2, h3, h4, h5, h6, section, article, blockquote";function Tc(a){let t=a.closest(Ac)??a.parentNode,e=document.createRange();return e.setStart(t,0),e.setEndBefore(a),e.toString().replace(/\s+$/,"").slice(-1)}function qi(a){let t=[...a.querySelectorAll('[is="inline-price"][data-template="price"]')].filter(r=>!r.closest("merch-addon"));return(t.find(r=>r.dataset.promotionCode&&r.dataset.promotionCode!=="cancel-context")??t[0])?.dataset.wcsOsi??a.aemFragment?.data?.fields?.osi}function Lc(a){let t=Tc(a);return!t||Sc.includes(t)?"upper":"lower"}function Wr(a,t){if(a.dataset.placeholder!==ua)return;let e=a.closest("merch-card, mas-field")?.osi;e&&(t.wcsOsi=e,t.planTypeCase=Lc(a))}function Pc(a){return a.compatVersion>=1||a.hasAttribute("data-promotion-project")}function _c(a){return Pc(a)?a.contextPromotionCode:null}function Yr(a,t){if(t.promotionCode)return;let e=_c(a);e&&(t.promotionCode=e)}function Ui(a,t){a&&(t.literals??(t.literals={}),Object.assign(t.literals,a))}function ji(a,t){xa(a)&&(t.displayPerUnit=!1,t.displayTax=!1)}function Gi(a,t){t.displayAnnual===void 0&&typeof a?.settings?.displayAnnual=="boolean"&&(t.displayAnnual=a.settings.displayAnnual,a.settings.displayAnnual&&a.setAttribute("annualized",""))}function Vi(a,t,e){!a?.providers||a.providers.has(t)||(a.providers.price(t),a.providers.checkout(e),a.providers.has(Wr)||a.providers.price(Wr))}var rr="merch-card",Wi="merch-card:",Yi=["full-pricing-express","simplified-pricing-express"],Ki=["segment","product","plans-education","mini-compare-chart-mweb"];function Rc(a,t){let e=a.closest(rr);if(!e)return t;Ui(e.priceLiterals,t),ji(a,t),Yr(e,t),e.aemFragment&&(t[fa]=!0),e.variantLayout?.priceOptionsProvider?.(a,t),a.dataset.template===M&&(t.displayDot??(t.displayDot=e.variantLayout?.legalDisplayDot??!0)),Gi(e,t)}function Oc(a,t){let e=a.closest(rr);if(!e)return t;Yr(e,t)}function Dc(a){Vi(a,Rc,Oc)}var kt=new IntersectionObserver(a=>{a.forEach(t=>{let e=t.target;if(Yi.includes(e.variant)){if(e.clientHeight===0)return;kt.unobserve(e),e.requestUpdate();return}if(Ki.includes(e.variant)){if(t.boundingClientRect.width===0)return;if((e.variant==="product"||e.variant==="mini-compare-chart-mweb"||e.variant==="plans-education")&&e.querySelector('merch-icon[slot="icons"]')){kt.unobserve(e);return}let r=e.getBoundingClientRect().width,i=e.querySelector('[slot="badge"] > merch-badge'),n=i?.getBoundingClientRect().width||0;if(r===0||!i){kt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(r-n-16)}px`),kt.unobserve(e)}})}),Nc=0,Ct,Ke,Qe,Ze,j,ve,I,be,T,fe,St,Kr,tr,ne=class extends Mc{constructor(){super();v(this,T);v(this,Ct);v(this,Ke);v(this,Qe);v(this,Ze);v(this,j);v(this,ve);v(this,I);v(this,be,new Promise(e=>{g(this,I,e)}));d(this,"compatVersion");d(this,"customerSegment");d(this,"marketSegment");d(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMasReady=this.handleMasReady.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}get contextPromotionCode(){return p(this,Ct)}set contextPromotionCode(e){g(this,Ct,e),e?this.setAttribute("data-promotion-code",e):this.removeAttribute("data-promotion-code")}firstUpdated(){this.variantLayout=Dr(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=Dr(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){S(this,T,fe).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(w)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(G)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(G)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(G)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let i of r){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let c=i.dataset.wcsOsi.split(",").filter(s=>s!==o);e.checked&&c.push(o),i.dataset.wcsOsi=c.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let i=n=>{let{offerType:o,planType:c}=n.value?.[0]??{};if(!o||!c)return;let s=e.getOsi(c,o),l=(n.dataset.wcsOsi||"").split(",").filter(h=>h&&h!==s);e.checked&&l.push(s),n.dataset.wcsOsi=l.join(",")};r.forEach(i)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let i of r)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(i=>{if(e){r[i].order=Math.min(r[i].order||2,2);return}let n=r[i].order;n===1||isNaN(n)||(r[i].order=Number(n)+1)}),this.filters=r}showInfoTooltip(e,r){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(r)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(r=>this.iconButton.addEventListener(r,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(r=>this.iconButton.addEventListener(r,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",r=>{r.key==="Escape"&&this.iconButton.classList.remove(e)}))}additionalModalTriggers(){if(!this.settings?.additionalModalTriggers)return;let e=this.variantLayout.aemFragmentMapping.title;this.makeElementModalTrigger(e?.tag,e?.slot),this.makeElementModalTrigger("merch-icon","icons")}handleMasReady(){this.handleInfoIconEvents(),this.additionalModalTriggers()}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),p(this,Qe)||g(this,Qe,Nc++),this.aemFragment||((r=p(this,I))==null||r.call(this),g(this,I,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??p(this,Qe);g(this,ve,`${Wi}${e}${ma}`),g(this,Ke,`${Wi}${e}${ga}`),performance.mark(p(this,ve)),g(this,j,et()),Dc(p(this,j)),g(this,Ze,p(this,j).Log.module(rr)),this.addEventListener(O,this.handleQuantitySelection),this.addEventListener(nr,this.handleAddonAndQuantityUpdate),this.addEventListener(na,this.handleMerchOfferSelectReady),this.addEventListener(Lt,this.handleAemFragmentEvents),this.addEventListener(Tt,this.handleAemFragmentEvents),this.addEventListener(ce,this.handleMasReady),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}makeElementModalTrigger(e,r){let i=e==="merch-icon",n=this.querySelector(`${e}[slot="${r}"]:not(.modal-trigger)`);if(!n)return;let o=this.querySelector("a.button.placeholder-resolved[data-modal]");if(!o)return;n.setAttribute("tabindex","0"),n.addEventListener("click",l=>{o.checkoutActionHandler?.(l)}),n.addEventListener("keypress",l=>{l.code==="Enter"&&o.checkoutActionHandler?.(l)}),n.classList.add("modal-trigger");let s=`${this.title.replace(/\s+/g,"-").toLowerCase()}${i?"-icon":""}--${this.analyticsId}--card`;n.setAttribute("daa-ll",s),n.setAttribute("role","link"),i&&n.setAttribute("alt",this.title)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(O,this.handleQuantitySelection),this.removeEventListener(Lt,this.handleAemFragmentEvents),this.removeEventListener(Tt,this.handleAemFragmentEvents),this.removeEventListener(ce,this.handleMasReady),this.removeEventListener("change",this.changeHandler),this.removeEventListener(nr,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===Lt&&S(this,T,fe).call(this,"AEM fragment cannot be loaded"),e.type===Tt&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{p(this,I)||g(this,be,new Promise(n=>{g(this,I,n)})),await Hi(i,this)}catch(n){S(this,T,fe).call(this,`hydration has failed: ${n.message}`)}finally{(r=p(this,I))==null||r.call(this),g(this,I,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;p(this,be)&&(await p(this,be),(Yi.includes(this.variant)||Ki.includes(this.variant))&&kt.observe(this),g(this,be,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e,r=new Promise(l=>{e=ba(()=>l("timeout"),xe)});if(this.aemFragment){let l=await Promise.race([this.aemFragment.updateComplete,r]);if(l===!1||l==="timeout"){let h=l==="timeout"?`AEM fragment was not resolved within ${xe} timeout`:"AEM fragment cannot be loaded";zt(e),S(this,T,fe).call(this,h,{},!1);return}}let i=[...this.querySelectorAll(aa)],n=Promise.all(i.map(l=>{let h=l.onceSettled?.();return h?h.catch(()=>l):Promise.resolve(l)})).then(l=>{let h=l.filter(m=>m.isConnected);return h.length===0||h.every(m=>m.classList.contains("placeholder-resolved"))}),o=await Promise.race([n,r]);if(zt(e),!this.isConnected)return;let c=i.filter(l=>l.isConnected);if(c.length===0||c.every(l=>l.classList.contains("placeholder-resolved"))){this.measure=performance.measure(p(this,Ke),p(this,ve));let l={...this.aemFragment?.fetchInfo,...p(this,j).duration,measure:sr(this.measure)};return this.dispatchEvent(new CustomEvent(ce,{bubbles:!0,composed:!0,detail:l})),this}else{this.measure=performance.measure(p(this,Ke),p(this,ve));let l={measure:sr(this.measure),...p(this,j).duration};if(o==="timeout")S(this,T,fe).call(this,`Contains offers that were not resolved within ${xe} timeout`,l);else{let h=c.some(m=>m.matches(G)&&m.classList.contains("placeholder-failed"));S(this,T,fe).call(this,h?"CTA has an invalid offer":"Contains unresolved offers",l)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(G)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r,productArrangementCode:i}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let o=this.checkoutLinks.find(h=>h.getAttribute("data-modal-id")===e);if(!o)return;let c=i??o.value?.[0]?.productArrangementCode;if(!c)return;let s=r.find(h=>h.productArrangementCode===c)?.quantity,l=!!r.find(h=>h.productArrangementCode!==c);if(s&&this.quantitySelect?.dispatchEvent(new CustomEvent(Je,{detail:{quantity:s},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==l){this.toggleStockOffer({target:this.addonCheckbox});let h=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(h,"target",{writable:!1,value:{checked:l}}),this.addonCheckbox.handleChange(h)}}get prices(){return Array.from(this.querySelectorAll(w))}get osi(){return qi(this)}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${w}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return p(this,T,St)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${w}[data-promotion-code],${G}[data-promotion-code]`)].map(i=>$i(i.dataset.promotionCode)[0]).filter(i=>![void 0,"","cancel-context"].includes(i));if(e.length===0)return this.contextPromotionCode;let r=[...new Set(e)];return r.length>1&&p(this,Ze)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${w}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(p(this,T,Kr)??p(this,T,St))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return p(this,T,St)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return p(this,T,Kr)?.querySelector(e)?.textContent?.trim()??p(this,T,St)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return S(this,T,tr).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${G}, a`);return Array.from(e??[])}get primaryCta(){return S(this,T,tr).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return S(this,T,tr).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Ct=new WeakMap,Ke=new WeakMap,Qe=new WeakMap,Ze=new WeakMap,j=new WeakMap,ve=new WeakMap,I=new WeakMap,be=new WeakMap,T=new WeakSet,fe=function(e,r={},i=!0){var s;if(!this.isConnected)return;let n=this.aemFragment,o=n?.getAttribute("fragment");o=`[${o}]`;let c={...n?.fetchInfo,...p(this,j).duration,...r,message:e};p(this,Ze).error(`merch-card${o}: ${e}`,c),this.failed=!0,(s=p(this,I))==null||s.call(this),g(this,I,void 0),p(this,j).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(ca,{bubbles:!0,composed:!0,detail:c}))},St=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${w}[data-template="price"] > span`)},Kr=function(){return this.querySelector(`${w}[data-template="legal"]`)},tr=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},d(ne,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,i,n]=e.split(",");return{PUF:r,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[i,n,o]=r.split(":"),c=Number(n);return[i,{order:isNaN(c)?void 0:c,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:i,size:n}])=>[r,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:er,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),d(ne,"styles",[ta,...ra()]),d(ne,"registerVariant",A),d(ne,"getCollectionOptions",Si),d(ne,"getFragmentMapping",Mt);customElements.define(rr,ne);export{ne as MerchCard};

...
async function previewFragment(id, options) {
    ...
    let context = { ...DEFAULT_CONTEXT, locale, country, ...options, id, api_key: 'wcms-commerce-ims-ro-user-milo' };
    const initPromises = {};
...
async function previewStudioFragment(body, options) {
    let context = { ...DEFAULT_CONTEXT, ...options, body, api_key: 'wcms-commerce-ims-ro-user-milo' };

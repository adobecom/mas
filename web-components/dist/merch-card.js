var Mr=Object.defineProperty;var Rr=a=>{throw TypeError(a)};var Li=(a,r,e)=>r in a?Mr(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var zi=(a,r,e)=>()=>{if(e)throw e[0];try{return a&&(r=a(a=0)),r}catch(t){throw e=[t],t}};var Pi=(a,r)=>{for(var e in r)Mr(a,e,{get:r[e],enumerable:!0})};var d=(a,r,e)=>Li(a,typeof r!="symbol"?r+"":r,e),Qt=(a,r,e)=>r.has(a)||Rr("Cannot "+e);var p=(a,r,e)=>(Qt(a,r,"read from private field"),e?e.call(a):r.get(a)),v=(a,r,e)=>r.has(a)?Rr("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),g=(a,r,e,t)=>(Qt(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),S=(a,r,e)=>(Qt(a,r,"access private method"),e);var tr={};Pi(tr,{default:()=>tt});import{LitElement as Oi,html as we,css as Ni,nothing as Di}from"./lit-all.min.js";import{unsafeHTML as ta}from"./lit-all.min.js";import{ifDefined as Fi}from"./lit-all.min.js";function $i(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var N,tt,rr=zi(()=>{N=class N extends Oi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();N.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),l=c?c.offsetWidth:o,h=c?c.offsetHeight:s,u=this.effectivePlacement;u==="top"&&e.top-h-n<0?u="bottom":u==="bottom"&&e.bottom+h+n>i?u="top":u==="left"&&e.left-l-n<0?u="right":u==="right"&&e.right+l+n>t&&(u="left");let y=e.left+e.width/2,k=e.top+e.height/2,L=6,K=(Ci,Ai,Ti)=>Math.max(Ci,Math.min(Ai,Ti)),Q,oe,Kt;u==="top"||u==="bottom"?(Q=u==="top"?e.top-h-n:e.bottom+n,oe=K(0,t-l,y-l/2),Kt=K(L,l-L*2,y-oe-L)):(oe=u==="left"?e.left-l-n:e.right+n,Q=K(0,i-h,k-h/2),Kt=K(L,h-L*2,k-Q-L)),this._tooltipTop=Q,this._tooltipLeft=oe,this._arrowOffset=Kt,this._computedPlacement=u}showTooltip(){N.activeTooltip&&N.activeTooltip!==this&&(N.activeTooltip.closeOverlay(),N.activeTooltip.tooltipVisible=!1,N.activeTooltip.requestUpdate()),N.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){N.activeTooltip===this&&(N.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?we`<merch-icon
    ...
    `);tt=N;customElements.define("mas-mnemonic",tt)});import{LitElement as Bo}from"./lit-all.min.js";import{css as Dr,unsafeCSS as Nr}from"./lit-all.min.js";var C="(max-width: 767px)",z="(max-width: 1199px)",w="(min-width: 768px)",b="(min-width: 1200px)",M="(min-width: 1600px)",Ze="(min-width: 1280px)",Or={matchMobile:window.matchMedia(C),matchDesktop:window.matchMedia(`${b} and (not ${M})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(M),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Or;function St(){return Or.isDesktop}var Fr=Dr`
    :host {

...
`,gr=()=>[pr`
    ...
    `);customElements.define("merch-addon",we);import{html as ut,nothing as ii}from"./lit-all.min.js";var Ee,Ke=class Ke{constructor(t){d(this,"card");g(this,Ee);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,Ee,s(this,Ee)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,Ee)}insertVariantStyle(){let t=this.constructor.name;if(!Ke.styleMap[t]){Ke.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),ut`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return ft(this.card.variant)}};Ee=new WeakMap,d(Ke,"styleMap",{});var x=Ke;import{html as Ft,css as ni}from"./lit-all.min.js";var Lr=`
:root {
...
`;var vt=class extends x{constructor(t){super(t)}getGlobalCSS(){return Mr}renderLayout(){return Rr` ${this.badge}
            ...
            ${this.card.customHr?"":Rr`<hr />`} ${this.secureLabelFooter}`}};import{html as Z,css as ci,unsafeCSS as Nr}from"./lit-all.min.js";var Or=`
  :root {
...
`;var hi=32,$r={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ce=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>xt` <footer>
    ...
    `);import{html as Qe,css as pi,nothing as bt}from"./lit-all.min.js";var Br=`
:root {
...
`;var yt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},qr={...function(){let{whatsIncluded:a,size:t,...e}=yt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Hr={...function(){let{subtitle:a,whatsIncluded:t,size:e,quantitySelect:r,...i}=yt;return i}()},U,_=class extends x{constructor(e){super(e);g(this,U);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,r){e.dataset.template===N&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Br}adjustSlotPlacement(e,r,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),h=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!r.includes(c)){if(o?.classList.toggle("wide-footer",v.isDesktopOrUp),!i&&l){if(h)l.remove();else{let u=p.querySelector(`[data-placeholder-for="${e}"]`);u?u.replaceWith(l):p.appendChild(l)}return}if(i&&h){let u=document.createElement("div");if(u.setAttribute("data-placeholder-for",e),u.classList.add("slot-placeholder"),!l){let E=h.cloneNode(!0);o.prepend(E)}h.replaceWith(u)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],v.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],v.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==e?e.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,U)||(m(this,U,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,U)?.disconnect(),m(this,U,null),this.syncHeights())})),s(this,U).observe(this.card));return}["heading-xs","subtitle","heading-m","promo-text","body-xs"].forEach(r=>{let i=this.card.querySelector(`[slot="${r}"]`);i&&this.updateCardElementMinHeight(i,r)})}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),r.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let h=0,p=this.card.querySelector('[slot="heading-s"]');p&&(h+=Ge(p));let u=this.card.querySelector('[slot="subtitle"]');u&&(h+=Ge(u));let E=this.card.querySelector('[slot="heading-m"]');E&&(h+=8+Ge(E));for(let re of r.childNodes){if(re.classList.contains("spacer"))break;h+=Ge(re)}let R=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");h>(parseFloat(R)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${h}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${h}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){if(this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),window.matchMedia("(min-width: 768px)").matches){let e=this.getContainer();if(!e)return;let r=`--consonant-merch-card-${this.card.variant}`,i=e.style.getPropertyValue(`${r}-heading-xs-height`);requestAnimationFrame(i?()=>{this.syncHeights()}:()=>{e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(o=>o.variantLayout?.syncHeights?.())})}}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${b}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Qe`<div class="divider"></div>`:bt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],r=this.card.querySelector(`[slot="heading-m"] ${b}[data-template="price"]`);r&&e.push(r);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?Qe`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};U=new WeakMap,d(_,"variantStyle",pi`
        :host([variant^='plans']) {
            min-height: 273px;
...
`;var Wr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ae=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Vr}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return It` ${this.badge}
...
`;var Zr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Le=class extends x{constructor(t){super(t)}getGlobalCSS(){return Qr}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return fi`
    ...
    `);import{html as Bt,css as xi}from"./lit-all.min.js";var Xr=`
:root {
...
`;var Gt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Oe=class extends x{getGlobalCSS(){return ca}get aemFragmentMapping(){return Gt}renderLayout(){return Ti`
    ...
    `);var Et=new Map,sa=new WeakMap,la=new Map,k=(a,t,e=null,r=null,i)=>{Et.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",ke,zr,ke.variantStyle);k("image",oe);k("inline-heading",vt);k("mini-compare-chart",Se,Dr,Se.variantStyle);k("mini-compare-chart-mweb",Ce,$r,Ce.variantStyle);k("plans",_,yt,_.variantStyle,_.collectionOptions);k("plans-students",_,Hr,_.variantStyle,_.collectionOptions);k("plans-education",_,qr,_.variantStyle,_.collectionOptions);k("plans-v2",X,jr,X.variantStyle,X.collectionOptions);k("product",Ae,Wr,Ae.variantStyle);k("segment",Te,Yr,Te.variantStyle);k("media",Le,Zr,Le.variantStyle);k("headless",Me,ia,Me.variantStyle);k("special-offers",ze,Jr,ze.variantStyle);k("simplified-pricing-express",Pe,qt,Pe.variantStyle);k("full-pricing-express",_e,Ht,_e.variantStyle);k("mini",Re,oa,Re.variantStyle);k("image",oe,_r,oe.variantStyle);k("fries",Oe,Gt,Oe.variantStyle);var zi=(a,t,e)=>{try{let r=la.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),la.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},jt=a=>{let t=Et.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=sa.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?zi(a,r,i):{};return sa.set(a,{appliedVariant:a.variant,...n}),new e(a)};function ft(a){return Et.get(a)?.fragmentMapping}function da(a){return Et.get(a)?.collectionOptions}var ha=document.createElement("style");ha.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var se={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ma=1e3;function Mi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ga(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!se.serializableTypes.includes(e))return e}return a}function Ri(a,t){if(!se.ignoredProperties.includes(a))return ga(t)}var Wt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(h=>{h!=null&&(Mi(h)?r:i).push(h)}),r.length&&(n+=` ${r.map(ga).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${se.delimiter}page=${o}${c}`;l.length>ma&&(l=`${l.slice(0,ma)}<trunc>`),n+=l,i.length&&(n+=`${se.delimiter}facts=`,n+=JSON.stringify(i,Ri)),window.lana?.log(n,se)}};function ua(a){Object.assign(se,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in se&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var fa={LOCAL:"local",PROD:"prod",STAGE:"stage"},Kt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Yt=new Set,Qt=new Set,va=new Map,xa={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},ba={filter:({level:a})=>a!==Kt.DEBUG},Oi={filter:()=>!1};function Ni(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&St(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Di(a){[...Qt].every(t=>t(a))&&Yt.forEach(t=>t(a))}function ya(a){let t=(va.get(a)??0)+1;va.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>ya(`${r.namespace}/${i}`),updateConfig:ua};return Object.values(Kt).forEach(i=>{r[i]=(n,...o)=>Di(Ni(i,n,a,o,e))}),Object.seal(r)}function Ct(...a){a.forEach(t=>{let{append:e,filter:r}=t;St(r)&&Qt.add(r),St(e)&&Yt.add(e)})}function Fi(a={}){let{name:t}=a,e=pa(kt("commerce.debug",{search:!0,storage:!0}),t===fa.LOCAL);return Ct(e?xa:ba),t===fa.PROD&&Ct(Wt),Ze}function Ii(){Yt.clear(),Qt.clear()}var Ze={...ya(Cr),Level:Kt,Plugins:{consoleAppender:xa,debugFilter:ba,quietFilter:Oi,lanaAppender:Wt},init:Fi,reset:Ii,use:Ct};var $i="mas-commerce-service",ll=Ze.module("utilities"),Bi={requestId:ht,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var At=a=>window.setTimeout(a);function Zt(){return document.getElementsByTagName($i)?.[0]}function wa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Bi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ea(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var ka="fragment",Sa="author",Ca="preview",Aa="loading",Ta="timeout",Xt="aem-fragment",La="eager",za="cache",qi=[La,za],G,le,$,Jt=class{constructor(){g(this,G,new Map);g(this,le,new Map);g(this,$,new Map)}clear(){s(this,G).clear(),s(this,le).clear(),s(this,$).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,G).set(t.id,t),t.fields?.originalId&&s(this,G).set(t.fields.originalId,t),s(this,$).has(t.id)){let[,r]=s(this,$).get(t.id);r()}if(s(this,$).has(t.fields?.originalId)){let[,r]=s(this,$).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,G).has(t)}entries(){return s(this,G).entries()}get(t){return s(this,G).get(t)}getAsPromise(t){let[e]=s(this,$).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,$).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,le).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,le).set(t,e)),e}remove(t){s(this,G).delete(t),s(this,le).delete(t),s(this,$).delete(t)}};G=new WeakMap,le=new WeakMap,$=new WeakMap;var J=new Jt,Ne,B,W,D,M,C,Xe,Je,q,et,tt,De,H,Pa,_a,er,Ma,Tt=class extends HTMLElement{constructor(){super(...arguments);g(this,H);d(this,"cache",J);g(this,Ne);g(this,B,null);g(this,W,null);g(this,D,null);g(this,M);g(this,C);g(this,Xe,La);g(this,Je,5e3);g(this,q);g(this,et,!1);g(this,tt,0);g(this,De)}static get observedAttributes(){return[ka,Aa,Ta,Sa,Ca]}attributeChangedCallback(e,r,i){e===ka&&(m(this,M,i),m(this,C,J.getFetchInfo(i))),e===Aa&&qi.includes(i)&&m(this,Xe,i),e===Ta&&m(this,Je,parseInt(i,10)),e===Sa&&m(this,et,["","true"].includes(i)),e===Ca&&m(this,De,i)}connectedCallback(){if(!s(this,q)){if(s(this,D)??m(this,D,ie(this)),m(this,De,s(this,D).settings?.preview),s(this,Ne)??m(this,Ne,s(this,D).log.module(`${Xt}[${s(this,M)}]`)),!s(this,M)||s(this,M)==="#"){s(this,C)??m(this,C,J.getFetchInfo("missing-fragment-id")),z(this,H,er).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,C)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&J.remove(s(this,M)),s(this,Xe)===za&&await Promise.race([J.getAsPromise(s(this,M)),new Promise(c=>setTimeout(c,s(this,Je)))]);try{m(this,q,z(this,H,Ma).call(this)),await s(this,q)}catch(c){return z(this,H,er).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,B)||{};return o&&!kt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ve,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,C)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,W)?s(this,W):(s(this,et)?this.transformAuthorData():this.transformPublishData(),s(this,W))}get rawData(){return s(this,B)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:h={}}=s(this,B),p=Array.isArray(e)?e:[];m(this,W,p.reduce((u,{name:E,multiple:R,values:re})=>(u.fields[E]=R?re:re[0],u),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:h,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:h}=s(this,B);m(this,W,Object.entries(e).reduce((p,[u,E])=>(p.fields[u]=E?.mimeType?E.value:E??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:h}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,M),{locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey})}};Ne=new WeakMap,B=new WeakMap,W=new WeakMap,D=new WeakMap,M=new WeakMap,C=new WeakMap,Xe=new WeakMap,Je=new WeakMap,q=new WeakMap,et=new WeakMap,tt=new WeakMap,De=new WeakMap,H=new WeakSet,Pa=async function(e){lr(this,tt)._++;let r=`${Xt}:${s(this,M)}:${s(this,tt)}`,i=`${r}${pt}`,n=`${r}${mt}`;if(s(this,De))return await this.generatePreview();performance.mark(i);let o;try{if(s(this,C).stale=!1,s(this,C).url=e,o=await Ea(e,{cache:"default",credentials:"omit"}),z(this,H,_a).call(this,o),s(this,C).status=o?.status,s(this,C).measure=be(performance.measure(n,i)),s(this,C).retryCount=o.retryCount,!o?.ok)throw new ce("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,C).measure=be(performance.measure(n,i)),s(this,C).retryCount=c.retryCount,s(this,B))return s(this,C).stale=!0,s(this,Ne).error("Serving stale data",s(this,C)),s(this,B);let l=c.message??"unknown";throw new ce(`Failed to fetch fragment: ${l}`,{})}},_a=function(e){Object.assign(s(this,C),wa(e))},er=function(e){m(this,q,null),s(this,C).message=e,this.classList.add("error");let r={...s(this,C),...s(this,D).duration};s(this,Ne).error(e,r),this.dispatchEvent(new CustomEvent(xe,{detail:r,bubbles:!0,composed:!0}))},Ma=async function(){var l;this.classList.remove("error"),m(this,W,null);let e=J.get(s(this,M));if(e)return m(this,B,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,M)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await z(this,H,Pa).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,M)),J.add(e),m(this,B,e),!0},d(Tt,"cache",J);customElements.define(Xt,Tt);import{LitElement as Hi,html as tr,css as Ui,nothing as Gi}from"./lit-all.min.js";import{unsafeHTML as ji}from"./lit-all.min.js";var Vi=a=>a?a.startsWith("sp-icon-")?tr`${ji(`<${a} class="badge-icon"></${a}>`)}`:tr`<img src="${a}" class="badge-icon" />`:Gi,Fe=class extends Hi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return tr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Fe);import{html as Wi,css as Ki,LitElement as Yi}from"./lit-all.min.js";var rt=class extends Yi{constructor(){super()}render(){return Wi`
            <slot name="icon"></slot>
    ...
    `),d(rt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",rt);import{html as rr,css as Qi,LitElement as Zi,nothing as Ra}from"./lit-all.min.js";var at=class extends Zi{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return rr`<slot name="heading"></slot>

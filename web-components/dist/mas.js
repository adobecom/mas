...
`,bc=()=>[y`
    ...
    `);customElements.define("merch-icon",Vt);var Xr,Ct,Kr,Qr,jt,Ki=class extends HTMLElement{constructor(){super();E(this,Xr,"");E(this,Ct);E(this,Kr,[]);E(this,Qr,[]);E(this,jt);b(this,jt,zr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,p(this,Ct)?this.parentElement.style.borderRadius=p(this,Ct):p(this,Ct)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let r=p(this,Kr).map((i,a)=>{let n=p(this,Qr)[a]||"";return`${i} ${n}`}).join(", ");return`linear-gradient(${p(this,Xr)}, ${r})`}connectedCallback(){p(this,jt).call(this)}attributeChangedCallback(r,i,a){r==="border-radius"&&b(this,Ct,a?.trim()),r==="colors"&&a?b(this,Kr,a?.split(",").map(n=>n.trim())??[]):r==="positions"&&a?b(this,Qr,a?.split(",").map(n=>n.trim())??[]):r==="angle"&&b(this,Xr,a?.trim()??""),p(this,jt).call(this)}};Xr=new WeakMap,Ct=new WeakMap,Kr=new WeakMap,Qr=new WeakMap,jt=new WeakMap;customElements.define("merch-gradient",Ki);M();var Wt=class extends G{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,r){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[r]||[r]).map(s=>`p[data-plan-type="${t}"] ${D}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Fe,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Fe,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let r=t.target,i=r?.value?.[0];i&&(r.setAttribute("data-offer-type",i.offerType),r.closest("p").setAttribute("data-plan-type",i.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return f` <input
                type="checkbox"
                id="addon-checkbox"
...
`;var Uc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},$e,Zt=class extends C{constructor(r){super(r);E(this,$e);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Fc}priceOptionsProvider(r,i){r.dataset.template===le&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return f` ${this.badge}
...
`;var qc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Jt=class extends C{constructor(t){super(t)}priceOptionsProvider(t,r){t.dataset.template===le&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}getGlobalCSS(){return Gc}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${D}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let r=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),t.parentNode.insertBefore(r,t.nextSibling),await r.onceSettled()}catch{}}renderLayout(){return f`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Hn={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Jr=class Jr extends C{getGlobalCSS(){return Kc}get aemFragmentMapping(){return Hn}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return f`
        ...
        `}async syncHeights(){if(await document.fonts.ready,await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let t=Jr.SYNCED_SECTIONS.map(s=>({name:s,getElement:c=>c.shadowRoot?.querySelector(`.${s}`)})),r=this.getContainer(),i=r?r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],a='[slot="body-s"] > *',n=Math.max(0,...Array.from(i,s=>s.querySelectorAll(a).length)),o=Array.from({length:n},(s,c)=>({name:`description-row-${c}`,getElement:l=>l.querySelectorAll(a)[c]}));this.syncRowHeights([...t,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let t=this.getContainer();if(t){let r=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),i=49;r.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>i;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}renderLayout(){return f`
            ${this.badge}
            ...
            <slot></slot>
        `}};u(Jr,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),u(Jr,"variantStyle",y`
...
`;var Bn={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},nr=class extends C{getGlobalCSS(){return tl}get aemFragmentMapping(){return Bn}renderLayout(){return f`
    ...
    `);var ea=new Map,rl=new WeakMap,il=new Map,q=(e,t,r=null,i=null,a)=>{ea.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:a})};q("catalog",Xt,_c,Xt.variantStyle);q("image",Tt);q("inline-heading",Zi);q("mini-compare-chart",Kt,Oc,Kt.variantStyle);q("mini-compare-chart-mweb",Qt,Ic,Qt.variantStyle);q("plans",fe,Ji,fe.variantStyle,fe.collectionOptions);q("plans-students",fe,$c,fe.variantStyle,fe.collectionOptions);q("plans-education",fe,Dc,fe.variantStyle,fe.collectionOptions);q("plans-v2",tt,Bc,tt.variantStyle,tt.collectionOptions);q("product",Zt,Uc,Zt.variantStyle);q("segment",Jt,qc,Jt.variantStyle);q("media",er,jc,er.variantStyle);q("headless",ir,Zc,ir.variantStyle);q("special-offers",tr,Yc,tr.variantStyle);q("simplified-pricing-express",rr,$n,rr.variantStyle);q("full-pricing-express",ei,Hn,ei.variantStyle);q("mini",ar,el,ar.variantStyle);q("image",Tt,Lc,Tt.variantStyle);q("fries",nr,Bn,nr.variantStyle);var pp=(e,t,r)=>{try{let i=il.get(e.variant);if(i||(i=new CSSStyleSheet,i.replaceSync(t.cssText),il.set(e.variant,i)),r?.styleSheet&&r.styleSheet!==i){let a=e.shadowRoot.adoptedStyleSheets.indexOf(r.styleSheet);a!==-1&&e.shadowRoot.adoptedStyleSheets.splice(a,1)}return e.shadowRoot.adoptedStyleSheets.includes(i)||e.shadowRoot.adoptedStyleSheets.push(i),{styleSheet:i}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",e.variant);let n=r?.styleElement||e.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),e.shadowRoot.appendChild(a),{styleElement:a}}},Fn=e=>{let t=ea.get(e.variant);if(!t)return;let{class:r,style:i}=t,a=rl.get(e);if(a?.appliedVariant===e.variant)return new r(e);let n=i?pp(e,i,a):{};return rl.set(e,{appliedVariant:e.variant,...n}),new r(e)};function Qi(e){return ea.get(e)?.fragmentMapping}function al(e){return ea.get(e)?.collectionOptions}var nl=document.createElement("style");nl.innerHTML=`
:root {
...
`;document.head.appendChild(nl);var ol="fragment",sl="author",cl="preview",ll="loading",dl="timeout",Un="aem-fragment",hl="eager",pl="cache",mp=[hl,pl],He,kt,Le,Gn=class{constructor(){E(this,He,new Map);E(this,kt,new Map);E(this,Le,new Map)}clear(){p(this,He).clear(),p(this,kt).clear(),p(this,Le).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(p(this,He).set(t.id,t),t.fields?.originalId&&p(this,He).set(t.fields.originalId,t),p(this,Le).has(t.id)){let[,i]=p(this,Le).get(t.id);i()}if(p(this,Le).has(t.fields?.originalId)){let[,i]=p(this,Le).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return p(this,He).has(t)}entries(){return p(this,He).entries()}get(t){return p(this,He).get(t)}getAsPromise(t){let[r]=p(this,Le).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),p(this,Le).set(t,[r,i]),r}getFetchInfo(t){let r=p(this,kt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},p(this,kt).set(t,r)),r}remove(t){p(this,He).delete(t),p(this,kt).delete(t),p(this,Le).delete(t)}};He=new WeakMap,kt=new WeakMap,Le=new WeakMap;var rt=new Gn,or,Ce,Ye,be,xe,J,ti,ri,Re,ii,ai,sr,Me,ml,ul,qn,gl,ta=class extends HTMLElement{constructor(){super(...arguments);E(this,Me);u(this,"cache",rt);E(this,or);E(this,Ce,null);E(this,Ye,null);E(this,be,null);E(this,xe);E(this,J);E(this,ti,hl);E(this,ri,5e3);E(this,Re);E(this,ii,!1);E(this,ai,0);E(this,sr)}static get observedAttributes(){return[ol,ll,dl,sl,cl]}attributeChangedCallback(r,i,a){r===ol&&(b(this,xe,a),b(this,J,rt.getFetchInfo(a))),r===ll&&mp.includes(a)&&b(this,ti,a),r===dl&&b(this,ri,parseInt(a,10)),r===sl&&b(this,ii,["","true"].includes(a)),r===cl&&b(this,sr,a)}connectedCallback(){if(!p(this,Re)){if(p(this,be)??b(this,be,vt(this)),b(this,sr,p(this,be).settings?.preview),p(this,or)??b(this,or,p(this,be).log.module(`${Un}[${p(this,xe)}]`)),!p(this,xe)||p(this,xe)==="#"){p(this,J)??b(this,J,rt.getFetchInfo("missing-fragment-id")),Z(this,Me,qn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(p(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(p(this,Re)&&!await Promise.race([p(this,Re),Promise.resolve(!1)]))return;r&&rt.remove(p(this,xe)),p(this,ti)===pl&&await Promise.race([rt.getAsPromise(p(this,xe)),new Promise(s=>setTimeout(s,p(this,ri)))]);try{b(this,Re,Z(this,Me,gl).call(this)),await p(this,Re)}catch(s){return Z(this,Me,qn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=p(this,Ce)||{};return o&&!B("mas.disableWcsCache")&&p(this,be).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(lt,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...p(this,J)},bubbles:!0,composed:!0})),p(this,Re)}get updateComplete(){return p(this,Re)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return p(this,Ye)?p(this,Ye):(p(this,ii)?this.transformAuthorData():this.transformPublishData(),p(this,Ye))}get rawData(){return p(this,Ce)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=p(this,Ce);b(this,Ye,r.reduce((d,{name:h,multiple:m,values:g})=>(d.fields[h]=m?g:g[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){if(!p(this,Ce))return;let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=p(this,Ce);b(this,Ye,Object.entries(r).reduce((d,[h,m])=>(d.fields[h]=m?.mimeType?m.value:m??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r),a={locale:p(this,be).settings.locale,apiKey:p(this,be).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??p(this,be).settings.instant;return n&&(a.instant=n),await i(p(this,xe),a)}};or=new WeakMap,Ce=new WeakMap,Ye=new WeakMap,be=new WeakMap,xe=new WeakMap,J=new WeakMap,ti=new WeakMap,ri=new WeakMap,Re=new WeakMap,ii=new WeakMap,ai=new WeakMap,sr=new WeakMap,Me=new WeakSet,ml=async function(r){oo(this,ai)._++;let i=`${Un}:${p(this,xe)}:${p(this,ai)}`,a=`${i}${pt}`,n=`${i}${mt}`;if(p(this,sr)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Ne(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(p(this,J).stale=!1,p(this,J).url=r,o=await Bi(r,{cache:"default",credentials:"omit"}),Z(this,Me,ul).call(this,o),p(this,J).status=o?.status,p(this,J).measure=Ie(performance.measure(n,a)),p(this,J).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...p(this,be).duration});return await o.json()}catch(s){if(p(this,J).measure=Ie(performance.measure(n,a)),p(this,J).retryCount=s.retryCount,p(this,Ce))return p(this,J).stale=!0,p(this,or).error("Serving stale data",p(this,J)),p(this,Ce);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},ul=function(r){Object.assign(p(this,J),Ai(r))},qn=function(r){b(this,Re,null),p(this,J).message=r,this.classList.add("error");let i={...p(this,J),...p(this,be).duration};p(this,or).error(r,i),this.dispatchEvent(new CustomEvent(dt,{detail:i,bubbles:!0,composed:!0}))},gl=async function(){var c;this.classList.remove("error"),b(this,Ye,null);let r=rt.get(p(this,xe));if(r)return b(this,Ce,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=p(this,be).settings,s=`${i}/fragment?id=${p(this,xe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Me,ml).call(this,s),(c=r.fields).originalId??(c.originalId=p(this,xe)),rt.add(r),b(this,Ce,r),!0},u(ta,"cache",rt);customElements.define(Un,ta);M();zn();var up=e=>e?e.startsWith("sp-icon-")?f`${Wr(`<${e} class="badge-icon"></${e}>`)}`:f`<img src="${e}" class="badge-icon" />`:w,cr=class extends G{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">
    ...
    `);customElements.define("merch-badge",cr);M();var ni=class extends G{constructor(){super()}render(){return f`
            <slot name="icon"></slot>
...
`;var Ll={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},ur=class extends C{getGlobalCSS(){return Pl}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return f` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}async postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage(),await super.postCardUpdateHook()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};u(ur,"variantStyle",y`
...
`;var Ml={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},gr=class extends C{getGlobalCSS(){return Rl}renderLayout(){return f` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Zn={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},xr=class extends C{getGlobalCSS(){return Nl}get aemFragmentMapping(){return Zn}renderLayout(){return f`
    ...
    `);q("ccd-suggested",ur,Ll,ur.variantStyle);q("ccd-slice",gr,Ml,gr.variantStyle);q("ah-try-buy-widget",fr,Qn,fr.variantStyle);q("ah-promoted-plans",xr,Zn,xr.variantStyle);

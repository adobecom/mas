...
var g = (e, t, r) => Eo(e, typeof t != 'symbol' ? t + '' : t, r),
    br = (e, t, r) => t.has(e) || Gi('Cannot ' + r);
var A = (e, t, r) => (
    ...
    $ = (e, t, r) =>
        t.has(e)
            ...
            : t instanceof WeakSet
              ...
              : t.set(e, r),
    V = (e, t, r, i) => (
        br(e, t, 'write to private field'), i ? i.call(e, r) : t.set(e, r), r
    ),
    Bt = (e, t, r) => (br(e, t, 'access private method'), r);
import {
    html as ve,
    LitElement as lo,
    css as po,
...
var G = '(max-width: 767px)',
    ...
    re = '(min-width: 1600px)',
    Vi = {
        matchMobile: window.matchMedia(G),
        matchDesktop: window.matchMedia(`${P} and (not ${re})`),
        matchDesktopOrUp: window.matchMedia(P),
        matchLargeDesktop: window.matchMedia(re),
        get isMobile() {
...
var qi = 'hashchange';
function Ao(e = window.location.hash) {
    let t = [],
        r = e.replace(/^#/, '').split('&');
    for (let i of r) {
        let [a, n = ''] = i.split('=');
        a && t.push([a, decodeURIComponent(n.replace(/\+/g, ' '))]);
    }
...
function ji(e) {
    let t = () => {
        ...
        let r = Ao(window.location.hash);
        e(r);
    };
    return (
        t(),
        window.addEventListener(qi, t),
        () => {
            window.removeEventListener(qi, t);
        }
    );
}
var Vr = {};
wo(Vr, {
    CLASS_NAME_FAILED: () => Pr,
    CLASS_NAME_HIDDEN: () => To,
    CLASS_NAME_PENDING: () => Lr,
    CLASS_NAME_RESOLVED: () => kr,
    CheckoutWorkflow: () => Fo,
    CheckoutWorkflowStep: () => Q,
    Commitment: () => _e,
    ERROR_MESSAGE_BAD_REQUEST: () => Mr,
    ERROR_MESSAGE_MISSING_LITERALS_URL: () => Ho,
    ERROR_MESSAGE_OFFER_NOT_FOUND: () => Rr,
    EVENT_AEM_ERROR: () => _r,
    EVENT_AEM_LOAD: () => Tr,
    EVENT_MAS_ERROR: () => Cr,
    EVENT_MAS_READY: () => Do,
    EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE: () => Oo,
    EVENT_MERCH_CARD_ACTION_MENU_TOGGLE: () => Er,
    EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED: () => se,
    EVENT_MERCH_CARD_COLLECTION_SHOWMORE: () => Ar,
    EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED: () => dt,
    EVENT_MERCH_CARD_COLLECTION_SORT: () => wr,
    EVENT_MERCH_CARD_QUANTITY_CHANGE: () => No,
    EVENT_MERCH_OFFER_READY: () => Po,
    EVENT_MERCH_OFFER_SELECT_READY: () => Lo,
    EVENT_MERCH_QUANTITY_SELECTOR_CHANGE: () => Ce,
    EVENT_MERCH_SEARCH_CHANGE: () => Io,
    EVENT_MERCH_SIDENAV_SELECT: () => Sr,
    EVENT_MERCH_STOCK_CHANGE: () => Mo,
    EVENT_MERCH_STORAGE_CHANGE: () => Ro,
    EVENT_OFFER_SELECTED: () => ko,
    EVENT_TYPE_FAILED: () => Nr,
    EVENT_TYPE_READY: () => Ut,
    EVENT_TYPE_RESOLVED: () => Or,
    Env: () => he,
    FF_DEFAULTS: () => ue,
    HEADER_X_REQUEST_ID: () => pt,
    LOG_NAMESPACE: () => Ir,
    Landscape: () => Ee,
    MARK_DURATION_SUFFIX: () => Gr,
    MARK_START_SUFFIX: () => $r,
    MODAL_TYPE_3_IN_1: () => Pe,
    NAMESPACE: () => So,
    PARAM_AOS_API_KEY: () => Bo,
    PARAM_ENV: () => Hr,
    PARAM_LANDSCAPE: () => Br,
    PARAM_MAS_PREVIEW: () => Dr,
    PARAM_WCS_API_KEY: () => Uo,
    PROVIDER_ENVIRONMENT: () => zr,
    SELECTOR_MAS_CHECKOUT_LINK: () => Wi,
    SELECTOR_MAS_ELEMENT: () => yr,
    SELECTOR_MAS_INLINE_PRICE: () => K,
    SELECTOR_MAS_SP_BUTTON: () => Co,
    SELECTOR_MAS_UPT_LINK: () => Yi,
    SORT_ORDER: () => le,
    STATE_FAILED: () => ce,
    STATE_PENDING: () => ye,
    STATE_RESOLVED: () => me,
    TAG_NAME_SERVICE: () => _o,
    TEMPLATE_PRICE: () => zo,
    TEMPLATE_PRICE_ANNUAL: () => Go,
    TEMPLATE_PRICE_LEGAL: () => ht,
    TEMPLATE_PRICE_STRIKETHROUGH: () => $o,
    Term: () => ae,
    WCS_PROD_URL: () => Ur,
    WCS_STAGE_URL: () => Fr,
});
var _e = Object.freeze({
    ...
    So = 'merch',
    To = 'hidden',
    Ut = 'wcms:commerce:ready',
    _o = 'mas-commerce-service',
    K = 'span[is="inline-price"][data-wcs-osi]',
    Wi =
        'a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',
    Co = 'sp-button[data-wcs-osi]',
    Yi = 'a[is="upt-link"]',
    yr = `${K},${Wi},${Yi}`,
    Po = 'merch-offer:ready',
    Lo = 'merch-offer-select:ready',
    Er = 'merch-card:action-menu-toggle',
    ko = 'merch-offer:selected',
    Mo = 'merch-stock:change',
    Ro = 'merch-storage:change',
    Ce = 'merch-quantity-selector:change',
    No = 'merch-card-quantity:change',
    Oo = 'merch-modal:addon-and-quantity-update',
    Io = 'merch-search:change',
    wr = 'merch-card-collection:sort',
    se = 'merch-card-collection:literals-changed',
    dt = 'merch-card-collection:sidenav-attached',
    Ar = 'merch-card-collection:showmore',
    Sr = 'merch-sidenav:select',
    Tr = 'aem:load',
    _r = 'aem:error',
    Do = 'mas:ready',
    Cr = 'mas:error',
    Pr = 'placeholder-failed',
    Lr = 'placeholder-pending',
    kr = 'placeholder-resolved',
    Mr = 'Bad WCS request',
    Rr = 'Commerce offer not found',
    Ho = 'Literals URL not provided',
    Nr = 'mas:failed',
    Or = 'mas:resolved',
    Ir = 'mas/commerce',
    Dr = 'mas.preview',
    Hr = 'commerce.env',
    Br = 'commerce.landscape',
    Bo = 'commerce.aosKey',
    Uo = 'commerce.wcsKey',
    Ur = 'https://www.adobe.com/web_commerce_artifact',
    Fr = 'https://www.stage.adobe.com/web_commerce_artifact_stage',
    ce = 'failed',
    ye = 'pending',
    me = 'resolved',
    Ee = { DRAFT: 'DRAFT', PUBLISHED: 'PUBLISHED' },
    pt = 'X-Request-Id',
    Q = Object.freeze({
    ...
    zr = { PRODUCTION: 'PRODUCTION' },
    Pe = { TWP: 'twp', D2P: 'd2p', CRM: 'crm' },
    $r = ':start',
    Gr = ':duration',
    zo = 'price',
    $o = 'price-strikethrough',
    Go = 'annual',
    ht = 'legal',
    ue = 'mas-ff-defaults',
    le = { alphabetical: 'alphabetical', authored: 'authored' };
var Vo = 'mas-commerce-service';
var mt = (e, t) => e?.querySelector(`[slot="${t}"]`)?.textContent?.trim();
function Le(e, t = {}, r = null, i = null) {
    let a = i
        ? document.createElement(e, { is: i })
        : document.createElement(e);
    r instanceof HTMLElement ? a.appendChild(r) : (a.innerHTML = r);
...
import { html as zt, nothing as qo } from './lit-all.min.js';
var ze,
    gt = class gt {
        constructor(t) {
            g(this, 'card');
        ...
        insertVariantStyle() {
            if (!gt.styleMap[this.card.variant]) {
                gt.styleMap[this.card.variant] = !0;
        ...
        updateCardElementMinHeight(t, r) {
            ...
            let i = `--consonant-merch-card-${this.card.variant}-${r}-height`,
                ...
                n =
                    ...
                    0;
            a > n && this.getContainer().style.setProperty(i, `${a}px`);
        }
        get badge() {
            let t;
            if (
        ...
        get secureLabel() {
            return this.card.secureLabel
                ? zt`<span class="secure-transaction-label"
        ...
        get aemFragmentMapping() {
            return $t(this.card.variant);
        }
    };
(ze = new WeakMap()), g(gt, 'styleMap', {});
var M = gt;
import { html as jr, css as jo } from './lit-all.min.js';
var Xi = `
:root {
...
import { html as xt } from './lit-all.min.js';
var Qi = `
:root {
    ...
    renderLayout() {
        return xt`${this.cardImage}
            <div class="body">
                ...
                ${
                    this.promoBottom
                        ? xt`<slot name="body-xs"></slot
                          ><slot name="promo-text"></slot>`
                        : xt`<slot name="promo-text"></slot
                          ><slot name="body-xs"></slot>`
                }
            </div>
            ${
...
import { html as Ji } from './lit-all.min.js';
var Zi = `
:root {
...
var Vt = class extends M {
    ...
    renderLayout() {
        return Ji` ${this.badge}
            ...
            ${this.card.customHr ? '' : Ji`<hr />`} ${this.secureLabelFooter}`;
    }
};
import { html as Ge, css as Wo, unsafeCSS as ta } from './lit-all.min.js';
var ea = `
  :root {
    ...
    Ve = class extends M {
        constructor(r) {
            ...
            g(this, 'getMiniCompareFooter', () => {
              ...
              >`
                ...
                return Ge`<footer>${r}<slot name="footer"></slot></footer>`;
            });
            this.updatePriceQuantity = this.updatePriceQuantity.bind(this);
        }
        connectedCallbackHook() {
            this.card.addEventListener(Ce, this.updatePriceQuantity);
        }
        disconnectedCallbackHook() {
            this.card.removeEventListener(Ce, this.updatePriceQuantity);
        }
        ...
        removeEmptyRows() {
            this.card.querySelectorAll('.footer-row-cell').forEach((i) => {
                let a = i.querySelector('.footer-row-cell-description');
                a && !a.textContent.trim() && i.remove();
            });
        }
        get mainPrice() {
            return this.card.querySelector(
                `[slot="heading-m-price"] ${K}[data-template="price"]`,
            );
        }
        ...
        toggleAddon(r) {
            ...
            if (!i && a) {
                let n = r?.getAttribute('plan-type'),
                    o = null;
                if (
                    (r &&
                        n &&
        ...
        async adjustAddon() {
            ...
            if (
                (i && (await i.onceSettled(), (a = i.value?.[0]?.planType)), !a)
            )
                return;
            (r.planType = a),
                this.card
...
import { html as vt, css as Xo, nothing as qt } from './lit-all.min.js';
var ra = `
:root {
...
var jt = {
    ...
    ia = {
        ...(function () {
            let { whatsIncluded: e, size: t, ...r } = jt;
            return r;
        })(),
    ...
    Z = class extends M {
        ...
        adjustSlotPlacement(t, r, i) {
            ...
            let s = a.querySelector(`footer slot[name="${t}"]`),
                c = a.querySelector(`.body slot[name="${t}"]`),
                l = a.querySelector('.body');
            if (
                (o.includes('wide') ||
                ...
                if (
                    (n?.classList.toggle('wide-footer', k.isDesktopOrUp),
                    !i && s)
                ) {
                    if (c) s.remove();
                    else {
        ...
        adaptForMedia() {
            ...
            this.adjustSlotPlacement('addon', ['super-wide'], k.isDesktopOrUp),
        ...
        async adjustEduLists() {
            ...
            n.classList.add('spacer'), r.insertBefore(n, a);
            let o = new IntersectionObserver(([s]) => {
                ...
                let h = this.card.parentElement.style.getPropertyValue(
        ...
        get mainPrice() {
            return this.headingM.querySelector(`${K}[data-template="price"]`);
        }
        get divider() {
            return this.card.variant === 'plans-education'
                ? vt`<div class="divider"></div>`
                : qt;
        }
        async adjustLegal() {
                ...
                try {
                    ...
                    let t = [],
                        r = this.card.querySelector(
                            `[slot="heading-m"] ${K}[data-template="price"]`,
                        );
                    r && t.push(r);
                    let i = t.map(async (a) => {
                        let n = a.cloneNode(!0);
        ...
        get icons() {
            return !this.card.querySelector('[slot="icons"]') &&
                ...
                ? qt
                : vt`<slot name="icons"></slot>`;
        }
        connectedCallbackHook() {
            k.matchMobile.addEventListener('change', this.adaptForMedia),
                k.matchDesktopOrUp.addEventListener(
                    'change',
                    this.adaptForMedia,
                );
        }
        disconnectedCallbackHook() {
            k.matchMobile.removeEventListener('change', this.adaptForMedia),
...
g(
    ...
    g(Z, 'collectionOptions', {
        customHeaderArea: (t) =>
            t.sidenav ? vt`<slot name="resultsText"></slot>` : qt,
        headerVisibility: {
            search: !1,
            sort: !1,
        ...
        onSidenavAttached: (t) => {
            let r = () => {
                ...
                for (let n of i)
                    n.hasAttribute('data-size') &&
                        (n.setAttribute('size', n.getAttribute('data-size')),
                        n.removeAttribute('data-size'));
                if (!k.isDesktop) return;
                let a = 0;
                for (let n of i) {
                    if (n.style.display === 'none') continue;
                    let o = n.getAttribute('size'),
                        s = o === 'wide' ? 2 : o === 'super-wide' ? 3 : 1;
                    s === 2 &&
                        a % 3 === 2 &&
                        (n.setAttribute('data-size', o),
                        n.removeAttribute('size'),
                        (s = 1)),
                        (a += s);
                }
            };
            k.matchDesktop.addEventListener('change', r),
                t.addEventListener(se, r),
                t.onUnmount.push(() => {
                    k.matchDesktop.removeEventListener('change', r),
                        t.removeEventListener(se, r);
                });
        },
    });
import {
...
var sa = {
    ...
    we = class extends M {
        ...
        adjustSlotPlacement(t, r, i) {
            let { shadowRoot: a } = this.card,
                n = a.querySelector('footer'),
                o = a.querySelector('.body'),
                s = this.card.getAttribute('size');
            if (!s) return;
            let c = a.querySelector(`footer slot[name="${t}"]`),
                l = a.querySelector(`.body slot[name="${t}"]`);
            if (
                (s.includes('wide') ||
                    (n?.classList.remove('wide-footer'), c?.remove()),
                !!r.includes(s))
            ) {
                if (
                    (n?.classList.toggle('wide-footer', k.isDesktopOrUp),
...
`,
        ...
        connectedCallbackHook() {
            (this.handleMediaChange = () => {
                ...
                k.matchMobile.addEventListener(
                    'change',
                    this.handleMediaChange,
                ),
                k.matchDesktopOrUp.addEventListener(
        ...
        disconnectedCallbackHook() {
            k.matchMobile.removeEventListener('change', this.handleMediaChange),
                k.matchDesktopOrUp.removeEventListener(
                    'change',
                    this.handleMediaChange,
                );
...
g(
    ...
    g(we, 'collectionOptions', {
        customHeaderArea: (t) =>
            t.sidenav ? qe`<slot name="resultsText"></slot>` : Wt,
        headerVisibility: {
            search: !1,
            sort: !1,
            result: ['mobile', 'tablet'],
...
import { html as Wr, css as Qo } from './lit-all.min.js';
var ca = `
:root {
...
var je = class extends M {
    ...
    postCardUpdateHook() {
        this.card.isConnected &&
            (this.adjustAddon(),
            k.isMobile || this.adjustProductBodySlots(),
            this.adjustTitleWidth());
    }
    get headingXSSlot() {
        return this.card.shadowRoot
    ...
    get mainPrice() {
        return this.card.querySelector(
            `[slot="heading-xs"] ${K}[data-template="price"]`,
        );
    }
...
import { html as Yr, css as Zo } from './lit-all.min.js';
var la = `
:root {
...
import { html as Xr, css as Jo } from './lit-all.min.js';
var da = `
:root {
...
import { html as es, css as ts } from './lit-all.min.js';
var ha = `
:root {
...
var Kr = {
    ...
    Xe = class extends M {
        ...
        setupAccordion() {
            ...
            if (!t) return;
            let r = () => {
                if (st()) t.removeAttribute('data-expanded');
                else {
        ...
        handleChevronClick(t) {
            ...
            r.setAttribute('data-expanded', n);
        }
        renderLayout() {
            return es`
...
import { html as rs, css as is } from './lit-all.min.js';
var ma = `
:root {
...
import { css as as, html as ns } from './lit-all.min.js';
var ua = `
...
var fa = {
    ...
    Qe = class extends M {
        ...
        adjustLegal() {
            ...
            let r = this.card.querySelector(`${K}[data-template="price"]`);
            if (!r) return;
            let i = r.cloneNode(!0);
            (this.legal = i),
...
J('catalog', $e, Ki, $e.variantStyle);
J('image', Gt);
J('inline-heading', Vt);
J('mini-compare-chart', Ve, null, Ve.variantStyle);
J('plans', Z, jt, Z.variantStyle, Z.collectionOptions);
J('plans-students', Z, aa, Z.variantStyle, Z.collectionOptions);
J('plans-education', Z, ia, Z.variantStyle, Z.collectionOptions);
J('plans-v2', we, sa, we.variantStyle, we.collectionOptions);
J('product', je, null, je.variantStyle);
J('segment', We, null, We.variantStyle);
J('special-offers', Ye, pa, Ye.variantStyle);
J('simplified-pricing-express', Xe, Kr, Xe.variantStyle);
J('full-pricing-express', Ke, Qr, Ke.variantStyle);
J('mini', Qe, fa, Qe.variantStyle);
function $t(e) {
    return ga.get(e)?.fragmentMapping;
}
var xa = 'tacocat.js';
var Zr = (e, t) =>
...
function D(
    e,
    t = {},
    { metadata: r = !0, search: i = !0, storage: a = !0 } = {},
) {
    let n;
    if (i && n == null) {
...
var os = (e) => typeof e == 'boolean',
    Yt = (e) => typeof e == 'function',
    Xt = (e) => typeof e == 'number',
    ba = (e) => e != null && typeof e == 'object';
var Ze = (e) => typeof e == 'string',
    ya = (e) => Ze(e) && e,
    bt = (e) => Xt(e) && Number.isFinite(e) && e > 0;
function Kt(e, t = (r) => r == null || r === '') {
    return (
        e != null &&
...
var cs = Date.now(),
    Jr = () => `(+${Date.now() - cs}ms)`,
    Qt = new Set(),
    ls = E(D('tacocat.debug', {}, { metadata: !1 }), !1);
function wa(e) {
    let t = `[${xa}/${e}]`,
        r = (o, s, ...c) => (o ? !0 : (a(s, ...c), !1)),
        i = ls
            ? (o, ...s) => {
                  console.debug(`${t} ${o}`, ...s, Jr());
              }
            : () => {},
        a = (o, ...s) => {
            let c = `${t} ${o}`;
...
var ni = 'ABM',
    ...
    ci = 'PERPETUAL',
    li = 'P3Y',
    gs = 'TAX_INCLUSIVE_DETAILS',
    xs = 'TAX_EXCLUSIVE',
    Sa = { ABM: ni, PUF: oi, M2M: si, PERPETUAL: ci, P3Y: li },
    _p = {
        [ni]: { commitment: ie.YEAR, term: ne.MONTHLY },
        [oi]: { commitment: ie.YEAR, term: ne.ANNUAL },
        [si]: { commitment: ie.MONTH, term: ne.MONTHLY },
        [ci]: { commitment: ie.PERPETUAL, term: void 0 },
        [li]: { commitment: ie.THREE_MONTHS, term: ne.P3Y },
    },
    Ta = 'Value is not an offer',
    Jt = (e) => {
        if (typeof e != 'object') return Ta;
...
var vs = (e, t) => {
    switch (e) {
        ...
        case '':
            return '';
        case ie.YEAR:
            return t === ne.MONTHLY ? ni : t === ne.ANNUAL ? oi : '';
        case ie.MONTH:
            return t === ne.MONTHLY ? si : '';
        case ie.PERPETUAL:
            return ci;
        case ie.TERM_LICENSE:
            return t === ne.P3Y ? li : '';
        default:
            return '';
    }
...
function Et(e, { country: t, forceTaxExclusive: r }) {
    let i;
    if (e.length < 2) i = e;
    else {
        let a = t === 'GB' ? 'EN' : 'MULT';
        e.sort((n, o) => (n.language === a ? -1 : o.language === a ? 1 : 0)),
            e.sort((n, o) =>
                !n.term && o.term ? -1 : n.term && !o.term ? 1 : 0,
            ),
            (i = [e[0]]);
    }
    return r && (i = i.map(_a)), i;
}
var er = (e) => window.setTimeout(e);
function Je(e, t = 1) {
    if (e == null) return [t];
    let r = (Array.isArray(e) ? e : String(e).split(',')).map(Ea).filter(bt);
    return r.length || (r = [t]), r;
}
function tr(e) {
    return e == null
        ? []
        : (Array.isArray(e) ? e : String(e).split(',')).filter(ya);
}
function ee() {
    return document.getElementsByTagName(bs)?.[0];
}
function Ca(e) {
    let t = {};
    if (!e?.headers) return t;
    let r = e.headers;
    for (let [i, a] of Object.entries(ys)) {
        let n = r.get(a);
        n &&
            ((n = n.replace(/[,;]/g, '|')),
            (n = n.replace(/[| ]+/g, '|')),
...
function La(e) {
    ...
    if (t === 'object') {
        ...
        if (typeof e.originatingRequest == 'string') {
            let { message: i, originatingRequest: a, status: n } = e;
...
function ws(e, t) {
    if (!ke.ignoredProperties.includes(e)) return La(t);
}
var di = {
    append(e) {
        ...
        let { message: t, params: r } = e,
            ...
            n = t;
        r.forEach((l) => {
            l != null && (Es(l) ? i : a).push(l);
        }),
            i.length && (n += ' ' + i.map(La).join(' '));
        let { pathname: o, search: s } = window.location,
            c = `${ke.delimiter}page=${o}${s}`;
        c.length > Pa && (c = `${c.slice(0, Pa)}<trunc>`),
            (n += c),
            a.length &&
                ((n += `${ke.delimiter}facts=`), (n += JSON.stringify(a, ws))),
            window.lana?.log(n, ke);
    },
};
function rr(e) {
    Object.assign(
...
var ka = { LOCAL: 'local', PROD: 'prod', STAGE: 'stage' },
    pi = { DEBUG: 'debug', ERROR: 'error', INFO: 'info', WARN: 'warn' },
    hi = new Set(),
    mi = new Set(),
    Ma = new Map(),
    Ra = {
        append({ level: e, message: t, params: r, timestamp: i, source: a }) {
            console[e](`${i}ms [${a}] %c${t}`, 'font-weight: bold;', ...r);
        },
    },
    Na = { filter: ({ level: e }) => e !== pi.DEBUG },
    As = { filter: () => !1 };
...
function Ts(e) {
    [...mi].every((t) => t(e)) && hi.forEach((t) => t(e));
}
function Oa(e) {
    let t = (Ma.get(e) ?? 0) + 1;
    Ma.set(e, t);
    let r = `${e} #${t}`,
        i = {
            id: r,
            namespace: e,
            module: (a) => Oa(`${i.namespace}/${a}`),
            updateConfig: rr,
        };
    return (
        Object.values(pi).forEach((a) => {
            i[a] = (n, ...o) => Ts(Ss(a, n, e, o, r));
        }),
        Object.seal(i)
    );
}
function ir(...e) {
    e.forEach((t) => {
        ...
        Yt(i) && mi.add(i), Yt(r) && hi.add(r);
    });
}
function _s(e = {}) {
    let { name: t } = e,
        r = E(D('commerce.debug', { search: !0, storage: !0 }), t === ka.LOCAL);
    return ir(r ? Ra : Na), t === ka.PROD && ir(di), oe;
}
function Cs() {
    hi.clear(), mi.clear();
}
...
var et = class e extends Error {
    constructor(t, r, i) {
        if ((super(t, { cause: i }), (this.name = 'MasError'), r.response)) {
            let a = r.response.headers?.get(pt);
            a && (r.requestId = a),
                r.response.status &&
...
var Ps = { [ce]: Pr, [ye]: Lr, [me]: kr },
    ...
    Ae = class {
        constructor(t) {
            ...
            (this.wrapperElement = t), (this.log = oe.module('mas-element'));
        }
        update() {
            [ce, ye, me].forEach((t) => {
                this.wrapperElement.classList.toggle(Ps[t], t === this.state);
            });
        }
        notify() {
            (this.state === me || this.state === ce) &&
                (this.state === me
                ...
                (this.promises = []));
            let t = this.error;
            this.error instanceof et &&
                (t = { message: this.error.message, ...this.error.context }),
                this.wrapperElement.dispatchEvent(
                    new CustomEvent(Ls[this.state], { bubbles: !0, detail: t }),
                );
        }
        ...
        connectedCallback() {
            V(this, wt, ee()), this.requestUpdate(!0);
        }
        ...
        toggleFailed(t, r, i) {
            ...
            return (
                this.log?.error(`${a}: Failed to render: ${r.message}`, {
                    element: this.wrapperElement,
                    ...r.context,
                    ...A(this, wt)?.duration,
                }),
        ...
        requestUpdate(t = !1) {
            if (!this.wrapperElement.isConnected || !ee() || this.timer) return;
            let { error: r, options: i, state: a, value: n, version: o } = this;
            (this.state = ye),
                (this.timer = er(async () => {
                    this.timer = null;
                    let s = null;
...
function ar(e, t = {}) {
    let { tag: r, is: i } = e,
        a = document.createElement(r, { is: i });
    return a.setAttribute('is', i), Object.assign(a.dataset, Ia(t)), a;
}
function Da(e, t = {}) {
    return e instanceof HTMLElement
        ? (Object.assign(e.dataset, Ia(t)), e)
        : null;
}
function ks(e) {
...
var Ne,
    Me = class Me extends HTMLAnchorElement {
        constructor() {
            super();
            g(this, 'masElement', new Ae(this));
            $(this, Ne);
            this.setAttribute('is', Me.is);
        }
        get isUptLink() {
            return !0;
        }
        ...
        attributeChangedCallback(r, i, a) {
            this.masElement.attributeChangedCallback(r, i, a);
        }
        connectedCallback() {
            this.masElement.connectedCallback(),
                V(this, Ne, ut()),
                A(this, Ne) && (this.log = A(this, Ne).log.module('upt-link'));
        }
        disconnectedCallback() {
            this.masElement.disconnectedCallback(), V(this, Ne, void 0);
        }
        requestUpdate(r = !1) {
        ...
        async render() {
            ...
            let a = this.masElement.togglePending(i),
                n = r.resolveOfferSelectors(i);
            try {
                ...
                m && (d += `&promotion_code=${encodeURIComponent(m)}`),
                    (this.href = `${ks(l)}?${d}`),
                    this.masElement.toggleResolved(a, o, i);
            } catch (o) {
                let s = new Error(
                    `Could not resolve offer selectors for id: ${i.wcsOsi}.`,
                    o.message,
                );
                return this.masElement.toggleFailed(a, s, i), !1;
            }
        }
        static createFrom(r) {
            let i = new Me();
...
function Os(e, t, r) {
    let i = !1,
        a = { value: e };
    e < 0 && ((i = !0), (a.value = -a.value)),
        (a.sign = i ? '-' : ''),
        (a.value = Number(a.value).toFixed(t.fraction && t.fraction.length)),
        (a.value = Number(a.value).toString());
    let n = t.fraction && t.fraction.lastIndexOf('0'),
        [o = '0', s = ''] = a.value.split('.');
    return (
        (!s || (s && s.length <= n)) &&
            (s = n < 0 ? '' : (+('0.' + s)).toFixed(n + 1).replace('0.', '')),
        (a.integer = o),
        (a.fraction = s),
        Is(a, t),
        (a.result === '0' || a.result === '') && ((i = !1), (a.sign = '')),
...
function Is(e, t) {
    ...
    let r = t.integer.split(t.separator),
        ...
        a = i && i.indexOf('0');
    if (a > -1)
        for (; e.integer.length < i.length - a; ) e.integer = '0' + e.integer;
    else Number(e.integer) === 0 && (e.integer = '');
    let n = r[1] && r[r.length - 1].length;
    if (n) {
        let o = e.integer.length,
            s = o % n;
        for (let c = 0; c < o; c++)
            (e.result += e.integer.charAt(c)),
                !((c - s + 1) % n) && c < o - n && (e.result += t.separator);
...
function Ds(e, t, r = {}) {
    ...
    let i = Ns(e),
        a = Os(t, i, r);
    return i.prefix + a.sign + a.result + i.suffix;
}
var Ua = Ds;
var Fa = '.',
    Hs = ',',
    ...
    gi = {
        [_e.YEAR]: { [ae.MONTHLY]: Oe.MONTH, [ae.ANNUAL]: Oe.YEAR },
        [_e.MONTH]: { [ae.MONTHLY]: Oe.MONTH },
    },
    Fs = (e, t) => e.indexOf(`'${t}'`) === 0,
    zs = (e, t = !0) => {
    ...
    $s = (e) => {
        let t = Vs(e),
            r = Fs(e, t),
            i = e.replace(/'.*?'/, ''),
            a = $a.test(i) || Ga.test(i);
        return { currencySymbol: t, isCurrencyFirst: r, hasCurrencySpace: a };
    },
    Va = (e) => e.replace($a, za).replace(Ga, za),
    Gs = (e) => (e.match(/#(.?)#/)?.[1] === Fa ? Hs : Fa),
    Vs = (e) => e.match(/'(.*?)'/)?.[1] ?? '',
    qa = (e) => e.match(/0(.?)0/)?.[1] ?? '';
function tt(
    ...
    let { currencySymbol: o, isCurrencyFirst: s, hasCurrencySpace: c } = $s(e),
        l = r ? qa(e) : '',
        d = zs(e, r),
        m = r ? 2 : 0,
        h = n(t, { currencySymbol: o }),
        p = i
            ? h.toLocaleString('hi-IN', {
                  minimumFractionDigits: m,
                  maximumFractionDigits: m,
              })
            : Ua(d, h),
        u = r ? p.lastIndexOf(l) : p.length,
        f = p.substring(0, u),
        x = p.substring(u + 1);
    return {
        accessiblePrice: e
...
var ja = (e) => {
        let { commitment: t, term: r, usePrecision: i } = e,
            a = Bs[r] ?? 1;
        return tt(e, a > 1 ? Oe.MONTH : gi[t]?.[r], (n) => {
            let o = { divisor: a, price: n, usePrecision: i },
                { round: s } = Us.find(({ accept: c }) => c(o));
            if (!s)
                throw new Error(
    ...
    Wa = ({ commitment: e, term: t, ...r }) => tt(r, gi[e]?.[t]),
    Ya = (e) => {
        let {
            commitment: t,
            instant: r,
        ...
        if (t === _e.YEAR && c === ae.MONTHLY) {
            if (!o) return tt(e, Oe.YEAR, ui);
            let { displaySummary: { outcomeType: l, duration: d } = {} } = o;
            switch (l) {
                case 'PERCENTAGE_DISCOUNT':
                    if (Ie(o, r, s)) {
                        let m = parseInt(d.replace('P', '').replace('M', ''));
                        if (isNaN(m)) return ui(i);
                        let h = a * m,
                            p = n * (12 - m),
                            u = Math.round((h + p) * 100) / 100;
                        return tt({ ...e, price: u }, Oe.YEAR);
                    }
                default:
                    return tt(e, Oe.YEAR, () => ui(n ?? i));
            }
        }
        return tt(e, gi[t]?.[c]);
    };
...
function Ja(e) {
    return class extends e {
        ...
        attributeChangedCallback(i, a, n) {
            this.masElement.attributeChangedCallback(i, a, n);
        }
        connectedCallback() {
            this.masElement.connectedCallback(),
        ...
        get is3in1Modal() {
            return Object.values(Pe).includes(this.getAttribute('data-modal'));
        }
        get isOpen3in1Modal() {
        ...
        async render(i = {}) {
            ...
            if (!a) return !1;
            this.dataset.imsCountry ||
                a.imsCountryPromise.then((p) => {
                    p && (this.dataset.imsCountry = p);
                }),
                (i.imsCountry = null);
            let n = a.collectCheckoutOptions(i, this);
            if (!n.wcsOsi.length) return !1;
            let o;
            try {
                o = JSON.parse(n.extraOptions ?? '{}');
            } catch (p) {
            ...
            let s = this.masElement.togglePending(n);
            this.setCheckoutUrl('');
            let c = a.resolveOfferSelectors(n),
            ...
            !Ie(
                ...
                n.promotionCode &&
                delete n.promotionCode,
                (n.country = this.dataset.imsCountry || n.country);
            let h = await a.buildCheckoutAction?.(
                l.flat(),
                { ...o, ...n },
                this,
            );
            return this.renderOffers(l.flat(), n, {}, h, s);
        }
        renderOffers(i, a, n = {}, o = void 0, s = void 0) {
            let c = ee();
            if (!c) return !1;
            if (
                ((a = {
                ...
                s ?? (s = this.masElement.togglePending(a)),
                this.checkoutActionHandler &&
                    (this.checkoutActionHandler = void 0),
                o)
            ) {
                this.classList.remove(Xa, Ka),
                    this.masElement.toggleResolved(s, i, a);
                let { url: d, text: m, className: h, handler: p } = o;
                d && this.setCheckoutUrl(d),
                    m && (this.firstElementChild.innerHTML = m),
                    h && this.classList.add(...h.split(' ')),
                    p &&
                        (this.setCheckoutUrl('#'),
                        (this.checkoutActionHandler = p.bind(this)));
            }
            if (i.length) {
                if (this.masElement.toggleResolved(s, i, a)) {
                    if (
                        !this.classList.contains(Xa) &&
                        !this.classList.contains(Ka)
                    ) {
                        let d = c.buildCheckoutURL(i, a);
                        this.setCheckoutUrl(a.modal === 'true' ? '#' : d);
                    }
                    return !0;
                }
            } else {
                let d = new Error(`Not provided: ${a?.wcsOsi ?? '-'}`);
                if (this.masElement.toggleFailed(s, d, a))
...
var At = class At extends Ja(HTMLAnchorElement) {
...
g(At, 'is', 'checkout-link'), g(At, 'tag', 'a');
var fe = At;
window.customElements.get(fe.is) ||
    window.customElements.define(fe.is, fe, { extends: fe.tag });
var qs = 'p_draft_landscape',
    js = '/store/',
    Ws = new Map([
        ['countrySpecific', 'cs'],
        ['customerSegment', 'cs'],
    ...
    Ys = ['env', 'workflowStep', 'clientId', 'country'],
    en = (e) => Ws.get(e) ?? e;
function vi(e, t, r) {
    for (let [i, a] of Object.entries(e)) {
        let n = en(i);
        a != null && r.has(n) && t.set(n, a);
    }
}
function Xs(e) {
    switch (e) {
...
function Ks(e, t) {
    for (let r in e) {
        let i = e[r];
        for (let [a, n] of Object.entries(i)) {
            if (n == null) continue;
            let o = en(a);
            t.set(`items[${r}][${o}]`, n);
        }
...
function Qs({ url: e, modal: t, is3in1: r }) {
    ...
    return (
        ...
        e.searchParams.get('cli') !== 'doc_cloud' &&
            e.searchParams.set('cli', t === Pe.CRM ? 'creative' : 'mini_plans'),
        e
    );
}
function tn(e) {
    ...
    if (
        ((p.pathname = `${js}${i}`),
        i !== Q.SEGMENTATION &&
            i !== Q.CHANGE_PLAN_TEAM_PLANS &&
            Ks(r, p.searchParams),
        vi({ ...h }, p.searchParams, xi),
        c === Ee.DRAFT && vi({ af: qs }, p.searchParams, xi),
        i === Q.SEGMENTATION)
    ) {
        let u = {
            marketSegment: a,
            ...
            addonProductArrangementCode: s
                ? r?.find((f) => f.productArrangementCode !== s)
...
function Zs(e) {
    ...
    if (
        e.workflowStep !== Q.SEGMENTATION &&
        e.workflowStep !== Q.CHANGE_PLAN_TEAM_PLANS &&
        !e.items
    )
...
var L = Object.freeze({
    ...
    landscape: Ee.PUBLISHED,
});
function rn({ settings: e, providers: t }) {
    function r(n, o) {
        let {
                checkoutClientId: s,
        ...
        if (o) for (let Be of t.checkout) Be(o, f);
        let {
                checkoutMarketSegment: x,
                checkoutWorkflowStep: C = c,
                imsCountry: v,
                country: b = v ?? l,
                language: w = d,
                quantity: _ = h,
                ...
                extraOptions: X,
                ...pe
            } = Object.assign(f, o?.dataset ?? {}, n ?? {}),
            be = yt(C, Q, L.checkoutWorkflowStep);
        return (
            (f = Kt({
                ...pe,
                extraOptions: X,
                ...
                modal: Y,
                perpetual: E(z),
                promotionCode: Zt(N).effectivePromoCode,
                wcsOsi: tr(U),
                preselectPlan: p,
            })),
            f
    ...
    function i(n, o) {
        if (!Array.isArray(n) || !n.length || !o) return '';
        let { env: s, landscape: c } = e,
            ...
            b = document.querySelector('meta[name=mas-ff-3in1]'),
            w =
                Object.values(Pe).includes(o.modal) &&
                (!b || b.content !== 'off'),
            _ = window.frameElement || w ? 'if' : 'fp',
            [
                {
                    productArrangementCode: R,
                    marketSegments: [B],
                    customerSegment: Y,
                    offerType: z,
                },
        ...
        if (n.length === 1) {
            let { offerId: be } = n[0];
            X.items.push({ id: be, quantity: pe });
        } else
            X.items.push(
                ...n.map(({ offerId: be, productArrangementCode: Be }) => ({
                    id: be,
                    quantity: pe,
                    ...(w ? { productArrangementCode: Be } : {}),
                })),
            );
        return tn(X);
    }
    let { createCheckoutLink: a } = fe;
    return {
        CheckoutLink: fe,
        CheckoutWorkflowStep: Q,
        buildCheckoutURL: i,
        collectCheckoutOptions: r,
        createCheckoutLink: a,
    };
}
function Js({ interval: e = 200, maxAttempts: t = 25 } = {}) {
    let r = oe.module('ims');
...
var nn = window.masPriceLiterals;
function on(e) {
    if (Array.isArray(nn)) {
        let t = (i) => nn.find((a) => Zr(a.lang, i)),
...
function un(e) {
    ...
    for (
        var t = e.split(dn).filter(function (h) {
                return h.length > 0;
            }),
            r = [],
            i = 0,
...
function vn(e) {
    for (var t = {}, r = 0, i = e; r < i.length; r++) {
        ...
        switch (a.stem) {
            ...
            case 'measure-unit':
            case 'unit':
                (t.style = 'unit'), (t.unit = ic(a.options[0]));
                continue;
            case 'compact-short':
            case 'K':
            ...
            case 'integer-width':
                ...
                a.options[0].replace(ac, function (c, l, d, m, h, p) {
        ...
        if (pn.test(a.stem)) {
            ...
            a.stem.replace(pn, function (c, l, d, m, h, p) {
                return (
                    d === '*'
                        ...
                        : m && m[0] === '#'
                          ...
                          : h && p
                            ? ((t.minimumFractionDigits = h.length),
                              (t.maximumFractionDigits = h.length + p.length))
                            : ((t.minimumFractionDigits = l.length),
...
function bn(e, t) {
    for (var r = '', i = 0; i < e.length; i++) {
        var a = e.charAt(i);
        if (a === 'j') {
            for (var n = 0; i + 1 < e.length && e.charAt(i + 1) === a; )
                n++, i++;
            var o = 1 + (n & 1),
                s = n < 2 ? 1 : 3 + (n >> 1),
                c = 'a',
...
function oc(e) {
    ...
    var a = _t[i || ''] || _t[r || ''] || _t[''.concat(r, '-001')] || _t['001'];
    return a[0];
}
var wi,
    sc = new RegExp('^'.concat(Ei.source, '*')),
    cc = new RegExp(''.concat(Ei.source, '*$'));
function T(e, t) {
    return { start: e, end: t };
}
var lc = !!String.prototype.startsWith,
    dc = !!String.fromCodePoint,
    pc = !!Object.fromEntries,
    hc = !!String.prototype.codePointAt,
    mc = !!String.prototype.trimStart,
    uc = !!String.prototype.trimEnd,
    fc = !!Number.isSafeInteger,
    gc = fc
    ...
    Si = !0;
try {
    (yn = Sn('([^\\p{White_Space}\\p{Pattern_Syntax}]*)', 'yu')),
        (Si =
            ((wi = yn.exec('a')) === null || wi === void 0 ? void 0 : wi[0]) ===
            'a');
} catch {
    Si = !1;
}
    ...
    Ti = dc
        ...
        : function () {
              for (var t = [], r = 0; r < arguments.length; r++)
                  t[r] = arguments[r];
              for (var i = '', a = t.length, n = 0, o; a > n; ) {
                  if (((o = t[n++]), o > 1114111))
...
var _i;
Si
    ? ((Ai = Sn('([^\\p{White_Space}\\p{Pattern_Syntax}]*)', 'yu')),
      (_i = function (t, r) {
          var i;
          Ai.lastIndex = r;
          var a = Ai.exec(t);
    ...
    Tn = (function () {
        ...
        return (
            ...
            (e.prototype.parseTag = function (t, r) {
                ...
                if (this.bumpIf('>')) {
                    var n = this.parseMessage(t + 1, r, !0);
                    if (n.err) return n;
                    var o = n.val,
            ...
            (e.prototype.parseTagName = function () {
                var t = this.offset();
                for (this.bump(); !this.isEOF() && yc(this.char()); )
                    this.bump();
            ...
            (e.prototype.parseLiteral = function (t, r) {
                ...
                return {
                    val: { type: O.literal, value: a, location: c },
                    err: null,
                };
            }),
            ...
            (e.prototype.parseArgument = function (t, r) {
                ...
                if ((this.bump(), this.bumpSpace(), this.isEOF()))
                    return this.error(
                        y.EXPECT_ARGUMENT_CLOSING_BRACE,
                        T(i, this.clonePosition()),
                    );
                if (this.char() === 125)
                    return (
                        this.bump(),
                        this.error(y.EMPTY_ARGUMENT, T(i, this.clonePosition()))
                    );
                var a = this.parseIdentifierIfPossible().value;
                if (!a)
                    return this.error(
                        y.MALFORMED_ARGUMENT,
                        T(i, this.clonePosition()),
                    );
                    ...
                    case 44:
                        return (
                            ...
                            this.isEOF()
                                ...
                                : this.parseArgumentOptions(t, r, a, i)
                        );
                    default:
                        return this.error(
                            y.MALFORMED_ARGUMENT,
            ...
            (e.prototype.parseArgumentOptions = function (t, r, i, a) {
                var n,
                ...
                switch (s) {
                    case '':
                        return this.error(y.EXPECT_ARGUMENT_TYPE, T(o, c));
                    case 'number':
                    case 'date':
                    case 'time': {
                        this.bumpSpace();
                        ...
                        if (this.bumpIf(',')) {
                            ...
                            var p = T(d, this.clonePosition());
                            l = { style: h, styleLocation: p };
                        }
                        var u = this.tryParseArgumentClose(a);
                        if (u.err) return u;
                        var f = T(a, this.clonePosition());
                        if (l && En(l?.style, '::', 0)) {
                            var x = xc(l.style.slice(2));
                            if (s === 'number') {
                                ...
                                if (x.length === 0)
                                    return this.error(
                                        y.EXPECT_DATE_TIME_SKELETON,
                                        f,
                                    );
                                var C = x;
                                this.locale && (C = bn(x, this.locale));
                                var h = {
                                        type: De.dateTime,
                                        pattern: C,
                    ...
                    case 'select': {
                        ...
                        if ((this.bumpSpace(), !this.bumpIf(',')))
                            return this.error(
                                y.EXPECT_SELECT_ARGUMENT_OPTIONS,
                                T(b, S({}, b)),
                            );
                        this.bumpSpace();
                        ...
                        var R = this.tryParsePluralOrSelectOptions(t, s, r, w);
                        if (R.err) return R;
                        var u = this.tryParseArgumentClose(a);
                        if (u.err) return u;
                    ...
                    default:
                        return this.error(y.INVALID_ARGUMENT_TYPE, T(o, c));
                }
            }),
                ...
                for (var t = 0, r = this.clonePosition(); !this.isEOF(); ) {
                    ...
                    switch (i) {
                        case 39: {
                            ...
                            if (!this.bumpUntil("'"))
                                return this.error(
                                    y.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,
            ...
            (e.prototype.tryParsePluralOrSelectOptions = function (t, r, i, a) {
                for (
                    var n,
                        o = !1,
                        s = [],
                    ...
                    var u = this.parseMessage(t + 1, r, i);
                    if (u.err) return u;
                    var f = this.tryParseArgumentClose(p);
                    if (f.err) return f;
                    s.push([
                        l,
                        { value: u.val, location: T(p, this.clonePosition()) },
                    ]),
                        c.add(l),
                        this.bumpSpace(),
                        (n = this.parseIdentifierIfPossible()),
                        (l = n.value),
                        (d = n.location);
                }
                return s.length === 0
                    ? this.error(
                          r === 'select'
                              ? y.EXPECT_SELECT_ARGUMENT_SELECTOR
                              : y.EXPECT_PLURAL_ARGUMENT_SELECTOR,
                          T(this.clonePosition(), this.clonePosition()),
                      )
                    : this.requiresOtherClause && !o
                      ? this.error(
                            y.MISSING_OTHER_CLAUSE,
                            T(this.clonePosition(), this.clonePosition()),
                        )
                      : { val: s, err: null };
            }),
            (e.prototype.tryParseDecimalInteger = function (t, r) {
                ...
                for (var n = !1, o = 0; !this.isEOF(); ) {
                    var s = this.char();
                    if (s >= 48 && s <= 57)
                        (n = !0), (o = o * 10 + (s - 48)), this.bump();
                    else break;
                }
                var c = T(a, this.clonePosition());
                return n
                    ? ((o *= i),
                      gc(o) ? { val: o, err: null } : this.error(r, c))
                    : this.error(t, c);
            }),
...
function Pi(e) {
    e.forEach(function (t) {
        if ((delete t.location, lr(t) || dr(t)))
            for (var r in t.options)
                delete t.options[r].location, Pi(t.options[r].value);
        else
            (or(t) && hr(t.style)) || ((sr(t) || cr(t)) && Tt(t.style))
...
function Cn(e, t) {
    ...
    if (r.err) {
        var i = SyntaxError(y[r.err.kind]);
        throw (
    ...
    return t?.captureLocation || Pi(r.val), r.val;
}
function Ct(e, t) {
    var r = t && t.cache ? t.cache : Cc,
        i = t && t.serializer ? t.serializer : _c,
        a = t && t.strategy ? t.strategy : Ac;
    return a(e, { cache: r, serializer: i });
}
function wc(e) {
...
function Pn(e, t, r, i) {
    var a = wc(i) ? i : r(i),
        n = t.get(a);
    return typeof n > 'u' && ((n = e.call(this, i)), t.set(a, n)), n;
}
function Ln(e, t, r) {
    var i = Array.prototype.slice.call(arguments, 3),
        a = r(i),
        n = t.get(a);
    return typeof n > 'u' && ((n = e.apply(this, i)), t.set(a, n)), n;
}
function Li(e, t, r, i, a) {
    return r.bind(t, e, i, a);
}
function Ac(e, t) {
    var r = e.length === 1 ? Pn : Ln;
    return Li(e, this, r, t.cache.create(), t.serializer);
}
function Sc(e, t) {
    return Li(e, this, Ln, t.cache.create(), t.serializer);
}
function Tc(e, t) {
    return Li(e, this, Pn, t.cache.create(), t.serializer);
}
var _c = function () {
...
var Pt = (function (e) {
    ...
    function t(r, i, a) {
        ...
        return (n.code = i), (n.originalMessage = a), n;
    }
    return (
    ...
    for (var s = [], c = 0, l = e; c < l.length; c++) {
        ...
        if (pr(d)) {
            var u = d.children,
                f = d.value,
                x = a[f];
            if (!Lc(x)) throw new kn(f, 'function', o);
            var C = Lt(u, t, r, i, a, n),
                v = x(
                    C.map(function (_) {
                        return _.value;
                    }),
            ...
            Array.isArray(v) || (v = [v]),
                s.push.apply(
                    ...
                    v.map(function (_) {
                        return {
                            type: typeof _ == 'string' ? j.literal : j.object,
                            value: _,
                        };
                    }),
                );
        ...
        if (lr(d)) {
            var b = d.options[h] || d.options.other;
            if (!b) throw new Mi(d.value, h, Object.keys(d.options), o);
            s.push.apply(s, Lt(b.value, t, r, i, a));
            continue;
        }
        if (dr(d)) {
            var b = d.options['='.concat(h)];
            if (!b) {
                if (!Intl.PluralRules)
                    throw new Pt(
...
`,
                ...
                var w = r
                    ...
                    .select(h - (d.offset || 0));
                b = d.options[w] || d.options.other;
            }
            if (!b) throw new Mi(d.value, h, Object.keys(d.options), o);
            s.push.apply(s, Lt(b.value, t, r, i, a, h - (d.offset || 0)));
            continue;
        }
    }
    return Pc(s);
    ...
    return (
        e === void 0 && (e = { number: {}, dateTime: {}, pluralRules: {} }),
        {
            getNumberFormat: Ct(
                ...
                { cache: Ri(e.number), strategy: mr.variadic },
            ),
            getDateTimeFormat: Ct(
                ...
                { cache: Ri(e.dateTime), strategy: mr.variadic },
            ),
            getPluralRules: Ct(
                function () {
                    for (var t, r = [], i = 0; i < arguments.length; i++)
                ...
                { cache: Ri(e.pluralRules), strategy: mr.variadic },
            ),
        }
    );
}
var Rn = (function () {
    function e(t, r, i, a) {
        ...
        (this.formats = Mc(e.formats, i)),
            (this.formatters = (a && a.formatters) || Rc(this.formatterCache));
    }
    return (
...
var Ni = {
    ...
    Nc = wa('ConsonantTemplates/price'),
    Oc = /<\/?[^>]+(>|$)/g,
    H = {
        container: 'price',
    ...
    Ic = (e) =>
        ba(e)
            ...
            : '',
    F = (e, t, r, i = !1) =>
        `<span class="${e}${t ? '' : ' ' + H.disabled}"${Ic(r)}>${i ? Va(t) : (t ?? '')}</span>`;
function Dc(e) {
    e = e.replaceAll('</a>', '&lt;/a&gt;');
    let t = /<a [^>]+(>|$)/g;
    return (
        e.match(t)?.forEach((i) => {
            let a = i.replace('<a ', '&lt;a ').replace('>', '&gt;');
            e = e.replaceAll(i, a);
        }),
        e
    );
...
function ge(e, t, r, i) {
    ...
    let n = a.includes('<'),
        o = a.includes('<a ');
    try {
        (a = o ? Dc(a) : a), (a = n ? a.replace(Oc, '') : a);
        let s = new Nn(a, t).format(i);
        return o ? Hc(s) : s;
    } catch {
        return Nc.error('Failed to format literal:', a), '';
    }
}
function Bc(
    e,
    ...
    let p = F(H.currencySymbol, i),
        u = F(H.currencySpace, o ? '&nbsp;' : ''),
        f = '';
    return (
        t
            ? (f = `<sr-only class="strikethrough-aria-label">${t}</sr-only>`)
            : r && (f = `<sr-only class="alt-aria-label">${r}</sr-only>`),
        c && (f += p + u),
        (f += F(H.integer, s)),
        (f += F(H.decimalsDelimiter, n)),
        (f += F(H.decimals, a)),
        c || (f += u + p),
        (f += F(H.recurrence, l, null, !0)),
        (f += F(H.unitType, d, null, !0)),
        (f += F(H.taxInclusivity, m, !0)),
        F(e, f, { ...h })
    );
}
var W =
        ...
        (
            ...
            Object.entries({
                ...
                if (yo == null)
                    throw new Error(
                        `Argument "${bo}" is missing for osi ${x?.toString()}, country ${n}, language ${d}`,
                    );
            });
            let N = { ...Ni, ...m },
                U = `${d.toLowerCase()}-${n.toUpperCase()}`,
                X;
            Y && !u && b ? (X = e ? v : b) : r && b ? (X = b) : (X = v);
            let pe = t ? ja : Wa;
            i && (pe = Ya);
            let {
                    accessiblePrice: be,
            ...
            E(s) &&
                Be &&
                (vr = ge(N, U, Se.recurrenceLabel, { recurrenceTerm: Be }));
            let Dt = '';
            E(c) &&
                (p && (Dt += ' '),
                (Dt += ge(N, U, Se.perUnitLabel, { perUnit: 'LICENSE' })));
            let Ht = '';
            E(l) &&
                _ &&
                (p && (Ht += ' '),
                (Ht += ge(
                    N,
                    U,
                    w === Oi ? Se.taxExclusiveLabel : Se.taxInclusiveLabel,
                    { taxTerm: _ },
                ))),
                r &&
                    (gr = ge(N, U, Se.strikethroughAriaLabel, {
                        strikethroughPrice: gr,
                    })),
                e &&
                    (xr = ge(N, U, Se.alternativePriceAriaLabel, {
                        alternativePrice: xr,
                    }));
            let Ue = H.container;
            if (
                (t && (Ue += ' ' + H.containerOptical),
                r && (Ue += ' ' + H.containerStrikethrough),
                e && (Ue += ' ' + H.containerAlternative),
                i && (Ue += ' ' + H.containerAnnual),
                E(o))
            )
                return Bc(
                    Ue,
                    {
                        ...Ui,
                        accessibleLabel: gr,
                        altAccessibleLabel: xr,
                        recurrenceLabel: vr,
                        perUnitLabel: Dt,
                        taxInclusivityLabel: Ht,
                    },
                    z,
                );
            let {
                ...
                Fe = [go, fo, uo];
            xo
                ? (Fe.unshift(zi ? '\xA0' : ''), Fe.unshift(Fi))
                : (Fe.push(zi ? '\xA0' : ''), Fe.push(Fi)),
                Fe.push(vr, Dt, Ht);
            let vo = Fe.join('');
            return F(Ue, vo, z);
        },
    On = () => (e, t, r) => {
        let i = Ie(
            ...
            n =
                (e.displayOldPrice === void 0 || E(e.displayOldPrice)) &&
                t.priceWithoutDiscount &&
                t.priceWithoutDiscount != t.price &&
                (!t.promotion || i);
        return `${n ? W({ displayStrikethrough: !0 })({ isPromoApplied: i, ...e }, t, r) + '&nbsp;' : ''}${W({ isAlternativePrice: n })({ isPromoApplied: i, ...e }, t, r)}`;
    },
    In = () => (e, t, r) => {
        let { instant: i } = e;
        try {
        ...
        let a = Ie(
            ...
            n = { ...e, displayTax: !1, displayPerUnit: !1, isPromoApplied: a };
        if (!a)
            return (
                W()(e, { ...t, price: t.priceWithoutDiscount }, r) +
                F(H.containerAnnualPrefix, '&nbsp;(') +
                W({ displayAnnual: !0, instant: i })(
                    n,
                    { ...t, price: t.priceWithoutDiscount },
                    r,
                ) +
                F(H.containerAnnualSuffix, ')')
            );
        let s =
            (e.displayOldPrice === void 0 || E(e.displayOldPrice)) &&
            t.priceWithoutDiscount &&
            t.priceWithoutDiscount != t.price;
        return `${s ? W({ displayStrikethrough: !0 })(n, t, r) + '&nbsp;' : ''}${W({ isAlternativePrice: s })({ isPromoApplied: a, ...e }, t, r)}${F(H.containerAnnualPrefix, '&nbsp;(')}${W({ displayAnnual: !0, instant: i })(n, t, r)}${F(H.containerAnnualSuffix, ')')}`;
    },
    Dn = () => (e, t, r) => {
        let i = { ...e, displayTax: !1, displayPerUnit: !1 };
        return `${W({ isAlternativePrice: e.displayOldPrice })(e, t, r)}${F(H.containerAnnualPrefix, '&nbsp;(')}${W({ displayAnnual: !0 })(i, t, r)}${F(H.containerAnnualSuffix, ')')}`;
    };
var kt = { ...H, containerLegal: 'price-legal', planType: 'price-plan-type' },
    ur = { ...Se, planTypeLabel: 'planTypeLabel' };
function Uc(
    e,
    ...
    let n = '';
    return (
        (n += F(kt.unitType, t, null, !0)),
        r && i && (r += '. '),
        (n += F(kt.taxInclusivity, r, !0)),
        (n += F(kt.planType, i, null)),
        F(e, n, { ...a })
    );
}
var Hn = (
    ...
    let d = { ...Ni, ...n },
        m = `${a.toLowerCase()}-${e.toUpperCase()}`,
        h = '';
    E(t) && (h = ge(d, m, ur.perUnitLabel, { perUnit: 'LICENSE' }));
    let p = '';
    e === 'US' && a === 'en' && (r = !1),
        E(r) &&
            s &&
            (p = ge(
                d,
                m,
                o === Oi ? ur.taxExclusiveLabel : ur.taxInclusiveLabel,
                { taxTerm: s },
            ));
    let u = '';
    E(i) && c && (u = ge(d, m, ur.planTypeLabel, { planType: c }));
    let f = kt.container;
    return (
        (f += ' ' + kt.containerLegal),
        Uc(f, { perUnitLabel: h, taxInclusivityLabel: p, planTypeLabel: u }, l)
    );
};
var Bn = W(),
    Un = On(),
    Fn = W({ displayOptical: !0 }),
    zn = W({ displayStrikethrough: !0 }),
    $n = W({ displayAnnual: !0 }),
    Gn = W({ displayOptical: !0, isAlternativePrice: !0 }),
    Vn = W({ isAlternativePrice: !0 }),
    qn = Dn(),
    jn = In(),
    Wn = Hn;
var Fc = (e, t) => {
        if (!(!bt(e) || !bt(t))) return Math.floor(((t - e) / t) * 100);
    },
    Yn = () => (e, t) => {
        ...
        return a === void 0
            ...
            : `<span class="discount">${a}%</span>`;
    };
var Xn = Yn();
var Qn = 'INDIVIDUAL_COM',
    Ii = 'TEAM_COM',
    Zn = 'INDIVIDUAL_EDU',
    Di = 'TEAM_EDU',
    Kn = [
    ...
    zc = {
        ...
        [Ii]: ['MU_en', 'LT_lt', 'LV_lv', 'NG_en', 'CO_es', 'KR_ko'],
        [Zn]: ['LT_lt', 'LV_lv', 'SA_en', 'SG_en'],
        [Di]: ['SG_en', 'KR_ko'],
    },
    $c = {
        MU_en: [!1, !1, !1, !1],
    ...
    jc = (e, t, r, i) => {
        let a = `${e}_${t}`;
        if (Kn.includes(e) || Kn.includes(a)) return !0;
        let n = zc[`${r}_${i}`];
        return n
            ? n.includes(e) || n.includes(a)
                ? !0
                : L.displayTax
            : L.displayTax;
    },
    Wc = async (e, t, r, i) => {
        ...
        return {
            displayTax: a,
            forceTaxExclusive: a ? qc(e, t, r, i) : L.forceTaxExclusive,
        };
    },
    Mt = class Mt extends HTMLSpanElement {
        constructor() {
            super();
            g(this, 'masElement', new Ae(this));
        ...
        get isFailed() {
            return this.masElement.state === ce;
        }
        requestUpdate(r = !1) {
        ...
        async render(r = {}) {
            ...
            let i = ee();
            if (!i) return !1;
            let a = i.collectPriceOptions(r, this),
                n = { ...i.settings, ...a };
            if (!n.wcsOsi.length) return !1;
            try {
                let o = this.masElement.togglePending({});
                this.innerHTML = '';
                let [s] = await i.resolveOfferSelectors(n),
                    c = Et(await s, n),
                    [l] = c;
                if (i.featureFlags[ue] || n[ue]) {
                    if (
                        (a.displayPerUnit === void 0 &&
                            (n.displayPerUnit =
                                l.customerSegment !== 'INDIVIDUAL'),
                        a.displayTax === void 0 ||
                            a.forceTaxExclusive === void 0)
                    ) {
                        let { country: d, language: m } = n,
                            [h = ''] = l.marketSegments,
                            p = await Wc(d, m, l.customerSegment, h);
                        a.displayTax === void 0 &&
                            (n.displayTax = p?.displayTax || n.displayTax),
                            a.forceTaxExclusive === void 0 &&
                                (n.forceTaxExclusive =
                                    p?.forceTaxExclusive ||
                                    n.forceTaxExclusive),
                            n.forceTaxExclusive && (c = Et(c, n));
                    }
                } else a.displayOldPrice === void 0 && (n.displayOldPrice = !0);
                return this.renderOffers(c, n, o);
            } catch (o) {
                throw ((this.innerHTML = ''), o);
            }
        }
        renderOffers(r, i, a = void 0) {
            if (!this.isConnected) return;
            let n = ee();
            if (!n) return !1;
            if ((a ?? (a = this.masElement.togglePending()), r.length)) {
                if (this.masElement.toggleResolved(a, r, i)) {
                    this.innerHTML = n.buildPriceHTML(r, this.options);
                ...
                if (this.masElement.toggleFailed(a, o, this.options))
                    return (this.innerHTML = ''), !0;
            }
            return !1;
        }
    };
g(Mt, 'is', 'inline-price'), g(Mt, 'tag', 'span');
var xe = Mt;
window.customElements.get(xe.is) ||
    window.customElements.define(xe.is, xe, { extends: xe.tag });
function Jn({ literals: e, providers: t, settings: r }) {
    function i(o, s = null) {
        let c = {
            country: r.country,
            language: r.language,
        ...
        if (s && t?.price) for (let R of t.price) R(s, c);
        let {
            displayOldPrice: l,
            displayPerUnit: d,
            displayRecurrence: m,
        ...
        return (
            (c = Kt(
                Object.assign({
                    ...
                    displayOldPrice: E(l),
                    displayPerUnit: E(d),
                    displayRecurrence: E(m),
                    displayTax: E(h),
                    displayPlanType: E(p),
                    forceTaxExclusive: E(u),
                    perpetual: E(f),
                    displayAnnual: E(x),
                    promotionCode: Zt(C).effectivePromoCode,
                    quantity: Je(v, L.quantity),
                    alternativePrice: E(b),
                    wcsOsi: tr(w),
                }),
            )),
            c
                ...
                s.template === 'optical' && s.alternativePrice
                    ...
                    : s.template === 'optical'
                      ...
                      : s.displayAnnual && o[0].planType === 'ABM'
                        ? (l = s.promotionCode ? jn : qn)
                        : s.alternativePrice
                          ? (l = Vn)
                          : (l = s.promotionCode ? Un : Bn);
        }
        let [d] = o;
        return (d = { ...d, ...d.priceDetails }), l({ ...r, ...s }, d);
    }
    let n = xe.createInlinePrice;
    return {
        InlinePrice: xe,
        buildPriceHTML: a,
...
function eo(e = {}, t) {
    let r = t.featureFlags[ue],
        ...
        a = he.PRODUCTION,
        n = Ur,
        o = D('checkoutClientId', i) ?? L.checkoutClientId,
        s = yt(D('checkoutWorkflowStep', i), Q, L.checkoutWorkflowStep),
        c = L.displayOldPrice,
        l = L.displayPerUnit,
        d = E(D('displayRecurrence', i), L.displayRecurrence),
        m = E(D('displayTax', i), L.displayTax),
        h = E(D('displayPlanType', i), L.displayPlanType),
        p = E(D('entitlement', i), L.entitlement),
        u = E(D('modal', i), L.modal),
        f = E(D('forceTaxExclusive', i), L.forceTaxExclusive),
        x = D('promotionCode', i) ?? L.promotionCode,
        C = Je(D('quantity', i)),
        v = D('wcsApiKey', i) ?? L.wcsApiKey,
        b = i?.env === 'stage',
        w = Ee.PUBLISHED;
    ['true', ''].includes(i.allowOverride) &&
        ((b =
            (D(Hr, i, { metadata: !1 })?.toLowerCase() ?? i?.env) === 'stage'),
        (w = yt(D(Br, i), Ee, w))),
        b && ((a = he.STAGE), (n = Fr));
    let R = D(Dr) ?? e.preview,
        B = typeof R < 'u' && R !== 'off' && R !== 'false',
        Y = {};
    B && (Y = { preview: B });
    let z =
            D('mas-io-url') ??
            e.masIOUrl ??
            `https://www${a === he.STAGE ? '.stage' : ''}.adobe.com/mas/io`,
        N = D('preselect-plan') ?? void 0;
    return {
        ...Yc(e),
        ...Y,
        displayOldPrice: c,
...
async function to(e, t = {}, r = 2, i = 100) {
    let a;
    for (let n = 0; n <= r; n++)
        try {
            ...
            if (((a = o), (a.retryCount = n), n > r)) break;
            await new Promise((s) => setTimeout(s, i * (n + 1)));
        }
    throw a;
}
var Hi = 'wcs';
function ro({ settings: e }) {
    let t = oe.module(Hi),
        { env: r, wcsApiKey: i } = e,
        a = new Map(),
        n = new Map(),
    ...
    async function c(p, u, f = !0) {
        ...
        let w = new Map(u),
            [_] = p.offerSelectorIds,
            R = Date.now() + Math.random().toString(36).substring(2, 7),
            B = `${Hi}:${_}:${R}${$r}`,
            Y = `${Hi}:${_}:${R}${Gr}`,
            z;
        try {
            if (
                (performance.mark(B),
                (v = new URL(e.wcsURL)),
                v.searchParams.set('offer_selector_ids', _),
                v.searchParams.set('country', p.country),
                v.searchParams.set('locale', p.locale),
                v.searchParams.set(
                    'landscape',
                    r === he.STAGE ? 'ALL' : e.landscape,
                ),
                v.searchParams.set('api_key', i),
                p.language && v.searchParams.set('language', p.language),
                p.promotionCode &&
                    v.searchParams.set('promotion_code', p.promotionCode),
                p.currency && v.searchParams.set('currency', p.currency),
                (b = await to(v.toString(), { credentials: 'omit' })),
                b.ok)
            ) {
                let N = [];
                try {
                    let U = await b.json();
                    t.debug('Fetched:', p, U), (N = U.resolvedOffers ?? []);
                } catch (U) {
                    t.error(`Error parsing JSON: ${U.message}`, {
                        ...U.context,
                        ...x?.duration,
                    });
                }
                (N = N.map(Jt)),
                    u.forEach(({ resolve: U }, X) => {
                        let pe = N.filter(({ offerSelectorIds: be }) =>
                            be.includes(X),
                        ).flat();
                        pe.length && (w.delete(X), u.delete(X), U(pe));
                    });
            } else C = Mr;
        } catch (N) {
            C = `Network error: ${N.message}`;
        } finally {
            (z = performance.measure(Y, B)),
                performance.clearMarks(B),
                performance.clearMeasures(Y);
        }
        if (f && u.size) {
            t.debug('Missing:', { offerSelectorIds: [...u.keys()] });
            let N = Ca(b);
            u.forEach((U) => {
                U.reject(
                    new et(C, {
    ...
    function l() {
        clearTimeout(o);
        let p = [...n.values()];
        n.clear(), p.forEach(({ options: u, promises: f }) => c(u, f));
    }
    function d(p) {
        if (!p || typeof p != 'object')
            throw new TypeError('Cache must be a Map or similar object');
        let u = r === he.STAGE ? 'stage' : 'prod',
            f = p[u];
        if (!f || typeof f != 'object') {
            t.warn(`No cache found for environment: ${r}`);
            return;
        }
        for (let [x, C] of Object.entries(f))
            a.set(x, Promise.resolve(C.map(Jt)));
        t.debug(`Prefilled WCS cache with ${f.size} entries`);
    }
    function m() {
        let p = a.size;
        (s = new Map(a)),
    ...
    function h({
        ...
        return C.map((w) => {
            let _ = `${w}-${b}`;
            if (a.has(_)) return a.get(_);
            let R = new Promise((B, Y) => {
                let z = n.get(b);
                if (!z) {
                    let N = { country: p, locale: v, offerSelectorIds: [] };
                    p !== 'GB' && !f && (N.language = u),
                        (z = { options: N, promises: new Map() }),
                        n.set(b, z);
                }
                x && (z.options.promotionCode = x),
                    z.options.offerSelectorIds.push(w),
                    z.promises.set(w, { resolve: B, reject: Y }),
                    l();
            }).catch((B) => {
    ...
    return {
        ...
        Term: ae,
        applyPlanType: Jt,
        resolveOfferSelectors: h,
        flushWcsCacheInternal: m,
        prefillWcsCache: d,
    };
}
var io = 'mas-commerce-service',
    ao = 'mas-commerce-service:start',
    no = 'mas-commerce-service:ready',
    Rt,
    rt,
    it,
    oo,
    ...
    Bi = class extends HTMLElement {
        ...
        async registerCheckoutAction(r) {
            typeof r == 'function' &&
                (this.buildCheckoutAction = async (i, a, n) => {
                    let o = await r?.(i, a, this.imsSignedInPromise, n);
                    return o || null;
                });
        }
        get featureFlags() {
            return (
                A(this, rt) ||
                    V(this, rt, { [ue]: Bt(this, it, so).call(this, ue) }),
                A(this, rt)
            );
        }
        activate() {
            let r = A(this, it, oo),
                i = eo(r, this);
            rr(r.lana);
            let a = oe.init(r.hostEnv).module('service');
            a.debug('Activating:', r);
            let o = { price: on(i) },
            ...
            Object.defineProperties(
                ...
                a.debug('Activated:', { literals: o, settings: i });
            let l = new CustomEvent(Ut, {
                bubbles: !0,
                cancelable: !1,
                detail: this,
            });
            performance.mark(no),
                V(this, Rt, performance.measure(no, ao)),
        ...
        connectedCallback() {
            performance.mark(ao), this.activate();
        }
        flushWcsCache() {
        ...
        get duration() {
            return { 'mas-commerce-service:measure': Ft(A(this, Rt)) };
        }
        logFailedRequests() {
            let r = [...performance.getEntriesByType('resource')]
                    .filter(({ startTime: a }) => a > this.lastLoggingTime)
                    .filter(
                        ({ transferSize: a, duration: n, responseStatus: o }) =>
                            (a === 0 && n === 0 && o < 200) || o >= 400,
                    ),
                i = Array.from(new Map(r.map((a) => [a.name, a])).values());
            if (
                i.some(({ name: a }) =>
                    /(\/fragment\?|web_commerce_artifact)/.test(a),
                )
            ) {
                let a = i.map(({ name: n }) => n);
...
(Rt = new WeakMap()),
    ...
    (oo = function () {
        ...
        return (
            ['locale', 'country', 'language', 'preview'].forEach((a) => {
            ...
            [
                ...
                let n = this.getAttribute(a);
                if (n != null) {
                    let o = a.replace(/-([a-z])/g, (s) => s[1].toUpperCase());
                    i.commerce[o] = n;
                }
            }),
            i
...
window.customElements.get(io) || window.customElements.define(io, Bi);
var ho = 'merch-card-collection',
    Xc = 2e4,
    Kc = {
    ...
    at = class extends lo {
        ...
        updated(r) {
            ...
            let n = this.sort === le.alphabetical ? el : tl,
                s = [Zc, Jc, rl, n]
                    .reduce((l, d) => d(l, this), a)
                    .map((l, d) => [l, d]);
            if (((this.resultCount = s.length), this.page && this.limit)) {
                let l = this.page * this.limit;
                (this.hasMore = s.length > l), (s = s.filter(([, d]) => d < l));
            }
                ...
                this.updateComplete.then(() => {
                    this.dispatchLiteralsChanged(),
                        this.sidenav &&
                            ...
                            (this.sidenav.addEventListener(Sr, () => {
                                this.dispatchLiteralsChanged();
                            }),
        ...
        connectedCallback() {
            super.connectedCallback(),
                V(this, nt, ut()),
                A(this, nt) && V(this, Ot, A(this, nt).Log.module(ho)),
                V(this, It, customElements.get('merch-card')),
        ...
        initializeHeader() {
            ...
            (r.collection = this),
                ...
                (this.header = r),
                this.querySelectorAll('[placeholder]').forEach((a) => {
                    let n = a.getAttribute('slot');
                    this.header.placeholderKeys.includes(n) &&
        ...
        initializePlaceholders() {
            ...
            !r.searchText &&
                ...
                (r.searchText = this.data.sidenavSettings.searchText);
            for (let i of Object.keys(r)) {
                let a = r[i],
                    n = a.includes('<p>') ? 'div' : 'p',
        ...
        attachSidenav(r, i = !0) {
            ...
            i && this.parentElement.prepend(r),
                ...
                Qc[this.variant] && this.sidenav.setAttribute('autoclose', ''),
                this.initializeHeader(),
                this.dispatchEvent(new CustomEvent(dt));
            let a = A(this, It)?.getCollectionOptions(
                this.variant,
            )?.onSidenavAttached;
            a && a(this);
        }
        async hydrate() {
            ...
            function n(o, s) {
                let c;
                o.fields?.checkboxGroups
                    ? (c = o.fields.checkboxGroups)
                    : o.fields?.tagFilters &&
                      (c = [
                          {
                              title: o.fields?.tagFiltersTitle,
                              label: 'types',
                              deeplink: 'types',
                              checkboxes: o.fields.tagFilters.map((h) => {
                                  let p = h.split('/').pop(),
                                      u = o.settings?.tagLabels?.[p] || p;
                                  return (
                                      (u = u.startsWith('coll-tag-filter')
                ...
                let l = {
                        searchText: o.fields?.searchText,
                        tagFilters: c,
                        linksTitle: o.fields?.linksTitle,
                        link: o.fields?.link,
                        linkText: o.fields?.linkText,
                        linkIcon: o.fields?.linkIcon,
                    },
                    d = {
                        cards: [],
                        hierarchy: [],
                    ...
                    for (let u of p) {
                        if (u.fieldName === 'cards') {
                            if (
                                ...
                                continue;
                            d.cards.push(o.references[u.identifier].value);
                            continue;
                        }
                        let f = o.references[u.identifier]?.value;
                        if (!f?.fields) continue;
                        let { fields: x } = f,
                            C = {
                                label: x.label || '',
                                icon: x.icon,
                                iconLight: x.iconLight,
                                queryLabel: x.queryLabel,
                                cards: x.cards
                                    ? x.cards.map((v) => s[v] || v)
                                    : [],
                                collections: [],
                        ...
                        x.defaultchild &&
                            (C.defaultchild =
                                s[x.defaultchild] || x.defaultchild),
                            h.push(C),
                            m(C.collections, u.referencesTree);
                    }
                }
                return (
                    m(d.hierarchy, o.referencesTree),
                    d.hierarchy.length === 0 && (a.filtered = 'all'),
                    d
                );
            }
            r.addEventListener(_r, (o) => {
                Bt(this, fr, mo).call(
                    this,
                ...
                r.addEventListener(Tr, async (o) => {
                    (this.limit = 27), (this.data = n(o.detail, A(this, Te)));
                    let { cards: s, hierarchy: c } = this.data,
                        l =
                            c.length === 0 && o.detail.fields?.defaultchild
                                ? A(this, Te)[o.detail.fields.defaultchild] ||
                    ...
                    let d = (p, u) => {
                        for (let f of p)
                            if (
                                f.defaultchild === u ||
                                (f.collections && d(f.collections, u))
                            )
                                return !0;
                        return !1;
                    };
                    for (let p of s) {
                        let v = function (w) {
                            ...
                            u = document.createElement('merch-card'),
                            f = A(this, Te)[p.id] || p.id;
                        u.setAttribute('consonant', ''),
                            u.setAttribute('style', '');
                        let x = p.fields.tags
                            ?.filter((w) => w.startsWith('mas:types/'))
                            .map((w) => w.split('/')[1])
                            .join(',');
                        x && u.setAttribute('types', x),
                            $t(p.fields.variant)?.supportsDefaultChild &&
                                (l ? f === l : d(c, f)) &&
                                u.setAttribute('data-default-card', 'true'),
                            v(c);
                        let b = document.createElement('aem-fragment');
                        b.setAttribute('fragment', f),
                            u.append(b),
                    ...
                    let m = '',
                        h = Ha(s[0]?.fields?.variant);
                    (this.variant = h),
                        h === 'plans' &&
                            s.length === 3 &&
                            !s.some((p) => p.fields?.size?.includes('wide')) &&
                            (m = 'ThreeColumns'),
                        h &&
                            this.classList.add(
        ...
        sortChanged(r) {
            r.target.value === le.authored
                ? lt({ sort: void 0 })
                : lt({ sort: r.target.value }),
                this.dispatchEvent(
                    new CustomEvent(wr, {
                        bubbles: !0,
                        composed: !0,
        ...
        async showMore() {
            this.dispatchEvent(
                new CustomEvent(Ar, { bubbles: !0, composed: !0 }),
            );
            let r = this.page + 1;
            lt({ page: r }), (this.page = r), await this.updateComplete;
        }
        startDeeplink() {
            this.stopDeeplink = ji(
                ({
                    category: r,
                    filter: i,
                    types: a,
...
(Te = new WeakMap()),
    ...
    (fr = new WeakSet()),
    (mo = function (r, i = {}, a = !0) {
        A(this, Ot).error(`merch-card-collection: ${r}`, i),
            (this.failed = !0),
            a &&
                this.dispatchEvent(
                    new CustomEvent(Cr, {
...
var il = {
    ...
    al = (e, t, r) => {
        e.querySelectorAll(`[data-placeholder="${t}"]`).forEach((a) => {
            a.innerText = r || '';
        });
    },
    nl = {
    ...
    Nt = class extends lo {
        constructor() {
            ...
            $(this, te);
            $(this, ot);
            g(this, 'tablet', new ct(this, I));
            g(this, 'desktop', new ct(this, P));
        ...
        connectedCallback() {
            super.connectedCallback(),
                this.collection?.addEventListener(se, this.updateLiterals),
                this.collection?.addEventListener(
                    dt,
                    this.handleSidenavAttached,
                ),
                V(this, ot, customElements.get('merch-card'));
        }
        disconnectedCallback() {
            super.disconnectedCallback(),
                this.collection?.removeEventListener(se, this.updateLiterals),
        ...
        willUpdate() {
            (A(this, te).search = this.getVisibility('search')),
                (A(this, te).filter = this.getVisibility('filter')),
                (A(this, te).sort = this.getVisibility('sort')),
                (A(this, te).result = this.getVisibility('result')),
                (A(this, te).custom = this.getVisibility('custom'));
        }
        parseVisibilityOptions(r, i) {
            ...
            return a === !1
                ...
                : a === !0
                  ? !0
                  : a.includes(this.currentMedia);
        }
        getVisibility(r) {
            let i = A(this, ot)?.getCollectionOptions(
                    this.collection?.variant,
                )?.headerVisibility,
                a = this.parseVisibilityOptions(i, r);
            return a !== null ? a : this.parseVisibilityOptions(nl, r);
        }
        get sidenav() {
        ...
        get searchAction() {
            if (!A(this, te).search) return de;
            let r = mt(this, 'searchText');
            return r
                ? ve`
        ...
        get sortAction() {
            if (!A(this, te).sort) return de;
            let r = mt(this, 'sortText');
            if (!r) return;
            let i = mt(this, 'popularityText'),
                a = mt(this, 'alphabeticallyText');
            if (!(i && a)) return;
            let n = this.collection?.sort === le.alphabetical;
            return ve`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        get resultSlotName() {
            ...
            return il[r][Math.min(this.resultCount, 2)];
        }
        get resultLabel() {
            if (!A(this, te).result) return de;
            if (!this.sidenav) return de;
        ...
        get customArea() {
            if (!A(this, te).custom) return de;
            let r = A(this, ot)?.getCollectionOptions(
                this.collection?.variant,
            )?.customHeaderArea;
            if (!r) return de;
            ...
            return !i || i === de
                ? de
                : ve`<div id="custom" role="heading" aria-level="2">
            ${i}
        </div>`;
        }
        openFilters(r) {
...
customElements.define('merch-card-collection-header', Nt);
export { at as MerchCardCollection, Nt as default };

var sa=Object.defineProperty;var ca=e=>{throw TypeError(e)};var ts=(e,r,t)=>r in e?sa(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var rs=(e,r)=>{for(var t in r)sa(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>ts(e,typeof r!="symbol"?r+"":r,t),kr=(e,r,t)=>r.has(e)||ca("Cannot "+t);var b=(e,r,t)=>(kr(e,r,"read from private field"),t?t.call(e):r.get(e)),U=(e,r,t)=>r.has(e)?ca("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),N=(e,r,t,i)=>(kr(e,r,"write to private field"),i?i.call(e,t):r.set(e,t),t),bt=(e,r,t)=>(kr(e,r,"access private method"),t);import{html as Ce,LitElement as qo,css as Vo,unsafeCSS as Go,nothing as me}from"./lit-all.min.js";var I="(max-width: 767px)",X="(max-width: 1199px)",D="(min-width: 768px)",T="(min-width: 1200px)",Z="(min-width: 1600px)",la={matchMobile:window.matchMedia(I),matchDesktop:window.matchMedia(`${T} and (not ${Z})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(Z),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},C=la;function Yt(){return la.isDesktop}var yt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var da="hashchange";function is(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let i of t){let[a,n=""]=i.split("=");a&&r.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function wt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([a,n])=>{n?r.set(a,n):r.delete(a)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,i)}function ha(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=is(window.location.hash);e(t)};return r(),window.addEventListener(da,r),()=>{window.removeEventListener(da,r)}}var ri={};rs(ri,{CLASS_NAME_FAILED:()=>Fr,CLASS_NAME_HIDDEN:()=>ns,CLASS_NAME_PENDING:()=>Ur,CLASS_NAME_RESOLVED:()=>$r,CheckoutWorkflow:()=>ys,CheckoutWorkflowStep:()=>ee,Commitment:()=>Ie,ERROR_MESSAGE_BAD_REQUEST:()=>Gr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>vs,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>qr,EVENT_AEM_ERROR:()=>Hr,EVENT_AEM_LOAD:()=>zr,EVENT_MAS_ERROR:()=>Br,EVENT_MAS_READY:()=>fs,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>us,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Nr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>de,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Ir,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Et,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Or,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>ms,EVENT_MERCH_OFFER_READY:()=>cs,EVENT_MERCH_OFFER_SELECT_READY:()=>ls,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ue,EVENT_MERCH_SEARCH_CHANGE:()=>gs,EVENT_MERCH_SIDENAV_SELECT:()=>Dr,EVENT_MERCH_STOCK_CHANGE:()=>hs,EVENT_MERCH_STORAGE_CHANGE:()=>ps,EVENT_OFFER_SELECTED:()=>ds,EVENT_TYPE_FAILED:()=>Vr,EVENT_TYPE_READY:()=>Xt,EVENT_TYPE_RESOLVED:()=>Ke,Env:()=>ge,FF_ANNUAL_PRICE:()=>Ze,FF_DEFAULTS:()=>we,HEADER_X_REQUEST_ID:()=>At,LOG_NAMESPACE:()=>jr,Landscape:()=>Pe,MARK_DURATION_SUFFIX:()=>ei,MARK_START_SUFFIX:()=>Jr,MERCH_CARD_LOAD_TIMEOUT:()=>Mr,MODAL_TYPE_3_IN_1:()=>De,NAMESPACE:()=>as,PARAM_AOS_API_KEY:()=>xs,PARAM_ENV:()=>Yr,PARAM_LANDSCAPE:()=>Xr,PARAM_MAS_PREVIEW:()=>Wr,PARAM_WCS_API_KEY:()=>bs,PROVIDER_ENVIRONMENT:()=>Qr,SELECTOR_MAS_CHECKOUT_LINK:()=>pa,SELECTOR_MAS_ELEMENT:()=>Rr,SELECTOR_MAS_INLINE_PRICE:()=>j,SELECTOR_MAS_SP_BUTTON:()=>ss,SELECTOR_MAS_UPT_LINK:()=>ma,SORT_ORDER:()=>pe,STATE_FAILED:()=>he,STATE_PENDING:()=>_e,STATE_RESOLVED:()=>ye,SUPPORTED_COUNTRIES:()=>ti,TAG_NAME_SERVICE:()=>os,TEMPLATE_PRICE:()=>ws,TEMPLATE_PRICE_ANNUAL:()=>As,TEMPLATE_PRICE_LEGAL:()=>ne,TEMPLATE_PRICE_STRIKETHROUGH:()=>Es,Term:()=>ce,WCS_PROD_URL:()=>Kr,WCS_STAGE_URL:()=>Zr});var Ie=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ce=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),as="merch",Mr=2e4,ns="hidden",Xt="wcms:commerce:ready",os="mas-commerce-service",j='span[is="inline-price"][data-wcs-osi]',pa='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',ss="sp-button[data-wcs-osi]",ma='a[is="upt-link"]',Rr=`${j},${pa},${ma}`,cs="merch-offer:ready",ls="merch-offer-select:ready",Nr="merch-card:action-menu-toggle",ds="merch-offer:selected",hs="merch-stock:change",ps="merch-storage:change",ue="merch-quantity-selector:change",ms="merch-card-quantity:change",us="merch-modal:addon-and-quantity-update",gs="merch-search:change",Or="merch-card-collection:sort",de="merch-card-collection:literals-changed",Et="merch-card-collection:sidenav-attached",Ir="merch-card-collection:showmore",Dr="merch-sidenav:select",zr="aem:load",Hr="aem:error",fs="mas:ready",Br="mas:error",Fr="placeholder-failed",Ur="placeholder-pending",$r="placeholder-resolved",Gr="Bad WCS request",qr="Commerce offer not found",vs="Literals URL not provided",Vr="mas:failed",Ke="mas:resolved",jr="mas/commerce",Wr="mas.preview",Yr="commerce.env",Xr="commerce.landscape",xs="commerce.aosKey",bs="commerce.wcsKey",Kr="https://www.adobe.com/web_commerce_artifact",Zr="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",_e="pending",ye="resolved",Pe={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},At="X-Request-Id",ee=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),ys="UCv3",ge=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Qr={PRODUCTION:"PRODUCTION"},De={TWP:"twp",D2P:"d2p",CRM:"crm"},Jr=":start",ei=":duration",ws="price",Es="price-strikethrough",As="annual",ne="legal",we="mas-ff-defaults",Ze="mas-ff-annual-price",pe={alphabetical:"alphabetical",authored:"authored"},ti=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Ss="mas-commerce-service";function ua(e,r){let t;return function(){let i=this,a=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(i,a),r)}}var St=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function fe(e,r={},t=null,i=null){let a=i?document.createElement(e,{is:i}):document.createElement(e);t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t;for(let[n,o]of Object.entries(r))a.setAttribute(n,o);return a}function Kt(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function ii(){return window.matchMedia("(max-width: 1024px)").matches}function Tt(){return document.getElementsByTagName(Ss)?.[0]}function Ct(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}import{html as Zt,nothing as Ts}from"./lit-all.min.js";var Qe,_t=class _t{constructor(r){g(this,"card");U(this,Qe);this.card=r,this.insertVariantStyle()}getContainer(){return N(this,Qe,b(this,Qe)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),b(this,Qe)}insertVariantStyle(){let r=this.constructor.name;if(!_t.styleMap[r]){_t.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let i=this.card.variant,a=Array.from(t.querySelectorAll(`merch-card[variant="${i}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${i}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of a){let s=o.getBoundingClientRect();if(s.width<=2)continue;let l=Math.round(s.top),c=n.get(l);c||(c=[],n.set(l,c)),c.push(o)}for(let o of n.values())for(let{name:s,getElement:l}of r){let c=`--consonant-merch-card-${i}-${s}-height`,d=0,p=[];for(let m of o){m.style.removeProperty(c);let h=l(m);if(!h){p.push({card:m,height:0});continue}let u=Math.max(0,parseInt(window.getComputedStyle(h).height)||0);p.push({card:m,height:u}),u>d&&(d=u)}if(!(d<=0))for(let{card:m}of p)m.style.setProperty(c,`${d}px`)}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Zt`
            <div
                id="badge"
...
`;var Jt=class extends _{constructor(r){super(r)}getGlobalCSS(){return ba}renderLayout(){return ya` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Ls=32,Aa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},et=class extends _{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Le`<slot name="secure-transaction-label">
    ...
    `);import{html as er,css as ks,unsafeCSS as Ta,nothing as Ms}from"./lit-all.min.js";var Sa=`
  :root {
...
`;var Rs=32,Ca={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},tt=class extends _{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>er` <footer>
    ...
    `);import{html as Lt,css as Ns,nothing as tr}from"./lit-all.min.js";var _a=`
:root {
...
`;var Oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},be,rt=class extends _{constructor(t){super(t);U(this,be);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Na}priceOptionsProvider(t,i){t.dataset.template===ne&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return ni` ${this.badge}
    ...
    `);import{html as oi,css as Ds}from"./lit-all.min.js";var Ia=`
:root {
...
`;var Ha={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},at=class extends _{constructor(r){super(r)}getGlobalCSS(){return za}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return zs`
    ...
    `);import{html as si,css as Bs}from"./lit-all.min.js";var Ba=`
:root {
...
`;var li={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},st=class extends _{getGlobalCSS(){return $a}get aemFragmentMapping(){return li}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ga`
    ...
    `);import{html as di,css as Gs,nothing as qs}from"./lit-all.min.js";var qa=`

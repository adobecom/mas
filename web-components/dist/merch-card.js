var Qt=Object.defineProperty;var Xt=i=>{throw TypeError(i)};var vi=(i,t,e)=>t in i?Qt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var bi=(i,t)=>()=>(i&&(t=i(i=0)),t);var yi=(i,t)=>{for(var e in t)Qt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>vi(i,typeof t!="symbol"?t+"":t,e),Et=(i,t,e)=>t.has(i)||Xt("Cannot "+e);var c=(i,t,e)=>(Et(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Xt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),m=(i,t,e,r)=>(Et(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),S=(i,t,e)=>(Et(i,t,"access private method"),e);var Zt=(i,t,e,r)=>({set _(a){m(i,t,a,e)},get _(){return c(i,t,r)}});var kt={};yi(kt,{default:()=>De});import{LitElement as wi,html as et,css as Ei}from"./lit-all.min.js";function ki(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var L,De,St=bi(()=>{L=class L extends wi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();L.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}showTooltip(){L.activeTooltip&&L.activeTooltip!==this&&(L.activeTooltip.closeOverlay(),L.activeTooltip.tooltipVisible=!1,L.activeTooltip.requestUpdate()),L.activeTooltip=this,this.tooltipVisible=!0}hideTooltip(){L.activeTooltip===this&&(L.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?et`<merch-icon
    ...
    `);De=L;customElements.define("mas-mnemonic",De)});import{LitElement as Qa}from"./lit-all.min.js";import{css as tr,unsafeCSS as er}from"./lit-all.min.js";var v="(max-width: 767px)",M="(max-width: 1199px)",b="(min-width: 768px)",u="(min-width: 1200px)",A="(min-width: 1600px)",Jt={matchMobile:window.matchMedia(v),matchDesktop:window.matchMedia(`${u} and (not ${A})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(A),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},f=Jt;function Je(){return Jt.isDesktop}var rr=tr`
    :host {
...
`,ir=()=>[tr`
        ...
        `];import{LitElement as Si,html as ar,css as Ci}from"./lit-all.min.js";function Ai(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var pe=class extends Si{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Ai())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>St())}e.remove()})}render(){let{href:t}=this;return t?ar`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};l(pe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(pe,"styles",Ci`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as qe}from"./lit-all.min.js";var yr=`
:root {
...
`;var ct=class extends x{constructor(t){super(t)}getGlobalCSS(){return yr}renderLayout(){return qe`${this.cardImage}
            <div class="body">
...
`;var Di=32,we=class extends x{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ye`<slot name="secure-transaction-label">
    ...
    `);import{html as Ue,css as $i,nothing as dt}from"./lit-all.min.js";var Cr=`
:root {
...
`;document.head.appendChild(Ur);function gt(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Ot(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Ot(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Yi(Ot(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Wi=i=>typeof i=="boolean",ut=i=>typeof i=="function";var Ot=i=>typeof i=="string";function jr(i,t){if(Wi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Yi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var re=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(tt);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var ie={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Gr=1e3;function Ki(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Vr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!ie.serializableTypes.includes(e))return e}return i}function Qi(i,t){if(!ie.ignoredProperties.includes(i))return Vr(t)}var Dt={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(p=>{p!=null&&(Ki(p)?r:a).push(p)}),r.length&&(n+=" "+r.map(Vr).join(" "));let{pathname:o,search:s}=window.location,d=`${ie.delimiter}page=${o}${s}`;d.length>Gr&&(d=`${d.slice(0,Gr)}<trunc>`),n+=d,a.length&&(n+=`${ie.delimiter}facts=`,n+=JSON.stringify(a,Qi)),window.lana?.log(n,ie)}};function Wr(i){Object.assign(ie,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in ie&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Yr={LOCAL:"local",PROD:"prod",STAGE:"stage"},$t={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Nt=new Set,Ft=new Set,Kr=new Map,Qr={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},Xr={filter:({level:i})=>i!==$t.DEBUG},Xi={filter:()=>!1};function Zi(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&ut(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function Ji(i){[...Ft].every(t=>t(i))&&Nt.forEach(t=>t(i))}function Zr(i){let t=(Kr.get(i)??0)+1;Kr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>Zr(`${r.namespace}/${a}`),updateConfig:Wr};return Object.values($t).forEach(a=>{r[a]=(n,...o)=>Ji(Zi(a,n,i,o,e))}),Object.seal(r)}function ft(...i){i.forEach(t=>{let{append:e,filter:r}=t;ut(r)&&Ft.add(r),ut(e)&&Nt.add(e)})}function ea(i={}){let{name:t}=i,e=jr(gt("commerce.debug",{search:!0,storage:!0}),t===Yr.LOCAL);return ft(e?Qr:Xr),t===Yr.PROD&&ft(Dt),je}function ta(){Nt.clear(),Ft.clear()}var je={...Zr(ur),Level:$t,Plugins:{consoleAppender:Qr,debugFilter:Xr,quietFilter:Xi,lanaAppender:Dt},init:ea,reset:ta,use:ft};var ra="mas-commerce-service",Us=je.module("utilities"),ia={requestId:tt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var xt=i=>window.setTimeout(i);function It(){return document.getElementsByTagName(ra)?.[0]}function Jr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(ia)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function ei(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var ti="fragment",ri="author",ii="preview",ai="loading",ni="timeout",Bt="aem-fragment",oi="eager",si="cache",aa=[oi,si],D,ae,$,Q,Ht=class{constructor(){g(this,D,new Map);g(this,ae,new Map);g(this,$,new Map);g(this,Q,new Map)}clear(){c(this,D).clear(),c(this,ae).clear(),c(this,$).clear(),c(this,Q).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,D).set(t.id,t),t.fields?.originalId&&c(this,D).set(t.fields.originalId,t),c(this,$).has(t.id)){let[,r]=c(this,$).get(t.id);r()}if(c(this,$).has(t.fields?.originalId)){let[,r]=c(this,$).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,D).has(t)}entries(){return c(this,D).entries()}get(t){return c(this,D).get(t)}getAsPromise(t){let[e]=c(this,$).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,$).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ae).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ae).set(t,e)),e}remove(t){c(this,D).delete(t),c(this,ae).delete(t),c(this,$).delete(t),c(this,Q).delete(t)}getOrFetch(t,e){let r=c(this,D).get(t);if(r)return Promise.resolve(r);let a=c(this,Q).get(t);if(a)return a;let n=e().finally(()=>{c(this,Q).delete(t)});return c(this,Q).set(t,n),n}};D=new WeakMap,ae=new WeakMap,$=new WeakMap,Q=new WeakMap;var U=new Ht,Le,I,j,R,T,k,Ge,Ve,N,We,Ye,ze,F,ci,li,qt,di,vt=class extends HTMLElement{constructor(){super(...arguments);g(this,F);l(this,"cache",U);g(this,Le);g(this,I,null);g(this,j,null);g(this,R,null);g(this,T);g(this,k);g(this,Ge,oi);g(this,Ve,5e3);g(this,N);g(this,We,!1);g(this,Ye,0);g(this,ze)}static get observedAttributes(){return[ti,ai,ni,ri,ii]}attributeChangedCallback(e,r,a){e===ti&&(m(this,T,a),m(this,k,U.getFetchInfo(a))),e===ai&&aa.includes(a)&&m(this,Ge,a),e===ni&&m(this,Ve,parseInt(a,10)),e===ri&&m(this,We,["","true"].includes(a)),e===ii&&m(this,ze,a)}connectedCallback(){if(!c(this,N)){if(c(this,R)??m(this,R,ee(this)),m(this,ze,c(this,R).settings?.preview),c(this,Le)??m(this,Le,c(this,R).log.module(`${Bt}[${c(this,T)}]`)),!c(this,T)||c(this,T)==="#"){c(this,k)??m(this,k,U.getFetchInfo("missing-fragment-id")),S(this,F,qt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,N)&&!await Promise.race([c(this,N),Promise.resolve(!1)]))return;e&&U.remove(c(this,T)),c(this,Ge)===si&&await Promise.race([U.getAsPromise(c(this,T)),new Promise(s=>setTimeout(s,c(this,Ve)))]);try{m(this,N,S(this,F,di).call(this)),await c(this,N)}catch(s){return S(this,F,qt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,I)||{};return o&&!gt("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(me,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,N)}get updateComplete(){return c(this,N)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,j)?c(this,j):(c(this,We)?this.transformAuthorData():this.transformPublishData(),c(this,j))}get rawData(){return c(this,I)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);m(this,j,e.reduce((p,{name:h,multiple:y,values:P})=>(p.fields[h]=y?P:P[0],p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);m(this,j,Object.entries(e).reduce((p,[h,y])=>(p.fields[h]=y?.mimeType?y.value:y??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,T),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};Le=new WeakMap,I=new WeakMap,j=new WeakMap,R=new WeakMap,T=new WeakMap,k=new WeakMap,Ge=new WeakMap,Ve=new WeakMap,N=new WeakMap,We=new WeakMap,Ye=new WeakMap,ze=new WeakMap,F=new WeakSet,ci=async function(e){Zt(this,Ye)._++;let r=`${Bt}:${c(this,T)}:${c(this,Ye)}`,a=`${r}${rt}`,n=`${r}${it}`;if(c(this,ze))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await ei(e,{cache:"default",credentials:"omit"}),S(this,F,li).call(this,o),c(this,k).status=o?.status,c(this,k).measure=ue(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new re("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,k).measure=ue(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,I))return c(this,k).stale=!0,c(this,Le).error("Serving stale data",c(this,k)),c(this,I);let d=s.message??"unknown";throw new re(`Failed to fetch fragment: ${d}`,{})}},li=function(e){Object.assign(c(this,k),Jr(e))},qt=function(e){m(this,N,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,R).duration};c(this,Le).error(e,r),this.dispatchEvent(new CustomEvent(ge,{detail:r,bubbles:!0,composed:!0}))},di=async function(){this.classList.remove("error"),m(this,j,null);let{masIOUrl:e,wcsApiKey:r,country:a,locale:n}=c(this,R).settings,o=`${e}/fragment?id=${c(this,T)}&api_key=${r}&locale=${n}`;a&&!n.endsWith(`_${a}`)&&(o+=`&country=${a}`),U.remove(c(this,T));let s=await U.getOrFetch(c(this,T),async()=>{var p;let d=await S(this,F,ci).call(this,o);return(p=d.fields).originalId??(p.originalId=c(this,T)),U.add(d),d});return m(this,I,s),!0},l(vt,"cache",U);customElements.define(Bt,vt);import{LitElement as na,html as Ut,css as oa,nothing as sa}from"./lit-all.min.js";import{unsafeHTML as ca}from"./lit-all.min.js";var la=i=>i?i.startsWith("sp-icon-")?Ut`${ca(`<${i} class="badge-icon"></${i}>`)}`:Ut`<img src="${i}" class="badge-icon" />`:sa,_e=class extends na{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Ut`<div class="badge">
            ${la(this.icon)}${this.text}
        </div>`}};l(_e,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),l(_e,"styles",oa`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",_e);import{html as da,css as pa,LitElement as ha}from"./lit-all.min.js";var Ke=class extends ha{constructor(){super()}render(){return da`
            <slot name="icon"></slot>

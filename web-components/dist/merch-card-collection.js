...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as zt,css as Ws}from"./lit-all.min.js";var Pa=`
:root {
...
`;var cr=class extends T{constructor(r){super(r)}getGlobalCSS(){return Ma}renderLayout(){return Ra` ${this.badge}
            ...
            ${this.card.customHr?"":Ra`<hr />`} ${this.secureLabelFooter}`}};import{html as Oe,css as Ys,unsafeCSS as Oa}from"./lit-all.min.js";var za=`
  :root {
...
`;var Qs=32,Ha={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},st=class extends T{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>lr` <footer>
    ...
    `);import{html as Ot,css as Js,nothing as dr}from"./lit-all.min.js";var Ba=`
:root {
...
`;var hr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Fa={...function(){let{whatsIncluded:e,size:r,...t}=hr;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Ua={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:i,...a}=hr;return a}()},be,ye,ae=class extends T{constructor(t){super(t);z(this,be);z(this,ye);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Ba}adjustSlotPlacement(t,i,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let l=n.querySelector(`footer slot[name="${t}"]`),c=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!i.includes(s)){if(o?.classList.toggle("wide-footer",k.isDesktopOrUp),!a&&l){if(c)l.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(l):d.appendChild(l)}return}if(a&&c){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!l){let m=c.cloneNode(!0);o.prepend(m)}c.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],k.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],k.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==t?t.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,be)||(_(this,be,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,be)?.disconnect(),_(this,be,null),this.syncHeights())})),v(this,be).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(i=>({name:i,getElement:a=>a.querySelector(`[slot="${i}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),i.insertBefore(o,n);let s=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let c=0,d=this.card.querySelector('[slot="heading-s"]');d&&(c+=Mt(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(c+=Mt(p));let m=this.card.querySelector('[slot="heading-m"]');m&&(c+=8+Mt(m));for(let u of i.childNodes){if(u.classList.contains("spacer"))break;c+=Mt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");c>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${c}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${c}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${V}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ot`<div class="divider"></div>`:dr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],i=this.card.querySelector(`[slot="heading-m"] ${V}[data-template="price"]`);i&&t.push(i);let a=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(t.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?Ot`<label id="stock-checkbox">
    ...
    `),g(ae,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ot`<slot name="resultsText"></slot>`:dr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let i=()=>{let a=t.querySelectorAll("merch-card");for(let o of a)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!k.isDesktop)return;let n=0;for(let o of a){if(o.style.display==="none")continue;let s=o.getAttribute("size"),l=s==="wide"?2:s==="super-wide"?3:1;l===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),l=1),n+=l}};k.matchDesktop.addEventListener("change",i),t.addEventListener(me,i),t.onUnmount.push(()=>{k.matchDesktop.removeEventListener("change",i),t.removeEventListener(me,i)})}});import{html as Ce,css as ec,unsafeCSS as Ga,nothing as pr}from"./lit-all.min.js";var $a=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(k.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?k.isMobile?Ce`
        ...
        `:Ce`
            ...
            `:pr}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?Ce`<slot name="icons"></slot>`:pr}get secureLabelFooter(){return Ce`<footer>
            ...
            <slot></slot>`}};g(Ne,"variantStyle",ec`
...
`;var[Gh,qh,ja,Wa,Ya,Xa]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Ka={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},Te,we,qe,W,Za,It,Qa,Dt,fi,mr,ur=class ur extends T{constructor(){super(...arguments);z(this,W);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);z(this,Te,null);z(this,we,null);z(this,qe,null);g(this,"handleResize",()=>{v(this,we)&&cancelAnimationFrame(v(this,we)),_(this,we,requestAnimationFrame(()=>{_(this,we,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))});g(this,"toggleExpanded",t=>{t.preventDefault();let i=!this.expanded;for(let a of Y(this,W,Za).call(this)){let n=a.variantLayout;n instanceof ur&&(n.expanded=i,a.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?Y(this,W,fi).call(this):Y(this,W,Dt).call(this),this.card.requestUpdate()});z(this,mr,t=>{let i=this.licenseOptions;if(!i?.length)return;let a=i.length-1;switch(t.key){case Wa:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%i.length:Y(this,W,Dt).call(this);break;case ja:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+i.length)%i.length:Y(this,W,Dt).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=a;break;case Ya:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(i[this.licenseHighlightedIndex]);return}Y(this,W,Dt).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),Y(this,W,fi).call(this);break;case Xa:this.licenseOpen&&this.selectLicenseQty(i[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,Y(this,W,It).call(this);let i=this.quantitySelectEl;i&&(i.selectedValue=Number(t),i.dispatchEvent(new CustomEvent(he,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return Va}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let i=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),i.dataset.displayPerUnit="false",t.parentNode.insertBefore(i,t.nextSibling),await i.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),i.addEventListener(Me,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let a=this.card.querySelector('[slot="heading-m"] [data-template="legal"]')?.querySelector(".price-plan-type");a&&(a.textContent=t)}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${V}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(t.planType=a)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights())}syncHeights(){this.card.getBoundingClientRect().width<=2||this.syncRowHeights([{name:"top-card",getElement:t=>t.shadowRoot?.querySelector(".top-card")}])}connectedCallbackHook(){window.addEventListener("resize",this.handleResize),_(this,qe,new IntersectionObserver(([t])=>{t.boundingClientRect.height!==0&&t.isIntersecting&&(window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>this.syncHeights()),v(this,qe)?.disconnect())})),v(this,qe).observe(this.card)}disconnectedCallbackHook(){Y(this,W,It).call(this),window.removeEventListener("resize",this.handleResize),v(this,we)&&(cancelAnimationFrame(v(this,we)),_(this,we,null)),v(this,qe)?.disconnect()}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let i=parseInt(t.getAttribute("min"),10),a=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(i)||Number.isNaN(a)||a<i)return null;let o=[];for(let s=i;s<=a;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(t){let i=this.quantitySelectEl?.getAttribute("title")||"License",[a,n]=i.split("|").map(o=>o.trim());return Number(t)===1?a:n||a}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let i=this.quantitySelectEl?.getAttribute("default-value");return i!=null&&t.includes(i)?i:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Ie`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,i=this.currentLicenseValue,a=!!this.licenseOpen,n=this.licenseLabel(Number(i));return Ie`
        ...
        `}renderLayout(){let t=!!this.expanded;return Ie`
            ...
            ${this.hasWhatsIncluded?Ie`
                  ...
                  `:Nt}
            <slot></slot>
        `}};Te=new WeakMap,we=new WeakMap,qe=new WeakMap,W=new WeakSet,Za=function(){let t=Math.round(this.card.getBoundingClientRect().top),i=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(a=>{let n=a.getBoundingClientRect();return n.width>2&&Math.round(n.top)===t});return i.length?i:[this.card]},It=function(){v(this,Te)&&(document.removeEventListener("mousedown",v(this,Te)),_(this,Te,null))},Qa=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},Dt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=Y(this,W,Qa).call(this),v(this,Te)||(_(this,Te,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),Y(this,W,It).call(this))}),document.addEventListener("mousedown",v(this,Te)))},fi=function(){this.licenseOpen=!1,Y(this,W,It).call(this)},mr=new WeakMap,g(ur,"variantStyle",tc`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Ht=ur;import{html as vi,css as rc}from"./lit-all.min.js";var Ja=`
:root {
...
`;var en={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ee,ct=class extends T{constructor(t){super(t);z(this,Ee);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ja}priceOptionsProvider(t,i){t.dataset.template===ee&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return vi` ${this.badge}
...
`;var sn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},ht=class extends T{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return on}renderLayout(){return bi`${this.cardImage}
            ...
            ${this.evergreen?bi`
                  ...
                  `:bi`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(ht,"variantStyle",oc`
...
`;var wi={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},mt=class extends T{getGlobalCSS(){return ln}get aemFragmentMapping(){return wi}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return dn`
    ...
    `);import{html as Ei,css as dc,nothing as hc}from"./lit-all.min.js";var hn=`
...
`,Qe.MISSING_INTL_API,o);var A=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[A]||d.options.other}if(!b)throw new aa(d.value,m,Object.keys(d.options),o);s.push.apply(s,Xt(b.value,r,t,i,a,m-(d.offset||0)));continue}}return ql(s)}function jl(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,i){return t[i]=P(P({},e[i]),r[i]||{}),t},{})):e}function Wl(e,r){return r?Object.keys(e).reduce(function(t,i){return t[i]=jl(e[i],r[i]),t},P({},e)):e}function na(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function Yl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Wt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.NumberFormat).bind.apply(r,_r([void 0],t,!1)))},{cache:na(e.number),strategy:Nr.variadic}),getDateTimeFormat:Wt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.DateTimeFormat).bind.apply(r,_r([void 0],t,!1)))},{cache:na(e.dateTime),strategy:Nr.variadic}),getPluralRules:Wt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.PluralRules).bind.apply(r,_r([void 0],t,!1)))},{cache:na(e.pluralRules),strategy:Nr.variadic})}}var Oo=function(){function e(r,t,i,a){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var l=s.reduce(function(c,d){return!c.length||d.type!==Q.literal||typeof c[c.length-1]!="string"?c.push(d.value):c[c.length-1]+=d.value,c},[]);return l.length<=1?l[0]||"":l},this.formatToParts=function(o){return Xt(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Wl(e.formats,i),this.formatters=a&&a.formatters||Yl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Po,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var No=Oo;var oa={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Xl=En("ConsonantTemplates/price"),Kl=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},He={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},sa="TAX_EXCLUSIVE",Zl=e=>bn(e)?Object.entries(e).filter(([,r])=>vt(r)||fr(r)||r===!0).reduce((r,[t,i])=>`${r} ${t}${i===!0?"":`="${xn(i)}"`}`,""):"",G=(e,r,t,i=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${Zl(t)}>${i?Yn(r):r??""}</span>`;function Ql(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function Jl(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function ke(e,r,t,i){let a=e[t];if(a==null)return"";let n=a.includes("<"),o=a.includes("<a ");try{a=o?Ql(a):a,a=n?a.replace(Kl,""):a;let s=new No(a,r).format(i);return o?Jl(s):s}catch{return Xl.error("Failed to format literal:",a),""}}function ed(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:l,recurrenceLabel:c,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=G($.currencySymbol,i),u=G($.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),l&&(f+=h+u),f+=G($.integer,s),f+=G($.decimalsDelimiter,n),f+=G($.decimals,a),l||(f+=u+h),f+=G($.recurrence,c,null,!0),f+=G($.unitType,d,null,!0),f+=G($.taxInclusivity,p,!0),G(e,f,{...m})}var K=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:l=!0,displayPerUnit:c=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:S,price:b,priceWithoutDiscount:A,taxDisplay:D,taxTerm:R,term:U,usePrecision:q,promotion:te}={},X={})=>{Object.entries({country:o,formatString:S,language:p,price:b}).forEach(([bs,ys])=>{if(ys==null)throw new Error(`Argument "${bs}" is missing for osi ${y?.toString()}, country ${o}, language ${p}`)});let F={...oa,...m},N=`${p.toLowerCase()}-${o.toUpperCase()}`,re;te&&!f&&A?re=e||i?b:A:t&&A?re=A:re=b;let le=r?Kn:Zn;a&&(le=Qn);let{accessiblePrice:tt,recurrenceTerm:ga,...fa}=le({commitment:x,formatString:S,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:A,price:r?b:re,promotion:te,quantity:h,term:U,usePrecision:q}),Hr="",Br="",Fr="";w(l)&&ga&&(Fr=ke(F,N,He.recurrenceLabel,{recurrenceTerm:ga}));let tr="";w(c)&&(u&&(tr+=" "),tr+=ke(F,N,He.perUnitLabel,{perUnit:"LICENSE"}));let rr="";w(d)&&R&&(u&&(rr+=" "),rr+=ke(F,N,D===sa?He.taxExclusiveLabel:He.taxInclusiveLabel,{taxTerm:R})),t&&(Hr=ke(F,N,He.strikethroughAriaLabel,{strikethroughPrice:Hr})),e&&(Br=ke(F,N,He.alternativePriceAriaLabel,{alternativePrice:Br}));let Fe=$.container;if(r&&(Fe+=` ${$.containerOptical}`),t&&(Fe+=` ${$.containerStrikethrough}`),i&&(Fe+=` ${$.containerPromoStrikethrough}`),e&&(Fe+=` ${$.containerAlternative}`),a&&(Fe+=` ${$.containerAnnual}`),w(s))return ed(Fe,{...fa,accessibleLabel:Hr,altAccessibleLabel:Br,recurrenceLabel:Fr,perUnitLabel:tr,taxInclusivityLabel:rr},X);let{currencySymbol:va,decimals:us,decimalsDelimiter:gs,hasCurrencySpace:xa,integer:fs,isCurrencyFirst:vs}=fa,rt=[fs,gs,us];vs?(rt.unshift(xa?"\xA0":""),rt.unshift(va)):(rt.push(xa?"\xA0":""),rt.push(va)),rt.push(Fr,tr,rr);let xs=rt.join("");return G(Fe,xs,X)},Io=()=>(e,r,t)=>{let i=Ke(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||i);return`${n?`${K({displayStrikethrough:!0})({isPromoApplied:i,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${K({isAlternativePrice:n})({isPromoApplied:i,...e},r,t)}`},Do=()=>(e,r,t)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=Ke(r.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return K()(e,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualPrefix," (")+K({displayAnnual:!0,instant:i})(n,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${K({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${K({isAlternativePrice:s})({isPromoApplied:a,...e},r,t)}${G($.containerAnnualPrefix," (")}${K({displayAnnual:!0,instant:i})(n,r,t)}${G($.containerAnnualSuffix,")")}`},Ho=()=>(e,r,t)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${K({isAlternativePrice:e.displayOldPrice})(e,r,t)}${G($.containerAnnualPrefix," (")}${K({displayAnnual:!0})(i,r,t)}${G($.containerAnnualSuffix,")")}`};var Kt={...$,containerLegal:"price-legal",planType:"price-plan-type"},Ir={...He,planTypeLabel:"planTypeLabel"};function td(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:i},a={},n=!0){let o="";return o+=G(Kt.unitType,r,null,!0),t&&i&&n&&(t+=". "),o+=G(Kt.taxInclusivity,t,!0),o+=G(Kt.planType,i,null),G(e,o,{...a})}var Bo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:i=!1,displayDot:a=!0,language:n,literals:o={}}={},{taxDisplay:s,taxTerm:l,planType:c}={},d={})=>{let p={...oa,...o},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";w(r)&&(h=ke(p,m,Ir.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),w(t)&&l&&(u=ke(p,m,s===sa?Ir.taxExclusiveLabel:Ir.taxInclusiveLabel,{taxTerm:l}));let f="";w(i)&&c&&(f=ke(p,m,Ir.planTypeLabel,{planType:c}));let x=Kt.container;return x+=` ${Kt.containerLegal}`,td(x,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,a)};var Fo=K(),Uo=Io(),$o=K({displayOptical:!0}),Go=K({displayStrikethrough:!0}),qo=K({displayPromoStrikethrough:!0}),Vo=K({displayAnnual:!0}),jo=K({displayOptical:!0,isAlternativePrice:!0}),Wo=K({isAlternativePrice:!0}),Yo=Ho(),Xo=Do(),Ko=Bo;var rd=(e,r)=>{if(!(!Bt(e)||!Bt(r)))return Math.floor((r-e)/r*100)},Zo=()=>(e,r)=>{let{price:t,priceWithoutDiscount:i}=r,a=rd(t,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var Qo=Zo();var Jo="INDIVIDUAL_COM",la="TEAM_COM",es="INDIVIDUAL_EDU",da="TEAM_EDU",id=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],ad={[Jo]:[],[la]:[],[es]:[],[da]:[]},nd={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},od=[Jo,la,es,da],sd=e=>[la,da].includes(e);function ca(e,r,t,i){if(e[r])return e[r];let a=`${r}_${t}`;if(e[a])return e[a];let n;if(i)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var cd=(e,r,t,i)=>{let a=`${t}_${i}`,n=ca(nd,e,r,!1);if(n){let o=od.indexOf(a);return n[o]}return sd(a)},ld=(e,r,t,i)=>{if(ca(id,e,r,!0))return!0;let a=ad[`${t}_${i}`];return a?ca(a,e,r,!0)?!0:M.displayTax:M.displayTax},ha=async(e,r,t,i)=>{let a=ld(e,r,t,i);return{displayTax:a,forceTaxExclusive:a?cd(e,r,t,i):M.forceTaxExclusive}},Zt=class Zt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new De(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let i=oe();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=i.collectPriceOptions(t);return Cr(Zt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ue}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let i=oe();if(!i)return!1;let a=i.collectPriceOptions(t,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=i.resolveOfferSelectors(n),l=await Promise.all(s),c=l.map(h=>{let u=Ut(h,n);return u?.length?u[0]:null});if(c.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=c,p=Fi(c);if(i.featureFlags[Ae]||n[Ae]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,x=await ha(h,u,p.customerSegment,f);a.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=l.map(y=>{let S=Ut(y,n);return S?.length?S[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(i.featureFlags[it]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=Fi(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,i,a=void 0){if(!this.isConnected)return;let n=oe();if(!n)return!1;if(a??(a=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(a,t,i)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(l=>{l.dataset.template!=="strikethrough"&&l.options&&!l.options.alternativePrice&&!l.isFailed&&(l.options.alternativePrice=!0,l.innerHTML=n.buildPriceHTML(t,l.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,o,this.options))return this.innerHTML="",!0}return!1}};g(Zt,"is","inline-price"),g(Zt,"tag","span");var Pe=Zt;window.customElements.get(Pe.is)||window.customElements.define(Pe.is,Pe,{extends:Pe.tag});function ts({literals:e,providers:r,settings:t}){function i(o,s=null){let l={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let R of r.price)R(s,l);let{displayOldPrice:c,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:y,quantity:S,alternativePrice:b,wcsOsi:A,...D}=Object.assign(l,s?.dataset??{},o??{});return l=vr(Object.assign({...l,...D,displayOldPrice:w(c),displayPerUnit:w(d),displayRecurrence:w(p),displayTax:w(m),displayPlanType:w(h),forceTaxExclusive:w(u),perpetual:w(f),displayAnnual:w(x),promotionCode:br(y).effectivePromoCode,quantity:xt(S,M.quantity),alternativePrice:w(b),wcsOsi:Ar(A)})),l}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:l}=s,c;switch(l){case"discount":c=Qo;break;case"strikethrough":c=Go;break;case"promo-strikethrough":c=qo;break;case"annual":c=Vo;break;case"legal":c=Ko;break;default:s.template==="optical"&&s.alternativePrice?c=jo:s.template==="optical"?c=$o:s.displayAnnual&&o[0].planType==="ABM"?c=s.promotionCode&&o[0].promotion?Xo:Yo:s.alternativePrice?c=Wo:c=s.promotionCode&&o[0].promotion?Uo:Fo}let[d]=o;return d={...d,...d.priceDetails},c({...t,...s},d)}let n=Pe.createInlinePrice;return{InlinePrice:Pe,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function dd({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||M.language),r??(r=e?.split("_")?.[1]||M.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function rs(e={},r){let t=r.featureFlags[Ae],{commerce:i={}}=e,a=ve.PRODUCTION,n=si,o=H("checkoutClientId",i)??M.checkoutClientId,s=Ft(H("checkoutWorkflowStep",i),ie,M.checkoutWorkflowStep),l=w(H("displayOldPrice",i),M.displayOldPrice),c=M.displayPerUnit,d=w(H("displayRecurrence",i),M.displayRecurrence),p=w(H("displayTax",i),M.displayTax),m=w(H("displayPlanType",i),M.displayPlanType),h=w(H("entitlement",i),M.entitlement),u=w(H("modal",i),M.modal),f=w(H("forceTaxExclusive",i),M.forceTaxExclusive),x=H("promotionCode",i)??M.promotionCode,y=xt(H("quantity",i)),S=H("wcsApiKey",i)??M.wcsApiKey,b=i?.env==="stage",A=ze.PUBLISHED;["true",""].includes(i.allowOverride)&&(b=(H(ni,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",A=Ft(H(oi,i),ze,A)),b&&(a=ve.STAGE,n=ci);let R=H(ai)??e.preview,U=typeof R<"u"&&R!=="off"&&R!=="false",q={};U&&(q={preview:U});let te=H("mas-io-url")??e.masIOUrl??`https://www${a===ve.STAGE?".stage":""}.adobe.com/mas/io`,X=H("preselect-plan")??void 0,F=H("instant")??e.instant;return{...dd(e),...q,displayOldPrice:l,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:c,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:M.extraOptions,modal:u,env:a,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:M.alternativePrice,wcsApiKey:S,wcsURL:n,landscape:A,masIOUrl:te,...X&&{preselectPlan:X},...F&&{instant:F}}}async function is(e,r={},t=2,i=100){let a;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,i*(n+1)))}throw a}var pa="wcs";function as({settings:e}){let r=ne.module(pa),{env:t,wcsApiKey:i}=e,a=new Map,n=new Map,o,s=new Map;async function l(u,f,x=!0){let y=oe(),S=ti;r.debug("Fetching:",u);let b="",A;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let D=new Map(f),[R]=u.offerSelectorIds,U=Date.now()+Math.random().toString(36).substring(2,7),q=`${pa}:${R}:${U}${di}`,te=`${pa}:${R}:${U}${hi}`,X;try{if(performance.mark(q),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",R),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===ve.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",i),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),A=await is(b.toString(),{credentials:"omit"}),A.ok){let F=[];try{let N=await A.json();r.debug("Fetched:",u,N),F=N.resolvedOffers??[]}catch(N){r.error(`Error parsing JSON: ${N.message}`,{...N.context,...y?.duration})}F=F.map(yr),f.forEach(({resolve:N},re)=>{let le=F.filter(({offerSelectorIds:tt})=>tt.includes(re)).flat();le.length&&(D.delete(re),f.delete(re),N(le))})}else S=ei}catch(F){S=`Network error: ${F.message}`}finally{X=performance.measure(te,q),performance.clearMarks(q),performance.clearMeasures(te)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=Nn(A);f.forEach(N=>{N.reject(new bt(S,{...u,...F,response:A,measure:nr(X),...y?.duration}))})}}function c(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>l(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ve.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,S]of Object.entries(x))a.set(y,Promise.resolve(S.map(yr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let u=a.size;s=new Map(a),a.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,x){let y=u!=="GB"&&!x?"MULT":"en",S=pi.includes(u)?u:M.country;return{validCountry:S,validLanguage:y,locale:`${f}_${S}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:S=[]}){let{validCountry:b,validLanguage:A,locale:D}=m(u,f,x),R=[b,A,y].filter(U=>U).join("-").toLowerCase();return S.map(U=>{let q=`${U}-${R}`;if(a.has(q))return a.get(q);let te=new Promise((X,F)=>{let N=n.get(R);N||(N={options:{country:b,locale:D,...A==="MULT"&&{language:A},offerSelectorIds:[]},promises:new Map},n.set(R,N)),y&&(N.options.promotionCode=y),N.options.offerSelectorIds.push(U),N.promises.set(U,{resolve:X,reject:F}),c()}).catch(X=>{if(s.has(q))return s.get(q);throw X});return a.set(q,te),te})}return{Commitment:Ue,PlanType:An,Term:de,applyPlanType:yr,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var ns="mas-commerce-service",os="mas-commerce-service:start",ss="mas-commerce-service:ready",Qt,wt,Je,cs,ua,ma=class extends HTMLElement{constructor(){super(...arguments);z(this,Je);z(this,Qt);z(this,wt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let o=await t?.(i,a,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,wt)||_(this,wt,{[Ae]:Y(this,Je,ua).call(this,Ae),[it]:Y(this,Je,ua).call(this,it)}),v(this,wt)}activate(){let t=v(this,Je,cs),i=rs(t,this);wr(t.lana);let a=ne.init(t.hostEnv).module("service");a.debug("Activating:",t);let o={price:so(i)},s={checkout:new Set,price:new Set},l={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...ao(l),...no(l),...ts(l),...as(l),...mi,Log:ne,resolvePriceTaxFlags:ha,get defaults(){return M},get log(){return ne},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:o,settings:i});let c=new CustomEvent(ar,{bubbles:!0,cancelable:!1,detail:this});performance.mark(ss),_(this,Qt,performance.measure(ss,os)),this.dispatchEvent(c),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(os),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Gr).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":nr(v(this,Qt))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:o})=>a===0&&n===0&&o<200||o>=400),i=Array.from(new Map(t.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Qt=new WeakMap,wt=new WeakMap,Je=new WeakSet,cs=function(){let t=this.getAttribute("env")??"prod",i={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=n}}),i},ua=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(ns)||window.customElements.define(ns,ma);var ps="merch-card-collection",hd=3e4,pd={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},md={plans:!0},ud=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),gd=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(i=>t.types.includes(i)))):e,fd=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),vd=(e,{filter:r})=>e.sort((t,i)=>i.filters[r]?.order==null||isNaN(i.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-i.filters[r].order),xd=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Be,St,et,er,Dr,ms,Et=class extends ds{constructor(){super();z(this,Dr);z(this,Be,{});z(this,St);z(this,et);z(this,er);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return Le` <slot></slot>
        ...
        </sp-button>`}sortChanged(t){t.target.value===ge.authored?Tt({sort:void 0}):Tt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(Vr,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(jr,{bubbles:!0,composed:!0}));let t=this.page+1;Tt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=Aa(({category:t,filter:i,types:a,sort:n,search:o,single_app:s,page:l})=>{i=i||t,!this.filtered&&i&&i!==this.filter&&setTimeout(()=>{Tt({page:void 0}),this.page=1},1),this.filtered||(this.filter=i??this.filter),this.types=a??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(l)||1})}openFilters(t){this.sidenav?.showModal(t)}};Be=new WeakMap,St=new WeakMap,et=new WeakMap,er=new WeakMap,Dr=new WeakSet,ms=function(t,i={},a=!0){v(this,et)?.error(`merch-card-collection: ${t}`,i),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(Kr,{detail:{...i,message:t},bubbles:!0,composed:!0}))},g(Et,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:ge.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(Et,"styles",hs`
        #footer {
            grid-column: 1 / -1;
    ...
    `);Et.SortOrder=ge;customElements.define(ps,Et);var bd={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},yd=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(a=>{a.innerText=t||""})},wd={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},Ed={catalog:"l"},se,At,Jt=class extends ds{constructor(){super();z(this,se);z(this,At);g(this,"tablet",new Ct(this,I));g(this,"desktop",new Ct(this,C));this.collection=null,_(this,se,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(me,this.updateLiterals),this.collection?.addEventListener(_t,this.handleSidenavAttached),_(this,At,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(me,this.updateLiterals),this.collection?.removeEventListener(_t,this.handleSidenavAttached)}willUpdate(){v(this,se).search=this.getVisibility("search"),v(this,se).filter=this.getVisibility("filter"),v(this,se).sort=this.getVisibility("sort"),v(this,se).result=this.getVisibility("result"),v(this,se).custom=this.getVisibility("custom")}parseVisibilityOptions(t,i){if(!t||!Object.hasOwn(t,i))return null;let a=t[i];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(t){let i=v(this,At)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(i,t);return a!==null?a:this.parseVisibilityOptions(wd,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,se).search)return fe;let t=Pt(this,"searchText");return t?Le`
        ...
        `:fe}get filterAction(){return v(this,se).filter?this.sidenav?Le`
            ...
            ></sp-action-button>
        `:fe:fe}get sortAction(){if(!v(this,se).sort)return fe;let t=Pt(this,"sortText");if(!t)return;let i=Pt(this,"popularityText"),a=Pt(this,"alphabeticallyText");if(!(i&&a))return;let n=this.collection?.sort===ge.alphabetical;return Le`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        </div>`}get customArea(){if(!v(this,se).custom)return fe;let t=v(this,At)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return fe;let i=t(this.collection);return!i||i===fe?fe:Le`<div id="custom" role="heading" aria-level="2">
            ${i}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(i=>{yd(this,i,t.detail[i])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return Le`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};se=new WeakMap,At=new WeakMap,g(Jt,"styles",hs`
        :host {

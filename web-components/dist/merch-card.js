...
`,yr=()=>[xr`
    ...
    `);customElements.define("merch-addon",Se);import{html as yt,nothing as ui}from"./lit-all.min.js";var Ce,Ze=class Ze{constructor(t){h(this,"card");f(this,Ce);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,Ce,s(this,Ce)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,Ce)}insertVariantStyle(){let t=this.constructor.name;if(!Ze.styleMap[t]){Ze.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let r=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${r}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of t){let c=`--consonant-merch-card-${r}-${o}-height`;e.style.getPropertyValue(c)&&e.style.removeProperty(c)}let n=new Map;for(let o of i){let c=o.getBoundingClientRect();if(c.width<=2)continue;let l=Math.round(c.top),d=n.get(l);d||(d=[],n.set(l,d)),d.push(o)}for(let o of n.values())for(let{name:c,getElement:l}of t){let d=`--consonant-merch-card-${r}-${c}-height`,p=0,g=[];for(let u of o){u.style.removeProperty(d);let C=l(u);if(!C){g.push({card:u,height:0});continue}let $=Math.max(0,parseInt(window.getComputedStyle(C).height)||0);g.push({card:u,height:$}),$>p&&(p=$)}if(!(p<=0))for(let{card:u}of g)u.style.setProperty(d,`${p}px`)}}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),yt`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return wt(this.card.variant)}};Ce=new WeakMap,h(Ze,"styleMap",{});var b=Ze;import{html as Ut,css as fi}from"./lit-all.min.js";var Nr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Je,css as vi}from"./lit-all.min.js";var Fr=`
:root {
...
`;var Ei=32,Vr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Le=class extends b{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>kt` <footer>
    ...
    `);import{html as et,css as ki,nothing as St}from"./lit-all.min.js";var Wr=`
:root {
...
`;var ea={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ze=class extends b{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Jr}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Gt` ${this.badge}
...
`;var ra={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Pe=class extends b{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===N&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ta}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${y}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return jt`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
Caused by: ${this.cause}`),e}};var de={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ya=1e3;function Ui(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function wa(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!de.serializableTypes.includes(e))return e}return a}function Gi(a,t){if(!de.ignoredProperties.includes(a))return wa(t)}var Jt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(d=>{d!=null&&(Ui(d)?r:i).push(d)}),r.length&&(n+=` ${r.map(wa).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${de.delimiter}page=${o}${c}`;l.length>ya&&(l=`${l.slice(0,ya)}<trunc>`),n+=l,i.length&&(n+=`${de.delimiter}facts=`,n+=JSON.stringify(i,Gi)),window.lana?.log(n,de)}};function Ea(a){Object.assign(de,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in de&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ka={LOCAL:"local",PROD:"prod",STAGE:"stage"},er={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},tr=new Set,rr=new Set,Sa=new Map,Ca={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},Aa={filter:({level:a})=>a!==er.DEBUG},ji={filter:()=>!1};function Vi(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&zt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Wi(a){[...rr].every(t=>t(a))&&tr.forEach(t=>t(a))}function Ta(a){let t=(Sa.get(a)??0)+1;Sa.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>Ta(`${r.namespace}/${i}`),updateConfig:Ea};return Object.values(er).forEach(i=>{r[i]=(n,...o)=>Wi(Vi(i,n,a,o,e))}),Object.seal(r)}function Pt(...a){a.forEach(t=>{let{append:e,filter:r}=t;zt(r)&&rr.add(r),zt(e)&&tr.add(e)})}function Ki(a={}){let{name:t}=a,e=ba(Lt("commerce.debug",{search:!0,storage:!0}),t===ka.LOCAL);return Pt(e?Ca:Aa),t===ka.PROD&&Pt(Jt),tt}function Yi(){tr.clear(),rr.clear()}var tt={...Ta(Mr),Level:er,Plugins:{consoleAppender:Ca,debugFilter:Aa,quietFilter:ji,lanaAppender:Jt},init:Ki,reset:Yi,use:Pt};var Qi="mas-commerce-service",El=tt.module("utilities"),Xi={requestId:ft,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var _t=a=>window.setTimeout(a);function ar(){return document.getElementsByTagName(Qi)?.[0]}function La(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Xi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function za(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var Pa="fragment",_a="author",Ma="preview",Ra="loading",Oa="timeout",ir="aem-fragment",Na="eager",Da="cache",Zi=[Na,Da],V,he,B,nr=class{constructor(){f(this,V,new Map);f(this,he,new Map);f(this,B,new Map)}clear(){s(this,V).clear(),s(this,he).clear(),s(this,B).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,V).set(t.id,t),t.fields?.originalId&&s(this,V).set(t.fields.originalId,t),s(this,B).has(t.id)){let[,r]=s(this,B).get(t.id);r()}if(s(this,B).has(t.fields?.originalId)){let[,r]=s(this,B).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,V).has(t)}entries(){return s(this,V).entries()}get(t){return s(this,V).get(t)}getAsPromise(t){let[e]=s(this,B).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,B).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,he).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,he).set(t,e)),e}remove(t){s(this,V).delete(t),s(this,he).delete(t),s(this,B).delete(t)}};V=new WeakMap,he=new WeakMap,B=new WeakMap;var ae=new nr,Ie,q,Y,D,R,A,rt,at,H,it,nt,$e,U,Fa,Ia,or,$a,Mt=class extends HTMLElement{constructor(){super(...arguments);f(this,U);h(this,"cache",ae);f(this,Ie);f(this,q,null);f(this,Y,null);f(this,D,null);f(this,R);f(this,A);f(this,rt,Na);f(this,at,5e3);f(this,H);f(this,it,!1);f(this,nt,0);f(this,$e)}static get observedAttributes(){return[Pa,Ra,Oa,_a,Ma]}attributeChangedCallback(e,r,i){e===Pa&&(m(this,R,i),m(this,A,ae.getFetchInfo(i))),e===Ra&&Zi.includes(i)&&m(this,rt,i),e===Oa&&m(this,at,parseInt(i,10)),e===_a&&m(this,it,["","true"].includes(i)),e===Ma&&m(this,$e,i)}connectedCallback(){if(!s(this,H)){if(s(this,D)??m(this,D,ce(this)),m(this,$e,s(this,D).settings?.preview),s(this,Ie)??m(this,Ie,s(this,D).log.module(`${ir}[${s(this,R)}]`)),!s(this,R)||s(this,R)==="#"){s(this,A)??m(this,A,ae.getFetchInfo("missing-fragment-id")),P(this,U,or).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,A)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,H)&&!await Promise.race([s(this,H),Promise.resolve(!1)]))return;e&&ae.remove(s(this,R)),s(this,rt)===Da&&await Promise.race([ae.getAsPromise(s(this,R)),new Promise(c=>setTimeout(c,s(this,at)))]);try{m(this,H,P(this,U,$a).call(this)),await s(this,H)}catch(c){return P(this,U,or).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,q)||{};return o&&!Lt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ye,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,A)},bubbles:!0,composed:!0})),s(this,H)}get updateComplete(){return s(this,H)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,Y)?s(this,Y):(s(this,it)?this.transformAuthorData():this.transformPublishData(),s(this,Y))}get rawData(){return s(this,q)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:d={}}=s(this,q);m(this,Y,e.reduce((p,{name:g,multiple:u,values:C})=>(p.fields[g]=u?C:C[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:d,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:d}=s(this,q);m(this,Y,Object.entries(e).reduce((p,[g,u])=>(p.fields[g]=u?.mimeType?u.value:u??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,R),{locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0})}};Ie=new WeakMap,q=new WeakMap,Y=new WeakMap,D=new WeakMap,R=new WeakMap,A=new WeakMap,rt=new WeakMap,at=new WeakMap,H=new WeakMap,it=new WeakMap,nt=new WeakMap,$e=new WeakMap,U=new WeakSet,Fa=async function(e){ur(this,nt)._++;let r=`${ir}:${s(this,R)}:${s(this,nt)}`,i=`${r}${vt}`,n=`${r}${xt}`;if(s(this,$e)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new re(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,A).stale=!1,s(this,A).url=e,o=await za(e,{cache:"default",credentials:"omit"}),P(this,U,Ia).call(this,o),s(this,A).status=o?.status,s(this,A).measure=Ee(performance.measure(n,i)),s(this,A).retryCount=o.retryCount,!o?.ok)throw new re("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,A).measure=Ee(performance.measure(n,i)),s(this,A).retryCount=c.retryCount,s(this,q))return s(this,A).stale=!0,s(this,Ie).error("Serving stale data",s(this,A)),s(this,q);let l=c.message??"unknown";throw new re(`Failed to fetch fragment: ${l}`,{})}},Ia=function(e){Object.assign(s(this,A),La(e))},or=function(e){m(this,H,null),s(this,A).message=e,this.classList.add("error");let r={...s(this,A),...s(this,D).duration};s(this,Ie).error(e,r),this.dispatchEvent(new CustomEvent(we,{detail:r,bubbles:!0,composed:!0}))},$a=async function(){var l;this.classList.remove("error"),m(this,Y,null);let e=ae.get(s(this,R));if(e)return m(this,q,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,R)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await P(this,U,Fa).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,R)),ae.add(e),m(this,q,e),!0},h(Mt,"cache",ae);customElements.define(ir,Mt);import{LitElement as Ji,html as cr,css as en,nothing as tn}from"./lit-all.min.js";import{unsafeHTML as rn}from"./lit-all.min.js";var an=a=>a?a.startsWith("sp-icon-")?cr`${rn(`<${a} class="badge-icon"></${a}>`)}`:cr`<img src="${a}" class="badge-icon" />`:tn,Be=class extends Ji{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return cr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Be);import{html as nn,css as on,LitElement as cn}from"./lit-all.min.js";var ot=class extends cn{constructor(){super()}render(){return nn`
            <slot name="icon"></slot>

...
`;var bc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-variation"},allowedBadgeColors:["spectrum-yellow-300-variation","spectrum-gray-300-variation","spectrum-gray-700-variation","spectrum-green-900-variation","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-variation","spectrum-gray-300-variation","spectrum-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},wt=class extends C{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return vc}priceOptionsProvider(t,r){t.dataset.template===ct&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return f` ${this.badge}
...
`;document.head.appendChild(Lc);var Rc="fragment",Mc="author",Oc="preview",Nc="loading",Ic="timeout",ka="aem-fragment",Dc="eager",$c="cache",Nh=[Dc,$c],Me,Et,_e,Pa=class{constructor(){w(this,Me,new Map);w(this,Et,new Map);w(this,_e,new Map)}clear(){h(this,Me).clear(),h(this,Et).clear(),h(this,_e).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,Me).set(t.id,t),t.fields?.originalId&&h(this,Me).set(t.fields.originalId,t),h(this,_e).has(t.id)){let[,i]=h(this,_e).get(t.id);i()}if(h(this,_e).has(t.fields?.originalId)){let[,i]=h(this,_e).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:n,value:a}=t.references[i];n==="content-fragment"&&(a.settings={...t?.settings,...a.settings},a.placeholders={...t?.placeholders,...a.placeholders},a.dictionary={...t?.dictionary,...a.dictionary},a.priceLiterals={...t?.priceLiterals,...a.priceLiterals},this.add(a,t))}}}has(t){return h(this,Me).has(t)}entries(){return h(this,Me).entries()}get(t){return h(this,Me).get(t)}getAsPromise(t){let[r]=h(this,_e).get(t)??[];if(r)return r;let i;return r=new Promise(n=>{i=n,this.has(t)&&n()}),h(this,_e).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,Et).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,Et).set(t,r)),r}remove(t){h(this,Me).delete(t),h(this,Et).delete(t),h(this,_e).delete(t)}};Me=new WeakMap,Et=new WeakMap,_e=new WeakMap;var Ke=new Pa,Qt,Ce,Ue,ye,ue,J,Gr,qr,ke,Vr,jr,Zt,Pe,zc,Hc,La,Bc,Gi=class extends HTMLElement{constructor(){super(...arguments);w(this,Pe);m(this,"cache",Ke);w(this,Qt);w(this,Ce,null);w(this,Ue,null);w(this,ye,null);w(this,ue);w(this,J);w(this,Gr,Dc);w(this,qr,5e3);w(this,ke);w(this,Vr,!1);w(this,jr,0);w(this,Zt)}static get observedAttributes(){return[Rc,Nc,Ic,Mc,Oc]}attributeChangedCallback(r,i,n){r===Rc&&(y(this,ue,n),y(this,J,Ke.getFetchInfo(n))),r===Nc&&Nh.includes(n)&&y(this,Gr,n),r===Ic&&y(this,qr,parseInt(n,10)),r===Mc&&y(this,Vr,["","true"].includes(n)),r===Oc&&y(this,Zt,n)}connectedCallback(){if(!h(this,ke)){if(h(this,ye)??y(this,ye,mt(this)),y(this,Zt,h(this,ye).settings?.preview),h(this,Qt)??y(this,Qt,h(this,ye).log.module(`${ka}[${h(this,ue)}]`)),!h(this,ue)||h(this,ue)==="#"){h(this,J)??y(this,J,Ke.getFetchInfo("missing-fragment-id")),Z(this,Pe,La).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,ke)&&!await Promise.race([h(this,ke),Promise.resolve(!1)]))return;r&&Ke.remove(h(this,ue)),h(this,Gr)===$c&&await Promise.race([Ke.getAsPromise(h(this,ue)),new Promise(s=>setTimeout(s,h(this,qr)))]);try{y(this,ke,Z(this,Pe,Bc).call(this)),await h(this,ke)}catch(s){return Z(this,Pe,La).call(this,s.message),!1}let{references:i,referencesTree:n,placeholders:a,wcs:o}=h(this,Ce)||{};return o&&!U("mas.disableWcsCache")&&h(this,ye).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(it,{detail:{...this.data,references:i,referencesTree:n,placeholders:a,...h(this,J)},bubbles:!0,composed:!0})),h(this,ke)}get updateComplete(){return h(this,ke)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,Ue)?h(this,Ue):(h(this,Vr)?this.transformAuthorData():this.transformPublishData(),h(this,Ue))}get rawData(){return h(this,Ce)}transformAuthorData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,Ce);y(this,Ue,r.reduce((l,{name:d,multiple:p,values:u})=>(l.fields[d]=p?u:u[0],l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=h(this,Ce);y(this,Ue,Object.entries(r).reduce((l,[d,p])=>(l.fields[d]=p?.mimeType?p.value:p??"",l),{fields:{},id:i,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=i.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,o=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${o}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,ue),{locale:h(this,ye).settings.locale,apiKey:h(this,ye).settings.wcsApiKey})}};Qt=new WeakMap,Ce=new WeakMap,Ue=new WeakMap,ye=new WeakMap,ue=new WeakMap,J=new WeakMap,Gr=new WeakMap,qr=new WeakMap,ke=new WeakMap,Vr=new WeakMap,jr=new WeakMap,Zt=new WeakMap,Pe=new WeakSet,zc=async function(r){Xa(this,jr)._++;let i=`${ka}:${h(this,ue)}:${h(this,jr)}`,n=`${i}${ot}`,a=`${i}${st}`;if(h(this,Zt))return await this.generatePreview();performance.mark(n);let o;try{if(h(this,J).stale=!1,h(this,J).url=r,o=await ki(r,{cache:"default",credentials:"omit"}),Z(this,Pe,Hc).call(this,o),h(this,J).status=o?.status,h(this,J).measure=Re(performance.measure(a,n)),h(this,J).retryCount=o.retryCount,!o?.ok)throw new Ie("Unexpected fragment response",{response:o,...h(this,ye).duration});return await o.json()}catch(s){if(h(this,J).measure=Re(performance.measure(a,n)),h(this,J).retryCount=s.retryCount,h(this,Ce))return h(this,J).stale=!0,h(this,Qt).error("Serving stale data",h(this,J)),h(this,Ce);let c=s.message??"unknown";throw new Ie(`Failed to fetch fragment: ${c}`,{})}},Hc=function(r){Object.assign(h(this,J),pi(r))},La=function(r){y(this,ke,null),h(this,J).message=r,this.classList.add("error");let i={...h(this,J),...h(this,ye).duration};h(this,Qt).error(r,i),this.dispatchEvent(new CustomEvent(nt,{detail:i,bubbles:!0,composed:!0}))},Bc=async function(){var c;this.classList.remove("error"),y(this,Ue,null);let r=Ke.get(h(this,ue));if(r)return y(this,Ce,r),!0;let{masIOUrl:i,wcsApiKey:n,country:a,locale:o}=h(this,ye).settings,s=`${i}/fragment?id=${h(this,ue)}&api_key=${n}&locale=${o}`;return a&&!o.endsWith(`_${a}`)&&(s+=`&country=${a}`),r=await Z(this,Pe,zc).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,ue)),Ke.add(r),y(this,Ce,r),!0},m(Gi,"cache",Ke);customElements.define(ka,Gi);M();$r();var Uc={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Fc=e=>(...t)=>({_$litDirective$:e,values:t}),qi=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,i){this._$Ct=t,this._$AM=r,this._$Ci=i}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};var Wr=class extends qi{constructor(t){if(super(t),this.et=E,t.type!==Uc.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===E||t==null)return this.ft=void 0,this.et=t;if(t===Be)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let r=[t];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};Wr.directiveName="unsafeHTML",Wr.resultType=1;var Gc=Fc(Wr);var Ih=e=>e?e.startsWith("sp-icon-")?f`${Gc(`<${e} class="badge-icon"></${e}>`)}`:f`<img src="${e}" class="badge-icon" />`:E,Jt=class extends z{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">
    ...
    `);customElements.define("merch-badge",Jt);M();var Yr=class extends z{constructor(){super()}render(){return f`
            <slot name="icon"></slot>

...
`,ar=()=>[rr`
    ...
    `);customElements.define("merch-icon",pe);var bn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),yn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var w='span[is="inline-price"][data-wcs-osi]',j='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Pi='a[is="upt-link"]',or=`${w},${j},${Pi}`;var sr="merch-offer-select:ready",cr="merch-card:action-menu-toggle";var H="merch-quantity-selector:change",lr="merch-card-quantity:change",At="merch-modal:addon-and-quantity-update";var he="merch-card-collection:literals-changed";var me="aem:load",ge="aem:error",dr="mas:ready",pr="mas:error",hr="placeholder-failed",mr="placeholder-pending",gr="placeholder-resolved";var ur="mas:failed",$e="mas:resolved",fr="mas/commerce";var V="failed",Z="pending",W="resolved";var rt="X-Request-Id",wn=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var En=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var it=":start",at=":duration";var nt="legal",xr="mas-ff-defaults";var Mi="mas-commerce-service";function vr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function L(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function ue(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function Ct(){return window.matchMedia("(max-width: 1024px)").matches}function J(){return document.getElementsByTagName(Mi)?.[0]}function Fe(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Ie,ee,Be,He,fe,ot=class extends HTMLElement{constructor(){super();g(this,Ie,"");g(this,ee);g(this,Be,[]);g(this,He,[]);g(this,fe);m(this,fe,vr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,ee)?this.parentElement.style.borderRadius=c(this,ee):c(this,ee)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Be).map((r,a)=>{let n=c(this,He)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Ie)}, ${e})`}connectedCallback(){c(this,fe).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&m(this,ee,a?.trim()),e==="colors"&&a?m(this,Be,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?m(this,He,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Ie,a?.trim()??""),c(this,fe).call(this)}};Ie=new WeakMap,ee=new WeakMap,Be=new WeakMap,He=new WeakMap,fe=new WeakMap;customElements.define("merch-gradient",ot);import{LitElement as Ri,html as Oi,css as Di}from"./lit-all.min.js";var xe=class extends Ri{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${w}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener($e,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener($e,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Oi` <input
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};l(xe,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),l(xe,"styles",Di`
        :host {
            --merch-addon-gap: 9px;
...
`;var Ee=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Rr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Lt` ${this.badge}
    ...
    `);import{html as zt,css as Gi}from"./lit-all.min.js";var Or=`
:root {
...
`;var ke=class extends x{constructor(t){super(t)}getGlobalCSS(){return Or}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return zt` ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as _t,css as ji}from"./lit-all.min.js";var Dr=`
:root {

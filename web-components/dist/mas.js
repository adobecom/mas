...
`;var Qi=class extends C{constructor(t){super(t)}getGlobalCSS(){return Rc}renderLayout(){return f` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Hn={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},or=class extends C{getGlobalCSS(){return tl}get aemFragmentMapping(){return Hn}renderLayout(){return f`
    ...
    `);var Ji=new Map,rl=new WeakMap,il=new Map,q=(e,t,r=null,i=null,a)=>{Ji.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:a})};q("catalog",Xt,_c,Xt.variantStyle);q("image",Tt);q("inline-heading",Qi);q("mini-compare-chart",Kt,Oc,Kt.variantStyle);q("mini-compare-chart-mweb",Qt,zc,Qt.variantStyle);q("plans",fe,Zi,fe.variantStyle,fe.collectionOptions);q("plans-students",fe,$c,fe.variantStyle,fe.collectionOptions);q("plans-education",fe,Dc,fe.variantStyle,fe.collectionOptions);q("plans-v2",tt,Bc,tt.variantStyle,tt.collectionOptions);q("product",Zt,Uc,Zt.variantStyle);q("segment",Jt,qc,Jt.variantStyle);q("media",er,jc,er.variantStyle);q("headless",ar,Zc,ar.variantStyle);q("special-offers",tr,Yc,tr.variantStyle);q("simplified-pricing-express",rr,Dn,rr.variantStyle);q("full-pricing-express",ir,$n,ir.variantStyle);q("mini",nr,el,nr.variantStyle);q("image",Tt,Lc,Tt.variantStyle);q("fries",or,Hn,or.variantStyle);var mp=(e,t,r)=>{try{let i=il.get(e.variant);if(i||(i=new CSSStyleSheet,i.replaceSync(t.cssText),il.set(e.variant,i)),r?.styleSheet&&r.styleSheet!==i){let a=e.shadowRoot.adoptedStyleSheets.indexOf(r.styleSheet);a!==-1&&e.shadowRoot.adoptedStyleSheets.splice(a,1)}return e.shadowRoot.adoptedStyleSheets.includes(i)||e.shadowRoot.adoptedStyleSheets.push(i),{styleSheet:i}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",e.variant);let n=r?.styleElement||e.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),e.shadowRoot.appendChild(a),{styleElement:a}}},Bn=e=>{let t=Ji.get(e.variant);if(!t)return;let{class:r,style:i}=t,a=rl.get(e);if(a?.appliedVariant===e.variant)return new r(e);let n=i?mp(e,i,a):{};return rl.set(e,{appliedVariant:e.variant,...n}),new r(e)};function Ki(e){return Ji.get(e)?.fragmentMapping}function al(e){return Ji.get(e)?.collectionOptions}var nl=document.createElement("style");nl.innerHTML=`
:root {
...
`;document.head.appendChild(nl);var up="explicit_empty";function Fn(e){return e===up}function gp(e){return Array.isArray(e)&&e.length===1&&Fn(e[0])}function ol(e,t=[]){if(gp(t))return e?[]:"";if(e)return t.map(i=>Fn(i)?"":i);let r=t[0];return Fn(r)?"":r}var sl="fragment",cl="author",ll="preview",dl="loading",hl="timeout",Un="aem-fragment",pl="eager",ml="cache",fp=[pl,ml],He,kt,Pe,Gn=class{constructor(){E(this,He,new Map);E(this,kt,new Map);E(this,Pe,new Map)}clear(){p(this,He).clear(),p(this,kt).clear(),p(this,Pe).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(p(this,He).set(t.id,t),t.fields?.originalId&&p(this,He).set(t.fields.originalId,t),p(this,Pe).has(t.id)){let[,i]=p(this,Pe).get(t.id);i()}if(p(this,Pe).has(t.fields?.originalId)){let[,i]=p(this,Pe).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return p(this,He).has(t)}entries(){return p(this,He).entries()}get(t){return p(this,He).get(t)}getAsPromise(t){let[r]=p(this,Pe).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),p(this,Pe).set(t,[r,i]),r}getFetchInfo(t){let r=p(this,kt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},p(this,kt).set(t,r)),r}remove(t){p(this,He).delete(t),p(this,kt).delete(t),p(this,Pe).delete(t)}};He=new WeakMap,kt=new WeakMap,Pe=new WeakMap;var rt=new Gn,sr,Le,Ye,be,xe,J,ei,ti,Re,ri,ii,cr,Me,ul,gl,qn,fl,ea=class extends HTMLElement{constructor(){super(...arguments);E(this,Me);u(this,"cache",rt);E(this,sr);E(this,Le,null);E(this,Ye,null);E(this,be,null);E(this,xe);E(this,J);E(this,ei,pl);E(this,ti,5e3);E(this,Re);E(this,ri,!1);E(this,ii,0);E(this,cr)}static get observedAttributes(){return[sl,dl,hl,cl,ll]}attributeChangedCallback(r,i,a){r===sl&&(b(this,xe,a),b(this,J,rt.getFetchInfo(a))),r===dl&&fp.includes(a)&&b(this,ei,a),r===hl&&b(this,ti,parseInt(a,10)),r===cl&&b(this,ri,["","true"].includes(a)),r===ll&&b(this,cr,a)}connectedCallback(){if(!p(this,Re)){if(p(this,be)??b(this,be,vt(this)),b(this,cr,p(this,be).settings?.preview),p(this,sr)??b(this,sr,p(this,be).log.module(`${Un}[${p(this,xe)}]`)),!p(this,xe)||p(this,xe)==="#"){p(this,J)??b(this,J,rt.getFetchInfo("missing-fragment-id")),Z(this,Me,qn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(p(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(p(this,Re)&&!await Promise.race([p(this,Re),Promise.resolve(!1)]))return;r&&rt.remove(p(this,xe)),p(this,ei)===ml&&await Promise.race([rt.getAsPromise(p(this,xe)),new Promise(s=>setTimeout(s,p(this,ti)))]);try{b(this,Re,Z(this,Me,fl).call(this)),await p(this,Re)}catch(s){return Z(this,Me,qn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=p(this,Le)||{};return o&&!B("mas.disableWcsCache")&&p(this,be).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(lt,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...p(this,J)},bubbles:!0,composed:!0})),p(this,Re)}get updateComplete(){return p(this,Re)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return p(this,Ye)?p(this,Ye):(p(this,ri)?this.transformAuthorData():this.transformPublishData(),p(this,Ye))}get rawData(){return p(this,Le)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=p(this,Le);b(this,Ye,r.reduce((d,{name:h,multiple:m,values:g})=>(d.fields[h]=ol(m,g),d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=p(this,Le);b(this,Ye,Object.entries(r).reduce((d,[h,m])=>(d.fields[h]=m?.mimeType?m.value:m??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r),a={locale:p(this,be).settings.locale,apiKey:p(this,be).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??p(this,be).settings.instant;return n&&(a.instant=n),await i(p(this,xe),a)}};sr=new WeakMap,Le=new WeakMap,Ye=new WeakMap,be=new WeakMap,xe=new WeakMap,J=new WeakMap,ei=new WeakMap,ti=new WeakMap,Re=new WeakMap,ri=new WeakMap,ii=new WeakMap,cr=new WeakMap,Me=new WeakSet,ul=async function(r){oo(this,ii)._++;let i=`${Un}:${p(this,xe)}:${p(this,ii)}`,a=`${i}${pt}`,n=`${i}${mt}`;if(p(this,cr)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Ne(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(p(this,J).stale=!1,p(this,J).url=r,o=await Hi(r,{cache:"default",credentials:"omit"}),Z(this,Me,gl).call(this,o),p(this,J).status=o?.status,p(this,J).measure=ze(performance.measure(n,a)),p(this,J).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...p(this,be).duration});return await o.json()}catch(s){if(p(this,J).measure=ze(performance.measure(n,a)),p(this,J).retryCount=s.retryCount,p(this,Le))return p(this,J).stale=!0,p(this,sr).error("Serving stale data",p(this,J)),p(this,Le);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},gl=function(r){Object.assign(p(this,J),Si(r))},qn=function(r){b(this,Re,null),p(this,J).message=r,this.classList.add("error");let i={...p(this,J),...p(this,be).duration};p(this,sr).error(r,i),this.dispatchEvent(new CustomEvent(dt,{detail:i,bubbles:!0,composed:!0}))},fl=async function(){var c;this.classList.remove("error"),b(this,Ye,null);let r=rt.get(p(this,xe));if(r)return b(this,Le,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=p(this,be).settings,s=`${i}/fragment?id=${p(this,xe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Me,ul).call(this,s),(c=r.fields).originalId??(c.originalId=p(this,xe)),rt.add(r),b(this,Le,r),!0},u(ea,"cache",rt);customElements.define(Un,ea);M();zn();var xp=e=>e?e.startsWith("sp-icon-")?f`${Yr(`<${e} class="badge-icon"></${e}>`)}`:f`<img src="${e}" class="badge-icon" />`:w,lr=class extends G{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">
    ...
    `),u(ci,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",ci);M();M();var Tl=y`
    :host {
...
`;var[ly,dy,Yn,Xn,_l,Pl]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Kn=class extends G{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return kl}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=Dr(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=Dr(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(Nt,this.debouncedQuantityUpdate)}get button(){return this.shadowRoot.querySelector("button")}handleKeyup(t){t.key===Xn||t.key===Yn||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let t=this.options[this.highlightedIndex];if(!t){this.closed=!0;return}this.selectedValue=t,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(t){switch(t.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case Pl:this.selectValue();break;case Xn:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,t.preventDefault();break;case Yn:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),t.preventDefault();break;case _l:this.selectValue(),this.button.classList.contains("focused")&&t.preventDefault();break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=t.value.replace(/\D/g,"");t.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let a=i;this.maxInput&&i>this.maxInput&&(a=this.maxInput),this.min&&a<this.min&&(a=this.min),this.adjustInput(t,a)}else this.adjustInput(t,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(Nt,this.debouncedQuantityUpdate)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}update(t){if(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue")){this.options=this.generateOptionsArray();let r=this.options[0],i=this.defaultValue!=null&&this.options.includes(this.defaultValue)?this.defaultValue:r;this.highlightedIndex=this.options.indexOf(i),this.handleMenuOption(i)}super.update(t)}handleClickOutside(t){t.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let t=this.shadowRoot.querySelector(".popover");this.closed||t.getBoundingClientRect().bottom<=window.innerHeight?t.setAttribute("placement","bottom"):t.setAttribute("placement","top")}handleMouseEnter(t){this.highlightedIndex=t}handleMenuOption(t,r){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let t=new CustomEvent(te,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}get configured(){return this.title||this.min||this.step}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return f` <div
        ...
        `:w}};customElements.define("merch-quantity-select",Kn);Yi();M();var Ll=`
...
`;var Rl={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},gr=class extends C{getGlobalCSS(){return Ll}get stripStyle(){return this.card.backgroundImage?`
...
`;var Ol={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},fr=class extends C{getGlobalCSS(){return Ml}renderLayout(){return f` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Zn={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},vr=class extends C{getGlobalCSS(){return zl}get aemFragmentMapping(){return Zn}renderLayout(){return f`
    ...
    `);q("ccd-suggested",gr,Rl,gr.variantStyle);q("ccd-slice",fr,Ol,fr.variantStyle);q("ah-try-buy-widget",xr,Qn,xr.variantStyle);q("ah-promoted-plans",vr,Zn,vr.variantStyle);

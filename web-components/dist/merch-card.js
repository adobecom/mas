var Mr=Object.defineProperty;var Rr=a=>{throw TypeError(a)};var Li=(a,r,e)=>r in a?Mr(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var zi=(a,r,e)=>()=>{if(e)throw e[0];try{return a&&(r=a(a=0)),r}catch(t){throw e=[t],t}};var Pi=(a,r)=>{for(var e in r)Mr(a,e,{get:r[e],enumerable:!0})};var d=(a,r,e)=>Li(a,typeof r!="symbol"?r+"":r,e),Qt=(a,r,e)=>r.has(a)||Rr("Cannot "+e);var p=(a,r,e)=>(Qt(a,r,"read from private field"),e?e.call(a):r.get(a)),v=(a,r,e)=>r.has(a)?Rr("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),u=(a,r,e,t)=>(Qt(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),k=(a,r,e)=>(Qt(a,r,"access private method"),e);var tr={};Pi(tr,{default:()=>Xe});import{LitElement as Oi,html as be,css as Ni,nothing as Di}from"./lit-all.min.js";import{unsafeHTML as ra}from"./lit-all.min.js";import{ifDefined as Fi}from"./lit-all.min.js";function $i(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var O,Xe,rr=zi(()=>{O=class O extends Oi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();O.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),l=c?c.offsetWidth:o,h=c?c.offsetHeight:s,g=this.effectivePlacement;g==="top"&&e.top-h-n<0?g="bottom":g==="bottom"&&e.bottom+h+n>i?g="top":g==="left"&&e.left-l-n<0?g="right":g==="right"&&e.right+l+n>t&&(g="left");let E=e.left+e.width/2,A=e.top+e.height/2,I=6,wt=(Si,Ai,Ti)=>Math.max(Si,Math.min(Ai,Ti)),Et,kt,Kt;g==="top"||g==="bottom"?(Et=g==="top"?e.top-h-n:e.bottom+n,kt=wt(0,t-l,E-l/2),Kt=wt(I,l-I*2,E-kt-I)):(kt=g==="left"?e.left-l-n:e.right+n,Et=wt(0,i-h,A-h/2),Kt=wt(I,h-I*2,A-Et-I)),this._tooltipTop=Et,this._tooltipLeft=kt,this._arrowOffset=Kt,this._computedPlacement=g}showTooltip(){O.activeTooltip&&O.activeTooltip!==this&&(O.activeTooltip.closeOverlay(),O.activeTooltip.tooltipVisible=!1,O.activeTooltip.requestUpdate()),O.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){O.activeTooltip===this&&(O.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?be`<merch-icon
    ...
    `);Xe=O;customElements.define("mas-mnemonic",Xe)});import{LitElement as Uo}from"./lit-all.min.js";import{css as Dr,unsafeCSS as Nr}from"./lit-all.min.js";var C="(max-width: 767px)",L="(max-width: 1199px)",y="(min-width: 768px)",b="(min-width: 1200px)",_="(min-width: 1600px)",Ye="(min-width: 1280px)",Or={matchMobile:window.matchMedia(C),matchDesktop:window.matchMedia(`${b} and (not ${_})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(_),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Or;function Ct(){return Or.isDesktop}var Fr=Dr`
    :host {

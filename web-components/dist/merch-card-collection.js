var rn=Object.defineProperty;var an=e=>{throw TypeError(e)};var fc=(e,r,t)=>r in e?rn(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var vc=(e,r)=>{for(var t in r)rn(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>fc(e,typeof r!="symbol"?r+"":r,t),fa=(e,r,t)=>r.has(e)||an("Cannot "+t);var v=(e,r,t)=>(fa(e,r,"read from private field"),t?t.call(e):r.get(e)),S=(e,r,t)=>r.has(e)?an("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),A=(e,r,t,a)=>(fa(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),B=(e,r,t)=>(fa(e,r,"access private method"),t);import{html as Oe,LitElement as nc,css as oc,unsafeCSS as ic,nothing as ye}from"./lit-all.min.js";var z="(max-width: 767px)",K="(max-width: 1199px)",R="(min-width: 768px)",_="(min-width: 1200px)",ae="(min-width: 1600px)",$t="(min-width: 1280px)",nn={matchMobile:window.matchMedia(z),matchDesktop:window.matchMedia(`${_} and (not ${ae})`),matchDesktopOrUp:window.matchMedia(_),matchLargeDesktop:window.matchMedia(ae),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},C=nn;function kr(){return nn.isDesktop}var Gt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var on="hashchange";function xc(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function qt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function sn(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=xc(window.location.hash);e(t)};return r(),window.addEventListener(on,r),()=>{window.removeEventListener(on,r)}}var Ga={};vc(Ga,{CLASS_NAME_FAILED:()=>ka,CLASS_NAME_HIDDEN:()=>yc,CLASS_NAME_PENDING:()=>_a,CLASS_NAME_RESOLVED:()=>La,CheckoutWorkflow:()=>Oc,CheckoutWorkflowStep:()=>oe,Commitment:()=>We,ERROR_MESSAGE_BAD_REQUEST:()=>Pa,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Mc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Ma,EVENT_AEM_ERROR:()=>Ca,EVENT_AEM_LOAD:()=>Sa,EVENT_COMPARE_CHART_REHYDRATE:()=>Lc,EVENT_EXPANDED_GROUPS_CHANGE:()=>Pc,EVENT_MAS_ERROR:()=>Ta,EVENT_MAS_READY:()=>Pr,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>ya,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>ba,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>ge,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Ea,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Vt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>wa,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Lr,EVENT_MERCH_OFFER_READY:()=>Ac,EVENT_MERCH_OFFER_SELECT_READY:()=>Sc,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ne,EVENT_MERCH_SEARCH_CHANGE:()=>_c,EVENT_MERCH_SIDENAV_SELECT:()=>Aa,EVENT_MERCH_STOCK_CHANGE:()=>Tc,EVENT_MERCH_STORAGE_CHANGE:()=>kc,EVENT_OFFER_SELECTED:()=>Cc,EVENT_TYPE_FAILED:()=>Ra,EVENT_TYPE_READY:()=>_r,EVENT_TYPE_RESOLVED:()=>fe,Env:()=>we,FF_ANNUAL_PRICE:()=>dt,FF_DEFAULTS:()=>_e,HEADER_X_REQUEST_ID:()=>jt,LOG_NAMESPACE:()=>Na,Landscape:()=>He,MARK_DURATION_SUFFIX:()=>Ua,MARK_START_SUFFIX:()=>Ba,MERCH_CARD_LOAD_TIMEOUT:()=>va,MODAL_TYPE_3_IN_1:()=>Ye,NAMESPACE:()=>bc,PARAM_AOS_API_KEY:()=>Rc,PARAM_ENV:()=>Ia,PARAM_LANDSCAPE:()=>za,PARAM_MAS_PREVIEW:()=>Oa,PARAM_WCS_API_KEY:()=>Nc,PLACEHOLDER_PLAN_TYPE_TEXT:()=>Hc,PROVIDER_ENVIRONMENT:()=>Fa,SELECTOR_MAS_CHECKOUT_LINK:()=>cn,SELECTOR_MAS_ELEMENT:()=>xa,SELECTOR_MAS_INLINE_PRICE:()=>G,SELECTOR_MAS_SP_BUTTON:()=>Ec,SELECTOR_MAS_UPT_LINK:()=>ln,SORT_ORDER:()=>xe,STATE_FAILED:()=>ve,STATE_PENDING:()=>De,STATE_RESOLVED:()=>de,SUPPORTED_COUNTRIES:()=>$a,TAG_NAME_SERVICE:()=>wc,TEMPLATE_PRICE:()=>Ic,TEMPLATE_PRICE_ANNUAL:()=>Dc,TEMPLATE_PRICE_LEGAL:()=>Z,TEMPLATE_PRICE_STRIKETHROUGH:()=>zc,TRIAL_ANALYTICS_IDS:()=>dn,Term:()=>pe,WCS_PROD_URL:()=>Da,WCS_STAGE_URL:()=>Ha});var We=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),pe=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),bc="merch",va=2e4,yc="hidden",_r="wcms:commerce:ready",wc="mas-commerce-service",G='span[is="inline-price"][data-wcs-osi]',cn='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Ec="sp-button[data-wcs-osi]",ln='a[is="upt-link"]',xa=`${G},${cn},${ln}`,dn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]),Ac="merch-offer:ready",Sc="merch-offer-select:ready",ba="merch-card:action-menu-toggle",Cc="merch-offer:selected",Tc="merch-stock:change",kc="merch-storage:change",ne="merch-quantity-selector:change",Lr="merch-card-quantity:change",ya="merch-modal:addon-and-quantity-update",_c="merch-search:change",wa="merch-card-collection:sort",ge="merch-card-collection:literals-changed",Vt="merch-card-collection:sidenav-attached",Ea="merch-card-collection:showmore",Aa="merch-sidenav:select",Sa="aem:load",Ca="aem:error",Pr="mas:ready",Ta="mas:error",Lc="mas-compare-chart:rehydrate",Pc="expanded-groups-change",ka="placeholder-failed",_a="placeholder-pending",La="placeholder-resolved",Pa="Bad WCS request",Ma="Commerce offer not found",Mc="Literals URL not provided",Ra="mas:failed",fe="mas:resolved",Na="mas/commerce",Oa="mas.preview",Ia="commerce.env",za="commerce.landscape",Rc="commerce.aosKey",Nc="commerce.wcsKey",Da="https://www.adobe.com/web_commerce_artifact",Ha="https://www.stage.adobe.com/web_commerce_artifact_stage",ve="failed",De="pending",de="resolved",He={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},jt="X-Request-Id",oe=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Oc="UCv3",we=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Fa={PRODUCTION:"PRODUCTION"},Ye={TWP:"twp",D2P:"d2p",CRM:"crm"},Ba=":start",Ua=":duration",Ic="price",zc="price-strikethrough",Dc="annual",Z="legal",Hc="plan-type-text",_e="mas-ff-defaults",dt="mas-ff-annual-price",xe={alphabetical:"alphabetical",authored:"authored"},$a=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Fc="mas-commerce-service";function hn(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Wt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function Ee(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Mr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function qa(){return window.matchMedia("(max-width: 1024px)").matches}function Yt(){return document.getElementsByTagName(Fc)?.[0]}function Xt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var Bc=["adobe.com","adobeioruntime.net","aem.live","aem.page"],Uc=["localhost","127.0.0.1"];function pn(e){try{let r=new URL(e);return Uc.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:Bc.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as Rr,nothing as $c}from"./lit-all.min.js";var ht,Kt=class Kt{constructor(r){g(this,"card");S(this,ht);this.card=r,this.insertVariantStyle()}getContainer(){return A(this,ht,v(this,ht)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,ht)}insertVariantStyle(){let r=this.constructor.name;if(!Kt.styleMap[r]){Kt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(h=>h.style.getPropertyValue(l)),u=0,m=o.map(h=>{h.style.removeProperty(l);let p=c(h);if(!p)return p;let f=Math.max(0,parseInt(window.getComputedStyle(p).height)||0);return f>u&&(u=f),p});o.forEach((h,p)=>{m[p]?.tagName!=="HR"&&(u>0?h.style.setProperty(l,`${u}px`):d[p]&&h.style.setProperty(l,d[p]))})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Rr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Qt,css as qc}from"./lit-all.min.js";var gn=`
:root {
...
`;var Or=class extends E{constructor(r){super(r)}getGlobalCSS(){return vn}renderLayout(){return xn` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":xn`<hr />`} ${this.secureLabelFooter}`}};import{html as Fe,css as Vc,unsafeCSS as yn}from"./lit-all.min.js";var bn=`
  :root {
...
`;var jc=32,wn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},mt=class extends E{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Fe`<slot name="secure-transaction-label">
    ...
    `);import{html as Ir,css as Wc,unsafeCSS as ja,nothing as Yc}from"./lit-all.min.js";var En=`
  :root {
...
`;var Xc=32,Kc=0,Qc=()=>`mweb-list-${Kc+=1}`,Zc=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],Jc=8,An={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ae,Ke,gt,ft,vt,Be,Wa,Ya,ut=class extends E{constructor(t){super(t);S(this,Be);S(this,Ae);S(this,Ke);S(this,gt);S(this,ft,0);S(this,vt);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Ir` <footer>
    ...
    `);import{html as Zt,css as el,nothing as zr}from"./lit-all.min.js";var Sn=`
:root {
...
`;var Dr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Cn={...(function(){let{whatsIncluded:e,size:r,...t}=Dr;return t})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Tn={...(function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=Dr;return i})()},Se,Ce,se=class extends E{constructor(t){super(t);S(this,Se);S(this,Ce);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===Z&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Sn}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(s)){if(o?.classList.toggle("wide-footer",C.isDesktopOrUp),!i&&c){if(l)c.remove();else{let u=d.querySelector(`[data-placeholder-for="${t}"]`);u?u.replaceWith(c):d.appendChild(c)}return}if(i&&l){let u=document.createElement("div");if(u.setAttribute("data-placeholder-for",t),u.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);o.prepend(m)}l.replaceWith(u)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],C.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],C.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,Se)||(A(this,Se,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Se)?.disconnect(),A(this,Se,null),this.syncHeights())})),v(this,Se).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),a.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Xt(d));let u=this.card.querySelector('[slot="subtitle"]');u&&(l+=Xt(u));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+Xt(m));for(let p of a.childNodes){if(p.classList.contains("spacer"))break;l+=Xt(p)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${G}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Zt`<div class="divider"></div>`:zr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${G}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?Zt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Se=new WeakMap,Ce=new WeakMap,g(se,"variantStyle",el`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(C.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?C.isMobile?Le`
        ...
        `:Le`
            ...
            <slot></slot>`}};g(Ue,"variantStyle",tl`
...
`;var[im,nm,Mn,Rn,Nn,On]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Br="pro",Xa=`--consonant-merch-card-${Br}-top-card-height`,Fr=[{prop:`--consonant-merch-card-${Br}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Br}-name-description-height`,selector:".name-description"}],In=`--consonant-merch-card-${Br}-strike-reserve`,Ka='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',al="(min-width: 768px)",zn={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Me,Qe,ar,ir,Y,Dn,er,Hn,tr,Qa,Ur,$r=class $r extends E{constructor(t){super(t);S(this,Y);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);S(this,Me,null);S(this,Qe,null);S(this,ar,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);S(this,ir,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of B(this,Y,Dn).call(this)){let n=i.variantLayout;n instanceof $r&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?B(this,Y,Qa).call(this):B(this,Y,tr).call(this),this.card.requestUpdate()});S(this,Ur,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case Rn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:B(this,Y,tr).call(this);break;case Mn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:B(this,Y,tr).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case Nn:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}B(this,Y,tr).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),B(this,Y,Qa).call(this);break;case On:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,B(this,Y,er).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(ne,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return Pn}priceOptionsProvider(t,a){t.dataset.template===Z&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(fe,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]');if(!t?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=t.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${G}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=Xa,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(al).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,u)=>{let m=l(u);return m?Math.max(d,parseInt(getComputedStyle(m).height)||0):d},0);for(let c of o.values()){if(c.forEach(m=>this.clearSyncedHeights(m)),c.length<2)continue;let l=c.map(m=>m.querySelector(Ka)&&parseInt(getComputedStyle(m.querySelector(Ka)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((m,h)=>{let p=d-l[h];p>0&&m.style.setProperty(In,`${p}px`)});for(let m of Fr){let h=s(c,p=>p.shadowRoot?.querySelector(m.selector));h>0&&c.forEach(p=>p.style.setProperty(m.prop,`${h}px`))}let u=s(c,m=>m.shadowRoot?.querySelector(".top-card"));u>0&&c.forEach(m=>m.style.setProperty(i,`${u}px`))}}clearSyncedHeights(t){t.style.removeProperty(Xa),t.style.removeProperty(In),Fr.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(Ka),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Lr,v(this,ir)),this.card.addEventListener(ne,this.updatePriceQuantity),this.card.addEventListener(fe,v(this,ar)),typeof ResizeObserver>"u"))return;A(this,Qe,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Qe).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Qe).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ne,this.updatePriceQuantity),this.card?.removeEventListener(fe,v(this,ar)),B(this,Y,er).call(this),v(this,Qe)?.disconnect(),this.card?.removeEventListener(Lr,v(this,ir))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Pe`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Pe`
        ...
        `}renderLayout(){let t=!!this.expanded;return Pe`
            ...
            <slot></slot>
        `}};Me=new WeakMap,Qe=new WeakMap,ar=new WeakMap,ir=new WeakMap,Y=new WeakSet,Dn=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},er=function(){v(this,Me)&&(document.removeEventListener("mousedown",v(this,Me)),A(this,Me,null))},Hn=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},tr=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=B(this,Y,Hn).call(this),v(this,Me)||(A(this,Me,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),B(this,Y,er).call(this))}),document.addEventListener("mousedown",v(this,Me)))},Qa=function(){this.licenseOpen=!1,B(this,Y,er).call(this)},Ur=new WeakMap,g($r,"variantStyle",rl`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var rr=$r;import{html as Za,css as il}from"./lit-all.min.js";var Fn=`
:root {
...
`;var Bn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Te,bt=class extends E{constructor(t){super(t);S(this,Te);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Fn}priceOptionsProvider(t,a){t.dataset.template===Z&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return Za` ${this.badge}
    ...
    `);import{html as nl,css as ol}from"./lit-all.min.js";var Un=`
...
`;var $n={cardName:{attribute:"name"},mnemonics:{size:"l"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},planType:!0,promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},yt=class extends E{getGlobalCSS(){return Un}priceOptionsProvider(r,t){r.dataset.template===Z&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.card.querySelector(`[slot="heading-xs"] ${G}[data-template="price"]`);if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}renderLayout(){return nl` ${this.badge}
            ...
            <slot></slot>`}};g(yt,"variantStyle",ol`
    ...
    `);import{html as Ja,css as sl}from"./lit-all.min.js";var Gn=`
:root {
...
`;var qn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},wt=class extends E{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===Z&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return Gn}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${G}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return Ja`
    ...
    `);import{html as cl,css as ll}from"./lit-all.min.js";var Vn=`
...
`;var jn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Et=class extends E{constructor(r){super(r)}getGlobalCSS(){return Vn}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return cl`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as ei,css as dl}from"./lit-all.min.js";var Wn=`
:root {
...
`;var Yn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},At=class extends E{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Wn}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${G}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return ei`${this.cardImage}
    ...
    `);import{html as Kn,css as hl}from"./lit-all.min.js";var Xn=`
:root {
...
`;var ti={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},St=class extends E{getGlobalCSS(){return Xn}get aemFragmentMapping(){return ti}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return Kn`<div
    ...
    `);import{html as Zn,css as pl}from"./lit-all.min.js";var Qn=`
:root {
...
`;var ri={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},nr=class nr extends E{getGlobalCSS(){return Qn}get aemFragmentMapping(){return ri}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return Zn`<div
        ...
        >
            ...
            <slot></slot>
        `}};g(nr,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(nr,"variantStyle",pl`
    ...
    `);var or=nr;import{html as sr,nothing as eo}from"./lit-all.min.js";import{css as ml,unsafeCSS as ul}from"./lit-all.min.js";var Jn=["headless","marquee","faq","banner-blade"],Ct=(e,r="")=>Jn.map(t=>`merch-card[variant='${t}'] [slot='${e}']${r}`).join(`,
`),ai=e=>Jn.map(r=>`merch-card[variant='${r}'] ${e}`).join(`,
`),$e=`
...
`;function Ge(e){let r=ul(e);return ml`
        :host([variant='${r}']) {
            border: none;
            background: transparent;
            box-shadow: none;
    ...
    `}var to={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},gl=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Tt=class extends E{constructor(r){super(r)}getGlobalCSS(){return $e}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return sr`
        ...
        `}};g(Tt,"variantStyle",Ge("headless"));import{css as fl,html as vl}from"./lit-all.min.js";var ro=`
...
`;var ao={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},kt=class extends E{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return ro}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${G}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return vl`
    ...
    `);import{html as xl,css as bl}from"./lit-all.min.js";var io=`
...
`;var ii={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},yl=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Gr,no,_t=class extends E{constructor(t){super(t);S(this,Gr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return io}get aemFragmentMapping(){return ii}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,B(this,Gr,no).call(this))}renderLayout(){return xl`
            <div class="card">
            ...
            <slot></slot>
        `}};Gr=new WeakSet,no=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;yl.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(_t,"variantStyle",bl`
    ...
    `);import{html as wl,css as El}from"./lit-all.min.js";var oo=`
...
`;var ni={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Lt=class extends E{getGlobalCSS(){return oo}get aemFragmentMapping(){return ni}renderLayout(){return wl`
    ...
    `);import{html as oi,nothing as Al}from"./lit-all.min.js";var so={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},Sl=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Pt=class extends E{constructor(r){super(r)}getGlobalCSS(){return $e}renderLayout(){return oi`
            <div class="headless">
                ${Sl.map(({slot:r,label:t})=>oi`
                        <div class="headless-row">
        ...
        `}};g(Pt,"variantStyle",Ge("marquee"));import{html as co}from"./lit-all.min.js";var lo={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},Cl=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],Mt=class extends E{constructor(r){super(r)}getGlobalCSS(){return $e}renderLayout(){return co`
            <div class="headless">
                ${Cl.map(({slot:r,label:t})=>co`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value">
                                <slot name="${r}"></slot>
        ...
        `}};g(Mt,"variantStyle",Ge("faq"));import{html as ho}from"./lit-all.min.js";var po={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},Tl=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],Rt=class extends E{constructor(r){super(r)}getGlobalCSS(){return $e}renderLayout(){return ho`
            <div class="headless">
                ${Tl.map(({slot:r,label:t})=>ho`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value" data-slot="${r}">
                                <slot name="${r}"></slot>
        ...
        `}};g(Rt,"variantStyle",Ge("banner-blade"));var mo=new Map;var U=(e,r,t=null,a=null,i)=>{mo.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};U("catalog",pt,un,pt.variantStyle);U("image",Xe);U("inline-heading",Or);U("mini-compare-chart",mt,wn,mt.variantStyle);U("mini-compare-chart-mweb",ut,An,ut.variantStyle);U("plans",se,Dr,se.variantStyle,se.collectionOptions);U("plans-students",se,Tn,se.variantStyle,se.collectionOptions);U("plans-education",se,Cn,se.variantStyle,se.collectionOptions);U("plans-v2",Ue,Ln,Ue.variantStyle,Ue.collectionOptions);U("pro",rr,zn,rr.variantStyle);U("product",bt,Bn,bt.variantStyle);U("brand-concierge-product",yt,$n,yt.variantStyle);U("segment",wt,qn,wt.variantStyle);U("media",Et,jn,Et.variantStyle);U("headless",Tt,to,Tt.variantStyle);U("special-offers",At,Yn,At.variantStyle);U("simplified-pricing-express",St,ti,St.variantStyle);U("full-pricing-express",or,ri,or.variantStyle);U("mini",kt,ao,kt.variantStyle);U("image",Xe,fn,Xe.variantStyle);U("compare-chart-column",_t,ii,_t.variantStyle);U("fries",Lt,ni,Lt.variantStyle);U("marquee",Pt,so,Pt.variantStyle);U("faq",Mt,lo,Mt.variantStyle);U("banner-blade",Rt,po,Rt.variantStyle);function Nr(e){return mo.get(e)?.fragmentMapping}var uo="tacocat.js";var si=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),go=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function F(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=Nt(a)?a:e;n=o.get(s)}if(i&&n==null){let o=Nt(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=_l(Nt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var kl=e=>typeof e=="boolean",qr=e=>typeof e=="function",Vr=e=>typeof e=="number",fo=e=>e!=null&&typeof e=="object";var Nt=e=>typeof e=="string",ci=e=>Nt(e)&&e,Ot=e=>Vr(e)&&Number.isFinite(e)&&e>0;function jr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function T(e,r){if(kl(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function cr(e,r,t){let a=Object.values(r);return a.find(i=>si(i,e))??t??a[0]}function _l(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function vo(e,r=1){return Vr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var Ll=Date.now(),li=()=>`(+${Date.now()-Ll}ms)`,Wr=new Set,Pl=T(F("tacocat.debug",{},{metadata:!1}),!1);function xo(e){let r=`[${uo}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=Pl?(o,...s)=>{console.debug(`${r} ${o}`,...s,li())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;Wr.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;Wr.forEach(([,l])=>l(c,...s))}}}function Ml(e,r){let t=[e,r];return Wr.add(t),()=>{Wr.delete(t)}}Ml((e,...r)=>{console.error(e,...r,li())},(e,...r)=>{console.warn(e,...r,li())});var Rl="no promo",bo="promo-tag",Nl="yellow",Ol="neutral",Il=(e,r,t)=>{let a=n=>n||Rl,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Yr="cancel-context",Xr=(e,r)=>{let t=e===Yr,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?bo:`${bo} no-promo`,text:Il(o,r,i),variant:n?Nl:Ol,isOverriden:i}};var di;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(di||(di={}));var he;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(he||(he={}));var me;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(me||(me={}));var hi;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(hi||(hi={}));var pi;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(pi||(pi={}));var mi;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(mi||(mi={}));var ui;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(ui||(ui={}));var gi="ABM",fi="PUF",vi="M2M",xi="PERPETUAL",bi="P3Y",zl="TAX_INCLUSIVE_DETAILS",Dl="TAX_EXCLUSIVE",yo={ABM:gi,PUF:fi,M2M:vi,PERPETUAL:xi,P3Y:bi},zg={[gi]:{commitment:he.YEAR,term:me.MONTHLY},[fi]:{commitment:he.YEAR,term:me.ANNUAL},[vi]:{commitment:he.MONTH,term:me.MONTHLY},[xi]:{commitment:he.PERPETUAL,term:void 0},[bi]:{commitment:he.THREE_MONTHS,term:me.P3Y}},wo="Value is not an offer",Kr=e=>{if(typeof e!="object")return wo;let{commitment:r,term:t}=e,a=Hl(r,t);return{...e,planType:a}};var Hl=(e,r)=>{switch(e){case void 0:return wo;case"":return"";case he.YEAR:return r===me.MONTHLY?gi:r===me.ANNUAL?fi:"";case he.MONTH:return r===me.MONTHLY?vi:"";case he.PERPETUAL:return xi;case he.TERM_LICENSE:return r===me.P3Y?bi:"";default:return""}};function Eo(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==zl)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:Dl}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Ze={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ao=1e3;function Fl(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function So(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ze.serializableTypes.includes(t))return t}return e}function Bl(e,r){if(!Ze.ignoredProperties.includes(e))return So(r)}var yi={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(Fl(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(So).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${Ze.delimiter}page=${o}${s}`;c.length>Ao&&(c=`${c.slice(0,Ao)}<trunc>`),n+=c,i.length&&(n+=`${Ze.delimiter}facts=`,n+=JSON.stringify(i,Bl)),window.lana?.log(n,Ze)}};function Qr(e){Object.assign(Ze,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in Ze&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Co={LOCAL:"local",PROD:"prod",STAGE:"stage"},wi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Ei=new Set,Ai=new Set,To=new Map,ko={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},_o={filter:({level:e})=>e!==wi.DEBUG},Ul={filter:()=>!1};function $l(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&qr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function Gl(e){[...Ai].every(r=>r(e))&&Ei.forEach(r=>r(e))}function Lo(e){let r=(To.get(e)??0)+1;To.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>Lo(`${a.namespace}/${i}`),updateConfig:Qr};return Object.values(wi).forEach(i=>{a[i]=(n,...o)=>Gl($l(i,n,e,o,t))}),Object.seal(a)}function Zr(...e){e.forEach(r=>{let{append:t,filter:a}=r;qr(a)&&Ai.add(a),qr(t)&&Ei.add(t)})}function ql(e={}){let{name:r}=e,t=T(F("commerce.debug",{search:!0,storage:!0}),r===Co.LOCAL);return Zr(t?ko:_o),r===Co.PROD&&Zr(yi),ce}function Vl(){Ei.clear(),Ai.clear()}var ce={...Lo(Na),Level:wi,Plugins:{consoleAppender:ko,debugFilter:_o,quietFilter:Ul,lanaAppender:yi},init:ql,reset:Vl,use:Zr};var jl="mas-commerce-service",Wl=ce.module("utilities"),Yl={requestId:jt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function lr(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map(Eo)),a}var Po=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function Si(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let u=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?s.priceDetails?.formatString:s[l];m!==u&&Wl.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:u,actual:m})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=Po(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=Po(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var Jr=e=>window.setTimeout(e);function It(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(vo).filter(Ot);return t.length||(t=[r]),t}function Xl(e){return e==null?[]:Array.isArray(e)?e:String(e).split(",").map(r=>r.trim())}function ea(e,r){let t=Xl(r);if(e==null)return{wcsOsi:[],promotionCodes:t};let a=Array.isArray(e)?e:String(e).split(",");if(t.length<=1)return{wcsOsi:a.filter(ci),promotionCodes:t};let i=[],n=[];return a.forEach((o,s)=>{ci(o)&&(i.push(o),n.push(t[s]??""))}),{wcsOsi:i,promotionCodes:n}}function ie(){return document.getElementsByTagName(jl)?.[0]}function Mo(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(Yl)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var zt=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(jt);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var Kl={[ve]:ka,[De]:_a,[de]:La},Ql={[ve]:Ra,[de]:fe},dr,qe=class{constructor(r){S(this,dr);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",De);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=ce.module("mas-element")}update(){[ve,De,de].forEach(r=>{this.wrapperElement.classList.toggle(Kl[r],r===this.state)})}notify(){(this.state===de||this.state===ve)&&(this.state===de?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ve&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof zt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Ql[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){A(this,dr,ie()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return de===a?Promise.resolve(this.wrapperElement):ve===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=de,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Jr(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=ve,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,dr)?.duration}),Jr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=De,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!ie()||this.timer)return;let{error:t,options:a,state:i,value:n,version:o}=this;this.state=De,this.timer=Jr(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===De&&this.version===o&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};dr=new WeakMap;function Ro(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function ta(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,Ro(r)),i}function No(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Ro(r)),e):null}function Zl(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var tt,Je=class Je extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new qe(this));S(this,tt);this.setAttribute("is",Je.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),A(this,tt,Yt()),v(this,tt)&&(this.log=v(this,tt).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),A(this,tt,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Yt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=a,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,u=this.getAttribute("data-promotion-code");u&&(d+=`&promotion_code=${encodeURIComponent(u)}`),this.href=`${Zl(l)}?${d}`,this.masElement.toggleResolved(i,o,a)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,a),!1}}static createFrom(t){let a=new Je;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};tt=new WeakMap,g(Je,"is","upt-link"),g(Je,"tag","a"),g(Je,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var et=Je;window.customElements.get(et.is)||window.customElements.define(et.is,et,{extends:et.tag});function Oo(e){return e&&(e==="bizpro"&&(e="pro"),e==="pro"||e.startsWith("plans")?"plans":e)}var Jl="p_draft_landscape",ed="/store/",td=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),Ci=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),rd=["env","workflowStep","clientId","country"],ad=["/tw/","/hk_zh/"];function id(e){let r=e??"";return ad.some(t=>r.startsWith(t))}function nd(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(id)}function hr(e){if(!nd())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var Io=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),zo=e=>td.get(e)??e;function ra(e,r,t){for(let[a,i]of Object.entries(e)){let n=zo(a);i!=null&&t.has(n)&&r.set(n,i)}}function od(e){return e===Fa.PRODUCTION?"https://commerce.adobe.com":"https://commerce-stg.adobe.com"}function sd(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let o=zo(i);r.set(`items[${t}][${o}]`,n)}}}function cd({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===Ye.CRM?"creative":"mini_plans"),e}function ld(e){let r=e.indexOf("?");return r===-1?e:e.slice(0,r)}function dd(e){let r=new URLSearchParams(window.location.search),t={};Io.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=ld(i))}),Object.keys(t).length>0&&ra(t,e.searchParams,Io)}function Do(e){hd(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:u,...m}=e,h=new URL(od(r));if(h.pathname=`${ed}${a}`,a!==oe.SEGMENTATION&&a!==oe.CHANGE_PLAN_TEAM_PLANS&&sd(t,h.searchParams),ra({...m},h.searchParams,Ci),dd(h),c===He.DRAFT&&ra({af:Jl},h.searchParams,Ci),a===oe.SEGMENTATION){let p={marketSegment:i,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};u?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):u?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),ra(p,h.searchParams,Ci),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=cd({url:h,modal:l,is3in1:d})}return hr(h)}function hd(e){for(let r of rd)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==oe.SEGMENTATION&&e.workflowStep!==oe.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}function Ti(e,r){return e.length>0&&!r.perpetual&&!e.some(t=>t.commitment==="PERPETUAL")}function pd(e,r){if(!Ti(e,r))return;let[t]=e,a={clientId:r.checkoutClientId,clientType:"web",co:r.country,pa:t.productArrangementCode,cs:r.cs,ms:r.ms},i=r.preselectPlan?.toLowerCase();i==="edu"&&(a.ms="EDU"),i==="team"&&(a.cs="TEAM");let n=t.productArrangement?.productCode;n&&(a.pc=n);for(let c of["svar","customerIntent","sid"])r[c]&&(a[c]=r[c]);let o=new URL("https://commerce.adobe.com");o.searchParams.set("lang",r.language);let s={lang:new URL(hr(o)).searchParams.get("lang"),ctxrturl:r.ctxrturl??window.location.href,ot:t.offerType,items:e.map(({offerId:c},l)=>{let d=r.q??r.quantity?.[l]??r.quantity?.[0];return d==null?c:`${c}|${d}`}).join(",")};for(let[c,l]of Object.entries({step:r.checkoutWorkflowStep,apc:r.promotionCode,ao:r.addonProductArrangementCode,code:r.authCode,soSu:r["so.su"],soCa:r["so.ca"],soVa:r["so.va"],soTr:r["so.tr"],contextGuid:r["context.guid"],dcwatc:r.DCWATC}))l!=null&&(s[c]=l);for(let c of["step","apc","ao","ctx","ijt","otac","nglwfdata","appctxid","soSu","soCa","soVa","soTr","promoid","sdid","trackingid","mv","mv2","contextGuid","ai","sc","th","lo","gsp","spint","mal","csm","af","rf","usid","dcwatc","cf","rtc","ccli","csc","referrer","code","ew","pp","token","mat","pcid"])r[c]!=null&&(s[c]=r[c]);return{intent:t.offerType==="TRIAL"?"try":"buy",context:a,params:s}}async function Ho(e,r,t,a){let i=pd(r,t);if(!i)return!1;let n=await e.getOrchestratorContext();if(typeof n?.launchWorkflowInModal!="function")return!1;let o,s;if(a){let l=n.clientMessageHandler;s=(d,u,m)=>{let h=u?.data?.actions;return d==="System"&&u?.subType==="AppClosed"&&Array.isArray(h)&&(o=h.find(p=>p?.required&&p.actionMessage?.type==="System"&&p.actionMessage?.subType==="ReportState")?.actionMessage.data?.commerce?.cart),typeof l=="function"?l(d,u,m):m(d,u)}}let c=await(s?n.launchWorkflowInModal(i,s):n.launchWorkflowInModal(i));return c?.status==="cancel"&&Array.isArray(o)&&o.every(l=>typeof l?.productArrangementCode=="string")&&o.some(l=>l?.productArrangementCode===i.context.pa)&&a?.(o),c?.status!=="no-workflow-found"}var md=/[0-9\-+#]/,ud=/[^\d\-+#]/g;function Fo(e){return e.search(md)}function gd(e="#.##"){let r={},t=e.length,a=Fo(e);r.prefix=a>0?e.substring(0,a):"";let i=Fo(e.split("").reverse().join("")),n=t-i,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=i>0?e.substring(s,t):"",r.mask=e.substring(a,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(ud);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function fd(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=i.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),i.integer=o,i.fraction=s,vd(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function vd(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function xd(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=gd(e),i=fd(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var Bo=xd;var Uo=".",bd=",",Go=/^\s+/,qo=/\s+$/,$o="&nbsp;",ki=e=>e*12,at=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),u=new Date(i);return l>=d&&l<=u},rt={MONTH:"MONTH",YEAR:"YEAR"},yd={[pe.ANNUAL]:12,[pe.MONTHLY]:1,[pe.THREE_YEARS]:36,[pe.TWO_YEARS]:24},_i=(e,r)=>({accept:e,round:r}),wd=[_i(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),_i(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),_i(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],Li={[We.YEAR]:{[pe.MONTHLY]:rt.MONTH,[pe.ANNUAL]:rt.YEAR},[We.MONTH]:{[pe.MONTHLY]:rt.MONTH}},Ed=(e,r)=>e.indexOf(`'${r}'`)===0,Ad=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=jo(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Cd(e)}`),t},Sd=e=>{let r=Td(e),t=Ed(e,r),a=e.replace(/'.*?'/,""),i=Go.test(a)||qo.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},Vo=e=>e.replace(Go,$o).replace(qo,$o),Cd=e=>e.match(/#(.?)#/)?.[1]===Uo?bd:Uo,Td=e=>e.match(/'(.*?)'/)?.[1]??"",jo=e=>e.match(/0(.?)0/)?.[1]??"";function Dt({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1},i,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=Sd(e),l=t?jo(e):"",d=Ad(e,t),u=t?2:0,m=n(r,{currencySymbol:o}),h=a?m.toLocaleString("hi-IN",{minimumFractionDigits:u,maximumFractionDigits:u}):Bo(d,m),p=t?h.lastIndexOf(l):h.length,f=h.substring(0,p),x=h.substring(p+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var Wo=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=yd[t]??1;return Dt(e,i>1?rt.MONTH:Li[r]?.[t],n=>{let o={divisor:i,price:n,usePrecision:a},{round:s}=wd.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},Yo=({commitment:e,term:r,...t})=>Dt(t,Li[e]?.[r]),Xo=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===We.YEAR&&c===pe.MONTHLY){if(!o)return Dt(e,rt.YEAR,ki);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(at(o,t,s)){let u=parseInt(d.replace("P","").replace("M",""));if(isNaN(u))return ki(a);let m=i*u,h=n*(12-u),p=Math.round((m+h)*100)/100;return Dt({...e,price:p},rt.YEAR)}default:return Dt(e,rt.YEAR,()=>ki(n??a))}}return Dt(e,Li[r]?.[c])};var Pi="download",Ko="upgrade",Qo={e:"EDU",t:"TEAM"},Mi=!1;function Zo(e,r={},t=""){let a=ie();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:u,quantity:m,wcsOsi:h,extraOptions:p,analyticsId:f}=a.collectCheckoutOptions(r),x=ta(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:r.promotionCode===Yr?Yr:u,quantity:m,wcsOsi:h,extraOptions:p,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function Jo(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new qe(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0]?.marketSegments?.[0];return Qo[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return Qo[a]??a}get is3in1Modal(){return Object.values(Ye).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=ie();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>lr(h,n));let d=l.flat().find(h=>h.promotion);!at(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let m=await i.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},m,s)}renderOffers(a,i,n={},o=void 0,s=void 0){let c=ie();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(Pi,Ko),this.masElement.toggleResolved(s,a,i);let{url:d,text:u,className:m,handler:h}=o;d&&this.setCheckoutUrl(hr(d)),u&&(this.firstElementChild.innerHTML=u),m&&this.classList.add(...m.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(a.length){if(this.masElement.toggleResolved(s,a,i)){if(!this.classList.contains(Pi)&&!this.classList.contains(Ko)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}handleAupCheckout(a){if(a.defaultPrevented||a.button!==0||a.metaKey||a.ctrlKey||a.shiftKey||a.altKey||this.classList.contains(Pi)||this.hasAttribute("download")||this.target&&this.target!=="_self")return!1;let i=window.aupsdk;if(this.masElement.state!==de||!ie()?.settings.aupSelect||typeof i?.getOrchestratorContext!="function")return!1;let{checkoutActionHandler:n,href:o,value:s}=this,c=this.closest("merch-card"),l=this.getAttribute("data-modal-id"),d={...this.options,cs:this.customerSegment,ms:this.marketSegment};if(!Ti(s,d))return!1;if(a.preventDefault(),Mi)return!0;let u=()=>{if(n)return n(a);o&&(window.location.href=o)},m;return Mi=!0,this.aupCheckoutPromise=Ho(i,s,d,c&&l?h=>{m=h}:void 0).catch(h=>(this.masElement.log?.error("AUP checkout launch failed",h),!1)).then(async h=>{if(!h)try{return await u()}catch(p){this.masElement.log?.error("AUP checkout fallback failed",p);return}if(m)try{let p=s[0].productArrangementCode;if(this.masElement.state!==de||this.value[0]?.productArrangementCode!==p)return;let f=[...c.querySelectorAll('merch-addon [is="inline-price"]')];if(c.addonCheckbox&&(!f.length||f.some(w=>w.masElement.state!==de||!w.value?.length)))return;let x=f.flatMap(w=>w.value),y=m.filter(w=>w.productArrangementCode===p||x.some(b=>b.productArrangementCode===w.productArrangementCode));c.dispatchEvent(new CustomEvent(ya,{detail:{id:l,items:y,productArrangementCode:p}}))}catch(p){this.masElement.log?.warn("AUP checkout cart synchronization failed",p)}}).finally(()=>{Mi=!1}),!0}clickHandler(a){}updateOptions(a={}){let i=ie();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:u,promotionCode:m,quantity:h,wcsOsi:p}=i.collectCheckoutOptions(a);return No(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:u,promotionCode:m,quantity:h,wcsOsi:p}),!0}}}var pr=class pr extends Jo(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return Zo(pr,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(!this.handleAupCheckout(r)&&this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(pr,"is","checkout-link"),g(pr,"tag","a");var Re=pr;window.customElements.get(Re.is)||window.customElements.define(Re.is,Re,{extends:Re.tag});var N=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:oe.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:we.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:He.PUBLISHED});function es({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:u,quantity:m,preselectPlan:h,env:p}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:u,quantity:m,preselectPlan:h,env:p};if(o)for(let ze of r.checkout)ze(o,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:y=c,imsCountry:w,country:b=w??l,language:L=d,quantity:I=m,entitlement:D,upgrade:q,modal:j,perpetual:X,promotionCode:ee=u,wcsOsi:H,extraOptions:O,...te}=Object.assign(f,o?.dataset??{},n??{}),Q=cr(y,oe,N.checkoutWorkflowStep),{wcsOsi:Ie,promotionCodes:ue}=ea(H,ee),ct=ue.map(ze=>Xr(ze).effectivePromoCode);return f=jr({...te,extraOptions:O,checkoutClientId:s,checkoutMarketSegment:x,country:b,quantity:It(I,N.quantity),checkoutWorkflowStep:Q,language:L,entitlement:T(D),upgrade:T(q),modal:j,perpetual:T(X),promotionCode:ct[0],promotionCodes:ct,wcsOsi:Ie,preselectPlan:h}),f}function a(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:u,country:m,promotionCode:h,quantity:p,preselectPlan:f,ms:x,cs:y,...w}=t(o),b=document.querySelector("meta[name=mas-ff-3in1]"),L=Object.values(Ye).includes(o.modal)&&(!b||b.content!=="off"),I=window.frameElement||L?"if":"fp",[{productArrangementCode:D,marketSegments:[q],customerSegment:j,offerType:X}]=n,ee=x??q??d,H=y??j;f?.toLowerCase()==="edu"?ee="EDU":f?.toLowerCase()==="team"&&(H="TEAM");let O={is3in1:L,checkoutPromoCode:h,clientId:l,context:I,country:m,env:s,items:[],marketSegment:ee,customerSegment:H,offerType:X,productArrangementCode:D,workflowStep:u,landscape:c,...w},te=p[0]>1?p[0]:void 0;if(n.length===1){let{offerId:Q}=n[0];O.items.push({id:Q,quantity:te})}else O.items.push(...n.map(({offerId:Q,productArrangementCode:Ie})=>({id:Q,quantity:te,...L?{productArrangementCode:Ie}:{}})));return Do(O)}let{createCheckoutLink:i}=Re;return{CheckoutLink:Re,CheckoutWorkflowStep:oe,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}var kd="ims_country_code";function _d(){if(typeof document>"u")return null;let e=document.cookie.match(new RegExp(`(?:^|;\\s*)${kd}=([^;]*)`));if(!e)return null;let r;try{r=decodeURIComponent(e[1])}catch{return null}return r.trim().toUpperCase()||null}function Ld({interval:e=200,maxAttempts:r=25}={}){let t=ce.module("ims");return new Promise(a=>{t.debug("Waiting for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function Pd(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Md(){let e=_d();return e&&ce.module("ims").debug("Got user country from cookie:",e),Promise.resolve(e)}function ts(){let e=Ld();return{imsReadyPromise:e,imsSignedInPromise:Pd(e),imsCountryPromise:Md()}}var rs=window.masPriceLiterals;function as(e){if(Array.isArray(rs)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>rs.find(n=>si(n.lang,i)),a=t(r)??t(N.language);if(a)return Object.freeze(a)}return{}}var Ri=function(e,r){return Ri=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},Ri(e,r)};function mr(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");Ri(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var P=function(){return P=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},P.apply(this,arguments)};function aa(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var k;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(k||(k={}));var $;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})($||($={}));var it;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(it||(it={}));function Ni(e){return e.type===$.literal}function is(e){return e.type===$.argument}function ia(e){return e.type===$.number}function na(e){return e.type===$.date}function oa(e){return e.type===$.time}function sa(e){return e.type===$.select}function ca(e){return e.type===$.plural}function ns(e){return e.type===$.pound}function la(e){return e.type===$.tag}function da(e){return!!(e&&typeof e=="object"&&e.type===it.number)}function ur(e){return!!(e&&typeof e=="object"&&e.type===it.dateTime)}var Oi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var Rd=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function os(e){var r={};return e.replace(Rd,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var ss=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function hs(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(ss).filter(function(m){return m.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var u=d[l];if(u.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function Nd(e){return e.replace(/^(.*?)-/,"")}var cs=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,ps=/^(@+)?(\+|#+)?[rs]?$/g,Od=/(\*)(0+)|(#+)(0+)|(0+)/g,ms=/^(0+)$/;function ls(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(ps,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function us(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Id(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!ms.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function ds(e){var r={},t=us(e);return t||r}function gs(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=Nd(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=P(P(P({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return P(P({},c),ds(l))},{}));continue;case"engineering":r=P(P(P({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return P(P({},c),ds(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(Od,function(c,l,d,u,m,h){if(l)r.minimumIntegerDigits=d.length;else{if(u&&m)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(ms.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(cs.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(cs,function(c,l,d,u,m,h){return d==="*"?r.minimumFractionDigits=l.length:u&&u[0]==="#"?r.maximumFractionDigits=u.length:m&&h?(r.minimumFractionDigits=m.length,r.maximumFractionDigits=m.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=P(P({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=P(P({},r),ls(n)));continue}if(ps.test(i.stem)){r=P(P({},r),ls(i.stem));continue}var o=us(i.stem);o&&(r=P(P({},r),o));var s=Id(i.stem);s&&(r=P(P({},r),s))}return r}var gr={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function fs(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=zd(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function zd(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=gr[a||""]||gr[t||""]||gr["".concat(t,"-001")]||gr["001"];return i[0]}var Ii,Dd=new RegExp("^".concat(Oi.source,"*")),Hd=new RegExp("".concat(Oi.source,"*$"));function M(e,r){return{start:e,end:r}}var Fd=!!String.prototype.startsWith,Bd=!!String.fromCodePoint,Ud=!!Object.fromEntries,$d=!!String.prototype.codePointAt,Gd=!!String.prototype.trimStart,qd=!!String.prototype.trimEnd,Vd=!!Number.isSafeInteger,jd=Vd?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Di=!0;try{vs=ws("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Di=((Ii=vs.exec("a"))===null||Ii===void 0?void 0:Ii[0])==="a"}catch{Di=!1}var vs,xs=Fd?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},Hi=Bd?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,o;i>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");a+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return a},bs=Ud?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],o=n[0],s=n[1];t[o]=s}return t},ys=$d?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},Wd=Gd?function(r){return r.trimStart()}:function(r){return r.replace(Dd,"")},Yd=qd?function(r){return r.trimEnd()}:function(r){return r.replace(Hd,"")};function ws(e,r){return new RegExp(e,r)}var Fi;Di?(zi=ws("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Fi=function(r,t){var a;zi.lastIndex=t;var i=zi.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):Fi=function(r,t){for(var a=[];;){var i=ys(r,t);if(i===void 0||As(i)||Qd(i))break;a.push(i),t+=i>=65536?2:1}return Hi.apply(void 0,a)};var zi,Es=(function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,a);if(o.err)return o;i.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:$.pound,location:M(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(k.UNMATCHED_CLOSING_TAG,M(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&Bi(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;i.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;i.push(o.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:$.literal,value:"<".concat(i,"/>"),location:M(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Bi(this.char()))return this.error(k.INVALID_TAG,M(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(k.UNMATCHED_CLOSING_TAG,M(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:$.tag,value:i,children:o,location:M(a,this.clonePosition())},err:null}:this.error(k.INVALID_TAG,M(s,this.clonePosition())))}else return this.error(k.UNCLOSED_TAG,M(a,this.clonePosition()))}else return this.error(k.INVALID_TAG,M(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&Kd(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){i+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=M(a,this.clonePosition());return{val:{type:$.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!Xd(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return Hi.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),Hi(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(k.EMPTY_ARGUMENT,M(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(k.MALFORMED_ARGUMENT,M(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:$.argument,value:i,location:M(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(k.MALFORMED_ARGUMENT,M(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=Fi(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),o=M(r,n);return{value:a,location:o}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(k.EXPECT_ARGUMENT_TYPE,M(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),u=this.parseSimpleArgStyleIfPossible();if(u.err)return u;var m=Yd(u.val);if(m.length===0)return this.error(k.EXPECT_ARGUMENT_STYLE,M(this.clonePosition(),this.clonePosition()));var h=M(d,this.clonePosition());l={style:m,styleLocation:h}}var p=this.tryParseArgumentClose(i);if(p.err)return p;var f=M(i,this.clonePosition());if(l&&xs(l?.style,"::",0)){var x=Wd(l.style.slice(2));if(s==="number"){var u=this.parseNumberSkeletonFromString(x,l.styleLocation);return u.err?u:{val:{type:$.number,value:a,location:f,style:u.val},err:null}}else{if(x.length===0)return this.error(k.EXPECT_DATE_TIME_SKELETON,f);var y=x;this.locale&&(y=fs(x,this.locale));var m={type:it.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?os(y):{}},w=s==="date"?$.date:$.time;return{val:{type:w,value:a,location:f,style:m},err:null}}}return{val:{type:s==="number"?$.number:s==="date"?$.date:$.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(k.EXPECT_SELECT_ARGUMENT_OPTIONS,M(b,P({},b)));this.bumpSpace();var L=this.parseIdentifierIfPossible(),I=0;if(s!=="select"&&L.value==="offset"){if(!this.bumpIf(":"))return this.error(k.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,M(this.clonePosition(),this.clonePosition()));this.bumpSpace();var u=this.tryParseDecimalInteger(k.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,k.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(u.err)return u;this.bumpSpace(),L=this.parseIdentifierIfPossible(),I=u.val}var D=this.tryParsePluralOrSelectOptions(r,s,t,L);if(D.err)return D;var p=this.tryParseArgumentClose(i);if(p.err)return p;var q=M(i,this.clonePosition());return s==="select"?{val:{type:$.select,value:a,options:bs(D.val),location:q},err:null}:{val:{type:$.plural,value:a,options:bs(D.val),offset:I,pluralType:s==="plural"?"cardinal":"ordinal",location:q},err:null}}default:return this.error(k.INVALID_ARGUMENT_TYPE,M(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(k.EXPECT_ARGUMENT_CLOSING_BRACE,M(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(k.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,M(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=hs(r)}catch{return this.error(k.INVALID_NUMBER_SKELETON,t)}return{val:{type:it.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?gs(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,o=!1,s=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var u=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var m=this.tryParseDecimalInteger(k.EXPECT_PLURAL_ARGUMENT_SELECTOR,k.INVALID_PLURAL_ARGUMENT_SELECTOR);if(m.err)return m;d=M(u,this.clonePosition()),l=this.message.slice(u.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?k.DUPLICATE_SELECT_ARGUMENT_SELECTOR:k.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?k.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:k.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,M(this.clonePosition(),this.clonePosition()));var p=this.parseMessage(r+1,t,a);if(p.err)return p;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:p.val,location:M(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?k.EXPECT_SELECT_ARGUMENT_SELECTOR:k.EXPECT_PLURAL_ARGUMENT_SELECTOR,M(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(k.MISSING_OTHER_CLAUSE,M(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=M(i,this.clonePosition());return n?(o*=a,jd(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=ys(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(xs(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&As(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e})();function Bi(e){return e>=97&&e<=122||e>=65&&e<=90}function Xd(e){return Bi(e)||e===47}function Kd(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function As(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function Qd(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Ui(e){e.forEach(function(r){if(delete r.location,sa(r)||ca(r))for(var t in r.options)delete r.options[t].location,Ui(r.options[t].value);else ia(r)&&da(r.style)||(na(r)||oa(r))&&ur(r.style)?delete r.style.location:la(r)&&Ui(r.children)})}function Ss(e,r){r===void 0&&(r={}),r=P({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new Es(e,r).parse();if(t.err){var a=SyntaxError(k[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||Ui(t.val),t.val}function fr(e,r){var t=r&&r.cache?r.cache:ah,a=r&&r.serializer?r.serializer:rh,i=r&&r.strategy?r.strategy:Jd;return i(e,{cache:t,serializer:a})}function Zd(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Cs(e,r,t,a){var i=Zd(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function Ts(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function $i(e,r,t,a,i){return t.bind(r,e,a,i)}function Jd(e,r){var t=e.length===1?Cs:Ts;return $i(e,this,t,r.cache.create(),r.serializer)}function eh(e,r){return $i(e,this,Ts,r.cache.create(),r.serializer)}function th(e,r){return $i(e,this,Cs,r.cache.create(),r.serializer)}var rh=function(){return JSON.stringify(arguments)};function Gi(){this.cache=Object.create(null)}Gi.prototype.get=function(e){return this.cache[e]};Gi.prototype.set=function(e,r){this.cache[e]=r};var ah={create:function(){return new Gi}},ha={variadic:eh,monadic:th};var nt;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(nt||(nt={}));var vr=(function(e){mr(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r})(Error);var qi=(function(e){mr(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),nt.INVALID_VALUE,n)||this}return r})(vr);var ks=(function(e){mr(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),nt.INVALID_VALUE,i)||this}return r})(vr);var _s=(function(e){mr(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),nt.MISSING_VALUE,a)||this}return r})(vr);var re;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(re||(re={}));function ih(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==re.literal||t.type!==re.literal?r.push(t):a.value+=t.value,r},[])}function nh(e){return typeof e=="function"}function xr(e,r,t,a,i,n,o){if(e.length===1&&Ni(e[0]))return[{type:re.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(Ni(d)){s.push({type:re.literal,value:d.value});continue}if(ns(d)){typeof n=="number"&&s.push({type:re.literal,value:t.getNumberFormat(r).format(n)});continue}var u=d.value;if(!(i&&u in i))throw new _s(u,o);var m=i[u];if(is(d)){(!m||typeof m=="string"||typeof m=="number")&&(m=typeof m=="string"||typeof m=="number"?String(m):""),s.push({type:typeof m=="string"?re.literal:re.object,value:m});continue}if(na(d)){var h=typeof d.style=="string"?a.date[d.style]:ur(d.style)?d.style.parsedOptions:void 0;s.push({type:re.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(oa(d)){var h=typeof d.style=="string"?a.time[d.style]:ur(d.style)?d.style.parsedOptions:a.time.medium;s.push({type:re.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(ia(d)){var h=typeof d.style=="string"?a.number[d.style]:da(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(m=m*(h.scale||1)),s.push({type:re.literal,value:t.getNumberFormat(r,h).format(m)});continue}if(la(d)){var p=d.children,f=d.value,x=i[f];if(!nh(x))throw new ks(f,"function",o);var y=xr(p,r,t,a,i,n),w=x(y.map(function(I){return I.value}));Array.isArray(w)||(w=[w]),s.push.apply(s,w.map(function(I){return{type:typeof I=="string"?re.literal:re.object,value:I}}))}if(sa(d)){var b=d.options[m]||d.options.other;if(!b)throw new qi(d.value,m,Object.keys(d.options),o);s.push.apply(s,xr(b.value,r,t,a,i));continue}if(ca(d)){var b=d.options["=".concat(m)];if(!b){if(!Intl.PluralRules)throw new vr(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,nt.MISSING_INTL_API,o);var L=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[L]||d.options.other}if(!b)throw new qi(d.value,m,Object.keys(d.options),o);s.push.apply(s,xr(b.value,r,t,a,i,m-(d.offset||0)));continue}}return ih(s)}function oh(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=P(P({},e[a]),r[a]||{}),t},{})):e}function sh(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=oh(e[a],r[a]),t},P({},e)):e}function Vi(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function ch(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:fr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,aa([void 0],t,!1)))},{cache:Vi(e.number),strategy:ha.variadic}),getDateTimeFormat:fr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,aa([void 0],t,!1)))},{cache:Vi(e.dateTime),strategy:ha.variadic}),getPluralRules:fr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,aa([void 0],t,!1)))},{cache:Vi(e.pluralRules),strategy:ha.variadic})}}var Ls=(function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==re.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return xr(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=sh(e.formats,a),this.formatters=i&&i.formatters||ch(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Ss,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e})();var Ps=Ls;var br={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}",discountLabel:"{discount}%"},lh=xo("ConsonantTemplates/price"),dh=/<\/?[^>]+(>|$)/g,V={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ke={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},ji="TAX_EXCLUSIVE",hh=e=>fo(e)?Object.entries(e).filter(([,r])=>Nt(r)||Vr(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${go(a)}"`}`,""):"",W=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${V.disabled}`}"${hh(t)}>${a?Vo(r):r??""}</span>`;function ph(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function mh(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function be(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?ph(i):i,i=n?i.replace(dh,""):i;let s=new Ps(i,r).format(a);return o?mh(s):s}catch{return lh.error("Failed to format literal:",i),""}}function uh(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:u},m={}){let h=W(V.currencySymbol,a),p=W(V.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+p),f+=W(V.integer,s),f+=W(V.decimalsDelimiter,n),f+=W(V.decimals,i),c||(f+=p+h),f+=W(V.recurrence,l,null,!0),f+=W(V.unitType,d,null,!0),f+=W(V.taxInclusivity,u,!0),W(e,f,{...m})}var J=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:u,literals:m={},quantity:h=1,space:p=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:w,price:b,priceWithoutDiscount:L,taxDisplay:I,taxTerm:D,term:q,usePrecision:j,promotion:X}={},ee={})=>{Object.entries({country:o,formatString:w,language:u,price:b}).forEach(([uc,gc])=>{if(gc==null)throw new Error(`Argument "${uc}" is missing for osi ${y?.toString()}, country ${o}, language ${u}`)});let H={...br,...m},O=`${u.toLowerCase()}-${o.toUpperCase()}`,te;X&&!f&&L?te=e||a?b:L:t&&L?te=L:te=b;let Q=r?Wo:Yo;i&&(Q=Xo);let{accessiblePrice:Ie,recurrenceTerm:ue,...ct}=Q({commitment:x,formatString:w,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:L,price:r?b:te,promotion:X,quantity:h,term:q,usePrecision:j}),ze="",ua="",ga="";T(c)&&ue&&(ga=be(H,O,ke.recurrenceLabel,{recurrenceTerm:ue}));let Cr="";T(l)&&(p&&(Cr+=" "),Cr+=be(H,O,ke.perUnitLabel,{perUnit:"LICENSE"}));let Tr="";T(d)&&D&&(p&&(Tr+=" "),Tr+=be(H,O,I===ji?ke.taxExclusiveLabel:ke.taxInclusiveLabel,{taxTerm:D})),t&&(ze=be(H,O,ke.strikethroughAriaLabel,{strikethroughPrice:ze})),e&&(ua=be(H,O,ke.alternativePriceAriaLabel,{alternativePrice:ua}));let je=V.container;if(r&&(je+=` ${V.containerOptical}`),t&&(je+=` ${V.containerStrikethrough}`),a&&(je+=` ${V.containerPromoStrikethrough}`),e&&(je+=` ${V.containerAlternative}`),i&&(je+=` ${V.containerAnnual}`),T(s))return uh(je,{...ct,accessibleLabel:ze,altAccessibleLabel:ua,recurrenceLabel:ga,perUnitLabel:Cr,taxInclusivityLabel:Tr},ee);let{currencySymbol:en,decimals:lc,decimalsDelimiter:dc,hasCurrencySpace:tn,integer:hc,isCurrencyFirst:pc}=ct,lt=[hc,dc,lc];pc?(lt.unshift(tn?"\xA0":""),lt.unshift(en)):(lt.push(tn?"\xA0":""),lt.push(en)),lt.push(ga,Cr,Tr);let mc=lt.join("");return W(je,mc,ee)},Ms=()=>(e,r,t)=>{let a=at(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${J({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${J({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},Rs=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=at(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return J()(e,{...r,price:r.priceWithoutDiscount},t)+W(V.containerAnnualPrefix," (")+J({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+W(V.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${J({displayStrikethrough:!0})(n,r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${J({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${W(V.containerAnnualPrefix," (")}${J({displayAnnual:!0,instant:a})(n,r,t)}${W(V.containerAnnualSuffix,")")}`},Ns=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${J({isAlternativePrice:e.displayOldPrice})(e,r,t)}${W(V.containerAnnualPrefix," (")}${J({displayAnnual:!0})(a,r,t)}${W(V.containerAnnualSuffix,")")}`};var yr={...V,containerLegal:"price-legal",planType:"price-plan-type"},pa={...ke,planTypeLabel:"planTypeLabel"};function gh(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=W(yr.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=W(yr.taxInclusivity,t,!0),o+=W(yr.planType,a,null),W(e,o,{...i})}var Os=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,planTypeCase:n,language:o,literals:s={}}={},{taxDisplay:c,taxTerm:l,planType:d}={},u={})=>{let m={...br,...s},h=`${o.toLowerCase()}-${e.toUpperCase()}`,p="";T(r)&&(p=be(m,h,pa.perUnitLabel,{perUnit:"LICENSE"}));let f="";e==="US"&&o==="en"&&(t=!1),T(t)&&l&&(f=be(m,h,c===ji?pa.taxExclusiveLabel:pa.taxInclusiveLabel,{taxTerm:l}));let x="";T(a)&&d&&(x=be(m,h,pa.planTypeLabel,{planType:d})),x&&n&&(x=(n==="lower"?x[0].toLowerCase():x[0].toUpperCase())+x.slice(1));let y=yr.container;return y+=` ${yr.containerLegal}`,gh(y,{perUnitLabel:p,taxInclusivityLabel:f,planTypeLabel:x},u,i)};var Is=J(),zs=Ms(),Ds=J({displayOptical:!0}),Hs=J({displayStrikethrough:!0}),Fs=J({displayPromoStrikethrough:!0}),Bs=J({displayAnnual:!0}),Us=J({displayOptical:!0,isAlternativePrice:!0}),$s=J({isAlternativePrice:!0}),Gs=Ns(),qs=Rs(),Vs=Os;var fh={...ke,discountLabel:"discountLabel"},vh=(e,r)=>{if(!r&&Ot(e))return 0;if(!(!Ot(e)||!Ot(r)))return Math.floor((r-e)/r*100)},js=()=>(e,r)=>{let{country:t,language:a,literals:i={}}=e??{},{price:n,priceWithoutDiscount:o}=r,s=vh(n,o);if(s===void 0)return'<span class="no-discount"></span>';let c={...br,...i},l=a&&t?`${a.toLowerCase()}-${t.toUpperCase()}`:"en-US";return`<span class="discount">${be(c,l,fh.discountLabel,{discount:s,remainingPercent:100-s})}</span>`};var Ws=js();var Ys="INDIVIDUAL_COM",Yi="TEAM_COM",Xs="INDIVIDUAL_EDU",Xi="TEAM_EDU",xh=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh","KE_en","GH_en","TZ_en","AM_en","AZ_en","GE_en","MD_en","KZ_en","KG_en","TJ_en","UZ_en","OM_en","BH_en"],bh={[Ys]:[],[Yi]:[],[Xs]:[],[Xi]:[]},yh={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},wh=[Ys,Yi,Xs,Xi],Eh=e=>[Yi,Xi].includes(e);function Wi(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Ah=(e,r,t,a)=>{let i=`${t}_${a}`,n=Wi(yh,e,r,!1);if(n){let o=wh.indexOf(i);return n[o]}return Eh(i)},Sh=(e,r,t,a)=>{if(Wi(xh,e,r,!0))return!0;let i=bh[`${t}_${a}`];return i?Wi(i,e,r,!0)?!0:N.displayTax:N.displayTax},Ki=async(e,r,t,a)=>{let i=Sh(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Ah(e,r,t,a):N.forceTaxExclusive}},wr=class wr extends HTMLSpanElement{constructor(){super();g(this,"masElement",new qe(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=ie();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:h,alternativePrice:p,template:f,wcsOsi:x}=a.collectPriceOptions(t);return ta(wr,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:h,alternativePrice:p,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ve}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=ie();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let p=lr(h,n);return p?.length?p[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,u=Si(l);if(a.featureFlags[_e]||n[_e]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=u.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:p}=n,[f=""]=u.marketSegments,x=await Ki(h,p,u.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let w=lr(y,n);return w?.length?w[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[dt]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,p]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:p.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=Si(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=ie();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(wr,"is","inline-price"),g(wr,"tag","span");var Ne=wr;window.customElements.get(Ne.is)||window.customElements.define(Ne.is,Ne,{extends:Ne.tag});function Ks({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let X of r.price)X(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:u,displayTax:m,displayPlanType:h,forceTaxExclusive:p,perpetual:f,displayAnnual:x,promotionCode:y,quantity:w,alternativePrice:b,wcsOsi:L,...I}=Object.assign(c,s?.dataset??{},o??{}),{wcsOsi:D,promotionCodes:q}=ea(L,y),j=q.map(X=>Xr(X).effectivePromoCode);return c=jr(Object.assign({...c,...I,displayOldPrice:T(l),displayPerUnit:T(d),displayRecurrence:T(u),displayTax:T(m),displayPlanType:T(h),forceTaxExclusive:T(p),perpetual:T(f),displayAnnual:T(x),promotionCode:j[0],promotionCodes:j,quantity:It(w,N.quantity),alternativePrice:T(b),wcsOsi:D})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Ws;break;case"strikethrough":l=Hs;break;case"promo-strikethrough":l=Fs;break;case"annual":l=Bs;break;case"legal":l=Vs;break;default:s.template==="optical"&&s.alternativePrice?l=Us:s.template==="optical"?l=Ds:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?qs:Gs:s.alternativePrice?l=$s:l=s.promotionCode&&o[0].promotion?zs:Is}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Ne.createInlinePrice;return{InlinePrice:Ne,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Ch({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||N.language),r??(r=e?.split("_")?.[1]||N.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function Qs(e={},r){let t=r.featureFlags[_e],{commerce:a={}}=e,i=we.PRODUCTION,n=Da,o=F("checkoutClientId",a)??N.checkoutClientId,s=cr(F("checkoutWorkflowStep",a),oe,N.checkoutWorkflowStep),c=T(F("displayOldPrice",a),N.displayOldPrice),l=N.displayPerUnit,d=T(F("displayRecurrence",a),N.displayRecurrence),u=T(F("displayTax",a),N.displayTax),m=T(F("displayPlanType",a),N.displayPlanType),h=T(F("entitlement",a),N.entitlement),p=T(F("modal",a),N.modal),f=T(F("forceTaxExclusive",a),N.forceTaxExclusive),x=F("promotionCode",a)??N.promotionCode,y=It(F("quantity",a)),w=F("wcsApiKey",a)??N.wcsApiKey,b=a?.env==="stage",L=He.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(F(Ia,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",L=cr(F(za,a),He,L)),b&&(i=we.STAGE,n=Ha);let D=F(Oa)??e.preview,q=typeof D<"u"&&D!=="off"&&D!=="false",j={};q&&(j={preview:q});let X=F("mas-io-url")??e.masIOUrl,ee=pn(X)?X:`https://www${i===we.STAGE?".stage":""}.adobe.com/mas/io`,H=F("preselect-plan")??void 0,O=F("instant")??e.instant;return{...Ch(e),...j,get aupSelect(){return F("aup-select",{"aup-select":r.getAttribute("aup-select")},{search:!0,storage:!1})==="on"},displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:u,displayPlanType:m,entitlement:h,extraOptions:N.extraOptions,modal:p,env:i,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:N.alternativePrice,wcsApiKey:w,wcsURL:n,landscape:L,masIOUrl:ee,...H&&{preselectPlan:H},...O&&{instant:O}}}async function Zs(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var Qi="wcs";function Js({settings:e}){let r=ce.module(Qi),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(p,f,x=!0){let y=ie(),w=Ma;r.debug("Fetching:",p);let b="",L;if(p.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let I=new Map(f),[D]=p.offerSelectorIds,q=Date.now()+Math.random().toString(36).substring(2,7),j=`${Qi}:${D}:${q}${Ba}`,X=`${Qi}:${D}:${q}${Ua}`,ee;try{if(performance.mark(j),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",D),b.searchParams.set("country",p.country),b.searchParams.set("locale",p.locale),b.searchParams.set("landscape",t===we.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),p.language&&b.searchParams.set("language",p.language),p.promotionCode&&b.searchParams.set("promotion_code",p.promotionCode),p.currency&&b.searchParams.set("currency",p.currency),L=await Zs(b.toString(),{credentials:"omit"}),L.ok){let H=[];try{let O=await L.json();r.debug("Fetched:",p,O),H=O.resolvedOffers??[]}catch(O){r.error(`Error parsing JSON: ${O.message}`,{...O.context,...y?.duration})}H=H.map(Kr),f.forEach(({resolve:O},te)=>{let Q=H.filter(({offerSelectorIds:Ie})=>Ie.includes(te)).flat();Q.length&&(I.delete(te),f.delete(te),O(Q))})}else w=Pa}catch(H){w=`Network error: ${H.message}`}finally{ee=performance.measure(X,j),performance.clearMarks(j),performance.clearMeasures(X)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let H=Mo(L);f.forEach(O=>{O.reject(new zt(w,{...p,...H,response:L,measure:Mr(ee),...y?.duration}))})}}function l(){clearTimeout(o);let p=[...n.values()];n.clear(),p.forEach(({options:f,promises:x})=>c(f,x))}function d(p){if(!p||typeof p!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===we.STAGE?"stage":"prod",x=p[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,w]of Object.entries(x))i.set(y,Promise.resolve(w.map(Kr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function u(){let p=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${p} cache entries to stale cache`)}function m(p,f,x){let y=p!=="GB"&&!x?"MULT":"en",w=$a.includes(p)?p:N.country;return{validCountry:w,validLanguage:y,locale:`${f}_${w}`}}function h({country:p,language:f,perpetual:x=!1,promotionCode:y="",promotionCodes:w,wcsOsi:b=[]}){let{validCountry:L,validLanguage:I,locale:D}=m(p,f,x),q=Array.isArray(w)&&w.length?w:[y];return b.map((j,X)=>{let ee=q.length===1?q[0]:q[X]??"",H=[L,I,ee].filter(Q=>Q).join("-").toLowerCase(),O=`${j}-${H}`;if(i.has(O))return i.get(O);let te=new Promise((Q,Ie)=>{let ue=n.get(H);ue||(ue={options:{country:L,locale:D,...I==="MULT"&&{language:I},offerSelectorIds:[]},promises:new Map},n.set(H,ue)),ee&&(ue.options.promotionCode=ee),ue.options.offerSelectorIds.push(j),ue.promises.set(j,{resolve:Q,reject:Ie}),l()}).catch(Q=>{if(s.has(O))return s.get(O);throw Q});return i.set(O,te),te})}return{Commitment:We,PlanType:yo,Term:pe,applyPlanType:Kr,resolveOfferSelectors:h,flushWcsCacheInternal:u,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var ec="mas-commerce-service",tc="mas-commerce-service:start",rc="mas-commerce-service:ready",Er,Ht,ot,ac,Ji,Zi=class extends HTMLElement{constructor(){super(...arguments);S(this,ot);S(this,Er);S(this,Ht);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,Ht)||A(this,Ht,{[_e]:B(this,ot,Ji).call(this,_e),[dt]:B(this,ot,Ji).call(this,dt)}),v(this,Ht)}activate(){let t=v(this,ot,ac),a=Qs(t,this);Qr(t.lana);let i=ce.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:as(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...es(c),...ts(c),...Ks(c),...Js(c),...Ga,Log:ce,resolvePriceTaxFlags:Ki,get defaults(){return N},get log(){return ce},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(_r,{bubbles:!0,cancelable:!1,detail:this});performance.mark(rc),A(this,Er,performance.measure(rc,tc)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(tc),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(xa).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Mr(v(this,Er))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Er=new WeakMap,Ht=new WeakMap,ot=new WeakSet,ac=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},Ji=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||F(t))};window.customElements.get(ec)||window.customElements.define(ec,Zi);var sc="merch-card-collection",Th=3e4,kh={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},_h={plans:!0},Lh=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Ph=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,Mh=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Rh=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),Nh=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Ve,Bt,st,Sr,ma,cc,Ft=class extends nc{constructor(){super();S(this,ma);S(this,Ve,{});S(this,Bt);S(this,st);S(this,Sr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=hn(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Oe` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a=new Promise(i=>setTimeout(()=>i(!1),Th));return Promise.race([this.hydrationReady,a])}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===xe.alphabetical?Mh:Rh,s=[Lh,Ph,Nh,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Aa,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(ge,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){A(this,Ve,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,Ve)[a]=i)})}connectedCallback(){super.connectedCallback(),A(this,Bt,Yt()),v(this,Bt)&&A(this,st,v(this,Bt).Log.module(sc)),A(this,Sr,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",a),o.setAttribute("placeholder",""),o.innerHTML=i,this.append(o)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),_h[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Vt));let i=v(this,Sr)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(s=>{a=s});let i=this;function n(s){let c;return s.fields?.checkboxGroups?c=s.fields.checkboxGroups:s.fields?.tagFilters&&(c=[{title:s.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:s.fields.tagFilters.map(l=>{let d=l.split("/").pop(),u=s.settings?.tagLabels?.[d]||d;return u=u.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):u,{name:d,label:u}})}]),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(u,m){for(let h of m){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){v(i,st)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let p=s.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)p=b,f=b.referencesTree,s.references={...s.references,...b.references};else{v(i,st)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!p?.fields)continue;let{fields:y}=p,w={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(b=>c[b]||b):[],collections:[]};y.defaultchild&&(w.defaultchild=c[y.defaultchild]||y.defaultchild),u.push(w),d(w.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(Ca,s=>{B(this,ma,cc).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(Sa,async s=>{this.limit=27,this.data=o(s.detail,v(this,Ve)),s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?v(this,Ve)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let u=(p,f)=>{for(let x of p)if(x.defaultchild===f||x.collections&&u(x.collections,f))return!0;return!1};for(let p of c){let b=function(I){for(let D of I){let q=D.cards.indexOf(x);if(q===-1)continue;let j=D.queryLabel??D?.label?.toLowerCase()??"";f.filters[j]={order:q+1,size:p.fields.size},b(D.collections)}},f=document.createElement("merch-card"),x=v(this,Ve)[p.id]||p.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=p.fields.tags?.filter(I=>I.startsWith("mas:types/")).map(I=>I.split("/")[1]).join(",");y&&f.setAttribute("types",y),Nr(p.fields.variant)?.supportsDefaultChild&&(d?x===d:u(l,x))&&f.setAttribute("data-default-card","true"),b(l);let L=document.createElement("aem-fragment");L.setAttribute("fragment",x),f.append(L),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(p)+1,size:p.fields.size}}),this.append(f)}let m="",h=Oo(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(p=>p.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?m=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(m=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...kh[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Oe`<div id="footer">

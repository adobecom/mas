...
var ti = (i, t, e) =>
    t in i
        ? Ut(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
        : (i[t] = e);
var ri = (i, t) => () => (i && (t = i((i = 0))), t);
var ii = (i, t) => {
    for (var e in t) Ut(i, e, { get: t[e], enumerable: !0 });
};
var d = (i, t, e) => ti(i, typeof t != 'symbol' ? t + '' : t, e),
    ut = (i, t, e) => t.has(i) || Ht('Cannot ' + e);
var c = (i, t, e) => (
...
var ft = {};
ii(ft, { default: () => Y });
import { LitElement as ni, html as Ve, css as ai } from '/deps/lit-all.min.js';
function oi() {
    return (
...
import { LitElement as Ln } from '/deps/lit-all.min.js';
import { css as jt, unsafeCSS as Gt } from '/deps/lit-all.min.js';
var _ = '(max-width: 767px)',
    P = '(max-width: 1199px)',
    x = '(min-width: 768px)',
    u = '(min-width: 1200px)',
    N = '(min-width: 1600px)';
function He() {
    return window.matchMedia(_);
}
function qe() {
    ...
    handleTooltips() {
        ...
        this.querySelectorAll('sp-tooltip, overlay-trigger').forEach((e) => {
            ...
            if (e.tagName === 'SP-TOOLTIP')
                (r = e.textContent), (n = e.getAttribute('placement') || 'top');
            else if (e.tagName === 'OVERLAY-TRIGGER') {
                let a = e.querySelector('sp-tooltip');
                a &&
                    ((r = a.textContent),
                    (n =
            ...
            if (r) {
                ...
                a.setAttribute('content', r), a.setAttribute('placement', n);
...
var Xt = 'merch-offer-select:ready',
    Qt = 'merch-card:action-menu-toggle';
...
function sr(i, t) {
    ...
    return function () {
        let r = this,
            n = arguments;
        clearTimeout(e), (e = setTimeout(() => i.apply(r, n), t));
    };
}
    ...
    Xe = class extends HTMLElement {
        ...
        get value() {
            let e = c(this, Pe)
                ...
                .join(', ');
            return `linear-gradient(${c(this, Le)}, ${e})`;
        }
        connectedCallback() {
            c(this, le).call(this);
        }
        attributeChangedCallback(e, r, n) {
            e === 'border-radius' && h(this, X, n?.trim()),
                e === 'colors' && n
                    ? h(this, Pe, n?.split(',').map((a) => a.trim()) ?? [])
                    : e === 'positions' && n
                      ? h(this, Re, n?.split(',').map((a) => a.trim()) ?? [])
                      : e === 'angle' && h(this, Le, n?.trim() ?? ''),
                c(this, le).call(this);
        }
    };
(Le = new WeakMap()),
    ...
    (Re = new WeakMap()),
    (le = new WeakMap());
customElements.define('merch-gradient', Xe);
...
import { html as Qe, nothing as ui } from '/deps/lit-all.min.js';
var pe,
    Me = class Me {
        constructor(t) {
            d(this, 'card');
        ...
        updateCardElementMinHeight(t, e) {
            ...
            let r = `--consonant-merch-card-${this.card.variant}-${e}-height`,
                ...
                a =
                    ...
                    0;
            n > a && this.getContainer().style.setProperty(r, `${n}px`);
        }
        get badge() {
            let t;
            if (
        ...
        get secureLabel() {
            return this.card.secureLabel
                ? Qe`<span class="secure-transaction-label"
    ...
    ue = class extends v {
        ...
        removeEmptyRows() {
            this.card.querySelectorAll('.footer-row-cell').forEach((r) => {
                let n = r.querySelector('.footer-row-cell-description');
                n && !n.textContent.trim() && r.remove();
            });
        }
        get mainPrice() {
        ...
        toggleAddon(e) {
            ...
            if (!r && n) {
                let a = e?.getAttribute('plan-type'),
                    o = null;
                if (
                    (e &&
                        a &&
        ...
        async adjustAddon() {
            ...
            if (
                (r && (await r.onceSettled(), (n = r.value?.[0]?.planType)), !n)
            )
                return;
            (e.planType = n),
                this.card
    ...
    A = class extends v {
        ...
        adjustSlotPlacement(t, e, r) {
            ...
            let s = n.querySelector(`footer slot[name="${t}"]`),
                ...
                p = n.querySelector('.body');
            if (
                (o.includes('wide') ||
                    (a?.classList.remove('wide-footer'), s && s.remove()),
                !!e.includes(o))
            ) {
                if ((a?.classList.toggle('wide-footer', je()), !r && s)) {
                    if (l) s.remove();
                    else {
        ...
        adaptForMedia() {
            ...
            this.adjustSlotPlacement('addon', ['super-wide'], je()),
        ...
        async adjustEduLists() {
            ...
            a.classList.add('spacer'), e.insertBefore(a, n);
            let o = new IntersectionObserver(([s]) => {
                ...
                f && (l += 8 + _e(f));
                for (let ae of e.childNodes) {
                    if (ae.classList.contains('spacer')) break;
                    l += _e(ae);
                }
...
var fe = class extends v {
    ...
    postCardUpdateHook() {
        this.card.isConnected &&
            (this.adjustAddon(),
            Ge() || this.adjustProductBodySlots(),
            this.adjustTitleWidth());
    }
    get headingXSSlot() {
        return this.card.shadowRoot
...
var it = () => window.matchMedia(P).matches,
    ...
    ve = class extends v {
        ...
        handleChevronClick(t) {
            ...
            e.setAttribute('data-expanded', a);
        }
        renderLayout() {
            return Si`
...
import { css as Ci, html as ki } from '/deps/lit-all.min.js';
var Ar = `
...
C('catalog', me, lr, me.variantStyle);
C('image', Je);
C('inline-heading', et);
C('mini-compare-chart', ue, null, ue.variantStyle);
C('plans', A, rt, A.variantStyle, A.collectionOptions);
C('plans-students', A, br, A.variantStyle, A.collectionOptions);
C('plans-education', A, xr, A.variantStyle, A.collectionOptions);
C('product', fe, null, fe.variantStyle);
C('segment', xe, null, xe.variantStyle);
C('special-offers', be, wr, be.variantStyle);
C('simplified-pricing-express', ve, At, ve.variantStyle);
C('mini', ye, Cr, ye.variantStyle);
var Ct = (i) => {
    let t = nt.get(i.variant);
    if (!t) return;
    let { class: e, style: r } = t;
    if (r)
        try {
            let n = new CSSStyleSheet();
            n.replaceSync(r.cssText), i.shadowRoot.adoptedStyleSheets.push(n);
        } catch {
            let a = document.createElement('style');
            (a.textContent = r.cssText), i.shadowRoot.appendChild(a);
        }
    return new e(i);
};
function Ze(i) {
    return nt.get(i)?.fragmentMapping;
}
function kr(i) {
    return nt.get(i)?.collectionOptions;
}
...
function at(
    i,
    t = {},
    { metadata: e = !0, search: r = !0, storage: n = !0 } = {},
) {
    let a;
    if (r && a == null) {
...
var Q = class i extends Error {
    constructor(t, e, r) {
        if ((super(t, { cause: r }), (this.name = 'MasError'), e.response)) {
            let n = e.response.headers?.get(Ye);
            n && (e.requestId = n),
                e.response.status &&
...
function Lr(i) {
    ...
    let e = i.headers;
    for (let [r, n] of Object.entries(Pi)) {
        let a = e.get(n);
        a &&
            ((a = a.replace(/[,;]/g, '|')),
            (a = a.replace(/[| ]+/g, '|')),
...
async function Pr(i, t = {}, e = 2, r = 100) {
    ...
    for (let a = 0; a <= e; a++)
        try {
            ...
            if (((n = o), (n.retryCount = a), a > e)) break;
            await new Promise((s) => setTimeout(s, r * (a + 1)));
        }
    throw n;
}
var Rr = 'fragment',
            ...
            if (!this.has(t.id) && !this.has(t.fields?.originalId)) {
                ...
                if (
                    ...
                    for (let r in t.references) {
                        let { type: n, value: a } = t.references[r];
                        n === 'content-fragment' &&
...
var G = new Lt(),
    ...
    ct = class extends HTMLElement {
        ...
        attributeChangedCallback(e, r, n) {
            e === Rr && (h(this, k, n), h(this, y, G.getFetchInfo(n))),
                e === Or && Ri.includes(n) && h(this, Ne, n),
                e === Nr && h(this, $e, parseInt(n, 10)),
                e === Mr && h(this, Ie, ['', 'true'].includes(n)),
                e === zr && h(this, we, n);
        }
        connectedCallback() {
            if (!c(this, M)) {
                if (
                    (c(this, L) ?? h(this, L, W(this)),
                    h(this, we, c(this, L).settings?.preview),
                    c(this, Ee) ??
                        h(
                            this,
                            Ee,
                            c(this, L).log.module(`${_t}[${c(this, k)}]`),
                        ),
                    !c(this, k) || c(this, k) === '#')
                ) {
                    c(this, y) ??
                        h(this, y, G.getFetchInfo('missing-fragment-id')),
        ...
        async refresh(e = !0) {
            ...
            return (
                o &&
                    !at('mas.disableWcsCache') &&
                    c(this, L).prefillWcsCache(o),
                this.dispatchEvent(
                    new CustomEvent(se, {
                        detail: {
                            ...this.data,
        ...
        async generatePreview() {
            ...
            return await r(c(this, k), {
                locale: c(this, L).settings.locale,
                apiKey: c(this, L).settings.wcsApiKey,
            });
        }
    };
(Ee = new WeakMap()),
    ...
    (Dr = async function (e) {
        ...
        try {
            if (
                ...
                (c(this, y).measure = de(performance.measure(a, n))),
                (c(this, y).retryCount = o.retryCount),
                !o?.ok)
            )
                throw new Q('Unexpected fragment response', {
                    response: o,
                    ...c(this, L).duration,
                });
            return await o.json();
            ...
            throw new Q(`Failed to fetch fragment: ${l}`, {});
        }
    }),
    (Fr = function (e) {
        Object.assign(c(this, y), Lr(e));
    }),
    (Pt = function (e) {
        h(this, M, null), (c(this, y).message = e), this.classList.add('error');
        let r = { ...c(this, y), ...c(this, L).duration };
        c(this, Ee).error(e, r),
            this.dispatchEvent(
    ...
    (Br = async function () {
        ...
        let {
            ...
            s = `${r}/fragment?id=${c(this, k)}&api_key=${n}&locale=${o}`;
        return (
            a && !o.endsWith(`_${a}`) && (s += `&country=${a}`),
            (e = await w(this, z, Dr).call(this, s)),
            (l = e.fields).originalId ?? (l.originalId = c(this, k)),
            G.add(e),
            h(this, I, e),
            !0
        );
...
function Hr(i) {
    ...
    if (t === 'object') {
        ...
        if (typeof i.originatingRequest == 'string') {
            let { message: r, originatingRequest: n, status: a } = i;
            return [r, a, n].filter(Boolean).join(' ');
        }
        let e =
...
function Ui(i, t) {
    if (!J.ignoredProperties.includes(i)) return Hr(t);
}
var Mt = {
    append(i) {
        ...
        let { message: t, params: e } = i,
            ...
            a = t;
        e.forEach((p) => {
            p != null && (Bi(p) ? r : n).push(p);
        }),
            r.length && (a += ' ' + r.map(Hr).join(' '));
        let { pathname: o, search: s } = window.location,
            l = `${J.delimiter}page=${o}${s}`;
        l.length > Ur && (l = `${l.slice(0, Ur)}<trunc>`),
            (a += l),
            n.length &&
                ((a += `${J.delimiter}facts=`), (a += JSON.stringify(n, Ui))),
            window.lana?.log(a, J);
    },
};
function qr(i) {
...
var Gr = { LOCAL: 'local', PROD: 'prod', STAGE: 'stage' },
    zt = { DEBUG: 'debug', ERROR: 'error', INFO: 'info', WARN: 'warn' },
    Ot = new Set(),
    Nt = new Set(),
    jr = new Map(),
    Vr = {
        append({ level: i, message: t, params: e, timestamp: r, source: n }) {
            console[i](`${r}ms [${n}] %c${t}`, 'font-weight: bold;', ...e);
        },
    },
    Yr = { filter: ({ level: i }) => i !== zt.DEBUG },
    Hi = { filter: () => !1 };
function qi(i, t, e, r, n) {
    return {
        level: i,
        message: t,
        namespace: e,
...
function Kr(i) {
    ...
    let e = `${i} #${t}`,
        r = {
            id: e,
            namespace: i,
            module: (n) => Kr(`${r.namespace}/${n}`),
            updateConfig: qr,
        };
    return (
        Object.values(zt).forEach((n) => {
            r[n] = (a, ...o) => Gi(qi(n, a, i, o, e));
        }),
        Object.seal(r)
    );
}
...
function ji(i = {}) {
    let { name: t } = i,
        e = _r(
            at('commerce.debug', { search: !0, storage: !0 }),
            t === Gr.LOCAL,
        );
    return dt(e ? Vr : Yr), t === Gr.PROD && dt(Mt), $t;
}
function Vi() {
    Ot.clear(), Nt.clear();
}
...
var Yi = { [H]: tr, [K]: rr, [q]: ir },
    ...
    lt = class {
        ...
        connectedCallback() {
            h(this, Ue, Tt()), this.requestUpdate(!0);
        }
        disconnectedCallback() {
            this.connected &&
                ((this.connected = !1),
        ...
        toggleFailed(t, e, r) {
            ...
            return (
                this.log?.error(`${n}: Failed to render: ${e.message}`, {
                    element: this.wrapperElement,
                    ...e.context,
                    ...c(this, Ue)?.duration,
                }),
        ...
        requestUpdate(t = !1) {
            ...
            let { error: e, options: r, state: n, value: a, version: o } = this;
            (this.state = K),
                (this.timer = st(async () => {
                    this.timer = null;
                    let s = null;
...
var te,
    ee = class ee extends HTMLAnchorElement {
        ...
        attributeChangedCallback(e, r, n) {
            this.masElement.attributeChangedCallback(e, r, n);
        }
        connectedCallback() {
        ...
        async render() {
            ...
            let n = this.masElement.togglePending(r),
                a = e.resolveOfferSelectors(r);
            try {
                ...
                f && (m += `&promotion_code=${encodeURIComponent(f)}`),
                    (this.href = `${Wi(p)}?${m}`),
                    this.masElement.toggleResolved(n, o, r);
            } catch (o) {
                let s = new Error(
                    `Could not resolve offer selectors for id: ${r.wcsOsi}.`,
                    o.message,
                );
                return this.masElement.toggleFailed(n, s, r), !1;
            }
        }
        static createFrom(e) {
            let r = new ee();
...
function O(i, t, e, r) {
    ...
    if (t[i] && n) {
        ...
        if (n.maxCount && typeof o == 'string') {
            let [l, p] = yn(o, n.maxCount, n.withSuffix);
            l !== o && ((a.title = p), (o = l));
        }
        let s = S(n.tag, a, o);
        e.append(s);
...
function nn(i, t, e) {
    let r = i.mnemonicIcon?.map((a, o) => ({
        icon: a,
        alt: i.mnemonicAlt[o] ?? '',
        link: i.mnemonicLink[o] ?? '',
    }));
    r?.forEach(({ icon: a, alt: o, link: s }) => {
        if (s && !/^https?:/.test(s))
            try {
    ...
    if (e.badge?.slot) {
        if (i.badge?.length && !i.badge?.startsWith('<merch-badge')) {
            ...
            e.allowedBadgeColors?.includes(e.badge?.default) &&
                ((r = e.badge?.default), i.borderColor || (n = !0));
            let a = i.badgeBackgroundColor || r,
                o = i.borderColor || '';
            n && ((o = e.badge?.default), (i.borderColor = e.badge?.default)),
                (i.badge = `<merch-badge variant="${i.variant}" background-color="${a}" border-color="${o}">${i.badge}</merch-badge>`);
        }
        O('badge', i, t, e);
    } else
        i.badge
            ? (t.setAttribute('badge-text', i.badge),
              e.disabledAttributes?.includes('badgeColor') ||
                  t.setAttribute('badge-color', i.badgeColor || Xi),
            ...
            : t.setAttribute('border-color', i.borderColor || Qi);
}
function on(i, t, e) {
...
function pn(i, t, e) {
    ...
    if (i.borderColor?.toLowerCase() === 'transparent')
        ...
        } else t.style.setProperty(n, `var(--${i.borderColor})`);
}
function mn(i, t, e) {
...
function Xr(i, t, e) {
    let r = i.hasAttribute('data-wcs-osi') && !!i.getAttribute('data-wcs-osi'),
        n = i.className || '',
        a = Ji.exec(n)?.[0] ?? 'accent',
        o = a.includes('accent'),
        s = a.includes('primary'),
        l = a.includes('secondary'),
        p = a.includes('-outline'),
        m = a.includes('-link');
    i.classList.remove('accent', 'primary', 'secondary');
    let f;
    if (t.consonant) f = An(i, o, r, m, s);
    else if (m) f = i;
    else {
        let T;
        o ? (T = 'accent') : s ? (T = 'primary') : l && (T = 'secondary'),
            (f = t.spectrum === 'swc' ? Sn(i, e, p, T, r) : wn(i, e, p, T, r));
    }
    return f;
}
function un(i, t) {
...
function xn(i, t, e) {
    ...
    let n = S('merch-addon', { slot: 'addon' }, r);
...
function En(i, t) {
    t.querySelectorAll('a.upt-link').forEach((r) => {
        let n = j.createFrom(r);
        r.replaceWith(n), n.initializeWcsData(i.osi, i.promoCode);
    });
}
function wn(i, t, e, r, n) {
    ...
    for (let m of i.attributes)
        ['class', 'is'].includes(m.name) || a.setAttribute(m.name, m.value);
    ...
    return e && p.push('spectrum-Button--outline'), a.classList.add(...p), a;
}
function Sn(i, t, e, r, n) {
    let a = i;
    n &&
        ((a = customElements
            .get('checkout-button')
    ...
    return (
        (s.source = a),
        (n ? a.onceSettled() : Promise.resolve(a)).then((l) => {
            s.setAttribute('data-navigation-url', l.href);
        }),
        s.addEventListener('click', (l) => {
            l.defaultPrevented || a.click();
        }),
        s
    );
}
function An(i, t, e, r, n) {
    let a = i;
    return (
        e &&
            (a = customElements
...
function Cn(i, t, e, r) {
    if (i.ctas) {
        i.ctas = ht(i.ctas);
        let { slot: n } = e.ctas,
            a = S('div', { slot: n }, i.ctas),
            o = [...a.querySelectorAll('a')].map((s) => Xr(s, t, e));
...
function kn(i, t) {
    ...
    t.setAttribute(pt, r),
        [
            ...
            a.setAttribute(tn, `${a.dataset.analyticsId}-${o + 1}`);
        });
}
function Tn(i) {
    i.spectrum === 'css' &&
...
async function Qr(i, t) {
    ...
    let { id: e, fields: r, settings: n = {}, priceLiterals: a } = i,
        { variant: o } = r;
...
var Rn = 0,
    ...
    V = class extends Ln {
        ...
        get checkoutLinks() {
            return [...(this.footerSlot?.querySelectorAll(U) ?? [])];
        }
        get checkoutLinksDescription() {
            return [...(this.descriptionSlot?.querySelectorAll(U) ?? [])];
        }
        get checkoutLinkDescriptionCompare() {
            return [
                ...(this.descriptionSlotCompare?.querySelectorAll(U) ?? []),
            ];
        }
        ...
        async toggleStockOffer({ target: e }) {
            ...
            if (r.length !== 0)
                for (let n of r) {
                    ...
                    if (!o) return;
                    let s = n.dataset.wcsOsi.split(',').filter((l) => l !== o);
                    e.checked && s.push(o), (n.dataset.wcsOsi = s.join(','));
                }
        }
        changeHandler(e) {
            ...
            let n = (a) => {
                ...
                let l = e.getOsi(s, o),
                    p = (a.dataset.wcsOsi || '')
                        .split(',')
                        .filter((m) => m && m !== l);
                e.checked && p.push(l), (a.dataset.wcsOsi = p.join(','));
            };
            r.forEach(n);
        }
        handleQuantitySelection(e) {
            ...
            if (r.length !== 0)
                for (let n of r) n.dataset.quantity = e.detail.option;
        }
        get titleElement() {
        ...
        updateFilters(e) {
            ...
            Object.keys(r).forEach((n) => {
                if (e) {
                    r[n].order = Math.min(r[n].order || 2, 2);
                    return;
                }
                let a = r[n].order;
                a === 1 || isNaN(a) || (r[n].order = Number(a) + 1);
            }),
                (this.filters = r);
        }
        includes(e) {
        ...
        async checkReady() {
            ...
            c(this, ne) && (await c(this, ne), h(this, ne, void 0)),
                this.variantLayoutPromise &&
        ...
        displayFooterElementsInColumn() {
            ...
            (this.footerSlot?.querySelectorAll(U)).length === 2 &&
                e &&
        ...
        get promotionCode() {
            let e = [
                    ...this.querySelectorAll(
                        `${b}[data-promotion-code],${U}[data-promotion-code]`,
                    ),
...
(Ae = new WeakMap()),
    ...
    (re = function (e, r = {}, n = !0) {
        ...
        c(this, ke).error(`merch-card${o}: ${e}`, s),
            (this.failed = !0),
            n &&
                this.dispatchEvent(
                    new CustomEvent(er, {
    ...
    d(V, 'properties', {
        ...
        filters: {
            ...
            converter: {
                ...
                toAttribute: (e) =>
                    Object.entries(e)
                        .map(([r, { order: n, size: a }]) =>
                            [r, n, a].filter((o) => o != null).join(':'),
                        )
                        .join(','),
            },
        },
    ...
    d(V, 'styles', [Vt, ...Yt()]),
    d(V, 'registerVariant', C),
    d(V, 'getCollectionOptions', kr),

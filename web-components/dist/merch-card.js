var Yt=Object.defineProperty;var Kt=i=>{throw TypeError(i)};var pi=(i,t,e)=>t in i?Yt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var hi=(i,t)=>()=>(i&&(t=i(i=0)),t);var mi=(i,t)=>{for(var e in t)Yt(i,e,{get:t[e],enumerable:!0})};var d=(i,t,e)=>pi(i,typeof t!="symbol"?t+"":t,e),bt=(i,t,e)=>t.has(i)||Kt("Cannot "+e);var c=(i,t,e)=>(bt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Kt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),m=(i,t,e,r)=>(bt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),A=(i,t,e)=>(bt(i,t,"access private method"),e);var Wt=(i,t,e,r)=>({set _(a){m(i,t,a,e)},get _(){return c(i,t,r)}});var yt={};mi(yt,{default:()=>Z});import{LitElement as gi,html as Xe,css as ui}from"./lit-all.min.js";function fi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var Z,wt=hi(()=>{Z=class extends gi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Xe`<merch-icon
            src="${this.src}"
            size="${this.size}"
    ...
    `);customElements.define("mas-mnemonic",Z)});import{LitElement as Ha}from"./lit-all.min.js";import{css as Zt,unsafeCSS as Xt}from"./lit-all.min.js";var E="(max-width: 767px)",C="(max-width: 1199px)",v="(min-width: 768px)",u="(min-width: 1200px)",L="(min-width: 1600px)",Qt={matchMobile:window.matchMedia(E),matchDesktop:window.matchMedia(`${u} and (not ${L})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},f=Qt;function Oe(){return Qt.isDesktop}var Jt=Zt`
    :host {
...
`,er=()=>[Zt`
        ...
        `];import{LitElement as xi,html as tr,css as vi}from"./lit-all.min.js";function bi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var de=class extends xi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(bi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>wt())}e.remove()})}render(){let{href:t}=this;return t?tr`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(de,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(de,"styles",vi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",de);var tn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),rn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var b='span[is="inline-price"][data-wcs-osi]',G='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var yi='a[is="upt-link"]',rr=`${b},${G},${yi}`;var ir="merch-offer-select:ready",ar="merch-card:action-menu-toggle";var H="merch-quantity-selector:change",nr="merch-card-quantity:change",Et="merch-modal:addon-and-quantity-update";var pe="merch-card-collection:literals-changed";var he="aem:load",me="aem:error",or="mas:ready",sr="mas:error",cr="placeholder-failed",lr="placeholder-pending",dr="placeholder-resolved";var pr="mas:failed",Ne="mas:resolved",hr="mas/commerce";var V="failed",J="pending",Y="resolved";var Ze="X-Request-Id",an=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var nn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Je=":start",et=":duration";var tt="legal",mr="mas-ff-defaults";var wi="mas-commerce-service";function gr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function z(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function ge(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function kt(){return window.matchMedia("(max-width: 1024px)").matches}function ee(){return document.getElementsByTagName(wi)?.[0]}function De(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var $e,te,Ie,Fe,ue,rt=class extends HTMLElement{constructor(){super();g(this,$e,"");g(this,te);g(this,Ie,[]);g(this,Fe,[]);g(this,ue);m(this,ue,gr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,te)?this.parentElement.style.borderRadius=c(this,te):c(this,te)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Ie).map((r,a)=>{let n=c(this,Fe)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,$e)}, ${e})`}connectedCallback(){c(this,ue).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&m(this,te,a?.trim()),e==="colors"&&a?m(this,Ie,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?m(this,Fe,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,$e,a?.trim()??""),c(this,ue).call(this)}};$e=new WeakMap,te=new WeakMap,Ie=new WeakMap,Fe=new WeakMap,ue=new WeakMap;customElements.define("merch-gradient",rt);import{LitElement as Ei,html as ki,css as Si}from"./lit-all.min.js";var fe=class extends Ei{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${b}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Ne,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Ne,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return ki` <input
                type="checkbox"
                id="addon-checkbox"
...
`;var Li=32,ye=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?be`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),f.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};d(ye,"variantStyle",Ti`
...
`;var ct={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},kr={...function(){let{whatsIncluded:i,size:t,...e}=ct;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Sr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=ct;return a}()},_=class extends x{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===tt&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Er}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=a.querySelector(`footer slot[name="${t}"]`),l=a.querySelector(`.body slot[name="${t}"]`),p=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",f.isDesktopOrUp),!r&&s){if(l)s.remove();else{let h=p.querySelector(`[data-placeholder-for="${t}"]`);h?h.replaceWith(s):p.appendChild(s)}return}if(r&&l){let h=document.createElement("div");if(h.setAttribute("data-placeholder-for",t),h.classList.add("slot-placeholder"),!s){let y=l.cloneNode(!0);n.prepend(y)}l.replaceWith(h)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],f.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],f.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let a=r.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),e.insertBefore(n,a);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let l=0,p=this.card.querySelector('[slot="heading-s"]');p&&(l+=De(p));let h=this.card.querySelector('[slot="subtitle"]');h&&(l+=De(h));let y=this.card.querySelector('[slot="heading-m"]');y&&(l+=8+De(y));for(let B of e.childNodes){if(B.classList.contains("spacer"))break;l+=De(B)}let S=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(S)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${b}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?qe`<div class="divider"></div>`:st}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${b}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling),await n.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?qe`<label id="stock-checkbox">
    ...
    `),d(_,"collectionOptions",{customHeaderArea:t=>t.sidenav?qe`<slot name="resultsText"></slot>`:st,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let e=()=>{let r=t.querySelectorAll("merch-card");for(let n of r)n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"));if(!f.isDesktop)return;let a=0;for(let n of r){if(n.style.display==="none")continue;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&a%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),a+=s}};f.matchDesktop.addEventListener("change",e),t.addEventListener(pe,e),t.onUnmount.push(()=>{f.matchDesktop.removeEventListener("change",e),t.removeEventListener(pe,e)})}});import{html as q,css as _i,unsafeCSS as Cr,nothing as lt}from"./lit-all.min.js";var Ar=`
:root {
...
`;var Nr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ce=class extends x{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Or}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${b}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Fi`
            ${this.badge}
            <div class="body">
    ...
    `);var dt=new Map,T=(i,t,e=null,r=null,a)=>{dt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};T("catalog",ve,fr,ve.variantStyle);T("image",nt);T("inline-heading",ot);T("mini-compare-chart",ye,null,ye.variantStyle);T("plans",_,ct,_.variantStyle,_.collectionOptions);T("plans-students",_,Sr,_.variantStyle,_.collectionOptions);T("plans-education",_,kr,_.variantStyle,_.collectionOptions);T("plans-v2",K,Tr,K.variantStyle,K.collectionOptions);T("product",we,null,we.variantStyle);T("segment",Ee,null,Ee.variantStyle);T("special-offers",ke,Pr,ke.variantStyle);T("simplified-pricing-express",Se,Lt,Se.variantStyle);T("full-pricing-express",Ae,zt,Ae.variantStyle);T("mini",Ce,Nr,Ce.variantStyle);var _t=i=>{let t=dt.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let a=new CSSStyleSheet;a.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(a)}catch{let n=document.createElement("style");n.textContent=r.cssText,i.shadowRoot.appendChild(n)}return new e(i)};function at(i){return dt.get(i)?.fragmentMapping}function Dr(i){return dt.get(i)?.collectionOptions}var $r=document.createElement("style");$r.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var qi="mas-commerce-service",Ui={requestId:Ze,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var mt=i=>window.setTimeout(i);function Mt(){return document.getElementsByTagName(qi)?.[0]}function Fr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Ui)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Br(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Hr="fragment",qr="author",Ur="preview",jr="loading",Gr="timeout",Rt="aem-fragment",Vr="eager",Yr="cache",ji=[Vr,Yr],I,ie,O,Ot=class{constructor(){g(this,I,new Map);g(this,ie,new Map);g(this,O,new Map)}clear(){c(this,I).clear(),c(this,ie).clear(),c(this,O).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,O).has(t.id)){let[,r]=c(this,O).get(t.id);r()}if(c(this,O).has(t.fields?.originalId)){let[,r]=c(this,O).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,O).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,O).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ie).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ie).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,ie).delete(t),c(this,O).delete(t)}};I=new WeakMap,ie=new WeakMap,O=new WeakMap;var W=new Ot,Te,N,U,M,P,k,Ue,je,D,Ge,Ve,Le,$,Kr,Wr,Nt,Qr,gt=class extends HTMLElement{constructor(){super(...arguments);g(this,$);d(this,"cache",W);g(this,Te);g(this,N,null);g(this,U,null);g(this,M,null);g(this,P);g(this,k);g(this,Ue,Vr);g(this,je,5e3);g(this,D);g(this,Ge,!1);g(this,Ve,0);g(this,Le)}static get observedAttributes(){return[Hr,jr,Gr,qr,Ur]}attributeChangedCallback(e,r,a){e===Hr&&(m(this,P,a),m(this,k,W.getFetchInfo(a))),e===jr&&ji.includes(a)&&m(this,Ue,a),e===Gr&&m(this,je,parseInt(a,10)),e===qr&&m(this,Ge,["","true"].includes(a)),e===Ur&&m(this,Le,a)}connectedCallback(){if(!c(this,D)){if(c(this,M)??m(this,M,ee(this)),m(this,Le,c(this,M).settings?.preview),c(this,Te)??m(this,Te,c(this,M).log.module(`${Rt}[${c(this,P)}]`)),!c(this,P)||c(this,P)==="#"){c(this,k)??m(this,k,W.getFetchInfo("missing-fragment-id")),A(this,$,Nt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,D)&&!await Promise.race([c(this,D),Promise.resolve(!1)]))return;e&&W.remove(c(this,P)),c(this,Ue)===Yr&&await Promise.race([W.getAsPromise(c(this,P)),new Promise(s=>setTimeout(s,c(this,je)))]);try{m(this,D,A(this,$,Qr).call(this)),await c(this,D)}catch(s){return A(this,$,Nt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,N)||{};return o&&!pt("mas.disableWcsCache")&&c(this,M).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(he,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,D)}get updateComplete(){return c(this,D)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,Ge)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,N)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,N);m(this,U,e.reduce((p,{name:h,multiple:y,values:S})=>(p.fields[h]=y?S:S[0],p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,N);m(this,U,Object.entries(e).reduce((p,[h,y])=>(p.fields[h]=y?.mimeType?y.value:y??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,P),{locale:c(this,M).settings.locale,apiKey:c(this,M).settings.wcsApiKey})}};Te=new WeakMap,N=new WeakMap,U=new WeakMap,M=new WeakMap,P=new WeakMap,k=new WeakMap,Ue=new WeakMap,je=new WeakMap,D=new WeakMap,Ge=new WeakMap,Ve=new WeakMap,Le=new WeakMap,$=new WeakSet,Kr=async function(e){Wt(this,Ve)._++;let r=`${Rt}:${c(this,P)}:${c(this,Ve)}`,a=`${r}${Je}`,n=`${r}${et}`;if(c(this,Le))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await Br(e,{cache:"default",credentials:"omit"}),A(this,$,Wr).call(this,o),c(this,k).status=o?.status,c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new re("Unexpected fragment response",{response:o,...c(this,M).duration});return await o.json()}catch(s){if(c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,N))return c(this,k).stale=!0,c(this,Te).error("Serving stale data",c(this,k)),c(this,N);let l=s.message??"unknown";throw new re(`Failed to fetch fragment: ${l}`,{})}},Wr=function(e){Object.assign(c(this,k),Fr(e))},Nt=function(e){m(this,D,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,M).duration};c(this,Te).error(e,r),this.dispatchEvent(new CustomEvent(me,{detail:r,bubbles:!0,composed:!0}))},Qr=async function(){var l;this.classList.remove("error"),m(this,U,null);let e=W.get(c(this,P));if(e)return m(this,N,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,M).settings,s=`${r}/fragment?id=${c(this,P)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await A(this,$,Kr).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,P)),W.add(e),m(this,N,e),!0},d(gt,"cache",W);customElements.define(Rt,gt);import{LitElement as Gi,html as Vi,css as Yi}from"./lit-all.min.js";var ze=class extends Gi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Vi`<div class="badge">${this.text}</div>`}};d(ze,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),d(ze,"styles",Yi`
        :host {
            display: block;

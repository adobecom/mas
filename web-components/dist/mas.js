...
`,xc=()=>[b`
    ...
    `);customElements.define("merch-addon",Gt);P();var Vt,Kr=class Kr{constructor(t){m(this,"card");E(this,Vt);this.card=t,this.insertVariantStyle()}getContainer(){return y(this,Vt,h(this,Vt)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),h(this,Vt)}insertVariantStyle(){let t=this.constructor.name;if(!Kr.styleMap[t]){Kr.styleMap[t]=!0;let r=document.createElement("style");r.innerHTML=this.getGlobalCSS(),document.head.appendChild(r)}}updateCardElementMinHeight(t,r){if(!t||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),u`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Yi(this.card.variant)}};Vt=new WeakMap,m(Kr,"styleMap",{});var A=Kr;P();var vc=`
:root {
...
`;var Ki={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},_c={...function(){let{whatsIncluded:e,size:t,...r}=Ki;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Pc={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...a}=Ki;return a}()},Ie,ge=class extends A{constructor(r){super(r);E(this,Ie);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(r,i){r.dataset.template===xe&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Tc}adjustSlotPlacement(r,i,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${r}"]`),l=n.querySelector(`.body slot[name="${r}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!i.includes(s)){if(o?.classList.toggle("wide-footer",R.isDesktopOrUp),!a&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${r}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(a&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",r),p.classList.add("slot-placeholder"),!c){let g=l.cloneNode(!0);o.prepend(g)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],R.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],R.isDesktopOrUp)}adjustCallout(){let r=this.card.querySelector('[slot="callout-content"] .icon-button');r&&r.title&&(r.dataset.tooltip=r.title,r.removeAttribute("title"),r.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==r?r.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==r?r.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){h(this,Ie)||(y(this,Ie,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(h(this,Ie)?.disconnect(),y(this,Ie,null),this.syncHeights())})),h(this,Ie).observe(this.card));return}["heading-xs","subtitle","heading-m","promo-text","body-xs"].forEach(i=>{let a=this.card.querySelector(`[slot="${i}"]`);a&&this.updateCardElementMinHeight(a,i)})}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),i.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Ir(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=Ir(p));let g=this.card.querySelector('[slot="heading-m"]');g&&(l+=8+Ir(g));for(let x of i.childNodes){if(x.classList.contains("spacer"))break;l+=Ir(x)}let f=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(f)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){if(this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),window.matchMedia("(min-width: 768px)").matches){let r=this.getContainer();if(!r)return;let i=`--consonant-merch-card-${this.card.variant}`,a=r.style.getPropertyValue(`${i}-heading-xs-height`);requestAnimationFrame(a?()=>{this.syncHeights()}:()=>{r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(o=>o.variantLayout?.syncHeights?.())})}}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${D}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?u`<div class="divider"></div>`:w}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=[],i=this.card.querySelector(`[slot="heading-m"] ${D}[data-template="price"]`);i&&r.push(i);let a=r.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let r=this.card.addon;if(!r)return;r.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(r.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?u`<label id="stock-checkbox">
    ...
    `),m(ge,"collectionOptions",{customHeaderArea:r=>r.sidenav?u`<slot name="resultsText"></slot>`:w,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let i=()=>{let a=r.querySelectorAll("merch-card");for(let o of a)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!R.isDesktop)return;let n=0;for(let o of a){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};R.matchDesktop.addEventListener("change",i),r.addEventListener(nt,i),r.onUnmount.push(()=>{R.matchDesktop.removeEventListener("change",i),r.removeEventListener(nt,i)})}});P();var Lc=`
:root {
...
`;var Oc={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},be,Xt=class extends A{constructor(){super(...arguments);m(this,"expanded",!1);m(this,"licenseOpen",!1);m(this,"licenseQty",null);E(this,be,null);m(this,"toggleExpanded",r=>{r.preventDefault(),this.expanded=!this.expanded,this.card.requestUpdate()});m(this,"toggleLicensePopover",r=>{r.preventDefault(),r.stopPropagation(),this.licenseOpen=!this.licenseOpen,this.licenseOpen?(y(this,be,i=>{i.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),document.removeEventListener("mousedown",h(this,be)),y(this,be,null))}),document.addEventListener("mousedown",h(this,be))):h(this,be)&&(document.removeEventListener("mousedown",h(this,be)),y(this,be,null)),this.card.requestUpdate()});m(this,"selectLicenseQty",r=>{this.licenseQty=r,this.licenseOpen=!1,h(this,be)&&(document.removeEventListener("mousedown",h(this,be)),y(this,be,null));let i=this.quantitySelectEl;i&&(i.selectedValue=Number(r),i.dispatchEvent(new CustomEvent(Z,{detail:{option:Number(r)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return Rc}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){return!!this.card.querySelector('[slot="quantity-select"]')}get hasPerUnitLabel(){return!!this.card.querySelector('[slot="per-unit-label"]')}get hasPriceOriginal(){return!!this.card.querySelector('[slot="price-original"]')}get hasTermsLink(){return!!this.card.querySelector('[slot="terms-link"]')}get hasAddOn(){return!!this.card.querySelector('[slot="add-on"]')}get hasLegalText(){return!!this.card.querySelector('[slot="legal-text"]')}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let r=this.card.getAttribute("license-options");if(r)return r.split(",").map(c=>c.trim()).filter(Boolean);let i=this.quantitySelectEl;if(!i)return null;let a=parseInt(i.getAttribute("min"),10),n=parseInt(i.getAttribute("max"),10),o=parseInt(i.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(n)||n<a)return null;let s=[];for(let c=a;c<=n;c+=o)s.push(String(c));return s.length?s:null}get licenseLabel(){return this.card.getAttribute("license-label")||this.quantitySelectEl?.getAttribute("title")||"License"}get licenseLabelPlural(){return this.card.getAttribute("license-label-plural")??`${this.licenseLabel}s`}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let r=this.licenseOptions;if(!r?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let i=this.quantitySelectEl?.getAttribute("default-value");return i!=null&&r.includes(i)?i:r[0]}formatLicenseRow(r){let a=String(r).replace(/\D/g,"")==="1"?this.licenseLabel:this.licenseLabelPlural;return{value:r,label:a}}renderLicenseSelector(){if(!this.hasLicenseSelector)return u`<slot name="quantity-select"></slot>`;let r=this.licenseOptions,i=this.currentLicenseValue,a=!!this.licenseOpen,{value:n,label:o}=this.formatLicenseRow(i);return u`
        ...
        `}renderLayout(){let r=!!this.expanded;return u`
            ...
            ${this.hasWhatsIncluded?u`
                  ...
                  `:w}
            <slot></slot>
        `}};be=new WeakMap,m(Xt,"variantStyle",b`
...
`;var zc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Kt=class extends A{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Nc}priceOptionsProvider(t,r){t.dataset.template===xe&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return u` ${this.badge}
...
`;var Dc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Qt=class extends A{constructor(t){super(t)}priceOptionsProvider(t,r){t.dataset.template===xe&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}getGlobalCSS(){return Ic}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${D}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let r=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),t.parentNode.insertBefore(r,t.nextSibling),await r.onceSettled()}catch{}}renderLayout(){return u`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;document.head.appendChild(Zc);var Jc="fragment",el="author",tl="preview",rl="loading",il="timeout",Hn="aem-fragment",al="eager",nl="cache",lp=[al,nl],De,St,Pe,Bn=class{constructor(){E(this,De,new Map);E(this,St,new Map);E(this,Pe,new Map)}clear(){h(this,De).clear(),h(this,St).clear(),h(this,Pe).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(h(this,De).set(t.id,t),t.fields?.originalId&&h(this,De).set(t.fields.originalId,t),h(this,Pe).has(t.id)){let[,i]=h(this,Pe).get(t.id);i()}if(h(this,Pe).has(t.fields?.originalId)){let[,i]=h(this,Pe).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return h(this,De).has(t)}entries(){return h(this,De).entries()}get(t){return h(this,De).get(t)}getAsPromise(t){let[r]=h(this,Pe).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),h(this,Pe).set(t,[r,i]),r}getFetchInfo(t){let r=h(this,St).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},h(this,St).set(t,r)),r}remove(t){h(this,De).delete(t),h(this,St).delete(t),h(this,Pe).delete(t)}};De=new WeakMap,St=new WeakMap,Pe=new WeakMap;var Je=new Bn,nr,Le,Ve,Ae,fe,ee,Qr,Zr,Me,Jr,ei,or,Re,ol,sl,Fn,cl,Zi=class extends HTMLElement{constructor(){super(...arguments);E(this,Re);m(this,"cache",Je);E(this,nr);E(this,Le,null);E(this,Ve,null);E(this,Ae,null);E(this,fe);E(this,ee);E(this,Qr,al);E(this,Zr,5e3);E(this,Me);E(this,Jr,!1);E(this,ei,0);E(this,or)}static get observedAttributes(){return[Jc,rl,il,el,tl]}attributeChangedCallback(r,i,a){r===Jc&&(y(this,fe,a),y(this,ee,Je.getFetchInfo(a))),r===rl&&lp.includes(a)&&y(this,Qr,a),r===il&&y(this,Zr,parseInt(a,10)),r===el&&y(this,Jr,["","true"].includes(a)),r===tl&&y(this,or,a)}connectedCallback(){if(!h(this,Me)){if(h(this,Ae)??y(this,Ae,gt(this)),y(this,or,h(this,Ae).settings?.preview),h(this,nr)??y(this,nr,h(this,Ae).log.module(`${Hn}[${h(this,fe)}]`)),!h(this,fe)||h(this,fe)==="#"){h(this,ee)??y(this,ee,Je.getFetchInfo("missing-fragment-id")),J(this,Re,Fn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(h(this,ee)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(h(this,Me)&&!await Promise.race([h(this,Me),Promise.resolve(!1)]))return;r&&Je.remove(h(this,fe)),h(this,Qr)===nl&&await Promise.race([Je.getAsPromise(h(this,fe)),new Promise(s=>setTimeout(s,h(this,Zr)))]);try{y(this,Me,J(this,Re,cl).call(this)),await h(this,Me)}catch(s){return J(this,Re,Fn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=h(this,Le)||{};return o&&!U("mas.disableWcsCache")&&h(this,Ae).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ot,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...h(this,ee)},bubbles:!0,composed:!0})),h(this,Me)}get updateComplete(){return h(this,Me)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return h(this,Ve)?h(this,Ve):(h(this,Jr)?this.transformAuthorData():this.transformPublishData(),h(this,Ve))}get rawData(){return h(this,Le)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=h(this,Le);y(this,Ve,r.reduce((d,{name:p,multiple:g,values:f})=>(d.fields[p]=g?f:f[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=h(this,Le);y(this,Ve,Object.entries(r).reduce((d,[p,g])=>(d.fields[p]=g?.mimeType?g.value:g??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(h(this,fe),{locale:h(this,Ae).settings.locale,apiKey:h(this,Ae).settings.wcsApiKey,fullContext:!0})}};nr=new WeakMap,Le=new WeakMap,Ve=new WeakMap,Ae=new WeakMap,fe=new WeakMap,ee=new WeakMap,Qr=new WeakMap,Zr=new WeakMap,Me=new WeakMap,Jr=new WeakMap,ei=new WeakMap,or=new WeakMap,Re=new WeakSet,ol=async function(r){ao(this,ei)._++;let i=`${Hn}:${h(this,fe)}:${h(this,ei)}`,a=`${i}${lt}`,n=`${i}${dt}`;if(h(this,or)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Ne(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(h(this,ee).stale=!1,h(this,ee).url=r,o=await $i(r,{cache:"default",credentials:"omit"}),J(this,Re,sl).call(this,o),h(this,ee).status=o?.status,h(this,ee).measure=ze(performance.measure(n,a)),h(this,ee).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...h(this,Ae).duration});return await o.json()}catch(s){if(h(this,ee).measure=ze(performance.measure(n,a)),h(this,ee).retryCount=s.retryCount,h(this,Le))return h(this,ee).stale=!0,h(this,nr).error("Serving stale data",h(this,ee)),h(this,Le);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},sl=function(r){Object.assign(h(this,ee),Ei(r))},Fn=function(r){y(this,Me,null),h(this,ee).message=r,this.classList.add("error");let i={...h(this,ee),...h(this,Ae).duration};h(this,nr).error(r,i),this.dispatchEvent(new CustomEvent(st,{detail:i,bubbles:!0,composed:!0}))},cl=async function(){var c;this.classList.remove("error"),y(this,Ve,null);let r=Je.get(h(this,fe));if(r)return y(this,Le,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=h(this,Ae).settings,s=`${i}/fragment?id=${h(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await J(this,Re,ol).call(this,s),(c=r.fields).originalId??(c.originalId=h(this,fe)),Je.add(r),y(this,Le,r),!0},m(Zi,"cache",Je);customElements.define(Hn,Zi);P();Vr();var ll={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},dl=e=>(...t)=>({_$litDirective$:e,values:t}),Ji=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,i){this._$Ct=t,this._$AM=r,this._$Ci=i}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};var ti=class extends Ji{constructor(t){if(super(t),this.et=w,t.type!==ll.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===w||t==null)return this.ft=void 0,this.et=t;if(t===Ge)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let r=[t];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};ti.directiveName="unsafeHTML",ti.resultType=1;var hl=dl(ti);var dp=e=>e?e.startsWith("sp-icon-")?u`${hl(`<${e} class="badge-icon"></${e}>`)}`:u`<img src="${e}" class="badge-icon" />`:w,sr=class extends q{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return u`<div class="badge">
    ...
    `),m(ri,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ri);P();var ii=class extends q{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return u`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?u`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:w}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};m(ii,"styles",b`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),m(si,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",si);P();P();var wl=b`
    :host {
...
`;var kl={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},mr=class extends A{getGlobalCSS(){return Cl}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return u` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};m(mr,"variantStyle",b`

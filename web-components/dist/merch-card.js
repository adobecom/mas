var fr=Object.defineProperty;var vr=a=>{throw TypeError(a)};var ii=(a,t,e)=>t in a?fr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var ni=(a,t)=>()=>(a&&(t=a(a=0)),t);var oi=(a,t)=>{for(var e in t)fr(a,e,{get:t[e],enumerable:!0})};var h=(a,t,e)=>ii(a,typeof t!="symbol"?t+"":t,e),$t=(a,t,e)=>t.has(a)||vr("Cannot "+e);var s=(a,t,e)=>($t(a,t,"read from private field"),e?e.call(a):t.get(a)),f=(a,t,e)=>t.has(a)?vr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),g=(a,t,e,r)=>($t(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),T=(a,t,e)=>($t(a,t,"access private method"),e);var xr=(a,t,e,r)=>({set _(i){g(a,t,i,e)},get _(){return s(a,t,r)}});var Bt={};oi(Bt,{default:()=>We});import{LitElement as ci,html as xe,css as si,nothing as li}from"./lit-all.min.js";import{unsafeHTML as Sr}from"./lit-all.min.js";import{ifDefined as di}from"./lit-all.min.js";function hi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var _,We,Ht=ni(()=>{_=class _ extends ci{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();_.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let t=this.shadowRoot?.querySelector(".css-tooltip");if(!t)return;let e=t.getBoundingClientRect(),r=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-p-n<0?u="bottom":u==="bottom"&&e.bottom+p+n>i?u="top":u==="left"&&e.left-d-n<0?u="right":u==="right"&&e.right+d+n>r&&(u="left");let C=e.left+e.width/2,$=e.top+e.height/2,Q=6,ht=(ti,ri,ai)=>Math.max(ti,Math.min(ri,ai)),pt,mt,It;u==="top"||u==="bottom"?(pt=u==="top"?e.top-p-n:e.bottom+n,mt=ht(0,r-d,C-d/2),It=ht(Q,d-Q*2,C-mt-Q)):(mt=u==="left"?e.left-d-n:e.right+n,pt=ht(0,i-p,$-p/2),It=ht(Q,p-Q*2,$-pt-Q)),this._tooltipTop=pt,this._tooltipLeft=mt,this._arrowOffset=It,this._computedPlacement=u}showTooltip(){_.activeTooltip&&_.activeTooltip!==this&&(_.activeTooltip.closeOverlay(),_.activeTooltip.tooltipVisible=!1,_.activeTooltip.requestUpdate()),_.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){_.activeTooltip===this&&(_.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?xe`<merch-icon
    ...
    `);We=_;customElements.define("mas-mnemonic",We)});import{LitElement as no}from"./lit-all.min.js";import{css as wr,unsafeCSS as yr}from"./lit-all.min.js";var w="(max-width: 767px)",L="(max-width: 1199px)",E="(min-width: 768px)",v="(min-width: 1200px)",P="(min-width: 1600px)",br={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${v} and (not ${P})`),matchDesktopOrUp:window.matchMedia(v),matchLargeDesktop:window.matchMedia(P),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},b=br;function gt(){return br.isDesktop}var Er=wr`
    :host {

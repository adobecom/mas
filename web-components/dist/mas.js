...
`,vc=()=>[b`
    ...
    `);customElements.define("merch-icon",Gt);var Xr,Et,Kr,Qr,qt,Yi=class extends HTMLElement{constructor(){super();E(this,Xr,"");E(this,Et);E(this,Kr,[]);E(this,Qr,[]);E(this,qt);y(this,qt,Ir(()=>{this.isConnected&&(this.parentElement.style.background=this.value,m(this,Et)?this.parentElement.style.borderRadius=m(this,Et):m(this,Et)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let r=m(this,Kr).map((i,a)=>{let n=m(this,Qr)[a]||"";return`${i} ${n}`}).join(", ");return`linear-gradient(${m(this,Xr)}, ${r})`}connectedCallback(){m(this,qt).call(this)}attributeChangedCallback(r,i,a){r==="border-radius"&&y(this,Et,a?.trim()),r==="colors"&&a?y(this,Kr,a?.split(",").map(n=>n.trim())??[]):r==="positions"&&a?y(this,Qr,a?.split(",").map(n=>n.trim())??[]):r==="angle"&&y(this,Xr,a?.trim()??""),m(this,qt).call(this)}};Xr=new WeakMap,Et=new WeakMap,Kr=new WeakMap,Qr=new WeakMap,qt=new WeakMap;customElements.define("merch-gradient",Yi);M();var Vt=class extends G{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,r){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[r]||[r]).map(s=>`p[data-plan-type="${t}"] ${D}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Mt,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Mt,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let r=t.target,i=r?.value?.[0];i&&(r.setAttribute("data-offer-type",i.offerType),r.closest("p").setAttribute("data-plan-type",i.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return f` <input
                type="checkbox"
                id="addon-checkbox"
    ...
    `);customElements.define("merch-addon",Vt);M();var jt,Zr=class Zr{constructor(t){u(this,"card");E(this,jt);this.card=t,this.insertVariantStyle()}getContainer(){return y(this,jt,m(this,jt)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),m(this,jt)}insertVariantStyle(){let t=this.constructor.name;if(!Zr.styleMap[t]){Zr.styleMap[t]=!0;let r=document.createElement("style");r.innerHTML=this.getGlobalCSS(),document.head.appendChild(r)}}updateCardElementMinHeight(t,r){if(!t||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}syncRowHeights(t){if(this.card.heightSync===!1)return;let r=this.getContainer();if(!r)return;let i=this.card.variant,a=Array.from(r.querySelectorAll(`merch-card[variant="${i}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(a.length===0)return;for(let{name:o}of t){let s=`--consonant-merch-card-${i}-${o}-height`;r.style.getPropertyValue(s)&&r.style.removeProperty(s)}let n=new Map;for(let o of a){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of t){let l=`--consonant-merch-card-${i}-${s}-height`,d=0,h=[];for(let p of o){p.style.removeProperty(l);let g=c(p);if(!g){h.push({card:p,height:0});continue}let v=Math.max(0,parseInt(window.getComputedStyle(g).height)||0);h.push({card:p,height:v}),v>d&&(d=v)}if(!(d<=0))for(let{card:p}of h)p.style.setProperty(l,`${d}px`)}}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),f`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Xi(this.card.variant)}};jt=new WeakMap,u(Zr,"styleMap",{});var C=Zr;M();var Cc=`
:root {
...
`;var Qi={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},zc={...function(){let{whatsIncluded:e,size:t,...r}=Qi;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Ic={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...a}=Qi;return a}()},Ie,De,ge=class extends C{constructor(r){super(r);E(this,Ie);E(this,De);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(r,i){r.dataset.template===ve&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Nc}adjustSlotPlacement(r,i,a){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${r}"]`),l=n.querySelector(`.body slot[name="${r}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!i.includes(s)){if(o?.classList.toggle("wide-footer",z.isDesktopOrUp),!a&&c){if(l)c.remove();else{let h=d.querySelector(`[data-placeholder-for="${r}"]`);h?h.replaceWith(c):d.appendChild(c)}return}if(a&&l){let h=document.createElement("div");if(h.setAttribute("data-placeholder-for",r),h.classList.add("slot-placeholder"),!c){let p=l.cloneNode(!0);o.prepend(p)}l.replaceWith(h)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],z.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],z.isDesktopOrUp)}adjustCallout(){let r=this.card.querySelector('[slot="callout-content"] .icon-button');r&&r.title&&(r.dataset.tooltip=r.title,r.removeAttribute("title"),r.classList.add("hide-tooltip"),document.addEventListener("touchstart",i=>{i.preventDefault(),i.target!==r?r.classList.add("hide-tooltip"):i.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",i=>{i.preventDefault(),i.target!==r?r.classList.add("hide-tooltip"):i.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){m(this,Ie)||(y(this,Ie,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(m(this,Ie)?.disconnect(),y(this,Ie,null),this.syncHeights())})),m(this,Ie).observe(this.card));return}let r=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(r.map(i=>({name:i,getElement:a=>a.querySelector(`[slot="${i}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let i=this.card.querySelector('[slot="body-xs"]');if(!i)return;let a=i.querySelector("ul");if(!a)return;let n=a.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),i.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Dr(d));let h=this.card.querySelector('[slot="subtitle"]');h&&(l+=Dr(h));let p=this.card.querySelector('[slot="heading-m"]');p&&(l+=8+Dr(p));for(let v of i.childNodes){if(v.classList.contains("spacer"))break;l+=Dr(v)}let g=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(g)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${D}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?f`<div class="divider"></div>`:w}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=[],i=this.card.querySelector(`[slot="heading-m"] ${D}[data-template="price"]`);i&&r.push(i);let a=r.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(a)}catch{}}async adjustAddon(){await this.card.updateComplete;let r=this.card.addon;if(!r)return;r.setAttribute("custom-checkbox","");let i=this.mainPrice;if(!i)return;await i.onceSettled();let a=i.value?.[0]?.planType;a&&(r.planType=a)}get stockCheckbox(){return this.card.checkboxLabel?f`<label id="stock-checkbox">
    ...
    `),u(ge,"collectionOptions",{customHeaderArea:r=>r.sidenav?f`<slot name="resultsText"></slot>`:w,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let i=()=>{let a=r.querySelectorAll("merch-card");for(let o of a)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!z.isDesktop)return;let n=0;for(let o of a){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};z.matchDesktop.addEventListener("change",i),r.addEventListener(nt,i),r.onUnmount.push(()=>{z.matchDesktop.removeEventListener("change",i),r.removeEventListener(nt,i)})}});M();var Dc=`
:root {
...
`;var $n={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},ar=class extends C{getGlobalCSS(){return Jc}get aemFragmentMapping(){return $n}renderLayout(){return f`
    ...
    `);var Zi=new Map,el=new WeakMap,tl=new Map,q=(e,t,r=null,i=null,a)=>{Zi.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:a})};q("catalog",Wt,Tc,Wt.variantStyle);q("image",St);q("inline-heading",Ki);q("mini-compare-chart",Yt,Rc,Yt.variantStyle);q("mini-compare-chart-mweb",Xt,Oc,Xt.variantStyle);q("plans",ge,Qi,ge.variantStyle,ge.collectionOptions);q("plans-students",ge,Ic,ge.variantStyle,ge.collectionOptions);q("plans-education",ge,zc,ge.variantStyle,ge.collectionOptions);q("plans-v2",Je,$c,Je.variantStyle,Je.collectionOptions);q("product",Kt,Bc,Kt.variantStyle);q("segment",Qt,Uc,Qt.variantStyle);q("media",Zt,qc,Zt.variantStyle);q("headless",rr,Kc,rr.variantStyle);q("special-offers",Jt,jc,Jt.variantStyle);q("simplified-pricing-express",er,In,er.variantStyle);q("full-pricing-express",tr,Dn,tr.variantStyle);q("mini",ir,Zc,ir.variantStyle);q("image",St,_c,St.variantStyle);q("fries",ar,$n,ar.variantStyle);var dp=(e,t,r)=>{try{let i=tl.get(e.variant);if(i||(i=new CSSStyleSheet,i.replaceSync(t.cssText),tl.set(e.variant,i)),r?.styleSheet&&r.styleSheet!==i){let a=e.shadowRoot.adoptedStyleSheets.indexOf(r.styleSheet);a!==-1&&e.shadowRoot.adoptedStyleSheets.splice(a,1)}return e.shadowRoot.adoptedStyleSheets.includes(i)||e.shadowRoot.adoptedStyleSheets.push(i),{styleSheet:i}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",e.variant);let n=r?.styleElement||e.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),e.shadowRoot.appendChild(a),{styleElement:a}}},Hn=e=>{let t=Zi.get(e.variant);if(!t)return;let{class:r,style:i}=t,a=el.get(e);if(a?.appliedVariant===e.variant)return new r(e);let n=i?dp(e,i,a):{};return el.set(e,{appliedVariant:e.variant,...n}),new r(e)};function Xi(e){return Zi.get(e)?.fragmentMapping}function rl(e){return Zi.get(e)?.collectionOptions}var il=document.createElement("style");il.innerHTML=`
:root {
...
`;var Ll={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},gr=class extends C{getGlobalCSS(){return Pl}renderLayout(){return f` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Qn={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},vr=class extends C{getGlobalCSS(){return Ml}get aemFragmentMapping(){return Qn}renderLayout(){return f`
    ...
    `);q("ccd-suggested",ur,_l,ur.variantStyle);q("ccd-slice",gr,Ll,gr.variantStyle);q("ah-try-buy-widget",fr,Kn,fr.variantStyle);q("ah-promoted-plans",vr,Qn,vr.variantStyle);

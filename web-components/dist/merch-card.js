var Br=Object.defineProperty;var qr=a=>{throw TypeError(a)};var Yi=(a,r,e)=>r in a?Br(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Ki=(a,r,e)=>()=>{if(e)throw e[0];try{return a&&(r=a(a=0)),r}catch(t){throw e=[t],t}};var Qi=(a,r)=>{for(var e in r)Br(a,e,{get:r[e],enumerable:!0})};var d=(a,r,e)=>Yi(a,typeof r!="symbol"?r+"":r,e),ir=(a,r,e)=>r.has(a)||qr("Cannot "+e);var p=(a,r,e)=>(ir(a,r,"read from private field"),e?e.call(a):r.get(a)),v=(a,r,e)=>r.has(a)?qr("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),g=(a,r,e,t)=>(ir(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),C=(a,r,e)=>(ir(a,r,"access private method"),e);var dr={};Qi(dr,{default:()=>ot});import{LitElement as tn,html as Se,css as rn,nothing as an}from"./lit-all.min.js";import{unsafeHTML as ma}from"./lit-all.min.js";import{ifDefined as nn}from"./lit-all.min.js";function on(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var D,ot,hr=Ki(()=>{D=class D extends tn{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();D.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,s=this.shadowRoot?.querySelector(".css-tooltip-body"),l=s?s.offsetWidth:o,h=s?s.offsetHeight:c,u=this.effectivePlacement;u==="top"&&e.top-h-n<0?u="bottom":u==="bottom"&&e.bottom+h+n>i?u="top":u==="left"&&e.left-l-n<0?u="right":u==="right"&&e.right+l+n>t&&(u="left");let E=e.left+e.width/2,k=e.top+e.height/2,L=6,Q=(Gi,Vi,Wi)=>Math.max(Gi,Math.min(Vi,Wi)),Z,se,ar;u==="top"||u==="bottom"?(Z=u==="top"?e.top-h-n:e.bottom+n,se=Q(0,t-l,E-l/2),ar=Q(L,l-L*2,E-se-L)):(se=u==="left"?e.left-l-n:e.right+n,Z=Q(0,i-h,k-h/2),ar=Q(L,h-L*2,k-Z-L)),this._tooltipTop=Z,this._tooltipLeft=se,this._arrowOffset=ar,this._computedPlacement=u}showTooltip(){D.activeTooltip&&D.activeTooltip!==this&&(D.activeTooltip.closeOverlay(),D.activeTooltip.tooltipVisible=!1,D.activeTooltip.requestUpdate()),D.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){D.activeTooltip===this&&(D.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Se`<merch-icon
        ...
        ></merch-icon>`:Se`<slot></slot>`}render(){let r=this.effectiveContent,e=this.effectivePlacement;if(!r)return Se`<span class="icon-only">${this.renderIcon()}</span>`;if(on())return Se`
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${nn(l)}>
                    ${ma(r)}
    ...
    `);ot=D;customElements.define("mas-mnemonic",ot)});import{LitElement as bc}from"./lit-all.min.js";import{css as Vr,unsafeCSS as Gr}from"./lit-all.min.js";var S="(max-width: 767px)",z="(max-width: 1199px)",x="(min-width: 768px)",b="(min-width: 1200px)",R="(min-width: 1600px)",le="(min-width: 1280px)",Ur="(min-width: 1440px)",jr={matchMobile:window.matchMedia(S),matchDesktop:window.matchMedia(`${b} and (not ${R})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(R),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},y=jr;function _t(){return jr.isDesktop}var Wr=Vr`
    :host {
...
`,Yr=()=>[Vr`
            ...
            /* Laptop */
            @media screen and ${Gr(b)} {
                :host([size='wide']) {
                    grid-column: span 2;
                }
            }
        `];import{LitElement as cn,html as ga,css as sn}from"./lit-all.min.js";var Ac=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Tc=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var ke=2e4;var w='span[is="inline-price"][data-wcs-osi]',V='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Zi='a[is="upt-link"]',Kr=`${w},${V},${Zi}`,Qr=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);var Zr="merch-offer-select:ready",Xr="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",at="merch-card-quantity:change",nr="merch-modal:addon-and-quantity-update";var Ce="merch-card-collection:literals-changed";var Mt="aem:load",Rt="aem:error",de="mas:ready",Jr="mas:error";var ea="placeholder-failed",ta="placeholder-pending",ra="placeholder-resolved";var aa="mas:failed",N="mas:resolved",ia="mas/commerce";var X="failed",he="pending",J="resolved";var or="X-Request-Id",Lc=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var zc=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var na=":start",oa=":duration";var P="legal",ca="plan-type-text",sa="mas-ff-defaults",pe="mas-ff-annual-price";var Xi="mas-commerce-service";function la(a,r){let e;return function(){let t=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(t,i),r)}}function _(a,r={},e=null,t=null){let i=t?document.createElement(a,{is:t}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function sr(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function lr(){return window.matchMedia("(max-width: 1024px)").matches}var cr=new Map,Ji=0;function da(a,r){let e=++Ji,t=r,i=performance.now(),n,o=()=>{Ot(e),a()},c=()=>{i=performance.now(),n=setTimeout(o,t)},s=()=>{document.visibilityState==="hidden"?(clearTimeout(n),t-=performance.now()-i):c()};return cr.set(e,()=>{clearTimeout(n),document.removeEventListener("visibilitychange",s)}),document.addEventListener("visibilitychange",s),document.visibilityState!=="hidden"&&c(),e}function Ot(a){let r=cr.get(a);r&&(r(),cr.delete(a))}function it(){return document.getElementsByTagName(Xi)?.[0]}function nt(a){let r=window.getComputedStyle(a);return a.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function ha(a){let r=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var en=["www.adobe.com","www.stage.adobe.com"];function pa(a,r=window.location.hostname){if(!a||!en.includes(r))return a;try{let e=new URL(a,`https://${r}`);return/\.aem\.(live|page)$/.test(e.hostname)?`${e.pathname}${e.search}${e.hash}`:a}catch{return a}}function ln(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Ae=class extends cn{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(ln())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let t="",i="top";if(e.tagName==="SP-TOOLTIP")t=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(t=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(t){let n=document.createElement("mas-mnemonic");n.setAttribute("content",t),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>hr())}e.remove()})}render(){let{href:r}=this,e=pa(this.src);return r?ga`<a href="${r}">
                  <img
                      src="${e}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(Ae,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(Ae,"styles",sn`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Ae);var ct,me,st,lt,Te,Nt=class extends HTMLElement{constructor(){super();v(this,ct,"");v(this,me);v(this,st,[]);v(this,lt,[]);v(this,Te);g(this,Te,la(()=>{this.isConnected&&(this.parentElement.style.background=this.value,p(this,me)?this.parentElement.style.borderRadius=p(this,me):p(this,me)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=p(this,st).map((t,i)=>{let n=p(this,lt)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${p(this,ct)}, ${e})`}connectedCallback(){p(this,Te).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&g(this,me,i?.trim()),e==="colors"&&i?g(this,st,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?g(this,lt,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&g(this,ct,i?.trim()??""),p(this,Te).call(this)}};ct=new WeakMap,me=new WeakMap,st=new WeakMap,lt=new WeakMap,Te=new WeakMap;customElements.define("merch-gradient",Nt);import{LitElement as dn,html as hn,css as pn}from"./lit-all.min.js";var Le=class extends dn{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${r}"] ${w}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(N,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(N,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];if(!t)return;e.setAttribute("data-offer-type",t.offerType);let i=e.closest("p");if(i.getAttribute("data-plan-type"))return;let n=this.querySelector(`p[data-plan-type="${t.planType}"]`);n&&n!==i||i.setAttribute("data-plan-type",t.planType)}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return hn` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(Le,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0},background:{type:String,attribute:"background"}}),d(Le,"styles",pn`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return ua}setAriaExpanded(e,t){e.setAttribute("aria-expanded",t)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};d(Pe,"variantStyle",gn`
    ...
    `);import{html as ht,css as un}from"./lit-all.min.js";var va=`
:root {
...
`;var ba={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},ge=class extends f{constructor(r){super(r)}getGlobalCSS(){return va}renderLayout(){return ht`<div class="image">
    ...
    `);import{html as ya}from"./lit-all.min.js";var xa=`
:root {
...
`;var $t=class extends f{constructor(r){super(r)}getGlobalCSS(){return xa}renderLayout(){return ya` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":ya`<hr />`} ${this.secureLabelFooter}`}};import{html as ee,css as An,unsafeCSS as Ra}from"./lit-all.min.js";var wa=`
  :root {
...
`;function Ea(a,r={},{metadata:e=!0,search:t=!0,storage:i=!0}={}){let n;if(t&&n==null){let o=new URLSearchParams(window.location.search),c=mr(t)?t:a;n=o.get(c)}if(i&&n==null){let o=mr(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=vn(mr(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[a]}var fn=a=>typeof a=="boolean",It=a=>typeof a=="function";var mr=a=>typeof a=="string";function ka(a,r){if(fn(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:r}function vn(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,e,t)=>`${e}-${t}`).replace(/\W+/gu,"-").toLowerCase()}var ue={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ca=1e3;function bn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Sa(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ue.serializableTypes.includes(e))return e}return a}function xn(a,r){if(!ue.ignoredProperties.includes(a))return Sa(r)}var gr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(l=>{l!=null&&(bn(l)?t:i).push(l)}),t.length&&(n+=` ${t.map(Sa).join(" ")}`);let{pathname:o,search:c}=window.location,s=`${ue.delimiter}page=${o}${c}`;s.length>Ca&&(s=`${s.slice(0,Ca)}<trunc>`),n+=s,i.length&&(n+=`${ue.delimiter}facts=`,n+=JSON.stringify(i,xn)),window.lana?.log(n,ue)}};function Aa(a){Object.assign(ue,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in ue&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Ta={LOCAL:"local",PROD:"prod",STAGE:"stage"},ur={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},fr=new Set,vr=new Set,La=new Map,za={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},Pa={filter:({level:a})=>a!==ur.DEBUG},yn={filter:()=>!1};function wn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&It(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function En(a){[...vr].every(r=>r(a))&&fr.forEach(r=>r(a))}function _a(a){let r=(La.get(a)??0)+1;La.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>_a(`${t.namespace}/${i}`),updateConfig:Aa};return Object.values(ur).forEach(i=>{t[i]=(n,...o)=>En(wn(i,n,a,o,e))}),Object.seal(t)}function Ht(...a){a.forEach(r=>{let{append:e,filter:t}=r;It(t)&&vr.add(t),It(e)&&fr.add(e)})}function kn(a={}){let{name:r}=a,e=ka(Ea("commerce.debug",{search:!0,storage:!0}),r===Ta.LOCAL);return Ht(e?za:Pa),r===Ta.PROD&&Ht(gr),pt}function Cn(){fr.clear(),vr.clear()}var pt={..._a(ia),Level:ur,Plugins:{consoleAppender:za,debugFilter:Pa,quietFilter:yn,lanaAppender:gr},init:kn,reset:Cn,use:Ht};var Sn="mas-commerce-service",Ms=pt.module("utilities");var Bt=a=>window.setTimeout(a);function Ma(a){return a==null?[]:Array.isArray(a)?a:String(a).split(",").map(r=>r.trim())}function H(){return document.getElementsByTagName(Sn)?.[0]}var Tn=32,Oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"};function mt(a,r,e,t){a?.featureFlags[pe]&&r.options[t]?e.dataset[t]="false":r.options[t]&&(r.dataset[t]="false")}var _e=class extends f{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ee`<slot name="secure-transaction-label">
    ...
    `);import{html as qt,css as Ln,unsafeCSS as br,nothing as zn}from"./lit-all.min.js";var Na=`
  :root {
...
`;var Pn=32,_n=0,Mn=()=>`mweb-list-${_n+=1}`,Rn=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],On=8,Da={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},B,fe,Re,Oe,Ne,te,xr,yr,Me=class extends f{constructor(e){super(e);v(this,te);v(this,B);v(this,fe);v(this,Re);v(this,Oe,0);v(this,Ne);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>qt` <footer>
        ...
        `}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),y.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),y.isMobile||await C(this,te,yr).call(this)}resetSyncedHeights(){let e=this.getContainer();if(!e)return;let t=this.card.variant,i=C(this,te,xr).call(this,e);for(let n of Rn){let o=`--consonant-merch-card-${t}-${n}-height`;e.style.removeProperty(o),i.forEach(c=>c.style.removeProperty(o))}for(let n=1;n<=On;n+=1)e.style.removeProperty(this.getRowMinHeightPropertyName(n))}};B=new WeakMap,fe=new WeakMap,Re=new WeakMap,Oe=new WeakMap,Ne=new WeakMap,te=new WeakSet,xr=function(e){return e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)},yr=async function(){let e=this.getContainer();if(!e)return;let t=Array.from(C(this,te,xr).call(this,e));this.card===t[0]&&(await Promise.all(t.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),requestAnimationFrame(()=>{this.resetSyncedHeights(),this.syncHeights()}))},d(Me,"variantStyle",Ln`
    ...
    `);import{html as gt,css as Nn,nothing as Ut}from"./lit-all.min.js";var Fa=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(y.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?y.isMobile?W`
        ...
        `:W`
            ...
            <slot></slot>`}};d(re,"variantStyle",Dn`
...
`;var[kl,Cl,ja,Ga,Va,Wa]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Wt="pro",wr=`--consonant-merch-card-${Wt}-top-card-height`,Vt=[{prop:`--consonant-merch-card-${Wt}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Wt}-name-description-height`,selector:".name-description"}],Ya=`--consonant-merch-card-${Wt}-strike-reserve`,Er='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',$n="(min-width: 768px)",Ka={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},K,ve,xt,yt,M,Qa,ft,Za,vt,kr,Yt,Kt=class Kt extends f{constructor(e){super(e);v(this,M);d(this,"expanded",!1);d(this,"licenseOpen",!1);d(this,"licenseQty",null);d(this,"licenseHighlightedIndex",0);v(this,K,null);v(this,ve,null);v(this,xt,()=>this.resyncOnReflow());d(this,"lastSyncKey",null);v(this,yt,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});d(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of C(this,M,Qa).call(this)){let n=i.variantLayout;n instanceof Kt&&(n.expanded=t,i._proExpanded=t,i.requestUpdate())}});d(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?C(this,M,kr).call(this):C(this,M,vt).call(this),this.card.requestUpdate()});v(this,Yt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Ga:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:C(this,M,vt).call(this);break;case ja:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:C(this,M,vt).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Va:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}C(this,M,vt).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),C(this,M,kr).call(this);break;case Wa:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});d(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,C(this,M,ft).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(O,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._proExpanded??!1}getGlobalCSS(){return Ua}priceOptionsProvider(e,t){e.dataset.template===P&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(N,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]');if(!e?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=e.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let e=this.card.querySelector('[slot="whats-included"]');if(!e||e.querySelector(".whats-included-title"))return;let t=e.querySelector(".whats-included-label");if(!t)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=t.innerHTML,t.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},c=document.createElement("p");if(c.className="whats-included-label",c.textContent=n??"",i.after(c),e.querySelectorAll(".section h4:not(.whats-included-title)").forEach(s=>{let l=document.createElement("p");l.innerHTML=s.innerHTML,s.replaceWith(l)}),o){let s=document.createElement("div");s.className="whats-included-disclaimer",s.innerHTML=o,e.append(s)}}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=wr,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(s=>s.getBoundingClientRect().width>2&&s.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia($n).matches){n.forEach(s=>this.clearSyncedHeights(s));return}let o=new Map;for(let s of n){let l=o.get(s.offsetTop)??[];l.push(s),o.set(s.offsetTop,l)}let c=(s,l)=>s.reduce((h,m)=>{let u=l(m);return u?Math.max(h,parseInt(getComputedStyle(u).height)||0):h},0);for(let s of o.values()){if(s.forEach(u=>this.clearSyncedHeights(u)),s.length<2)continue;let l=s.map(u=>u.querySelector(Er)&&parseInt(getComputedStyle(u.querySelector(Er)).height)||0),h=Math.max(0,...l);h>0&&s.forEach((u,E)=>{let k=h-l[E];k>0&&u.style.setProperty(Ya,`${k}px`)});for(let u of Vt){let E=c(s,k=>k.shadowRoot?.querySelector(u.selector));E>0&&s.forEach(k=>k.style.setProperty(u.prop,`${E}px`))}let m=c(s,u=>u.shadowRoot?.querySelector(".top-card"));m>0&&s.forEach(u=>u.style.setProperty(i,`${m}px`))}}clearSyncedHeights(e){e.style.removeProperty(wr),e.style.removeProperty(Ya),Vt.forEach(t=>e.style.removeProperty(t.prop))}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(e),t('[slot="body-xs"]'),t(Er),t('[slot="heading-m"] span[is="inline-price"]'),t('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),t(".license-zone",this.card.shadowRoot),t(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(at,p(this,yt)),this.card.addEventListener(O,this.updatePriceQuantity),this.card.addEventListener(N,p(this,xt)),typeof ResizeObserver>"u"))return;g(this,ve,new ResizeObserver(()=>this.resyncOnReflow())),p(this,ve).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&p(this,ve).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(O,this.updatePriceQuantity),this.card?.removeEventListener(N,p(this,xt)),C(this,M,ft).call(this),p(this,ve)?.disconnect(),this.card?.removeEventListener(at,p(this,yt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t||n<1)return null;let o=[];for(let c=t;c<=i;c+=n)o.push(String(c));return o}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Y`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return Y`
        ...
        `}renderLayout(){let e=!!this.expanded;return Y`
            ...
            <slot></slot>
        `}};K=new WeakMap,ve=new WeakMap,xt=new WeakMap,yt=new WeakMap,M=new WeakSet,Qa=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},ft=function(){p(this,K)&&(document.removeEventListener("mousedown",p(this,K)),g(this,K,null))},Za=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},vt=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=C(this,M,Za).call(this),p(this,K)||(g(this,K,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),C(this,M,ft).call(this))}),document.addEventListener("mousedown",p(this,K)))},kr=function(){this.licenseOpen=!1,C(this,M,ft).call(this)},Yt=new WeakMap,d(Kt,"variantStyle",Fn`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var bt=Kt;import{html as Cr,css as In}from"./lit-all.min.js";var Xa=`
:root {
...
`;var Ja={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},j,Fe=class extends f{constructor(e){super(e);v(this,j);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Xa}priceOptionsProvider(e,t){e.dataset.template===P&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return Cr` ${this.badge}
    ...
    `);import{html as Hn,css as Bn}from"./lit-all.min.js";var ei=`
...
`;var ti={cardName:{attribute:"name"},mnemonics:{size:"l"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},planType:!0,promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},$e=class extends f{getGlobalCSS(){return ei}priceOptionsProvider(r,e){r.dataset.template===P&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`);if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}renderLayout(){return Hn` ${this.badge}
    ...
    `);import{html as Sr,css as qn}from"./lit-all.min.js";var ri=`
:root {
...
`;var ai={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ie=class extends f{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===P&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return ri}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return Sr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Un,css as jn}from"./lit-all.min.js";var ii=`
...
`;var ni={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},He=class extends f{constructor(r){super(r)}getGlobalCSS(){return ii}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Un`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as Ar,css as Gn}from"./lit-all.min.js";var oi=`
:root {
...
`;var ci={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Be=class extends f{constructor(e){super(e);d(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return oi}priceOptionsProvider(e,t){t.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayPlanType="false",t.dataset.template="legal",t.dataset.displayPerUnit="false",t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return Ar`${this.cardImage}
            ...
            ${this.evergreen?Ar`
                  ...
                  `:Ar`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(Be,"variantStyle",Gn`
    ...
    `);import{html as li,css as Vn}from"./lit-all.min.js";var si=`
:root {
...
`;var Tr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},qe=class extends f{getGlobalCSS(){return si}get aemFragmentMapping(){return Tr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return li`<div
    ...
    `);import{html as hi,css as Wn}from"./lit-all.min.js";var di=`
:root {
...
`;var Lr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},wt=class wt extends f{getGlobalCSS(){return di}get aemFragmentMapping(){return Lr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return hi`<div
        ...
        >
            ...
            <slot></slot>
        `}};d(wt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),d(wt,"variantStyle",Wn`
    ...
    `);var Et=wt;import{html as kt,nothing as mi}from"./lit-all.min.js";import{css as Yn,unsafeCSS as Kn}from"./lit-all.min.js";var pi=["headless","marquee","faq","banner-blade"],Ue=(a,r="")=>pi.map(e=>`merch-card[variant='${e}'] [slot='${a}']${r}`).join(`,
`),zr=a=>pi.map(r=>`merch-card[variant='${r}'] ${a}`).join(`,
`),ae=`
...
`;function ie(a){let r=Kn(a);return Yn`
        :host([variant='${r}']) {
            border: none;
            background: transparent;
            box-shadow: none;
    ...
    `}var gi={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},Qn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],je=class extends f{constructor(r){super(r)}getGlobalCSS(){return ae}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return kt`
        ...
        `}};d(je,"variantStyle",ie("headless"));import{css as Zn,html as Xn}from"./lit-all.min.js";var ui=`
...
`;var fi={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ge=class extends f{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return ui}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,t){t.literals={...t.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},t.space=!0,t.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",t.dataset.template="legal",t.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return Xn`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Jn,css as eo}from"./lit-all.min.js";var vi=`
...
`;var Pr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},to=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Qt,bi,Ve=class extends f{constructor(e){super(e);v(this,Qt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return vi}get aemFragmentMapping(){return Pr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,C(this,Qt,bi).call(this))}renderLayout(){return Jn`
            <div class="card">
            ...
            <slot></slot>
        `}};Qt=new WeakSet,bi=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;to.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},d(Ve,"variantStyle",eo`
    ...
    `);import{html as ro,css as ao}from"./lit-all.min.js";var xi=`
...
`;var _r={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},We=class extends f{getGlobalCSS(){return xi}get aemFragmentMapping(){return _r}renderLayout(){return ro`
    ...
    `);import{html as Mr,nothing as io}from"./lit-all.min.js";var yi={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},no=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Ye=class extends f{constructor(r){super(r)}getGlobalCSS(){return ae}renderLayout(){return Mr`
            <div class="headless">
                ${no.map(({slot:r,label:e})=>Mr`
                        <div class="headless-row">
        ...
        `}};d(Ye,"variantStyle",ie("marquee"));import{html as wi}from"./lit-all.min.js";var Ei={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},oo=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],Ke=class extends f{constructor(r){super(r)}getGlobalCSS(){return ae}renderLayout(){return wi`
            <div class="headless">
                ${oo.map(({slot:r,label:e})=>wi`
                        <div class="headless-row">
                            <span class="headless-label">${e}</span>
                            <span class="headless-value">
                                <slot name="${r}"></slot>
        ...
        `}};d(Ke,"variantStyle",ie("faq"));import{html as ki}from"./lit-all.min.js";var Ci={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},co=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],Qe=class extends f{constructor(r){super(r)}getGlobalCSS(){return ae}renderLayout(){return ki`
            <div class="headless">
                ${co.map(({slot:r,label:e})=>ki`
                        <div class="headless-row">
                            <span class="headless-label">${e}</span>
                            <span class="headless-value" data-slot="${r}">
                                <slot name="${r}"></slot>
        ...
        `}};d(Qe,"variantStyle",ie("banner-blade"));import{html as so,css as lo}from"./lit-all.min.js";var Si=`
...
`;var Ai=x,Ti=["heading-s","body-xs","heading-xs"],Li={cardName:{attribute:"name"},mnemonics:{size:"s"},badge:{tag:"div",slot:"badge"},title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},ne,Ct,Ze=class extends f{constructor(){super(...arguments);v(this,ne,null);v(this,Ct,()=>this.resyncOnReflow());d(this,"lastSyncKey",null)}getGlobalCSS(){return Si}get headingSelector(){return'[slot="heading-s"]'}priceOptionsProvider(e,t){e.dataset.template===P&&(t.displayPlanType=!0)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.card.querySelector(`[slot="heading-xs"] ${w}:not([data-template="legal"])`);if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e.options)return;e.options.displayPerUnit&&(e.dataset.displayPerUnit="false"),e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook(),this.flagPriceRow(),window.matchMedia(Ai).matches&&requestAnimationFrame(()=>this.syncHeights()))}syncHeights(){this.card.getBoundingClientRect().width<=2||window.matchMedia(Ai).matches&&this.syncRowHeights(Ti.map(e=>({name:e,getElement:t=>t.querySelector(`[slot="${e}"]`)})))}flagPriceRow(){this.card.toggleAttribute("no-price",!this.card.querySelector('[slot="heading-xs"]'))}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=n=>Math.round(this.card.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(e),...Ti.map(n=>t(`[slot="${n}"]`))].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(this.card.addEventListener(N,p(this,Ct)),typeof ResizeObserver>"u")return;g(this,ne,new ResizeObserver(()=>this.resyncOnReflow())),p(this,ne).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&p(this,ne).observe(e)}disconnectedCallbackHook(){this.card.removeEventListener(N,p(this,Ct)),p(this,ne)?.disconnect(),g(this,ne,null)}renderLayout(){return so` <div class="header">
                <slot name="icons"></slot>
                <slot name="badge"></slot>
            </div>
            <div class="panel">
            ...
            <slot></slot>`}};ne=new WeakMap,Ct=new WeakMap,d(Ze,"variantStyle",lo`
    ...
    `);var Zt=new Map,zi=new WeakMap,Pi=new Map,A=(a,r,e=null,t=null,i)=>{Zt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};A("catalog",Pe,fa,Pe.variantStyle);A("image",ge);A("inline-heading",$t);A("mini-compare-chart",_e,Oa,_e.variantStyle);A("mini-compare-chart-mweb",Me,Da,Me.variantStyle);A("plans",F,jt,F.variantStyle,F.collectionOptions);A("plans-students",F,Ia,F.variantStyle,F.collectionOptions);A("plans-education",F,$a,F.variantStyle,F.collectionOptions);A("plans-v2",re,qa,re.variantStyle,re.collectionOptions);A("pro",bt,Ka,bt.variantStyle);A("product",Fe,Ja,Fe.variantStyle);A("brand-concierge-product",$e,ti,$e.variantStyle);A("segment",Ie,ai,Ie.variantStyle);A("media",He,ni,He.variantStyle);A("headless",je,gi,je.variantStyle);A("special-offers",Be,ci,Be.variantStyle);A("simplified-pricing-express",qe,Tr,qe.variantStyle);A("full-pricing-express",Et,Lr,Et.variantStyle);A("mini",Ge,fi,Ge.variantStyle);A("image",ge,ba,ge.variantStyle);A("compare-chart-column",Ve,Pr,Ve.variantStyle);A("fries",We,_r,We.variantStyle);A("marquee",Ye,yi,Ye.variantStyle);A("faq",Ke,Ei,Ke.variantStyle);A("banner-blade",Qe,Ci,Qe.variantStyle);A("product-pricing",Ze,Li,Ze.variantStyle);var ho=(a,r,e)=>{try{let t=Pi.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),Pi.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Rr=a=>{let r=Zt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=zi.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?ho(a,t,i):{};return zi.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Ft(a){return Zt.get(a)?.fragmentMapping}function _i(a){return Zt.get(a)?.collectionOptions}var Mi=document.createElement("style");Mi.innerHTML=`
:root {
...
`;document.head.appendChild(Mi);import{LitElement as po,html as Or,css as mo,nothing as go}from"./lit-all.min.js";import{unsafeHTML as uo}from"./lit-all.min.js";var fo=a=>a?a.startsWith("sp-icon-")?Or`${uo(`<${a} class="badge-icon"></${a}>`)}`:Or`<img src="${a}" class="badge-icon" />`:go,Xe=class extends po{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Or`<div class="badge">
    ...
    `);customElements.define("merch-badge",Xe);import{html as vo,css as bo,LitElement as xo}from"./lit-all.min.js";var St=class extends xo{constructor(){super()}render(){return vo`
            <slot name="icon"></slot>
    ...
    `),d(St,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",St);import{html as Nr,css as yo,LitElement as wo,nothing as Ri}from"./lit-all.min.js";var At=class extends wo{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Nr`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?Nr`<slot name="content"></slot>`:Ri}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Nr`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Ri}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(At,"styles",yo`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
...
Caused by: ${this.cause}`),e}};var Eo={[X]:ea,[he]:ta,[J]:ra},ko={[X]:aa,[J]:N},Tt,Jt=class{constructor(r){v(this,Tt);d(this,"changes",new Map);d(this,"connected",!1);d(this,"error");d(this,"log");d(this,"options");d(this,"promises",[]);d(this,"state",he);d(this,"timer",null);d(this,"value");d(this,"version",0);d(this,"wrapperElement");this.wrapperElement=r,this.log=pt.module("mas-element")}update(){[X,he,J].forEach(r=>{this.wrapperElement.classList.toggle(Eo[r],r===this.state)})}notify(){(this.state===J||this.state===X)&&(this.state===J?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===X&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let r=this.error;this.error instanceof Xt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(ko[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,e,t){this.changes.set(r,t),this.requestUpdate()}connectedCallback(){g(this,Tt,H()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:e,state:t}=this;return J===t?Promise.resolve(this.wrapperElement):X===t?Promise.reject(r):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(r,e,t){return r!==this.version?!1:(t!==void 0&&(this.options=t),this.state=J,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),Bt(()=>this.notify()),!0)}toggleFailed(r,e,t){if(r!==this.version)return!1;t!==void 0&&(this.options=t),this.error=e,this.state=X,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...p(this,Tt)?.duration}),Bt(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=he,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!H()||this.timer)return;let{error:e,options:t,state:i,value:n,version:o}=this;this.state=he,this.timer=Bt(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||r)try{await this.wrapperElement.render?.()===!1&&this.state===he&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(s){this.toggleFailed(this.version,s,t)}})}};Tt=new WeakMap;function Co(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var xe,be=class be extends HTMLAnchorElement{constructor(){super();d(this,"masElement",new Jt(this));v(this,xe);this.setAttribute("is",be.is)}get isUptLink(){return!0}initializeWcsData(e,t){this.setAttribute("data-wcs-osi",e),t&&this.setAttribute("data-promotion-code",t)}attributeChangedCallback(e,t,i){this.masElement.attributeChangedCallback(e,t,i)}connectedCallback(){this.masElement.connectedCallback(),g(this,xe,it()),p(this,xe)&&(this.log=p(this,xe).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),g(this,xe,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=it();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let t=e.collectCheckoutOptions({},this);if(!t.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(t),n=e.resolveOfferSelectors(t);try{let[[o]]=await Promise.all(n),{country:c,language:s,env:l}=t,h=`locale=${s}_${c}&country=${c}&offer_id=${o.offerId}`,m=this.getAttribute("data-promotion-code");m&&(h+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${Co(l)}?${h}`,this.masElement.toggleResolved(i,o,t)}catch(o){let c=new Error(`Could not resolve offer selectors for id: ${t.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,c,t),!1}}static createFrom(e){let t=new be;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?t.setAttribute("class",i.value.replace("upt-link","").trim()):t.setAttribute(i.name,i.value));return t.innerHTML=e.innerHTML,t.setAttribute("tabindex",0),t}};xe=new WeakMap,d(be,"is","upt-link"),d(be,"tag","a"),d(be,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var oe=be;window.customElements.get(oe.is)||window.customElements.define(oe.is,oe,{extends:oe.tag});var So="#000000",Dr="#F8D904",Ao="#EAEAEA",To="#31A547",Lo=/(accent|primary|secondary)(-(outline|link))?/,zo="mas:product_code/",Po="daa-ll",er="daa-lh",_o=["XL","L","M","S"],Fr="...",Mo=new Set(["headless","marquee","banner-blade"]),Ro={STRONG:"Primary",EM:"Secondary"};function $(a,r,e,t){let i=t[a];if(r[a]&&i){let n={slot:i?.slot,...i?.attributes},o=r[a];if(i.maxCount&&typeof o=="string"){let[s,l]=ic(o,i.maxCount,i.withSuffix);s!==o&&(n.title=l,o=s)}let c=_(i.tag,n,o);e.append(c)}}function Oo(a,r,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,c)=>({icon:o,alt:a.mnemonicAlt?.[c]??"",link:a.mnemonicLink?.[c]??""}));i?.forEach(({icon:o,alt:c,link:s})=>{if(s&&!/^https?:/.test(s))try{s=new URL(`https://${s}`).href.toString()}catch{s="#"}let l={slot:"icons",src:o,loading:r.loading,size:e?.size??"l"};c&&(l.alt=c),s&&(l.href=s);let h=_("merch-icon",l);r.append(h)});let n=r.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function No(a){let r=new DOMParser().parseFromString(a,"text/html").querySelector("merch-badge");return r?r.querySelector('span[is="inline-price"]')?!1:!r.textContent?.trim():!0}function Do(a,r,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let i=Dr,n=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(i=e.badge?.default,a.borderColor||(n=!0));let o=a.badgeBackgroundColor||i,c=a.borderColor||"";n&&(c=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${o}" border-color="${c}">${a.badge}</merch-badge>`}a.badge?.startsWith("<merch-badge")&&No(a.badge)&&(a.badge=""),$("badge",a,r,e)}else a.badge?(r.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||r.setAttribute("badge-color",a.badgeColor||So),e.disabledAttributes?.includes("badgeBackgroundColor")||r.setAttribute("badge-background-color",a.badgeBackgroundColor||Dr),r.setAttribute("border-color",a.badgeBackgroundColor||Dr)):r.setAttribute("border-color",a.borderColor||Ao)}function Fo(a,r,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let t=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||To;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${t}">${a.trialBadge}</merch-badge>`}$("trialBadge",a,r,e)}}function $o(a,r,e){e?.includes(a.size)&&r.setAttribute("size",a.size)}function Io(a,r){a.cardName&&r.setAttribute("name",a.cardName)}function Ho(a,r,e){a.cardTitle&&(a.cardTitle=Je(a.cardTitle)),$("cardTitle",a,r,{cardTitle:e})}function Bo(a,r,e){$("subtitle",a,r,e)}function qo(a,r,e,t){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){r.style.removeProperty("--merch-card-custom-background-color"),r.removeAttribute("background-color");return}e?.[a.backgroundColor]?(r.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),r.setAttribute("background-color",a.backgroundColor)):t?.attribute&&a.backgroundColor&&(r.setAttribute(t.attribute,a.backgroundColor),r.style.removeProperty("--merch-card-custom-background-color"))}function Uo(a,r,e){let t=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")r.style.setProperty(i,"transparent");else if(a.borderColor&&t){let o=t?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),c=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){r.setAttribute("gradient-border","true");let s=a.borderColor;if(t?.specialValues){for(let[l,h]of Object.entries(t.specialValues))if(h===a.borderColor){s=l;break}}r.setAttribute("border-color",s),r.style.removeProperty(i)}else c?(r.setAttribute("border-color",a.borderColor),r.style.setProperty(i,`var(--${a.borderColor})`)):r.style.setProperty(i,`var(--${a.borderColor})`)}else r.style.removeProperty(i)}var jo=new Set(["","default"]);function Go(a,r,e){let t=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!t)return;let o=(r.querySelector('[slot="footer-rows"] merch-whats-included')??r.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),c=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",s=o||c;if(s==null||jo.has(String(s).trim().toLowerCase())){r.removeAttribute("whats-included-divider-color"),r.style.removeProperty(i);return}let l=String(s).trim();if(l.toLowerCase()==="transparent"){r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,"transparent");return}let m=t.specialValues?.[l]?.includes("gradient")||/-gradient/.test(l)||/^gradient-/.test(l),u=/^spectrum-.*-(plans|special-offers)$/.test(l);if(m){let E=l;if(t.specialValues){for(let[k,L]of Object.entries(t.specialValues))if(L===l){E=k;break}}r.setAttribute("whats-included-divider-color",E),r.style.removeProperty(i)}else u?(r.setAttribute("whats-included-divider-color",l),r.style.setProperty(i,`var(--${l})`)):(r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,`var(--${l})`))}function Vo(a,r,e){if(a.backgroundImage){let t={loading:r.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?t.alt=a.backgroundImageAltText:t.role="none",!e)return;if(e?.attribute){r.setAttribute(e.attribute,a.backgroundImage);return}r.append(_(e.tag,{slot:e.slot},_("img",t)))}}function Je(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(hr(),dr)).catch(console.error),a}function Wo(a,r,e){a.prices&&(a.prices=Je(a.prices)),$("prices",a,r,e)}function $r(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap($r);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap($r);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function Yo(a,r,e){let t=$r(a.features).filter(n=>n.trim());if(!t.length)return;let i=_("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});t.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let c=o.body.querySelector("p[name]");if(c){i.append(c);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&r.append(i),Zo(r,e)}function Ko(a){let e=customElements.get("checkout-link")?.createCheckoutLink(a.dataset,a.innerHTML)??a;if(e===a)return e;for(let t of a.attributes)["class","is","href"].includes(t.name)||e.setAttribute(t.name,t.value);return e}function Ni(a,r,e,t=!1){let i=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),n=a.className||"",o=a.parentElement?.tagName,c=t&&!n&&Mo.has(r.variant),s=n?Lo.exec(n)?.[0]??"accent":"accent",l=!c&&s.includes("accent"),h=!c&&s.includes("primary"),m=!c&&s.includes("secondary"),u=!c&&s.includes("-outline"),E=c||s.includes("-link");a.classList.remove("accent","primary","secondary");let k;if(r.consonant)k=sc(a,l,i,E,h,m,e?.ctas?.size);else if(E)k=c&&i?Ko(a):a;else{let L;l?L="accent":h?L="primary":m&&(L="secondary"),k=r.spectrum==="swc"?cc(a,e,u,L,i):oc(a,e,u,L,i)}if(c){let L=k;if(o==="STRONG"||o==="EM"){let se=document.createElement(o.toLowerCase());se.append(k),L=se}let Q=document.createElement("span");Q.className="headless-cta-variant-label",Q.textContent=Ro[o]??"Link";let Z=document.createElement("span");return Z.className="headless-cta-item",Z.append(L,Q),Z}return k}function Qo(a,r){let{slot:e}=r?.description;Di(a,r,e)}function Zo(a,r){let e=r?.features?.slot;e&&Di(a,r,e)}function Di(a,r,e){let t=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);t.length&&t.forEach(i=>{let n=Ni(i,a,r);i.replaceWith(n)})}function Xo(a,r,e,t){a.description&&(a.description=Je(a.description)),a.promoText&&(a.promoText=Je(a.promoText)),a.shortDescription&&(a.shortDescription=Je(a.shortDescription)),$("promoText",a,r,e),$("description",a,r,e),$("shortDescription",a,r,e),a.shortDescription&&(r.setAttribute("action-menu","true"),a.actionMenuLabel||r.setAttribute("action-menu-label","More options")),Qo(r,e),$("callout",a,r,e),Jo(a,r,e,t),$("whatsIncluded",a,r,e)}function Jo(a,r,e,t={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=t.quantitySelect),$("quantitySelect",a,r,e))}function ec(a,r,e,t={}){if(!e.addon)return;let n=(a.addon??t.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o,c=n,s=document.createElement("div");s.innerHTML=n;let l=s.firstElementChild;l?.tagName?.toLowerCase()==="merch-addon"&&(o=l.getAttribute("background")||void 0,c=l.innerHTML);let h={slot:"addon"};o&&(h.background=o);let m=_("merch-addon",h,c);[...m.querySelectorAll(w)].forEach(u=>{let E=u.parentElement;E?.nodeName==="P"&&(E.hasAttribute("data-plan-type")||E.setAttribute("data-plan-type",""))}),r.append(m)}function tc(a,r,e){a.addonConfirmation&&$("addonConfirmation",a,r,e)}function rc(a,r,e){let t=e?.customFields;if(!t)return;let i=Array.isArray(a.customFields)?a.customFields:a.customFields?[a.customFields]:[],n=Array.isArray(a.customFieldLabels)?a.customFieldLabels:a.customFieldLabels?[a.customFieldLabels]:[];i.filter(Boolean).forEach((o,c)=>{let s=n[c],l=_(t.tag,{slot:`custom-field-${c}`,"data-label":s||""},o);r.append(l)})}function ac(a,r,e,t){t?.secureLabel&&e?.secureLabel&&r.setAttribute("secure-label",t.secureLabel)}function ic(a,r,e=!0){try{let t=typeof a!="string"?"":a,i=Oi(t);if(i.length<=r)return[t,i];let n=0,o=!1,c=e?r-Fr.length<1?1:r-Fr.length:r,s=[];for(let m of t){if(n++,m==="<")if(o=!0,t[n]==="/")s.pop();else{let u="";for(let E of t.substring(n)){if(E===" "||E===">")break;u+=E}s.push(u)}if(m==="/"&&t[n]===">"&&s.pop(),m===">"){o=!1;continue}if(!o&&(c--,c===0))break}let l=t.substring(0,n).trim();if(s.length>0){s[0]==="p"&&s.shift();for(let m of s.reverse())l+=`</${m}>`}return[`${l}${e?Fr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=Oi(i);return[i,n]}}function Oi(a){if(!a)return"";let r="",e=!1;for(let t of a){if(t==="<"&&(e=!0),t===">"){e=!1;continue}e||(r+=t)}return r}function nc(a,r){r.querySelectorAll("a.upt-link").forEach(t=>{let i=oe.createFrom(t);t.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function oc(a,r,e,t,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let h of a.attributes)["class","is"].includes(h.name)||n.setAttribute(h.name,h.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=r?.ctas?.size??"M",c=`spectrum-Button--${t}`,s=_o.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",l=["spectrum-Button",c,s];return e&&l.push("spectrum-Button--outline"),n.classList.add(...l),n}function cc(a,r,e,t,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let c=_("sp-button",{treatment:o,variant:t,tabIndex:0,size:r?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return c.source=n,(i?n.onceSettled():Promise.resolve(n)).then(s=>{c.setAttribute("data-navigation-url",s.href)}),c.addEventListener("click",s=>{s.defaultPrevented||n.click()}),c}function sc(a,r,e,t,i,n,o){let c=a;if(e){try{let s=customElements.get("checkout-link");s&&(c=s.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}a.hasAttribute("aria-label")&&c.setAttribute("aria-label",a.getAttribute("aria-label"))}return t||(c.classList.add("button","con-button"),o&&o!=="m"&&c.classList.add(`button-${o}`),r&&c.classList.add("blue"),i&&c.classList.add("primary"),n&&c.classList.add("secondary")),c}function lc(a,r,e,t,i){if(a.ctas&&e.ctas){a.ctas=Je(a.ctas);let{slot:n}=e.ctas,o=_("div",{slot:n},a.ctas),c=[...o.querySelectorAll("a")],s=i?.hideTrialCTAs?c.filter(h=>!Qr.has(h.dataset.analyticsId)):c,l=(s.length>0?s:c).map(h=>Ni(h,r,e,!0));o.textContent="",o.append(...l),r.append(o),i?.hideTrialCTAs&&s.length>0&&l.forEach(h=>{let m=h.source??h;m.onceSettled&&(h.hidden=!0,m.onceSettled().then(()=>{m.value?.[0]?.offerType==="TRIAL"&&l.some(E=>E!==h&&!E.hidden)?h.remove():h.hidden=!1}).catch(()=>{h.hidden=!1}))})}}function dc(a,r){let{tags:e}=a,t=e?.find(n=>typeof n=="string"&&n.startsWith(zo))?.split("/").pop();if(!t)return;r.setAttribute(er,t),[...r.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...r.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(Po,`${n.dataset.analyticsId}-${o+1}`)})}function hc(a){a.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([r,e])=>{a.querySelectorAll(`a.${r}`).forEach(t=>{t.classList.remove(r),t.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function pc(a){a.querySelectorAll("[slot]").forEach(t=>{t.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",er].forEach(t=>a.removeAttribute(t));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function Fi(a,r){if(!a){let l=r?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!a.fields){let l=a.id||"unknown",h=r?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'.`)}let{id:e,fields:t,settings:i={},priceLiterals:n,placeholders:o}=a;t.variant==="bizpro"&&(t.variant="pro");let{variant:c}=t;if(!c)throw new Error(`hydrate: no template found in payload ${e}`);pc(r),r.compatVersion=t.compatVersion,r.contextPromotionCode=t.promoCode,r.settings=i,n&&(r.priceLiterals=n),o&&(r.placeholders=o),r.id??(r.id=a.id),a.variationId&&r.setAttribute("variation-id",a.variationId),a.maskId&&r.setAttribute("mask-id",a.maskId),a.promoProject&&r.setAttribute("data-promotion-project",a.promoProject),a.promoVariationProject&&r.setAttribute("data-promotion-variation-project",a.promoVariationProject),r.variant=c,await r.updateComplete;let{aemFragmentMapping:s}=r.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&r.setAttribute("consonant",!0),Oo(t,r,s.mnemonics),Fo(t,r,s),$o(t,r,s.size),Io(t,r),Ho(t,r,s.title),Do(t,r,s),Bo(t,r,s),Wo(t,r,s),Vo(t,r,s.backgroundImage),qo(t,r,s.allowedColors,s.backgroundColor),Uo(t,r,s),Xo(t,r,s,i),Yo(t,r,s),Go(t,r,s),ec(t,r,s,i),tc(t,r,s),rc(t,r,s),ac(t,r,s,i);try{nc(t,r)}catch{}lc(t,r,s,c,i),dc(t,r),hc(r)}var mc=[".","!","?"],gc=`

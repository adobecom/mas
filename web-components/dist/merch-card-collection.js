...
`;var gl=32,fl=0,vl=()=>`mweb-list-${fl+=1}`,xl=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],bl=8,ci={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ae,Ze,vt,xt,bt,$e,oi,si,ft=class extends y{constructor(t){super(t);S(this,$e);S(this,Ae);S(this,Ze);S(this,vt);S(this,xt,0);S(this,bt);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Fr` <footer>
...
`;var yi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Mt=class extends y{getGlobalCSS(){return xo}get aemFragmentMapping(){return yi}renderLayout(){return Ul`
    ...
    `);import{html as wi,nothing as Gl}from"./lit-all.min.js";var bo={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},ql=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Rt=class extends y{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return wi`
        ...
        `}};g(Rt,"variantStyle",Ve("marquee"));import{html as yo}from"./lit-all.min.js";var wo={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},Vl=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],Nt=class extends y{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return yo`
            <div class="headless">
...
`;var Co=P,To=[{name:"heading-s",getElement:e=>e.querySelector('[slot="heading-s"]')},{name:"body-xs",getElement:e=>e.querySelector('[slot="body-xs"]')},{name:"price",getElement:e=>e.shadowRoot?.querySelector(".price")}],ko={cardName:{attribute:"name"},mnemonics:{size:"s"},badge:{tag:"div",slot:"badge"},title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},ctas:{slot:"footer",size:"m"},planType:!0,style:"consonant"},Ne,hr,It=class extends y{constructor(){super(...arguments);S(this,Ne,null);S(this,hr,()=>this.resyncOnReflow());g(this,"lastSyncKey",null)}getGlobalCSS(){return Ao}get headingSelector(){return'[slot="heading-s"]'}priceOptionsProvider(t,a){t.dataset.template===Y&&(a.displayPlanType=this.card?.settings?.displayPlanType??!0)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.card.querySelector(`[slot="heading-xs"] ${F}:not([data-template="legal"])`);if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),this.legalHost().appendChild(a),await a.onceSettled()}catch{}}legalHost(){let t=this.card.querySelector('p[slot="legal"]');return t||(t=document.createElement("p"),t.setAttribute("slot","legal"),this.card.appendChild(t)),t}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook(),this.flagPriceRow(),window.matchMedia(Co).matches&&requestAnimationFrame(()=>this.syncHeights()))}syncHeights(){this.card.getBoundingClientRect().width<=2||window.matchMedia(Co).matches&&this.syncRowHeights(To)}flagPriceRow(){this.card.toggleAttribute("no-price",!this.card.querySelector('[slot="heading-xs"]'))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=[Math.round(t),...To.map(({getElement:i})=>Math.round(i(this.card)?.getBoundingClientRect().height||0))].join(":");a!==this.lastSyncKey&&(this.lastSyncKey=a,this.syncHeights())}connectedCallbackHook(){if(this.card.addEventListener(se,v(this,hr)),typeof ResizeObserver>"u")return;E(this,Ne,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Ne).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Ne).observe(t);let a=this.card.querySelector('[slot="short-description"]');a&&v(this,Ne).observe(a)}disconnectedCallbackHook(){this.card.removeEventListener(se,v(this,hr)),v(this,Ne)?.disconnect(),E(this,Ne,null)}renderLayout(){return Wl` <div class="header">
            ...
            <slot></slot>`}};Ne=new WeakMap,hr=new WeakMap,g(It,"variantStyle",Yl`

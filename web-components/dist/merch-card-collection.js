var Ei=Object.defineProperty;var Si=e=>{throw TypeError(e)};var Ts=(e,r,t)=>r in e?Ei(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var ks=(e,r)=>{for(var t in r)Ei(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Ts(e,typeof r!="symbol"?r+"":r,t),Gr=(e,r,t)=>r.has(e)||Si("Cannot "+t);var v=(e,r,t)=>(Gr(e,r,"read from private field"),t?t.call(e):r.get(e)),z=(e,r,t)=>r.has(e)?Si("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),L=(e,r,t,a)=>(Gr(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),j=(e,r,t)=>(Gr(e,r,"access private method"),t);import{html as Pe,LitElement as gs,css as fs,unsafeCSS as us,nothing as fe}from"./lit-all.min.js";var N="(max-width: 767px)",Z="(max-width: 1199px)",I="(min-width: 768px)",T="(min-width: 1200px)",J="(min-width: 1600px)",Ai="(min-width: 1280px)",Ci={matchMobile:window.matchMedia(N),matchDesktop:window.matchMedia(`${T} and (not ${J})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(J),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},k=Ci;function ir(){return Ci.isDesktop}var At=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var Ti="hashchange";function _s(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function Ct(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function ki(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=_s(window.location.hash);e(t)};return r(),window.addEventListener(Ti,r),()=>{window.removeEventListener(Ti,r)}}var ga={};ks(ga,{CLASS_NAME_FAILED:()=>Jr,CLASS_NAME_HIDDEN:()=>Ls,CLASS_NAME_PENDING:()=>ea,CLASS_NAME_RESOLVED:()=>ta,CheckoutWorkflow:()=>Ws,CheckoutWorkflowStep:()=>ae,Commitment:()=>Fe,ERROR_MESSAGE_BAD_REQUEST:()=>ra,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>qs,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>aa,EVENT_AEM_ERROR:()=>Zr,EVENT_AEM_LOAD:()=>Kr,EVENT_COMPARE_CHART_REHYDRATE:()=>$s,EVENT_EXPANDED_GROUPS_CHANGE:()=>Gs,EVENT_MAS_ERROR:()=>Qr,EVENT_MAS_READY:()=>Us,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>Bs,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>jr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>me,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Yr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Tt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Wr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Hs,EVENT_MERCH_OFFER_READY:()=>zs,EVENT_MERCH_OFFER_SELECT_READY:()=>Ns,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>he,EVENT_MERCH_SEARCH_CHANGE:()=>Fs,EVENT_MERCH_SIDENAV_SELECT:()=>Xr,EVENT_MERCH_STOCK_CHANGE:()=>Is,EVENT_MERCH_STORAGE_CHANGE:()=>Ds,EVENT_OFFER_SELECTED:()=>Os,EVENT_TYPE_FAILED:()=>ia,EVENT_TYPE_READY:()=>nr,EVENT_TYPE_RESOLVED:()=>Le,Env:()=>ve,FF_ANNUAL_PRICE:()=>rt,FF_DEFAULTS:()=>Se,HEADER_X_REQUEST_ID:()=>kt,LOG_NAMESPACE:()=>na,Landscape:()=>Re,MARK_DURATION_SUFFIX:()=>ma,MARK_START_SUFFIX:()=>pa,MERCH_CARD_LOAD_TIMEOUT:()=>qr,MODAL_TYPE_3_IN_1:()=>Ue,NAMESPACE:()=>Ps,PARAM_AOS_API_KEY:()=>Vs,PARAM_ENV:()=>sa,PARAM_LANDSCAPE:()=>ca,PARAM_MAS_PREVIEW:()=>oa,PARAM_WCS_API_KEY:()=>js,PROVIDER_ENVIRONMENT:()=>ha,SELECTOR_MAS_CHECKOUT_LINK:()=>_i,SELECTOR_MAS_ELEMENT:()=>Vr,SELECTOR_MAS_INLINE_PRICE:()=>W,SELECTOR_MAS_SP_BUTTON:()=>Rs,SELECTOR_MAS_UPT_LINK:()=>Pi,SORT_ORDER:()=>ge,STATE_FAILED:()=>ue,STATE_PENDING:()=>Me,STATE_RESOLVED:()=>Ee,SUPPORTED_COUNTRIES:()=>ua,TAG_NAME_SERVICE:()=>Ms,TEMPLATE_PRICE:()=>Ys,TEMPLATE_PRICE_ANNUAL:()=>Ks,TEMPLATE_PRICE_LEGAL:()=>ee,TEMPLATE_PRICE_STRIKETHROUGH:()=>Xs,Term:()=>de,WCS_PROD_URL:()=>la,WCS_STAGE_URL:()=>da});var Fe=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),de=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Ps="merch",qr=2e4,Ls="hidden",nr="wcms:commerce:ready",Ms="mas-commerce-service",W='span[is="inline-price"][data-wcs-osi]',_i='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Rs="sp-button[data-wcs-osi]",Pi='a[is="upt-link"]',Vr=`${W},${_i},${Pi}`,zs="merch-offer:ready",Ns="merch-offer-select:ready",jr="merch-card:action-menu-toggle",Os="merch-offer:selected",Is="merch-stock:change",Ds="merch-storage:change",he="merch-quantity-selector:change",Hs="merch-card-quantity:change",Bs="merch-modal:addon-and-quantity-update",Fs="merch-search:change",Wr="merch-card-collection:sort",me="merch-card-collection:literals-changed",Tt="merch-card-collection:sidenav-attached",Yr="merch-card-collection:showmore",Xr="merch-sidenav:select",Kr="aem:load",Zr="aem:error",Us="mas:ready",Qr="mas:error",$s="mas-compare-chart:rehydrate",Gs="expanded-groups-change",Jr="placeholder-failed",ea="placeholder-pending",ta="placeholder-resolved",ra="Bad WCS request",aa="Commerce offer not found",qs="Literals URL not provided",ia="mas:failed",Le="mas:resolved",na="mas/commerce",oa="mas.preview",sa="commerce.env",ca="commerce.landscape",Vs="commerce.aosKey",js="commerce.wcsKey",la="https://www.adobe.com/web_commerce_artifact",da="https://www.stage.adobe.com/web_commerce_artifact_stage",ue="failed",Me="pending",Ee="resolved",Re={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},kt="X-Request-Id",ae=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Ws="UCv3",ve=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),ha={PRODUCTION:"PRODUCTION"},Ue={TWP:"twp",D2P:"d2p",CRM:"crm"},pa=":start",ma=":duration",Ys="price",Xs="price-strikethrough",Ks="annual",ee="legal",Se="mas-ff-defaults",rt="mas-ff-annual-price",ge={alphabetical:"alphabetical",authored:"authored"},ua=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Zs="mas-commerce-service";var _t=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function xe(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function or(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function fa(){return window.matchMedia("(max-width: 1024px)").matches}function Pt(){return document.getElementsByTagName(Zs)?.[0]}function Lt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}import{html as sr,nothing as Qs}from"./lit-all.min.js";var at,Mt=class Mt{constructor(r){g(this,"card");z(this,at);this.card=r,this.insertVariantStyle()}getContainer(){return L(this,at,v(this,at)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,at)}insertVariantStyle(){let r=this.constructor.name;if(!Mt.styleMap[r]){Mt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(m=>m.style.getPropertyValue(l)),p=0;for(let m of o){m.style.removeProperty(l);let h=c(m);if(!h)continue;let u=Math.max(0,parseInt(window.getComputedStyle(h).height)||0);u>p&&(p=u)}o.forEach((m,h)=>{p>0?m.style.setProperty(l,`${p}px`):d[h]&&m.style.setProperty(l,d[h])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),sr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Rt,css as ec}from"./lit-all.min.js";var Ri=`
:root {
...
`;var zi={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},$e=class extends w{constructor(r){super(r)}getGlobalCSS(){return Ri}renderLayout(){return Rt`<div class="image">
    ...
    `);import{html as Oi}from"./lit-all.min.js";var Ni=`
:root {
...
`;var lr=class extends w{constructor(r){super(r)}getGlobalCSS(){return Ni}renderLayout(){return Oi` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Oi`<hr />`} ${this.secureLabelFooter}`}};import{html as ze,css as tc,unsafeCSS as Di}from"./lit-all.min.js";var Ii=`
  :root {
...
`;var rc=32,Hi={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},nt=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?ze`<slot name="secure-transaction-label">
    ...
    `);import{html as dr,css as ac,unsafeCSS as Fi,nothing as ic}from"./lit-all.min.js";var Bi=`
  :root {
...
`;var nc=32,Ui={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},ot=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>dr` <footer>
    ...
    `);import{html as zt,css as oc,nothing as hr}from"./lit-all.min.js";var $i=`
:root {
...
`;var pr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Gi={...function(){let{whatsIncluded:e,size:r,...t}=pr;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},qi={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=pr;return i}()},be,ye,ie=class extends w{constructor(t){super(t);z(this,be);z(this,ye);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===ee&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return $i}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(s)){if(o?.classList.toggle("wide-footer",k.isDesktopOrUp),!i&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(i&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);o.prepend(m)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],k.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],k.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,be)||(L(this,be,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,be)?.disconnect(),L(this,be,null),this.syncHeights())})),v(this,be).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),a.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Lt(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=Lt(p));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+Lt(m));for(let u of a.childNodes){if(u.classList.contains("spacer"))break;l+=Lt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${W}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?zt`<div class="divider"></div>`:hr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?zt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};be=new WeakMap,ye=new WeakMap,g(ie,"variantStyle",oc`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(k.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?k.isMobile?Ae`
        ...
        `:Ae`
            ...
            <slot></slot>`}};g(Ne,"variantStyle",sc`
...
`;var[Jh,ep,Xi,Ki,Zi,Qi]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Ji={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},Ce,Ge,Y,en,Ot,tn,It,xa,ur,gr=class gr extends w{constructor(){super(...arguments);z(this,Y);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);z(this,Ce,null);z(this,Ge,null);g(this,"lastSyncKey",null);g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of j(this,Y,en).call(this)){let n=i.variantLayout;n instanceof gr&&(n.expanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?j(this,Y,xa).call(this):j(this,Y,It).call(this),this.card.requestUpdate()});z(this,ur,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case Ki:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:j(this,Y,It).call(this);break;case Xi:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:j(this,Y,It).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case Zi:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}j(this,Y,It).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),j(this,Y,xa).call(this);break;case Qi:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,j(this,Y,Ot).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(he,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()})}getGlobalCSS(){return Yi}priceOptionsProvider(t,a){t.dataset.template===ee&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(Le,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]')?.querySelector(".price-plan-type");i&&(i.textContent=t)}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=`--consonant-merch-card-${a}-top-card-height`,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(s=>s.getBoundingClientRect().width>2&&s.variantLayout?.card?.heightSync!==!1),o=new Map;for(let s of n){let c=o.get(s.offsetTop)??[];c.push(s),o.set(s.offsetTop,c)}for(let s of o.values()){let c=0;for(let l of s){l.style.removeProperty(i);let d=l.shadowRoot?.querySelector(".top-card");d&&(c=Math.max(c,parseInt(getComputedStyle(d).height)||0))}c>0&&s.length>1&&s.forEach(l=>l.style.setProperty(i,`${c}px`))}}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=this.card.querySelector('[slot="body-xs"]'),i=a?Math.round(a.getBoundingClientRect().height):0,n=`${Math.round(t)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;L(this,Ge,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Ge).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Ge).observe(t)}disconnectedCallbackHook(){j(this,Y,Ot).call(this),v(this,Ge)?.disconnect()}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Oe`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Oe`
        ...
        `}renderLayout(){let t=!!this.expanded;return Oe`
            ...
            ${this.hasWhatsIncluded?Oe`
                  ...
                  `:Nt}
            <slot></slot>
        `}};Ce=new WeakMap,Ge=new WeakMap,Y=new WeakSet,en=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll('merch-card[variant="bizpro"]')??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},Ot=function(){v(this,Ce)&&(document.removeEventListener("mousedown",v(this,Ce)),L(this,Ce,null))},tn=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},It=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=j(this,Y,tn).call(this),v(this,Ce)||(L(this,Ce,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),j(this,Y,Ot).call(this))}),document.addEventListener("mousedown",v(this,Ce)))},xa=function(){this.licenseOpen=!1,j(this,Y,Ot).call(this)},ur=new WeakMap,g(gr,"variantStyle",cc`
        :host([variant='bizpro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Dt=gr;import{html as ba,css as lc}from"./lit-all.min.js";var rn=`
:root {
...
`;var an={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},we,st=class extends w{constructor(t){super(t);z(this,we);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return rn}priceOptionsProvider(t,a){t.dataset.template===ee&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return ba` ${this.badge}
    ...
    `);import{html as ya,css as dc}from"./lit-all.min.js";var nn=`
:root {
...
`;var on={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ct=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===ee&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return nn}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${W}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return ya`
    ...
    `);import{html as hc,css as pc}from"./lit-all.min.js";var sn=`
...
`;var cn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},lt=class extends w{constructor(r){super(r)}getGlobalCSS(){return sn}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return hc`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as wa,css as mc}from"./lit-all.min.js";var ln=`
:root {
...
`;var dn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},dt=class extends w{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ln}renderLayout(){return wa`${this.cardImage}
            ...
            ${this.evergreen?wa`
                  ...
                  `:wa`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(dt,"variantStyle",mc`
    ...
    `);import{html as uc,css as gc}from"./lit-all.min.js";var hn=`
:root {
...
`;var Ea={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ht=class extends w{getGlobalCSS(){return hn}get aemFragmentMapping(){return Ea}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(r.querySelector(`.${i}`),i));let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let a=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');a&&this.updateCardElementMinHeight(a,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),a=34;t.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>a;o.classList.toggle("small-font-size-button",s)})}),k.isDesktopOrUp&&t.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!ir()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(t=>t.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let t=()=>{if(ir())r.removeAttribute("data-expanded");else{let i=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",i?"true":"false")}};t();let a=window.matchMedia(N);this.mediaQueryListener=()=>{t()},a.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(N).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||ir())return;let i=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",i)}renderLayout(){return uc`
    ...
    `);import{html as mn,css as fc}from"./lit-all.min.js";var pn=`
:root {
...
`;var Sa={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Ht=class Ht extends w{getGlobalCSS(){return pn}get aemFragmentMapping(){return Sa}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return mn`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let t=window.getComputedStyle(r),a=`${t.fontWeight} ${t.fontSize} ${t.fontFamily}`;await document.fonts.load(a,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let r=Ht.SYNCED_SECTIONS.map(s=>({name:s,getElement:c=>c.shadowRoot?.querySelector(`.${s}`)})),t=this.getContainer(),a=t?t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(a,s=>s.querySelectorAll(i).length)),o=Array.from({length:n},(s,c)=>({name:`description-row-${c}`,getElement:l=>l.querySelectorAll(i)[c]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),a=49;t.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>a;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let t=this.card.querySelector(this.headingSelector),a=t?Math.round(t.getBoundingClientRect().height):0,i=`${Math.round(r)}:${a}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return mn`
            ...
            <slot></slot>
        `}};g(Ht,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(Ht,"variantStyle",fc`
    ...
    `);var Bt=Ht;import{html as Aa,css as vc,nothing as xc}from"./lit-all.min.js";var un=`
...
`;var gn={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},bc=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],pt=class extends w{constructor(r){super(r)}getGlobalCSS(){return un}renderLayout(){return Aa`
    ...
    `);import{css as yc,html as wc}from"./lit-all.min.js";var fn=`
...
`;var vn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},mt=class extends w{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return fn}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${W}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return wc`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Ec,css as Sc}from"./lit-all.min.js";var xn=`
...
`;var Ca={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Ac=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],fr,bn,ut=class extends w{constructor(t){super(t);z(this,fr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return xn}get aemFragmentMapping(){return Ca}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,j(this,fr,bn).call(this))}renderLayout(){return Ec`
            <div class="card">
            ...
            <slot></slot>
        `}};fr=new WeakSet,bn=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Ac.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(ut,"variantStyle",Sc`
...
`;var Ta={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},gt=class extends w{getGlobalCSS(){return yn}get aemFragmentMapping(){return Ta}renderLayout(){return Cc`
    ...
    `);var wn=new Map;var G=(e,r,t=null,a=null,i)=>{wn.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};G("catalog",it,Mi,it.variantStyle);G("image",$e);G("inline-heading",lr);G("mini-compare-chart",nt,Hi,nt.variantStyle);G("mini-compare-chart-mweb",ot,Ui,ot.variantStyle);G("plans",ie,pr,ie.variantStyle,ie.collectionOptions);G("plans-students",ie,qi,ie.variantStyle,ie.collectionOptions);G("plans-education",ie,Gi,ie.variantStyle,ie.collectionOptions);G("plans-v2",Ne,Wi,Ne.variantStyle,Ne.collectionOptions);G("bizpro",Dt,Ji,Dt.variantStyle);G("product",st,an,st.variantStyle);G("segment",ct,on,ct.variantStyle);G("media",lt,cn,lt.variantStyle);G("headless",pt,gn,pt.variantStyle);G("special-offers",dt,dn,dt.variantStyle);G("simplified-pricing-express",ht,Ea,ht.variantStyle);G("full-pricing-express",Bt,Sa,Bt.variantStyle);G("mini",mt,vn,mt.variantStyle);G("image",$e,zi,$e.variantStyle);G("compare-chart-column",ut,Ca,ut.variantStyle);G("fries",gt,Ta,gt.variantStyle);function cr(e){return wn.get(e)?.fragmentMapping}var En="tacocat.js";var ka=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),Sn=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function H(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=ft(a)?a:e;n=o.get(s)}if(i&&n==null){let o=ft(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=_c(ft(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var kc=e=>typeof e=="boolean",vr=e=>typeof e=="function",xr=e=>typeof e=="number",An=e=>e!=null&&typeof e=="object";var ft=e=>typeof e=="string",Cn=e=>ft(e)&&e,Ft=e=>xr(e)&&Number.isFinite(e)&&e>0;function br(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function E(e,r){if(kc(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Ut(e,r,t){let a=Object.values(r);return a.find(i=>ka(i,e))??t??a[0]}function _c(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function Tn(e,r=1){return xr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var Pc=Date.now(),_a=()=>`(+${Date.now()-Pc}ms)`,yr=new Set,Lc=E(H("tacocat.debug",{},{metadata:!1}),!1);function kn(e){let r=`[${En}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=Lc?(o,...s)=>{console.debug(`${r} ${o}`,...s,_a())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;yr.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;yr.forEach(([,l])=>l(c,...s))}}}function Mc(e,r){let t=[e,r];return yr.add(t),()=>{yr.delete(t)}}Mc((e,...r)=>{console.error(e,...r,_a())},(e,...r)=>{console.warn(e,...r,_a())});var Rc="no promo",_n="promo-tag",zc="yellow",Nc="neutral",Oc=(e,r,t)=>{let a=n=>n||Rc,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Ic="cancel-context",wr=(e,r)=>{let t=e===Ic,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?_n:`${_n} no-promo`,text:Oc(o,r,i),variant:n?zc:Nc,isOverriden:i}};var Pa;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Pa||(Pa={}));var ce;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(ce||(ce={}));var pe;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(pe||(pe={}));var La;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(La||(La={}));var Ma;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(Ma||(Ma={}));var Ra;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(Ra||(Ra={}));var za;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(za||(za={}));var Na="ABM",Oa="PUF",Ia="M2M",Da="PERPETUAL",Ha="P3Y",Dc="TAX_INCLUSIVE_DETAILS",Hc="TAX_EXCLUSIVE",Pn={ABM:Na,PUF:Oa,M2M:Ia,PERPETUAL:Da,P3Y:Ha},Jm={[Na]:{commitment:ce.YEAR,term:pe.MONTHLY},[Oa]:{commitment:ce.YEAR,term:pe.ANNUAL},[Ia]:{commitment:ce.MONTH,term:pe.MONTHLY},[Da]:{commitment:ce.PERPETUAL,term:void 0},[Ha]:{commitment:ce.THREE_MONTHS,term:pe.P3Y}},Ln="Value is not an offer",Er=e=>{if(typeof e!="object")return Ln;let{commitment:r,term:t}=e,a=Bc(r,t);return{...e,planType:a}};var Bc=(e,r)=>{switch(e){case void 0:return Ln;case"":return"";case ce.YEAR:return r===pe.MONTHLY?Na:r===pe.ANNUAL?Oa:"";case ce.MONTH:return r===pe.MONTHLY?Ia:"";case ce.PERPETUAL:return Da;case ce.TERM_LICENSE:return r===pe.P3Y?Ha:"";default:return""}};function Mn(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==Dc)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:Hc}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var qe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Rn=1e3;function Fc(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function zn(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!qe.serializableTypes.includes(t))return t}return e}function Uc(e,r){if(!qe.ignoredProperties.includes(e))return zn(r)}var Ba={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(Fc(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(zn).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${qe.delimiter}page=${o}${s}`;c.length>Rn&&(c=`${c.slice(0,Rn)}<trunc>`),n+=c,i.length&&(n+=`${qe.delimiter}facts=`,n+=JSON.stringify(i,Uc)),window.lana?.log(n,qe)}};function Sr(e){Object.assign(qe,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in qe&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Nn={LOCAL:"local",PROD:"prod",STAGE:"stage"},Fa={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Ua=new Set,$a=new Set,On=new Map,In={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},Dn={filter:({level:e})=>e!==Fa.DEBUG},$c={filter:()=>!1};function Gc(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&vr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function qc(e){[...$a].every(r=>r(e))&&Ua.forEach(r=>r(e))}function Hn(e){let r=(On.get(e)??0)+1;On.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>Hn(`${a.namespace}/${i}`),updateConfig:Sr};return Object.values(Fa).forEach(i=>{a[i]=(n,...o)=>qc(Gc(i,n,e,o,t))}),Object.seal(a)}function Ar(...e){e.forEach(r=>{let{append:t,filter:a}=r;vr(a)&&$a.add(a),vr(t)&&Ua.add(t)})}function Vc(e={}){let{name:r}=e,t=E(H("commerce.debug",{search:!0,storage:!0}),r===Nn.LOCAL);return Ar(t?In:Dn),r===Nn.PROD&&Ar(Ba),ne}function jc(){Ua.clear(),$a.clear()}var ne={...Hn(na),Level:Fa,Plugins:{consoleAppender:In,debugFilter:Dn,quietFilter:$c,lanaAppender:Ba},init:Vc,reset:jc,use:Ar};var Wc="mas-commerce-service",Yc=ne.module("utilities"),Xc={requestId:kt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function $t(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map(Mn)),a}var Bn=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function Ga(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let p=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?s.priceDetails?.formatString:s[l];m!==p&&Yc.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:p,actual:m})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=Bn(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=Bn(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var Cr=e=>window.setTimeout(e);function vt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(Tn).filter(Ft);return t.length||(t=[r]),t}function Tr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(Cn)}function oe(){return document.getElementsByTagName(Wc)?.[0]}function Fn(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(Xc)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var xt=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(kt);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var Kc={[ue]:Jr,[Me]:ea,[Ee]:ta},Zc={[ue]:ia,[Ee]:Le},Gt,Ie=class{constructor(r){z(this,Gt);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",Me);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=ne.module("mas-element")}update(){[ue,Me,Ee].forEach(r=>{this.wrapperElement.classList.toggle(Kc[r],r===this.state)})}notify(){(this.state===Ee||this.state===ue)&&(this.state===Ee?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ue&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof xt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Zc[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){L(this,Gt,oe()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return Ee===a?Promise.resolve(this.wrapperElement):ue===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=Ee,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Cr(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=ue,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,Gt)?.duration}),Cr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=Me,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!oe()||this.timer)return;let{error:t,options:a,state:i,value:n,version:o}=this;this.state=Me,this.timer=Cr(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===Me&&this.version===o&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};Gt=new WeakMap;function Un(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function kr(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,Un(r)),i}function $n(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Un(r)),e):null}function Qc(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var We,Ve=class Ve extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new Ie(this));z(this,We);this.setAttribute("is",Ve.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),L(this,We,Pt()),v(this,We)&&(this.log=v(this,We).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),L(this,We,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Pt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=a,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,p=this.getAttribute("data-promotion-code");p&&(d+=`&promotion_code=${encodeURIComponent(p)}`),this.href=`${Qc(l)}?${d}`,this.masElement.toggleResolved(i,o,a)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,a),!1}}static createFrom(t){let a=new Ve;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};We=new WeakMap,g(Ve,"is","upt-link"),g(Ve,"tag","a"),g(Ve,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var je=Ve;window.customElements.get(je.is)||window.customElements.define(je.is,je,{extends:je.tag});function Gn(e){return e&&(e==="bizpro"||e.startsWith("plans")?"plans":e)}var Jc="p_draft_landscape",el="/store/",tl=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),qa=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),rl=["env","workflowStep","clientId","country"],al=["/tw/","/hk_zh/"];function il(e){let r=e??"";return al.some(t=>r.startsWith(t))}function nl(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(il)}function Va(e){if(!nl())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var qn=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),Vn=e=>tl.get(e)??e;function _r(e,r,t){for(let[a,i]of Object.entries(e)){let n=Vn(a);i!=null&&t.has(n)&&r.set(n,i)}}function ol(e){switch(e){case ha.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function sl(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let o=Vn(i);r.set(`items[${t}][${o}]`,n)}}}function cl({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===Ue.CRM?"creative":"mini_plans"),e}function ll(e){let r=new URLSearchParams(window.location.search),t={};qn.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=i)}),Object.keys(t).length>0&&_r(t,e.searchParams,qn)}function jn(e){dl(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:p,...m}=e,h=new URL(ol(r));if(h.pathname=`${el}${a}`,a!==ae.SEGMENTATION&&a!==ae.CHANGE_PLAN_TEAM_PLANS&&sl(t,h.searchParams),_r({...m},h.searchParams,qa),ll(h),c===Re.DRAFT&&_r({af:Jc},h.searchParams,qa),a===ae.SEGMENTATION){let u={marketSegment:i,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};p?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):p?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),_r(u,h.searchParams,qa),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=cl({url:h,modal:l,is3in1:d})}return Va(h)}function dl(e){for(let r of rl)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==ae.SEGMENTATION&&e.workflowStep!==ae.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var hl=/[0-9\-+#]/,pl=/[^\d\-+#]/g;function Wn(e){return e.search(hl)}function ml(e="#.##"){let r={},t=e.length,a=Wn(e);r.prefix=a>0?e.substring(0,a):"";let i=Wn(e.split("").reverse().join("")),n=t-i,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=i>0?e.substring(s,t):"",r.mask=e.substring(a,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(pl);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function ul(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=i.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),i.integer=o,i.fraction=s,gl(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function gl(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function fl(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=ml(e),i=ul(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var Yn=fl;var Xn=".",vl=",",Zn=/^\s+/,Qn=/\s+$/,Kn="&nbsp;",ja=e=>e*12,Xe=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),p=new Date(i);return l>=d&&l<=p},Ye={MONTH:"MONTH",YEAR:"YEAR"},xl={[de.ANNUAL]:12,[de.MONTHLY]:1,[de.THREE_YEARS]:36,[de.TWO_YEARS]:24},Wa=(e,r)=>({accept:e,round:r}),bl=[Wa(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),Wa(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),Wa(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],Ya={[Fe.YEAR]:{[de.MONTHLY]:Ye.MONTH,[de.ANNUAL]:Ye.YEAR},[Fe.MONTH]:{[de.MONTHLY]:Ye.MONTH}},yl=(e,r)=>e.indexOf(`'${r}'`)===0,wl=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=eo(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Sl(e)}`),t},El=e=>{let r=Al(e),t=yl(e,r),a=e.replace(/'.*?'/,""),i=Zn.test(a)||Qn.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},Jn=e=>e.replace(Zn,Kn).replace(Qn,Kn),Sl=e=>e.match(/#(.?)#/)?.[1]===Xn?vl:Xn,Al=e=>e.match(/'(.*?)'/)?.[1]??"",eo=e=>e.match(/0(.?)0/)?.[1]??"";function bt({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1},i,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=El(e),l=t?eo(e):"",d=wl(e,t),p=t?2:0,m=n(r,{currencySymbol:o}),h=a?m.toLocaleString("hi-IN",{minimumFractionDigits:p,maximumFractionDigits:p}):Yn(d,m),u=t?h.lastIndexOf(l):h.length,f=h.substring(0,u),x=h.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var to=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=xl[t]??1;return bt(e,i>1?Ye.MONTH:Ya[r]?.[t],n=>{let o={divisor:i,price:n,usePrecision:a},{round:s}=bl.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},ro=({commitment:e,term:r,...t})=>bt(t,Ya[e]?.[r]),ao=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===Fe.YEAR&&c===de.MONTHLY){if(!o)return bt(e,Ye.YEAR,ja);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(Xe(o,t,s)){let p=parseInt(d.replace("P","").replace("M",""));if(isNaN(p))return ja(a);let m=i*p,h=n*(12-p),u=Math.round((m+h)*100)/100;return bt({...e,price:u},Ye.YEAR)}default:return bt(e,Ye.YEAR,()=>ja(n??a))}}return bt(e,Ya[r]?.[c])};var io="download",no="upgrade",oo={e:"EDU",t:"TEAM"};function so(e,r={},t=""){let a=oe();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f}=a.collectCheckoutOptions(r),x=kr(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function co(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new Ie(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0].marketSegments?.[0];return oo[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return oo[a]??a}get is3in1Modal(){return Object.values(Ue).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=oe();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>$t(h,n));let d=l.flat().find(h=>h.promotion);!Xe(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let m=await i.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},m,s)}renderOffers(a,i,n={},o=void 0,s=void 0){let c=oe();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(io,no),this.masElement.toggleResolved(s,a,i);let{url:d,text:p,className:m,handler:h}=o;d&&this.setCheckoutUrl(Va(d)),p&&(this.firstElementChild.innerHTML=p),m&&this.classList.add(...m.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(a.length){if(this.masElement.toggleResolved(s,a,i)){if(!this.classList.contains(io)&&!this.classList.contains(no)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(a){}updateOptions(a={}){let i=oe();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}=i.collectCheckoutOptions(a);return $n(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}),!0}}}var qt=class qt extends co(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return so(qt,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(qt,"is","checkout-link"),g(qt,"tag","a");var Te=qt;window.customElements.get(Te.is)||window.customElements.define(Te.is,Te,{extends:Te.tag});var M=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:ae.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:ve.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Re.PUBLISHED});function lo({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u};if(o)for(let et of r.checkout)et(o,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:y=c,imsCountry:A,country:b=A??l,language:C=d,quantity:D=m,entitlement:R,upgrade:U,modal:V,perpetual:te,promotionCode:X=p,wcsOsi:F,extraOptions:O,...re}=Object.assign(f,o?.dataset??{},n??{}),le=Ut(y,ae,M.checkoutWorkflowStep);return f=br({...re,extraOptions:O,checkoutClientId:s,checkoutMarketSegment:x,country:b,quantity:vt(D,M.quantity),checkoutWorkflowStep:le,language:C,entitlement:E(R),upgrade:E(U),modal:V,perpetual:E(te),promotionCode:wr(X).effectivePromoCode,wcsOsi:Tr(F),preselectPlan:h}),f}function a(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:p,country:m,promotionCode:h,quantity:u,preselectPlan:f,ms:x,cs:y,...A}=t(o),b=document.querySelector("meta[name=mas-ff-3in1]"),C=Object.values(Ue).includes(o.modal)&&(!b||b.content!=="off"),D=window.frameElement||C?"if":"fp",[{productArrangementCode:R,marketSegments:[U],customerSegment:V,offerType:te}]=n,X=x??U??d,F=y??V;f?.toLowerCase()==="edu"?X="EDU":f?.toLowerCase()==="team"&&(F="TEAM");let O={is3in1:C,checkoutPromoCode:h,clientId:l,context:D,country:m,env:s,items:[],marketSegment:X,customerSegment:F,offerType:te,productArrangementCode:R,workflowStep:p,landscape:c,...A},re=u[0]>1?u[0]:void 0;if(n.length===1){let{offerId:le}=n[0];O.items.push({id:le,quantity:re})}else O.items.push(...n.map(({offerId:le,productArrangementCode:et})=>({id:le,quantity:re,...C?{productArrangementCode:et}:{}})));return jn(O)}let{createCheckoutLink:i}=Te;return{CheckoutLink:Te,CheckoutWorkflowStep:ae,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}function Cl({interval:e=200,maxAttempts:r=25}={}){let t=ne.module("ims");return new Promise(a=>{t.debug("Waing for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function Tl(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function kl(e){let r=ne.module("ims");return e.then(t=>t?window.adobeIMS.getProfile().then(({countryCode:a})=>(r.debug("Got user country:",a),a),a=>{r.error("Unable to get user country:",a)}):null)}function ho({}){let e=Cl(),r=Tl(e),t=kl(r);return{imsReadyPromise:e,imsSignedInPromise:r,imsCountryPromise:t}}var po=window.masPriceLiterals;function mo(e){if(Array.isArray(po)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>po.find(n=>ka(n.lang,i)),a=t(r)??t(M.language);if(a)return Object.freeze(a)}return{}}var Xa=function(e,r){return Xa=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},Xa(e,r)};function Vt(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");Xa(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var _=function(){return _=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},_.apply(this,arguments)};function Pr(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var S;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(S||(S={}));var B;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(B||(B={}));var Ke;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Ke||(Ke={}));function Ka(e){return e.type===B.literal}function uo(e){return e.type===B.argument}function Lr(e){return e.type===B.number}function Mr(e){return e.type===B.date}function Rr(e){return e.type===B.time}function zr(e){return e.type===B.select}function Nr(e){return e.type===B.plural}function go(e){return e.type===B.pound}function Or(e){return e.type===B.tag}function Ir(e){return!!(e&&typeof e=="object"&&e.type===Ke.number)}function jt(e){return!!(e&&typeof e=="object"&&e.type===Ke.dateTime)}var Za=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var _l=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function fo(e){var r={};return e.replace(_l,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var vo=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function wo(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(vo).filter(function(m){return m.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var p=d[l];if(p.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function Pl(e){return e.replace(/^(.*?)-/,"")}var xo=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Eo=/^(@+)?(\+|#+)?[rs]?$/g,Ll=/(\*)(0+)|(#+)(0+)|(0+)/g,So=/^(0+)$/;function bo(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(Eo,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function Ao(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Ml(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!So.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function yo(e){var r={},t=Ao(e);return t||r}function Co(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=Pl(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=_(_(_({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return _(_({},c),yo(l))},{}));continue;case"engineering":r=_(_(_({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return _(_({},c),yo(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(Ll,function(c,l,d,p,m,h){if(l)r.minimumIntegerDigits=d.length;else{if(p&&m)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(So.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(xo.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(xo,function(c,l,d,p,m,h){return d==="*"?r.minimumFractionDigits=l.length:p&&p[0]==="#"?r.maximumFractionDigits=p.length:m&&h?(r.minimumFractionDigits=m.length,r.maximumFractionDigits=m.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=_(_({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=_(_({},r),bo(n)));continue}if(Eo.test(i.stem)){r=_(_({},r),bo(i.stem));continue}var o=Ao(i.stem);o&&(r=_(_({},r),o));var s=Ml(i.stem);s&&(r=_(_({},r),s))}return r}var Wt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function To(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=Rl(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function Rl(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=Wt[a||""]||Wt[t||""]||Wt["".concat(t,"-001")]||Wt["001"];return i[0]}var Qa,zl=new RegExp("^".concat(Za.source,"*")),Nl=new RegExp("".concat(Za.source,"*$"));function P(e,r){return{start:e,end:r}}var Ol=!!String.prototype.startsWith,Il=!!String.fromCodePoint,Dl=!!Object.fromEntries,Hl=!!String.prototype.codePointAt,Bl=!!String.prototype.trimStart,Fl=!!String.prototype.trimEnd,Ul=!!Number.isSafeInteger,$l=Ul?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},ei=!0;try{ko=Mo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),ei=((Qa=ko.exec("a"))===null||Qa===void 0?void 0:Qa[0])==="a"}catch{ei=!1}var ko,_o=Ol?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},ti=Il?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,o;i>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");a+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return a},Po=Dl?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],o=n[0],s=n[1];t[o]=s}return t},Lo=Hl?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},Gl=Bl?function(r){return r.trimStart()}:function(r){return r.replace(zl,"")},ql=Fl?function(r){return r.trimEnd()}:function(r){return r.replace(Nl,"")};function Mo(e,r){return new RegExp(e,r)}var ri;ei?(Ja=Mo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),ri=function(r,t){var a;Ja.lastIndex=t;var i=Ja.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):ri=function(r,t){for(var a=[];;){var i=Lo(r,t);if(i===void 0||zo(i)||Wl(i))break;a.push(i),t+=i>=65536?2:1}return ti.apply(void 0,a)};var Ja,Ro=function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,a);if(o.err)return o;i.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:B.pound,location:P(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(S.UNMATCHED_CLOSING_TAG,P(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&ai(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;i.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;i.push(o.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:B.literal,value:"<".concat(i,"/>"),location:P(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!ai(this.char()))return this.error(S.INVALID_TAG,P(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(S.UNMATCHED_CLOSING_TAG,P(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:B.tag,value:i,children:o,location:P(a,this.clonePosition())},err:null}:this.error(S.INVALID_TAG,P(s,this.clonePosition())))}else return this.error(S.UNCLOSED_TAG,P(a,this.clonePosition()))}else return this.error(S.INVALID_TAG,P(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&jl(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){i+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=P(a,this.clonePosition());return{val:{type:B.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!Vl(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return ti.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),ti(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,P(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(S.EMPTY_ARGUMENT,P(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(S.MALFORMED_ARGUMENT,P(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,P(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:B.argument,value:i,location:P(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,P(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(S.MALFORMED_ARGUMENT,P(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=ri(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),o=P(r,n);return{value:a,location:o}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(S.EXPECT_ARGUMENT_TYPE,P(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),p=this.parseSimpleArgStyleIfPossible();if(p.err)return p;var m=ql(p.val);if(m.length===0)return this.error(S.EXPECT_ARGUMENT_STYLE,P(this.clonePosition(),this.clonePosition()));var h=P(d,this.clonePosition());l={style:m,styleLocation:h}}var u=this.tryParseArgumentClose(i);if(u.err)return u;var f=P(i,this.clonePosition());if(l&&_o(l?.style,"::",0)){var x=Gl(l.style.slice(2));if(s==="number"){var p=this.parseNumberSkeletonFromString(x,l.styleLocation);return p.err?p:{val:{type:B.number,value:a,location:f,style:p.val},err:null}}else{if(x.length===0)return this.error(S.EXPECT_DATE_TIME_SKELETON,f);var y=x;this.locale&&(y=To(x,this.locale));var m={type:Ke.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?fo(y):{}},A=s==="date"?B.date:B.time;return{val:{type:A,value:a,location:f,style:m},err:null}}}return{val:{type:s==="number"?B.number:s==="date"?B.date:B.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(S.EXPECT_SELECT_ARGUMENT_OPTIONS,P(b,_({},b)));this.bumpSpace();var C=this.parseIdentifierIfPossible(),D=0;if(s!=="select"&&C.value==="offset"){if(!this.bumpIf(":"))return this.error(S.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,P(this.clonePosition(),this.clonePosition()));this.bumpSpace();var p=this.tryParseDecimalInteger(S.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,S.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(p.err)return p;this.bumpSpace(),C=this.parseIdentifierIfPossible(),D=p.val}var R=this.tryParsePluralOrSelectOptions(r,s,t,C);if(R.err)return R;var u=this.tryParseArgumentClose(i);if(u.err)return u;var U=P(i,this.clonePosition());return s==="select"?{val:{type:B.select,value:a,options:Po(R.val),location:U},err:null}:{val:{type:B.plural,value:a,options:Po(R.val),offset:D,pluralType:s==="plural"?"cardinal":"ordinal",location:U},err:null}}default:return this.error(S.INVALID_ARGUMENT_TYPE,P(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,P(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(S.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,P(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=wo(r)}catch{return this.error(S.INVALID_NUMBER_SKELETON,t)}return{val:{type:Ke.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?Co(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,o=!1,s=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var p=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var m=this.tryParseDecimalInteger(S.EXPECT_PLURAL_ARGUMENT_SELECTOR,S.INVALID_PLURAL_ARGUMENT_SELECTOR);if(m.err)return m;d=P(p,this.clonePosition()),l=this.message.slice(p.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?S.DUPLICATE_SELECT_ARGUMENT_SELECTOR:S.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?S.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:S.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,P(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(r+1,t,a);if(u.err)return u;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:u.val,location:P(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?S.EXPECT_SELECT_ARGUMENT_SELECTOR:S.EXPECT_PLURAL_ARGUMENT_SELECTOR,P(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(S.MISSING_OTHER_CLAUSE,P(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=P(i,this.clonePosition());return n?(o*=a,$l(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=Lo(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(_o(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&zo(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e}();function ai(e){return e>=97&&e<=122||e>=65&&e<=90}function Vl(e){return ai(e)||e===47}function jl(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function zo(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function Wl(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function ii(e){e.forEach(function(r){if(delete r.location,zr(r)||Nr(r))for(var t in r.options)delete r.options[t].location,ii(r.options[t].value);else Lr(r)&&Ir(r.style)||(Mr(r)||Rr(r))&&jt(r.style)?delete r.style.location:Or(r)&&ii(r.children)})}function No(e,r){r===void 0&&(r={}),r=_({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new Ro(e,r).parse();if(t.err){var a=SyntaxError(S[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||ii(t.val),t.val}function Yt(e,r){var t=r&&r.cache?r.cache:Jl,a=r&&r.serializer?r.serializer:Ql,i=r&&r.strategy?r.strategy:Xl;return i(e,{cache:t,serializer:a})}function Yl(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Oo(e,r,t,a){var i=Yl(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function Io(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function ni(e,r,t,a,i){return t.bind(r,e,a,i)}function Xl(e,r){var t=e.length===1?Oo:Io;return ni(e,this,t,r.cache.create(),r.serializer)}function Kl(e,r){return ni(e,this,Io,r.cache.create(),r.serializer)}function Zl(e,r){return ni(e,this,Oo,r.cache.create(),r.serializer)}var Ql=function(){return JSON.stringify(arguments)};function oi(){this.cache=Object.create(null)}oi.prototype.get=function(e){return this.cache[e]};oi.prototype.set=function(e,r){this.cache[e]=r};var Jl={create:function(){return new oi}},Dr={variadic:Kl,monadic:Zl};var Ze;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Ze||(Ze={}));var Xt=function(e){Vt(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r}(Error);var si=function(e){Vt(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),Ze.INVALID_VALUE,n)||this}return r}(Xt);var Do=function(e){Vt(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),Ze.INVALID_VALUE,i)||this}return r}(Xt);var Ho=function(e){Vt(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),Ze.MISSING_VALUE,a)||this}return r}(Xt);var Q;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(Q||(Q={}));function ed(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==Q.literal||t.type!==Q.literal?r.push(t):a.value+=t.value,r},[])}function td(e){return typeof e=="function"}function Kt(e,r,t,a,i,n,o){if(e.length===1&&Ka(e[0]))return[{type:Q.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(Ka(d)){s.push({type:Q.literal,value:d.value});continue}if(go(d)){typeof n=="number"&&s.push({type:Q.literal,value:t.getNumberFormat(r).format(n)});continue}var p=d.value;if(!(i&&p in i))throw new Ho(p,o);var m=i[p];if(uo(d)){(!m||typeof m=="string"||typeof m=="number")&&(m=typeof m=="string"||typeof m=="number"?String(m):""),s.push({type:typeof m=="string"?Q.literal:Q.object,value:m});continue}if(Mr(d)){var h=typeof d.style=="string"?a.date[d.style]:jt(d.style)?d.style.parsedOptions:void 0;s.push({type:Q.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(Rr(d)){var h=typeof d.style=="string"?a.time[d.style]:jt(d.style)?d.style.parsedOptions:a.time.medium;s.push({type:Q.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(Lr(d)){var h=typeof d.style=="string"?a.number[d.style]:Ir(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(m=m*(h.scale||1)),s.push({type:Q.literal,value:t.getNumberFormat(r,h).format(m)});continue}if(Or(d)){var u=d.children,f=d.value,x=i[f];if(!td(x))throw new Do(f,"function",o);var y=Kt(u,r,t,a,i,n),A=x(y.map(function(D){return D.value}));Array.isArray(A)||(A=[A]),s.push.apply(s,A.map(function(D){return{type:typeof D=="string"?Q.literal:Q.object,value:D}}))}if(zr(d)){var b=d.options[m]||d.options.other;if(!b)throw new si(d.value,m,Object.keys(d.options),o);s.push.apply(s,Kt(b.value,r,t,a,i));continue}if(Nr(d)){var b=d.options["=".concat(m)];if(!b){if(!Intl.PluralRules)throw new Xt(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Ze.MISSING_INTL_API,o);var C=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[C]||d.options.other}if(!b)throw new si(d.value,m,Object.keys(d.options),o);s.push.apply(s,Kt(b.value,r,t,a,i,m-(d.offset||0)));continue}}return ed(s)}function rd(e,r){return r?_(_(_({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=_(_({},e[a]),r[a]||{}),t},{})):e}function ad(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=rd(e[a],r[a]),t},_({},e)):e}function ci(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function id(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Yt(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,Pr([void 0],t,!1)))},{cache:ci(e.number),strategy:Dr.variadic}),getDateTimeFormat:Yt(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,Pr([void 0],t,!1)))},{cache:ci(e.dateTime),strategy:Dr.variadic}),getPluralRules:Yt(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,Pr([void 0],t,!1)))},{cache:ci(e.pluralRules),strategy:Dr.variadic})}}var Bo=function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==Q.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Kt(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=ad(e.formats,a),this.formatters=i&&i.formatters||id(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=No,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Fo=Bo;var li={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},nd=kn("ConsonantTemplates/price"),od=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},De={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},di="TAX_EXCLUSIVE",sd=e=>An(e)?Object.entries(e).filter(([,r])=>ft(r)||xr(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Sn(a)}"`}`,""):"",q=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${sd(t)}>${a?Jn(r):r??""}</span>`;function cd(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function ld(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function ke(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?cd(i):i,i=n?i.replace(od,""):i;let s=new Fo(i,r).format(a);return o?ld(s):s}catch{return nd.error("Failed to format literal:",i),""}}function dd(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=q($.currencySymbol,a),u=q($.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=q($.integer,s),f+=q($.decimalsDelimiter,n),f+=q($.decimals,i),c||(f+=u+h),f+=q($.recurrence,l,null,!0),f+=q($.unitType,d,null,!0),f+=q($.taxInclusivity,p,!0),q(e,f,{...m})}var K=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:A,price:b,priceWithoutDiscount:C,taxDisplay:D,taxTerm:R,term:U,usePrecision:V,promotion:te}={},X={})=>{Object.entries({country:o,formatString:A,language:p,price:b}).forEach(([As,Cs])=>{if(Cs==null)throw new Error(`Argument "${As}" is missing for osi ${y?.toString()}, country ${o}, language ${p}`)});let F={...li,...m},O=`${p.toLowerCase()}-${o.toUpperCase()}`,re;te&&!f&&C?re=e||a?b:C:t&&C?re=C:re=b;let le=r?to:ro;i&&(le=ao);let{accessiblePrice:et,recurrenceTerm:xi,...bi}=le({commitment:x,formatString:A,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:C,price:r?b:re,promotion:te,quantity:h,term:U,usePrecision:V}),Fr="",Ur="",$r="";E(c)&&xi&&($r=ke(F,O,De.recurrenceLabel,{recurrenceTerm:xi}));let rr="";E(l)&&(u&&(rr+=" "),rr+=ke(F,O,De.perUnitLabel,{perUnit:"LICENSE"}));let ar="";E(d)&&R&&(u&&(ar+=" "),ar+=ke(F,O,D===di?De.taxExclusiveLabel:De.taxInclusiveLabel,{taxTerm:R})),t&&(Fr=ke(F,O,De.strikethroughAriaLabel,{strikethroughPrice:Fr})),e&&(Ur=ke(F,O,De.alternativePriceAriaLabel,{alternativePrice:Ur}));let Be=$.container;if(r&&(Be+=` ${$.containerOptical}`),t&&(Be+=` ${$.containerStrikethrough}`),a&&(Be+=` ${$.containerPromoStrikethrough}`),e&&(Be+=` ${$.containerAlternative}`),i&&(Be+=` ${$.containerAnnual}`),E(s))return dd(Be,{...bi,accessibleLabel:Fr,altAccessibleLabel:Ur,recurrenceLabel:$r,perUnitLabel:rr,taxInclusivityLabel:ar},X);let{currencySymbol:yi,decimals:bs,decimalsDelimiter:ys,hasCurrencySpace:wi,integer:ws,isCurrencyFirst:Es}=bi,tt=[ws,ys,bs];Es?(tt.unshift(wi?"\xA0":""),tt.unshift(yi)):(tt.push(wi?"\xA0":""),tt.push(yi)),tt.push($r,rr,ar);let Ss=tt.join("");return q(Be,Ss,X)},Uo=()=>(e,r,t)=>{let a=Xe(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${K({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${K({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},$o=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=Xe(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return K()(e,{...r,price:r.priceWithoutDiscount},t)+q($.containerAnnualPrefix," (")+K({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+q($.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${K({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${K({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${q($.containerAnnualPrefix," (")}${K({displayAnnual:!0,instant:a})(n,r,t)}${q($.containerAnnualSuffix,")")}`},Go=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${K({isAlternativePrice:e.displayOldPrice})(e,r,t)}${q($.containerAnnualPrefix," (")}${K({displayAnnual:!0})(a,r,t)}${q($.containerAnnualSuffix,")")}`};var Zt={...$,containerLegal:"price-legal",planType:"price-plan-type"},Hr={...De,planTypeLabel:"planTypeLabel"};function hd(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=q(Zt.unitType,r,null,!0),t&&a&&n&&(t+=". "),o+=q(Zt.taxInclusivity,t,!0),o+=q(Zt.planType,a,null),q(e,o,{...i})}var qo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,language:n,literals:o={}}={},{taxDisplay:s,taxTerm:c,planType:l}={},d={})=>{let p={...li,...o},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";E(r)&&(h=ke(p,m,Hr.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),E(t)&&c&&(u=ke(p,m,s===di?Hr.taxExclusiveLabel:Hr.taxInclusiveLabel,{taxTerm:c}));let f="";E(a)&&l&&(f=ke(p,m,Hr.planTypeLabel,{planType:l}));let x=Zt.container;return x+=` ${Zt.containerLegal}`,hd(x,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,i)};var Vo=K(),jo=Uo(),Wo=K({displayOptical:!0}),Yo=K({displayStrikethrough:!0}),Xo=K({displayPromoStrikethrough:!0}),Ko=K({displayAnnual:!0}),Zo=K({displayOptical:!0,isAlternativePrice:!0}),Qo=K({isAlternativePrice:!0}),Jo=Go(),es=$o(),ts=qo;var pd=(e,r)=>{if(!(!Ft(e)||!Ft(r)))return Math.floor((r-e)/r*100)},rs=()=>(e,r)=>{let{price:t,priceWithoutDiscount:a}=r,i=pd(t,a);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var as=rs();var is="INDIVIDUAL_COM",pi="TEAM_COM",ns="INDIVIDUAL_EDU",mi="TEAM_EDU",md=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],ud={[is]:[],[pi]:[],[ns]:[],[mi]:[]},gd={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},fd=[is,pi,ns,mi],vd=e=>[pi,mi].includes(e);function hi(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var xd=(e,r,t,a)=>{let i=`${t}_${a}`,n=hi(gd,e,r,!1);if(n){let o=fd.indexOf(i);return n[o]}return vd(i)},bd=(e,r,t,a)=>{if(hi(md,e,r,!0))return!0;let i=ud[`${t}_${a}`];return i?hi(i,e,r,!0)?!0:M.displayTax:M.displayTax},ui=async(e,r,t,a)=>{let i=bd(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?xd(e,r,t,a):M.forceTaxExclusive}},Qt=class Qt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ie(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=oe();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=a.collectPriceOptions(t);return kr(Qt,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ue}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=oe();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let u=$t(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=Ga(l);if(a.featureFlags[Se]||n[Se]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,x=await ui(h,u,p.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let A=$t(y,n);return A?.length?A[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[rt]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=Ga(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=oe();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(Qt,"is","inline-price"),g(Qt,"tag","span");var _e=Qt;window.customElements.get(_e.is)||window.customElements.define(_e.is,_e,{extends:_e.tag});function os({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let R of r.price)R(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:y,quantity:A,alternativePrice:b,wcsOsi:C,...D}=Object.assign(c,s?.dataset??{},o??{});return c=br(Object.assign({...c,...D,displayOldPrice:E(l),displayPerUnit:E(d),displayRecurrence:E(p),displayTax:E(m),displayPlanType:E(h),forceTaxExclusive:E(u),perpetual:E(f),displayAnnual:E(x),promotionCode:wr(y).effectivePromoCode,quantity:vt(A,M.quantity),alternativePrice:E(b),wcsOsi:Tr(C)})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=as;break;case"strikethrough":l=Yo;break;case"promo-strikethrough":l=Xo;break;case"annual":l=Ko;break;case"legal":l=ts;break;default:s.template==="optical"&&s.alternativePrice?l=Zo:s.template==="optical"?l=Wo:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?es:Jo:s.alternativePrice?l=Qo:l=s.promotionCode&&o[0].promotion?jo:Vo}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=_e.createInlinePrice;return{InlinePrice:_e,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function yd({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||M.language),r??(r=e?.split("_")?.[1]||M.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function ss(e={},r){let t=r.featureFlags[Se],{commerce:a={}}=e,i=ve.PRODUCTION,n=la,o=H("checkoutClientId",a)??M.checkoutClientId,s=Ut(H("checkoutWorkflowStep",a),ae,M.checkoutWorkflowStep),c=E(H("displayOldPrice",a),M.displayOldPrice),l=M.displayPerUnit,d=E(H("displayRecurrence",a),M.displayRecurrence),p=E(H("displayTax",a),M.displayTax),m=E(H("displayPlanType",a),M.displayPlanType),h=E(H("entitlement",a),M.entitlement),u=E(H("modal",a),M.modal),f=E(H("forceTaxExclusive",a),M.forceTaxExclusive),x=H("promotionCode",a)??M.promotionCode,y=vt(H("quantity",a)),A=H("wcsApiKey",a)??M.wcsApiKey,b=a?.env==="stage",C=Re.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(H(sa,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",C=Ut(H(ca,a),Re,C)),b&&(i=ve.STAGE,n=da);let R=H(oa)??e.preview,U=typeof R<"u"&&R!=="off"&&R!=="false",V={};U&&(V={preview:U});let te=H("mas-io-url")??e.masIOUrl??`https://www${i===ve.STAGE?".stage":""}.adobe.com/mas/io`,X=H("preselect-plan")??void 0,F=H("instant")??e.instant;return{...yd(e),...V,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:M.extraOptions,modal:u,env:i,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:M.alternativePrice,wcsApiKey:A,wcsURL:n,landscape:C,masIOUrl:te,...X&&{preselectPlan:X},...F&&{instant:F}}}async function cs(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var gi="wcs";function ls({settings:e}){let r=ne.module(gi),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(u,f,x=!0){let y=oe(),A=aa;r.debug("Fetching:",u);let b="",C;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let D=new Map(f),[R]=u.offerSelectorIds,U=Date.now()+Math.random().toString(36).substring(2,7),V=`${gi}:${R}:${U}${pa}`,te=`${gi}:${R}:${U}${ma}`,X;try{if(performance.mark(V),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",R),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===ve.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),C=await cs(b.toString(),{credentials:"omit"}),C.ok){let F=[];try{let O=await C.json();r.debug("Fetched:",u,O),F=O.resolvedOffers??[]}catch(O){r.error(`Error parsing JSON: ${O.message}`,{...O.context,...y?.duration})}F=F.map(Er),f.forEach(({resolve:O},re)=>{let le=F.filter(({offerSelectorIds:et})=>et.includes(re)).flat();le.length&&(D.delete(re),f.delete(re),O(le))})}else A=ra}catch(F){A=`Network error: ${F.message}`}finally{X=performance.measure(te,V),performance.clearMarks(V),performance.clearMeasures(te)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=Fn(C);f.forEach(O=>{O.reject(new xt(A,{...u,...F,response:C,measure:or(X),...y?.duration}))})}}function l(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ve.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,A]of Object.entries(x))i.set(y,Promise.resolve(A.map(Er)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let u=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,x){let y=u!=="GB"&&!x?"MULT":"en",A=ua.includes(u)?u:M.country;return{validCountry:A,validLanguage:y,locale:`${f}_${A}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:A=[]}){let{validCountry:b,validLanguage:C,locale:D}=m(u,f,x),R=[b,C,y].filter(U=>U).join("-").toLowerCase();return A.map(U=>{let V=`${U}-${R}`;if(i.has(V))return i.get(V);let te=new Promise((X,F)=>{let O=n.get(R);O||(O={options:{country:b,locale:D,...C==="MULT"&&{language:C},offerSelectorIds:[]},promises:new Map},n.set(R,O)),y&&(O.options.promotionCode=y),O.options.offerSelectorIds.push(U),O.promises.set(U,{resolve:X,reject:F}),l()}).catch(X=>{if(s.has(V))return s.get(V);throw X});return i.set(V,te),te})}return{Commitment:Fe,PlanType:Pn,Term:de,applyPlanType:Er,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var ds="mas-commerce-service",hs="mas-commerce-service:start",ps="mas-commerce-service:ready",Jt,yt,Qe,ms,vi,fi=class extends HTMLElement{constructor(){super(...arguments);z(this,Qe);z(this,Jt);z(this,yt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,yt)||L(this,yt,{[Se]:j(this,Qe,vi).call(this,Se),[rt]:j(this,Qe,vi).call(this,rt)}),v(this,yt)}activate(){let t=v(this,Qe,ms),a=ss(t,this);Sr(t.lana);let i=ne.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:mo(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...lo(c),...ho(c),...os(c),...ls(c),...ga,Log:ne,resolvePriceTaxFlags:ui,get defaults(){return M},get log(){return ne},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(nr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(ps),L(this,Jt,performance.measure(ps,hs)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(hs),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Vr).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":or(v(this,Jt))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Jt=new WeakMap,yt=new WeakMap,Qe=new WeakSet,ms=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},vi=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(ds)||window.customElements.define(ds,fi);var vs="merch-card-collection",wd=3e4,Ed={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Sd={plans:!0},Ad=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Cd=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,Td=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),kd=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),_d=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,He,Et,Je,tr,Br,xs,wt=class extends gs{constructor(){super();z(this,Br);z(this,He,{});z(this,Et);z(this,Je);z(this,tr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return Pe` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a=new Promise(i=>setTimeout(()=>i(!1),wd));return Promise.race([this.hydrationReady,a])}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===ge.alphabetical?Td:kd,s=[Ad,Cd,_d,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Xr,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(me,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){L(this,He,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,He)[a]=i)})}connectedCallback(){super.connectedCallback(),L(this,Et,Pt()),v(this,Et)&&L(this,Je,v(this,Et).Log.module(vs)),L(this,tr,customElements.get("merch-card")),this.buildOverrideMap(),this.init()}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t()}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",a),o.setAttribute("placeholder",""),o.innerHTML=i,this.append(o)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Sd[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Tt));let i=v(this,tr)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(s=>{a=s});let i=this;function n(s){let c;return s.fields?.checkboxGroups?c=s.fields.checkboxGroups:s.fields?.tagFilters&&(c=[{title:s.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:s.fields.tagFilters.map(l=>{let d=l.split("/").pop(),p=s.settings?.tagLabels?.[d]||d;return p=p.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):p,{name:d,label:p}})}]),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(p,m){for(let h of m){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){v(i,Je)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let u=s.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)u=b,f=b.referencesTree,s.references={...s.references,...b.references};else{v(i,Je)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!u?.fields)continue;let{fields:y}=u,A={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(b=>c[b]||b):[],collections:[]};y.defaultchild&&(A.defaultchild=c[y.defaultchild]||y.defaultchild),p.push(A),d(A.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(Zr,s=>{j(this,Br,xs).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(Kr,async s=>{this.limit=27,this.data=o(s.detail,v(this,He)),s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?v(this,He)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let p=(u,f)=>{for(let x of u)if(x.defaultchild===f||x.collections&&p(x.collections,f))return!0;return!1};for(let u of c){let b=function(D){for(let R of D){let U=R.cards.indexOf(x);if(U===-1)continue;let V=R.queryLabel??R?.label?.toLowerCase()??"";f.filters[V]={order:U+1,size:u.fields.size},b(R.collections)}},f=document.createElement("merch-card"),x=v(this,He)[u.id]||u.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=u.fields.tags?.filter(D=>D.startsWith("mas:types/")).map(D=>D.split("/")[1]).join(",");y&&f.setAttribute("types",y),cr(u.fields.variant)?.supportsDefaultChild&&(d?x===d:p(l,x))&&f.setAttribute("data-default-card","true"),b(l);let C=document.createElement("aem-fragment");C.setAttribute("fragment",x),f.append(C),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(u)+1,size:u.fields.size}}),this.append(f)}let m="",h=Gn(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(u=>u.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?m=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(m=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Ed[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Pe`<div id="footer">

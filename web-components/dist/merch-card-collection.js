...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Pt,css as _s}from"./lit-all.min.js";var va=`
:root {
...
`;var Rs=32,Ca={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},rt=class extends _{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>tr` <footer>
    ...
    `);import{html as Lt,css as Ns,nothing as rr}from"./lit-all.min.js";var _a=`
:root {
...
`;var Oa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},be,it=class extends _{constructor(t){super(t);U(this,be);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Na}priceOptionsProvider(t,i){t.dataset.template===ne&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return oi` ${this.badge}
...
`;var Da={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},at=class extends _{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===ne&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return Ia}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${j}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return si`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Fa={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},ot=class extends _{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Ba}renderLayout(){return ci`${this.cardImage}
            ...
            ${this.evergreen?ci`
                  ...
                  `:ci`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(ot,"variantStyle",Bs`
...
`;var di={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},He=class He extends _{getGlobalCSS(){return $a}get aemFragmentMapping(){return di}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ga`
        ...
        `}async syncHeights(){if(await document.fonts.ready,await new Promise(i=>requestAnimationFrame(i)),this.card.getBoundingClientRect().width<=2)return;let r=He.SYNCED_SECTIONS.map(i=>({name:i,getElement:a=>a.shadowRoot?.querySelector(`.${i}`)})),t=Array.from({length:He.SYNCED_DESCRIPTION_ROWS},(i,a)=>({name:`description-row-${a}`,getElement:n=>n.querySelectorAll('[slot="body-s"] > *')[a]}));this.syncRowHeights([...r,...t])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),i=49;t.forEach(a=>{a.classList.remove("small-font-size-button"),a.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>i;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}renderLayout(){return Ga`
            ${this.badge}
            ...
            <slot></slot>
        `}};g(He,"SYNCED_DESCRIPTION_ROWS",12),g(He,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(He,"variantStyle",$s`
    ...
    `);var kt=He;import{html as hi,css as Gs,nothing as qs}from"./lit-all.min.js";var qa=`
...
`,je.MISSING_INTL_API,o);var A=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));x=d.options[A]||d.options.other}if(!x)throw new Wi(d.value,m,Object.keys(d.options),o);s.push.apply(s,Ut(x.value,r,t,i,a,m-(d.offset||0)));continue}}return Sl(s)}function Tl(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,i){return t[i]=P(P({},e[i]),r[i]||{}),t},{})):e}function Cl(e,r){return r?Object.keys(e).reduce(function(t,i){return t[i]=Tl(e[i],r[i]),t},P({},e)):e}function Yi(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function _l(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Bt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.NumberFormat).bind.apply(r,vr([void 0],t,!1)))},{cache:Yi(e.number),strategy:Tr.variadic}),getDateTimeFormat:Bt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.DateTimeFormat).bind.apply(r,vr([void 0],t,!1)))},{cache:Yi(e.dateTime),strategy:Tr.variadic}),getPluralRules:Bt(function(){for(var r,t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return new((r=Intl.PluralRules).bind.apply(r,vr([void 0],t,!1)))},{cache:Yi(e.pluralRules),strategy:Tr.variadic})}}var uo=function(){function e(r,t,i,a){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var l=s.reduce(function(c,d){return!c.length||d.type!==K.literal||typeof c[c.length-1]!="string"?c.push(d.value):c[c.length-1]+=d.value,c},[]);return l.length<=1?l[0]||"":l},this.formatToParts=function(o){return Ut(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Cl(e.formats,i),this.formatters=a&&a.formatters||_l(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=co,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var go=uo;var Xi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Pl=tn("ConsonantTemplates/price"),Ll=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Re={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ki="TAX_EXCLUSIVE",kl=e=>Qa(e)?Object.entries(e).filter(([,r])=>ht(r)||or(r)||r===!0).reduce((r,[t,i])=>`${r} ${t}${i===!0?"":`="${Za(i)}"`}`,""):"",G=(e,r,t,i=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${kl(t)}>${i?Pn(r):r??""}</span>`;function Ml(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function Rl(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function Ae(e,r,t,i){let a=e[t];if(a==null)return"";let n=a.includes("<"),o=a.includes("<a ");try{a=o?Ml(a):a,a=n?a.replace(Ll,""):a;let s=new go(a,r).format(i);return o?Rl(s):s}catch{return Pl.error("Failed to format literal:",a),""}}function Nl(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:l,recurrenceLabel:c,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=G($.currencySymbol,i),u=G($.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),l&&(f+=h+u),f+=G($.integer,s),f+=G($.decimalsDelimiter,n),f+=G($.decimals,a),l||(f+=u+h),f+=G($.recurrence,c,null,!0),f+=G($.unitType,d,null,!0),f+=G($.taxInclusivity,p,!0),G(e,f,{...m})}var Y=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:l=!0,displayPerUnit:c=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:v,offerSelectorIds:y,formatString:S,price:x,priceWithoutDiscount:A,taxDisplay:O,taxTerm:M,term:F,usePrecision:q,promotion:Q}={},W={})=>{Object.entries({country:o,formatString:S,language:p,price:x}).forEach(([Jo,es])=>{if(es==null)throw new Error(`Argument "${Jo}" is missing for osi ${y?.toString()}, country ${o}, language ${p}`)});let B={...Xi,...m},R=`${p.toLowerCase()}-${o.toUpperCase()}`,J;Q&&!f&&A?J=e||i?x:A:t&&A?J=A:J=x;let se=r?kn:Mn;a&&(se=Rn);let{accessiblePrice:Xe,recurrenceTerm:aa,...na}=se({commitment:v,formatString:S,instant:n,isIndianPrice:o==="IN",originalPrice:x,priceWithoutDiscount:A,price:r?x:J,promotion:Q,quantity:h,term:F,usePrecision:q}),Pr="",Lr="",kr="";w(l)&&aa&&(kr=Ae(B,R,Re.recurrenceLabel,{recurrenceTerm:aa}));let Wt="";w(c)&&(u&&(Wt+=" "),Wt+=Ae(B,R,Re.perUnitLabel,{perUnit:"LICENSE"}));let Yt="";w(d)&&M&&(u&&(Yt+=" "),Yt+=Ae(B,R,O===Ki?Re.taxExclusiveLabel:Re.taxInclusiveLabel,{taxTerm:M})),t&&(Pr=Ae(B,R,Re.strikethroughAriaLabel,{strikethroughPrice:Pr})),e&&(Lr=Ae(B,R,Re.alternativePriceAriaLabel,{alternativePrice:Lr}));let Oe=$.container;if(r&&(Oe+=` ${$.containerOptical}`),t&&(Oe+=` ${$.containerStrikethrough}`),i&&(Oe+=` ${$.containerPromoStrikethrough}`),e&&(Oe+=` ${$.containerAlternative}`),a&&(Oe+=` ${$.containerAnnual}`),w(s))return Nl(Oe,{...na,accessibleLabel:Pr,altAccessibleLabel:Lr,recurrenceLabel:kr,perUnitLabel:Wt,taxInclusivityLabel:Yt},W);let{currencySymbol:oa,decimals:Yo,decimalsDelimiter:Xo,hasCurrencySpace:sa,integer:Ko,isCurrencyFirst:Zo}=na,Ke=[Ko,Xo,Yo];Zo?(Ke.unshift(sa?"\xA0":""),Ke.unshift(oa)):(Ke.push(sa?"\xA0":""),Ke.push(oa)),Ke.push(kr,Wt,Yt);let Qo=Ke.join("");return G(Oe,Qo,W)},fo=()=>(e,r,t)=>{let i=qe(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||i);return`${n?`${Y({displayStrikethrough:!0})({isPromoApplied:i,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${Y({isAlternativePrice:n})({isPromoApplied:i,...e},r,t)}`},vo=()=>(e,r,t)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=qe(r.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return Y()(e,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualPrefix," (")+Y({displayAnnual:!0,instant:i})(n,{...r,price:r.priceWithoutDiscount},t)+G($.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${Y({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${Y({isAlternativePrice:s})({isPromoApplied:a,...e},r,t)}${G($.containerAnnualPrefix," (")}${Y({displayAnnual:!0,instant:i})(n,r,t)}${G($.containerAnnualSuffix,")")}`},xo=()=>(e,r,t)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${Y({isAlternativePrice:e.displayOldPrice})(e,r,t)}${G($.containerAnnualPrefix," (")}${Y({displayAnnual:!0})(i,r,t)}${G($.containerAnnualSuffix,")")}`};var $t={...$,containerLegal:"price-legal",planType:"price-plan-type"},Cr={...Re,planTypeLabel:"planTypeLabel"};function Ol(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:i},a={},n=!0){let o="";return o+=G($t.unitType,r,null,!0),t&&i&&n&&(t+=". "),o+=G($t.taxInclusivity,t,!0),o+=G($t.planType,i,null),G(e,o,{...a})}var bo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:i=!1,displayDot:a=!0,language:n,literals:o={}}={},{taxDisplay:s,taxTerm:l,planType:c}={},d={})=>{let p={...Xi,...o},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";w(r)&&(h=Ae(p,m,Cr.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),w(t)&&l&&(u=Ae(p,m,s===Ki?Cr.taxExclusiveLabel:Cr.taxInclusiveLabel,{taxTerm:l}));let f="";w(i)&&c&&(f=Ae(p,m,Cr.planTypeLabel,{planType:c}));let v=$t.container;return v+=` ${$t.containerLegal}`,Ol(v,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,a)};var yo=Y(),wo=fo(),Eo=Y({displayOptical:!0}),So=Y({displayStrikethrough:!0}),Ao=Y({displayPromoStrikethrough:!0}),To=Y({displayAnnual:!0}),Co=Y({displayOptical:!0,isAlternativePrice:!0}),_o=Y({isAlternativePrice:!0}),Po=xo(),Lo=vo(),ko=bo;var Il=(e,r)=>{if(!(!Mt(e)||!Mt(r)))return Math.floor((r-e)/r*100)},Mo=()=>(e,r)=>{let{price:t,priceWithoutDiscount:i}=r,a=Il(t,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var Ro=Mo();var No="INDIVIDUAL_COM",Qi="TEAM_COM",Oo="INDIVIDUAL_EDU",Ji="TEAM_EDU",Dl=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","AR_es","PH_en","PH_fil"],zl={[No]:[],[Qi]:["VN_vi","VN_en","TW_zh"],[Oo]:[],[Ji]:["VN_vi","VN_en","TW_zh"]},Hl={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Bl=[No,Qi,Oo,Ji],Fl=e=>[Qi,Ji].includes(e);function Zi(e,r,t,i){if(e[r])return e[r];let a=`${r}_${t}`;if(e[a])return e[a];let n;if(i)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Ul=(e,r,t,i)=>{let a=`${t}_${i}`,n=Zi(Hl,e,r,!1);if(n){let o=Bl.indexOf(a);return n[o]}return Fl(a)},$l=(e,r,t,i)=>{if(Zi(Dl,e,r,!0))return!0;let a=zl[`${t}_${i}`];return a?Zi(a,e,r,!0)?!0:k.displayTax:k.displayTax},ea=async(e,r,t,i)=>{let a=$l(e,r,t,i);return{displayTax:a,forceTaxExclusive:a?Ul(e,r,t,i):k.forceTaxExclusive}},Gt=class Gt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Me(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let i=ie();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:v}=i.collectPriceOptions(t);return gr(Gt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(t,i,a){this.masElement.attributeChangedCallback(t,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===he}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let i=ie();if(!i)return!1;let a=i.collectPriceOptions(t,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=i.resolveOfferSelectors(n),l=await Promise.all(s),c=l.map(h=>{let u=Nt(h,n);return u?.length?u[0]:null});if(c.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=c,p=Li(c);if(i.featureFlags[we]||n[we]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,v=await ea(h,u,p.customerSegment,f);a.displayTax===void 0&&(n.displayTax=v?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=v?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=l.map(y=>{let S=Nt(y,n);return S?.length?S[0]:null}))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(i.featureFlags[Qe]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=Li(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,i,a=void 0){if(!this.isConnected)return;let n=ie();if(!n)return!1;if(a??(a=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(a,t,i)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(l=>{l.dataset.template!=="strikethrough"&&l.options&&!l.options.alternativePrice&&!l.isFailed&&(l.options.alternativePrice=!0,l.innerHTML=n.buildPriceHTML(t,l.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,o,this.options))return this.innerHTML="",!0}return!1}};g(Gt,"is","inline-price"),g(Gt,"tag","span");var Te=Gt;window.customElements.get(Te.is)||window.customElements.define(Te.is,Te,{extends:Te.tag});function Io({literals:e,providers:r,settings:t}){function i(o,s=null){let l={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let M of r.price)M(s,l);let{displayOldPrice:c,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:v,promotionCode:y,quantity:S,alternativePrice:x,wcsOsi:A,...O}=Object.assign(l,s?.dataset??{},o??{});return l=sr(Object.assign({...l,...O,displayOldPrice:w(c),displayPerUnit:w(d),displayRecurrence:w(p),displayTax:w(m),displayPlanType:w(h),forceTaxExclusive:w(u),perpetual:w(f),displayAnnual:w(v),promotionCode:lr(y).effectivePromoCode,quantity:pt(S,k.quantity),alternativePrice:w(x),wcsOsi:ur(A)})),l}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:l}=s,c;switch(l){case"discount":c=Ro;break;case"strikethrough":c=So;break;case"promo-strikethrough":c=Ao;break;case"annual":c=To;break;case"legal":c=ko;break;default:s.template==="optical"&&s.alternativePrice?c=Co:s.template==="optical"?c=Eo:s.displayAnnual&&o[0].planType==="ABM"?c=s.promotionCode&&o[0].promotion?Lo:Po:s.alternativePrice?c=_o:c=s.promotionCode&&o[0].promotion?wo:yo}let[d]=o;return d={...d,...d.priceDetails},c({...t,...s},d)}let n=Te.createInlinePrice;return{InlinePrice:Te,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function Gl({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||k.language),r??(r=e?.split("_")?.[1]||k.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function Do(e={},r){let t=r.featureFlags[we],{commerce:i={}}=e,a=ge.PRODUCTION,n=Zr,o=z("checkoutClientId",i)??k.checkoutClientId,s=Rt(z("checkoutWorkflowStep",i),ee,k.checkoutWorkflowStep),l=w(z("displayOldPrice",i),k.displayOldPrice),c=k.displayPerUnit,d=w(z("displayRecurrence",i),k.displayRecurrence),p=w(z("displayTax",i),k.displayTax),m=w(z("displayPlanType",i),k.displayPlanType),h=w(z("entitlement",i),k.entitlement),u=w(z("modal",i),k.modal),f=w(z("forceTaxExclusive",i),k.forceTaxExclusive),v=z("promotionCode",i)??k.promotionCode,y=pt(z("quantity",i)),S=z("wcsApiKey",i)??k.wcsApiKey,x=i?.env==="stage",A=Pe.PUBLISHED;["true",""].includes(i.allowOverride)&&(x=(z(Xr,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",A=Rt(z(Kr,i),Pe,A)),x&&(a=ge.STAGE,n=Qr);let M=z(Yr)??e.preview,F=typeof M<"u"&&M!=="off"&&M!=="false",q={};F&&(q={preview:F});let Q=z("mas-io-url")??e.masIOUrl??`https://www${a===ge.STAGE?".stage":""}.adobe.com/mas/io`,W=z("preselect-plan")??void 0,B=z("instant")??e.instant;return{...Gl(e),...q,displayOldPrice:l,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:c,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:k.extraOptions,modal:u,env:a,forceTaxExclusive:f,promotionCode:v,quantity:y,alternativePrice:k.alternativePrice,wcsApiKey:S,wcsURL:n,landscape:A,masIOUrl:Q,...W&&{preselectPlan:W},...B&&{instant:B}}}async function zo(e,r={},t=2,i=100){let a;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,i*(n+1)))}throw a}var ta="wcs";function Ho({settings:e}){let r=re.module(ta),{env:t,wcsApiKey:i}=e,a=new Map,n=new Map,o,s=new Map;async function l(u,f,v=!0){let y=ie(),S=Vr;r.debug("Fetching:",u);let x="",A;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let O=new Map(f),[M]=u.offerSelectorIds,F=Date.now()+Math.random().toString(36).substring(2,7),q=`${ta}:${M}:${F}${ei}`,Q=`${ta}:${M}:${F}${ti}`,W;try{if(performance.mark(q),x=new URL(e.wcsURL),x.searchParams.set("offer_selector_ids",M),x.searchParams.set("country",u.country),x.searchParams.set("locale",u.locale),x.searchParams.set("landscape",t===ge.STAGE?"ALL":e.landscape),x.searchParams.set("api_key",i),u.language&&x.searchParams.set("language",u.language),u.promotionCode&&x.searchParams.set("promotion_code",u.promotionCode),u.currency&&x.searchParams.set("currency",u.currency),A=await zo(x.toString(),{credentials:"omit"}),A.ok){let B=[];try{let R=await A.json();r.debug("Fetched:",u,R),B=R.resolvedOffers??[]}catch(R){r.error(`Error parsing JSON: ${R.message}`,{...R.context,...y?.duration})}B=B.map(dr),f.forEach(({resolve:R},J)=>{let se=B.filter(({offerSelectorIds:Xe})=>Xe.includes(J)).flat();se.length&&(O.delete(J),f.delete(J),R(se))})}else S=qr}catch(B){S=`Network error: ${B.message}`}finally{W=performance.measure(Q,q),performance.clearMarks(q),performance.clearMeasures(Q)}if(v&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let B=gn(A);f.forEach(R=>{R.reject(new mt(S,{...u,...B,response:A,measure:Zt(W),...y?.duration}))})}}function c(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:v})=>l(f,v))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ge.STAGE?"stage":"prod",v=u[f];if(!v||typeof v!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,S]of Object.entries(v))a.set(y,Promise.resolve(S.map(dr)));r.debug(`Prefilled WCS cache with ${v.size} entries`)}function p(){let u=a.size;s=new Map(a),a.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,v){let y=u!=="GB"&&!v?"MULT":"en",S=ri.includes(u)?u:k.country;return{validCountry:S,validLanguage:y,locale:`${f}_${S}`}}function h({country:u,language:f,perpetual:v=!1,promotionCode:y="",wcsOsi:S=[]}){let{validCountry:x,validLanguage:A,locale:O}=m(u,f,v),M=[x,A,y].filter(F=>F).join("-").toLowerCase();return S.map(F=>{let q=`${F}-${M}`;if(a.has(q))return a.get(q);let Q=new Promise((W,B)=>{let R=n.get(M);R||(R={options:{country:x,locale:O,...A==="MULT"&&{language:A},offerSelectorIds:[]},promises:new Map},n.set(M,R)),y&&(R.options.promotionCode=y),R.options.offerSelectorIds.push(F),R.promises.set(F,{resolve:W,reject:B}),c()}).catch(W=>{if(s.has(q))return s.get(q);throw W});return a.set(q,Q),Q})}return{Commitment:Ie,PlanType:an,Term:ce,applyPlanType:dr,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var Bo="mas-commerce-service",Fo="mas-commerce-service:start",Uo="mas-commerce-service:ready",qt,gt,We,$o,ia,ra=class extends HTMLElement{constructor(){super(...arguments);U(this,We);U(this,qt);U(this,gt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let o=await t?.(i,a,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return b(this,gt)||N(this,gt,{[we]:bt(this,We,ia).call(this,we),[Qe]:bt(this,We,ia).call(this,Qe)}),b(this,gt)}activate(){let t=b(this,We,$o),i=Do(t,this);hr(t.lana);let a=re.init(t.hostEnv).module("service");a.debug("Activating:",t);let o={price:Un(i)},s={checkout:new Set,price:new Set},l={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Hn(l),...Bn(l),...Io(l),...Ho(l),...ii,Log:re,resolvePriceTaxFlags:ea,get defaults(){return k},get log(){return re},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:o,settings:i});let c=new CustomEvent(Kt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Uo),N(this,qt,performance.measure(Uo,Fo)),this.dispatchEvent(c),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Fo),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Nr).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Zt(b(this,qt))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:o})=>a===0&&n===0&&o<200||o>=400),i=Array.from(new Map(t.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};qt=new WeakMap,gt=new WeakMap,We=new WeakSet,$o=function(){let t=this.getAttribute("env")??"prod",i={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=n}}),i},ia=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||z(t))};window.customElements.get(Bo)||window.customElements.define(Bo,ra);var jo="merch-card-collection",ql=3e4,Vl={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},jl={plans:!0},Wl=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Yl=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(i=>t.types.includes(i)))):e,Xl=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Kl=(e,{filter:r})=>e.sort((t,i)=>i.filters[r]?.order==null||isNaN(i.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-i.filters[r].order),Zl=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Ne,vt,Ye,jt,_r,Wo,ft=class extends qo{constructor(){super();U(this,_r);U(this,Ne,{});U(this,vt);U(this,Ye);U(this,jt);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return Ce` <slot></slot>
        ...
        </sp-button>`}sortChanged(t){t.target.value===pe.authored?wt({sort:void 0}):wt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(Ir,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(Dr,{bubbles:!0,composed:!0}));let t=this.page+1;wt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=pa(({category:t,filter:i,types:a,sort:n,search:o,single_app:s,page:l})=>{i=i||t,!this.filtered&&i&&i!==this.filter&&setTimeout(()=>{wt({page:void 0}),this.page=1},1),this.filtered||(this.filter=i??this.filter),this.types=a??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(l)||1})}openFilters(t){this.sidenav?.showModal(t)}};Ne=new WeakMap,vt=new WeakMap,Ye=new WeakMap,jt=new WeakMap,_r=new WeakSet,Wo=function(t,i={},a=!0){b(this,Ye)?.error(`merch-card-collection: ${t}`,i),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(Fr,{detail:{...i,message:t},bubbles:!0,composed:!0}))},g(ft,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:pe.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(ft,"styles",Vo`
        #footer {
            grid-column: 1 / -1;
    ...
    `);ft.SortOrder=pe;customElements.define(jo,ft);var Ql={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},Jl=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(a=>{a.innerText=t||""})},ed={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},td={catalog:"l"},ae,xt,Vt=class extends qo{constructor(){super();U(this,ae);U(this,xt);g(this,"tablet",new yt(this,D));g(this,"desktop",new yt(this,T));this.collection=null,N(this,ae,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(de,this.updateLiterals),this.collection?.addEventListener(Et,this.handleSidenavAttached),N(this,xt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(de,this.updateLiterals),this.collection?.removeEventListener(Et,this.handleSidenavAttached)}willUpdate(){b(this,ae).search=this.getVisibility("search"),b(this,ae).filter=this.getVisibility("filter"),b(this,ae).sort=this.getVisibility("sort"),b(this,ae).result=this.getVisibility("result"),b(this,ae).custom=this.getVisibility("custom")}parseVisibilityOptions(t,i){if(!t||!Object.hasOwn(t,i))return null;let a=t[i];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(t){let i=b(this,xt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(i,t);return a!==null?a:this.parseVisibilityOptions(ed,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!b(this,ae).search)return me;let t=At(this,"searchText");return t?Ce`
        ...
        `:me}get filterAction(){return b(this,ae).filter?this.sidenav?Ce`
            ...
            ></sp-action-button>
        `:me:me}get sortAction(){if(!b(this,ae).sort)return me;let t=At(this,"sortText");if(!t)return;let i=At(this,"popularityText"),a=At(this,"alphabeticallyText");if(!(i&&a))return;let n=this.collection?.sort===pe.alphabetical;return Ce`
            <sp-action-menu
                id="sort"
                size="m"
    ...
    `);customElements.define("merch-card-collection-header",Vt);export{ft as MerchCardCollection,Vt as default};

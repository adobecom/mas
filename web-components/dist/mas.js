...
`;var Hc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Kt=class extends C{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return $c}priceOptionsProvider(t,r){t.dataset.template===ve&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return f` ${this.badge}
...
`;var Fc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Qt=class extends C{constructor(t){super(t)}priceOptionsProvider(t,r){t.dataset.template===ve&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}getGlobalCSS(){return Bc}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${D}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let r=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),t.parentNode.insertBefore(r,t.nextSibling),await r.onceSettled()}catch{}}renderLayout(){return f`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;document.head.appendChild(rl);var il="fragment",al="author",nl="preview",ol="loading",sl="timeout",Hn="aem-fragment",cl="eager",ll="cache",dp=[cl,ll],$e,Ct,Le,Bn=class{constructor(){E(this,$e,new Map);E(this,Ct,new Map);E(this,Le,new Map)}clear(){m(this,$e).clear(),m(this,Ct).clear(),m(this,Le).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(m(this,$e).set(t.id,t),t.fields?.originalId&&m(this,$e).set(t.fields.originalId,t),m(this,Le).has(t.id)){let[,i]=m(this,Le).get(t.id);i()}if(m(this,Le).has(t.fields?.originalId)){let[,i]=m(this,Le).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return m(this,$e).has(t)}entries(){return m(this,$e).entries()}get(t){return m(this,$e).get(t)}getAsPromise(t){let[r]=m(this,Le).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),m(this,Le).set(t,[r,i]),r}getFetchInfo(t){let r=m(this,Ct).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},m(this,Ct).set(t,r)),r}remove(t){m(this,$e).delete(t),m(this,Ct).delete(t),m(this,Le).delete(t)}};$e=new WeakMap,Ct=new WeakMap,Le=new WeakMap;var tt=new Bn,nr,Ae,We,be,fe,J,Zr,Jr,Re,ei,ti,or,Me,dl,hl,Fn,pl,Zi=class extends HTMLElement{constructor(){super(...arguments);E(this,Me);u(this,"cache",tt);E(this,nr);E(this,Ae,null);E(this,We,null);E(this,be,null);E(this,fe);E(this,J);E(this,Zr,cl);E(this,Jr,5e3);E(this,Re);E(this,ei,!1);E(this,ti,0);E(this,or)}static get observedAttributes(){return[il,ol,sl,al,nl]}attributeChangedCallback(r,i,a){r===il&&(y(this,fe,a),y(this,J,tt.getFetchInfo(a))),r===ol&&dp.includes(a)&&y(this,Zr,a),r===sl&&y(this,Jr,parseInt(a,10)),r===al&&y(this,ei,["","true"].includes(a)),r===nl&&y(this,or,a)}connectedCallback(){if(!m(this,Re)){if(m(this,be)??y(this,be,ft(this)),y(this,or,m(this,be).settings?.preview),m(this,nr)??y(this,nr,m(this,be).log.module(`${Hn}[${m(this,fe)}]`)),!m(this,fe)||m(this,fe)==="#"){m(this,J)??y(this,J,tt.getFetchInfo("missing-fragment-id")),Z(this,Me,Fn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(m(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(m(this,Re)&&!await Promise.race([m(this,Re),Promise.resolve(!1)]))return;r&&tt.remove(m(this,fe)),m(this,Zr)===ll&&await Promise.race([tt.getAsPromise(m(this,fe)),new Promise(s=>setTimeout(s,m(this,Jr)))]);try{y(this,Re,Z(this,Me,pl).call(this)),await m(this,Re)}catch(s){return Z(this,Me,Fn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=m(this,Ae)||{};return o&&!B("mas.disableWcsCache")&&m(this,be).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(st,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...m(this,J)},bubbles:!0,composed:!0})),m(this,Re)}get updateComplete(){return m(this,Re)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return m(this,We)?m(this,We):(m(this,ei)?this.transformAuthorData():this.transformPublishData(),m(this,We))}get rawData(){return m(this,Ae)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=m(this,Ae);y(this,We,r.reduce((d,{name:h,multiple:p,values:g})=>(d.fields[h]=p?g:g[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){if(!m(this,Ae))return;let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=m(this,Ae);y(this,We,Object.entries(r).reduce((d,[h,p])=>(d.fields[h]=p?.mimeType?p.value:p??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r),a={locale:m(this,be).settings.locale,apiKey:m(this,be).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??m(this,be).settings.instant;return n&&(a.instant=n),await i(m(this,fe),a)}};nr=new WeakMap,Ae=new WeakMap,We=new WeakMap,be=new WeakMap,fe=new WeakMap,J=new WeakMap,Zr=new WeakMap,Jr=new WeakMap,Re=new WeakMap,ei=new WeakMap,ti=new WeakMap,or=new WeakMap,Me=new WeakSet,dl=async function(r){ao(this,ti)._++;let i=`${Hn}:${m(this,fe)}:${m(this,ti)}`,a=`${i}${dt}`,n=`${i}${ht}`;if(m(this,or)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Ne(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(m(this,J).stale=!1,m(this,J).url=r,o=await Di(r,{cache:"default",credentials:"omit"}),Z(this,Me,hl).call(this,o),m(this,J).status=o?.status,m(this,J).measure=ze(performance.measure(n,a)),m(this,J).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...m(this,be).duration});return await o.json()}catch(s){if(m(this,J).measure=ze(performance.measure(n,a)),m(this,J).retryCount=s.retryCount,m(this,Ae))return m(this,J).stale=!0,m(this,nr).error("Serving stale data",m(this,J)),m(this,Ae);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},hl=function(r){Object.assign(m(this,J),wi(r))},Fn=function(r){y(this,Re,null),m(this,J).message=r,this.classList.add("error");let i={...m(this,J),...m(this,be).duration};m(this,nr).error(r,i),this.dispatchEvent(new CustomEvent(ct,{detail:i,bubbles:!0,composed:!0}))},pl=async function(){var c;this.classList.remove("error"),y(this,We,null);let r=tt.get(m(this,fe));if(r)return y(this,Ae,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=m(this,be).settings,s=`${i}/fragment?id=${m(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Me,dl).call(this,s),(c=r.fields).originalId??(c.originalId=m(this,fe)),tt.add(r),y(this,Ae,r),!0},u(Zi,"cache",tt);customElements.define(Hn,Zi);M();On();var hp=e=>e?e.startsWith("sp-icon-")?f`${jr(`<${e} class="badge-icon"></${e}>`)}`:f`<img src="${e}" class="badge-icon" />`:w,sr=class extends G{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">

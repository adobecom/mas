...
`;var[Hm,Fm,Jn,eo,to,ro]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var ea="pro",vi=`--consonant-merch-card-${ea}-top-card-height`,Jr=[{prop:`--consonant-merch-card-${ea}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${ea}-name-description-height`,selector:".name-description"}],ao=`--consonant-merch-card-${ea}-strike-reserve`,xi='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',zl="(min-width: 768px)",io={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Re,tt,cr,lr,K,no,nr,oo,or,bi,ta,ra=class ra extends y{constructor(t){super(t);S(this,K);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);S(this,Re,null);S(this,tt,null);S(this,cr,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);S(this,lr,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of U(this,K,no).call(this)){let n=i.variantLayout;n instanceof ra&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?U(this,K,bi).call(this):U(this,K,or).call(this),this.card.requestUpdate()});S(this,ta,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case eo:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:U(this,K,or).call(this);break;case Jn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:U(this,K,or).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case to:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}U(this,K,or).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),U(this,K,bi).call(this);break;case ro:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,U(this,K,nr).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(ne,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return Zn}priceOptionsProvider(t,a){t.dataset.template===X&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(oe,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]');if(!t?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=t.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${F}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=vi,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(zl).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,m)=>{let p=l(m);return p?Math.max(d,parseInt(getComputedStyle(p).height)||0):d},0);for(let c of o.values()){if(c.forEach(p=>this.clearSyncedHeights(p)),c.length<2)continue;let l=c.map(p=>p.querySelector(xi)&&parseInt(getComputedStyle(p.querySelector(xi)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((p,h)=>{let u=d-l[h];u>0&&p.style.setProperty(ao,`${u}px`)});for(let p of Jr){let h=s(c,u=>u.shadowRoot?.querySelector(p.selector));h>0&&c.forEach(u=>u.style.setProperty(p.prop,`${h}px`))}let m=s(c,p=>p.shadowRoot?.querySelector(".top-card"));m>0&&c.forEach(p=>p.style.setProperty(i,`${m}px`))}}clearSyncedHeights(t){t.style.removeProperty(vi),t.style.removeProperty(ao),Jr.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(xi),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Rr,v(this,lr)),this.card.addEventListener(ne,this.updatePriceQuantity),this.card.addEventListener(oe,v(this,cr)),typeof ResizeObserver>"u"))return;w(this,tt,new ResizeObserver(()=>this.resyncOnReflow())),v(this,tt).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,tt).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ne,this.updatePriceQuantity),this.card?.removeEventListener(oe,v(this,cr)),U(this,K,nr).call(this),v(this,tt)?.disconnect(),this.card?.removeEventListener(Rr,v(this,lr))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Me`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Me`
        ...
        `}renderLayout(){let t=!!this.expanded;return Me`
            ...
            <slot></slot>
        `}};Re=new WeakMap,tt=new WeakMap,cr=new WeakMap,lr=new WeakMap,K=new WeakSet,no=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},nr=function(){v(this,Re)&&(document.removeEventListener("mousedown",v(this,Re)),w(this,Re,null))},oo=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},or=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=U(this,K,oo).call(this),v(this,Re)||(w(this,Re,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),U(this,K,nr).call(this))}),document.addEventListener("mousedown",v(this,Re)))},bi=function(){this.licenseOpen=!1,U(this,K,nr).call(this)},ta=new WeakMap,g(ra,"variantStyle",Il`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
...
`;var co={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Te,At=class extends y{constructor(t){super(t);S(this,Te);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return so}priceOptionsProvider(t,a){t.dataset.template===X&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return yi` ${this.badge}
...
`;var To={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Rt=class extends y{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Co}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${F}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Kl`
            ${this.badge}
            <div class="body">
...
`,ct.MISSING_INTL_API,o);var P=t.getPluralRules(r,{type:d.pluralType}).select(p-(d.offset||0));b=d.options[P]||d.options.other}if(!b)throw new ji(d.value,p,Object.keys(d.options),o);s.push.apply(s,wr(b.value,r,t,a,i,p-(d.offset||0)));continue}}return gh(s)}function vh(e,r){return r?M(M(M({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=M(M({},e[a]),r[a]||{}),t},{})):e}function xh(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=vh(e[a],r[a]),t},M({},e)):e}function Wi(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function bh(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:br(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,oa([void 0],t,!1)))},{cache:Wi(e.number),strategy:ua.variadic}),getDateTimeFormat:br(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,oa([void 0],t,!1)))},{cache:Wi(e.dateTime),strategy:ua.variadic}),getPluralRules:br(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,oa([void 0],t,!1)))},{cache:Wi(e.pluralRules),strategy:ua.variadic})}}var Ds=(function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==ae.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return wr(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=xh(e.formats,a),this.formatters=i&&i.formatters||bh(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Rs,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e})();var Hs=Ds;var Er={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}",discountLabel:"{discount}%"},yh=_n("ConsonantTemplates/price"),wh=/<\/?[^>]+(>|$)/g,V={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ke={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Yi="TAX_EXCLUSIVE",Eh=e=>Tn(e)?Object.entries(e).filter(([,r])=>gt(r)||Fr(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Cn(a)}"`}`,""):"",Y=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${V.disabled}`}"${Eh(t)}>${a?Zo(r):r??""}</span>`;function Sh(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function Ah(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function be(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?Sh(i):i,i=n?i.replace(wh,""):i;let s=new Hs(i,r).format(a);return o?Ah(s):s}catch{return yh.error("Failed to format literal:",i),""}}function Ch(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:m},p={}){let h=Y(V.currencySymbol,a),u=Y(V.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=Y(V.integer,s),f+=Y(V.decimalsDelimiter,n),f+=Y(V.decimals,i),c||(f+=u+h),f+=Y(V.recurrence,l,null,!0),f+=Y(V.unitType,d,null,!0),f+=Y(V.taxInclusivity,m,!0),Y(e,f,{...p})}var ee=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:m,literals:p={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:E,formatString:A,price:b,priceWithoutDiscount:P,taxDisplay:I,taxTerm:D,term:q,usePrecision:W,promotion:Q}={},te={})=>{Object.entries({country:o,formatString:A,language:m,price:b}).forEach(([Ec,Sc])=>{if(Sc==null)throw new Error(`Argument "${Ec}" is missing for osi ${E?.toString()}, country ${o}, language ${m}`)});let H={...Er,...p},O=`${m.toLowerCase()}-${o.toUpperCase()}`,re;Q&&!f&&P?re=e||a?b:P:t&&P?re=P:re=b;let J=r?es:ts;i&&(J=rs);let{accessiblePrice:ze,recurrenceTerm:ge,...ht}=J({commitment:x,formatString:A,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:P,price:r?b:re,promotion:Q,quantity:h,term:q,usePrecision:W}),De="",va="",xa="";T(c)&&ge&&(xa=be(H,O,ke.recurrenceLabel,{recurrenceTerm:ge}));let _r="";T(l)&&(u&&(_r+=" "),_r+=be(H,O,ke.perUnitLabel,{perUnit:"LICENSE"}));let Lr="";T(d)&&D&&(u&&(Lr+=" "),Lr+=be(H,O,I===Yi?ke.taxExclusiveLabel:ke.taxInclusiveLabel,{taxTerm:D})),t&&(De=be(H,O,ke.strikethroughAriaLabel,{strikethroughPrice:De})),e&&(va=be(H,O,ke.alternativePriceAriaLabel,{alternativePrice:va}));let Ye=V.container;if(r&&(Ye+=` ${V.containerOptical}`),t&&(Ye+=` ${V.containerStrikethrough}`),a&&(Ye+=` ${V.containerPromoStrikethrough}`),e&&(Ye+=` ${V.containerAlternative}`),i&&(Ye+=` ${V.containerAnnual}`),T(s))return Ch(Ye,{...ht,accessibleLabel:De,altAccessibleLabel:va,recurrenceLabel:xa,perUnitLabel:_r,taxInclusivityLabel:Lr},te);let{currencySymbol:rn,decimals:vc,decimalsDelimiter:xc,hasCurrencySpace:an,integer:bc,isCurrencyFirst:yc}=ht,pt=[bc,xc,vc];yc?(pt.unshift(an?"\xA0":""),pt.unshift(rn)):(pt.push(an?"\xA0":""),pt.push(rn)),pt.push(xa,_r,Lr);let wc=pt.join("");return Y(Ye,wc,te)},Fs=()=>(e,r,t)=>{let a=ot(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${ee({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},Bs=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=ot(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return ee()(e,{...r,price:r.priceWithoutDiscount},t)+Y(V.containerAnnualPrefix," (")+ee({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+Y(V.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${ee({displayStrikethrough:!0})(n,r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${Y(V.containerAnnualPrefix," (")}${ee({displayAnnual:!0,instant:a})(n,r,t)}${Y(V.containerAnnualSuffix,")")}`},Us=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${ee({isAlternativePrice:e.displayOldPrice})(e,r,t)}${Y(V.containerAnnualPrefix," (")}${ee({displayAnnual:!0})(a,r,t)}${Y(V.containerAnnualSuffix,")")}`};var Sr={...V,containerLegal:"price-legal",planType:"price-plan-type"},ga={...ke,planTypeLabel:"planTypeLabel"};function Th(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=Y(Sr.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=Y(Sr.taxInclusivity,t,!0),o+=Y(Sr.planType,a,null),Y(e,o,{...i})}var $s=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,planTypeCase:n,language:o,literals:s={}}={},{taxDisplay:c,taxTerm:l,planType:d}={},m={})=>{let p={...Er,...s},h=`${o.toLowerCase()}-${e.toUpperCase()}`,u="";T(r)&&(u=be(p,h,ga.perUnitLabel,{perUnit:"LICENSE"}));let f="";e==="US"&&o==="en"&&(t=!1),T(t)&&l&&(f=be(p,h,c===Yi?ga.taxExclusiveLabel:ga.taxInclusiveLabel,{taxTerm:l}));let x="";T(a)&&d&&(x=be(p,h,ga.planTypeLabel,{planType:d})),x&&n&&(x=(n==="lower"?x[0].toLowerCase():x[0].toUpperCase())+x.slice(1));let E=Sr.container;return E+=` ${Sr.containerLegal}`,Th(E,{perUnitLabel:u,taxInclusivityLabel:f,planTypeLabel:x},m,i)};var Gs=ee(),qs=Fs(),Vs=ee({displayOptical:!0}),js=ee({displayStrikethrough:!0}),Ws=ee({displayPromoStrikethrough:!0}),Ys=ee({displayAnnual:!0}),Xs=ee({displayOptical:!0,isAlternativePrice:!0}),Ks=ee({isAlternativePrice:!0}),Qs=Us(),Zs=Bs(),Js=$s;var kh={...ke,discountLabel:"discountLabel"},_h=(e,r)=>{if(!r&&ft(e))return 0;if(!(!ft(e)||!ft(r)))return Math.floor((r-e)/r*100)},ec=()=>(e,r)=>{let{country:t,language:a,literals:i={}}=e??{},{price:n,priceWithoutDiscount:o}=r,s=_h(n,o);if(s===void 0)return'<span class="no-discount"></span>';let c={...Er,...i},l=a&&t?`${a.toLowerCase()}-${t.toUpperCase()}`:"en-US";return`<span class="discount">${be(c,l,kh.discountLabel,{discount:s,remainingPercent:100-s})}</span>`};var tc=ec();var rc="INDIVIDUAL_COM",Ki="TEAM_COM",ac="INDIVIDUAL_EDU",Qi="TEAM_EDU",Lh=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh","KE_en","GH_en","TZ_en","AM_en","AZ_en","GE_en","MD_en","KZ_en","KG_en","TJ_en","UZ_en","OM_en","BH_en"],Ph={[rc]:[],[Ki]:[],[ac]:[],[Qi]:[]},Mh={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Rh=[rc,Ki,ac,Qi],Nh=e=>[Ki,Qi].includes(e);function Xi(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Oh=(e,r,t,a)=>{let i=`${t}_${a}`,n=Xi(Mh,e,r,!1);if(n){let o=Rh.indexOf(i);return n[o]}return Nh(i)},Ih=(e,r,t,a)=>{if(Xi(Lh,e,r,!0))return!0;let i=Ph[`${t}_${a}`];return i?Xi(i,e,r,!0)?!0:N.displayTax:N.displayTax},Zi=async(e,r,t,a)=>{let i=Ih(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Oh(e,r,t,a):N.forceTaxExclusive}},Ar=class Ar extends HTMLSpanElement{constructor(){super();g(this,"masElement",new je(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=j();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=a.collectPriceOptions(t);return ia(Ar,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ve}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=j();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let u=tr(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,m=mi(l);if(a.featureFlags[Le]||n[Le]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=m.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=m.marketSegments,x=await Zi(h,u,m.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(E=>{let A=tr(E,n);return A?.length?A[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[he]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let p=mi(d);return this.renderOffers([p],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=j();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(Ar,"is","inline-price"),g(Ar,"tag","span");var Oe=Ar;window.customElements.get(Oe.is)||window.customElements.define(Oe.is,Oe,{extends:Oe.tag});function ic({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let Q of r.price)Q(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:m,displayTax:p,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:E,quantity:A,alternativePrice:b,wcsOsi:P,...I}=Object.assign(c,s?.dataset??{},o??{}),{wcsOsi:D,promotionCodes:q}=Yr(P,E),W=q.map(Q=>Gr(Q).effectivePromoCode);return c=Br(Object.assign({...c,...I,displayOldPrice:T(l),displayPerUnit:T(d),displayRecurrence:T(m),displayTax:T(p),displayPlanType:T(h),forceTaxExclusive:T(u),perpetual:T(f),displayAnnual:T(x),promotionCode:W[0],promotionCodes:W,quantity:vt(A,N.quantity),alternativePrice:T(b),wcsOsi:D})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=tc;break;case"strikethrough":l=js;break;case"promo-strikethrough":l=Ws;break;case"annual":l=Ys;break;case"legal":l=Js;break;default:s.template==="optical"&&s.alternativePrice?l=Xs:s.template==="optical"?l=Vs:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?Zs:Qs:s.alternativePrice?l=Ks:l=s.promotionCode&&o[0].promotion?qs:Gs}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Oe.createInlinePrice;return{InlinePrice:Oe,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function zh({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||N.language),r??(r=e?.split("_")?.[1]||N.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function nc(e={},r){let t=r.featureFlags[Le],{commerce:a={}}=e,i=we.PRODUCTION,n=Fa,o=$("checkoutClientId",a)??N.checkoutClientId,s=er($("checkoutWorkflowStep",a),se,N.checkoutWorkflowStep),c=T($("displayOldPrice",a),N.displayOldPrice),l=N.displayPerUnit,d=T($("displayRecurrence",a),N.displayRecurrence),m=T($("displayTax",a),N.displayTax),p=T($("displayPlanType",a),N.displayPlanType),h=T($("entitlement",a),N.entitlement),u=T($("modal",a),N.modal),f=T($("forceTaxExclusive",a),N.forceTaxExclusive),x=$("promotionCode",a)??N.promotionCode,E=vt($("quantity",a)),A=$("wcsApiKey",a)??N.wcsApiKey,b=a?.env==="stage",P=Fe.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=($(Da,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",P=er($(Ha,a),Fe,P)),b&&(i=we.STAGE,n=Ba);let D=$(za)??e.preview,q=typeof D<"u"&&D!=="off"&&D!=="false",W={};q&&(W={preview:q});let Q=$("mas-io-url")??e.masIOUrl,te=fn(Q)?Q:`https://www${i===we.STAGE?".stage":""}.adobe.com/mas/io`,H=$("preselect-plan")??void 0,O=$("instant")??e.instant;return{...zh(e),...W,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:m,displayPlanType:p,entitlement:h,extraOptions:N.extraOptions,modal:u,env:i,forceTaxExclusive:f,promotionCode:x,quantity:E,alternativePrice:N.alternativePrice,wcsApiKey:A,wcsURL:n,landscape:P,masIOUrl:te,...H&&{preselectPlan:H},...O&&{instant:O}}}async function oc(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var Ji="wcs";function sc({settings:e}){let r=ce.module(Ji),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(u,f,x=!0){let E=j(),A=Na;r.debug("Fetching:",u);let b="",P;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let I=new Map(f),[D]=u.offerSelectorIds,q=Date.now()+Math.random().toString(36).substring(2,7),W=`${Ji}:${D}:${q}${$a}`,Q=`${Ji}:${D}:${q}${Ga}`,te;try{if(performance.mark(W),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",D),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===we.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),P=await oc(b.toString(),{credentials:"omit"}),P.ok){let H=[];try{let O=await P.json();r.debug("Fetched:",u,O),H=O.resolvedOffers??[]}catch(O){r.error(`Error parsing JSON: ${O.message}`,{...O.context,...E?.duration})}H=H.map(qr),f.forEach(({resolve:O},re)=>{let J=H.filter(({offerSelectorIds:ze})=>ze.includes(re)).flat();J.length&&(I.delete(re),f.delete(re),O(J))})}else A=Ra}catch(H){A=`Network error: ${H.message}`}finally{te=performance.measure(Q,W),performance.clearMarks(W),performance.clearMeasures(Q)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let H=Un(P);f.forEach(O=>{O.reject(new Ft(A,{...u,...H,response:P,measure:Or(te),...E?.duration}))})}}function l(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===we.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[E,A]of Object.entries(x))i.set(E,Promise.resolve(A.map(qr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function m(){let u=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function p(u,f,x){let E=u!=="GB"&&!x?"MULT":"en",A=qa.includes(u)?u:N.country;return{validCountry:A,validLanguage:E,locale:`${f}_${A}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:E="",promotionCodes:A,wcsOsi:b=[]}){let{validCountry:P,validLanguage:I,locale:D}=p(u,f,x),q=Array.isArray(A)&&A.length?A:[E];return b.map((W,Q)=>{let te=q.length===1?q[0]:q[Q]??"",H=[P,I,te].filter(J=>J).join("-").toLowerCase(),O=`${W}-${H}`;if(i.has(O))return i.get(O);let re=new Promise((J,ze)=>{let ge=n.get(H);ge||(ge={options:{country:P,locale:D,...I==="MULT"&&{language:I},offerSelectorIds:[]},promises:new Map},n.set(H,ge)),te&&(ge.options.promotionCode=te),ge.options.offerSelectorIds.push(W),ge.promises.set(W,{resolve:J,reject:ze}),l()}).catch(J=>{if(s.has(O))return s.get(O);throw J});return i.set(O,re),re})}return{Commitment:Ke,PlanType:Pn,Term:me,applyPlanType:qr,resolveOfferSelectors:h,flushWcsCacheInternal:m,prefillWcsCache:d,normalizeCountryLanguageAndLocale:p}}var cc="mas-commerce-service",lc="mas-commerce-service:start",dc="mas-commerce-service:ready",Cr,Ut,lt,hc,tn,en=class extends HTMLElement{constructor(){super(...arguments);S(this,lt);S(this,Cr);S(this,Ut);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,Ut)||w(this,Ut,{[Le]:U(this,lt,tn).call(this,Le),[he]:U(this,lt,tn).call(this,he)}),v(this,Ut)}activate(){let t=v(this,lt,hc),a=nc(t,this);Vr(t.lana);let i=ce.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:hs(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...cs(c),...ls(c),...ic(c),...sc(c),...Va,Log:ce,resolvePriceTaxFlags:Zi,get defaults(){return N},get log(){return ce},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(Mr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(dc),w(this,Cr,performance.measure(dc,lc)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(lc),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(wa).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Or(v(this,Cr))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Cr=new WeakMap,Ut=new WeakMap,lt=new WeakSet,hc=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},tn=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||$(t))};window.customElements.get(cc)||window.customElements.define(cc,en);var gc="merch-card-collection",Dh=3e4,Hh={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Fh={plans:!0},Bh=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Uh=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,$h=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Gh=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),qh=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,We,Gt,dt,kr,fa,fc,$t=class extends mc{constructor(){super();S(this,fa);S(this,We,{});S(this,Gt);S(this,dt);S(this,kr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=un(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Ie` <slot></slot>
    ...
    `);$t.SortOrder=xe;customElements.define(gc,$t);var Vh={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},jh=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(i=>{i.innerText=t||""})},Wh={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},Yh={catalog:"l"},de,qt,Tr=class extends mc{constructor(){super();S(this,de);S(this,qt);g(this,"tablet",new Vt(this,L));g(this,"desktop",new Vt(this,_));this.collection=null,w(this,de,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(fe,this.updateLiterals),this.collection?.addEventListener(Wt,this.handleSidenavAttached),w(this,qt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(fe,this.updateLiterals),this.collection?.removeEventListener(Wt,this.handleSidenavAttached)}willUpdate(){v(this,de).search=this.getVisibility("search"),v(this,de).filter=this.getVisibility("filter"),v(this,de).sort=this.getVisibility("sort"),v(this,de).result=this.getVisibility("result"),v(this,de).custom=this.getVisibility("custom")}parseVisibilityOptions(t,a){if(!t||!Object.hasOwn(t,a))return null;let i=t[a];return i===!1?!1:i===!0?!0:i.includes(this.currentMedia)}getVisibility(t){let a=v(this,qt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,i=this.parseVisibilityOptions(a,t);return i!==null?i:this.parseVisibilityOptions(Wh,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,de).search)return ye;let t=Xt(this,"searchText");return t?Ie`
        ...
        >
            ...
            ${a}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(a=>{jh(this,a,t.detail[a])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return Ie`
            <sp-theme color="light" scale="medium">
                <div id="header">

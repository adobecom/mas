var Pr=Object.defineProperty;var _r=a=>{throw TypeError(a)};var Ti=(a,r,e)=>r in a?Pr(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Li=(a,r)=>()=>(a&&(r=a(a=0)),r);var Pi=(a,r)=>{for(var e in r)Pr(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>Ti(a,typeof r!="symbol"?r+"":r,e),Jt=(a,r,e)=>r.has(a)||_r("Cannot "+e);var l=(a,r,e)=>(Jt(a,r,"read from private field"),e?e.call(a):r.get(a)),u=(a,r,e)=>r.has(a)?_r("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(Jt(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),y=(a,r,e)=>(Jt(a,r,"access private method"),e);var Mr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return l(a,r,t)}});var er={};Pi(er,{default:()=>Je});import{LitElement as _i,html as Ce,css as Mi,nothing as Ri}from"./lit-all.min.js";import{unsafeHTML as $r}from"./lit-all.min.js";import{ifDefined as Oi}from"./lit-all.min.js";function Di(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var R,Je,tr=Li(()=>{R=class R extends _i{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();R.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),d=c?c.offsetWidth:o,p=c?c.offsetHeight:s,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>t&&(f="left");let C=e.left+e.width/2,G=e.top+e.height/2,re=6,kt=(Si,Ai,zi)=>Math.max(Si,Math.min(Ai,zi)),Ct,St,Xt;f==="top"||f==="bottom"?(Ct=f==="top"?e.top-p-n:e.bottom+n,St=kt(0,t-d,C-d/2),Xt=kt(re,d-re*2,C-St-re)):(St=f==="left"?e.left-d-n:e.right+n,Ct=kt(0,i-p,G-p/2),Xt=kt(re,p-re*2,G-Ct-re)),this._tooltipTop=Ct,this._tooltipLeft=St,this._arrowOffset=Xt,this._computedPlacement=f}showTooltip(){R.activeTooltip&&R.activeTooltip!==this&&(R.activeTooltip.closeOverlay(),R.activeTooltip.tooltipVisible=!1,R.activeTooltip.requestUpdate()),R.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){R.activeTooltip===this&&(R.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ce`<merch-icon
        ...
        ></merch-icon>`:Ce`<slot></slot>`}render(){let r=this.effectiveContent,e=this.effectivePlacement;if(!r)return Ce`<span class="icon-only">${this.renderIcon()}</span>`;if(Di())return Ce`
            ...
            `;let i=r.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:g=>{this.lastPointerType=g.pointerType},pointerenter:g=>g.pointerType!=="touch"&&this.showTooltip(),pointerleave:g=>g.pointerType!=="touch"&&this.hideTooltip(),click:g=>{this.lastPointerType==="touch"&&this.handleTap(g),this.lastPointerType=null}},s=this._computedPlacement,c=s==="top"||s==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=c?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return Ce`
            <span
...
`,Ir=()=>[Nr`
    ...
    `);customElements.define("merch-icon",Se);var Vo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Wo=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var Ae=2e4;var w='span[is="inline-price"][data-wcs-osi]',X='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var $i='a[is="upt-link"]',Hr=`${w},${X},${$i}`;var qr="merch-offer-select:ready",Ur="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",Gr="merch-card-quantity:change",rr="merch-modal:addon-and-quantity-update";var ze="merch-card-collection:literals-changed";var Te="aem:load",Le="aem:error",zt="mas:ready",jr="mas:error";var Vr="placeholder-failed",Wr="placeholder-pending",Kr="placeholder-resolved";var Yr="mas:failed",j="mas:resolved",Qr="mas/commerce";var ae="failed",pe="pending",ie="resolved";var Tt="X-Request-Id",Ko=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Yo=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Lt=":start",Pt=":duration";var M="legal",Zr="mas-ff-defaults";var Bi="mas-commerce-service";function Xr(a,r){let e;return function(){let t=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(t,i),r)}}function z(a,r={},e=null,t=null){let i=t?document.createElement(a,{is:t}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Pe(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function ar(){return window.matchMedia("(max-width: 1024px)").matches}function me(){return document.getElementsByTagName(Bi)?.[0]}function et(a){let r=window.getComputedStyle(a);return a.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function Jr(a){let r=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var tt,ge,rt,at,_e,_t=class extends HTMLElement{constructor(){super();u(this,tt,"");u(this,ge);u(this,rt,[]);u(this,at,[]);u(this,_e);m(this,_e,Xr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,l(this,ge)?this.parentElement.style.borderRadius=l(this,ge):l(this,ge)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=l(this,rt).map((t,i)=>{let n=l(this,at)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${l(this,tt)}, ${e})`}connectedCallback(){l(this,_e).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&m(this,ge,i?.trim()),e==="colors"&&i?m(this,rt,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,at,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,tt,i?.trim()??""),l(this,_e).call(this)}};tt=new WeakMap,ge=new WeakMap,rt=new WeakMap,at=new WeakMap,_e=new WeakMap;customElements.define("merch-gradient",_t);import{LitElement as Hi,html as qi,css as Ui}from"./lit-all.min.js";var Me=class extends Hi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${r}"] ${w}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(j,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(j,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];t&&(e.setAttribute("data-offer-type",t.offerType),e.closest("p").setAttribute("data-plan-type",t.planType))}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return qi` <input
                type="checkbox"
                id="addon-checkbox"
    ...
    `);customElements.define("merch-addon",Me);import{html as Mt,nothing as Gi}from"./lit-all.min.js";var Re,it=class it{constructor(r){h(this,"card");u(this,Re);this.card=r,this.insertVariantStyle()}getContainer(){return m(this,Re,l(this,Re)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),l(this,Re)}insertVariantStyle(){let r=this.constructor.name;if(!it.styleMap[r]){it.styleMap[r]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(r,e){if(!r||this.card.heightSync===!1)return;let t=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(t))||0;i>o&&n.style.setProperty(t,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let t=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${t}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${t}-${o}-height`;e.style.getPropertyValue(s)&&e.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),d=n.get(c);d||(d=[],n.set(c,d)),d.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let d=`--consonant-merch-card-${t}-${s}-height`,p=o.map(f=>f.style.getPropertyValue(d)),g=0;for(let f of o){f.style.removeProperty(d);let C=c(f);if(!C)continue;let G=Math.max(0,parseInt(window.getComputedStyle(C).height)||0);G>g&&(g=G)}o.forEach((f,C)=>{g>0?f.style.setProperty(d,`${g}px`):p[C]&&f.style.setProperty(d,p[C])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Mt`
            <div
                id="badge"
...
`;var Ot=class extends v{constructor(r){super(r)}getGlobalCSS(){return ia}renderLayout(){return na` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Ft={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ma={...function(){let{whatsIncluded:a,size:r,...e}=Ft;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},ga={...function(){let{subtitle:a,whatsIncluded:r,size:e,quantitySelect:t,...i}=Ft;return i}()},V,W,D=class extends v{constructor(e){super(e);u(this,V);u(this,W);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return pa}adjustSlotPlacement(e,t,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!t.includes(s)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&c){if(d)c.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(c):p.appendChild(c)}return}if(i&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!c){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){l(this,V)||(m(this,V,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(l(this,V)?.disconnect(),m(this,V,null),this.syncHeights())})),l(this,V).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let i=t.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),t.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=et(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(d+=et(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+et(f));for(let G of t.childNodes){if(G.classList.contains("spacer"))break;d+=et(G)}let C=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(C)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${w}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?ot`<div class="divider"></div>`:Nt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${w}[data-template="price"]`);t&&e.push(t);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?ot`<label id="stock-checkbox">
    ...
    `),h(D,"collectionOptions",{customHeaderArea:e=>e.sidenav?ot`<slot name="resultsText"></slot>`:Nt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let t=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};x.matchDesktop.addEventListener("change",t),e.addEventListener(ze,t),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",t),e.removeEventListener(ze,t)})}});import{html as J,css as Ji,unsafeCSS as fa,nothing as It}from"./lit-all.min.js";var ua=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?J`
    ...
    `),h(oe,"collectionOptions",{customHeaderArea:r=>r.sidenav?J`<slot name="resultsText"></slot>`:It,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let e=()=>{let t=r.querySelectorAll("merch-card");if(t.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!x.isDesktop)return;let i=0;t.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),i+=s})};x.matchDesktop.addEventListener("change",e),r.addEventListener(ze,e),r.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",e),r.removeEventListener(ze,e)})}});import{html as se,css as en,nothing as st}from"./lit-all.min.js";var ba=`
:root {
...
`;var za={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Y,Fe=class extends v{constructor(e){super(e);u(this,Y);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Aa}priceOptionsProvider(e,t){e.dataset.template===M&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return or` ${this.badge}
...
`;var La={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ie=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===M&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Ta}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${w}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return sr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var _a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},$e=class extends v{constructor(r){super(r)}getGlobalCSS(){return Pa}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return an`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Ba={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ue=class extends v{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return $a}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,t){t.literals={...t.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},t.space=!0,t.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",t.dataset.template="legal",t.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return gn`
            ${this.badge}
            <div class="body">
...
`;var pr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},vn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Ht,qa,Ge=class extends v{constructor(e){super(e);u(this,Ht);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ha}get aemFragmentMapping(){return pr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Ht,qa).call(this))}renderLayout(){return un`
            ...
            <slot></slot>
        `}};Ht=new WeakSet,qa=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;vn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ge,"variantStyle",fn`
...
`;document.head.appendChild(Wa);function Ut(a,r={},{metadata:e=!0,search:t=!0,storage:i=!0}={}){let n;if(t&&n==null){let o=new URLSearchParams(window.location.search),s=ur(t)?t:a;n=o.get(s)}if(i&&n==null){let o=ur(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=En(ur(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[a]}var wn=a=>typeof a=="boolean",Gt=a=>typeof a=="function";var ur=a=>typeof a=="string";function Ka(a,r){if(wn(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:r}function En(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,e,t)=>`${e}-${t}`).replace(/\W+/gu,"-").toLowerCase()}var ce=class a extends Error{constructor(r,e,t){if(super(r,{cause:t}),this.name="MasError",e.response){let i=e.response.headers?.get(Tt);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let r=Object.entries(this.context||{}).map(([t,i])=>`${t}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return r&&(e+=` (${r})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var ve={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Ya=1e3;function kn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function Qa(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ve.serializableTypes.includes(e))return e}return a}function Cn(a,r){if(!ve.ignoredProperties.includes(a))return Qa(r)}var fr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(kn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(Qa).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${ve.delimiter}page=${o}${s}`;c.length>Ya&&(c=`${c.slice(0,Ya)}<trunc>`),n+=c,i.length&&(n+=`${ve.delimiter}facts=`,n+=JSON.stringify(i,Cn)),window.lana?.log(n,ve)}};function Za(a){Object.assign(ve,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in ve&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Xa={LOCAL:"local",PROD:"prod",STAGE:"stage"},vr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},br=new Set,xr=new Set,Ja=new Map,ei={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},ti={filter:({level:a})=>a!==vr.DEBUG},Sn={filter:()=>!1};function An(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Gt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function zn(a){[...xr].every(r=>r(a))&&br.forEach(r=>r(a))}function ri(a){let r=(Ja.get(a)??0)+1;Ja.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>ri(`${t.namespace}/${i}`),updateConfig:Za};return Object.values(vr).forEach(i=>{t[i]=(n,...o)=>zn(An(i,n,a,o,e))}),Object.seal(t)}function jt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Gt(t)&&xr.add(t),Gt(e)&&br.add(e)})}function Tn(a={}){let{name:r}=a,e=Ka(Ut("commerce.debug",{search:!0,storage:!0}),r===Xa.LOCAL);return jt(e?ei:ti),r===Xa.PROD&&jt(fr),mt}function Ln(){br.clear(),xr.clear()}var mt={...ri(Qr),Level:vr,Plugins:{consoleAppender:ei,debugFilter:ti,quietFilter:Sn,lanaAppender:fr},init:Tn,reset:Ln,use:jt};var Pn="mas-commerce-service",Cd=mt.module("utilities"),_n={requestId:Tt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Vt=a=>window.setTimeout(a);function yr(){return document.getElementsByTagName(Pn)?.[0]}function ai(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(_n)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function ii(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,t*(n+1)))}throw i}var ni="fragment",oi="author",si="preview",ci="loading",li="timeout",wr="aem-fragment",di="eager",hi="cache",Mn=[di,hi],Q,be,H,Er=class{constructor(){u(this,Q,new Map);u(this,be,new Map);u(this,H,new Map)}clear(){l(this,Q).clear(),l(this,be).clear(),l(this,H).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(l(this,Q).set(r.id,r),r.fields?.originalId&&l(this,Q).set(r.fields.originalId,r),l(this,H).has(r.id)){let[,t]=l(this,H).get(r.id);t()}if(l(this,H).has(r.fields?.originalId)){let[,t]=l(this,H).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return l(this,Q).has(r)}entries(){return l(this,Q).entries()}get(r){return l(this,Q).get(r)}getAsPromise(r){let[e]=l(this,H).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),l(this,H).set(r,[e,t]),e}getFetchInfo(r){let e=l(this,be).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},l(this,be).set(r,e)),e}remove(r){l(this,Q).delete(r),l(this,be).delete(r),l(this,H).delete(r)}};Q=new WeakMap,be=new WeakMap,H=new WeakMap;var le=new Er,Ve,I,te,F,N,L,gt,ut,q,ft,vt,We,U,pi,mi,kr,gi,Wt=class extends HTMLElement{constructor(){super(...arguments);u(this,U);h(this,"cache",le);u(this,Ve);u(this,I,null);u(this,te,null);u(this,F,null);u(this,N);u(this,L);u(this,gt,di);u(this,ut,5e3);u(this,q);u(this,ft,!1);u(this,vt,0);u(this,We)}static get observedAttributes(){return[ni,ci,li,oi,si]}attributeChangedCallback(e,t,i){e===ni&&(m(this,N,i),m(this,L,le.getFetchInfo(i))),e===ci&&Mn.includes(i)&&m(this,gt,i),e===li&&m(this,ut,parseInt(i,10)),e===oi&&m(this,ft,["","true"].includes(i)),e===si&&m(this,We,i)}connectedCallback(){if(!l(this,q)){if(l(this,F)??m(this,F,me(this)),m(this,We,l(this,F).settings?.preview),l(this,Ve)??m(this,Ve,l(this,F).log.module(`${wr}[${l(this,N)}]`)),!l(this,N)||l(this,N)==="#"){l(this,L)??m(this,L,le.getFetchInfo("missing-fragment-id")),y(this,U,kr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(l(this,L)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(l(this,q)&&!await Promise.race([l(this,q),Promise.resolve(!1)]))return;e&&le.remove(l(this,N)),l(this,gt)===hi&&await Promise.race([le.getAsPromise(l(this,N)),new Promise(s=>setTimeout(s,l(this,ut)))]);try{m(this,q,y(this,U,gi).call(this)),await l(this,q)}catch(s){return y(this,U,kr).call(this,s.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=l(this,I)||{};return o&&!Ut("mas.disableWcsCache")&&l(this,F).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Te,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...l(this,L)},bubbles:!0,composed:!0})),l(this,q)}get updateComplete(){return l(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return l(this,te)?l(this,te):(l(this,ft)?this.transformAuthorData():this.transformPublishData(),l(this,te))}get rawData(){return l(this,I)}transformAuthorData(){let{fields:e,id:t,tags:i,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:d={}}=l(this,I);m(this,te,e.reduce((p,{name:g,multiple:f,values:C})=>(p.fields[g]=f?C:C[0],p),{fields:{},id:t,tags:i,settings:o,priceLiterals:s,dictionary:c,placeholders:d,variationId:n}))}transformPublishData(){if(!l(this,I))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:d}=l(this,I);m(this,te,Object.entries(e).reduce((p,[g,f])=>(p.fields[g]=f?.mimeType?f.value:f??"",p),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:d}))}getFragmentClientUrl(){let t=new URLSearchParams(window.location.search).get("maslibs");if(!t||t.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=t.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:l(this,F).settings.locale,apiKey:l(this,F).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??l(this,F).settings.instant;return n&&(i.instant=n),await t(l(this,N),i)}};Ve=new WeakMap,I=new WeakMap,te=new WeakMap,F=new WeakMap,N=new WeakMap,L=new WeakMap,gt=new WeakMap,ut=new WeakMap,q=new WeakMap,ft=new WeakMap,vt=new WeakMap,We=new WeakMap,U=new WeakSet,pi=async function(e){Mr(this,vt)._++;let t=`${wr}:${l(this,N)}:${l(this,vt)}`,i=`${t}${Lt}`,n=`${t}${Pt}`;if(l(this,We)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new ce(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(l(this,L).stale=!1,l(this,L).url=e,o=await ii(e,{cache:"default",credentials:"omit"}),y(this,U,mi).call(this,o),l(this,L).status=o?.status,l(this,L).measure=Pe(performance.measure(n,i)),l(this,L).retryCount=o.retryCount,!o?.ok)throw new ce("Unexpected fragment response",{response:o,...l(this,F).duration});return await o.json()}catch(s){if(l(this,L).measure=Pe(performance.measure(n,i)),l(this,L).retryCount=s.retryCount,l(this,I))return l(this,L).stale=!0,l(this,Ve).error("Serving stale data",l(this,L)),l(this,I);let c=s.message??"unknown";throw new ce(`Failed to fetch fragment: ${c}`,{})}},mi=function(e){Object.assign(l(this,L),ai(e))},kr=function(e){m(this,q,null),l(this,L).message=e,this.classList.add("error");let t={...l(this,L),...l(this,F).duration};l(this,Ve).error(e,t),this.dispatchEvent(new CustomEvent(Le,{detail:t,bubbles:!0,composed:!0}))},gi=async function(){var c;this.classList.remove("error"),m(this,te,null);let e=le.get(l(this,N));if(e)return m(this,I,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=l(this,F).settings,s=`${t}/fragment?id=${l(this,N)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await y(this,U,pi).call(this,s),(c=e.fields).originalId??(c.originalId=l(this,N)),le.add(e),m(this,I,e),!0},h(Wt,"cache",le);customElements.define(wr,Wt);import{LitElement as Rn,html as Cr,css as On,nothing as Dn}from"./lit-all.min.js";import{unsafeHTML as Nn}from"./lit-all.min.js";var Fn=a=>a?a.startsWith("sp-icon-")?Cr`${Nn(`<${a} class="badge-icon"></${a}>`)}`:Cr`<img src="${a}" class="badge-icon" />`:Dn,Ke=class extends Rn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Cr`<div class="badge">
    ...
    `),h(xt,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",xt);var Un={[ae]:Vr,[pe]:Wr,[ie]:Kr},Gn={[ae]:Yr,[ie]:j},yt,Kt=class{constructor(r){u(this,yt);h(this,"changes",new Map);h(this,"connected",!1);h(this,"error");h(this,"log");h(this,"options");h(this,"promises",[]);h(this,"state",pe);h(this,"timer",null);h(this,"value");h(this,"version",0);h(this,"wrapperElement");this.wrapperElement=r,this.log=mt.module("mas-element")}update(){[ae,pe,ie].forEach(r=>{this.wrapperElement.classList.toggle(Un[r],r===this.state)})}notify(){(this.state===ie||this.state===ae)&&(this.state===ie?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===ae&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let r=this.error;this.error instanceof ce&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Gn[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,e,t){this.changes.set(r,t),this.requestUpdate()}connectedCallback(){m(this,yt,yr()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:e,state:t}=this;return ie===t?Promise.resolve(this.wrapperElement):ae===t?Promise.reject(r):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(r,e,t){return r!==this.version?!1:(t!==void 0&&(this.options=t),this.state=ie,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),Vt(()=>this.notify()),!0)}toggleFailed(r,e,t){if(r!==this.version)return!1;t!==void 0&&(this.options=t),this.error=e,this.state=ae,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...l(this,yt)?.duration}),Vt(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=pe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!yr()||this.timer)return;let{error:e,options:t,state:i,value:n,version:o}=this;this.state=pe,this.timer=Vt(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===pe&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,t)}})}};yt=new WeakMap;function jn(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ye,xe=class xe extends HTMLAnchorElement{constructor(){super();h(this,"masElement",new Kt(this));u(this,ye);this.setAttribute("is",xe.is)}get isUptLink(){return!0}initializeWcsData(e,t){this.setAttribute("data-wcs-osi",e),t&&this.setAttribute("data-promotion-code",t)}attributeChangedCallback(e,t,i){this.masElement.attributeChangedCallback(e,t,i)}connectedCallback(){this.masElement.connectedCallback(),m(this,ye,me()),l(this,ye)&&(this.log=l(this,ye).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,ye,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=me();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let t=e.collectCheckoutOptions({},this);if(!t.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(t),n=e.resolveOfferSelectors(t);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:d}=t,p=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,g=this.getAttribute("data-promotion-code");g&&(p+=`&promotion_code=${encodeURIComponent(g)}`),this.href=`${jn(d)}?${p}`,this.masElement.toggleResolved(i,o,t)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${t.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,t),!1}}static createFrom(e){let t=new xe;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?t.setAttribute("class",i.value.replace("upt-link","").trim()):t.setAttribute(i.name,i.value));return t.innerHTML=e.innerHTML,t.setAttribute("tabindex",0),t}};ye=new WeakMap,h(xe,"is","upt-link"),h(xe,"tag","a"),h(xe,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var de=xe;window.customElements.get(de.is)||window.customElements.define(de.is,de,{extends:de.tag});var Vn="#000000",Ar="#F8D904",Wn="#EAEAEA",Kn="#31A547",Yn=/(accent|primary|secondary)(-(outline|link))?/,Qn="mas:product_code/",Zn="daa-ll",Yt="daa-lh",Xn=["XL","L","M","S"],zr="...",Jn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function $(a,r,e,t){let i=t[a];if(r[a]&&i){let n={slot:i?.slot,...i?.attributes},o=r[a];if(i.maxCount&&typeof o=="string"){let[c,d]=wo(o,i.maxCount,i.withSuffix);c!==o&&(n.title=d,o=c)}let s=z(i.tag,n,o);e.append(s)}}function eo(a,r,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,s)=>({icon:o,alt:a.mnemonicAlt?.[s]??"",link:a.mnemonicLink?.[s]??""}));i?.forEach(({icon:o,alt:s,link:c})=>{if(c&&!/^https?:/.test(c))try{c=new URL(`https://${c}`).href.toString()}catch{c="#"}let d={slot:"icons",src:o,loading:r.loading,size:e?.size??"l"};s&&(d.alt=s),c&&(d.href=c);let p=z("merch-icon",d);r.append(p)});let n=r.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function to(a,r,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let t=Ar,i=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(t=e.badge?.default,a.borderColor||(i=!0));let n=a.badgeBackgroundColor||t,o=a.borderColor||"";i&&(o=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${n}" border-color="${o}">${a.badge}</merch-badge>`}$("badge",a,r,e)}else a.badge?(r.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||r.setAttribute("badge-color",a.badgeColor||Vn),e.disabledAttributes?.includes("badgeBackgroundColor")||r.setAttribute("badge-background-color",a.badgeBackgroundColor||Ar),r.setAttribute("border-color",a.badgeBackgroundColor||Ar)):r.setAttribute("border-color",a.borderColor||Wn)}function ro(a,r,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let t=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||Kn;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${t}">${a.trialBadge}</merch-badge>`}$("trialBadge",a,r,e)}}function ao(a,r,e){e?.includes(a.size)&&r.setAttribute("size",a.size)}function io(a,r){a.cardName&&r.setAttribute("name",a.cardName)}function no(a,r,e){a.cardTitle&&(a.cardTitle=Ye(a.cardTitle)),$("cardTitle",a,r,{cardTitle:e})}function oo(a,r,e){$("subtitle",a,r,e)}function so(a,r,e,t){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){r.style.removeProperty("--merch-card-custom-background-color"),r.removeAttribute("background-color");return}e?.[a.backgroundColor]?(r.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),r.setAttribute("background-color",a.backgroundColor)):t?.attribute&&a.backgroundColor&&(r.setAttribute(t.attribute,a.backgroundColor),r.style.removeProperty("--merch-card-custom-background-color"))}function co(a,r,e){let t=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")r.style.setProperty(i,"transparent");else if(a.borderColor&&t){let o=t?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),s=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){r.setAttribute("gradient-border","true");let c=a.borderColor;if(t?.specialValues){for(let[d,p]of Object.entries(t.specialValues))if(p===a.borderColor){c=d;break}}r.setAttribute("border-color",c),r.style.removeProperty(i)}else s?(r.setAttribute("border-color",a.borderColor),r.style.setProperty(i,`var(--${a.borderColor})`)):r.style.setProperty(i,`var(--${a.borderColor})`)}}var lo=new Set(["","default"]);function ho(a,r,e){let t=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!t)return;let o=(r.querySelector('[slot="footer-rows"] merch-whats-included')??r.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),s=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",c=o||s;if(c==null||lo.has(String(c).trim().toLowerCase())){r.removeAttribute("whats-included-divider-color"),r.style.removeProperty(i);return}let d=String(c).trim();if(d.toLowerCase()==="transparent"){r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,"transparent");return}let g=t.specialValues?.[d]?.includes("gradient")||/-gradient/.test(d)||/^gradient-/.test(d),f=/^spectrum-.*-(plans|special-offers)$/.test(d);if(g){let C=d;if(t.specialValues){for(let[G,re]of Object.entries(t.specialValues))if(re===d){C=G;break}}r.setAttribute("whats-included-divider-color",C),r.style.removeProperty(i)}else f?(r.setAttribute("whats-included-divider-color",d),r.style.setProperty(i,`var(--${d})`)):(r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,`var(--${d})`))}function po(a,r,e){if(a.backgroundImage){let t={loading:r.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?t.alt=a.backgroundImageAltText:t.role="none",!e)return;if(e?.attribute){r.setAttribute(e.attribute,a.backgroundImage);return}r.append(z(e.tag,{slot:e.slot},z("img",t)))}}function Ye(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(tr(),er)).catch(console.error),a}function mo(a,r,e){a.prices&&(a.prices=Ye(a.prices)),$("prices",a,r,e)}function Tr(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap(Tr);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap(Tr);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function go(a,r,e){let t=Tr(a.features).filter(n=>n.trim());if(!t.length)return;let i=z("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});t.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let s=o.body.querySelector("p[name]");if(s){i.append(s);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&r.append(i)}function vi(a,r,e){let t=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=Yn.exec(i)?.[0]??"accent",o=n.includes("accent"),s=n.includes("primary"),c=n.includes("secondary"),d=n.includes("-outline"),p=n.includes("-link");a.classList.remove("accent","primary","secondary");let g;if(r.consonant)g=So(a,o,t,p,s,c,e?.ctas?.size);else if(p)g=a;else{let f;o?f="accent":s?f="primary":c&&(f="secondary"),g=r.spectrum==="swc"?Co(a,e,d,f,t):ko(a,e,d,f,t)}return g}function uo(a,r){let{slot:e}=r?.description,t=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);t.length&&t.forEach(i=>{let n=vi(i,a,r);i.replaceWith(n)})}function fo(a,r,e,t){a.description&&(a.description=Ye(a.description)),a.promoText&&(a.promoText=Ye(a.promoText)),a.shortDescription&&(a.shortDescription=Ye(a.shortDescription)),$("promoText",a,r,e),$("description",a,r,e),$("shortDescription",a,r,e),a.shortDescription&&(r.setAttribute("action-menu","true"),a.actionMenuLabel||r.setAttribute("action-menu-label","More options")),uo(r,e),$("callout",a,r,e),vo(a,r,e,t),$("whatsIncluded",a,r,e)}function vo(a,r,e,t={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=t.quantitySelect),$("quantitySelect",a,r,e))}function bo(a,r,e,t={}){if(!e.addon)return;let n=(a.addon??t.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o=z("merch-addon",{slot:"addon"},n);[...o.querySelectorAll(w)].forEach(s=>{let c=s.parentElement;c?.nodeName==="P"&&c.setAttribute("data-plan-type","")}),r.append(o)}function xo(a,r,e){a.addonConfirmation&&$("addonConfirmation",a,r,e)}function yo(a,r,e,t){t?.secureLabel&&e?.secureLabel&&r.setAttribute("secure-label",t.secureLabel)}function wo(a,r,e=!0){try{let t=typeof a!="string"?"":a,i=fi(t);if(i.length<=r)return[t,i];let n=0,o=!1,s=e?r-zr.length<1?1:r-zr.length:r,c=[];for(let g of t){if(n++,g==="<")if(o=!0,t[n]==="/")c.pop();else{let f="";for(let C of t.substring(n)){if(C===" "||C===">")break;f+=C}c.push(f)}if(g==="/"&&t[n]===">"&&c.pop(),g===">"){o=!1;continue}if(!o&&(s--,s===0))break}let d=t.substring(0,n).trim();if(c.length>0){c[0]==="p"&&c.shift();for(let g of c.reverse())d+=`</${g}>`}return[`${d}${e?zr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=fi(i);return[i,n]}}function fi(a){if(!a)return"";let r="",e=!1;for(let t of a){if(t==="<"&&(e=!0),t===">"){e=!1;continue}e||(r+=t)}return r}function Eo(a,r){r.querySelectorAll("a.upt-link").forEach(t=>{let i=de.createFrom(t);t.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function ko(a,r,e,t,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of a.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=r?.ctas?.size??"M",s=`spectrum-Button--${t}`,c=Xn.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",d=["spectrum-Button",s,c];return e&&d.push("spectrum-Button--outline"),n.classList.add(...d),n}function Co(a,r,e,t,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let s=z("sp-button",{treatment:o,variant:t,tabIndex:0,size:r?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return s.source=n,(i?n.onceSettled():Promise.resolve(n)).then(c=>{s.setAttribute("data-navigation-url",c.href)}),s.addEventListener("click",c=>{c.defaultPrevented||n.click()}),s}function So(a,r,e,t,i,n,o){let s=a;if(e)try{let c=customElements.get("checkout-link");c&&(s=c.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return t||(s.classList.add("button","con-button"),o&&o!=="m"&&s.classList.add(`button-${o}`),r&&s.classList.add("blue"),i&&s.classList.add("primary"),n&&s.classList.add("secondary")),s}function Ao(a,r,e,t,i){if(a.ctas){a.ctas=Ye(a.ctas);let{slot:n}=e.ctas,o=z("div",{slot:n},a.ctas),s=[...o.querySelectorAll("a")],c=i?.hideTrialCTAs?s.filter(p=>!Jn.has(p.dataset.analyticsId)):s,d=(c.length>0?c:s).map(p=>vi(p,r,e));o.textContent="",o.append(...d),r.append(o),i?.hideTrialCTAs&&c.length>0&&d.forEach(p=>{let g=p.source??p;g.onceSettled&&(p.hidden=!0,g.onceSettled().then(()=>{g.value?.[0]?.offerType==="TRIAL"&&d.some(C=>C!==p&&!C.hidden)?p.remove():p.hidden=!1}).catch(()=>{p.hidden=!1}))})}}function zo(a,r){let{tags:e}=a,t=e?.find(n=>typeof n=="string"&&n.startsWith(Qn))?.split("/").pop();if(!t)return;r.setAttribute(Yt,t),[...r.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...r.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(Zn,`${n.dataset.analyticsId}-${o+1}`)})}function To(a,r,e){let t={},i=[...a.classList].filter(n=>n!==r);for(let n of a.attributes)n.name!=="class"&&(t[n.name]=n.value);i.length&&(t.class=i.join(" ")),e==="secondary"&&(t.variant="secondary"),a.replaceWith(z("sp-link",t,a.innerHTML))}function Lo(a){if(a.consonant)return;let{spectrum:r}=a;r!=="css"&&r!=="swc"||[["primary-link","primary"],["secondary-link","secondary"]].forEach(([e,t])=>{a.querySelectorAll(`a.${e}`).forEach(i=>{r==="swc"?To(i,e,t):(i.classList.remove(e),i.classList.add("spectrum-Link",`spectrum-Link--${t}`))})})}function Po(a){a.querySelectorAll("[slot]").forEach(t=>{t.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",Yt].forEach(t=>a.removeAttribute(t));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function bi(a,r){if(!a){let c=r?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${c}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${c}).`)}if(!a.fields){let c=a.id||"unknown",d=r?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${c}' (merchCard id: ${d}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${c}' (merchCard id: ${d}) is missing 'fields'.`)}let{id:e,fields:t,settings:i={},priceLiterals:n}=a,{variant:o}=t;if(!o)throw new Error(`hydrate: no template found in payload ${e}`);Po(r),r.compatVersion=t.compatVersion,r.contextPromotionCode=t.promoCode,r.settings=i,n&&(r.priceLiterals=n),r.id??(r.id=a.id),a.variationId&&r.setAttribute("variation-id",a.variationId??""),r.variant=o,await r.updateComplete;let{aemFragmentMapping:s}=r.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&r.setAttribute("consonant",!0),eo(t,r,s.mnemonics),ro(t,r,s),ao(t,r,s.size),io(t,r),no(t,r,s.title),to(t,r,s),oo(t,r,s),mo(t,r,s),po(t,r,s.backgroundImage),so(t,r,s.allowedColors,s.backgroundColor),co(t,r,s),fo(t,r,s,i),go(t,r,s),ho(t,r,s),bo(t,r,s,i),xo(t,r,s),yo(t,r,s,i);try{Eo(t,r)}catch{}Ao(t,r,s,o,i),zo(t,r),Lo(r)}var Zt="merch-card",xi="merch-card:",ki=["full-pricing-express","simplified-pricing-express"],Ci=["segment","product"];function yi(a,r){let e=a.closest(Zt);if(!e)return r;e.priceLiterals&&(r.literals??(r.literals={}),Object.assign(r.literals,e.priceLiterals)),Jr(a)&&(r.displayPerUnit=!1,r.displayTax=!1),!r.promotionCode&&e.compatVersion>=1&&(r.promotionCode=e.contextPromotionCode),e.aemFragment&&(r[Zr]=!0),e.variantLayout?.priceOptionsProvider?.(a,r),a.dataset.template===M&&(r.displayDot??(r.displayDot=e.variantLayout?.legalDisplayDot??!0))}function wi(a,r){let e=a.closest(Zt);if(!e)return r;!r.promotionCode&&e.compatVersion>=1&&(r.promotionCode=e.contextPromotionCode)}function Mo(a){a.providers.has(yi)||a.providers.price(yi),a.providers.has(wi)||a.providers.checkout(wi)}var wt=new IntersectionObserver(a=>{a.forEach(r=>{let e=r.target;if(ki.includes(e.variant)){if(e.clientHeight===0)return;wt.unobserve(e),e.requestUpdate();return}if(Ci.includes(e.variant)){if(r.boundingClientRect.width===0)return;if(e.variant==="product"&&e.querySelector('merch-icon[slot="icons"]')){wt.unobserve(e);return}let t=e.getBoundingClientRect().width,n=e.querySelector('[slot="badge"]')?.getBoundingClientRect().width||0;if(t===0||n===0){wt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-n-16)}px`),wt.unobserve(e)}})}),Ro=0,Qe,Ze,Xe,Z,Ee,B,ke,A,we,Et,Lr,Qt,he=class extends _o{constructor(){super();u(this,A);h(this,"contextPromotionCode");u(this,Qe);u(this,Ze);u(this,Xe);u(this,Z);u(this,Ee);u(this,B);u(this,ke,new Promise(e=>{m(this,B,e)}));h(this,"compatVersion");h(this,"customerSegment");h(this,"marketSegment");h(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=gr(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=gr(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(t){y(this,A,we).call(this,`Error in postCardUpdateHook: ${t.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(w)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(X)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(X)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(X)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let t=this.checkoutLinks;if(t.length!==0)for(let i of t){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==o);e.checked&&s.push(o),i.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length===0)return;let i=n=>{let{offerType:o,planType:s}=n.value?.[0]??{};if(!o||!s)return;let c=e.getOsi(s,o),d=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==c);e.checked&&d.push(c),n.dataset.wcsOsi=d.join(",")};t.forEach(i)}handleQuantitySelection(e){let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length!==0)for(let i of t)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let t={...this.filters};Object.keys(t).forEach(i=>{if(e){t[i].order=Math.min(t[i].order||2,2);return}let n=t[i].order;n===1||isNaN(n)||(t[i].order=Number(n)+1)}),this.filters=t}showInfoTooltip(e,t){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(t)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(t=>this.iconButton.addEventListener(t,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(t=>this.iconButton.addEventListener(t,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",t=>{t.key==="Escape"&&this.iconButton.classList.remove(e)}))}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var t;super.connectedCallback(),l(this,Ze)||m(this,Ze,Ro++),this.aemFragment||((t=l(this,B))==null||t.call(this),m(this,B,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??l(this,Ze);m(this,Ee,`${xi}${e}${Lt}`),m(this,Qe,`${xi}${e}${Pt}`),performance.mark(l(this,Ee)),m(this,Z,me()),Mo(l(this,Z)),m(this,Xe,l(this,Z).Log.module(Zt)),this.addEventListener(O,this.handleQuantitySelection),this.addEventListener(rr,this.handleAddonAndQuantityUpdate),this.addEventListener(qr,this.handleMerchOfferSelectReady),this.addEventListener(Le,this.handleAemFragmentEvents),this.addEventListener(Te,this.handleAemFragmentEvents),this.addEventListener(zt,this.handleInfoIconEvents),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(O,this.handleQuantitySelection),this.removeEventListener(Le,this.handleAemFragmentEvents),this.removeEventListener(Te,this.handleAemFragmentEvents),this.removeEventListener(zt,this.handleInfoIconEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(rr,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var t;if(this.isConnected&&(e.type===Le&&y(this,A,we).call(this,"AEM fragment cannot be loaded"),e.type===Te&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{l(this,B)||m(this,ke,new Promise(n=>{m(this,B,n)})),await bi(i,this)}catch(n){y(this,A,we).call(this,`hydration has failed: ${n.message}`)}finally{(t=l(this,B))==null||t.call(this),m(this,B,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;l(this,ke)&&(await l(this,ke),(ki.includes(this.variant)||Ci.includes(this.variant))&&wt.observe(this),m(this,ke,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(c=>setTimeout(()=>c("timeout"),Ae));if(this.aemFragment){let c=await Promise.race([this.aemFragment.updateComplete,e]);if(c===!1||c==="timeout"){let d=c==="timeout"?`AEM fragment was not resolved within ${Ae} timeout`:"AEM fragment cannot be loaded";y(this,A,we).call(this,d,{},!1);return}}let t=[...this.querySelectorAll(Hr)],i=Promise.all(t.map(c=>{let d=c.onceSettled?.();return d?d.catch(()=>c):Promise.resolve(c)})).then(c=>{let d=c.filter(p=>p.isConnected);return d.length===0||d.every(p=>p.classList.contains("placeholder-resolved"))}),n=await Promise.race([i,e]);if(!this.isConnected)return;let o=t.filter(c=>c.isConnected);if(o.length===0||o.every(c=>c.classList.contains("placeholder-resolved"))){this.measure=performance.measure(l(this,Qe),l(this,Ee));let c={...this.aemFragment?.fetchInfo,...l(this,Z).duration,measure:Pe(this.measure)};return this.dispatchEvent(new CustomEvent(zt,{bubbles:!0,composed:!0,detail:c})),this}else{this.measure=performance.measure(l(this,Qe),l(this,Ee));let c={measure:Pe(this.measure),...l(this,Z).duration};if(n==="timeout")y(this,A,we).call(this,`Contains offers that were not resolved within ${Ae} timeout`,c);else{let d=o.some(p=>p.matches(X)&&p.classList.contains("placeholder-failed"));y(this,A,we).call(this,d?"CTA has an invalid offer":"Contains unresolved offers",c)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(X)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:t}}){if(!e||!t?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let s=new URL(n.getAttribute("href")).searchParams.get("pa"),c=t.find(p=>p.productArrangementCode===s)?.quantity,d=!!t.find(p=>p.productArrangementCode!==s);if(c&&this.quantitySelect?.dispatchEvent(new CustomEvent(Gr,{detail:{quantity:c},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==d){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:d}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(w))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${w}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return l(this,A,Et)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${w}[data-promotion-code],${X}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return this.contextPromotionCode;let t=[...new Set(e)];return t.length>1&&l(this,Xe)?.warn(`Multiple different promotion codes found: ${t.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${w}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(l(this,A,Lr)??l(this,A,Et))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return l(this,A,Et)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return l(this,A,Lr)?.querySelector(e)?.textContent?.trim()??l(this,A,Et)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return y(this,A,Qt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${X}, a`);return Array.from(e??[])}get primaryCta(){return y(this,A,Qt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return y(this,A,Qt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Qe=new WeakMap,Ze=new WeakMap,Xe=new WeakMap,Z=new WeakMap,Ee=new WeakMap,B=new WeakMap,ke=new WeakMap,A=new WeakSet,we=function(e,t={},i=!0){var c;if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let s={...this.aemFragment.fetchInfo,...l(this,Z).duration,...t,message:e};l(this,Xe).error(`merch-card${o}: ${e}`,s),this.failed=!0,(c=l(this,B))==null||c.call(this),m(this,B,void 0),l(this,Z).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(jr,{bubbles:!0,composed:!0,detail:s}))},Et=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${w}[data-template="price"] > span`)},Lr=function(){return this.querySelector(`${w}[data-template="legal"]`)},Qt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},h(he,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[t,i,n]=e.split(",");return{PUF:t,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(t=>{let[i,n,o]=t.split(":"),s=Number(n);return[i,{order:isNaN(s)?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([t,{order:i,size:n}])=>[t,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Yt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),h(he,"styles",[Fr,...Ir()]),h(he,"registerVariant",S),h(he,"getCollectionOptions",Va),h(he,"getFragmentMapping",Rt);customElements.define(Zt,he);export{he as MerchCard};

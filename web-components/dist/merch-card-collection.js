...
`;var es=32,qe=class extends N{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Ve`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),L.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(qe,"variantStyle",Jo`
    ...
    `);import{html as vt,css as ts,nothing as qt}from"./lit-all.min.js";var oa=`
:root {
...
`,Ue.MISSING_INTL_API,o);var A=r.getPluralRules(t,{type:d.pluralType}).select(m-(d.offset||0));x=d.options[A]||d.options.other}if(!x)throw new Ri(d.value,m,Object.keys(d.options),o);s.push.apply(s,Lt(x.value,t,r,i,a,m-(d.offset||0)));continue}}return Oc(s)}function Dc(e,t){return t?T(T(T({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=T(T({},e[i]),t[i]||{}),r},{})):e}function Hc(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=Dc(e[i],t[i]),r},T({},e)):e}function Ni(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Bc(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:_t(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,or([void 0],r,!1)))},{cache:Ni(e.number),strategy:ur.variadic}),getDateTimeFormat:_t(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,or([void 0],r,!1)))},{cache:Ni(e.dateTime),strategy:ur.variadic}),getPluralRules:_t(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,or([void 0],r,!1)))},{cache:Ni(e.pluralRules),strategy:ur.variadic})}}var Bn=function(){function e(t,r,i,a){var n=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==Y.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Lt(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Hc(e.formats,i),this.formatters=a&&a.formatters||Bc(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Nn,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Un=Bn;var Oi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Uc=_a("ConsonantTemplates/price"),Fc=/<\/?[^>]+(>|$)/g,F={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Te={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ii="TAX_EXCLUSIVE",zc=e=>Aa(e)?Object.entries(e).filter(([,t])=>Qe(t)||Xt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+Sa(i)+'"'}`,""):"",$=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+F.disabled}"${zc(r)}>${i?Xa(t):t??""}</span>`;function $c(e){e=e.replaceAll("</a>","&lt;/a&gt;");let t=/<a [^>]+(>|$)/g;return e.match(t)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function Gc(e){e=e.replaceAll("&lt;/a&gt;","</a>");let t=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(t)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function ve(e,t,r,i){let a=e[r];if(a==null)return"";let n=a.includes("<"),o=a.includes("<a ");try{a=o?$c(a):a,a=n?a.replace(Fc,""):a;let s=new Un(a,t).format(i);return o?Gc(s):s}catch{return Uc.error("Failed to format literal:",a),""}}function Vc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:h},m={}){let p=$(F.currencySymbol,i),u=$(F.currencySpace,o?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=p+u),f+=$(F.integer,s),f+=$(F.decimalsDelimiter,n),f+=$(F.decimals,a),c||(f+=u+p),f+=$(F.recurrence,l,null,!0),f+=$(F.unitType,d,null,!0),f+=$(F.taxInclusivity,h,!0),$(e,f,{...m})}var W=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayPromoStrikethrough:i=!1,displayAnnual:a=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:h,literals:m={},quantity:p=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:v,offerSelectorIds:b,formatString:y,price:x,priceWithoutDiscount:A,taxDisplay:H,taxTerm:k,term:R,usePrecision:B,promotion:q}={},G={})=>{Object.entries({country:o,formatString:y,language:h,price:x}).forEach(([To,Co])=>{if(Co==null)throw new Error(`Argument "${To}" is missing for osi ${b?.toString()}, country ${o}, language ${h}`)});let z={...Oi,...m},M=`${h.toLowerCase()}-${o.toUpperCase()}`,X;q&&!f&&A?X=e||i?x:A:r&&A?X=A:X=x;let ae=t?Za:Qa;a&&(ae=Ja);let{accessiblePrice:Fe,recurrenceTerm:$i,...Gi}=ae({commitment:v,formatString:y,instant:n,isIndianPrice:o==="IN",originalPrice:x,priceWithoutDiscount:A,price:t?x:X,promotion:q,quantity:p,term:R,usePrecision:B}),xr="",vr="",br="";w(c)&&$i&&(br=ve(z,M,Te.recurrenceLabel,{recurrenceTerm:$i}));let It="";w(l)&&(u&&(It+=" "),It+=ve(z,M,Te.perUnitLabel,{perUnit:"LICENSE"}));let Dt="";w(d)&&k&&(u&&(Dt+=" "),Dt+=ve(z,M,H===Ii?Te.taxExclusiveLabel:Te.taxInclusiveLabel,{taxTerm:k})),r&&(xr=ve(z,M,Te.strikethroughAriaLabel,{strikethroughPrice:xr})),e&&(vr=ve(z,M,Te.alternativePriceAriaLabel,{alternativePrice:vr}));let _e=F.container;if(t&&(_e+=" "+F.containerOptical),r&&(_e+=" "+F.containerStrikethrough),i&&(_e+=" "+F.containerPromoStrikethrough),e&&(_e+=" "+F.containerAlternative),a&&(_e+=" "+F.containerAnnual),w(s))return Vc(_e,{...Gi,accessibleLabel:xr,altAccessibleLabel:vr,recurrenceLabel:br,perUnitLabel:It,taxInclusivityLabel:Dt},G);let{currencySymbol:Vi,decimals:yo,decimalsDelimiter:Eo,hasCurrencySpace:qi,integer:wo,isCurrencyFirst:So}=Gi,ze=[wo,Eo,yo];So?(ze.unshift(qi?"\xA0":""),ze.unshift(Vi)):(ze.push(qi?"\xA0":""),ze.push(Vi)),ze.push(br,It,Dt);let Ao=ze.join("");return $(_e,Ao,G)},Fn=()=>(e,t,r)=>{let i=He(t.promotion,t.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price&&(!t.promotion||i);return`${n?W({displayStrikethrough:!0})({isPromoApplied:i,...e},t,r)+"&nbsp;":""}${W({isAlternativePrice:n})({isPromoApplied:i,...e},t,r)}`},zn=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=He(t.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return W()(e,{...t,price:t.priceWithoutDiscount},r)+$(F.containerAnnualPrefix,"&nbsp;(")+W({displayAnnual:!0,instant:i})(n,{...t,price:t.priceWithoutDiscount},r)+$(F.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${s?W({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${W({isAlternativePrice:s})({isPromoApplied:a,...e},t,r)}${$(F.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0,instant:i})(n,t,r)}${$(F.containerAnnualSuffix,")")}`},$n=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${W({isAlternativePrice:e.displayOldPrice})(e,t,r)}${$(F.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(i,t,r)}${$(F.containerAnnualSuffix,")")}`};var kt={...F,containerLegal:"price-legal",planType:"price-plan-type"},fr={...Te,planTypeLabel:"planTypeLabel"};function qc(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},a={}){let n="";return n+=$(kt.unitType,t,null,!0),r&&i&&(r+=". "),n+=$(kt.taxInclusivity,r,!0),n+=$(kt.planType,i,null),$(e,n,{...a})}var Gn=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:a,literals:n={}}={},{taxDisplay:o,taxTerm:s,planType:c}={},l={})=>{let d={...Oi,...n},h=`${a.toLowerCase()}-${e.toUpperCase()}`,m="";w(t)&&(m=ve(d,h,fr.perUnitLabel,{perUnit:"LICENSE"}));let p="";e==="US"&&a==="en"&&(r=!1),w(r)&&s&&(p=ve(d,h,o===Ii?fr.taxExclusiveLabel:fr.taxInclusiveLabel,{taxTerm:s}));let u="";w(i)&&c&&(u=ve(d,h,fr.planTypeLabel,{planType:c}));let f=kt.container;return f+=" "+kt.containerLegal,qc(f,{perUnitLabel:m,taxInclusivityLabel:p,planTypeLabel:u},l)};var Vn=W(),qn=Fn(),jn=W({displayOptical:!0}),Wn=W({displayStrikethrough:!0}),Yn=W({displayPromoStrikethrough:!0}),Xn=W({displayAnnual:!0}),Kn=W({displayOptical:!0,isAlternativePrice:!0}),Zn=W({isAlternativePrice:!0}),Qn=$n(),Jn=zn(),eo=Gn;var jc=(e,t)=>{if(!(!bt(e)||!bt(t)))return Math.floor((t-e)/t*100)},to=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,a=jc(r,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var ro=to();var io="INDIVIDUAL_COM",Hi="TEAM_COM",ao="INDIVIDUAL_EDU",Bi="TEAM_EDU",Wc=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","LU_de","LU_en","LU_fr","MY_en","MY_ms","MU_en","NL_nl","NO_nb","NZ_en","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TH_en","TH_th","TR_tr","UA_uk"],Yc={[io]:["LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko","ZA_en"],[Hi]:["LT_lt","LV_lv","NG_en","CO_es","KR_ko","ZA_en"],[ao]:["LT_lt","LV_lv","SA_en","SG_en","SA_ar"],[Bi]:["SG_en","KR_ko"]},Xc={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0],ZA_en:[!1,!1,!1,!1]},Kc=[io,Hi,ao,Bi],Zc=e=>[Hi,Bi].includes(e);function Di(e,t,r,i){if(e[t])return e[t];let a=`${t}_${r}`;if(e[a])return e[a];let n;if(i)n=e.find(o=>o.startsWith(`${t}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${t}_`));n=o?e[o]:null}return n}var Qc=(e,t,r,i)=>{let a=`${r}_${i}`,n=Di(Xc,e,t,!1);if(n){let o=Kc.indexOf(a);return n[o]}return Zc(a)},Jc=(e,t,r,i)=>{if(Di(Wc,e,t,!0))return!0;let a=Yc[`${r}_${i}`];return a?Di(a,e,t,!0)?!0:_.displayTax:_.displayTax},Ui=async(e,t,r,i)=>{let a=Jc(e,t,r,i);return{displayTax:a,forceTaxExclusive:a?Qc(e,t,r,i):_.forceTaxExclusive}},Mt=class Mt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ae(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(r){let i=ee();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:h,promotionCode:m,quantity:p,alternativePrice:u,template:f,wcsOsi:v}=i.collectPriceOptions(r);return ar(Mt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:h,promotionCode:m,quantity:p,alternativePrice:u,template:f,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,a){this.masElement.attributeChangedCallback(r,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===de}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=ee();if(!i)return!1;let a=i.collectPriceOptions(r,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let[s]=await i.resolveOfferSelectors(n),c=Et(await s,n),[l]=c;if(i.featureFlags[fe]||n[fe]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=l.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:d,language:h}=n,[m=""]=l.marketSegments,p=await Ui(d,h,l.customerSegment,m);a.displayTax===void 0&&(n.displayTax=p?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=p?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(c=Et(c,n))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);return this.renderOffers(c,n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(r,i,a=void 0){if(!this.isConnected)return;let n=ee();if(!n)return!1;if(a??(a=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(a,r,i)){this.innerHTML=n.buildPriceHTML(r,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(r,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,o,this.options))return this.innerHTML="",!0}return!1}};g(Mt,"is","inline-price"),g(Mt,"tag","span");var be=Mt;window.customElements.get(be.is)||window.customElements.define(be.is,be,{extends:be.tag});function no({literals:e,providers:t,settings:r}){function i(o,s=null){let c={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(s&&t?.price)for(let k of t.price)k(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:h,displayTax:m,displayPlanType:p,forceTaxExclusive:u,perpetual:f,displayAnnual:v,promotionCode:b,quantity:y,alternativePrice:x,wcsOsi:A,...H}=Object.assign(c,s?.dataset??{},o??{});return c=Kt(Object.assign({...c,...H,displayOldPrice:w(l),displayPerUnit:w(d),displayRecurrence:w(h),displayTax:w(m),displayPlanType:w(p),forceTaxExclusive:w(u),perpetual:w(f),displayAnnual:w(v),promotionCode:Qt(b).effectivePromoCode,quantity:Je(y,_.quantity),alternativePrice:w(x),wcsOsi:tr(A)})),c}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=ro;break;case"strikethrough":l=Wn;break;case"promo-strikethrough":l=Yn;break;case"annual":l=Xn;break;case"legal":l=eo;break;default:s.template==="optical"&&s.alternativePrice?l=Kn:s.template==="optical"?l=jn:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode?Jn:Qn:s.alternativePrice?l=Zn:l=s.promotionCode?qn:Vn}let[d]=o;return d={...d,...d.priceDetails},l({...r,...s},d)}let n=be.createInlinePrice;return{InlinePrice:be,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function el({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||_.language),t??(t=e?.split("_")?.[1]||_.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function oo(e={},t){let r=t.featureFlags[fe],{commerce:i={}}=e,a=me.PRODUCTION,n=Fr,o=U("checkoutClientId",i)??_.checkoutClientId,s=yt(U("checkoutWorkflowStep",i),Z,_.checkoutWorkflowStep),c=_.displayOldPrice,l=_.displayPerUnit,d=w(U("displayRecurrence",i),_.displayRecurrence),h=w(U("displayTax",i),_.displayTax),m=w(U("displayPlanType",i),_.displayPlanType),p=w(U("entitlement",i),_.entitlement),u=w(U("modal",i),_.modal),f=w(U("forceTaxExclusive",i),_.forceTaxExclusive),v=U("promotionCode",i)??_.promotionCode,b=Je(U("quantity",i)),y=U("wcsApiKey",i)??_.wcsApiKey,x=i?.env==="stage",A=we.PUBLISHED;["true",""].includes(i.allowOverride)&&(x=(U(Br,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",A=yt(U(Ur,i),we,A)),x&&(a=me.STAGE,n=zr);let k=U(Hr)??e.preview,R=typeof k<"u"&&k!=="off"&&k!=="false",B={};R&&(B={preview:R});let q=U("mas-io-url")??e.masIOUrl??`https://www${a===me.STAGE?".stage":""}.adobe.com/mas/io`,G=U("preselect-plan")??void 0;return{...el(e),...B,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:h,displayPlanType:m,entitlement:p,extraOptions:_.extraOptions,modal:u,env:a,forceTaxExclusive:f,promotionCode:v,quantity:b,alternativePrice:_.alternativePrice,wcsApiKey:y,wcsURL:n,landscape:A,masIOUrl:q,...G&&{preselectPlan:G}}}async function so(e,t={},r=2,i=100){let a;for(let n=0;n<=r;n++)try{let o=await fetch(e,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>r)break;await new Promise(s=>setTimeout(s,i*(n+1)))}throw a}var Fi="wcs";function co({settings:e}){let t=ce.module(Fi),{env:r,wcsApiKey:i}=e,a=new Map,n=new Map,o,s=new Map;async function c(u,f,v=!0){let b=ee(),y=Nr;t.debug("Fetching:",u);let x="",A;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let H=new Map(f),[k]=u.offerSelectorIds,R=Date.now()+Math.random().toString(36).substring(2,7),B=`${Fi}:${k}:${R}${Gr}`,q=`${Fi}:${k}:${R}${Vr}`,G;try{if(performance.mark(B),x=new URL(e.wcsURL),x.searchParams.set("offer_selector_ids",k),x.searchParams.set("country",u.country),x.searchParams.set("locale",u.locale),x.searchParams.set("landscape",r===me.STAGE?"ALL":e.landscape),x.searchParams.set("api_key",i),u.language&&x.searchParams.set("language",u.language),u.promotionCode&&x.searchParams.set("promotion_code",u.promotionCode),u.currency&&x.searchParams.set("currency",u.currency),A=await so(x.toString(),{credentials:"omit"}),A.ok){let z=[];try{let M=await A.json();t.debug("Fetched:",u,M),z=M.resolvedOffers??[]}catch(M){t.error(`Error parsing JSON: ${M.message}`,{...M.context,...b?.duration})}z=z.map(Jt),f.forEach(({resolve:M},X)=>{let ae=z.filter(({offerSelectorIds:Fe})=>Fe.includes(X)).flat();ae.length&&(H.delete(X),f.delete(X),M(ae))})}else y=Rr}catch(z){y=`Network error: ${z.message}`}finally{G=performance.measure(q,B),performance.clearMarks(B),performance.clearMeasures(q)}if(v&&f.size){t.debug("Missing:",{offerSelectorIds:[...f.keys()]});let z=Ra(A);f.forEach(M=>{M.reject(new et(y,{...u,...z,response:A,measure:Ft(G),...b?.duration}))})}}function l(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:v})=>c(f,v))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=r===me.STAGE?"stage":"prod",v=u[f];if(!v||typeof v!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[b,y]of Object.entries(v))a.set(b,Promise.resolve(y.map(Jt)));t.debug(`Prefilled WCS cache with ${v.size} entries`)}function h(){let u=a.size;s=new Map(a),a.clear(),t.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,v){let b=u!=="GB"&&!v?"MULT":"en",y=qr.includes(u)?u:_.country;return{validCountry:y,validLanguage:b,locale:`${f}_${y}`}}function p({country:u,language:f,perpetual:v=!1,promotionCode:b="",wcsOsi:y=[]}){let{validCountry:x,validLanguage:A,locale:H}=m(u,f,v),k=[x,A,b].filter(R=>R).join("-").toLowerCase();return y.map(R=>{let B=`${R}-${k}`;if(a.has(B))return a.get(B);let q=new Promise((G,z)=>{let M=n.get(k);M||(M={options:{country:x,locale:H,...A==="MULT"&&{language:A},offerSelectorIds:[]},promises:new Map},n.set(k,M)),b&&(M.options.promotionCode=b),M.options.offerSelectorIds.push(R),M.promises.set(R,{resolve:G,reject:z}),l()}).catch(G=>{if(s.has(B))return s.get(B);throw G});return a.set(B,q),q})}return{Commitment:Pe,PlanType:La,Term:oe,applyPlanType:Jt,resolveOfferSelectors:p,flushWcsCacheInternal:h,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var lo="mas-commerce-service",po="mas-commerce-service:start",ho="mas-commerce-service:ready",Rt,rt,it,mo,uo,zi=class extends HTMLElement{constructor(){super(...arguments);V(this,it);V(this,Rt);V(this,rt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let o=await r?.(i,a,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return S(this,rt)||j(this,rt,{[fe]:Ht(this,it,uo).call(this,fe)}),S(this,rt)}activate(){let r=S(this,it,mo),i=oo(r,this);rr(r.lana);let a=ce.init(r.hostEnv).module("service");a.debug("Activating:",r);let o={price:hn(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...ln(c),...dn(c),...no(c),...co(c),...jr,Log:ce,resolvePriceTaxFlags:Ui,get defaults(){return _},get log(){return ce},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(Ut,{bubbles:!0,cancelable:!1,detail:this});performance.mark(ho),j(this,Rt,performance.measure(ho,po)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(po),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Er).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Ft(S(this,Rt))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:o})=>a===0&&n===0&&o<200||o>=400),i=Array.from(new Map(r.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Rt=new WeakMap,rt=new WeakMap,it=new WeakSet,mo=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=n}}),i},uo=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||U(r))};window.customElements.get(lo)||window.customElements.define(lo,zi);var vo="merch-card-collection",tl=2e4,rl={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},il={plans:!0},al=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),nl=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,ol=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),sl=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),cl=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,Ce,nt,Ot,ot,gr,bo,at=class extends go{constructor(){super();V(this,gr);V(this,Ce,{});V(this,nt);V(this,Ot);V(this,ot);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}get paginationConfig(){let i=S(this,ot)?.getCollectionOptions(this.variant)?.pagination||{};return{enabled:this.paginationEnabled??i.enabled??!1,defaultPageSize:i.defaultPageSize??27,respectFiltered:i.respectFiltered??!1}}render(){return ye` <slot></slot>
        ...
        </sp-button>`}sortChanged(r){r.target.value===pe.authored?lt({sort:void 0}):lt({sort:r.target.value}),this.dispatchEvent(new CustomEvent(Sr,{bubbles:!0,composed:!0,detail:{value:r.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(Ar,{bubbles:!0,composed:!0}));let r=this.page+1;lt({page:r}),this.page=r,await this.updateComplete}startDeeplink(){this.stopDeeplink=Ki(({category:r,filter:i,types:a,sort:n,search:o,single_app:s,page:c})=>{i=i||r,!this.filtered&&i&&i!==this.filter&&setTimeout(()=>{lt({page:void 0}),this.page=1},1),this.filtered||(this.filter=i??this.filter),this.types=a??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(c)||1})}openFilters(r){this.sidenav?.showModal(r)}};Ce=new WeakMap,nt=new WeakMap,Ot=new WeakMap,ot=new WeakMap,gr=new WeakSet,bo=function(r,i={},a=!0){S(this,Ot).error(`merch-card-collection: ${r}`,i),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(Pr,{detail:{...i,message:r},bubbles:!0,composed:!0}))},g(at,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},pageSize:{type:Number,attribute:"page-size"},paginationEnabled:{type:Boolean,attribute:"pagination"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:pe.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(at,"styles",xo`
        #footer {
            grid-column: 1 / -1;
    ...
    `);at.SortOrder=pe;customElements.define(vo,at);var ll={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},dl=(e,t,r)=>{e.querySelectorAll(`[data-placeholder="${t}"]`).forEach(a=>{a.innerText=r||""})},pl={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},hl={catalog:"l"},te,st,Nt=class extends go{constructor(){super();V(this,te);V(this,st);g(this,"tablet",new ct(this,D));g(this,"desktop",new ct(this,P));this.collection=null,j(this,te,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(le,this.updateLiterals),this.collection?.addEventListener(dt,this.handleSidenavAttached),j(this,st,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(le,this.updateLiterals),this.collection?.removeEventListener(dt,this.handleSidenavAttached)}willUpdate(){S(this,te).search=this.getVisibility("search"),S(this,te).filter=this.getVisibility("filter"),S(this,te).sort=this.getVisibility("sort"),S(this,te).result=this.getVisibility("result"),S(this,te).custom=this.getVisibility("custom")}parseVisibilityOptions(r,i){if(!r||!Object.hasOwn(r,i))return null;let a=r[i];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(r){let i=S(this,st)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(i,r);return a!==null?a:this.parseVisibilityOptions(pl,r)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!S(this,te).search)return he;let r=mt(this,"searchText");return r?ye`
        ...
        `:he}get filterAction(){return S(this,te).filter?this.sidenav?ye`
            ...
            ></sp-action-button>
        `:he:he}get sortAction(){if(!S(this,te).sort)return he;let r=mt(this,"sortText");if(!r)return;let i=mt(this,"popularityText"),a=mt(this,"alphabeticallyText");if(!(i&&a))return;let n=this.collection?.sort===pe.alphabetical;return ye`
            <sp-action-menu
                id="sort"
                size="m"

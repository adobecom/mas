    ...
    `);customElements.define("merch-addon",ye);import{html as gt,nothing as ii}from"./lit-all.min.js";var we,We=class We{constructor(t){d(this,"card");g(this,we);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,we,s(this,we)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,we)}insertVariantStyle(){let t=this.constructor.name;if(!We.styleMap[t]){We.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),gt`
        ...
        `}get cardImage(){return gt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:ii}get secureLabelFooter(){return gt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return ut(this.card.variant)}};we=new WeakMap,d(We,"styleMap",{});var x=We;import{html as Dt,css as ni}from"./lit-all.min.js";var zr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Ke,css as oi}from"./lit-all.min.js";var _r=`
:root {
...
`;var ft=class extends x{constructor(t){super(t)}getGlobalCSS(){return Rr}renderLayout(){return Or` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Or`<hr />`} ${this.secureLabelFooter}`}};import{html as X,css as ci,unsafeCSS as Dr}from"./lit-all.min.js";var Nr=`
  :root {
...
`;var si=32,Fr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},ke=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?X`<slot name="secure-transaction-label">
    ...
    `);import{html as vt,css as li,unsafeCSS as $r,nothing as di}from"./lit-all.min.js";var Ir=`
  :root {
...
`;var hi=32,Br={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Se=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>vt` <footer>
    ...
    `);import{html as Ye,css as pi,nothing as xt}from"./lit-all.min.js";var qr=`
:root {
...
`;var Kr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ce=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Wr}priceOptionsProvider(t,e){t.dataset.template===O&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ft` ${this.badge}
    ...
    `);import{html as It,css as ui}from"./lit-all.min.js";var Yr=`
:root {
...
`;var Qr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ae=class extends x{constructor(t){super(t)}priceOptionsProvider(t,e){t.dataset.template===O&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Yr}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${b}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let e=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),t.parentNode.insertBefore(e,t.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return It`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as fi,css as vi}from"./lit-all.min.js";var Xr=`
...
`;var Zr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Te=class extends x{constructor(t){super(t)}getGlobalCSS(){return Xr}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return fi`
    ...
    `);import{html as $t,css as xi}from"./lit-all.min.js";var Jr=`
:root {
...
`;var ea={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Le=class extends x{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Jr}renderLayout(){return $t`${this.cardImage}
    ...
    `);import{html as bi,css as yi}from"./lit-all.min.js";var ta=`
:root {
...
`;var Bt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ze=class extends x{getGlobalCSS(){return ta}get aemFragmentMapping(){return Bt}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;if(!t)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(t.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(i=>i.onceSettled?.()));let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",c)})}),v.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!ct()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let t=this.getContainer();t&&t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t<=2||t===this.lastSyncedWidth||(this.lastSyncedWidth=t,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(ct())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};e();let r=window.matchMedia(y);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(y).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||ct())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return bi`
    ...
    `);import{html as aa,css as wi}from"./lit-all.min.js";var ra=`
:root {
...
`;var qt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Pe=class extends x{getGlobalCSS(){return ra}get aemFragmentMapping(){return qt}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return aa`
    ...
    `);import{html as Ht,css as Ei,nothing as ki}from"./lit-all.min.js";var ia=`
...
`;var na={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Si=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],_e=class extends x{constructor(t){super(t)}getGlobalCSS(){return ia}renderLayout(){return Ht`
    ...
    `);import{css as Ci,html as Ai}from"./lit-all.min.js";var oa=`
...
`;var ca={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Me=class extends x{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return oa}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${b}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ai`
            ${this.badge}
            <div class="body">
...
`;var Ut={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Re=class extends x{getGlobalCSS(){return sa}get aemFragmentMapping(){return Ut}renderLayout(){return Ti`
    ...
    `);var wt=new Map,la=new WeakMap,da=new Map,E=(a,t,e=null,r=null,i)=>{wt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};E("catalog",Ee,Pr,Ee.variantStyle);E("image",oe);E("inline-heading",ft);E("mini-compare-chart",ke,Fr,ke.variantStyle);E("mini-compare-chart-mweb",Se,Br,Se.variantStyle);E("plans",_,bt,_.variantStyle,_.collectionOptions);E("plans-students",_,Ur,_.variantStyle,_.collectionOptions);E("plans-education",_,Hr,_.variantStyle,_.collectionOptions);E("plans-v2",Z,Vr,Z.variantStyle,Z.collectionOptions);E("product",Ce,Kr,Ce.variantStyle);E("segment",Ae,Qr,Ae.variantStyle);E("media",Te,Zr,Te.variantStyle);E("headless",_e,na,_e.variantStyle);E("special-offers",Le,ea,Le.variantStyle);E("simplified-pricing-express",ze,Bt,ze.variantStyle);E("full-pricing-express",Pe,qt,Pe.variantStyle);E("mini",Me,ca,Me.variantStyle);E("image",oe,Mr,oe.variantStyle);E("fries",Re,Ut,Re.variantStyle);var zi=(a,t,e)=>{try{let r=da.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),da.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Gt=a=>{let t=wt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=la.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?zi(a,r,i):{};return la.set(a,{appliedVariant:a.variant,...n}),new e(a)};function ut(a){return wt.get(a)?.fragmentMapping}function ha(a){return wt.get(a)?.collectionOptions}var pa=document.createElement("style");pa.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var ce={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ga=1e3;function Mi(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ua(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ce.serializableTypes.includes(e))return e}return a}function Ri(a,t){if(!ce.ignoredProperties.includes(a))return ua(t)}var Vt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(h=>{h!=null&&(Mi(h)?r:i).push(h)}),r.length&&(n+=" "+r.map(ua).join(" "));let{pathname:o,search:c}=window.location,l=`${ce.delimiter}page=${o}${c}`;l.length>ga&&(l=`${l.slice(0,ga)}<trunc>`),n+=l,i.length&&(n+=`${ce.delimiter}facts=`,n+=JSON.stringify(i,Ri)),window.lana?.log(n,ce)}};function fa(a){Object.assign(ce,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in ce&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var va={LOCAL:"local",PROD:"prod",STAGE:"stage"},Wt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Kt=new Set,Yt=new Set,xa=new Map,ba={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},ya={filter:({level:a})=>a!==Wt.DEBUG},Oi={filter:()=>!1};function Ni(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&kt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Di(a){[...Yt].every(t=>t(a))&&Kt.forEach(t=>t(a))}function wa(a){let t=(xa.get(a)??0)+1;xa.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>wa(`${r.namespace}/${i}`),updateConfig:fa};return Object.values(Wt).forEach(i=>{r[i]=(n,...o)=>Di(Ni(i,n,a,o,e))}),Object.seal(r)}function St(...a){a.forEach(t=>{let{append:e,filter:r}=t;kt(r)&&Yt.add(r),kt(e)&&Kt.add(e)})}function Fi(a={}){let{name:t}=a,e=ma(Et("commerce.debug",{search:!0,storage:!0}),t===va.LOCAL);return St(e?ba:ya),t===va.PROD&&St(Vt),Qe}function Ii(){Kt.clear(),Yt.clear()}var Qe={...wa(Ar),Level:Wt,Plugins:{consoleAppender:ba,debugFilter:ya,quietFilter:Oi,lanaAppender:Vt},init:Fi,reset:Ii,use:St};var $i="mas-commerce-service",sl=Qe.module("utilities"),Bi={requestId:dt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Ct=a=>window.setTimeout(a);function Qt(){return document.getElementsByTagName($i)?.[0]}function Ea(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Bi)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function ka(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var Sa="fragment",Ca="author",Aa="preview",Ta="loading",La="timeout",Xt="aem-fragment",za="eager",Pa="cache",qi=[za,Pa],G,se,$,Zt=class{constructor(){g(this,G,new Map);g(this,se,new Map);g(this,$,new Map)}clear(){s(this,G).clear(),s(this,se).clear(),s(this,$).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,G).set(t.id,t),t.fields?.originalId&&s(this,G).set(t.fields.originalId,t),s(this,$).has(t.id)){let[,r]=s(this,$).get(t.id);r()}if(s(this,$).has(t.fields?.originalId)){let[,r]=s(this,$).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,G).has(t)}entries(){return s(this,G).entries()}get(t){return s(this,G).get(t)}getAsPromise(t){let[e]=s(this,$).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,$).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,se).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,se).set(t,e)),e}remove(t){s(this,G).delete(t),s(this,se).delete(t),s(this,$).delete(t)}};G=new WeakMap,se=new WeakMap,$=new WeakMap;var ee=new Zt,Oe,B,W,N,M,C,Xe,Ze,q,Je,et,Ne,H,_a,Ma,Jt,Ra,At=class extends HTMLElement{constructor(){super(...arguments);g(this,H);d(this,"cache",ee);g(this,Oe);g(this,B,null);g(this,W,null);g(this,N,null);g(this,M);g(this,C);g(this,Xe,za);g(this,Ze,5e3);g(this,q);g(this,Je,!1);g(this,et,0);g(this,Ne)}static get observedAttributes(){return[Sa,Ta,La,Ca,Aa]}attributeChangedCallback(e,r,i){e===Sa&&(m(this,M,i),m(this,C,ee.getFetchInfo(i))),e===Ta&&qi.includes(i)&&m(this,Xe,i),e===La&&m(this,Ze,parseInt(i,10)),e===Ca&&m(this,Je,["","true"].includes(i)),e===Aa&&m(this,Ne,i)}connectedCallback(){if(!s(this,q)){if(s(this,N)??m(this,N,ie(this)),m(this,Ne,s(this,N).settings?.preview),s(this,Oe)??m(this,Oe,s(this,N).log.module(`${Xt}[${s(this,M)}]`)),!s(this,M)||s(this,M)==="#"){s(this,C)??m(this,C,ee.getFetchInfo("missing-fragment-id")),z(this,H,Jt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,C)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&ee.remove(s(this,M)),s(this,Xe)===Pa&&await Promise.race([ee.getAsPromise(s(this,M)),new Promise(c=>setTimeout(c,s(this,Ze)))]);try{m(this,q,z(this,H,Ra).call(this)),await s(this,q)}catch(c){return z(this,H,Jt).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,B)||{};return o&&!Et("mas.disableWcsCache")&&s(this,N).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(fe,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,C)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,W)?s(this,W):(s(this,Je)?this.transformAuthorData():this.transformPublishData(),s(this,W))}get rawData(){return s(this,B)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:h={}}=s(this,B);m(this,W,e.reduce((p,{name:u,multiple:S,values:I})=>(p.fields[u]=S?I:I[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:h,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:h}=s(this,B);m(this,W,Object.entries(e).reduce((p,[u,S])=>(p.fields[u]=S?.mimeType?S.value:S??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:h}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,M),{locale:s(this,N).settings.locale,apiKey:s(this,N).settings.wcsApiKey,fullContext:!0})}};Oe=new WeakMap,B=new WeakMap,W=new WeakMap,N=new WeakMap,M=new WeakMap,C=new WeakMap,Xe=new WeakMap,Ze=new WeakMap,q=new WeakMap,Je=new WeakMap,et=new WeakMap,Ne=new WeakMap,H=new WeakSet,_a=async function(e){lr(this,et)._++;let r=`${Xt}:${s(this,M)}:${s(this,et)}`,i=`${r}${ht}`,n=`${r}${pt}`;if(s(this,Ne)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new J(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,C).stale=!1,s(this,C).url=e,o=await ka(e,{cache:"default",credentials:"omit"}),z(this,H,Ma).call(this,o),s(this,C).status=o?.status,s(this,C).measure=xe(performance.measure(n,i)),s(this,C).retryCount=o.retryCount,!o?.ok)throw new J("Unexpected fragment response",{response:o,...s(this,N).duration});return await o.json()}catch(c){if(s(this,C).measure=xe(performance.measure(n,i)),s(this,C).retryCount=c.retryCount,s(this,B))return s(this,C).stale=!0,s(this,Oe).error("Serving stale data",s(this,C)),s(this,B);let l=c.message??"unknown";throw new J(`Failed to fetch fragment: ${l}`,{})}},Ma=function(e){Object.assign(s(this,C),Ea(e))},Jt=function(e){m(this,q,null),s(this,C).message=e,this.classList.add("error");let r={...s(this,C),...s(this,N).duration};s(this,Oe).error(e,r),this.dispatchEvent(new CustomEvent(ve,{detail:r,bubbles:!0,composed:!0}))},Ra=async function(){var l;this.classList.remove("error"),m(this,W,null);let e=ee.get(s(this,M));if(e)return m(this,B,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,N).settings,c=`${r}/fragment?id=${s(this,M)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await z(this,H,_a).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,M)),ee.add(e),m(this,B,e),!0},d(At,"cache",ee);customElements.define(Xt,At);import{LitElement as Hi,html as er,css as Ui,nothing as Gi}from"./lit-all.min.js";import{unsafeHTML as ji}from"./lit-all.min.js";var Vi=a=>a?a.startsWith("sp-icon-")?er`${ji(`<${a} class="badge-icon"></${a}>`)}`:er`<img src="${a}" class="badge-icon" />`:Gi,De=class extends Hi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return er`<div class="badge">
    ...
    `),d(tt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",tt);import{html as tr,css as Qi,LitElement as Xi,nothing as Oa}from"./lit-all.min.js";var rt=class extends Xi{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return tr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?tr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:Oa}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(rt,"styles",Qi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;

...
`,gr=()=>[pr`
    ...
    `);customElements.define("merch-icon",ge);var Wn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Kn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var b='span[is="inline-price"][data-wcs-osi]',K='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Xa='a[is="upt-link"]',fr=`${b},${K},${Xa}`;var vr="merch-offer-select:ready",xr="merch-card:action-menu-toggle";var R="merch-quantity-selector:change",br="merch-card-quantity:change",Nt="merch-modal:addon-and-quantity-update";var ue="merch-card-collection:literals-changed";var fe="aem:load",ve="aem:error",dt="mas:ready",yr="mas:error",wr="placeholder-failed",Er="placeholder-pending",kr="placeholder-resolved";var Cr="mas:failed",Ue="mas:resolved",Sr="mas/commerce";var Y="failed",re="pending",Q="resolved";var ht="X-Request-Id",Yn=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Qn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var pt=":start",mt=":duration";var O="legal",Ar="mas-ff-defaults";var Ja="mas-commerce-service";function Tr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function L(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(t))i.setAttribute(n,o);return i}function xe(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function Dt(){return window.matchMedia("(max-width: 1024px)").matches}function ae(){return document.getElementsByTagName(Ja)?.[0]}function Ge(a){let t=window.getComputedStyle(a);return a.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var je,ie,Ve,We,be,gt=class extends HTMLElement{constructor(){super();g(this,je,"");g(this,ie);g(this,Ve,[]);g(this,We,[]);g(this,be);m(this,be,Tr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,ie)?this.parentElement.style.borderRadius=s(this,ie):s(this,ie)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Ve).map((r,i)=>{let n=s(this,We)[i]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,je)}, ${e})`}connectedCallback(){s(this,be).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&m(this,ie,i?.trim()),e==="colors"&&i?m(this,Ve,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,We,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,je,i?.trim()??""),s(this,be).call(this)}};je=new WeakMap,ie=new WeakMap,Ve=new WeakMap,We=new WeakMap,be=new WeakMap;customElements.define("merch-gradient",gt);import{LitElement as ei,html as ti,css as ri}from"./lit-all.min.js";var ye=class extends ei{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${b}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Ue,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Ue,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return ti` <input
                type="checkbox"
                id="addon-checkbox"
    ...
    `);customElements.define("merch-addon",ye);import{html as ut,nothing as ai}from"./lit-all.min.js";var we,Ke=class Ke{constructor(t){d(this,"card");g(this,we);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,we,s(this,we)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,we)}insertVariantStyle(){let t=this.constructor.name;if(!Ke.styleMap[t]){Ke.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),ut`
            <div
                id="badge"
        ...
        `}get cardImage(){return ut` <div class="image">
            ...
            ${this.badge}
              ...
              >`:ai}get secureLabelFooter(){return ut`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return ft(this.card.variant)}};we=new WeakMap,d(Ke,"styleMap",{});var x=Ke;import{html as Ft,css as ii}from"./lit-all.min.js";var Lr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as Ye,css as ni}from"./lit-all.min.js";var Pr=`
:root {
...
`;var vt=class extends x{constructor(t){super(t)}getGlobalCSS(){return Mr}renderLayout(){return Rr` ${this.badge}
            ...
            ${this.card.customHr?"":Rr`<hr />`} ${this.secureLabelFooter}`}};import{html as Z,css as oi,unsafeCSS as Nr}from"./lit-all.min.js";var Or=`
  :root {
...
`;var ci=32,Dr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},ke=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?Z`<slot name="secure-transaction-label">
    ...
    `);import{html as xt,css as si,unsafeCSS as Ir,nothing as li}from"./lit-all.min.js";var Fr=`
  :root {
...
`;var di=32,$r={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ce=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>xt` <footer>
    ...
    `);import{html as Qe,css as hi,nothing as bt}from"./lit-all.min.js";var Br=`
:root {
...
`;var Wr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Se=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Vr}priceOptionsProvider(t,e){t.dataset.template===O&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return It` ${this.badge}
    ...
    `);import{html as $t,css as gi}from"./lit-all.min.js";var Kr=`
:root {
...
`;var Zr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Te=class extends x{constructor(t){super(t)}getGlobalCSS(){return Qr}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return ui`
    ...
    `);import{html as Bt,css as vi}from"./lit-all.min.js";var Xr=`
:root {
...
`;var Ht={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Pe=class extends x{getGlobalCSS(){return ta}get aemFragmentMapping(){return Ht}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return ra`
    ...
    `);import{html as Ut,css as wi,nothing as Ei}from"./lit-all.min.js";var aa=`
...
`;var Gt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Re=class extends x{getGlobalCSS(){return ca}get aemFragmentMapping(){return Gt}renderLayout(){return Ai`
    ...
    `);var Et=new Map,sa=new WeakMap,la=new Map,E=(a,t,e=null,r=null,i)=>{Et.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};E("catalog",Ee,zr,Ee.variantStyle);E("image",ne);E("inline-heading",vt);E("mini-compare-chart",ke,Dr,ke.variantStyle);E("mini-compare-chart-mweb",Ce,$r,Ce.variantStyle);E("plans",_,yt,_.variantStyle,_.collectionOptions);E("plans-students",_,Hr,_.variantStyle,_.collectionOptions);E("plans-education",_,qr,_.variantStyle,_.collectionOptions);E("plans-v2",X,jr,X.variantStyle,X.collectionOptions);E("product",Se,Wr,Se.variantStyle);E("segment",Ae,Yr,Ae.variantStyle);E("media",Te,Zr,Te.variantStyle);E("headless",_e,ia,_e.variantStyle);E("special-offers",Le,Jr,Le.variantStyle);E("simplified-pricing-express",ze,qt,ze.variantStyle);E("full-pricing-express",Pe,Ht,Pe.variantStyle);E("mini",Me,oa,Me.variantStyle);E("image",ne,_r,ne.variantStyle);E("fries",Re,Gt,Re.variantStyle);var Li=(a,t,e)=>{try{let r=la.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),la.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},jt=a=>{let t=Et.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=sa.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?Li(a,r,i):{};return sa.set(a,{appliedVariant:a.variant,...n}),new e(a)};function ft(a){return Et.get(a)?.fragmentMapping}function da(a){return Et.get(a)?.collectionOptions}var ha=document.createElement("style");ha.innerHTML=`
:root {
...
`;document.head.appendChild(ha);function kt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=Vt(r)?r:a;n=o.get(c)}if(i&&n==null){let o=Vt(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Pi(Vt(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var zi=a=>typeof a=="boolean",Ct=a=>typeof a=="function";var Vt=a=>typeof a=="string";function pa(a,t){if(zi(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Pi(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var oe=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(ht);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var ce={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ma=1e3;function _i(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ga(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ce.serializableTypes.includes(e))return e}return a}function Mi(a,t){if(!ce.ignoredProperties.includes(a))return ga(t)}var Wt={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(h=>{h!=null&&(_i(h)?r:i).push(h)}),r.length&&(n+=" "+r.map(ga).join(" "));let{pathname:o,search:c}=window.location,l=`${ce.delimiter}page=${o}${c}`;l.length>ma&&(l=`${l.slice(0,ma)}<trunc>`),n+=l,i.length&&(n+=`${ce.delimiter}facts=`,n+=JSON.stringify(i,Mi)),window.lana?.log(n,ce)}};function ua(a){Object.assign(ce,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in ce&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var fa={LOCAL:"local",PROD:"prod",STAGE:"stage"},Kt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Yt=new Set,Qt=new Set,va=new Map,xa={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},ba={filter:({level:a})=>a!==Kt.DEBUG},Ri={filter:()=>!1};function Oi(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&Ct(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function Ni(a){[...Qt].every(t=>t(a))&&Yt.forEach(t=>t(a))}function ya(a){let t=(va.get(a)??0)+1;va.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>ya(`${r.namespace}/${i}`),updateConfig:ua};return Object.values(Kt).forEach(i=>{r[i]=(n,...o)=>Ni(Oi(i,n,a,o,e))}),Object.seal(r)}function St(...a){a.forEach(t=>{let{append:e,filter:r}=t;Ct(r)&&Qt.add(r),Ct(e)&&Yt.add(e)})}function Di(a={}){let{name:t}=a,e=pa(kt("commerce.debug",{search:!0,storage:!0}),t===fa.LOCAL);return St(e?xa:ba),t===fa.PROD&&St(Wt),Ze}function Fi(){Yt.clear(),Qt.clear()}var Ze={...ya(Sr),Level:Kt,Plugins:{consoleAppender:xa,debugFilter:ba,quietFilter:Ri,lanaAppender:Wt},init:Di,reset:Fi,use:St};var Ii="mas-commerce-service",nl=Ze.module("utilities"),$i={requestId:ht,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var At=a=>window.setTimeout(a);function Zt(){return document.getElementsByTagName(Ii)?.[0]}function wa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries($i)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ea(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var ka="fragment",Ca="author",Sa="preview",Aa="loading",Ta="timeout",Xt="aem-fragment",La="eager",za="cache",Bi=[La,za],G,se,I,Jt=class{constructor(){g(this,G,new Map);g(this,se,new Map);g(this,I,new Map)}clear(){s(this,G).clear(),s(this,se).clear(),s(this,I).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,G).set(t.id,t),t.fields?.originalId&&s(this,G).set(t.fields.originalId,t),s(this,I).has(t.id)){let[,r]=s(this,I).get(t.id);r()}if(s(this,I).has(t.fields?.originalId)){let[,r]=s(this,I).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,G).has(t)}entries(){return s(this,G).entries()}get(t){return s(this,G).get(t)}getAsPromise(t){let[e]=s(this,I).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,I).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,se).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,se).set(t,e)),e}remove(t){s(this,G).delete(t),s(this,se).delete(t),s(this,I).delete(t)}};G=new WeakMap,se=new WeakMap,I=new WeakMap;var J=new Jt,Oe,$,W,N,M,S,Xe,Je,B,et,tt,Ne,q,Pa,_a,er,Ma,Tt=class extends HTMLElement{constructor(){super(...arguments);g(this,q);d(this,"cache",J);g(this,Oe);g(this,$,null);g(this,W,null);g(this,N,null);g(this,M);g(this,S);g(this,Xe,La);g(this,Je,5e3);g(this,B);g(this,et,!1);g(this,tt,0);g(this,Ne)}static get observedAttributes(){return[ka,Aa,Ta,Ca,Sa]}attributeChangedCallback(e,r,i){e===ka&&(m(this,M,i),m(this,S,J.getFetchInfo(i))),e===Aa&&Bi.includes(i)&&m(this,Xe,i),e===Ta&&m(this,Je,parseInt(i,10)),e===Ca&&m(this,et,["","true"].includes(i)),e===Sa&&m(this,Ne,i)}connectedCallback(){if(!s(this,B)){if(s(this,N)??m(this,N,ae(this)),m(this,Ne,s(this,N).settings?.preview),s(this,Oe)??m(this,Oe,s(this,N).log.module(`${Xt}[${s(this,M)}]`)),!s(this,M)||s(this,M)==="#"){s(this,S)??m(this,S,J.getFetchInfo("missing-fragment-id")),z(this,q,er).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,S)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,B)&&!await Promise.race([s(this,B),Promise.resolve(!1)]))return;e&&J.remove(s(this,M)),s(this,Xe)===za&&await Promise.race([J.getAsPromise(s(this,M)),new Promise(c=>setTimeout(c,s(this,Je)))]);try{m(this,B,z(this,q,Ma).call(this)),await s(this,B)}catch(c){return z(this,q,er).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,$)||{};return o&&!kt("mas.disableWcsCache")&&s(this,N).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(fe,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,S)},bubbles:!0,composed:!0})),s(this,B)}get updateComplete(){return s(this,B)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,W)?s(this,W):(s(this,et)?this.transformAuthorData():this.transformPublishData(),s(this,W))}get rawData(){return s(this,$)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:h={}}=s(this,$),p=Array.isArray(e)?e:[];m(this,W,p.reduce((u,{name:C,multiple:H,values:qe})=>(u.fields[C]=H?qe:qe[0],u),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:h,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:h}=s(this,$);m(this,W,Object.entries(e).reduce((p,[u,C])=>(p.fields[u]=C?.mimeType?C.value:C??"",p),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:h}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,M),{locale:s(this,N).settings.locale,apiKey:s(this,N).settings.wcsApiKey})}};Oe=new WeakMap,$=new WeakMap,W=new WeakMap,N=new WeakMap,M=new WeakMap,S=new WeakMap,Xe=new WeakMap,Je=new WeakMap,B=new WeakMap,et=new WeakMap,tt=new WeakMap,Ne=new WeakMap,q=new WeakSet,Pa=async function(e){lr(this,tt)._++;let r=`${Xt}:${s(this,M)}:${s(this,tt)}`,i=`${r}${pt}`,n=`${r}${mt}`;if(s(this,Ne))return await this.generatePreview();performance.mark(i);let o;try{if(s(this,S).stale=!1,s(this,S).url=e,o=await Ea(e,{cache:"default",credentials:"omit"}),z(this,q,_a).call(this,o),s(this,S).status=o?.status,s(this,S).measure=xe(performance.measure(n,i)),s(this,S).retryCount=o.retryCount,!o?.ok)throw new oe("Unexpected fragment response",{response:o,...s(this,N).duration});return await o.json()}catch(c){if(s(this,S).measure=xe(performance.measure(n,i)),s(this,S).retryCount=c.retryCount,s(this,$))return s(this,S).stale=!0,s(this,Oe).error("Serving stale data",s(this,S)),s(this,$);let l=c.message??"unknown";throw new oe(`Failed to fetch fragment: ${l}`,{})}},_a=function(e){Object.assign(s(this,S),wa(e))},er=function(e){m(this,B,null),s(this,S).message=e,this.classList.add("error");let r={...s(this,S),...s(this,N).duration};s(this,Oe).error(e,r),this.dispatchEvent(new CustomEvent(ve,{detail:r,bubbles:!0,composed:!0}))},Ma=async function(){var l;this.classList.remove("error"),m(this,W,null);let e=J.get(s(this,M));if(e)return m(this,$,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,N).settings,c=`${r}/fragment?id=${s(this,M)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await z(this,q,Pa).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,M)),J.add(e),m(this,$,e),!0},d(Tt,"cache",J);customElements.define(Xt,Tt);import{LitElement as qi,html as tr,css as Hi,nothing as Ui}from"./lit-all.min.js";import{unsafeHTML as Gi}from"./lit-all.min.js";var ji=a=>a?a.startsWith("sp-icon-")?tr`${Gi(`<${a} class="badge-icon"></${a}>`)}`:tr`<img src="${a}" class="badge-icon" />`:Ui,De=class extends qi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return tr`<div class="badge">
    ...
    `);customElements.define("merch-badge",De);import{html as Vi,css as Wi,LitElement as Ki}from"./lit-all.min.js";var rt=class extends Ki{constructor(){super()}render(){return Vi`
            <slot name="icon"></slot>
    ...
    `),d(rt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",rt);import{html as rr,css as Yi,LitElement as Qi,nothing as Ra}from"./lit-all.min.js";var at=class extends Qi{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return rr`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?rr`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:Ra}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(at,"styles",Yi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
